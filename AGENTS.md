...
binary. The build verifies it is the native-bridge build and applies exactly one
asserted cosmetic patch (the version label). If you think you need to change the
UI, you actually need to change what the backend returns.
