...
//@display-name Inlay Nexus 2.0.13
//@api 3.0
//@version 2.0.13
...
(function(){var Ia=Object.defineProperty,Ht=(e,t)=>{let n={};for(var a in e)Ia(n,a,{get:e[a],enumerable:!0});return t||Ia(n,Symbol.toStringTag,{value:"Module"}),n},at="2.0.13",ps="2026-08-05-base-wear-fixed",Ea=["author_note","tagger","format","prefill","preprocess","preset_1","lore_inject","char_inject","appearance_inject","autotag"],_s=["tagger","format","appearance_inject","lore_inject","autotag"],Ie="__global__",$a="inx_native_settings",ja=e=>`inx_nxstore_${e}`,ve=e=>`inx_nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,qt="inx_nxref_image",Gt="inx_nxvibe_image",Wt="inx_nxvibe_data",ys="native_settings",bs=e=>`nxstore_${e}`,ws=e=>`nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,vs="nxref_image",Wu="https://image.novelai.net/ai/generate-image",xs="https://image.novelai.net/ai/encode-vibe",ks="https://api.novelai.net/user/subscription",Ss=["meta","cards","characters","jobs","images"],Ms=4e3;function rt(){const e=globalThis;return e.risuai??e.Risuai}function Vt(e){return typeof rt()?.[e]=="function"}var As=new Set(["ms","bytes","status","message","job_id","background","focus"]),xe=[],Yt="",Zt=null,Xt="boot",Nn="boot",Ca=null,Ns=e=>{Ca=e},Qt=e=>{Yt=e},Is=()=>Yt,st=()=>Nn,en=()=>Xt,In=()=>Zt,Es=()=>xe.length,Ta=(e,t)=>xe.filter(n=>n.job_id===e).slice(-t),La=(e,t=280)=>{if(e==null||typeof e=="number"||typeof e=="boolean")return e;let n;if(typeof e=="string")n=e;else try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:`${n.slice(0,t)}…(+${n.length-t})`},$s=e=>e.startsWith("job.")||e.startsWith("nai.")||e.startsWith("llm.")||e.startsWith("image.");function v(e,t={},n="info"){const a={t:Date.now(),iso:new Date().toISOString(),stage:String(e||""),level:n,job_id:Yt||t.job_id||"",ms:t.ms!=null?Number(t.ms):void 0,bytes:t.bytes!=null?Number(t.bytes):void 0,status:t.status!=null?t.status:void 0,message:t.message!=null?La(t.message,240):void 0,detail:{}};for(const[s,i]of Object.entries(t))As.has(s)||(a.detail[s]=i==null||typeof i=="number"||typeof i=="boolean"?i:La(i,220));for(xe.push(a);xe.length>240;)xe.shift();Xt=a.stage,(t.focus||!t.background&&$s(a.stage))&&(Nn=a.stage),n==="error"&&(Zt={stage:a.stage,message:String(a.message??""),t:a.t});const r=`[InlayNX:${a.stage}]`+(a.message?` ${String(a.message)}`:"")+(a.ms!=null?` ${a.ms}ms`:"")+(a.bytes!=null?` ${a.bytes}B`:"");return n==="error"?console.error(r,a.detail):n==="warn"?console.warn(r,a.detail):console.log(r,a.detail),a}function Q(e){const t=Date.now();return{end:(n={},a="info")=>v(e,{...n,ms:Date.now()-t},a),fail:(n,a={})=>v(e,{...a,message:String(n?.message??n),ms:Date.now()-t},"error")}}function ae(){const e=rt()??{};let t=null;try{t=typeof document<"u"?!!document.hidden:null}catch{}const n=xe.slice(-80),a={};for(const r of n)a[r.stage]=(a[r.stage]??0)+1;return{ok:!0,version:at,now:Date.now(),last_stage:Xt,focus_stage:Nn,last_error:Zt,job_ctx:Yt||null,env:{has_nativeFetch:typeof e.nativeFetch=="function",has_getLocalPluginStorage:typeof e.getLocalPluginStorage=="function",has_pluginStorage:!!e.pluginStorage?.getItem,has_DecompressionStream:typeof DecompressionStream=="function",has_AbortController:typeof AbortController<"u",document_hidden:t},counts:{events:xe.length,...Ca?.()??{}},by_stage:a,errors:xe.filter(r=>r.level==="error").slice(-20),events:n}}function En(){return xe.length=0,Zt=null,Xt="cleared",!0}function ze(e,t,n){const a=t?.error?.message,r=new Error(n??a??`HTTP ${e}`);return r.status=e,r.data=t,r}var Pa=e=>e instanceof Error&&typeof e.status=="number",V=(e,t="error")=>({error:{code:t,message:e}}),Ue=e=>new Promise(t=>setTimeout(t,e)),$n=class{tail=Promise.resolve();run(e){const t=this.tail.then(e,e);return this.tail=t.then(()=>{},()=>{}),t}},St=32768,js=2e5;function re(e){return e?e instanceof Uint8Array?e:new Uint8Array(e):new Uint8Array(0)}function it(e){const t=re(e);let n="";for(let a=0;a<t.length;a+=St)n+=String.fromCharCode(...t.subarray(a,a+St));return btoa(n)}async function Je(e){const t=re(e);if(t.length<js)return it(t);let n="";for(let a=0;a<t.length;a+=St)n+=String.fromCharCode(...t.subarray(a,a+St)),a>0&&a%(St*24)===0&&await Ue(0);return btoa(n)}function Cs(e){return e?it(e):""}async function Ts(e){return e?Je(e):""}function Ee(e){const t=atob(e),n=new Uint8Array(t.length);for(let a=0;a<t.length;a+=1)n[a]=t.charCodeAt(a);return n}function Ls(e){return e?Ee(e).buffer:null}function Y(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}function Mt(e,t){const n=new Uint8Array(t);let a=0;for(const r of e)n.set(r,a),a+=r.length;return n}function At(e){return!!(e&&e.length>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)}function jn(e){return!!(e&&e.length>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70&&e[8]===87&&e[9]===69&&e[10]===66&&e[11]===80)}function Nt(e){const t=re(e);return jn(t)?"image/webp":At(t)?"image/png":t.length>=3&&t[0]===255&&t[1]===216&&t[2]===255?"image/jpeg":"image/png"}function Ps(e){const t=/^data:([^;,]+)?(;base64)?,(.*)$/i.exec(String(e||""));if(!t)return null;const n=!!t[2],a=t[3]||"";try{return Y(n?Ee(a):new TextEncoder().encode(decodeURIComponent(a)))}catch{return null}}function u(e,t=2e5){if(e==null)return"";let n=String(e).replace(/\x00/g," ").replace(/\r\n/g,`
`);return n=n.replace(/[ \t\f\v]+/g," ").replace(/\n{4,}/g,`


`).trim(),n.slice(0,t)}function j(e,t=-1){if(e==null||typeof e=="string"&&!e.trim())return t;const n=parseInt(String(e),10);return Number.isNaN(n)?t:n}function tn(e){if(e==null||typeof e=="string"&&!e.trim())return null;const t=parseFloat(String(e));return Number.isNaN(t)?null:t}function C(...e){const t=[],n=new Set;for(const a of e)for(const r of u(a).split(",")){const s=r.trim();if(!s)continue;const i=s.toLowerCase();i==="null"||i==="none"||n.has(i)||(n.add(i),t.push(s))}return t.join(", ")}var U=e=>u(e,200).toLowerCase().replace(/\s+/g," "),ot=e=>u(e).toLowerCase().replace(/\s+/g,"");function J(e){if(e==null)return[];let t;if(Array.isArray(e))t=e.map(r=>u(r,200));else{const r=u(e,2e3);t=r?r.split(/[,|/]|,(?=\s)|、|\//):[],t.length<=1&&r&&(t=r.split(/\n+/))}const n=[],a=new Set;for(const r of t){const s=u(r,200);if(!s)continue;const i=U(s);!i||a.has(i)||(a.add(i),n.push(s))}return n}function Os(e){let t=0;for(let n=0;n<e.length;n+=1)t=Math.imul(31,t)+e.charCodeAt(n)|0;return t}function Bs(e){const t=u(e,1e6);let n=2166136261,a=2654435769;for(let r=0;r<t.length;r+=1){const s=t.charCodeAt(r);n^=s,n=Math.imul(n,16777619),a^=s+(n<<6|n>>>26),a=Math.imul(a,2246822507)}return`${(n>>>0).toString(16).padStart(8,"0")}${(a>>>0).toString(16).padStart(8,"0")}`}function Rs(e){const t=u(e??"",200);return t?`risu_${Bs(`${t}|__unified__`)}`:""}function nn(e){let t=e;for(let n=0;n<20;n+=1){const a=t.replace(/\{\{#when[\s\S]*?\}\}([\s\S]*?)\{\{\/when\}\}/g,"$1").replace(/\{\{#if[\s\S]*?\}\}([\s\S]*?)\{\{\/if\}\}/g,"$1").replace(/\{\{:else\}\}[\s\S]*?(?=\{\{\/)/g,"");if(a===t)break;t=a}return t.replace(/\{\{[^}]+\}\}/g,"").trim()}function Ds(e){const t=e.match(/\[Positive\]\s*([\s\S]*?)\s*\[Negative\]/),n=e.match(/\[Negative\]\s*([\s\S]*?)\s*$/);return t||n?[u(t?.[1]??""),u(n?.[1]??"")]:[u(e),""]}function Ke(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}var He=4e3,Vu="",Yu=0,Zu="",Fs=[],zs="indexeddb:getLocalPluginStorage",Us="indexeddb:inx_nximg_*",Js="embedded",Ks={backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",notes:"PNG/settings live on this device (not save-file). Folder explorer reads card+location metadata."},Hs=JSON.parse(`{"power":true,"execute":"auto","mode":"illustration","image_min":3,"image_max":3,"character_max":2,"preset":1,"lorebook":true,"lore_extra":"tags","char_info":true,"user_info":true,"char_appearance":true,"preprocessing":false,"person_tag_mode":"gender","auto_person_tags":true,"original_text":"","custom_pos":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","custom_neg":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth","presets":[{"id":"프리셋_닭장_0_14izz","name":"프리셋 1","positive":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","negative":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth"},{"id":"프리셋_농후_1_u4veg","name":"프리셋 2","positive":"2.0::artist:duoyuanjun::, artist:dawalixi, artist:m (1n910), 1.45::artist:murata yuusuke::, 1.4::artist:konya karasue::, 1.5::artist:wanke::, 2.3::artist:lunch(shin new)::, 0.8::artist:baffu::, 1.4::artist:ishigaki takashi::, 0.8::artist:xipa::, 0.8::artist:freng::, 0.5::artist:kim eb::, year 2025, year 2024, 0.5::3d, blender::, high detail, masterpiece, best quality, very aesthetic, highres, best illustration, novel illustration, -3::simple illustration::, -1::censored::, -3::artist collaboration::, detailed background, -1::door::","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration"},{"id":"프리셋_매끈_2_jgrz3","name":"프리셋 3","positive":"2.4::artist:uki_(ukikusaya) ::, 0.6::artist:sohn woohyoung::, 0.6::artist:minamoto (mutton) ::, artist:sakura no tomoru hi e, 0.5::artist:bettkan::, 0.4::artist:nanja::, 0.4::artist:joy boy \\\\(jerrydurd\\\\) ::, artist:freng, 0.2::artist:murata yuusuke::, 0.8::artist:mx2j::, artist:aoi nagisa (metalder), 0.2::artist:oda non::, 0.4::artist:lunch_(shin new) ::, 0.6::artist:duoyuanjun::, year 2025, year 2024, year 2023, solo artist, -5.3::artist collaboration::, -1::faux retro artstyle::, -1::film grain::, -1::clean text::, -1::flat color::, 1.2::3d::, blender(medium), 1.3::realistic::, natural, incredibly absurdres, very aesthetic, highres, masterpiece, best quality, amazing quality, -3::simple illustration::, best illustration, novel illustration, 0.06::best::, -1::ring::, 1.5::uncensored::, -2::censored::, -2::bar censor::, 2::shiny realistic skin::, 1.3::steaming body::,","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, character sheet, reference sheet, lineup, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration,"},{"id":"프리셋_닭_3_8yiw2","name":"프리셋 2-1","positive":"1.5::artist:sohn woohyoung::, 1.6::artist:solipsist::, 1.45::artist:gogalking::, 1.2::artist:oda non::, 1.25::artist:henriiku_(ahemaru) ::, 1.6::artist:Ask (Askzy) ::, 2.7::artist:jagercoke::, 2::artist:seven (sixplusone) ::, artist:wlop, 1.25::artist:wanke::, artist:seoyong, 0.7::artist:healthyman::, artist:freng, 1.2::artist:sos adult::, artist:shinjiro, 2::artist:nianbingzi::, artist:teshima nari, year 2024, year 2025, 2::blender (medium) ::, 2::pastel (medium) ::, -2::flat color::, pastel colors, 1.4::masterpiece, very aesthetic::, best quality, amazing quality, absurdres, 2::realistic::, -6::artist collaboration::, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, no text, -1.1::pubic hair::, uncensored,","negative":"natsuki karin, text, logo, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, sketch"},{"id":"프리셋_말랑_4_ian7o","name":"프리셋 말랑","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_깔_5_3rh46","name":"프리셋 깔","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_쫀_6_815h6","name":"프리셋 쫀","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::, 1.4::bedroom::, 1.2::sunlight::, 2.9::hotel::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"},{"id":"프리셋_리얼_7_xwn4c","name":"프리셋 리얼","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"}],"active_preset_id":"프리셋_닭장_0_14izz","include_min":0,"include_max":0,"userchat":false,"gallery_fab":false,"floating_viewer":true,"overlay_markers":true,"llm_anchor_percent":true,"natural_base":"short","inline_previews":true,"inline_thumb_pct":100,"scale_semantics_version":2,"mobile_toggle_pin":false,"hover_preview":true,"hover_preview_anchor":"mouse","hover_preview_corner":"top-right","viewer_minimize_mode":"icon","unified_chat_priority":false,"overlay_hide_offscreen":true,"scroll_message_track":true,"click_message_track":true,"message_select_gesture":"single","text_drag_select":true,"show_risu_settings_button":true,"debug_panel":false,"generate_all_roles":false,"auto_gen_on_reply":false,"scroll_delay_ms":250,"capture_delay_ms":10,"overlay_x_pct":38,"overlay_y_pct":80,"overlay_pin_unit":"pct","overlay_pin_origin":"bl"}`),qs={source:"custom",provider:"openrouter",endpoint:"https://openrouter.ai/api/v1/chat/completions",model:"openai/gpt-oss-20b:nitro",api_key:"",service_account_json:"",temperature:.4,max_tokens:8e3,timeout_seconds:180,reasoning_effort:"default",vertex_region:"us-central1",anthropic_version:"2023-06-01"},Gs={provider:"Novel AI",backend:"nai",request_url:"https://image.novelai.net/ai/generate-image",api_key:"",model:"nai-diffusion-4-5-full",width:832,height:1216,sampler:"k_euler_ancestral",scheduler:"karras",steps:28,cfg_scale:7,cfg_rescale:.36,seed:0,variety_plus:!1,enable_i2i:!1,image_reference:"none",image_reference_strength:.6,image_reference_fidelity:1,image_reference_type:"character&style",vibe_transfer:"none",vibe_transfer_strength:.6,vibe_transfer_information_extracted:1,uc_preset:"human_focus",apply_quality_tags:!1,comfy_url:"http://localhost:8188",comfy_workflow_json:"",backend_timeout_seconds:300},Ws={bind_host:"",port:0,auth_token:"",allowed_origins:Fs,database_path:zs,images_dir:Us,prompts_dir:Js,storage:Ks,card:Hs,llm:qs,nai:Gs},Vs="nai-diffusion-4-full",Ys="nai-diffusion-4-curated-preview",Zs="nai-diffusion-3",Xs={"naid4.5f":"nai-diffusion-4-5-full","naid4.5c":"nai-diffusion-4-5-curated",naid4f:Vs,naid4c:Ys,naid3:Zs},Xu="",Qs="Tag the chat message into Danbooru-style English image prompts. Output ONE JSON object only.",ei='{"scenes":[{"place":"...","shots":[{"paragraph":0,"camera":"...","situation":"...","characters":[{"name":"...","action":"..."}]}]}],"new_characters":[]}',ti=`Registered: {registered_block}
Incomplete: {incomplete_block}
Detected: {detected_block}`,ni="Use matched lorebook context:",ai="Character info:",ri="Summarize visual details from the message.",Qu="",si=`[Positive]
, masterpiece, best quality

[Negative]
lowres, bad quality, watermark`,ii={author_note:"",tagger:Qs,format:ei,appearance_inject:ti,lore_inject:ni,char_inject:ai,preprocess:ri,prefill:"",preset_1:si},oi=", no text, best quality, very aesthetic, absurdres",ci=", rating:general, amazing quality, very aesthetic, absurdres",li=", best quality, amazing quality, very aesthetic, absurdres",ui={"naid4.5f":", location, very aesthetic, masterpiece, no text","naid4.5c":", location, masterpiece, no text, -0.8::feet::, rating:general",naid4f:oi,naid4c:ci,naid3:li},di={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, multiple views, logo, too many watermarks",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing",none:""},fi={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, logo, dated, signature, multiple views, gigantic breasts",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing, logo, dated, signature",none:""},gi={heavy:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]",light:"lowres, jpeg artifacts, worst quality, watermark, blurry, very displeasing",human_focus:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract], bad anatomy, bad hands, @_@, mismatched pupils, heart-shaped pupils, glowing eyes",none:""},mi={"naid4.5f":{heavy:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page",light:"lowres, artistic error, scan artifacts, worst quality, bad quality, jpeg artifacts, multiple views, very displeasing, too many watermarks, negative space, blank page",human_focus:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page, @_@, mismatched pupils, glowing eyes, bad anatomy",none:""},"naid4.5c":{heavy:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, negative space, blank page",light:"blurry, lowres, upscaled, artistic error, scan artifacts, jpeg artifacts, logo, too many watermarks, negative space, blank page",human_focus:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, bad anatomy, bad hands, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, @_@, mismatched pupils, glowing eyes, negative space, blank page",none:""},naid4f:di,naid4c:fi,naid3:gi},qe=Ws,hi=ii,an=ui,pi=mi,_i=1,yi="inlay-nexus-prompt-pack-v1",bi=()=>new TextEncoder,wi=()=>new TextDecoder;function vi(e,t){const n=bi().encode(t),a=new Uint8Array(e.length);for(let r=0;r<e.length;r+=1)a[r]=e[r]^n[r%n.length];return a}function xi(e){if(typeof Buffer<"u")return new Uint8Array(Buffer.from(e,"base64"));const t=atob(e),n=new Uint8Array(t.length);for(let a=0;a<t.length;a+=1)n[a]=t.charCodeAt(a);return n}function ki(e){if(!e||typeof e!="object")return{};const t=e;if(typeof t.__enc=="string"){if(Number(t.__v??1)!==_i)return{};try{const a=wi().decode(vi(xi(t.__enc),yi)),r=JSON.parse(a),s={};for(const[i,o]of Object.entries(r))typeof o=="string"&&(s[i]=o);return s}catch{return{}}}const n={};for(const[a,r]of Object.entries(t))typeof r=="string"&&(n[a]=r);return n}function Si(){return ki(globalThis.__INLAY_NATIVE_PROMPTS__)}function rn(e){const t=u(Si()[e]);return t||hi[e]||""}var Oa=e=>!!e&&typeof e=="object"&&!Array.isArray(e);function se(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e))}function $e(e,t){const n=se(e??{});for(const[a,r]of Object.entries(t??{})){const s=n[a];n[a]=Oa(r)&&Oa(s)?$e(s,r):r}return n}function Mi(e){const t=u(e).replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,""),n=t.slice(0,180).replace(/\s+/g," ");try{return JSON.parse(t)}catch{const a=t.match(/\{[\s\S]*\}/);if(!a)throw new Error(`태거 JSON 파싱 실패${n?` · 응답: ${n}`:" · 응답이 비어 있거나 JSON이 아님"}`);try{return JSON.parse(a[0])}catch(r){throw new Error(`태거 JSON 파싱 실패 · ${String(r?.message??r).slice(0,120)} · 응답: ${n}`)}}}var Ba=se(qe);function $(){return Ba}function Cn(e){Ba=e}var Ai=new $n,sn=new Map,ct=new Map,Tn=new Set,Ra="",Da="";function Fa(){return Ra}function Ln(e){Ra=e}function za(){return Da}function Pn(e){Da=e}var Ni=["necklace","earring","earrings","bracelet","ring","pendant","brooch","bag","backpack","purse","handbag","briefcase","suitcase","pouch","satchel","watch","wristwatch","wristband","badge","id card","lanyard","name badge","nameplate","glasses","sunglasses","goggles","monocle","crown","tiara","veil","sword","katana","knife","dagger","gun","pistol","rifle","spear","axe","staff","wand","blade","weapon","shield","crossbow","scythe","hammer","umbrella","phone","smartphone","book","clipboard","folder","cigarette","microphone","camera","holding","airpods","earbuds","earbud","earphones","earphone","headphones","headset","in one ear","wireless earbuds"],Ii=["shirt","blouse","pants","trousers","jeans","shorts","skirt","dress","jacket","coat","hoodie","sweater","cardigan","vest","waistcoat","uniform","armor","robe","cloak","cape","apron","overalls","leggings","stockings","tights","pantyhose","socks","thighhighs","boots","shoes","heels","sandals","slippers","footwear","barefoot","gloves","mittens","hat","cap","beret","hood","scarf","necktie","bowtie","tie","belt","bra","panties","underwear","lingerie","swimsuit","bikini","kimono","yukata","hakama","cheongsam","hanbok","suit","tuxedo","collar","choker","mask","helmet","nude","naked","topless","bottomless","completely nude","open shirt","unbuttoned","unzipped","torn clothes","clothes","clothing","outfit","attire","sleeves","rolled-up sleeves","long sleeves","short sleeves","sleeveless","off shoulder","bare shoulders","midriff","navel","cleavage","garter","corset","bodysuit","leotard","fishnets","ribbon","bow","bandana","no shirt","no pants","shirt lift","panties pull","skirt lift"],q=e=>String(e??"").trim().replace(/\s+/g," "),lt=e=>q(e).normalize("NFKC").toLocaleLowerCase().replace(/[\s_.·•･-]+/g,"");function je(e){const t=Array.isArray(e)?e:String(e??"").split(/[,/\n]/),n=[],a=new Set;for(const r of t){const s=q(r),i=lt(s);!s||a.has(i)||(a.add(i),n.push(s))}return n}function Ei(e){const t=q(e).split(" ").filter(Boolean);return t.length!==2||!t.every(n=>/^[A-Za-z'-]+$/.test(n))||!t.every(n=>n===n.toUpperCase())?{surname:"",given_name:""}:{surname:t[0],given_name:t[1]}}function pe(e={}){const t=q(e.name),n=Ei(t);return{...e,id:q(e.id)||t,name:t,aliases:je(e.aliases),surname:q(e.surname)||n.surname,given_name:q(e.given_name)||n.given_name,surname_variants:je(e.surname_variants),given_name_variants:je(e.given_name_variants),priority:Number.isFinite(Number(e.priority))?Number(e.priority):0,attire_locked:e.attire_locked===!0,accessories_locked:e.accessories_locked===!0,schema_version:2}}function on(e,t,n){const a=pe(e);return new Set(je([a[t],...a[n]||[]]).map(lt).filter(Boolean))}function Ua(e,t){const n=pe(e),a=pe(t),r=on(n,"surname","surname_variants"),s=on(a,"surname","surname_variants"),i=on(n,"given_name","given_name_variants"),o=on(a,"given_name","given_name_variants");if(!r.size||!s.size||!i.size||!o.size)return!1;const c=[...r].some(d=>s.has(d)),l=[...i].some(d=>o.has(d));return c&&l}function Ja(e,t){if(!e||!t)return!1;const n=pe(e),a=pe(t);if(n.id&&a.id&&String(n.id)===String(a.id)||Ua(n,a))return!0;const r=On(n),s=On(a);for(const i of r)if(s.has(i))return!0;return!1}function On(e){const t=pe(e),n=new Set,a=o=>{const c=lt(o);c&&n.add(c)};a(t.name);const r=new Set(je([t.surname,...t.surname_variants]).map(lt));for(const o of t.aliases)r.has(lt(o))||a(o);const s=je([t.surname,...t.surname_variants]),i=je([t.given_name,...t.given_name_variants]);for(const o of s)for(const c of i)a(`${o} ${c}`),a(`${o}${c}`),a(`${c} ${o}`);return n}function $i(e,t=[]){const n=lt(e);if(!n)return null;const a=t.map(r=>pe(r)).filter(r=>On(r).has(n));return a.length!==1?null:a[0]}function ji(e,t){const n=Number(t.priority||0)-Number(e.priority||0);if(n)return n;const a=Number(e.created_at||e.updated_at||0)-Number(t.created_at||t.updated_at||0);return a||String(e.id).localeCompare(String(t.id))}function Bn(...e){return je(e.flat())}function Ci(e){const t=[...e].sort(ji),n={...t[0]};n.aliases=Bn(...t.map(a=>[a.name,...a.aliases||[]])),n.surname_variants=Bn(...t.map(a=>[a.surname,...a.surname_variants||[]])),n.given_name_variants=Bn(...t.map(a=>[a.given_name,...a.given_name_variants||[]])),n.surname||(n.surname=t.map(a=>a.surname).find(Boolean)||""),n.given_name||(n.given_name=t.map(a=>a.given_name).find(Boolean)||"");for(const a of t){const r=q(a.appearance||""),s=q(a.attire||""),i=q(a.accessories||""),o=q(a.original||"");r.length>q(n.appearance||"").length&&(n.appearance=r),!n.attire_locked&&s.length>q(n.attire||"").length&&(n.attire=s),!n.accessories_locked&&i.length>q(n.accessories||"").length&&(n.accessories=i),o&&!q(n.original||"")&&(n.original=o)}return n.surname=q(n.surname)||t.map(a=>q(a.surname)).find(Boolean)||"",n.given_name=q(n.given_name)||t.map(a=>q(a.given_name)).find(Boolean)||"",n}function Ti(e=[]){const t=e.map(r=>pe(r)),n=[],a=new Set;for(let r=0;r<t.length;r++){if(a.has(r))continue;const s=[t[r]];a.add(r);for(let i=r+1;i<t.length;i++)a.has(i)||s.some(o=>Ua(o,t[i]))&&(a.add(i),s.push(t[i]));n.push(s)}return{records:t,active:n.map(Ci),groups:n}}function It(e){const t=pe(e||{}),n=J([t.name,...t.aliases||[]]),a=J([t.surname,...t.surname_variants||[]]),r=J([t.given_name,...t.given_name_variants||[]]);for(const s of a)for(const i of r)n.push(`${s} ${i}`,`${s}${i}`,`${i} ${s}`);return J(n).filter(s=>!a.some(i=>U(i)===U(s)))}function ie(e,t){return $i(e,t||[])}function Rn(e,t,n=6){const a=Math.max(1,Math.min(6,Number(n)||6)),r=[],s=new Set,i=(o,c)=>{if(!o||!c)return o;for(const l of["action","expression","attire","accessories","appearance","label","age","body","sex","original","original_tag","negative"]){const d=u(o[l]||"",2e3),g=u(c[l]||"",2e3);g&&(d?d.toLowerCase().includes(g.toLowerCase())||(o[l]=C(d,g)):o[l]=g)}return o};for(const o of e||[]){if(!o||typeof o!="object")continue;const c=u(o.name,200);if(!c)continue;const l=ie(c,t),d=l?`id:${u(l.id||l.name,200)}`:`name:${U(c)}`;if(!d||d==="id:"||d==="name:")continue;const g=r.findIndex(p=>p._dedupeKey===d);if(g>=0){i(r[g],o);continue}r.length>=a||(s.add(d),r.push({...o,name:l?.name||c,_dedupeKey:d}))}return r.map(({_dedupeKey:o,...c})=>c)}function Dn(e){const t=new Set;for(const a of It(e)){const r=U(a);r&&t.add(r)}const n=U(e?.name);return n&&t.add(n),t}function Fn(e){return Ti(e||[]).active}function Li(e,t){const n=u(e).toLowerCase(),a=ot(e);if(!n)return[];const r=[],s=new Set;for(const i of t||[]){const o=u(i.id||i.name,200);if(!(!o||s.has(o)))for(const c of It(i)){const l=U(c),d=ot(c);if(!(d.length<2)&&(n.includes(l)||a.includes(d))){r.push(i),s.add(o);break}}}return r}function ut(e,t=""){if(typeof e!="object"||e===null)return null;const n=e,a=u(n.name||t,200);if(!a)return null;let r=J(n.aliases);r=[a,...r.filter(g=>U(g)!==U(a))];const s=u(n.original||n.original_tag||n.copyright||"",400);let i=u(n.appearance||"",4e3),o=u(n.attire||"",4e3),c=u(n.accessories||"",4e3);const l=u(n.tags||"",4e3);if(l&&!i&&!o&&!c)[i,o,c]=ee(l);else if(l){const[g,p,f]=ee(C(i,l));i=g,o=C(o,p),c=C(c,f)}if(i){const[g,p,f]=ee(i);i=g,o=C(o,p),c=C(c,f)}s&&i&&(i=C(...i.split(",").filter(g=>U(g)!==U(s))));let d=u(n.id,80)||a.replace(/[^a-zA-Z0-9_\uac00-\ud7a3]+/g,"_").replace(/^_|_$/g,"").slice(0,64);return d||(d=`char_${Math.abs(Os(a))%1e7}`),pe({...n,id:d,name:a,aliases:r,original:s,appearance:i,attire:o,accessories:c})}function Pi(e,t,n={}){const a=Array.isArray(e)?e:[],r=Array.isArray(t)?t:[],s=typeof n.hasAppearance=="function"?n.hasAppearance:()=>!1,i=typeof n.resolve=="function"?n.resolve:()=>null,o=typeof n.aliasKeys=="function"?n.aliasKeys:()=>new Set,c=typeof n.normalizeName=="function"?n.normalizeName:h=>String(h||"").trim().toLowerCase(),l=typeof n.fullTags=="function"?n.fullTags:()=>"",d=typeof n.clean=="function"?n.clean:h=>String(h||"").trim(),g=n.globalScope||"__global__",p=[],f=new Set;for(const h of a){if(!d(h?.name,200)||s(h))continue;const m=i(h.name,r);if(m&&s(m))continue;for(const _ of o(h))f.add(_);const y=c(h.name);y&&f.add(y)}for(const h of r){const m=i(h.name,a);if([...o(h)].some(S=>f.has(S)))continue;const y=!h.attire_locked&&d(m?.attire||"")?m?.attire||"":h.attire||"",_=!h.accessories_locked&&d(m?.accessories||"")?m?.accessories||"":h.accessories||"",k=y!==(h.attire||""),M=_!==(h.accessories||"");m&&(k||M)?p.push({...h,attire:y,accessories:_,aliases:h.aliases||m.aliases||[],tags:l({...h,attire:y,accessories:_}),scope:g}):p.push(h)}for(const h of a){const m=i(h.name,p);if(!(m&&s(h))){if(m&&!s(h)){if(s(m))continue;const y=p.findIndex(_=>i(h.name,[_]));y>=0?p[y]=h:p.push(h);continue}m||p.push(h)}}return p}var Oi=Ii,Bi=Ni,Ri=["off","girls","people","gender"],Di=/\b(?:\d+\+?)?girls?\b|\bwom(?:an|en)\b|\bfemale\b|\blady\b|\bladies\b|\bmilf\b|\bloli\b|\bmaiden\b/i,Fi=/\b(?:\d+\+?)?boys?\b|\bm(?:a|e)n\b|\bmale\b|\bguys?\b|\bgentleman\b|\botoko\b/i,Ka=/^\d+\+?(?:girls?|boys?|people|person)$/i,zi=e=>Ri.includes(e);function Ha(e){const t=u(e).toLowerCase();return t?Bi.some(n=>t.includes(n)):!1}function Ui(e){const t=u(e).toLowerCase();return!t||Ha(t)?!1:Oi.some(n=>t.includes(n))}function ee(e){const t=[],n=[],a=[];for(const r of u(e).split(",")){const s=r.trim();s&&(Ha(s)?a.push(s):Ui(s)?n.push(s):t.push(s))}return[C(...t),C(...n),C(...a)]}function Ji(e){const[t,n]=ee(e);return[t,n]}function Ge(e,t,n,a){const[r,s,i]=ee(C(e,t,n)),o=u(a);if(!o)return[r,s,i];const[c,l,d]=ee(o);return[C(r,c),l||(d?s:o),d||i]}function We(e,t,n,a){const[r,s,i]=ee(C(e,t,n)),o=u(a);if(!o)return[r,s,i];const[c,l,d]=ee(o);return[C(r,c),C(s,l),d||o]}function Ki(...e){const t=C(...e.filter(r=>r!=null).map(r=>u(r)));if(!t)return null;const n=(t.match(Di)||[]).length,a=(t.match(Fi)||[]).length;return n>a?"f":a>n?"m":null}function cn(e,t,n,a){return e<=0?"":e===1?t:e<=5?`${e}${n}`:a}function Hi(e,t){const n=[],a=cn(e,"1girl","girls","6+girls"),r=cn(t,"1boy","boys","6+boys");return a&&n.push(a),r&&n.push(r),n.join(", ")}function qi(e){const t=[];for(const n of u(e).split(",")){const a=n.trim();a&&(Ka.test(a)||t.push(a))}return C(...t)}function zn(e){const t=[],n=new Set;for(const a of u(e).split(",")){let r=a.trim();if(!r)continue;if(Ka.test(r)){const i=r.toLowerCase();if(i.includes("girl"))r="girl";else if(i.includes("boy"))r="boy";else continue}const s=r.toLowerCase();n.has(s)||(n.add(s),t.push(r))}return C(...t)}function qa(e,t=null){let n=e;if(n==null&&t!=null&&(n=t),n===!1)return"off";if(n===!0)return"gender";const a=u(n,40).toLowerCase();return["","auto","mixed","true","1","on"].includes(a)?"gender":["off","none","false","0","disable","disabled"].includes(a)?"off":["girl","all_girls","girls_only"].includes(a)?"girls":["person","persons"].includes(a)?"people":zi(a)?a:"gender"}function Gi(e,t,n="gender",a=null){const r=qa(n,a);if(r==="off")return"";const s=(e||[]).slice(0,6),i=s.length;if(i<=0)return"";if(r==="girls")return cn(i,"1girl","girls","6+girls");if(r==="people")return cn(i,"1person","people","6+people");let o=0,c=0;for(const l of s){const d=u(l.name,200),g=d?ie(d,t):null,p=Ki(g?.appearance,g?.attire,g?.accessories,l.sex,l.label,l.age,l.appearance,l.body,l.attire,l.accessories);p==="f"?o++:p==="m"&&c++}return Hi(o,c)}function Et(e){return C(e?.original||"",e?.appearance||"",e?.attire||"",e?.accessories||"")}function oe(e){if(typeof e!="object"||e===null)return!1;const t=e;let n=u(t.appearance||"",4e3);if(!n)return!1;const a=u(t.original||"",400);a&&(n=C(...n.split(",").filter(i=>U(i)!==U(a))));const[r]=Ji(n);if(n=u(r||"",4e3),!n)return!1;const s=new Set(["girl","boy","man","woman","male","female","1girl","1boy","2girls","2boys","solo","other"]);return n.split(",").map(i=>i.trim().toLowerCase()).filter(Boolean).filter(i=>!s.has(i)&&!/^\d+(girl|boy)s?$/.test(i)).length>0}function Wi(e,t){const n=oe(e),a=u(t?.original||t?.original_tag||"",400),r=u(e?.original||"",400);if(n){const s=u(t?.attire||"",4e3)||u(e?.attire||"",4e3),i=u(t?.accessories||"",4e3)||u(e?.accessories||"",4e3);return zn(C(r||a,e?.appearance,s,i,t?.expression,t?.action,t?.sex))}return zn(C(r?"":a,t?.label,t?.age,t?.appearance,t?.body,u(t?.attire||"",4e3)||u(e?.attire||"",4e3),u(t?.accessories||"",4e3)||u(e?.accessories||"",4e3),t?.expression,t?.action,t?.sex))}function Ce(e){const t=typeof e=="object"&&e?e:{},n=j(t.character_max??t.char_max??6,6);return Math.max(1,Math.min(6,n))}function Vi(e,t,n,a){let r=u(e);if(!r)return"";for(const o of a){const c=u(o);if(c)if(r.endsWith(c))r=r.slice(0,r.length-c.length).replace(/[,\s]+$/g,"");else{const l=r.lastIndexOf(c);l>=0&&(r=`${r.slice(0,l)}${r.slice(l+c.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}}const s=u(t);if(s)if(r.startsWith(s))r=r.slice(s.length).replace(/^[,\s]+/g,"");else{const o=r.indexOf(s);o>=0&&(r=`${r.slice(0,o)}${r.slice(o+s.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}const i=[...n].map(o=>u(o)).filter(Boolean).sort((o,c)=>c.length-o.length);for(const o of i){const c=r.indexOf(o);c<0||(r=`${r.slice(0,c)}${r.slice(c+o.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}return u(r)}function Yi(e){const t=u(e.setup),n=u(e.main);if(!n)return{lockedSetup:t,rebuildMain:!0};if(t&&t!==n)return{lockedSetup:t,rebuildMain:!0};const a=u(e.person);if(a||e.stylePositives&&e.stylePositives.length){const r=Vi(n,a,e.stylePositives||[],e.qualitySuffixes||[]);if(r&&r!==n)return{lockedSetup:r,rebuildMain:!0}}return{lockedSetup:"",rebuildMain:!1}}function Zi(e){if(!e||typeof e!="object")return[];const t=[],n=u(e.custom_pos);n&&t.push(n);const a=Array.isArray(e.presets)?e.presets:[];for(const r of a){if(!r||typeof r!="object")continue;const s=r,i=u(s.positive||s.pos);i&&t.push(i)}return t}async function Ga(e,t,n){const a=new Blob([e],{type:t});let r=null;if(typeof createImageBitmap=="function"?r=await createImageBitmap(a):n&&typeof document<"u"&&(r=await new Promise((o,c)=>{const l=new Image,d=URL.createObjectURL(a);l.onload=()=>{URL.revokeObjectURL(d),o(l)},l.onerror=()=>{URL.revokeObjectURL(d),c(new Error("image decode failed"))},l.src=d})),!r)return null;const s=r,i="naturalWidth"in s?{w:s.naturalWidth,h:s.naturalHeight}:{w:0,h:0};return{source:s,width:s.width||i.w||0,height:s.height||i.h||0,close:()=>{try{"close"in s&&s.close()}catch{}}}}function Wa(e,t,n,a){if(a&&typeof OffscreenCanvas<"u"){const r=new OffscreenCanvas(t,n),s=r.getContext("2d");return s?(s.drawImage(e.source,0,0,t,n),{kind:"offscreen",canvas:r}):null}if(typeof document<"u"){const r=document.createElement("canvas");r.width=t,r.height=n;const s=r.getContext("2d");return s?(s.drawImage(e.source,0,0,t,n),{kind:"dom",canvas:r}):null}return null}async function Xi(e,t=.8){const n=re(e);if(!n.length)return null;if(jn(n))return Y(n);const a=Nt(n);try{const r=await Ga(n,a,!0);if(!r)return null;if(!(r.width>0&&r.height>0))return r.close(),null;const s=Wa(r,r.width,r.height,!0);if(!s)return r.close(),null;let i;if(s.kind==="offscreen"){const c=await s.canvas.convertToBlob({type:"image/webp",quality:t});if(r.close(),!c||!c.size)return null;i=await c.arrayBuffer()}else i=Ps(s.canvas.toDataURL("image/webp",t)),r.close();if(!i)return null;const o=re(i);return!jn(o)||o.length>=n.length*.98?null:i}catch(r){return v("image.webp.encode.fail",{message:String(r?.message||r)},"warn"),null}}async function Qi(e){let t=re(e);if(!t.length)throw new Error("image is empty");const n=1536,a=12e5,r=Nt(t),s=t.length>a;try{const i=await Ga(t,r,!1);if(i&&(s||i.width>n||i.height>n)){const o=Math.min(1,n/Math.max(i.width,i.height,1)),c=Wa(i,Math.max(1,Math.round(i.width*o)),Math.max(1,Math.round(i.height*o)),!1);if(c?.kind==="dom"){const l=await new Promise(d=>{c.canvas.toBlob(d,"image/png")});if(l)return t=new Uint8Array(await l.arrayBuffer()),i.close(),{bytes:t,mime:"image/png",filename:"image.png"}}}i?.close()}catch(i){v("autotag.resize",{message:String(i?.message||i)},"warn")}return{bytes:t,mime:r,filename:`image.${r==="image/jpeg"?"jpg":r==="image/webp"?"webp":"png"}`}}var Va=e=>typeof e?.getItem=="function"&&typeof e?.setItem=="function",$t=null;async function ln(){return $t||($t=(async()=>{const e=rt();if(typeof e?.getLocalPluginStorage=="function")try{const n=Q("storage.open"),a=await e.getLocalPluginStorage();if(Va(a))return n.end({message:"idb/getLocalPluginStorage"}),{kind:"idb",api:a};n.end({message:"getLocalPluginStorage returned unusable api"},"warn")}catch(n){v("storage.open",{message:String(n?.message||n)},"error"),console.warn("[Inlay Nexus] getLocalPluginStorage failed",n?.message||n)}const t=e?.pluginStorage;if(Va(t))return v("storage.open",{message:"fallback pluginStorage (save-file)"},"warn"),console.warn("[Inlay Nexus] falling back to pluginStorage (save-file scoped)"),{kind:"plugin",api:t};throw v("storage.open",{message:"no storage API"},"error"),new Error("기기 로컬 IndexedDB 저장소(getLocalPluginStorage)를 사용할 수 없습니다.")})().catch(e=>{throw $t=null,e}),$t)}function eo(){return rt()?.pluginStorage??null}async function Ve(e,t){try{const{kind:n,api:a}=await ln(),r=await a.getItem(e);if(r!=null&&r!=="")return r;if(n==="idb"&&t){const s=eo();if(s?.getItem)try{const i=await s.getItem(t);if(i!=null&&i!=="")return await a.setItem(e,i),i}catch{}}return null}catch{return null}}function to(e){if(typeof e=="string")return e.length;try{return JSON.stringify(e).length}catch{return 0}}async function dt(e,t){const{kind:n,api:a}=await ln(),r=to(t),s=r>5e4?Q("storage.set.large"):null;try{return await a.setItem(e,t),s?s.end({message:e,bytes:r,kind:n,background:!0}):r>8e3&&v("storage.set",{message:e,bytes:r,kind:n,background:!0}),!0}catch(i){throw s?s.fail(i,{message:e,bytes:r,kind:n,background:!0}):v("storage.set",{message:`${e}: ${i?.message||i}`,bytes:r,kind:n,background:!0},"error"),i}}async function Te(e){try{const{api:t}=await ln();t?.removeItem&&await t.removeItem(e)}catch{}}var no=class{budgetChars;urls=new Map;pinned=new Set;bytes=0;constructor(e){this.budgetChars=e}get size(){return this.urls.size}get byteLength(){return this.bytes}get(e){const t=String(e||"");if(!t)return;const n=this.urls.get(t);if(n!==void 0)return this.urls.delete(t),this.urls.set(t,n),n}set(e,t){const n=String(e||"");if(!n||typeof t!="string"||!t)return;const a=this.urls.get(n);a!==void 0&&(this.bytes-=a.length),this.urls.delete(n),this.urls.set(n,t),this.bytes+=t.length,this.evict()}drop(e){const t=String(e||""),n=this.urls.get(t);n!==void 0&&(this.urls.delete(t),this.bytes-=n.length,this.pinned.delete(t))}pin(e){this.pinned.clear();for(const t of e){const n=String(t||"");if(!n)continue;this.pinned.add(n);const a=this.urls.get(n);a!==void 0&&(this.urls.delete(n),this.urls.set(n,a))}this.evict()}pinnedIds(){return[...this.pinned]}clear(){this.urls.clear(),this.pinned.clear(),this.bytes=0}evict(){if(!(this.bytes<=this.budgetChars))for(const[e,t]of this.urls){if(this.bytes<=this.budgetChars)break;this.pinned.has(e)||(this.urls.delete(e),this.bytes-=t.length)}}},ao=33554432,jt=new no(ao),L={meta:new Map,cards:new Map,characters:new Map,jobs:new Map,images:new Map},Ct=new Map;function Ya(e){const t=String(e.session_id??"");if(!t)return;let n=Ct.get(t);n||(n=new Set,Ct.set(t,n)),n.add(String(e.id))}function Za(e){if(!e)return;const t=String(e.session_id??""),n=t?Ct.get(t):void 0;n&&(n.delete(String(e.id)),n.size===0&&Ct.delete(t))}function Xa(e,t){if(e==="characters"){if(Array.isArray(t))return`${t[0]}	${t[1]}`;if(t&&typeof t=="object"){const n=t;return`${n.scope}	${n.id}`}}return String(t)}function ro(e,t){if(!t||typeof t!="object")return"";const n=t;return e==="meta"?String(n.key||""):e==="characters"?`${n.scope}	${n.id}`:String(n.id||"")}var so=25,un=new Set,ft=null,Un=Promise.resolve(),le=Promise.resolve(),io=!1;function oo(e){if(!e||typeof e!="object")return e;const t={...e};if(!t.result_json)return t;try{const n=JSON.parse(t.result_json);if(!n||typeof n!="object")return t;const a={...n};delete a.tagged,delete a.appearance,delete a.debug_tail,Array.isArray(a.cards)&&(a.cards=a.cards.map(r=>{if(!r||typeof r!="object")return r;const s={...r};return typeof s.image_url=="string"&&s.image_url.startsWith("data:")&&(s.image_url=""),s})),t.result_json=JSON.stringify(a)}catch{}return t}function co(e){const t={};if(e==="images"){for(const[n,a]of L.images)t[n]={id:a.id,location:a.location||null,has_png:a.has_png,png_bytes:a.png_bytes,storage:"indexeddb",storage_key:ve(n)};return t}for(const[n,a]of L[e]){const r=a;if(e==="meta"&&r?.key==="reference_image"){t[n]={key:"reference_image",has_png:!!r.png,updated_at:r.updated_at||0};continue}if(e==="meta"&&r?.key==="vibe_transfer"){t[n]={key:"vibe_transfer",has_png:!!r.png,has_encoded:!!r.encoded,model:r.model||"",information_extracted:r.information_extracted??1,updated_at:r.updated_at||0};continue}if(e==="jobs"){t[n]=oo(r);continue}t[n]=a}return t}async function lo(e){await dt(ja(e),co(e))}function Qa(){ft=null;const e=[...un];un.clear(),e.length&&(Un=Un.then(async()=>{for(const t of e){if(io){v("storage.persist.skip",{message:t,background:!0});continue}try{await lo(t)}catch(n){console.warn("[Inlay Nexus] persist failed",t,n?.message||n)}}}).catch(()=>{}))}function gt(e){un.add(e),!ft&&(ft=setTimeout(Qa,so))}async function er(){ft&&(clearTimeout(ft),Qa()),await Un,await le}function uo(){const e=globalThis.document;if(!e?.addEventListener)return;const t=()=>{!ft&&!un.size||er()};e.addEventListener("visibilitychange",()=>{e.visibilityState==="hidden"&&t()}),globalThis.addEventListener?.("pagehide",t)}uo();var tr=100663296,mt=0;function fo(e,t){L.images.delete(e),L.images.set(e,t)}function nr(e){if(mt+=e,!(mt<=tr))for(const t of L.images.values()){if(mt<=tr)break;!t.png||!t.durable||(mt-=t.png.byteLength,t.png=null,t.hydrated=!1)}}var Jn=new Map,Kn=e=>typeof e=="string"&&e?Ls(e):null;async function go(e,t){if(t.hydrated)return t.png;const n=Jn.get(e);if(n)return n;const a=(async()=>{const r=Kn(await Ve(ve(e),ws(e)));return t.png=r,t.hydrated=!0,t.durable=!0,r?(t.png_bytes=r.byteLength,nr(r.byteLength)):(t.has_png=!1,t.png_bytes=0),r})().finally(()=>Jn.delete(e));return Jn.set(e,a),a}var Tt=null;async function Le(){return Tt||(Tt=(async()=>{for(const e of Ss){const t=await Ve(ja(e),bs(e));if(t==null||t==="")continue;let n=t;if(typeof t=="string")try{n=JSON.parse(t)}catch{continue}if(!(!n||typeof n!="object"))for(const[a,r]of Object.entries(n)){const s=r??{};if(e==="images"){const i=!!s.has_png;L.images.set(a,{id:String(s.id||a),location:s.location||{},png:null,has_png:i,png_bytes:Number(s.png_bytes)||0,hydrated:!i,durable:!0})}else if(e==="meta"&&(s.key==="reference_image"||a==="reference_image")){const i=Kn(await Ve(qt,vs));L.meta.set("reference_image",{key:"reference_image",png:i})}else if(e==="meta"&&(s.key==="vibe_transfer"||a==="vibe_transfer")){const i=Kn(await Ve(Gt));let o=await Ve(Wt);if(typeof o=="string")try{o=JSON.parse(o)}catch{o=null}const c=o??{};L.meta.set("vibe_transfer",{key:"vibe_transfer",png:i,encoded:c.encoded||"",model:c.model||s.model||"",information_extracted:c.information_extracted??s.information_extracted??1})}else if(e==="cards"){const i=s;L.cards.set(a,i),Ya(i)}else L[e].set(a,s)}}return!0})().catch(e=>{throw Tt=null,e}),Tt)}async function R(e,t){await Le();const n=Xa(e,t);if(e==="images"){const r=L.images.get(n);return r?(r.hydrated?r.png&&fo(n,r):await go(n,r),r):void 0}const a=L[e].get(n);return a??void 0}async function mo(e){await Le();const t=L.images.get(String(e));if(t)return{has_png:t.has_png,png_bytes:t.png_bytes}}async function F(e,t,n={}){await Le();const a=ro(e,t);if(!a)throw new Error(`invalid ${e} key`);const r=n.persist!==!1;if(e==="images"){const s=t.png||null,i=L.images.get(a);i?.png&&(mt-=i.png.byteLength);const o={id:String(t.id),location:t.location||{},...typeof t.mime=="string"&&t.mime?{mime:t.mime}:{},png:s,has_png:!!s,png_bytes:s?s.byteLength:0,hydrated:!0,durable:!s};return L.images.set(a,o),s?(nr(s.byteLength),le=le.then(async()=>{const c=await Je(new Uint8Array(s));await dt(ve(a),c),L.images.get(a)===o&&(o.durable=!0)}).catch(c=>console.warn("[Inlay Nexus] image persist failed",a,c?.message||c))):le=le.then(()=>Te(ve(a))).catch(()=>{}),r&&gt("images"),a}if(e==="meta"&&t.key==="reference_image"){const s=t.png||null;return L.meta.set("reference_image",{key:"reference_image",png:s}),s?le=le.then(async()=>{await dt(qt,await Je(new Uint8Array(s)))}).catch(i=>console.warn("[Inlay Nexus] ref persist failed",i?.message||i)):le=le.then(()=>Te(qt)).catch(()=>{}),r&&gt("meta"),"reference_image"}if(e==="meta"&&t.key==="vibe_transfer"){const s={key:"vibe_transfer",png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return L.meta.set("vibe_transfer",s),le=le.then(async()=>{s.png?await dt(Gt,await Je(new Uint8Array(s.png))):await Te(Gt),s.encoded?await dt(Wt,{encoded:s.encoded,model:s.model,information_extracted:s.information_extracted}):await Te(Wt)}).catch(i=>console.warn("[Inlay Nexus] vibe persist failed",i?.message||i)),r&&gt("meta"),"vibe_transfer"}if(e==="cards"){Za(L.cards.get(a));const s=t;return L.cards.set(a,s),Ya(s),r&&gt("cards"),a}return L[e].set(a,t),r&&gt(e),a}async function ht(e,t){await Le();const n=Xa(e,t);if(e==="cards"&&Za(L.cards.get(n)),e==="images"){const a=L.images.get(n);a?.png&&(mt-=a.png.byteLength)}return L[e].delete(n),e==="images"&&await Te(ve(n)),e==="meta"&&n==="reference_image"&&await Te(qt),e==="meta"&&n==="vibe_transfer"&&(await Te(Gt),await Te(Wt)),gt(e),e==="images"&&rr(n),!0}async function ue(e){return await Le(),[...L[e].values()]}async function ar(e){await Le();const t=Ct.get(String(e));if(!t)return[];const n=[];for(const a of t){const r=L.cards.get(a);r&&n.push(r)}return n}function Lt(e){return L[e].size}function ho(){let e=0;for(const t of L.images.values())e+=t.png_bytes;return e}function po(){const e=[];for(const t of L.images.values())e.push(t.location||{});return e}async function _o(e){await Le();const t=L.images.get(String(e))?.location;return t&&typeof t=="object"?t:{}}function Pt(e){return jt.get(String(e))}function yo(e,t){jt.set(String(e),t)}function rr(e){jt.drop(String(e))}function bo(e){jt.pin(e)}function wo(){return jt.size}async function vo(e){return(await R("images",String(e)))?.png??null}async function pt(e){if(!e)return"";const t=Pt(e);if(t!==void 0)return t;const n=Q("image.data_url"),a=await R("images",e);if(!a?.png)return n.end({message:`missing png ${e}`,id:e,background:!0},"warn"),"";const r=typeof a.mime=="string"&&a.mime||Nt(a.png),s=`data:${r};base64,${await Ts(a.png)}`;return yo(e,s),n.end({message:e,bytes:a.png.byteLength||0,mime:r,url_len:s.length,focus:!0}),s}function _e(e){const t=typeof e=="string"?e:e?.id;return t&&Pt(String(t))||""}async function Hn(e,t,n=null){const a=Q("image.publish");rr(e);let r=t,s=Nt(t);try{const o=await Xi(t,.8);o&&(r=o,s="image/webp")}catch(o){v("image.webp",{message:String(o?.message||o),id:e},"warn")}await F("images",{id:e,png:r,mime:s,location:n||{}});let i="";try{const o=pt(e);i=await Promise.race([o,Ue(5e3).then(()=>_e(e)||"")]),i||(v("image.data_url.defer",{message:e,bytes:r?.byteLength||0,mime:s,focus:!0},"warn"),o.catch(c=>console.warn("[Inlay Nexus] deferred data URL failed",c?.message||c)))}catch(o){v("image.data_url",{message:String(o?.message||o),id:e},"warn"),Promise.resolve().then(()=>pt(e)).catch(()=>{})}return a.end({message:e,bytes:r?.byteLength||0,src_bytes:t?.byteLength||0,mime:s,has_url:!!i,has_location:!!(n&&Object.keys(n).length),focus:!0}),i}var qn=2,_t=new Set,ce=[],ke=0,ye=0,Se=0,sr=null;function xo(){const e=ce.length+ke,t=Math.max(ye,Se+e),n=Math.min(Se,t),a=t>0?Math.max(0,Math.min(100,Math.round(n/t*100))):0;return{pending:e,active:ke,done:n,total:t,pct:a,busy:e>0}}function ko(e){sr=typeof e=="function"?e:null}function Ye(){try{sr?.()}catch{}}function Gn(){for(;ke<qn&&ce.length;){const e=ce.shift();ke+=1,Ye(),pt(e).catch(()=>{}).finally(()=>{ke-=1,_t.delete(e),Se+=1,ce.length===0&&ke===0&&(ye=0,Se=0),Ye(),Gn()})}}function So(e){const t=String(e||"");!t||Pt(t)!==void 0||_t.has(t)||(_t.add(t),ce.push(t),ye+=1,Ye(),Gn())}function Mo(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];if(bo(t),!t.length)return;const n=new Set(t),a=ce.length,r=[];for(const c of ce)n.has(c)?r.push(c):_t.delete(c);ce.length=0;const s=[];for(const c of t)Pt(c)===void 0&&(_t.has(c)||(_t.add(c),ye+=1),s.includes(c)||s.push(c));const i=r.filter(c=>!s.includes(c));ce.push(...s,...i);const o=a-r.length;o>0&&(ye=Math.max(Se+ce.length+ke,ye-o)),Ye(),Gn()}async function Ao(e=[],{concurrency:t=qn}={}){const n=[...new Set((e||[]).map(String).filter(Boolean))],a=Math.max(1,Number(t)||qn),r=n.filter(s=>Pt(s)===void 0);r.length&&(ye+=r.length,Ye());for(let s=0;s<r.length;s+=a){const i=r.slice(s,s+a);await Promise.all(i.map(o=>pt(o).catch(()=>"").finally(()=>{Se+=1,ce.length===0&&ke===0&&Se>=ye&&(ye=0,Se=0),Ye()})))}return ce.length===0&&ke===0&&(ye=0,Se=0,Ye()),n.map(s=>_e(s)).filter(Boolean)}async function Pe(e,t={}){if(!e||typeof e!="object")return e;if(Array.isArray(e)){for(let a=0;a<e.length;a+=1)e[a]=await Pe(e[a],t);return e}const n=e;if(typeof n.id=="string"&&(typeof n.image_url=="string"||n.image_path!=null||"shot_index"in n||"main_prompt"in n)){const a=String(n.id),r=t.ids!=null?new Set([...t.ids].map(String)):null;if(!t.cachedOnly&&(!r||r.has(a))){const s=await pt(a);s&&(n.image_url=s)}else n.image_url=_e(a)||"",n.image_url||So(a);return e}for(const a of Object.keys(n))n[a]&&typeof n[a]=="object"&&(n[a]=await Pe(n[a],t));return e}function dn(e){return e?`data:${Nt(e)};base64,${Cs(e)}`:""}var Oe=(e,t)=>!!e&&Object.prototype.hasOwnProperty.call(e,t),fn=e=>e?[...e]:[],Wn=e=>e;async function Z(e){return(await ue("characters")).filter(t=>t.scope===u(e,200)).sort((t,n)=>(t.name||"").localeCompare(n.name||"",void 0,{sensitivity:"base"})).map(t=>{let n=t.aliases;if(typeof n=="string")try{n=JSON.parse(n)}catch{n=J(n)}const a={id:t.id,name:t.name,aliases:Array.isArray(n)?n:J(n),surname:t.surname||"",given_name:t.given_name||"",surname_variants:J(t.surname_variants),given_name_variants:J(t.given_name_variants),priority:Number(t.priority||0),attire_locked:t.attire_locked===!0,accessories_locked:t.accessories_locked===!0,schema_version:Number(t.schema_version||1),original:t.original||"",appearance:t.appearance||"",attire:t.attire||"",accessories:t.accessories||"",updated_at:t.updated_at,scope:t.scope};return a.tags=Et(a),a})}async function No(e){const t=u(e,200);return t?(await ue("meta")).filter(n=>n.key?.startsWith(`toggle:${t}:`)&&n.enabled===0).map(n=>u(n.global_key||n.key.split(":").slice(2).join(":"),200)).filter(Boolean):[]}async function Io(e,t){const n=u(e,200);if(!n)return{ok:!1,error:{code:"bad_request",message:"character_id required"}};const a=[],r=new Set;for(const o of t||[]){const c=u(o,200);!c||r.has(c)||(r.add(c),a.push(c))}const s=await ue("meta");for(const o of s)o.key?.startsWith(`toggle:${n}:`)&&await ht("meta",o.key);const i=Date.now()/1e3;for(const o of a)await F("meta",{key:`toggle:${n}:${o}`,character_id:n,global_key:o,enabled:0,updated_at:i});return{ok:!0,character_id:n,disabled_globals:a}}function ir(e){const t=[];for(const n of[e.id,e.name]){const a=u(n,200);if(!a)continue;t.push(a);const r=a.toLowerCase();r!==a&&t.push(r)}return[...new Set(t)]}function Vn(e,t){if(!t?.size)return!1;for(const n of ir(e))if(t.has(n))return!0;return!1}async function Yn(e){const t=await No(e);return new Set(t)}async function Eo(e){const t=await Yn(e),n={};for(const a of await Z(Ie)){const r=!Vn(a,t);for(const s of ir(a))n[s]=r;n[u(a.name,200)]=r}return n}async function $o(e=[]){const t=[],n=new Set;for(const a of e||[]){const r=u(a,200);!r||r==="__global__"||n.has(r)||(n.add(r),t.push(...await Z(r)))}return Wn(Fn(t))}async function Zn(e,t="",n="",a=[]){const r=!!$()?.card?.unified_chat_priority,s=(Array.isArray(a)?a:[]).map(d=>u(d,200)).filter(Boolean);let i;r&&s.length?i=await $o(s):i=await Z(u(e||"",200));const o=u(n||"",200),c=o?await Yn(o):new Set,l=(await Z(Ie)).filter(d=>!Vn(d,c));return Wn(Pi(i,l,{hasAppearance:oe,resolve:ie,aliasKeys:Dn,normalizeName:U,fullTags:Et,clean:u,globalScope:Ie}))}async function de(e,t){const n=Oe(t,"appearance"),a=Oe(t,"attire"),r=Oe(t,"accessories"),s=Oe(t,"original"),i=Oe(t,"surname"),o=Oe(t,"given_name"),c=Oe(t,"surname_variants"),l=Oe(t,"given_name_variants");let d=ut(t);if(!d)return null;const g=u(e,200)||"__global__",p=await Z(g),f=u(d.id,80),h=d,m=p.find(_=>f&&u(_.id,80)===f?!1:!!(ie(h.name,[_])||(h.aliases||[]).some(k=>ie(k,[_]))));if(m){const _=J([...m.aliases||[],...d.aliases||[],d.name,m.name]),k=u(d.appearance||"",4e3),M=u(d.attire||"",4e3),S=u(d.accessories||"",4e3),x=u(d.original||"",400),A=u(d.surname||"",200),w=u(d.given_name||"",200);if(d=ut({...m,...d,id:m.id,name:m.name||d.name,aliases:_,original:s?x:x||m.original||"",appearance:n?k:k||m.appearance||"",attire:m.attire_locked?m.attire||"":a?M:M||m.attire||"",accessories:m.accessories_locked?m.accessories||"":r?S:S||m.accessories||"",surname:i?A:A||m.surname||"",given_name:o?w:w||m.given_name||"",surname_variants:J(c?[...d.surname_variants||[],A]:[...m.surname_variants||[],...d.surname_variants||[],A,m.surname]),given_name_variants:J(l?[...d.given_name_variants||[],w]:[...m.given_name_variants||[],...d.given_name_variants||[],w,m.given_name]),attire_locked:m.attire_locked===!0||d.attire_locked===!0,accessories_locked:m.accessories_locked===!0||d.accessories_locked===!0,priority:Math.max(Number(m.priority||0),Number(d.priority||0))}),!d)return null}const y=Date.now()/1e3;if(await F("characters",{scope:g,id:d.id,name:d.name,aliases:d.aliases,surname:d.surname||"",given_name:d.given_name||"",surname_variants:d.surname_variants||[],given_name_variants:d.given_name_variants||[],priority:Number(d.priority||0),attire_locked:d.attire_locked===!0,accessories_locked:d.accessories_locked===!0,schema_version:2,appearance:d.appearance,attire:d.attire,accessories:d.accessories||"",original:d.original||"",updated_at:y}),g!=="__global__"){const _=`appearance:${g}`,k=(await R("meta",_))?.value||{},M=Et(d);M?k[d.name]=M:delete k[d.name],await F("meta",{key:_,value:k,updated_at:y})}else(a||r)&&await jo(d,{clearAttire:a,clearAccessories:r});return d}async function jo(e,{clearAttire:t=!0,clearAccessories:n=!0}={}){if(!e||!t&&!n)return 0;const a=s=>!s||s.scope==="__global__"||oe(s)?!1:!!Ja(s,e);let r=0;try{const s=await ue("characters");for(const i of s||[]){if(!a(i))continue;const o=t?"":i.attire||"",c=n?"":i.accessories||"";(i.attire||"")===o&&(i.accessories||"")===c||(await F("characters",{...i,attire:o,accessories:c,updated_at:Date.now()/1e3}),r+=1)}}catch{}return r}async function Xn(e,t){const n=u(e,200)||"__global__",a=u(t,80);if(!a)return!1;const r=await R("characters",{scope:n,id:a});if(await ht("characters",{scope:n,id:a}),n!=="__global__"&&r?.name){const s=`appearance:${n}`,i={...(await R("meta",s))?.value||{}};delete i[r.name],await F("meta",{key:s,value:i,updated_at:Date.now()/1e3})}return!0}var Co=(e,t)=>!!Ja(e,t);function or(e){return(Array.isArray(e)?e:[]).filter(t=>{if(!t||typeof t!="object")return!1;const n=t;return!!(n.id||n.name)})}async function To(e,t,n=""){const a=or(t);if(!a.length)return{deleted:0,sessions:0};const r=u(n,200),s=new Set;let i=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===r||l==="__global__"||s.has(l))continue;s.add(l);const d=await Z(l);let g=!1;for(const p of d)a.some(f=>Co(p,f))&&(await Xn(l,p.id),i+=1,g=!0);g&&(o+=1)}return{deleted:i,sessions:o}}async function cr(e,t,n=""){const a=or(t);if(!a.length)return{updated:0,sessions:0};const r=u(n,200),s=new Set;let i=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===r||l==="__global__"||s.has(l))continue;s.add(l);const d=await Z(l);let g=!1;for(const p of a){const f=ie(p.name,d)||(Array.isArray(p.aliases)?p.aliases.map(h=>ie(h,d)).find(Boolean):null)||(u(p.id,80)?d.find(h=>u(h.id,80)===u(p.id,80)):null);f&&await de(l,{...p,id:f.id,name:f.name||p.name,appearance:p.appearance!=null?p.appearance:"",attire:p.attire!=null?p.attire:"",accessories:p.accessories!=null?p.accessories:"",original:p.original!=null?p.original:""})&&(i+=1,g=!0)}g&&(o+=1)}return{updated:i,sessions:o}}async function Ot(e,t,n={}){const a=u(e,200)||"__global__",r=n.prune===!0,s=Array.isArray(n.rootSessionIds)?n.rootSessionIds:[],i=Fn(t||[]);if(s.length){if(r){const c=new Set;for(const l of i){for(const g of Dn(l))c.add(g);const d=U(l.name);d&&c.add(d)}for(const l of s){const d=u(l,200);if(!(!d||d==="__global__"))for(const g of await Z(d)){const p=[...Dn(g)],f=U(g.name);f&&p.push(f),!p.some(h=>c.has(h))&&await Xn(d,g.id)}}}return i.length&&await cr(s,i,""),Wn(i.map(c=>ut(c)).filter(c=>!!c))}const o=[];for(const c of i){const l=await de(a,c);l&&o.push(l)}if(r){const c=new Set(o.map(l=>u(l.id,80)).filter(Boolean));for(const l of await Z(a)){const d=u(l.id,80);d&&!c.has(d)&&await Xn(a,d)}}return o}async function Bt(e,t=""){const n=u(e,200),a=u(t,200),r=n?await Z(n):[],s=a?await Yn(a):new Set,i=[];for(const o of await Z(Ie)){const c={...o};c.enabled_for_character=a?!Vn(o,s):!0,i.push(c)}return{ok:!0,session_id:n,character_id:a,characters:r,global:i,appearance:Object.fromEntries(r.map(o=>[o.name,Et(o)])),disabled_globals:[...s].sort(),global_enabled:a?await Eo(a):{}}}async function lr(e,t,n=!0){const a=u(e,200);if(!a)return{ok:!1,error:{code:"bad_request",message:"target_session_id required"}};const r=[],s=new Set;for(const c of t||[]){const l=u(c,200);!l||s.has(l)||(s.add(l),r.push(...await Z(l)))}n&&!s.has(a)&&r.push(...await Z(a));const i=Fn(r),o=[];for(const c of i){const l=ie(c.name,await Z(a)),d=await de(a,{...c,id:l?.id||c.id,priority:Math.max(Number(l?.priority||0),Number(c.priority||0))});d&&o.push(d)}return{...await Bt(a),ok:!0,merged:o.length,sources:[...s]}}async function Lo(e){return Object.fromEntries((await Z(e)).map(t=>[t.name,Et(t)]))}async function Po(e,t){return await Ot(e,Object.entries(t||{}).map(([n,a])=>({name:n,tags:a}))),{ok:!0,appearance:await Lo(e)}}async function Oo(e){const{sessionId:t,tagged:n,shotChars:a}=e,r=e.unifiedSessionId??"",s=e.sourceSessionIds??[],i=u(e.characterId||"",200),o=u(t||"",200),c=()=>Zn(t,r,i,s);let l=await c();const d=[...n.new_characters||[]],g=new Set(d.map(f=>U(f?.name))),p=(f,h=null)=>({surname:u(f?.surname||h?.surname||"",200),given_name:u(f?.given_name||h?.given_name||"",200),surname_variants:J([...fn(h?.surname_variants),...fn(f?.surname_variants),f?.surname,h?.surname]),given_name_variants:J([...fn(h?.given_name_variants),...fn(f?.given_name_variants),f?.given_name,h?.given_name])});for(const f of a||[]){const h=u(f.name,200);if(!h||g.has(U(h)))continue;const m=ie(h,l);m&&oe(m)||(d.push({name:m?.name||h,aliases:J(f.aliases)||m?.aliases||[h],original:u(f.original||f.original_tag||m?.original||"",400),appearance:C(f.label,f.age,f.appearance,f.body),attire:u(f.attire||m?.attire||""),accessories:u(f.accessories||m?.accessories||""),...p(f,m)}),g.add(U(h)))}typeof n=="object"&&(n.new_characters=d);for(const f of d){const h=ut(f);if(!h)continue;const m=ie(h.name,l),y=u(h.appearance||""),_=u(h.attire||""),k=u(h.accessories||""),M=p(h,m);if(m?.scope==="__global__"&&oe(m)){l=await c();continue}if(m&&!oe(m)){const S=m.scope==="__global__"?Ie:m.scope||o,x=J([...m.aliases||[],...h.aliases||[]]);let A=y||m.appearance||"",w=m.attire||"",I=m.accessories||"";const P=m.original||h.original||"";!m.attire_locked&&_?[A,w,I]=Ge(A,w,I,_):!m.attire_locked&&h.attire&&([A,w,I]=Ge(A,w,I,h.attire)),!m.accessories_locked&&k?[A,w,I]=We(A,w,I,k):!m.accessories_locked&&h.accessories&&([A,w,I]=We(A,w,I,h.accessories)),await de(S,{id:m.id||h.id,name:m.name||h.name,aliases:x.length?x:m.aliases||h.aliases,original:P,appearance:A,attire:w,accessories:I,attire_locked:m.attire_locked===!0,accessories_locked:m.accessories_locked===!0,...M}),l=await c();continue}if(m&&m.scope!=="__global__"){const S=J([...m.aliases||[],...h.aliases||[]]);let x=m.appearance||h.appearance||"",A=m.attire||"",w=m.accessories||"",I=m.original||h.original||"";h.appearance&&!m.appearance&&(x=h.appearance),h.original&&!m.original&&(I=h.original);const P=oe(m);!P&&!m.attire_locked&&h.attire&&([x,A,w]=Ge(x,A,w,h.attire)),!P&&!m.accessories_locked&&h.accessories&&([x,A,w]=We(x,A,w,h.accessories)),await de(o,{id:m.id||h.id,name:m.name||h.name,aliases:S,original:I,appearance:x,attire:A,accessories:w,attire_locked:m.attire_locked===!0,accessories_locked:m.accessories_locked===!0,...M})}else m||await de(o,h);l=await c()}for(const f of a||[]){const h=u(f.name,200);if(!h)continue;const m=ie(h,l),y=u(f.attire||""),_=u(f.accessories||""),k=u(f.appearance||"");if(m&&oe(m)){l=await c();continue}if(m?.scope==="__global__"){const M=!m.attire_locked,S=!m.accessories_locked;if(!M&&!S){l=await c();continue}let x=m.attire||"",A=m.accessories||"",w=m.appearance||"",I=!1;if(M&&y)[w,x,A]=Ge(w,x,A,y),I=!0;else if(M&&k){const[,P]=ee(k);P&&([w,x,A]=Ge(w,x,A,P),I=!0)}if(S&&_)[w,x,A]=We(w,x,A,_),I=!0;else if(S&&k){const[,,P]=ee(k);P&&([w,x,A]=We(w,x,A,P),I=!0)}if(!I){l=await c();continue}await de(o,{id:m.id,name:m.name,aliases:m.aliases,original:"",appearance:"",attire:x,accessories:A})}else if(m){let M=m.appearance||"",S=m.attire||"",x=m.accessories||"";const A=J([...m.aliases||[],...J(f.aliases)]);if(!m.attire_locked&&y)[M,S,x]=Ge(M,S,x,y);else if(!m.attire_locked&&k){const[,w]=ee(k);w&&([M,S,x]=Ge(M,S,x,w))}if(!m.accessories_locked&&_)[M,S,x]=We(M,S,x,_);else if(!m.accessories_locked&&k){const[,,w]=ee(k);w&&([M,S,x]=We(M,S,x,w))}await de(m.scope==="__global__"?Ie:m.scope||o,{id:m.id,name:m.name,aliases:A.length?A:m.aliases,original:m.original||u(f.original||"",400),appearance:M||m.appearance,attire:S,accessories:x,attire_locked:m.attire_locked===!0,accessories_locked:m.accessories_locked===!0})}else{const M=C(f.label,f.age,f.appearance||"",f.body||""),S=u(f.attire||""),x=u(f.accessories||""),[A,w,I]=ee(C(M,S,x));await de(o,{name:h,aliases:J(f.aliases)||[h],original:u(f.original||f.original_tag||"",400),appearance:A,attire:w,accessories:I})}l=await c()}return c()}async function Bo(){if((await ue("characters")).length)return;const e=(await ue("meta")).filter(t=>t.key?.startsWith("appearance:"));if(e.length)for(const t of e){const n=t.key.slice(11),a=t.value||{};for(const[r,s]of Object.entries(a)){const i=ut({name:r,tags:s},r);i&&await de(n,i)}}}async function Ro(){const e=await ue("characters");for(const t of e){if(Number(t.schema_version||0)>=2)continue;const n=ut(t);n&&await F("characters",{...t,...n,scope:t.scope,updated_at:t.updated_at||Date.now()/1e3})}}var Do=new Set(["off","short","detailed","supplement"]);function Qn(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e===!0||e==="true"||e==="on"?"short":e==="detailed"||e==="detail"?"detailed":e==="supplement"||e==="supp"?"supplement":typeof e=="string"&&Do.has(e)?e:"short"}var Fo=e=>JSON.parse(JSON.stringify(e??{})),zo=new Set(["api_key","auth_token","password","secret"]);function ea(e){if(Array.isArray(e))return e.map(ea);if(!e||typeof e!="object")return e;const t={};for(const[n,a]of Object.entries(e))zo.has(n.toLowerCase())||(t[n]=ea(a));return t}function ta(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Settings must be an object");const t=Fo(e),n=t.card&&typeof t.card=="object"&&!Array.isArray(t.card)?t.card:{};if(t.card=n,Number(n.scale_semantics_version||0)<2){const s=Number(n.inline_thumb_pct);n.inline_thumb_pct=Number.isFinite(s)?Math.max(1,s/6):100,n.scale_semantics_version=2}if(Number.isFinite(Number(n.overlay_x_pct))||Number.isFinite(Number(n.overlay_y_pct))||n.overlay_pin_unit==="pct"){n.overlay_pin_unit="pct";const s=String(n.overlay_pin_origin||"");(!s||s==="bottom-left")&&(n.overlay_pin_origin="bl")}const a=n.lore_extra;a===!0||a==="true"||a==="sections"?n.lore_extra="tags":a===!1||a==="false"||a==="none"?n.lore_extra="off":a==="full"||a==="tags"||a==="off"?n.lore_extra=a:n.lore_extra="tags",n.natural_base=Qn(n.natural_base);const r=n.overlay_markers!==!1;return n.overlay_markers=r,n.inline_previews=r,t.settings_schema_version=2,t}function Uo(e){return JSON.stringify(ea(ta(e)),null,2)}function Jo(e){if(typeof e!="string")throw new TypeError("Settings JSON must be text");if(e.length>2e6)throw new RangeError("Settings JSON is too large");const t=JSON.parse(e);if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Settings JSON must contain an object");return ta(t)}function ur(e){if(!e||e.length<22)return!1;const t=Math.max(0,e.length-65536);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const a=e[n+20]|e[n+21]<<8;if(n+22+a<=e.length)return!0}return!1}function Be(e,t){return e[t]|e[t+1]<<8}function yt(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function na(e){const t=Math.max(0,e.length-65536-22);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const a=Be(e,n+20);if(n+22+a<=e.length)return n}return-1}function Ko(e){const t=na(e);if(t<0)return null;const n=yt(e,t+16);if(n+46>e.length||e[n]!==80||e[n+1]!==75||e[n+2]!==1||e[n+3]!==2)return null;const a=Be(e,n+10),r=yt(e,n+20),s=yt(e,n+24),i=yt(e,n+42);if(i+30>e.length||e[i]!==80||e[i+1]!==75||e[i+2]!==3||e[i+3]!==4)return null;const o=Be(e,i+26),c=Be(e,i+28),l=i+30+o+c;return l+r>e.length?null:{source:"central_dir",compMethod:a,compSize:r,uncompSize:s,dataStart:l,compData:e.subarray(l,l+r)}}function Ho(e){const t=Be(e,6),n=Be(e,8);let a=yt(e,18);const r=Be(e,26),s=Be(e,28),i=30+r+s;if((t&8)!==0||a===0){let o=-1;for(let c=i+4;c<e.length-3;c+=1){if(e[c]!==80||e[c+1]!==75)continue;const l=e[c+2];if(l===7||l===1||l===5){o=c;break}}if(o<0){const c=na(e);c>i&&(o=c)}if(o<0)throw new Error("ZIP 데이터 경계를 찾지 못했습니다 (local header bit3)");a=o-i}if(i+a>e.length)throw new Error(`ZIP 엔트리 길이 초과 (need ${i+a}, have ${e.length})`);return{source:"local_header",compMethod:n,compSize:a,uncompSize:yt(e,22),dataStart:i,compData:e.subarray(i,i+a)}}async function qo(e){if(typeof DecompressionStream!="function")throw new Error("DecompressionStream 미지원 — ZIP deflate를 풀 수 없습니다");const t=re(e);v("nai.inflate.start",{message:`${t.length}B`,bytes:t.length,focus:!0});const n=new DecompressionStream("deflate-raw"),a=n.writable.getWriter(),r=n.readable.getReader(),s=[];let i=0;const o=Date.now()+2e4,c=(async()=>{for(;;){if(Date.now()>=o)throw new Error(`ZIP inflate 타임아웃 (out=${i}B)`);const{done:g,value:p}=await r.read();if(g)break;p&&(s.push(p),i+=p.length,i>0&&i%524288<p.length&&v("nai.inflate",{message:`out ${Math.round(i/1024)}KB`,bytes:i,focus:!0}))}})(),l=131072;for(let g=0;g<t.length;g+=l){if(Date.now()>=o){try{await a.abort()}catch{}throw new Error(`ZIP inflate write 타임아웃 (in=${g}B)`)}await a.write(t.subarray(g,Math.min(t.length,g+l))),g>0&&g%(l*4)===0&&await Ue(0)}await a.close(),await c;const d=Mt(s,i);return v("nai.inflate.done",{bytes:i,focus:!0}),d}async function Go(e){const t=re(e);if(v("nai.unzip.start",{message:`${t.length}B`,bytes:t.length,focus:!0}),At(t))return v("nai.unzip",{message:"raw PNG",bytes:t.length,focus:!0}),Y(t);if(t.length<30||t[0]!==80||t[1]!==75){const r=Array.from(t.subarray(0,16)).map(s=>s.toString(16).padStart(2,"0")).join(" ");throw new Error(`ZIP/PNG 응답이 아닙니다 (len=${t.length}, head=${r})`)}const n=Ko(t)??Ho(t);v("nai.unzip.entry",{message:`${n.source} method=${n.compMethod} comp=${n.compSize}B uncomp=${n.uncompSize||"?"}`,comp_method:n.compMethod,bytes:n.compSize,source:n.source,focus:!0});const a=na(t);if(a>=0&&n.dataStart+n.compSize>a&&(v("nai.unzip.clamp",{message:`comp ${n.compSize} → ${a-n.dataStart}`,focus:!0},"warn"),n.compSize=a-n.dataStart,n.compData=t.subarray(n.dataStart,a)),n.compSize<=0)throw new Error("ZIP 압축 페이로드가 비어 있습니다");if(n.compMethod===0)return Y(n.compData);if(n.compMethod===8){const r=await qo(n.compData);return!At(r)&&!(r[0]===82&&r[1]===73)&&v("nai.unzip",{message:"inflated but not PNG/RIFF magic",bytes:r.length},"warn"),Y(r)}throw new Error(`지원하지 않는 ZIP 압축 방식: ${n.compMethod}`)}var fe=0,aa=0,ra=0,ge=null,dr=!1,fr=()=>fe,Wo=()=>aa,Vo=()=>ra,Yo=()=>ge!==null;function Zo(e="force"){return ge?(ge.forceFinish(e),!0):!1}async function Re(e,t={}){const n=rt()?.nativeFetch,a=n||globalThis.fetch,r=n?"nativeFetch":"fetch";if(typeof a!="function")throw new Error("fetch를 사용할 수 없습니다");const s={...t};s.networkRoute==null&&delete s.networkRoute;const i=Q("net.fetch");v("net.fetch.start",{message:r,url:String(e).slice(0,120),has_signal:!!s.signal});try{const o=await a(e,s),c=Number(o?.status||(o?.ok===!1?0:200));return i.end({message:r,status:c,url:String(e).slice(0,80)}),o}catch(o){throw i.fail(o,{message:r,url:String(e).slice(0,80)}),o}}async function bt(e,t={}){if(!e)throw new Error("빈 응답");const n=Number(t.deadline||Date.now()+Number(t.timeoutMs||9e4)),a=t.signal||null,r=typeof t.onProgress=="function"?t.onProgress:null,s=Number(t.idleMs||2500),i=(g=0)=>{if(a?.aborted)throw new Error(`NAI 본문 읽기 중단 (abort, ${g}B)`);if(Date.now()>=n)throw new Error(`NAI 본문 읽기 타임아웃 (${g}B received)`)};if(e instanceof ArrayBuffer)return e;if(e instanceof Uint8Array)return Y(e);if(typeof e=="string"){const g=e.replace(/\s+/g,"");if(g.length>64&&/^[A-Za-z0-9+/=]+$/.test(g))return v("nai.read_bytes",{message:"string base64 body",bytes:g.length,focus:!0}),Y(Ee(g))}const o=e;if(o.buffer instanceof ArrayBuffer&&typeof o.byteLength=="number")return o.buffer.slice(o.byteOffset||0,(o.byteOffset||0)+o.byteLength);const c=e;if(e&&typeof e=="object"&&"data"in e&&!c.arrayBuffer&&!c.body)return bt(c.data,t);let l=null;try{const g=c.headers,p=g?.get?.("content-length")||g?.get?.("Content-Length")||null;p&&(l=Number(p))}catch{}if(l!=null&&l>0&&(aa=l),v("nai.read_bytes.start",{message:"begin body",content_length:l,has_arrayBuffer:typeof c.arrayBuffer=="function",has_body_reader:!!(c.body&&typeof c.body.getReader=="function"),keys:e&&typeof e=="object"?Object.keys(e).slice(0,12).join(","):typeof e,focus:!0}),c.body&&typeof c.body.getReader=="function"){const g=c.body.getReader(),p=[];let f=0,h=Date.now(),m=Date.now(),y=!1,_=null;ge={forceFinish:(M="force")=>{y=!0,v("nai.read_bytes.force",{message:M,bytes:f||l||0,focus:!0});try{g.cancel()}catch{}_&&_({done:!0,value:void 0,__forced:!0})}};try{for(;i(f),!y;){if(f>=64&&Date.now()-h>=s){v("nai.read_bytes.idle_complete",{message:`${s}ms idle`,bytes:f,focus:!0});break}if(l!=null&&l>0&&f>=l){v("nai.read_bytes.length_complete",{bytes:f,content_length:l,focus:!0});break}const M=await new Promise((w,I)=>{let P=!1;const E=(z,B)=>{P||(P=!0,clearInterval(O),_=null,B?I(B):w(z))};_=z=>E(z,null);const O=setInterval(()=>{if(!P){if(y)return E({done:!0,value:void 0,__forced:!0},null);if(f>=64&&Date.now()-h>=s)return E({done:!0,value:void 0,__idle:!0},null);if(l!=null&&l>0&&f>=l)return E({done:!0,value:void 0,__length:!0},null);if(a?.aborted||Date.now()>=n)return g.cancel().catch(()=>{}),E(null,new Error(`NAI 본문 읽기 타임아웃 (${f}B received)`))}},200);g.read().then(z=>E(z,null),z=>E(null,z))});if(M?.__forced||M?.__idle||M?.__length)break;const{done:S,value:x}=M;if(S)break;if(!x)continue;const A=x instanceof Uint8Array?x:new Uint8Array(x);if(p.push(A),f+=A.length,h=Date.now(),ra=h,fe=f,r&&r(f,l),Date.now()-m>=2e3&&(m=Date.now(),v("nai.read_bytes.progress",{message:`${Math.round(f/1024)}KB`,bytes:f,content_length:l,focus:!0})),ur(Mt(p,f))&&Date.now()-h>=600){v("nai.read_bytes.zip_eocd",{bytes:f,focus:!0});break}if(l!=null&&l>0&&f>=l)break}}catch(M){if(f>=64){const S=Mt(p,f);if(ur(S)||l!=null&&l>0&&f>=l*.98)return v("nai.read_bytes.recover",{message:String(M?.message||M),bytes:f,focus:!0},"warn"),ge=null,Y(S)}try{await g.cancel()}catch{}throw ge=null,M}if(ge=null,!f)throw new Error("NAI 본문이 비어 있습니다");const k=Mt(p,f);return v("nai.read_bytes.done",{bytes:f,focus:!0}),Y(k)}const d=c.arrayBuffer;if(typeof d=="function"){v("nai.read_bytes",{message:"fallback arrayBuffer() — no body stream",focus:!0});let g=!1,p,f;const h=new Promise((_,k)=>{p=_,f=k});ge={forceFinish:(_="force")=>{v("nai.read_bytes.force",{message:`${_} (arrayBuffer)`,content_length:l,focus:!0},"warn"),g||(g=!0,clearInterval(m),f(new Error(`NAI arrayBuffer 강제중단 (${_}, content-length=${l})`)))}};const m=setInterval(()=>{g||(a?.aborted||Date.now()>=n?(g=!0,clearInterval(m),ge=null,f(new Error(`NAI arrayBuffer 타임아웃 (content-length=${l}). 본문 ~${l?Math.round(l/1024):"?"}KB를 플러그인이 받지 못했습니다.`))):v("nai.read_bytes.wait",{message:`arrayBuffer pending · expect ${l?Math.round(l/1024):"?"}KB`,content_length:l,focus:!0},"warn"))},3e3);d.call(c).then(_=>{g||(g=!0,clearInterval(m),ge=null,p(_))}).catch(_=>{g||(g=!0,clearInterval(m),ge=null,f(_))});const y=await h;if(y&&y.byteLength)return fe=y.byteLength,v("nai.read_bytes.done",{bytes:y.byteLength,focus:!0}),y}if(typeof c.bytes=="function"){const g=await c.bytes();if(g?.length)return Y(g)}if(typeof c.text=="function"){const g=await c.text();if(/^[A-Za-z0-9+/=\s]+$/.test(g)&&g.replace(/\s+/g,"").length>64)try{return Y(Ee(g.replace(/\s+/g,"")))}catch{}throw new Error(`바이너리 본문을 읽지 못함 (text head=${String(g).slice(0,120)})`)}throw new Error("바이너리 본문을 읽지 못함")}async function Xo(e,t,n,a={}){const r={Authorization:`Bearer ${e}`,"Content-Type":"application/json"},s=Number(a.timeoutMs||75e3),i=a.signal||null,o=JSON.stringify(t);if(v("nai.payload",{message:`body ${Math.round(o.length/1024)}KB`,bytes:o.length,model:t?.model,timeout_ms:s,url:String(n||"https://image.novelai.net/ai/generate-image").slice(0,100),has_nativeFetch:Vt("nativeFetch")}),o.length>15e5)throw v("nai.payload",{message:"too large",bytes:o.length},"error"),new Error(`NAI 페이로드가 너무 큼 (${Math.round(o.length/1024)}KB). 참조 이미지/프롬프트를 줄이세요.`);const c=typeof AbortController<"u"?new AbortController:null,l=()=>{v("nai.abort",{message:"external signal"},"warn"),c?.abort()};if(i){if(i.aborted)throw new Error("NAI 요청이 취소되었습니다.");i.addEventListener("abort",l,{once:!0})}const d=Date.now();fe=0,aa=0,ra=0,dr=!0;const g=setInterval(()=>{const f=Date.now()-d;f>=s?(v("nai.watchdog",{message:`abort after ${f}ms · body=${fe}B`,ms:f,bytes:fe},"warn"),c?.abort()):f>0&&f%1e4<1100&&v("nai.wait",{message:`waiting ${Math.round(f/1e3)}s · body=${fe}B · ${st()}`,ms:f,bytes:fe,focus:!0},"warn")},1e3);let p=null;try{try{v("nai.fetch.start",{message:"POST generate-image",timeout_ms:s,focus:!0});const f=await Re(n||"https://image.novelai.net/ai/generate-image",{method:"POST",headers:r,body:o,signal:c?.signal,requestTimeoutMs:s});if(v("nai.fetch.returned",{message:"nativeFetch resolved",ms:Date.now()-d,status:Number(f?.status||0),focus:!0}),i?.aborted||c?.signal?.aborted)throw v("nai.fetch.aborted",{ms:Date.now()-d},"error"),new Error(`NAI 타임아웃 (${Math.round(s/1e3)}s) — nativeFetch가 응답하지 않습니다. Models에서 NAI Test를 확인하세요.`);const h={signal:c?.signal,deadline:d+s,onProgress:k=>{fe=k}};if(f&&typeof f=="object"&&"ok"in f&&"data"in f&&!f.arrayBuffer){const k=Number(f.status||(f.ok?200:0));if(v("nai.resp.shape",{message:"ok/data shape",status:k,focus:!0}),k===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(k===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(k>=400){const x=typeof f.data=="string"?f.data:f.data instanceof Uint8Array?new TextDecoder().decode(f.data.subarray(0,220)):JSON.stringify(f.data||{}).slice(0,220);throw new Error(`NAI HTTP ${k}: ${x}`)}const M=Q("nai.read_bytes"),S=await bt(f.data,h);if(M.end({bytes:S?.byteLength||0,focus:!0}),!S||S.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${S?.byteLength||0} bytes)`);return S}const m=Number(f?.status||0);if(v("nai.resp.shape",{message:"Response-like",status:m,has_arrayBuffer:typeof f?.arrayBuffer=="function",has_body:!!f?.body,focus:!0}),m===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(m===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(m>=400){let k="";try{k=await f.text()}catch{}throw new Error(`NAI HTTP ${m}: ${k.slice(0,220)}`)}const y=Q("nai.read_bytes"),_=await bt(f,h);if(y.end({bytes:_?.byteLength||0,status:m,focus:!0}),!_||_.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${_?.byteLength||0} bytes)`);return _}catch(f){throw p=String(f?.message||f),v("nai.fetch.error",{message:p,ms:Date.now()-d,bytes:fe},"error"),/abort|timeout|타임아웃|취소|본문 읽기/i.test(p)?new Error(`NAI 타임아웃/본문실패 (${Math.round(s/1e3)}s, body=${fe}B). ${p.slice(0,180)}`):f instanceof Error?f:new Error(p)}}finally{dr=!1,clearInterval(g),i&&i.removeEventListener("abort",l)}}var Qo=new $n;function Rt(e){return u(e?.backend||"nai").toLowerCase()==="comfy"?"comfy":"nai"}function ec(e){const t=Number(e?.backend_timeout_seconds??300);return Math.max(30,Math.min(1800,Number.isNaN(t)?300:t))*1e3}function gn(e){return String(e||"").trim().replace(/\/+$/,"")}function gr(e){return gn(u(e?.comfy_url))||"http://localhost:8188"}function sa(e){return!!u(e?.comfy_workflow_json)}async function ia(e,t={}){const n=await Re(e,t);if(n&&typeof n=="object"&&"ok"in n&&"data"in n&&typeof n.arrayBuffer!="function"){const s=Number(n.status||(n.ok?200:0));let i=n.data;if(i instanceof Uint8Array&&(i=new TextDecoder().decode(i)),typeof i=="string")try{i=JSON.parse(i)}catch{}return{status:s,data:i}}const a=Number(n?.status||0);let r=null;try{r=await n.json()}catch{try{r=JSON.parse(await n.text())}catch{}}return{status:a,data:r}}async function tc(e,t,n={}){const a=`inlay-nexus-${Math.random().toString(36).slice(2,10)}`,{status:r,data:s}=await ia(`${gn(e)}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:a,prompt:t}),signal:n.signal});if(r>=400||!s?.prompt_id){const i=s?JSON.stringify(s.node_errors||s.error||s).slice(0,300):"";throw new Error(`/prompt 제출 실패 (HTTP ${r}) ${i}`)}return String(s.prompt_id)}async function nc(e,t,n={}){const a=gn(e),r=Number(n.timeoutMs||3e5),s=Date.now()+r;let i=0,o="";for(;Date.now()<s;){if(n.signal?.aborted)throw new Error("이미지 대기 중단 (abort)");await Ue(2500),i+=1;let c=null;try{const{status:g,data:p}=await ia(`${a}/history/${t}`,{method:"GET",signal:n.signal});g<400&&p&&p[t]&&(c=p[t])}catch(g){o=String(g?.message||g);continue}if(i%8===0&&v("comfy.poll",{message:`${i}회 · ${Math.round((Date.now()-(s-r))/1e3)}s`,focus:!0}),!c)continue;const l=c.status||{};if(l.status_str==="error")throw new Error(`생성 실패: ${JSON.stringify(l.messages||[]).slice(0,400)}`);const d=c.outputs||{};for(const g of Object.keys(d)){const p=d[g]?.images;if(Array.isArray(p)&&p.length)return p.find(f=>(f?.type||"output")!=="temp")||p[0]}if(l.completed)throw new Error("생성은 완료됐지만 출력 이미지가 없습니다 (SaveImage 노드 확인)")}throw new Error(`이미지 대기 타임아웃 (${Math.round(r/1e3)}s)${o?` · ${o}`:""}`)}async function ac(e,t,n={}){const a=new URLSearchParams({filename:u(t?.filename,300),subfolder:u(t?.subfolder,300),type:u(t?.type,40)||"output"}),r=await Re(`${gn(e)}/view?${a.toString()}`,{method:"GET",signal:n.signal}),s={signal:n.signal,deadline:Date.now()+6e4};if(r&&typeof r=="object"&&"ok"in r&&"data"in r&&!r.arrayBuffer){const o=Number(r.status||(r.ok?200:0));if(o>=400)throw new Error(`/view 실패 (HTTP ${o})`);return bt(r.data,s)}const i=Number(r?.status||0);if(i>=400)throw new Error(`/view 실패 (HTTP ${i})`);return bt(r,s)}function rc(e,t){let n=String(e||"");for(let a=0;a<8;a+=1){const r=n.replace(/\[\[#(\w+)\]\]([\s\S]*?)\[\[\/\1\]\]/g,(s,i,o)=>{const c=t[i];return c!=null&&String(c).trim()!==""?o:""});if(r===n)break;n=r}return n.replace(/[ \t]+\n/g,`
`).replace(/\n{3,}/g,`

`)}function sc(e,t){for(const n of Object.values(e)){const a=n?.inputs;if(!(!a||typeof a!="object"))for(const r of Object.keys(a)){const s=a[r];if(typeof s!="string"||!s.includes("[["))continue;const i=rc(s,t),o=i.match(/^\[\[\s*(\w+)\s*\]\]$/);if(o&&o[1]in t){a[r]=t[o[1]];continue}a[r]=i.replace(/\[\[\s*(\w+)\s*\]\]/g,(c,l)=>l in t?String(t[l]):c)}}}function ic(e,t){const n=Number(t)||1;for(const a of Object.values(e)){const r=a?.inputs;if(!(!r||typeof r!="object"))for(const s of Object.keys(r)){if(!/^(seed|noise_seed)$/i.test(s))continue;const i=r[s];(typeof i=="number"&&Number.isFinite(i)||typeof i=="string"&&/^\d+$/.test(i.trim()))&&(r[s]=n)}}}function mr({main:e,neg:t,captions:n,nai:a,seed:r}){const s={pos:String(e||""),neg:String(t||""),width:Number(a.width??832)||832,height:Number(a.height??1216)||1216,seed:Number(r)||1,steps:Number(a.steps??28)||28,cfg:Number(a.cfg_scale??7)||7};for(let i=0;i<6;i+=1)s[`char${i+1}`]=u(n?.[i]?.prompt,2e3);return s}function oc(e){let t=String(e||"");return t=t.replace(/(:\s*)\[\[\s*(\w+)\s*\]\](\s*[,}\]])/g,'$1"[[$2]]"$3'),t}function hr(e,t){const n=u(e);if(!n)throw new Error("ComfyUI 워크플로 JSON이 비어 있습니다. Models 탭에 API Export JSON을 붙여넣으세요.");let a;const r=oc(n);try{a=JSON.parse(r)}catch(o){const c=/\[\[/.test(n)?' · 팁: [[seed]] 같은 값은 반드시 "[[seed]]"처럼 따옴표로 감싸세요.':"";throw new Error(`ComfyUI 워크플로 JSON 파싱 실패: ${String(o?.message||o).slice(0,120)}${c}`)}if(!a||typeof a!="object"||Array.isArray(a))throw new Error("ComfyUI 워크플로는 API 포맷(JSON 객체, 노드ID→노드)이어야 합니다.");let s=a;if(s.nodes&&s.links)throw new Error("UI 저장 포맷 워크플로입니다. ComfyUI에서 'Export (API)'로 내보낸 JSON을 넣으세요.");const i=JSON.stringify(s);if(!/\[\[\s*pos\s*\]\]/.test(i))throw new Error("워크플로에 [[pos]]가 없습니다. 긍정 프롬프트를 넣는 칸에 [[pos]]를 적어 주세요.");return s=JSON.parse(i),sc(s,t),ic(s,t.seed),s}async function cc(e,t,n,a){const r=gr(e),s=ec(e),i=Number(e.seed??0)||Math.floor(Math.random()*4294967295)||1,o=mr({main:t,neg:n,captions:a,nai:e,seed:i}),c=hr(e.comfy_workflow_json,o);return v("comfy.generate.start",{message:r,prompt_len:String(t||"").length,chars:(a||[]).length,nodes:Object.keys(c).length,focus:!0}),Qo.run(async()=>{const l=await tc(r,c);v("comfy.generate.submitted",{message:l.slice(0,8),focus:!0});const d=await nc(r,l,{timeoutMs:s}),g=await ac(r,d);if(v("comfy.generate.done",{bytes:g?.byteLength||0,focus:!0}),!g||g.byteLength<256)throw new Error(`ComfyUI 응답 이미지가 너무 짧음 (${g?.byteLength||0}B)`);return[g,i]})}var oa=Xs;function wt(e,t=!1){let n=oa[String(e).toLowerCase()]||e;return t&&(n+="-inpainting"),n}function lc(e){const t=[],n=[];for(const a of e.characters||[]){const r={x:a.center_x,y:a.center_y};t.push({char_caption:a.prompt,centers:[r]}),n.push({char_caption:a.uc||"",centers:[r]})}return{autoSmea:!0,prefer_brownian:!0,ucPreset:0,use_coords:!1,legacy_uc:!1,add_original_image:!0,v4_prompt:{caption:{base_caption:e.prompt,char_captions:t},use_coords:!1,use_order:!0},v4_negative_prompt:{caption:{base_caption:e.negative_prompt,char_captions:n},legacy_uc:!1}}}function uc(e){const t=wt(e.model),n={width:e.width,height:e.height,n_samples:1,seed:e.seed,extra_noise_seed:e.seed,sampler:e.sampler,steps:e.steps,scale:e.cfg_scale,negative_prompt:e.negative_prompt,cfg_rescale:e.cfg_rescale,noise_schedule:e.scheduler,params_version:3,legacy:!1,legacy_v3_extend:!1};if(e.var_plus?n.skip_cfg_above_sigma=t.includes("4-5")?58:19:n.skip_cfg_above_sigma=null,t.includes("nai-diffusion-4")&&Object.assign(n,lc(e)),e.vibes?.length&&(n.reference_image_multiple=e.vibes.map(a=>a.encoded),n.reference_strength_multiple=e.vibes.map(a=>a.strength),n.reference_information_extracted_multiple=e.vibes.map(a=>a.information_extracted),n.normalize_reference_strength_multiple=!0),e.character_refs?.length){if(!t.includes("4-5"))throw new Error("Character Reference는 NAID4.5 전용입니다");n.director_reference_images=e.character_refs.map(a=>it(a.image)),n.director_reference_strength_values=e.character_refs.map(a=>a.strength),n.director_reference_secondary_strength_values=e.character_refs.map(a=>1-a.fidelity),n.director_reference_descriptions=e.character_refs.map(a=>({caption:{base_caption:a.type,char_captions:[]},legacy_uc:!1})),n.director_reference_information_extracted=e.character_refs.map(()=>1),n.controlnet_strength=1,n.inpaintImg2ImgStrength=1,n.normalize_reference_strength_multiple=!0,delete n.skip_cfg_above_sigma}return n}function Ze(e){const t=u(e)||"nai-diffusion-4-5-full",n=Object.fromEntries(Object.entries(oa).map(([a,r])=>[r,a]));return oa[t]?t:n[t]?n[t]:"naid4.5f"}var dc=new $n;async function pr(e,t,n,a={}){const r={input:t.prompt,model:wt(t.model),action:"generate",parameters:uc(t)};return v("nai.generate.start",{message:r.model,prompt_len:String(t.prompt||"").length,chars:(t.characters||[]).length,has_char_refs:!!t.character_refs?.length,has_vibes:!!t.vibes?.length}),dc.run(async()=>{const s=await Xo(e,r,n,a),i=Q("nai.unzip");try{const o=await Go(new Uint8Array(s)),c=At(new Uint8Array(o));return i.end({bytes:o?.byteLength||0,is_png:c,zip_bytes:s?.byteLength||0}),c||v("nai.unzip",{message:"unzipped but not PNG magic",bytes:o?.byteLength||0},"warn"),{raw_bytes:o,seed:t.seed||0}}catch(o){throw i.fail(o,{zip_bytes:s?.byteLength||0}),o}})}async function fc(e){const t=await Re(ks,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),n=Number(t?.status||0);if(n===401)throw new Error("인증 실패 (401). API 토큰을 확인하세요.");if(n>=400)throw new Error(`Anlas 조회 실패: HTTP ${n}`);const a=await t.json(),r=a.trainingStepsLeft||{},s=r.fixedTrainingStepsLeft||0,i=r.purchasedTrainingSteps||0,o=a.perks?.unlimitedMaxPriority||!1;return{fixed:s,purchased:i,total:s+i,opus:o}}async function _r(e,t,n,a=1,r=3){const s=wt(n),i=Math.max(0,Math.min(1,Number(a)||1)),o={image:await Je(t),information_extracted:i,model:s};let c="";for(let l=1;l<=r;l++)try{v("nai.encode_vibe.start",{message:s,ie:i,attempt:l,focus:!0});const d=await Re(xs,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(o)}),g=Number(d?.status||0);if([502,503,504,520].includes(g)){c=`HTTP ${g}`,await Ue(2*l*1e3);continue}if(g<200||g>=300){let h="";try{h=typeof d?.text=="function"?await d.text():""}catch{}if(c=`HTTP ${g}: ${String(h).slice(0,200)}`,l<r){await Ue(1e3);continue}break}const p=await bt(d,{timeoutMs:6e4}),f=await Je(p);return v("nai.encode_vibe.done",{message:s,bytes:p?.byteLength||0,focus:!0}),f}catch(d){if(c=String(d?.message||d),l<r){await Ue(1e3);continue}}throw new Error(`encode-vibe 실패 (${r}회): ${c}`)}var gc=Ht({LLM_ENDPOINT_PRESETS:()=>Xe,LLM_PROVIDERS:()=>mc,REASONING_EFFORTS:()=>yr,applyReasoningToBody:()=>kr,defaultEndpointForProvider:()=>wr,endpointPresetKeyFor:()=>_c,ensureLlmRequestUrl:()=>xr,knownLlmEndpoints:()=>vr,llmModelPlaceholder:()=>pc,normalizeLlmProvider:()=>Qe,normalizeReasoningEffort:()=>br,shouldAutoReplaceEndpoint:()=>hc}),Xe=Object.freeze({openai:"https://api.openai.com/v1/chat/completions",openrouter:"https://openrouter.ai/api/v1/chat/completions",google_ai:"https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",lmstudio:"http://127.0.0.1:1234/v1/chat/completions",ollama:"http://127.0.0.1:11434/v1/chat/completions",anthropic:"https://api.anthropic.com/v1/messages",vertex:"https://us-central1-aiplatform.googleapis.com"}),yr=Object.freeze(["default","none","minimal","low","medium","high","xhigh","max"]),mc=Object.freeze([{value:"openrouter",label:"OpenRouter"},{value:"openai",label:"OpenAI"},{value:"google_ai",label:"Google AI Studio"},{value:"vertex",label:"Vertex AI (Google Cloud)"},{value:"anthropic_compatible",label:"Anthropic-compatible"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}]);function Qe(e){const t=String(e||"").toLowerCase().replace(/[ -]+/g,"_").trim();return["openrouter"].includes(t)?"openrouter":["openai"].includes(t)?"openai":["google","google_ai","google_ai_studio","gemini"].includes(t)?"google_ai":["vertex","vertex_ai","google_vertex"].includes(t)?"vertex":["anthropic","anthropic_compat","anthropic_compatible","claude"].includes(t)?"anthropic_compatible":["lmstudio","lm_studio"].includes(t)?"lmstudio":["ollama"].includes(t)?"ollama":["custom"].includes(t)?"custom":["openai_compatible","openai_compat"].includes(t)?"openrouter":"custom"}function br(e){const t=String(e??"default").toLowerCase().trim();return!t||t==="auto"||t==="default"?"default":yr.includes(t)?t:"default"}function wr(e,t={}){const n=Qe(e);return n==="vertex"?`https://${String(t.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1"}-aiplatform.googleapis.com`:n==="anthropic_compatible"?Xe.anthropic:n==="custom"?Xe.openai:Xe[n]||Xe.openai}function vr(){const e=new Set;for(const t of Object.values(Xe)){const n=String(t||"").replace(/\/+$/,"");n&&(e.add(n),e.add(n.replace(/\/chat\/completions$/i,"")),e.add(n.replace(/\/v1\/messages$/i,"")),e.add(n.replace(/\/v1$/i,"")))}return e.add("https://us-central1-aiplatform.googleapis.com"),e.add("https://europe-west1-aiplatform.googleapis.com"),e.add("https://asia-northeast1-aiplatform.googleapis.com"),e}function hc(e){const t=String(e||"").trim().replace(/\/+$/,"");return t?vr().has(t):!0}function xr(e,t,n={}){const a=Qe(t);let r=String(e||"").trim().replace(/\/+$/,"");if(r||(r=wr(a,n).replace(/\/+$/,"")),a==="anthropic_compatible")return/\/v1\/messages$/i.test(r)||/\/messages$/i.test(r)?r:/\/v1$/i.test(r)?`${r}/messages`:`${r}/v1/messages`;if(a==="vertex"){const s=String(n.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1",i=String(n.projectId||"").trim();if(i)return`https://${s}-aiplatform.googleapis.com/v1/projects/${encodeURIComponent(i)}/locations/${encodeURIComponent(s)}/endpoints/openapi/chat/completions`;if(/aiplatform\.googleapis\.com/i.test(r)&&!/\/chat\/completions$/i.test(r))return r}return/\/chat\/completions$/i.test(r)?r:/\/openai$/i.test(r)?`${r}/chat/completions`:/\/v1beta$/i.test(r)?`${r}/openai/chat/completions`:/\/v1$/i.test(r)?`${r}/chat/completions`:r}function kr(e,t){const n={};e&&typeof e=="object"&&Object.assign(n,e);const a=br(t);return a==="default"||(n.reasoning={effort:a}),n}function pc(e){const t=Qe(e),n={openrouter:"openai/gpt-4o-mini",openai:"gpt-4o-mini",google_ai:"gemini-2.5-flash",vertex:"gemini-2.0-flash-001",anthropic_compatible:"claude-sonnet-4",lmstudio:"local-model",ollama:"llama3.2",custom:"model-id"};return n[t]||n.custom}function _c(e){const t=String(e||"").trim().replace(/\/+$/,"");for(const[n,a]of Object.entries(Xe)){const r=a.replace(/\/+$/,"");if(t===r||t===r.replace(/\/chat\/completions$/i,"")||t===r.replace(/\/v1\/messages$/i,""))return n}return"custom"}var mn=e=>!!e&&typeof e.getReader=="function",ca=e=>typeof e=="object"?e?.text||"":String(e||"");function hn(e){const t=String(e||"").trim().toLowerCase();return t==="main"||t==="risu_main"||t==="risu-main"?"main":t==="aux"||t==="otherax"||t==="other_ax"||t==="risu_aux"||t==="risu-aux"||t==="sub"||t==="secondary"?"aux":"custom"}function yc(e){const t=hn(e);return t==="main"||t==="aux"}function Sr(e){const t=e||{};return yc(t.source)?!0:Qe(t.provider)==="vertex"?!!(u(t.model)&&(u(t.api_key)||u(t.service_account_json))):!!(u(t.model)&&u(t.api_key))}function bc(e){let t="";const n=[];for(const a of e||[]){const r=String(a?.role||""),s=a?.content;if(r==="system"){const i=typeof s=="string"?s:Array.isArray(s)?s.map(o=>typeof o=="object"?o.text||"":String(o)).join(""):String(s??"");t=t?`${t}
${i}`:i;continue}if(Array.isArray(s)){const i=[];for(const o of s){if(!o||typeof o!="object"){const g=String(o||"").trim();g&&i.push({type:"text",text:g});continue}const c=o.image_url,l=(typeof c=="object"&&c?c.url:"")||(typeof c=="string"?c:"");if(o.type==="image_url"||l){const g=String(l).match(/^data:([^;]+);base64,([\s\S]+)$/i);g&&i.push({type:"image",source:{type:"base64",media_type:g[1]||"image/png",data:g[2].replace(/\s+/g,"")}});continue}const d=String(o.text||"").trim();d&&i.push({type:"text",text:d})}n.push({role:r==="assistant"?"assistant":"user",content:i.length?i:[{type:"text",text:""}]});continue}n.push({role:r==="assistant"?"assistant":"user",content:String(s??"")})}return{system:t,messages:n}}function wc(e){const t=e?.choices||[];if(!t.length)throw new Error("LLM returned no choices.");let n=(t[0].message||{}).content;return Array.isArray(n)&&(n=n.map(ca).join("")),u(n)}function vc(e){const t=e?.content,n=(Array.isArray(t)?t:[]).map(ca).join(""),a=u(n||e?.completion||"");if(!a)throw new Error("Anthropic 응답이 비어 있습니다.");return a}async function pn(e){if(!mn(e))return"";const t=e.getReader(),n=typeof TextDecoder<"u"?new TextDecoder:null;let a="",r="";for(;;){const{done:s,value:i}=await t.read();if(s)break;if(typeof i=="string")a=i,r+=i;else if(i instanceof Uint8Array)r+=n?n.decode(i,{stream:!0}):"";else if(i&&typeof i=="object"){const o=i,c=o[0];typeof c=="string"?a=c:typeof o.content=="string"?a=o.content:typeof o.text=="string"&&(a=o.text)}}return n&&(r+=n.decode()),a||r}async function xc(e){if(typeof e=="string")return e;if(mn(e))return pn(e);if(e==null)return"";if(typeof e=="number"||typeof e=="boolean")return String(e);if(typeof e=="object"){const t=e,n=u(t.type,40).toLowerCase();if(n==="fail"||n==="error"){const r=u(t.result||t.message||t.error||"Risu LLM 실패",800);throw new Error(`Risu LLM 실패: ${r}`)}if(n==="streaming"||n==="stream"){const r=await pn(t.result??t.data??t.stream);if(r.trim())return r}if(n==="success"||n==="ok"){const r=t.result??t.data??t.content;if(typeof r=="string")return r;if(mn(r))return pn(r)}const a=[t.choices?.[0]?.message?.content,t.choices?.[0]?.text,t.choices?.[0]?.delta?.content,t.message?.content,t.content,t.text,t.response,n?null:t.result,t.output];for(const r of a){if(typeof r=="string"&&r.trim())return r;if(Array.isArray(r)){const s=r.map(ca).join("");if(s.trim())return s}if(mn(r)){const s=await pn(r);if(s.trim())return s}}try{return JSON.stringify(e)}catch{return String(e)}}return String(e||"")}async function kc(){try{const e=await Ve($a,ys);if(e==null||e==="")return se(qe);const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return se(qe);const n=ta(t),a=$e(qe,n);return JSON.stringify(t)!==JSON.stringify(n)&&await Mr(a),a}catch(e){console.warn("[Inlay Nexus] settings load failed",e?.message||e)}return se(qe)}async function Mr(e){if(await dt($a,se(e)),await Ve("inx_native_settings")==null)throw new Error("설정 저장 실패: IndexedDB(getLocalPluginStorage)에 기록되지 않았습니다.")}var Ar=["","none","off","false","0"];async function Sc(){const e=await R("meta","prompt:__pack__"),t=!e||e.text!=="2026-08-05-base-wear-fixed",n=Date.now()/1e3;for(const a of Ea)await R("meta",`prompt:${a}`)&&!(t&&_s.includes(a))||await F("meta",{key:`prompt:${a}`,text:rn(a),updated_at:n});await F("meta",{key:"prompt:__pack__",text:ps,updated_at:n})}async function me(e){const t=await R("meta",`prompt:${e}`);return t?.text!=null?t.text:rn(e)}async function Nr(e,t){const n=Date.now()/1e3;return await F("meta",{key:`prompt:${e}`,text:t,updated_at:n}),{ok:!0,key:e,updated_at:n}}async function Mc(){const e=await ue("meta"),t=new Map(e.filter(a=>a.key?.startsWith("prompt:")&&!a.key.startsWith("prompt:__")).map(a=>[a.key.slice(7),{key:a.key.slice(7),text:a.text||"",updated_at:a.updated_at||0}])),n=[];for(const a of Ea){const r=t.get(a);r?n.push(r):n.push({key:a,text:rn(a),updated_at:0}),t.delete(a)}for(const a of t.values())n.push(a);return n}async function De(){const e=se($());await Ai.run(()=>Mr(e))}function Ac(){return Uo($())}async function Nc(e){const t=Jo(String(e??"").slice(0,2000001)),n=se($());await F("meta",{key:"settings_backup",value:n,updated_at:Date.now()/1e3});const a=$e(qe,t);return a.llm={...a.llm,api_key:n.llm?.api_key||""},a.nai={...a.nai,api_key:n.nai?.api_key||""},a.auth_token=n.auth_token||"",Cn(a),await De(),{ok:!0,settings:_n()}}async function Ic(){const e=se($());await F("meta",{key:"settings_backup",value:e,updated_at:Date.now()/1e3});const t=se(qe);t.llm={...t.llm,api_key:e.llm?.api_key||""},t.nai={...t.nai,api_key:e.nai?.api_key||""},t.auth_token=e.auth_token||"";const n=e.card;return t.card={...t.card,presets:Array.isArray(n.presets)?se(n.presets):t.card.presets||[],active_preset_id:String(n.active_preset_id||t.card.active_preset_id||""),custom_pos:String(n.custom_pos??t.card.custom_pos??""),custom_neg:String(n.custom_neg??t.card.custom_neg??"")},Cn(t),await De(),{ok:!0,settings:_n()}}function Ec(){const e=$(),t=e.nai,n=e.llm;let a=0,r=0,s=0,i=0;try{a=Lt("cards"),r=Lt("images"),s=ho();const o=new Set;for(const c of po()){const l=u(c.character_id||"",200)||"unknown",d=u(c.chat_id||"",200)||"unknown";o.add(`${l}|${d}`)}i=o.size}catch{}return{ok:!0,version:at,pid:0,source_file:"native",nai_configured:Rt(t)==="comfy"?sa(t):!!u(t.api_key),image_backend:Rt(t),llm_configured:Sr(n),port:0,image_mode:"data-url",storage:"indexeddb",storage_api:"getLocalPluginStorage",storage_scope:"device-local",cards:a,images:r,folders:i,png_bytes:s,last_stage:en(),focus_stage:st(),last_error:In(),debug_events:Es()}}function _n(){const e=se($());e.nai?.api_key?(e.nai.api_key="",e.nai.api_key_configured=!0):e.nai={...e.nai,api_key_configured:!1},e.llm?.api_key?(e.llm.api_key="",e.llm.api_key_configured=!0):e.llm={...e.llm,api_key_configured:!1},e.llm?.service_account_json?(e.llm.service_account_json="",e.llm.service_account_configured=!0):e.llm={...e.llm,service_account_configured:!1};const t=e.nai;t.backend=Rt(t),t.image_backend=t.backend,t.comfy_configured=sa(t);const n=Fa(),a=za(),r=!Ar.includes(u(t.image_reference));t.image_reference_configured=!!(r&&n),t.image_reference||(t.image_reference=t.image_reference_configured?"file":"none"),t.image_reference_configured&&n&&(t.reference_preview_url=n);const s=!Ar.includes(u(t.vibe_transfer));return t.vibe_transfer_configured=!!(s&&a),t.vibe_transfer||(t.vibe_transfer=t.vibe_transfer_configured?"file":"none"),t.vibe_transfer_configured&&a&&(t.vibe_preview_url=a),e.card.character_max=Ce(e.card),e.database_path="indexeddb:getLocalPluginStorage",e.images_dir="indexeddb:inx_nximg_*",e.prompts_dir="embedded",e.storage={...e.storage,backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",image_mode:"data-url"},e}async function $c(e){const t=e&&typeof e=="object"?e:{},n=$(),a={...t.nai||{}},r={...t.llm||{}},s={...t.card||{}};if("api_key"in a){const i=a.api_key;delete a.api_key,delete a.api_key_configured,u(i)&&(n.nai.api_key=i),(a.clearApiKey||t.clear_nai_key)&&(n.nai.api_key=""),delete a.clearApiKey}if("api_key"in r){const i=r.api_key;delete r.api_key,delete r.api_key_configured,u(i)&&(n.llm.api_key=i),(r.clearApiKey||t.clear_llm_key)&&(n.llm.api_key=""),delete r.clearApiKey}if("service_account_json"in r){const i=r.service_account_json;delete r.service_account_json,delete r.service_account_configured,u(i)&&(n.llm.service_account_json=i),(r.clearServiceAccount||t.clear_llm_service_account)&&(n.llm.service_account_json=""),delete r.clearServiceAccount}if(Object.keys(s).length){const i=$e(n.card,s);Array.isArray(s.presets)&&(i.presets=s.presets),"active_preset_id"in s&&(i.active_preset_id=s.active_preset_id),"custom_pos"in s&&(i.custom_pos=s.custom_pos),"custom_neg"in s&&(i.custom_neg=s.custom_neg),n.card=i,n.card.character_max=Ce(n.card)}Object.keys(a).length&&(n.nai=$e(n.nai,a)),Object.keys(r).length&&(n.llm=$e(n.llm,r));for(const i of["bind_host","port","auth_token"])i in t&&(n[i]=t[i]);return await De(),{ok:!0,settings:_n()}}var Ir=12582912,Dt=32;async function jc(){const e=await R("meta","reference_image");return!!(e?.png&&e.png.byteLength>Dt)}async function Er(){return(await R("meta","reference_image"))?.png||null}async function Cc(e){if(!e||e.byteLength<Dt)throw new Error("참조 이미지가 비어 있습니다");if(e.byteLength>Ir)throw new Error("참조 이미지가 너무 큽니다 (최대 12MB)");return await F("meta",{key:"reference_image",png:e}),Ln(dn(e)),$().nai.image_reference="file",await De(),{ok:!0,image_reference:"file",configured:!0,bytes:e.byteLength,preview_url:"/v1/nai/reference.png"}}async function $r(){return await ht("meta","reference_image"),Ln(""),$().nai.image_reference="none",await De(),{ok:!0,image_reference:"none",configured:!1}}async function Tc(){const e=await R("meta","vibe_transfer");return!!(e?.encoded&&e?.png&&e.png.byteLength>Dt)}async function Lc(){return await R("meta","vibe_transfer")||null}async function Pc(){return(await R("meta","vibe_transfer"))?.png||null}function jr(e){let t=Number(e??1);return Number.isNaN(t)&&(t=1),Math.max(0,Math.min(1,t))}async function Oc(e,t={}){if(!e||e.byteLength<Dt)throw new Error("Vibe 이미지가 비어 있습니다");if(e.byteLength>Ir)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const n=$(),a=u(n.nai.api_key);if(!a)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const r=Ze(t.model||n.nai.model||"nai-diffusion-4-5-full"),s=jr(t.information_extracted??n.nai.vibe_transfer_information_extracted),i=await _r(a,e,r,s);return await F("meta",{key:"vibe_transfer",png:e,encoded:i,model:wt(r),information_extracted:s}),Pn(dn(e)),n.nai.vibe_transfer="file",t.strength!=null&&!Number.isNaN(Number(t.strength))&&(n.nai.vibe_transfer_strength=Math.max(0,Math.min(1,Number(t.strength)))),n.nai.vibe_transfer_information_extracted=s,await De(),{ok:!0,vibe_transfer:"file",configured:!0,bytes:e.byteLength,encoded_bytes:i.length,model:wt(r),information_extracted:s,preview_url:"/v1/nai/vibe.png"}}async function Cr(){return await ht("meta","vibe_transfer"),Pn(""),$().nai.vibe_transfer="none",await De(),{ok:!0,vibe_transfer:"none",configured:!1}}async function Bc(){const e=await Lc();if(!e?.png||e.png.byteLength<Dt)return null;const t=$(),n=u(t.nai.api_key);if(!n)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=wt(Ze(t.nai.model||"nai-diffusion-4-5-full")),r=jr(t.nai.vibe_transfer_information_extracted);if(!(!u(e.encoded)||u(e.model)!==a||Math.abs(Number(e.information_extracted??1)-r)>.001))return e;const s=await _r(n,e.png,a,r),i={...e,key:"vibe_transfer",encoded:s,model:a,information_extracted:r};return await F("meta",i),i}async function yn(e){const{shot:t,roster:n}=e,a=$().card,r=$().nai,s=Ce(a),i=Rn(t.characters||[],n,s).slice(0,s),o=Math.max(1,i.length),c=qa(a.person_tag_mode,a.auto_person_tags),l=Gi(i,n,c),[d,g]=Ds(await me("preset_1")),p=Array.isArray(a.presets)?a.presets:[],f=u(a.active_preset_id,120);let h=null;p.length&&(f&&(h=p.find(B=>typeof B=="object"&&u(B.id,120)===f)||null),!h&&typeof p[0]=="object"&&(h=p[0]));let m,y;h?(m=u(h.positive||h.pos||""),y=u(h.negative||h.neg||"")):(m=C(u(a.custom_pos),d),y=C(u(a.custom_neg),g));let _=t.situation||t.scene;c!=="off"&&(_=qi(_||""));let k;const M=u(e.lockedSetup||"");M?k=M:(k=C(t.camera,_,t.place,t.action),a.mode==="asset"&&(k=C(k,"white background","simple background","cowboy shot","looking at viewer","portrait")));const S=Qn(a.natural_base),x=S==="supplement"?600:S==="detailed"?480:400,A=S==="off"?"":u(t.natural||t.natural_base||t.nl||"",x);let w=C(l,m,A,k);const I=Ze(r.model||"nai-diffusion-4-5-full");r.apply_quality_tags!==!1&&(w+=an[I]||"");const P=u(r.uc_preset)||"human_focus",E=C(y,(pi[I]||{})[P]||""),O=[],z=[];for(let B=0;B<i.length;B++){const we=i[B],X=u(we.name,200),ne=X?ie(X,n):null,H=Wi(ne,we),kt=u(we.negative),G=o===1?.5:Math.round((.1+.8*B/Math.max(1,o-1))*10)/10,he=.5;O.push({prompt:H||"girl",uc:kt,center_x:G,center_y:he}),z.push({name:ne?.name||X,prompt:H,uc:kt,center_x:G,center_y:he,raw:we})}return{main:w,neg:E,captions:O,meta:{setup:k,person:l,characters:z,paragraph:t.paragraph}}}async function Tr(e){const t=$().nai,n=e.captions;if(Rt(t)==="comfy"){const[d,g]=await cc(t,e.main,e.neg,n);return{bytes:d,seed:g}}const a=u(t.api_key);if(!a)throw new Error("NAI api_key가 설정되지 않았습니다.");const r=[],s=u(t.image_reference||"none").toLowerCase();if(!["","none","off","false","0"].includes(s)){const d=await Er();if(d){let g=u(t.image_reference_type||"character&style")||"character&style";["character","style","character&style"].includes(g)||(g="character&style");let p=Number(t.image_reference_strength??.6),f=Number(t.image_reference_fidelity??1);Number.isNaN(p)&&(p=.6),Number.isNaN(f)&&(f=1),r.push({image:d,type:g,strength:Math.max(0,Math.min(1,p)),fidelity:Math.max(0,Math.min(1,f))})}}const i=[],o=u(t.vibe_transfer||"none").toLowerCase();if(!["","none","off","false","0"].includes(o)){const d=await Bc();if(d?.encoded){let g=Number(t.vibe_transfer_strength??.6),p=Number(t.vibe_transfer_information_extracted??d.information_extracted??1);Number.isNaN(g)&&(g=.6),Number.isNaN(p)&&(p=1),i.push({encoded:d.encoded,strength:Math.max(0,Math.min(1,g)),information_extracted:Math.max(0,Math.min(1,p))})}}const c={prompt:e.main,negative_prompt:e.neg,width:Math.min(Number(t.width??640)||640,832),height:Math.min(Number(t.height??960)||960,1216),seed:Number(t.seed??0)||0,steps:Math.min(Number(t.steps??28)||28,28),cfg_scale:Number(t.cfg_scale??7),cfg_rescale:Number(t.cfg_rescale??.36),sampler:u(t.sampler)||"k_euler_ancestral",scheduler:u(t.scheduler)||"karras",model:Ze(t.model||"nai-diffusion-4-5-full"),var_plus:!!t.variety_plus,characters:n,character_refs:r,vibes:i};c.width*c.height>1011712&&(c.width=640,c.height=960),v("nai.generate.dims",{message:`${c.width}x${c.height}`,steps:c.steps,focus:!0}),c.seed||(c.seed=Math.floor(Math.random()*4294967295)||1);const l=u(t.request_url)||"https://image.novelai.net/ai/generate-image";return{bytes:(await pr(a,c,l,{timeoutMs:9e4})).raw_bytes,seed:c.seed||0}}function Rc({imageId:e,sessionId:t,request:n,shotIndex:a,paragraph:r,yPercent:s,contentHash:i=""}){return{version:1,image_id:u(e,80),session_id:u(t,200),unified_session_id:u(n.unified_session_id||"",200),character_id:u(n.character_id||"",200),character_name:u(n.character_name||"",200),chat_id:u(n.chat_id||"",200),chat_name:u(n.chat_name||"",200),char_index:j(n.char_index,-1),chat_index:j(n.chat_index,-1),message_index:j(n.message_index,-1),message_role:u(n.message_role||n.role||"",40).toLowerCase(),shot_index:j(a,0),paragraph:j(r,0),y_percent:s,content_hash:u(i||n.content_hash||"",128),assistant_preview:u(n.assistant_text||"",He)}}async function et(e){return _o(e)}async function Lr(e,t){const n=await R("images",e),a=n?{...n}:{id:e},r=t||{};a.location={...r,version:Number(r.version||1),image_id:u(e,80)},await F("images",a)}async function Fe(e,t={}){const n=await et(e),a=typeof t=="object"&&t?t:{};let r=n.y_percent;r==null&&(r=a.y_percent??a.anchor_percent??a.read_percent);const s=Object.keys(n).length>0,i=ve(u(e,80));return{character_id:u(n.character_id||a.character_id||"",200),chat_id:u(n.chat_id||a.chat_id||"",200),character_name:u(n.character_name||a.character_name||"",200),chat_name:u(n.chat_name||a.chat_name||"",200),char_index:j(n.char_index??a.char_index,-1),chat_index:j(n.chat_index??a.chat_index,-1),message_index:j("message_index"in n?n.message_index:a.message_index,-1),message_role:u(n.message_role||a.message_role||"",40).toLowerCase(),shot_index:j(n.shot_index,-1),paragraph:j("paragraph"in n?n.paragraph:a.paragraph,0),y_percent:tn(r),content_hash:u(n.content_hash||a.content_hash||"",128),assistant_preview:u(n.assistant_preview||a.assistant_preview||"",He),unified_session_id:u(n.unified_session_id||a.unified_session_id||"",200),location_file:s?`idb:${i}`:"",storage:"indexeddb",storage_key:i}}function la(e,t,n=0){const a=typeof e=="object"&&e?{...e}:{},r=t||{};return{...a,character_id:u(r.character_id||a.character_id||"",200),chat_id:u(r.chat_id||a.chat_id||"",200),character_name:u(r.character_name||a.character_name||"",200),chat_name:u(r.chat_name||a.chat_name||"",200),char_index:j(r.char_index??a.char_index,-1),chat_index:j(r.chat_index??a.chat_index,-1),message_index:j(r.message_index??a.message_index,-1),message_role:u(r.message_role||a.message_role||"",40).toLowerCase(),content_hash:u(r.content_hash||a.content_hash||"",128),assistant_preview:u(r.assistant_preview||a.assistant_preview||"",He),unified_session_id:u(r.unified_session_id||a.unified_session_id||"",200),y_percent:tn(r.y_percent??a.y_percent),storage:"indexeddb",storage_key:ve(u(r.image_id||"",80)),png_bytes:Number(n)||0}}var Dc=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t+=1){let n=t;for(let a=0;a<8;a+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e})();function ua(e){return Array.isArray(e)?new Uint8Array(e):re(e)}function Fc(e){const t=ua(e);let n=4294967295;for(let a=0;a<t.length;a+=1)n=Dc[(n^t[a])&255]^n>>>8;return(n^4294967295)>>>0}function K(e){const t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e>>>0,!0),t}function te(e){const t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function Ft(e){let t=0;for(const n of e)t+=n.length;return Mt(e,t)}function zc(e){return new TextEncoder().encode(String(e??""))}function Uc(e=[]){const t=[],n=[];let a=0;for(const i of e){const o=zc(i.name||"file"),c=ua(i.data),l=Fc(c),d=Ft([te(67324752),K(20),K(0),K(0),K(0),K(0),te(l),te(c.length),te(c.length),K(o.length),K(0),o,c]),g=Ft([te(33639248),K(20),K(20),K(0),K(0),K(0),K(0),te(l),te(c.length),te(c.length),K(o.length),K(0),K(0),K(0),K(0),te(0),te(a),o]);t.push(d),n.push(g),a+=d.length}const r=Ft(n),s=Ft([te(101010256),K(0),K(0),K(e.length),K(e.length),te(r.length),te(a),K(0)]);return Ft([...t,r,s])}function da(e,t){return e[t]|e[t+1]<<8}function Pr(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Jc(e){const t=ua(e),n=new Map;let a=0;for(;a+30<=t.length;){const r=Pr(t,a);if(r===33639248||r===101010256)break;if(r!==67324752){a+=1;continue}const s=da(t,a+8),i=Pr(t,a+18),o=da(t,a+26),c=da(t,a+28),l=a+30,d=new TextDecoder().decode(t.subarray(l,l+o)),g=l+o+c,p=g+i;if(p>t.length)break;s===0&&n.set(d.replace(/\\/g,"/"),t.subarray(g,p)),a=p}return n}function Kc(e=[],{exportedAt:t=Date.now()}={}){return{format:"inlay-nexus-gallery",version:1,exported_at:t,items:(e||[]).map(n=>({id:String(n.id||""),file:`images/${String(n.id||"unknown")}.png`,location:{character_id:n.character_id||"",chat_id:n.chat_id||"",character_name:n.character_name||"",chat_name:n.chat_name||"",char_index:n.char_index??-1,chat_index:n.chat_index??-1,message_index:n.message_index??-1,content_hash:n.content_hash||"",paragraph:n.paragraph??0,shot_index:n.shot_index??0,y_percent:n.y_percent??null,assistant_preview:n.assistant_preview||"",session_id:n.session_id||""},meta:{main_prompt:n.main_prompt||"",seed:n.seed??null,created_at:n.created_at??null,characters:n.characters||[]}}))}}function Hc(e,t=[]){const n=e?.location||{},a=String(n.content_hash||"").trim(),r=t||[];if(a){const l=r.find(d=>String(d.content_hash||"")===a);if(l)return{status:"exact",matchId:String(l.id),content_hash:a}}const s=String(n.character_id||""),i=String(n.chat_id||""),o=Number(n.message_index),c=r.filter(l=>s&&String(l.character_id||"")!==s||i&&String(l.chat_id||"")!==i||Number.isFinite(o)&&o>=0&&Number(l.message_index)!==o?!1:!!(s||i||Number.isFinite(o)&&o>=0)).slice(0,8);return c.length?{status:"candidate",candidates:c.map(l=>({id:l.id,content_hash:l.content_hash,message_index:l.message_index})),location:n}:{status:"orphan",location:n}}function qc(e=[]){return Uc(e)}function Gc(e){const t=Jc(e);let n=null;const a=t.get("manifest.json");if(a)try{n=JSON.parse(new TextDecoder().decode(a))}catch{n=null}const r=new Map;for(const[s,i]of t.entries())s!=="manifest.json"&&/\.(png|webp|jpe?g)$/i.test(s)&&r.set(s.replace(/\\/g,"/"),i);return{manifest:n,images:r,files:t}}function zt(e){try{const t=JSON.parse(e.meta_json||"{}");return t&&typeof t=="object"?t:{}}catch{return{}}}async function Or(e,t){return(await mo(e))?.png_bytes||Number(t.png_bytes)||0}async function fa(e){const t=(await ue("cards")).sort((s,i)=>(i.created_at||0)-(s.created_at||0)).slice(0,Math.max(1,Math.min(2e3,e))),n={},a=[];for(const s of t){const i=zt(s),o=await Fe(s.id,i),c=await et(s.id),l=u(o.character_name||c.character_name||i.character_name||"",200),d=u(o.chat_name||c.chat_name||i.chat_name||"",200),g=u(o.character_id||"",200)||"unknown",p=u(o.chat_id||"",200)||"unknown",f=`${g}|${p}`;let h=n[f];h||(h={key:f,character_id:g,chat_id:p,character_name:l||g.slice(0,12)||"Unknown",chat_name:d||`chat ${o.chat_index??"?"}`,char_index:o.char_index??-1,chat_index:o.chat_index??-1,count:0,storage:"indexeddb"},n[f]=h),l&&!h.character_name&&(h.character_name=l),d&&(h.chat_name=d),h.count+=1,a.push({id:s.id,job_id:s.job_id,session_id:s.session_id,folder_key:f,shot_index:o.shot_index>=0?o.shot_index:s.shot_index,paragraph:Object.keys(c).length?o.paragraph:s.paragraph,y_percent:o.y_percent,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:g,character_name:h.character_name,chat_id:p,chat_name:h.chat_name,char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:u(o.assistant_preview||c.assistant_preview||i.assistant_preview||"",He),main_prompt:s.main_prompt,characters:JSON.parse(s.characters_json||"[]"),image_url:_e(s.id),seed:s.seed,created_at:s.created_at,storage:"indexeddb",storage_key:o.storage_key||ve(s.id),location_file:o.location_file||"",png_bytes:await Or(s.id,i)})}const r={ok:!0,folders:Object.values(n).sort((s,i)=>`${s.character_name||""}`.localeCompare(`${i.character_name||""}`,void 0,{sensitivity:"base"})||`${s.chat_name||""}`.localeCompare(`${i.chat_name||""}`,void 0,{sensitivity:"base"})),items:a,total:a.length,storage:"indexeddb",storage_api:"getLocalPluginStorage"};return await Pe(r,{cachedOnly:!0}),r}async function Wc(e=400){return fa(e)}async function Vc(e,t=40){const n=(await ar(e)).sort((s,i)=>(i.created_at||0)-(s.created_at||0)).slice(0,Number(t)),a=[];for(const s of n){const i=zt(s),o=await Fe(s.id,i),c=await et(s.id);a.push({id:s.id,job_id:s.job_id,shot_index:o.shot_index>=0?o.shot_index:s.shot_index,paragraph:Object.keys(c).length?o.paragraph:s.paragraph,y_percent:o.y_percent,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:o.character_id||"",chat_id:o.chat_id||"",character_name:o.character_name||"",chat_name:o.chat_name||"",char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:o.assistant_preview||i.assistant_preview||"",main_prompt:s.main_prompt,negative_prompt:s.negative_prompt,characters:JSON.parse(s.characters_json||"[]"),image_url:_e(s.id),seed:s.seed,created_at:s.created_at,storage:"indexeddb",storage_key:o.storage_key||ve(s.id),png_bytes:await Or(s.id,i)})}const r={ok:!0,session_id:e,items:a,storage:"indexeddb"};return await Pe(r,{cachedOnly:!0}),r}async function Yc(e={}){const t=u(e.session_id,200),n=u(e.to_hash,128),a=u(e.assistant_preview||"",He),r=(Array.isArray(e.card_ids)?e.card_ids:[]).map(i=>u(i,80)).filter(Boolean);if(!n||!r.length)return{ok:!1,...V("to_hash and card_ids required","bad_request"),rebound:0,ids:[]};const s=[];for(const i of r){const o=await R("cards",i);if(!o||t&&u(o.session_id||"",200)!==t)continue;const c=zt(o),l=await et(i),d={...l,image_id:i,content_hash:n,assistant_preview:a||l.assistant_preview||""};await Lr(i,d),c.content_hash=n,a&&(c.assistant_preview=a),c.message_role=u(c.message_role||l.message_role||"",40).toLowerCase(),o.meta_json=JSON.stringify(c),await F("cards",o),s.push(i)}return v("gallery.rebind",{n:s.length,to:n.slice(0,8)}),{ok:!0,rebound:s.length,ids:s,content_hash:n}}async function ga(e,t="",n=null){const a=u(e,200),r=u(t);let s=null;try{n!=null&&String(n).trim()!==""&&(s=parseInt(String(n),10))}catch{s=null}if(!a||!r&&s==null)return{ok:!0,unlinked:0,ids:[]};const i=(await ar(a)).sort((c,l)=>(c.created_at||0)-(l.created_at||0)),o=[];for(const c of i){const l=zt(c),d=await Fe(c.id,l),g=u(d.content_hash||""),p=j(d.message_index,-1);let f=!1;if((r&&g&&g===r||s!=null&&s>=0&&p===s)&&(f=!0),!f)continue;const h={...await et(c.id),version:1,image_id:c.id,session_id:a,content_hash:"",message_index:-1,character_id:"",chat_id:"",char_index:-1,chat_index:-1,unlinked_at:Date.now()/1e3};await Lr(c.id,h),(l.content_hash||l.message_index!=null||l.assistant_preview)&&(l.content_hash="",l.assistant_preview="",l.message_index=-1,l.unlinked_at=Date.now()/1e3,c.meta_json=JSON.stringify(l),await F("cards",c)),o.push(c.id)}return{ok:!0,unlinked:o.length,ids:o}}async function ma(e){const t=u(e,80);return t?await R("cards",t)?(await ht("cards",t),await ht("images",t),{ok:!0,deleted:1,ids:[t]}):{ok:!1,...V("card not found","not_found")}:{ok:!1,...V("card_id required","bad_request")}}async function ha(e){return ma(e)}async function Zc(e=[]){const t=[...new Set((e||[]).map(a=>u(a,80)).filter(Boolean))],n=[];for(const a of t)(await ma(a)).ok&&n.push(a);return{ok:!0,deleted:n.length,ids:n}}async function Br(){const e=(await R("meta","explorer_favorites"))?.ids;return{ok:!0,ids:Array.isArray(e)?e.map(t=>u(t,80)).filter(Boolean):[]}}async function Xc(e=[]){const t=[...new Set((e||[]).map(n=>u(n,80)).filter(Boolean))].slice(0,5e3);return await F("meta",{key:"explorer_favorites",ids:t,updated_at:Date.now()/1e3}),{ok:!0,ids:t}}async function Qc(e={}){let t=(await fa(2e3)).items;const n=u(e.folder_key||"",400);if(!e.all)if(n)t=t.filter(i=>i.folder_key===n);else if(Array.isArray(e.card_ids)&&e.card_ids.length){const i=new Set(e.card_ids.map(o=>u(o,80)));t=t.filter(o=>i.has(o.id))}else return{ok:!1,...V("card_ids, folder_key, or all required","bad_request")};if(!t.length)return{ok:!1,...V("no images to export","empty")};const a=Kc(t),r=[{name:"manifest.json",data:new TextEncoder().encode(JSON.stringify(a,null,2))}];for(const i of t){const o=await Rr(i.id);o?.byteLength&&r.push({name:`images/${i.id}.png`,data:re(o)})}if(r.length<2)return{ok:!1,...V("image bytes missing","empty")};const s=qc(r);return{ok:!0,count:r.length-1,filename:`inlay-gallery-${Date.now()}.zip`,zip_base64:it(s),bytes:s.length}}async function el(e={}){const t=e.prefer_new_ids===void 0?!0:e.prefer_new_ids,n=String(e.zip_base64||"").replace(/^data:.*base64,/,"");if(!n)return{ok:!1,...V("zip_base64 required","bad_request")};let a;try{a=Ee(n)}catch(l){return{ok:!1,...V(`invalid base64: ${l?.message||l}`,"bad_request")}}const{manifest:r,images:s}=Gc(a);if(!r?.items?.length)return{ok:!1,...V("manifest.items missing","bad_request")};const i=(await fa(2e3)).items,o=[],c={exact:0,candidate:0,orphan:0,skipped:0};for(const l of r.items){const d=String(l.file||`images/${l.id}.png`).replace(/\\/g,"/"),g=s.get(d)||s.get(`images/${l.id}.png`);if(!g?.byteLength){c.skipped+=1;continue}const p=Hc(l,i);c[p.status]=(c[p.status]||0)+1;const f={...l.location||{}},h=t?Ke():u(l.id||"",80)||Ke(),m=u(f.session_id||"",200)||`import_${Ke().replace(/-/g,"").slice(0,10)}`,y={version:1,image_id:h,session_id:m,character_id:u(f.character_id||"",200),character_name:u(f.character_name||"",200),chat_id:u(f.chat_id||"",200),chat_name:u(f.chat_name||"",200),char_index:j(f.char_index,-1),chat_index:j(f.chat_index,-1),message_index:j(f.message_index,-1),shot_index:j(f.shot_index,0),paragraph:j(f.paragraph,0),y_percent:tn(f.y_percent),content_hash:u(f.content_hash||"",128),assistant_preview:u(f.assistant_preview||"",He),imported_at:Date.now()/1e3,reattach:p.status},_=Y(g);await Hn(h,_,y);const k=la({...l.meta||{},assistant_preview:y.assistant_preview,imported_at:y.imported_at,reattach:p.status},y,_.byteLength||0);await F("cards",{id:h,job_id:`import_${h.slice(0,8)}`,session_id:m,shot_index:y.shot_index,paragraph:y.paragraph,main_prompt:u(l.meta?.main_prompt||"",8e3),negative_prompt:"",characters_json:JSON.stringify(l.meta?.characters||[]),seed:l.meta?.seed??0,meta_json:JSON.stringify(k),created_at:Number(l.meta?.created_at)||Date.now()/1e3}),o.push({id:h,reattach:p.status,content_hash:y.content_hash})}return{ok:!0,imported:o.length,items:o,report:c}}async function tl(e){const t=u(e,400);if(!t||!t.includes("|"))return{ok:!1,...V("folder_key required","bad_request")};const[n,a]=t.split("|",2),r=u(n,200)||"unknown",s=u(a,200)||"unknown",i=await ue("cards"),o=[];for(const c of i){const l=zt(c),d=await Fe(c.id,l),g=u(d.character_id||"",200)||"unknown",p=u(d.chat_id||"",200)||"unknown";g!==r||p!==s||(await ma(c.id)).ok&&o.push(c.id)}return{ok:!0,deleted:o.length,ids:o,folder_key:`${r}|${s}`}}async function Rr(e){return vo(e)}var nl=["queued","tagging","generating"];function bn(e={},t=""){const n=u(t||e.session_id||"",200)||"_",a=u(e.content_hash||"",128);if(a)return`${n}::h:${a}`;const r=j(e.message_index,-1);return r>=0?`${n}::m:${r}`:`${n}::all`}async function al(e){if(Tn.has(e))return"message-reroll";const t=sn.get(e);if(!t?.jobId)return"";const n=ct.get(t.jobId);if(!n||n.cancelRequested)return"";const a=await R("jobs",t.jobId);return a&&nl.includes(String(a.state||""))?t.jobId:""}async function pa(e={},t=""){const n=await al(bn(e,t));return n?{ok:!1,busy:!0,accepted:!1,job_id:n==="message-reroll"?"":n,session_id:u(t||e.session_id||"",200),job_state:"busy",error:{code:"busy",message:"같은 메시지 작업이 아직 진행 중입니다. 끝날 때까지 기다려 주세요."}}:null}var Dr=e=>e.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"");function Fr(e){const t=typeof e=="string"?e:JSON.stringify(e);return Dr(it(new TextEncoder().encode(t)))}function rl(e){const t=ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):re(e);return Dr(it(t))}async function sl(e){let t;try{t=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("Vertex Service Account JSON 파싱 실패")}if(!t?.client_email||!t?.private_key)throw new Error("Service Account JSON에 client_email/private_key가 필요합니다.");if(!globalThis.crypto?.subtle)throw new Error("이 환경에서는 Vertex Service Account(JWT) 서명을 지원하지 않습니다. API key 칸에 OAuth access token을 넣거나 Google AI Studio를 쓰세요.");const n=Math.floor(Date.now()/1e3),a=`${Fr({alg:"RS256",typ:"JWT"})}.${Fr({iss:t.client_email,scope:"https://www.googleapis.com/auth/cloud-platform",aud:"https://oauth2.googleapis.com/token",iat:n,exp:n+3600})}`,r=String(t.private_key).replace(/\\n/g,`
`).replace(/-----BEGIN [^-]+-----/,"").replace(/-----END [^-]+-----/,"").replace(/\s+/g,""),s=Uint8Array.from(atob(r),d=>d.charCodeAt(0)),i=await crypto.subtle.importKey("pkcs8",s,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),o=`${a}.${rl(await crypto.subtle.sign("RSASSA-PKCS1-v1_5",i,new TextEncoder().encode(a)))}`,c=await Re("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`grant_type=${encodeURIComponent("urn:ietf:params:oauth:grant-type:jwt-bearer")}&assertion=${encodeURIComponent(o)}`});let l={};try{l=await c.json()}catch{l={}}if(!l?.access_token)throw new Error(`Vertex 토큰 발급 실패: ${JSON.stringify(l).slice(0,240)}`);return{accessToken:String(l.access_token),projectId:u(t.project_id||"")}}async function wn(e,t){const n=hn(e.source);if(n==="main"||n==="aux")return il(e,t,n);const a=Qe(e.provider),r=u(e.model),s=u(e.vertex_region)||"us-central1";let i=u(e.api_key),o="";if(a==="vertex"&&u(e.service_account_json)){const f=await sl(e.service_account_json);i=f.accessToken,o=f.projectId}if(!r||!i)throw v("llm.config",{message:"missing model/api_key",provider:a},"error"),new Error(a==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM이 설정되지 않았습니다. 모델 설정에서 Provider·Model·API key를 넣으세요. (NovelAI 키와 별개)");const c=xr(u(e.endpoint),a,{region:s,projectId:o});if(a==="vertex"&&!/\/chat\/completions$/i.test(c))throw new Error("Vertex AI: project_id가 있는 Service Account JSON이 필요합니다. (OpenAI-compatible endpoint 구성용)");const l=Number(e.timeout_seconds??180)*1e3,d=typeof AbortController<"u"?new AbortController:null,g=setTimeout(()=>{v("llm.abort",{message:`timeout ${l}ms`,model:r,provider:a},"warn"),d?.abort?.()},l),p=Q("llm.call");v("llm.call.start",{message:r,msgs:t?.length||0,timeout_ms:l,source:n,provider:a,reasoning:u(e.reasoning_effort)||"default"});try{let f;if(a==="anthropic_compatible"){const _=bc(t),k={model:r,max_tokens:Number(e.max_tokens??8e3),temperature:Math.min(1,Number(e.temperature??.4)),messages:_.messages};_.system&&(k.system=_.system),f=await Re(c,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":i,"anthropic-version":u(e.anthropic_version)||"2023-06-01"},body:JSON.stringify(k),signal:d?.signal})}else{const _=kr({model:r,messages:t,temperature:Number(e.temperature??.4),max_tokens:Number(e.max_tokens??8e3)},e.reasoning_effort),k={"Content-Type":"application/json",Authorization:`Bearer ${i}`};a==="openrouter"&&(k["HTTP-Referer"]="https://risuai.xyz",k["X-Title"]="Inlay Nexus"),f=await Re(c,{method:"POST",headers:k,body:JSON.stringify(_),signal:d?.signal})}const h=Number(f?.status||0);let m;try{m=await f.json()}catch{m={}}if(h>=400)throw p.fail(new Error(`HTTP ${h}`),{status:h,body:JSON.stringify(m).slice(0,200),provider:a}),new Error(`LLM HTTP ${h}: ${JSON.stringify(m).slice(0,500)}`);const y=a==="anthropic_compatible"?vc(m):wc(m);return p.end({message:r,status:h,bytes:y.length,provider:a}),y}catch(f){throw p.fail(f,{model:r,provider:a}),f}finally{clearTimeout(g)}}async function il(e,t,n,a=""){const r=rt();if(!r||typeof r.runLLMModel!="function")throw new Error("RisuAI runLLMModel API를 사용할 수 없습니다. Risu를 최신으로 업데이트하세요.");const s=n==="main"?"model":"otherAx",i=Math.max(5e3,Number(e.timeout_seconds??180)*1e3),o=u(a)||"",c=Q("llm.call");v("llm.call.start",{message:`risu:${s}`,msgs:t?.length||0,timeout_ms:i,source:n,static_model:o});let l;const d=new Promise((g,p)=>{l=setTimeout(()=>p(new Error(`Risu LLM timeout ${i}ms (${s})`)),i)});try{const g=await Promise.race([r.runLLMModel({mode:s,...o?{staticModel:o}:{},allowPlugins:!0,messages:t}),d]),p=u(await xc(g));if(!p)throw new Error(`Risu LLM(${s}) 응답이 비어 있습니다.`);return c.end({message:`risu:${s}`,bytes:p.length}),p}catch(g){throw c.fail(g,{mode:s}),g}finally{l!==void 0&&clearTimeout(l)}}var ol=Ht({isCharacterImageExtraLore:()=>tt,matchCharacterImageSectionTitles:()=>Jr,normalizeNameKey:()=>vt,parseCharacterImageTagLore:()=>_a,trimCharacterImageTagLore:()=>Ur});function tt(e){return String(e?.comment||e?.name||"").trim().toLowerCase()==="lb-xnai.lb.extra"}function _a(e){const t=String(e||"");if(!t.trim())return{header:"",sections:[]};const n=/^(#{2,3})\s+(.+?)\s*$/gm,a=[];let r;for(;(r=n.exec(t))!==null;)a.push({hashes:r[1],title:String(r[2]||"").trim(),start:r.index,titleEnd:r.index+r[0].length});if(!a.length)return{header:t.trimEnd(),sections:[]};let s=t.slice(0,a[0].start).trimEnd();const i=[];for(let o=0;o<a.length;o+=1){const c=a[o],l=o+1<a.length?a[o+1].start:t.length,d=t.slice(c.titleEnd,l).replace(/^\r?\n/,"").trimEnd();if(c.title.toLowerCase()==="character image tags"){const g=t.slice(c.start,l).trimEnd();s=s?`${s}

${g}`:g;continue}i.push({title:c.title,hashes:c.hashes,body:d})}return{header:s.trimEnd(),sections:i}}function vt(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}function zr(e){return new Set((Array.isArray(e)?e:[]).map(t=>vt(t)).filter(Boolean))}function cl(e,t){if(!t.length)return"";const n=[];e&&n.push(e);for(const a of t){const r=`${a.hashes} ${a.title}`;n.push(a.body?`${r}
${a.body}`:r)}return n.join(`

`).trimEnd()}function Ur(e,t=[],n=[]){const a=_a(e);if(!a.sections.length)return"";const r=zr(n);if(!r.size)return"";const s=zr(t),i=a.sections.filter(o=>{const c=vt(o.title);return r.has(c)&&!s.has(c)});return cl(a.header,i)}function Jr(e,t,n=[]){const a=_a(e),r=vt(t),s=new Set((Array.isArray(n)?n:[]).map(o=>vt(o)).filter(o=>o.length>=2));if(!r&&!s.size)return[];const i=[];for(const o of a.sections){const c=vt(o.title);c.length<2||(r&&r.includes(c)||s.has(c))&&i.push(o.title)}return i}function Kr(e){const t=e.key||e.keys||e.trigger||"";let n;if(Array.isArray(t))n=t.map(i=>u(i,200));else{const i=u(t,2e3);n=i?i.split(/[,|\n]/):[]}const a=e.secondkey||e.second_key||"";a&&n.push(...J(a));const r=[],s=new Set;for(const i of n){const o=u(i,200),c=U(o),l=o?ot(o):"";!c||s.has(c)||o.startsWith("")||l.length<2||(s.add(c),r.push(o))}return r}function Hr(e,t,n){const a=U(e),r=ot(e);if(r.length<2)return 0;const s=(i,o)=>{if(!i||!o||o.length<2)return 0;let c=0,l=0;for(;l<=i.length-o.length;){const d=i.indexOf(o,l);if(d<0)break;c+=1,l=d+o.length}return c};return Math.max(s(t,a),s(n,r))}function ll(e,t){const n=u(t).toLowerCase(),a=ot(t);if(!n)return[];const r=[],s=new Set;for(const i of e||[]){if(typeof i!="object"||tt(i))continue;const o=u(i.mode||"",40).toLowerCase(),c=u(i.key||"",2e3);if(o==="folder"||c.startsWith("folder:"))continue;const l=Kr(i);if(!l.length)continue;let d=0;for(const g of l)d+=Hr(g,n,a);if(!(d<=0))for(const g of l){const p=U(g);!p||s.has(p)||(s.add(p),r.push(g))}}return r}function qr(e,t=[]){const n=String(e||"");if(!/character\s*image\s*tags/i.test(n))return!1;const a=(n.match(/^#{2,3}\s+.+$/gm)||[]).filter(s=>!/character\s*image\s*tags/i.test(s)),r=Array.isArray(t)?t.filter(Boolean).length:0;return a.length>=3&&(r===0||a.length>r+1)}function ul(e){const t=[],n=new Set;for(const a of e||[])if(oe(a))for(const r of It(a)){const s=u(r,200),i=U(s);!s||!i||n.has(i)||(n.add(i),t.push(s))}return t}function Gr(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e==="full"?"full":"tags"}function dl(e,t,n=[],a=5,r=1200,s=null,i="tags"){const o=Array.isArray(e)?e:[],c=Gr(i),l=c==="off"?[]:o.filter(h=>tt(h)),d=o.filter(h=>!tt(h)),g=fl(d,t,a,r),p=Array.isArray(s)&&s.length?s.map(h=>u(h,200)).filter(Boolean):ll(d,t),f=[];for(const h of l){const m=u(h.content||h.data||"",5e4);if(m)if(c==="full")f.push({comment:u(h.comment||h.name||"lb-xnai.lb.extra",200),content:m,key:"full",always:!0,lore_extra_mode:"full"});else{const y=Jr(m,t,p),_=y.length?Ur(m,n,y):"";_&&!qr(_,y)&&f.push({comment:u(h.comment||h.name||"lb-xnai.lb.extra",200),content:_,key:y.join(", "),always:!0,lore_extra_mode:"tags"})}}for(const h of g)qr(u(h.content||h.data||"",r),[])||f.push(h);return f}function fl(e,t,n=5,a=1200){const r=u(t).toLowerCase(),s=ot(t);if(!r)return[];const i=[];for(const o of e||[]){if(typeof o!="object"||tt(o))continue;const c=u(o.mode||"",40).toLowerCase(),l=u(o.key||"",2e3);if(c==="folder"||l.startsWith("folder:"))continue;const d=u(o.content||o.data||"",a);if(!d)continue;const g=Kr(o);if(!g.length)continue;let p=0;for(const f of g)p+=Hr(f,r,s);p<=0||i.push({comment:u(o.comment||o.name||"",200),content:d,key:l,hits:p})}return i.sort((o,c)=>c.hits-o.hits||String(o.comment).localeCompare(String(c.comment))),i.slice(0,Math.max(1,n)).map(({hits:o,...c})=>c)}async function gl(e){const t=$e($().card,e.card||{}),n=u(e.session_id,200),a=[{role:"system",content:`${nn(await me("tagger"))}
...
## {{user}} Info
${u(e.persona_description,8e3)}`});const r=u(e.assistant_text,2e4),s=Array.isArray(e.source_session_ids)?e.source_session_ids.map(f=>u(f,200)).filter(Boolean):[],i=t.lorebook||t.char_appearance!==!1?await Zn(n,u(e.unified_session_id||"",200),u(e.character_id||"",200),s):[],o=ul(i);if(t.lorebook){const f=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:null,h=Gr(t.lore_extra),m=dl(e.lorebook||[],r,o,5,1200,f,h),y=[],_=[];for(const M of m){const S=tt(M)||M.always,x=u(M.content||"",S?5e4:1200);if(!x)continue;const A=u(M.comment||"",200),w=A?`### ${A}
${x}`:x;S?y.push(w):_.push(w)}const k=[];y.length&&k.push(`## lb-xnai.lb.extra — OFFICIAL PACK (START)
...
[END OF lb-xnai.lb.extra] The official pack above is finished. Do NOT treat any heading or text below as lb-xnai image-tag ground truth.`),_.length&&k.push(`## Reference Lorebook (trigger-matched only)
...
`)),v("job.lore.extra",{trigger_keys:Array.isArray(f)?f.length:0,injected:y.length,reference:_.length,sections:m.filter(M=>tt(M)||M.always).map(M=>M.key||"").filter(Boolean).join(" | ")}),k.length&&a.push({role:"system",content:`${await me("lore_inject")}
${k.join(`

`)}`})}if(t.char_appearance!==!1){const f=i,h=f.filter(_=>oe(_)),m=f.filter(_=>u(_.name,200)&&!oe(_)),y=Li(r,f);if(h.length||m.length||y.length){const _=h.length?h.map(x=>{const A=u(x.name,200),w=u(x.appearance||"",200),I=u(x.attire||"",160),P=u(x.accessories||"",120),E=[w?`appearance=${w}`:"",I?`attire=${I}`:"",P?`accessories=${P}`:""].filter(Boolean);return E.length?`${A} ← ${E.join(" | ")}`:A}).filter(Boolean).join(`
`):"(없음)",k=m.length?m.map(x=>`- ${x.name} (별칭: ${It(x).slice(0,8).join(", ")}) → appearance 비어 있음, new_characters에 상세 외형 필수`).join(`
`):"(없음)",M=y.length?y.map(x=>`- ${x.name} [${oe(x)?"외형OK":"외형미완성"}] (별칭: ${It(x).slice(0,8).join(", ")})`).join(`
`):"(이번 메시지에서 등록 캐릭터 트리거 미검출 — 전부 신규일 수 있음)";let S=await me("appearance_inject");S=S.includes("{registered_block}")?S.replace("{registered_block}",_):`${S}

${_}`,S=S.includes("{incomplete_block}")?S.replace("{incomplete_block}",k):`${S}

## 외형 미완성
${k}`,S=S.includes("{detected_block}")?S.replace("{detected_block}",M):`${S}

${M}`,a.push({role:"system",content:S}),v("job.roster.split",{filled:h.map(x=>x.name),incomplete:m.map(x=>x.name),matched:y.map(x=>x.name),session_id:n})}}a.push({role:"system",content:"Every shot MUST include `y_percent` (number 0–100): reading position top→bottom in the message. CRITICAL spread rule: NEVER cluster all shots in the early band. Space them across the whole 0–100 range in reading order (shot0 < shot1 < shot2 …). Aim ~even gaps. Examples — 2 shots: ~25 and ~75; 3 shots: ~20, ~50, ~80; 4 shots: ~15, ~40, ~65, ~90. Forbidden: all values under 40, duplicates, or gaps under ~15 between neighbors unless only 1 shot."});const c=Qn(t.natural_base);a.push({role:"system",content:hl(c)});const l=Ce(t);a.push({role:"system",content:`CHARACTER CAP: each shot may include at most ${l} characters (char1..char${l} only). Never list more than ${l} entries in \`characters[]\`. If more people are visible, keep the ${l} most important and fold extras into situation/place tags.`});const d=[];if(Number(t.include_max||0)>0)for(const f of e.recent_messages||[]){const h=u(f?.role,40)||"char",m=u(f?.content||f?.data,12e3);m&&(r&&m===r&&["char","assistant","bot"].includes(h.toLowerCase())||d.push(`[${h}]
${m}`))}r&&d.push(r);const g=d.length?d.join(`
...
${p}
> These are instructions explicitly given by the user. If in conflict with previous instructions, this section MUST take precedence.`}),a}function ml(e){const t=Ce($().card),n=e,a=[];for(const r of n.scenes||[]){const s=u(r.place);for(const i of r.shots||[]){const o={...i,place:s,characters:Rn(i.characters||[],[],t).slice(0,t)};a.push(o)}}return a}function hl(e){return e==="off"?"Natural base mode OFF. Omit the `natural` field (or leave it empty). Do not invent natural-language base phrases.":e==="detailed"?["Natural base mode DETAILED. Every shot MUST include `natural`: a compact English phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include framing/vantage when useful (side view, close-up, viewed through, reflected in…), then for each visible person in left-to-right (or front-to-back) order: hair color + age band + gender, facial expression, clothing, and pose/action as separate details.","Multi-person: NEVER use character names — use position (left girl, right boy) or hair. Add shared action and lighting/atmosphere briefly.","Telegraphic and objective. Example: `side view upper body, left red hair adult woman tense smile in coat pulling right blue hair teen boy startled arms pinned, warm cafe light`. Keep ~12–28 words, English only."].join(" "):e==="supplement"?["Natural base mode SUPPLEMENT. Every shot MUST include `natural`: telegraphic English sentences describing what tags cannot express (composition, framing, actions, atmosphere, lighting) for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Keep tags and natural language clearly separated. Multi-person: NEVER use names — identify by position (left girl, bottom boy) or appearance. For each person include facial expression and clothing as distinct details; also hair and pose unless already obvious.","Unusual framing welcome (viewed through, reflected in shards of a broken mirror, behind…). Concise, minimal, objective — no subjective interpretation.","Example: `Side view, upper body. Left: adult woman with red hair, tense smile, coat, pulling. Right: teen boy with blue hair, startled face, arms pinned. Warm cafe lighting.` Prefer ~2–5 short sentences, English only."].join(" "):["Natural base mode SHORT. Every shot MUST include `natural`: a short English natural-language phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include hair color + age band + gender for each visible person, plus the shared action. Example: `red hair adult woman forced hug blue hair boy`. Keep ~6–20 words, English only."].join(" ")}var Wr=5e3,pl=2500,_l=64;function yl(e,t,n){const a=bn(t,n),r=(sn.get(a)?.epoch||0)+1;return sn.set(a,{epoch:r,jobId:e}),ct.set(e,{key:a,epoch:r,cancelRequested:!1,publishedIds:[]}),{key:a,epoch:r}}function bl(e){const t=ct.get(e);if(!t||t.cancelRequested)return!1;const n=sn.get(t.key);return!!(n&&n.jobId===e&&n.epoch===t.epoch)}async function wl(e){const t=ct.get(e),n=t?.publishedIds?[...t.publishedIds]:[];t&&(t.publishedIds=[]);for(const a of n)try{await ha(a)}catch{}return n.length}async function Me(e,t="interrupted"){if(bl(e))return!1;const n=await wl(e);return await be(e,"cancelled",{phase:"cancelled",progress:0,message:`${t}${n?` · discarded ${n}`:""}`,shot_count:0,shot_done:0},null),v("job.cancelled",{job_id:e,message:t,discarded:n,focus:!0}),!0}function Ut(e={}){return{shot_count:e.shot_count??0,shot_index:e.shot_index??0,shot_done:e.shot_done??0,progress:e.progress??0,phase:e.phase||"generating",message:e.message||"",cards_so_far:e.cards_so_far,debug_stage:st()||en(),debug_error:In()?.message||""}}function vl(e){return!e||typeof e!="object"?e:JSON.parse(JSON.stringify(e,(t,n)=>{if(t==="image_url"&&typeof n=="string"&&n.startsWith("data:"))return"";if(!(t==="tagged"||t==="appearance"||t==="debug_tail"))return n}))}async function be(e,t,n=null,a=null){const r=await R("jobs",e);if(!r)return;const s=r.state,i={...r,state:t},o=vl(n);i.result_json=o!=null?JSON.stringify(o):null,i.error=a,i.updated_at=Date.now()/1e3;const c=t!=="generating"||s!=="generating"||!!a;await F("jobs",i,{persist:c}),(t==="done"||t==="error"||t==="cancelled")&&await er(),v("job.set",{message:`${t}${a?" ERR":""}${c?"":" (mem)"}`,job_id:e,state:t,persist:c,err:a?String(a).slice(0,160):"",background:t==="generating",focus:t!=="generating"})}async function Vr(e){if(!($().card||{}).power&&!e.force)throw new Error("Power가 OFF 상태입니다.");const t=u(e.session_id,200)||`sess_${Ke().replace(/-/g,"").slice(0,12)}`,n={...e,session_id:t},a=await pa(n,t);if(a)return v("job.busy",{message:a.error.message||"busy",key:bn(n,t),focus:!0},"warn"),a;const r=Ke(),s=Date.now()/1e3;if(yl(r,n,t),n.force)try{await ga(t,u(n.content_hash||""),n.message_index)}catch{}return await F("jobs",{id:r,session_id:t,state:"queued",request_json:JSON.stringify(n),result_json:null,error:null,created_at:s,updated_at:s}),Sl(r).catch(async i=>{console.error("[Inlay Nexus] job crashed",r,i);try{await be(r,"error",null,String(i?.message||i).slice(0,1500))}catch{}}),{ok:!0,accepted:!0,job_id:r,session_id:t,job_state:"queued"}}async function xl(e){const t=await R("jobs",e);if(!t)return{ok:!1,error:{code:"not_found",message:"job not found"}};const n=t.result_json?JSON.parse(t.result_json):null,a={};if(n&&typeof n=="object")for(const r of["shot_count","shot_index","shot_done","progress","phase","message","cards_so_far","debug_stage","debug_error"])r in n&&(a[r]=n[r]);return n&&await Pe(n),{ok:!0,job_id:t.id,session_id:t.session_id,state:t.state,error:t.error,result:n,progress:a,debug:{last_stage:en(),last_error:In(),events:Ta(e,40)},created_at:t.created_at,updated_at:t.updated_at}}function kl(e){for(const t of["y_percent","anchor_percent","read_percent"]){const n=e[t];if(n!=null)try{return Math.max(0,Math.min(100,Number(n)))}catch{return null}}return null}async function Sl(e){const t=await R("jobs",e);if(!t)return;const n=JSON.parse(t.request_json??"{}"),a=String(t.session_id??""),r=Is();Qt(e);const s=Q("job.run");v("job.start",{job_id:e,session_id:a,message_index:n.message_index,text_len:String(n.assistant_text||"").length});try{if(await Me(e,"superseded before start")||(n.force&&await ga(a,u(n.content_hash||""),n.message_index),await Me(e,"superseded before tagging")))return;await be(e,"tagging",{phase:"tagging",progress:0,message:"장면 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.tagging"});const i=await gl(n);if(v("job.tagger.messages",{msgs:i.length}),$().card?.preprocessing){const w=nn(await me("preprocess"));if(w){const I=[{role:"system",content:w},i[i.length-1]],P=await wn($().llm,I);if(await Me(e,"superseded during preprocess"))return;i.splice(i.length-1,0,{role:"system",content:`## Preprocess Summary
${P}`})}}const o=await wn($().llm,i);if(await Me(e,"superseded after tagging"))return;const c=Mi(o);let l=ml(c);if(v("job.tagger.done",{shots:l.length,raw_len:String(o||"").length}),!l.length)throw new Error("태거가 shot을 반환하지 않았습니다.");const d=$().card||{},g=Math.max(1,Number(d.image_min??1)),p=Math.max(g,Number(d.image_max??3));l=l.slice(0,p);const f=l.flatMap(w=>w.characters||[]),h=u(n.unified_session_id||"",200),m=u(n.character_id||"",200),y=Array.isArray(n.source_session_ids)?n.source_session_ids.map(w=>u(w,200)).filter(Boolean):[],_=await Oo({sessionId:a,tagged:c,shotChars:f,unifiedSessionId:h,characterId:m,sourceSessionIds:y});v("job.roster",{roster:_.length});const k=Ce(d);for(const w of l)w.characters=Rn(w.characters||[],_,k);if(await Me(e,"superseded before generate"))return;await be(e,"generating",Ut({shot_count:l.length,shot_index:0,shot_done:0,progress:0,phase:"generating",message:`이미지 1/${l.length} 생성 준비`}));const M=[],S=!!d.llm_anchor_percent;for(let w=0;w<l.length;w+=1){if(await Me(e,`superseded before shot ${w+1}`))return;const I=l[w],{main:P,neg:E,captions:O,meta:z}=await yn({shot:I,roster:_}),B=Ke(),we=Date.now()/1e3,X=u(n.content_hash||"");let ne=kl(I);ne==null&&S&&(ne=Math.round(w/Math.max(1,l.length)*1e4)/100),v("job.shot.prepare",{shot:w,card_id:B,prompt_len:String(P||"").length,captions:(O||[]).length}),await be(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w,progress:Math.round(w/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`NovelAI 요청 중 ${w+1}/${l.length}… [${st()}]`}));let H=0;const kt=setInterval(()=>{H+=Wr/1e3;const ms=Vo();Yo()&&fr()>=_l&&ms&&Date.now()-ms>=pl&&Zo("heartbeat-idle");const hs=fr()||Wo();be(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w,progress:Math.round(w/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`NovelAI 대기 ${w+1}/${l.length} (${H}s) · ${st()}${hs?` ${Math.round(hs/1024)}KB`:""}`})).catch(()=>{})},Wr);let G,he;try{({bytes:G,seed:he}=await Tr({main:P,neg:E,captions:O}))}finally{clearInterval(kt)}if(v("job.shot.nai_done",{shot:w,bytes:G?.byteLength||0,seed:he}),await Me(e,`superseded after shot ${w+1} nai`))return;await be(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w,progress:Math.round((w+.5)/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`이미지 저장 중 ${w+1}/${l.length}… [${st()}]`}));const D=Rc({imageId:B,sessionId:a,request:n,shotIndex:w,paragraph:I.paragraph,yPercent:ne,contentHash:X});await Hn(B,G,D);const An=la(z,D,G?.byteLength||0);await F("cards",{id:B,job_id:e,session_id:a,shot_index:w,paragraph:Number(I.paragraph||0),main_prompt:P,negative_prompt:E,characters_json:JSON.stringify(z.characters||[]),seed:he,meta_json:JSON.stringify(An),created_at:we});const gs=ct.get(e);if(gs&&gs.publishedIds.push(B),await Me(e,`superseded after shot ${w+1} save`))return;M.push({id:B,shot_index:w,paragraph:D.paragraph,y_percent:D.y_percent,message_index:D.message_index??-1,message_role:D.message_role||"",content_hash:D.content_hash||"",character_id:D.character_id||"",chat_id:D.chat_id||"",character_name:D.character_name||"",chat_name:D.chat_name||"",char_index:D.char_index??-1,chat_index:D.chat_index??-1,assistant_preview:u(n.assistant_text||"",Ms),main_prompt:P,negative_prompt:E,characters:z.characters||[],image_url:_e(B),seed:he,storage:"indexeddb",png_bytes:G?.byteLength||0}),v("job.shot.saved",{shot:w,card_id:B,has_url:!!_e(B)}),await be(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w+1,progress:Math.round((w+1)/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`이미지 ${w+1}/${l.length} 완료`,cards_so_far:M.length}))}if(await Me(e,"superseded before done"))return;const x={cards:M,message_index:n.message_index!=null?Number(n.message_index):-1,shot_count:l.length,shot_done:l.length,progress:100,phase:"done",message:`이미지 ${l.length}/${l.length} 완료`};await Pe(x),await be(e,"done",x);const A=ct.get(e);A&&(A.publishedIds=[]),s.end({message:"done",cards:M.length})}catch(i){s.fail(i);const o=i,c=`${o?.message||i}
${o?.stack||""}`.slice(-1500);await be(e,"error",{phase:"error",message:String(o?.message||i).slice(0,240),debug_stage:en(),debug_tail:Ta(e,12)},c)}finally{Qt(r)}}function nt(e,t){try{return JSON.parse(e)}catch{return t}}async function Ml(e,t={}){const n=u(e,80),a=await R("cards",n);if(!a)return{ok:!1,error:{code:"not_found",message:"card not found"}};const r=nt(a.characters_json||"[]",[]),s=Array.isArray(r)?r:[];let i=a.main_prompt;"main_prompt"in t&&(i=u(t.main_prompt,8e3));let o=a.negative_prompt;"negative_prompt"in t&&(o=u(t.negative_prompt,8e3));let c=s;if("characters"in t){const g=t.characters||[];if(!Array.isArray(g))return{ok:!1,error:{code:"bad_request",message:"characters must be a list"}};c=[];const p=Ce($().card||{});for(let f=0;f<g.slice(0,p).length;f++){const h=g[f];if(typeof h!="object")continue;const m=h,y=f<s.length&&typeof s[f]=="object"?s[f]:{},_=u(m.name!=null?m.name:y.name,200),k=u(m.prompt!=null?m.prompt:y.prompt,4e3);if(!_&&!k)continue;const M={...y,name:_||`char${f+1}`,prompt:k||"girl"};"uc"in m&&(M.uc=u(m.uc,2e3));for(const S of["center_x","center_y"])if(S in m)try{M[S]=Number(m[S])}catch{}c.push(M)}}a.main_prompt=i,a.negative_prompt=o,a.characters_json=JSON.stringify(c);try{let g=nt(a.meta_json||"{}",{});(!g||typeof g!="object"||Array.isArray(g))&&(g={});const p=g;p.setup=i,p.characters=c,a.meta_json=JSON.stringify(p)}catch{}await F("cards",a);const l=await Fe(n,{}),d={id:n,main_prompt:i,negative_prompt:o,characters:c,paragraph:a.paragraph,shot_index:a.shot_index,y_percent:l.y_percent,message_index:l.message_index,content_hash:l.content_hash,image_url:_e(n)};return await Pe(d),{ok:!0,card:d}}async function Yr(e,t="nai",n=null,a={}){const r=await R("cards",e);if(!r)return{ok:!1,error:{code:"not_found",message:"card not found"}};const s=r.session_id,i=nt(r.meta_json||"{}",{}),o=i.location||{};if(!a.skipBusyCheck)try{const E=await Fe(e,i),O=await pa({session_id:s,content_hash:u(E.content_hash||i.content_hash||"",128),message_index:j(E.message_index,-1)},s);if(O)return O}catch{}const c=u(o.character_id||i.character_id||"",200);let l=u(i.unified_session_id||o.unified_session_id||"",200);!l&&c&&(l=Rs(c));let d=[];try{const E=await R("jobs",r.job_id);if(E?.request_json){const O=JSON.parse(E.request_json);Array.isArray(O.source_session_ids)&&(d=O.source_session_ids.map(z=>u(z,200)).filter(Boolean))}}catch{}const g=await Zn(s,l,c,d);if(t==="full"){const E=await R("jobs",r.job_id);if(!E)return{ok:!1,error:{code:"no_job",message:"original job missing"}};const O=JSON.parse(E.request_json);return O.force=!0,Vr(O)}let p,f,h,m,y={};const _=n;if(_&&("main_prompt"in _||"negative_prompt"in _||"characters"in _))p="main_prompt"in _?u(_.main_prompt||""):u(r.main_prompt),f="negative_prompt"in _?u(_.negative_prompt||""):u(r.negative_prompt),m="characters"in _?_.characters:null,m==null&&(m=nt(r.characters_json||"[]",[])),h=(m||[]).slice(0,Ce($().card||{})).map(E=>({prompt:zn(E.prompt||"girl")||"girl",uc:u(E.uc),center_x:Number(E.center_x??.5),center_y:Number(E.center_y??.5)}));else if(u(r.main_prompt||"")){const E=nt(r.characters_json||"[]",[]),O=Array.isArray(E)?E:[],z=Zr(i),B=O.map(he=>{if(!he||typeof he!="object")return null;const D=he;if(D.raw&&typeof D.raw=="object"){const An=D.raw;return{...An,name:u(An.name||D.name,200)}}return{name:u(D.name,200),action:D.action,expression:D.expression,sex:D.sex,label:D.label,age:D.age,original:D.original||D.original_tag}}).filter(Boolean),we=$().card||{},X=Ze($().nai?.model||"nai-diffusion-4-5-full"),ne=Object.values(an).filter(Boolean);an[X]&&ne.unshift(an[X]);const H=Yi({setup:i.setup,main:r.main_prompt,person:i.person,stylePositives:Zi(we),qualitySuffixes:ne}),kt={characters:z.length?z:B,paragraph:r.paragraph,camera:H.rebuildMain&&H.lockedSetup?"":u(i.camera||""),situation:H.rebuildMain&&H.lockedSetup?"":u(i.situation||i.scene||""),place:H.rebuildMain&&H.lockedSetup?"":u(i.place||""),action:H.rebuildMain&&H.lockedSetup?"":u(i.action||"")},G=await yn({shot:kt,roster:g,lockedSetup:H.rebuildMain?H.lockedSetup:void 0});H.rebuildMain?(p=G.main,f=G.neg,h=G.captions,m=G.meta.characters,y={setup:G.meta.setup,person:G.meta.person,characters:m}):(p=u(r.main_prompt),f=u(r.negative_prompt)||G.neg,h=G.captions,m=G.meta.characters,y={setup:p,person:G.meta.person,characters:m})}else{const E=nt(r.characters_json||"[]",[]),O=Zr(i),z=(E||[]).map(ne=>{if(!ne||typeof ne!="object")return null;const H=ne;return H.raw||{name:H.name,action:H.action,expression:H.expression}}).filter(Boolean),B=u(i.setup||""),we={characters:O.length?O:z,paragraph:r.paragraph,camera:B?"":u(i.camera||""),situation:B?"":u(i.situation||i.scene||""),place:B?"":u(i.place||""),action:B?"":u(i.action||"")},X=await yn({shot:we,roster:g,lockedSetup:B});p=X.main,f=X.neg,h=X.captions,m=X.meta.characters,y={setup:X.meta.setup,person:X.meta.person,characters:m}}if(!h.length&&!(_&&"characters"in _)){const E={characters:(i.characters||[]).map(z=>z.raw||z),camera:i.setup},O=await yn({shot:E,roster:g});p=O.main,f=O.neg,h=O.captions,m=O.meta.characters,y={setup:O.meta.setup,person:O.meta.person,characters:m}}const{bytes:k,seed:M}=await Tr({main:p,neg:f,captions:h}),S=Ke(),x=Date.now()/1e3;let A=await et(r.id);Object.keys(A).length||(A=await Fe(r.id,i));const w={version:1,image_id:S,session_id:s,unified_session_id:l,character_id:u(A.character_id||"",200),character_name:u(A.character_name||i.character_name||"",200),chat_id:u(A.chat_id||"",200),chat_name:u(A.chat_name||i.chat_name||"",200),char_index:j(A.char_index,-1),chat_index:j(A.chat_index,-1),message_index:j(A.message_index,-1),shot_index:j(A.shot_index,j(r.shot_index,0)),paragraph:j(A.paragraph,j(r.paragraph,0)),y_percent:tn(A.y_percent),content_hash:u(A.content_hash||"",128),assistant_preview:u(A.assistant_preview||i.assistant_preview||"",He)};await Hn(S,k,w);const I=la({...i,...y},w,k.byteLength);for(const E of["y_percent","anchor_percent","read_percent"])delete I[E];I.y_percent=w.y_percent,await F("cards",{id:S,job_id:r.job_id,session_id:s,shot_index:r.shot_index,paragraph:r.paragraph,main_prompt:p,negative_prompt:f,characters_json:JSON.stringify(m),seed:M,meta_json:JSON.stringify(I),created_at:x});try{await ha(e)}catch{}const P={id:S,image_url:_e(S),main_prompt:p,negative_prompt:f,characters:m,seed:M,paragraph:w.paragraph,y_percent:w.y_percent,message_index:w.message_index,shot_index:w.shot_index,content_hash:w.content_hash,character_id:w.character_id,chat_id:w.chat_id,character_name:w.character_name,chat_name:w.chat_name,assistant_preview:w.assistant_preview,storage:"indexeddb",png_bytes:k.byteLength};return await Pe(P),{ok:!0,replaced:e,card:P}}async function Al({session_id:e="",content_hash:t="",message_index:n=-1}={}){const a=u(e,200),r=u(t,128),s=j(n,-1);if(!a&&!r&&s<0)return{ok:!1,error:{code:"bad_request",message:"session_id or content_hash required"}};const i=await ue("cards"),o=[];for(const m of i){if(a&&m.session_id!==a)continue;const y=nt(m.meta_json||"{}",{}),_=await Fe(m.id,y),k=u(_.content_hash||y.content_hash||"",128),M=j(_.message_index,-1);if(r){if(k!==r)continue}else if(s>=0){if(M!==s)continue}else continue;const S=_.y_percent??y.y_percent??y.anchor_percent??y.read_percent,x=Number(S);o.push({row:m,y:Number.isFinite(x)?x:999,shot:j(m.shot_index,0),paragraph:j(m.paragraph??_.paragraph,0)})}if(o.sort((m,y)=>m.y-y.y||m.shot-y.shot||m.paragraph-y.paragraph),!o.length)return{ok:!1,error:{code:"not_found",message:"no cards for message"}};const c=a||u(o[0]?.row?.session_id||"",200),l={session_id:c,content_hash:r,message_index:s},d=await pa(l,c);if(d)return d;const g=bn(l,c);Tn.add(g);const p=[],f=[],h=[];try{for(const m of o){const y=m.row;try{const _=await Yr(y.id,"nai",null,{skipBusyCheck:!0});if(_?.busy){h.push({id:y.id,error:_.error?.message||"busy"});break}_?.ok&&_.card?(p.push(_.card),_.replaced&&f.push(_.replaced)):h.push({id:y.id,error:u(_?.error?.message||"reroll failed",400)})}catch(_){h.push({id:y.id,error:u(_?.message||_,400)})}}return{ok:p.length>0,count:p.length,replaced:f,cards:p,failed:h}}finally{Tn.delete(g)}}function Zr(e){return Array.isArray(e.characters)?e.characters.map(t=>t&&typeof t=="object"?t.raw||t:null).filter(Boolean):[]}var Nl=Ht({HASH_REBIND_THRESHOLD:()=>Cl,PREFIX_MATCH_MIN_CHARS:()=>24,PREFIX_MATCH_THRESHOLD:()=>jl,SIMILARITY_COMPARE_MAX:()=>800,VIEWER_THUMB_LAYOUT:()=>W,activeSegmentIndex:()=>xu,bigramCounts:()=>ba,clampPinPercent:()=>Ae,clampReadingPercent:()=>vu,clampThumbScrollOffset:()=>fu,composeDualProgressBarsHtml:()=>bu,composeStickyThumbHtml:()=>ru,createDebouncedSaveQueue:()=>Xl,createScrollSettleTracker:()=>Yl,createSessionChangeGuard:()=>Zl,describeDomApiCompare:()=>Fl,diceBigramRatio:()=>es,evenAnchorPercent:()=>xa,findHashRebindCandidates:()=>Tl,galleryFocusMessage:()=>Ol,galleryForMessage:()=>Pl,galleryIndexFromChildIndex:()=>lu,gallerySelectedCount:()=>va,galleryStripContentWidth:()=>du,galleryStripSplitAt:()=>kn,hasGenerationInfo:()=>ss,isCharMessageRole:()=>Rl,isMessageSelectionGesture:()=>Gl,isNearbyDomIndex:()=>hu,linkCardsForMessage:()=>wa,longestCommonPrefixLength:()=>Qr,mergeViewerPaintJob:()=>_u,messageCompactKey:()=>xt,messageContextTriplet:()=>Dl,messagesTextOverlapScore:()=>is,nearbyDomIndexWindow:()=>pu,nearbyMessageImageIds:()=>mu,normalizeMatchText:()=>vn,normalizeMessageRole:()=>ya,parseAutotagLookJson:()=>us,pickMessageIndexNearPoint:()=>ql,pinPercentToPx:()=>Jl,pinPercentToPxFromBottom:()=>Kl,pinPxToPercent:()=>os,prefixMatchRatio:()=>ts,rawMessageRole:()=>xn,readingPercentInMessage:()=>ds,rebindGalleryMessageIndexes:()=>zl,resolveCardAnchorPercent:()=>wu,resolveChatMessageMatch:()=>Ul,resolveClickSelectionAction:()=>Wl,resolveIndexProgress:()=>yu,resolveStickyThumbPct:()=>nu,resolveStoredPinPercent:()=>Hl,roleFromGenerationInfo:()=>Bl,scaleInlineThumbnail:()=>$l,shouldKeepStickyThumbHidden:()=>tu,shouldRefreshGallery:()=>Ql,shouldRewriteStickyThumb:()=>eu,shouldSelectMessageByTextDrag:()=>Vl,stickyCornerEdgeBox:()=>cs,stickyCornerImageBox:()=>iu,stickyPinEdgeBox:()=>cu,stickyPinOverImage:()=>ou,stickyThumbBoxFromPct:()=>au,stickyThumbNeedsHtmlPaint:()=>su,thumbIndexAtStripX:()=>uu,visibleGalleryImageIds:()=>gu}),Il=528,El=720;function b(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Xr(e,t){const n={...e};for(const[a,r]of Object.entries(t||{})){const s=n[a];n[a]=r&&typeof r=="object"&&!Array.isArray(r)?Xr(s&&typeof s=="object"?s:{},r):r}return n}function $l(e){const t=Math.max(1,b(e,100));return{width:Math.max(1,Math.round(Il*t/100)),height:Math.max(1,Math.round(El*t/100)),percent:t}}function vn(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}var jl=.6,Cl=.6,ed=24,td=800;function ya(e){const t=String(e||"").toLowerCase().trim();return t?t==="char"||t==="assistant"||t==="bot"?"char":t==="user"||t==="human"?"user":t:""}function Qr(e,t){const n=String(e||""),a=String(t||""),r=Math.min(n.length,a.length);let s=0;for(;s<r&&n.charCodeAt(s)===a.charCodeAt(s);)s+=1;return s}function ba(e){const t=String(e||""),n=new Map;if(t.length<2)return n;for(let a=0;a<t.length-1;a+=1){const r=t.charCodeAt(a)+","+t.charCodeAt(a+1);n.set(r,(n.get(r)||0)+1)}return n}function es(e,t,n=null){const a=String(e||""),r=String(t||"");if(!a||!r)return 0;if(a===r)return 1;if(a.length<2||r.length<2)return 0;const s=n||ba(a),i=ba(r);let o=0;for(const[d,g]of i){const p=s.get(d)||0;p&&(o+=Math.min(p,g))}const c=a.length-1,l=r.length-1;return 2*o/(c+l)}function ts(e,t){const n=vn(e),a=vn(t);if(!n||!a)return 0;const r=Math.max(n.length,a.length);if(r<24)return 0;if(n===a)return 1;const s=Qr(n,a)/r;return s>=.6?s:es(n.length>800?n.slice(0,800):n,a.length>800?a.slice(0,800):a)}function wa(e,t){if(!t)return[];const n=Array.isArray(e)?e:[],a=String(t.hash||"");return a?rs(n.filter(r=>r?.content_hash&&r.content_hash===a)):[]}function Tl(e,t={}){const n=Array.isArray(e)?e:[],a=String(t.newHash||t.hash||""),r=String(t.text||""),s=String(t.characterId||""),i=String(t.chatId||""),o=String(t.sessionId||""),c=Number(t.messageIndex),l=ya(t.role||t.messageRole||"");if(!a||!r||!s||!l||!Number.isFinite(c)||c<0)return[];if(n.some(g=>g?.content_hash&&g.content_hash===a))return[];if(vn(r).length<24)return[];const d=[];for(const g of n){const p=String(g?.content_hash||"");if(!p||p===a||String(g?.character_id||"")!==s)continue;const f=String(g?.chat_id||""),h=String(g?.session_id||"");if(i){if(f!==i)continue}else if(o){if(h&&h!==o)continue}else continue;if(Number(g?.message_index)!==c)continue;const m=ya(g?.message_role||g?.role||"");if(!m||m!==l)continue;const y=String(g?.assistant_preview||"");if(!y)continue;const _=ts(r,y);_<.6||d.push({card:g,score:_})}return d.sort((g,p)=>p.score-g.score||b(p.card?.created_at)-b(g.card?.created_at)),rs(d.map(g=>g.card))}function ns(e){const t=e?.y_percent??e?.anchor_percent??e?.read_percent,n=Number(t);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function Ll(e,t){return ns(e)-ns(t)||b(e?.paragraph)-b(t?.paragraph)||b(e?.shot_index)-b(t?.shot_index)||b(t?.created_at)-b(e?.created_at)}function as(e,t){return b(t?.created_at)-b(e?.created_at)||b(t?.message_index)-b(e?.message_index)||b(t?.paragraph)-b(e?.paragraph)||b(t?.shot_index)-b(e?.shot_index)}function rs(e){const t=new Map;for(const n of e||[]){const a=`${n?.paragraph??"?"}|${n?.shot_index??n?.id}`,r=t.get(a);(!r||b(n?.created_at)>=b(r?.created_at))&&t.set(a,n)}return[...t.values()]}function Pl(e,t,n=8){const a=new Map;for(const d of e||[]){const g=String(d?.id||"");!g||a.has(g)||a.set(g,d)}const r=[...a.values()],s=Math.max(0,Math.min(64,b(n,8)||8));if(!t)return r.sort(as).slice(0,Math.max(1,s||8));const i=wa(r,t).sort(Ll),o=new Set(i.map(d=>String(d.id))),c=String(t.sessionId||""),l=r.filter(d=>!o.has(String(d.id))).filter(d=>!c||!d?.session_id||d.session_id===c).sort(as).slice(0,s);return[...i,...l]}function va(e,t){return t?wa(e,t).length:0}function Ol(e,t,n){return e&&va(n,e)>0?e:t&&va(n,t)>0?t:e||t||null}function xn(e){const t=String(e?.role||e?.type||e?.speaker||e?.sender||e?.from||e?.name||"").trim().toLowerCase();return e?.isUser===!0||e?.fromUser===!0||/^(user|human|player|you|me)$/.test(t)||t.includes("user")?"user":e?.isAssistant===!0||e?.isBot===!0||e?.isChar===!0||/^(assistant|bot|char|character|model|ai)$/.test(t)||t.includes("assistant")||t.includes("bot")||t.includes("char")?"char":t==="system"||t==="developer"?"system":""}function ss(e){const t=e?.generationInfo??e?.generation_info??e?.messageGenerationInfo;return t==null?!1:typeof t=="string"?t.trim().length>0:typeof t=="object"?Object.keys(t).length>0:!0}function Bl(e){return ss(e)?"char":"user"}function Rl(e){if(e&&typeof e=="object")return xn(e)==="char";const t=String(e||"").trim().toLowerCase();return t==="char"||t==="assistant"||t==="bot"}function xt(e,t=48){const n=Math.max(1,b(t,48));return String(e||"").replace(/\s+/g,"").slice(0,n)}function Dl(e,t,n=48){const a=Array.isArray(e)?e:[],r=Math.floor(b(t,-1)),s=r>=0&&r<a.length?a[r]:null,i=r>0?a[r-1]:null,o=r>=0&&r<a.length-1?a[r+1]:null;return[xt(i?.text,n),xt(s?.text,n),xt(o?.text,n),xn(s)||String(s?.role||"").trim().toLowerCase()].join("|")}function is(e,t){const n=String(e||"").replace(/\s+/g,""),a=String(t||"").replace(/\s+/g,"");if(!n||!a)return 0;if(n.includes(a))return a.length;if(a.includes(n))return n.length;let r=0;const s=(o,c,l=8,d=512)=>{let g=l,p=Math.min(o.length,d),f=0;for(;g<=p;){const h=g+p>>1;c.includes(o.slice(0,h))?(f=h,g=h+1):p=h-1}return f};r=Math.max(r,s(a,n),s(n,a));const i=Math.min(a.length,2400);for(let o=0;o+8<=i;o+=32){const c=Math.min(64,i-o);for(let l=c;l>=8;l-=8)if(n.includes(a.slice(o,o+l))){r=Math.max(r,l);break}}return r}function Fl(e,t){const n=String(e||""),a=String(t||""),r=xt(n),s=xt(a),i=is(n,a),o=i>=8,c=r.length>0&&r.length<8&&r===s,l=s.slice(0,48),d=r.slice(0,48);return{domChars:n.length,apiChars:a.length,domCompactChars:r.length,apiCompactChars:s.length,shareScore:i,overlap:o,shortExact:c,apiInDom:!!(l&&l.length>=8&&r.includes(l)),domInApi:!!(d&&d.length>=8&&s.includes(d)),apiKey:l,domKey:d}}function zl(e,t,n){const a=Array.isArray(t)?t:[],r=typeof n=="function"?n:null,s=new Map;if(r)for(let o=0;o<a.length;o+=1){const c=String(a[o]?.text??a[o]?.data??a[o]?.content??""),l=String(r(c)||"");if(!l)continue;const d=Number.isFinite(Number(a[o]?.index))?Number(a[o].index):o,g=s.get(l);g?g.push(d):s.set(l,[d])}let i=0;return{cards:(Array.isArray(e)?e:[]).map(o=>{const c=String(o?.content_hash||""),l=c?s.get(c):void 0;return!c||!l?o:l.length!==1?Number(o?.message_index)!==-1?(i+=1,{...o,message_index:-1}):o:Number(o?.message_index)!==l[0]?(i+=1,{...o,message_index:l[0]}):o}),changed:i}}function Ul(e,t,n,a,r){const s=Array.isArray(t)?t:[],i=Math.floor(b(n,-1)),o=(d,g,p,f=-1)=>({chatIndex:Number.isFinite(Number(d?.index))?Number(d?.index):f>=0?f:i,text:String(d?.text||e||""),role:xn(d)||String(d?.role||"").trim().toLowerCase(),matchMethod:g,score:p});if(!s.length)return{chatIndex:Math.max(0,i),text:String(e||""),role:"",matchMethod:"fallback",score:0};const c=s.length-1-i;if(c>=0&&c<s.length)return o(s[c],"reverse",100,c);const l=Math.max(0,Math.min(s.length-1,c));return o(s[l],"reverse",50,l)}function Ae(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(100,Math.floor(n))):Math.max(0,Math.min(100,Math.floor(b(t,0))))}function Jl(e,t,n=22,a=4){const r=Math.max(1,b(t,1)),s=Math.max(1,b(n,1)),i=Math.max(0,b(a,0)),o=Math.floor(r*Ae(e,0)/100);return Math.max(i,Math.min(r-s-i,o))}function Kl(e,t,n=22,a=8){const r=Math.max(1,b(t,1)),s=Math.max(1,b(n,1)),i=Math.max(0,b(a,0)),o=r-Math.floor(r*Ae(e,0)/100)-s;return Math.max(i,Math.min(r-s-i,o))}function os(e,t){const n=Math.max(1,b(t,1));return Ae(b(e,0)/n*100,0)}function Hl(e,t,n,a=null){const r=a&&typeof a=="object"?a:{x:38,y:80},s=t==="y"||t==="Y",i=s?b(r.y,80):b(r.x,38),o=s?"overlay_y_pct":"overlay_x_pct",c=s?"overlay_y_offset":"overlay_x_offset",l=String(e?.overlay_pin_origin||""),d=l==="top"||l==="tl"||l==="top-left",g=e?.[o],p=g!=null&&Number.isFinite(Number(g)),f=Number(e?.[c]),h=Number.isFinite(f),m=y=>Ae(100-Number(y),i);return p?s&&d?m(g):Ae(g,i):h?s?Ae((b(n,1)-f)/Math.max(1,b(n,1))*100,i):os(f,n):Ae(i,i)}function ql(e,t,n=null,a=800){const r=Array.isArray(e)?e:[];if(!r.length)return-1;const s=Math.max(1,b(a,800)),i=Number.isFinite(Number(t))?Number(t):s*.5,o=Number.isFinite(Number(n))?Number(n):null;let c=-1,l=1/0,d=-1,g=1/0;for(let p=0;p<r.length;p+=1){const f=r[p];if(!f)continue;const h=b(f.top,0),m=b(f.bottom,h);if(m<=0||h>=s)continue;const y=(h+m)*.5,_=Number.isFinite(Number(f.left))&&Number.isFinite(Number(f.right))?(Number(f.left)+Number(f.right))*.5:null,k=_!=null&&o!=null?Math.hypot(_-o,y-i):Math.abs(y-i);k<g&&(g=k,d=p);const M=i>=h&&i<=m,S=o==null||!Number.isFinite(Number(f.left))||!Number.isFinite(Number(f.right))||o>=Number(f.left)&&o<=Number(f.right);if(M&&S){const x=Math.max(1,m-h);x<l&&(l=x,c=p)}}return c>=0?c:d}function Gl({gesture:e="single",detail:t=1,movement:n=0,textSelecting:a=!1,excludedTarget:r=!1}={}){const s=e==="double"?2:1;return!r&&!a&&b(n,1/0)<=8&&b(t)===s}function Wl({gesture:e="single",detail:t=1,pendingDomIndex:n=null,targetDomIndex:a=null}={}){const r=b(t,1);return e==="double"?r===1?{action:"provisional",pendingDomIndex:a}:r===2?{action:"confirm",clearPending:!0,matchedPending:n!=null&&Number(n)===Number(a)}:{action:"ignore"}:r===1?{action:"confirm",clearPending:!0}:{action:"ignore"}}function Vl({enabled:e=!0,movement:t=0,hasSelection:n=!1,excludedTarget:a=!1}={}){return!!e&&!a&&!!n&&b(t,0)>8}function Yl({delayMs:e=160,onSettle:t}={}){let n=null;const a=Math.max(0,b(e,160)),r=()=>{n=null,typeof t=="function"&&t()};return{bump(){n&&clearTimeout(n),n=setTimeout(r,a)},settleNow(){n&&clearTimeout(n),n=null,r()},cancel(){n&&clearTimeout(n),n=null},get pending(){return n!=null}}}function Zl(e=""){let t=String(e||""),n="",a=0;return{observe(r){const s=String(r||"");return!s||s===t?(n="",a=0,!1):s!==n?(n=s,a=1,!1):(a+=1,a<2?!1:(t=n,n="",a=0,!0))},current(){return t},reset(r=""){t=String(r||""),n="",a=0}}}function Xl(e,t=300){let n={},a=null,r=null;const s=async()=>r||(r=(async()=>{for(;Object.keys(n).length;){const i=n;n={},await e(i)}})().finally(()=>{r=null}),r);return{enqueue(i){n=Xr(n,i),a&&clearTimeout(a),a=setTimeout(()=>{a=null,s().catch(()=>{})},Math.max(0,b(t,300)))},async flush(){a&&(clearTimeout(a),a=null);do await s();while(Object.keys(n).length||r)},hasPending(){return!!a||!!r||Object.keys(n).length>0}}}function Ql(e,t){const n=Array.isArray(e)?e.map(String):[],a=Array.isArray(t)?t.map(String):[];if(n.length!==a.length)return!0;for(let r=0;r<n.length;r+=1)if(n[r]!==a[r])return!0;return!1}function eu(e,t){return String(e||"")!==String(t||"")}function tu(e,t,n){if(!e)return!1;const a=String(t||""),r=String(n||"");return!!a&&!!r&&a===r}function nu(e){if(!e.alwaysOn||e.userCollapsed||e.editorOpen)return 0;const t=b(e.settingsPct,0);return t>0?t:0}function au(e,t,n){const a=Math.max(0,b(e,0)),r=Math.max(0,b(t,0)),s=Math.max(0,b(n,0));return{pct:a,w:Math.max(0,Math.round(r*a/100)),h:Math.max(0,Math.round(s*a/100))}}function ru(e,t=""){const n=typeof e=="string"?e:"";return n?`<img src="${n}" style="width:100%;height:100%;object-fit:cover;display:block" />`:'<div style="width:100%;height:100%;background:#0b0f18"></div>'}function su(e,t,n,a){const r=typeof t=="string"?t:"";return r?String(e||"")!==r||String(n||"")!==String(a||""):!1}function iu(e,t,n,a=16){const r=Math.max(1,Math.round(b(t?.w,1))),s=Math.max(1,Math.round(b(t?.h,1))),i=Math.max(r,Math.round(b(n?.width,r))),o=Math.max(s,Math.round(b(n?.height,s))),c=Math.max(0,Math.round(b(a,16))),l=String(e||"bottom-right");return{left:l.includes("left")?c:Math.max(c,i-r-c),top:l.includes("top")?c:Math.max(c,o-s-c),w:r,h:s}}function cs(e,t,n=16){const a=Math.max(1,Math.round(b(t?.w,1))),r=Math.max(1,Math.round(b(t?.h,1))),s=Math.max(0,Math.round(b(n,16))),i=String(e||"bottom-right");return{w:a,h:r,top:i.includes("top")?s:null,bottom:i.includes("bottom")?s:null,left:i.includes("left")?s:null,right:i.includes("right")?s:null}}function ou(e,t=28,n=6){const a=Math.round(b(e?.left,0)),r=Math.round(b(e?.top,0)),s=Math.max(1,Math.round(b(e?.w,1))),i=Math.max(1,Math.round(b(t,28))),o=Math.max(0,Math.round(b(n,6)));return{left:Math.round(a+(s-i)/2),top:r-o}}function cu(e,t,n=28,a=6,r=16){const s=cs(e,t,r),i=Math.max(1,Math.round(b(n,28))),o=Math.max(0,Math.round(b(a,6))),c=s.left!=null?s.left:s.right,l=Math.round(b(c,0)+(s.w-i)/2);return{size:i,top:s.top!=null?Math.round(s.top-o):null,bottom:s.bottom!=null?Math.round(s.bottom+s.h+o):null,left:s.left!=null?l:null,right:s.right!=null?l:null}}var W=Object.freeze({width:64,height:88,gap:8,splitWidth:16,splitExtraMargin:4});function kn(e,t){const n=Math.max(0,Math.floor(b(t,0))),a=Math.max(0,Math.min(Math.floor(b(e,0)),n));return a>0&&a<n?a:0}function lu(e,t,n){const a=Math.max(0,Math.floor(b(n,0))),r=Math.floor(b(e,-1));if(r<0||a<=0)return-1;const s=kn(t,a);if(s<=0)return r<a?r:-1;if(r===s)return-1;const i=r>s?r-1:r;return i>=0&&i<a?i:-1}function uu(e,{count:t=0,selectedCount:n=0,thumbWidth:a=W.width,gap:r=W.gap,splitWidth:s=W.splitWidth,splitExtraMargin:i=W.splitExtraMargin}={}){const o=Math.max(0,Math.floor(b(t,0)));if(o<=0)return-1;const c=b(e,NaN);if(!Number.isFinite(c)||c<0)return-1;const l=Math.max(1,b(a,W.width)),d=Math.max(0,b(r,W.gap)),g=Math.max(0,b(s,W.splitWidth)),p=Math.max(0,b(i,W.splitExtraMargin)),f=kn(n,o),h=[];for(let y=0;y<o;y+=1)f>0&&y===f&&h.push({type:"split"}),h.push({type:"thumb",galIdx:y,marginLeft:f>0&&y===f?p:0});let m=0;for(let y=0;y<h.length;y+=1){y>0&&(m+=d);const _=h[y];if(_.type==="split"){if(c>=m&&c<m+g)return-1;m+=g;continue}if(m+=_.marginLeft,c>=m&&c<m+l)return _.galIdx;m+=l}return-1}function du({count:e=0,selectedCount:t=0,thumbWidth:n=W.width,gap:a=W.gap,splitWidth:r=W.splitWidth,splitExtraMargin:s=W.splitExtraMargin}={}){const i=Math.max(0,Math.floor(b(e,0)));if(i<=0)return 0;const o=Math.max(1,b(n,W.width)),c=Math.max(0,b(a,W.gap)),l=Math.max(0,b(r,W.splitWidth)),d=Math.max(0,b(s,W.splitExtraMargin)),g=kn(t,i),p=i+(g>0?1:0);let f=i*o+Math.max(0,p-1)*c;return g>0&&(f+=l+d),f}function fu(e,t,n){const a=Math.max(0,b(t,0)-Math.max(0,b(n,0))),r=b(e,0);return Math.max(0,Math.min(a,r))}function gu(e,t=0,n=1,a=8,r=0){const s=Array.isArray(e)?e:[];if(!s.length)return[];const i=Math.max(0,Math.min(b(t,0),s.length-1)),o=Math.max(1,Math.min(s.length,b(a,8)||8)),c=Math.min(o,1+2*Math.max(0,b(n,1))),l=Math.max(c,o);let d=Math.max(0,i-Math.floor((l-1)/2));const g=Math.min(s.length-1,d+l-1);d=Math.max(0,g-l+1);const p=[],f=new Set,h=y=>{const _=String(s[y]?.id||"");!_||f.has(_)||(f.add(_),p.push(_))},m=Math.max(0,Math.min(s.length,b(r,0)));for(let y=0;y<m;y+=1)h(y);for(let y=d;y<=g&&(h(y),!(p.length>=o));y+=1);return p}function mu(e,t,n=2,a=[]){const r=Array.isArray(e)?e:[],s=Math.max(0,Math.min(8,b(n,2))),i=b(t?.messageIndex??t?.message_index,NaN),o=String(t?.sessionId||t?.session_id||""),c=String(t?.chatId||t?.chat_id||""),l=String(t?.hash||""),d=new Set,g=[],p=f=>{const h=String(f||"");!h||d.has(h)||(d.add(h),g.push(h))};for(const f of a||[])p(f);for(const f of r){if(!f?.id||o&&f.session_id&&String(f.session_id)!==o||c&&f.chat_id&&String(f.chat_id)!==c)continue;const h=b(f.message_index,NaN);if(Number.isFinite(i)&&Number.isFinite(h)){Math.abs(h-i)<=s&&p(f.id);continue}l&&String(f.content_hash||"")===l&&p(f.id)}return g}function hu(e,t,n=2){const a=b(e,NaN),r=b(t,NaN);if(!Number.isFinite(a)||!Number.isFinite(r))return!1;const s=Math.max(0,b(n,2));return Math.abs(a-r)<=s}function pu(e,t,n=2){const a=Math.max(0,Math.floor(b(t,0))),r=Math.max(0,Math.min(Math.max(0,a-1),Math.floor(b(e,0)))),s=Math.max(0,Math.floor(b(n,2)));return a<=0?{lo:0,hi:-1,center:0}:{lo:Math.max(0,r-s),hi:Math.min(a-1,r+s),center:r}}var ls={chrome:1,content:2,full:3};function _u(e,t){const n=ls[String(e??"")]||0,a=ls[String(t??"")]||0;return!n&&!a?"full":a>=n?t||e||"full":e||t||"full"}function us(e){const t=String(e||"").trim();if(!t)return{appearance:"",attire:"",accessories:"",text:""};let n=null;const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i),r=(a?a[1]:t).trim().match(/\{[\s\S]*\}/);if(r)try{const i=JSON.parse(r[0]);n=i&&typeof i=="object"?i:null}catch{n=null}if(n&&typeof n=="object"){const i=String(n.appearance??n.look??n.identity??"").trim(),o=String(n.attire??n.clothing??n.outfit??"").trim(),c=String(n.accessories??n.accessory??n.props??"").trim();return{appearance:i,attire:o,accessories:c,text:[i,o,c].filter(Boolean).join(", ")}}const s=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,"").trim();return{appearance:s,attire:"",accessories:"",text:s}}function yu(e={}){const t=!!e.warmBusy,n=Math.max(0,Math.min(100,Math.round(b(e.warmPct,0)))),a=String(e.jobState||""),r=Math.max(0,Math.min(100,Math.round(b(e.jobPct,0))));return t?{pct:Math.max(t?6:0,n),busy:!0,label:"인덱싱"}:a==="tagging"?{pct:Math.max(6,r),busy:!0,label:"인덱싱"}:{pct:0,busy:!1,label:"인덱싱"}}function bu(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,a=Math.max(t?6:0,Math.min(100,Math.round(b(e.jobPct,0)))),r=Math.max(n?6:0,Math.min(100,Math.round(b(e.indexPct,0)))),s=e.error?"#f87171":"#7c6cff",i="#2dd4bf",o=(c,l)=>`<span style="display:block;height:5px;border-radius:999px;background:rgba(255,255,255,.08);overflow:hidden"><span style="display:block;height:100%;width:${c}%;background:${l};border-radius:inherit"></span></span>`;return`<span style="flex:0 0 132px;display:flex;flex-direction:column;gap:3px;justify-content:center">${o(a,s)}${o(r,i)}</span>`}function Sn(e){return Math.max(0,Math.min(100,b(e,0)))}function xa(e,t){const n=Math.max(1,b(t,1));return Math.max(0,Math.min(b(e,0),n-1))/n*100}function wu(e,t=0,n=1,a=null){if(a&&a.forceEven)return xa(t,n);const r=e?.y_percent??e?.anchor_percent??e?.read_percent,s=Number(r);return Number.isFinite(s)?Sn(s):xa(t,n)}function ds(e,t,n=.5){if(!e)return null;const a=Math.max(1,b(e.height,0)),r=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return r<b(e.top,0)||r>b(e.bottom,0)?null:Sn((r-b(e.top,0))/a*100)}function vu(e,t,n=.5){const a=ds(e,t,n);if(a!=null)return a;const r=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return b(e?.bottom,0)<r?100:0}function xu(e,t){const n=Array.isArray(e)?e:[];if(!n.length)return-1;const a=Sn(t),r=n.map(c=>Sn(c)),s=r.reduce((c,l,d)=>l<=20?c.concat(d):c,[]),i=s.length===1&&r[s[0]]>0?r.map((c,l)=>l===s[0]?1:c):r;if(i[0]>0&&a<i[0])return-1;let o=0;for(let c=0;c<i.length;c+=1)a>=i[c]&&(o=c);return o}function ka(){const e=ae(),t=e.events;return{last_stage:e.last_stage,events:Array.isArray(t)?t.slice(-20):[]}}async function ku(e){if(e){const t=$(),n={...e};u(n.api_key)&&(t.llm.api_key=u(n.api_key)),delete n.api_key,delete n.api_key_configured,u(n.service_account_json)&&(t.llm.service_account_json=u(n.service_account_json)),delete n.service_account_json,delete n.service_account_configured,Object.keys(n).length&&(t.llm=$e(t.llm,n)),await De()}try{const t=$().llm,n=hn(t.source),a=Qe(t.provider);return n==="custom"&&!Sr(t)?{ok:!1,message:a==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM Model/API key가 비어 있습니다. NovelAI 키가 아니라 태깅용 LLM 키를 넣으세요."}:(n==="main"||n==="aux")&&!Vt("runLLMModel")?{ok:!1,message:"RisuAI runLLMModel API를 사용할 수 없습니다."}:{ok:!0,message:`LLM ok (${n}): ${(await wn(t,[{role:"user",content:"Reply with exactly: ok"}])).slice(0,120)}`}}catch(t){return{ok:!1,message:String(t?.message||t)}}}async function Su(){const e=$().nai;if(Rt(e)==="comfy")try{if(!sa(e))return{ok:!1,message:"ComfyUI 워크플로 JSON이 없습니다.",debug:ae()};const t=mr({main:"test",neg:"test",captions:[{name:"",prompt:"char1"},{name:"",prompt:"char2"}],nai:e,seed:1}),n=hr(e.comfy_workflow_json,t),a=gr(e),{status:r,data:s}=await ia(`${a}/system_stats`,{method:"GET"});if(r>=400)return{ok:!1,message:`ComfyUI 연결 실패 (HTTP ${r}) · ${a}`,debug:ae()};const i=s?.devices?.[0]?.name||s?.system?.os||"ok";return{ok:!0,message:`ComfyUI ok · ${a} · nodes=${Object.keys(n).length} · ${i}`,debug:ka()}}catch(t){return v("comfy.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ae()}}if(!u(e.api_key))return{ok:!1,message:"NAI api_key missing",debug:ae()};try{const t=u(e.api_key);try{const n=Q("nai.test.anlas"),a=await fc(t);return n.end({message:"anlas ok"}),{ok:!0,message:`NAI token ok · Anlas=${JSON.stringify(a)}`,debug:ka()}}catch(n){const a=Ze(e.model||"nai-diffusion-4-5-full");return v("nai.test.anlas",{message:String(n?.message||n)},"warn"),{ok:!0,message:`NAI config present · model=${a} · anlas_skip=${n?.message||n}`,debug:ka()}}}catch(t){return v("nai.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ae()}}}async function Mu(){const e=$().nai,t=u(e.api_key);if(!t)return{ok:!1,message:"NAI api_key missing",debug:ae()};const n=String(ae().job_ctx??"");Qt("probe-nai");const a=Q("nai.probe");try{v("nai.probe.start",{message:"tiny generate"});const r={prompt:"1girl, solo, simple background, best quality",negative_prompt:"lowres, bad quality",width:512,height:768,steps:10,cfg_scale:5,cfg_rescale:0,sampler:"k_euler_ancestral",scheduler:"karras",model:Ze(e.model||"nai-diffusion-4-5-full"),var_plus:!1,characters:[],seed:Math.floor(Math.random()*4294967295)||1},s=u(e.request_url)||"https://image.novelai.net/ai/generate-image",i=await pr(t,r,s,{timeoutMs:9e4}),o=i.raw_bytes.byteLength,c=At(re(i.raw_bytes));return a.end({bytes:o,is_png:c,seed:i.seed}),{ok:!0,message:`probe ok · png=${c} · ${o}B · seed=${i.seed}`,bytes:o,is_png:c,seed:i.seed,debug:ae()}}catch(r){return a.fail(r),{ok:!1,message:String(r?.message||r),debug:ae()}}finally{Qt(n)}}async function Au(e,t){if(!e?.byteLength)throw new Error("image is empty");const n=await Qi(e),a=n.bytes,r=n.mime||"image/png",s=n.filename||"image.png",i=`data:${r};base64,${await Je(a)}`,o=nn(await me("autotag"))||["Tag ONE character reference image into Danbooru-style English prompts.",'Return ONE JSON object only: {"appearance":"...","attire":"...","accessories":"..."}.',"appearance = identity/hair/eyes/body (no clothes). attire = clothing only. accessories = jewelry/props/earbuds/etc."].join(`
`);v("autotag.start",{message:`llm-vision ${s} ${a.length}B`,bytes:a.length,focus:!0,source:hn($().llm.source)});const c=[{role:"system",content:o},{role:"user",content:[{type:"text",text:"Tag this character image. JSON only with appearance, attire, accessories."},{type:"image_url",image_url:{url:i}}]}];let l="";try{l=await wn($().llm,c)}catch(y){throw v("autotag.llm.fail",{message:String(y?.message||y)},"error"),new Error(`오토태그 LLM 실패: ${String(y?.message||y).slice(0,240)}`)}const d=us(l),g=u(d.appearance||"",4e3),p=u(d.attire||"",4e3),f=u(d.accessories||"",4e3),h=u(d.text||[g,p,f].filter(Boolean).join(", "),8e3);if(!g&&!p&&!f)throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");const m=h.split(",").map(y=>y.trim()).filter(Boolean);return v("autotag.done",{message:`app=${g.length} attire=${p.length} acc=${f.length}`,focus:!0}),{ok:!0,appearance:g,attire:p,accessories:f,tags:m,text:h,count:m.length,threshold:Number(t||.2),engine:"llm-vision"}}function Nu(e){const t=e.indexOf("?");if(t<0)return{pathname:e,query:{}};const n=e.slice(0,t),a=new URLSearchParams(e.slice(t+1)),r={};for(const[s,i]of a.entries()){const o=r[s];o===void 0?r[s]=i:Array.isArray(o)?o.push(i):r[s]=[o,i]}return{pathname:n,query:r}}function Jt(e,t,n=""){const a=e[t];return Array.isArray(a)?a[0]??n:a??n}function Iu(e,t={}){const n=u(e.auth_token,4e3);if(!n)return!0;const a=String(t.Authorization||t.authorization||"");let r=a.toLowerCase().startsWith("bearer ")?a.slice(7):a;if(r=r||String(t["X-Inlay-Nexus-Token"]||t["x-inlay-nexus-token"]||""),typeof r!="string"||r.length!==n.length)return!1;let s=0;for(let i=0;i<n.length;i+=1)s|=r.charCodeAt(i)^n.charCodeAt(i);return s===0}var T=(...e)=>t=>e.includes(t)?"":null,Ne=e=>t=>t.startsWith(e)?t.slice(e.length):null,Sa=(e,t)=>n=>n.startsWith(e)&&n.endsWith(t)?n.slice(e.length,n.length-t.length):null,N=e=>({status:200,data:e}),Ma=e=>({status:200,data:e,contentType:"image/png",raw:!0}),Kt=e=>{throw ze(404,{ok:!1,...V(e,"not_found")},e)};function Aa(e){let t=e.image_b64||e.data||"";return typeof t=="string"&&t.startsWith("data:")&&(t=t.split(",",2)[1]??""),String(t||"")}var Eu=[{match:T("/v1/settings/export"),handler:()=>N({ok:!0,json:Ac()})},{match:T("/v1/settings"),handler:()=>N({ok:!0,settings:_n()})},{match:T("/v1/prompts"),handler:async()=>N({ok:!0,prompts:await Mc()})},{match:Ne("/v1/prompts/"),handler:async({param:e})=>N({ok:!0,key:e,text:await me(e)})},{match:Ne("/v1/jobs/"),handler:async({param:e})=>N(await xl(e))},{match:Ne("/v1/gallery/explore"),handler:async({query:e})=>N(await Wc(Number(Jt(e,"limit","400"))))},{match:T("/v1/gallery/favorites"),handler:async()=>N(await Br())},{match:Ne("/v1/gallery"),handler:async({query:e})=>N(await Vc(Jt(e,"session_id"),Number(Jt(e,"limit","40"))))},{match:T("/v1/nai/reference.png"),handler:async()=>Ma(await Er()??Kt("no reference"))},{match:T("/v1/nai/vibe.png"),handler:async()=>Ma(await Pc()??Kt("no vibe"))},{match:T("/v1/nai/reference"),handler:async()=>{const e=await jc();return N({ok:!0,configured:e,image_reference:$().nai?.image_reference||"none",preview_url:e?"/v1/nai/reference.png":""})}},{match:T("/v1/nai/vibe"),handler:async()=>{const e=await Tc();return N({ok:!0,configured:e,vibe_transfer:$().nai?.vibe_transfer||"none",preview_url:e?"/v1/nai/vibe.png":""})}},{match:Ne("/v1/characters"),handler:async({query:e})=>N(await Bt(Jt(e,"session_id"),Jt(e,"character_id")))},{match:Ne("/v1/appearance/"),handler:async({param:e})=>N(await Bt(e))},{match:Ne("/v1/images/"),handler:async({param:e})=>{let t=e.replace(/^\/+|\/+$/g,"");if(t.endsWith(".json")){const n=await et(t.slice(0,-5));return Object.keys(n).length||Kt("location missing"),N(n)}return t.endsWith(".png")&&(t=t.slice(0,-4)),Ma(await Rr(t)??Kt("image missing"))}}],$u=[{match:T("/v1/settings/reset"),handler:async()=>N(await Ic())},{match:T("/v1/settings/import"),handler:async({body:e})=>N(await Nc(String(e.json||e.text||"")))},{match:T("/v1/settings","/v1/settings/update"),handler:async({body:e})=>N(await $c(e))},{match:Sa("/v1/prompts/","/reset"),handler:async({param:e})=>N(await Nr(e,rn(e)))},{match:Ne("/v1/prompts/"),handler:async({param:e,body:t})=>N(await Nr(e,String(t.text||"")))},{match:T("/v1/jobs/create","/v1/jobs"),handler:async({body:e})=>({status:202,data:await Vr(e)})},{match:T("/v1/gallery/unlink","/v1/cards/unlink"),handler:async({body:e})=>N(await ga(String(e.session_id||""),String(e.content_hash||""),e.message_index))},{match:T("/v1/gallery/rebind-hash","/v1/cards/rebind-hash"),handler:async({body:e})=>N(await Yc({session_id:String(e.session_id||e.sessionId||""),card_ids:e.card_ids||e.ids||[],to_hash:String(e.to_hash||e.content_hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||"")}))},{match:T("/v1/gallery/delete","/v1/cards/delete"),handler:async({body:e})=>{const t=u(e.folder_key||"",400),n=u(e.card_id||e.id||"",80),a=Array.isArray(e.card_ids)?e.card_ids:null;if(t)return N(await tl(t));if(a?.length)return N(await Zc(a));if(n)return N(await ha(n));const r="card_id or folder_key required";throw ze(400,{ok:!1,...V(r,"bad_request")},r)}},{match:T("/v1/gallery/export"),handler:async({body:e})=>N(await Qc(e))},{match:T("/v1/gallery/import"),handler:async({body:e})=>N(await el(e))},{match:T("/v1/gallery/favorites"),handler:async({body:e})=>Array.isArray(e.ids)?N(await Xc(e.ids)):N(await Br())},{match:Sa("/v1/cards/","/tags"),handler:async({param:e,body:t})=>N(await Ml(e,t))},{match:Sa("/v1/cards/","/reroll"),handler:async({param:e,body:t})=>N(await Yr(e,String(t.mode||"nai"),t.overrides))},{match:T("/v1/messages/reroll","/v1/gallery/reroll-message"),handler:async({body:e})=>N(await Al({session_id:String(e.session_id||e.sessionId||""),content_hash:String(e.content_hash||e.contentHash||""),message_index:Number(e.message_index??e.messageIndex??-1)}))},{match:T("/v1/characters/global-toggles","/v1/characters/global_toggles"),handler:async({body:e})=>N(await Io(String(e.character_id||""),e.disabled_globals||e.disabled||[]))},{match:T("/v1/characters/unify","/v1/characters/merge"),handler:async({body:e})=>N(await lr(String(e.target_session_id||e.session_id||""),e.source_session_ids||e.session_ids||[],e.include_target!==!1))},{match:T("/v1/characters","/v1/characters/update"),handler:({body:e})=>ju(e)},{match:Ne("/v1/appearance/"),handler:async({param:e,body:t})=>t.characters!=null||t.global!=null?(t.characters!=null&&await Ot(e,t.characters||[],{prune:!0}),t.global!=null&&await Ot(Ie,t.global||[],{prune:!0}),N(await Bt(e))):N(await Po(e,t.appearance||{}))},{match:T("/v1/models/test"),handler:async({body:e})=>N(await ku(e.llm&&typeof e.llm=="object"?e.llm:null))},{match:T("/v1/nai/test"),handler:async()=>N(await Su())},{match:T("/v1/nai/probe","/v1/debug/probe-nai"),handler:async()=>N(await Mu())},{match:T("/v1/debug/clear"),handler:()=>(En(),N({ok:!0,cleared:!0}))},{match:T("/v1/nai/reference","/v1/nai/reference/upload"),handler:async({body:e})=>{if(e.clear)return N(await $r());const t=Aa(e);if(!u(t))throw new Error("image_b64 required");return N(await Cc(Y(Ee(t))))}},{match:T("/v1/nai/reference/clear"),handler:async()=>N(await $r())},{match:T("/v1/nai/vibe","/v1/nai/vibe/upload"),handler:async({body:e})=>{if(e.clear)return N(await Cr());const t=Aa(e);if(!u(t))throw new Error("image_b64 required");return N(await Oc(Y(Ee(t)),{model:e.model,information_extracted:e.information_extracted??e.vibe_transfer_information_extracted,strength:e.strength??e.vibe_transfer_strength}))}},{match:T("/v1/nai/vibe/clear"),handler:async()=>N(await Cr())},{match:T("/v1/autotag","/v1/autotag/evaluate"),handler:async({body:e})=>{const t=Aa(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=Ee(t);return N(await Au(Y(n),Number(e.threshold??.2)))}}];async function ju(e){const t=u(e.session_id||"",200),n=u(e.character_id||"",200),a=(Array.isArray(e.root_session_ids)?e.root_session_ids:Array.isArray(e.cascade_session_ids)?e.cascade_session_ids:[]).map(s=>u(s,200)).filter(Boolean);if("characters"in e&&t&&await Ot(t,e.characters||[],{prune:!0,rootSessionIds:a}),"global"in e&&await Ot(Ie,e.global||[],{prune:!0}),"character"in e){const s=u(e.scope||t||"__global__",200);a.length&&s!=="__global__"?await cr(a,[e.character||{}],""):await de(s,e.character||{})}const r=Array.isArray(e.root_delete)?e.root_delete:Array.isArray(e.cascade_delete)?e.cascade_delete:[];return r.length&&a.length&&await To(a,r,""),a.length&&t&&await lr(t,a,!1),N(await Bt(t,n))}async function fs(e,t){for(const n of e){const a=n.match(t.pathname);if(a!==null)return n.handler({...t,param:a})}return Kt(t.pathname)}async function Cu(e,t={}){const{pathname:n,query:a}=Nu(e),r=String(t.method||"GET").toUpperCase();let s;if(typeof t.body=="string")try{s=JSON.parse(t.body)}catch{s={}}else s=t.body??{};if(["/v1/health","/healthz","/readyz"].includes(n))return N({ok:!0,health:Ec()});if(n==="/v1/debug"||n==="/v1/debug/log")return r==="DELETE"||r==="POST"&&s.clear?(En(),N({ok:!0,cleared:!0})):N(ae());if(!Iu($(),t.headers||{})){const o="invalid token";throw ze(401,{ok:!1,...V(o,"unauthorized")},o)}const i={method:r,pathname:n,query:a,body:s};if(r==="GET")return fs(Eu,i);if(["POST","PUT","PATCH"].includes(r))try{return await fs($u,i)}catch(o){if(Pa(o))throw o;const c=String(o?.message||o);throw ze(500,{ok:!1,...V(c,"internal")},c)}throw ze(405,{ok:!1,...V(r,"method_not_allowed")},r)}var Mn=null;async function Tu(){v("boot.ready.start",{message:at}),await Le();const e=await ln().catch(a=>{throw v("boot.storage",{message:String(a?.message||a)},"error"),a});v("boot.storage",{message:e.kind}),Cn(await kc()),await Sc(),await Bo(),await Ro();const t=await R("meta","reference_image");t?.png&&Ln(dn(t.png));const n=await R("meta","vibe_transfer");n?.png&&Pn(dn(n.png)),v("boot.ready.done",{message:at,has_nativeFetch:Vt("nativeFetch"),has_idb:Vt("getLocalPluginStorage")})}async function Na(){return Mn||(Mn=Tu().catch(e=>{throw Mn=null,e})),await Mn,!0}async function Lu(e,t={},n=12e4){await Na();try{const a=await Cu(e,t);if(a.raw)return a.data;if(a.status>=400)throw ze(a.status,a.data);return a.data}catch(a){if(Pa(a))throw a;const r=String(a?.message||a);throw ze(500,{ok:!1,...V(r,"internal")},r)}}async function Pu(e){return await Na(),pt(e)}function Ou(){Ns(()=>({cards:Lt("cards"),images:Lt("images"),jobs:Lt("jobs"),blob_urls:wo()})),Reflect.set(globalThis,"__INLAY_NATIVE__",{VERSION:at,ready:Na,fetch:Lu,resolveImageUrl:_e,refPreviewUrl:Fa,vibePreviewUrl:za,ensureImageUrl:Pu,warmImages:Ao,pinImageUrls:Mo,warmProgress:xo,onWarmProgress:ko,debug:ae,clearDebug:En})}var Bu=Ht({applyExplorerClick:()=>Fu,clearSelection:()=>Uu,createSelectionState:()=>Ru,moveFocus:()=>Ju,reorderByIds:()=>qu,selectAll:()=>zu,sortExplorerItems:()=>Ku,thumbMinWidth:()=>Hu,visibleIds:()=>Du});function Ru(e=[]){return{selected:new Set((e||[]).map(String).filter(Boolean)),anchorId:"",focusId:""}}function Du(e=[]){return(e||[]).map(t=>String(t?.id||"")).filter(Boolean)}function Fu(e,t,{index:n,ids:a,shift:r=!1,ctrl:s=!1}={}){const i={selected:new Set(e?.selected||[]),anchorId:String(e?.anchorId||""),focusId:String(e?.focusId||"")},o=String(t||"");if(!o)return i;const c=Array.isArray(a)?a.map(String):[],l=typeof n=="number"&&Number.isFinite(n)?n:c.indexOf(o);if(r&&i.anchorId&&c.length){const d=c.indexOf(i.anchorId),g=l>=0?l:c.indexOf(o);if(d>=0&&g>=0){const p=Math.min(d,g),f=Math.max(d,g);return i.selected=new Set(c.slice(p,f+1)),i.focusId=o,i}}return s?(i.selected.has(o)?i.selected.delete(o):i.selected.add(o),i.anchorId=o,i.focusId=o,i):(i.selected=new Set([o]),i.anchorId=o,i.focusId=o,i)}function zu(e,t=[]){return{selected:new Set((t||[]).map(String).filter(Boolean)),anchorId:String(e?.anchorId||t?.[0]||""),focusId:String(e?.focusId||t?.[0]||"")}}function Uu(e=null){return{selected:new Set,anchorId:String(e?.anchorId||""),focusId:""}}function Ju(e=[],t="",n=1){const a=(e||[]).map(String).filter(Boolean);if(!a.length)return"";const r=a.indexOf(String(t||""));return r<0?a[0]:a[Math.max(0,Math.min(a.length-1,r+n))]}function Ku(e=[],t="newest"){const n=[...e||[]],a=(r,s=0)=>{const i=Number(r);return Number.isFinite(i)?i:s};return t==="oldest"?n.sort((r,s)=>a(r.created_at)-a(s.created_at)||String(r.id).localeCompare(String(s.id))):t==="message"?n.sort((r,s)=>a(r.message_index,1e9)-a(s.message_index,1e9)||a(r.shot_index)-a(s.shot_index)||a(s.created_at)-a(r.created_at)):t==="shot"?n.sort((r,s)=>a(r.shot_index)-a(s.shot_index)||a(r.message_index,1e9)-a(s.message_index,1e9)||a(s.created_at)-a(r.created_at)):n.sort((r,s)=>a(s.created_at)-a(r.created_at)||String(s.id).localeCompare(String(r.id)))}function Hu(e="m"){return e==="s"?96:e==="l"?200:148}function qu(e=[],t=[]){const n=s=>{const i=s&&typeof s=="object"?s.id:void 0;return String(i??s)},a=new Map((e||[]).map(s=>[n(s),s])),r=[];for(const s of t||[]){const i=String(s);a.has(i)&&(r.push(a.get(i)),a.delete(i))}for(const s of a.values())r.push(s);return r}function Gu(){Reflect.set(globalThis,"__INLAY_VIEWER_CORE__",{...Nl}),Reflect.set(globalThis,"__INLAY_LLM__",{...gc}),Reflect.set(globalThis,"__INLAY_LORE_EXTRA__",{...ol}),Reflect.set(globalThis,"__INLAY_EXPLORER__",{...Bu})}Gu(),Ou(),v("boot.loaded",{message:at})})();
...
var Zt = "inlay-nexus-native", ea = "Inlay Nexus", He = "2.0.13", rn = class extends Error {
  segment;
  constructor($) {
...
${(n.assistant_preview || "").slice(0, 120)}`)}">
  ...
  function Mt() {
    return document.getElementById("nx-power") ? {
      ...
      natural_base: N("nx-natural-base") || "short",
