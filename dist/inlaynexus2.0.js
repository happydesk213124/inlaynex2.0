...
globalThis.__INLAY_NATIVE_PROMPTS__ = {"__v":1,"__enc":""};

(function(){var Si=Object.defineProperty,T=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(r){throw n=[r],r}},fn=(e,t)=>{let n={};for(var r in e)Si(n,r,{get:e[r],enumerable:!0});return t||Si(n,Symbol.toStringTag,{value:"Module"}),n},qe,Ai,dn,Mi,Ve,Gr,Wr,Ee,mn,pn,gn,tr,nr,hn,_n,Dt,Ft,yn,Ni,Ii,Ei,Ci,Kl,$i,Ti,ji,Oi,ee=T((()=>{qe="2.1.4",Ai="2026-08-06-inline-line",dn=["author_note","tagger","format","prefill","preprocess","preset_1","lore_inject","char_inject","appearance_inject","asset_tags_inject","autotag","curation_refine","curation_embed_hint"],Mi=["tagger","format","appearance_inject","lore_inject","asset_tags_inject","autotag","curation_refine","curation_embed_hint"],Ve="__global__",Gr="inx_native_settings",Wr=e=>`inx_nxstore_${e}`,Ee=e=>`inx_nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,mn="inx_nxref_image",pn="inx_nxvibe_image",gn="inx_nxvibe_data",tr="inx_nx_curation_catalog",nr="inx_nx_curation_embeddings",hn=e=>`inx_nxvibe_p_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,_n=e=>`inx_nxvibe_pd_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,Dt=e=>`vibe_preset_${String(e)}`,Ft=e=>typeof e=="string"&&e.startsWith("vibe_preset_"),yn=e=>e.slice(12),Ni="native_settings",Ii=e=>`nxstore_${e}`,Ei=e=>`nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,Ci="nxref_image",Kl="https://image.novelai.net/ai/generate-image",$i="https://image.novelai.net/ai/encode-vibe",Ti="https://api.novelai.net/user/subscription",ji=["meta","cards","characters","jobs","images"],Oi=4e3}));function Ye(){const e=globalThis;return e.risuai??e.Risuai}function zt(e){return typeof Ye()?.[e]=="function"}var pt=T((()=>{}));function w(e,t={},n="info"){const r={t:Date.now(),iso:new Date().toISOString(),stage:String(e||""),level:n,job_id:bn||t.job_id||"",ms:t.ms!=null?Number(t.ms):void 0,bytes:t.bytes!=null?Number(t.bytes):void 0,status:t.status!=null?t.status:void 0,message:t.message!=null?Xr(t.message,240):void 0,detail:{}};for(const[i,o]of Object.entries(t))Pi.has(i)||(r.detail[i]=o==null||typeof o=="number"||typeof o=="boolean"?o:Xr(o,220));for(Ce.push(r);Ce.length>240;)Ce.shift();vn=r.stage,(t.focus||!t.background&&Di(r.stage))&&(rr=r.stage),n==="error"&&(wn={stage:r.stage,message:String(r.message??""),t:r.t});const a=`[InlayNX:${r.stage}]`+(r.message?` ${String(r.message)}`:"")+(r.ms!=null?` ${r.ms}ms`:"")+(r.bytes!=null?` ${r.bytes}B`:"");return n==="error"?console.error(a,r.detail):n==="warn"?console.warn(a,r.detail):console.log(a,r.detail),r}function ue(e){const t=Date.now();return{end:(n={},r="info")=>w(e,{...n,ms:Date.now()-t},r),fail:(n,r={})=>w(e,{...r,message:String(n?.message??n),ms:Date.now()-t},"error")}}function ge(){const e=Ye()??{};let t=null;try{t=typeof document<"u"?!!document.hidden:null}catch{}const n=Ce.slice(-80),r={};for(const a of n)r[a.stage]=(r[a.stage]??0)+1;return{ok:!0,version:qe,now:Date.now(),last_stage:vn,focus_stage:rr,last_error:wn,job_ctx:bn||null,env:{has_nativeFetch:typeof e.nativeFetch=="function",has_getLocalPluginStorage:typeof e.getLocalPluginStorage=="function",has_pluginStorage:!!e.pluginStorage?.getItem,has_DecompressionStream:typeof DecompressionStream=="function",has_AbortController:typeof AbortController<"u",document_hidden:t},counts:{events:Ce.length,...Vr?.()??{}},by_stage:r,errors:Ce.filter(a=>a.level==="error").slice(-20),events:n}}function qr(){return Ce.length=0,wn=null,vn="cleared",!0}var Pi,Ce,bn,wn,vn,rr,Vr,Li,xn,Bi,gt,kn,ar,Ri,Yr,Xr,Di,q=T((()=>{ee(),pt(),Pi=new Set(["ms","bytes","status","message","job_id","background","focus"]),Ce=[],bn="",wn=null,vn="boot",rr="boot",Vr=null,Li=e=>{Vr=e},xn=e=>{bn=e},Bi=()=>bn,gt=()=>rr,kn=()=>vn,ar=()=>wn,Ri=()=>Ce.length,Yr=(e,t)=>Ce.filter(n=>n.job_id===e).slice(-t),Xr=(e,t=280)=>{if(e==null||typeof e=="number"||typeof e=="boolean")return e;let n;if(typeof e=="string")n=e;else try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:`${n.slice(0,t)}…(+${n.length-t})`},Di=e=>e.startsWith("job.")||e.startsWith("nai.")||e.startsWith("llm.")||e.startsWith("image.")}));q();function ht(e,t,n){const r=t?.error?.message,a=new Error(n??r??`HTTP ${e}`);return a.status=e,a.data=t,a}var Fi=e=>e instanceof Error&&typeof e.status=="number",ae=(e,t="error")=>({error:{code:t,message:e}}),Xe,ir,_t=T((()=>{Xe=e=>new Promise(t=>setTimeout(t,e)),ir=class{tail=Promise.resolve();run(e){const t=this.tail.then(e,e);return this.tail=t.then(()=>{},()=>{}),t}}}));function Z(e){return e?e instanceof Uint8Array?e:new Uint8Array(e):new Uint8Array(0)}function Ut(e){const t=Z(e);let n="";for(let r=0;r<t.length;r+=Jt)n+=String.fromCharCode(...t.subarray(r,r+Jt));return btoa(n)}async function Ze(e){const t=Z(e);if(t.length<zi)return Ut(t);let n="";for(let r=0;r<t.length;r+=Jt)n+=String.fromCharCode(...t.subarray(r,r+Jt)),r>0&&r%(Jt*24)===0&&await Xe(0);return btoa(n)}function Gl(e){return e?Ut(e):""}async function Wl(e){return e?Ze(e):""}function Re(e){const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function ql(e){return e?Re(e).buffer:null}function te(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}function Sn(e,t){const n=new Uint8Array(t);let r=0;for(const a of e)n.set(a,r),r+=a.length;return n}function yt(e){return!!(e&&e.length>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)}function An(e){return!!(e&&e.length>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70&&e[8]===87&&e[9]===69&&e[10]===66&&e[11]===80)}function Mn(e){const t=Z(e);return An(t)?"image/webp":yt(t)?"image/png":t.length>=3&&t[0]===255&&t[1]===216&&t[2]===255?"image/jpeg":"image/png"}function Vl(e){const t=/^data:([^;,]+)?(;base64)?,(.*)$/i.exec(String(e||""));if(!t)return null;const n=!!t[2],r=t[3]||"";try{return te(n?Re(r):new TextEncoder().encode(decodeURIComponent(r)))}catch{return null}}var Jt,zi,Q=T((()=>{_t(),Jt=32768,zi=2e5}));function u(e,t=2e5){if(e==null)return"";let n=String(e).replace(/\x00/g," ").replace(/\r\n/g,`
`);return n=n.replace(/[ \t\f\v]+/g," ").replace(/\n{4,}/g,`


`).trim(),n.slice(0,t)}function P(e,t=-1){if(e==null||typeof e=="string"&&!e.trim())return t;const n=parseInt(String(e),10);return Number.isNaN(n)?t:n}function or(e){if(e==null||typeof e=="string"&&!e.trim())return null;const t=parseFloat(String(e));return Number.isNaN(t)?null:t}function Ui(e){const t=u(e);if(!t)return[];const n=[],r=/-?\d+(?:\.\d+)?::(?:(?!::).)*?::|[^,]+/g;let a;for(;(a=r.exec(t))!==null;){const i=a[0].trim();i&&n.push(i)}return n}function I(...e){const t=[],n=new Set;for(const r of e)for(const a of Ui(r)){const i=a.trim();if(!i)continue;const o=i.toLowerCase();o==="null"||o==="none"||n.has(o)||(n.add(o),t.push(i))}return t.join(", ")}function X(e){if(e==null)return[];let t;if(Array.isArray(e))t=e.map(a=>u(a,200));else{const a=u(e,2e3);t=a?a.split(/[,|/]|,(?=\s)|、|\//):[],t.length<=1&&a&&(t=a.split(/\n+/))}const n=[],r=new Set;for(const a of t){const i=u(a,200);if(!i)continue;const o=U(i);!o||r.has(o)||(r.add(o),n.push(i))}return n}function Yl(e){let t=0;for(let n=0;n<e.length;n+=1)t=Math.imul(31,t)+e.charCodeAt(n)|0;return t}function Xl(e){const t=u(e,1e6);let n=2166136261,r=2654435769;for(let a=0;a<t.length;a+=1){const i=t.charCodeAt(a);n^=i,n=Math.imul(n,16777619),r^=i+(n<<6|n>>>26),r=Math.imul(r,2246822507)}return`${(n>>>0).toString(16).padStart(8,"0")}${(r>>>0).toString(16).padStart(8,"0")}`}function Zl(e){const t=u(e??"",200);return t?`risu_${Xl(`${t}|__unified__`)}`:""}function sr(e){let t=e;for(let n=0;n<20;n+=1){const r=t.replace(/\{\{#when[\s\S]*?\}\}([\s\S]*?)\{\{\/when\}\}/g,"$1").replace(/\{\{#if[\s\S]*?\}\}([\s\S]*?)\{\{\/if\}\}/g,"$1").replace(/\{\{:else\}\}[\s\S]*?(?=\{\{\/)/g,"");if(r===t)break;t=r}return t.replace(/\{\{[^}]+\}\}/g,"").trim()}function Ql(e){const t=e.match(/\[Positive\]\s*([\s\S]*?)\s*\[Negative\]/),n=e.match(/\[Negative\]\s*([\s\S]*?)\s*$/);return t||n?[u(t?.[1]??""),u(n?.[1]??"")]:[u(e),""]}function bt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}var U,wt,Qe,D=T((()=>{U=e=>u(e,200).toLowerCase().replace(/\s+/g," "),wt=e=>u(e).toLowerCase().replace(/\s+/g,""),Qe=4e3})),eu,tu,nu,Ji,Hi,Ki,Gi,Wi,qi,Vi,Yi,Xi,Zi,ru=T((()=>{eu="",tu=0,nu="",Ji=[],Hi="indexeddb:getLocalPluginStorage",Ki="indexeddb:inx_nximg_*",Gi="embedded",Wi={backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",notes:"PNG/settings live on this device (not save-file). Folder explorer reads card+location metadata."},qi=JSON.parse(`{"power":true,"execute":"auto","mode":"illustration","image_min":3,"image_max":3,"character_max":2,"preset":1,"lorebook":true,"lore_extra":"tags","asset_nai_tags":false,"char_info":true,"user_info":true,"char_appearance":true,"preprocessing":false,"person_tag_mode":"gender","auto_person_tags":true,"person_tag_weight":3,"original_text":"","custom_pos":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","custom_neg":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth","presets":[{"id":"프리셋_닭장_0_14izz","name":"프리셋 1","positive":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","negative":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth"},{"id":"프리셋_농후_1_u4veg","name":"프리셋 2","positive":"2.0::artist:duoyuanjun::, artist:dawalixi, artist:m (1n910), 1.45::artist:murata yuusuke::, 1.4::artist:konya karasue::, 1.5::artist:wanke::, 2.3::artist:lunch(shin new)::, 0.8::artist:baffu::, 1.4::artist:ishigaki takashi::, 0.8::artist:xipa::, 0.8::artist:freng::, 0.5::artist:kim eb::, year 2025, year 2024, 0.5::3d, blender::, high detail, masterpiece, best quality, very aesthetic, highres, best illustration, novel illustration, -3::simple illustration::, -1::censored::, -3::artist collaboration::, detailed background, -1::door::","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration"},{"id":"프리셋_매끈_2_jgrz3","name":"프리셋 3","positive":"2.4::artist:uki_(ukikusaya) ::, 0.6::artist:sohn woohyoung::, 0.6::artist:minamoto (mutton) ::, artist:sakura no tomoru hi e, 0.5::artist:bettkan::, 0.4::artist:nanja::, 0.4::artist:joy boy \\\\(jerrydurd\\\\) ::, artist:freng, 0.2::artist:murata yuusuke::, 0.8::artist:mx2j::, artist:aoi nagisa (metalder), 0.2::artist:oda non::, 0.4::artist:lunch_(shin new) ::, 0.6::artist:duoyuanjun::, year 2025, year 2024, year 2023, solo artist, -5.3::artist collaboration::, -1::faux retro artstyle::, -1::film grain::, -1::clean text::, -1::flat color::, 1.2::3d::, blender(medium), 1.3::realistic::, natural, incredibly absurdres, very aesthetic, highres, masterpiece, best quality, amazing quality, -3::simple illustration::, best illustration, novel illustration, 0.06::best::, -1::ring::, 1.5::uncensored::, -2::censored::, -2::bar censor::, 2::shiny realistic skin::, 1.3::steaming body::,","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, character sheet, reference sheet, lineup, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration,"},{"id":"프리셋_닭_3_8yiw2","name":"프리셋 2-1","positive":"1.5::artist:sohn woohyoung::, 1.6::artist:solipsist::, 1.45::artist:gogalking::, 1.2::artist:oda non::, 1.25::artist:henriiku_(ahemaru) ::, 1.6::artist:Ask (Askzy) ::, 2.7::artist:jagercoke::, 2::artist:seven (sixplusone) ::, artist:wlop, 1.25::artist:wanke::, artist:seoyong, 0.7::artist:healthyman::, artist:freng, 1.2::artist:sos adult::, artist:shinjiro, 2::artist:nianbingzi::, artist:teshima nari, year 2024, year 2025, 2::blender (medium) ::, 2::pastel (medium) ::, -2::flat color::, pastel colors, 1.4::masterpiece, very aesthetic::, best quality, amazing quality, absurdres, 2::realistic::, -6::artist collaboration::, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, no text, -1.1::pubic hair::, uncensored,","negative":"natsuki karin, text, logo, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, sketch"},{"id":"프리셋_말랑_4_ian7o","name":"프리셋 말랑","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_깔_5_3rh46","name":"프리셋 깔","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_쫀_6_815h6","name":"프리셋 쫀","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::, 1.4::bedroom::, 1.2::sunlight::, 2.9::hotel::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"},{"id":"프리셋_리얼_7_xwn4c","name":"프리셋 리얼","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"}],"active_preset_id":"프리셋_닭장_0_14izz","include_min":0,"include_max":0,"userchat":false,"gallery_fab":false,"floating_viewer":true,"overlay_markers":true,"inline_chat_images":false,"progress_toast":false,"llm_anchor_percent":true,"natural_base":"short","composition_curation":false,"inline_previews":true,"inline_thumb_pct":100,"scale_semantics_version":2,"mobile_toggle_pin":false,"hover_preview":true,"hover_preview_anchor":"mouse","hover_preview_corner":"top-right","viewer_minimize_mode":"icon","unified_chat_priority":false,"overlay_hide_offscreen":true,"scroll_message_track":true,"click_message_track":true,"message_select_gesture":"single","text_drag_select":true,"show_risu_settings_button":true,"debug_panel":false,"generate_all_roles":false,"auto_gen_on_reply":false,"scroll_delay_ms":250,"capture_delay_ms":10,"overlay_x_pct":38,"overlay_y_pct":80,"overlay_pin_unit":"pct","overlay_pin_origin":"bl"}`),Vi={source:"custom",provider:"openrouter",endpoint:"https://openrouter.ai/api/v1/chat/completions",model:"openai/gpt-oss-20b:nitro",api_key:"",service_account_json:"",temperature:.4,max_tokens:8e3,timeout_seconds:180,reasoning_effort:"default",vertex_region:"us-central1",anthropic_version:"2023-06-01"},Yi={provider:"Novel AI",backend:"nai",request_url:"https://image.novelai.net/ai/generate-image",api_key:"",model:"nai-diffusion-4-5-full",width:832,height:1216,sampler:"k_euler_ancestral",scheduler:"karras",steps:28,cfg_scale:7,cfg_rescale:.36,seed:0,variety_plus:!1,enable_i2i:!1,image_reference:"none",image_reference_strength:.6,image_reference_fidelity:1,image_reference_type:"character&style",vibe_transfer:"none",vibe_transfer_strength:.6,vibe_transfer_information_extracted:1,uc_preset:"human_focus",apply_quality_tags:!1,comfy_url:"http://localhost:8188",comfy_workflow_json:"",backend_timeout_seconds:300},Xi={mode:"off",strict_ids:!1,embedding:{provider:"openai",model:"text-embedding-3-small",endpoint:"https://api.openai.com/v1/embeddings",api_key:""}},Zi={bind_host:"",port:0,auth_token:"",allowed_origins:Ji,database_path:Hi,images_dir:Ki,prompts_dir:Gi,storage:Wi,card:qi,llm:Vi,nai:Yi,curation:Xi}})),Qi,eo,to,no,au=T((()=>{Qi="nai-diffusion-4-full",eo="nai-diffusion-4-curated-preview",to="nai-diffusion-3",no={"naid4.5f":"nai-diffusion-4-5-full","naid4.5c":"nai-diffusion-4-5-curated",naid4f:Qi,naid4c:eo,naid3:to}})),iu,ro,ao,io,oo,so,co,lo,ou,uo,fo,mo,po,su=T((()=>{iu="",ro="Tag the chat message into Danbooru-style English image prompts. Output ONE JSON object only.",ao='{"scenes":[{"place":"...","shots":[{"paragraph":0,"y_percent":50,"line":1,"camera":"...","situation":"...","characters":[{"name":"...","action":"..."}]}]}],"new_characters":[]}',io=`Registered: {registered_block}
Incomplete: {incomplete_block}
Detected: {detected_block}`,oo=`NovelAI asset tags for new_characters:
{asset_tags_block}`,so="Use matched lorebook context:",co="Character info:",lo="Summarize visual details from the message.",ou="",uo=`[Positive]
, masterpiece, best quality

[Negative]
lowres, bad quality, watermark`,fo="Batch-refine ALL shots' scene tags from allowed curation option ids in ONE JSON response.",mo="Write detailed Danbooru scene tags for camera/situation/place/action.",po={author_note:"",tagger:ro,format:ao,appearance_inject:io,asset_tags_inject:oo,lore_inject:so,char_inject:co,preprocess:lo,prefill:"",preset_1:uo,curation_refine:fo,curation_embed_hint:mo}})),go,ho,_o,yo,cu=T((()=>{go=", no text, best quality, very aesthetic, absurdres",ho=", rating:general, amazing quality, very aesthetic, absurdres",_o=", best quality, amazing quality, very aesthetic, absurdres",yo={"naid4.5f":", location, very aesthetic, masterpiece, no text","naid4.5c":", location, masterpiece, no text, -0.8::feet::, rating:general",naid4f:go,naid4c:ho,naid3:_o}})),bo,wo,vo,xo,lu=T((()=>{bo={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, multiple views, logo, too many watermarks",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing",none:""},wo={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, logo, dated, signature, multiple views, gigantic breasts",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing, logo, dated, signature",none:""},vo={heavy:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]",light:"lowres, jpeg artifacts, worst quality, watermark, blurry, very displeasing",human_focus:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract], bad anatomy, bad hands, @_@, mismatched pupils, heart-shaped pupils, glowing eyes",none:""},xo={"naid4.5f":{heavy:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page",light:"lowres, artistic error, scan artifacts, worst quality, bad quality, jpeg artifacts, multiple views, very displeasing, too many watermarks, negative space, blank page",human_focus:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page, @_@, mismatched pupils, glowing eyes, bad anatomy",none:""},"naid4.5c":{heavy:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, negative space, blank page",light:"blurry, lowres, upscaled, artistic error, scan artifacts, jpeg artifacts, logo, too many watermarks, negative space, blank page",human_focus:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, bad anatomy, bad hands, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, @_@, mismatched pupils, glowing eyes, negative space, blank page",none:""},naid4f:bo,naid4c:wo,naid3:vo}})),et,ko,Nn,So,Ht=T((()=>{ru(),su(),cu(),lu(),et=Zi,ko=po,Nn=yo,So=xo}));function uu(e,t){const n=No().encode(t),r=new Uint8Array(e.length);for(let a=0;a<e.length;a+=1)r[a]=e[a]^n[a%n.length];return r}function fu(e){if(typeof Buffer<"u")return new Uint8Array(Buffer.from(e,"base64"));const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function du(e){if(!e||typeof e!="object")return{};const t=e;if(typeof t.__enc=="string"){if(Number(t.__v??1)!==Ao)return{};try{const r=Io().decode(uu(fu(t.__enc),Mo)),a=JSON.parse(r),i={};for(const[o,s]of Object.entries(a))typeof s=="string"&&(i[o]=s);return i}catch{return{}}}const n={};for(const[r,a]of Object.entries(t))typeof a=="string"&&(n[r]=a);return n}var Ao,Mo,No,Io,mu=T((()=>{Ao=1,Mo="inlay-nexus-prompt-pack-v1",No=()=>new TextEncoder,Io=()=>new TextDecoder}));function pu(){return du(globalThis.__INLAY_NATIVE_PROMPTS__)}function In(e){const t=u(pu()[e]);return t||ko[e]||""}var Eo=T((()=>{D(),Ht(),mu()}));function he(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e))}function tt(e,t){const n=he(e??{});for(const[r,a]of Object.entries(t??{})){const i=n[r];n[r]=Qr(a)&&Qr(i)?tt(i,a):a}return n}function Zr(e){const t=u(e).replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,""),n=t.slice(0,180).replace(/\s+/g," ");try{return JSON.parse(t)}catch{const r=t.match(/\{[\s\S]*\}/);if(!r)throw new Error(`태거 JSON 파싱 실패${n?` · 응답: ${n}`:" · 응답이 비어 있거나 JSON이 아님"}`);try{return JSON.parse(r[0])}catch(a){throw new Error(`태거 JSON 파싱 실패 · ${String(a?.message??a).slice(0,120)} · 응답: ${n}`)}}}var Qr,vt=T((()=>{D(),Qr=e=>!!e&&typeof e=="object"&&!Array.isArray(e)}));function C(){return ra}function cr(e){ra=e}function Co(){return aa}function ea(e){aa=e}function $o(){return ia}function ta(e){ia=e}function na(e){return fr.get(String(e||""))||""}function lr(e,t){const n=String(e||"");n&&(t?fr.set(n,t):fr.delete(n))}var ra,To,En,xt,ur,aa,ia,fr,_e=T((()=>{Ht(),_t(),vt(),ra=he(et),To=new ir,En=new Map,xt=new Map,ur=new Set,aa="",ia="",fr=new Map})),jo,gu=T((()=>{jo=["shirt","blouse","pants","trousers","jeans","shorts","skirt","dress","jacket","coat","hoodie","sweater","cardigan","vest","waistcoat","uniform","armor","robe","cloak","cape","apron","overalls","leggings","stockings","tights","pantyhose","socks","thighhighs","boots","shoes","heels","sandals","slippers","footwear","barefoot","gloves","mittens","hat","cap","beret","hood","scarf","necktie","bowtie","tie","belt","bra","panties","underwear","lingerie","swimsuit","bikini","kimono","yukata","hakama","cheongsam","hanbok","suit","tuxedo","collar","choker","mask","helmet","nude","naked","topless","bottomless","completely nude","open shirt","unbuttoned","unzipped","torn clothes","clothes","clothing","outfit","attire","sleeves","rolled-up sleeves","long sleeves","short sleeves","sleeveless","off shoulder","bare shoulder","bare shoulders","midriff","navel","cleavage","garter","corset","bodysuit","leotard","fishnets","ribbon","bow","bandana","no shirt","no pants","shirt lift","panties pull","skirt lift"]})),Oo,hu=T((()=>{Oo=["necklace","earring","earrings","bracelet","ring","pendant","brooch","watch","wristwatch","wristband","glasses","sunglasses","goggles","monocle","crown","tiara","veil","hair ribbon","hairpin","hair pin","scrunchie","hair ornament","airpods","earbuds","earbud","earphones","earphone","headphones","headset","in one ear","wireless earbuds"]})),Po,_u=T((()=>{Po=["bag","backpack","purse","handbag","briefcase","suitcase","pouch","satchel","badge","id card","lanyard","name badge","nameplate","sword","katana","knife","dagger","gun","pistol","rifle","spear","axe","staff","wand","blade","weapon","shield","crossbow","scythe","hammer","umbrella","phone","smartphone","book","clipboard","folder","cigarette","microphone","camera","holding"]}));function Kt(e){const t=V(e).toLowerCase();return t?["girl","female","f","woman","여자","여"].includes(t)?"girl":["boy","male","m","man","남자","남"].includes(t)?"boy":["other","unknown","unset","미정","기타"].includes(t)?"other":"":""}function yu(...e){const t=new Set(["girl","woman","female"]),n=new Set(["boy","man","male"]);let r=0,a=0;for(const i of e)for(const o of String(i??"").split(",")){let s=o.trim().toLowerCase();if(!s)continue;const c=s.match(/^\d+(?:\.\d+)?::(.+)::$/);c&&(s=c[1].trim().toLowerCase()),s=s.replace(/_/g," ").trim(),t.has(s)&&(r+=1),n.has(s)&&(a+=1)}return r>a?"girl":a>r?"boy":""}function nt(e){const t=Array.isArray(e)?e:String(e??"").split(/[,/\n]/),n=[],r=new Set;for(const a of t){const i=V(a),o=kt(i);!i||r.has(o)||(r.add(o),n.push(i))}return n}function bu(e){const t=V(e).split(" ").filter(Boolean);return t.length!==2||!t.every(n=>/^[A-Za-z'-]+$/.test(n))||!t.every(n=>n===n.toUpperCase())?{surname:"",given_name:""}:{surname:t[0],given_name:t[1]}}function $e(e={}){const t=V(e.name),n=bu(t);return{...e,id:V(e.id)||t,name:t,aliases:nt(e.aliases),surname:V(e.surname)||n.surname,given_name:V(e.given_name)||n.given_name,surname_variants:nt(e.surname_variants),given_name_variants:nt(e.given_name_variants),priority:Number.isFinite(Number(e.priority))?Number(e.priority):0,attire_locked:e.attire_locked!==!1,accessories_locked:e.accessories_locked!==!1,gender:Kt(e.gender??e.sex),schema_version:2}}function dr(e,t,n){const r=$e(e);return new Set(nt([r[t],...r[n]||[]]).map(kt).filter(Boolean))}function Lo(e,t){const n=$e(e),r=$e(t),a=dr(n,"surname","surname_variants"),i=dr(r,"surname","surname_variants"),o=dr(n,"given_name","given_name_variants"),s=dr(r,"given_name","given_name_variants");if(!a.size||!i.size||!o.size||!s.size)return!1;const c=[...a].some(f=>i.has(f)),l=[...o].some(f=>s.has(f));return c&&l}function Bo(e,t){if(!e||!t)return!1;const n=$e(e),r=$e(t);if(n.id&&r.id&&String(n.id)===String(r.id)||Lo(n,r))return!0;const a=oa(n),i=oa(r);for(const o of a)if(i.has(o))return!0;return!1}function oa(e){const t=$e(e),n=new Set,r=s=>{const c=kt(s);c&&n.add(c)};r(t.name);const a=new Set(nt([t.surname,...t.surname_variants]).map(kt));for(const s of t.aliases)a.has(kt(s))||r(s);const i=nt([t.surname,...t.surname_variants]),o=nt([t.given_name,...t.given_name_variants]);for(const s of i)for(const c of o)r(`${s} ${c}`),r(`${s}${c}`),r(`${c} ${s}`);return n}function wu(e,t=[]){const n=kt(e);if(!n)return null;const r=t.map(a=>$e(a)).filter(a=>oa(a).has(n));return r.length!==1?null:r[0]}function vu(e,t){const n=Number(t.priority||0)-Number(e.priority||0);if(n)return n;const r=Number(e.created_at||e.updated_at||0)-Number(t.created_at||t.updated_at||0);return r||String(e.id).localeCompare(String(t.id))}function sa(...e){return nt(e.flat())}function xu(e){const t=[...e].sort(vu),n={...t[0]};n.aliases=sa(...t.map(r=>[r.name,...r.aliases||[]])),n.surname_variants=sa(...t.map(r=>[r.surname,...r.surname_variants||[]])),n.given_name_variants=sa(...t.map(r=>[r.given_name,...r.given_name_variants||[]])),n.surname||(n.surname=t.map(r=>r.surname).find(Boolean)||""),n.given_name||(n.given_name=t.map(r=>r.given_name).find(Boolean)||"");for(const r of t){const a=V(r.appearance||""),i=V(r.attire||""),o=V(r.accessories||""),s=V(r.original||"");a.length>V(n.appearance||"").length&&(n.appearance=a),!ca(n.attire_locked)&&i.length>V(n.attire||"").length&&(n.attire=i),!ca(n.accessories_locked)&&o.length>V(n.accessories||"").length&&(n.accessories=o),s&&!V(n.original||"")&&(n.original=s)}return n.surname=V(n.surname)||t.map(r=>V(r.surname)).find(Boolean)||"",n.given_name=V(n.given_name)||t.map(r=>V(r.given_name)).find(Boolean)||"",n}function ku(e=[]){const t=e.map(a=>$e(a)),n=[],r=new Set;for(let a=0;a<t.length;a++){if(r.has(a))continue;const i=[t[a]];r.add(a);for(let o=a+1;o<t.length;o++)r.has(o)||i.some(s=>Lo(s,t[o]))&&(r.add(o),i.push(t[o]));n.push(i)}return{records:t,active:n.map(xu),groups:n}}var V,kt,ca,la=T((()=>{V=e=>String(e??"").trim().replace(/\s+/g," "),kt=e=>V(e).normalize("NFKC").toLocaleLowerCase().replace(/[\s_.·•･-]+/g,""),ca=e=>e!==!1}));function mr(e){const t=$e(e||{}),n=X([t.name,...t.aliases||[]]),r=X([t.surname,...t.surname_variants||[]]),a=X([t.given_name,...t.given_name_variants||[]]);for(const i of r)for(const o of a)n.push(`${i} ${o}`,`${i}${o}`,`${o} ${i}`);return X(n).filter(i=>!r.some(o=>U(o)===U(i)))}function ye(e,t){return wu(e,t||[])}function ua(e,t,n=6){const r=Math.max(1,Math.min(6,Number(n)||6)),a=[],i=new Set,o=(s,c)=>{if(!s||!c)return s;for(const l of["action","expression","attire","accessories","appearance","label","age","body","sex","original","original_tag","negative"]){const f=u(s[l]||"",2e3),d=u(c[l]||"",2e3);d&&(f?f.toLowerCase().includes(d.toLowerCase())||(s[l]=I(f,d)):s[l]=d)}return s};for(const s of e||[]){if(!s||typeof s!="object")continue;const c=u(s.name,200);if(!c)continue;const l=ye(c,t),f=l?`id:${u(l.id||l.name,200)}`:`name:${U(c)}`;if(!f||f==="id:"||f==="name:")continue;const d=a.findIndex(p=>p._dedupeKey===f);if(d>=0){o(a[d],s);continue}a.length>=r||(i.add(f),a.push({...s,name:l?.name||c,_dedupeKey:f}))}return a.map(({_dedupeKey:s,...c})=>c)}function Cn(e){const t=new Set;for(const r of mr(e)){const a=U(r);a&&t.add(a)}const n=U(e?.name);return n&&t.add(n),t}function fa(e){return ku(e||[]).active}function Ro(e,t){const n=u(e).toLowerCase(),r=wt(e);if(!n)return[];const a=[],i=new Set;for(const o of t||[]){const s=u(o.id||o.name,200);if(!(!s||i.has(s)))for(const c of mr(o)){const l=U(c),f=wt(c);if(!(f.length<2)&&(n.includes(l)||r.includes(f))){a.push(o),i.add(s);break}}}return a}function Gt(e,t=""){if(typeof e!="object"||e===null)return null;const n=e,r=u(n.name||t,200);if(!r)return null;let a=X(n.aliases);a=[r,...a.filter(d=>U(d)!==U(r))];const i=u(n.original||n.original_tag||n.copyright||"",400);let o=u(n.appearance||"",4e3),s=u(n.attire||"",4e3),c=u(n.accessories||"",4e3);const l=u(n.tags||"",4e3);l&&!o&&!s&&!c&&(o=l),i&&o&&(o=I(...o.split(",").filter(d=>U(d)!==U(i))));let f=u(n.id,80)||r.replace(/[^a-zA-Z0-9_\uac00-\ud7a3]+/g,"_").replace(/^_|_$/g,"").slice(0,64);return f||(f=`char_${Math.abs(Yl(r))%1e7}`),$e({...n,id:f,name:r,aliases:a,original:i,appearance:o,attire:s,accessories:c,gender:Kt(n.gender??n.sex)})}function Su(e,t,n={}){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[],i=typeof n.hasAppearance=="function"?n.hasAppearance:()=>!1,o=typeof n.resolve=="function"?n.resolve:()=>null,s=typeof n.aliasKeys=="function"?n.aliasKeys:()=>new Set,c=typeof n.normalizeName=="function"?n.normalizeName:p=>String(p||"").trim().toLowerCase(),l=typeof n.clean=="function"?n.clean:p=>String(p||"").trim(),f=[],d=new Set;for(const p of r){if(!l(p?.name,200)||i(p))continue;const m=o(p.name,a);if(m&&i(m))continue;for(const h of s(p))d.add(h);const g=c(p.name);g&&d.add(g)}for(const p of a)[...s(p)].some(m=>d.has(m))||f.push(p);for(const p of r){const m=o(p.name,f);if(!(m&&i(p))){if(m&&!i(p)){if(i(m))continue;const g=f.findIndex(h=>o(p.name,[h]));g>=0?f[g]=p:f.push(p);continue}m||f.push(p)}}return f}var Wt=T((()=>{D(),la()}));function da(e){const t=u(e).toLowerCase();return t?gr(t,Ho):!1}function Do(e){const t=u(e).toLowerCase();return!t||da(t)?!1:gr(t,Jo)}function Au(e){return da(e)||Do(e)}function Mu(e){const t=u(e).toLowerCase();return!t||Au(t)?!1:gr(t,Uo)}function Nu(e){const t=[],n=[],r=[];for(const a of u(e).split(",")){const i=a.trim();i&&(da(i)?r.push(i):Do(i)||Mu(i)?n.push(i):t.push(i))}return[I(...t),I(...n),I(...r)]}function Iu(e){if(e===!0||e===1)return!0;const t=u(e,20).toLowerCase();return t==="true"||t==="on"||t==="1"}function Eu(e){if(e==null||e===!1)return 0;if(e===!0)return 3;if(typeof e=="number"&&Number.isFinite(e)){const n=Math.floor(e);return n<=0?0:n===1?1:n===2?2:3}const t=u(e,40).toLowerCase().replace(/_/g," ").trim();return!t||t==="off"||t==="false"||t==="0"||t==="none"?0:t==="1"||t==="torn"||t==="torn clothes"?1:t==="2"||t==="nude"?2:t==="3"||t==="on"||t==="true"||t==="completely"||t==="completely nude"||t==="complete"?3:0}function Cu(e,t,n=null){const r=u(e,4e3);if(t<=0)return r;let a="";return t===1?a="2::torn clothes::":t===2?a="2.5::nude::":n==="m"?a="2.5::completely nude::":a="2::completely nude::",n==="f"?I(r,a,"nipples","pussy"):n==="m"?I(r,a,"penis"):I(r,a)}function $u(e){const[t,n]=Nu(e);return[t,n]}function Tu(...e){const t=[];for(const n of e)if(n!=null)for(const r of u(n).split(",")){let a=r.trim().toLowerCase();if(!a)continue;const i=a.match(/^\d+(?:\.\d+)?::(.+)::$/);i&&(a=i[1].trim().toLowerCase()),a=a.replace(/_/g," ").trim(),a&&t.push(a)}return t}function ju(...e){const t=Tu(...e);if(!t.length)return null;let n=0,r=0;for(const a of t)(Go.has(a)||/^\d+\+?girls?$/.test(a))&&(n+=1),(Wo.has(a)||/^\d+\+?boys?$/.test(a))&&(r+=1);return n>r?"f":r>n?"m":null}function $n(e,t){const n=Kt(e?.gender??t?.gender??t?.sex);return n==="girl"?"f":n==="boy"?"m":n==="other"?null:ju(t?.appearance,t?.attire,t?.accessories,e?.appearance,e?.attire,e?.accessories,e?.label,e?.age,e?.body,e?.prompt,e?.sex)}function pr(e,t,n,r){return e<=0?"":e===1?t:e<=5?`${e}${n}`:r}function Ou(e,t){const n=[],r=pr(e,"1girl","girls","6+girls"),a=pr(t,"1boy","boys","6+boys");return r&&n.push(r),a&&n.push(a),n.join(", ")}function Fo(e){const t=u(e);if(!t)return"";const n=[];for(const r of Ui(t)){const a=r.trim();a&&(pa.test(a)||qo.test(a)||Vo.test(a)||n.push(a))}return I(...n)}function ma(e){const t=[],n=new Set;for(const r of u(e).split(",")){let a=r.trim();if(!a)continue;if(pa.test(a)){const o=a.toLowerCase();if(o.includes("girl"))a="girl";else if(o.includes("boy"))a="boy";else continue}const i=a.toLowerCase();n.has(i)||(n.add(i),t.push(a))}return I(...t)}function Pu(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function Lu(e,t=3){const n=u(e,200);if(!n)return"";const r=Pu(t);return r<=0?n:`${r}::${n}::`}function zo(e,t=null){let n=e;if(n==null&&t!=null&&(n=t),n===!1)return"off";if(n===!0)return"gender";const r=u(n,40).toLowerCase();return["","auto","mixed","true","1","on"].includes(r)?"gender":["off","none","false","0","disable","disabled"].includes(r)?"off":["girl","all_girls","girls_only"].includes(r)?"girls":["person","persons"].includes(r)?"people":Yo(r)?r:"gender"}function Bu(e,t,n="gender",r=null){const a=zo(n,r);if(a==="off")return"";const i=(e||[]).slice(0,6),o=i.length;if(o<=0)return"";if(a==="girls")return pr(o,"1girl","girls","6+girls");if(a==="people")return pr(o,"1person","people","6+people");let s=0,c=0,l=0;for(const f of i){const d=u(f.name,200),p=d?ye(d,t):null,m=$n(f,p);m==="f"?s++:m==="m"?c++:Kt(f.gender??p?.gender)==="other"||l++}return s+=l,Ou(s,c)}function Tn(e){return I(e?.original||"",e?.appearance||"",e?.attire||"",e?.accessories||"")}function be(e){if(typeof e!="object"||e===null)return!1;const t=e;let n=u(t.appearance||"",4e3);if(!n)return!1;const r=u(t.original||"",400);r&&(n=I(...n.split(",").filter(o=>U(o)!==U(r))));const[a]=$u(n);if(n=u(a||"",4e3),!n)return!1;const i=new Set(["girl","boy","man","woman","male","female","1girl","1boy","2girls","2boys","solo","other"]);return n.split(",").map(o=>o.trim().toLowerCase()).filter(Boolean).filter(o=>!i.has(o)&&!/^\d+(girl|boy)s?$/.test(o)).length>0}function ce(e){return e!==!1}function Ru(e,t){const n=be(e),r=u(t?.original||t?.original_tag||"",400),a=u(e?.original||"",400),i=u(e?.attire||"",4e3),o=u(e?.accessories||"",4e3),s=u(t?.attire||"",4e3),c=u(t?.accessories||"",4e3),l=ce(e?.attire_locked)?i:s||i,f=ce(e?.accessories_locked)?o:c||o,d=Eu(t?.nude),p=Iu(t?.weapon),m=Cu(l,d,$n(t,e)),g=p?f:"";return ma(n?I(a||r,e?.appearance,m,g,t?.expression,t?.action,t?.sex):I(a?"":r,t?.label,t?.age,t?.appearance,t?.body,m,g,t?.expression,t?.action,t?.sex))}function rt(e){const t=typeof e=="object"&&e?e:{},n=P(t.character_max??t.char_max??6,6);return Math.max(1,Math.min(6,n))}var Uo,Jo,Ho,Ko,Go,Wo,pa,qo,ga,Vo,Yo,gr,at=T((()=>{gu(),hu(),_u(),D(),la(),Wt(),Uo=jo,Jo=Oo,Ho=Po,Ko=["off","girls","people","gender"],Go=new Set(["girl","woman","female"]),Wo=new Set(["boy","man","male"]),pa=/^\d+\+?(?:girls?|boys?|people|person)$/i,qo=/^(?:1girl|1boy)$/i,ga="(?:\\d+\\+?(?:girls?|boys?|people|person)|1girl|1boy|solo)",Vo=new RegExp(`^-?\\d+(?:\\.\\d+)?::\\s*${ga}(?:\\s*,\\s*${ga})*\\s*::$`,"i"),Yo=e=>Ko.includes(e),gr=(e,t)=>t.some(n=>{if(n.length<=3){const r=n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?:^|[^a-z0-9])${r}(?:[^a-z0-9]|$)`,"i").test(e)}return e.includes(n)})}));Q(),Eo(),_e(),at(),D();function Du(e,t,n,r){let a=u(e);if(!a)return"";for(const s of r){const c=u(s);if(c)if(a.endsWith(c))a=a.slice(0,a.length-c.length).replace(/[,\s]+$/g,"");else{const l=a.lastIndexOf(c);l>=0&&(a=`${a.slice(0,l)}${a.slice(l+c.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}}const i=u(t);if(i)if(a.startsWith(i))a=a.slice(i.length).replace(/^[,\s]+/g,"");else{const s=a.indexOf(i);s>=0&&(a=`${a.slice(0,s)}${a.slice(s+i.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}const o=[...n].map(s=>u(s)).filter(Boolean).sort((s,c)=>c.length-s.length);for(const s of o){const c=a.indexOf(s);c<0||(a=`${a.slice(0,c)}${a.slice(c+s.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}return u(a)}function Fu(e){const t=u(e.setup),n=u(e.main);if(!n)return{lockedSetup:t,rebuildMain:!0};if(t&&t!==n)return{lockedSetup:t,rebuildMain:!0};const r=u(e.person);if(r||e.stylePositives&&e.stylePositives.length){const a=Du(n,r,e.stylePositives||[],e.qualitySuffixes||[]);if(a&&a!==n)return{lockedSetup:a,rebuildMain:!0}}return{lockedSetup:"",rebuildMain:!1}}function zu(e){if(!e||typeof e!="object")return[];const t=[],n=u(e.custom_pos);n&&t.push(n);const r=Array.isArray(e.presets)?e.presets:[];for(const a of r){if(!a||typeof a!="object")continue;const i=a,o=u(i.positive||i.pos);o&&t.push(o)}return t}async function Xo(e,t,n){const r=new Blob([e],{type:t});let a=null;if(typeof createImageBitmap=="function"?a=await createImageBitmap(r):n&&typeof document<"u"&&(a=await new Promise((s,c)=>{const l=new Image,f=URL.createObjectURL(r);l.onload=()=>{URL.revokeObjectURL(f),s(l)},l.onerror=()=>{URL.revokeObjectURL(f),c(new Error("image decode failed"))},l.src=f})),!a)return null;const i=a,o="naturalWidth"in i?{w:i.naturalWidth,h:i.naturalHeight}:{w:0,h:0};return{source:i,width:i.width||o.w||0,height:i.height||o.h||0,close:()=>{try{"close"in i&&i.close()}catch{}}}}function Zo(e,t,n,r){if(r&&typeof OffscreenCanvas<"u"){const a=new OffscreenCanvas(t,n),i=a.getContext("2d");return i?(i.drawImage(e.source,0,0,t,n),{kind:"offscreen",canvas:a}):null}if(typeof document<"u"){const a=document.createElement("canvas");a.width=t,a.height=n;const i=a.getContext("2d");return i?(i.drawImage(e.source,0,0,t,n),{kind:"dom",canvas:a}):null}return null}async function Uu(e,t=.8){const n=Z(e);if(!n.length)return null;if(An(n))return te(n);const r=Mn(n);try{const a=await Xo(n,r,!0);if(!a)return null;if(!(a.width>0&&a.height>0))return a.close(),null;const i=Zo(a,a.width,a.height,!0);if(!i)return a.close(),null;let o;if(i.kind==="offscreen"){const c=await i.canvas.convertToBlob({type:"image/webp",quality:t});if(a.close(),!c||!c.size)return null;o=await c.arrayBuffer()}else o=Vl(i.canvas.toDataURL("image/webp",t)),a.close();if(!o)return null;const s=Z(o);return!An(s)||s.length>=n.length*.98?null:o}catch(a){return w("image.webp.encode.fail",{message:String(a?.message||a)},"warn"),null}}async function Ju(e){let t=Z(e);if(!t.length)throw new Error("image is empty");const n=1536,r=12e5,a=Mn(t),i=t.length>r;try{const o=await Xo(t,a,!1);if(o&&(i||o.width>n||o.height>n)){const s=Math.min(1,n/Math.max(o.width,o.height,1)),c=Zo(o,Math.max(1,Math.round(o.width*s)),Math.max(1,Math.round(o.height*s)),!1);if(c?.kind==="dom"){const l=await new Promise(f=>{c.canvas.toBlob(f,"image/png")});if(l)return t=new Uint8Array(await l.arrayBuffer()),o.close(),{bytes:t,mime:"image/png",filename:"image.png"}}}o?.close()}catch(o){w("autotag.resize",{message:String(o?.message||o)},"warn")}return{bytes:t,mime:a,filename:`image.${a==="image/jpeg"?"jpg":a==="image/webp"?"webp":"png"}`}}async function hr(){return qt||(qt=(async()=>{const e=Ye();if(typeof e?.getLocalPluginStorage=="function")try{const n=ue("storage.open"),r=await e.getLocalPluginStorage();if(ha(r))return n.end({message:"idb/getLocalPluginStorage"}),{kind:"idb",api:r};n.end({message:"getLocalPluginStorage returned unusable api"},"warn")}catch(n){w("storage.open",{message:String(n?.message||n)},"error"),console.warn("[Inlay Nexus] getLocalPluginStorage failed",n?.message||n)}const t=e?.pluginStorage;if(ha(t))return w("storage.open",{message:"fallback pluginStorage (save-file)"},"warn"),console.warn("[Inlay Nexus] falling back to pluginStorage (save-file scoped)"),{kind:"plugin",api:t};throw w("storage.open",{message:"no storage API"},"error"),new Error("기기 로컬 IndexedDB 저장소(getLocalPluginStorage)를 사용할 수 없습니다.")})().catch(e=>{throw qt=null,e}),qt)}function Hu(){return Ye()?.pluginStorage??null}async function Ae(e,t){try{const{kind:n,api:r}=await hr(),a=await r.getItem(e);if(a!=null&&a!=="")return a;if(n==="idb"&&t){const i=Hu();if(i?.getItem)try{const o=await i.getItem(t);if(o!=null&&o!=="")return await r.setItem(e,o),o}catch{}}return null}catch{return null}}function Ku(e){if(typeof e=="string")return e.length;try{return JSON.stringify(e).length}catch{return 0}}async function Me(e,t){const{kind:n,api:r}=await hr(),a=Ku(t),i=a>5e4?ue("storage.set.large"):null;try{return await r.setItem(e,t),i?i.end({message:e,bytes:a,kind:n,background:!0}):a>8e3&&w("storage.set",{message:e,bytes:a,kind:n,background:!0}),!0}catch(o){throw i?i.fail(o,{message:e,bytes:a,kind:n,background:!0}):w("storage.set",{message:`${e}: ${o?.message||o}`,bytes:a,kind:n,background:!0},"error"),o}}async function fe(e){try{const{api:t}=await hr();t?.removeItem&&await t.removeItem(e)}catch{}}var ha,qt,_r=T((()=>{q(),pt(),ha=e=>typeof e?.getItem=="function"&&typeof e?.setItem=="function",qt=null})),Qo,es,Vt,Gu=T((()=>{Qo=class{budgetChars;urls=new Map;pinned=new Set;bytes=0;constructor(e){this.budgetChars=e}get size(){return this.urls.size}get byteLength(){return this.bytes}get(e){const t=String(e||"");if(!t)return;const n=this.urls.get(t);if(n!==void 0)return this.urls.delete(t),this.urls.set(t,n),n}set(e,t){const n=String(e||"");if(!n||typeof t!="string"||!t)return;const r=this.urls.get(n);r!==void 0&&(this.bytes-=r.length),this.urls.delete(n),this.urls.set(n,t),this.bytes+=t.length,this.evict()}drop(e){const t=String(e||""),n=this.urls.get(t);n!==void 0&&(this.urls.delete(t),this.bytes-=n.length,this.pinned.delete(t))}pin(e){this.pinned.clear();for(const t of e){const n=String(t||"");if(!n)continue;this.pinned.add(n);const r=this.urls.get(n);r!==void 0&&(this.urls.delete(n),this.urls.set(n,r))}this.evict()}pinnedIds(){return[...this.pinned]}clear(){this.urls.clear(),this.pinned.clear(),this.bytes=0}evict(){if(!(this.bytes<=this.budgetChars))for(const[e,t]of this.urls){if(this.bytes<=this.budgetChars)break;this.pinned.has(e)||(this.urls.delete(e),this.bytes-=t.length)}}},es=33554432,Vt=new Qo(es)}));function ts(e){const t=String(e.session_id??"");if(!t)return;let n=Yt.get(t);n||(n=new Set,Yt.set(t,n)),n.add(String(e.id))}function ns(e){if(!e)return;const t=String(e.session_id??""),n=t?Yt.get(t):void 0;n&&(n.delete(String(e.id)),n.size===0&&Yt.delete(t))}function rs(e,t){if(e==="characters"){if(Array.isArray(t))return`${t[0]}	${t[1]}`;if(t&&typeof t=="object"){const n=t;return`${n.scope}	${n.id}`}}return String(t)}function Wu(e,t){if(!t||typeof t!="object")return"";const n=t;return e==="meta"?String(n.key||""):e==="characters"?`${n.scope}	${n.id}`:String(n.id||"")}function qu(e){if(!e||typeof e!="object")return e;const t={...e};if(!t.result_json)return t;try{const n=JSON.parse(t.result_json);if(!n||typeof n!="object")return t;const r={...n};delete r.tagged,delete r.appearance,delete r.debug_tail,Array.isArray(r.cards)&&(r.cards=r.cards.map(a=>{if(!a||typeof a!="object")return a;const i={...a};return typeof i.image_url=="string"&&i.image_url.startsWith("data:")&&(i.image_url=""),i})),t.result_json=JSON.stringify(r)}catch{}return t}function Vu(e){const t={};if(e==="images"){for(const[n,r]of L.images)t[n]={id:r.id,location:r.location||null,has_png:r.has_png,png_bytes:r.png_bytes,storage:"indexeddb",storage_key:Ee(n)};return t}for(const[n,r]of L[e]){const a=r;if(e==="meta"&&a?.key==="reference_image"){t[n]={key:"reference_image",has_png:!!a.png,updated_at:a.updated_at||0};continue}if(e==="meta"&&a?.key==="vibe_transfer"){t[n]={key:"vibe_transfer",has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="meta"&&Ft(a?.key)){t[n]={key:a.key,has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="jobs"){t[n]=qu(a);continue}t[n]=r}return t}async function Yu(e){await Me(Wr(e),Vu(e))}function as(){Mt=null;const e=[...Pn];Pn.clear(),e.length&&(yr=yr.then(async()=>{for(const t of e){if(us){w("storage.persist.skip",{message:t,background:!0});continue}try{await Yu(t)}catch(n){console.warn("[Inlay Nexus] persist failed",t,n?.message||n)}}}).catch(()=>{}))}function St(e){Pn.add(e),!Mt&&(Mt=setTimeout(as,ls))}async function is(){Mt&&(clearTimeout(Mt),as()),await yr,await le}function Xu(){const e=globalThis.document;if(!e?.addEventListener)return;const t=()=>{!Mt&&!Pn.size||is()};e.addEventListener("visibilitychange",()=>{e.visibilityState==="hidden"&&t()}),globalThis.addEventListener?.("pagehide",t)}function Zu(e,t){L.images.delete(e),L.images.set(e,t)}function os(e){if(Nt+=e,!(Nt<=_a))for(const t of L.images.values()){if(Nt<=_a)break;!t.png||!t.durable||(Nt-=t.png.byteLength,t.png=null,t.hydrated=!1)}}async function Qu(e,t){if(t.hydrated)return t.png;const n=br.get(e);if(n)return n;const r=(async()=>{const a=Ln(await Ae(Ee(e),Ei(e)));return t.png=a,t.hydrated=!0,t.durable=!0,a?(t.png_bytes=a.byteLength,os(a.byteLength)):(t.has_png=!1,t.png_bytes=0),a})().finally(()=>br.delete(e));return br.set(e,r),r}async function it(){return Xt||(Xt=(async()=>{for(const e of ji){const t=await Ae(Wr(e),Ii(e));if(t==null||t==="")continue;let n=t;if(typeof t=="string")try{n=JSON.parse(t)}catch{continue}if(!(!n||typeof n!="object"))for(const[r,a]of Object.entries(n)){const i=a??{};if(e==="images"){const o=!!i.has_png;L.images.set(r,{id:String(i.id||r),location:i.location||{},png:null,has_png:o,png_bytes:Number(i.png_bytes)||0,hydrated:!o,durable:!0})}else if(e==="meta"&&(i.key==="reference_image"||r==="reference_image")){const o=Ln(await Ae(mn,Ci));L.meta.set("reference_image",{key:"reference_image",png:o})}else if(e==="meta"&&(i.key==="vibe_transfer"||r==="vibe_transfer")){const o=Ln(await Ae(pn));let s=await Ae(gn);if(typeof s=="string")try{s=JSON.parse(s)}catch{s=null}const c=s??{};L.meta.set("vibe_transfer",{key:"vibe_transfer",png:o,encoded:c.encoded||"",model:c.model||i.model||"",information_extracted:c.information_extracted??i.information_extracted??1})}else if(e==="meta"&&Ft(i.key||r)){const o=String(i.key||r),s=yn(o),c=Ln(await Ae(hn(s)));let l=await Ae(_n(s));if(typeof l=="string")try{l=JSON.parse(l)}catch{l=null}const f=l??{};L.meta.set(o,{key:o,png:c,encoded:f.encoded||"",model:f.model||i.model||"",information_extracted:f.information_extracted??i.information_extracted??1})}else if(e==="cards"){const o=i;L.cards.set(r,o),ts(o)}else L[e].set(r,i)}}return!0})().catch(e=>{throw Xt=null,e}),Xt)}async function z(e,t){await it();const n=rs(e,t);if(e==="images"){const a=L.images.get(n);return a?(a.hydrated?a.png&&Zu(n,a):await Qu(n,a),a):void 0}const r=L[e].get(n);return r??void 0}async function ef(e){await it();const t=L.images.get(String(e));if(t)return{has_png:t.has_png,png_bytes:t.png_bytes}}async function F(e,t,n={}){await it();const r=Wu(e,t);if(!r)throw new Error(`invalid ${e} key`);const a=n.persist!==!1;if(e==="images"){const i=t.png||null,o=L.images.get(r);o?.png&&(Nt-=o.png.byteLength);const s={id:String(t.id),location:t.location||{},...typeof t.mime=="string"&&t.mime?{mime:t.mime}:{},png:i,has_png:!!i,png_bytes:i?i.byteLength:0,hydrated:!0,durable:!i};return L.images.set(r,s),i?(os(i.byteLength),le=le.then(async()=>{const c=await Ze(new Uint8Array(i));await Me(Ee(r),c),L.images.get(r)===s&&(s.durable=!0)}).catch(c=>console.warn("[Inlay Nexus] image persist failed",r,c?.message||c))):le=le.then(()=>fe(Ee(r))).catch(()=>{}),a&&St("images"),r}if(e==="meta"&&t.key==="reference_image"){const i=t.png||null;return L.meta.set("reference_image",{key:"reference_image",png:i}),i?le=le.then(async()=>{await Me(mn,await Ze(new Uint8Array(i)))}).catch(o=>console.warn("[Inlay Nexus] ref persist failed",o?.message||o)):le=le.then(()=>fe(mn)).catch(()=>{}),a&&St("meta"),"reference_image"}if(e==="meta"&&t.key==="vibe_transfer"){const i={key:"vibe_transfer",png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return L.meta.set("vibe_transfer",i),le=le.then(async()=>{i.png?await Me(pn,await Ze(new Uint8Array(i.png))):await fe(pn),i.encoded?await Me(gn,{encoded:i.encoded,model:i.model,information_extracted:i.information_extracted}):await fe(gn)}).catch(o=>console.warn("[Inlay Nexus] vibe persist failed",o?.message||o)),a&&St("meta"),"vibe_transfer"}if(e==="meta"&&Ft(t.key)){const i=String(t.key),o=yn(i),s={key:i,png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return L.meta.set(i,s),le=le.then(async()=>{s.png?await Me(hn(o),await Ze(new Uint8Array(s.png))):await fe(hn(o)),s.encoded?await Me(_n(o),{encoded:s.encoded,model:s.model,information_extracted:s.information_extracted}):await fe(_n(o))}).catch(c=>console.warn("[Inlay Nexus] preset vibe persist failed",c?.message||c)),a&&St("meta"),i}if(e==="cards"){ns(L.cards.get(r));const i=t;return L.cards.set(r,i),ts(i),a&&St("cards"),r}return L[e].set(r,t),a&&St(e),r}async function At(e,t){await it();const n=rs(e,t);if(e==="cards"&&ns(L.cards.get(n)),e==="images"){const r=L.images.get(n);r?.png&&(Nt-=r.png.byteLength)}if(L[e].delete(n),e==="images"&&await fe(Ee(n)),e==="meta"&&n==="reference_image"&&await fe(mn),e==="meta"&&n==="vibe_transfer"&&(await fe(pn),await fe(gn)),e==="meta"&&Ft(n)){const r=yn(n);await fe(hn(r)),await fe(_n(r))}return St(e),e==="images"&&cs(n),!0}async function we(e){return await it(),[...L[e].values()]}async function ss(e){await it();const t=Yt.get(String(e));if(!t)return[];const n=[];for(const r of t){const a=L.cards.get(r);a&&n.push(a)}return n}function jn(e){return L[e].size}function tf(){let e=0;for(const t of L.images.values())e+=t.png_bytes;return e}function nf(){const e=[];for(const t of L.images.values())e.push(t.location||{});return e}async function rf(e){await it();const t=L.images.get(String(e))?.location;return t&&typeof t=="object"?t:{}}function On(e){return Vt.get(String(e))}function af(e,t){Vt.set(String(e),t)}function cs(e){Vt.drop(String(e))}function of(e){Vt.pin(e)}function sf(){return Vt.size}async function cf(e){return(await z("images",String(e)))?.png??null}var L,Yt,ls,Pn,Mt,yr,le,us,_a,Nt,br,Ln,Xt,Te=T((()=>{ee(),q(),Q(),_r(),Gu(),L={meta:new Map,cards:new Map,characters:new Map,jobs:new Map,images:new Map},Yt=new Map,ls=25,Pn=new Set,Mt=null,yr=Promise.resolve(),le=Promise.resolve(),us=!1,Xu(),_a=100663296,Nt=0,br=new Map,Ln=e=>typeof e=="string"&&e?ql(e):null,Xt=null}));q(),Q(),_t(),Te();async function Zt(e){if(!e)return"";const t=On(e);if(t!==void 0)return t;const n=ue("image.data_url"),r=await z("images",e);if(!r?.png)return n.end({message:`missing png ${e}`,id:e,background:!0},"warn"),"";const a=typeof r.mime=="string"&&r.mime||Mn(r.png),i=`data:${a};base64,${await Wl(r.png)}`;return af(e,i),n.end({message:e,bytes:r.png.byteLength||0,mime:a,url_len:i.length,focus:!0}),i}function je(e){const t=typeof e=="string"?e:e?.id;return t&&On(String(t))||""}async function ya(e,t,n=null){const r=ue("image.publish");cs(e);let a=t,i=Mn(t);try{const s=await Uu(t,.8);s&&(a=s,i="image/webp")}catch(s){w("image.webp",{message:String(s?.message||s),id:e},"warn")}await F("images",{id:e,png:a,mime:i,location:n||{}});let o="";try{const s=Zt(e);o=await Promise.race([s,Xe(5e3).then(()=>je(e)||"")]),o||(w("image.data_url.defer",{message:e,bytes:a?.byteLength||0,mime:i,focus:!0},"warn"),s.catch(c=>console.warn("[Inlay Nexus] deferred data URL failed",c?.message||c)))}catch(s){w("image.data_url",{message:String(s?.message||s),id:e},"warn"),Promise.resolve().then(()=>Zt(e)).catch(()=>{})}return r.end({message:e,bytes:a?.byteLength||0,src_bytes:t?.byteLength||0,mime:i,has_url:!!o,has_location:!!(n&&Object.keys(n).length),focus:!0}),o}var ba=2,Qt=new Set,ve=[],De=0,Oe=0,Fe=0,fs=null;function lf(){const e=ve.length+De,t=Math.max(Oe,Fe+e),n=Math.min(Fe,t),r=t>0?Math.max(0,Math.min(100,Math.round(n/t*100))):0;return{pending:e,active:De,done:n,total:t,pct:r,busy:e>0}}function uf(e){fs=typeof e=="function"?e:null}function It(){try{fs?.()}catch{}}function wa(){for(;De<ba&&ve.length;){const e=ve.shift();De+=1,It(),Zt(e).catch(()=>{}).finally(()=>{De-=1,Qt.delete(e),Fe+=1,ve.length===0&&De===0&&(Oe=0,Fe=0),It(),wa()})}}function ff(e){const t=String(e||"");!t||On(t)!==void 0||Qt.has(t)||(Qt.add(t),ve.push(t),Oe+=1,It(),wa())}function df(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];if(of(t),!t.length)return;const n=new Set(t),r=ve.length,a=[];for(const c of ve)n.has(c)?a.push(c):Qt.delete(c);ve.length=0;const i=[];for(const c of t)On(c)===void 0&&(Qt.has(c)||(Qt.add(c),Oe+=1),i.includes(c)||i.push(c));const o=a.filter(c=>!i.includes(c));ve.push(...i,...o);const s=r-a.length;s>0&&(Oe=Math.max(Fe+ve.length+De,Oe-s)),It(),wa()}async function mf(e=[],{concurrency:t=ba}={}){const n=[...new Set((e||[]).map(String).filter(Boolean))],r=Math.max(1,Number(t)||ba),a=n.filter(i=>On(i)===void 0);a.length&&(Oe+=a.length,It());for(let i=0;i<a.length;i+=r){const o=a.slice(i,i+r);await Promise.all(o.map(s=>Zt(s).catch(()=>"").finally(()=>{Fe+=1,ve.length===0&&De===0&&Fe>=Oe&&(Oe=0,Fe=0),It()})))}return ve.length===0&&De===0&&(Oe=0,Fe=0,It()),n.map(i=>je(i)).filter(Boolean)}async function ot(e,t={}){if(!e||typeof e!="object")return e;if(Array.isArray(e)){for(let r=0;r<e.length;r+=1)e[r]=await ot(e[r],t);return e}const n=e;if(typeof n.id=="string"&&(typeof n.image_url=="string"||n.image_path!=null||"shot_index"in n||"main_prompt"in n)){const r=String(n.id),a=t.ids!=null?new Set([...t.ids].map(String)):null;if(!t.cachedOnly&&(!a||a.has(r))){const i=await Zt(r);i&&(n.image_url=i)}else n.image_url=je(r)||"",n.image_url||ff(r);return e}for(const r of Object.keys(n))n[r]&&typeof n[r]=="object"&&(n[r]=await ot(n[r],t));return e}function Et(e){return e?`data:${Mn(e)};base64,${Gl(e)}`:""}D();var pf=new Set(["year 2024","year 2025","year 2026","cowboy shot","looking at viewer","best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration"]),ds=/^(-?\d+(?:\.\d+)?)::([\s\S]*?)::$/;function ms(e){const t=u(e);if(!t)return[];const n=[];let r="",a=0,i=0,o=0,s=!1;const c=()=>{const l=r.trim();l&&n.push(l),r=""};for(;a<t.length;){const l=t[a];if(!s&&i===0&&o===0){const f=t.slice(a).match(/^(-?\d+(?:\.\d+)?)::/);if(f){c(),s=!0,r=f[0],a+=f[0].length;continue}}if(s){if(r+=l,l===":"&&t[a+1]===":"){for(r+=":",a+=2,s=!1,c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}a+=1;continue}if(l==="{"){i+=1,r+=l,a+=1;continue}if(l==="}"&&i>0){if(i-=1,r+=l,a+=1,i===0&&o===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l==="["){o+=1,r+=l,a+=1;continue}if(l==="]"&&o>0){if(o-=1,r+=l,a+=1,i===0&&o===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l===","&&i===0&&o===0){for(c(),a+=1;a<t.length&&t[a]===" ";)a+=1;continue}r+=l,a+=1}return c(),n}function gf(e){return/^-\d+(?:\.\d+)?::/.test(e.trim())}function hf(e){return/artist\s*:/i.test(e)}function ps(e){const t=e.trim();if(t.length<2)return null;const n=t[0],r=n==="{"?"}":n==="["?"]":null;if(!r||t[t.length-1]!==r)return null;let a=0;for(let s=0;s<t.length&&t[s]===n;s+=1)a+=1;let i=0;for(let s=t.length-1;s>=0&&t[s]===r;s-=1)i+=1;const o=Math.min(a,i);return o<1?null:{kind:n==="{"?"brace":"bracket",inner:t.slice(o,t.length-o).trim(),depth:o}}function gs(e,t,n){if(t==="weight")return`${n}::${e}::`;const r=t==="brace"?"{":"[",a=t==="brace"?"}":"]",i=Math.max(1,Number(n)||1);return`${r.repeat(i)}${e}${a.repeat(i)}`}function hs(e){const t=e.trim();if(!t)return[];const n=t.match(ds);if(n){const o=n[1];return n[2].trim().split(",").map(s=>s.trim()).filter(Boolean).map(s=>({plain:s,restore:gs(s,"weight",o)}))}let r=t,a=null,i=0;for(;;){const o=ps(r);if(!o)break;a=o.kind,i=o.depth,r=o.inner}return a?r.split(",").map(o=>o.trim()).filter(Boolean).map(o=>({plain:o,restore:gs(o,a,i)})):[{plain:t,restore:t}]}function _f(e){const t=[],n=new Map,r=new Set;for(const a of ms(e))if(!gf(a)&&!hf(a))for(const{plain:i,restore:o}of hs(a)){const s=i.toLowerCase();!s||pf.has(s)||(n.has(s)||n.set(s,o),!r.has(s)&&(r.add(s),t.push(i)))}return{plains:t,weightMap:n}}function _s(e){return new Set(e.map(t=>t.toLowerCase()).filter(Boolean))}function yf(e){const t=new Map;for(const i of e)for(const[o,s]of i.weightMap)t.has(o)||t.set(o,s);if(!e.length)return{common:[],assets:[],weightMap:t};let n=_s(e[0].plains);for(let i=1;i<e.length;i+=1){const o=_s(e[i].plains);n=new Set([...n].filter(s=>o.has(s)))}const r=[],a=new Set;for(const i of e[0].plains){const o=i.toLowerCase();!n.has(o)||a.has(o)||(a.add(o),r.push(i))}return{common:r,assets:e.map(i=>{const o=[],s=new Set;for(const c of i.plains){const l=c.toLowerCase();n.has(l)||s.has(l)||(s.add(l),o.push(c))}return{name:i.name,unique:o}}),weightMap:t}}function bf(e){const t=[];t.push("## NovelAI character asset tags (ground truth for new_characters looks)"),t.push("Use ONLY tags from this block for appearance / attire / accessories (clothes, jewelry, weapons included)."),t.push("Do not invent looks outside this list. Asset names hint which outfit belongs to which person."),t.push(""),t.push(`공통: ${e.common.length?e.common.join(", "):"(none)"}`);for(const n of e.assets)t.push(""),t.push(`에셋 \`${n.name}\`:`),t.push(`  ${n.unique.length?n.unique.join(", "):"(no unique tags)"}`);return t.join(`
`)}function va(e,t){if(!t?.size)return u(e);const n=[],r=new Set;for(const a of ms(e)){if(ds.test(a)||ps(a)){const i=a.toLowerCase();if(r.has(i))continue;r.add(i),n.push(a);continue}for(const{plain:i}of hs(a)){const o=i.toLowerCase();!o||r.has(o)||(r.add(o),n.push(t.get(o)||i))}}return I(...n)}function wf(...e){const t=new Map;for(const n of e)if(n)for(const[r,a]of n)t.has(r)||t.set(r,a);return t}D();function Bn(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function ys(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function bs(e){const t=Bn(e);if(!t)return[];const n=[],r=u(t.base_caption??t.baseCaption??"");r&&n.push(r);const a=t.char_captions??t.charCaptions;if(Array.isArray(a))for(const i of a){const o=Bn(i),s=u(o?.char_caption??o?.charCaption??o?.caption??"");s&&n.push(s)}return n}function vf(e){const t=Bn(ys(e));if(!t)return u(e);let n=t.Comment??t.comment;n=ys(n);const r=Bn(n),a=[],i=s=>{if(!s)return;const c=u(s.prompt??s.Prompt??"");c&&a.push(c);const l=Bn(s.v4_prompt??s.v4Prompt);l&&a.push(...bs(l.caption??l)),a.push(...bs(s.caption))};i(r),i(t);const o=u(t.Description??t.description??"");return o&&!a.some(s=>s.includes(o.slice(0,40)))&&a.push(o),I(...a)}Q();var xf=8;function en(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function ws(e,t,n){try{return new TextDecoder("utf-8",{fatal:!1}).decode(e.subarray(t,n))}catch{return en(e,t,n)}}async function vs(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("deflate"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{try{const t=new DecompressionStream("deflate-raw"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{return null}}}async function kf(e){const t=Z(e),n={};if(!yt(t)||t.length<8)return n;let r=xf;const a=new DataView(t.buffer,t.byteOffset,t.byteLength);for(;r+12<=t.length;){const i=a.getUint32(r),o=en(t,r+4,r+8),s=r+8,c=s+i;if(c+4>t.length)break;const l=t.subarray(s,c);if(o==="tEXt"){const f=l.indexOf(0);if(f>0){const d=en(l,0,f),p=en(l,f+1,l.length);d&&!(d in n)&&(n[d]=p)}}else if(o==="iTXt"){let f=0;const d=l.indexOf(0);if(d>0){const p=ws(l,0,d);f=d+1;const m=l[f]??0;f+=1,f+=1;const g=l.indexOf(0,f);if(g>=f){f=g+1;const h=l.indexOf(0,f);if(h>=f){f=h+1;let _=l.subarray(f);if(m===1){const v=await vs(_);v&&(_=v)}const y=ws(_,0,_.length);p&&!(p in n)&&(n[p]=y)}}}}else if(o==="zTXt"){const f=l.indexOf(0);if(f>0&&f+2<=l.length){const d=en(l,0,f),p=await vs(l.subarray(f+2));p&&d&&!(d in n)&&(n[d]=en(p,0,p.length))}}if(o==="IEND")break;r=c+4}return n}Q();function Sf(e){const t=Math.floor(e.length/8)*8,n=new Uint8Array(t/8);for(let r=0;r<t;r+=8){let a=0;for(let i=0;i<8;i+=1)a|=(e[r+i]&1)<<7-i;n[r/8]=a}return n}async function Af(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("gzip"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t);return new Uint8Array(await new Response(r).arrayBuffer())}catch{return null}}async function Mf(e,t,n){if(!e.length||t<1||n<1)return null;const r=t*n*4;if(e.length<r)return null;const a=new Uint8Array(t*n);for(let h=0,_=3;h<a.length;h+=1,_+=4)a[h]=e[_];const i=Sf(a);if(i.length<20)return null;const o="stealth_pngcomp",s="stealth_pnginfo",c=String.fromCharCode(...i.subarray(0,15));let l=0,f=!1;if(c.startsWith(o))f=!0,l=15;else if(c.startsWith(s))f=!1,l=15;else return null;if(l+4>i.length)return null;const d=(i[l]<<24|i[l+1]<<16|i[l+2]<<8|i[l+3])>>>0;l+=4;const p=Math.floor(d/8);if(p<1||l+p>i.length)return null;let m=i.subarray(l,l+p);if(f){const h=await Af(m);if(!h)return null;m=h}const g=new TextDecoder("utf-8",{fatal:!1}).decode(m);try{return JSON.parse(g)}catch{return null}}async function Nf(e){const t=Z(e);if(!t.length||typeof createImageBitmap!="function")return null;try{const n=new Uint8Array(t.byteLength);n.set(t);const r=new Blob([n]),a=await createImageBitmap(r),i=a.width,o=a.height,s=typeof OffscreenCanvas=="function"?new OffscreenCanvas(i,o):(()=>{const f=document.createElement("canvas");return f.width=i,f.height=o,f})(),c=s.getContext("2d")??s.getContext("2d");if(!c)return a.close?.(),null;c.drawImage(a,0,0);const l=c.getImageData(0,0,i,o);return a.close?.(),{rgba:new Uint8Array(l.data.buffer,l.data.byteOffset,l.data.byteLength),width:i,height:o}}catch{return null}}Q();function xs(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function ks(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]<<8|e[a+1]);return String.fromCharCode(...r)}function If(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]|e[a+1]<<8);return String.fromCharCode(...r)}function Ef(e){if(e.length<8)return"";const t=xs(e,0,8).replace(/\0+$/g,""),n=e.subarray(8);return/^ASCII/i.test(t)?new TextDecoder("utf-8",{fatal:!1}).decode(n).replace(/\0+$/g,""):/^UNICODE/i.test(t)?n.length>=2&&n[0]===255&&n[1]===254?If(n,2,n.length).replace(/\0+$/g,""):n.length>=2&&n[0]===254&&n[1]===255?ks(n,2,n.length).replace(/\0+$/g,""):ks(n,0,n.length).replace(/\0+$/g,""):new TextDecoder("utf-8",{fatal:!1}).decode(e).replace(/\0+$/g,"")}function Cf(e){const t={};if(e.length<8)return t;let n=0;e.length>=6&&e[0]===69&&e[1]===120&&e[2]===105&&e[3]===102&&(n=6);const r=e.subarray(n);if(r.length<8)return t;const a=r[0]===73&&r[1]===73,i=r[0]===77&&r[1]===77;if(!a&&!i)return t;const o=new DataView(r.buffer,r.byteOffset,r.byteLength),s=d=>a?o.getUint16(d,!0):o.getUint16(d,!1),c=d=>a?o.getUint32(d,!0):o.getUint32(d,!1),l=c(4);return(d=>{if(d+2>r.length)return;const p=s(d);for(let m=0;m<p;m+=1){const g=d+2+m*12;if(g+12>r.length)break;const h=s(g),_=s(g+2),y=c(g+4);let v=g+8;const x=y*(_===2||_===7?1:_===3?2:_===4?4:1);if(x>4&&(v=c(g+8)),v+x>r.length)continue;const N=r.subarray(v,v+x);h===270&&_===2?t.ImageDescription=new TextDecoder("utf-8",{fatal:!1}).decode(N).replace(/\0+$/g,""):h===37510&&(t.UserComment=Ef(N))}})(l),t}function $f(e){const t=Z(e);if(!An(t)||t.length<12)return null;let n=12;for(;n+8<=t.length;){const r=xs(t,n,n+4),a=t[n+4]|t[n+5]<<8|t[n+6]<<16|t[n+7]<<24,i=n+8,o=i+a;if(o>t.length)break;if(r==="EXIF")return t.subarray(i,o);n=o+(a&1)}return null}function Tf(e){const t=$f(e);return t?Cf(t):{}}Q();function Ss(e){const t=e.Comment||e.comment;if(t)try{return{Comment:JSON.parse(t),...e}}catch{return{Comment:t,...e}}return e}async function jf(e){const t=Z(e);if(!t.length)return null;if(yt(t)){const r=await kf(t);if(r.Comment||r.Description||r.Source)return Ss(r)}else if(An(t)){const r=Tf(t);if(r.UserComment||r.ImageDescription){const a={};return r.UserComment&&(a.Comment=r.UserComment),r.ImageDescription&&(a.Description=r.ImageDescription),Ss(a)}}const n=await Nf(t);return n?Mf(n.rgba,n.width,n.height):null}async function Of(e){const t=await jf(e);if(!t)return null;const n=vf(t);if(!n.trim())return null;const r=_f(n);return r.plains.length?r:null}D();var Pf=3;function Lf(e){const t=u(e,400).replace(/\.[a-z0-9]{2,5}$/i,"").toLowerCase();return t?t.split(/[\s_\-/\\.|]+/).map(n=>n.trim()).filter(Boolean):[]}function Bf(e){const t=[],n=new Set;for(const r of e){const a=u(r,200).toLowerCase();a.length<Pf||n.has(a)||(n.add(a),t.push(a))}return t}function Rf(e,t){const n=u(e,400);if(!n)return null;const r=new Set(Lf(n));if(!r.size)return null;const a=[];for(const i of t)r.has(i)&&a.push(i);return a.length?{name:n,key:n,score:a.reduce((i,o)=>i+o.length,0)*10+a.length,hits:a}:null}q(),pt(),Q(),D();var Df=4,Ff=12,xa=new Map,As=new Map;function zf(){return xa}function Ms(e){xa=e}function Uf(e){const t=e&&typeof e=="object"?e:null,n=t?.additionalAssets??t?.additional_assets;if(!Array.isArray(n))return[];const r=[];for(const a of n){if(Array.isArray(a)){const i=u(a[0],400),o=u(a[1],800);i&&o&&r.push({name:i,key:o});continue}if(a&&typeof a=="object"){const i=a,o=u(i.name??i.assetName??i.fileName,400),s=u(i.key??i.path??i.id??i.asset,800);o&&s&&r.push({name:o,key:s})}}return r}async function Ns(e){const t=Ye();if(!t||typeof t.readImage!="function")return null;try{const n=await t.readImage(e);if(!n)return null;if(n instanceof ArrayBuffer)return Z(n);if(n instanceof Uint8Array)return n;if(typeof Blob<"u"&&n instanceof Blob)return Z(await n.arrayBuffer());if(typeof n=="string"){const r=n.match(/^data:[^;]+;base64,(.+)$/i);if(r){const a=atob(r[1]),i=new Uint8Array(a.length);for(let o=0;o<a.length;o+=1)i[o]=a.charCodeAt(o);return i}try{const a=atob(n.replace(/\s+/g,"")),i=new Uint8Array(a.length);for(let o=0;o<a.length;o+=1)i[o]=a.charCodeAt(o);return i}catch{return null}}if(n&&typeof n=="object"){const r=n;if(r.data instanceof ArrayBuffer)return Z(r.data);if(typeof r.data=="string")return Ns(r.data)}}catch(n){w("asset-tags.read.fail",{path:e,message:String(n?.message||n)},"warn")}return null}async function Is(e){const t=Bf(e);if(!t.length)return w("asset-tags.skip",{reason:"no_long_triggers"}),null;if(!zt("getCharacter")||!zt("readImage"))return w("asset-tags.skip",{reason:"host_api_missing"}),null;let n;try{n=await Ye().getCharacter()}catch(f){return w("asset-tags.getCharacter.fail",{message:String(f?.message||f)},"warn"),null}const r=Uf(n);if(!r.length)return w("asset-tags.skip",{reason:"no_assets"}),null;const a=r.map(f=>{const d=Rf(f.name,t);return d?{...f,score:d.score,hits:d.hits}:null}).filter(Boolean);a.sort((f,d)=>d.score-f.score||f.name.localeCompare(d.name));const i=[];let o=0;for(const f of a){if(i.length>=Df||o>=Ff)break;o+=1;const d=f.key;let p,m;const g=As.get(d);if(g)p=g.plains,m=new Map(g.weights);else{const h=await Ns(f.key);if(!h?.length)continue;const _=await Of(h);if(!_?.plains.length){w("asset-tags.no_meta",{name:f.name});continue}p=_.plains,m=_.weightMap,As.set(d,{plains:p,weights:[...m.entries()]})}i.push({name:f.name,plains:p,weightMap:m})}if(!i.length)return w("asset-tags.skip",{reason:"no_meta_hits",matched:a.length,attempts:o}),null;const s=yf(i),c=wf(s.weightMap);xa=c;const l=bf(s);return w("asset-tags.done",{assets:s.assets.map(f=>f.name),common:s.common.length,unique:s.assets.reduce((f,d)=>f+d.unique.length,0)}),{block:l,packed:s,weightMap:c}}ee(),D(),la(),Wt(),Te();var Pe=(e,t)=>!!e&&Object.prototype.hasOwnProperty.call(e,t),wr=e=>e?[...e]:[],ka=e=>e;async function ie(e){const t=(await we("characters")).filter(r=>r.scope===u(e,200)).sort((r,a)=>(r.name||"").localeCompare(a.name||"",void 0,{sensitivity:"base"})),n=[];for(const r of t){let a=r.aliases;if(typeof a=="string")try{a=JSON.parse(a)}catch{a=X(a)}const i=r.appearance||"",o=r.attire||"",s=r.accessories||"";let c=Kt(r.gender??r.sex);if(!c){const f=yu(i,o,s);f&&(c=f,await F("characters",{...r,gender:f,schema_version:Math.max(2,Number(r.schema_version||1)),updated_at:Date.now()/1e3}))}const l={id:r.id,name:r.name,aliases:Array.isArray(a)?a:X(a),surname:r.surname||"",given_name:r.given_name||"",surname_variants:X(r.surname_variants),given_name_variants:X(r.given_name_variants),priority:Number(r.priority||0),attire_locked:ce(r.attire_locked),accessories_locked:ce(r.accessories_locked),schema_version:Number(r.schema_version||1),original:r.original||"",appearance:i,attire:o,accessories:s,gender:c,updated_at:r.updated_at,scope:r.scope};l.tags=Tn(l),n.push(l)}return n}async function Jf(e){const t=u(e,200);return t?(await we("meta")).filter(n=>n.key?.startsWith(`toggle:${t}:`)&&n.enabled===0).map(n=>u(n.global_key||n.key.split(":").slice(2).join(":"),200)).filter(Boolean):[]}async function Hf(e,t){const n=u(e,200);if(!n)return{ok:!1,error:{code:"bad_request",message:"character_id required"}};const r=[],a=new Set;for(const s of t||[]){const c=u(s,200);!c||a.has(c)||(a.add(c),r.push(c))}const i=await we("meta");for(const s of i)s.key?.startsWith(`toggle:${n}:`)&&await At("meta",s.key);const o=Date.now()/1e3;for(const s of r)await F("meta",{key:`toggle:${n}:${s}`,character_id:n,global_key:s,enabled:0,updated_at:o});return{ok:!0,character_id:n,disabled_globals:r}}function Es(e){const t=[];for(const n of[e.id,e.name]){const r=u(n,200);if(!r)continue;t.push(r);const a=r.toLowerCase();a!==r&&t.push(a)}return[...new Set(t)]}function Sa(e,t){if(!t?.size)return!1;for(const n of Es(e))if(t.has(n))return!0;return!1}async function Aa(e){const t=await Jf(e);return new Set(t)}async function Kf(e){const t=await Aa(e),n={};for(const r of await ie(Ve)){const a=!Sa(r,t);for(const i of Es(r))n[i]=a;n[u(r.name,200)]=a}return n}async function Gf(e=[]){const t=[],n=new Set;for(const r of e||[]){const a=u(r,200);!a||a==="__global__"||n.has(a)||(n.add(a),t.push(...await ie(a)))}return ka(fa(t))}async function Ma(e,t="",n="",r=[]){const a=!!C()?.card?.unified_chat_priority,i=(Array.isArray(r)?r:[]).map(f=>u(f,200)).filter(Boolean);let o;a&&i.length?o=await Gf(i):o=await ie(u(e||"",200));const s=u(n||"",200),c=s?await Aa(s):new Set,l=(await ie(Ve)).filter(f=>!Sa(f,c));return ka(Su(o,l,{hasAppearance:be,resolve:ye,aliasKeys:Cn,normalizeName:U,fullTags:Tn,clean:u,globalScope:Ve}))}async function st(e,t){const n=Pe(t,"appearance"),r=Pe(t,"attire"),a=Pe(t,"accessories"),i=Pe(t,"original"),o=Pe(t,"surname"),s=Pe(t,"given_name"),c=Pe(t,"surname_variants"),l=Pe(t,"given_name_variants");let f=Gt(t);if(!f)return null;const d=u(e,200)||"__global__",p=await ie(d),m=u(f.id,80),g=f,h=p.find(y=>m&&u(y.id,80)===m?!1:!!(ye(g.name,[y])||(g.aliases||[]).some(v=>ye(v,[y]))));if(h){const y=X([...h.aliases||[],...f.aliases||[],f.name,h.name]),v=u(f.appearance||"",4e3),x=u(f.attire||"",4e3),N=u(f.accessories||"",4e3),O=u(f.original||"",400),A=u(f.surname||"",200),$=u(f.given_name||"",200);if(f=Gt({...h,...f,id:h.id,name:h.name||f.name,aliases:y,original:i?O:O||h.original||"",appearance:n?v:v||h.appearance||"",attire:r?x:x||h.attire||"",accessories:a?N:N||h.accessories||"",surname:o?A:A||h.surname||"",given_name:s?$:$||h.given_name||"",surname_variants:X(c?[...f.surname_variants||[],A]:[...h.surname_variants||[],...f.surname_variants||[],A,h.surname]),given_name_variants:X(l?[...f.given_name_variants||[],$]:[...h.given_name_variants||[],...f.given_name_variants||[],$,h.given_name]),attire_locked:Pe(t,"attire_locked")?ce(f.attire_locked):ce(h.attire_locked),accessories_locked:Pe(t,"accessories_locked")?ce(f.accessories_locked):ce(h.accessories_locked),priority:Math.max(Number(h.priority||0),Number(f.priority||0))}),!f)return null}const _=Date.now()/1e3;if(await F("characters",{scope:d,id:f.id,name:f.name,aliases:f.aliases,surname:f.surname||"",given_name:f.given_name||"",surname_variants:f.surname_variants||[],given_name_variants:f.given_name_variants||[],priority:Number(f.priority||0),attire_locked:ce(f.attire_locked),accessories_locked:ce(f.accessories_locked),schema_version:2,appearance:f.appearance,attire:f.attire,accessories:f.accessories||"",original:f.original||"",gender:Kt(f.gender??f.sex),updated_at:_}),d!=="__global__"){const y=`appearance:${d}`,v=(await z("meta",y))?.value||{},x=Tn(f);x?v[f.name]=x:delete v[f.name],await F("meta",{key:y,value:v,updated_at:_})}else(r||a)&&await Wf(f,{clearAttire:r,clearAccessories:a});return f}async function Wf(e,{clearAttire:t=!0,clearAccessories:n=!0}={}){if(!e||!t&&!n)return 0;const r=i=>!i||i.scope==="__global__"||be(i)?!1:!!Bo(i,e);let a=0;try{const i=await we("characters");for(const o of i||[]){if(!r(o))continue;const s=t?"":o.attire||"",c=n?"":o.accessories||"";(o.attire||"")===s&&(o.accessories||"")===c||(await F("characters",{...o,attire:s,accessories:c,updated_at:Date.now()/1e3}),a+=1)}}catch{}return a}async function vr(e,t){const n=u(e,200)||"__global__",r=u(t,80);if(!r)return!1;const a=await z("characters",{scope:n,id:r});if(await At("characters",{scope:n,id:r}),n!=="__global__"&&a?.name){const i=`appearance:${n}`,o={...(await z("meta",i))?.value||{}};delete o[a.name],await F("meta",{key:i,value:o,updated_at:Date.now()/1e3})}return!0}var qf=(e,t)=>!!Bo(e,t);function Cs(e){return(Array.isArray(e)?e:[]).filter(t=>{if(!t||typeof t!="object")return!1;const n=t;return!!(n.id||n.name)})}async function Vf(e,t,n=""){const r=Cs(t);if(!r.length)return{deleted:0,sessions:0};const a=u(n,200),i=new Set;let o=0,s=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||i.has(l))continue;i.add(l);const f=await ie(l);let d=!1;for(const p of f)r.some(m=>qf(p,m))&&(await vr(l,p.id),o+=1,d=!0);d&&(s+=1)}return{deleted:o,sessions:s}}async function $s(e,t,n=""){const r=Cs(t);if(!r.length)return{updated:0,sessions:0};const a=u(n,200),i=new Set;let o=0,s=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||i.has(l))continue;i.add(l);const f=await ie(l);let d=!1;for(const p of r){const m=ye(p.name,f)||(Array.isArray(p.aliases)?p.aliases.map(g=>ye(g,f)).find(Boolean):null)||(u(p.id,80)?f.find(g=>u(g.id,80)===u(p.id,80)):null);m&&await st(l,{...p,id:m.id,name:m.name||p.name,appearance:p.appearance!=null?p.appearance:"",attire:p.attire!=null?p.attire:"",accessories:p.accessories!=null?p.accessories:"",original:p.original!=null?p.original:""})&&(o+=1,d=!0)}d&&(s+=1)}return{updated:o,sessions:s}}async function Rn(e,t,n={}){const r=u(e,200)||"__global__",a=n.prune===!0,i=Array.isArray(n.rootSessionIds)?n.rootSessionIds:[],o=fa(t||[]);if(i.length){if(a){const c=new Set;for(const l of o){for(const d of Cn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of i){const f=u(l,200);if(!(!f||f==="__global__"))for(const d of await ie(f)){const p=[...Cn(d)],m=U(d.name);m&&p.push(m),!p.some(g=>c.has(g))&&await vr(f,d.id)}}}return o.length&&await $s(i,o,""),ka(o.map(c=>Gt(c)).filter(c=>!!c))}const s=[];for(const c of o){const l=await st(r,c);l&&s.push(l)}if(a){const c=new Set(s.map(l=>u(l.id,80)).filter(Boolean));for(const l of await ie(r)){const f=u(l.id,80);f&&!c.has(f)&&await vr(r,f)}}return s}async function Dn(e,t=""){const n=u(e,200),r=u(t,200),a=n?await ie(n):[],i=r?await Aa(r):new Set,o=[];for(const s of await ie(Ve)){const c={...s};c.enabled_for_character=r?!Sa(s,i):!0,o.push(c)}return{ok:!0,session_id:n,character_id:r,characters:a,global:o,appearance:Object.fromEntries(a.map(s=>[s.name,Tn(s)])),disabled_globals:[...i].sort(),global_enabled:r?await Kf(r):{}}}async function Ts(e,t,n=!0){const r=u(e,200);if(!r)return{ok:!1,error:{code:"bad_request",message:"target_session_id required"}};const a=[],i=new Set;for(const l of t||[]){const f=u(l,200);!f||i.has(f)||(i.add(f),a.push(...await ie(f)))}n&&!i.has(r)&&a.push(...await ie(r));const o=fa(a),s=[];for(const l of o){const f=ye(l.name,await ie(r)),d=await st(r,{...l,id:f?.id||l.id,priority:Math.max(Number(f?.priority||0),Number(l.priority||0))});d&&s.push(d)}const c=new Set;for(const l of s){for(const d of Cn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of await ie(r)){const f=[...Cn(l)],d=U(l.name);d&&f.push(d),!f.some(p=>c.has(p))&&await vr(r,l.id)}return{...await Dn(r),ok:!0,merged:s.length,sources:[...i]}}async function Yf(e){return Object.fromEntries((await ie(e)).map(t=>[t.name,Tn(t)]))}async function Xf(e,t){return await Rn(e,Object.entries(t||{}).map(([n,r])=>({name:n,tags:r}))),{ok:!0,appearance:await Yf(e)}}async function Zf(e){const{sessionId:t,tagged:n,shotChars:r}=e,a=e.unifiedSessionId??"",i=e.sourceSessionIds??[],o=u(e.characterId||"",200),s=u(t||"",200),c=()=>Ma(t,a,o,i);let l=await c();const f=[...n.new_characters||[]],d=new Set(f.map(m=>U(m?.name))),p=(m,g=null)=>({surname:u(m?.surname||g?.surname||"",200),given_name:u(m?.given_name||g?.given_name||"",200),surname_variants:X([...wr(g?.surname_variants),...wr(m?.surname_variants),m?.surname,g?.surname]),given_name_variants:X([...wr(g?.given_name_variants),...wr(m?.given_name_variants),m?.given_name,g?.given_name])});for(const m of r||[]){const g=u(m.name,200);if(!g||d.has(U(g)))continue;const h=ye(g,l);h&&be(h)||(f.push({name:h?.name||g,aliases:X(m.aliases)||h?.aliases||[g],original:u(m.original||m.original_tag||h?.original||"",400),appearance:I(m.label,m.age,m.appearance,m.body),attire:u(m.attire||""),accessories:u(m.accessories||""),...p(m,h)}),d.add(U(g)))}typeof n=="object"&&(n.new_characters=f);for(const m of f){const g=Gt(m);if(!g)continue;const h=zf();h.size&&(g.appearance=va(g.appearance,h),g.attire=va(g.attire,h),g.accessories=va(g.accessories,h));const _=ye(g.name,l),y=u(g.appearance||""),v=u(g.attire||""),x=u(g.accessories||""),N=p(g,_);if(_&&be(_)){l=await c();continue}if(_&&!be(_)){const O=_.scope==="__global__"?Ve:_.scope||s,A=X([..._.aliases||[],...g.aliases||[]]),$=y||_.appearance||"",B=_.original||g.original||"";await st(O,{id:_.id||g.id,name:_.name||g.name,aliases:A.length?A:_.aliases||g.aliases,original:B,appearance:$,attire:v,accessories:x,attire_locked:ce(_.attire_locked),accessories_locked:ce(_.accessories_locked),...N}),l=await c();continue}_||await st(s,{...g,attire_locked:ce(g.attire_locked),accessories_locked:ce(g.accessories_locked)}),l=await c()}for(const m of r||[]){const g=u(m.name,200);if(g){if(ye(g,l)){l=await c();continue}{const h=I(m.label,m.age,m.appearance||"",m.body||""),_=u(m.attire||""),y=u(m.accessories||"");await st(s,{name:g,aliases:X(m.aliases)||[g],original:u(m.original||m.original_tag||"",400),appearance:h,attire:_,accessories:y,attire_locked:!0,accessories_locked:!0,...p(m,null)})}l=await c()}}return c()}async function Qf(){if((await we("characters")).length)return;const e=(await we("meta")).filter(t=>t.key?.startsWith("appearance:"));if(e.length)for(const t of e){const n=t.key.slice(11),r=t.value||{};for(const[a,i]of Object.entries(r)){const o=Gt({name:a,tags:i},a);o&&await st(n,o)}}}async function ed(){const e=await we("characters");for(const t of e){if(Number(t.schema_version||0)>=2)continue;const n=Gt(t);n&&await F("characters",{...t,...n,scope:t.scope,updated_at:t.updated_at||Date.now()/1e3})}}function td(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function Na(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"||e==="full"?"two_stage":e===!1||e==="false"||e===0||e==="0"||e==="none"?"off":typeof e=="string"&&Os.has(e)?e:"off"}function Ia(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function Ea(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e===!0||e==="true"||e==="on"?"short":e==="detailed"||e==="detail"?"detailed":e==="supplement"||e==="supp"?"supplement":typeof e=="string"&&js.has(e)?e:"short"}function Ca(e){if(Array.isArray(e))return e.map(Ca);if(!e||typeof e!="object")return e;const t={};for(const[n,r]of Object.entries(e))Ls.has(n.toLowerCase())||(t[n]=Ca(r));return t}function $a(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Settings must be an object");const t=Ps(e),n=t.card&&typeof t.card=="object"&&!Array.isArray(t.card)?t.card:{};if(t.card=n,Number(n.scale_semantics_version||0)<2){const c=Number(n.inline_thumb_pct);n.inline_thumb_pct=Number.isFinite(c)?Math.max(1,c/6):100,n.scale_semantics_version=2}if(Number.isFinite(Number(n.overlay_x_pct))||Number.isFinite(Number(n.overlay_y_pct))||n.overlay_pin_unit==="pct"){n.overlay_pin_unit="pct";const c=String(n.overlay_pin_origin||"");(!c||c==="bottom-left")&&(n.overlay_pin_origin="bl")}const r=n.lore_extra;r===!0||r==="true"||r==="sections"?n.lore_extra="tags":r===!1||r==="false"||r==="none"?n.lore_extra="off":r==="full"||r==="tags"||r==="off"?n.lore_extra=r:n.lore_extra="tags",n.asset_nai_tags=n.asset_nai_tags===!0||n.asset_nai_tags==="true"||n.asset_nai_tags===1||n.asset_nai_tags==="1",n.natural_base=Ea(n.natural_base),n.person_tag_weight=td(n.person_tag_weight);const a=t.curation&&typeof t.curation=="object"&&!Array.isArray(t.curation)?{...t.curation}:{},i=n.composition_curation===!0||n.composition_curation==="true"||n.composition_curation===1||n.composition_curation==="1"||n.composition_curation==="on";a.mode==null&&i&&(a.mode="two_stage"),a.mode=Na(a.mode),a.strict_ids=Ia(a.strict_ids);const o=a.embedding&&typeof a.embedding=="object"&&!Array.isArray(a.embedding)?{...a.embedding}:{};o.provider||(o.provider="openai"),o.model||(o.model="text-embedding-3-small"),o.endpoint||(o.endpoint="https://api.openai.com/v1/embeddings"),o.api_key==null&&(o.api_key=""),a.embedding=o,t.curation=a,n.composition_curation=!1;const s=n.overlay_markers!==!1;n.overlay_markers=s,n.inline_previews=s,n.inline_chat_images==null?n.inline_chat_images=!1:n.inline_chat_images=n.inline_chat_images===!0||n.inline_chat_images==="true"||n.inline_chat_images===1||n.inline_chat_images==="1",n.progress_toast==null?n.progress_toast=!1:n.progress_toast=n.progress_toast===!0||n.progress_toast==="true"||n.progress_toast===1||n.progress_toast==="1";{const c=String(n.viewer_minimize_mode||"icon");n.viewer_minimize_mode=c==="toolbar"||c==="actions"?c:"icon"}return t.settings_schema_version=2,t}function nd(e){return JSON.stringify(Ca($a(e)),null,2)}function rd(e){if(typeof e!="string")throw new TypeError("Settings JSON must be text");if(e.length>2e6)throw new RangeError("Settings JSON is too large");const t=JSON.parse(e);if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Settings JSON must contain an object");return $a(t)}var js,Os,Ps,Ls,Fn=T((()=>{js=new Set(["off","short","detailed","supplement"]),Os=new Set(["off","two_stage","embed_snap"]),Ps=e=>JSON.parse(JSON.stringify(e??{})),Ls=new Set(["api_key","auth_token","password","secret"])}));Fn();function Bs(e){if(e==null||e==="")return null;const t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:null}function ad(e,t){let n=Number(e.cfg_scale??7),r=Number(e.cfg_rescale??.36);if(Number.isFinite(n)||(n=7),Number.isFinite(r)||(r=.36),t){const a=Bs(t.cfg_scale);a!=null&&(n=a);const i=Bs(t.cfg_rescale);i!=null&&(r=i)}return{cfg_scale:n,cfg_rescale:r}}function Rs(e){if(!e||e.length<22)return!1;const t=Math.max(0,e.length-65536);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=e[n+20]|e[n+21]<<8;if(n+22+r<=e.length)return!0}return!1}function ct(e,t){return e[t]|e[t+1]<<8}function tn(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Ta(e){const t=Math.max(0,e.length-65536-22);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=ct(e,n+20);if(n+22+r<=e.length)return n}return-1}function id(e){const t=Ta(e);if(t<0)return null;const n=tn(e,t+16);if(n+46>e.length||e[n]!==80||e[n+1]!==75||e[n+2]!==1||e[n+3]!==2)return null;const r=ct(e,n+10),a=tn(e,n+20),i=tn(e,n+24),o=tn(e,n+42);if(o+30>e.length||e[o]!==80||e[o+1]!==75||e[o+2]!==3||e[o+3]!==4)return null;const s=ct(e,o+26),c=ct(e,o+28),l=o+30+s+c;return l+a>e.length?null:{source:"central_dir",compMethod:r,compSize:a,uncompSize:i,dataStart:l,compData:e.subarray(l,l+a)}}function od(e){const t=ct(e,6),n=ct(e,8);let r=tn(e,18);const a=ct(e,26),i=ct(e,28),o=30+a+i;if((t&8)!==0||r===0){let s=-1;for(let c=o+4;c<e.length-3;c+=1){if(e[c]!==80||e[c+1]!==75)continue;const l=e[c+2];if(l===7||l===1||l===5){s=c;break}}if(s<0){const c=Ta(e);c>o&&(s=c)}if(s<0)throw new Error("ZIP 데이터 경계를 찾지 못했습니다 (local header bit3)");r=s-o}if(o+r>e.length)throw new Error(`ZIP 엔트리 길이 초과 (need ${o+r}, have ${e.length})`);return{source:"local_header",compMethod:n,compSize:r,uncompSize:tn(e,22),dataStart:o,compData:e.subarray(o,o+r)}}async function sd(e){if(typeof DecompressionStream!="function")throw new Error("DecompressionStream 미지원 — ZIP deflate를 풀 수 없습니다");const t=Z(e);w("nai.inflate.start",{message:`${t.length}B`,bytes:t.length,focus:!0});const n=new DecompressionStream("deflate-raw"),r=n.writable.getWriter(),a=n.readable.getReader(),i=[];let o=0;const s=Date.now()+2e4,c=(async()=>{for(;;){if(Date.now()>=s)throw new Error(`ZIP inflate 타임아웃 (out=${o}B)`);const{done:d,value:p}=await a.read();if(d)break;p&&(i.push(p),o+=p.length,o>0&&o%524288<p.length&&w("nai.inflate",{message:`out ${Math.round(o/1024)}KB`,bytes:o,focus:!0}))}})(),l=131072;for(let d=0;d<t.length;d+=l){if(Date.now()>=s){try{await r.abort()}catch{}throw new Error(`ZIP inflate write 타임아웃 (in=${d}B)`)}await r.write(t.subarray(d,Math.min(t.length,d+l))),d>0&&d%(l*4)===0&&await Xe(0)}await r.close(),await c;const f=Sn(i,o);return w("nai.inflate.done",{bytes:o,focus:!0}),f}async function cd(e){const t=Z(e);if(w("nai.unzip.start",{message:`${t.length}B`,bytes:t.length,focus:!0}),yt(t))return w("nai.unzip",{message:"raw PNG",bytes:t.length,focus:!0}),te(t);if(t.length<30||t[0]!==80||t[1]!==75){const a=Array.from(t.subarray(0,16)).map(i=>i.toString(16).padStart(2,"0")).join(" ");throw new Error(`ZIP/PNG 응답이 아닙니다 (len=${t.length}, head=${a})`)}const n=id(t)??od(t);w("nai.unzip.entry",{message:`${n.source} method=${n.compMethod} comp=${n.compSize}B uncomp=${n.uncompSize||"?"}`,comp_method:n.compMethod,bytes:n.compSize,source:n.source,focus:!0});const r=Ta(t);if(r>=0&&n.dataStart+n.compSize>r&&(w("nai.unzip.clamp",{message:`comp ${n.compSize} → ${r-n.dataStart}`,focus:!0},"warn"),n.compSize=r-n.dataStart,n.compData=t.subarray(n.dataStart,r)),n.compSize<=0)throw new Error("ZIP 압축 페이로드가 비어 있습니다");if(n.compMethod===0)return te(n.compData);if(n.compMethod===8){const a=await sd(n.compData);return!yt(a)&&!(a[0]===82&&a[1]===73)&&w("nai.unzip",{message:"inflated but not PNG/RIFF magic",bytes:a.length},"warn"),te(a)}throw new Error(`지원하지 않는 ZIP 압축 방식: ${n.compMethod}`)}var Ds=T((()=>{q(),Q(),_t()}));function ld(e="force"){return ke?(ke.forceFinish(e),!0):!1}async function Le(e,t={}){const n=Ye()?.nativeFetch,r=n||globalThis.fetch,a=n?"nativeFetch":"fetch";if(typeof r!="function")throw new Error("fetch를 사용할 수 없습니다");const i={...t};i.networkRoute==null&&delete i.networkRoute;const o=ue("net.fetch");w("net.fetch.start",{message:a,url:String(e).slice(0,120),has_signal:!!i.signal});try{const s=await r(e,i),c=Number(s?.status||(s?.ok===!1?0:200));return o.end({message:a,status:c,url:String(e).slice(0,80)}),s}catch(s){throw o.fail(s,{message:a,url:String(e).slice(0,80)}),s}}async function nn(e,t={}){if(!e)throw new Error("빈 응답");const n=Number(t.deadline||Date.now()+Number(t.timeoutMs||9e4)),r=t.signal||null,a=typeof t.onProgress=="function"?t.onProgress:null,i=Number(t.idleMs||2500),o=(d=0)=>{if(r?.aborted)throw new Error(`NAI 본문 읽기 중단 (abort, ${d}B)`);if(Date.now()>=n)throw new Error(`NAI 본문 읽기 타임아웃 (${d}B received)`)};if(e instanceof ArrayBuffer)return e;if(e instanceof Uint8Array)return te(e);if(typeof e=="string"){const d=e.replace(/\s+/g,"");if(d.length>64&&/^[A-Za-z0-9+/=]+$/.test(d))return w("nai.read_bytes",{message:"string base64 body",bytes:d.length,focus:!0}),te(Re(d))}const s=e;if(s.buffer instanceof ArrayBuffer&&typeof s.byteLength=="number")return s.buffer.slice(s.byteOffset||0,(s.byteOffset||0)+s.byteLength);const c=e;if(e&&typeof e=="object"&&"data"in e&&!c.arrayBuffer&&!c.body)return nn(c.data,t);let l=null;try{const d=c.headers,p=d?.get?.("content-length")||d?.get?.("Content-Length")||null;p&&(l=Number(p))}catch{}if(l!=null&&l>0&&(xr=l),w("nai.read_bytes.start",{message:"begin body",content_length:l,has_arrayBuffer:typeof c.arrayBuffer=="function",has_body_reader:!!(c.body&&typeof c.body.getReader=="function"),keys:e&&typeof e=="object"?Object.keys(e).slice(0,12).join(","):typeof e,focus:!0}),c.body&&typeof c.body.getReader=="function"){const d=c.body.getReader(),p=[];let m=0,g=Date.now(),h=Date.now(),_=!1,y=null;ke={forceFinish:(x="force")=>{_=!0,w("nai.read_bytes.force",{message:x,bytes:m||l||0,focus:!0});try{d.cancel()}catch{}y&&y({done:!0,value:void 0,__forced:!0})}};try{for(;o(m),!_;){if(m>=64&&Date.now()-g>=i){w("nai.read_bytes.idle_complete",{message:`${i}ms idle`,bytes:m,focus:!0});break}if(l!=null&&l>0&&m>=l){w("nai.read_bytes.length_complete",{bytes:m,content_length:l,focus:!0});break}const x=await new Promise(($,B)=>{let k=!1;const E=(R,H)=>{k||(k=!0,clearInterval(M),y=null,H?B(H):$(R))};y=R=>E(R,null);const M=setInterval(()=>{if(!k){if(_)return E({done:!0,value:void 0,__forced:!0},null);if(m>=64&&Date.now()-g>=i)return E({done:!0,value:void 0,__idle:!0},null);if(l!=null&&l>0&&m>=l)return E({done:!0,value:void 0,__length:!0},null);if(r?.aborted||Date.now()>=n)return d.cancel().catch(()=>{}),E(null,new Error(`NAI 본문 읽기 타임아웃 (${m}B received)`))}},200);d.read().then(R=>E(R,null),R=>E(null,R))});if(x?.__forced||x?.__idle||x?.__length)break;const{done:N,value:O}=x;if(N)break;if(!O)continue;const A=O instanceof Uint8Array?O:new Uint8Array(O);if(p.push(A),m+=A.length,g=Date.now(),kr=g,xe=m,a&&a(m,l),Date.now()-h>=2e3&&(h=Date.now(),w("nai.read_bytes.progress",{message:`${Math.round(m/1024)}KB`,bytes:m,content_length:l,focus:!0})),Rs(Sn(p,m))&&Date.now()-g>=600){w("nai.read_bytes.zip_eocd",{bytes:m,focus:!0});break}if(l!=null&&l>0&&m>=l)break}}catch(x){if(m>=64){const N=Sn(p,m);if(Rs(N)||l!=null&&l>0&&m>=l*.98)return w("nai.read_bytes.recover",{message:String(x?.message||x),bytes:m,focus:!0},"warn"),ke=null,te(N)}try{await d.cancel()}catch{}throw ke=null,x}if(ke=null,!m)throw new Error("NAI 본문이 비어 있습니다");const v=Sn(p,m);return w("nai.read_bytes.done",{bytes:m,focus:!0}),te(v)}const f=c.arrayBuffer;if(typeof f=="function"){w("nai.read_bytes",{message:"fallback arrayBuffer() — no body stream",focus:!0});let d=!1,p,m;const g=new Promise((y,v)=>{p=y,m=v});ke={forceFinish:(y="force")=>{w("nai.read_bytes.force",{message:`${y} (arrayBuffer)`,content_length:l,focus:!0},"warn"),d||(d=!0,clearInterval(h),m(new Error(`NAI arrayBuffer 강제중단 (${y}, content-length=${l})`)))}};const h=setInterval(()=>{d||(r?.aborted||Date.now()>=n?(d=!0,clearInterval(h),ke=null,m(new Error(`NAI arrayBuffer 타임아웃 (content-length=${l}). 본문 ~${l?Math.round(l/1024):"?"}KB를 플러그인이 받지 못했습니다.`))):w("nai.read_bytes.wait",{message:`arrayBuffer pending · expect ${l?Math.round(l/1024):"?"}KB`,content_length:l,focus:!0},"warn"))},3e3);f.call(c).then(y=>{d||(d=!0,clearInterval(h),ke=null,p(y))}).catch(y=>{d||(d=!0,clearInterval(h),ke=null,m(y))});const _=await g;if(_&&_.byteLength)return xe=_.byteLength,w("nai.read_bytes.done",{bytes:_.byteLength,focus:!0}),_}if(typeof c.bytes=="function"){const d=await c.bytes();if(d?.length)return te(d)}if(typeof c.text=="function"){const d=await c.text();if(/^[A-Za-z0-9+/=\s]+$/.test(d)&&d.replace(/\s+/g,"").length>64)try{return te(Re(d.replace(/\s+/g,"")))}catch{}throw new Error(`바이너리 본문을 읽지 못함 (text head=${String(d).slice(0,120)})`)}throw new Error("바이너리 본문을 읽지 못함")}async function ud(e,t,n,r={}){const a={Authorization:`Bearer ${e}`,"Content-Type":"application/json"},i=Number(r.timeoutMs||75e3),o=r.signal||null,s=JSON.stringify(t);if(w("nai.payload",{message:`body ${Math.round(s.length/1024)}KB`,bytes:s.length,model:t?.model,timeout_ms:i,url:String(n||"https://image.novelai.net/ai/generate-image").slice(0,100),has_nativeFetch:zt("nativeFetch")}),s.length>15e5)throw w("nai.payload",{message:"too large",bytes:s.length},"error"),new Error(`NAI 페이로드가 너무 큼 (${Math.round(s.length/1024)}KB). 참조 이미지/프롬프트를 줄이세요.`);const c=typeof AbortController<"u"?new AbortController:null,l=()=>{w("nai.abort",{message:"external signal"},"warn"),c?.abort()};if(o){if(o.aborted)throw new Error("NAI 요청이 취소되었습니다.");o.addEventListener("abort",l,{once:!0})}const f=Date.now();xe=0,xr=0,kr=0,ja=!0;const d=setInterval(()=>{const m=Date.now()-f;m>=i?(w("nai.watchdog",{message:`abort after ${m}ms · body=${xe}B`,ms:m,bytes:xe},"warn"),c?.abort()):m>0&&m%1e4<1100&&w("nai.wait",{message:`waiting ${Math.round(m/1e3)}s · body=${xe}B · ${gt()}`,ms:m,bytes:xe,focus:!0},"warn")},1e3);let p=null;try{try{w("nai.fetch.start",{message:"POST generate-image",timeout_ms:i,focus:!0});const m=await Le(n||"https://image.novelai.net/ai/generate-image",{method:"POST",headers:a,body:s,signal:c?.signal,requestTimeoutMs:i});if(w("nai.fetch.returned",{message:"nativeFetch resolved",ms:Date.now()-f,status:Number(m?.status||0),focus:!0}),o?.aborted||c?.signal?.aborted)throw w("nai.fetch.aborted",{ms:Date.now()-f},"error"),new Error(`NAI 타임아웃 (${Math.round(i/1e3)}s) — nativeFetch가 응답하지 않습니다. Models에서 NAI Test를 확인하세요.`);const g={signal:c?.signal,deadline:f+i,onProgress:v=>{xe=v}};if(m&&typeof m=="object"&&"ok"in m&&"data"in m&&!m.arrayBuffer){const v=Number(m.status||(m.ok?200:0));if(w("nai.resp.shape",{message:"ok/data shape",status:v,focus:!0}),v===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(v===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(v>=400){const O=typeof m.data=="string"?m.data:m.data instanceof Uint8Array?new TextDecoder().decode(m.data.subarray(0,220)):JSON.stringify(m.data||{}).slice(0,220);throw new Error(`NAI HTTP ${v}: ${O}`)}const x=ue("nai.read_bytes"),N=await nn(m.data,g);if(x.end({bytes:N?.byteLength||0,focus:!0}),!N||N.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${N?.byteLength||0} bytes)`);return N}const h=Number(m?.status||0);if(w("nai.resp.shape",{message:"Response-like",status:h,has_arrayBuffer:typeof m?.arrayBuffer=="function",has_body:!!m?.body,focus:!0}),h===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(h===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(h>=400){let v="";try{v=await m.text()}catch{}throw new Error(`NAI HTTP ${h}: ${v.slice(0,220)}`)}const _=ue("nai.read_bytes"),y=await nn(m,g);if(_.end({bytes:y?.byteLength||0,status:h,focus:!0}),!y||y.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${y?.byteLength||0} bytes)`);return y}catch(m){throw p=String(m?.message||m),w("nai.fetch.error",{message:p,ms:Date.now()-f,bytes:xe},"error"),/abort|timeout|타임아웃|취소|본문 읽기/i.test(p)?new Error(`NAI 타임아웃/본문실패 (${Math.round(i/1e3)}s, body=${xe}B). ${p.slice(0,180)}`):m instanceof Error?m:new Error(p)}}finally{ja=!1,clearInterval(d),o&&o.removeEventListener("abort",l)}}var xe,xr,kr,ke,ja,Oa,Fs,zs,Us,Ct=T((()=>{ee(),q(),pt(),Q(),Ds(),xe=0,xr=0,kr=0,ke=null,ja=!1,Oa=()=>xe,Fs=()=>xr,zs=()=>kr,Us=()=>ke!==null}));function zn(e){return u(e?.backend||"nai").toLowerCase()==="comfy"?"comfy":"nai"}function fd(e){const t=Number(e?.backend_timeout_seconds??300);return Math.max(30,Math.min(1800,Number.isNaN(t)?300:t))*1e3}function Sr(e){return String(e||"").trim().replace(/\/+$/,"")}function Js(e){return Sr(u(e?.comfy_url))||"http://localhost:8188"}function Pa(e){return!!u(e?.comfy_workflow_json)}async function La(e,t={}){const n=await Le(e,t);if(n&&typeof n=="object"&&"ok"in n&&"data"in n&&typeof n.arrayBuffer!="function"){const i=Number(n.status||(n.ok?200:0));let o=n.data;if(o instanceof Uint8Array&&(o=new TextDecoder().decode(o)),typeof o=="string")try{o=JSON.parse(o)}catch{}return{status:i,data:o}}const r=Number(n?.status||0);let a=null;try{a=await n.json()}catch{try{a=JSON.parse(await n.text())}catch{}}return{status:r,data:a}}async function dd(e,t,n={}){const r=`inlay-nexus-${Math.random().toString(36).slice(2,10)}`,{status:a,data:i}=await La(`${Sr(e)}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:r,prompt:t}),signal:n.signal});if(a>=400||!i?.prompt_id){const o=i?JSON.stringify(i.node_errors||i.error||i).slice(0,300):"";throw new Error(`/prompt 제출 실패 (HTTP ${a}) ${o}`)}return String(i.prompt_id)}async function md(e,t,n={}){const r=Sr(e),a=Number(n.timeoutMs||3e5),i=Date.now()+a;let o=0,s="";for(;Date.now()<i;){if(n.signal?.aborted)throw new Error("이미지 대기 중단 (abort)");await Xe(2500),o+=1;let c=null;try{const{status:d,data:p}=await La(`${r}/history/${t}`,{method:"GET",signal:n.signal});d<400&&p&&p[t]&&(c=p[t])}catch(d){s=String(d?.message||d);continue}if(o%8===0&&w("comfy.poll",{message:`${o}회 · ${Math.round((Date.now()-(i-a))/1e3)}s`,focus:!0}),!c)continue;const l=c.status||{};if(l.status_str==="error")throw new Error(`생성 실패: ${JSON.stringify(l.messages||[]).slice(0,400)}`);const f=c.outputs||{};for(const d of Object.keys(f)){const p=f[d]?.images;if(Array.isArray(p)&&p.length)return p.find(m=>(m?.type||"output")!=="temp")||p[0]}if(l.completed)throw new Error("생성은 완료됐지만 출력 이미지가 없습니다 (SaveImage 노드 확인)")}throw new Error(`이미지 대기 타임아웃 (${Math.round(a/1e3)}s)${s?` · ${s}`:""}`)}async function pd(e,t,n={}){const r=new URLSearchParams({filename:u(t?.filename,300),subfolder:u(t?.subfolder,300),type:u(t?.type,40)||"output"}),a=await Le(`${Sr(e)}/view?${r.toString()}`,{method:"GET",signal:n.signal}),i={signal:n.signal,deadline:Date.now()+6e4};if(a&&typeof a=="object"&&"ok"in a&&"data"in a&&!a.arrayBuffer){const s=Number(a.status||(a.ok?200:0));if(s>=400)throw new Error(`/view 실패 (HTTP ${s})`);return nn(a.data,i)}const o=Number(a?.status||0);if(o>=400)throw new Error(`/view 실패 (HTTP ${o})`);return nn(a,i)}function gd(e,t){let n=String(e||"");for(let r=0;r<8;r+=1){const a=n.replace(/\[\[#(\w+)\]\]([\s\S]*?)\[\[\/\1\]\]/g,(i,o,s)=>{const c=t[o];return c!=null&&String(c).trim()!==""?s:""});if(a===n)break;n=a}return n.replace(/[ \t]+\n/g,`
`).replace(/\n{3,}/g,`

`)}function hd(e,t){for(const n of Object.values(e)){const r=n?.inputs;if(!(!r||typeof r!="object"))for(const a of Object.keys(r)){const i=r[a];if(typeof i!="string"||!i.includes("[["))continue;const o=gd(i,t),s=o.match(/^\[\[\s*(\w+)\s*\]\]$/);if(s&&s[1]in t){r[a]=t[s[1]];continue}r[a]=o.replace(/\[\[\s*(\w+)\s*\]\]/g,(c,l)=>l in t?String(t[l]):c)}}}function _d(e,t){const n=Number(t)||1;for(const r of Object.values(e)){const a=r?.inputs;if(!(!a||typeof a!="object"))for(const i of Object.keys(a)){if(!/^(seed|noise_seed)$/i.test(i))continue;const o=a[i];(typeof o=="number"&&Number.isFinite(o)||typeof o=="string"&&/^\d+$/.test(o.trim()))&&(a[i]=n)}}}function Hs({main:e,neg:t,captions:n,nai:r,seed:a}){const i={pos:String(e||""),neg:String(t||""),width:Number(r.width??832)||832,height:Number(r.height??1216)||1216,seed:Number(a)||1,steps:Number(r.steps??28)||28,cfg:Number(r.cfg_scale??7)||7};for(let o=0;o<6;o+=1)i[`char${o+1}`]=u(n?.[o]?.prompt,2e3);return i}function yd(e){let t=String(e||"");return t=t.replace(/(:\s*)\[\[\s*(\w+)\s*\]\](\s*[,}\]])/g,'$1"[[$2]]"$3'),t}function Ks(e,t){const n=u(e);if(!n)throw new Error("ComfyUI 워크플로 JSON이 비어 있습니다. Models 탭에 API Export JSON을 붙여넣으세요.");let r;const a=yd(n);try{r=JSON.parse(a)}catch(s){const c=/\[\[/.test(n)?' · 팁: [[seed]] 같은 값은 반드시 "[[seed]]"처럼 따옴표로 감싸세요.':"";throw new Error(`ComfyUI 워크플로 JSON 파싱 실패: ${String(s?.message||s).slice(0,120)}${c}`)}if(!r||typeof r!="object"||Array.isArray(r))throw new Error("ComfyUI 워크플로는 API 포맷(JSON 객체, 노드ID→노드)이어야 합니다.");let i=r;if(i.nodes&&i.links)throw new Error("UI 저장 포맷 워크플로입니다. ComfyUI에서 'Export (API)'로 내보낸 JSON을 넣으세요.");const o=JSON.stringify(i);if(!/\[\[\s*pos\s*\]\]/.test(o))throw new Error("워크플로에 [[pos]]가 없습니다. 긍정 프롬프트를 넣는 칸에 [[pos]]를 적어 주세요.");return i=JSON.parse(o),hd(i,t),_d(i,t.seed),i}async function bd(e,t,n,r){const a=Js(e),i=fd(e),o=Number(e.seed??0)||Math.floor(Math.random()*4294967295)||1,s=Hs({main:t,neg:n,captions:r,nai:e,seed:o}),c=Ks(e.comfy_workflow_json,s);return w("comfy.generate.start",{message:a,prompt_len:String(t||"").length,chars:(r||[]).length,nodes:Object.keys(c).length,focus:!0}),Gs.run(async()=>{const l=await dd(a,c);w("comfy.generate.submitted",{message:l.slice(0,8),focus:!0});const f=await md(a,l,{timeoutMs:i}),d=await pd(a,f);if(w("comfy.generate.done",{bytes:d?.byteLength||0,focus:!0}),!d||d.byteLength<256)throw new Error(`ComfyUI 응답 이미지가 너무 짧음 (${d?.byteLength||0}B)`);return[d,o]})}var Gs,Ba=T((()=>{q(),_t(),D(),Ct(),Gs=new ir}));Ba(),au(),Q(),D();var Ra=no;function ze(e,t=!1){let n=Ra[String(e).toLowerCase()]||e;return t&&(n+="-inpainting"),n}function wd(e){const t=[],n=[];for(const r of e.characters||[]){const a={x:r.center_x,y:r.center_y};t.push({char_caption:r.prompt,centers:[a]}),n.push({char_caption:r.uc||"",centers:[a]})}return{autoSmea:!0,prefer_brownian:!0,ucPreset:0,use_coords:!1,legacy_uc:!1,add_original_image:!0,v4_prompt:{caption:{base_caption:e.prompt,char_captions:t},use_coords:!1,use_order:!0},v4_negative_prompt:{caption:{base_caption:e.negative_prompt,char_captions:n},legacy_uc:!1}}}function vd(e){const t=ze(e.model),n={width:e.width,height:e.height,n_samples:1,seed:e.seed,extra_noise_seed:e.seed,sampler:e.sampler,steps:e.steps,scale:e.cfg_scale,negative_prompt:e.negative_prompt,cfg_rescale:e.cfg_rescale,noise_schedule:e.scheduler,params_version:3,legacy:!1,legacy_v3_extend:!1};if(e.var_plus?n.skip_cfg_above_sigma=t.includes("4-5")?58:19:n.skip_cfg_above_sigma=null,t.includes("nai-diffusion-4")&&Object.assign(n,wd(e)),e.vibes?.length&&(n.reference_image_multiple=e.vibes.map(r=>r.encoded),n.reference_strength_multiple=e.vibes.map(r=>r.strength),n.reference_information_extracted_multiple=e.vibes.map(r=>r.information_extracted),n.normalize_reference_strength_multiple=!0),e.character_refs?.length){if(!t.includes("4-5"))throw new Error("Character Reference는 NAID4.5 전용입니다");n.director_reference_images=e.character_refs.map(r=>Ut(r.image)),n.director_reference_strength_values=e.character_refs.map(r=>r.strength),n.director_reference_secondary_strength_values=e.character_refs.map(r=>1-r.fidelity),n.director_reference_descriptions=e.character_refs.map(r=>({caption:{base_caption:r.type,char_captions:[]},legacy_uc:!1})),n.director_reference_information_extracted=e.character_refs.map(()=>1),n.controlnet_strength=1,n.inpaintImg2ImgStrength=1,n.normalize_reference_strength_multiple=!0,delete n.skip_cfg_above_sigma}return n}function Ue(e){const t=u(e)||"nai-diffusion-4-5-full",n=Object.fromEntries(Object.entries(Ra).map(([r,a])=>[a,r]));return Ra[t]?t:n[t]?n[t]:"naid4.5f"}ee(),q(),_t(),Q(),Ds(),Ct();var xd=new ir;async function Ws(e,t,n,r={}){const a={input:t.prompt,model:ze(t.model),action:"generate",parameters:vd(t)};return w("nai.generate.start",{message:a.model,prompt_len:String(t.prompt||"").length,chars:(t.characters||[]).length,has_char_refs:!!t.character_refs?.length,has_vibes:!!t.vibes?.length}),xd.run(async()=>{const i=await ud(e,a,n,r),o=ue("nai.unzip");try{const s=await cd(new Uint8Array(i)),c=yt(new Uint8Array(s));return o.end({bytes:s?.byteLength||0,is_png:c,zip_bytes:i?.byteLength||0}),c||w("nai.unzip",{message:"unzipped but not PNG magic",bytes:s?.byteLength||0},"warn"),{raw_bytes:s,seed:t.seed||0}}catch(s){throw o.fail(s,{zip_bytes:i?.byteLength||0}),s}})}async function kd(e){const t=await Le(Ti,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),n=Number(t?.status||0);if(n===401)throw new Error("인증 실패 (401). API 토큰을 확인하세요.");if(n>=400)throw new Error(`Anlas 조회 실패: HTTP ${n}`);const r=await t.json(),a=r.trainingStepsLeft||{},i=a.fixedTrainingStepsLeft||0,o=a.purchasedTrainingSteps||0,s=r.perks?.unlimitedMaxPriority||!1;return{fixed:i,purchased:o,total:i+o,opus:s}}function Se(e){return Number.isFinite(e)?Math.max(0,Math.min(100,e)):0}function Sd(e){if(!e)return null;for(const t of["y_percent","anchor_percent","read_percent"]){const n=Number(e[t]);if(Number.isFinite(n))return Se(n)}return null}function Ad(e){const t=e.length;if(!t)return[];const n=e.map((a,i)=>({index:i,y:Sd(a)})).map((a,i)=>a.y!=null?a.y:t===1?50:Se(i/Math.max(1,t-1)*100)).map((a,i)=>({y:a,index:i})).sort((a,i)=>a.y-i.y||a.index-i.index),r=Array.from({length:t},()=>({from_percent:0,to_percent:100}));for(let a=0;a<n.length;a++){const{y:i,index:o}=n[a],s=a>0?n[a-1].y:null,c=a<n.length-1?n[a+1].y:null;let l,f;s==null&&c==null?(l=Se(i-Da),f=Se(i+Da)):s==null?(l=0,f=Se((i+c)/2)):c==null?(l=Se((s+i)/2),f=100):(l=Se((s+i)/2),f=Se((i+c)/2)),f<l&&(f=l),f-l<1&&(l=Se(i-.5),f=Se(i+.5),f<l&&(f=l)),r[o]={from_percent:Math.round(l*100)/100,to_percent:Math.round(f*100)/100}}return r}function Md(e,t,n){const r=e.length;if(!r)return{start:0,end:0};const a=Se(t),i=Se(n);let o=Math.floor(r*a/100),s=Math.ceil(r*i/100);return s<o&&(s=o),s===o&&o<r&&(s=Math.min(r,o+1)),{start:Math.max(0,o),end:Math.min(r,s)}}function Nd(e,t,n,r=Vs){const a=typeof e=="string"?e:"";if(!a)return"";let{start:i,end:o}=Md(a,t,n);const s=a.lastIndexOf(`
`,i);s>=0&&i-s<=80&&(i=s+1);const c=a.indexOf(`
`,o);c>=0&&c-o<=80&&(o=c);let l=a.slice(i,o).trim();return l.length>r&&(l=`${l.slice(0,r).trimEnd()}…`),l}function qs(e,t){return Ad(e).map(n=>({focus:n,focus_hint:Nd(t,n.from_percent,n.to_percent)}))}var Da,Vs,Id=T((()=>{Da=15,Vs=600})),Ed,Ys,Xs,Zs,Cd=T((()=>{Ed=1,Ys="Inlay default (SFW)",Xs=[{id:"composition.solo",label:"솔로 구도",options:[{id:"1girl_solo_portrait",description:"여성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"1boy_solo_portrait",description:"남성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"solo_from_side",description:"혼자 옆모습",tags:"from side, cowboy shot"},{id:"solo_upper_body",description:"혼자 상반신 클로즈업",tags:"upper body, looking at viewer"}]},{id:"composition.duo",label:"2인 구도",options:[{id:"facing_each_other",description:"남녀가 서로를 향함",tags:"2::facing another::",slot:"char",by_slot:{female:"2::facing another::",male:"2::facing another::"}},{id:"male_behind_female",description:"남성이 여성 뒤",tags:"2::from side::, 2::side-by-side::, 2::behind another::"},{id:"side_by_side",description:"나란히 서 있음",tags:"2::side-by-side::, 2::from side::"},{id:"2girls_facing",description:"여성 둘이 마주봄",tags:"2::facing another::"},{id:"hug_front",description:"앞에서 안기",tags:"hug, facing another"}]},{id:"camera.framing",label:"카메라/프레이밍",options:[{id:"cowboy_shot",description:"허리 위",tags:"cowboy shot"},{id:"full_body",description:"전신",tags:"full body"},{id:"upper_body",description:"상반신",tags:"upper body"},{id:"close_up",description:"얼굴 클로즈업",tags:"close-up, face"},{id:"from_above",description:"위에서",tags:"from above"},{id:"from_below",description:"아래에서",tags:"from below"},{id:"from_side",description:"옆에서",tags:"from side"},{id:"pov",description:"1인칭 시점",tags:"pov, pov hands"}]},{id:"pose.hands",label:"손/포즈",options:[{id:"hand_on_own_chest",description:"자신의 가슴에 손",tags:"hand on own chest"},{id:"hands_up",description:"손 들기",tags:"hands up"},{id:"reaching_out",description:"손 뻗기",tags:"reaching out"},{id:"holding_hands",description:"손잡기",tags:"holding hands"},{id:"arm_around_waist",description:"허리에 팔",tags:"arm around waist"},{id:"hug_from_behind",description:"뒤에서 안기",tags:"hug from behind"}]},{id:"expression.basic",label:"표정",options:[{id:"smile",description:"미소",tags:"smile"},{id:"blush",description:"홍조",tags:"blush"},{id:"serious",description:"진지",tags:"serious"},{id:"open_mouth",description:"입 벌림",tags:"open mouth"},{id:"closed_eyes",description:"눈 감음",tags:"closed eyes"},{id:"looking_at_another",description:"상대를 봄",tags:"looking at another"}]},{id:"place.indoor",label:"실내 배경",options:[{id:"bedroom",description:"침실",tags:"bedroom, indoors"},{id:"classroom",description:"교실",tags:"classroom, indoors"},{id:"living_room",description:"거실",tags:"living room, indoors"},{id:"bathroom",description:"욕실",tags:"bathroom, indoors"},{id:"cafe",description:"카페",tags:"cafe, indoors"}]},{id:"place.outdoor",label:"야외 배경",options:[{id:"outdoors_day",description:"낮 야외",tags:"outdoors, blue sky"},{id:"street",description:"거리",tags:"street, outdoors"},{id:"park",description:"공원",tags:"park, outdoors, tree"},{id:"beach",description:"해변",tags:"beach, outdoors, ocean"},{id:"night_city",description:"밤 도시",tags:"outdoors, night, cityscape"}]}],Zs={version:1,name:Ys,groups:Xs}}));function Un(e){return e?e.has_presets===!0?!0:e.presets!=null&&typeof e.presets=="object":!1}function $d(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t={};for(const[n,r]of Object.entries(e)){const a=u(n,80);if(!a||!r||typeof r!="object"||Array.isArray(r))continue;const i=r,o=Array.isArray(i.fallback_order)?i.fallback_order.map(c=>u(c,160)).filter(Boolean):[],s=Math.max(1,Math.min(8,Number(i.max_active_groups)||1));o.length&&(t[a]={max_active_groups:s,fallback_order:o,...u(i.scope,40)?{scope:u(i.scope,40)}:{}})}return Object.keys(t).length?t:void 0}function Qs(e,t){const n=u(e,160).toLowerCase(),r=u(t,160).toLowerCase();if(!n||!r)return!1;if(n.endsWith(".*")){const a=n.slice(0,-1);return r.startsWith(a)||r===n.slice(0,-2)}return n.endsWith("*")?r.startsWith(n.slice(0,-1)):r===n}function ec(e){const t=Array.isArray(e)?e:u(e,800).split(/[,|]/),n=[],r=new Set;for(const a of t){const i=u(a,120);!i||r.has(i)||(r.add(i),n.push(i))}return n}function tc(e,t){const n=ec(t),r=e.modifier_lanes;if(!r||!Object.keys(r).length)return n;const a=new Map;for(const o of n){const s=an(e,o);s&&a.set(o,s.group.id)}const i=new Set;for(const o of Object.values(r)){const s=new Set;for(const f of a.values())o.fallback_order.some(d=>Qs(d,f))&&s.add(f);if(s.size<=o.max_active_groups)continue;const c=[...s].map(f=>{let d=o.fallback_order.length;for(let p=0;p<o.fallback_order.length;p++)if(Qs(o.fallback_order[p],f)){d=p;break}return{gid:f,rank:d}});c.sort((f,d)=>f.rank-d.rank||f.gid.localeCompare(d.gid));const l=new Set(c.slice(0,o.max_active_groups).map(f=>f.gid));for(const{gid:f}of c)l.has(f)||i.add(f)}return i.size?n.filter(o=>{const s=a.get(o);return!s||!i.has(s)}):n}function Fa(){return{base:"",char:"",primary:"",secondary:"",female:"",male:""}}function $t(e,t){const n=u(t,40).toLowerCase();if(["char","character","actor"].includes(n))return"char";if(["primary","main"].includes(n))return"primary";if(["secondary","partner"].includes(n))return"secondary";if(["female","f","girl","woman"].includes(n))return"female";if(["male","m","boy","man"].includes(n))return"male";if(["base","global","scene","camera","place"].includes(n))return"base";const r=u(e,160).toLowerCase();return/^(pose|expression|gesture|emotion|contact|action|interaction|manual|relation|gaze)([./_]|$)/.test(r)||/\.(pose|expression|gesture|interaction|manual|contact)\b/.test(r)||/^composition\.(duo|pair|multi|group|couple)/.test(r)?"char":/^(place|camera|background|location|framing|view|lighting|scene)([./_]|$)/.test(r)||/^composition\./.test(r)?"base":/^state\./.test(r)?"char":"base"}function nc(e){const t=u(e,200).toLowerCase();if(!t)return null;const n=t.split(".")[0]||"";return n==="global"||n==="scene"||n==="camera"?"base":n==="primary"?"primary":n==="secondary"?"secondary":n==="female"||n==="girl"||n==="woman"?"female":n==="male"||n==="boy"||n==="man"?"male":n==="persona"?"base":null}function Td(e){return e.trim().toLowerCase()==="global.composition"}function rc(e){if(!e||typeof e!="object"||Array.isArray(e))return{};const t={};for(const[n,r]of Object.entries(e)){if(Td(n))continue;const a=nc(n);if(!a)continue;const i=Jn(r);i&&(t[a]=I(t[a],i))}return t}function Tt(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function Jn(e){if(typeof e=="string")return u(e,800);if(!Array.isArray(e)||!e.length)return"";const t=[];for(const n of e){if(typeof n=="string"){const i=u(n,200);i&&t.push(i);continue}if(!Array.isArray(n)||n.length<2)continue;const r=Number(n[0]),a=u(n[1],200);a&&(Number.isFinite(r)&&r!==1?t.push(`${r}::${a}::`):t.push(a))}return I(...t)}function jd(e,t,n){const r=Tt(e);if(!r)return null;const a=u(r.id,120)||`opt_${t}`,i=rc(r.prompt),o=Tt(r.by_slot)||Tt(r.slots)||Tt(r.actors),s={...i};if(o){for(const d of["base","char","primary","secondary","female","male"]){const p=u(o[d],800);p&&(s[d]=I(s[d],p))}for(const[d,p]of Object.entries(o)){const m=$t(n,d);typeof p=="string"&&u(p)&&(s[m]=I(s[m],u(p,800)))}}let c=u(r.tags??r.tag,800);if(c||(c=Array.isArray(r.prompt)?Jn(r.prompt):""),c||(c=u(typeof r.prompt=="string"?r.prompt:"",800)),!c&&Object.keys(s).length&&(c=I(...Object.values(s))),!c)return null;const l=$t(n,r.slot??r.target??r.apply_to),f=Object.keys(s).length?s:void 0;return{id:a,description:u(r.description??r.label??r.when,400)||a,tags:c,slot:l,...f?{by_slot:f}:{}}}function ac(e,t,n){const r=Tt(e);if(!r)return null;const a=u(r.id,160)||`group_${t}`,i=u(r.label??r.name??r.description,200)||a,o=Array.isArray(r.options)?r.options:Array.isArray(r.include_options)?r.include_options:[],s=[];for(let c=0;c<o.length&&s.length<n;c++){const l=jd(o[c],c,a);l&&s.push(l)}return s.length?{id:a,label:i,options:s,...r.continuity===!0||r.continuity==="true"?{continuity:!0}:{}}:null}function Od(e,t){const n=Array.isArray(e)?e:e&&typeof e=="object"?Object.values(e):[],r=[];for(let a=0;a<n.length;a++){const i=ac(n[a],a,t);i&&r.push(i)}return r}function Pd(e,t){return e.modifier_library!=null?{list:Od(e.modifier_library,80),maxOptions:80,nameHint:"Asset Maid catalog",preNormalized:!0}:Array.isArray(e.groups)?{list:e.groups,maxOptions:80,nameHint:"",preNormalized:!1}:Array.isArray(t)?{list:t,maxOptions:80,nameHint:"",preNormalized:!1}:{list:[],maxOptions:10,nameHint:"",preNormalized:!1}}function za(e,t="catalog"){const n=Tt(e)||{},{list:r,maxOptions:a,nameHint:i,preNormalized:o}=Pd(n,e),s=[];for(let A=0;A<r.length;A++){if(o){const B=r[A];if(B?.id&&Array.isArray(B.options)&&B.options.length){const k=B.options.slice(0,a).map((E,M)=>({...E,slot:E.slot||$t(B.id,E.slot),id:E.id||`opt_${M}`,description:E.description||E.id||`opt_${M}`,tags:E.tags}));s.push({id:B.id,label:B.label||B.id,options:k,...B.continuity?{continuity:!0}:{}})}continue}const $=ac(r[A],A,a);$&&s.push($)}if(!s.length)throw new Error("큐레이션 카탈로그에 그룹이 없습니다. Inlay `{groups:[…]}` 또는 Asset Maid `modifier_library` JSON인지 확인하세요.");const c=Number(n.version)||1,l=u(n.name,200)||i||t,f=n.presets!=null&&typeof n.presets=="object"?n.presets:void 0,d=$d(n.modifier_lanes),p=Tt(n.global)||{},m=Jn(p.fixed_positive)||u(p.fixed_positive??n.fixed_positive,800),g=Jn(p.fixed_negative)||u(p.fixed_negative??n.fixed_negative,800),h=n.subjects??p.subjects,_=n.selection??p.selection,y=p.prompt_order??n.prompt_order,v=Array.isArray(y)?y.map(A=>u(A,40)).filter(Boolean):void 0,x=new Set(s.filter(A=>A.continuity).map(A=>A.id)),N=n.continuity??p.continuity;if(Array.isArray(N))for(const A of N){const $=u(A,160);if(!$)continue;x.add($);const B=s.find(k=>k.id===$);B&&(B.continuity=!0)}const O={version:c,name:l,groups:s,...f?{presets:f,has_presets:!0}:{has_presets:!1},...d?{modifier_lanes:d}:{},...m?{fixed_positive:m}:{},...g?{fixed_negative:g}:{},...h!=null&&typeof h=="object"?{subjects:h}:{},..._!=null&&typeof _=="object"?{selection:_}:{},...v?.length?{prompt_order:v}:{},...x.size?{continuity_group_ids:[...x].sort()}:{}};return O.sha=Hn(O),O}function Ua(e,t){const n=u(t,160);return n?e.continuity_group_ids?.includes(n)?!0:oc(e,n)?.continuity===!0:!1}function ic(e){return e.groups.filter(t=>!Ua(e,t.id))}function Ja(){return za(Zs,"Inlay default (SFW)")}function Hn(e){const t=JSON.stringify({version:e.version,name:e.name,groups:e.groups.map(r=>({id:r.id,continuity:r.continuity??null,options:r.options.map(a=>({id:a.id,tags:a.tags,description:a.description,slot:a.slot,by_slot:a.by_slot}))})),presets:e.presets??null,modifier_lanes:e.modifier_lanes??null,fixed_positive:e.fixed_positive??null,fixed_negative:e.fixed_negative??null,subjects:e.subjects??null,selection:e.selection??null,prompt_order:e.prompt_order??null,continuity_group_ids:e.continuity_group_ids??null});let n=2166136261;for(let r=0;r<t.length;r++)n^=t.charCodeAt(r),n=Math.imul(n,16777619);return(n>>>0).toString(16).padStart(8,"0")}function Ld(...e){const t=Fa();for(const n of e)n&&(t.base=I(t.base,n.base),t.char=I(t.char,n.char),t.primary=I(t.primary,n.primary),t.secondary=I(t.secondary,n.secondary),t.female=I(t.female,n.female),t.male=I(t.male,n.male));return t}function rn(e){return e?{base:u(e.base,800),char:u(e.char,800),primary:u(e.primary,800),secondary:u(e.secondary,800),female:u(e.female,800),male:u(e.male,800)}:Fa()}function oc(e,t){const n=u(t,160);return n&&e.groups.find(r=>r.id===n)||null}function an(e,t){const n=u(t,120);if(!n)return null;for(const r of e.groups){const a=r.options.find(i=>i.id===n);if(a)return{group:r,option:a}}return null}function Bd(e){const t=[];for(const n of e.groups)for(const r of n.options)t.push({key:`${n.id}::${r.id}`,groupId:n.id,optionId:r.id,text:`${r.description} | ${r.tags}`,tags:r.tags,slot:r.slot||$t(n.id)});return t}function Rd(e,t=!1){const n=ic(e).map(r=>{const a=r.options.map(i=>`  - ${i.id}: ${i.description}`).join(`
`);return`### ${r.id} (${r.label})
...
`)}function sc(){return["## Per-actor ids (strict catalog-id mode)",'Add `"characters": [ { "index": 0, "option_ids": ["id", "..."] }, ... ]` to EVERY shot.','Each shot input includes `cast`: `[{ "index": 0, "name": "...", "gender": "girl|boy|""" }, ...]`.',"`index` MUST match `cast[].index` / Pass-1 `characters` array order — use name+gender from `cast`, not chat mention order.","Example: if cast says index 0 = 보민 (boy) and index 1 = Serin (girl), put bound/tears on the boy's index, not the girl's.","Put an option on `characters[].option_ids` when it targets ONE specific actor (pose, contact, expression, gaze).","Put an option on the shot-level `curation_option_ids` instead when it is scene-wide (camera, place, framing) — do not duplicate it into every actor.","Every actor in `cast` needs an entry, even if `option_ids` is `[]`.","This mode has NO freeform camera/situation/action fallback — an unlisted concept is simply omitted, never paraphrased."]}function Dd(e,t,n){const r=n?.strictIds===!0,a=new Set(t.map(s=>u(s,160)).filter(Boolean)),i=ic(e).filter(s=>a.has(s.id)),o=(i.length?i:[]).map(s=>{const c=s.options.map(l=>`  - ${l.id}: ${l.description}`).join(`
`);return`### ${s.id} (${s.label})
${c}`});return["Curation two-stage ON (pass 2 — scene refine, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ] }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "camera": "...", "situation": "...", "place": "...", "action": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["cowboy_shot", "smile"] }, { "index": 1, "option_ids": ["facing_each_other"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["cowboy_shot", "facing_each_other", "smile", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output — host injects catalog tags from those ids.","For EVERY shot pick ALL listed options that match the chat at that y_percent (pose, contact, expression, place…).","Typical **2–8 ids**; `[]` ONLY if nothing fits. Do not skip obvious matches.",r?"Do NOT invent character appearance/attire. Do NOT invent option ids. Do NOT write freeform camera/situation/action text — ids only.":"Prefer ids over freeform camera/situation/action paraphrase.",...r?[]:["Do NOT invent character appearance/attire. Do NOT invent option ids."],...cc(),...r?["",...sc()]:[],"",o.length?"## Allowed options (union of all shots' groups)":`## Allowed options
(none — leave scene fields empty)`,...o].join(`
`)}function cc(){return["## Chat context (separate user message, READ-ONLY)","A prior user message is the exact chat text from pass 1 (for LLM prompt cache).","Use it for continuity only (who the cast is, ongoing scene).","Do NOT rewrite, quote-edit, summarize into the JSON, or invent missing plot beats.","Do NOT change shot count, shot_index, composition_id, composition_variant, or y_percent.","","## Shot focus bands (PRIMARY evidence)","Each shot includes `y_percent`, `focus: { from_percent, to_percent }`, and `focus_hint` (a short quote from that band of the chat).","Pick options primarily from `focus_hint` / the `focus` percent range for THAT shot.","Do NOT pull actions from far-away bands into this shot. Full chat is background, not a license to copy the same ids onto every shot.","When focuses differ, prefer distinct `curation_option_ids` / per-actor ids across shots — avoid pasting one identical set on every shot_index.","Do NOT invent aftermath tags (`after_sex`, `afterglow`, cum_on_*, etc.) unless `focus_hint` explicitly shows that aftermath.","y_percent / focus are already final — never output new y_percent or focus fields."]}function Fd(){return["Curation embed-snap mode: write DETAILED English Danbooru scene tags.","Fill camera, situation, place, action with concrete tags (framing, pose, contact, location, expression-as-scene).",'Use standard Danbooru spacing (underscores as spaces): e.g. "cowboy shot", "from side", "hand on own chest", "facing another".','Prefer specific pose/contact/framing over vague words like "intimate" or "dramatic".',"Character appearance/attire/accessories stay in character fields — do not move them into camera/situation.","`natural` still follows the Natural base mode system message."].join(`
`)}function zd(e){const t=e.prompt_order;if(!t?.length)return Ka;const n=[],r=new Set;for(const a of t){const i=nc(a)||(u(a,40).toLowerCase()==="char"?"char":null);i&&!r.has(i)&&(r.add(i),n.push(i))}for(const a of Ka)r.has(a)||n.push(a);return n}function Ud(e,t){const n=lc(e,t);return I(...zd(e).map(r=>n[r]))}function lc(e,t){const n=Array.isArray(t)?t:u(t,800).split(/[,|]/),r={base:[],char:[],primary:[],secondary:[],female:[],male:[]},a=new Set;for(const i of n){const o=u(i,120);if(!o||a.has(o))continue;const s=an(e,o);if(!s)continue;a.add(o);const c=s.option.by_slot;if(c&&Object.keys(c).length){for(const l of Object.keys(c)){const f=u(c[l],800);f&&r[l].push(f)}continue}r[$t(s.group.id)].push(s.option.tags)}return{base:I(...r.base),char:I(...r.char),primary:I(...r.primary),secondary:I(...r.secondary),female:I(...r.female),male:I(...r.male)}}function jt(e,t){t&&(e.action=I(u(e.action,600),t))}function Ha(e,t,n){const r={...Fa(),...t};e.camera=u(r.base,800),e.situation=u(n?.situation,400)||"",n&&"place"in n&&(e.place=u(n.place,400));const a=(Array.isArray(e.characters)?e.characters:[]).filter(o=>o&&typeof o=="object"),i=!!(r.char||r.primary||r.secondary||r.female||r.male);if(!a.length){e.action=i?I(r.char,r.primary,r.secondary,r.female,r.male):"";return}i&&(e.action=""),Jd(a,r)}function uc(e){const t=Array.isArray(e?.characters)?e.characters:[],n=[];for(let r=0;r<t.length;r++){const a=t[r];if(!a||typeof a!="object"){n.push({index:r,name:"",gender:""});continue}const i=a,o=$n(i);n.push({index:r,name:u(i.name,200),gender:o==="f"?"girl":o==="m"?"boy":""})}return n}function fc(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(!n||typeof n!="object")continue;const r=n,a=Number(r.index);!Number.isInteger(a)||a<0||t.push({index:a,option_ids:r.option_ids??r.ids??r.curation_option_ids})}return t}function dc(e,t,n){if(!t.length)return;const r=Array.isArray(e.characters)?e.characters:[];for(const{index:a,option_ids:i}of t){const o=r[a];if(!o||typeof o!="object")continue;const s=Ud(n,i);s&&jt(o,s)}}function Jd(e,t){t.primary&&jt(e[0],t.primary),t.secondary&&e[1]&&jt(e[1],t.secondary);for(const n of e){t.char&&jt(n,t.char);const r=$n(n);t.female&&r==="f"&&jt(n,t.female),t.male&&r==="m"&&jt(n,t.male)}if(!e.some(n=>$n(n)!=null)){const n=I(t.female,t.male);if(n)for(const r of e)jt(r,n)}}function Hd(e){return e.groups.reduce((t,n)=>t+n.options.length,0)}var Kd,Gd,Ka,Ga=T((()=>{Cd(),D(),at(),Kd=10,Gd=80,Ka=["base","char","primary","secondary","female","male"]}));function Wd(e){let t=u(e.composition_id,160)||u(e.preset_id,160)||u(e.leaf_id,160)||u(e.position_id,160)||u(e.curation_leaf,160)||u(e.composition,160);if(t&&/[|/]/.test(t)){const r=t.split(/[/|]/).map(a=>u(a,160)).filter(Boolean);r.length>=2&&((!Array.isArray(e.preset_path)||!e.preset_path.length)&&(e.preset_path=r),t=r[r.length-1])}const n=u(e.composition_variant,120)||u(e.selected_variant_id,120)||u(e.variant_id,120)||u(e.variant,120);return t&&(e.composition_id=t),n&&(e.composition_variant=n),Array.isArray(e.preset_path)&&e.preset_path.length?!0:!!t}function Ot(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function qd(e){const t=[];for(const n of["children","variants"]){const r=e[n];if(Array.isArray(r))for(const a of r){const i=Ot(a);i&&t.push(i)}}return t}function mc(e){return Array.isArray(e.variants)?e.variants.map(Ot).filter(Boolean):[]}function Vd(e){const t=e.when_to_use;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):u(e.description,400)}function Yd(e){const t=e.avoid_when;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):""}function Xd(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,n=u(t.ref??t.id??t.group,160);if(!n)return null;const r=Array.isArray(t.include_options)?t.include_options.map(o=>u(o,120)).filter(Boolean):void 0,a=t.action&&typeof t.action=="object"&&!Array.isArray(t.action)?t.action:null,i=a?{source:u(a.source,40)||void 0,target:u(a.target,40)||void 0,include_options:Array.isArray(a.include_options)?a.include_options.map(o=>u(o,120)).filter(Boolean):void 0}:void 0;return{ref:n,include_options:r?.length?r:void 0,replace:t.replace===!0,order:Number.isFinite(Number(t.order))?Number(t.order):void 0,action:i}}function pc(e){return Array.isArray(e.modifiers)?e.modifiers.map(Xd).filter(Boolean):[]}function Zd(e){if(!Un(e))return[];const t=Ot(e.presets);if(!t)return[];const n=[],r=(a,i,o,s)=>{const c=u(a.id,160),l=u(a.type,40),f=c&&c!=="preset"?[...i,c]:i,d=!o&&c&&c!=="preset"?c:o,p=l==="category"&&c?c:s,m=Array.isArray(a.children)?a.children.map(Ot).filter(Boolean):[],g=mc(a);if(c&&c!=="preset"&&(l==="position"||g.length>0&&m.length===0)){const h=pc(a),_=[...new Set(h.map(y=>y.ref).filter(Boolean))];n.push({id:c,path:f,composition:d||c,category:p,when:Vd(a),avoid:Yd(a),variants:g.map(y=>u(y.id,120)).filter(Boolean),description:u(a.description,300)||c,selectionModifiers:_})}for(const h of m)r(h,f,d,p)};return r(t,[],"",""),n}function gc(e,t,n){const r=Ot(e.presets),a=u(t,160);if(!r||!a)return null;const i={chain:null},o=(d,p)=>{if(i.chain)return;const m=[...p,d];if(u(d.id,160)===a){i.chain=m;return}const g=Array.isArray(d.children)?d.children.map(Ot).filter(Boolean):[];for(const h of g)o(h,m)};o(r,[]);const s=i.chain;if(!s)return null;const c=u(n,120);if(!c)return s;const l=s[s.length-1],f=mc(l).find(d=>u(d.id,120)===c);return f?[...s,f]:s}function Wa(e,t){const n=t.preset_path;if(Array.isArray(n)&&n.length){const r=n.map(s=>u(s,160)).filter(Boolean),a=Ot(e.presets);if(!a||!r.length)return null;const i=[a];let o=a;for(const s of r){if(u(o.id,160)===s)continue;const c=qd(o).find(l=>u(l.id,160)===s);if(!c)return gc(e,r[r.length-1],void 0);i.push(c),o=c}return i}return gc(e,t.composition_id??(typeof n=="string"?n:""),t.composition_variant)}function qa(e){const t=new Map;for(const n of e)for(const r of pc(n)){const a=t.get(r.ref);if(r.replace||!a){t.set(r.ref,r);continue}const i=[...new Set([...a.include_options||[],...r.include_options||[]])];t.set(r.ref,{...a,...r,include_options:i.length?i:a.include_options,action:r.action||a.action})}return[...t.values()]}function Qd(e,t){const n=new Map,r=new Set;for(const i of t){for(const o of qa(i))n.set(o.ref,o);for(const o of _c(i))r.add(o)}const a=[];for(const[i,o]of n){if(Ua(e,i))continue;const s=oc(e,i);if(!s)continue;const c=o.include_options?.length?new Set(o.include_options):null;let l=c?s.options.filter(f=>c.has(f.id)):s.options;if(r.size){const f=yc(e,l.map(p=>p.id),r),d=new Set(f);l=l.filter(p=>d.has(p.id))}l.length&&a.push({id:s.id,label:s.label,options:l})}return a}function em(e,t){return t?.length?qa(t).filter(n=>Ua(e,n.ref)):[]}function hc(e){const t=u(e,40).toLowerCase();return t?["male","m","boy","man"].includes(t)?"male":["female","f","girl","woman"].includes(t)?"female":["primary","main"].includes(t)?"primary":["secondary","partner"].includes(t)?"secondary":["global","base","scene","camera"].includes(t)?"base":["char","both","all"].includes(t)?"char":null:null}function tm(e){return rn(rc(e))}function nm(e,t,n){const r=an(e,t);if(!r)return rn({});const a=n.find(s=>s.ref!==r.group.id?!1:!s.include_options?.length&&!s.action?.include_options?.length?!0:new Set([...s.include_options||[],...s.action?.include_options||[]]).has(t))||n.find(s=>s.ref===r.group.id);if(r.option.by_slot&&Object.keys(r.option.by_slot).length)return rn(r.option.by_slot);const i=r.option.tags||Jn(r.option.tags);if(!i)return rn({});if(a?.action){const s=hc(a.action.source),c=hc(a.action.target),l={};if(s&&(l[s]=i),c&&(l[c]=I(l[c],i)),s||c)return rn(l)}const o=$t(r.group.id);return rn({[o]:i})}function _c(e){const t=new Set;for(const n of e){const r=n.modifier_filter;if(!r||typeof r!="object"||Array.isArray(r))continue;const a=r.deny;if(!(!a||typeof a!="object"||Array.isArray(a))){for(const i of Object.values(a))if(Array.isArray(i))for(const o of i){const s=u(o,160).toLowerCase();s&&t.add(s)}}}return t}function yc(e,t,n){return n.size?t.filter(r=>{const a=r.toLowerCase();if(n.has(a))return!1;const i=an(e,r);if(!i)return!0;const o=u(i.option.tags,800).toLowerCase(),s=u(i.option.description,400).toLowerCase();for(const c of n){const l=c.replace(/_/g," ");if(o.includes(c)||o.includes(l)||s.includes(l))return!1}return!0}):t}function rm(e,t,n){const r=new Map;for(const a of n)Number.isFinite(a.order)&&r.set(a.ref,a.order);return r.size?t.map((a,i)=>({id:a,i})).sort((a,i)=>{const o=an(e,a.id)?.group.id,s=an(e,i.id)?.group.id,c=o!=null&&r.has(o)?r.get(o):Number.MAX_SAFE_INTEGER,l=s!=null&&r.has(s)?r.get(s):Number.MAX_SAFE_INTEGER;return c!==l?c-l:a.i-i.i}).map(a=>a.id):t}function am(e,t,n){if(!Un(e))return null;const r=Wa(e,t);if(!r?.length)return null;const a=r.map(p=>tm(p.prompt)),i=qa(r),o=new Set(i.map(p=>p.ref)),s=[...i,...(n?.bindings||[]).filter(p=>!o.has(p.ref))],c=_c(r),l=[...ec(t.curation_option_ids),...n?.optionIds||[]];let f=tc(e,l);f=yc(e,f,c),f=rm(e,f,s);const d=f.map(p=>nm(e,p,s));return Ld(...a,...d)}function im(){return["# Preset selection (Asset Maid analyzer rules)","Use ONLY information in the chat/shot context. Do not invent unseen actors or actions.","","## Actors → composition first","Count actors that are required for the current moment's action/contact.","Pick a composition that matches actor count and genders (e.g. 1girl_solo vs 1girl_1boy).","Do NOT drop a visible partner to force solo. If a male hand/arm is visible contacting the girl from POV, that male is an actor → prefer 1girl_1boy, not 1girl_solo.","","## Walk the tree","Read the leaf list as composition → category → position.","Categories matter: `general` = non-sexual placement; `foreplay` / `sexual` / `insertion` = intimate contact. If the chat has kissing, licking, sexual touch, or sex, do NOT pick a `general` leaf just because posture when-text matches.","For each candidate use when / avoid / selection_modifiers. Prefer the leaf whose when matches AND whose selection_modifiers cover the stated actions.","selection_modifiers are modifier **group ids** this leaf unlocks for pass 2 (e.g. `interaction.partner.mouth_contact`). They are the main reason to prefer one leaf over another when posture is similar.","CRITICAL: do NOT pick a leaf that only matches vague posture words if it lacks the group needed for the chat action. Example: ear licking / kissing / licking neck need a leaf with `interaction.partner.mouth_contact` (usually under foreplay), not `general/facing_each_other` which only has `interaction.general`.","Pick exactly ONE `composition_id` (position leaf) per shot.","If the same leaf id appears under multiple compositions/categories (e.g. `free`), set `composition_id` to the full path string `composition / category / leaf` so the host can disambiguate.","","## Variant","If the leaf lists variants, pick `composition_variant` for the camera that fits (from_side, pov, default…).","If unsure and a default/from_side exists, prefer that over inventing camera tags.","","## What NOT to do in pass 1","Do NOT invent Danbooru camera/pose tags into camera/situation/action.","Do NOT return modifier option ids here (pass 2 does that — e.g. do not emit `licking_ear` in pass 1).","Do NOT set `curation_groups`."]}function om(e,t=!1){const n=Zd(e),r=new Map;for(const i of n){const o=r.get(i.composition)||[];o.push(i),r.set(i.composition,o)}const a=[];for(const[i,o]of r){a.push(`## composition: ${i}`);for(const s of o){const c=s.variants.length?s.variants.join("|"):"(none)",l=s.selectionModifiers.length?s.selectionModifiers.join(", "):"(none)",f=s.description&&s.description!==s.id&&s.description!==s.when?`description: ${s.description}`:"";a.push([`### ${s.id}`,`path: ${s.path.join(" / ")}`,s.category?`category: ${s.category}`:"",s.when?`when: ${s.when}`:"",s.avoid?`avoid: ${s.avoid}`:"",f,`selection_modifiers: ${l}`,`variants: ${c}`].filter(Boolean).join(`
`))}}return["Curation two-stage ON (pass 1 — Asset Maid presets).","CRITICAL: every shot MUST include `composition_id` (exact leaf id, or full path if id is ambiguous). This overrides the base format schema.","Also set `composition_variant` when the leaf lists variants.",...im(),"","On every shot set:","- `composition_id`: leaf id (e.g. `face_to_face_upright`) OR path `1girl_1boy / foreplay / face_to_face_upright` when ids collide","- `composition_variant`: one variant id for that leaf, or omit if none","Still fill characters (appearance/attire/accessories) as usual.","`place` may stay as a short location hint.",...t?["STRICT catalog-id mode is ON: leave `camera`, `situation`, `natural`, and every `characters[].action` / `characters[].expression` completely EMPTY.","Pass 2 assembles ALL scene and per-actor tags from catalog ids only, keyed off the `composition_id`/`composition_variant` you pick here."]:["Leave `situation` empty or non-person scene words only — NEVER put 1girl/1boy/solo there (host adds person-count tags).","`camera`/`action` must NOT include 1girl/1boy/solo either.","`natural` still follows the Natural base mode system message."],"","## Preset leaf catalog (do not invent ids)","selection_modifiers = group ids unlocked for pass 2 (not option ids). Use them to choose the leaf; pass 2 picks concrete options like licking_ear.",...a.length?a:["(empty presets tree)"]].join(`
`)}function sm(e){const t=e.modifier_lanes;if(!t||!Object.keys(t).length)return[];const n=["## Modifier lanes (hard caps — host also enforces)","Within each lane, keep at most max_active_groups distinct groups."];for(const[r,a]of Object.entries(t))n.push(`- lane \`${r}\`: max ${a.max_active_groups} group(s) among [${a.fallback_order.join(", ")}] (earlier pattern wins if over cap)`);return n.push("Example: do not pick both manual.arm_pose and manual.partner_contact options together."),n}function cm(e,t,n){const r=n?.strictIds===!0,a=Qd(e,t).map(i=>{const o=i.options.map(s=>`  - ${s.id}: ${s.description}`).join(`
`);return`### ${i.id} (${i.label})
${o}`});return["Curation two-stage ON (pass 2 — preset modifiers, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ], "place": "..." }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "place": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["hug", "from_side"] }, { "index": 1, "option_ids": ["blush"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["hug", "from_side", "blush", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output. Host injects those catalog tags into the image — empty array = weak/empty pose.","For EVERY shot, pick ALL options that match the chat band at that shot's y_percent:","- contact / hug / hands / pose / expression / gaze / blush / location / lighting / clothing state when visible","Typical count: **2–8 ids** when the scene has clear action; 1 id only if truly minimal; `[]` ONLY if nothing in the list fits.","Do NOT leave `curation_option_ids` empty just to be safe — if hug/facing/hand contact is in the text and listed below, INCLUDE those ids.","Pick ONLY ids listed below. Never invent ids. Never invent character appearance/attire.","Do NOT put Danbooru tags in freeform fields instead of picking ids — prefer ids.","`place` may repeat a short location hint; optional.","Host assembles path prompts + these options into base vs char slots.",...r?["",...sc()]:[],...cc(),...sm(e),"",a.length?"## Allowed modifier options":`## Allowed modifier options
(none — return empty curation_option_ids)`,...a].join(`
`)}var lm=T((()=>{D(),Ga()}));function um(e,t){if(!e.length||e.length!==t.length)return-1;let n=0,r=0,a=0;for(let i=0;i<e.length;i++){const o=e[i],s=t[i];n+=o*s,r+=o*o,a+=s*s}return r<=0||a<=0?-1:n/(Math.sqrt(r)*Math.sqrt(a))}function fm(e,t,n){const r=n?.minScore??.35,a=gm(n?.groupId);let i=null,o=-1,s=null,c=-1;for(const l of t){const f=um(e,l.vector);f>o&&(o=f,i=l),a&&l.groupId===a&&f>c&&(c=f,s=l)}return s&&c>=r?s:i&&o>=r?i:null}function dm(e){return e.slot||$t(e.groupId)}function mm(e,t,n,r=.4){const a=[],i=[],o=[],s=[],c=[],l=[],f=[];let d=0,p=0;const m=(g,h)=>{g==="base"?i.push(h):g==="primary"?s.push(h):g==="secondary"?c.push(h):g==="female"?l.push(h):g==="male"?f.push(h):o.push(h)};for(let g=0;g<e.length;g++){const h=e[g].trim();if(!h)continue;const _=t[g];if(!_||!_.length){a.push(h),i.push(h),p+=1;continue}const y=fm(_,n,{minScore:r});y?(a.push(y.tags),m(dm(y),y.tags),d+=1):(a.push(h),i.push(h),p+=1)}return{tags:a,baseTags:i,charTags:o,primaryTags:s,secondaryTags:c,femaleTags:l,maleTags:f,snapped:d,kept:p}}function pm(e){const t=String(e||"").trim();if(!t)return[];const n=[];let r="",a=0;for(let o=0;o<t.length;o++){const s=t[o];if(s===":"&&t[o+1]===":"){a+=r.includes("::")?-1:1,r+="::",o+=1;continue}if(s===","&&a<=0){const c=r.trim();c&&n.push(c),r="";continue}r+=s}const i=r.trim();return i&&n.push(i),n}function gm(e){return typeof e=="string"?e.trim():""}var hm=T((()=>{Ga()}));function Ne(e){const t=u(e,40).toLowerCase().replace(/[ -]+/g,"_");return t==="openai_compatible"||t==="compat"?"openai_compat":Mr.includes(t)?t:"openai"}function Ar(e){switch(Ne(e)){case"openai":return"https://api.openai.com/v1/embeddings";case"voyage":return"https://api.voyageai.com/v1/embeddings";case"openrouter":return"https://openrouter.ai/api/v1/embeddings";case"lmstudio":return"http://127.0.0.1:1234/v1/embeddings";case"ollama":return"http://127.0.0.1:11434/api/embeddings";default:return"https://api.openai.com/v1/embeddings"}}function Kn(e){switch(Ne(e)){case"voyage":return"voyage-3-lite";case"ollama":return"nomic-embed-text";case"openrouter":return"openai/text-embedding-3-small";case"lmstudio":return"text-embedding-nomic-embed-text-v1.5";default:return"text-embedding-3-small"}}function _m(e){return Kn(e)}function ym(){const e=new Set;for(const t of Mr){const n=Ar(t).replace(/\/+$/,"");e.add(n),e.add(n.replace(/\/embeddings$/i,"")),e.add(n.replace(/\/api\/embeddings$/i,"")),e.add(n.replace(/\/v1$/i,""))}return e}function bm(e){const t=u(e,500);if(!t)return!0;const n=t.replace(/\/+$/,"");return ym().has(n)}function wm(e){const t=u(e,200);return t?new Set(Mr.map(n=>Kn(n))).has(t):!0}function vm(e){const t=Ne(e);return t!=="lmstudio"&&t!=="ollama"}function xm(e){const t=Ne(e.provider),n=u(e.endpoint,500)||Ar(t);return t==="ollama"?n.replace(/\/$/,""):/\/embeddings\/?$/i.test(n)?n.replace(/\/$/,""):/\/v1\/?$/i.test(n)?`${n.replace(/\/$/,"")}/embeddings`:n}function km(e){const t=e&&typeof e=="object"?e:{},n=Array.isArray(t.data)?t.data:[],r=[];for(const a of n){const i=a&&typeof a=="object"?a.embedding:null;if(Array.isArray(i)&&i.every(o=>typeof o=="number"))r.push(i);else throw new Error("임베딩 응답에 숫자 벡터가 없습니다.")}return r}async function bc(e){const t=e.ok!==!1&&(e.status===void 0||e.status>=200&&e.status<300);if(typeof e.json=="function")try{const n=await e.json();if(!t){const r=typeof n=="object"&&n?JSON.stringify(n).slice(0,400):String(n);throw new Error(`임베딩 HTTP ${e.status??"?"}: ${r}`)}return n}catch(n){if(n instanceof Error&&n.message.startsWith("임베딩 HTTP"))throw n}if(typeof e.text=="function"){const n=await e.text();if(!t)throw new Error(`임베딩 HTTP ${e.status??"?"}: ${n.slice(0,400)}`);return n?JSON.parse(n):{}}throw new Error("임베딩 응답을 읽을 수 없습니다.")}async function Va(e,t,n){if(!t.length)return{vectors:[],model:u(e.model)};const r=Ne(e.provider),a=u(e.model,200)||Kn(r),i=xm({...e,provider:r,model:a}),o=u(e.api_key,4e3);if(r==="ollama"){const l=[];for(const f of t){const d=(await bc(await Le(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:a,prompt:f}),signal:n?.signal}))).embedding;if(!Array.isArray(d)||!d.every(p=>typeof p=="number"))throw new Error("Ollama 임베딩 응답이 올바르지 않습니다.");l.push(d)}return{vectors:l,model:a}}const s={"Content-Type":"application/json"};o&&(s.Authorization=`Bearer ${o}`);const c=km(await bc(await Le(i,{method:"POST",headers:s,body:JSON.stringify(r==="voyage"?{model:a,input:t,input_type:"document"}:{model:a,input:t}),signal:n?.signal})));if(c.length!==t.length)throw new Error(`임베딩 개수 불일치: got ${c.length}, want ${t.length}`);return{vectors:c,model:a}}async function Sm(e){const{vectors:t,model:n}=await Va(e,["curation embedding ping"]),r=t[0]?.length||0;if(!r)throw new Error("임베딩 차원이 0입니다.");return{ok:!0,dims:r,model:n}}var Ya,Mr,wc=T((()=>{D(),Ct(),Ya=Object.freeze([{value:"openai",label:"OpenAI"},{value:"voyage",label:"Voyage"},{value:"openrouter",label:"OpenRouter"},{value:"openai_compat",label:"OpenAI-compat"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}]),Mr=Ya.map(e=>e.value)})),Am=fn({LLM_ENDPOINT_PRESETS:()=>lt,LLM_PROVIDERS:()=>Mc,REASONING_EFFORTS:()=>Xa,applyReasoningToBody:()=>Ac,defaultEndpointForProvider:()=>xc,endpointPresetKeyFor:()=>Im,ensureLlmRequestUrl:()=>Sc,knownLlmEndpoints:()=>kc,llmModelPlaceholder:()=>Nm,normalizeLlmProvider:()=>Pt,normalizeReasoningEffort:()=>vc,shouldAutoReplaceEndpoint:()=>Mm});function Pt(e){const t=String(e||"").toLowerCase().replace(/[ -]+/g,"_").trim();return["openrouter"].includes(t)?"openrouter":["openai"].includes(t)?"openai":["google","google_ai","google_ai_studio","gemini"].includes(t)?"google_ai":["vertex","vertex_ai","google_vertex"].includes(t)?"vertex":["anthropic","anthropic_compat","anthropic_compatible","claude"].includes(t)?"anthropic_compatible":["lmstudio","lm_studio"].includes(t)?"lmstudio":["ollama"].includes(t)?"ollama":["custom"].includes(t)?"custom":["openai_compatible","openai_compat"].includes(t)?"openrouter":"custom"}function vc(e){const t=String(e??"default").toLowerCase().trim();return!t||t==="auto"||t==="default"?"default":Xa.includes(t)?t:"default"}function xc(e,t={}){const n=Pt(e);return n==="vertex"?`https://${String(t.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1"}-aiplatform.googleapis.com`:n==="anthropic_compatible"?lt.anthropic:n==="custom"?lt.openai:lt[n]||lt.openai}function kc(){const e=new Set;for(const t of Object.values(lt)){const n=String(t||"").replace(/\/+$/,"");n&&(e.add(n),e.add(n.replace(/\/chat\/completions$/i,"")),e.add(n.replace(/\/v1\/messages$/i,"")),e.add(n.replace(/\/v1$/i,"")))}return e.add("https://us-central1-aiplatform.googleapis.com"),e.add("https://europe-west1-aiplatform.googleapis.com"),e.add("https://asia-northeast1-aiplatform.googleapis.com"),e}function Mm(e){const t=String(e||"").trim().replace(/\/+$/,"");return t?kc().has(t):!0}function Sc(e,t,n={}){const r=Pt(t);let a=String(e||"").trim().replace(/\/+$/,"");if(a||(a=xc(r,n).replace(/\/+$/,"")),r==="anthropic_compatible")return/\/v1\/messages$/i.test(a)||/\/messages$/i.test(a)?a:/\/v1$/i.test(a)?`${a}/messages`:`${a}/v1/messages`;if(r==="vertex"){const i=String(n.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1",o=String(n.projectId||"").trim();if(o)return`https://${i}-aiplatform.googleapis.com/v1/projects/${encodeURIComponent(o)}/locations/${encodeURIComponent(i)}/endpoints/openapi/chat/completions`;if(/aiplatform\.googleapis\.com/i.test(a)&&!/\/chat\/completions$/i.test(a))return a}return/\/chat\/completions$/i.test(a)?a:/\/openai$/i.test(a)?`${a}/chat/completions`:/\/v1beta$/i.test(a)?`${a}/openai/chat/completions`:/\/v1$/i.test(a)?`${a}/chat/completions`:a}function Ac(e,t){const n={};e&&typeof e=="object"&&Object.assign(n,e);const r=vc(t);return r==="default"||(n.reasoning={effort:r}),n}function Nm(e){const t=Pt(e),n={openrouter:"openai/gpt-4o-mini",openai:"gpt-4o-mini",google_ai:"gemini-2.5-flash",vertex:"gemini-2.0-flash-001",anthropic_compatible:"claude-sonnet-4",lmstudio:"local-model",ollama:"llama3.2",custom:"model-id"};return n[t]||n.custom}function Im(e){const t=String(e||"").trim().replace(/\/+$/,"");for(const[n,r]of Object.entries(lt)){const a=r.replace(/\/+$/,"");if(t===a||t===a.replace(/\/chat\/completions$/i,"")||t===a.replace(/\/v1\/messages$/i,""))return n}return"custom"}var lt,Xa,Mc,Nr=T((()=>{lt=Object.freeze({openai:"https://api.openai.com/v1/chat/completions",openrouter:"https://openrouter.ai/api/v1/chat/completions",google_ai:"https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",lmstudio:"http://127.0.0.1:1234/v1/chat/completions",ollama:"http://127.0.0.1:11434/v1/chat/completions",anthropic:"https://api.anthropic.com/v1/messages",vertex:"https://us-central1-aiplatform.googleapis.com"}),Xa=Object.freeze(["default","none","minimal","low","medium","high","xhigh","max"]),Mc=Object.freeze([{value:"openrouter",label:"OpenRouter"},{value:"openai",label:"OpenAI"},{value:"google_ai",label:"Google AI Studio"},{value:"vertex",label:"Vertex AI (Google Cloud)"},{value:"anthropic_compatible",label:"Anthropic-compatible"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}])}));function Ir(e){const t=String(e||"").trim().toLowerCase();return t==="main"||t==="risu_main"||t==="risu-main"?"main":t==="aux"||t==="otherax"||t==="other_ax"||t==="risu_aux"||t==="risu-aux"||t==="sub"||t==="secondary"?"aux":"custom"}function Em(e){const t=Ir(e);return t==="main"||t==="aux"}function Nc(e){const t=e||{};return Em(t.source)?!0:Pt(t.provider)==="vertex"?!!(u(t.model)&&(u(t.api_key)||u(t.service_account_json))):!!(u(t.model)&&u(t.api_key))}function Cm(e){let t="";const n=[];for(const r of e||[]){const a=String(r?.role||""),i=r?.content;if(a==="system"){const o=typeof i=="string"?i:Array.isArray(i)?i.map(s=>typeof s=="object"?s.text||"":String(s)).join(""):String(i??"");t=t?`${t}
${o}`:o;continue}if(Array.isArray(i)){const o=[];for(const s of i){if(!s||typeof s!="object"){const d=String(s||"").trim();d&&o.push({type:"text",text:d});continue}const c=s.image_url,l=(typeof c=="object"&&c?c.url:"")||(typeof c=="string"?c:"");if(s.type==="image_url"||l){const d=String(l).match(/^data:([^;]+);base64,([\s\S]+)$/i);d&&o.push({type:"image",source:{type:"base64",media_type:d[1]||"image/png",data:d[2].replace(/\s+/g,"")}});continue}const f=String(s.text||"").trim();f&&o.push({type:"text",text:f})}n.push({role:a==="assistant"?"assistant":"user",content:o.length?o:[{type:"text",text:""}]});continue}n.push({role:a==="assistant"?"assistant":"user",content:String(i??"")})}return{system:t,messages:n}}function $m(e){const t=e?.choices||[];if(!t.length)throw new Error("LLM returned no choices.");let n=(t[0].message||{}).content;return Array.isArray(n)&&(n=n.map(Cr).join("")),u(n)}function Tm(e){const t=e?.content,n=(Array.isArray(t)?t:[]).map(Cr).join(""),r=u(n||e?.completion||"");if(!r)throw new Error("Anthropic 응답이 비어 있습니다.");return r}async function Er(e){if(!Gn(e))return"";const t=e.getReader(),n=typeof TextDecoder<"u"?new TextDecoder:null;let r="",a="";for(;;){const{done:i,value:o}=await t.read();if(i)break;if(typeof o=="string")r=o,a+=o;else if(o instanceof Uint8Array)a+=n?n.decode(o,{stream:!0}):"";else if(o&&typeof o=="object"){const s=o,c=s[0];typeof c=="string"?r=c:typeof s.content=="string"?r=s.content:typeof s.text=="string"&&(r=s.text)}}return n&&(a+=n.decode()),r||a}async function jm(e){if(typeof e=="string")return e;if(Gn(e))return Er(e);if(e==null)return"";if(typeof e=="number"||typeof e=="boolean")return String(e);if(typeof e=="object"){const t=e,n=u(t.type,40).toLowerCase();if(n==="fail"||n==="error"){const a=u(t.result||t.message||t.error||"Risu LLM 실패",800);throw new Error(`Risu LLM 실패: ${a}`)}if(n==="streaming"||n==="stream"){const a=await Er(t.result??t.data??t.stream);if(a.trim())return a}if(n==="success"||n==="ok"){const a=t.result??t.data??t.content;if(typeof a=="string")return a;if(Gn(a))return Er(a)}const r=[t.choices?.[0]?.message?.content,t.choices?.[0]?.text,t.choices?.[0]?.delta?.content,t.message?.content,t.content,t.text,t.response,n?null:t.result,t.output];for(const a of r){if(typeof a=="string"&&a.trim())return a;if(Array.isArray(a)){const i=a.map(Cr).join("");if(i.trim())return i}if(Gn(a)){const i=await Er(a);if(i.trim())return i}}try{return JSON.stringify(e)}catch{return String(e)}}return String(e||"")}var Gn,Cr,Za=T((()=>{D(),Nr(),Gn=e=>!!e&&typeof e.getReader=="function",Cr=e=>typeof e=="object"?e?.text||"":String(e||"")}));async function Om(){try{const e=await Ae(Gr,Ni);if(e==null||e==="")return he(et);const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return he(et);const n=$a(t),r=tt(et,n);return JSON.stringify(t)!==JSON.stringify(n)&&await Ic(r),r}catch(e){console.warn("[Inlay Nexus] settings load failed",e?.message||e)}return he(et)}async function Ic(e){if(await Me(Gr,he(e)),await Ae("inx_native_settings")==null)throw new Error("설정 저장 실패: IndexedDB(getLocalPluginStorage)에 기록되지 않았습니다.")}var Ec=T((()=>{ee(),vt(),Ht(),_r()}));async function Pm(){const e=await z("meta","prompt:__pack__"),t=!e||e.text!=="2026-08-06-inline-line",n=Date.now()/1e3;for(const r of dn)await z("meta",`prompt:${r}`)&&!(t&&Mi.includes(r))||await F("meta",{key:`prompt:${r}`,text:In(r),updated_at:n});await F("meta",{key:"prompt:__pack__",text:Ai,updated_at:n})}async function se(e){const t=await z("meta",`prompt:${e}`);return t?.text!=null?t.text:In(e)}async function Cc(e,t){const n=Date.now()/1e3;return await F("meta",{key:`prompt:${e}`,text:t,updated_at:n}),{ok:!0,key:e,updated_at:n}}async function $r(){const e=await we("meta"),t=new Map(e.filter(r=>r.key?.startsWith("prompt:")&&!r.key.startsWith("prompt:__")).map(r=>[r.key.slice(7),{key:r.key.slice(7),text:r.text||"",updated_at:r.updated_at||0}])),n=[];for(const r of dn){const a=t.get(r);a?n.push(a):n.push({key:r,text:In(r),updated_at:0}),t.delete(r)}for(const r of t.values())n.push(r);return n}async function Lm(){const e=await $r(),t={};for(const n of e)t[n.key]=n.text;return{version:qe,prompts:t}}async function Bm(e){const t=Dm(e);let n=0;const r=Date.now()/1e3;for(const a of dn)Object.prototype.hasOwnProperty.call(t,a)&&(await F("meta",{key:`prompt:${a}`,text:String(t[a]??""),updated_at:r}),n+=1);return{ok:!0,updated:n,prompts:await $r()}}async function Rm(e){const t=e?.keep_author_note!==!1,n=Date.now()/1e3;let r=0;for(const a of dn)t&&a==="author_note"||(await F("meta",{key:`prompt:${a}`,text:In(a),updated_at:n}),r+=1);return{ok:!0,updated:r,keep_author_note:t,prompts:await $r()}}function Dm(e){let t=e;if(typeof e=="string"){const i=e.trim();if(!i)return{};t=JSON.parse(i)}if(!t||typeof t!="object"||Array.isArray(t))return{};const n=t,r={},a=n.prompts;if(a&&typeof a=="object"&&!Array.isArray(a)){for(const[i,o]of Object.entries(a))typeof i=="string"&&(r[i]=String(o??""));return r}if(Array.isArray(a)){for(const i of a){if(!i||typeof i!="object")continue;const o=i,s=String(o.key||"");s&&(r[s]=String(o.text??""))}return r}if(typeof n.key=="string"&&"text"in n)return r[n.key]=String(n.text??""),r;for(const[i,o]of Object.entries(n))i==="version"||i==="ok"||typeof o=="string"&&(r[i]=o);return r}async function Je(){const e=he(C());await To.run(()=>Ic(e))}function Fm(){return nd(C())}async function zm(e){const t=rd(String(e??"").slice(0,2000001)),n=he(C());await F("meta",{key:"settings_backup",value:n,updated_at:Date.now()/1e3});const r=tt(et,t);return r.llm={...r.llm,api_key:n.llm?.api_key||""},r.nai={...r.nai,api_key:n.nai?.api_key||""},r.auth_token=n.auth_token||"",cr(r),await Je(),{ok:!0,settings:Tr()}}async function Um(){const e=he(C());await F("meta",{key:"settings_backup",value:e,updated_at:Date.now()/1e3});const t=he(et);t.llm={...t.llm,api_key:e.llm?.api_key||""},t.nai={...t.nai,api_key:e.nai?.api_key||""},t.auth_token=e.auth_token||"";const n=e.card;return t.card={...t.card,presets:Array.isArray(n.presets)?he(n.presets):t.card.presets||[],active_preset_id:String(n.active_preset_id||t.card.active_preset_id||""),custom_pos:String(n.custom_pos??t.card.custom_pos??""),custom_neg:String(n.custom_neg??t.card.custom_neg??"")},cr(t),await Je(),{ok:!0,settings:Tr()}}function Jm(){const e=C(),t=e.nai,n=e.llm;let r=0,a=0,i=0,o=0;try{r=jn("cards"),a=jn("images"),i=tf();const s=new Set;for(const c of nf()){const l=u(c.character_id||"",200)||"unknown",f=u(c.chat_id||"",200)||"unknown";s.add(`${l}|${f}`)}o=s.size}catch{}return{ok:!0,version:qe,pid:0,source_file:"native",nai_configured:zn(t)==="comfy"?Pa(t):!!u(t.api_key),image_backend:zn(t),llm_configured:Nc(n),port:0,image_mode:"data-url",storage:"indexeddb",storage_api:"getLocalPluginStorage",storage_scope:"device-local",cards:r,images:a,folders:o,png_bytes:i,last_stage:kn(),focus_stage:gt(),last_error:ar(),debug_events:Ri()}}function Tr(){const e=he(C());e.nai?.api_key?(e.nai.api_key="",e.nai.api_key_configured=!0):e.nai={...e.nai,api_key_configured:!1},e.llm?.api_key?(e.llm.api_key="",e.llm.api_key_configured=!0):e.llm={...e.llm,api_key_configured:!1},e.llm?.service_account_json?(e.llm.service_account_json="",e.llm.service_account_configured=!0):e.llm={...e.llm,service_account_configured:!1};const t=e.nai;t.backend=zn(t),t.image_backend=t.backend,t.comfy_configured=Pa(t);const n=Co(),r=$o(),a=!Qa.includes(u(t.image_reference));t.image_reference_configured=!!(a&&n),t.image_reference||(t.image_reference=t.image_reference_configured?"file":"none"),t.image_reference_configured&&n&&(t.reference_preview_url=n);const i=!Qa.includes(u(t.vibe_transfer));if(t.vibe_transfer_configured=!!(i&&r),t.vibe_transfer||(t.vibe_transfer=t.vibe_transfer_configured?"file":"none"),t.vibe_transfer_configured&&r&&(t.vibe_preview_url=r),Array.isArray(e.card?.presets))for(const c of e.card.presets){if(!c||typeof c!="object")continue;const l=c,f=u(l.id,120),d=f?na(f):"";d?(l.vibe_configured=!0,l.vibe_preview_url=d):(delete l.vibe_configured,delete l.vibe_preview_url),delete l.vibe_transfer}e.card.character_max=rt(e.card),e.database_path="indexeddb:getLocalPluginStorage",e.images_dir="indexeddb:inx_nximg_*",e.prompts_dir="embedded";const o=e.curation&&typeof e.curation=="object"?e.curation:{},s=o.embedding&&typeof o.embedding=="object"?{...o.embedding}:{};return s.api_key?(s.api_key="",s.api_key_configured=!0):s.api_key_configured=!1,o.embedding=s,e.curation=o,e.storage={...e.storage,backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",image_mode:"data-url"},e}async function Hm(e){const t=e&&typeof e=="object"?e:{},n=C(),r={...t.nai||{}},a={...t.llm||{}},i={...t.card||{}};if("api_key"in r){const o=r.api_key;delete r.api_key,delete r.api_key_configured,u(o)&&(n.nai.api_key=o),(r.clearApiKey||t.clear_nai_key)&&(n.nai.api_key=""),delete r.clearApiKey}if("api_key"in a){const o=a.api_key;delete a.api_key,delete a.api_key_configured,u(o)&&(n.llm.api_key=o),(a.clearApiKey||t.clear_llm_key)&&(n.llm.api_key=""),delete a.clearApiKey}if("service_account_json"in a){const o=a.service_account_json;delete a.service_account_json,delete a.service_account_configured,u(o)&&(n.llm.service_account_json=o),(a.clearServiceAccount||t.clear_llm_service_account)&&(n.llm.service_account_json=""),delete a.clearServiceAccount}if(Object.keys(i).length){const o=tt(n.card,i);Array.isArray(i.presets)&&(o.presets=i.presets),"active_preset_id"in i&&(o.active_preset_id=i.active_preset_id),"custom_pos"in i&&(o.custom_pos=i.custom_pos),"custom_neg"in i&&(o.custom_neg=i.custom_neg),n.card=o,n.card.character_max=rt(n.card)}if(Object.keys(r).length&&(n.nai=tt(n.nai,r)),Object.keys(a).length&&(n.llm=tt(n.llm,a)),t.curation&&typeof t.curation=="object"){const{updateCurationSettings:o}=await Promise.resolve().then(()=>(Vn(),Vm));await o(t.curation)}for(const o of["bind_host","port","auth_token"])o in t&&(n[o]=t[o]);return await Je(),{ok:!0,settings:Tr()}}var Qa,ut=T((()=>{Ht(),Fn(),ee(),q(),vt(),D(),at(),Za(),Ec(),Te(),_e(),Qa=["","none","off","false","0"]}));function $c(e){const t=typeof e=="string"?e:JSON.stringify(e);return ei(Ut(new TextEncoder().encode(t)))}function Km(e){const t=ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):Z(e);return ei(Ut(t))}async function Gm(e){let t;try{t=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("Vertex Service Account JSON 파싱 실패")}if(!t?.client_email||!t?.private_key)throw new Error("Service Account JSON에 client_email/private_key가 필요합니다.");if(!globalThis.crypto?.subtle)throw new Error("이 환경에서는 Vertex Service Account(JWT) 서명을 지원하지 않습니다. API key 칸에 OAuth access token을 넣거나 Google AI Studio를 쓰세요.");const n=Math.floor(Date.now()/1e3),r=`${$c({alg:"RS256",typ:"JWT"})}.${$c({iss:t.client_email,scope:"https://www.googleapis.com/auth/cloud-platform",aud:"https://oauth2.googleapis.com/token",iat:n,exp:n+3600})}`,a=String(t.private_key).replace(/\\n/g,`
`).replace(/-----BEGIN [^-]+-----/,"").replace(/-----END [^-]+-----/,"").replace(/\s+/g,""),i=Uint8Array.from(atob(a),f=>f.charCodeAt(0)),o=await crypto.subtle.importKey("pkcs8",i,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),s=`${r}.${Km(await crypto.subtle.sign("RSASSA-PKCS1-v1_5",o,new TextEncoder().encode(r)))}`,c=await Le("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`grant_type=${encodeURIComponent("urn:ietf:params:oauth:grant-type:jwt-bearer")}&assertion=${encodeURIComponent(s)}`});let l={};try{l=await c.json()}catch{l={}}if(!l?.access_token)throw new Error(`Vertex 토큰 발급 실패: ${JSON.stringify(l).slice(0,240)}`);return{accessToken:String(l.access_token),projectId:u(t.project_id||"")}}var ei,Wm=T((()=>{Q(),D(),Ct(),ei=e=>e.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}));async function on(e,t){const n=Ir(e.source);if(n==="main"||n==="aux")return qm(e,t,n);const r=Pt(e.provider),a=u(e.model),i=u(e.vertex_region)||"us-central1";let o=u(e.api_key),s="";if(r==="vertex"&&u(e.service_account_json)){const m=await Gm(e.service_account_json);o=m.accessToken,s=m.projectId}if(!a||!o)throw w("llm.config",{message:"missing model/api_key",provider:r},"error"),new Error(r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM이 설정되지 않았습니다. 모델 설정에서 Provider·Model·API key를 넣으세요. (NovelAI 키와 별개)");const c=Sc(u(e.endpoint),r,{region:i,projectId:s});if(r==="vertex"&&!/\/chat\/completions$/i.test(c))throw new Error("Vertex AI: project_id가 있는 Service Account JSON이 필요합니다. (OpenAI-compatible endpoint 구성용)");const l=Number(e.timeout_seconds??180)*1e3,f=typeof AbortController<"u"?new AbortController:null,d=setTimeout(()=>{w("llm.abort",{message:`timeout ${l}ms`,model:a,provider:r},"warn"),f?.abort?.()},l),p=ue("llm.call");w("llm.call.start",{message:a,msgs:t?.length||0,timeout_ms:l,source:n,provider:r,reasoning:u(e.reasoning_effort)||"default"});try{let m;if(r==="anthropic_compatible"){const y=Cm(t),v={model:a,max_tokens:Number(e.max_tokens??8e3),temperature:Math.min(1,Number(e.temperature??.4)),messages:y.messages};y.system&&(v.system=y.system),m=await Le(c,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":o,"anthropic-version":u(e.anthropic_version)||"2023-06-01"},body:JSON.stringify(v),signal:f?.signal})}else{const y=Ac({model:a,messages:t,temperature:Number(e.temperature??.4),max_tokens:Number(e.max_tokens??8e3)},e.reasoning_effort),v={"Content-Type":"application/json",Authorization:`Bearer ${o}`};r==="openrouter"&&(v["HTTP-Referer"]="https://risuai.xyz",v["X-Title"]="Inlay Nexus"),m=await Le(c,{method:"POST",headers:v,body:JSON.stringify(y),signal:f?.signal})}const g=Number(m?.status||0);let h;try{h=await m.json()}catch{h={}}if(g>=400)throw p.fail(new Error(`HTTP ${g}`),{status:g,body:JSON.stringify(h).slice(0,200),provider:r}),new Error(`LLM HTTP ${g}: ${JSON.stringify(h).slice(0,500)}`);const _=r==="anthropic_compatible"?Tm(h):$m(h);return p.end({message:a,status:g,bytes:_.length,provider:r}),_}catch(m){throw p.fail(m,{model:a,provider:r}),m}finally{clearTimeout(d)}}async function qm(e,t,n,r=""){const a=Ye();if(!a||typeof a.runLLMModel!="function")throw new Error("RisuAI runLLMModel API를 사용할 수 없습니다. Risu를 최신으로 업데이트하세요.");const i=n==="main"?"model":"otherAx",o=Math.max(5e3,Number(e.timeout_seconds??180)*1e3),s=u(r)||"",c=ue("llm.call");w("llm.call.start",{message:`risu:${i}`,msgs:t?.length||0,timeout_ms:o,source:n,static_model:s});let l;const f=new Promise((d,p)=>{l=setTimeout(()=>p(new Error(`Risu LLM timeout ${o}ms (${i})`)),o)});try{const d=await Promise.race([a.runLLMModel({mode:i,...s?{staticModel:s}:{},allowPlugins:!0,messages:t}),f]),p=u(await jm(d));if(!p)throw new Error(`Risu LLM(${i}) 응답이 비어 있습니다.`);return c.end({message:`risu:${i}`,bytes:p.length}),p}catch(d){throw c.fail(d,{mode:i}),d}finally{l!==void 0&&clearTimeout(l)}}var ti=T((()=>{q(),pt(),D(),Ct(),Wm(),Nr(),Za()})),Vm=fn({catalogSha:()=>Hn,curationStatus:()=>qn,curationTaggerSystemMessage:()=>Rc,embedCurationCatalog:()=>Pc,getCurationMode:()=>jr,getCurationStrictIds:()=>Or,getEmbedProgress:()=>Tc,getEmbeddingSettingsFromConfig:()=>Wn,loadCurationCatalog:()=>ft,refineShotsWithCuration:()=>Dc,resetCurationCatalog:()=>Oc,saveCurationCatalog:()=>jc,snapShotsSceneTags:()=>Uc,testCurationEmbedding:()=>Lc,updateCurationSettings:()=>Jc});function Tc(){return{...sn}}function jr(){const e=C(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=Na(t.mode);if(n!=="off")return n;const r=e.card;return r?.composition_curation===!0||r?.composition_curation==="true"||r?.composition_curation===1?"two_stage":"off"}function Or(){const e=C(),t=e.curation&&typeof e.curation=="object"?e.curation:{};return Ia(t.strict_ids)}function Wn(){const e=C(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=t.embedding&&typeof t.embedding=="object"?t.embedding:{},r=Ne(n.provider);return{provider:r,model:u(n.model,200)||Kn(r),endpoint:u(n.endpoint,500)||Ar(r),api_key:u(n.api_key,4e3)}}async function ft(){const e=await Ae(tr);if(e==null||e==="")return Ja();try{const t=typeof e=="string"?JSON.parse(e):e;return za(t)}catch(t){return w("curation.catalog.load",{message:String(t?.message||t)},"warn"),Ja()}}async function jc(e){const t=za(e);await Me(tr,t);const n=await ni();return n&&(n.catalog_sha,t.sha),{ok:!0,status:await qn()}}async function Oc(){const e=Ja();return await Me(tr,e),await fe(nr),{ok:!0,status:await qn()}}async function ni(){const e=await Ae(nr);if(e==null||e==="")return null;try{const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return null;const n=t;return Array.isArray(n.items)?n:null}catch{return null}}async function qn(){const e=await ft(),t=await ni(),n=Hd(e);let r="missing";if(t?.items?.length){r=t.catalog_sha===e.sha?"ready":"stale";const a=Wn(),i=u(a.model);i&&t.model&&t.model!==i&&(r="stale")}return{mode:jr(),catalog_name:e.name,catalog_sha:e.sha||Hn(e),option_count:n,group_count:e.groups.length,has_presets:Un(e),embed_status:r,embed_count:t?.items?.length||0,embed_model:t?.model||"",embed_updated_at:t?.updated_at||0,large_warning:n>Hc,embed_progress:Tc()}}async function Pc(e){const t=await ft(),n=Bd(t),r=Wn();if(!n.length)throw new Error("임베딩할 카탈로그 항목이 없습니다.");if(Ne(r.provider)!=="ollama"&&Ne(r.provider)!=="lmstudio"&&!u(r.api_key))throw new Error("임베딩 API key가 없습니다. 큐레이팅 탭에서 키를 저장하세요.");const a=(c,l,f)=>{sn={running:c<l,done:c,total:l,message:f},e?.(c,l,f)},i=Ne(r.provider)==="ollama"?1:16,o=[];let s=r.model;a(0,n.length,"임베딩 시작…");try{for(let l=0;l<n.length;l+=i){const f=n.slice(l,l+i);a(l,n.length,`임베딩 중… ${l}/${n.length}`);const{vectors:d,model:p}=await Va(r,f.map(m=>m.text));s=p||s;for(let m=0;m<f.length;m++){const g=f[m],h=d[m];if(!h?.length)throw new Error(`임베딩 실패: ${g.key}`);o.push({key:g.key,groupId:g.groupId,optionId:g.optionId,tags:g.tags,slot:g.slot,vector:h})}}a(n.length,n.length,"저장 중…");const c={catalog_sha:t.sha||Hn(t),model:s,provider:String(r.provider),updated_at:Date.now()/1e3,items:o};return await Me(nr,c),a(n.length,n.length,"완료"),sn={running:!1,done:n.length,total:n.length,message:"완료"},{ok:!0,status:await qn()}}catch(c){throw sn={running:!1,done:sn.done,total:n.length,message:`실패: ${c?.message||c}`},c}}async function Lc(){const e=Wn();return Sm(e)}function Bc(e){return!!(e.base||e.char||e.primary||e.secondary||e.female||e.male)}async function Rc(){const e=jr();if(e==="off")return null;if(e==="embed_snap")return u(await se("curation_embed_hint"),4e3)||Fd();const t=await ft(),n=Or();return Un(t)?om(t,n):Rd(t,n)}async function Dc(e,t){if(!e.length)return;const n=u(t?.chatContext,1e5),r=await ft();if(Un(r)){for(const a of e)Wd(a);if(e.some(a=>!!Wa(r,{preset_path:a.preset_path,composition_id:a.composition_id,composition_variant:a.composition_variant}))){await Xm(r,e,n);return}w("curation.preset_refine",{message:"no composition_id on shots → falling back to group refine"},"warn")}await Ym(r,e,n)}function Fc(e,t,n){const r=[{role:"system",content:e}];return t&&r.push({role:"user",content:t}),r.push({role:"user",content:JSON.stringify(n)}),r}async function Ym(e,t,n){const r=Or(),a=g=>{const h=g.curation_groups;return Array.isArray(h)?h.map(_=>u(_,160)).filter(Boolean):u(h,400).split(/[,|]/).map(_=>_.trim()).filter(Boolean)},i=t.map(a),o=[...new Set(i.flat())];if(!o.length){w("curation.group_refine",{message:"no curation_groups on shots — skip"},"warn");return}const s=Dd(e,o,{strictIds:r}),c=`${u(await se("curation_refine"),6e3)||s}

${s}`,l=qs(t,n),f={shots:t.map((g,h)=>({shot_index:h,y_percent:g.y_percent??g.anchor_percent??null,...l[h],curation_groups:i[h],camera:g.camera||"",situation:g.situation||g.scene||"",place:g.place||"",action:g.action||"",natural:g.natural||"",character_count:Array.isArray(g.characters)?g.characters.length:0,cast:uc(g)}))},d=await on(C().llm,Fc(c,n,f)),p=Zr(d);if(!p||typeof p!="object")return;zc(t,p,(g,h)=>{if(!h||typeof h!="object")return;const _=h.curation_option_ids??h.option_ids,y=lc(e,_);Bc(y)?(Ha(g,y,{place:h.place!=null?h.place:g.place,situation:""}),g.curation_option_ids=_):(h.place!=null&&(g.place=u(h.place,400)),r||(h.camera!=null&&(g.camera=u(h.camera,600)),h.situation!=null&&(g.situation=u(h.situation,600)),h.action!=null&&(g.action=u(h.action,600)))),r&&Array.isArray(h.characters)&&dc(g,fc(h.characters),e)})}async function Xm(e,t,n){const r=Or(),a=t.map(d=>Wa(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant}));if(!a.some(Boolean))return;const i=cm(e,a.filter(Boolean),{strictIds:r}),o=qs(t,n),s={shots:t.map((d,p)=>({shot_index:p,y_percent:d.y_percent??d.anchor_percent??null,...o[p],composition_id:d.composition_id||"",composition_variant:d.composition_variant||"",place:d.place||"",natural:d.natural||"",character_count:Array.isArray(d.characters)?d.characters.length:0,cast:uc(d)}))};let c=null;try{const d=await on(C().llm,Fc(i,n,s));c=Zr(d)}catch(d){w("curation.preset_refine",{message:String(d?.message||d)},"warn")}const l=new Map,f=(d,p,m)=>{const g=p&&typeof p=="object"?p.curation_option_ids??p.option_ids:d.curation_option_ids,h=g!=null?tc(e,g):[];for(const x of em(e,a[m])){const N=[...x.include_options||[],...x.action?.include_options||[]];N.length&&l.set(x.ref,{ids:N,binding:x})}const _=[...l.values()].flatMap(x=>x.ids),y=[...l.values()].map(x=>x.binding),v=am(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant,curation_option_ids:h},{optionIds:_,bindings:y});if(v&&Bc(v)&&(Ha(d,v,{place:p&&p.place!=null?p.place:d.place,situation:""}),g!=null&&(d.curation_option_ids=h),e.fixed_positive&&(d.curation_fixed_positive=e.fixed_positive)),r){const x=p&&typeof p=="object"?p.characters:void 0;Array.isArray(x)&&dc(d,fc(x),e)}};if(c&&typeof c=="object"){zc(t,c,f);return}t.forEach((d,p)=>f(d,null,p))}function zc(e,t,n){const r=Array.isArray(t.shots)?t.shots:Array.isArray(t)?t:null;if(r){for(let a=0;a<e.length;a++){const i=r.find(o=>o&&typeof o=="object"&&Number(o.shot_index)===a);n(e[a],i||r[a],a)}return}e.length===1&&n(e[0],t,0)}async function Uc(e){if(!e.length)return{ok:!0,snapped:0};const t=await ft(),n=await ni(),r=t.sha||Hn(t);if(!n?.items?.length)return{ok:!1,reason:"임베딩 없음 → 큐레이션 없이 생성"};if(n.catalog_sha!==r)return{ok:!1,reason:"임베딩 stale → 큐레이션 없이 생성"};const a=e.map(o=>{const s=I(u(o.camera,600),u(o.situation||o.scene,600),u(o.place,400),u(o.action,600));return pm(s)}),i=a.flat();if(!i.length)return{ok:!0,snapped:0};try{const o=Wn(),{vectors:s}=await Va(o,i);let c=0,l=0;for(let f=0;f<e.length;f++){const d=a[f],p=s.slice(c,c+d.length);if(c+=d.length,!d.length)continue;const{baseTags:m,charTags:g,primaryTags:h,secondaryTags:_,femaleTags:y,maleTags:v,snapped:x}=mm(d,p,n.items);l+=x,Ha(e[f],{base:I(...m),char:I(...g),primary:I(...h),secondary:I(..._),female:I(...y),male:I(...v)},{place:"",situation:""})}return{ok:!0,snapped:l}}catch(o){const s=`임베딩 API 실패 → 큐레이션 없이 생성 (${o?.message||o})`;return w("curation.snap",{message:s},"warn"),{ok:!1,reason:s}}}async function Jc(e){const t=C(),n=t.curation&&typeof t.curation=="object"?{...t.curation}:{},r={...n,...e};if(e.mode!=null&&(r.mode=Na(e.mode)),e.strict_ids!=null&&(r.strict_ids=Ia(e.strict_ids)),e.embedding&&typeof e.embedding=="object"){const a=n.embedding&&typeof n.embedding=="object"?{...n.embedding}:{},i=e.embedding,o={...a,...i};if("api_key"in i){const s=i.api_key;delete o.api_key,delete o.api_key_configured,u(s)&&(o.api_key=s),(i.clearApiKey||e.clear_embedding_key)&&(o.api_key=""),delete o.clearApiKey}o.provider!=null&&(o.provider=Ne(o.provider)),r.embedding=o}return t.curation=r,e.mode!=null&&t.card&&typeof t.card=="object"&&(t.card.composition_curation=!1),cr(t),await Je(),{ok:!0}}var Hc,sn,Vn=T((()=>{Id(),Ga(),lm(),Fn(),hm(),ee(),q(),D(),wc(),vt(),_r(),_e(),ut(),ti(),Hc=400,sn={running:!1,done:0,total:0,message:""}}));Vn(),ee(),q(),_t(),Q(),Ct();async function Pr(e,t,n,r=1,a=3){const i=ze(n),o=Math.max(0,Math.min(1,Number(r)||1)),s={image:await Ze(t),information_extracted:o,model:i};let c="";for(let l=1;l<=a;l++)try{w("nai.encode_vibe.start",{message:i,ie:o,attempt:l,focus:!0});const f=await Le($i,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(s)}),d=Number(f?.status||0);if([502,503,504,520].includes(d)){c=`HTTP ${d}`,await Xe(2*l*1e3);continue}if(d<200||d>=300){let g="";try{g=typeof f?.text=="function"?await f.text():""}catch{}if(c=`HTTP ${d}: ${String(g).slice(0,200)}`,l<a){await Xe(1e3);continue}break}const p=await nn(f,{timeoutMs:6e4}),m=await Ze(p);return w("nai.encode_vibe.done",{message:i,bytes:p?.byteLength||0,focus:!0}),m}catch(f){if(c=String(f?.message||f),l<a){await Xe(1e3);continue}}throw new Error(`encode-vibe 실패 (${a}회): ${c}`)}ee(),D(),Te(),_e(),ut();var ri=12582912,He=32;async function Zm(){const e=await z("meta","reference_image");return!!(e?.png&&e.png.byteLength>He)}async function Kc(){return(await z("meta","reference_image"))?.png||null}async function Qm(e){if(!e||e.byteLength<He)throw new Error("참조 이미지가 비어 있습니다");if(e.byteLength>ri)throw new Error("참조 이미지가 너무 큽니다 (최대 12MB)");return await F("meta",{key:"reference_image",png:e}),ea(Et(e)),C().nai.image_reference="file",await Je(),{ok:!0,image_reference:"file",configured:!0,bytes:e.byteLength,preview_url:"/v1/nai/reference.png"}}async function Gc(){return await At("meta","reference_image"),ea(""),C().nai.image_reference="none",await Je(),{ok:!0,image_reference:"none",configured:!1}}async function ep(){const e=await z("meta","vibe_transfer");return!!(e?.encoded&&e?.png&&e.png.byteLength>He)}async function tp(){return await z("meta","vibe_transfer")||null}async function np(){return(await z("meta","vibe_transfer"))?.png||null}function Lr(e){let t=Number(e??1);return Number.isNaN(t)&&(t=1),Math.max(0,Math.min(1,t))}async function rp(e,t={}){if(!e||e.byteLength<He)throw new Error("Vibe 이미지가 비어 있습니다");if(e.byteLength>ri)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const n=C(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const a=Ue(t.model||n.nai.model||"nai-diffusion-4-5-full"),i=Lr(t.information_extracted??n.nai.vibe_transfer_information_extracted),o=await Pr(r,e,a,i);return await F("meta",{key:"vibe_transfer",png:e,encoded:o,model:ze(a),information_extracted:i}),ta(Et(e)),n.nai.vibe_transfer="file",t.strength!=null&&!Number.isNaN(Number(t.strength))&&(n.nai.vibe_transfer_strength=Math.max(0,Math.min(1,Number(t.strength)))),n.nai.vibe_transfer_information_extracted=i,await Je(),{ok:!0,vibe_transfer:"file",configured:!0,bytes:e.byteLength,encoded_bytes:o.length,model:ze(a),information_extracted:i,preview_url:"/v1/nai/vibe.png"}}async function Wc(){return await At("meta","vibe_transfer"),ta(""),C().nai.vibe_transfer="none",await Je(),{ok:!0,vibe_transfer:"none",configured:!1}}async function ap(){const e=await tp();if(!e?.png||e.png.byteLength<He)return null;const t=C(),n=u(t.nai.api_key);if(!n)throw new Error("NAI api_key가 설정되지 않았습니다.");const r=ze(Ue(t.nai.model||"nai-diffusion-4-5-full")),a=Lr(t.nai.vibe_transfer_information_extracted);if(!(!u(e.encoded)||u(e.model)!==r||Math.abs(Number(e.information_extracted??1)-a)>.001))return e;const i=await Pr(n,e.png,r,a),o={...e,key:"vibe_transfer",encoded:i,model:r,information_extracted:a};return await F("meta",o),o}async function qc(e){const t=u(e,120);return t&&await z("meta",Dt(t))||null}async function ip(e,t,n={}){const r=u(e,120);if(!r)throw new Error("preset_id required");if(!t||t.byteLength<He)throw new Error("Vibe 이미지가 비어 있습니다");if(t.byteLength>ri)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const a=C(),i=u(a.nai.api_key);if(!i)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const o=Ue(n.model||a.nai.model||"nai-diffusion-4-5-full"),s=Lr(n.information_extracted??a.nai.vibe_transfer_information_extracted),c=await Pr(i,t,o,s),l=Dt(r);await F("meta",{key:l,png:t,encoded:c,model:ze(o),information_extracted:s});const f=Et(t);return lr(r,f),{ok:!0,preset_id:r,vibe_transfer:"file",configured:!0,bytes:t.byteLength,encoded_bytes:c.length,model:ze(o),information_extracted:s,preview_url:f}}async function Vc(e){const t=u(e,120);if(!t)throw new Error("preset_id required");return await At("meta",Dt(t)),lr(t,""),{ok:!0,preset_id:t,vibe_transfer:"none",configured:!1}}async function op(e,t){const n=await qc(e);if(!n?.png||n.png.byteLength<He)return!1;const r=u(t,120);if(!r)return!1;await F("meta",{key:Dt(r),png:n.png,encoded:n.encoded||"",model:n.model||"",information_extracted:n.information_extracted??1});const a=na(e)||(n.png?Et(n.png):"");return a&&lr(r,a),!0}async function sp(e){const t=await qc(e);if(!t?.png||t.png.byteLength<He)return null;const n=C(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=ze(Ue(n.nai.model||"nai-diffusion-4-5-full")),i=Lr(n.nai.vibe_transfer_information_extracted);if(!(!u(t.encoded)||u(t.model)!==a||Math.abs(Number(t.information_extracted??1)-i)>.001))return t;const o=await Pr(r,t.png,a,i),s=Dt(u(e,120)),c={...t,key:s,encoded:o,model:a,information_extracted:i};return await F("meta",c),c}async function cp(){for(const e of await we("meta")){const t=String(e?.key||"");if(!Ft(t))continue;const n=e.png;!n||n.byteLength<He||lr(yn(t),Et(n))}}Ht(),Fn(),ee(),q(),D(),Wt(),at(),Ba(),Te(),_e(),ut();function Yc(e,t){const n=Number(e);return Math.max(1,Math.min(5e3,Number.isFinite(n)&&n>0?Math.round(n):t))}async function Br(e){const{shot:t,roster:n}=e,r=C().card,a=C().nai,i=rt(r),o=ua(t.characters||[],n,i).slice(0,i),s=Math.max(1,o.length),c=zo(r.person_tag_mode,r.auto_person_tags),l=Lu(Bu(o,n,c),r.person_tag_weight),[f,d]=Ql(await se("preset_1")),p=Array.isArray(r.presets)?r.presets:[],m=u(r.active_preset_id,120);let g=null;p.length&&(m&&(g=p.find(W=>typeof W=="object"&&u(W.id,120)===m)||null),!g&&typeof p[0]=="object"&&(g=p[0]));let h,_;g?(h=u(g.positive||g.pos||""),_=u(g.negative||g.neg||"")):(h=I(u(r.custom_pos),f),_=I(u(r.custom_neg),d));let y=t.situation||t.scene;const v=u(e.lockedSetup||"");let x;v?x=v:(x=I(t.camera,y,t.place,t.action),r.mode==="asset"&&(x=I(x,"white background","simple background","cowboy shot","looking at viewer","portrait")));const N=Ea(r.natural_base),O=N==="supplement"?600:N==="detailed"?480:400,A=N==="off"?"":u(t.natural||t.natural_base||t.nl||"",O);let $="",B="";if(u(t.composition_id,160)||u(t.curation_fixed_positive,200))try{const W=await ft();$=u(t.curation_fixed_positive,800)||u(W.fixed_positive,800),B=u(W.fixed_negative,800)}catch{$=u(t.curation_fixed_positive,800)}let k=I(h,A,x,$);c!=="off"&&(k=Fo(k),x=Fo(x));let E=l?k?`${l}, ${k}`:l:k;const M=Ue(a.model||"nai-diffusion-4-5-full");a.apply_quality_tags!==!1&&(E+=Nn[M]||"");const R=u(a.uc_preset)||"human_focus",H=I(_,B,(So[M]||{})[R]||""),pe=[],J=[];for(let W=0;W<o.length;W++){const G=o[W],We=u(G.name,200),oe=We?ye(We,n):null,mt=I(Ru(oe,G)),Y=u(G.negative),Be=s===1?.5:Math.round((.1+.8*W/Math.max(1,s-1))*10)/10,re=.5;pe.push({prompt:mt||"girl",uc:Y,center_x:Be,center_y:re}),J.push({name:oe?.name||We,prompt:mt,uc:Y,center_x:Be,center_y:re,raw:G})}return{main:E,neg:H,captions:pe,meta:{setup:x,person:l,characters:J,paragraph:t.paragraph}}}async function Xc(e){const t=C().nai,n=e.captions;if(zn(t)==="comfy"){const[_,y]=await bd(t,e.main,e.neg,n);return{bytes:_,seed:y}}const r=u(t.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=[],i=u(t.image_reference||"none").toLowerCase();if(!["","none","off","false","0"].includes(i)){const _=await Kc();if(_){let y=u(t.image_reference_type||"character&style")||"character&style";["character","style","character&style"].includes(y)||(y="character&style");let v=Number(t.image_reference_strength??.6),x=Number(t.image_reference_fidelity??1);Number.isNaN(v)&&(v=.6),Number.isNaN(x)&&(x=1),a.push({image:_,type:y,strength:Math.max(0,Math.min(1,v)),fidelity:Math.max(0,Math.min(1,x))})}}const o=C().card,s=Array.isArray(o.presets)?o.presets:[],c=u(o.active_preset_id,120);let l=null;s.length&&(c&&(l=s.find(_=>typeof _=="object"&&u(_.id,120)===c)||null),!l&&typeof s[0]=="object"&&(l=s[0]));const f=u(l?.id||c,120),d=ad(t,l),p=[];let m=f?await sp(f):null;if(!m){const _=u(t.vibe_transfer||"none").toLowerCase();["","none","off","false","0"].includes(_)||(m=await ap())}if(m?.encoded){let _=Number(t.vibe_transfer_strength??.6),y=Number(t.vibe_transfer_information_extracted??m.information_extracted??1);Number.isNaN(_)&&(_=.6),Number.isNaN(y)&&(y=1),p.push({encoded:m.encoded,strength:Math.max(0,Math.min(1,_)),information_extracted:Math.max(0,Math.min(1,y))})}const g={prompt:e.main,negative_prompt:e.neg,width:Yc(t.width,832),height:Yc(t.height,1216),seed:Number(t.seed??0)||0,steps:Math.min(Number(t.steps??28)||28,28),cfg_scale:d.cfg_scale,cfg_rescale:d.cfg_rescale,sampler:u(t.sampler)||"k_euler_ancestral",scheduler:u(t.scheduler)||"karras",model:Ue(t.model||"nai-diffusion-4-5-full"),var_plus:!!t.variety_plus,characters:n,character_refs:a,vibes:p};w("nai.generate.dims",{message:`${g.width}x${g.height}`,steps:g.steps,focus:!0}),g.seed||(g.seed=Math.floor(Math.random()*4294967295)||1);const h=u(t.request_url)||"https://image.novelai.net/ai/generate-image";return{bytes:(await Ws(r,g,h,{timeoutMs:9e4})).raw_bytes,seed:g.seed||0}}function lp({imageId:e,sessionId:t,request:n,shotIndex:r,paragraph:a,yPercent:i,line:o=null,contentHash:s=""}){const c=Math.floor(Number(o));return{version:1,image_id:u(e,80),session_id:u(t,200),unified_session_id:u(n.unified_session_id||"",200),character_id:u(n.character_id||"",200),character_name:u(n.character_name||"",200),chat_id:u(n.chat_id||"",200),chat_name:u(n.chat_name||"",200),char_index:P(n.char_index,-1),chat_index:P(n.chat_index,-1),message_index:P(n.message_index,-1),message_role:u(n.message_role||n.role||"",40).toLowerCase(),shot_index:P(r,0),paragraph:P(a,0),y_percent:i,line:Number.isFinite(c)&&c>=1?c:null,content_hash:u(s||n.content_hash||"",128),assistant_preview:u(n.assistant_text||"",Qe)}}async function Lt(e){return rf(e)}async function Zc(e,t){const n=await z("images",e),r=n?{...n}:{id:e},a=t||{};r.location={...a,version:Number(a.version||1),image_id:u(e,80)},await F("images",r)}async function dt(e,t={}){const n=await Lt(e),r=typeof t=="object"&&t?t:{};let a=n.y_percent;a==null&&(a=r.y_percent??r.anchor_percent??r.read_percent);const i=Object.keys(n).length>0,o=Ee(u(e,80));return{character_id:u(n.character_id||r.character_id||"",200),chat_id:u(n.chat_id||r.chat_id||"",200),character_name:u(n.character_name||r.character_name||"",200),chat_name:u(n.chat_name||r.chat_name||"",200),char_index:P(n.char_index??r.char_index,-1),chat_index:P(n.chat_index??r.chat_index,-1),message_index:P("message_index"in n?n.message_index:r.message_index,-1),message_role:u(n.message_role||r.message_role||"",40).toLowerCase(),shot_index:P(n.shot_index,-1),paragraph:P("paragraph"in n?n.paragraph:r.paragraph,0),y_percent:or(a),line:(()=>{const s=Math.floor(Number(n.line??r.line));return Number.isFinite(s)&&s>=1?s:null})(),content_hash:u(n.content_hash||r.content_hash||"",128),assistant_preview:u(n.assistant_preview||r.assistant_preview||"",Qe),unified_session_id:u(n.unified_session_id||r.unified_session_id||"",200),location_file:i?`idb:${o}`:"",storage:"indexeddb",storage_key:o}}function ai(e,t,n=0){const r=typeof e=="object"&&e?{...e}:{},a=t||{};return{...r,character_id:u(a.character_id||r.character_id||"",200),chat_id:u(a.chat_id||r.chat_id||"",200),character_name:u(a.character_name||r.character_name||"",200),chat_name:u(a.chat_name||r.chat_name||"",200),char_index:P(a.char_index??r.char_index,-1),chat_index:P(a.chat_index??r.chat_index,-1),message_index:P(a.message_index??r.message_index,-1),message_role:u(a.message_role||r.message_role||"",40).toLowerCase(),content_hash:u(a.content_hash||r.content_hash||"",128),assistant_preview:u(a.assistant_preview||r.assistant_preview||"",Qe),unified_session_id:u(a.unified_session_id||r.unified_session_id||"",200),y_percent:or(a.y_percent??r.y_percent),line:(()=>{const i=Math.floor(Number(a.line??r.line));return Number.isFinite(i)&&i>=1?i:null})(),storage:"indexeddb",storage_key:Ee(u(a.image_id||"",80)),png_bytes:Number(n)||0}}Q();var up=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t+=1){let n=t;for(let r=0;r<8;r+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e})();function ii(e){return Array.isArray(e)?new Uint8Array(e):Z(e)}function fp(e){const t=ii(e);let n=4294967295;for(let r=0;r<t.length;r+=1)n=up[(n^t[r])&255]^n>>>8;return(n^4294967295)>>>0}function K(e){const t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e>>>0,!0),t}function de(e){const t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function Yn(e){let t=0;for(const n of e)t+=n.length;return Sn(e,t)}function dp(e){return new TextEncoder().encode(String(e??""))}function mp(e=[]){const t=[],n=[];let r=0;for(const o of e){const s=dp(o.name||"file"),c=ii(o.data),l=fp(c),f=Yn([de(67324752),K(20),K(0),K(0),K(0),K(0),de(l),de(c.length),de(c.length),K(s.length),K(0),s,c]),d=Yn([de(33639248),K(20),K(20),K(0),K(0),K(0),K(0),de(l),de(c.length),de(c.length),K(s.length),K(0),K(0),K(0),K(0),de(0),de(r),s]);t.push(f),n.push(d),r+=f.length}const a=Yn(n),i=Yn([de(101010256),K(0),K(0),K(e.length),K(e.length),de(a.length),de(r),K(0)]);return Yn([...t,a,i])}function oi(e,t){return e[t]|e[t+1]<<8}function Qc(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function pp(e){const t=ii(e),n=new Map;let r=0;for(;r+30<=t.length;){const a=Qc(t,r);if(a===33639248||a===101010256)break;if(a!==67324752){r+=1;continue}const i=oi(t,r+8),o=Qc(t,r+18),s=oi(t,r+26),c=oi(t,r+28),l=r+30,f=new TextDecoder().decode(t.subarray(l,l+s)),d=l+s+c,p=d+o;if(p>t.length)break;i===0&&n.set(f.replace(/\\/g,"/"),t.subarray(d,p)),r=p}return n}function gp(e=[],{exportedAt:t=Date.now()}={}){return{format:"inlay-nexus-gallery",version:1,exported_at:t,items:(e||[]).map(n=>({id:String(n.id||""),file:`images/${String(n.id||"unknown")}.png`,location:{character_id:n.character_id||"",chat_id:n.chat_id||"",character_name:n.character_name||"",chat_name:n.chat_name||"",char_index:n.char_index??-1,chat_index:n.chat_index??-1,message_index:n.message_index??-1,content_hash:n.content_hash||"",paragraph:n.paragraph??0,shot_index:n.shot_index??0,y_percent:n.y_percent??null,assistant_preview:n.assistant_preview||"",session_id:n.session_id||""},meta:{main_prompt:n.main_prompt||"",seed:n.seed??null,created_at:n.created_at??null,characters:n.characters||[]}}))}}function hp(e,t=[]){const n=e?.location||{},r=String(n.content_hash||"").trim(),a=t||[];if(r){const l=a.find(f=>String(f.content_hash||"")===r);if(l)return{status:"exact",matchId:String(l.id),content_hash:r}}const i=String(n.character_id||""),o=String(n.chat_id||""),s=Number(n.message_index),c=a.filter(l=>i&&String(l.character_id||"")!==i||o&&String(l.chat_id||"")!==o||Number.isFinite(s)&&s>=0&&Number(l.message_index)!==s?!1:!!(i||o||Number.isFinite(s)&&s>=0)).slice(0,8);return c.length?{status:"candidate",candidates:c.map(l=>({id:l.id,content_hash:l.content_hash,message_index:l.message_index})),location:n}:{status:"orphan",location:n}}function _p(e=[]){return mp(e)}function yp(e){const t=pp(e);let n=null;const r=t.get("manifest.json");if(r)try{n=JSON.parse(new TextDecoder().decode(r))}catch{n=null}const a=new Map;for(const[i,o]of t.entries())i!=="manifest.json"&&/\.(png|webp|jpe?g)$/i.test(i)&&a.set(i.replace(/\\/g,"/"),o);return{manifest:n,images:a,files:t}}ee(),q(),Q(),D(),Te();function Xn(e){try{const t=JSON.parse(e.meta_json||"{}");return t&&typeof t=="object"?t:{}}catch{return{}}}async function el(e,t){return(await ef(e))?.png_bytes||Number(t.png_bytes)||0}async function si(e){const t=(await we("cards")).sort((i,o)=>(o.created_at||0)-(i.created_at||0)).slice(0,Math.max(1,Math.min(2e3,e))),n={},r=[];for(const i of t){const o=Xn(i),s=await dt(i.id,o),c=await Lt(i.id),l=u(s.character_name||c.character_name||o.character_name||"",200),f=u(s.chat_name||c.chat_name||o.chat_name||"",200),d=u(s.character_id||"",200)||"unknown",p=u(s.chat_id||"",200)||"unknown",m=`${d}|${p}`;let g=n[m];g||(g={key:m,character_id:d,chat_id:p,character_name:l||d.slice(0,12)||"Unknown",chat_name:f||`chat ${s.chat_index??"?"}`,char_index:s.char_index??-1,chat_index:s.chat_index??-1,count:0,storage:"indexeddb"},n[m]=g),l&&!g.character_name&&(g.character_name=l),f&&(g.chat_name=f),g.count+=1,r.push({id:i.id,job_id:i.job_id,session_id:i.session_id,folder_key:m,shot_index:s.shot_index>=0?s.shot_index:i.shot_index,paragraph:Object.keys(c).length?s.paragraph:i.paragraph,y_percent:s.y_percent,line:s.line,message_index:s.message_index??-1,message_role:s.message_role||"",content_hash:s.content_hash||"",character_id:d,character_name:g.character_name,chat_id:p,chat_name:g.chat_name,char_index:s.char_index??-1,chat_index:s.chat_index??-1,assistant_preview:u(s.assistant_preview||c.assistant_preview||o.assistant_preview||"",Qe),main_prompt:i.main_prompt,characters:JSON.parse(i.characters_json||"[]"),image_url:je(i.id),seed:i.seed,created_at:i.created_at,storage:"indexeddb",storage_key:s.storage_key||Ee(i.id),location_file:s.location_file||"",png_bytes:await el(i.id,o)})}const a={ok:!0,folders:Object.values(n).sort((i,o)=>`${i.character_name||""}`.localeCompare(`${o.character_name||""}`,void 0,{sensitivity:"base"})||`${i.chat_name||""}`.localeCompare(`${o.chat_name||""}`,void 0,{sensitivity:"base"})),items:r,total:r.length,storage:"indexeddb",storage_api:"getLocalPluginStorage"};return await ot(a,{cachedOnly:!0}),a}async function bp(e=400){return si(e)}async function wp(e,t=40){const n=(await ss(e)).sort((i,o)=>(o.created_at||0)-(i.created_at||0)).slice(0,Number(t)),r=[];for(const i of n){const o=Xn(i),s=await dt(i.id,o),c=await Lt(i.id);r.push({id:i.id,job_id:i.job_id,shot_index:s.shot_index>=0?s.shot_index:i.shot_index,paragraph:Object.keys(c).length?s.paragraph:i.paragraph,y_percent:s.y_percent,line:s.line,message_index:s.message_index??-1,message_role:s.message_role||"",content_hash:s.content_hash||"",character_id:s.character_id||"",chat_id:s.chat_id||"",character_name:s.character_name||"",chat_name:s.chat_name||"",char_index:s.char_index??-1,chat_index:s.chat_index??-1,assistant_preview:s.assistant_preview||o.assistant_preview||"",main_prompt:i.main_prompt,negative_prompt:i.negative_prompt,characters:JSON.parse(i.characters_json||"[]"),image_url:je(i.id),seed:i.seed,created_at:i.created_at,storage:"indexeddb",storage_key:s.storage_key||Ee(i.id),png_bytes:await el(i.id,o)})}const a={ok:!0,session_id:e,items:r,storage:"indexeddb"};return await ot(a,{cachedOnly:!0}),a}async function vp(e={}){const t=u(e.session_id,200),n=u(e.to_hash,128),r=u(e.assistant_preview||"",Qe),a=(Array.isArray(e.card_ids)?e.card_ids:[]).map(o=>u(o,80)).filter(Boolean);if(!n||!a.length)return{ok:!1,...ae("to_hash and card_ids required","bad_request"),rebound:0,ids:[]};const i=[];for(const o of a){const s=await z("cards",o);if(!s||t&&u(s.session_id||"",200)!==t)continue;const c=Xn(s),l=await Lt(o),f={...l,image_id:o,content_hash:n,assistant_preview:r||l.assistant_preview||""};await Zc(o,f),c.content_hash=n,r&&(c.assistant_preview=r),c.message_role=u(c.message_role||l.message_role||"",40).toLowerCase(),s.meta_json=JSON.stringify(c),await F("cards",s),i.push(o)}return w("gallery.rebind",{n:i.length,to:n.slice(0,8)}),{ok:!0,rebound:i.length,ids:i,content_hash:n}}async function ci(e,t="",n=null){const r=u(e,200),a=u(t);let i=null;try{n!=null&&String(n).trim()!==""&&(i=parseInt(String(n),10))}catch{i=null}if(!r||!a&&i==null)return{ok:!0,unlinked:0,ids:[]};const o=(await ss(r)).sort((c,l)=>(c.created_at||0)-(l.created_at||0)),s=[];for(const c of o){const l=Xn(c),f=await dt(c.id,l),d=u(f.content_hash||""),p=P(f.message_index,-1);let m=!1;if((a&&d&&d===a||i!=null&&i>=0&&p===i)&&(m=!0),!m)continue;const g={...await Lt(c.id),version:1,image_id:c.id,session_id:r,content_hash:"",message_index:-1,character_id:"",chat_id:"",char_index:-1,chat_index:-1,unlinked_at:Date.now()/1e3};await Zc(c.id,g),(l.content_hash||l.message_index!=null||l.assistant_preview)&&(l.content_hash="",l.assistant_preview="",l.message_index=-1,l.unlinked_at=Date.now()/1e3,c.meta_json=JSON.stringify(l),await F("cards",c)),s.push(c.id)}return{ok:!0,unlinked:s.length,ids:s}}async function li(e){const t=u(e,80);return t?await z("cards",t)?(await At("cards",t),await At("images",t),{ok:!0,deleted:1,ids:[t]}):{ok:!1,...ae("card not found","not_found")}:{ok:!1,...ae("card_id required","bad_request")}}async function ui(e){return li(e)}async function xp(e=[]){const t=[...new Set((e||[]).map(r=>u(r,80)).filter(Boolean))],n=[];for(const r of t)(await li(r)).ok&&n.push(r);return{ok:!0,deleted:n.length,ids:n}}async function tl(){const e=(await z("meta","explorer_favorites"))?.ids;return{ok:!0,ids:Array.isArray(e)?e.map(t=>u(t,80)).filter(Boolean):[]}}async function kp(e=[]){const t=[...new Set((e||[]).map(n=>u(n,80)).filter(Boolean))].slice(0,5e3);return await F("meta",{key:"explorer_favorites",ids:t,updated_at:Date.now()/1e3}),{ok:!0,ids:t}}async function Sp(e={}){let t=(await si(2e3)).items;const n=u(e.folder_key||"",400);if(!e.all)if(n)t=t.filter(o=>o.folder_key===n);else if(Array.isArray(e.card_ids)&&e.card_ids.length){const o=new Set(e.card_ids.map(s=>u(s,80)));t=t.filter(s=>o.has(s.id))}else return{ok:!1,...ae("card_ids, folder_key, or all required","bad_request")};if(!t.length)return{ok:!1,...ae("no images to export","empty")};const r=gp(t),a=[{name:"manifest.json",data:new TextEncoder().encode(JSON.stringify(r,null,2))}];for(const o of t){const s=await nl(o.id);s?.byteLength&&a.push({name:`images/${o.id}.png`,data:Z(s)})}if(a.length<2)return{ok:!1,...ae("image bytes missing","empty")};const i=_p(a);return{ok:!0,count:a.length-1,filename:`inlay-gallery-${Date.now()}.zip`,zip_base64:Ut(i),bytes:i.length}}async function Ap(e={}){const t=e.prefer_new_ids===void 0?!0:e.prefer_new_ids,n=String(e.zip_base64||"").replace(/^data:.*base64,/,"");if(!n)return{ok:!1,...ae("zip_base64 required","bad_request")};let r;try{r=Re(n)}catch(l){return{ok:!1,...ae(`invalid base64: ${l?.message||l}`,"bad_request")}}const{manifest:a,images:i}=yp(r);if(!a?.items?.length)return{ok:!1,...ae("manifest.items missing","bad_request")};const o=(await si(2e3)).items,s=[],c={exact:0,candidate:0,orphan:0,skipped:0};for(const l of a.items){const f=String(l.file||`images/${l.id}.png`).replace(/\\/g,"/"),d=i.get(f)||i.get(`images/${l.id}.png`);if(!d?.byteLength){c.skipped+=1;continue}const p=hp(l,o);c[p.status]=(c[p.status]||0)+1;const m={...l.location||{}},g=t?bt():u(l.id||"",80)||bt(),h=u(m.session_id||"",200)||`import_${bt().replace(/-/g,"").slice(0,10)}`,_={version:1,image_id:g,session_id:h,character_id:u(m.character_id||"",200),character_name:u(m.character_name||"",200),chat_id:u(m.chat_id||"",200),chat_name:u(m.chat_name||"",200),char_index:P(m.char_index,-1),chat_index:P(m.chat_index,-1),message_index:P(m.message_index,-1),shot_index:P(m.shot_index,0),paragraph:P(m.paragraph,0),y_percent:or(m.y_percent),content_hash:u(m.content_hash||"",128),assistant_preview:u(m.assistant_preview||"",Qe),imported_at:Date.now()/1e3,reattach:p.status},y=te(d);await ya(g,y,_);const v=ai({...l.meta||{},assistant_preview:_.assistant_preview,imported_at:_.imported_at,reattach:p.status},_,y.byteLength||0);await F("cards",{id:g,job_id:`import_${g.slice(0,8)}`,session_id:h,shot_index:_.shot_index,paragraph:_.paragraph,main_prompt:u(l.meta?.main_prompt||"",8e3),negative_prompt:"",characters_json:JSON.stringify(l.meta?.characters||[]),seed:l.meta?.seed??0,meta_json:JSON.stringify(v),created_at:Number(l.meta?.created_at)||Date.now()/1e3}),s.push({id:g,reattach:p.status,content_hash:_.content_hash})}return{ok:!0,imported:s.length,items:s,report:c}}async function Mp(e){const t=u(e,400);if(!t||!t.includes("|"))return{ok:!1,...ae("folder_key required","bad_request")};const[n,r]=t.split("|",2),a=u(n,200)||"unknown",i=u(r,200)||"unknown",o=await we("cards"),s=[];for(const c of o){const l=Xn(c),f=await dt(c.id,l),d=u(f.character_id||"",200)||"unknown",p=u(f.chat_id||"",200)||"unknown";d!==a||p!==i||(await li(c.id)).ok&&s.push(c.id)}return{ok:!0,deleted:s.length,ids:s,folder_key:`${a}|${i}`}}async function nl(e){return cf(e)}D(),Te(),_e();var Np=["queued","tagging","generating"];function Rr(e={},t=""){const n=u(t||e.session_id||"",200)||"_",r=u(e.content_hash||"",128);if(r)return`${n}::h:${r}`;const a=P(e.message_index,-1);return a>=0?`${n}::m:${a}`:`${n}::all`}async function Ip(e){if(ur.has(e))return"message-reroll";const t=En.get(e);if(!t?.jobId)return"";const n=xt.get(t.jobId);if(!n||n.cancelRequested)return"";const r=await z("jobs",t.jobId);return r&&Np.includes(String(r.state||""))?t.jobId:""}async function fi(e={},t=""){const n=await Ip(Rr(e,t));return n?{ok:!1,busy:!0,accepted:!1,job_id:n==="message-reroll"?"":n,session_id:u(t||e.session_id||"",200),job_state:"busy",error:{code:"busy",message:"같은 메시지 작업이 아직 진행 중입니다. 끝날 때까지 기다려 주세요."}}:null}var Ep=fn({isCharacterImageExtraLore:()=>Bt,matchCharacterImageSectionTitles:()=>il,normalizeNameKey:()=>cn,parseCharacterImageTagLore:()=>di,trimCharacterImageTagLore:()=>al});function Bt(e){return String(e?.comment||e?.name||"").trim().toLowerCase()==="lb-xnai.lb.extra"}function di(e){const t=String(e||"");if(!t.trim())return{header:"",sections:[]};const n=/^(#{2,3})\s+(.+?)\s*$/gm,r=[];let a;for(;(a=n.exec(t))!==null;)r.push({hashes:a[1],title:String(a[2]||"").trim(),start:a.index,titleEnd:a.index+a[0].length});if(!r.length)return{header:t.trimEnd(),sections:[]};let i=t.slice(0,r[0].start).trimEnd();const o=[];for(let s=0;s<r.length;s+=1){const c=r[s],l=s+1<r.length?r[s+1].start:t.length,f=t.slice(c.titleEnd,l).replace(/^\r?\n/,"").trimEnd();if(c.title.toLowerCase()==="character image tags"){const d=t.slice(c.start,l).trimEnd();i=i?`${i}

${d}`:d;continue}o.push({title:c.title,hashes:c.hashes,body:f})}return{header:i.trimEnd(),sections:o}}function cn(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}function rl(e){return new Set((Array.isArray(e)?e:[]).map(t=>cn(t)).filter(Boolean))}function Cp(e,t){if(!t.length)return"";const n=[];e&&n.push(e);for(const r of t){const a=`${r.hashes} ${r.title}`;n.push(r.body?`${a}
${r.body}`:a)}return n.join(`

`).trimEnd()}function al(e,t=[],n=[]){const r=di(e);if(!r.sections.length)return"";const a=rl(n);if(!a.size)return"";const i=rl(t),o=r.sections.filter(s=>{const c=cn(s.title);return a.has(c)&&!i.has(c)});return Cp(r.header,o)}function il(e,t,n=[]){const r=di(e),a=cn(t),i=new Set((Array.isArray(n)?n:[]).map(s=>cn(s)).filter(s=>s.length>=2));if(!a&&!i.size)return[];const o=[];for(const s of r.sections){const c=cn(s.title);c.length<2||(a&&a.includes(c)||i.has(c))&&o.push(s.title)}return o}D(),Wt(),at();function ol(e){const t=e.key||e.keys||e.trigger||"";let n;if(Array.isArray(t))n=t.map(o=>u(o,200));else{const o=u(t,2e3);n=o?o.split(/[,|\n]/):[]}const r=e.secondkey||e.second_key||"";r&&n.push(...X(r));const a=[],i=new Set;for(const o of n){const s=u(o,200),c=U(s),l=s?wt(s):"";!c||i.has(c)||s.startsWith("")||l.length<2||(i.add(c),a.push(s))}return a}function sl(e,t,n){const r=U(e),a=wt(e);if(a.length<2)return 0;const i=(o,s)=>{if(!o||!s||s.length<2)return 0;let c=0,l=0;for(;l<=o.length-s.length;){const f=o.indexOf(s,l);if(f<0)break;c+=1,l=f+s.length}return c};return Math.max(i(t,r),i(n,a))}function mi(e,t){const n=u(t).toLowerCase(),r=wt(t);if(!n)return[];const a=[],i=new Set;for(const o of e||[]){if(typeof o!="object"||Bt(o))continue;const s=u(o.mode||"",40).toLowerCase(),c=u(o.key||"",2e3);if(s==="folder"||c.startsWith("folder:"))continue;const l=ol(o);if(!l.length)continue;let f=0;for(const d of l)f+=sl(d,n,r);if(!(f<=0))for(const d of l){const p=U(d);!p||i.has(p)||(i.add(p),a.push(d))}}return a}function cl(e,t=[]){const n=String(e||"");if(!/character\s*image\s*tags/i.test(n))return!1;const r=(n.match(/^#{2,3}\s+.+$/gm)||[]).filter(i=>!/character\s*image\s*tags/i.test(i)),a=Array.isArray(t)?t.filter(Boolean).length:0;return r.length>=3&&(a===0||r.length>a+1)}function $p(e){const t=[],n=new Set;for(const r of e||[])if(be(r))for(const a of mr(r)){const i=u(a,200),o=U(i);!i||!o||n.has(o)||(n.add(o),t.push(i))}return t}function ll(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e==="full"?"full":"tags"}function Tp(e,t,n=[],r=5,a=1200,i=null,o="tags"){const s=Array.isArray(e)?e:[],c=ll(o),l=c==="off"?[]:s.filter(g=>Bt(g)),f=s.filter(g=>!Bt(g)),d=jp(f,t,r,a),p=Array.isArray(i)&&i.length?i.map(g=>u(g,200)).filter(Boolean):mi(f,t),m=[];for(const g of l){const h=u(g.content||g.data||"",5e4);if(h)if(c==="full")m.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:h,key:"full",always:!0,lore_extra_mode:"full"});else{const _=il(h,t,p),y=_.length?al(h,n,_):"";y&&!cl(y,_)&&m.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:y,key:_.join(", "),always:!0,lore_extra_mode:"tags"})}}for(const g of d)cl(u(g.content||g.data||"",a),[])||m.push(g);return m}function jp(e,t,n=5,r=1200){const a=u(t).toLowerCase(),i=wt(t);if(!a)return[];const o=[];for(const s of e||[]){if(typeof s!="object"||Bt(s))continue;const c=u(s.mode||"",40).toLowerCase(),l=u(s.key||"",2e3);if(c==="folder"||l.startsWith("folder:"))continue;const f=u(s.content||s.data||"",r);if(!f)continue;const d=ol(s);if(!d.length)continue;let p=0;for(const m of d)p+=sl(m,a,i);p<=0||o.push({comment:u(s.comment||s.name||"",200),content:f,key:l,hits:p})}return o.sort((s,c)=>c.hits-s.hits||String(s.comment).localeCompare(String(c.comment))),o.slice(0,Math.max(1,n)).map(({hits:s,...c})=>c)}q(),vt(),D(),Fn(),Wt(),at(),_e(),Vn(),ut();function Op(e){for(let t=e.length-1;t>=0;t--){const n=e[t];if(!n||n.role!=="user")continue;const r=typeof n.content=="string"?n.content:"";if(r.trim()&&!r.startsWith("# Priority: Author"))return r}return""}async function Pp(e){const t=tt(C().card,e.card||{}),n=u(e.session_id,200),r=[{role:"system",content:`${sr(await se("tagger"))}
...
## {{user}} Info
${u(e.persona_description,8e3)}`});const a=u(e.assistant_text,2e4),i=Array.isArray(e.source_session_ids)?e.source_session_ids.map(_=>u(_,200)).filter(Boolean):[],o=t.lorebook||t.char_appearance!==!1||t.asset_nai_tags?await Ma(n,u(e.unified_session_id||"",200),u(e.character_id||"",200),i):[],s=$p(o);if(t.lorebook){const _=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:null,y=ll(t.lore_extra),v=Tp(e.lorebook||[],a,s,5,1200,_,y),x=[],N=[];for(const A of v){const $=Bt(A)||A.always,B=u(A.content||"",$?5e4:1200);if(!B)continue;const k=u(A.comment||"",200),E=k?`### ${k}
${B}`:B;$?x.push(E):N.push(E)}const O=[];x.length&&O.push(`## lb-xnai.lb.extra — OFFICIAL PACK (START)
...
[END OF lb-xnai.lb.extra] Pack finished — text below is not lb-xnai ground truth.`),N.length&&O.push(`## Reference Lorebook (trigger-matched only)
Naming/context only. Not lb-xnai. Do not copy lore prose into tags.

`+N.join(`

`)),w("job.lore.extra",{trigger_keys:Array.isArray(_)?_.length:0,injected:x.length,reference:N.length,sections:v.filter(A=>Bt(A)||A.always).map(A=>A.key||"").filter(Boolean).join(" | ")}),O.length&&r.push({role:"system",content:`${await se("lore_inject")}
${O.join(`

`)}`})}if(t.char_appearance!==!1){const _=o,y=_.filter(N=>be(N)),v=_.filter(N=>u(N.name,200)&&!be(N)),x=Ro(a,_);if(y.length||v.length||x.length){const N=M=>{const R=u(M.name,200),H=u(M.appearance||"",200),pe=u(M.attire||"",160),J=u(M.accessories||"",120),W=[H?`appearance=${H}`:"",pe?`attire=${pe}`:"",J?`accessories=${J}`:""].filter(Boolean);return W.length?`${R} ← ${W.join(" | ")}`:R},O=x.filter(M=>be(M)),A=x.filter(M=>!be(M)),$=O.length?O.map(N).filter(Boolean).join(`
`):"(none)",B=A.length?A.map(M=>`- ${M.name} (aliases: ${mr(M).slice(0,8).join(", ")}) → empty appearance; full looks required in new_characters`).join(`
`):"(none)";let k=await se("appearance_inject");k.includes("{registered_block}")&&(k=k.replace("{registered_block}",$)),k=k.includes("{incomplete_block}")?k.replace("{incomplete_block}",B):`${k}

## Incomplete
${B}`,k=k.includes("{detected_block}")?k.replace("{detected_block}",$):`${k}

${$}`,r.push({role:"system",content:k}),w("job.roster.split",{filled:y.map(M=>M.name),incomplete:v.map(M=>M.name),matched:x.map(M=>M.name),matched_with_looks:O.map(M=>M.name),session_id:n});const E=A.length>0||x.length===0;if(t.asset_nai_tags&&E){const M=[...Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:[],...mi(e.lorebook||[],a)];try{const R=await Is(M);if(R?.block){let H=await se("asset_tags_inject");H=H.includes("{asset_tags_block}")?H.replace("{asset_tags_block}",R.block):`${H}

${R.block}`,r.push({role:"system",content:H})}else Ms(new Map)}catch(R){Ms(new Map),w("asset-tags.inject.fail",{message:String(R?.message||R)},"warn")}}}}else if(t.asset_nai_tags){const _=Ro(a,o);if(_.filter(y=>!be(y)).length>0||_.length===0){const y=[...Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:[],...mi(e.lorebook||[],a)];try{const v=await Is(y);if(v?.block){let x=await se("asset_tags_inject");x=x.includes("{asset_tags_block}")?x.replace("{asset_tags_block}",v.block):`${x}

${v.block}`,r.push({role:"system",content:x})}}catch(v){w("asset-tags.inject.fail",{message:String(v?.message||v)},"warn")}}}const c=Ea(t.natural_base),l=rt(t),f=Math.max(1,Number(t.image_min??1)||1),d=Math.max(f,Number(t.image_max??3)||3);r.push({role:"system",content:["Every shot MUST include `y_percent` (0–100): reading position top→bottom. Spread across the full range in order (shot0 < shot1 < …); ~even gaps. E.g. 2→~25/~75; 3→~20/~50/~80; 4→~15/~40/~65/~90. Forbidden: all under 40, duplicates, or gaps under ~15 unless 1 shot.",f===d?`SHOT COUNT: produce exactly ${d} shot(s) in scenes[].shots (across all scenes).`:`SHOT COUNT: produce between ${f} and ${d} shots in scenes[].shots (across all scenes). Prefer the count that fits the message; never fewer than ${f} or more than ${d}.`,Bp(c),`CHARACTER CAP: at most ${l} characters per shot (char1..char${l}). If more are visible, keep the ${l} most important; fold extras into situation/place.`].join(`
`)});const p=await Rc();p&&r.push({role:"system",content:p});const m=[];if(Number(t.include_max||0)>0)for(const _ of e.recent_messages||[]){const y=u(_?.role,40)||"char",v=u(_?.content||_?.data,12e3);v&&(a&&v===a&&["char","assistant","bot"].includes(y.toLowerCase())||m.push(`[${y}]
...
${h}
> These are instructions explicitly given by the user. If in conflict with previous instructions, this section MUST take precedence.`}),r}function Lp(e){const t=rt(C().card),n=e,r=[];for(const a of n.scenes||[]){const i=u(a.place);for(const o of a.shots||[]){const s={...o,place:i,characters:ua(o.characters||[],[],t).slice(0,t)};r.push(s)}}return r}function Bp(e){return e==="off"?"Natural base mode OFF. Omit the `natural` field (or leave it empty). Do not invent natural-language base phrases.":e==="detailed"?["Natural base mode DETAILED. Every shot MUST include `natural`: a compact English phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include framing/vantage when useful (side view, close-up, viewed through, reflected in…), then for each visible person in left-to-right (or front-to-back) order: hair color + age band + gender, facial expression, clothing, and pose/action as separate details.","Multi-person: NEVER use character names — use position (left girl, right boy) or hair. Add shared action and lighting/atmosphere briefly.","Telegraphic and objective. Example: `side view upper body, left red hair adult woman tense smile in coat pulling right blue hair teen boy startled arms pinned, warm cafe light`. Keep ~12–28 words, English only."].join(" "):e==="supplement"?["Natural base mode SUPPLEMENT. Every shot MUST include `natural`: telegraphic English sentences describing what tags cannot express (composition, framing, actions, atmosphere, lighting) for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Keep tags and natural language clearly separated. Multi-person: NEVER use names — identify by position (left girl, bottom boy) or appearance. For each person include facial expression and clothing as distinct details; also hair and pose unless already obvious.","Unusual framing welcome (viewed through, reflected in shards of a broken mirror, behind…). Concise, minimal, objective — no subjective interpretation.","Example: `Side view, upper body. Left: adult woman with red hair, tense smile, coat, pulling. Right: teen boy with blue hair, startled face, arms pinned. Warm cafe lighting.` Prefer ~2–5 short sentences, English only."].join(" "):["Natural base mode SHORT. Every shot MUST include `natural`: a short English natural-language phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include hair color + age band + gender for each visible person, plus the shared action. Example: `red hair adult woman forced hug blue hair boy`. Keep ~6–20 words, English only."].join(" ")}ee(),q(),D(),vt(),Ct(),ti(),at(),Wt(),Te(),_e(),Vn(),ut();var ul=5e3,Rp=2500,Dp=64;function Fp(e,t,n){const r=Rr(t,n),a=(En.get(r)?.epoch||0)+1;return En.set(r,{epoch:a,jobId:e}),xt.set(e,{key:r,epoch:a,cancelRequested:!1,publishedIds:[]}),{key:r,epoch:a}}function zp(e){const t=xt.get(e);if(!t||t.cancelRequested)return!1;const n=En.get(t.key);return!!(n&&n.jobId===e&&n.epoch===t.epoch)}async function Up(e){const t=xt.get(e),n=t?.publishedIds?[...t.publishedIds]:[];t&&(t.publishedIds=[]);for(const r of n)try{await ui(r)}catch{}return n.length}async function Ie(e,t="interrupted"){if(zp(e))return!1;const n=await Up(e);return await me(e,"cancelled",{phase:"cancelled",progress:0,message:`${t}${n?` · discarded ${n}`:""}`,shot_count:0,shot_done:0},null),w("job.cancelled",{job_id:e,message:t,discarded:n,focus:!0}),!0}function Zn(e={}){return{shot_count:e.shot_count??0,shot_index:e.shot_index??0,shot_done:e.shot_done??0,progress:e.progress??0,phase:e.phase||"generating",message:e.message||"",cards_so_far:e.cards_so_far,debug_stage:gt()||kn(),debug_error:ar()?.message||""}}function Jp(e){return!e||typeof e!="object"?e:JSON.parse(JSON.stringify(e,(t,n)=>{if(t==="image_url"&&typeof n=="string"&&n.startsWith("data:"))return"";if(!(t==="tagged"||t==="appearance"||t==="debug_tail"))return n}))}async function me(e,t,n=null,r=null){const a=await z("jobs",e);if(!a)return;const i=a.state,o={...a,state:t},s=Jp(n);o.result_json=s!=null?JSON.stringify(s):null,o.error=r,o.updated_at=Date.now()/1e3;const c=t!=="generating"||i!=="generating"||!!r;await F("jobs",o,{persist:c}),(t==="done"||t==="error"||t==="cancelled")&&await is(),w("job.set",{message:`${t}${r?" ERR":""}${c?"":" (mem)"}`,job_id:e,state:t,persist:c,err:r?String(r).slice(0,160):"",background:t==="generating",focus:t!=="generating"})}async function fl(e){if(!(C().card||{}).power&&!e.force)throw new Error("Power가 OFF 상태입니다.");const t=u(e.session_id,200)||`sess_${bt().replace(/-/g,"").slice(0,12)}`,n={...e,session_id:t},r=await fi(n,t);if(r)return w("job.busy",{message:r.error.message||"busy",key:Rr(n,t),focus:!0},"warn"),r;const a=bt(),i=Date.now()/1e3;if(Fp(a,n,t),n.force)try{await ci(t,u(n.content_hash||""),n.message_index)}catch{}return await F("jobs",{id:a,session_id:t,state:"queued",request_json:JSON.stringify(n),result_json:null,error:null,created_at:i,updated_at:i}),Gp(a).catch(async o=>{console.error("[Inlay Nexus] job crashed",a,o);try{await me(a,"error",null,String(o?.message||o).slice(0,1500))}catch{}}),{ok:!0,accepted:!0,job_id:a,session_id:t,job_state:"queued"}}async function Hp(e){const t=await z("jobs",e);if(!t)return{ok:!1,error:{code:"not_found",message:"job not found"}};const n=t.result_json?JSON.parse(t.result_json):null,r={};if(n&&typeof n=="object")for(const a of["shot_count","shot_index","shot_done","progress","phase","message","cards_so_far","debug_stage","debug_error"])a in n&&(r[a]=n[a]);return n&&await ot(n),{ok:!0,job_id:t.id,session_id:t.session_id,state:t.state,error:t.error,result:n,progress:r,debug:{last_stage:kn(),last_error:ar(),events:Yr(e,40)},created_at:t.created_at,updated_at:t.updated_at}}function Kp(e){for(const t of["y_percent","anchor_percent","read_percent"]){const n=e[t];if(n!=null)try{return Math.max(0,Math.min(100,Number(n)))}catch{return null}}return null}async function Gp(e){const t=await z("jobs",e);if(!t)return;const n=JSON.parse(t.request_json??"{}"),r=String(t.session_id??""),a=Bi();xn(e);const i=ue("job.run");w("job.start",{job_id:e,session_id:r,message_index:n.message_index,text_len:String(n.assistant_text||"").length});try{if(await Ie(e,"superseded before start")||(n.force&&await ci(r,u(n.content_hash||""),n.message_index),await Ie(e,"superseded before tagging")))return;await me(e,"tagging",{phase:"tagging",progress:0,message:"장면 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.tagging"});const o=await Pp(n),s=Op(o);if(w("job.tagger.messages",{msgs:o.length}),C().card?.preprocessing){const k=sr(await se("preprocess"));if(k){const E=[{role:"system",content:k},o[o.length-1]],M=await on(C().llm,E);if(await Ie(e,"superseded during preprocess"))return;o.splice(o.length-1,0,{role:"system",content:`## Preprocess Summary
${M}`})}}const c=await on(C().llm,o);if(await Ie(e,"superseded after tagging"))return;const l=Zr(c);let f=Lp(l);if(w("job.tagger.done",{shots:f.length,raw_len:String(c||"").length}),!f.length)throw new Error("태거가 shot을 반환하지 않았습니다.");const d=C().card||{},p=Math.max(1,Number(d.image_min??1)),m=Math.max(p,Number(d.image_max??3));f=f.slice(0,m);const g=jr();if(g==="two_stage"){if(await me(e,"tagging",{phase:"tagging",progress:.35,message:"큐레이션 2단 씬 태그 보강 중…",shot_count:f.length,shot_done:0,debug_stage:"job.curation_refine"}),await Ie(e,"superseded during curation refine"))return;await Dc(f,{chatContext:s})}else if(g==="embed_snap"){if(await me(e,"tagging",{phase:"tagging",progress:.4,message:"씬 태그 임베딩 매칭 중…",shot_count:f.length,shot_done:0,debug_stage:"job.curation_snap"}),await Ie(e,"superseded during curation snap"))return;const k=await Uc(f);k.ok||(w("job.curation_snap.fallback",{message:k.reason},"warn"),await me(e,"tagging",{phase:"tagging",progress:.45,message:k.reason||"임베딩 없음 → 큐레이션 없이 생성",shot_count:f.length,shot_done:0,debug_stage:"job.curation_snap_fallback"}))}const h=f.flatMap(k=>k.characters||[]),_=u(n.unified_session_id||"",200),y=u(n.character_id||"",200),v=Array.isArray(n.source_session_ids)?n.source_session_ids.map(k=>u(k,200)).filter(Boolean):[],x=await Zf({sessionId:r,tagged:l,shotChars:h,unifiedSessionId:_,characterId:y,sourceSessionIds:v});w("job.roster",{roster:x.length});const N=rt(d);for(const k of f)k.characters=ua(k.characters||[],x,N);if(await Ie(e,"superseded before generate"))return;await me(e,"generating",Zn({shot_count:f.length,shot_index:0,shot_done:0,progress:0,phase:"generating",message:`이미지 1/${f.length} 생성 준비`}));const O=[],A=!!d.llm_anchor_percent;for(let k=0;k<f.length;k+=1){if(await Ie(e,`superseded before shot ${k+1}`))return;const E=f[k],{main:M,neg:R,captions:H,meta:pe}=await Br({shot:E,roster:x}),J=bt(),W=Date.now()/1e3,G=u(n.content_hash||"");let We=Kp(E);We==null&&A&&(We=Math.round(k/Math.max(1,f.length)*1e4)/100),w("job.shot.prepare",{shot:k,card_id:J,prompt_len:String(M||"").length,captions:(H||[]).length}),await me(e,"generating",Zn({shot_count:f.length,shot_index:k,shot_done:k,progress:Math.round(k/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`NovelAI 요청 중 ${k+1}/${f.length}… [${gt()}]`}));let oe=0;const mt=setInterval(()=>{oe+=ul/1e3;const un=zs();Us()&&Oa()>=Dp&&un&&Date.now()-un>=Rp&&ld("heartbeat-idle");const Hl=Oa()||Fs();me(e,"generating",Zn({shot_count:f.length,shot_index:k,shot_done:k,progress:Math.round(k/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`NovelAI 대기 ${k+1}/${f.length} (${oe}s) · ${gt()}${Hl?` ${Math.round(Hl/1024)}KB`:""}`})).catch(()=>{})},ul);let Y,Be;try{({bytes:Y,seed:Be}=await Xc({main:M,neg:R,captions:H}))}finally{clearInterval(mt)}if(w("job.shot.nai_done",{shot:k,bytes:Y?.byteLength||0,seed:Be}),await Ie(e,`superseded after shot ${k+1} nai`))return;await me(e,"generating",Zn({shot_count:f.length,shot_index:k,shot_done:k,progress:Math.round((k+.5)/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`이미지 저장 중 ${k+1}/${f.length}… [${gt()}]`}));const re=lp({imageId:J,sessionId:r,request:n,shotIndex:k,paragraph:E.paragraph,yPercent:We,line:(()=>{const un=Math.floor(Number(E.line));return Number.isFinite(un)&&un>=1?un:null})(),contentHash:G});await ya(J,Y,re);const Ah=ai(pe,re,Y?.byteLength||0);await F("cards",{id:J,job_id:e,session_id:r,shot_index:k,paragraph:Number(E.paragraph||0),main_prompt:M,negative_prompt:R,characters_json:JSON.stringify(pe.characters||[]),seed:Be,meta_json:JSON.stringify(Ah),created_at:W});const Jl=xt.get(e);if(Jl&&Jl.publishedIds.push(J),await Ie(e,`superseded after shot ${k+1} save`))return;O.push({id:J,shot_index:k,paragraph:re.paragraph,y_percent:re.y_percent,line:re.line,message_index:re.message_index??-1,message_role:re.message_role||"",content_hash:re.content_hash||"",character_id:re.character_id||"",chat_id:re.chat_id||"",character_name:re.character_name||"",chat_name:re.chat_name||"",char_index:re.char_index??-1,chat_index:re.chat_index??-1,assistant_preview:u(n.assistant_text||"",Oi),main_prompt:M,negative_prompt:R,characters:pe.characters||[],image_url:je(J),seed:Be,storage:"indexeddb",png_bytes:Y?.byteLength||0}),w("job.shot.saved",{shot:k,card_id:J,has_url:!!je(J)}),await me(e,"generating",Zn({shot_count:f.length,shot_index:k,shot_done:k+1,progress:Math.round((k+1)/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`이미지 ${k+1}/${f.length} 완료`,cards_so_far:O.length}))}if(await Ie(e,"superseded before done"))return;const $={cards:O,message_index:n.message_index!=null?Number(n.message_index):-1,shot_count:f.length,shot_done:f.length,progress:100,phase:"done",message:`이미지 ${f.length}/${f.length} 완료`};await ot($),await me(e,"done",$);const B=xt.get(e);B&&(B.publishedIds=[]),i.end({message:"done",cards:O.length})}catch(o){i.fail(o);const s=o,c=`${s?.message||o}
${s?.stack||""}`.slice(-1500);await me(e,"error",{phase:"error",message:String(s?.message||o).slice(0,240),debug_stage:kn(),debug_tail:Yr(e,12)},c)}finally{xn(a)}}D(),at(),Ht(),Te(),_e();function Rt(e,t){try{return JSON.parse(e)}catch{return t}}async function Wp(e,t={}){const n=u(e,80),r=await z("cards",n);if(!r)return{ok:!1,error:{code:"not_found",message:"card not found"}};const a=Rt(r.characters_json||"[]",[]),i=Array.isArray(a)?a:[];let o=r.main_prompt;"main_prompt"in t&&(o=u(t.main_prompt,8e3));let s=r.negative_prompt;"negative_prompt"in t&&(s=u(t.negative_prompt,8e3));let c=i;if("characters"in t){const d=t.characters||[];if(!Array.isArray(d))return{ok:!1,error:{code:"bad_request",message:"characters must be a list"}};c=[];const p=rt(C().card||{});for(let m=0;m<d.slice(0,p).length;m++){const g=d[m];if(typeof g!="object")continue;const h=g,_=m<i.length&&typeof i[m]=="object"?i[m]:{},y=u(h.name!=null?h.name:_.name,200),v=u(h.prompt!=null?h.prompt:_.prompt,4e3);if(!y&&!v)continue;const x={..._,name:y||`char${m+1}`,prompt:v||"girl"};"uc"in h&&(x.uc=u(h.uc,2e3));for(const N of["center_x","center_y"])if(N in h)try{x[N]=Number(h[N])}catch{}c.push(x)}}r.main_prompt=o,r.negative_prompt=s,r.characters_json=JSON.stringify(c);try{let d=Rt(r.meta_json||"{}",{});(!d||typeof d!="object"||Array.isArray(d))&&(d={});const p=d;p.setup=o,p.characters=c,r.meta_json=JSON.stringify(p)}catch{}await F("cards",r);const l=await dt(n,{}),f={id:n,main_prompt:o,negative_prompt:s,characters:c,paragraph:r.paragraph,shot_index:r.shot_index,y_percent:l.y_percent,message_index:l.message_index,content_hash:l.content_hash,image_url:je(n)};return await ot(f),{ok:!0,card:f}}async function dl(e,t="nai",n=null,r={}){const a=await z("cards",e);if(!a)return{ok:!1,error:{code:"not_found",message:"card not found"}};const i=a.session_id,o=Rt(a.meta_json||"{}",{}),s=o.location||{};if(!r.skipBusyCheck)try{const E=await dt(e,o),M=await fi({session_id:i,content_hash:u(E.content_hash||o.content_hash||"",128),message_index:P(E.message_index,-1)},i);if(M)return M}catch{}const c=u(s.character_id||o.character_id||"",200);let l=u(o.unified_session_id||s.unified_session_id||"",200);!l&&c&&(l=Zl(c));let f=[];try{const E=await z("jobs",a.job_id);if(E?.request_json){const M=JSON.parse(E.request_json);Array.isArray(M.source_session_ids)&&(f=M.source_session_ids.map(R=>u(R,200)).filter(Boolean))}}catch{}const d=await Ma(i,l,c,f);if(t==="full"){const E=await z("jobs",a.job_id);if(!E)return{ok:!1,error:{code:"no_job",message:"original job missing"}};const M=JSON.parse(E.request_json);return M.force=!0,fl(M)}let p,m,g,h,_={};const y=n;if(y&&("main_prompt"in y||"negative_prompt"in y||"characters"in y))p="main_prompt"in y?u(y.main_prompt||""):u(a.main_prompt),m="negative_prompt"in y?u(y.negative_prompt||""):u(a.negative_prompt),h="characters"in y?y.characters:null,h==null&&(h=Rt(a.characters_json||"[]",[])),g=(h||[]).slice(0,rt(C().card||{})).map(E=>({prompt:ma(E.prompt||"girl")||"girl",uc:u(E.uc),center_x:Number(E.center_x??.5),center_y:Number(E.center_y??.5)}));else if(u(a.main_prompt||"")){const E=Rt(a.characters_json||"[]",[]),M=Array.isArray(E)?E:[],R=ml(o),H=M.map(mt=>{if(!mt||typeof mt!="object")return null;const Y=mt;if(Y.raw&&typeof Y.raw=="object"){const Be=Y.raw;return{...Be,name:u(Be.name||Y.name,200)}}return{name:u(Y.name,200),action:Y.action,expression:Y.expression,sex:Y.sex,label:Y.label,age:Y.age,original:Y.original||Y.original_tag}}).filter(Boolean),pe=C().card||{},J=Ue(C().nai?.model||"nai-diffusion-4-5-full"),W=Object.values(Nn).filter(Boolean);Nn[J]&&W.unshift(Nn[J]);const G=Fu({setup:o.setup,main:a.main_prompt,person:o.person,stylePositives:zu(pe),qualitySuffixes:W}),We={characters:R.length?R:H,paragraph:a.paragraph,camera:G.rebuildMain&&G.lockedSetup?"":u(o.camera||""),situation:G.rebuildMain&&G.lockedSetup?"":u(o.situation||o.scene||""),place:G.rebuildMain&&G.lockedSetup?"":u(o.place||""),action:G.rebuildMain&&G.lockedSetup?"":u(o.action||"")},oe=await Br({shot:We,roster:d,lockedSetup:G.rebuildMain?G.lockedSetup:void 0});G.rebuildMain?(p=oe.main,m=oe.neg,g=oe.captions,h=oe.meta.characters,_={setup:oe.meta.setup,person:oe.meta.person,characters:h}):(p=u(a.main_prompt),m=u(a.negative_prompt)||oe.neg,g=oe.captions,h=oe.meta.characters,_={setup:p,person:oe.meta.person,characters:h})}else{const E=Rt(a.characters_json||"[]",[]),M=ml(o),R=(E||[]).map(W=>{if(!W||typeof W!="object")return null;const G=W;return G.raw||{name:G.name,action:G.action,expression:G.expression}}).filter(Boolean),H=u(o.setup||""),pe={characters:M.length?M:R,paragraph:a.paragraph,camera:H?"":u(o.camera||""),situation:H?"":u(o.situation||o.scene||""),place:H?"":u(o.place||""),action:H?"":u(o.action||"")},J=await Br({shot:pe,roster:d,lockedSetup:H});p=J.main,m=J.neg,g=J.captions,h=J.meta.characters,_={setup:J.meta.setup,person:J.meta.person,characters:h}}if(!g.length&&!(y&&"characters"in y)){const E={characters:(o.characters||[]).map(R=>R.raw||R),camera:o.setup},M=await Br({shot:E,roster:d});p=M.main,m=M.neg,g=M.captions,h=M.meta.characters,_={setup:M.meta.setup,person:M.meta.person,characters:h}}const{bytes:v,seed:x}=await Xc({main:p,neg:m,captions:g}),N=bt(),O=Date.now()/1e3;let A=await Lt(a.id);Object.keys(A).length||(A=await dt(a.id,o));const $={version:1,image_id:N,session_id:i,unified_session_id:l,character_id:u(A.character_id||"",200),character_name:u(A.character_name||o.character_name||"",200),chat_id:u(A.chat_id||"",200),chat_name:u(A.chat_name||o.chat_name||"",200),char_index:P(A.char_index,-1),chat_index:P(A.chat_index,-1),message_index:P(A.message_index,-1),shot_index:P(A.shot_index,P(a.shot_index,0)),paragraph:P(A.paragraph,P(a.paragraph,0)),y_percent:or(A.y_percent),content_hash:u(A.content_hash||"",128),assistant_preview:u(A.assistant_preview||o.assistant_preview||"",Qe)};await ya(N,v,$);const B=ai({...o,..._},$,v.byteLength);for(const E of["y_percent","anchor_percent","read_percent"])delete B[E];B.y_percent=$.y_percent,await F("cards",{id:N,job_id:a.job_id,session_id:i,shot_index:a.shot_index,paragraph:a.paragraph,main_prompt:p,negative_prompt:m,characters_json:JSON.stringify(h),seed:x,meta_json:JSON.stringify(B),created_at:O});try{await ui(e)}catch{}const k={id:N,image_url:je(N),main_prompt:p,negative_prompt:m,characters:h,seed:x,paragraph:$.paragraph,y_percent:$.y_percent,message_index:$.message_index,shot_index:$.shot_index,content_hash:$.content_hash,character_id:$.character_id,chat_id:$.chat_id,character_name:$.character_name,chat_name:$.chat_name,assistant_preview:$.assistant_preview,storage:"indexeddb",png_bytes:v.byteLength};return await ot(k),{ok:!0,replaced:e,card:k}}async function qp({session_id:e="",content_hash:t="",message_index:n=-1}={}){const r=u(e,200),a=u(t,128),i=P(n,-1);if(!r&&!a&&i<0)return{ok:!1,error:{code:"bad_request",message:"session_id or content_hash required"}};const o=await we("cards"),s=[];for(const h of o){if(r&&h.session_id!==r)continue;const _=Rt(h.meta_json||"{}",{}),y=await dt(h.id,_),v=u(y.content_hash||_.content_hash||"",128),x=P(y.message_index,-1);if(a){if(v!==a)continue}else if(i>=0){if(x!==i)continue}else continue;const N=y.y_percent??_.y_percent??_.anchor_percent??_.read_percent,O=Number(N);s.push({row:h,y:Number.isFinite(O)?O:999,shot:P(h.shot_index,0),paragraph:P(h.paragraph??y.paragraph,0)})}if(s.sort((h,_)=>h.y-_.y||h.shot-_.shot||h.paragraph-_.paragraph),!s.length)return{ok:!1,error:{code:"not_found",message:"no cards for message"}};const c=r||u(s[0]?.row?.session_id||"",200),l={session_id:c,content_hash:a,message_index:i},f=await fi(l,c);if(f)return f;const d=Rr(l,c);ur.add(d);const p=[],m=[],g=[];try{for(const h of s){const _=h.row;try{const y=await dl(_.id,"nai",null,{skipBusyCheck:!0});if(y?.busy){g.push({id:_.id,error:y.error?.message||"busy"});break}y?.ok&&y.card?(p.push(y.card),y.replaced&&m.push(y.replaced)):g.push({id:_.id,error:u(y?.error?.message||"reroll failed",400)})}catch(y){g.push({id:_.id,error:u(y?.message||y,400)})}}return{ok:p.length>0,count:p.length,replaced:m,cards:p,failed:g}}finally{ur.delete(d)}}function ml(e){return Array.isArray(e.characters)?e.characters.map(t=>t&&typeof t=="object"?t.raw||t:null).filter(Boolean):[]}var Vp=fn({HASH_REBIND_THRESHOLD:()=>eg,PREFIX_MATCH_MIN_CHARS:()=>24,PREFIX_MATCH_THRESHOLD:()=>Qp,SIMILARITY_COMPARE_MAX:()=>800,VIEWER_THUMB_LAYOUT:()=>ne,activeSegmentIndex:()=>Wg,bigramCounts:()=>gi,buildInlineChatHtml:()=>Qg,claimStickyMarkerByCardId:()=>xg,clampPinPercent:()=>Ke,clampReadingPercent:()=>Gg,clampShotLine:()=>Tl,clampThumbScrollOffset:()=>Lg,composeDualProgressBarsHtml:()=>Jg,composeProgressToastHtml:()=>Hg,composeSingleProgressBarHtml:()=>Nl,composeStickyThumbHtml:()=>Ig,createDebouncedSaveQueue:()=>wg,createScrollSettleTracker:()=>yg,createSessionChangeGuard:()=>bg,describeDomApiCompare:()=>cg,diceBigramRatio:()=>hl,evenAnchorPercent:()=>yi,expandElementLineEntries:()=>Bl,findElementIndexForLine:()=>Rl,findElementIndexForLineWithFallback:()=>Zg,findHashRebindCandidates:()=>tg,findPlainLineStartOffset:()=>Pl,fitBoxInside:()=>Ng,galleryFocusMessage:()=>ag,galleryForMessage:()=>rg,galleryIndexFromChildIndex:()=>jg,gallerySelectedCount:()=>_i,galleryStripContentWidth:()=>Pg,galleryStripSplitAt:()=>zr,hasGenerationInfo:()=>vl,htmlToPlainLn:()=>Xg,injectInlineImagesIntoHtml:()=>zl,isCharMessageRole:()=>og,isMessageSelectionGesture:()=>gg,isNearbyDomIndex:()=>Dg,lineTextOccurrence:()=>Ll,linkCardsForMessage:()=>hi,longestCommonPrefixLength:()=>gl,markerBlockHtml:()=>Fl,mergeViewerPaintJob:()=>zg,messageCompactKey:()=>ln,messageContextTriplet:()=>sg,messagesTextOverlapScore:()=>xl,nearbyDomIndexWindow:()=>Fg,nearbyMessageImageIds:()=>Rg,normalizeInlineMatchText:()=>Hr,normalizeMatchText:()=>Dr,normalizeMessageRole:()=>pi,parseAutotagLookJson:()=>Ml,pickMessageIndexNearPoint:()=>pg,pinPercentToPx:()=>fg,pinPercentToPxFromBottom:()=>dg,pinPxToPercent:()=>kl,preferNearbyHostIndex:()=>Dl,prefixMatchRatio:()=>_l,rawMessageRole:()=>Fr,readingPercentInMessage:()=>Il,rebindGalleryMessageIndexes:()=>lg,resolveCardAnchorPercent:()=>Kg,resolveChatMessageMatch:()=>ug,resolveClickSelectionAction:()=>hg,resolveIndexProgress:()=>Ug,resolveStickyThumbPct:()=>Ag,resolveStoredPinPercent:()=>mg,roleFromGenerationInfo:()=>ig,scaleInlineThumbnail:()=>Zp,shouldKeepStickyThumbHidden:()=>Sg,shouldRefreshGallery:()=>vg,shouldRewriteStickyThumb:()=>kg,shouldSelectMessageByTextDrag:()=>_g,splitMessageLines:()=>Jr,stickyCornerEdgeBox:()=>Sl,stickyCornerImageBox:()=>Cg,stickyPinEdgeBox:()=>Tg,stickyPinOverImage:()=>$g,stickyThumbBoxFromPct:()=>Mg,stickyThumbNeedsHtmlPaint:()=>Eg,stripInlayInlineHtml:()=>$l,thumbIndexAtStripX:()=>Og,visibleGalleryImageIds:()=>Bg}),Yp=528,Xp=720;function b(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function pl(e,t){const n={...e};for(const[r,a]of Object.entries(t||{})){const i=n[r];n[r]=a&&typeof a=="object"&&!Array.isArray(a)?pl(i&&typeof i=="object"?i:{},a):a}return n}function Zp(e){const t=Math.max(1,b(e,100));return{width:Math.max(1,Math.round(Yp*t/100)),height:Math.max(1,Math.round(Xp*t/100)),percent:t}}function Dr(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}var Qp=.6,eg=.6,Mh=24,Nh=800;function pi(e){const t=String(e||"").toLowerCase().trim();return t?t==="char"||t==="assistant"||t==="bot"?"char":t==="user"||t==="human"?"user":t:""}function gl(e,t){const n=String(e||""),r=String(t||""),a=Math.min(n.length,r.length);let i=0;for(;i<a&&n.charCodeAt(i)===r.charCodeAt(i);)i+=1;return i}function gi(e){const t=String(e||""),n=new Map;if(t.length<2)return n;for(let r=0;r<t.length-1;r+=1){const a=t.charCodeAt(r)+","+t.charCodeAt(r+1);n.set(a,(n.get(a)||0)+1)}return n}function hl(e,t,n=null){const r=String(e||""),a=String(t||"");if(!r||!a)return 0;if(r===a)return 1;if(r.length<2||a.length<2)return 0;const i=n||gi(r),o=gi(a);let s=0;for(const[f,d]of o){const p=i.get(f)||0;p&&(s+=Math.min(p,d))}const c=r.length-1,l=a.length-1;return 2*s/(c+l)}function _l(e,t){const n=Dr(e),r=Dr(t);if(!n||!r)return 0;const a=Math.max(n.length,r.length);if(a<24)return 0;if(n===r)return 1;const i=gl(n,r)/a;return i>=.6?i:hl(n.length>800?n.slice(0,800):n,r.length>800?r.slice(0,800):r)}function hi(e,t){if(!t)return[];const n=Array.isArray(e)?e:[],r=String(t.hash||"");return r?wl(n.filter(a=>a?.content_hash&&a.content_hash===r)):[]}function tg(e,t={}){const n=Array.isArray(e)?e:[],r=String(t.newHash||t.hash||""),a=String(t.text||""),i=String(t.characterId||""),o=String(t.chatId||""),s=String(t.sessionId||""),c=Number(t.messageIndex),l=pi(t.role||t.messageRole||"");if(!r||!a||!i||!l||!Number.isFinite(c)||c<0)return[];if(n.some(d=>d?.content_hash&&d.content_hash===r))return[];if(Dr(a).length<24)return[];const f=[];for(const d of n){const p=String(d?.content_hash||"");if(!p||p===r||String(d?.character_id||"")!==i)continue;const m=String(d?.chat_id||""),g=String(d?.session_id||"");if(o){if(m!==o)continue}else if(s){if(g&&g!==s)continue}else continue;if(Number(d?.message_index)!==c)continue;const h=pi(d?.message_role||d?.role||"");if(!h||h!==l)continue;const _=String(d?.assistant_preview||"");if(!_)continue;const y=_l(a,_);y<.6||f.push({card:d,score:y})}return f.sort((d,p)=>p.score-d.score||b(p.card?.created_at)-b(d.card?.created_at)),wl(f.map(d=>d.card))}function yl(e){const t=e?.y_percent??e?.anchor_percent??e?.read_percent,n=Number(t);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ng(e,t){return yl(e)-yl(t)||b(e?.paragraph)-b(t?.paragraph)||b(e?.shot_index)-b(t?.shot_index)||b(t?.created_at)-b(e?.created_at)}function bl(e,t){return b(t?.created_at)-b(e?.created_at)||b(t?.message_index)-b(e?.message_index)||b(t?.paragraph)-b(e?.paragraph)||b(t?.shot_index)-b(e?.shot_index)}function wl(e){const t=new Map;for(const n of e||[]){const r=`${n?.paragraph??"?"}|${n?.shot_index??n?.id}`,a=t.get(r);(!a||b(n?.created_at)>=b(a?.created_at))&&t.set(r,n)}return[...t.values()]}function rg(e,t,n=8){const r=new Map;for(const f of e||[]){const d=String(f?.id||"");!d||r.has(d)||r.set(d,f)}const a=[...r.values()],i=Math.max(0,Math.min(64,b(n,8)||8));if(!t)return a.sort(bl).slice(0,Math.max(1,i||8));const o=hi(a,t).sort(ng),s=new Set(o.map(f=>String(f.id))),c=String(t.sessionId||""),l=a.filter(f=>!s.has(String(f.id))).filter(f=>!c||!f?.session_id||f.session_id===c).sort(bl).slice(0,i);return[...o,...l]}function _i(e,t){return t?hi(e,t).length:0}function ag(e,t,n){if(e&&_i(n,e)>0)return e;const r=String(e?.sessionId||e?.session_id||""),a=String(t?.sessionId||t?.session_id||"");return t&&_i(n,t)>0&&(!r||!a||r===a)?t:e||null}function Fr(e){const t=String(e?.role||e?.type||e?.speaker||e?.sender||e?.from||e?.name||"").trim().toLowerCase();return e?.isUser===!0||e?.fromUser===!0||/^(user|human|player|you|me)$/.test(t)||t.includes("user")?"user":e?.isAssistant===!0||e?.isBot===!0||e?.isChar===!0||/^(assistant|bot|char|character|model|ai)$/.test(t)||t.includes("assistant")||t.includes("bot")||t.includes("char")?"char":t==="system"||t==="developer"?"system":""}function vl(e){const t=e?.generationInfo??e?.generation_info??e?.messageGenerationInfo;return t==null?!1:typeof t=="string"?t.trim().length>0:typeof t=="object"?Object.keys(t).length>0:!0}function ig(e){return vl(e)?"char":"user"}function og(e){if(e&&typeof e=="object")return Fr(e)==="char";const t=String(e||"").trim().toLowerCase();return t==="char"||t==="assistant"||t==="bot"}function ln(e,t=48){const n=Math.max(1,b(t,48));return String(e||"").replace(/\s+/g,"").slice(0,n)}function sg(e,t,n=48){const r=Array.isArray(e)?e:[],a=Math.floor(b(t,-1)),i=a>=0&&a<r.length?r[a]:null,o=a>0?r[a-1]:null,s=a>=0&&a<r.length-1?r[a+1]:null;return[ln(o?.text,n),ln(i?.text,n),ln(s?.text,n),Fr(i)||String(i?.role||"").trim().toLowerCase()].join("|")}function xl(e,t){const n=String(e||"").replace(/\s+/g,""),r=String(t||"").replace(/\s+/g,"");if(!n||!r)return 0;if(n.includes(r))return r.length;if(r.includes(n))return n.length;let a=0;const i=(s,c,l=8,f=512)=>{let d=l,p=Math.min(s.length,f),m=0;for(;d<=p;){const g=d+p>>1;c.includes(s.slice(0,g))?(m=g,d=g+1):p=g-1}return m};a=Math.max(a,i(r,n),i(n,r));const o=Math.min(r.length,2400);for(let s=0;s+8<=o;s+=32){const c=Math.min(64,o-s);for(let l=c;l>=8;l-=8)if(n.includes(r.slice(s,s+l))){a=Math.max(a,l);break}}return a}function cg(e,t){const n=String(e||""),r=String(t||""),a=ln(n),i=ln(r),o=xl(n,r),s=o>=8,c=a.length>0&&a.length<8&&a===i,l=i.slice(0,48),f=a.slice(0,48);return{domChars:n.length,apiChars:r.length,domCompactChars:a.length,apiCompactChars:i.length,shareScore:o,overlap:s,shortExact:c,apiInDom:!!(l&&l.length>=8&&a.includes(l)),domInApi:!!(f&&f.length>=8&&i.includes(f)),apiKey:l,domKey:f}}function lg(e,t,n){const r=Array.isArray(t)?t:[],a=typeof n=="function"?n:null,i=new Map;if(a)for(let s=0;s<r.length;s+=1){const c=String(r[s]?.text??r[s]?.data??r[s]?.content??""),l=String(a(c)||"");if(!l)continue;const f=Number.isFinite(Number(r[s]?.index))?Number(r[s].index):s,d=i.get(l);d?d.push(f):i.set(l,[f])}let o=0;return{cards:(Array.isArray(e)?e:[]).map(s=>{const c=String(s?.content_hash||""),l=c?i.get(c):void 0;return!c||!l?s:l.length!==1?Number(s?.message_index)!==-1?(o+=1,{...s,message_index:-1}):s:Number(s?.message_index)!==l[0]?(o+=1,{...s,message_index:l[0]}):s}),changed:o}}function ug(e,t,n,r,a){const i=Array.isArray(t)?t:[],o=Math.floor(b(n,-1)),s=(f,d,p,m=-1)=>({chatIndex:Number.isFinite(Number(f?.index))?Number(f?.index):m>=0?m:o,text:String(f?.text||e||""),role:Fr(f)||String(f?.role||"").trim().toLowerCase(),matchMethod:d,score:p});if(!i.length)return{chatIndex:Math.max(0,o),text:String(e||""),role:"",matchMethod:"fallback",score:0};const c=i.length-1-o;if(c>=0&&c<i.length)return s(i[c],"reverse",100,c);const l=Math.max(0,Math.min(i.length-1,c));return s(i[l],"reverse",50,l)}function Ke(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(100,Math.floor(n))):Math.max(0,Math.min(100,Math.floor(b(t,0))))}function fg(e,t,n=22,r=4){const a=Math.max(1,b(t,1)),i=Math.max(1,b(n,1)),o=Math.max(0,b(r,0)),s=Math.floor(a*Ke(e,0)/100);return Math.max(o,Math.min(a-i-o,s))}function dg(e,t,n=22,r=8){const a=Math.max(1,b(t,1)),i=Math.max(1,b(n,1)),o=Math.max(0,b(r,0)),s=a-Math.floor(a*Ke(e,0)/100)-i;return Math.max(o,Math.min(a-i-o,s))}function kl(e,t){const n=Math.max(1,b(t,1));return Ke(b(e,0)/n*100,0)}function mg(e,t,n,r=null){const a=r&&typeof r=="object"?r:{x:38,y:80},i=t==="y"||t==="Y",o=i?b(a.y,80):b(a.x,38),s=i?"overlay_y_pct":"overlay_x_pct",c=i?"overlay_y_offset":"overlay_x_offset",l=String(e?.overlay_pin_origin||""),f=l==="top"||l==="tl"||l==="top-left",d=e?.[s],p=d!=null&&Number.isFinite(Number(d)),m=Number(e?.[c]),g=Number.isFinite(m),h=_=>Ke(100-Number(_),o);return p?i&&f?h(d):Ke(d,o):g?i?Ke((b(n,1)-m)/Math.max(1,b(n,1))*100,o):kl(m,n):Ke(o,o)}function pg(e,t,n=null,r=800){const a=Array.isArray(e)?e:[];if(!a.length)return-1;const i=Math.max(1,b(r,800)),o=Number.isFinite(Number(t))?Number(t):i*.5,s=Number.isFinite(Number(n))?Number(n):null;let c=-1,l=1/0,f=-1,d=1/0;for(let p=0;p<a.length;p+=1){const m=a[p];if(!m)continue;const g=b(m.top,0),h=b(m.bottom,g);if(h<=0||g>=i)continue;const _=(g+h)*.5,y=Number.isFinite(Number(m.left))&&Number.isFinite(Number(m.right))?(Number(m.left)+Number(m.right))*.5:null,v=y!=null&&s!=null?Math.hypot(y-s,_-o):Math.abs(_-o);v<d&&(d=v,f=p);const x=o>=g&&o<=h,N=s==null||!Number.isFinite(Number(m.left))||!Number.isFinite(Number(m.right))||s>=Number(m.left)&&s<=Number(m.right);if(x&&N){const O=Math.max(1,h-g);O<l&&(l=O,c=p)}}return c>=0?c:f}function gg({gesture:e="single",detail:t=1,movement:n=0,textSelecting:r=!1,excludedTarget:a=!1}={}){const i=e==="double"?2:1;return!a&&!r&&b(n,1/0)<=8&&b(t)===i}function hg({gesture:e="single",detail:t=1,pendingDomIndex:n=null,targetDomIndex:r=null}={}){const a=b(t,1);return e==="double"?a===1?{action:"provisional",pendingDomIndex:r}:a===2?{action:"confirm",clearPending:!0,matchedPending:n!=null&&Number(n)===Number(r)}:{action:"ignore"}:a===1?{action:"confirm",clearPending:!0}:{action:"ignore"}}function _g({enabled:e=!0,movement:t=0,hasSelection:n=!1,excludedTarget:r=!1}={}){return!!e&&!r&&!!n&&b(t,0)>8}function yg({delayMs:e=160,onSettle:t}={}){let n=null;const r=Math.max(0,b(e,160)),a=()=>{n=null,typeof t=="function"&&t()};return{bump(){n&&clearTimeout(n),n=setTimeout(a,r)},settleNow(){n&&clearTimeout(n),n=null,a()},cancel(){n&&clearTimeout(n),n=null},get pending(){return n!=null}}}function bg(e=""){let t=String(e||""),n="",r=0;return{observe(a){const i=String(a||"");return!i||i===t?(n="",r=0,!1):i!==n?(n=i,r=1,!1):(r+=1,r<2?!1:(t=n,n="",r=0,!0))},current(){return t},reset(a=""){t=String(a||""),n="",r=0}}}function wg(e,t=300){let n={},r=null,a=null;const i=async()=>a||(a=(async()=>{for(;Object.keys(n).length;){const o=n;n={},await e(o)}})().finally(()=>{a=null}),a);return{enqueue(o){n=pl(n,o),r&&clearTimeout(r),r=setTimeout(()=>{r=null,i().catch(()=>{})},Math.max(0,b(t,300)))},async flush(){r&&(clearTimeout(r),r=null);do await i();while(Object.keys(n).length||a)},hasPending(){return!!r||!!a||Object.keys(n).length>0}}}function vg(e,t){const n=Array.isArray(e)?e.map(String):[],r=Array.isArray(t)?t.map(String):[];if(n.length!==r.length)return!0;for(let a=0;a<n.length;a+=1)if(n[a]!==r[a])return!0;return!1}function xg(e,t){const n=String(t||"");if(!n||!Array.isArray(e)||!e.length)return null;const r=e.findIndex(i=>String(i?.card?.id||"")===n);if(r<0)return null;const a=e[r];return a?.thumb?(e.splice(r,1),a):null}function kg(e,t){return String(e||"")!==String(t||"")}function Sg(e,t,n){if(!e)return!1;const r=String(t||""),a=String(n||"");return!!r&&!!a&&r===a}function Ag(e){if(!e.alwaysOn||e.userCollapsed||e.editorOpen)return 0;const t=b(e.settingsPct,0);return t>0?t:0}function Mg(e,t,n){const r=Math.max(0,b(e,0)),a=Math.max(0,b(t,0)),i=Math.max(0,b(n,0));return{pct:r,w:Math.max(0,Math.round(a*r/100)),h:Math.max(0,Math.round(i*r/100))}}function Ng(e,t,n=0,r=0){const a=Math.max(0,b(e,0)),i=Math.max(0,b(t,0));if(a<=0||i<=0)return{w:0,h:0};const o=Math.max(0,b(n,0)),s=Math.max(0,b(r,0));if(o<=0||s<=0)return{w:a,h:i};const c=Math.min(a/o,i/s);return{w:Math.max(1,Math.round(o*c)),h:Math.max(1,Math.round(s*c))}}function Ig(e,t=""){const n=typeof e=="string"?e:"";return n?`<img src="${n}" style="width:100%;height:100%;object-fit:contain;display:block;background:transparent" />`:'<div style="width:100%;height:100%;background:transparent"></div>'}function Eg(e,t,n,r){const a=typeof t=="string"?t:"";return a?String(e||"")!==a||String(n||"")!==String(r||""):!1}function Cg(e,t,n,r=16){const a=Math.max(1,Math.round(b(t?.w,1))),i=Math.max(1,Math.round(b(t?.h,1))),o=Math.max(a,Math.round(b(n?.width,a))),s=Math.max(i,Math.round(b(n?.height,i))),c=Math.max(0,Math.round(b(r,16))),l=String(e||"bottom-right");return{left:l.includes("left")?c:Math.max(c,o-a-c),top:l.includes("top")?c:Math.max(c,s-i-c),w:a,h:i}}function Sl(e,t,n=16){const r=Math.max(1,Math.round(b(t?.w,1))),a=Math.max(1,Math.round(b(t?.h,1))),i=Math.max(0,Math.round(b(n,16))),o=String(e||"bottom-right");return{w:r,h:a,top:o.includes("top")?i:null,bottom:o.includes("bottom")?i:null,left:o.includes("left")?i:null,right:o.includes("right")?i:null}}function $g(e,t=28,n=6){const r=Math.round(b(e?.left,0)),a=Math.round(b(e?.top,0)),i=Math.max(1,Math.round(b(e?.w,1))),o=Math.max(1,Math.round(b(t,28))),s=Math.max(0,Math.round(b(n,6)));return{left:Math.round(r+(i-o)/2),top:a-s}}function Tg(e,t,n=28,r=6,a=16){const i=Sl(e,t,a),o=Math.max(1,Math.round(b(n,28))),s=Math.max(0,Math.round(b(r,6))),c=i.left!=null?i.left:i.right,l=Math.round(b(c,0)+(i.w-o)/2);return{size:o,top:i.top!=null?Math.round(i.top-s):null,bottom:i.bottom!=null?Math.round(i.bottom+i.h+s):null,left:i.left!=null?l:null,right:i.right!=null?l:null}}var ne=Object.freeze({width:64,height:88,gap:8,splitWidth:16,splitExtraMargin:4});function zr(e,t){const n=Math.max(0,Math.floor(b(t,0))),r=Math.max(0,Math.min(Math.floor(b(e,0)),n));return r>0&&r<n?r:0}function jg(e,t,n){const r=Math.max(0,Math.floor(b(n,0))),a=Math.floor(b(e,-1));if(a<0||r<=0)return-1;const i=zr(t,r);if(i<=0)return a<r?a:-1;if(a===i)return-1;const o=a>i?a-1:a;return o>=0&&o<r?o:-1}function Og(e,{count:t=0,selectedCount:n=0,thumbWidth:r=ne.width,gap:a=ne.gap,splitWidth:i=ne.splitWidth,splitExtraMargin:o=ne.splitExtraMargin}={}){const s=Math.max(0,Math.floor(b(t,0)));if(s<=0)return-1;const c=b(e,NaN);if(!Number.isFinite(c)||c<0)return-1;const l=Math.max(1,b(r,ne.width)),f=Math.max(0,b(a,ne.gap)),d=Math.max(0,b(i,ne.splitWidth)),p=Math.max(0,b(o,ne.splitExtraMargin)),m=zr(n,s),g=[];for(let _=0;_<s;_+=1)m>0&&_===m&&g.push({type:"split"}),g.push({type:"thumb",galIdx:_,marginLeft:m>0&&_===m?p:0});let h=0;for(let _=0;_<g.length;_+=1){_>0&&(h+=f);const y=g[_];if(y.type==="split"){if(c>=h&&c<h+d)return-1;h+=d;continue}if(h+=y.marginLeft,c>=h&&c<h+l)return y.galIdx;h+=l}return-1}function Pg({count:e=0,selectedCount:t=0,thumbWidth:n=ne.width,gap:r=ne.gap,splitWidth:a=ne.splitWidth,splitExtraMargin:i=ne.splitExtraMargin}={}){const o=Math.max(0,Math.floor(b(e,0)));if(o<=0)return 0;const s=Math.max(1,b(n,ne.width)),c=Math.max(0,b(r,ne.gap)),l=Math.max(0,b(a,ne.splitWidth)),f=Math.max(0,b(i,ne.splitExtraMargin)),d=zr(t,o),p=o+(d>0?1:0);let m=o*s+Math.max(0,p-1)*c;return d>0&&(m+=l+f),m}function Lg(e,t,n){const r=Math.max(0,b(t,0)-Math.max(0,b(n,0))),a=b(e,0);return Math.max(0,Math.min(r,a))}function Bg(e,t=0,n=1,r=8,a=0){const i=Array.isArray(e)?e:[];if(!i.length)return[];const o=Math.max(0,Math.min(b(t,0),i.length-1)),s=Math.max(1,Math.min(i.length,b(r,8)||8)),c=Math.min(s,1+2*Math.max(0,b(n,1))),l=Math.max(c,s);let f=Math.max(0,o-Math.floor((l-1)/2));const d=Math.min(i.length-1,f+l-1);f=Math.max(0,d-l+1);const p=[],m=new Set,g=_=>{const y=String(i[_]?.id||"");!y||m.has(y)||(m.add(y),p.push(y))},h=Math.max(0,Math.min(i.length,b(a,0)));for(let _=0;_<h;_+=1)g(_);for(let _=f;_<=d&&(g(_),!(p.length>=s));_+=1);return p}function Rg(e,t,n=2,r=[]){const a=Array.isArray(e)?e:[],i=Math.max(0,Math.min(8,b(n,2))),o=b(t?.messageIndex??t?.message_index,NaN),s=String(t?.sessionId||t?.session_id||""),c=String(t?.chatId||t?.chat_id||""),l=String(t?.hash||""),f=new Set,d=[],p=m=>{const g=String(m||"");!g||f.has(g)||(f.add(g),d.push(g))};for(const m of r||[])p(m);for(const m of a){if(!m?.id||s&&m.session_id&&String(m.session_id)!==s||c&&m.chat_id&&String(m.chat_id)!==c)continue;const g=b(m.message_index,NaN);if(Number.isFinite(o)&&Number.isFinite(g)){Math.abs(g-o)<=i&&p(m.id);continue}l&&String(m.content_hash||"")===l&&p(m.id)}return d}function Dg(e,t,n=2){const r=b(e,NaN),a=b(t,NaN);if(!Number.isFinite(r)||!Number.isFinite(a))return!1;const i=Math.max(0,b(n,2));return Math.abs(r-a)<=i}function Fg(e,t,n=2){const r=Math.max(0,Math.floor(b(t,0))),a=Math.max(0,Math.min(Math.max(0,r-1),Math.floor(b(e,0)))),i=Math.max(0,Math.floor(b(n,2)));return r<=0?{lo:0,hi:-1,center:0}:{lo:Math.max(0,a-i),hi:Math.min(r-1,a+i),center:a}}var Al={chrome:1,content:2,full:3};function zg(e,t){const n=Al[String(e??"")]||0,r=Al[String(t??"")]||0;return!n&&!r?"full":r>=n?t||e||"full":e||t||"full"}function Ml(e){const t=String(e||"").trim();if(!t)return{appearance:"",attire:"",accessories:"",text:"",gender:""};let n=null;const r=t.match(/```(?:json)?\s*([\s\S]*?)```/i),a=(r?r[1]:t).trim().match(/\{[\s\S]*\}/);if(a)try{const o=JSON.parse(a[0]);n=o&&typeof o=="object"?o:null}catch{n=null}if(n&&typeof n=="object"){const o=String(n.appearance??n.look??n.identity??"").trim(),s=String(n.attire??n.clothing??n.outfit??"").trim(),c=String(n.accessories??n.accessory??n.props??"").trim(),l=String(n.gender??n.sex??"").trim().toLowerCase(),f=["girl","female","f","woman"].includes(l)?"girl":["boy","male","m","man"].includes(l)?"boy":l==="other"?"other":"";return{appearance:o,attire:s,accessories:c,text:[o,s,c].filter(Boolean).join(", "),gender:f}}const i=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,"").trim();return{appearance:i,attire:"",accessories:"",text:i,gender:""}}function Ug(e={}){const t=!!e.warmBusy,n=Math.max(0,Math.min(100,Math.round(b(e.warmPct,0)))),r=String(e.jobState||""),a=Math.max(0,Math.min(100,Math.round(b(e.jobPct,0))));return t?{pct:Math.max(t?6:0,n),busy:!0,label:"인덱싱"}:r==="tagging"?{pct:Math.max(6,a),busy:!0,label:"인덱싱"}:{pct:0,busy:!1,label:"인덱싱"}}function Jg(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=Math.max(t?6:0,Math.min(100,Math.round(b(e.jobPct,0)))),a=Math.max(n?6:0,Math.min(100,Math.round(b(e.indexPct,0)))),i=e.error?"#f87171":"#7c6cff",o="#2dd4bf",s=(c,l)=>`<span style="display:block;height:4px;border-radius:2px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${c}%;background:${l}"></span></span>`;return`<span style="flex:0 0 120px;display:flex;flex-direction:column;gap:3px;justify-content:center">${s(r,i)}${s(a,o)}</span>`}function Nl(e={}){const t=!!e.busy,n=Math.max(t?6:0,Math.min(100,Math.round(b(e.pct,0)))),r=String(e.tone||"");return`<span style="flex:0 0 120px;display:block;height:6px;border-radius:3px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${n}%;background:${e.error?"#f87171":r==="index"?"#2dd4bf":"#7c6cff"}"></span></span>`}function Hg(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=!!e.busy||t||n;if(!r&&!e.error)return"";const a=typeof e.escapeHtml=="function"?e.escapeHtml:f=>String(f).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),i=String(e.tone||(!t&&n?"index":"job")),o=a(String(e.stage||(i==="index"?"인덱싱":"작업 중")).slice(0,80)),s=a(String(e.meta||"").slice(0,160));let c=e.pct;c==null&&(t?c=e.jobPct:n?c=e.indexPct:c=Math.max(b(e.jobPct,0),b(e.indexPct,0)));const l=Nl({pct:c,busy:r||!!e.error,error:e.error,tone:i});return`<div data-inlay-progress-toast="1" style="display:flex;align-items:center;gap:10px;min-width:220px;max-width:min(420px,92vw);padding:10px 14px;border-radius:8px;background:#121820;border:1px solid #2a3344;cursor:pointer;user-select:none"><span style="flex:0 0 auto;font-weight:700;color:${e.error?"#f87171":i==="index"?"#5eead4":"#c4b5fd"};font-size:11px;white-space:nowrap">${o}</span><span style="min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8b97ab;font-size:11px">${s}</span>${l}</div>`}function Ur(e){return Math.max(0,Math.min(100,b(e,0)))}function yi(e,t){const n=Math.max(1,b(t,1));return Math.max(0,Math.min(b(e,0),n-1))/n*100}function Kg(e,t=0,n=1,r=null){if(r&&r.forceEven)return yi(t,n);const a=e?.y_percent??e?.anchor_percent??e?.read_percent,i=Number(a);return Number.isFinite(i)?Ur(i):yi(t,n)}function Il(e,t,n=.5){if(!e)return null;const r=Math.max(1,b(e.height,0)),a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return a<b(e.top,0)||a>b(e.bottom,0)?null:Ur((a-b(e.top,0))/r*100)}function Gg(e,t,n=.5){const r=Il(e,t,n);if(r!=null)return r;const a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return b(e?.bottom,0)<a?100:0}function Wg(e,t){const n=Array.isArray(e)?e:[];if(!n.length)return-1;const r=Ur(t),a=n.map(c=>Ur(c)),i=a.reduce((c,l,f)=>l<=20?c.concat(f):c,[]),o=i.length===1&&a[i[0]]>0?a.map((c,l)=>l===i[0]?1:c):a;if(o[0]>0&&r<o[0])return-1;let s=0;for(let c=0;c<o.length;c+=1)r>=o[c]&&(s=c);return s}var qg="data-inlay-inline-shot",El=/^<\/(?:p|div|li|blockquote|h[1-6]|tr)>$/i,Cl=/^<br\s*\/?>$/i;function $l(e){const t=String(e||"");return t?t.replace(/<div[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/div>/gi,"").replace(/<(?:span|p)[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/(?:span|p)>/gi,""):""}function Jr(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function Tl(e,t){const n=Math.floor(Number(e)),r=Math.max(0,Math.floor(Number(t)||0));return!r||!Number.isFinite(n)||n<1?null:Math.max(1,Math.min(r,n))}function jl(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Vg(e){const t=e.toLowerCase();if(t==="&nbsp;")return" ";if(t==="&amp;")return"&";if(t==="&lt;")return"<";if(t==="&gt;")return">";if(t==="&quot;")return'"';if(t==="&#39;"||t==="&apos;")return"'";const n=/^&#(\d+);$/.exec(e);if(n){const a=Number(n[1]);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}const r=/^&#x([0-9a-f]+);$/i.exec(e);if(r){const a=Number.parseInt(r[1],16);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}return null}function Yg(e,t){let n=Math.max(0,Math.min(e.length,Math.floor(t)));for(;n>0;){let r=n;for(;r>0&&/[ \t\r\n]/.test(e[r-1]);)r-=1;if(r<=0||e[r-1]!==">")break;const a=e.lastIndexOf("<",r-1);if(a<0||a>=r-1)break;const i=e.slice(a,r);if(Cl.test(i)||El.test(i)||/^<\//.test(i)||!/^<[a-zA-Z][^>]*>$/.test(i))break;n=a}return n}function Ol(e){const t=[];let n=0;const r=String(e||"");for(;n<r.length;){if(r[n]==="<"){const s=r.indexOf(">",n);if(s<0)break;const c=r.slice(n,s+1);(Cl.test(c)||El.test(c))&&t.push({ch:`
`,htmlIndex:n}),n=s+1;continue}if(r[n]==="&"){const s=r.indexOf(";",n);if(s>n&&s-n<16){const c=Vg(r.slice(n,s+1));if(c!=null){for(let l=0;l<c.length;l+=1)t.push({ch:c[l],htmlIndex:n});n=s+1;continue}}}t.push({ch:r[n],htmlIndex:n}),n+=1}const a=[];for(let s=0;s<t.length;s+=1){const c=t[s];if(c.ch!==`
...
`||o[o.length-1].ch===" ");)o.pop();return o}function Xg(e){return Ol(String(e||"")).map(t=>t.ch).join("")}function Pl(e,t){const n=String(e??"").replace(/\r\n/g,`
`),r=Math.floor(Number(t));if(!Number.isFinite(r)||r<1)return null;let a=0,i=0;for(;i<=n.length;){const o=n.indexOf(`
`,i),s=o<0?n.length:o,c=n.slice(i,s);if(c.trim()&&(a+=1,a===r)){const l=/^\s*/.exec(c)?.[0].length||0;return i+l}if(o<0)break;i=o+1}return null}function Hr(e){return String(e??"").replace(/\s+/g," ").trim()}function Ll(e,t){const n=Array.isArray(e)?e:[],r=Math.floor(Number(t))-1;if(!Number.isFinite(r)||r<0||r>=n.length)return null;const a=Hr(n[r]);if(!a)return null;let i=0;for(let o=0;o<=r;o+=1)Hr(n[o])===a&&(i+=1);return{text:a,occurrence:i}}function Bl(e){const t=[],n=Array.isArray(e)?e:[];for(let r=0;r<n.length;r+=1)for(const a of Jr(n[r])){const i=Hr(a);i&&t.push({text:i,elementIndex:r})}return t}function Rl(e,t,n){const r=Ll(t,n);if(!r)return-1;const a=Bl(e);let i=0;for(const o of a)if(o.text===r.text&&(i+=1,i===r.occurrence))return o.elementIndex;return-1}function Dl(e,t,n=["P"]){const r=(Array.isArray(e)?e:[]).map(o=>String(o||"").toUpperCase()),a=Math.floor(Number(t));if(!Number.isFinite(a)||a<0||a>=r.length)return-1;const i=new Set((Array.isArray(n)&&n.length?n:["P"]).map(o=>String(o||"").toUpperCase()));if((r[a]||"")!=="DIV")return a;for(let o=1;o<r.length;o+=1){const s=a-o,c=a+o;if(s>=0&&i.has(r[s]))return s;if(c<r.length&&i.has(r[c]))return c}return-1}function Zg(e,t,n,r,a=["P"]){const i=Array.isArray(n)?n:[],o=Math.floor(Number(r));if(!Number.isFinite(o)||o<1||!i.length)return null;const s=i.length;for(let c=Math.max(1,o);c<=s;c+=1){const l=Dl(t,Rl(e,i,c),a);if(l>=0)return{elementIndex:l,usedLine:c}}return null}function Fl(e,t){const n=Number.isFinite(Number(e.shotIndex))?String(Math.floor(Number(e.shotIndex))):"",r=jl(String(e.cardId||n||e.line||"0"));return`<div ${qg}="${r}" x-inlay-inline-shot="${r}" contenteditable="false" style="display:block;margin:10px 0;text-align:center;line-height:0"><br><img src="${jl(e.src)}" alt="" style="zoom:0.5;width:auto;height:auto;max-width:none;border-radius:8px;display:inline-block;vertical-align:top"><br></div>`}function zl(e,t,n){const r=$l(e),a=Array.isArray(t)?t:[];if(!r||!a.length)return r;const i=Ol(r),o=i.map(g=>g.ch).join(""),s=Jr(o).length;if(!s||!i.length)return r;const c=new Map,l=new Set;for(const g of a){const h=Tl(g?.line,s),_=String(g?.src||""),y=String(g?.cardId||"");!h||!/^data:image\//i.test(_)||y&&l.has(y)||c.has(h)||(y&&l.add(y),c.set(h,{...g,line:h,src:_}))}if(!c.size)return r;const f=n?.maxWidthPx,d=new Map;for(const[g,h]of c){const _=Pl(o,g);if(_==null||_<0||_>=i.length)continue;const y=Yg(r,i[_].htmlIndex);d.has(y)||d.set(y,Fl(h,f))}if(!d.size)return r;const p=[...d.entries()].map(([g,h])=>({htmlIndex:g,html:h})).sort((g,h)=>h.htmlIndex-g.htmlIndex);let m=r;for(const g of p)m=m.slice(0,g.htmlIndex)+g.html+m.slice(g.htmlIndex);return m}function Qg(e,t,n){const r=Jr(e);return r.length?zl(r.map(a=>String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")).join("<br>"),t,n):""}ee(),q(),pt(),Q(),vt(),D(),Ba(),ti(),Nr(),Za(),_e(),ut();function bi(){const e=ge(),t=e.events;return{last_stage:e.last_stage,events:Array.isArray(t)?t.slice(-20):[]}}async function eh(e){if(e){const t=C(),n={...e};u(n.api_key)&&(t.llm.api_key=u(n.api_key)),delete n.api_key,delete n.api_key_configured,u(n.service_account_json)&&(t.llm.service_account_json=u(n.service_account_json)),delete n.service_account_json,delete n.service_account_configured,Object.keys(n).length&&(t.llm=tt(t.llm,n)),await Je()}try{const t=C().llm,n=Ir(t.source),r=Pt(t.provider);return n==="custom"&&!Nc(t)?{ok:!1,message:r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM Model/API key가 비어 있습니다. NovelAI 키가 아니라 태깅용 LLM 키를 넣으세요."}:(n==="main"||n==="aux")&&!zt("runLLMModel")?{ok:!1,message:"RisuAI runLLMModel API를 사용할 수 없습니다."}:{ok:!0,message:`LLM ok (${n}): ${(await on(t,[{role:"user",content:"Reply with exactly: ok"}])).slice(0,120)}`}}catch(t){return{ok:!1,message:String(t?.message||t)}}}async function th(){const e=C().nai;if(zn(e)==="comfy")try{if(!Pa(e))return{ok:!1,message:"ComfyUI 워크플로 JSON이 없습니다.",debug:ge()};const t=Hs({main:"test",neg:"test",captions:[{name:"",prompt:"char1"},{name:"",prompt:"char2"}],nai:e,seed:1}),n=Ks(e.comfy_workflow_json,t),r=Js(e),{status:a,data:i}=await La(`${r}/system_stats`,{method:"GET"});if(a>=400)return{ok:!1,message:`ComfyUI 연결 실패 (HTTP ${a}) · ${r}`,debug:ge()};const o=i?.devices?.[0]?.name||i?.system?.os||"ok";return{ok:!0,message:`ComfyUI ok · ${r} · nodes=${Object.keys(n).length} · ${o}`,debug:bi()}}catch(t){return w("comfy.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ge()}}if(!u(e.api_key))return{ok:!1,message:"NAI api_key missing",debug:ge()};try{const t=u(e.api_key);try{const n=ue("nai.test.anlas"),r=await kd(t);return n.end({message:"anlas ok"}),{ok:!0,message:`NAI token ok · Anlas=${JSON.stringify(r)}`,debug:bi()}}catch(n){const r=Ue(e.model||"nai-diffusion-4-5-full");return w("nai.test.anlas",{message:String(n?.message||n)},"warn"),{ok:!0,message:`NAI config present · model=${r} · anlas_skip=${n?.message||n}`,debug:bi()}}}catch(t){return w("nai.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ge()}}}async function nh(){const e=C().nai,t=u(e.api_key);if(!t)return{ok:!1,message:"NAI api_key missing",debug:ge()};const n=String(ge().job_ctx??"");xn("probe-nai");const r=ue("nai.probe");try{w("nai.probe.start",{message:"tiny generate"});const a={prompt:"1girl, solo, simple background, best quality",negative_prompt:"lowres, bad quality",width:512,height:768,steps:10,cfg_scale:5,cfg_rescale:0,sampler:"k_euler_ancestral",scheduler:"karras",model:Ue(e.model||"nai-diffusion-4-5-full"),var_plus:!1,characters:[],seed:Math.floor(Math.random()*4294967295)||1},i=u(e.request_url)||"https://image.novelai.net/ai/generate-image",o=await Ws(t,a,i,{timeoutMs:9e4}),s=o.raw_bytes.byteLength,c=yt(Z(o.raw_bytes));return r.end({bytes:s,is_png:c,seed:o.seed}),{ok:!0,message:`probe ok · png=${c} · ${s}B · seed=${o.seed}`,bytes:s,is_png:c,seed:o.seed,debug:ge()}}catch(a){return r.fail(a),{ok:!1,message:String(a?.message||a),debug:ge()}}finally{xn(n)}}async function rh(e,t){if(!e?.byteLength)throw new Error("image is empty");const n=await Ju(e),r=n.bytes,a=n.mime||"image/png",i=n.filename||"image.png",o=`data:${a};base64,${await Ze(r)}`,s=sr(await se("autotag"))||["Tag ONE character reference image into Danbooru-style English prompts.",'Return ONE JSON object only: {"gender":"girl|boy","appearance":"...","attire":"...","accessories":"..."}.',"gender must be exactly girl or boy from visual evidence. appearance = identity/hair/eyes/body (no clothes). attire = clothing + permanent jewelry (earrings/glasses/watch/earbuds). accessories = weapons/bags/held props/ID only (not jewelry)."].join(`
`);w("autotag.start",{message:`llm-vision ${i} ${r.length}B`,bytes:r.length,focus:!0,source:Ir(C().llm.source)});const c=[{role:"system",content:s},{role:"user",content:[{type:"text",text:"Tag this character image. JSON only with gender, appearance, attire, accessories."},{type:"image_url",image_url:{url:o}}]}];let l="";try{l=await on(C().llm,c)}catch(v){throw w("autotag.llm.fail",{message:String(v?.message||v)},"error"),new Error(`오토태그 LLM 실패: ${String(v?.message||v).slice(0,240)}`)}const f=Ml(l),d=u(f.appearance||"",4e3),p=u(f.attire||"",4e3),m=u(f.accessories||"",4e3),g=u(f.gender||"",20),h=u(f.text||[d,p,m].filter(Boolean).join(", "),8e3);if(!d&&!p&&!m)throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");const _=h.split(",").map(v=>v.trim()).filter(Boolean);w("autotag.done",{message:`gender=${g||"-"} app=${d.length} attire=${p.length} acc=${m.length}`,focus:!0});const y={ok:!0,appearance:d,attire:p,accessories:m,tags:_,text:h,count:_.length,threshold:Number(t||.2),engine:"llm-vision"};return g&&(y.gender=g),y}D();function ah(e){const t=e.indexOf("?");if(t<0)return{pathname:e,query:{}};const n=e.slice(0,t),r=new URLSearchParams(e.slice(t+1)),a={};for(const[i,o]of r.entries()){const s=a[i];s===void 0?a[i]=o:Array.isArray(s)?s.push(o):a[i]=[s,o]}return{pathname:n,query:a}}function Qn(e,t,n=""){const r=e[t];return Array.isArray(r)?r[0]??n:r??n}function ih(e,t={}){const n=u(e.auth_token,4e3);if(!n)return!0;const r=String(t.Authorization||t.authorization||"");let a=r.toLowerCase().startsWith("bearer ")?r.slice(7):r;if(a=a||String(t["X-Inlay-Nexus-Token"]||t["x-inlay-nexus-token"]||""),typeof a!="string"||a.length!==n.length)return!1;let i=0;for(let o=0;o<n.length;o+=1)i|=a.charCodeAt(o)^n.charCodeAt(o);return i===0}q(),Q(),D(),ee(),Eo(),_e(),ut(),Vn();var j=(...e)=>t=>e.includes(t)?"":null,Ge=e=>t=>t.startsWith(e)?t.slice(e.length):null,wi=(e,t)=>n=>n.startsWith(e)&&n.endsWith(t)?n.slice(e.length,n.length-t.length):null,S=e=>({status:200,data:e}),vi=e=>({status:200,data:e,contentType:"image/png",raw:!0}),er=e=>{throw ht(404,{ok:!1,...ae(e,"not_found")},e)};function xi(e){let t=e.image_b64||e.data||"";return typeof t=="string"&&t.startsWith("data:")&&(t=t.split(",",2)[1]??""),String(t||"")}var oh=[{match:j("/v1/settings/export"),handler:()=>S({ok:!0,json:Fm()})},{match:j("/v1/settings"),handler:()=>S({ok:!0,settings:Tr()})},{match:j("/v1/curation/status"),handler:async()=>S({ok:!0,status:await qn()})},{match:j("/v1/curation/catalog"),handler:async()=>S({ok:!0,catalog:await ft()})},{match:j("/v1/prompts"),handler:async()=>S({ok:!0,prompts:await $r()})},{match:j("/v1/prompts/export"),handler:async()=>S({ok:!0,...await Lm()})},{match:Ge("/v1/prompts/"),handler:async({param:e})=>S({ok:!0,key:e,text:await se(e)})},{match:Ge("/v1/jobs/"),handler:async({param:e})=>S(await Hp(e))},{match:Ge("/v1/gallery/explore"),handler:async({query:e})=>S(await bp(Number(Qn(e,"limit","400"))))},{match:j("/v1/gallery/favorites"),handler:async()=>S(await tl())},{match:Ge("/v1/gallery"),handler:async({query:e})=>S(await wp(Qn(e,"session_id"),Number(Qn(e,"limit","40"))))},{match:j("/v1/nai/reference.png"),handler:async()=>vi(await Kc()??er("no reference"))},{match:j("/v1/nai/vibe.png"),handler:async()=>vi(await np()??er("no vibe"))},{match:j("/v1/nai/reference"),handler:async()=>{const e=await Zm();return S({ok:!0,configured:e,image_reference:C().nai?.image_reference||"none",preview_url:e?"/v1/nai/reference.png":""})}},{match:j("/v1/nai/vibe"),handler:async()=>{const e=await ep();return S({ok:!0,configured:e,vibe_transfer:C().nai?.vibe_transfer||"none",preview_url:e?"/v1/nai/vibe.png":""})}},{match:Ge("/v1/characters"),handler:async({query:e})=>S(await Dn(Qn(e,"session_id"),Qn(e,"character_id")))},{match:Ge("/v1/appearance/"),handler:async({param:e})=>S(await Dn(e))},{match:Ge("/v1/images/"),handler:async({param:e})=>{let t=e.replace(/^\/+|\/+$/g,"");if(t.endsWith(".json")){const n=await Lt(t.slice(0,-5));return Object.keys(n).length||er("location missing"),S(n)}return t.endsWith(".png")&&(t=t.slice(0,-4)),vi(await nl(t)??er("image missing"))}}],sh=[{match:j("/v1/settings/reset"),handler:async()=>S(await Um())},{match:j("/v1/settings/import"),handler:async({body:e})=>S(await zm(String(e.json||e.text||"")))},{match:j("/v1/settings","/v1/settings/update"),handler:async({body:e})=>S(await Hm(e))},{match:j("/v1/curation/catalog"),handler:async({body:e})=>{const t=e.catalog??e;return S(await jc(t))}},{match:j("/v1/curation/catalog/reset"),handler:async()=>S(await Oc())},{match:j("/v1/curation/embed"),handler:async()=>S(await Pc())},{match:j("/v1/curation/embed/test"),handler:async()=>S(await Lc())},{match:j("/v1/curation/settings"),handler:async({body:e})=>S(await Jc(e))},{match:j("/v1/prompts/import"),handler:async({body:e})=>S(await Bm(e?.json!=null?e.json:(e?.prompts!=null,e)))},{match:j("/v1/prompts/reset-defaults"),handler:async({body:e})=>S(await Rm({keep_author_note:e?.keep_author_note!==!1&&e?.keepAuthorNote!==!1}))},{match:wi("/v1/prompts/","/reset"),handler:async({param:e})=>S(await Cc(e,In(e)))},{match:Ge("/v1/prompts/"),handler:async({param:e,body:t})=>S(await Cc(e,String(t.text||"")))},{match:j("/v1/jobs/create","/v1/jobs"),handler:async({body:e})=>({status:202,data:await fl(e)})},{match:j("/v1/gallery/unlink","/v1/cards/unlink"),handler:async({body:e})=>S(await ci(String(e.session_id||""),String(e.content_hash||""),e.message_index))},{match:j("/v1/gallery/rebind-hash","/v1/cards/rebind-hash"),handler:async({body:e})=>S(await vp({session_id:String(e.session_id||e.sessionId||""),card_ids:e.card_ids||e.ids||[],to_hash:String(e.to_hash||e.content_hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||"")}))},{match:j("/v1/gallery/delete","/v1/cards/delete"),handler:async({body:e})=>{const t=u(e.folder_key||"",400),n=u(e.card_id||e.id||"",80),r=Array.isArray(e.card_ids)?e.card_ids:null;if(t)return S(await Mp(t));if(r?.length)return S(await xp(r));if(n)return S(await ui(n));const a="card_id or folder_key required";throw ht(400,{ok:!1,...ae(a,"bad_request")},a)}},{match:j("/v1/gallery/export"),handler:async({body:e})=>S(await Sp(e))},{match:j("/v1/gallery/import"),handler:async({body:e})=>S(await Ap(e))},{match:j("/v1/gallery/favorites"),handler:async({body:e})=>Array.isArray(e.ids)?S(await kp(e.ids)):S(await tl())},{match:wi("/v1/cards/","/tags"),handler:async({param:e,body:t})=>S(await Wp(e,t))},{match:wi("/v1/cards/","/reroll"),handler:async({param:e,body:t})=>S(await dl(e,String(t.mode||"nai"),t.overrides))},{match:j("/v1/messages/reroll","/v1/gallery/reroll-message"),handler:async({body:e})=>S(await qp({session_id:String(e.session_id||e.sessionId||""),content_hash:String(e.content_hash||e.contentHash||""),message_index:Number(e.message_index??e.messageIndex??-1)}))},{match:j("/v1/characters/global-toggles","/v1/characters/global_toggles"),handler:async({body:e})=>S(await Hf(String(e.character_id||""),e.disabled_globals||e.disabled||[]))},{match:j("/v1/characters/unify","/v1/characters/merge"),handler:async({body:e})=>S(await Ts(String(e.target_session_id||e.session_id||""),e.source_session_ids||e.session_ids||[],e.include_target!==!1))},{match:j("/v1/characters","/v1/characters/update"),handler:({body:e})=>ch(e)},{match:Ge("/v1/appearance/"),handler:async({param:e,body:t})=>t.characters!=null||t.global!=null?(t.characters!=null&&await Rn(e,t.characters||[],{prune:!0}),t.global!=null&&await Rn(Ve,t.global||[],{prune:!0}),S(await Dn(e))):S(await Xf(e,t.appearance||{}))},{match:j("/v1/models/test"),handler:async({body:e})=>S(await eh(e.llm&&typeof e.llm=="object"?e.llm:null))},{match:j("/v1/nai/test"),handler:async()=>S(await th())},{match:j("/v1/nai/probe","/v1/debug/probe-nai"),handler:async()=>S(await nh())},{match:j("/v1/debug/clear"),handler:()=>(qr(),S({ok:!0,cleared:!0}))},{match:j("/v1/nai/reference","/v1/nai/reference/upload"),handler:async({body:e})=>{if(e.clear)return S(await Gc());const t=xi(e);if(!u(t))throw new Error("image_b64 required");return S(await Qm(te(Re(t))))}},{match:j("/v1/nai/reference/clear"),handler:async()=>S(await Gc())},{match:j("/v1/nai/vibe","/v1/nai/vibe/upload"),handler:async({body:e})=>{const t=u(e.preset_id||e.presetId||"",120);if(e.clear)return S(t?await Vc(t):await Wc());if(t&&e.copy_from){const a=u(e.copy_from,120),i=a?await op(a,t):!1;return S({ok:!0,preset_id:t,configured:i,preview_url:i?na(t):""})}const n=xi(e);if(!u(n))throw new Error("image_b64 required");const r={model:e.model,information_extracted:e.information_extracted??e.vibe_transfer_information_extracted,strength:e.strength??e.vibe_transfer_strength};return S(t?await ip(t,te(Re(n)),r):await rp(te(Re(n)),r))}},{match:j("/v1/nai/vibe/clear"),handler:async({body:e})=>{const t=u(e?.preset_id||e?.presetId||"",120);return S(t?await Vc(t):await Wc())}},{match:j("/v1/autotag","/v1/autotag/evaluate"),handler:async({body:e})=>{const t=xi(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=Re(t);return S(await rh(te(n),Number(e.threshold??.2)))}}];async function ch(e){const t=u(e.session_id||"",200),n=u(e.character_id||"",200),r=(Array.isArray(e.root_session_ids)?e.root_session_ids:Array.isArray(e.cascade_session_ids)?e.cascade_session_ids:[]).map(i=>u(i,200)).filter(Boolean);if("characters"in e&&t&&await Rn(t,e.characters||[],{prune:!0,rootSessionIds:r}),"global"in e&&await Rn(Ve,e.global||[],{prune:!0}),"character"in e){const i=u(e.scope||t||"__global__",200);r.length&&i!=="__global__"?await $s(r,[e.character||{}],""):await st(i,e.character||{})}const a=Array.isArray(e.root_delete)?e.root_delete:Array.isArray(e.cascade_delete)?e.cascade_delete:[];return a.length&&r.length&&await Vf(r,a,""),r.length&&t&&await Ts(t,r,!1),S(await Dn(t,n))}async function Ul(e,t){for(const n of e){const r=n.match(t.pathname);if(r!==null)return n.handler({...t,param:r})}return er(t.pathname)}async function lh(e,t={}){const{pathname:n,query:r}=ah(e),a=String(t.method||"GET").toUpperCase();let i;if(typeof t.body=="string")try{i=JSON.parse(t.body)}catch{i={}}else i=t.body??{};if(["/v1/health","/healthz","/readyz"].includes(n))return S({ok:!0,health:Jm()});if(n==="/v1/debug"||n==="/v1/debug/log")return a==="DELETE"||a==="POST"&&i.clear?(qr(),S({ok:!0,cleared:!0})):S(ge());if(!ih(C(),t.headers||{})){const s="invalid token";throw ht(401,{ok:!1,...ae(s,"unauthorized")},s)}const o={method:a,pathname:n,query:r,body:i};if(a==="GET")return Ul(oh,o);if(["POST","PUT","PATCH"].includes(a))try{return await Ul(sh,o)}catch(s){if(Fi(s))throw s;const c=String(s?.message||s);throw ht(500,{ok:!1,...ae(c,"internal")},c)}throw ht(405,{ok:!1,...ae(a,"method_not_allowed")},a)}ee(),q(),pt(),_r(),Ec(),Te(),_e(),ut();var Kr=null;async function uh(){w("boot.ready.start",{message:qe}),await it();const e=await hr().catch(r=>{throw w("boot.storage",{message:String(r?.message||r)},"error"),r});w("boot.storage",{message:e.kind}),cr(await Om()),await Pm(),await Qf(),await ed();const t=await z("meta","reference_image");t?.png&&ea(Et(t.png));const n=await z("meta","vibe_transfer");n?.png&&ta(Et(n.png)),await cp(),w("boot.ready.done",{message:qe,has_nativeFetch:zt("nativeFetch"),has_idb:zt("getLocalPluginStorage")})}async function ki(){return Kr||(Kr=uh().catch(e=>{throw Kr=null,e})),await Kr,!0}async function fh(e,t={},n=12e4){await ki();try{const r=await lh(e,t);if(r.raw)return r.data;if(r.status>=400)throw ht(r.status,r.data);return r.data}catch(r){if(Fi(r))throw r;const a=String(r?.message||r);throw ht(500,{ok:!1,...ae(a,"internal")},a)}}async function dh(e){return await ki(),Zt(e)}function mh(){Li(()=>({cards:jn("cards"),images:jn("images"),jobs:jn("jobs"),blob_urls:sf()})),Reflect.set(globalThis,"__INLAY_NATIVE__",{VERSION:qe,ready:ki,fetch:fh,resolveImageUrl:je,refPreviewUrl:Co,vibePreviewUrl:$o,ensureImageUrl:dh,warmImages:mf,pinImageUrls:df,warmProgress:lf,onWarmProgress:uf,debug:ge,clearDebug:qr})}var ph=fn({applyExplorerClick:()=>_h,clearSelection:()=>bh,createSelectionState:()=>gh,moveFocus:()=>wh,reorderByIds:()=>kh,selectAll:()=>yh,sortExplorerItems:()=>vh,thumbMinWidth:()=>xh,visibleIds:()=>hh});function gh(e=[]){return{selected:new Set((e||[]).map(String).filter(Boolean)),anchorId:"",focusId:""}}function hh(e=[]){return(e||[]).map(t=>String(t?.id||"")).filter(Boolean)}function _h(e,t,{index:n,ids:r,shift:a=!1,ctrl:i=!1}={}){const o={selected:new Set(e?.selected||[]),anchorId:String(e?.anchorId||""),focusId:String(e?.focusId||"")},s=String(t||"");if(!s)return o;const c=Array.isArray(r)?r.map(String):[],l=typeof n=="number"&&Number.isFinite(n)?n:c.indexOf(s);if(a&&o.anchorId&&c.length){const f=c.indexOf(o.anchorId),d=l>=0?l:c.indexOf(s);if(f>=0&&d>=0){const p=Math.min(f,d),m=Math.max(f,d);return o.selected=new Set(c.slice(p,m+1)),o.focusId=s,o}}return i?(o.selected.has(s)?o.selected.delete(s):o.selected.add(s),o.anchorId=s,o.focusId=s,o):(o.selected=new Set([s]),o.anchorId=s,o.focusId=s,o)}function yh(e,t=[]){return{selected:new Set((t||[]).map(String).filter(Boolean)),anchorId:String(e?.anchorId||t?.[0]||""),focusId:String(e?.focusId||t?.[0]||"")}}function bh(e=null){return{selected:new Set,anchorId:String(e?.anchorId||""),focusId:""}}function wh(e=[],t="",n=1){const r=(e||[]).map(String).filter(Boolean);if(!r.length)return"";const a=r.indexOf(String(t||""));return a<0?r[0]:r[Math.max(0,Math.min(r.length-1,a+n))]}function vh(e=[],t="newest"){const n=[...e||[]],r=(a,i=0)=>{const o=Number(a);return Number.isFinite(o)?o:i};return t==="oldest"?n.sort((a,i)=>r(a.created_at)-r(i.created_at)||String(a.id).localeCompare(String(i.id))):t==="message"?n.sort((a,i)=>r(a.message_index,1e9)-r(i.message_index,1e9)||r(a.shot_index)-r(i.shot_index)||r(i.created_at)-r(a.created_at)):t==="shot"?n.sort((a,i)=>r(a.shot_index)-r(i.shot_index)||r(a.message_index,1e9)-r(i.message_index,1e9)||r(i.created_at)-r(a.created_at)):n.sort((a,i)=>r(i.created_at)-r(a.created_at)||String(i.id).localeCompare(String(a.id)))}function xh(e="m"){return e==="s"?96:e==="l"?200:148}function kh(e=[],t=[]){const n=i=>{const o=i&&typeof i=="object"?i.id:void 0;return String(o??i)},r=new Map((e||[]).map(i=>[n(i),i])),a=[];for(const i of t||[]){const o=String(i);r.has(o)&&(a.push(r.get(o)),r.delete(o))}for(const i of r.values())a.push(i);return a}Nr(),wc();function Sh(){Reflect.set(globalThis,"__INLAY_VIEWER_CORE__",{...Vp}),Reflect.set(globalThis,"__INLAY_LLM__",{...Am}),Reflect.set(globalThis,"__INLAY_EMBED__",{EMBEDDING_PROVIDERS:Ya,normalizeEmbeddingProvider:Ne,defaultEndpointForEmbedding:Ar,defaultModelForEmbedding:Kn,embeddingModelPlaceholder:_m,shouldAutoReplaceEmbeddingEndpoint:bm,shouldAutoReplaceEmbeddingModel:wm,embeddingProviderNeedsApiKey:vm}),Reflect.set(globalThis,"__INLAY_LORE_EXTRA__",{...Ep}),Reflect.set(globalThis,"__INLAY_EXPLORER__",{...ph})}ee(),q(),Sh(),mh(),w("boot.loaded",{message:qe})})();
