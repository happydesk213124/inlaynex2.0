...
//@display-name Inlay Nexus 2.1.12
//@api 3.0
//@version 2.1.12
...
globalThis.__INLAY_NATIVE_PROMPTS__ = {"__v":1,"__enc":""};

(function(){var Vs=Object.defineProperty,T=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(r){throw n=[r],r}},_n=(e,t)=>{let n={};for(var r in e)Vs(n,r,{get:e[r],enumerable:!0});return t||Vs(n,Symbol.toStringTag,{value:"Module"}),n},nt,Ys,yn,Xs,rt,ia,oa,Pe,bn,wn,vn,fr,dr,xn,kn,qt,Vt,Sn,Zs,Qs,ei,ti,Ru,ni,ri,ai,An,re=T((()=>{nt="2.1.12",Ys="2026-08-07-asset-lore-keys",yn=["author_note","tagger","format","prefill","preprocess","preset_1","lore_inject","char_inject","appearance_inject","asset_tags_inject","char_looks","autotag","curation_refine","curation_embed_hint"],Xs=["tagger","format","appearance_inject","lore_inject","asset_tags_inject","char_looks","autotag","curation_refine","curation_embed_hint"],rt="__global__",ia="inx_native_settings",oa=e=>`inx_nxstore_${e}`,Pe=e=>`inx_nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,bn="inx_nxref_image",wn="inx_nxvibe_image",vn="inx_nxvibe_data",fr="inx_nx_curation_catalog",dr="inx_nx_curation_embeddings",xn=e=>`inx_nxvibe_p_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,kn=e=>`inx_nxvibe_pd_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,qt=e=>`vibe_preset_${String(e)}`,Vt=e=>typeof e=="string"&&e.startsWith("vibe_preset_"),Sn=e=>e.slice(12),Zs="native_settings",Qs=e=>`nxstore_${e}`,ei=e=>`nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,ti="nxref_image",Ru="https://image.novelai.net/ai/generate-image",ni="https://image.novelai.net/ai/encode-vibe",ri="https://api.novelai.net/user/subscription",ai=["meta","cards","characters","jobs","images"],An=4e3}));function Ee(){const e=globalThis;return e.risuai??e.Risuai}function ve(e){return typeof Ee()?.[e]=="function"}var _t=T((()=>{}));function w(e,t={},n="info"){const r={t:Date.now(),iso:new Date().toISOString(),stage:String(e||""),level:n,job_id:Mn||t.job_id||"",ms:t.ms!=null?Number(t.ms):void 0,bytes:t.bytes!=null?Number(t.bytes):void 0,status:t.status!=null?t.status:void 0,message:t.message!=null?fa(t.message,240):void 0,detail:{}};for(const[s,i]of Object.entries(t))si.has(s)||(r.detail[s]=i==null||typeof i=="number"||typeof i=="boolean"?i:fa(i,220));for(Oe.push(r);Oe.length>240;)Oe.shift();In=r.stage,(t.focus||!t.background&&li(r.stage))&&(mr=r.stage),n==="error"&&(Nn={stage:r.stage,message:String(r.message??""),t:r.t});const a=`[InlayNX:${r.stage}]`+(r.message?` ${String(r.message)}`:"")+(r.ms!=null?` ${r.ms}ms`:"")+(r.bytes!=null?` ${r.bytes}B`:"");return n==="error"?console.error(a,r.detail):n==="warn"?console.warn(a,r.detail):console.log(a,r.detail),r}function _e(e){const t=Date.now();return{end:(n={},r="info")=>w(e,{...n,ms:Date.now()-t},r),fail:(n,r={})=>w(e,{...r,message:String(n?.message??n),ms:Date.now()-t},"error")}}function xe(){const e=Ee()??{};let t=null;try{t=typeof document<"u"?!!document.hidden:null}catch{}const n=Oe.slice(-80),r={};for(const a of n)r[a.stage]=(r[a.stage]??0)+1;return{ok:!0,version:nt,now:Date.now(),last_stage:In,focus_stage:mr,last_error:Nn,job_ctx:Mn||null,env:{has_nativeFetch:typeof e.nativeFetch=="function",has_getLocalPluginStorage:typeof e.getLocalPluginStorage=="function",has_pluginStorage:!!e.pluginStorage?.getItem,has_DecompressionStream:typeof DecompressionStream=="function",has_AbortController:typeof AbortController<"u",document_hidden:t},counts:{events:Oe.length,...la?.()??{}},by_stage:r,errors:Oe.filter(a=>a.level==="error").slice(-20),events:n}}function ca(){return Oe.length=0,Nn=null,In="cleared",!0}var si,Oe,Mn,Nn,In,mr,la,ii,En,oi,yt,Cn,pr,ci,ua,fa,li,Y=T((()=>{re(),_t(),si=new Set(["ms","bytes","status","message","job_id","background","focus"]),Oe=[],Mn="",Nn=null,In="boot",mr="boot",la=null,ii=e=>{la=e},En=e=>{Mn=e},oi=()=>Mn,yt=()=>mr,Cn=()=>In,pr=()=>Nn,ci=()=>Oe.length,ua=(e,t)=>Oe.filter(n=>n.job_id===e).slice(-t),fa=(e,t=280)=>{if(e==null||typeof e=="number"||typeof e=="boolean")return e;let n;if(typeof e=="string")n=e;else try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:`${n.slice(0,t)}…(+${n.length-t})`},li=e=>e.startsWith("job.")||e.startsWith("nai.")||e.startsWith("llm.")||e.startsWith("image.")}));Y();function bt(e,t,n){const r=t?.error?.message,a=new Error(n??r??`HTTP ${e}`);return a.status=e,a.data=t,a}var ui=e=>e instanceof Error&&typeof e.status=="number",se=(e,t="error")=>({error:{code:t,message:e}}),at,gr,wt=T((()=>{at=e=>new Promise(t=>setTimeout(t,e)),gr=class{tail=Promise.resolve();run(e){const t=this.tail.then(e,e);return this.tail=t.then(()=>{},()=>{}),t}}}));function ee(e){return e?e instanceof Uint8Array?e:new Uint8Array(e):new Uint8Array(0)}function Yt(e){const t=ee(e);let n="";for(let r=0;r<t.length;r+=Xt)n+=String.fromCharCode(...t.subarray(r,r+Xt));return btoa(n)}async function Ge(e){const t=ee(e);if(t.length<fi)return Yt(t);let n="";for(let r=0;r<t.length;r+=Xt)n+=String.fromCharCode(...t.subarray(r,r+Xt)),r>0&&r%(Xt*24)===0&&await at(0);return btoa(n)}function Fu(e){return e?Yt(e):""}async function Du(e){return e?Ge(e):""}function Le(e){const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function zu(e){return e?Le(e).buffer:null}function ne(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}function jn(e,t){const n=new Uint8Array(t);let r=0;for(const a of e)n.set(a,r),r+=a.length;return n}function vt(e){return!!(e&&e.length>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)}function Tn(e){return!!(e&&e.length>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70&&e[8]===87&&e[9]===69&&e[10]===66&&e[11]===80)}function $n(e){const t=ee(e);return Tn(t)?"image/webp":vt(t)?"image/png":t.length>=3&&t[0]===255&&t[1]===216&&t[2]===255?"image/jpeg":"image/png"}function Uu(e){const t=/^data:([^;,]+)?(;base64)?,(.*)$/i.exec(String(e||""));if(!t)return null;const n=!!t[2],r=t[3]||"";try{return ne(n?Le(r):new TextEncoder().encode(decodeURIComponent(r)))}catch{return null}}var Xt,fi,te=T((()=>{wt(),Xt=32768,fi=2e5}));function u(e,t=2e5){if(e==null)return"";let n=String(e).replace(/\x00/g," ").replace(/\r\n/g,`
`);return n=n.replace(/[ \t\f\v]+/g," ").replace(/\n{4,}/g,`


`).trim(),n.slice(0,t)}function O(e,t=-1){if(e==null||typeof e=="string"&&!e.trim())return t;const n=parseInt(String(e),10);return Number.isNaN(n)?t:n}function hr(e){if(e==null||typeof e=="string"&&!e.trim())return null;const t=parseFloat(String(e));return Number.isNaN(t)?null:t}function di(e){const t=u(e);if(!t)return[];const n=[],r=/-?\d+(?:\.\d+)?::(?:(?!::).)*?::|[^,]+/g;let a;for(;(a=r.exec(t))!==null;){const s=a[0].trim();s&&n.push(s)}return n}function N(...e){const t=[],n=new Set;for(const r of e)for(const a of di(r)){const s=a.trim();if(!s)continue;const i=s.toLowerCase();i==="null"||i==="none"||n.has(i)||(n.add(i),t.push(s))}return t.join(", ")}function Z(e){if(e==null)return[];let t;if(Array.isArray(e))t=e.map(a=>u(a,200));else{const a=u(e,2e3);t=a?a.split(/[,|/]|,(?=\s)|、|\//):[],t.length<=1&&a&&(t=a.split(/\n+/))}const n=[],r=new Set;for(const a of t){const s=u(a,200);if(!s)continue;const i=U(s);!i||r.has(i)||(r.add(i),n.push(s))}return n}function Hu(e){let t=0;for(let n=0;n<e.length;n+=1)t=Math.imul(31,t)+e.charCodeAt(n)|0;return t}function Ku(e){const t=u(e,1e6);let n=2166136261,r=2654435769;for(let a=0;a<t.length;a+=1){const s=t.charCodeAt(a);n^=s,n=Math.imul(n,16777619),r^=s+(n<<6|n>>>26),r=Math.imul(r,2246822507)}return`${(n>>>0).toString(16).padStart(8,"0")}${(r>>>0).toString(16).padStart(8,"0")}`}function Ju(e){const t=u(e??"",200);return t?`risu_${Ku(`${t}|__unified__`)}`:""}function Pn(e){let t=e;for(let n=0;n<20;n+=1){const r=t.replace(/\{\{#when[\s\S]*?\}\}([\s\S]*?)\{\{\/when\}\}/g,"$1").replace(/\{\{#if[\s\S]*?\}\}([\s\S]*?)\{\{\/if\}\}/g,"$1").replace(/\{\{:else\}\}[\s\S]*?(?=\{\{\/)/g,"");if(r===t)break;t=r}return t.replace(/\{\{[^}]+\}\}/g,"").trim()}function Gu(e){const t=e.match(/\[Positive\]\s*([\s\S]*?)\s*\[Negative\]/),n=e.match(/\[Negative\]\s*([\s\S]*?)\s*$/);return t||n?[u(t?.[1]??""),u(n?.[1]??"")]:[u(e),""]}function xt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}var U,kt,st,B=T((()=>{U=e=>u(e,200).toLowerCase().replace(/\s+/g," "),kt=e=>u(e).toLowerCase().replace(/\s+/g,""),st=4e3})),Wu,qu,Vu,mi,pi,gi,hi,_i,yi,bi,wi,vi,xi,Yu=T((()=>{Wu="",qu=0,Vu="",mi=[],pi="indexeddb:getLocalPluginStorage",gi="indexeddb:inx_nximg_*",hi="embedded",_i={backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",notes:"PNG/settings live on this device (not save-file). Folder explorer reads card+location metadata."},yi=JSON.parse(`{"power":true,"execute":"auto","mode":"illustration","image_min":3,"image_max":3,"character_max":2,"preset":1,"lorebook":true,"lore_extra":"tags","asset_nai_tags":"off","auto_aspect":false,"char_info":true,"user_info":true,"char_appearance":true,"preprocessing":false,"person_tag_mode":"gender","auto_person_tags":true,"person_tag_solo":false,"person_tag_weight":3,"original_text":"","custom_pos":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","custom_neg":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth","presets":[{"id":"프리셋_닭장_0_14izz","name":"프리셋 1","positive":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","negative":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth"},{"id":"프리셋_농후_1_u4veg","name":"프리셋 2","positive":"2.0::artist:duoyuanjun::, artist:dawalixi, artist:m (1n910), 1.45::artist:murata yuusuke::, 1.4::artist:konya karasue::, 1.5::artist:wanke::, 2.3::artist:lunch(shin new)::, 0.8::artist:baffu::, 1.4::artist:ishigaki takashi::, 0.8::artist:xipa::, 0.8::artist:freng::, 0.5::artist:kim eb::, year 2025, year 2024, 0.5::3d, blender::, high detail, masterpiece, best quality, very aesthetic, highres, best illustration, novel illustration, -3::simple illustration::, -1::censored::, -3::artist collaboration::, detailed background, -1::door::","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration"},{"id":"프리셋_매끈_2_jgrz3","name":"프리셋 3","positive":"2.4::artist:uki_(ukikusaya) ::, 0.6::artist:sohn woohyoung::, 0.6::artist:minamoto (mutton) ::, artist:sakura no tomoru hi e, 0.5::artist:bettkan::, 0.4::artist:nanja::, 0.4::artist:joy boy \\\\(jerrydurd\\\\) ::, artist:freng, 0.2::artist:murata yuusuke::, 0.8::artist:mx2j::, artist:aoi nagisa (metalder), 0.2::artist:oda non::, 0.4::artist:lunch_(shin new) ::, 0.6::artist:duoyuanjun::, year 2025, year 2024, year 2023, solo artist, -5.3::artist collaboration::, -1::faux retro artstyle::, -1::film grain::, -1::clean text::, -1::flat color::, 1.2::3d::, blender(medium), 1.3::realistic::, natural, incredibly absurdres, very aesthetic, highres, masterpiece, best quality, amazing quality, -3::simple illustration::, best illustration, novel illustration, 0.06::best::, -1::ring::, 1.5::uncensored::, -2::censored::, -2::bar censor::, 2::shiny realistic skin::, 1.3::steaming body::,","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, character sheet, reference sheet, lineup, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration,"},{"id":"프리셋_닭_3_8yiw2","name":"프리셋 2-1","positive":"1.5::artist:sohn woohyoung::, 1.6::artist:solipsist::, 1.45::artist:gogalking::, 1.2::artist:oda non::, 1.25::artist:henriiku_(ahemaru) ::, 1.6::artist:Ask (Askzy) ::, 2.7::artist:jagercoke::, 2::artist:seven (sixplusone) ::, artist:wlop, 1.25::artist:wanke::, artist:seoyong, 0.7::artist:healthyman::, artist:freng, 1.2::artist:sos adult::, artist:shinjiro, 2::artist:nianbingzi::, artist:teshima nari, year 2024, year 2025, 2::blender (medium) ::, 2::pastel (medium) ::, -2::flat color::, pastel colors, 1.4::masterpiece, very aesthetic::, best quality, amazing quality, absurdres, 2::realistic::, -6::artist collaboration::, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, no text, -1.1::pubic hair::, uncensored,","negative":"natsuki karin, text, logo, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, sketch"},{"id":"프리셋_말랑_4_ian7o","name":"프리셋 말랑","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_깔_5_3rh46","name":"프리셋 깔","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_쫀_6_815h6","name":"프리셋 쫀","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::, 1.4::bedroom::, 1.2::sunlight::, 2.9::hotel::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"},{"id":"프리셋_리얼_7_xwn4c","name":"프리셋 리얼","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"}],"active_preset_id":"프리셋_닭장_0_14izz","include_min":0,"include_max":0,"userchat":false,"gallery_fab":false,"floating_viewer":true,"overlay_markers":true,"inline_chat_images":false,"progress_toast":false,"llm_anchor_percent":true,"natural_base":"short","composition_curation":false,"inline_previews":true,"inline_thumb_pct":100,"scale_semantics_version":2,"mobile_toggle_pin":false,"hover_preview":true,"hover_preview_anchor":"mouse","hover_preview_corner":"top-right","viewer_minimize_mode":"icon","unified_chat_priority":false,"overlay_hide_offscreen":true,"scroll_message_track":true,"click_message_track":true,"message_select_gesture":"single","text_drag_select":true,"show_risu_settings_button":true,"debug_panel":false,"generate_all_roles":false,"auto_gen_on_reply":false,"scroll_delay_ms":250,"capture_delay_ms":10,"overlay_x_pct":38,"overlay_y_pct":80,"overlay_pin_unit":"pct","overlay_pin_origin":"bl"}`),bi={source:"custom",provider:"openrouter",endpoint:"https://openrouter.ai/api/v1/chat/completions",model:"openai/gpt-oss-20b:nitro",api_key:"",service_account_json:"",temperature:.4,max_tokens:8e3,timeout_seconds:180,reasoning_effort:"default",vertex_region:"us-central1",anthropic_version:"2023-06-01"},wi={provider:"Novel AI",backend:"nai",request_url:"https://image.novelai.net/ai/generate-image",api_key:"",model:"nai-diffusion-4-5-full",width:832,height:1216,sampler:"k_euler_ancestral",scheduler:"karras",steps:28,cfg_scale:7,cfg_rescale:.36,seed:0,variety_plus:!1,enable_i2i:!1,image_reference:"none",image_reference_strength:.6,image_reference_fidelity:1,image_reference_type:"character&style",vibe_transfer:"none",vibe_transfer_strength:.6,vibe_transfer_information_extracted:1,uc_preset:"human_focus",apply_quality_tags:!1,comfy_url:"http://localhost:8188",comfy_workflow_json:"",backend_timeout_seconds:300},vi={mode:"off",strict_ids:!1,embedding:{provider:"openai",model:"text-embedding-3-small",endpoint:"https://api.openai.com/v1/embeddings",api_key:""}},xi={bind_host:"",port:0,auth_token:"",allowed_origins:mi,database_path:pi,images_dir:gi,prompts_dir:hi,storage:_i,card:yi,llm:bi,nai:wi,curation:vi}})),ki,Si,Ai,Mi,Xu=T((()=>{ki="nai-diffusion-4-full",Si="nai-diffusion-4-curated-preview",Ai="nai-diffusion-3",Mi={"naid4.5f":"nai-diffusion-4-5-full","naid4.5c":"nai-diffusion-4-5-curated",naid4f:ki,naid4c:Si,naid3:Ai}})),Zu,Ni,Ii,Ei,Ci,ji,Ti,$i,Pi,Qu,Oi,Li,Bi,Ri,ef=T((()=>{Zu="",Ni="Tag the chat message into Danbooru-style English image prompts. Output ONE JSON object only.",Ii='{"scenes":[{"place":"...","shots":[{"paragraph":0,"y_percent":50,"line":7,"aspect":"portrait|square|landscape","camera":"...","situation":"...","characters":[{"name":"...","action":"..."}]}]}],"new_characters":[]}',Ei=`Registered: {registered_block}
Incomplete: {incomplete_block}
Detected: {detected_block}`,Ci=`NovelAI asset tags for new_characters:
{asset_tags_block}
SORT verbatim Danbooru tags into appearance/attire/accessories. Use lore_keys for name/aliases. Never paraphrase or invent outfit names.`,ji="Fill new_characters by COPYING asset/lore Danbooru tags. Use lore_keys for name/aliases (Korean preferred). No prose paraphrase. JSON only.",Ti="Use matched lorebook context:",$i="Character info:",Pi="Summarize visual details from the message.",Qu="",Oi=`[Positive]
, masterpiece, best quality

[Negative]
lowres, bad quality, watermark`,Li="Batch-refine ALL shots' scene tags from allowed curation option ids in ONE JSON response.",Bi="Write detailed Danbooru scene tags for camera/situation/place/action.",Ri={author_note:"",tagger:Ni,format:Ii,appearance_inject:Ei,asset_tags_inject:Ci,char_looks:ji,lore_inject:Ti,char_inject:$i,preprocess:Pi,prefill:"",preset_1:Oi,curation_refine:Li,curation_embed_hint:Bi}})),Fi,Di,zi,Ui,tf=T((()=>{Fi=", no text, best quality, very aesthetic, absurdres",Di=", rating:general, amazing quality, very aesthetic, absurdres",zi=", best quality, amazing quality, very aesthetic, absurdres",Ui={"naid4.5f":", location, very aesthetic, masterpiece, no text","naid4.5c":", location, masterpiece, no text, -0.8::feet::, rating:general",naid4f:Fi,naid4c:Di,naid3:zi}})),Hi,Ki,Ji,Gi,nf=T((()=>{Hi={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, multiple views, logo, too many watermarks",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing",none:""},Ki={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, logo, dated, signature, multiple views, gigantic breasts",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing, logo, dated, signature",none:""},Ji={heavy:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]",light:"lowres, jpeg artifacts, worst quality, watermark, blurry, very displeasing",human_focus:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract], bad anatomy, bad hands, @_@, mismatched pupils, heart-shaped pupils, glowing eyes",none:""},Gi={"naid4.5f":{heavy:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page",light:"lowres, artistic error, scan artifacts, worst quality, bad quality, jpeg artifacts, multiple views, very displeasing, too many watermarks, negative space, blank page",human_focus:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page, @_@, mismatched pupils, glowing eyes, bad anatomy",none:""},"naid4.5c":{heavy:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, negative space, blank page",light:"blurry, lowres, upscaled, artistic error, scan artifacts, jpeg artifacts, logo, too many watermarks, negative space, blank page",human_focus:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, bad anatomy, bad hands, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, @_@, mismatched pupils, glowing eyes, negative space, blank page",none:""},naid4f:Hi,naid4c:Ki,naid3:Ji}})),it,Wi,On,qi,Zt=T((()=>{Yu(),ef(),tf(),nf(),it=xi,Wi=Ri,On=Ui,qi=Gi}));function rf(e,t){const n=Xi().encode(t),r=new Uint8Array(e.length);for(let a=0;a<e.length;a+=1)r[a]=e[a]^n[a%n.length];return r}function af(e){if(typeof Buffer<"u")return new Uint8Array(Buffer.from(e,"base64"));const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function sf(e){if(!e||typeof e!="object")return{};const t=e;if(typeof t.__enc=="string"){if(Number(t.__v??1)!==Vi)return{};try{const r=Zi().decode(rf(af(t.__enc),Yi)),a=JSON.parse(r),s={};for(const[i,o]of Object.entries(a))typeof o=="string"&&(s[i]=o);return s}catch{return{}}}const n={};for(const[r,a]of Object.entries(t))typeof a=="string"&&(n[r]=a);return n}var Vi,Yi,Xi,Zi,of=T((()=>{Vi=1,Yi="inlay-nexus-prompt-pack-v1",Xi=()=>new TextEncoder,Zi=()=>new TextDecoder}));function cf(){return sf(globalThis.__INLAY_NATIVE_PROMPTS__)}function Ln(e){const t=u(cf()[e]);return t||Wi[e]||""}var Qi=T((()=>{B(),Zt(),of()}));function ke(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e))}function Be(e,t){const n=ke(e??{});for(const[r,a]of Object.entries(t??{})){const s=n[r];n[r]=da(a)&&da(s)?Be(s,a):a}return n}function _r(e){const t=u(e).replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,""),n=t.slice(0,180).replace(/\s+/g," ");try{return JSON.parse(t)}catch{const r=t.match(/\{[\s\S]*\}/);if(!r)throw new Error(`태거 JSON 파싱 실패${n?` · 응답: ${n}`:" · 응답이 비어 있거나 JSON이 아님"}`);try{return JSON.parse(r[0])}catch(a){throw new Error(`태거 JSON 파싱 실패 · ${String(a?.message??a).slice(0,120)} · 응답: ${n}`)}}}var da,St=T((()=>{B(),da=e=>!!e&&typeof e=="object"&&!Array.isArray(e)}));function E(){return ha}function yr(e){ha=e}function eo(){return _a}function ma(e){_a=e}function to(){return ya}function pa(e){ya=e}function ga(e){return vr.get(String(e||""))||""}function br(e,t){const n=String(e||"");n&&(t?vr.set(n,t):vr.delete(n))}var ha,no,Bn,Re,wr,_a,ya,vr,fe=T((()=>{Zt(),wt(),St(),ha=ke(it),no=new gr,Bn=new Map,Re=new Map,wr=new Set,_a="",ya="",vr=new Map})),ro,lf=T((()=>{ro=["shirt","blouse","pants","trousers","jeans","shorts","skirt","dress","jacket","coat","hoodie","sweater","cardigan","vest","waistcoat","uniform","armor","robe","cloak","cape","apron","overalls","leggings","stockings","tights","pantyhose","socks","thighhighs","boots","shoes","heels","sandals","slippers","footwear","barefoot","gloves","mittens","hat","cap","beret","hood","scarf","necktie","bowtie","tie","belt","bra","panties","underwear","lingerie","swimsuit","bikini","kimono","yukata","hakama","cheongsam","hanbok","suit","tuxedo","collar","choker","mask","helmet","nude","naked","topless","bottomless","completely nude","open shirt","unbuttoned","unzipped","torn clothes","clothes","clothing","outfit","attire","sleeves","rolled-up sleeves","long sleeves","short sleeves","sleeveless","off shoulder","bare shoulder","bare shoulders","midriff","navel","cleavage","garter","corset","bodysuit","leotard","fishnets","ribbon","bow","bandana","no shirt","no pants","shirt lift","panties pull","skirt lift"]})),ao,uf=T((()=>{ao=["necklace","earring","earrings","bracelet","ring","pendant","brooch","watch","wristwatch","wristband","glasses","sunglasses","goggles","monocle","crown","tiara","veil","hair ribbon","hairpin","hair pin","scrunchie","hair ornament","airpods","earbuds","earbud","earphones","earphone","headphones","headset","in one ear","wireless earbuds"]})),so,ff=T((()=>{so=["bag","backpack","purse","handbag","briefcase","suitcase","pouch","satchel","badge","id card","lanyard","name badge","nameplate","sword","katana","knife","dagger","gun","pistol","rifle","spear","axe","staff","wand","blade","weapon","shield","crossbow","scythe","hammer","umbrella","phone","smartphone","book","clipboard","folder","cigarette","microphone","camera","holding"]}));function Qt(e){const t=X(e).toLowerCase();return t?["girl","female","f","woman","여자","여"].includes(t)?"girl":["boy","male","m","man","남자","남"].includes(t)?"boy":["other","unknown","unset","미정","기타"].includes(t)?"other":"":""}function df(...e){const t=new Set(["girl","woman","female"]),n=new Set(["boy","man","male"]);let r=0,a=0;for(const s of e)for(const i of String(s??"").split(",")){let o=i.trim().toLowerCase();if(!o)continue;const c=o.match(/^\d+(?:\.\d+)?::(.+)::$/);c&&(o=c[1].trim().toLowerCase()),o=o.replace(/_/g," ").trim(),t.has(o)&&(r+=1),n.has(o)&&(a+=1)}return r>a?"girl":a>r?"boy":""}function ot(e){const t=Array.isArray(e)?e:String(e??"").split(/[,/\n]/),n=[],r=new Set;for(const a of t){const s=X(a),i=At(s);!s||r.has(i)||(r.add(i),n.push(s))}return n}function mf(e){const t=X(e).split(" ").filter(Boolean);return t.length!==2||!t.every(n=>/^[A-Za-z'-]+$/.test(n))||!t.every(n=>n===n.toUpperCase())?{surname:"",given_name:""}:{surname:t[0],given_name:t[1]}}function Fe(e={}){const t=X(e.name),n=mf(t);return{...e,id:X(e.id)||t,name:t,aliases:ot(e.aliases),surname:X(e.surname)||n.surname,given_name:X(e.given_name)||n.given_name,surname_variants:ot(e.surname_variants),given_name_variants:ot(e.given_name_variants),priority:Number.isFinite(Number(e.priority))?Number(e.priority):0,attire_locked:e.attire_locked!==!1,accessories_locked:e.accessories_locked!==!1,gender:Qt(e.gender??e.sex),schema_version:2}}function xr(e,t,n){const r=Fe(e);return new Set(ot([r[t],...r[n]||[]]).map(At).filter(Boolean))}function io(e,t){const n=Fe(e),r=Fe(t),a=xr(n,"surname","surname_variants"),s=xr(r,"surname","surname_variants"),i=xr(n,"given_name","given_name_variants"),o=xr(r,"given_name","given_name_variants");if(!a.size||!s.size||!i.size||!o.size)return!1;const c=[...a].some(f=>s.has(f)),l=[...i].some(f=>o.has(f));return c&&l}function oo(e,t){if(!e||!t)return!1;const n=Fe(e),r=Fe(t);if(n.id&&r.id&&String(n.id)===String(r.id)||io(n,r))return!0;const a=ba(n),s=ba(r);for(const i of a)if(s.has(i))return!0;return!1}function ba(e){const t=Fe(e),n=new Set,r=o=>{const c=At(o);c&&n.add(c)};r(t.name);const a=new Set(ot([t.surname,...t.surname_variants]).map(At));for(const o of t.aliases)a.has(At(o))||r(o);const s=ot([t.surname,...t.surname_variants]),i=ot([t.given_name,...t.given_name_variants]);for(const o of s)for(const c of i)r(`${o} ${c}`),r(`${o}${c}`),r(`${c} ${o}`);return n}function pf(e,t=[]){const n=At(e);if(!n)return null;const r=t.map(a=>Fe(a)).filter(a=>ba(a).has(n));return r.length!==1?null:r[0]}function gf(e,t){const n=Number(t.priority||0)-Number(e.priority||0);if(n)return n;const r=Number(e.created_at||e.updated_at||0)-Number(t.created_at||t.updated_at||0);return r||String(e.id).localeCompare(String(t.id))}function wa(...e){return ot(e.flat())}function hf(e){const t=[...e].sort(gf),n={...t[0]};n.aliases=wa(...t.map(r=>[r.name,...r.aliases||[]])),n.surname_variants=wa(...t.map(r=>[r.surname,...r.surname_variants||[]])),n.given_name_variants=wa(...t.map(r=>[r.given_name,...r.given_name_variants||[]])),n.surname||(n.surname=t.map(r=>r.surname).find(Boolean)||""),n.given_name||(n.given_name=t.map(r=>r.given_name).find(Boolean)||"");for(const r of t){const a=X(r.appearance||""),s=X(r.attire||""),i=X(r.accessories||""),o=X(r.original||"");a.length>X(n.appearance||"").length&&(n.appearance=a),!va(n.attire_locked)&&s.length>X(n.attire||"").length&&(n.attire=s),!va(n.accessories_locked)&&i.length>X(n.accessories||"").length&&(n.accessories=i),o&&!X(n.original||"")&&(n.original=o)}return n.surname=X(n.surname)||t.map(r=>X(r.surname)).find(Boolean)||"",n.given_name=X(n.given_name)||t.map(r=>X(r.given_name)).find(Boolean)||"",n}function _f(e=[]){const t=e.map(a=>Fe(a)),n=[],r=new Set;for(let a=0;a<t.length;a++){if(r.has(a))continue;const s=[t[a]];r.add(a);for(let i=a+1;i<t.length;i++)r.has(i)||s.some(o=>io(o,t[i]))&&(r.add(i),s.push(t[i]));n.push(s)}return{records:t,active:n.map(hf),groups:n}}var X,At,va,xa=T((()=>{X=e=>String(e??"").trim().replace(/\s+/g," "),At=e=>X(e).normalize("NFKC").toLocaleLowerCase().replace(/[\s_.·•･-]+/g,""),va=e=>e!==!1}));function Mt(e){const t=Fe(e||{}),n=Z([t.name,...t.aliases||[]]),r=Z([t.surname,...t.surname_variants||[]]),a=Z([t.given_name,...t.given_name_variants||[]]);for(const s of r)for(const i of a)n.push(`${s} ${i}`,`${s}${i}`,`${i} ${s}`);return Z(n).filter(s=>!r.some(i=>U(i)===U(s)))}function Se(e,t){return pf(e,t||[])}function ka(e,t,n=6){const r=Math.max(1,Math.min(6,Number(n)||6)),a=[],s=new Set,i=(o,c)=>{if(!o||!c)return o;for(const l of["action","expression","attire","accessories","appearance","label","age","body","sex","original","original_tag","negative"]){const f=u(o[l]||"",2e3),d=u(c[l]||"",2e3);d&&(f?f.toLowerCase().includes(d.toLowerCase())||(o[l]=N(f,d)):o[l]=d)}return o};for(const o of e||[]){if(!o||typeof o!="object")continue;const c=u(o.name,200);if(!c)continue;const l=Se(c,t),f=l?`id:${u(l.id||l.name,200)}`:`name:${U(c)}`;if(!f||f==="id:"||f==="name:")continue;const d=a.findIndex(p=>p._dedupeKey===f);if(d>=0){i(a[d],o);continue}a.length>=r||(s.add(f),a.push({...o,name:l?.name||c,_dedupeKey:f}))}return a.map(({_dedupeKey:o,...c})=>c)}function Rn(e){const t=new Set;for(const r of Mt(e)){const a=U(r);a&&t.add(a)}const n=U(e?.name);return n&&t.add(n),t}function Sa(e){return _f(e||[]).active}function co(e,t){const n=u(e).toLowerCase(),r=kt(e);if(!n)return[];const a=[],s=new Set;for(const i of t||[]){const o=u(i.id||i.name,200);if(!(!o||s.has(o)))for(const c of Mt(i)){const l=U(c),f=kt(c);if(!(f.length<2)&&(n.includes(l)||r.includes(f))){a.push(i),s.add(o);break}}}return a}function en(e,t=""){if(typeof e!="object"||e===null)return null;const n=e,r=u(n.name||t,200);if(!r)return null;let a=Z(n.aliases);a=[r,...a.filter(d=>U(d)!==U(r))];const s=u(n.original||n.original_tag||n.copyright||"",400);let i=u(n.appearance||"",4e3),o=u(n.attire||"",4e3),c=u(n.accessories||"",4e3);const l=u(n.tags||"",4e3);l&&!i&&!o&&!c&&(i=l),s&&i&&(i=N(...i.split(",").filter(d=>U(d)!==U(s))));let f=u(n.id,80)||r.replace(/[^a-zA-Z0-9_\uac00-\ud7a3]+/g,"_").replace(/^_|_$/g,"").slice(0,64);return f||(f=`char_${Math.abs(Hu(r))%1e7}`),Fe({...n,id:f,name:r,aliases:a,original:s,appearance:i,attire:o,accessories:c,gender:Qt(n.gender??n.sex)})}function yf(e,t,n={}){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[],s=typeof n.hasAppearance=="function"?n.hasAppearance:()=>!1,i=typeof n.resolve=="function"?n.resolve:()=>null,o=typeof n.aliasKeys=="function"?n.aliasKeys:()=>new Set,c=typeof n.normalizeName=="function"?n.normalizeName:p=>String(p||"").trim().toLowerCase(),l=typeof n.clean=="function"?n.clean:p=>String(p||"").trim(),f=[],d=new Set;for(const p of r){if(!l(p?.name,200)||s(p))continue;const m=i(p.name,a);if(m&&s(m))continue;for(const h of o(p))d.add(h);const g=c(p.name);g&&d.add(g)}for(const p of a)[...o(p)].some(m=>d.has(m))||f.push(p);for(const p of r){const m=i(p.name,f);if(!(m&&s(p))){if(m&&!s(p)){if(s(m))continue;const g=f.findIndex(h=>i(p.name,[h]));g>=0?f[g]=p:f.push(p);continue}m||f.push(p)}}return f}var Nt=T((()=>{B(),xa()}));function Aa(e){const t=u(e).toLowerCase();return t?Sr(t,go):!1}function lo(e){const t=u(e).toLowerCase();return!t||Aa(t)?!1:Sr(t,po)}function bf(e){return Aa(e)||lo(e)}function wf(e){const t=u(e).toLowerCase();return!t||bf(t)?!1:Sr(t,mo)}function vf(e){const t=[],n=[],r=[];for(const a of u(e).split(",")){const s=a.trim();s&&(Aa(s)?r.push(s):lo(s)||wf(s)?n.push(s):t.push(s))}return[N(...t),N(...n),N(...r)]}function xf(e){if(e===!0||e===1)return!0;const t=u(e,20).toLowerCase();return t==="true"||t==="on"||t==="1"}function kf(e){if(e==null||e===!1)return 0;if(e===!0)return 3;if(typeof e=="number"&&Number.isFinite(e)){const n=Math.floor(e);return n<=0?0:n===1?1:n===2?2:3}const t=u(e,40).toLowerCase().replace(/_/g," ").trim();return!t||t==="off"||t==="false"||t==="0"||t==="none"?0:t==="1"||t==="torn"||t==="torn clothes"?1:t==="2"||t==="nude"?2:t==="3"||t==="on"||t==="true"||t==="completely"||t==="completely nude"||t==="complete"?3:0}function Sf(e,t,n=null){const r=u(e,4e3);if(t<=0)return r;let a="";return t===1?a="2::torn clothes::":t===2?a="2.5::nude::":n==="m"?a="2.5::completely nude::":a="2::completely nude::",n==="f"?N(r,a,"nipples","pussy"):n==="m"?N(r,a,"penis"):N(r,a)}function Af(e){const[t,n]=vf(e);return[t,n]}function Mf(...e){const t=[];for(const n of e)if(n!=null)for(const r of u(n).split(",")){let a=r.trim().toLowerCase();if(!a)continue;const s=a.match(/^\d+(?:\.\d+)?::(.+)::$/);s&&(a=s[1].trim().toLowerCase()),a=a.replace(/_/g," ").trim(),a&&t.push(a)}return t}function Nf(...e){const t=Mf(...e);if(!t.length)return null;let n=0,r=0;for(const a of t)(_o.has(a)||/^\d+\+?girls?$/.test(a))&&(n+=1),(yo.has(a)||/^\d+\+?boys?$/.test(a))&&(r+=1);return n>r?"f":r>n?"m":null}function Fn(e,t){const n=Qt(e?.gender??t?.gender??t?.sex);return n==="girl"?"f":n==="boy"?"m":n==="other"?null:Nf(t?.appearance,t?.attire,t?.accessories,e?.appearance,e?.attire,e?.accessories,e?.label,e?.age,e?.body,e?.prompt,e?.sex)}function kr(e,t,n,r){return e<=0?"":e===1?t:e<=5?`${e}${n}`:r}function If(e,t){const n=[],r=kr(e,"1girl","girls","6+girls"),a=kr(t,"1boy","boys","6+boys");return r&&n.push(r),a&&n.push(a),n.join(", ")}function uo(e){const t=u(e);if(!t)return"";const n=[];for(const r of di(t)){const a=r.trim();a&&(Na.test(a)||bo.test(a)||wo.test(a)||n.push(a))}return N(...n)}function Ma(e){const t=[],n=new Set;for(const r of u(e).split(",")){let a=r.trim();if(!a)continue;if(Na.test(a)){const i=a.toLowerCase();if(i.includes("girl"))a="girl";else if(i.includes("boy"))a="boy";else continue}const s=a.toLowerCase();n.has(s)||(n.add(s),t.push(a))}return N(...t)}function Ef(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function Cf(e,t=3){const n=u(e,200);if(!n)return"";const r=Ef(t);return r<=0?n:`${r}::${n}::`}function fo(e,t=null){let n=e;if(n==null&&t!=null&&(n=t),n===!1)return"off";if(n===!0)return"gender";const r=u(n,40).toLowerCase();return["","auto","mixed","true","1","on"].includes(r)?"gender":["off","none","false","0","disable","disabled"].includes(r)?"off":["girl","all_girls","girls_only"].includes(r)?"girls":["person","persons"].includes(r)?"people":vo(r)?r:"gender"}function jf(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function Tf(e,t,n="gender",r=null,a=!1){const s=(e||[]).slice(0,6),i=s.length;if(i<=0)return"";if(jf(a)&&i===1)return"solo";const o=fo(n,r);if(o==="off")return"";if(o==="girls")return kr(i,"1girl","girls","6+girls");if(o==="people")return kr(i,"1person","people","6+people");let c=0,l=0,f=0;for(const d of s){const p=u(d.name,200),m=p?Se(p,t):null,g=Fn(d,m);g==="f"?c++:g==="m"?l++:Qt(d.gender??m?.gender)==="other"||f++}return c+=f,If(c,l)}function Dn(e){return N(e?.original||"",e?.appearance||"",e?.attire||"",e?.accessories||"")}function ue(e){if(typeof e!="object"||e===null)return!1;const t=e;let n=u(t.appearance||"",4e3);if(!n)return!1;const r=u(t.original||"",400);r&&(n=N(...n.split(",").filter(i=>U(i)!==U(r))));const[a]=Af(n);if(n=u(a||"",4e3),!n)return!1;const s=new Set(["girl","boy","man","woman","male","female","1girl","1boy","2girls","2boys","solo","other"]);return n.split(",").map(i=>i.trim().toLowerCase()).filter(Boolean).filter(i=>!s.has(i)&&!/^\d+(girl|boy)s?$/.test(i)).length>0}function de(e){return e!==!1}function $f(e,t){const n=ue(e),r=u(t?.original||t?.original_tag||"",400),a=u(e?.original||"",400),s=u(e?.attire||"",4e3),i=u(e?.accessories||"",4e3),o=u(t?.attire||"",4e3),c=u(t?.accessories||"",4e3),l=de(e?.attire_locked)?s:o||s,f=de(e?.accessories_locked)?i:c||i,d=kf(t?.nude),p=xf(t?.weapon),m=Sf(l,d,Fn(t,e)),g=p?f:"";return Ma(n?N(a||r,e?.appearance,m,g,t?.expression,t?.action,t?.sex):N(a?"":r,t?.label,t?.age,t?.appearance,t?.body,m,g,t?.expression,t?.action,t?.sex))}function ct(e){const t=typeof e=="object"&&e?e:{},n=O(t.character_max??t.char_max??6,6);return Math.max(1,Math.min(6,n))}var mo,po,go,ho,_o,yo,Na,bo,Ia,wo,vo,Sr,De=T((()=>{lf(),uf(),ff(),B(),xa(),Nt(),mo=ro,po=ao,go=so,ho=["off","girls","people","gender"],_o=new Set(["girl","woman","female"]),yo=new Set(["boy","man","male"]),Na=/^\d+\+?(?:girls?|boys?|people|person)$/i,bo=/^(?:1girl|1boy)$/i,Ia="(?:\\d+\\+?(?:girls?|boys?|people|person)|1girl|1boy|solo)",wo=new RegExp(`^-?\\d+(?:\\.\\d+)?::\\s*${Ia}(?:\\s*,\\s*${Ia})*\\s*::$`,"i"),vo=e=>ho.includes(e),Sr=(e,t)=>t.some(n=>{if(n.length<=3){const r=n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?:^|[^a-z0-9])${r}(?:[^a-z0-9]|$)`,"i").test(e)}return e.includes(n)})}));te(),Qi(),fe(),De(),B();function Pf(e,t,n,r){let a=u(e);if(!a)return"";for(const o of r){const c=u(o);if(c)if(a.endsWith(c))a=a.slice(0,a.length-c.length).replace(/[,\s]+$/g,"");else{const l=a.lastIndexOf(c);l>=0&&(a=`${a.slice(0,l)}${a.slice(l+c.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}}const s=u(t);if(s)if(a.startsWith(s))a=a.slice(s.length).replace(/^[,\s]+/g,"");else{const o=a.indexOf(s);o>=0&&(a=`${a.slice(0,o)}${a.slice(o+s.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}const i=[...n].map(o=>u(o)).filter(Boolean).sort((o,c)=>c.length-o.length);for(const o of i){const c=a.indexOf(o);c<0||(a=`${a.slice(0,c)}${a.slice(c+o.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}return u(a)}function Of(e){const t=u(e.setup),n=u(e.main);if(!n)return{lockedSetup:t,rebuildMain:!0};if(t&&t!==n)return{lockedSetup:t,rebuildMain:!0};const r=u(e.person);if(r||e.stylePositives&&e.stylePositives.length){const a=Pf(n,r,e.stylePositives||[],e.qualitySuffixes||[]);if(a&&a!==n)return{lockedSetup:a,rebuildMain:!0}}return{lockedSetup:"",rebuildMain:!1}}function Lf(e){if(!e||typeof e!="object")return[];const t=[],n=u(e.custom_pos);n&&t.push(n);const r=Array.isArray(e.presets)?e.presets:[];for(const a of r){if(!a||typeof a!="object")continue;const s=a,i=u(s.positive||s.pos);i&&t.push(i)}return t}async function xo(e,t,n){const r=new Blob([e],{type:t});let a=null;if(typeof createImageBitmap=="function"?a=await createImageBitmap(r):n&&typeof document<"u"&&(a=await new Promise((o,c)=>{const l=new Image,f=URL.createObjectURL(r);l.onload=()=>{URL.revokeObjectURL(f),o(l)},l.onerror=()=>{URL.revokeObjectURL(f),c(new Error("image decode failed"))},l.src=f})),!a)return null;const s=a,i="naturalWidth"in s?{w:s.naturalWidth,h:s.naturalHeight}:{w:0,h:0};return{source:s,width:s.width||i.w||0,height:s.height||i.h||0,close:()=>{try{"close"in s&&s.close()}catch{}}}}function ko(e,t,n,r){if(r&&typeof OffscreenCanvas<"u"){const a=new OffscreenCanvas(t,n),s=a.getContext("2d");return s?(s.drawImage(e.source,0,0,t,n),{kind:"offscreen",canvas:a}):null}if(typeof document<"u"){const a=document.createElement("canvas");a.width=t,a.height=n;const s=a.getContext("2d");return s?(s.drawImage(e.source,0,0,t,n),{kind:"dom",canvas:a}):null}return null}async function Bf(e,t=.8){const n=ee(e);if(!n.length)return null;if(Tn(n))return ne(n);const r=$n(n);try{const a=await xo(n,r,!0);if(!a)return null;if(!(a.width>0&&a.height>0))return a.close(),null;const s=ko(a,a.width,a.height,!0);if(!s)return a.close(),null;let i;if(s.kind==="offscreen"){const c=await s.canvas.convertToBlob({type:"image/webp",quality:t});if(a.close(),!c||!c.size)return null;i=await c.arrayBuffer()}else i=Uu(s.canvas.toDataURL("image/webp",t)),a.close();if(!i)return null;const o=ee(i);return!Tn(o)||o.length>=n.length*.98?null:i}catch(a){return w("image.webp.encode.fail",{message:String(a?.message||a)},"warn"),null}}async function So(e){let t=ee(e);if(!t.length)throw new Error("image is empty");const n=1536,r=12e5,a=$n(t),s=t.length>r;try{const i=await xo(t,a,!1);if(i&&(s||i.width>n||i.height>n)){const o=Math.min(1,n/Math.max(i.width,i.height,1)),c=ko(i,Math.max(1,Math.round(i.width*o)),Math.max(1,Math.round(i.height*o)),!1);if(c?.kind==="dom"){const l=await new Promise(f=>{c.canvas.toBlob(f,"image/png")});if(l)return t=new Uint8Array(await l.arrayBuffer()),i.close(),{bytes:t,mime:"image/png",filename:"image.png"}}}i?.close()}catch(i){w("autotag.resize",{message:String(i?.message||i)},"warn")}return{bytes:t,mime:a,filename:`image.${a==="image/jpeg"?"jpg":a==="image/webp"?"webp":"png"}`}}async function Ar(){return tn||(tn=(async()=>{const e=Ee();if(typeof e?.getLocalPluginStorage=="function")try{const n=_e("storage.open"),r=await e.getLocalPluginStorage();if(Ea(r))return n.end({message:"idb/getLocalPluginStorage"}),{kind:"idb",api:r};n.end({message:"getLocalPluginStorage returned unusable api"},"warn")}catch(n){w("storage.open",{message:String(n?.message||n)},"error"),console.warn("[Inlay Nexus] getLocalPluginStorage failed",n?.message||n)}const t=e?.pluginStorage;if(Ea(t))return w("storage.open",{message:"fallback pluginStorage (save-file)"},"warn"),console.warn("[Inlay Nexus] falling back to pluginStorage (save-file scoped)"),{kind:"plugin",api:t};throw w("storage.open",{message:"no storage API"},"error"),new Error("기기 로컬 IndexedDB 저장소(getLocalPluginStorage)를 사용할 수 없습니다.")})().catch(e=>{throw tn=null,e}),tn)}function Rf(){return Ee()?.pluginStorage??null}async function Ce(e,t){try{const{kind:n,api:r}=await Ar(),a=await r.getItem(e);if(a!=null&&a!=="")return a;if(n==="idb"&&t){const s=Rf();if(s?.getItem)try{const i=await s.getItem(t);if(i!=null&&i!=="")return await r.setItem(e,i),i}catch{}}return null}catch{return null}}function Ff(e){if(typeof e=="string")return e.length;try{return JSON.stringify(e).length}catch{return 0}}async function je(e,t){const{kind:n,api:r}=await Ar(),a=Ff(t),s=a>5e4?_e("storage.set.large"):null;try{return await r.setItem(e,t),s?s.end({message:e,bytes:a,kind:n,background:!0}):a>8e3&&w("storage.set",{message:e,bytes:a,kind:n,background:!0}),!0}catch(i){throw s?s.fail(i,{message:e,bytes:a,kind:n,background:!0}):w("storage.set",{message:`${e}: ${i?.message||i}`,bytes:a,kind:n,background:!0},"error"),i}}async function ye(e){try{const{api:t}=await Ar();t?.removeItem&&await t.removeItem(e)}catch{}}var Ea,tn,Mr=T((()=>{Y(),_t(),Ea=e=>typeof e?.getItem=="function"&&typeof e?.setItem=="function",tn=null})),Ao,Mo,It,Df=T((()=>{Ao=class{budgetChars;urls=new Map;pinned=new Set;bytes=0;constructor(e){this.budgetChars=e}get size(){return this.urls.size}get byteLength(){return this.bytes}get(e){const t=String(e||"");if(!t)return;const n=this.urls.get(t);if(n!==void 0)return this.urls.delete(t),this.urls.set(t,n),n}set(e,t){const n=String(e||"");if(!n||typeof t!="string"||!t)return;const r=this.urls.get(n);r!==void 0&&(this.bytes-=r.length),this.urls.delete(n),this.urls.set(n,t),this.bytes+=t.length,this.evict()}drop(e){const t=String(e||""),n=this.urls.get(t);n!==void 0&&(this.urls.delete(t),this.bytes-=n.length,this.pinned.delete(t))}pin(e){this.pinned.clear();for(const t of e){const n=String(t||"");if(!n)continue;this.pinned.add(n);const r=this.urls.get(n);r!==void 0&&(this.urls.delete(n),this.urls.set(n,r))}this.evict()}retainOnly(e){this.pin(e);for(const t of[...this.urls.keys()]){if(this.pinned.has(t))continue;const n=this.urls.get(t);this.urls.delete(t),n!==void 0&&(this.bytes-=n.length),this.pinned.delete(t)}}pinnedIds(){return[...this.pinned]}clear(){this.urls.clear(),this.pinned.clear(),this.bytes=0}evict(){if(!(this.bytes<=this.budgetChars))for(const[e,t]of this.urls){if(this.bytes<=this.budgetChars)break;this.pinned.has(e)||(this.urls.delete(e),this.bytes-=t.length)}}},Mo=33554432,It=new Ao(Mo)}));function No(e){const t=String(e.session_id??"");if(!t)return;let n=nn.get(t);n||(n=new Set,nn.set(t,n)),n.add(String(e.id))}function Io(e){if(!e)return;const t=String(e.session_id??""),n=t?nn.get(t):void 0;n&&(n.delete(String(e.id)),n.size===0&&nn.delete(t))}function Eo(e,t){if(e==="characters"){if(Array.isArray(t))return`${t[0]}	${t[1]}`;if(t&&typeof t=="object"){const n=t;return`${n.scope}	${n.id}`}}return String(t)}function zf(e,t){if(!t||typeof t!="object")return"";const n=t;return e==="meta"?String(n.key||""):e==="characters"?`${n.scope}	${n.id}`:String(n.id||"")}function Uf(e){if(!e||typeof e!="object")return e;const t={...e};if(!t.result_json)return t;try{const n=JSON.parse(t.result_json);if(!n||typeof n!="object")return t;const r={...n};delete r.tagged,delete r.appearance,delete r.debug_tail,Array.isArray(r.cards)&&(r.cards=r.cards.map(a=>{if(!a||typeof a!="object")return a;const s={...a};return typeof s.image_url=="string"&&s.image_url.startsWith("data:")&&(s.image_url=""),s})),t.result_json=JSON.stringify(r)}catch{}return t}function Hf(e){const t={};if(e==="images"){for(const[n,r]of R.images)t[n]={id:r.id,location:r.location||null,has_png:r.has_png,png_bytes:r.png_bytes,storage:"indexeddb",storage_key:Pe(n)};return t}for(const[n,r]of R[e]){const a=r;if(e==="meta"&&a?.key==="reference_image"){t[n]={key:"reference_image",has_png:!!a.png,updated_at:a.updated_at||0};continue}if(e==="meta"&&a?.key==="vibe_transfer"){t[n]={key:"vibe_transfer",has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="meta"&&Vt(a?.key)){t[n]={key:a.key,has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="jobs"){t[n]=Uf(a);continue}t[n]=r}return t}async function Kf(e){await je(oa(e),Hf(e))}function Co(){jt=null;const e=[...Hn];Hn.clear(),e.length&&(Nr=Nr.then(async()=>{for(const t of e){if(Po){w("storage.persist.skip",{message:t,background:!0});continue}try{await Kf(t)}catch(n){console.warn("[Inlay Nexus] persist failed",t,n?.message||n)}}}).catch(()=>{}))}function Et(e){Hn.add(e),!jt&&(jt=setTimeout(Co,$o))}async function jo(){jt&&(clearTimeout(jt),Co()),await Nr,await me}function Jf(){const e=globalThis.document;if(!e?.addEventListener)return;const t=()=>{!jt&&!Hn.size||jo()};e.addEventListener("visibilitychange",()=>{e.visibilityState==="hidden"&&t()}),globalThis.addEventListener?.("pagehide",t)}function Gf(e,t){R.images.delete(e),R.images.set(e,t)}function To(e){if(Tt+=e,!(Tt<=Ta))for(const t of R.images.values()){if(Tt<=Ta)break;!t.png||!t.durable||(Tt-=t.png.byteLength,t.png=null,t.hydrated=!1)}}async function Wf(e,t){if(t.hydrated)return t.png;const n=Ir.get(e);if(n)return n;const r=(async()=>{const a=Kn(await Ce(Pe(e),ei(e)));return t.png=a,t.hydrated=!0,t.durable=!0,a?(t.png_bytes=a.byteLength,To(a.byteLength)):(t.has_png=!1,t.png_bytes=0),a})().finally(()=>Ir.delete(e));return Ir.set(e,r),r}async function lt(){return rn||(rn=(async()=>{for(const e of ai){const t=await Ce(oa(e),Qs(e));if(t==null||t==="")continue;let n=t;if(typeof t=="string")try{n=JSON.parse(t)}catch{continue}if(!(!n||typeof n!="object"))for(const[r,a]of Object.entries(n)){const s=a??{};if(e==="images"){const i=!!s.has_png;R.images.set(r,{id:String(s.id||r),location:s.location||{},png:null,has_png:i,png_bytes:Number(s.png_bytes)||0,hydrated:!i,durable:!0})}else if(e==="meta"&&(s.key==="reference_image"||r==="reference_image")){const i=Kn(await Ce(bn,ti));R.meta.set("reference_image",{key:"reference_image",png:i})}else if(e==="meta"&&(s.key==="vibe_transfer"||r==="vibe_transfer")){const i=Kn(await Ce(wn));let o=await Ce(vn);if(typeof o=="string")try{o=JSON.parse(o)}catch{o=null}const c=o??{};R.meta.set("vibe_transfer",{key:"vibe_transfer",png:i,encoded:c.encoded||"",model:c.model||s.model||"",information_extracted:c.information_extracted??s.information_extracted??1})}else if(e==="meta"&&Vt(s.key||r)){const i=String(s.key||r),o=Sn(i),c=Kn(await Ce(xn(o)));let l=await Ce(kn(o));if(typeof l=="string")try{l=JSON.parse(l)}catch{l=null}const f=l??{};R.meta.set(i,{key:i,png:c,encoded:f.encoded||"",model:f.model||s.model||"",information_extracted:f.information_extracted??s.information_extracted??1})}else if(e==="cards"){const i=s;R.cards.set(r,i),No(i)}else R[e].set(r,s)}}return!0})().catch(e=>{throw rn=null,e}),rn)}async function D(e,t){await lt();const n=Eo(e,t);if(e==="images"){const a=R.images.get(n);return a?(a.hydrated?a.png&&Gf(n,a):await Wf(n,a),a):void 0}const r=R[e].get(n);return r??void 0}async function qf(e){await lt();const t=R.images.get(String(e));if(t)return{has_png:t.has_png,png_bytes:t.png_bytes}}async function z(e,t,n={}){await lt();const r=zf(e,t);if(!r)throw new Error(`invalid ${e} key`);const a=n.persist!==!1;if(e==="images"){const s=t.png||null,i=R.images.get(r);i?.png&&(Tt-=i.png.byteLength);const o={id:String(t.id),location:t.location||{},...typeof t.mime=="string"&&t.mime?{mime:t.mime}:{},png:s,has_png:!!s,png_bytes:s?s.byteLength:0,hydrated:!0,durable:!s};return R.images.set(r,o),s?(To(s.byteLength),me=me.then(async()=>{const c=await Ge(new Uint8Array(s));await je(Pe(r),c),R.images.get(r)===o&&(o.durable=!0)}).catch(c=>console.warn("[Inlay Nexus] image persist failed",r,c?.message||c))):me=me.then(()=>ye(Pe(r))).catch(()=>{}),a&&Et("images"),r}if(e==="meta"&&t.key==="reference_image"){const s=t.png||null;return R.meta.set("reference_image",{key:"reference_image",png:s}),s?me=me.then(async()=>{await je(bn,await Ge(new Uint8Array(s)))}).catch(i=>console.warn("[Inlay Nexus] ref persist failed",i?.message||i)):me=me.then(()=>ye(bn)).catch(()=>{}),a&&Et("meta"),"reference_image"}if(e==="meta"&&t.key==="vibe_transfer"){const s={key:"vibe_transfer",png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return R.meta.set("vibe_transfer",s),me=me.then(async()=>{s.png?await je(wn,await Ge(new Uint8Array(s.png))):await ye(wn),s.encoded?await je(vn,{encoded:s.encoded,model:s.model,information_extracted:s.information_extracted}):await ye(vn)}).catch(i=>console.warn("[Inlay Nexus] vibe persist failed",i?.message||i)),a&&Et("meta"),"vibe_transfer"}if(e==="meta"&&Vt(t.key)){const s=String(t.key),i=Sn(s),o={key:s,png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return R.meta.set(s,o),me=me.then(async()=>{o.png?await je(xn(i),await Ge(new Uint8Array(o.png))):await ye(xn(i)),o.encoded?await je(kn(i),{encoded:o.encoded,model:o.model,information_extracted:o.information_extracted}):await ye(kn(i))}).catch(c=>console.warn("[Inlay Nexus] preset vibe persist failed",c?.message||c)),a&&Et("meta"),s}if(e==="cards"){Io(R.cards.get(r));const s=t;return R.cards.set(r,s),No(s),a&&Et("cards"),r}return R[e].set(r,t),a&&Et(e),r}async function Ct(e,t){await lt();const n=Eo(e,t);if(e==="cards"&&Io(R.cards.get(n)),e==="images"){const r=R.images.get(n);r?.png&&(Tt-=r.png.byteLength)}if(R[e].delete(n),e==="images"&&await ye(Pe(n)),e==="meta"&&n==="reference_image"&&await ye(bn),e==="meta"&&n==="vibe_transfer"&&(await ye(wn),await ye(vn)),e==="meta"&&Vt(n)){const r=Sn(n);await ye(xn(r)),await ye(kn(r))}return Et(e),e==="images"&&ja(n),!0}async function Ae(e){return await lt(),[...R[e].values()]}async function Ca(e){await lt();const t=nn.get(String(e));if(!t)return[];const n=[];for(const r of t){const a=R.cards.get(r);a&&n.push(a)}return n}function zn(e){return R[e].size}function Vf(){let e=0;for(const t of R.images.values())e+=t.png_bytes;return e}function Yf(){const e=[];for(const t of R.images.values())e.push(t.location||{});return e}async function Xf(e){await lt();const t=R.images.get(String(e))?.location;return t&&typeof t=="object"?t:{}}function Un(e){return It.get(String(e))}function Zf(e,t){It.set(String(e),t)}function ja(e){It.drop(String(e))}function Qf(e){It.pin(e)}function ed(e){It.retainOnly(e)}function td(){return It.size}async function nd(e){return(await D("images",String(e)))?.png??null}var R,nn,$o,Hn,jt,Nr,me,Po,Ta,Tt,Ir,Kn,rn,ze=T((()=>{re(),Y(),te(),Mr(),Df(),R={meta:new Map,cards:new Map,characters:new Map,jobs:new Map,images:new Map},nn=new Map,$o=25,Hn=new Set,jt=null,Nr=Promise.resolve(),me=Promise.resolve(),Po=!1,Jf(),Ta=100663296,Tt=0,Ir=new Map,Kn=e=>typeof e=="string"&&e?zu(e):null,rn=null}));Y(),te(),wt(),ze();async function an(e){if(!e)return"";const t=Un(e);if(t!==void 0)return t;const n=_e("image.data_url"),r=await D("images",e);if(!r?.png)return n.end({message:`missing png ${e}`,id:e,background:!0},"warn"),"";const a=typeof r.mime=="string"&&r.mime||$n(r.png),s=`data:${a};base64,${await Du(r.png)}`;return Zf(e,s),n.end({message:e,bytes:r.png.byteLength||0,mime:a,url_len:s.length,focus:!0}),s}function Ue(e){const t=typeof e=="string"?e:e?.id;return t&&Un(String(t))||""}async function $a(e,t,n=null){const r=_e("image.publish");ja(e);let a=t,s=$n(t);try{const o=await Bf(t,.8);o&&(a=o,s="image/webp")}catch(o){w("image.webp",{message:String(o?.message||o),id:e},"warn")}await z("images",{id:e,png:a,mime:s,location:n||{}});let i="";try{const o=an(e);i=await Promise.race([o,at(5e3).then(()=>Ue(e)||"")]),i||(w("image.data_url.defer",{message:e,bytes:a?.byteLength||0,mime:s,focus:!0},"warn"),o.catch(c=>console.warn("[Inlay Nexus] deferred data URL failed",c?.message||c)))}catch(o){w("image.data_url",{message:String(o?.message||o),id:e},"warn"),Promise.resolve().then(()=>an(e)).catch(()=>{})}return r.end({message:e,bytes:a?.byteLength||0,src_bytes:t?.byteLength||0,mime:s,has_url:!!i,has_location:!!(n&&Object.keys(n).length),focus:!0}),i}var Pa=2,$t=new Set,ie=[],We=0,He=0,qe=0,Oo=null;function rd(){const e=ie.length+We,t=Math.max(He,qe+e),n=Math.min(qe,t),r=t>0?Math.max(0,Math.min(100,Math.round(n/t*100))):0;return{pending:e,active:We,done:n,total:t,pct:r,busy:e>0}}function ad(e){Oo=typeof e=="function"?e:null}function Pt(){try{Oo?.()}catch{}}function Oa(){for(;We<Pa&&ie.length;){const e=ie.shift();We+=1,Pt(),an(e).catch(()=>{}).finally(()=>{We-=1,$t.delete(e),qe+=1,ie.length===0&&We===0&&(He=0,qe=0),Pt(),Oa()})}}function sd(e){const t=String(e||"");!t||Un(t)!==void 0||$t.has(t)||($t.add(t),ie.push(t),He+=1,Pt(),Oa())}function Lo(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];if(Qf(t),!t.length)return;const n=new Set(t),r=ie.length,a=[];for(const c of ie)n.has(c)?a.push(c):$t.delete(c);ie.length=0;const s=[];for(const c of t)Un(c)===void 0&&($t.has(c)||($t.add(c),He+=1),s.includes(c)||s.push(c));const i=a.filter(c=>!s.includes(c));ie.push(...s,...i);const o=r-a.length;o>0&&(He=Math.max(qe+ie.length+We,He-o)),Pt(),Oa()}function id(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];ed(t);const n=new Set(t);for(const a of ie)n.has(a)||$t.delete(a);const r=ie.filter(a=>n.has(a));ie.length=0,ie.push(...r),Lo(t)}function od(e){ja(String(e||""))}async function cd(e=[],{concurrency:t=Pa}={}){const n=[...new Set((e||[]).map(String).filter(Boolean))],r=Math.max(1,Number(t)||Pa),a=n.filter(s=>Un(s)===void 0);a.length&&(He+=a.length,Pt());for(let s=0;s<a.length;s+=r){const i=a.slice(s,s+r);await Promise.all(i.map(o=>an(o).catch(()=>"").finally(()=>{qe+=1,ie.length===0&&We===0&&qe>=He&&(He=0,qe=0),Pt()})))}return ie.length===0&&We===0&&(He=0,qe=0,Pt()),n.map(s=>Ue(s)).filter(Boolean)}async function ut(e,t={}){if(!e||typeof e!="object")return e;if(Array.isArray(e)){for(let r=0;r<e.length;r+=1)e[r]=await ut(e[r],t);return e}const n=e;if(typeof n.id=="string"&&(typeof n.image_url=="string"||n.image_path!=null||"shot_index"in n||"main_prompt"in n)){const r=String(n.id),a=t.ids!=null?new Set([...t.ids].map(String)):null;if(!t.cachedOnly&&(!a||a.has(r))){const s=await an(r);s&&(n.image_url=s)}else n.image_url=Ue(r)||"",!n.image_url&&t.warmMissing!==!1&&sd(r);return e}for(const r of Object.keys(n))n[r]&&typeof n[r]=="object"&&(n[r]=await ut(n[r],t));return e}function Ot(e){return e?`data:${$n(e)};base64,${Fu(e)}`:""}B();var ld=new Set(["year 2024","year 2025","year 2026","cowboy shot","looking at viewer","best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration"]),Bo=/^(-?\d+(?:\.\d+)?)::([\s\S]*?)::$/;function ud(e){return e.groups.flatMap(t=>t.assets.map(n=>n.name))}function La(e){const t=u(e);if(!t)return[];const n=[];let r="",a=0,s=0,i=0,o=!1;const c=()=>{const l=r.trim();l&&n.push(l),r=""};for(;a<t.length;){const l=t[a];if(!o&&s===0&&i===0){const f=t.slice(a).match(/^(-?\d+(?:\.\d+)?)::/);if(f){c(),o=!0,r=f[0],a+=f[0].length;continue}}if(o){if(r+=l,l===":"&&t[a+1]===":"){for(r+=":",a+=2,o=!1,c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}a+=1;continue}if(l==="{"){s+=1,r+=l,a+=1;continue}if(l==="}"&&s>0){if(s-=1,r+=l,a+=1,s===0&&i===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l==="["){i+=1,r+=l,a+=1;continue}if(l==="]"&&i>0){if(i-=1,r+=l,a+=1,s===0&&i===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l===","&&s===0&&i===0){for(c(),a+=1;a<t.length&&t[a]===" ";)a+=1;continue}r+=l,a+=1}return c(),n}function fd(e){return/^-\d+(?:\.\d+)?::/.test(e.trim())}function dd(e){return/artist\s*:/i.test(e)}function Ro(e){return e.replace(/[_-]+/g," ").replace(/\s+/g," ").trim()}function md(e){const t=Ro(e);return t==="background"||t.endsWith(" background")}function pd(e){const t=Ro(e);return t==="straight on"||t.replace(/\s+/g,"")==="straighton"}function gd(e){return!!(!e||ld.has(e)||md(e)||pd(e))}function Fo(e){const t=e.trim();if(t.length<2)return null;const n=t[0],r=n==="{"?"}":n==="["?"]":null;if(!r||t[t.length-1]!==r)return null;let a=0;for(let o=0;o<t.length&&t[o]===n;o+=1)a+=1;let s=0;for(let o=t.length-1;o>=0&&t[o]===r;o-=1)s+=1;const i=Math.min(a,s);return i<1?null:{kind:n==="{"?"brace":"bracket",inner:t.slice(i,t.length-i).trim(),depth:i}}function Do(e,t,n){if(t==="weight")return`${n}::${e}::`;const r=t==="brace"?"{":"[",a=t==="brace"?"}":"]",s=Math.max(1,Number(n)||1);return`${r.repeat(s)}${e}${a.repeat(s)}`}function Ba(e){const t=e.trim();if(!t)return[];const n=t.match(Bo);if(n){const i=n[1];return n[2].trim().split(",").map(o=>o.trim()).filter(Boolean).map(o=>({plain:o,restore:Do(o,"weight",i)}))}let r=t,a=null,s=0;for(;;){const i=Fo(r);if(!i)break;a=i.kind,s=i.depth,r=i.inner}return a?r.split(",").map(i=>i.trim()).filter(Boolean).map(i=>({plain:i,restore:Do(i,a,s)})):[{plain:t,restore:t}]}function hd(e){const t=[],n=new Map,r=new Set;for(const a of La(e))if(!fd(a)&&!dd(a))for(const{plain:s,restore:i}of Ba(a)){const o=s.toLowerCase();gd(o)||(n.has(o)||n.set(o,i),!r.has(o)&&(r.add(o),t.push(s)))}return{plains:t,weightMap:n}}function zo(e){return new Set(e.map(t=>t.toLowerCase()).filter(Boolean))}function _d(e,t,n=[]){if(!t.length)return{trigger:e,lore_keys:[...n],common:[],assets:[]};let r=zo(t[0].plains);for(let o=1;o<t.length;o+=1){const c=zo(t[o].plains);r=new Set([...r].filter(l=>c.has(l)))}const a=[],s=new Set;for(const o of t[0].plains){const c=o.toLowerCase();!r.has(c)||s.has(c)||(s.add(c),a.push(o))}const i=t.map(o=>{const c=[],l=new Set;for(const f of o.plains){const d=f.toLowerCase();r.has(d)||l.has(d)||(l.add(d),c.push(f))}return{name:o.name,unique:c}});return{trigger:e,lore_keys:[...n],common:a,assets:i}}function Uo(e,t=null){const n=new Map;for(const s of e)for(const[i,o]of s.weightMap)n.has(i)||n.set(i,o);if(!e.length)return{groups:[],weightMap:n};const r=new Map;for(const s of e){const i=u(s.trigger,200)||"_",o=r.get(i)||[];o.push(s),r.set(i,o)}const a=[];for(const[s,i]of r){const o=t?.get(s)||[];a.push(_d(s,i,o))}return{groups:a,weightMap:n}}function Ho(e){const t=[];t.push("## NovelAI character asset tags (ground truth for new_characters looks)"),t.push("Use ONLY tags from this block for appearance / attire / accessories (clothes, jewelry, weapons included)."),t.push("Do not invent looks outside this list. Use lore_keys for name/aliases; asset names hint outfits.");for(const n of e.groups){t.push(""),t.push(`## trigger \`${n.trigger}\``),t.push(`lore_keys: ${n.lore_keys.length?n.lore_keys.join(", "):n.trigger}`),t.push(`common: ${n.common.length?n.common.join(", "):"(none)"}`);for(const r of n.assets)t.push(""),t.push(`asset \`${r.name}\`:`),t.push(`  ${r.unique.length?r.unique.join(", "):"(no unique tags)"}`)}return t.join(`
`)}function Ra(e,t){if(!t?.size)return u(e);const n=[],r=new Set;for(const a of La(e)){if(Bo.test(a)||Fo(a)){const s=a.toLowerCase();if(r.has(s))continue;r.add(s),n.push(a);continue}for(const{plain:s}of Ba(a)){const i=s.toLowerCase();!i||r.has(i)||(r.add(i),n.push(t.get(i)||s))}}return N(...n)}function yd(...e){const t=new Map;for(const n of e)if(n)for(const[r,a]of n)t.has(r)||t.set(r,a);return t}function bd(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function sn(e){if(e===!0||e==="true"||e===1||e==="1"||e==="on")return"prepass_vision";if(e===!1||e==="false"||e===0||e==="0"||e==="off"||e==="none"||e==null||e==="")return"off";const t=String(e).toLowerCase().trim();return t==="legacy"||t==="together"||t==="single"?"inline":t==="split"||t==="looks"?"prepass":t==="vision"||t==="split_vision"||t==="prepass+vision"?"prepass_vision":Go.has(t)?t:"off"}function Fa(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"||e==="full"?"two_stage":e===!1||e==="false"||e===0||e==="0"||e==="none"?"off":typeof e=="string"&&Jo.has(e)?e:"off"}function Da(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function za(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e===!0||e==="true"||e==="on"?"short":e==="detailed"||e==="detail"?"detailed":e==="supplement"||e==="supp"?"supplement":typeof e=="string"&&Ko.has(e)?e:"short"}function Ua(e){if(Array.isArray(e))return e.map(Ua);if(!e||typeof e!="object")return e;const t={};for(const[n,r]of Object.entries(e))qo.has(n.toLowerCase())||(t[n]=Ua(r));return t}function Ha(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Settings must be an object");const t=Wo(e),n=t.card&&typeof t.card=="object"&&!Array.isArray(t.card)?t.card:{};if(t.card=n,Number(n.scale_semantics_version||0)<2){const c=Number(n.inline_thumb_pct);n.inline_thumb_pct=Number.isFinite(c)?Math.max(1,c/6):100,n.scale_semantics_version=2}if(Number.isFinite(Number(n.overlay_x_pct))||Number.isFinite(Number(n.overlay_y_pct))||n.overlay_pin_unit==="pct"){n.overlay_pin_unit="pct";const c=String(n.overlay_pin_origin||"");(!c||c==="bottom-left")&&(n.overlay_pin_origin="bl")}const r=n.lore_extra;r===!0||r==="true"||r==="sections"?n.lore_extra="tags":r===!1||r==="false"||r==="none"?n.lore_extra="off":r==="full"||r==="tags"||r==="off"?n.lore_extra=r:n.lore_extra="tags",n.asset_nai_tags=sn(n.asset_nai_tags),n.auto_aspect=n.auto_aspect===!0||n.auto_aspect==="true"||n.auto_aspect===1||n.auto_aspect==="1",n.natural_base=za(n.natural_base),n.person_tag_solo=n.person_tag_solo===!0||n.person_tag_solo==="true"||n.person_tag_solo===1||n.person_tag_solo==="1"||n.person_tag_solo==="on",n.person_tag_weight=bd(n.person_tag_weight);const a=t.curation&&typeof t.curation=="object"&&!Array.isArray(t.curation)?{...t.curation}:{},s=n.composition_curation===!0||n.composition_curation==="true"||n.composition_curation===1||n.composition_curation==="1"||n.composition_curation==="on";a.mode==null&&s&&(a.mode="two_stage"),a.mode=Fa(a.mode),a.strict_ids=Da(a.strict_ids);const i=a.embedding&&typeof a.embedding=="object"&&!Array.isArray(a.embedding)?{...a.embedding}:{};i.provider||(i.provider="openai"),i.model||(i.model="text-embedding-3-small"),i.endpoint||(i.endpoint="https://api.openai.com/v1/embeddings"),i.api_key==null&&(i.api_key=""),a.embedding=i,t.curation=a,n.composition_curation=!1;const o=n.overlay_markers!==!1;n.overlay_markers=o,n.inline_previews=o,n.inline_chat_images==null?n.inline_chat_images=!1:n.inline_chat_images=n.inline_chat_images===!0||n.inline_chat_images==="true"||n.inline_chat_images===1||n.inline_chat_images==="1",n.progress_toast==null?n.progress_toast=!1:n.progress_toast=n.progress_toast===!0||n.progress_toast==="true"||n.progress_toast===1||n.progress_toast==="1";{const c=String(n.viewer_minimize_mode||"icon");n.viewer_minimize_mode=c==="toolbar"||c==="actions"?c:"icon"}return t.settings_schema_version=2,t}function wd(e){return JSON.stringify(Ua(Ha(e)),null,2)}function vd(e){if(typeof e!="string")throw new TypeError("Settings JSON must be text");if(e.length>2e6)throw new RangeError("Settings JSON is too large");const t=JSON.parse(e);if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Settings JSON must contain an object");return Ha(t)}var Ko,Jo,Go,Wo,qo,Lt=T((()=>{Ko=new Set(["off","short","detailed","supplement"]),Jo=new Set(["off","two_stage","embed_snap"]),Go=new Set(["off","inline","prepass","prepass_vision"]),Wo=e=>JSON.parse(JSON.stringify(e??{})),qo=new Set(["api_key","auth_token","password","secret"])}));Lt();var xd=_n({isCharacterImageExtraLore:()=>Bt,matchCharacterImageSectionTitles:()=>Xo,normalizeNameKey:()=>on,parseCharacterImageTagLore:()=>Ka,trimCharacterImageTagLore:()=>Yo});function Bt(e){return String(e?.comment||e?.name||"").trim().toLowerCase()==="lb-xnai.lb.extra"}function Ka(e){const t=String(e||"");if(!t.trim())return{header:"",sections:[]};const n=/^(#{2,3})\s+(.+?)\s*$/gm,r=[];let a;for(;(a=n.exec(t))!==null;)r.push({hashes:a[1],title:String(a[2]||"").trim(),start:a.index,titleEnd:a.index+a[0].length});if(!r.length)return{header:t.trimEnd(),sections:[]};let s=t.slice(0,r[0].start).trimEnd();const i=[];for(let o=0;o<r.length;o+=1){const c=r[o],l=o+1<r.length?r[o+1].start:t.length,f=t.slice(c.titleEnd,l).replace(/^\r?\n/,"").trimEnd();if(c.title.toLowerCase()==="character image tags"){const d=t.slice(c.start,l).trimEnd();s=s?`${s}

${d}`:d;continue}i.push({title:c.title,hashes:c.hashes,body:f})}return{header:s.trimEnd(),sections:i}}function on(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}function Vo(e){return new Set((Array.isArray(e)?e:[]).map(t=>on(t)).filter(Boolean))}function kd(e,t){if(!t.length)return"";const n=[];e&&n.push(e);for(const r of t){const a=`${r.hashes} ${r.title}`;n.push(r.body?`${a}
${r.body}`:a)}return n.join(`

`).trimEnd()}function Yo(e,t=[],n=[]){const r=Ka(e);if(!r.sections.length)return"";const a=Vo(n);if(!a.size)return"";const s=Vo(t),i=r.sections.filter(o=>{const c=on(o.title);return a.has(c)&&!s.has(c)});return kd(r.header,i)}function Xo(e,t,n=[]){const r=Ka(e),a=on(t),s=new Set((Array.isArray(n)?n:[]).map(o=>on(o)).filter(o=>o.length>=2));if(!a&&!s.size)return[];const i=[];for(const o of r.sections){const c=on(o.title);c.length<2||(a&&a.includes(c)||s.has(c))&&i.push(o.title)}return i}B(),Nt();function Ja(e){const t=e.key||e.keys||e.trigger||"";let n;if(Array.isArray(t))n=t.map(i=>u(i,200));else{const i=u(t,2e3);n=i?i.split(/[,|\n]/):[]}const r=e.secondkey||e.second_key||"";r&&n.push(...Z(r));const a=[],s=new Set;for(const i of n){const o=u(i,200),c=U(o),l=o?kt(o):"";!c||s.has(c)||o.startsWith("")||l.length<2||(s.add(c),a.push(o))}return a}function Zo(e,t,n){const r=U(e),a=kt(e);if(a.length<2)return 0;const s=(i,o)=>{if(!i||!o||o.length<2)return 0;let c=0,l=0;for(;l<=i.length-o.length;){const f=i.indexOf(o,l);if(f<0)break;c+=1,l=f+o.length}return c};return Math.max(s(t,r),s(n,a))}function Ga(e,t){const n=u(t).toLowerCase(),r=kt(t);if(!n)return[];const a=[];for(const s of e||[]){if(typeof s!="object"||Bt(s))continue;const i=u(s.mode||"",40).toLowerCase(),o=u(s.key||"",2e3);if(i==="folder"||o.startsWith("folder:"))continue;const c=Ja(s);if(!c.length)continue;const l=[];for(const m of c)Zo(m,n,r)>0&&l.push(m);if(!l.length)continue;const f=new Set(l.map(m=>U(m))),d=c.filter(m=>!f.has(U(m))),p=u(s.comment??s.name??"",200);a.push({comment:p,keys:c,keys_hit_in_message:l,sibling_keys_not_in_message:d})}return a}function Wa(e,t){const n=Ga(e,t),r=[],a=new Set;for(const s of n)for(const i of s.keys){const o=U(i);!o||a.has(o)||(a.add(o),r.push(i))}return r}function Qo(e,t=[]){const n=String(e||"");if(!/character\s*image\s*tags/i.test(n))return!1;const r=(n.match(/^#{2,3}\s+.+$/gm)||[]).filter(s=>!/character\s*image\s*tags/i.test(s)),a=Array.isArray(t)?t.filter(Boolean).length:0;return r.length>=3&&(a===0||r.length>a+1)}function Sd(e){const t=[],n=new Set;for(const r of e||[])if(ue(r))for(const a of Mt(r)){const s=u(a,200),i=U(s);!s||!i||n.has(i)||(n.add(i),t.push(s))}return t}function Ad(e,t){if(!e||typeof e!="object")return!1;const n=new Set;for(const r of t||[]){const a=U(r);a&&n.add(a)}if(!n.size)return!1;for(const r of Ja(e)){const a=U(r);if(a&&n.has(a))return!0}return!1}function ec(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e==="full"?"full":"tags"}function Md(e,t,n=[],r=5,a=1200,s=null,i="tags"){const o=Array.isArray(e)?e:[],c=ec(i),l=c==="off"?[]:o.filter(g=>Bt(g)),f=o.filter(g=>!Bt(g)),d=Nd(f,t,r,a),p=Array.isArray(s)&&s.length?s.map(g=>u(g,200)).filter(Boolean):Wa(f,t),m=[];for(const g of l){const h=u(g.content||g.data||"",5e4);if(h)if(c==="full")m.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:h,key:"full",always:!0,lore_extra_mode:"full"});else{const _=Xo(h,t,p),y=_.length?Yo(h,n,_):"";y&&!Qo(y,_)&&m.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:y,key:_.join(", "),always:!0,lore_extra_mode:"tags"})}}for(const g of d)Ad(g,n)||Qo(u(g.content||g.data||"",a),[])||m.push(g);return m}function Nd(e,t,n=5,r=1200){const a=u(t).toLowerCase(),s=kt(t);if(!a)return[];const i=[];for(const o of e||[]){if(typeof o!="object"||Bt(o))continue;const c=u(o.mode||"",40).toLowerCase(),l=u(o.key||"",2e3);if(c==="folder"||l.startsWith("folder:"))continue;const f=u(o.content||o.data||"",r);if(!f)continue;const d=Ja(o);if(!d.length)continue;let p=0;for(const m of d)p+=Zo(m,a,s);p<=0||i.push({comment:u(o.comment||o.name||"",200),content:f,key:l,hits:p})}return i.sort((o,c)=>c.hits-o.hits||String(o.comment).localeCompare(String(c.comment))),i.slice(0,Math.max(1,n)).map(({hits:o,...c})=>c)}B();function Jn(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function tc(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function nc(e){const t=Jn(e);if(!t)return[];const n=[],r=u(t.base_caption??t.baseCaption??"");r&&n.push(r);const a=t.char_captions??t.charCaptions;if(Array.isArray(a))for(const s of a){const i=Jn(s),o=u(i?.char_caption??i?.charCaption??i?.caption??"");o&&n.push(o)}return n}function rc(e){const t=Jn(tc(e));if(!t)return u(e);let n=t.Comment??t.comment;n=tc(n);const r=Jn(n),a=[],s=o=>{if(!o)return;const c=u(o.prompt??o.Prompt??"");c&&a.push(c);const l=Jn(o.v4_prompt??o.v4Prompt);l&&a.push(...nc(l.caption??l)),a.push(...nc(o.caption))};s(r),s(t);const i=u(t.Description??t.description??"");return i&&!a.some(o=>o.includes(i.slice(0,40)))&&a.push(i),N(...a)}te();var Id=8;function cn(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function ac(e,t,n){try{return new TextDecoder("utf-8",{fatal:!1}).decode(e.subarray(t,n))}catch{return cn(e,t,n)}}async function sc(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("deflate"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{try{const t=new DecompressionStream("deflate-raw"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{return null}}}async function Ed(e){const t=ee(e),n={};if(!vt(t)||t.length<8)return n;let r=Id;const a=new DataView(t.buffer,t.byteOffset,t.byteLength);for(;r+12<=t.length;){const s=a.getUint32(r),i=cn(t,r+4,r+8),o=r+8,c=o+s;if(c+4>t.length)break;const l=t.subarray(o,c);if(i==="tEXt"){const f=l.indexOf(0);if(f>0){const d=cn(l,0,f),p=cn(l,f+1,l.length);d&&!(d in n)&&(n[d]=p)}}else if(i==="iTXt"){let f=0;const d=l.indexOf(0);if(d>0){const p=ac(l,0,d);f=d+1;const m=l[f]??0;f+=1,f+=1;const g=l.indexOf(0,f);if(g>=f){f=g+1;const h=l.indexOf(0,f);if(h>=f){f=h+1;let _=l.subarray(f);if(m===1){const v=await sc(_);v&&(_=v)}const y=ac(_,0,_.length);p&&!(p in n)&&(n[p]=y)}}}}else if(i==="zTXt"){const f=l.indexOf(0);if(f>0&&f+2<=l.length){const d=cn(l,0,f),p=await sc(l.subarray(f+2));p&&d&&!(d in n)&&(n[d]=cn(p,0,p.length))}}if(i==="IEND")break;r=c+4}return n}te();function Cd(e,t,n){const r=[];for(let a=0;a<t;a+=1)for(let s=0;s<n;s+=1){const i=s*t+a;r.push(e[i*4+3]&1)}return r}function jd(e,t,n){const r=Cd(e,t,n),a=Math.floor(r.length/8)*8,s=new Uint8Array(a/8);for(let i=0;i<a;i+=8){let o=0;for(let c=0;c<8;c+=1)o|=r[i+c]<<7-c;s[i/8]=o}return s}async function Td(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("gzip"),n=new Uint8Array(e.byteLength);n.set(e);const r=new Blob([n]).stream().pipeThrough(t);return new Uint8Array(await new Response(r).arrayBuffer())}catch{return null}}async function $d(e,t,n){if(!e.length||t<1||n<1)return null;const r=t*n*4;if(e.length<r)return null;const a=jd(e,t,n);if(a.length<20)return null;const s="stealth_pngcomp",i="stealth_pnginfo",o=String.fromCharCode(...a.subarray(0,15));let c=0,l=!1;if(o.startsWith(s))l=!0,c=15;else if(o.startsWith(i))l=!1,c=15;else return null;if(c+4>a.length)return null;const f=(a[c]<<24|a[c+1]<<16|a[c+2]<<8|a[c+3])>>>0;c+=4;const d=Math.floor(f/8);if(d<1||c+d>a.length)return null;let p=a.subarray(c,c+d);if(l){const g=await Td(p);if(!g)return null;p=g}const m=new TextDecoder("utf-8",{fatal:!1}).decode(p);try{const g=JSON.parse(m);if(g&&typeof g=="object"&&!Array.isArray(g)){const h=g;if(typeof h.Comment=="string")try{h.Comment=JSON.parse(h.Comment)}catch{}}return g}catch{return null}}async function Pd(e){const t=ee(e);if(!t.length||typeof createImageBitmap!="function")return null;try{const n=new Uint8Array(t.byteLength);n.set(t);const r=new Blob([n]);let a;try{a=await createImageBitmap(r,{colorSpaceConversion:"none",premultiplyAlpha:"none"})}catch{a=await createImageBitmap(r)}const s=a.width,i=a.height,o=typeof OffscreenCanvas=="function"?new OffscreenCanvas(s,i):(()=>{const f=document.createElement("canvas");return f.width=s,f.height=i,f})(),c=o.getContext("2d",{alpha:!0,willReadFrequently:!0})??o.getContext("2d",{alpha:!0,willReadFrequently:!0});if(!c)return a.close?.(),null;c.drawImage(a,0,0);const l=c.getImageData(0,0,s,i);return a.close?.(),{rgba:new Uint8Array(l.data.buffer,l.data.byteOffset,l.data.byteLength),width:s,height:i}}catch{return null}}te();function ic(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function oc(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]<<8|e[a+1]);return String.fromCharCode(...r)}function Od(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]|e[a+1]<<8);return String.fromCharCode(...r)}function Ld(e){if(e.length<8)return"";const t=ic(e,0,8).replace(/\0+$/g,""),n=e.subarray(8);return/^ASCII/i.test(t)?new TextDecoder("utf-8",{fatal:!1}).decode(n).replace(/\0+$/g,""):/^UNICODE/i.test(t)?n.length>=2&&n[0]===255&&n[1]===254?Od(n,2,n.length).replace(/\0+$/g,""):n.length>=2&&n[0]===254&&n[1]===255?oc(n,2,n.length).replace(/\0+$/g,""):oc(n,0,n.length).replace(/\0+$/g,""):new TextDecoder("utf-8",{fatal:!1}).decode(e).replace(/\0+$/g,"")}function Bd(e){const t={};if(e.length<8)return t;let n=0;e.length>=6&&e[0]===69&&e[1]===120&&e[2]===105&&e[3]===102&&(n=6);const r=e.subarray(n);if(r.length<8)return t;const a=r[0]===73&&r[1]===73,s=r[0]===77&&r[1]===77;if(!a&&!s)return t;const i=new DataView(r.buffer,r.byteOffset,r.byteLength),o=d=>a?i.getUint16(d,!0):i.getUint16(d,!1),c=d=>a?i.getUint32(d,!0):i.getUint32(d,!1),l=c(4);return(d=>{if(d+2>r.length)return;const p=o(d);for(let m=0;m<p;m+=1){const g=d+2+m*12;if(g+12>r.length)break;const h=o(g),_=o(g+2),y=c(g+4);let v=g+8;const x=y*(_===2||_===7?1:_===3?2:_===4?4:1);if(x>4&&(v=c(g+8)),v+x>r.length)continue;const M=r.subarray(v,v+x);h===270&&_===2?t.ImageDescription=new TextDecoder("utf-8",{fatal:!1}).decode(M).replace(/\0+$/g,""):h===37510&&(t.UserComment=Ld(M))}})(l),t}function Rd(e){const t=ee(e);if(!Tn(t)||t.length<12)return null;let n=12;for(;n+8<=t.length;){const r=ic(t,n,n+4),a=t[n+4]|t[n+5]<<8|t[n+6]<<16|t[n+7]<<24,s=n+8,i=s+a;if(i>t.length)break;if(r==="EXIF")return t.subarray(s,i);n=i+(a&1)}return null}function Fd(e){const t=Rd(e);return t?Bd(t):{}}var Dd={portrait:{width:832,height:1216},square:{width:1024,height:1024},landscape:{width:1216,height:832}};function zd(e){const t=String(e??"").trim().toLowerCase().replace(/\s+/g,"");return t?t==="portrait"||t==="vertical"||t==="tall"||t==="832x1216"||t==="3:4"||t==="2:3"?"portrait":t==="square"||t==="1:1"||t==="1x1"||t==="1024x1024"?"square":t==="landscape"||t==="horizontal"||t==="wide"||t==="1216x832"||t==="4:3"||t==="3:2"?"landscape":null:null}function Ud(e,t,n){if(n){const r=zd(e)||"portrait";return{...Dd[r],aspect:r}}return{width:Math.max(64,Math.min(5e3,Math.round(Number(t.width)||832))),height:Math.max(64,Math.min(5e3,Math.round(Number(t.height)||1216))),aspect:"settings"}}B();var Hd=new Set(["best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration","bad anatomy"]);function Kd(e){if(/artist\s*:/i.test(e))return!0;for(const{plain:t}of Ba(e))if(Hd.has(t.toLowerCase()))return!0;return!1}function Jd(e){const t=[],n=new Set;for(const r of La(e)){if(!Kd(r))continue;const a=r.toLowerCase();n.has(a)||(n.add(a),t.push(r.trim()))}return N(...t)}function cc(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function lc(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function uc(e){if(e==null||e==="")return null;const t=Number(e);return Number.isFinite(t)?t:null}function Gd(e,t){const n=cc(lc(e)),r=cc(n?lc(n.Comment??n.comment):null)||n,a=u(r?.uc??r?.negative_prompt??r?.negativePrompt??r?.Negative??n?.uc??"",2e4),s=uc(r?.scale??r?.cfg_scale??r?.cfgScale??n?.scale),i=uc(r?.cfg_rescale??r?.cfgRescale??n?.cfg_rescale);return{positive:Jd(t),negative:a,cfg_scale:s,cfg_rescale:i}}te();function fc(e){const t=e.Comment||e.comment;if(t)try{return{Comment:JSON.parse(t),...e}}catch{return{Comment:t,...e}}return e}async function dc(e){const t=ee(e);if(!t.length)return null;if(vt(t)){const r=await Ed(t);if(r.Comment||r.Description||r.Source)return fc(r)}else if(Tn(t)){const r=Fd(t);if(r.UserComment||r.ImageDescription){const a={};return r.UserComment&&(a.Comment=r.UserComment),r.ImageDescription&&(a.Description=r.ImageDescription),fc(a)}}const n=await Pd(t);return n?$d(n.rgba,n.width,n.height):null}async function Wd(e){const t=await dc(e);if(!t)return null;const n=rc(t);if(!n.trim())return null;const r=hd(n);return r.plains.length?r:null}B(),Nt(),De();var qd=3,Vd=/[\uac00-\ud7a3\u1100-\u11ff\u3130-\u318f]/,Yd=["default","normal","profile","smile"],sy=2;function Te(e,t=400){return u(e,t).normalize("NFC").toLowerCase().replace(/[\s_\-.]/g,"")}function qa(e){return u(e,400).normalize("NFC").toLowerCase().replace(/\.[a-z0-9]{2,5}$/i,"").replace(/[\s_\-.]/g,"")}function Xd(e){return Vd.test(e)}function Zd(e){const t=Te(e,200);return t?Xd(t)?!0:t.length>=qd:!1}function mc(e,t){const n=pc(e);if(!t?.length)return n;const r=new Set,a=new Set;for(const s of t){const i=Mt(s).map(o=>Te(o,200)).filter(o=>o.length>=2);if(ue(s))for(const o of i)r.add(o);else if(u(s.name,200))for(const o of i)a.add(o)}return n.filter(s=>{const i=Te(s,200);return i?a.has(i)?!0:!r.has(i):!1})}function pc(e){const t=[],n=new Set;for(const r of e){if(!Zd(r))continue;const a=Te(r,200);n.has(a)||(n.add(a),t.push(a))}return t}function Va(e,t,n=[]){const r=new Set(t.map(o=>Te(o,200)).filter(Boolean)),a=new Map,s=new Map,i=(o,c)=>{if(!r.has(o))return;const l=u(c,200);if(!l)return;let f=a.get(o),d=s.get(o);f||(f=[],d=new Set,a.set(o,f),s.set(o,d));const p=l.normalize("NFC").toLowerCase();d.has(p)||(d.add(p),f.push(l))};for(const o of e){const c=u(o,200);if(!c)continue;const l=Te(c,200);l&&i(l,c)}for(const o of n){const c=(o||[]).map(f=>u(f,200)).filter(Boolean);if(!c.length)continue;const l=new Set(c.map(f=>Te(f,200)).filter(f=>f&&r.has(f)));if(l.size)for(const f of l)for(const d of c)i(f,d)}return a}function Ya(e){return[...e].sort((t,n)=>n.length-t.length||t.localeCompare(n))}function Qd(e){return Yd.some(t=>e.includes(t))}function Rt(e,t){const n=Te(t,200);if(!n)return-1;const r=qa(e);if(!r.includes(n))return-1;const a=r===n,s=Qd(r),i=Math.max(0,2e3-r.length);return a?3e6+i:s?2e6+i:1e6+i}function em(e,t){const n=u(e,400);if(!n)return null;const r=qa(n);if(!r)return null;const a=[];for(const s of t){const i=Te(s,200);i&&r.includes(i)&&a.push(i)}return a.length?{name:n,key:n,score:Math.max(...a.map(s=>Rt(n,s))),hits:a}:null}function tm(e,t,n=2){const r=Ya(t),a=[],s=new Set;for(const i of r){const o=e.filter(l=>l.hits.includes(i)&&!s.has(l.key)).sort((l,f)=>Rt(f.name,i)-Rt(l.name,i)||l.name.localeCompare(f.name));let c=0;for(const l of o){if(c>=n)break;s.has(l.key)||(s.add(l.key),a.push(l),c+=1)}}return a}B();function Er(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(Array.isArray(n)){const r=u(n[0],400),a=u(n[1],800);r&&a&&t.push({name:r,key:a});continue}if(n&&typeof n=="object"){const r=n,a=u(r.name??r.assetName??r.fileName,400),s=u(r.key??r.path??r.id??r.asset,800);a&&s&&t.push({name:a,key:s})}}return t}function Xa(e,t){if(Array.isArray(t))for(const n of t){const r=u(n,200);r&&e.push(r)}}function nm(e){const t=[];Xa(t,e.enabledModules),Xa(t,e.chatModules),Xa(t,e.characterModules);const n=u(e.personaEmbeddedModuleId,200);if(n&&t.push(n),typeof e.moduleIntergration=="string")for(const r of e.moduleIntergration.split(",")){const a=r.trim();a&&t.push(a)}return t}function rm(e,t){const n=u(e.id,200);if(n&&t.has(n))return!0;const r=u(e.namespace,200);return!!(r&&t.has(r))}function am(e,t,n=[]){if(!t.length)return[];const r=new Set(t),a=[],s=new Set,i=o=>{if(!o||typeof o!="object")return;const c=o;if(!rm(c,r))return;const l=u(c.id,200)||u(c.namespace,200)||"";if(l){if(s.has(l))return;s.add(l)}a.push(...Er(c.assets))};for(const o of e)i(o);for(const o of n)i(o);return a}function sm(...e){const t=[],n=new Set;for(const r of e)for(const a of r)!a.name||!a.key||n.has(a.key)||(n.add(a.key),t.push(a));return t}function im(e){if(!e||typeof e!="object")return null;const t=e;if(!Array.isArray(t.personas))return null;const n=typeof t.selectedPersona=="number"?t.selectedPersona:0,r=t.personas[n];if(!r||typeof r!="object")return null;const a=r.embeddedModule;return a&&typeof a=="object"?a:null}Y(),_t(),B(),De(),te();function om(e,t){const n=qa(e),r=Te(t,200);return!!(n&&r&&n.includes(r))}var gc=16,cm=24,lm=5,Za=new Map,hc=new Map;function um(){return Za}function Qa(e){Za=e}async function es(e){const t=Ee();if(!t||typeof t.readImage!="function")return null;try{const n=await t.readImage(e);if(!n)return null;if(n instanceof ArrayBuffer)return ee(n);if(n instanceof Uint8Array)return n;if(typeof Blob<"u"&&n instanceof Blob)return ee(await n.arrayBuffer());if(typeof n=="string"){const r=n.match(/^data:[^;]+;base64,(.+)$/i);if(r){const a=atob(r[1]),s=new Uint8Array(a.length);for(let i=0;i<a.length;i+=1)s[i]=a.charCodeAt(i);return s}try{const a=atob(n.replace(/\s+/g,"")),s=new Uint8Array(a.length);for(let i=0;i<a.length;i+=1)s[i]=a.charCodeAt(i);return s}catch{return null}}if(n&&typeof n=="object"){const r=n;if(r.data instanceof ArrayBuffer)return ee(r.data);if(typeof r.data=="string")return es(r.data)}}catch(n){w("asset-tags.read.fail",{path:e,message:String(n?.message||n)},"warn")}return null}async function fm(){const e=Ee();if(!e||typeof e.getCurrentCharacterIndex!="function"||typeof e.getCurrentChatIndex!="function"||typeof e.getChatFromIndex!="function")return null;try{const t=await e.getCurrentCharacterIndex(),n=await e.getCurrentChatIndex();return await e.getChatFromIndex(t,n)}catch(t){return w("asset-tags.chat.fail",{message:String(t?.message||t)},"warn"),null}}function dm(e){const t=e&&typeof e=="object"?e:null;if(!t)return null;const n=Array.isArray(t.chats)?t.chats:null;if(!n?.length)return null;const r=typeof t.chatPage=="number"?t.chatPage:0,a=n[Math.max(0,Math.min(n.length-1,r))];return a&&typeof a=="object"?a:null}async function _c(e){const t=e&&typeof e=="object"?e:null,n=Er(t?.additionalAssets??t?.additional_assets);let r=[],a=[],s=[];if(ve("getDatabase"))try{const i=await Ee().getDatabase(["modules","enabledModules","moduleIntergration","personas","selectedPersona"]);if(i){const o=await fm()||dm(e),c=o&&typeof o=="object"?o:null,l=im(i),f=l&&typeof l=="object"?l:null;s=nm({enabledModules:i.enabledModules,characterModules:t?.modules,chatModules:c?.modules,moduleIntergration:i.moduleIntergration,personaEmbeddedModuleId:f?.id});const d=Array.isArray(i.modules)?i.modules:[];r=am(d,s,l?[l]:[]),f&&(a=Er(f.assets));const p=new Set(s),m=[];for(const g of d){if(!g||typeof g!="object")continue;const h=g,_=u(h.id,200),y=u(h.namespace,200);!(_&&p.has(_))&&!(y&&p.has(y))||m.push({id:_||y,name:u(h.name,200),assets:Er(h.assets).length})}w("asset-tags.modules",{enabled:s.length,module_assets:r.length,per_module:m.slice(0,12)})}}catch(i){w("asset-tags.modules.fail",{message:String(i?.message||i)},"warn")}return{assets:sm(n,r,a),characterCount:n.length,moduleCount:r.length,personaCount:a.length,enabledModuleIds:s}}async function yc(e,t){const n=e.map(f=>{const d=em(f.name,t);return d?{...f,score:d.score,hits:d.hits}:null}).filter(Boolean),r=[],a=[],s=[],i=new Set;let o=0;const c=async(f,d)=>{if(i.has(f.key)||r.length>=gc||o>=cm)return!1;o+=1;let p,m,g=!1;const h=hc.get(f.key);if(h)p=h.plains,m=new Map(h.weights),g=!0;else{const _=await es(f.key);if(!_?.length)return s.push({name:f.name,key:f.key,ok:!1,reason:"read_empty"}),!1;const y=await Wd(_);if(!y?.plains.length)return w("asset-tags.no_meta",{name:f.name}),s.push({name:f.name,key:f.key,ok:!1,reason:"no_nai_meta",bytes:_.length}),!1;p=y.plains,m=y.weightMap,hc.set(f.key,{plains:p,weights:[...m.entries()]})}return i.add(f.key),r.push({name:f.name,plains:p,weightMap:m,trigger:d}),s.push({name:f.name,key:f.key,ok:!0,from_cache:g,plains:p.length,hits:f.hits,trigger:d,score:f.score}),!0},l=new Set(tm(n,t,2).map(f=>f.key));for(const f of Ya(t)){if(r.length>=gc)break;const d=n.filter(m=>m.hits.includes(f)).sort((m,g)=>{const h=l.has(m.key)?1:0,_=l.has(g.key)?1:0;return _!==h?_-h:Rt(g.name,f)-Rt(m.name,f)||m.name.localeCompare(g.name)});let p=0;for(const m of d){if(p>=2)break;await c(m,f)&&(p===0&&a.length<lm&&!a.some(g=>g.key===m.key)&&a.push({name:m.name,key:m.key}),p+=1)}}return{scored:n,packedRows:r,previewTargets:a,attempts:o,attemptLog:s}}async function mm(e){const t=[];for(const n of e)try{const r=await es(n.key);if(!r?.length)continue;const a=await So(r),s=await Ge(a.bytes);t.push({name:n.name,dataUrl:`data:${a.mime||"image/png"};base64,${s}`})}catch(r){w("asset-tags.preview.fail",{name:n.name,message:String(r?.message||r)},"warn")}return t}async function bc(e,t={}){const n=mc(e,t.roster);if(!n.length)return w("asset-tags.skip",{reason:t.roster?.length?"no_unfilled_triggers":"no_long_triggers"}),null;if(!ve("getCharacter")||!ve("readImage"))return w("asset-tags.skip",{reason:"host_api_missing"}),null;let r;try{r=await Ee().getCharacter()}catch(_){return w("asset-tags.getCharacter.fail",{message:String(_?.message||_)},"warn"),null}const a=await _c(r);if(!a.assets.length)return w("asset-tags.skip",{reason:"no_assets"}),null;const s=t.lorebook?.length&&t.message?Ga(t.lorebook,t.message).map(_=>_.keys):[],i=Va(e,n,s),{scored:o,packedRows:c,previewTargets:l,attempts:f}=await yc(a.assets,n);if(!c.length)return w("asset-tags.skip",{reason:"no_meta_hits",matched:o.length,attempts:f}),null;const d=Uo(c,i),p=yd(d.weightMap);Za=p;const m=Ho(d),g=t.withPreviews===!0?await mm(l):[],h=ud(d);return w("asset-tags.done",{assets:h,groups:d.groups.map(_=>({trigger:_.trigger,lore_keys:_.lore_keys,common:_.common.length,assets:_.assets.map(y=>y.name)})),pool:a.assets.length,unique:d.groups.reduce((_,y)=>_+y.assets.reduce((v,x)=>v+x.unique.length,0),0),previews:g.map(_=>_.name)}),{block:m,packed:d,weightMap:p,previews:g}}async function pm(e={}){const t=u(e.message??e.text??"",2e4),n=Array.isArray(e.lorebook)?e.lorebook:[],r=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys.map(k=>u(k,200)).filter(Boolean):[],a=Wa(n,t),s=Ga(n,t),i=s.map(k=>k.keys),o=[...r,...a],c=pc(o),l=Array.isArray(e.roster)?e.roster:null,f=mc(o,l),d=E().card,p=sn(d.asset_nai_tags),m=p!=="off",g=[...new Set(s.flatMap(k=>k.sibling_keys_not_in_message.map(I=>Te(I,200)).filter(Boolean)))],h=(l||[]).filter(k=>u(k.name,200)&&!ue(k)).map(k=>u(k.name,200)),_={setting_asset_nai_tags:m,asset_nai_tags_mode:p,message_preview:t.slice(0,240),message_len:t.length,lorebook_entries:n.length,lore_entries_fired:s.map(k=>({comment:k.comment||"(no comment)",keys_hit_in_message:k.keys_hit_in_message,sibling_keys_not_in_message:k.sibling_keys_not_in_message,all_keys:k.keys})),sibling_keys_exported:g,lore_trigger_keys_ui:r,lore_trigger_keys_backend:a,asset_match_triggers_all:c,asset_match_triggers:f,roster_incomplete_names:h,note:"compact contains (drop space/-/_/.); per trigger ≤2; exact > default|normal|profile|smile > shorter; common tags computed per trigger group; ALL keys of a lit lore entry become asset triggers (see lore_entries_fired.sibling_keys_not_in_message)"};if(!t)return _.skip="no_message",{ok:!0,report:_};if(!f.length)return _.skip=c.length?"no_unfilled_triggers":"no_long_triggers",{ok:!0,report:_};if(!ve("getCharacter")||!ve("readImage"))return _.skip="host_api_missing",_.host={getCharacter:ve("getCharacter"),readImage:ve("readImage"),getDatabase:ve("getDatabase")},{ok:!0,report:_};let y;try{y=await Ee().getCharacter()}catch(k){return _.skip="getCharacter_fail",_.error=String(k?.message||k),{ok:!1,message:_.error,report:_}}const v=await _c(y);if(_.pool={total:v.assets.length,character:v.characterCount,module:v.moduleCount,persona:v.personaCount,enabled_module_ids:v.enabledModuleIds,sample_names:v.assets.slice(0,40).map(k=>k.name)},!v.assets.length)return _.skip="no_assets",{ok:!0,report:_};_.pool_names_containing_triggers=f.filter(k=>/[^\x00-\x7f]/.test(k)||/^(senoy|philia|awa|kurokage)$/i.test(k)).flatMap(k=>v.assets.filter(I=>om(I.name,k)).slice(0,8).map(I=>({trigger:k,name:I.name}))).slice(0,40);const{scored:x,packedRows:M,attempts:L,attemptLog:C}=await yc(v.assets,f);if(_.name_matches=x.slice(0,40).map(k=>({name:k.name,key:k.key,score:k.score,hits:k.hits})),_.per_trigger_picks=Ya(f).map(k=>{const I=x.filter(P=>P.hits.includes(k)).sort((P,J)=>Rt(J.name,k)-Rt(P.name,k)||P.name.localeCompare(J.name));return{trigger:k,lore_keys:Va(o,[k],i).get(k)||[],from_sibling_key:g.includes(k),match_count:I.length,top:I.slice(0,2).map(P=>P.name)}}),_.read_attempts=L,_.read_log=C,_.picked=M.map(k=>({name:k.name,plains_count:k.plains.length,plains_sample:k.plains.slice(0,12)})),!M.length)return _.skip="no_meta_hits",{ok:!0,report:_};const $=Va(o,f,i),F=Uo(M,$);return _.packed={groups:F.groups.map(k=>({trigger:k.trigger,lore_keys:k.lore_keys,common:k.common,assets:k.assets.map(I=>({name:I.name,unique:I.unique}))}))},_.inject_block_preview=Ho(F).slice(0,2e3),_.ok_picked=M.length,{ok:!0,report:_}}re(),B(),xa(),Nt(),De(),ze(),fe();var Ke=(e,t)=>!!e&&Object.prototype.hasOwnProperty.call(e,t),Cr=e=>e?[...e]:[],ts=e=>e;async function oe(e){const t=(await Ae("characters")).filter(r=>r.scope===u(e,200)).sort((r,a)=>(r.name||"").localeCompare(a.name||"",void 0,{sensitivity:"base"})),n=[];for(const r of t){let a=r.aliases;if(typeof a=="string")try{a=JSON.parse(a)}catch{a=Z(a)}const s=r.appearance||"",i=r.attire||"",o=r.accessories||"";let c=Qt(r.gender??r.sex);if(!c){const f=df(s,i,o);f&&(c=f,await z("characters",{...r,gender:f,schema_version:Math.max(2,Number(r.schema_version||1)),updated_at:Date.now()/1e3}))}const l={id:r.id,name:r.name,aliases:Array.isArray(a)?a:Z(a),surname:r.surname||"",given_name:r.given_name||"",surname_variants:Z(r.surname_variants),given_name_variants:Z(r.given_name_variants),priority:Number(r.priority||0),attire_locked:de(r.attire_locked),accessories_locked:de(r.accessories_locked),schema_version:Number(r.schema_version||1),original:r.original||"",appearance:s,attire:i,accessories:o,gender:c,updated_at:r.updated_at,scope:r.scope};l.tags=Dn(l),n.push(l)}return n}async function gm(e){const t=u(e,200);return t?(await Ae("meta")).filter(n=>n.key?.startsWith(`toggle:${t}:`)&&n.enabled===0).map(n=>u(n.global_key||n.key.split(":").slice(2).join(":"),200)).filter(Boolean):[]}async function hm(e,t){const n=u(e,200);if(!n)return{ok:!1,error:{code:"bad_request",message:"character_id required"}};const r=[],a=new Set;for(const o of t||[]){const c=u(o,200);!c||a.has(c)||(a.add(c),r.push(c))}const s=await Ae("meta");for(const o of s)o.key?.startsWith(`toggle:${n}:`)&&await Ct("meta",o.key);const i=Date.now()/1e3;for(const o of r)await z("meta",{key:`toggle:${n}:${o}`,character_id:n,global_key:o,enabled:0,updated_at:i});return{ok:!0,character_id:n,disabled_globals:r}}function wc(e){const t=[];for(const n of[e.id,e.name]){const r=u(n,200);if(!r)continue;t.push(r);const a=r.toLowerCase();a!==r&&t.push(a)}return[...new Set(t)]}function ns(e,t){if(!t?.size)return!1;for(const n of wc(e))if(t.has(n))return!0;return!1}async function rs(e){const t=await gm(e);return new Set(t)}async function _m(e){const t=await rs(e),n={};for(const r of await oe(rt)){const a=!ns(r,t);for(const s of wc(r))n[s]=a;n[u(r.name,200)]=a}return n}async function ym(e=[]){const t=[],n=new Set;for(const r of e||[]){const a=u(r,200);!a||a==="__global__"||n.has(a)||(n.add(a),t.push(...await oe(a)))}return ts(Sa(t))}async function Gn(e,t="",n="",r=[]){const a=!!E()?.card?.unified_chat_priority,s=(Array.isArray(r)?r:[]).map(f=>u(f,200)).filter(Boolean);let i;a&&s.length?i=await ym(s):i=await oe(u(e||"",200));const o=u(n||"",200),c=o?await rs(o):new Set,l=(await oe(rt)).filter(f=>!ns(f,c));return ts(yf(i,l,{hasAppearance:ue,resolve:Se,aliasKeys:Rn,normalizeName:U,fullTags:Dn,clean:u,globalScope:rt}))}async function ft(e,t){const n=Ke(t,"appearance"),r=Ke(t,"attire"),a=Ke(t,"accessories"),s=Ke(t,"original"),i=Ke(t,"surname"),o=Ke(t,"given_name"),c=Ke(t,"surname_variants"),l=Ke(t,"given_name_variants");let f=en(t);if(!f)return null;const d=u(e,200)||"__global__",p=await oe(d),m=u(f.id,80),g=f,h=p.find(y=>m&&u(y.id,80)===m?!1:!!(Se(g.name,[y])||(g.aliases||[]).some(v=>Se(v,[y]))));if(h){const y=Z([...h.aliases||[],...f.aliases||[],f.name,h.name]),v=u(f.appearance||"",4e3),x=u(f.attire||"",4e3),M=u(f.accessories||"",4e3),L=u(f.original||"",400),C=u(f.surname||"",200),$=u(f.given_name||"",200);if(f=en({...h,...f,id:h.id,name:h.name||f.name,aliases:y,original:s?L:L||h.original||"",appearance:n?v:v||h.appearance||"",attire:r?x:x||h.attire||"",accessories:a?M:M||h.accessories||"",surname:i?C:C||h.surname||"",given_name:o?$:$||h.given_name||"",surname_variants:Z(c?[...f.surname_variants||[],C]:[...h.surname_variants||[],...f.surname_variants||[],C,h.surname]),given_name_variants:Z(l?[...f.given_name_variants||[],$]:[...h.given_name_variants||[],...f.given_name_variants||[],$,h.given_name]),attire_locked:Ke(t,"attire_locked")?de(f.attire_locked):de(h.attire_locked),accessories_locked:Ke(t,"accessories_locked")?de(f.accessories_locked):de(h.accessories_locked),priority:Math.max(Number(h.priority||0),Number(f.priority||0))}),!f)return null}const _=Date.now()/1e3;if(await z("characters",{scope:d,id:f.id,name:f.name,aliases:f.aliases,surname:f.surname||"",given_name:f.given_name||"",surname_variants:f.surname_variants||[],given_name_variants:f.given_name_variants||[],priority:Number(f.priority||0),attire_locked:de(f.attire_locked),accessories_locked:de(f.accessories_locked),schema_version:2,appearance:f.appearance,attire:f.attire,accessories:f.accessories||"",original:f.original||"",gender:Qt(f.gender??f.sex),updated_at:_}),d!=="__global__"){const y=`appearance:${d}`,v=(await D("meta",y))?.value||{},x=Dn(f);x?v[f.name]=x:delete v[f.name],await z("meta",{key:y,value:v,updated_at:_})}else(r||a)&&await bm(f,{clearAttire:r,clearAccessories:a});return f}async function bm(e,{clearAttire:t=!0,clearAccessories:n=!0}={}){if(!e||!t&&!n)return 0;const r=s=>!s||s.scope==="__global__"||ue(s)?!1:!!oo(s,e);let a=0;try{const s=await Ae("characters");for(const i of s||[]){if(!r(i))continue;const o=t?"":i.attire||"",c=n?"":i.accessories||"";(i.attire||"")===o&&(i.accessories||"")===c||(await z("characters",{...i,attire:o,accessories:c,updated_at:Date.now()/1e3}),a+=1)}}catch{}return a}async function jr(e,t){const n=u(e,200)||"__global__",r=u(t,80);if(!r)return!1;const a=await D("characters",{scope:n,id:r});if(await Ct("characters",{scope:n,id:r}),n!=="__global__"&&a?.name){const s=`appearance:${n}`,i={...(await D("meta",s))?.value||{}};delete i[a.name],await z("meta",{key:s,value:i,updated_at:Date.now()/1e3})}return!0}var wm=(e,t)=>!!oo(e,t);function vc(e){return(Array.isArray(e)?e:[]).filter(t=>{if(!t||typeof t!="object")return!1;const n=t;return!!(n.id||n.name)})}async function vm(e,t,n=""){const r=vc(t);if(!r.length)return{deleted:0,sessions:0};const a=u(n,200),s=new Set;let i=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||s.has(l))continue;s.add(l);const f=await oe(l);let d=!1;for(const p of f)r.some(m=>wm(p,m))&&(await jr(l,p.id),i+=1,d=!0);d&&(o+=1)}return{deleted:i,sessions:o}}async function xc(e,t,n=""){const r=vc(t);if(!r.length)return{updated:0,sessions:0};const a=u(n,200),s=new Set;let i=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||s.has(l))continue;s.add(l);const f=await oe(l);let d=!1;for(const p of r){const m=Se(p.name,f)||(Array.isArray(p.aliases)?p.aliases.map(g=>Se(g,f)).find(Boolean):null)||(u(p.id,80)?f.find(g=>u(g.id,80)===u(p.id,80)):null);m&&await ft(l,{...p,id:m.id,name:m.name||p.name,appearance:p.appearance!=null?p.appearance:"",attire:p.attire!=null?p.attire:"",accessories:p.accessories!=null?p.accessories:"",original:p.original!=null?p.original:""})&&(i+=1,d=!0)}d&&(o+=1)}return{updated:i,sessions:o}}async function Wn(e,t,n={}){const r=u(e,200)||"__global__",a=n.prune===!0,s=Array.isArray(n.rootSessionIds)?n.rootSessionIds:[],i=Sa(t||[]);if(s.length){if(a){const c=new Set;for(const l of i){for(const d of Rn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of s){const f=u(l,200);if(!(!f||f==="__global__"))for(const d of await oe(f)){const p=[...Rn(d)],m=U(d.name);m&&p.push(m),!p.some(g=>c.has(g))&&await jr(f,d.id)}}}return i.length&&await xc(s,i,""),ts(i.map(c=>en(c)).filter(c=>!!c))}const o=[];for(const c of i){const l=await ft(r,c);l&&o.push(l)}if(a){const c=new Set(o.map(l=>u(l.id,80)).filter(Boolean));for(const l of await oe(r)){const f=u(l.id,80);f&&!c.has(f)&&await jr(r,f)}}return o}async function qn(e,t=""){const n=u(e,200),r=u(t,200),a=n?await oe(n):[],s=r?await rs(r):new Set,i=[];for(const o of await oe(rt)){const c={...o};c.enabled_for_character=r?!ns(o,s):!0,i.push(c)}return{ok:!0,session_id:n,character_id:r,characters:a,global:i,appearance:Object.fromEntries(a.map(o=>[o.name,Dn(o)])),disabled_globals:[...s].sort(),global_enabled:r?await _m(r):{}}}async function kc(e,t,n=!0){const r=u(e,200);if(!r)return{ok:!1,error:{code:"bad_request",message:"target_session_id required"}};const a=[],s=new Set;for(const l of t||[]){const f=u(l,200);!f||s.has(f)||(s.add(f),a.push(...await oe(f)))}n&&!s.has(r)&&a.push(...await oe(r));const i=Sa(a),o=[];for(const l of i){const f=Se(l.name,await oe(r)),d=await ft(r,{...l,id:f?.id||l.id,priority:Math.max(Number(f?.priority||0),Number(l.priority||0))});d&&o.push(d)}const c=new Set;for(const l of o){for(const d of Rn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of await oe(r)){const f=[...Rn(l)],d=U(l.name);d&&f.push(d),!f.some(p=>c.has(p))&&await jr(r,l.id)}return{...await qn(r),ok:!0,merged:o.length,sources:[...s]}}async function xm(e){return Object.fromEntries((await oe(e)).map(t=>[t.name,Dn(t)]))}async function km(e,t){return await Wn(e,Object.entries(t||{}).map(([n,r])=>({name:n,tags:r}))),{ok:!0,appearance:await xm(e)}}async function Sc(e){const{sessionId:t,tagged:n,shotChars:r}=e,a=e.unifiedSessionId??"",s=e.sourceSessionIds??[],i=u(e.characterId||"",200),o=u(t||"",200),c=()=>Gn(t,a,i,s);let l=await c();const f=[...n.new_characters||[]],d=new Set(f.map(m=>U(m?.name))),p=(m,g=null)=>({surname:u(m?.surname||g?.surname||"",200),given_name:u(m?.given_name||g?.given_name||"",200),surname_variants:Z([...Cr(g?.surname_variants),...Cr(m?.surname_variants),m?.surname,g?.surname]),given_name_variants:Z([...Cr(g?.given_name_variants),...Cr(m?.given_name_variants),m?.given_name,g?.given_name])});for(const m of r||[]){const g=u(m.name,200);if(!g||d.has(U(g)))continue;const h=Se(g,l);h&&ue(h)||(f.push({name:h?.name||g,aliases:Z(m.aliases)||h?.aliases||[g],original:u(m.original||m.original_tag||h?.original||"",400),appearance:N(m.label,m.age,m.appearance,m.body),attire:u(m.attire||""),accessories:u(m.accessories||""),...p(m,h)}),d.add(U(g)))}typeof n=="object"&&(n.new_characters=f);for(const m of f){const g=en(m);if(!g)continue;const h=um();h.size&&(g.appearance=Ra(g.appearance,h),g.attire=Ra(g.attire,h),g.accessories=Ra(g.accessories,h));const _=Se(g.name,l),y=u(g.appearance||""),v=u(g.attire||""),x=u(g.accessories||""),M=p(g,_);if(_&&ue(_)){l=await c();continue}if(_&&!ue(_)){const L=_.scope==="__global__"?rt:_.scope||o,C=Z([..._.aliases||[],...g.aliases||[]]),$=y||_.appearance||"",F=_.original||g.original||"";await ft(L,{id:_.id||g.id,name:_.name||g.name,aliases:C.length?C:_.aliases||g.aliases,original:F,appearance:$,attire:v,accessories:x,attire_locked:de(_.attire_locked),accessories_locked:de(_.accessories_locked),...M}),l=await c();continue}_||await ft(o,{...g,attire_locked:de(g.attire_locked),accessories_locked:de(g.accessories_locked)}),l=await c()}for(const m of r||[]){const g=u(m.name,200);if(g){if(Se(g,l)){l=await c();continue}{const h=N(m.label,m.age,m.appearance||"",m.body||""),_=u(m.attire||""),y=u(m.accessories||"");await ft(o,{name:g,aliases:Z(m.aliases)||[g],original:u(m.original||m.original_tag||"",400),appearance:h,attire:_,accessories:y,attire_locked:!0,accessories_locked:!0,...p(m,null)})}l=await c()}}return c()}async function Sm(){if((await Ae("characters")).length)return;const e=(await Ae("meta")).filter(t=>t.key?.startsWith("appearance:"));if(e.length)for(const t of e){const n=t.key.slice(11),r=t.value||{};for(const[a,s]of Object.entries(r)){const i=en({name:a,tags:s},a);i&&await ft(n,i)}}}async function Am(){const e=await Ae("characters");for(const t of e){if(Number(t.schema_version||0)>=2)continue;const n=en(t);n&&await z("characters",{...t,...n,scope:t.scope,updated_at:t.updated_at||Date.now()/1e3})}}function Ac(e){if(e==null||e==="")return null;const t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:null}function Mm(e,t){let n=Number(e.cfg_scale??7),r=Number(e.cfg_rescale??.36);if(Number.isFinite(n)||(n=7),Number.isFinite(r)||(r=.36),t){const a=Ac(t.cfg_scale);a!=null&&(n=a);const s=Ac(t.cfg_rescale);s!=null&&(r=s)}return{cfg_scale:n,cfg_rescale:r}}function Mc(e){if(!e||e.length<22)return!1;const t=Math.max(0,e.length-65536);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=e[n+20]|e[n+21]<<8;if(n+22+r<=e.length)return!0}return!1}function dt(e,t){return e[t]|e[t+1]<<8}function ln(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function as(e){const t=Math.max(0,e.length-65536-22);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=dt(e,n+20);if(n+22+r<=e.length)return n}return-1}function Nm(e){const t=as(e);if(t<0)return null;const n=ln(e,t+16);if(n+46>e.length||e[n]!==80||e[n+1]!==75||e[n+2]!==1||e[n+3]!==2)return null;const r=dt(e,n+10),a=ln(e,n+20),s=ln(e,n+24),i=ln(e,n+42);if(i+30>e.length||e[i]!==80||e[i+1]!==75||e[i+2]!==3||e[i+3]!==4)return null;const o=dt(e,i+26),c=dt(e,i+28),l=i+30+o+c;return l+a>e.length?null:{source:"central_dir",compMethod:r,compSize:a,uncompSize:s,dataStart:l,compData:e.subarray(l,l+a)}}function Im(e){const t=dt(e,6),n=dt(e,8);let r=ln(e,18);const a=dt(e,26),s=dt(e,28),i=30+a+s;if((t&8)!==0||r===0){let o=-1;for(let c=i+4;c<e.length-3;c+=1){if(e[c]!==80||e[c+1]!==75)continue;const l=e[c+2];if(l===7||l===1||l===5){o=c;break}}if(o<0){const c=as(e);c>i&&(o=c)}if(o<0)throw new Error("ZIP 데이터 경계를 찾지 못했습니다 (local header bit3)");r=o-i}if(i+r>e.length)throw new Error(`ZIP 엔트리 길이 초과 (need ${i+r}, have ${e.length})`);return{source:"local_header",compMethod:n,compSize:r,uncompSize:ln(e,22),dataStart:i,compData:e.subarray(i,i+r)}}async function Em(e){if(typeof DecompressionStream!="function")throw new Error("DecompressionStream 미지원 — ZIP deflate를 풀 수 없습니다");const t=ee(e);w("nai.inflate.start",{message:`${t.length}B`,bytes:t.length,focus:!0});const n=new DecompressionStream("deflate-raw"),r=n.writable.getWriter(),a=n.readable.getReader(),s=[];let i=0;const o=Date.now()+2e4,c=(async()=>{for(;;){if(Date.now()>=o)throw new Error(`ZIP inflate 타임아웃 (out=${i}B)`);const{done:d,value:p}=await a.read();if(d)break;p&&(s.push(p),i+=p.length,i>0&&i%524288<p.length&&w("nai.inflate",{message:`out ${Math.round(i/1024)}KB`,bytes:i,focus:!0}))}})(),l=131072;for(let d=0;d<t.length;d+=l){if(Date.now()>=o){try{await r.abort()}catch{}throw new Error(`ZIP inflate write 타임아웃 (in=${d}B)`)}await r.write(t.subarray(d,Math.min(t.length,d+l))),d>0&&d%(l*4)===0&&await at(0)}await r.close(),await c;const f=jn(s,i);return w("nai.inflate.done",{bytes:i,focus:!0}),f}async function Cm(e){const t=ee(e);if(w("nai.unzip.start",{message:`${t.length}B`,bytes:t.length,focus:!0}),vt(t))return w("nai.unzip",{message:"raw PNG",bytes:t.length,focus:!0}),ne(t);if(t.length<30||t[0]!==80||t[1]!==75){const a=Array.from(t.subarray(0,16)).map(s=>s.toString(16).padStart(2,"0")).join(" ");throw new Error(`ZIP/PNG 응답이 아닙니다 (len=${t.length}, head=${a})`)}const n=Nm(t)??Im(t);w("nai.unzip.entry",{message:`${n.source} method=${n.compMethod} comp=${n.compSize}B uncomp=${n.uncompSize||"?"}`,comp_method:n.compMethod,bytes:n.compSize,source:n.source,focus:!0});const r=as(t);if(r>=0&&n.dataStart+n.compSize>r&&(w("nai.unzip.clamp",{message:`comp ${n.compSize} → ${r-n.dataStart}`,focus:!0},"warn"),n.compSize=r-n.dataStart,n.compData=t.subarray(n.dataStart,r)),n.compSize<=0)throw new Error("ZIP 압축 페이로드가 비어 있습니다");if(n.compMethod===0)return ne(n.compData);if(n.compMethod===8){const a=await Em(n.compData);return!vt(a)&&!(a[0]===82&&a[1]===73)&&w("nai.unzip",{message:"inflated but not PNG/RIFF magic",bytes:a.length},"warn"),ne(a)}throw new Error(`지원하지 않는 ZIP 압축 방식: ${n.compMethod}`)}var Nc=T((()=>{Y(),te(),wt()}));function jm(e="force"){return Ne?(Ne.forceFinish(e),!0):!1}async function Je(e,t={}){const n=Ee()?.nativeFetch,r=n||globalThis.fetch,a=n?"nativeFetch":"fetch";if(typeof r!="function")throw new Error("fetch를 사용할 수 없습니다");const s={...t};s.networkRoute==null&&delete s.networkRoute;const i=_e("net.fetch");w("net.fetch.start",{message:a,url:String(e).slice(0,120),has_signal:!!s.signal});try{const o=await r(e,s),c=Number(o?.status||(o?.ok===!1?0:200));return i.end({message:a,status:c,url:String(e).slice(0,80)}),o}catch(o){throw i.fail(o,{message:a,url:String(e).slice(0,80)}),o}}async function un(e,t={}){if(!e)throw new Error("빈 응답");const n=Number(t.deadline||Date.now()+Number(t.timeoutMs||9e4)),r=t.signal||null,a=typeof t.onProgress=="function"?t.onProgress:null,s=Number(t.idleMs||2500),i=(d=0)=>{if(r?.aborted)throw new Error(`NAI 본문 읽기 중단 (abort, ${d}B)`);if(Date.now()>=n)throw new Error(`NAI 본문 읽기 타임아웃 (${d}B received)`)};if(e instanceof ArrayBuffer)return e;if(e instanceof Uint8Array)return ne(e);if(typeof e=="string"){const d=e.replace(/\s+/g,"");if(d.length>64&&/^[A-Za-z0-9+/=]+$/.test(d))return w("nai.read_bytes",{message:"string base64 body",bytes:d.length,focus:!0}),ne(Le(d))}const o=e;if(o.buffer instanceof ArrayBuffer&&typeof o.byteLength=="number")return o.buffer.slice(o.byteOffset||0,(o.byteOffset||0)+o.byteLength);const c=e;if(e&&typeof e=="object"&&"data"in e&&!c.arrayBuffer&&!c.body)return un(c.data,t);let l=null;try{const d=c.headers,p=d?.get?.("content-length")||d?.get?.("Content-Length")||null;p&&(l=Number(p))}catch{}if(l!=null&&l>0&&(Tr=l),w("nai.read_bytes.start",{message:"begin body",content_length:l,has_arrayBuffer:typeof c.arrayBuffer=="function",has_body_reader:!!(c.body&&typeof c.body.getReader=="function"),keys:e&&typeof e=="object"?Object.keys(e).slice(0,12).join(","):typeof e,focus:!0}),c.body&&typeof c.body.getReader=="function"){const d=c.body.getReader(),p=[];let m=0,g=Date.now(),h=Date.now(),_=!1,y=null;Ne={forceFinish:(x="force")=>{_=!0,w("nai.read_bytes.force",{message:x,bytes:m||l||0,focus:!0});try{d.cancel()}catch{}y&&y({done:!0,value:void 0,__forced:!0})}};try{for(;i(m),!_;){if(m>=64&&Date.now()-g>=s){w("nai.read_bytes.idle_complete",{message:`${s}ms idle`,bytes:m,focus:!0});break}if(l!=null&&l>0&&m>=l){w("nai.read_bytes.length_complete",{bytes:m,content_length:l,focus:!0});break}const x=await new Promise(($,F)=>{let k=!1;const I=(J,A)=>{k||(k=!0,clearInterval(P),y=null,A?F(A):$(J))};y=J=>I(J,null);const P=setInterval(()=>{if(!k){if(_)return I({done:!0,value:void 0,__forced:!0},null);if(m>=64&&Date.now()-g>=s)return I({done:!0,value:void 0,__idle:!0},null);if(l!=null&&l>0&&m>=l)return I({done:!0,value:void 0,__length:!0},null);if(r?.aborted||Date.now()>=n)return d.cancel().catch(()=>{}),I(null,new Error(`NAI 본문 읽기 타임아웃 (${m}B received)`))}},200);d.read().then(J=>I(J,null),J=>I(null,J))});if(x?.__forced||x?.__idle||x?.__length)break;const{done:M,value:L}=x;if(M)break;if(!L)continue;const C=L instanceof Uint8Array?L:new Uint8Array(L);if(p.push(C),m+=C.length,g=Date.now(),$r=g,Me=m,a&&a(m,l),Date.now()-h>=2e3&&(h=Date.now(),w("nai.read_bytes.progress",{message:`${Math.round(m/1024)}KB`,bytes:m,content_length:l,focus:!0})),Mc(jn(p,m))&&Date.now()-g>=600){w("nai.read_bytes.zip_eocd",{bytes:m,focus:!0});break}if(l!=null&&l>0&&m>=l)break}}catch(x){if(m>=64){const M=jn(p,m);if(Mc(M)||l!=null&&l>0&&m>=l*.98)return w("nai.read_bytes.recover",{message:String(x?.message||x),bytes:m,focus:!0},"warn"),Ne=null,ne(M)}try{await d.cancel()}catch{}throw Ne=null,x}if(Ne=null,!m)throw new Error("NAI 본문이 비어 있습니다");const v=jn(p,m);return w("nai.read_bytes.done",{bytes:m,focus:!0}),ne(v)}const f=c.arrayBuffer;if(typeof f=="function"){w("nai.read_bytes",{message:"fallback arrayBuffer() — no body stream",focus:!0});let d=!1,p,m;const g=new Promise((y,v)=>{p=y,m=v});Ne={forceFinish:(y="force")=>{w("nai.read_bytes.force",{message:`${y} (arrayBuffer)`,content_length:l,focus:!0},"warn"),d||(d=!0,clearInterval(h),m(new Error(`NAI arrayBuffer 강제중단 (${y}, content-length=${l})`)))}};const h=setInterval(()=>{d||(r?.aborted||Date.now()>=n?(d=!0,clearInterval(h),Ne=null,m(new Error(`NAI arrayBuffer 타임아웃 (content-length=${l}). 본문 ~${l?Math.round(l/1024):"?"}KB를 플러그인이 받지 못했습니다.`))):w("nai.read_bytes.wait",{message:`arrayBuffer pending · expect ${l?Math.round(l/1024):"?"}KB`,content_length:l,focus:!0},"warn"))},3e3);f.call(c).then(y=>{d||(d=!0,clearInterval(h),Ne=null,p(y))}).catch(y=>{d||(d=!0,clearInterval(h),Ne=null,m(y))});const _=await g;if(_&&_.byteLength)return Me=_.byteLength,w("nai.read_bytes.done",{bytes:_.byteLength,focus:!0}),_}if(typeof c.bytes=="function"){const d=await c.bytes();if(d?.length)return ne(d)}if(typeof c.text=="function"){const d=await c.text();if(/^[A-Za-z0-9+/=\s]+$/.test(d)&&d.replace(/\s+/g,"").length>64)try{return ne(Le(d.replace(/\s+/g,"")))}catch{}throw new Error(`바이너리 본문을 읽지 못함 (text head=${String(d).slice(0,120)})`)}throw new Error("바이너리 본문을 읽지 못함")}async function Tm(e,t,n,r={}){const a={Authorization:`Bearer ${e}`,"Content-Type":"application/json"},s=Number(r.timeoutMs||75e3),i=r.signal||null,o=JSON.stringify(t);if(w("nai.payload",{message:`body ${Math.round(o.length/1024)}KB`,bytes:o.length,model:t?.model,timeout_ms:s,url:String(n||"https://image.novelai.net/ai/generate-image").slice(0,100),has_nativeFetch:ve("nativeFetch")}),o.length>15e5)throw w("nai.payload",{message:"too large",bytes:o.length},"error"),new Error(`NAI 페이로드가 너무 큼 (${Math.round(o.length/1024)}KB). 참조 이미지/프롬프트를 줄이세요.`);const c=typeof AbortController<"u"?new AbortController:null,l=()=>{w("nai.abort",{message:"external signal"},"warn"),c?.abort()};if(i){if(i.aborted)throw new Error("NAI 요청이 취소되었습니다.");i.addEventListener("abort",l,{once:!0})}const f=Date.now();Me=0,Tr=0,$r=0,ss=!0;const d=setInterval(()=>{const m=Date.now()-f;m>=s?(w("nai.watchdog",{message:`abort after ${m}ms · body=${Me}B`,ms:m,bytes:Me},"warn"),c?.abort()):m>0&&m%1e4<1100&&w("nai.wait",{message:`waiting ${Math.round(m/1e3)}s · body=${Me}B · ${yt()}`,ms:m,bytes:Me,focus:!0},"warn")},1e3);let p=null;try{try{w("nai.fetch.start",{message:"POST generate-image",timeout_ms:s,focus:!0});const m=await Je(n||"https://image.novelai.net/ai/generate-image",{method:"POST",headers:a,body:o,signal:c?.signal,requestTimeoutMs:s});if(w("nai.fetch.returned",{message:"nativeFetch resolved",ms:Date.now()-f,status:Number(m?.status||0),focus:!0}),i?.aborted||c?.signal?.aborted)throw w("nai.fetch.aborted",{ms:Date.now()-f},"error"),new Error(`NAI 타임아웃 (${Math.round(s/1e3)}s) — nativeFetch가 응답하지 않습니다. Models에서 NAI Test를 확인하세요.`);const g={signal:c?.signal,deadline:f+s,onProgress:v=>{Me=v}};if(m&&typeof m=="object"&&"ok"in m&&"data"in m&&!m.arrayBuffer){const v=Number(m.status||(m.ok?200:0));if(w("nai.resp.shape",{message:"ok/data shape",status:v,focus:!0}),v===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(v===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(v>=400){const L=typeof m.data=="string"?m.data:m.data instanceof Uint8Array?new TextDecoder().decode(m.data.subarray(0,220)):JSON.stringify(m.data||{}).slice(0,220);throw new Error(`NAI HTTP ${v}: ${L}`)}const x=_e("nai.read_bytes"),M=await un(m.data,g);if(x.end({bytes:M?.byteLength||0,focus:!0}),!M||M.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${M?.byteLength||0} bytes)`);return M}const h=Number(m?.status||0);if(w("nai.resp.shape",{message:"Response-like",status:h,has_arrayBuffer:typeof m?.arrayBuffer=="function",has_body:!!m?.body,focus:!0}),h===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(h===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(h>=400){let v="";try{v=await m.text()}catch{}throw new Error(`NAI HTTP ${h}: ${v.slice(0,220)}`)}const _=_e("nai.read_bytes"),y=await un(m,g);if(_.end({bytes:y?.byteLength||0,status:h,focus:!0}),!y||y.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${y?.byteLength||0} bytes)`);return y}catch(m){throw p=String(m?.message||m),w("nai.fetch.error",{message:p,ms:Date.now()-f,bytes:Me},"error"),/abort|timeout|타임아웃|취소|본문 읽기/i.test(p)?new Error(`NAI 타임아웃/본문실패 (${Math.round(s/1e3)}s, body=${Me}B). ${p.slice(0,180)}`):m instanceof Error?m:new Error(p)}}finally{ss=!1,clearInterval(d),i&&i.removeEventListener("abort",l)}}var Me,Tr,$r,Ne,ss,is,Ic,Ec,Cc,Ft=T((()=>{re(),Y(),_t(),te(),Nc(),Me=0,Tr=0,$r=0,Ne=null,ss=!1,is=()=>Me,Ic=()=>Tr,Ec=()=>$r,Cc=()=>Ne!==null}));function Vn(e){return u(e?.backend||"nai").toLowerCase()==="comfy"?"comfy":"nai"}function $m(e){const t=Number(e?.backend_timeout_seconds??300);return Math.max(30,Math.min(1800,Number.isNaN(t)?300:t))*1e3}function Pr(e){return String(e||"").trim().replace(/\/+$/,"")}function jc(e){return Pr(u(e?.comfy_url))||"http://localhost:8188"}function os(e){return!!u(e?.comfy_workflow_json)}async function cs(e,t={}){const n=await Je(e,t);if(n&&typeof n=="object"&&"ok"in n&&"data"in n&&typeof n.arrayBuffer!="function"){const s=Number(n.status||(n.ok?200:0));let i=n.data;if(i instanceof Uint8Array&&(i=new TextDecoder().decode(i)),typeof i=="string")try{i=JSON.parse(i)}catch{}return{status:s,data:i}}const r=Number(n?.status||0);let a=null;try{a=await n.json()}catch{try{a=JSON.parse(await n.text())}catch{}}return{status:r,data:a}}async function Pm(e,t,n={}){const r=`inlay-nexus-${Math.random().toString(36).slice(2,10)}`,{status:a,data:s}=await cs(`${Pr(e)}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:r,prompt:t}),signal:n.signal});if(a>=400||!s?.prompt_id){const i=s?JSON.stringify(s.node_errors||s.error||s).slice(0,300):"";throw new Error(`/prompt 제출 실패 (HTTP ${a}) ${i}`)}return String(s.prompt_id)}async function Om(e,t,n={}){const r=Pr(e),a=Number(n.timeoutMs||3e5),s=Date.now()+a;let i=0,o="";for(;Date.now()<s;){if(n.signal?.aborted)throw new Error("이미지 대기 중단 (abort)");await at(2500),i+=1;let c=null;try{const{status:d,data:p}=await cs(`${r}/history/${t}`,{method:"GET",signal:n.signal});d<400&&p&&p[t]&&(c=p[t])}catch(d){o=String(d?.message||d);continue}if(i%8===0&&w("comfy.poll",{message:`${i}회 · ${Math.round((Date.now()-(s-a))/1e3)}s`,focus:!0}),!c)continue;const l=c.status||{};if(l.status_str==="error")throw new Error(`생성 실패: ${JSON.stringify(l.messages||[]).slice(0,400)}`);const f=c.outputs||{};for(const d of Object.keys(f)){const p=f[d]?.images;if(Array.isArray(p)&&p.length)return p.find(m=>(m?.type||"output")!=="temp")||p[0]}if(l.completed)throw new Error("생성은 완료됐지만 출력 이미지가 없습니다 (SaveImage 노드 확인)")}throw new Error(`이미지 대기 타임아웃 (${Math.round(a/1e3)}s)${o?` · ${o}`:""}`)}async function Lm(e,t,n={}){const r=new URLSearchParams({filename:u(t?.filename,300),subfolder:u(t?.subfolder,300),type:u(t?.type,40)||"output"}),a=await Je(`${Pr(e)}/view?${r.toString()}`,{method:"GET",signal:n.signal}),s={signal:n.signal,deadline:Date.now()+6e4};if(a&&typeof a=="object"&&"ok"in a&&"data"in a&&!a.arrayBuffer){const o=Number(a.status||(a.ok?200:0));if(o>=400)throw new Error(`/view 실패 (HTTP ${o})`);return un(a.data,s)}const i=Number(a?.status||0);if(i>=400)throw new Error(`/view 실패 (HTTP ${i})`);return un(a,s)}function Bm(e,t){let n=String(e||"");for(let r=0;r<8;r+=1){const a=n.replace(/\[\[#(\w+)\]\]([\s\S]*?)\[\[\/\1\]\]/g,(s,i,o)=>{const c=t[i];return c!=null&&String(c).trim()!==""?o:""});if(a===n)break;n=a}return n.replace(/[ \t]+\n/g,`
`).replace(/\n{3,}/g,`

`)}function Rm(e,t){for(const n of Object.values(e)){const r=n?.inputs;if(!(!r||typeof r!="object"))for(const a of Object.keys(r)){const s=r[a];if(typeof s!="string"||!s.includes("[["))continue;const i=Bm(s,t),o=i.match(/^\[\[\s*(\w+)\s*\]\]$/);if(o&&o[1]in t){r[a]=t[o[1]];continue}r[a]=i.replace(/\[\[\s*(\w+)\s*\]\]/g,(c,l)=>l in t?String(t[l]):c)}}}function Fm(e,t){const n=Number(t)||1;for(const r of Object.values(e)){const a=r?.inputs;if(!(!a||typeof a!="object"))for(const s of Object.keys(a)){if(!/^(seed|noise_seed)$/i.test(s))continue;const i=a[s];(typeof i=="number"&&Number.isFinite(i)||typeof i=="string"&&/^\d+$/.test(i.trim()))&&(a[s]=n)}}}function Tc({main:e,neg:t,captions:n,nai:r,seed:a}){const s={pos:String(e||""),neg:String(t||""),width:Number(r.width??832)||832,height:Number(r.height??1216)||1216,seed:Number(a)||1,steps:Number(r.steps??28)||28,cfg:Number(r.cfg_scale??7)||7};for(let i=0;i<6;i+=1)s[`char${i+1}`]=u(n?.[i]?.prompt,2e3);return s}function Dm(e){let t=String(e||"");return t=t.replace(/(:\s*)\[\[\s*(\w+)\s*\]\](\s*[,}\]])/g,'$1"[[$2]]"$3'),t}function $c(e,t){const n=u(e);if(!n)throw new Error("ComfyUI 워크플로 JSON이 비어 있습니다. Models 탭에 API Export JSON을 붙여넣으세요.");let r;const a=Dm(n);try{r=JSON.parse(a)}catch(o){const c=/\[\[/.test(n)?' · 팁: [[seed]] 같은 값은 반드시 "[[seed]]"처럼 따옴표로 감싸세요.':"";throw new Error(`ComfyUI 워크플로 JSON 파싱 실패: ${String(o?.message||o).slice(0,120)}${c}`)}if(!r||typeof r!="object"||Array.isArray(r))throw new Error("ComfyUI 워크플로는 API 포맷(JSON 객체, 노드ID→노드)이어야 합니다.");let s=r;if(s.nodes&&s.links)throw new Error("UI 저장 포맷 워크플로입니다. ComfyUI에서 'Export (API)'로 내보낸 JSON을 넣으세요.");const i=JSON.stringify(s);if(!/\[\[\s*pos\s*\]\]/.test(i))throw new Error("워크플로에 [[pos]]가 없습니다. 긍정 프롬프트를 넣는 칸에 [[pos]]를 적어 주세요.");return s=JSON.parse(i),Rm(s,t),Fm(s,t.seed),s}async function zm(e,t,n,r){const a=jc(e),s=$m(e),i=Number(e.seed??0)||Math.floor(Math.random()*4294967295)||1,o=Tc({main:t,neg:n,captions:r,nai:e,seed:i}),c=$c(e.comfy_workflow_json,o);return w("comfy.generate.start",{message:a,prompt_len:String(t||"").length,chars:(r||[]).length,nodes:Object.keys(c).length,focus:!0}),Pc.run(async()=>{const l=await Pm(a,c);w("comfy.generate.submitted",{message:l.slice(0,8),focus:!0});const f=await Om(a,l,{timeoutMs:s}),d=await Lm(a,f);if(w("comfy.generate.done",{bytes:d?.byteLength||0,focus:!0}),!d||d.byteLength<256)throw new Error(`ComfyUI 응답 이미지가 너무 짧음 (${d?.byteLength||0}B)`);return[d,i]})}var Pc,ls=T((()=>{Y(),wt(),B(),Ft(),Pc=new gr}));ls(),Xu(),te(),B();var us=Mi;function Ve(e,t=!1){let n=us[String(e).toLowerCase()]||e;return t&&(n+="-inpainting"),n}function Um(e){const t=[],n=[];for(const r of e.characters||[]){const a={x:r.center_x,y:r.center_y};t.push({char_caption:r.prompt,centers:[a]}),n.push({char_caption:r.uc||"",centers:[a]})}return{autoSmea:!0,prefer_brownian:!0,ucPreset:0,use_coords:!1,legacy_uc:!1,add_original_image:!0,v4_prompt:{caption:{base_caption:e.prompt,char_captions:t},use_coords:!1,use_order:!0},v4_negative_prompt:{caption:{base_caption:e.negative_prompt,char_captions:n},legacy_uc:!1}}}function Hm(e){const t=Ve(e.model),n={width:e.width,height:e.height,n_samples:1,seed:e.seed,extra_noise_seed:e.seed,sampler:e.sampler,steps:e.steps,scale:e.cfg_scale,negative_prompt:e.negative_prompt,cfg_rescale:e.cfg_rescale,noise_schedule:e.scheduler,params_version:3,legacy:!1,legacy_v3_extend:!1};if(e.var_plus?n.skip_cfg_above_sigma=t.includes("4-5")?58:19:n.skip_cfg_above_sigma=null,t.includes("nai-diffusion-4")&&Object.assign(n,Um(e)),e.vibes?.length&&(n.reference_image_multiple=e.vibes.map(r=>r.encoded),n.reference_strength_multiple=e.vibes.map(r=>r.strength),n.reference_information_extracted_multiple=e.vibes.map(r=>r.information_extracted),n.normalize_reference_strength_multiple=!0),e.character_refs?.length){if(!t.includes("4-5"))throw new Error("Character Reference는 NAID4.5 전용입니다");n.director_reference_images=e.character_refs.map(r=>Yt(r.image)),n.director_reference_strength_values=e.character_refs.map(r=>r.strength),n.director_reference_secondary_strength_values=e.character_refs.map(r=>1-r.fidelity),n.director_reference_descriptions=e.character_refs.map(r=>({caption:{base_caption:r.type,char_captions:[]},legacy_uc:!1})),n.director_reference_information_extracted=e.character_refs.map(()=>1),n.controlnet_strength=1,n.inpaintImg2ImgStrength=1,n.normalize_reference_strength_multiple=!0,delete n.skip_cfg_above_sigma}return n}function Ye(e){const t=u(e)||"nai-diffusion-4-5-full",n=Object.fromEntries(Object.entries(us).map(([r,a])=>[a,r]));return us[t]?t:n[t]?n[t]:"naid4.5f"}re(),Y(),wt(),te(),Nc(),Ft();var Km=new gr;async function Oc(e,t,n,r={}){const a={input:t.prompt,model:Ve(t.model),action:"generate",parameters:Hm(t)};return w("nai.generate.start",{message:a.model,prompt_len:String(t.prompt||"").length,chars:(t.characters||[]).length,has_char_refs:!!t.character_refs?.length,has_vibes:!!t.vibes?.length}),Km.run(async()=>{const s=await Tm(e,a,n,r),i=_e("nai.unzip");try{const o=await Cm(new Uint8Array(s)),c=vt(new Uint8Array(o));return i.end({bytes:o?.byteLength||0,is_png:c,zip_bytes:s?.byteLength||0}),c||w("nai.unzip",{message:"unzipped but not PNG magic",bytes:o?.byteLength||0},"warn"),{raw_bytes:o,seed:t.seed||0}}catch(o){throw i.fail(o,{zip_bytes:s?.byteLength||0}),o}})}async function Jm(e){const t=await Je(ri,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),n=Number(t?.status||0);if(n===401)throw new Error("인증 실패 (401). API 토큰을 확인하세요.");if(n>=400)throw new Error(`Anlas 조회 실패: HTTP ${n}`);const r=await t.json(),a=r.trainingStepsLeft||{},s=a.fixedTrainingStepsLeft||0,i=a.purchasedTrainingSteps||0,o=r.perks?.unlimitedMaxPriority||!1;return{fixed:s,purchased:i,total:s+i,opus:o}}function Ie(e){return Number.isFinite(e)?Math.max(0,Math.min(100,e)):0}function Gm(e){if(!e)return null;for(const t of["y_percent","anchor_percent","read_percent"]){const n=Number(e[t]);if(Number.isFinite(n))return Ie(n)}return null}function Wm(e){const t=e.length;if(!t)return[];const n=e.map((a,s)=>({index:s,y:Gm(a)})).map((a,s)=>a.y!=null?a.y:t===1?50:Ie(s/Math.max(1,t-1)*100)).map((a,s)=>({y:a,index:s})).sort((a,s)=>a.y-s.y||a.index-s.index),r=Array.from({length:t},()=>({from_percent:0,to_percent:100}));for(let a=0;a<n.length;a++){const{y:s,index:i}=n[a],o=a>0?n[a-1].y:null,c=a<n.length-1?n[a+1].y:null;let l,f;o==null&&c==null?(l=Ie(s-fs),f=Ie(s+fs)):o==null?(l=0,f=Ie((s+c)/2)):c==null?(l=Ie((o+s)/2),f=100):(l=Ie((o+s)/2),f=Ie((s+c)/2)),f<l&&(f=l),f-l<1&&(l=Ie(s-.5),f=Ie(s+.5),f<l&&(f=l)),r[i]={from_percent:Math.round(l*100)/100,to_percent:Math.round(f*100)/100}}return r}function qm(e,t,n){const r=e.length;if(!r)return{start:0,end:0};const a=Ie(t),s=Ie(n);let i=Math.floor(r*a/100),o=Math.ceil(r*s/100);return o<i&&(o=i),o===i&&i<r&&(o=Math.min(r,i+1)),{start:Math.max(0,i),end:Math.min(r,o)}}function Vm(e,t,n,r=Bc){const a=typeof e=="string"?e:"";if(!a)return"";let{start:s,end:i}=qm(a,t,n);const o=a.lastIndexOf(`
`,s);o>=0&&s-o<=80&&(s=o+1);const c=a.indexOf(`
`,i);c>=0&&c-i<=80&&(i=c);let l=a.slice(s,i).trim();return l.length>r&&(l=`${l.slice(0,r).trimEnd()}…`),l}function Lc(e,t){return Wm(e).map(n=>({focus:n,focus_hint:Vm(t,n.from_percent,n.to_percent)}))}var fs,Bc,Ym=T((()=>{fs=15,Bc=600})),Xm,Rc,Fc,Dc,Zm=T((()=>{Xm=1,Rc="Inlay default (SFW)",Fc=[{id:"composition.solo",label:"솔로 구도",options:[{id:"1girl_solo_portrait",description:"여성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"1boy_solo_portrait",description:"남성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"solo_from_side",description:"혼자 옆모습",tags:"from side, cowboy shot"},{id:"solo_upper_body",description:"혼자 상반신 클로즈업",tags:"upper body, looking at viewer"}]},{id:"composition.duo",label:"2인 구도",options:[{id:"facing_each_other",description:"남녀가 서로를 향함",tags:"2::facing another::",slot:"char",by_slot:{female:"2::facing another::",male:"2::facing another::"}},{id:"male_behind_female",description:"남성이 여성 뒤",tags:"2::from side::, 2::side-by-side::, 2::behind another::"},{id:"side_by_side",description:"나란히 서 있음",tags:"2::side-by-side::, 2::from side::"},{id:"2girls_facing",description:"여성 둘이 마주봄",tags:"2::facing another::"},{id:"hug_front",description:"앞에서 안기",tags:"hug, facing another"}]},{id:"camera.framing",label:"카메라/프레이밍",options:[{id:"cowboy_shot",description:"허리 위",tags:"cowboy shot"},{id:"full_body",description:"전신",tags:"full body"},{id:"upper_body",description:"상반신",tags:"upper body"},{id:"close_up",description:"얼굴 클로즈업",tags:"close-up, face"},{id:"from_above",description:"위에서",tags:"from above"},{id:"from_below",description:"아래에서",tags:"from below"},{id:"from_side",description:"옆에서",tags:"from side"},{id:"pov",description:"1인칭 시점",tags:"pov, pov hands"}]},{id:"pose.hands",label:"손/포즈",options:[{id:"hand_on_own_chest",description:"자신의 가슴에 손",tags:"hand on own chest"},{id:"hands_up",description:"손 들기",tags:"hands up"},{id:"reaching_out",description:"손 뻗기",tags:"reaching out"},{id:"holding_hands",description:"손잡기",tags:"holding hands"},{id:"arm_around_waist",description:"허리에 팔",tags:"arm around waist"},{id:"hug_from_behind",description:"뒤에서 안기",tags:"hug from behind"}]},{id:"expression.basic",label:"표정",options:[{id:"smile",description:"미소",tags:"smile"},{id:"blush",description:"홍조",tags:"blush"},{id:"serious",description:"진지",tags:"serious"},{id:"open_mouth",description:"입 벌림",tags:"open mouth"},{id:"closed_eyes",description:"눈 감음",tags:"closed eyes"},{id:"looking_at_another",description:"상대를 봄",tags:"looking at another"}]},{id:"place.indoor",label:"실내 배경",options:[{id:"bedroom",description:"침실",tags:"bedroom, indoors"},{id:"classroom",description:"교실",tags:"classroom, indoors"},{id:"living_room",description:"거실",tags:"living room, indoors"},{id:"bathroom",description:"욕실",tags:"bathroom, indoors"},{id:"cafe",description:"카페",tags:"cafe, indoors"}]},{id:"place.outdoor",label:"야외 배경",options:[{id:"outdoors_day",description:"낮 야외",tags:"outdoors, blue sky"},{id:"street",description:"거리",tags:"street, outdoors"},{id:"park",description:"공원",tags:"park, outdoors, tree"},{id:"beach",description:"해변",tags:"beach, outdoors, ocean"},{id:"night_city",description:"밤 도시",tags:"outdoors, night, cityscape"}]}],Dc={version:1,name:Rc,groups:Fc}}));function Yn(e){return e?e.has_presets===!0?!0:e.presets!=null&&typeof e.presets=="object":!1}function Qm(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t={};for(const[n,r]of Object.entries(e)){const a=u(n,80);if(!a||!r||typeof r!="object"||Array.isArray(r))continue;const s=r,i=Array.isArray(s.fallback_order)?s.fallback_order.map(c=>u(c,160)).filter(Boolean):[],o=Math.max(1,Math.min(8,Number(s.max_active_groups)||1));i.length&&(t[a]={max_active_groups:o,fallback_order:i,...u(s.scope,40)?{scope:u(s.scope,40)}:{}})}return Object.keys(t).length?t:void 0}function zc(e,t){const n=u(e,160).toLowerCase(),r=u(t,160).toLowerCase();if(!n||!r)return!1;if(n.endsWith(".*")){const a=n.slice(0,-1);return r.startsWith(a)||r===n.slice(0,-2)}return n.endsWith("*")?r.startsWith(n.slice(0,-1)):r===n}function Uc(e){const t=Array.isArray(e)?e:u(e,800).split(/[,|]/),n=[],r=new Set;for(const a of t){const s=u(a,120);!s||r.has(s)||(r.add(s),n.push(s))}return n}function Hc(e,t){const n=Uc(t),r=e.modifier_lanes;if(!r||!Object.keys(r).length)return n;const a=new Map;for(const i of n){const o=dn(e,i);o&&a.set(i,o.group.id)}const s=new Set;for(const i of Object.values(r)){const o=new Set;for(const f of a.values())i.fallback_order.some(d=>zc(d,f))&&o.add(f);if(o.size<=i.max_active_groups)continue;const c=[...o].map(f=>{let d=i.fallback_order.length;for(let p=0;p<i.fallback_order.length;p++)if(zc(i.fallback_order[p],f)){d=p;break}return{gid:f,rank:d}});c.sort((f,d)=>f.rank-d.rank||f.gid.localeCompare(d.gid));const l=new Set(c.slice(0,i.max_active_groups).map(f=>f.gid));for(const{gid:f}of c)l.has(f)||s.add(f)}return s.size?n.filter(i=>{const o=a.get(i);return!o||!s.has(o)}):n}function ds(){return{base:"",char:"",primary:"",secondary:"",female:"",male:""}}function Dt(e,t){const n=u(t,40).toLowerCase();if(["char","character","actor"].includes(n))return"char";if(["primary","main"].includes(n))return"primary";if(["secondary","partner"].includes(n))return"secondary";if(["female","f","girl","woman"].includes(n))return"female";if(["male","m","boy","man"].includes(n))return"male";if(["base","global","scene","camera","place"].includes(n))return"base";const r=u(e,160).toLowerCase();return/^(pose|expression|gesture|emotion|contact|action|interaction|manual|relation|gaze)([./_]|$)/.test(r)||/\.(pose|expression|gesture|interaction|manual|contact)\b/.test(r)||/^composition\.(duo|pair|multi|group|couple)/.test(r)?"char":/^(place|camera|background|location|framing|view|lighting|scene)([./_]|$)/.test(r)||/^composition\./.test(r)?"base":/^state\./.test(r)?"char":"base"}function Kc(e){const t=u(e,200).toLowerCase();if(!t)return null;const n=t.split(".")[0]||"";return n==="global"||n==="scene"||n==="camera"?"base":n==="primary"?"primary":n==="secondary"?"secondary":n==="female"||n==="girl"||n==="woman"?"female":n==="male"||n==="boy"||n==="man"?"male":n==="persona"?"base":null}function ep(e){return e.trim().toLowerCase()==="global.composition"}function Jc(e){if(!e||typeof e!="object"||Array.isArray(e))return{};const t={};for(const[n,r]of Object.entries(e)){if(ep(n))continue;const a=Kc(n);if(!a)continue;const s=Xn(r);s&&(t[a]=N(t[a],s))}return t}function zt(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function Xn(e){if(typeof e=="string")return u(e,800);if(!Array.isArray(e)||!e.length)return"";const t=[];for(const n of e){if(typeof n=="string"){const s=u(n,200);s&&t.push(s);continue}if(!Array.isArray(n)||n.length<2)continue;const r=Number(n[0]),a=u(n[1],200);a&&(Number.isFinite(r)&&r!==1?t.push(`${r}::${a}::`):t.push(a))}return N(...t)}function tp(e,t,n){const r=zt(e);if(!r)return null;const a=u(r.id,120)||`opt_${t}`,s=Jc(r.prompt),i=zt(r.by_slot)||zt(r.slots)||zt(r.actors),o={...s};if(i){for(const d of["base","char","primary","secondary","female","male"]){const p=u(i[d],800);p&&(o[d]=N(o[d],p))}for(const[d,p]of Object.entries(i)){const m=Dt(n,d);typeof p=="string"&&u(p)&&(o[m]=N(o[m],u(p,800)))}}let c=u(r.tags??r.tag,800);if(c||(c=Array.isArray(r.prompt)?Xn(r.prompt):""),c||(c=u(typeof r.prompt=="string"?r.prompt:"",800)),!c&&Object.keys(o).length&&(c=N(...Object.values(o))),!c)return null;const l=Dt(n,r.slot??r.target??r.apply_to),f=Object.keys(o).length?o:void 0;return{id:a,description:u(r.description??r.label??r.when,400)||a,tags:c,slot:l,...f?{by_slot:f}:{}}}function Gc(e,t,n){const r=zt(e);if(!r)return null;const a=u(r.id,160)||`group_${t}`,s=u(r.label??r.name??r.description,200)||a,i=Array.isArray(r.options)?r.options:Array.isArray(r.include_options)?r.include_options:[],o=[];for(let c=0;c<i.length&&o.length<n;c++){const l=tp(i[c],c,a);l&&o.push(l)}return o.length?{id:a,label:s,options:o,...r.continuity===!0||r.continuity==="true"?{continuity:!0}:{}}:null}function np(e,t){const n=Array.isArray(e)?e:e&&typeof e=="object"?Object.values(e):[],r=[];for(let a=0;a<n.length;a++){const s=Gc(n[a],a,t);s&&r.push(s)}return r}function rp(e,t){return e.modifier_library!=null?{list:np(e.modifier_library,80),maxOptions:80,nameHint:"Asset Maid catalog",preNormalized:!0}:Array.isArray(e.groups)?{list:e.groups,maxOptions:80,nameHint:"",preNormalized:!1}:Array.isArray(t)?{list:t,maxOptions:80,nameHint:"",preNormalized:!1}:{list:[],maxOptions:10,nameHint:"",preNormalized:!1}}function ms(e,t="catalog"){const n=zt(e)||{},{list:r,maxOptions:a,nameHint:s,preNormalized:i}=rp(n,e),o=[];for(let C=0;C<r.length;C++){if(i){const F=r[C];if(F?.id&&Array.isArray(F.options)&&F.options.length){const k=F.options.slice(0,a).map((I,P)=>({...I,slot:I.slot||Dt(F.id,I.slot),id:I.id||`opt_${P}`,description:I.description||I.id||`opt_${P}`,tags:I.tags}));o.push({id:F.id,label:F.label||F.id,options:k,...F.continuity?{continuity:!0}:{}})}continue}const $=Gc(r[C],C,a);$&&o.push($)}if(!o.length)throw new Error("큐레이션 카탈로그에 그룹이 없습니다. Inlay `{groups:[…]}` 또는 Asset Maid `modifier_library` JSON인지 확인하세요.");const c=Number(n.version)||1,l=u(n.name,200)||s||t,f=n.presets!=null&&typeof n.presets=="object"?n.presets:void 0,d=Qm(n.modifier_lanes),p=zt(n.global)||{},m=Xn(p.fixed_positive)||u(p.fixed_positive??n.fixed_positive,800),g=Xn(p.fixed_negative)||u(p.fixed_negative??n.fixed_negative,800),h=n.subjects??p.subjects,_=n.selection??p.selection,y=p.prompt_order??n.prompt_order,v=Array.isArray(y)?y.map(C=>u(C,40)).filter(Boolean):void 0,x=new Set(o.filter(C=>C.continuity).map(C=>C.id)),M=n.continuity??p.continuity;if(Array.isArray(M))for(const C of M){const $=u(C,160);if(!$)continue;x.add($);const F=o.find(k=>k.id===$);F&&(F.continuity=!0)}const L={version:c,name:l,groups:o,...f?{presets:f,has_presets:!0}:{has_presets:!1},...d?{modifier_lanes:d}:{},...m?{fixed_positive:m}:{},...g?{fixed_negative:g}:{},...h!=null&&typeof h=="object"?{subjects:h}:{},..._!=null&&typeof _=="object"?{selection:_}:{},...v?.length?{prompt_order:v}:{},...x.size?{continuity_group_ids:[...x].sort()}:{}};return L.sha=Zn(L),L}function ps(e,t){const n=u(t,160);return n?e.continuity_group_ids?.includes(n)?!0:qc(e,n)?.continuity===!0:!1}function Wc(e){return e.groups.filter(t=>!ps(e,t.id))}function gs(){return ms(Dc,"Inlay default (SFW)")}function Zn(e){const t=JSON.stringify({version:e.version,name:e.name,groups:e.groups.map(r=>({id:r.id,continuity:r.continuity??null,options:r.options.map(a=>({id:a.id,tags:a.tags,description:a.description,slot:a.slot,by_slot:a.by_slot}))})),presets:e.presets??null,modifier_lanes:e.modifier_lanes??null,fixed_positive:e.fixed_positive??null,fixed_negative:e.fixed_negative??null,subjects:e.subjects??null,selection:e.selection??null,prompt_order:e.prompt_order??null,continuity_group_ids:e.continuity_group_ids??null});let n=2166136261;for(let r=0;r<t.length;r++)n^=t.charCodeAt(r),n=Math.imul(n,16777619);return(n>>>0).toString(16).padStart(8,"0")}function ap(...e){const t=ds();for(const n of e)n&&(t.base=N(t.base,n.base),t.char=N(t.char,n.char),t.primary=N(t.primary,n.primary),t.secondary=N(t.secondary,n.secondary),t.female=N(t.female,n.female),t.male=N(t.male,n.male));return t}function fn(e){return e?{base:u(e.base,800),char:u(e.char,800),primary:u(e.primary,800),secondary:u(e.secondary,800),female:u(e.female,800),male:u(e.male,800)}:ds()}function qc(e,t){const n=u(t,160);return n&&e.groups.find(r=>r.id===n)||null}function dn(e,t){const n=u(t,120);if(!n)return null;for(const r of e.groups){const a=r.options.find(s=>s.id===n);if(a)return{group:r,option:a}}return null}function sp(e){const t=[];for(const n of e.groups)for(const r of n.options)t.push({key:`${n.id}::${r.id}`,groupId:n.id,optionId:r.id,text:`${r.description} | ${r.tags}`,tags:r.tags,slot:r.slot||Dt(n.id)});return t}function ip(e,t=!1){const n=Wc(e).map(r=>{const a=r.options.map(s=>`  - ${s.id}: ${s.description}`).join(`
`);return`### ${r.id} (${r.label})
...
`)}function Vc(){return["## Per-actor ids (strict catalog-id mode)",'Add `"characters": [ { "index": 0, "option_ids": ["id", "..."] }, ... ]` to EVERY shot.','Each shot input includes `cast`: `[{ "index": 0, "name": "...", "gender": "girl|boy|""" }, ...]`.',"`index` MUST match `cast[].index` / Pass-1 `characters` array order — use name+gender from `cast`, not chat mention order.","Example: if cast says index 0 = 보민 (boy) and index 1 = Serin (girl), put bound/tears on the boy's index, not the girl's.","Put an option on `characters[].option_ids` when it targets ONE specific actor (pose, contact, expression, gaze).","Put an option on the shot-level `curation_option_ids` instead when it is scene-wide (camera, place, framing) — do not duplicate it into every actor.","Every actor in `cast` needs an entry, even if `option_ids` is `[]`.","This mode has NO freeform camera/situation/action fallback — an unlisted concept is simply omitted, never paraphrased."]}function op(e,t,n){const r=n?.strictIds===!0,a=new Set(t.map(o=>u(o,160)).filter(Boolean)),s=Wc(e).filter(o=>a.has(o.id)),i=(s.length?s:[]).map(o=>{const c=o.options.map(l=>`  - ${l.id}: ${l.description}`).join(`
`);return`### ${o.id} (${o.label})
${c}`});return["Curation two-stage ON (pass 2 — scene refine, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ] }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "camera": "...", "situation": "...", "place": "...", "action": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["cowboy_shot", "smile"] }, { "index": 1, "option_ids": ["facing_each_other"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["cowboy_shot", "facing_each_other", "smile", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output — host injects catalog tags from those ids.","For EVERY shot pick ALL listed options that match the chat at that y_percent (pose, contact, expression, place…).","Typical **2–8 ids**; `[]` ONLY if nothing fits. Do not skip obvious matches.",r?"Do NOT invent character appearance/attire. Do NOT invent option ids. Do NOT write freeform camera/situation/action text — ids only.":"Prefer ids over freeform camera/situation/action paraphrase.",...r?[]:["Do NOT invent character appearance/attire. Do NOT invent option ids."],...Yc(),...r?["",...Vc()]:[],"",i.length?"## Allowed options (union of all shots' groups)":`## Allowed options
(none — leave scene fields empty)`,...i].join(`
`)}function Yc(){return["## Chat context (separate user message, READ-ONLY)","A prior user message is the exact chat text from pass 1 (for LLM prompt cache).","Use it for continuity only (who the cast is, ongoing scene).","Do NOT rewrite, quote-edit, summarize into the JSON, or invent missing plot beats.","Do NOT change shot count, shot_index, composition_id, composition_variant, or y_percent.","","## Shot focus bands (PRIMARY evidence)","Each shot includes `y_percent`, `focus: { from_percent, to_percent }`, and `focus_hint` (a short quote from that band of the chat).","Pick options primarily from `focus_hint` / the `focus` percent range for THAT shot.","Do NOT pull actions from far-away bands into this shot. Full chat is background, not a license to copy the same ids onto every shot.","When focuses differ, prefer distinct `curation_option_ids` / per-actor ids across shots — avoid pasting one identical set on every shot_index.","Do NOT invent aftermath tags (`after_sex`, `afterglow`, cum_on_*, etc.) unless `focus_hint` explicitly shows that aftermath.","y_percent / focus are already final — never output new y_percent or focus fields."]}function cp(){return["Curation embed-snap mode: write DETAILED English Danbooru scene tags.","Fill camera, situation, place, action with concrete tags (framing, pose, contact, location, expression-as-scene).",'Use standard Danbooru spacing (underscores as spaces): e.g. "cowboy shot", "from side", "hand on own chest", "facing another".','Prefer specific pose/contact/framing over vague words like "intimate" or "dramatic".',"Character appearance/attire/accessories stay in character fields — do not move them into camera/situation.","`natural` still follows the Natural base mode system message."].join(`
`)}function lp(e){const t=e.prompt_order;if(!t?.length)return _s;const n=[],r=new Set;for(const a of t){const s=Kc(a)||(u(a,40).toLowerCase()==="char"?"char":null);s&&!r.has(s)&&(r.add(s),n.push(s))}for(const a of _s)r.has(a)||n.push(a);return n}function up(e,t){const n=Xc(e,t);return N(...lp(e).map(r=>n[r]))}function Xc(e,t){const n=Array.isArray(t)?t:u(t,800).split(/[,|]/),r={base:[],char:[],primary:[],secondary:[],female:[],male:[]},a=new Set;for(const s of n){const i=u(s,120);if(!i||a.has(i))continue;const o=dn(e,i);if(!o)continue;a.add(i);const c=o.option.by_slot;if(c&&Object.keys(c).length){for(const l of Object.keys(c)){const f=u(c[l],800);f&&r[l].push(f)}continue}r[Dt(o.group.id)].push(o.option.tags)}return{base:N(...r.base),char:N(...r.char),primary:N(...r.primary),secondary:N(...r.secondary),female:N(...r.female),male:N(...r.male)}}function Ut(e,t){t&&(e.action=N(u(e.action,600),t))}function hs(e,t,n){const r={...ds(),...t};e.camera=u(r.base,800),e.situation=u(n?.situation,400)||"",n&&"place"in n&&(e.place=u(n.place,400));const a=(Array.isArray(e.characters)?e.characters:[]).filter(i=>i&&typeof i=="object"),s=!!(r.char||r.primary||r.secondary||r.female||r.male);if(!a.length){e.action=s?N(r.char,r.primary,r.secondary,r.female,r.male):"";return}s&&(e.action=""),fp(a,r)}function Zc(e){const t=Array.isArray(e?.characters)?e.characters:[],n=[];for(let r=0;r<t.length;r++){const a=t[r];if(!a||typeof a!="object"){n.push({index:r,name:"",gender:""});continue}const s=a,i=Fn(s);n.push({index:r,name:u(s.name,200),gender:i==="f"?"girl":i==="m"?"boy":""})}return n}function Qc(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(!n||typeof n!="object")continue;const r=n,a=Number(r.index);!Number.isInteger(a)||a<0||t.push({index:a,option_ids:r.option_ids??r.ids??r.curation_option_ids})}return t}function el(e,t,n){if(!t.length)return;const r=Array.isArray(e.characters)?e.characters:[];for(const{index:a,option_ids:s}of t){const i=r[a];if(!i||typeof i!="object")continue;const o=up(n,s);o&&Ut(i,o)}}function fp(e,t){t.primary&&Ut(e[0],t.primary),t.secondary&&e[1]&&Ut(e[1],t.secondary);for(const n of e){t.char&&Ut(n,t.char);const r=Fn(n);t.female&&r==="f"&&Ut(n,t.female),t.male&&r==="m"&&Ut(n,t.male)}if(!e.some(n=>Fn(n)!=null)){const n=N(t.female,t.male);if(n)for(const r of e)Ut(r,n)}}function dp(e){return e.groups.reduce((t,n)=>t+n.options.length,0)}var mp,pp,_s,ys=T((()=>{Zm(),B(),De(),mp=10,pp=80,_s=["base","char","primary","secondary","female","male"]}));function gp(e){let t=u(e.composition_id,160)||u(e.preset_id,160)||u(e.leaf_id,160)||u(e.position_id,160)||u(e.curation_leaf,160)||u(e.composition,160);if(t&&/[|/]/.test(t)){const r=t.split(/[/|]/).map(a=>u(a,160)).filter(Boolean);r.length>=2&&((!Array.isArray(e.preset_path)||!e.preset_path.length)&&(e.preset_path=r),t=r[r.length-1])}const n=u(e.composition_variant,120)||u(e.selected_variant_id,120)||u(e.variant_id,120)||u(e.variant,120);return t&&(e.composition_id=t),n&&(e.composition_variant=n),Array.isArray(e.preset_path)&&e.preset_path.length?!0:!!t}function Ht(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function hp(e){const t=[];for(const n of["children","variants"]){const r=e[n];if(Array.isArray(r))for(const a of r){const s=Ht(a);s&&t.push(s)}}return t}function tl(e){return Array.isArray(e.variants)?e.variants.map(Ht).filter(Boolean):[]}function _p(e){const t=e.when_to_use;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):u(e.description,400)}function yp(e){const t=e.avoid_when;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):""}function bp(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,n=u(t.ref??t.id??t.group,160);if(!n)return null;const r=Array.isArray(t.include_options)?t.include_options.map(i=>u(i,120)).filter(Boolean):void 0,a=t.action&&typeof t.action=="object"&&!Array.isArray(t.action)?t.action:null,s=a?{source:u(a.source,40)||void 0,target:u(a.target,40)||void 0,include_options:Array.isArray(a.include_options)?a.include_options.map(i=>u(i,120)).filter(Boolean):void 0}:void 0;return{ref:n,include_options:r?.length?r:void 0,replace:t.replace===!0,order:Number.isFinite(Number(t.order))?Number(t.order):void 0,action:s}}function nl(e){return Array.isArray(e.modifiers)?e.modifiers.map(bp).filter(Boolean):[]}function wp(e){if(!Yn(e))return[];const t=Ht(e.presets);if(!t)return[];const n=[],r=(a,s,i,o)=>{const c=u(a.id,160),l=u(a.type,40),f=c&&c!=="preset"?[...s,c]:s,d=!i&&c&&c!=="preset"?c:i,p=l==="category"&&c?c:o,m=Array.isArray(a.children)?a.children.map(Ht).filter(Boolean):[],g=tl(a);if(c&&c!=="preset"&&(l==="position"||g.length>0&&m.length===0)){const h=nl(a),_=[...new Set(h.map(y=>y.ref).filter(Boolean))];n.push({id:c,path:f,composition:d||c,category:p,when:_p(a),avoid:yp(a),variants:g.map(y=>u(y.id,120)).filter(Boolean),description:u(a.description,300)||c,selectionModifiers:_})}for(const h of m)r(h,f,d,p)};return r(t,[],"",""),n}function rl(e,t,n){const r=Ht(e.presets),a=u(t,160);if(!r||!a)return null;const s={chain:null},i=(d,p)=>{if(s.chain)return;const m=[...p,d];if(u(d.id,160)===a){s.chain=m;return}const g=Array.isArray(d.children)?d.children.map(Ht).filter(Boolean):[];for(const h of g)i(h,m)};i(r,[]);const o=s.chain;if(!o)return null;const c=u(n,120);if(!c)return o;const l=o[o.length-1],f=tl(l).find(d=>u(d.id,120)===c);return f?[...o,f]:o}function bs(e,t){const n=t.preset_path;if(Array.isArray(n)&&n.length){const r=n.map(o=>u(o,160)).filter(Boolean),a=Ht(e.presets);if(!a||!r.length)return null;const s=[a];let i=a;for(const o of r){if(u(i.id,160)===o)continue;const c=hp(i).find(l=>u(l.id,160)===o);if(!c)return rl(e,r[r.length-1],void 0);s.push(c),i=c}return s}return rl(e,t.composition_id??(typeof n=="string"?n:""),t.composition_variant)}function ws(e){const t=new Map;for(const n of e)for(const r of nl(n)){const a=t.get(r.ref);if(r.replace||!a){t.set(r.ref,r);continue}const s=[...new Set([...a.include_options||[],...r.include_options||[]])];t.set(r.ref,{...a,...r,include_options:s.length?s:a.include_options,action:r.action||a.action})}return[...t.values()]}function vp(e,t){const n=new Map,r=new Set;for(const s of t){for(const i of ws(s))n.set(i.ref,i);for(const i of sl(s))r.add(i)}const a=[];for(const[s,i]of n){if(ps(e,s))continue;const o=qc(e,s);if(!o)continue;const c=i.include_options?.length?new Set(i.include_options):null;let l=c?o.options.filter(f=>c.has(f.id)):o.options;if(r.size){const f=il(e,l.map(p=>p.id),r),d=new Set(f);l=l.filter(p=>d.has(p.id))}l.length&&a.push({id:o.id,label:o.label,options:l})}return a}function xp(e,t){return t?.length?ws(t).filter(n=>ps(e,n.ref)):[]}function al(e){const t=u(e,40).toLowerCase();return t?["male","m","boy","man"].includes(t)?"male":["female","f","girl","woman"].includes(t)?"female":["primary","main"].includes(t)?"primary":["secondary","partner"].includes(t)?"secondary":["global","base","scene","camera"].includes(t)?"base":["char","both","all"].includes(t)?"char":null:null}function kp(e){return fn(Jc(e))}function Sp(e,t,n){const r=dn(e,t);if(!r)return fn({});const a=n.find(o=>o.ref!==r.group.id?!1:!o.include_options?.length&&!o.action?.include_options?.length?!0:new Set([...o.include_options||[],...o.action?.include_options||[]]).has(t))||n.find(o=>o.ref===r.group.id);if(r.option.by_slot&&Object.keys(r.option.by_slot).length)return fn(r.option.by_slot);const s=r.option.tags||Xn(r.option.tags);if(!s)return fn({});if(a?.action){const o=al(a.action.source),c=al(a.action.target),l={};if(o&&(l[o]=s),c&&(l[c]=N(l[c],s)),o||c)return fn(l)}const i=Dt(r.group.id);return fn({[i]:s})}function sl(e){const t=new Set;for(const n of e){const r=n.modifier_filter;if(!r||typeof r!="object"||Array.isArray(r))continue;const a=r.deny;if(!(!a||typeof a!="object"||Array.isArray(a))){for(const s of Object.values(a))if(Array.isArray(s))for(const i of s){const o=u(i,160).toLowerCase();o&&t.add(o)}}}return t}function il(e,t,n){return n.size?t.filter(r=>{const a=r.toLowerCase();if(n.has(a))return!1;const s=dn(e,r);if(!s)return!0;const i=u(s.option.tags,800).toLowerCase(),o=u(s.option.description,400).toLowerCase();for(const c of n){const l=c.replace(/_/g," ");if(i.includes(c)||i.includes(l)||o.includes(l))return!1}return!0}):t}function Ap(e,t,n){const r=new Map;for(const a of n)Number.isFinite(a.order)&&r.set(a.ref,a.order);return r.size?t.map((a,s)=>({id:a,i:s})).sort((a,s)=>{const i=dn(e,a.id)?.group.id,o=dn(e,s.id)?.group.id,c=i!=null&&r.has(i)?r.get(i):Number.MAX_SAFE_INTEGER,l=o!=null&&r.has(o)?r.get(o):Number.MAX_SAFE_INTEGER;return c!==l?c-l:a.i-s.i}).map(a=>a.id):t}function Mp(e,t,n){if(!Yn(e))return null;const r=bs(e,t);if(!r?.length)return null;const a=r.map(p=>kp(p.prompt)),s=ws(r),i=new Set(s.map(p=>p.ref)),o=[...s,...(n?.bindings||[]).filter(p=>!i.has(p.ref))],c=sl(r),l=[...Uc(t.curation_option_ids),...n?.optionIds||[]];let f=Hc(e,l);f=il(e,f,c),f=Ap(e,f,o);const d=f.map(p=>Sp(e,p,o));return ap(...a,...d)}function Np(){return["# Preset selection (Asset Maid analyzer rules)","Use ONLY information in the chat/shot context. Do not invent unseen actors or actions.","","## Actors → composition first","Count actors that are required for the current moment's action/contact.","Pick a composition that matches actor count and genders (e.g. 1girl_solo vs 1girl_1boy).","Do NOT drop a visible partner to force solo. If a male hand/arm is visible contacting the girl from POV, that male is an actor → prefer 1girl_1boy, not 1girl_solo.","","## Walk the tree","Read the leaf list as composition → category → position.","Categories matter: `general` = non-sexual placement; `foreplay` / `sexual` / `insertion` = intimate contact. If the chat has kissing, licking, sexual touch, or sex, do NOT pick a `general` leaf just because posture when-text matches.","For each candidate use when / avoid / selection_modifiers. Prefer the leaf whose when matches AND whose selection_modifiers cover the stated actions.","selection_modifiers are modifier **group ids** this leaf unlocks for pass 2 (e.g. `interaction.partner.mouth_contact`). They are the main reason to prefer one leaf over another when posture is similar.","CRITICAL: do NOT pick a leaf that only matches vague posture words if it lacks the group needed for the chat action. Example: ear licking / kissing / licking neck need a leaf with `interaction.partner.mouth_contact` (usually under foreplay), not `general/facing_each_other` which only has `interaction.general`.","Pick exactly ONE `composition_id` (position leaf) per shot.","If the same leaf id appears under multiple compositions/categories (e.g. `free`), set `composition_id` to the full path string `composition / category / leaf` so the host can disambiguate.","","## Variant","If the leaf lists variants, pick `composition_variant` for the camera that fits (from_side, pov, default…).","If unsure and a default/from_side exists, prefer that over inventing camera tags.","","## What NOT to do in pass 1","Do NOT invent Danbooru camera/pose tags into camera/situation/action.","Do NOT return modifier option ids here (pass 2 does that — e.g. do not emit `licking_ear` in pass 1).","Do NOT set `curation_groups`."]}function Ip(e,t=!1){const n=wp(e),r=new Map;for(const s of n){const i=r.get(s.composition)||[];i.push(s),r.set(s.composition,i)}const a=[];for(const[s,i]of r){a.push(`## composition: ${s}`);for(const o of i){const c=o.variants.length?o.variants.join("|"):"(none)",l=o.selectionModifiers.length?o.selectionModifiers.join(", "):"(none)",f=o.description&&o.description!==o.id&&o.description!==o.when?`description: ${o.description}`:"";a.push([`### ${o.id}`,`path: ${o.path.join(" / ")}`,o.category?`category: ${o.category}`:"",o.when?`when: ${o.when}`:"",o.avoid?`avoid: ${o.avoid}`:"",f,`selection_modifiers: ${l}`,`variants: ${c}`].filter(Boolean).join(`
`))}}return["Curation two-stage ON (pass 1 — Asset Maid presets).","CRITICAL: every shot MUST include `composition_id` (exact leaf id, or full path if id is ambiguous). This overrides the base format schema.","Also set `composition_variant` when the leaf lists variants.",...Np(),"","On every shot set:","- `composition_id`: leaf id (e.g. `face_to_face_upright`) OR path `1girl_1boy / foreplay / face_to_face_upright` when ids collide","- `composition_variant`: one variant id for that leaf, or omit if none","Still fill characters (appearance/attire/accessories) as usual.","`place` may stay as a short location hint.",...t?["STRICT catalog-id mode is ON: leave `camera`, `situation`, `natural`, and every `characters[].action` / `characters[].expression` completely EMPTY.","Pass 2 assembles ALL scene and per-actor tags from catalog ids only, keyed off the `composition_id`/`composition_variant` you pick here."]:["Leave `situation` empty or non-person scene words only — NEVER put 1girl/1boy/solo there (host adds person-count tags).","`camera`/`action` must NOT include 1girl/1boy/solo either.","`natural` still follows the Natural base mode system message."],"","## Preset leaf catalog (do not invent ids)","selection_modifiers = group ids unlocked for pass 2 (not option ids). Use them to choose the leaf; pass 2 picks concrete options like licking_ear.",...a.length?a:["(empty presets tree)"]].join(`
`)}function Ep(e){const t=e.modifier_lanes;if(!t||!Object.keys(t).length)return[];const n=["## Modifier lanes (hard caps — host also enforces)","Within each lane, keep at most max_active_groups distinct groups."];for(const[r,a]of Object.entries(t))n.push(`- lane \`${r}\`: max ${a.max_active_groups} group(s) among [${a.fallback_order.join(", ")}] (earlier pattern wins if over cap)`);return n.push("Example: do not pick both manual.arm_pose and manual.partner_contact options together."),n}function Cp(e,t,n){const r=n?.strictIds===!0,a=vp(e,t).map(s=>{const i=s.options.map(o=>`  - ${o.id}: ${o.description}`).join(`
`);return`### ${s.id} (${s.label})
${i}`});return["Curation two-stage ON (pass 2 — preset modifiers, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ], "place": "..." }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "place": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["hug", "from_side"] }, { "index": 1, "option_ids": ["blush"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["hug", "from_side", "blush", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output. Host injects those catalog tags into the image — empty array = weak/empty pose.","For EVERY shot, pick ALL options that match the chat band at that shot's y_percent:","- contact / hug / hands / pose / expression / gaze / blush / location / lighting / clothing state when visible","Typical count: **2–8 ids** when the scene has clear action; 1 id only if truly minimal; `[]` ONLY if nothing in the list fits.","Do NOT leave `curation_option_ids` empty just to be safe — if hug/facing/hand contact is in the text and listed below, INCLUDE those ids.","Pick ONLY ids listed below. Never invent ids. Never invent character appearance/attire.","Do NOT put Danbooru tags in freeform fields instead of picking ids — prefer ids.","`place` may repeat a short location hint; optional.","Host assembles path prompts + these options into base vs char slots.",...r?["",...Vc()]:[],...Yc(),...Ep(e),"",a.length?"## Allowed modifier options":`## Allowed modifier options
(none — return empty curation_option_ids)`,...a].join(`
`)}var jp=T((()=>{B(),ys()}));function Tp(e,t){if(!e.length||e.length!==t.length)return-1;let n=0,r=0,a=0;for(let s=0;s<e.length;s++){const i=e[s],o=t[s];n+=i*o,r+=i*i,a+=o*o}return r<=0||a<=0?-1:n/(Math.sqrt(r)*Math.sqrt(a))}function $p(e,t,n){const r=n?.minScore??.35,a=Bp(n?.groupId);let s=null,i=-1,o=null,c=-1;for(const l of t){const f=Tp(e,l.vector);f>i&&(i=f,s=l),a&&l.groupId===a&&f>c&&(c=f,o=l)}return o&&c>=r?o:s&&i>=r?s:null}function Pp(e){return e.slot||Dt(e.groupId)}function Op(e,t,n,r=.4){const a=[],s=[],i=[],o=[],c=[],l=[],f=[];let d=0,p=0;const m=(g,h)=>{g==="base"?s.push(h):g==="primary"?o.push(h):g==="secondary"?c.push(h):g==="female"?l.push(h):g==="male"?f.push(h):i.push(h)};for(let g=0;g<e.length;g++){const h=e[g].trim();if(!h)continue;const _=t[g];if(!_||!_.length){a.push(h),s.push(h),p+=1;continue}const y=$p(_,n,{minScore:r});y?(a.push(y.tags),m(Pp(y),y.tags),d+=1):(a.push(h),s.push(h),p+=1)}return{tags:a,baseTags:s,charTags:i,primaryTags:o,secondaryTags:c,femaleTags:l,maleTags:f,snapped:d,kept:p}}function Lp(e){const t=String(e||"").trim();if(!t)return[];const n=[];let r="",a=0;for(let i=0;i<t.length;i++){const o=t[i];if(o===":"&&t[i+1]===":"){a+=r.includes("::")?-1:1,r+="::",i+=1;continue}if(o===","&&a<=0){const c=r.trim();c&&n.push(c),r="";continue}r+=o}const s=r.trim();return s&&n.push(s),n}function Bp(e){return typeof e=="string"?e.trim():""}var Rp=T((()=>{ys()}));function $e(e){const t=u(e,40).toLowerCase().replace(/[ -]+/g,"_");return t==="openai_compatible"||t==="compat"?"openai_compat":Lr.includes(t)?t:"openai"}function Or(e){switch($e(e)){case"openai":return"https://api.openai.com/v1/embeddings";case"voyage":return"https://api.voyageai.com/v1/embeddings";case"openrouter":return"https://openrouter.ai/api/v1/embeddings";case"lmstudio":return"http://127.0.0.1:1234/v1/embeddings";case"ollama":return"http://127.0.0.1:11434/api/embeddings";default:return"https://api.openai.com/v1/embeddings"}}function Qn(e){switch($e(e)){case"voyage":return"voyage-3-lite";case"ollama":return"nomic-embed-text";case"openrouter":return"openai/text-embedding-3-small";case"lmstudio":return"text-embedding-nomic-embed-text-v1.5";default:return"text-embedding-3-small"}}function Fp(e){return Qn(e)}function Dp(){const e=new Set;for(const t of Lr){const n=Or(t).replace(/\/+$/,"");e.add(n),e.add(n.replace(/\/embeddings$/i,"")),e.add(n.replace(/\/api\/embeddings$/i,"")),e.add(n.replace(/\/v1$/i,""))}return e}function zp(e){const t=u(e,500);if(!t)return!0;const n=t.replace(/\/+$/,"");return Dp().has(n)}function Up(e){const t=u(e,200);return t?new Set(Lr.map(n=>Qn(n))).has(t):!0}function Hp(e){const t=$e(e);return t!=="lmstudio"&&t!=="ollama"}function Kp(e){const t=$e(e.provider),n=u(e.endpoint,500)||Or(t);return t==="ollama"?n.replace(/\/$/,""):/\/embeddings\/?$/i.test(n)?n.replace(/\/$/,""):/\/v1\/?$/i.test(n)?`${n.replace(/\/$/,"")}/embeddings`:n}function Jp(e){const t=e&&typeof e=="object"?e:{},n=Array.isArray(t.data)?t.data:[],r=[];for(const a of n){const s=a&&typeof a=="object"?a.embedding:null;if(Array.isArray(s)&&s.every(i=>typeof i=="number"))r.push(s);else throw new Error("임베딩 응답에 숫자 벡터가 없습니다.")}return r}async function ol(e){const t=e.ok!==!1&&(e.status===void 0||e.status>=200&&e.status<300);if(typeof e.json=="function")try{const n=await e.json();if(!t){const r=typeof n=="object"&&n?JSON.stringify(n).slice(0,400):String(n);throw new Error(`임베딩 HTTP ${e.status??"?"}: ${r}`)}return n}catch(n){if(n instanceof Error&&n.message.startsWith("임베딩 HTTP"))throw n}if(typeof e.text=="function"){const n=await e.text();if(!t)throw new Error(`임베딩 HTTP ${e.status??"?"}: ${n.slice(0,400)}`);return n?JSON.parse(n):{}}throw new Error("임베딩 응답을 읽을 수 없습니다.")}async function vs(e,t,n){if(!t.length)return{vectors:[],model:u(e.model)};const r=$e(e.provider),a=u(e.model,200)||Qn(r),s=Kp({...e,provider:r,model:a}),i=u(e.api_key,4e3);if(r==="ollama"){const l=[];for(const f of t){const d=(await ol(await Je(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:a,prompt:f}),signal:n?.signal}))).embedding;if(!Array.isArray(d)||!d.every(p=>typeof p=="number"))throw new Error("Ollama 임베딩 응답이 올바르지 않습니다.");l.push(d)}return{vectors:l,model:a}}const o={"Content-Type":"application/json"};i&&(o.Authorization=`Bearer ${i}`);const c=Jp(await ol(await Je(s,{method:"POST",headers:o,body:JSON.stringify(r==="voyage"?{model:a,input:t,input_type:"document"}:{model:a,input:t}),signal:n?.signal})));if(c.length!==t.length)throw new Error(`임베딩 개수 불일치: got ${c.length}, want ${t.length}`);return{vectors:c,model:a}}async function Gp(e){const{vectors:t,model:n}=await vs(e,["curation embedding ping"]),r=t[0]?.length||0;if(!r)throw new Error("임베딩 차원이 0입니다.");return{ok:!0,dims:r,model:n}}var xs,Lr,cl=T((()=>{B(),Ft(),xs=Object.freeze([{value:"openai",label:"OpenAI"},{value:"voyage",label:"Voyage"},{value:"openrouter",label:"OpenRouter"},{value:"openai_compat",label:"OpenAI-compat"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}]),Lr=xs.map(e=>e.value)})),Wp=_n({LLM_ENDPOINT_PRESETS:()=>mt,LLM_PROVIDERS:()=>pl,REASONING_EFFORTS:()=>ks,applyReasoningToBody:()=>ml,defaultEndpointForProvider:()=>ul,endpointPresetKeyFor:()=>Yp,ensureLlmRequestUrl:()=>dl,knownLlmEndpoints:()=>fl,llmModelPlaceholder:()=>Vp,normalizeLlmProvider:()=>Kt,normalizeReasoningEffort:()=>ll,shouldAutoReplaceEndpoint:()=>qp});function Kt(e){const t=String(e||"").toLowerCase().replace(/[ -]+/g,"_").trim();return["openrouter"].includes(t)?"openrouter":["openai"].includes(t)?"openai":["google","google_ai","google_ai_studio","gemini"].includes(t)?"google_ai":["vertex","vertex_ai","google_vertex"].includes(t)?"vertex":["anthropic","anthropic_compat","anthropic_compatible","claude"].includes(t)?"anthropic_compatible":["lmstudio","lm_studio"].includes(t)?"lmstudio":["ollama"].includes(t)?"ollama":["custom"].includes(t)?"custom":["openai_compatible","openai_compat"].includes(t)?"openrouter":"custom"}function ll(e){const t=String(e??"default").toLowerCase().trim();return!t||t==="auto"||t==="default"?"default":ks.includes(t)?t:"default"}function ul(e,t={}){const n=Kt(e);return n==="vertex"?`https://${String(t.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1"}-aiplatform.googleapis.com`:n==="anthropic_compatible"?mt.anthropic:n==="custom"?mt.openai:mt[n]||mt.openai}function fl(){const e=new Set;for(const t of Object.values(mt)){const n=String(t||"").replace(/\/+$/,"");n&&(e.add(n),e.add(n.replace(/\/chat\/completions$/i,"")),e.add(n.replace(/\/v1\/messages$/i,"")),e.add(n.replace(/\/v1$/i,"")))}return e.add("https://us-central1-aiplatform.googleapis.com"),e.add("https://europe-west1-aiplatform.googleapis.com"),e.add("https://asia-northeast1-aiplatform.googleapis.com"),e}function qp(e){const t=String(e||"").trim().replace(/\/+$/,"");return t?fl().has(t):!0}function dl(e,t,n={}){const r=Kt(t);let a=String(e||"").trim().replace(/\/+$/,"");if(a||(a=ul(r,n).replace(/\/+$/,"")),r==="anthropic_compatible")return/\/v1\/messages$/i.test(a)||/\/messages$/i.test(a)?a:/\/v1$/i.test(a)?`${a}/messages`:`${a}/v1/messages`;if(r==="vertex"){const s=String(n.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1",i=String(n.projectId||"").trim();if(i)return`https://${s}-aiplatform.googleapis.com/v1/projects/${encodeURIComponent(i)}/locations/${encodeURIComponent(s)}/endpoints/openapi/chat/completions`;if(/aiplatform\.googleapis\.com/i.test(a)&&!/\/chat\/completions$/i.test(a))return a}return/\/chat\/completions$/i.test(a)?a:/\/openai$/i.test(a)?`${a}/chat/completions`:/\/v1beta$/i.test(a)?`${a}/openai/chat/completions`:/\/v1$/i.test(a)?`${a}/chat/completions`:a}function ml(e,t){const n={};e&&typeof e=="object"&&Object.assign(n,e);const r=ll(t);return r==="default"||(n.reasoning={effort:r}),n}function Vp(e){const t=Kt(e),n={openrouter:"openai/gpt-4o-mini",openai:"gpt-4o-mini",google_ai:"gemini-2.5-flash",vertex:"gemini-2.0-flash-001",anthropic_compatible:"claude-sonnet-4",lmstudio:"local-model",ollama:"llama3.2",custom:"model-id"};return n[t]||n.custom}function Yp(e){const t=String(e||"").trim().replace(/\/+$/,"");for(const[n,r]of Object.entries(mt)){const a=r.replace(/\/+$/,"");if(t===a||t===a.replace(/\/chat\/completions$/i,"")||t===a.replace(/\/v1\/messages$/i,""))return n}return"custom"}var mt,ks,pl,Br=T((()=>{mt=Object.freeze({openai:"https://api.openai.com/v1/chat/completions",openrouter:"https://openrouter.ai/api/v1/chat/completions",google_ai:"https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",lmstudio:"http://127.0.0.1:1234/v1/chat/completions",ollama:"http://127.0.0.1:11434/v1/chat/completions",anthropic:"https://api.anthropic.com/v1/messages",vertex:"https://us-central1-aiplatform.googleapis.com"}),ks=Object.freeze(["default","none","minimal","low","medium","high","xhigh","max"]),pl=Object.freeze([{value:"openrouter",label:"OpenRouter"},{value:"openai",label:"OpenAI"},{value:"google_ai",label:"Google AI Studio"},{value:"vertex",label:"Vertex AI (Google Cloud)"},{value:"anthropic_compatible",label:"Anthropic-compatible"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}])}));function Rr(e){const t=String(e||"").trim().toLowerCase();return t==="main"||t==="risu_main"||t==="risu-main"?"main":t==="aux"||t==="otherax"||t==="other_ax"||t==="risu_aux"||t==="risu-aux"||t==="sub"||t==="secondary"?"aux":"custom"}function Xp(e){const t=Rr(e);return t==="main"||t==="aux"}function gl(e){const t=e||{};return Xp(t.source)?!0:Kt(t.provider)==="vertex"?!!(u(t.model)&&(u(t.api_key)||u(t.service_account_json))):!!(u(t.model)&&u(t.api_key))}function Zp(e){let t="";const n=[];for(const r of e||[]){const a=String(r?.role||""),s=r?.content;if(a==="system"){const i=typeof s=="string"?s:Array.isArray(s)?s.map(o=>typeof o=="object"?o.text||"":String(o)).join(""):String(s??"");t=t?`${t}
${i}`:i;continue}if(Array.isArray(s)){const i=[];for(const o of s){if(!o||typeof o!="object"){const d=String(o||"").trim();d&&i.push({type:"text",text:d});continue}const c=o.image_url,l=(typeof c=="object"&&c?c.url:"")||(typeof c=="string"?c:"");if(o.type==="image_url"||l){const d=String(l).match(/^data:([^;]+);base64,([\s\S]+)$/i);d&&i.push({type:"image",source:{type:"base64",media_type:d[1]||"image/png",data:d[2].replace(/\s+/g,"")}});continue}const f=String(o.text||"").trim();f&&i.push({type:"text",text:f})}n.push({role:a==="assistant"?"assistant":"user",content:i.length?i:[{type:"text",text:""}]});continue}n.push({role:a==="assistant"?"assistant":"user",content:String(s??"")})}return{system:t,messages:n}}function Qp(e){const t=e?.choices||[];if(!t.length)throw new Error("LLM returned no choices.");let n=(t[0].message||{}).content;return Array.isArray(n)&&(n=n.map(Dr).join("")),u(n)}function eg(e){const t=e?.content,n=(Array.isArray(t)?t:[]).map(Dr).join(""),r=u(n||e?.completion||"");if(!r)throw new Error("Anthropic 응답이 비어 있습니다.");return r}async function Fr(e){if(!er(e))return"";const t=e.getReader(),n=typeof TextDecoder<"u"?new TextDecoder:null;let r="",a="";for(;;){const{done:s,value:i}=await t.read();if(s)break;if(typeof i=="string")r=i,a+=i;else if(i instanceof Uint8Array)a+=n?n.decode(i,{stream:!0}):"";else if(i&&typeof i=="object"){const o=i,c=o[0];typeof c=="string"?r=c:typeof o.content=="string"?r=o.content:typeof o.text=="string"&&(r=o.text)}}return n&&(a+=n.decode()),r||a}async function tg(e){if(typeof e=="string")return e;if(er(e))return Fr(e);if(e==null)return"";if(typeof e=="number"||typeof e=="boolean")return String(e);if(typeof e=="object"){const t=e,n=u(t.type,40).toLowerCase();if(n==="fail"||n==="error"){const a=u(t.result||t.message||t.error||"Risu LLM 실패",800);throw new Error(`Risu LLM 실패: ${a}`)}if(n==="streaming"||n==="stream"){const a=await Fr(t.result??t.data??t.stream);if(a.trim())return a}if(n==="success"||n==="ok"){const a=t.result??t.data??t.content;if(typeof a=="string")return a;if(er(a))return Fr(a)}const r=[t.choices?.[0]?.message?.content,t.choices?.[0]?.text,t.choices?.[0]?.delta?.content,t.message?.content,t.content,t.text,t.response,n?null:t.result,t.output];for(const a of r){if(typeof a=="string"&&a.trim())return a;if(Array.isArray(a)){const s=a.map(Dr).join("");if(s.trim())return s}if(er(a)){const s=await Fr(a);if(s.trim())return s}}try{return JSON.stringify(e)}catch{return String(e)}}return String(e||"")}var er,Dr,zr=T((()=>{B(),Br(),er=e=>!!e&&typeof e.getReader=="function",Dr=e=>typeof e=="object"?e?.text||"":String(e||"")}));async function ng(){try{const e=await Ce(ia,Zs);if(e==null||e==="")return ke(it);const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return ke(it);const n=Ha(t),r=Be(it,n);return JSON.stringify(t)!==JSON.stringify(n)&&await hl(r),r}catch(e){console.warn("[Inlay Nexus] settings load failed",e?.message||e)}return ke(it)}async function hl(e){if(await je(ia,ke(e)),await Ce("inx_native_settings")==null)throw new Error("설정 저장 실패: IndexedDB(getLocalPluginStorage)에 기록되지 않았습니다.")}var _l=T((()=>{re(),St(),Lt(),Zt(),Mr()}));async function rg(){const e=await D("meta","prompt:__pack__"),t=!e||e.text!=="2026-08-07-asset-lore-keys",n=Date.now()/1e3;for(const r of yn)await D("meta",`prompt:${r}`)&&!(t&&Xs.includes(r))||await z("meta",{key:`prompt:${r}`,text:Ln(r),updated_at:n});await z("meta",{key:"prompt:__pack__",text:Ys,updated_at:n})}async function ce(e){const t=await D("meta",`prompt:${e}`);return t?.text!=null?t.text:Ln(e)}async function yl(e,t){const n=Date.now()/1e3;return await z("meta",{key:`prompt:${e}`,text:t,updated_at:n}),{ok:!0,key:e,updated_at:n}}async function Ur(){const e=await Ae("meta"),t=new Map(e.filter(r=>r.key?.startsWith("prompt:")&&!r.key.startsWith("prompt:__")).map(r=>[r.key.slice(7),{key:r.key.slice(7),text:r.text||"",updated_at:r.updated_at||0}])),n=[];for(const r of yn){const a=t.get(r);a?n.push(a):n.push({key:r,text:Ln(r),updated_at:0}),t.delete(r)}for(const r of t.values())n.push(r);return n}async function ag(){const e=await Ur(),t={};for(const n of e)t[n.key]=n.text;return{version:nt,prompts:t}}async function sg(e){const t=og(e);let n=0;const r=Date.now()/1e3;for(const a of yn)Object.prototype.hasOwnProperty.call(t,a)&&(await z("meta",{key:`prompt:${a}`,text:String(t[a]??""),updated_at:r}),n+=1);return{ok:!0,updated:n,prompts:await Ur()}}async function ig(e){const t=e?.keep_author_note!==!1,n=Date.now()/1e3;let r=0;for(const a of yn)t&&a==="author_note"||(await z("meta",{key:`prompt:${a}`,text:Ln(a),updated_at:n}),r+=1);return{ok:!0,updated:r,keep_author_note:t,prompts:await Ur()}}function og(e){let t=e;if(typeof e=="string"){const s=e.trim();if(!s)return{};t=JSON.parse(s)}if(!t||typeof t!="object"||Array.isArray(t))return{};const n=t,r={},a=n.prompts;if(a&&typeof a=="object"&&!Array.isArray(a)){for(const[s,i]of Object.entries(a))typeof s=="string"&&(r[s]=String(i??""));return r}if(Array.isArray(a)){for(const s of a){if(!s||typeof s!="object")continue;const i=s,o=String(i.key||"");o&&(r[o]=String(i.text??""))}return r}if(typeof n.key=="string"&&"text"in n)return r[n.key]=String(n.text??""),r;for(const[s,i]of Object.entries(n))s==="version"||s==="ok"||typeof i=="string"&&(r[s]=i);return r}async function Xe(){const e=ke(E());await no.run(()=>hl(e))}function cg(){return wd(E())}async function lg(e){const t=vd(String(e??"").slice(0,2000001)),n=ke(E());await z("meta",{key:"settings_backup",value:n,updated_at:Date.now()/1e3});const r=Be(it,t);return r.llm={...r.llm,api_key:n.llm?.api_key||""},r.nai={...r.nai,api_key:n.nai?.api_key||""},r.auth_token=n.auth_token||"",yr(r),await Xe(),{ok:!0,settings:Hr()}}async function ug(){const e=ke(E());await z("meta",{key:"settings_backup",value:e,updated_at:Date.now()/1e3});const t=ke(it);t.llm={...t.llm,api_key:e.llm?.api_key||""},t.nai={...t.nai,api_key:e.nai?.api_key||""},t.auth_token=e.auth_token||"";const n=e.card;return t.card={...t.card,presets:Array.isArray(n.presets)?ke(n.presets):t.card.presets||[],active_preset_id:String(n.active_preset_id||t.card.active_preset_id||""),custom_pos:String(n.custom_pos??t.card.custom_pos??""),custom_neg:String(n.custom_neg??t.card.custom_neg??"")},yr(t),await Xe(),{ok:!0,settings:Hr()}}function fg(){const e=E(),t=e.nai,n=e.llm;let r=0,a=0,s=0,i=0;try{r=zn("cards"),a=zn("images"),s=Vf();const o=new Set;for(const c of Yf()){const l=u(c.character_id||"",200)||"unknown",f=u(c.chat_id||"",200)||"unknown";o.add(`${l}|${f}`)}i=o.size}catch{}return{ok:!0,version:nt,pid:0,source_file:"native",nai_configured:Vn(t)==="comfy"?os(t):!!u(t.api_key),image_backend:Vn(t),llm_configured:gl(n),port:0,image_mode:"data-url",storage:"indexeddb",storage_api:"getLocalPluginStorage",storage_scope:"device-local",cards:r,images:a,folders:i,png_bytes:s,last_stage:Cn(),focus_stage:yt(),last_error:pr(),debug_events:ci()}}function Hr(){const e=ke(E());e.nai?.api_key?(e.nai.api_key="",e.nai.api_key_configured=!0):e.nai={...e.nai,api_key_configured:!1},e.llm?.api_key?(e.llm.api_key="",e.llm.api_key_configured=!0):e.llm={...e.llm,api_key_configured:!1},e.llm?.service_account_json?(e.llm.service_account_json="",e.llm.service_account_configured=!0):e.llm={...e.llm,service_account_configured:!1};const t=e.nai;t.backend=Vn(t),t.image_backend=t.backend,t.comfy_configured=os(t);const n=eo(),r=to(),a=!Ss.includes(u(t.image_reference));t.image_reference_configured=!!(a&&n),t.image_reference||(t.image_reference=t.image_reference_configured?"file":"none"),t.image_reference_configured&&n&&(t.reference_preview_url=n);const s=!Ss.includes(u(t.vibe_transfer));if(t.vibe_transfer_configured=!!(s&&r),t.vibe_transfer||(t.vibe_transfer=t.vibe_transfer_configured?"file":"none"),t.vibe_transfer_configured&&r&&(t.vibe_preview_url=r),Array.isArray(e.card?.presets))for(const c of e.card.presets){if(!c||typeof c!="object")continue;const l=c,f=u(l.id,120),d=f?ga(f):"";d?(l.vibe_configured=!0,l.vibe_preview_url=d):(delete l.vibe_configured,delete l.vibe_preview_url),delete l.vibe_transfer}e.card.character_max=ct(e.card),e.database_path="indexeddb:getLocalPluginStorage",e.images_dir="indexeddb:inx_nximg_*",e.prompts_dir="embedded";const i=e.curation&&typeof e.curation=="object"?e.curation:{},o=i.embedding&&typeof i.embedding=="object"?{...i.embedding}:{};return o.api_key?(o.api_key="",o.api_key_configured=!0):o.api_key_configured=!1,i.embedding=o,e.curation=i,e.storage={...e.storage,backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",image_mode:"data-url"},e}async function dg(e){const t=e&&typeof e=="object"?e:{},n=E(),r={...t.nai||{}},a={...t.llm||{}},s={...t.card||{}};if("api_key"in r){const i=r.api_key;delete r.api_key,delete r.api_key_configured,u(i)&&(n.nai.api_key=i),(r.clearApiKey||t.clear_nai_key)&&(n.nai.api_key=""),delete r.clearApiKey}if("api_key"in a){const i=a.api_key;delete a.api_key,delete a.api_key_configured,u(i)&&(n.llm.api_key=i),(a.clearApiKey||t.clear_llm_key)&&(n.llm.api_key=""),delete a.clearApiKey}if("service_account_json"in a){const i=a.service_account_json;delete a.service_account_json,delete a.service_account_configured,u(i)&&(n.llm.service_account_json=i),(a.clearServiceAccount||t.clear_llm_service_account)&&(n.llm.service_account_json=""),delete a.clearServiceAccount}if(Object.keys(s).length){const i=Be(n.card,s);Array.isArray(s.presets)&&(i.presets=s.presets),"active_preset_id"in s&&(i.active_preset_id=s.active_preset_id),"custom_pos"in s&&(i.custom_pos=s.custom_pos),"custom_neg"in s&&(i.custom_neg=s.custom_neg),n.card=i,n.card.character_max=ct(n.card)}if(Object.keys(r).length&&(n.nai=Be(n.nai,r)),Object.keys(a).length&&(n.llm=Be(n.llm,a)),t.curation&&typeof t.curation=="object"){const{updateCurationSettings:i}=await Promise.resolve().then(()=>(rr(),_g));await i(t.curation)}for(const i of["bind_host","port","auth_token"])i in t&&(n[i]=t[i]);return await Xe(),{ok:!0,settings:Hr()}}var Ss,Ze=T((()=>{Zt(),Lt(),re(),Y(),St(),B(),De(),zr(),_l(),ze(),fe(),Ss=["","none","off","false","0"]}));function bl(e){const t=typeof e=="string"?e:JSON.stringify(e);return As(Yt(new TextEncoder().encode(t)))}function mg(e){const t=ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):ee(e);return As(Yt(t))}async function pg(e){let t;try{t=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("Vertex Service Account JSON 파싱 실패")}if(!t?.client_email||!t?.private_key)throw new Error("Service Account JSON에 client_email/private_key가 필요합니다.");if(!globalThis.crypto?.subtle)throw new Error("이 환경에서는 Vertex Service Account(JWT) 서명을 지원하지 않습니다. API key 칸에 OAuth access token을 넣거나 Google AI Studio를 쓰세요.");const n=Math.floor(Date.now()/1e3),r=`${bl({alg:"RS256",typ:"JWT"})}.${bl({iss:t.client_email,scope:"https://www.googleapis.com/auth/cloud-platform",aud:"https://oauth2.googleapis.com/token",iat:n,exp:n+3600})}`,a=String(t.private_key).replace(/\\n/g,`
`).replace(/-----BEGIN [^-]+-----/,"").replace(/-----END [^-]+-----/,"").replace(/\s+/g,""),s=Uint8Array.from(atob(a),f=>f.charCodeAt(0)),i=await crypto.subtle.importKey("pkcs8",s,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),o=`${r}.${mg(await crypto.subtle.sign("RSASSA-PKCS1-v1_5",i,new TextEncoder().encode(r)))}`,c=await Je("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`grant_type=${encodeURIComponent("urn:ietf:params:oauth:grant-type:jwt-bearer")}&assertion=${encodeURIComponent(o)}`});let l={};try{l=await c.json()}catch{l={}}if(!l?.access_token)throw new Error(`Vertex 토큰 발급 실패: ${JSON.stringify(l).slice(0,240)}`);return{accessToken:String(l.access_token),projectId:u(t.project_id||"")}}var As,gg=T((()=>{te(),B(),Ft(),As=e=>e.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}));async function Jt(e,t){const n=Rr(e.source);if(n==="main"||n==="aux")return hg(e,t,n);const r=Kt(e.provider),a=u(e.model),s=u(e.vertex_region)||"us-central1";let i=u(e.api_key),o="";if(r==="vertex"&&u(e.service_account_json)){const m=await pg(e.service_account_json);i=m.accessToken,o=m.projectId}if(!a||!i)throw w("llm.config",{message:"missing model/api_key",provider:r},"error"),new Error(r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM이 설정되지 않았습니다. 모델 설정에서 Provider·Model·API key를 넣으세요. (NovelAI 키와 별개)");const c=dl(u(e.endpoint),r,{region:s,projectId:o});if(r==="vertex"&&!/\/chat\/completions$/i.test(c))throw new Error("Vertex AI: project_id가 있는 Service Account JSON이 필요합니다. (OpenAI-compatible endpoint 구성용)");const l=Number(e.timeout_seconds??180)*1e3,f=typeof AbortController<"u"?new AbortController:null,d=setTimeout(()=>{w("llm.abort",{message:`timeout ${l}ms`,model:a,provider:r},"warn"),f?.abort?.()},l),p=_e("llm.call");w("llm.call.start",{message:a,msgs:t?.length||0,timeout_ms:l,source:n,provider:r,reasoning:u(e.reasoning_effort)||"default"});try{let m;if(r==="anthropic_compatible"){const y=Zp(t),v={model:a,max_tokens:Number(e.max_tokens??8e3),temperature:Math.min(1,Number(e.temperature??.4)),messages:y.messages};y.system&&(v.system=y.system),m=await Je(c,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":i,"anthropic-version":u(e.anthropic_version)||"2023-06-01"},body:JSON.stringify(v),signal:f?.signal})}else{const y=ml({model:a,messages:t,temperature:Number(e.temperature??.4),max_tokens:Number(e.max_tokens??8e3)},e.reasoning_effort),v={"Content-Type":"application/json",Authorization:`Bearer ${i}`};r==="openrouter"&&(v["HTTP-Referer"]="https://risuai.xyz",v["X-Title"]="Inlay Nexus"),m=await Je(c,{method:"POST",headers:v,body:JSON.stringify(y),signal:f?.signal})}const g=Number(m?.status||0);let h;try{h=await m.json()}catch{h={}}if(g>=400)throw p.fail(new Error(`HTTP ${g}`),{status:g,body:JSON.stringify(h).slice(0,200),provider:r}),new Error(`LLM HTTP ${g}: ${JSON.stringify(h).slice(0,500)}`);const _=r==="anthropic_compatible"?eg(h):Qp(h);return p.end({message:a,status:g,bytes:_.length,provider:r}),_}catch(m){throw p.fail(m,{model:a,provider:r}),m}finally{clearTimeout(d)}}async function hg(e,t,n,r=""){const a=Ee();if(!a||typeof a.runLLMModel!="function")throw new Error("RisuAI runLLMModel API를 사용할 수 없습니다. Risu를 최신으로 업데이트하세요.");const s=n==="main"?"model":"otherAx",i=Math.max(5e3,Number(e.timeout_seconds??180)*1e3),o=u(r)||"",c=_e("llm.call");w("llm.call.start",{message:`risu:${s}`,msgs:t?.length||0,timeout_ms:i,source:n,static_model:o});let l;const f=new Promise((d,p)=>{l=setTimeout(()=>p(new Error(`Risu LLM timeout ${i}ms (${s})`)),i)});try{const d=await Promise.race([a.runLLMModel({mode:s,...o?{staticModel:o}:{},allowPlugins:!0,messages:t}),f]),p=u(await tg(d));if(!p)throw new Error(`Risu LLM(${s}) 응답이 비어 있습니다.`);return c.end({message:`risu:${s}`,bytes:p.length}),p}catch(d){throw c.fail(d,{mode:s}),d}finally{l!==void 0&&clearTimeout(l)}}var Kr=T((()=>{Y(),_t(),B(),Ft(),gg(),Br(),zr()})),_g=_n({catalogSha:()=>Zn,curationStatus:()=>nr,curationTaggerSystemMessage:()=>Ml,embedCurationCatalog:()=>kl,getCurationMode:()=>Jr,getCurationStrictIds:()=>Gr,getEmbedProgress:()=>wl,getEmbeddingSettingsFromConfig:()=>tr,loadCurationCatalog:()=>pt,refineShotsWithCuration:()=>Nl,resetCurationCatalog:()=>xl,saveCurationCatalog:()=>vl,snapShotsSceneTags:()=>Cl,testCurationEmbedding:()=>Sl,updateCurationSettings:()=>jl});function wl(){return{...mn}}function Jr(){const e=E(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=Fa(t.mode);if(n!=="off")return n;const r=e.card;return r?.composition_curation===!0||r?.composition_curation==="true"||r?.composition_curation===1?"two_stage":"off"}function Gr(){const e=E(),t=e.curation&&typeof e.curation=="object"?e.curation:{};return Da(t.strict_ids)}function tr(){const e=E(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=t.embedding&&typeof t.embedding=="object"?t.embedding:{},r=$e(n.provider);return{provider:r,model:u(n.model,200)||Qn(r),endpoint:u(n.endpoint,500)||Or(r),api_key:u(n.api_key,4e3)}}async function pt(){const e=await Ce(fr);if(e==null||e==="")return gs();try{const t=typeof e=="string"?JSON.parse(e):e;return ms(t)}catch(t){return w("curation.catalog.load",{message:String(t?.message||t)},"warn"),gs()}}async function vl(e){const t=ms(e);await je(fr,t);const n=await Ms();return n&&(n.catalog_sha,t.sha),{ok:!0,status:await nr()}}async function xl(){const e=gs();return await je(fr,e),await ye(dr),{ok:!0,status:await nr()}}async function Ms(){const e=await Ce(dr);if(e==null||e==="")return null;try{const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return null;const n=t;return Array.isArray(n.items)?n:null}catch{return null}}async function nr(){const e=await pt(),t=await Ms(),n=dp(e);let r="missing";if(t?.items?.length){r=t.catalog_sha===e.sha?"ready":"stale";const a=tr(),s=u(a.model);s&&t.model&&t.model!==s&&(r="stale")}return{mode:Jr(),catalog_name:e.name,catalog_sha:e.sha||Zn(e),option_count:n,group_count:e.groups.length,has_presets:Yn(e),embed_status:r,embed_count:t?.items?.length||0,embed_model:t?.model||"",embed_updated_at:t?.updated_at||0,large_warning:n>Tl,embed_progress:wl()}}async function kl(e){const t=await pt(),n=sp(t),r=tr();if(!n.length)throw new Error("임베딩할 카탈로그 항목이 없습니다.");if($e(r.provider)!=="ollama"&&$e(r.provider)!=="lmstudio"&&!u(r.api_key))throw new Error("임베딩 API key가 없습니다. 큐레이팅 탭에서 키를 저장하세요.");const a=(c,l,f)=>{mn={running:c<l,done:c,total:l,message:f},e?.(c,l,f)},s=$e(r.provider)==="ollama"?1:16,i=[];let o=r.model;a(0,n.length,"임베딩 시작…");try{for(let l=0;l<n.length;l+=s){const f=n.slice(l,l+s);a(l,n.length,`임베딩 중… ${l}/${n.length}`);const{vectors:d,model:p}=await vs(r,f.map(m=>m.text));o=p||o;for(let m=0;m<f.length;m++){const g=f[m],h=d[m];if(!h?.length)throw new Error(`임베딩 실패: ${g.key}`);i.push({key:g.key,groupId:g.groupId,optionId:g.optionId,tags:g.tags,slot:g.slot,vector:h})}}a(n.length,n.length,"저장 중…");const c={catalog_sha:t.sha||Zn(t),model:o,provider:String(r.provider),updated_at:Date.now()/1e3,items:i};return await je(dr,c),a(n.length,n.length,"완료"),mn={running:!1,done:n.length,total:n.length,message:"완료"},{ok:!0,status:await nr()}}catch(c){throw mn={running:!1,done:mn.done,total:n.length,message:`실패: ${c?.message||c}`},c}}async function Sl(){const e=tr();return Gp(e)}function Al(e){return!!(e.base||e.char||e.primary||e.secondary||e.female||e.male)}async function Ml(){const e=Jr();if(e==="off")return null;if(e==="embed_snap")return u(await ce("curation_embed_hint"),4e3)||cp();const t=await pt(),n=Gr();return Yn(t)?Ip(t,n):ip(t,n)}async function Nl(e,t){if(!e.length)return;const n=u(t?.chatContext,1e5),r=await pt();if(Yn(r)){for(const a of e)gp(a);if(e.some(a=>!!bs(r,{preset_path:a.preset_path,composition_id:a.composition_id,composition_variant:a.composition_variant}))){await bg(r,e,n);return}w("curation.preset_refine",{message:"no composition_id on shots → falling back to group refine"},"warn")}await yg(r,e,n)}function Il(e,t,n){const r=[{role:"system",content:e}];return t&&r.push({role:"user",content:t}),r.push({role:"user",content:JSON.stringify(n)}),r}async function yg(e,t,n){const r=Gr(),a=g=>{const h=g.curation_groups;return Array.isArray(h)?h.map(_=>u(_,160)).filter(Boolean):u(h,400).split(/[,|]/).map(_=>_.trim()).filter(Boolean)},s=t.map(a),i=[...new Set(s.flat())];if(!i.length){w("curation.group_refine",{message:"no curation_groups on shots — skip"},"warn");return}const o=op(e,i,{strictIds:r}),c=`${u(await ce("curation_refine"),6e3)||o}

${o}`,l=Lc(t,n),f={shots:t.map((g,h)=>({shot_index:h,y_percent:g.y_percent??g.anchor_percent??null,...l[h],curation_groups:s[h],camera:g.camera||"",situation:g.situation||g.scene||"",place:g.place||"",action:g.action||"",natural:g.natural||"",character_count:Array.isArray(g.characters)?g.characters.length:0,cast:Zc(g)}))},d=await Jt(E().llm,Il(c,n,f)),p=_r(d);if(!p||typeof p!="object")return;El(t,p,(g,h)=>{if(!h||typeof h!="object")return;const _=h.curation_option_ids??h.option_ids,y=Xc(e,_);Al(y)?(hs(g,y,{place:h.place!=null?h.place:g.place,situation:""}),g.curation_option_ids=_):(h.place!=null&&(g.place=u(h.place,400)),r||(h.camera!=null&&(g.camera=u(h.camera,600)),h.situation!=null&&(g.situation=u(h.situation,600)),h.action!=null&&(g.action=u(h.action,600)))),r&&Array.isArray(h.characters)&&el(g,Qc(h.characters),e)})}async function bg(e,t,n){const r=Gr(),a=t.map(d=>bs(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant}));if(!a.some(Boolean))return;const s=Cp(e,a.filter(Boolean),{strictIds:r}),i=Lc(t,n),o={shots:t.map((d,p)=>({shot_index:p,y_percent:d.y_percent??d.anchor_percent??null,...i[p],composition_id:d.composition_id||"",composition_variant:d.composition_variant||"",place:d.place||"",natural:d.natural||"",character_count:Array.isArray(d.characters)?d.characters.length:0,cast:Zc(d)}))};let c=null;try{const d=await Jt(E().llm,Il(s,n,o));c=_r(d)}catch(d){w("curation.preset_refine",{message:String(d?.message||d)},"warn")}const l=new Map,f=(d,p,m)=>{const g=p&&typeof p=="object"?p.curation_option_ids??p.option_ids:d.curation_option_ids,h=g!=null?Hc(e,g):[];for(const x of xp(e,a[m])){const M=[...x.include_options||[],...x.action?.include_options||[]];M.length&&l.set(x.ref,{ids:M,binding:x})}const _=[...l.values()].flatMap(x=>x.ids),y=[...l.values()].map(x=>x.binding),v=Mp(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant,curation_option_ids:h},{optionIds:_,bindings:y});if(v&&Al(v)&&(hs(d,v,{place:p&&p.place!=null?p.place:d.place,situation:""}),g!=null&&(d.curation_option_ids=h),e.fixed_positive&&(d.curation_fixed_positive=e.fixed_positive)),r){const x=p&&typeof p=="object"?p.characters:void 0;Array.isArray(x)&&el(d,Qc(x),e)}};if(c&&typeof c=="object"){El(t,c,f);return}t.forEach((d,p)=>f(d,null,p))}function El(e,t,n){const r=Array.isArray(t.shots)?t.shots:Array.isArray(t)?t:null;if(r){for(let a=0;a<e.length;a++){const s=r.find(i=>i&&typeof i=="object"&&Number(i.shot_index)===a);n(e[a],s||r[a],a)}return}e.length===1&&n(e[0],t,0)}async function Cl(e){if(!e.length)return{ok:!0,snapped:0};const t=await pt(),n=await Ms(),r=t.sha||Zn(t);if(!n?.items?.length)return{ok:!1,reason:"임베딩 없음 → 큐레이션 없이 생성"};if(n.catalog_sha!==r)return{ok:!1,reason:"임베딩 stale → 큐레이션 없이 생성"};const a=e.map(i=>{const o=N(u(i.camera,600),u(i.situation||i.scene,600),u(i.place,400),u(i.action,600));return Lp(o)}),s=a.flat();if(!s.length)return{ok:!0,snapped:0};try{const i=tr(),{vectors:o}=await vs(i,s);let c=0,l=0;for(let f=0;f<e.length;f++){const d=a[f],p=o.slice(c,c+d.length);if(c+=d.length,!d.length)continue;const{baseTags:m,charTags:g,primaryTags:h,secondaryTags:_,femaleTags:y,maleTags:v,snapped:x}=Op(d,p,n.items);l+=x,hs(e[f],{base:N(...m),char:N(...g),primary:N(...h),secondary:N(..._),female:N(...y),male:N(...v)},{place:"",situation:""})}return{ok:!0,snapped:l}}catch(i){const o=`임베딩 API 실패 → 큐레이션 없이 생성 (${i?.message||i})`;return w("curation.snap",{message:o},"warn"),{ok:!1,reason:o}}}async function jl(e){const t=E(),n=t.curation&&typeof t.curation=="object"?{...t.curation}:{},r={...n,...e};if(e.mode!=null&&(r.mode=Fa(e.mode)),e.strict_ids!=null&&(r.strict_ids=Da(e.strict_ids)),e.embedding&&typeof e.embedding=="object"){const a=n.embedding&&typeof n.embedding=="object"?{...n.embedding}:{},s=e.embedding,i={...a,...s};if("api_key"in s){const o=s.api_key;delete i.api_key,delete i.api_key_configured,u(o)&&(i.api_key=o),(s.clearApiKey||e.clear_embedding_key)&&(i.api_key=""),delete i.clearApiKey}i.provider!=null&&(i.provider=$e(i.provider)),r.embedding=i}return t.curation=r,e.mode!=null&&t.card&&typeof t.card=="object"&&(t.card.composition_curation=!1),yr(t),await Xe(),{ok:!0}}var Tl,mn,rr=T((()=>{Ym(),ys(),jp(),Lt(),Rp(),re(),Y(),B(),cl(),St(),Mr(),fe(),Ze(),Kr(),Tl=400,mn={running:!1,done:0,total:0,message:""}}));rr(),re(),Y(),wt(),te(),Ft();async function Wr(e,t,n,r=1,a=3){const s=Ve(n),i=Math.max(0,Math.min(1,Number(r)||1)),o={image:await Ge(t),information_extracted:i,model:s};let c="";for(let l=1;l<=a;l++)try{w("nai.encode_vibe.start",{message:s,ie:i,attempt:l,focus:!0});const f=await Je(ni,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(o)}),d=Number(f?.status||0);if([502,503,504,520].includes(d)){c=`HTTP ${d}`,await at(2*l*1e3);continue}if(d<200||d>=300){let g="";try{g=typeof f?.text=="function"?await f.text():""}catch{}if(c=`HTTP ${d}: ${String(g).slice(0,200)}`,l<a){await at(1e3);continue}break}const p=await un(f,{timeoutMs:6e4}),m=await Ge(p);return w("nai.encode_vibe.done",{message:s,bytes:p?.byteLength||0,focus:!0}),m}catch(f){if(c=String(f?.message||f),l<a){await at(1e3);continue}}throw new Error(`encode-vibe 실패 (${a}회): ${c}`)}re(),B(),ze(),fe(),Ze();var Ns=12582912,Qe=32;async function wg(){const e=await D("meta","reference_image");return!!(e?.png&&e.png.byteLength>Qe)}async function $l(){return(await D("meta","reference_image"))?.png||null}async function vg(e){if(!e||e.byteLength<Qe)throw new Error("참조 이미지가 비어 있습니다");if(e.byteLength>Ns)throw new Error("참조 이미지가 너무 큽니다 (최대 12MB)");return await z("meta",{key:"reference_image",png:e}),ma(Ot(e)),E().nai.image_reference="file",await Xe(),{ok:!0,image_reference:"file",configured:!0,bytes:e.byteLength,preview_url:"/v1/nai/reference.png"}}async function Pl(){return await Ct("meta","reference_image"),ma(""),E().nai.image_reference="none",await Xe(),{ok:!0,image_reference:"none",configured:!1}}async function xg(){const e=await D("meta","vibe_transfer");return!!(e?.encoded&&e?.png&&e.png.byteLength>Qe)}async function kg(){return await D("meta","vibe_transfer")||null}async function Sg(){return(await D("meta","vibe_transfer"))?.png||null}function qr(e){let t=Number(e??1);return Number.isNaN(t)&&(t=1),Math.max(0,Math.min(1,t))}async function Ag(e,t={}){if(!e||e.byteLength<Qe)throw new Error("Vibe 이미지가 비어 있습니다");if(e.byteLength>Ns)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const n=E(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const a=Ye(t.model||n.nai.model||"nai-diffusion-4-5-full"),s=qr(t.information_extracted??n.nai.vibe_transfer_information_extracted),i=await Wr(r,e,a,s);return await z("meta",{key:"vibe_transfer",png:e,encoded:i,model:Ve(a),information_extracted:s}),pa(Ot(e)),n.nai.vibe_transfer="file",t.strength!=null&&!Number.isNaN(Number(t.strength))&&(n.nai.vibe_transfer_strength=Math.max(0,Math.min(1,Number(t.strength)))),n.nai.vibe_transfer_information_extracted=s,await Xe(),{ok:!0,vibe_transfer:"file",configured:!0,bytes:e.byteLength,encoded_bytes:i.length,model:Ve(a),information_extracted:s,preview_url:"/v1/nai/vibe.png"}}async function Ol(){return await Ct("meta","vibe_transfer"),pa(""),E().nai.vibe_transfer="none",await Xe(),{ok:!0,vibe_transfer:"none",configured:!1}}async function Mg(){const e=await kg();if(!e?.png||e.png.byteLength<Qe)return null;const t=E(),n=u(t.nai.api_key);if(!n)throw new Error("NAI api_key가 설정되지 않았습니다.");const r=Ve(Ye(t.nai.model||"nai-diffusion-4-5-full")),a=qr(t.nai.vibe_transfer_information_extracted);if(!(!u(e.encoded)||u(e.model)!==r||Math.abs(Number(e.information_extracted??1)-a)>.001))return e;const s=await Wr(n,e.png,r,a),i={...e,key:"vibe_transfer",encoded:s,model:r,information_extracted:a};return await z("meta",i),i}async function Ll(e){const t=u(e,120);return t&&await D("meta",qt(t))||null}async function Ng(e,t,n={}){const r=u(e,120);if(!r)throw new Error("preset_id required");if(!t||t.byteLength<Qe)throw new Error("Vibe 이미지가 비어 있습니다");if(t.byteLength>Ns)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const a=E(),s=u(a.nai.api_key);if(!s)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const i=Ye(n.model||a.nai.model||"nai-diffusion-4-5-full"),o=qr(n.information_extracted??a.nai.vibe_transfer_information_extracted),c=await Wr(s,t,i,o),l=qt(r);await z("meta",{key:l,png:t,encoded:c,model:Ve(i),information_extracted:o});const f=Ot(t);return br(r,f),{ok:!0,preset_id:r,vibe_transfer:"file",configured:!0,bytes:t.byteLength,encoded_bytes:c.length,model:Ve(i),information_extracted:o,preview_url:f}}async function Bl(e){const t=u(e,120);if(!t)throw new Error("preset_id required");return await Ct("meta",qt(t)),br(t,""),{ok:!0,preset_id:t,vibe_transfer:"none",configured:!1}}async function Ig(e,t){const n=await Ll(e);if(!n?.png||n.png.byteLength<Qe)return!1;const r=u(t,120);if(!r)return!1;await z("meta",{key:qt(r),png:n.png,encoded:n.encoded||"",model:n.model||"",information_extracted:n.information_extracted??1});const a=ga(e)||(n.png?Ot(n.png):"");return a&&br(r,a),!0}async function Eg(e){const t=await Ll(e);if(!t?.png||t.png.byteLength<Qe)return null;const n=E(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=Ve(Ye(n.nai.model||"nai-diffusion-4-5-full")),s=qr(n.nai.vibe_transfer_information_extracted);if(!(!u(t.encoded)||u(t.model)!==a||Math.abs(Number(t.information_extracted??1)-s)>.001))return t;const i=await Wr(r,t.png,a,s),o=qt(u(e,120)),c={...t,key:o,encoded:i,model:a,information_extracted:s};return await z("meta",c),c}async function Cg(){for(const e of await Ae("meta")){const t=String(e?.key||"");if(!Vt(t))continue;const n=e.png;!n||n.byteLength<Qe||br(Sn(t),Ot(n))}}Zt(),Lt(),re(),Y(),B(),Nt(),De(),ls(),ze(),fe(),Ze();function Rl(e,t){const n=Number(e);return Math.max(1,Math.min(5e3,Number.isFinite(n)&&n>0?Math.round(n):t))}async function Vr(e){const{shot:t,roster:n}=e,r=E().card,a=E().nai,s=ct(r),i=ka(t.characters||[],n,s).slice(0,s),o=Math.max(1,i.length),c=fo(r.person_tag_mode,r.auto_person_tags),l=Cf(Tf(i,n,c,null,r.person_tag_solo),r.person_tag_weight),[f,d]=Gu(await ce("preset_1")),p=Array.isArray(r.presets)?r.presets:[],m=u(r.active_preset_id,120);let g=null;p.length&&(m&&(g=p.find(q=>typeof q=="object"&&u(q.id,120)===m)||null),!g&&typeof p[0]=="object"&&(g=p[0]));let h,_;g?(h=u(g.positive||g.pos||""),_=u(g.negative||g.neg||"")):(h=N(u(r.custom_pos),f),_=N(u(r.custom_neg),d));let y=t.situation||t.scene;const v=u(e.lockedSetup||"");let x;v?x=v:(x=N(t.camera,y,t.place,t.action),r.mode==="asset"&&(x=N(x,"white background","simple background","cowboy shot","looking at viewer","portrait")));const M=za(r.natural_base),L=M==="supplement"?600:M==="detailed"?480:400,C=M==="off"?"":u(t.natural||t.natural_base||t.nl||"",L);let $="",F="";if(u(t.composition_id,160)||u(t.curation_fixed_positive,200))try{const q=await pt();$=u(t.curation_fixed_positive,800)||u(q.fixed_positive,800),F=u(q.fixed_negative,800)}catch{$=u(t.curation_fixed_positive,800)}let k=N(h,C,x,$);c!=="off"&&(k=uo(k),x=uo(x));let I=l?k?`${l}, ${k}`:l:k;const P=Ye(a.model||"nai-diffusion-4-5-full");a.apply_quality_tags!==!1&&(I+=On[P]||"");const J=u(a.uc_preset)||"human_focus",A=N(_,F,(qi[P]||{})[J]||""),W=[],K=[];for(let q=0;q<i.length;q++){const H=i[q],ge=u(H.name,200),G=ge?Se(ge,n):null,le=N($f(G,H)),Q=u(H.negative),Wt=o===1?.5:Math.round((.1+.8*q/Math.max(1,o-1))*10)/10,lr=.5;W.push({prompt:le||"girl",uc:Q,center_x:Wt,center_y:lr}),K.push({name:G?.name||ge,prompt:le,uc:Q,center_x:Wt,center_y:lr,raw:H})}return{main:I,neg:A,captions:W,meta:{setup:x,person:l,characters:K,paragraph:t.paragraph}}}async function Fl(e,t){const n=E().nai,r=!!E().card?.auto_aspect,a=e.width&&e.height?{width:Rl(e.width,832),height:Rl(e.height,1216),aspect:"settings"}:Ud(t,n,r),s=e.captions;if(Vn(n)==="comfy"){const x={...n,width:a.width,height:a.height},[M,L]=await zm(x,e.main,e.neg,s);return{bytes:M,seed:L}}const i=u(n.api_key);if(!i)throw new Error("NAI api_key가 설정되지 않았습니다.");const o=[],c=u(n.image_reference||"none").toLowerCase();if(!["","none","off","false","0"].includes(c)){const x=await $l();if(x){let M=u(n.image_reference_type||"character&style")||"character&style";["character","style","character&style"].includes(M)||(M="character&style");let L=Number(n.image_reference_strength??.6),C=Number(n.image_reference_fidelity??1);Number.isNaN(L)&&(L=.6),Number.isNaN(C)&&(C=1),o.push({image:x,type:M,strength:Math.max(0,Math.min(1,L)),fidelity:Math.max(0,Math.min(1,C))})}}const l=E().card,f=Array.isArray(l.presets)?l.presets:[],d=u(l.active_preset_id,120);let p=null;f.length&&(d&&(p=f.find(x=>typeof x=="object"&&u(x.id,120)===d)||null),!p&&typeof f[0]=="object"&&(p=f[0]));const m=u(p?.id||d,120),g=Mm(n,p),h=[];let _=m?await Eg(m):null;if(!_){const x=u(n.vibe_transfer||"none").toLowerCase();["","none","off","false","0"].includes(x)||(_=await Mg())}if(_?.encoded){let x=Number(n.vibe_transfer_strength??.6),M=Number(n.vibe_transfer_information_extracted??_.information_extracted??1);Number.isNaN(x)&&(x=.6),Number.isNaN(M)&&(M=1),h.push({encoded:_.encoded,strength:Math.max(0,Math.min(1,x)),information_extracted:Math.max(0,Math.min(1,M))})}const y={prompt:e.main,negative_prompt:e.neg,width:a.width,height:a.height,seed:Number(n.seed??0)||0,steps:Math.min(Number(n.steps??28)||28,28),cfg_scale:g.cfg_scale,cfg_rescale:g.cfg_rescale,sampler:u(n.sampler)||"k_euler_ancestral",scheduler:u(n.scheduler)||"karras",model:Ye(n.model||"nai-diffusion-4-5-full"),var_plus:!!n.variety_plus,characters:s,character_refs:o,vibes:h};w("nai.generate.dims",{message:`${y.width}x${y.height}`,aspect:a.aspect,auto_aspect:r,steps:y.steps,focus:!0}),y.seed||(y.seed=Math.floor(Math.random()*4294967295)||1);const v=u(n.request_url)||"https://image.novelai.net/ai/generate-image";return{bytes:(await Oc(i,y,v,{timeoutMs:9e4})).raw_bytes,seed:y.seed||0}}function jg({imageId:e,sessionId:t,request:n,shotIndex:r,paragraph:a,yPercent:s,line:i=null,contentHash:o="",assistantPreview:c=""}){const l=Math.floor(Number(i));return{version:1,image_id:u(e,80),session_id:u(t,200),unified_session_id:u(n.unified_session_id||"",200),character_id:u(n.character_id||"",200),character_name:u(n.character_name||"",200),chat_id:u(n.chat_id||"",200),chat_name:u(n.chat_name||"",200),char_index:O(n.char_index,-1),chat_index:O(n.chat_index,-1),message_index:O(n.message_index,-1),message_role:u(n.message_role||n.role||"",40).toLowerCase(),shot_index:O(r,0),paragraph:O(a,0),y_percent:s,line:Number.isFinite(l)&&l>=1?l:null,content_hash:u(o||n.content_hash||"",128),assistant_preview:u(c||n.assistant_text||"",st)}}async function gt(e){return Xf(e)}async function Dl(e,t){const n=await D("images",e),r=n?{...n}:{id:e},a=t||{};r.location={...a,version:Number(a.version||1),image_id:u(e,80)},await z("images",r)}async function ht(e,t={}){const n=await gt(e),r=typeof t=="object"&&t?t:{};let a=n.y_percent;a==null&&(a=r.y_percent??r.anchor_percent??r.read_percent);const s=Object.keys(n).length>0,i=Pe(u(e,80));return{character_id:u(n.character_id||r.character_id||"",200),chat_id:u(n.chat_id||r.chat_id||"",200),character_name:u(n.character_name||r.character_name||"",200),chat_name:u(n.chat_name||r.chat_name||"",200),char_index:O(n.char_index??r.char_index,-1),chat_index:O(n.chat_index??r.chat_index,-1),message_index:O("message_index"in n?n.message_index:r.message_index,-1),message_role:u(n.message_role||r.message_role||"",40).toLowerCase(),shot_index:O(n.shot_index,-1),paragraph:O("paragraph"in n?n.paragraph:r.paragraph,0),y_percent:hr(a),line:(()=>{const o=Math.floor(Number(n.line??r.line));return Number.isFinite(o)&&o>=1?o:null})(),content_hash:u(n.content_hash||r.content_hash||"",128),assistant_preview:u(n.assistant_preview||r.assistant_preview||"",st),unified_session_id:u(n.unified_session_id||r.unified_session_id||"",200),location_file:s?`idb:${i}`:"",storage:"indexeddb",storage_key:i}}function Is(e,t,n=0){const r=typeof e=="object"&&e?{...e}:{},a=t||{};return{...r,character_id:u(a.character_id||r.character_id||"",200),chat_id:u(a.chat_id||r.chat_id||"",200),character_name:u(a.character_name||r.character_name||"",200),chat_name:u(a.chat_name||r.chat_name||"",200),char_index:O(a.char_index??r.char_index,-1),chat_index:O(a.chat_index??r.chat_index,-1),message_index:O(a.message_index??r.message_index,-1),message_role:u(a.message_role||r.message_role||"",40).toLowerCase(),content_hash:u(a.content_hash||r.content_hash||"",128),assistant_preview:u(a.assistant_preview||r.assistant_preview||"",st),unified_session_id:u(a.unified_session_id||r.unified_session_id||"",200),y_percent:hr(a.y_percent??r.y_percent),line:(()=>{const s=Math.floor(Number(a.line??r.line));return Number.isFinite(s)&&s>=1?s:null})(),storage:"indexeddb",storage_key:Pe(u(a.image_id||"",80)),png_bytes:Number(n)||0}}te();var Tg=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t+=1){let n=t;for(let r=0;r<8;r+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e})();function Es(e){return Array.isArray(e)?new Uint8Array(e):ee(e)}function $g(e){const t=Es(e);let n=4294967295;for(let r=0;r<t.length;r+=1)n=Tg[(n^t[r])&255]^n>>>8;return(n^4294967295)>>>0}function V(e){const t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e>>>0,!0),t}function be(e){const t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function ar(e){let t=0;for(const n of e)t+=n.length;return jn(e,t)}function Pg(e){return new TextEncoder().encode(String(e??""))}function Og(e=[]){const t=[],n=[];let r=0;for(const i of e){const o=Pg(i.name||"file"),c=Es(i.data),l=$g(c),f=ar([be(67324752),V(20),V(0),V(0),V(0),V(0),be(l),be(c.length),be(c.length),V(o.length),V(0),o,c]),d=ar([be(33639248),V(20),V(20),V(0),V(0),V(0),V(0),be(l),be(c.length),be(c.length),V(o.length),V(0),V(0),V(0),V(0),be(0),be(r),o]);t.push(f),n.push(d),r+=f.length}const a=ar(n),s=ar([be(101010256),V(0),V(0),V(e.length),V(e.length),be(a.length),be(r),V(0)]);return ar([...t,a,s])}function Cs(e,t){return e[t]|e[t+1]<<8}function zl(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Lg(e){const t=Es(e),n=new Map;let r=0;for(;r+30<=t.length;){const a=zl(t,r);if(a===33639248||a===101010256)break;if(a!==67324752){r+=1;continue}const s=Cs(t,r+8),i=zl(t,r+18),o=Cs(t,r+26),c=Cs(t,r+28),l=r+30,f=new TextDecoder().decode(t.subarray(l,l+o)),d=l+o+c,p=d+i;if(p>t.length)break;s===0&&n.set(f.replace(/\\/g,"/"),t.subarray(d,p)),r=p}return n}function Bg(e=[],{exportedAt:t=Date.now()}={}){return{format:"inlay-nexus-gallery",version:1,exported_at:t,items:(e||[]).map(n=>({id:String(n.id||""),file:`images/${String(n.id||"unknown")}.png`,location:{character_id:n.character_id||"",chat_id:n.chat_id||"",character_name:n.character_name||"",chat_name:n.chat_name||"",char_index:n.char_index??-1,chat_index:n.chat_index??-1,message_index:n.message_index??-1,content_hash:n.content_hash||"",paragraph:n.paragraph??0,shot_index:n.shot_index??0,y_percent:n.y_percent??null,assistant_preview:n.assistant_preview||"",session_id:n.session_id||""},meta:{main_prompt:n.main_prompt||"",seed:n.seed??null,created_at:n.created_at??null,characters:n.characters||[]}}))}}function Rg(e,t=[]){const n=e?.location||{},r=String(n.content_hash||"").trim(),a=t||[];if(r){const l=a.find(f=>String(f.content_hash||"")===r);if(l)return{status:"exact",matchId:String(l.id),content_hash:r}}const s=String(n.character_id||""),i=String(n.chat_id||""),o=Number(n.message_index),c=a.filter(l=>s&&String(l.character_id||"")!==s||i&&String(l.chat_id||"")!==i||Number.isFinite(o)&&o>=0&&Number(l.message_index)!==o?!1:!!(s||i||Number.isFinite(o)&&o>=0)).slice(0,8);return c.length?{status:"candidate",candidates:c.map(l=>({id:l.id,content_hash:l.content_hash,message_index:l.message_index})),location:n}:{status:"orphan",location:n}}function Fg(e=[]){return Og(e)}function Dg(e){const t=Lg(e);let n=null;const r=t.get("manifest.json");if(r)try{n=JSON.parse(new TextDecoder().decode(r))}catch{n=null}const a=new Map;for(const[s,i]of t.entries())s!=="manifest.json"&&/\.(png|webp|jpe?g)$/i.test(s)&&a.set(s.replace(/\\/g,"/"),i);return{manifest:n,images:a,files:t}}re(),Y(),te(),B(),ze();function sr(e){try{const t=JSON.parse(e.meta_json||"{}");return t&&typeof t=="object"?t:{}}catch{return{}}}async function Ul(e,t){return(await qf(e))?.png_bytes||Number(t.png_bytes)||0}async function js(e){const t=(await Ae("cards")).sort((s,i)=>(i.created_at||0)-(s.created_at||0)).slice(0,Math.max(1,Math.min(2e3,e))),n={},r=[];for(const s of t){const i=sr(s),o=await ht(s.id,i),c=await gt(s.id),l=u(o.character_name||c.character_name||i.character_name||"",200),f=u(o.chat_name||c.chat_name||i.chat_name||"",200),d=u(o.character_id||"",200)||"unknown",p=u(o.chat_id||"",200)||"unknown",m=`${d}|${p}`;let g=n[m];g||(g={key:m,character_id:d,chat_id:p,character_name:l||d.slice(0,12)||"Unknown",chat_name:f||`chat ${o.chat_index??"?"}`,char_index:o.char_index??-1,chat_index:o.chat_index??-1,count:0,storage:"indexeddb"},n[m]=g),l&&!g.character_name&&(g.character_name=l),f&&(g.chat_name=f),g.count+=1,r.push({id:s.id,job_id:s.job_id,session_id:s.session_id,folder_key:m,shot_index:o.shot_index>=0?o.shot_index:s.shot_index,paragraph:Object.keys(c).length?o.paragraph:s.paragraph,y_percent:o.y_percent,line:o.line,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:d,character_name:g.character_name,chat_id:p,chat_name:g.chat_name,char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:u(o.assistant_preview||c.assistant_preview||i.assistant_preview||"",st),main_prompt:s.main_prompt,characters:JSON.parse(s.characters_json||"[]"),image_url:Ue(s.id),seed:s.seed,created_at:s.created_at,storage:"indexeddb",storage_key:o.storage_key||Pe(s.id),location_file:o.location_file||"",png_bytes:await Ul(s.id,i)})}const a={ok:!0,folders:Object.values(n).sort((s,i)=>`${s.character_name||""}`.localeCompare(`${i.character_name||""}`,void 0,{sensitivity:"base"})||`${s.chat_name||""}`.localeCompare(`${i.chat_name||""}`,void 0,{sensitivity:"base"})),items:r,total:r.length,storage:"indexeddb",storage_api:"getLocalPluginStorage"};return await ut(a,{cachedOnly:!0,warmMissing:!1}),a}async function zg(e=400){return js(e)}async function Ug(e,t=40){const n=(await Ca(e)).sort((s,i)=>(i.created_at||0)-(s.created_at||0)).slice(0,Number(t)),r=[];for(const s of n){const i=sr(s),o=await ht(s.id,i),c=await gt(s.id);r.push({id:s.id,job_id:s.job_id,shot_index:o.shot_index>=0?o.shot_index:s.shot_index,paragraph:Object.keys(c).length?o.paragraph:s.paragraph,y_percent:o.y_percent,line:o.line,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:o.character_id||"",chat_id:o.chat_id||"",character_name:o.character_name||"",chat_name:o.chat_name||"",char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:o.assistant_preview||i.assistant_preview||"",main_prompt:s.main_prompt,negative_prompt:s.negative_prompt,characters:JSON.parse(s.characters_json||"[]"),image_url:Ue(s.id),seed:s.seed,created_at:s.created_at,storage:"indexeddb",storage_key:o.storage_key||Pe(s.id),png_bytes:await Ul(s.id,i)})}const a={ok:!0,session_id:e,items:r,storage:"indexeddb"};return await ut(a,{cachedOnly:!0}),a}async function Hl(e={}){const t=u(e.session_id,200),n=u(e.to_hash,128),r=u(e.assistant_preview||"",st),a=(Array.isArray(e.card_ids)?e.card_ids:[]).map(c=>u(c,80)).filter(Boolean);if(!n||!a.length)return{ok:!1,...se("to_hash and card_ids required","bad_request"),rebound:0,ids:[]};const s=new Set(a),i=new Set;for(const c of a){const l=await D("cards",c),f=u(l?.job_id||"",80);f&&i.add(f)}if(i.size&&t)for(const c of await Ca(t)){const l=u(c?.job_id||"",80);if(!l||!i.has(l))continue;const f=u(c?.id||"",80);f&&s.add(f)}const o=[];for(const c of s){const l=await D("cards",c);if(!l||t&&u(l.session_id||"",200)!==t)continue;const f=sr(l),d=await gt(c);if(u(d.content_hash||f.content_hash||"",128)===n)continue;const p={...d,image_id:c,content_hash:n,assistant_preview:r||d.assistant_preview||""};await Dl(c,p),f.content_hash=n,r&&(f.assistant_preview=r),f.message_role=u(f.message_role||d.message_role||"",40).toLowerCase(),l.meta_json=JSON.stringify(f),await z("cards",l),o.push(c)}return w("gallery.rebind",{n:o.length,to:n.slice(0,8)}),{ok:!0,rebound:o.length,ids:o,content_hash:n}}async function Ts(e,t="",n=null){const r=u(e,200),a=u(t);let s=null;try{n!=null&&String(n).trim()!==""&&(s=parseInt(String(n),10))}catch{s=null}if(!r||!a&&s==null)return{ok:!0,unlinked:0,ids:[]};const i=(await Ca(r)).sort((c,l)=>(c.created_at||0)-(l.created_at||0)),o=[];for(const c of i){const l=sr(c),f=await ht(c.id,l),d=u(f.content_hash||""),p=O(f.message_index,-1);let m=!1;if((a&&d&&d===a||s!=null&&s>=0&&p===s)&&(m=!0),!m)continue;const g={...await gt(c.id),version:1,image_id:c.id,session_id:r,content_hash:"",message_index:-1,character_id:"",chat_id:"",char_index:-1,chat_index:-1,unlinked_at:Date.now()/1e3};await Dl(c.id,g),(l.content_hash||l.message_index!=null||l.assistant_preview)&&(l.content_hash="",l.assistant_preview="",l.message_index=-1,l.unlinked_at=Date.now()/1e3,c.meta_json=JSON.stringify(l),await z("cards",c)),o.push(c.id)}return{ok:!0,unlinked:o.length,ids:o}}async function $s(e){const t=u(e,80);return t?await D("cards",t)?(await Ct("cards",t),await Ct("images",t),{ok:!0,deleted:1,ids:[t]}):{ok:!1,...se("card not found","not_found")}:{ok:!1,...se("card_id required","bad_request")}}async function Ps(e){return $s(e)}async function Hg(e=[]){const t=[...new Set((e||[]).map(r=>u(r,80)).filter(Boolean))],n=[];for(const r of t)(await $s(r)).ok&&n.push(r);return{ok:!0,deleted:n.length,ids:n}}async function Kl(){const e=(await D("meta","explorer_favorites"))?.ids;return{ok:!0,ids:Array.isArray(e)?e.map(t=>u(t,80)).filter(Boolean):[]}}async function Kg(e=[]){const t=[...new Set((e||[]).map(n=>u(n,80)).filter(Boolean))].slice(0,5e3);return await z("meta",{key:"explorer_favorites",ids:t,updated_at:Date.now()/1e3}),{ok:!0,ids:t}}async function Jg(e={}){let t=(await js(2e3)).items;const n=u(e.folder_key||"",400);if(!e.all)if(n)t=t.filter(i=>i.folder_key===n);else if(Array.isArray(e.card_ids)&&e.card_ids.length){const i=new Set(e.card_ids.map(o=>u(o,80)));t=t.filter(o=>i.has(o.id))}else return{ok:!1,...se("card_ids, folder_key, or all required","bad_request")};if(!t.length)return{ok:!1,...se("no images to export","empty")};const r=Bg(t),a=[{name:"manifest.json",data:new TextEncoder().encode(JSON.stringify(r,null,2))}];for(const i of t){const o=await Jl(i.id);o?.byteLength&&a.push({name:`images/${i.id}.png`,data:ee(o)})}if(a.length<2)return{ok:!1,...se("image bytes missing","empty")};const s=Fg(a);return{ok:!0,count:a.length-1,filename:`inlay-gallery-${Date.now()}.zip`,zip_base64:Yt(s),bytes:s.length}}async function Gg(e={}){const t=e.prefer_new_ids===void 0?!0:e.prefer_new_ids,n=String(e.zip_base64||"").replace(/^data:.*base64,/,"");if(!n)return{ok:!1,...se("zip_base64 required","bad_request")};let r;try{r=Le(n)}catch(l){return{ok:!1,...se(`invalid base64: ${l?.message||l}`,"bad_request")}}const{manifest:a,images:s}=Dg(r);if(!a?.items?.length)return{ok:!1,...se("manifest.items missing","bad_request")};const i=(await js(2e3)).items,o=[],c={exact:0,candidate:0,orphan:0,skipped:0};for(const l of a.items){const f=String(l.file||`images/${l.id}.png`).replace(/\\/g,"/"),d=s.get(f)||s.get(`images/${l.id}.png`);if(!d?.byteLength){c.skipped+=1;continue}const p=Rg(l,i);c[p.status]=(c[p.status]||0)+1;const m={...l.location||{}},g=t?xt():u(l.id||"",80)||xt(),h=u(m.session_id||"",200)||`import_${xt().replace(/-/g,"").slice(0,10)}`,_={version:1,image_id:g,session_id:h,character_id:u(m.character_id||"",200),character_name:u(m.character_name||"",200),chat_id:u(m.chat_id||"",200),chat_name:u(m.chat_name||"",200),char_index:O(m.char_index,-1),chat_index:O(m.chat_index,-1),message_index:O(m.message_index,-1),shot_index:O(m.shot_index,0),paragraph:O(m.paragraph,0),y_percent:hr(m.y_percent),content_hash:u(m.content_hash||"",128),assistant_preview:u(m.assistant_preview||"",st),imported_at:Date.now()/1e3,reattach:p.status},y=ne(d);await $a(g,y,_);const v=Is({...l.meta||{},assistant_preview:_.assistant_preview,imported_at:_.imported_at,reattach:p.status},_,y.byteLength||0);await z("cards",{id:g,job_id:`import_${g.slice(0,8)}`,session_id:h,shot_index:_.shot_index,paragraph:_.paragraph,main_prompt:u(l.meta?.main_prompt||"",8e3),negative_prompt:"",characters_json:JSON.stringify(l.meta?.characters||[]),seed:l.meta?.seed??0,meta_json:JSON.stringify(v),created_at:Number(l.meta?.created_at)||Date.now()/1e3}),o.push({id:g,reattach:p.status,content_hash:_.content_hash})}return{ok:!0,imported:o.length,items:o,report:c}}async function Wg(e){const t=u(e,400);if(!t||!t.includes("|"))return{ok:!1,...se("folder_key required","bad_request")};const[n,r]=t.split("|",2),a=u(n,200)||"unknown",s=u(r,200)||"unknown",i=await Ae("cards"),o=[];for(const c of i){const l=sr(c),f=await ht(c.id,l),d=u(f.character_id||"",200)||"unknown",p=u(f.chat_id||"",200)||"unknown";d!==a||p!==s||(await $s(c.id)).ok&&o.push(c.id)}return{ok:!0,deleted:o.length,ids:o,folder_key:`${a}|${s}`}}async function Jl(e){return nd(e)}B(),ze(),fe();var Os=["queued","tagging","generating"];function Yr(e={},t=""){const n=u(t||e.session_id||"",200)||"_",r=u(e.content_hash||"",128);if(r)return`${n}::h:${r}`;const a=O(e.message_index,-1);return a>=0?`${n}::m:${a}`:`${n}::all`}async function qg(e){if(wr.has(e))return"message-reroll";const t=Bn.get(e);if(!t?.jobId)return"";const n=Re.get(t.jobId);if(!n||n.cancelRequested)return"";const r=await D("jobs",t.jobId);return r&&Os.includes(String(r.state||""))?t.jobId:""}async function Ls(e={},t=""){const n=await qg(Yr(e,t));return n?{ok:!1,busy:!0,accepted:!1,job_id:n==="message-reroll"?"":n,session_id:u(t||e.session_id||"",200),job_state:"busy",error:{code:"busy",message:"같은 메시지 작업이 아직 진행 중입니다. 끝날 때까지 기다려 주세요."}}:null}function Gl(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function Wl(e){const t=Gl(e);return t.length?t.map((n,r)=>`L${r+1}|${n}`).join(`
`):""}function Vg(e){if(e.length<2)return!1;for(let t=0;t<e.length;t+=1){const n=Math.floor(Number(e[t]));if(!Number.isFinite(n)||n!==t+1)return!1}return!0}function Yg(e,t){const n=Math.max(1,Math.floor(Number(t)||0)),r=new Set;return e.map(a=>{const s=Number(a);let i=n<=1?1:Math.max(1,Math.min(n,Math.round((Number.isFinite(s)?Math.max(0,Math.min(100,s)):50)/100*(n-1))+1));if(!r.has(i))return r.add(i),i;for(let o=1;o<n;o+=1){const c=i+o;if(c<=n&&!r.has(c))return r.add(c),c;const l=i-o;if(l>=1&&!r.has(l))return r.add(l),l}return r.add(i),i})}function Xg(e,t){if(!Array.isArray(e)||e.length<2)return e.slice();const n=Gl(t).length;if(n<2||!Vg(e.map(a=>a.line)))return e.slice();const r=Yg(e.map(a=>a.y_percent),n);return e.map((a,s)=>({...a,line:r[s]??a.line}))}Y(),St(),B(),Lt(),Nt(),De(),fe(),rr(),Ze();function Zg(e){for(let t=e.length-1;t>=0;t--){const n=e[t];if(!n||n.role!=="user")continue;const r=typeof n.content=="string"?n.content:"";if(r.trim()&&!r.startsWith("# Priority: Author"))return r}return""}function ql(e){const t=u(e.assistant_text,2e4);return[...Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:[],...Wa(e.lorebook||[],t)].map(n=>u(n,200)).filter(Boolean)}async function Qg(e,t={}){const n=Be(E().card,e.card||{});if(sn(n.asset_nai_tags)==="off")return null;try{const r=u(e.session_id,200),a=Array.isArray(e.source_session_ids)?e.source_session_ids.map(i=>u(i,200)).filter(Boolean):[],s=await Gn(r,u(e.unified_session_id||"",200),u(e.character_id||"",200),a);return await bc(ql(e),{withPreviews:t.withPreviews===!0,roster:s,lorebook:Array.isArray(e.lorebook)?e.lorebook:null,message:u(e.assistant_text,2e4)})}catch(r){return Qa(new Map),w("asset-tags.collect.fail",{message:String(r?.message||r)},"warn"),null}}function eh(e){const t=u(e.name,200),n=u(e.appearance||"",200),r=u(e.attire||"",160),a=u(e.accessories||"",120),s=[n?`appearance=${n}`:"",r?`attire=${r}`:"",a?`accessories=${a}`:""].filter(Boolean);return s.length?`${t} ← ${s.join(" | ")}`:t}async function Vl(e,t,n,r,a,s={}){if(!n.lorebook)return;const i=Sd(a),o=Array.isArray(t.lore_trigger_keys)?t.lore_trigger_keys:null,c=ec(n.lore_extra),l=Md(t.lorebook||[],r,i,5,1200,o,c),f=[],d=[];for(const m of l){const g=Bt(m)||m.always,h=u(m.content||"",g?5e4:1200);if(!h)continue;const _=u(m.comment||"",200),y=_?`### ${_}
${h}`:h;g?f.push(y):s.extraOnly||d.push(y)}const p=[];f.length&&p.push(`## lb-xnai.lb.extra — OFFICIAL PACK (START)
...
[END OF lb-xnai.lb.extra] Pack finished — text below is not lb-xnai ground truth.`),d.length&&p.push(`## Reference Lorebook (trigger-matched only)
Naming/context only. Not lb-xnai. Do not copy lore prose into tags.

`+d.join(`

`)),w("job.lore.extra",{trigger_keys:Array.isArray(o)?o.length:0,injected:f.length,reference:d.length,extra_only:s.extraOnly===!0,sections:l.filter(m=>Bt(m)||m.always).map(m=>m.key||"").filter(Boolean).join(" | ")}),p.length&&e.push({role:"system",content:`${await ce("lore_inject")}
${p.join(`

`)}`})}function th(e,t,n){const r=e.filter(c=>u(c.name,200)&&!ue(c));if(!r.length)return[];const a=t.map(c=>u(c,200).toLowerCase()).filter(Boolean),s=r.filter(c=>{const l=[c.name,...Mt(c)].map(f=>u(f,200).toLowerCase()).filter(Boolean);return a.some(f=>l.some(d=>d===f||f.includes(d)||d.includes(f)))});if(s.length)return s;const i=co(n,r);if(!i.length)return[];const o=new Set(i.map(c=>u(c.name,200)).filter(Boolean));return r.filter(c=>o.has(u(c.name,200)))}async function nh(e,t,n=[],r=[]){const a=Be(E().card,e.card||{}),s=u(e.session_id,200),i=[{role:"system",content:Pn(await ce("char_looks")).trim()}],o=u(e.assistant_text,2e4),c=Array.isArray(e.source_session_ids)?e.source_session_ids.map(m=>u(m,200)).filter(Boolean):[],l=await Gn(s,u(e.unified_session_id||"",200),u(e.character_id||"",200),c);await Vl(i,e,a,o,l,{extraOnly:!0}),Yl(i,await ce("asset_tags_inject"),t,"char_looks_prepass",n);const f=th(l,n,o);if(f.length){const m=f.map(g=>{const h=Mt(g).slice(0,8).join(", ");return`- ${g.name}${h?` (aliases: ${h})`:""}`});i.push({role:"system",content:"## Incomplete (empty appearance) — fill these in `new_characters`\nUse these exact name spellings. Skip anyone already filled on the roster.\n"+m.join(`
`)})}w("job.char_looks.targets",{assets:n,incomplete:f.map(m=>m.name)});const d=(Array.isArray(r)?r:[]).filter(m=>m?.dataUrl&&/^data:image\//i.test(m.dataUrl)).slice(0,5),p="Fill `new_characters` for incomplete / asset-matched people from the NovelAI asset block"+(f.length?" and the Incomplete list":"")+". COPY tags verbatim into appearance / attire / accessories. JSON only.";if(d.length){const m=[{type:"text",text:p}];for(const g of d)m.push({type:"text",text:[`Image asset_name: ${u(g.name,200)}`,"role: selected_asset"].join(`
`)}),m.push({type:"image_url",image_url:{url:g.dataUrl}});i.push({role:"user",content:m}),w("job.char_looks.previews",{count:d.length,names:d.map(g=>g.name)})}else i.push({role:"user",content:p});return i}async function rh(e,t,n,r,a){if(t.char_appearance===!1)return;const s=a,i=s.filter(g=>ue(g)),o=s.filter(g=>u(g.name,200)&&!ue(g)),c=co(n,s);if(!i.length&&!o.length&&!c.length)return;const l=c.filter(g=>ue(g)),f=c.filter(g=>!ue(g)),d=l.length?l.map(eh).filter(Boolean).join(`
`):"(none)",p=f.length?f.map(g=>`- ${g.name} (aliases: ${Mt(g).slice(0,8).join(", ")}) → empty appearance; full looks required in new_characters`).join(`
`):"(none)";let m=await ce("appearance_inject");m.includes("{registered_block}")&&(m=m.replace("{registered_block}",d)),m=m.includes("{incomplete_block}")?m.replace("{incomplete_block}",p):`${m}

## Incomplete
${p}`,m=m.includes("{detected_block}")?m.replace("{detected_block}",d):`${m}

${d}`,e.push({role:"system",content:m}),w("job.roster.split",{filled:i.map(g=>g.name),incomplete:o.map(g=>g.name),matched:c.map(g=>g.name),matched_with_looks:l.map(g=>g.name),session_id:r})}function Yl(e,t,n,r,a){const s=t.includes("{asset_tags_block}")?t.replace("{asset_tags_block}",n):`${t}

${n}`;e.push({role:"system",content:s}),w("asset-tags.inject",{reason:r,assets:a})}async function ah(e,t={}){const n=Be(E().card,e.card||{}),r=u(e.session_id,200),a=[{role:"system",content:`${Pn(await ce("tagger"))}

${Pn(await ce("format"))}`.trim()}];n.char_info&&u(e.character_description)&&a.push({role:"system",content:`${await ce("char_inject")}
## {{char}} Info
${u(e.character_description,12e3)}`}),n.user_info&&u(e.persona_description)&&a.push({role:"system",content:`${await ce("char_inject")}
## {{user}} Info
${u(e.persona_description,8e3)}`});const s=u(e.assistant_text,2e4),i=Array.isArray(e.source_session_ids)?e.source_session_ids.map(y=>u(y,200)).filter(Boolean):[],o=n.lorebook||n.char_appearance!==!1||sn(n.asset_nai_tags)!=="off"?await Gn(r,u(e.unified_session_id||"",200),u(e.character_id||"",200),i):[];await Vl(a,e,n,s,o),await rh(a,n,s,r,o);const c=sn(n.asset_nai_tags);if(!t.skipAssetInject&&c!=="off"){const y=ql(e);try{const v=await bc(y,{withPreviews:!1,roster:o,lorebook:Array.isArray(e.lorebook)?e.lorebook:null,message:s});v?.block?Yl(a,await ce("asset_tags_inject"),v.block,`asset_nai_tags_${c}`,v.packed.groups.flatMap(x=>x.assets.map(M=>M.name))):(Qa(new Map),w("asset-tags.inject.skip",{reason:c,cause:"collect_empty",triggers:y.length}))}catch(v){Qa(new Map),w("asset-tags.inject.fail",{reason:c,message:String(v?.message||v)},"warn")}}else t.skipAssetInject?w("asset-tags.inject.skip",{reason:"prepass_done"}):c==="off"&&w("asset-tags.inject.skip",{reason:"off"});const l=za(n.natural_base),f=ct(n),d=Math.max(1,Number(n.image_min??1)||1),p=Math.max(d,Number(n.image_max??3)||3);a.push({role:"system",content:["Every shot MUST include `y_percent` (0–100): reading position top→bottom. Spread across the full range in order (shot0 < shot1 < …); ~even gaps. E.g. 2→~25/~75; 3→~20/~50/~80; 4→~15/~40/~65/~90. Forbidden: all under 40, duplicates, or gaps under ~15 unless 1 shot.","LINE: message lines are labeled `L1|…`, `L2|…`. Set each shot `line` to that L number (illustration sits immediately before that line). Pick the L# whose text matches the shot moment. `paragraph` = shot order (0,1,2…). `line` is NOT shot order. INVALID: emitting line=1,2,3… just because you have 1st/2nd/3rd shots.",d===p?`SHOT COUNT: produce exactly ${p} shot(s) in scenes[].shots (across all scenes).`:`SHOT COUNT: produce between ${d} and ${p} shots in scenes[].shots (across all scenes). Prefer the count that fits the message; never fewer than ${d} or more than ${p}.`,ih(l),`CHARACTER CAP: at most ${f} characters per shot (char1..char${f}). If more are visible, keep the ${f} most important; fold extras into situation/place.`,n.auto_aspect?"ASPECT (required on every shot): set `aspect` to exactly one of `portrait` (832×1216 vertical), `square` (1024×1024), or `landscape` (1216×832 horizontal). Pick from the scene framing — tall full-body / standing → portrait; equal crop / face close-up square → square; wide group / side-by-side / scenic → landscape. Like Asset Maid size presets 1/5/2.":""].filter(Boolean).join(`
`)});const m=await Ml();m&&a.push({role:"system",content:m});const g=[];if(Number(n.include_max||0)>0)for(const y of e.recent_messages||[]){const v=u(y?.role,40)||"char",x=u(y?.content||y?.data,12e3);x&&(s&&x===s&&["char","assistant","bot"].includes(v.toLowerCase())||g.push(`[${v}]
${x}`))}s&&g.push(Wl(s));const h=g.length?g.join(`

`):Wl(s);if(!h)throw new Error("태깅할 메시지 텍스트가 없습니다.");a.push({role:"user",content:h});const _=u(await ce("author_note"),8e3);return _&&a.push({role:"user",content:`# Priority: Author's Note
${_}
> These are instructions explicitly given by the user. If in conflict with previous instructions, this section MUST take precedence.`}),a}function sh(e,t){const n=ct(E().card),r=e,a=[];for(const s of r.scenes||[]){const i=u(s.place);for(const o of s.shots||[]){const c={...o,place:i,characters:ka(o.characters||[],[],n).slice(0,n)};a.push(c)}}return Xg(a,t??"")}function ih(e){return e==="off"?"Natural base mode OFF. Omit the `natural` field (or leave it empty). Do not invent natural-language base phrases.":e==="detailed"?["Natural base mode DETAILED. Every shot MUST include `natural`: a compact English phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include framing/vantage when useful (side view, close-up, viewed through, reflected in…), then for each visible person in left-to-right (or front-to-back) order: hair color + age band + gender, facial expression, clothing, and pose/action as separate details.","Multi-person: NEVER use character names — use position (left girl, right boy) or hair. Add shared action and lighting/atmosphere briefly.","Telegraphic and objective. Example: `side view upper body, left red hair adult woman tense smile in coat pulling right blue hair teen boy startled arms pinned, warm cafe light`. Keep ~12–28 words, English only."].join(" "):e==="supplement"?["Natural base mode SUPPLEMENT. Every shot MUST include `natural`: telegraphic English sentences describing what tags cannot express (composition, framing, actions, atmosphere, lighting) for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Keep tags and natural language clearly separated. Multi-person: NEVER use names — identify by position (left girl, bottom boy) or appearance. For each person include facial expression and clothing as distinct details; also hair and pose unless already obvious.","Unusual framing welcome (viewed through, reflected in shards of a broken mirror, behind…). Concise, minimal, objective — no subjective interpretation.","Example: `Side view, upper body. Left: adult woman with red hair, tense smile, coat, pulling. Right: teen boy with blue hair, startled face, arms pinned. Warm cafe lighting.` Prefer ~2–5 short sentences, English only."].join(" "):["Natural base mode SHORT. Every shot MUST include `natural`: a short English natural-language phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include hair color + age band + gender for each visible person, plus the shared action. Example: `red hair adult woman forced hug blue hair boy`. Keep ~6–20 words, English only."].join(" ")}var oh=_n({HASH_REBIND_THRESHOLD:()=>Zl,INLINE_KEEP_MAX_PER_SIDE:()=>1,PREFIX_MATCH_MIN_CHARS:()=>24,PREFIX_MATCH_THRESHOLD:()=>fh,SIMILARITY_COMPARE_MAX:()=>800,VIEWER_THUMB_LAYOUT:()=>ae,activeSegmentIndex:()=>s_,bigramCounts:()=>Bs,buildInlineChatHtml:()=>u_,canRetargetJobSaveHash:()=>nu,claimStickyMarkerByCardId:()=>Ph,clampPinPercent:()=>et,clampReadingPercent:()=>a_,clampShotLine:()=>_u,clampThumbScrollOffset:()=>qh,composeDualProgressBarsHtml:()=>t_,composeProgressToastHtml:()=>n_,composeSingleProgressBarHtml:()=>fu,composeStickyThumbHtml:()=>Dh,createDebouncedSaveQueue:()=>Th,createScrollSettleTracker:()=>Ch,createSessionChangeGuard:()=>jh,describeDomApiCompare:()=>wh,diceBigramRatio:()=>eu,evenAnchorPercent:()=>Hs,expandElementLineEntries:()=>xu,findCardsForMessageIdentity:()=>tu,findElementIndexForLine:()=>ku,findElementIndexForLineWithFallback:()=>l_,findHashRebindCandidates:()=>dh,findPlainLineStartOffset:()=>wu,fitBoxInside:()=>Fh,galleryFocusMessage:()=>gh,galleryForMessage:()=>ph,galleryIndexFromChildIndex:()=>Jh,gallerySelectedCount:()=>Us,galleryStripContentWidth:()=>Wh,galleryStripSplitAt:()=>Qr,hasGenerationInfo:()=>su,htmlToPlainLn:()=>c_,injectInlineImagesIntoHtml:()=>Mu,isCharMessageRole:()=>_h,isMessageSelectionGesture:()=>Nh,isNearbyDomIndex:()=>Xh,jobMatchesMessageIdentity:()=>Ds,lineTextOccurrence:()=>vu,linkCardsForMessage:()=>Fs,longestCommonPrefixLength:()=>Ql,markerBlockHtml:()=>Au,mergeViewerPaintJob:()=>Qh,messageCompactKey:()=>gn,messageContextTriplet:()=>bh,messagesTextOverlapScore:()=>iu,nearbyDomIndexWindow:()=>Zh,nearbyMessageImageIds:()=>Yh,normalizeInlineMatchText:()=>na,normalizeMatchText:()=>Xr,normalizeMessageRole:()=>pn,parseAutotagLookJson:()=>uu,pickInlineKeepDomIndices:()=>yh,pickMessageIndexNearPoint:()=>Mh,pinPercentToPx:()=>kh,pinPercentToPxFromBottom:()=>Sh,pinPxToPercent:()=>ou,preferNearbyHostIndex:()=>Su,prefixMatchRatio:()=>Rs,rawMessageRole:()=>Zr,readingPercentInMessage:()=>du,rebindGalleryMessageIndexes:()=>vh,resolveCardAnchorPercent:()=>r_,resolveChatMessageMatch:()=>xh,resolveClickSelectionAction:()=>Ih,resolveIndexProgress:()=>e_,resolveStickyThumbPct:()=>Bh,resolveStoredPinPercent:()=>Ah,roleFromGenerationInfo:()=>hh,scaleInlineThumbnail:()=>uh,shouldKeepStickyThumbHidden:()=>Lh,shouldRefreshGallery:()=>$h,shouldRewriteStickyThumb:()=>Oh,shouldSelectMessageByTextDrag:()=>Eh,splitMessageLines:()=>ta,stickyCornerEdgeBox:()=>cu,stickyCornerImageBox:()=>Uh,stickyPinEdgeBox:()=>Kh,stickyPinOverImage:()=>Hh,stickyThumbBoxFromPct:()=>Rh,stickyThumbNeedsHtmlPaint:()=>zh,stripInlayInlineHtml:()=>hu,thumbIndexAtStripX:()=>Gh,visibleGalleryImageIds:()=>Vh}),ch=528,lh=720;function b(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Xl(e,t){const n={...e};for(const[r,a]of Object.entries(t||{})){const s=n[r];n[r]=a&&typeof a=="object"&&!Array.isArray(a)?Xl(s&&typeof s=="object"?s:{},a):a}return n}function uh(e){const t=Math.max(1,b(e,100));return{width:Math.max(1,Math.round(ch*t/100)),height:Math.max(1,Math.round(lh*t/100)),percent:t}}function Xr(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}var fh=.6,Zl=.6,iy=24,oy=800;function pn(e){const t=String(e||"").toLowerCase().trim();return t?t==="char"||t==="assistant"||t==="bot"?"char":t==="user"||t==="human"?"user":t:""}function Ql(e,t){const n=String(e||""),r=String(t||""),a=Math.min(n.length,r.length);let s=0;for(;s<a&&n.charCodeAt(s)===r.charCodeAt(s);)s+=1;return s}function Bs(e){const t=String(e||""),n=new Map;if(t.length<2)return n;for(let r=0;r<t.length-1;r+=1){const a=t.charCodeAt(r)+","+t.charCodeAt(r+1);n.set(a,(n.get(a)||0)+1)}return n}function eu(e,t,n=null){const r=String(e||""),a=String(t||"");if(!r||!a)return 0;if(r===a)return 1;if(r.length<2||a.length<2)return 0;const s=n||Bs(r),i=Bs(a);let o=0;for(const[f,d]of i){const p=s.get(f)||0;p&&(o+=Math.min(p,d))}const c=r.length-1,l=a.length-1;return 2*o/(c+l)}function Rs(e,t){const n=Xr(e),r=Xr(t);if(!n||!r)return 0;const a=Math.max(n.length,r.length);if(a<24)return 0;if(n===r)return 1;const s=Ql(n,r)/a;return s>=.6?s:eu(n.length>800?n.slice(0,800):n,r.length>800?r.slice(0,800):r)}function Fs(e,t){if(!t)return[];const n=Array.isArray(e)?e:[],r=String(t.hash||"");return r?zs(n.filter(a=>a?.content_hash&&a.content_hash===r)):[]}function tu(e,t={}){const n=Array.isArray(e)?e:[],r=String(t.characterId||""),a=String(t.chatId||""),s=String(t.sessionId||""),i=Number(t.messageIndex),o=pn(t.role||t.messageRole||"");if(!r||!o||!Number.isFinite(i)||i<0)return[];const c=[];for(const l of n){if(!String(l?.content_hash||"")||String(l?.character_id||"")!==r)continue;const f=String(l?.chat_id||""),d=String(l?.session_id||"");if(a){if(f!==a)continue}else if(s){if(d&&d!==s)continue}else continue;if(Number(l?.message_index)!==i)continue;const p=pn(l?.message_role||l?.role||"");!p||p!==o||c.push(l)}return zs(c)}function dh(e,t={}){const n=Array.isArray(e)?e:[],r=String(t.newHash||t.hash||""),a=String(t.text||""),s=String(t.characterId||""),i=String(t.chatId||""),o=String(t.sessionId||""),c=Number(t.messageIndex),l=pn(t.role||t.messageRole||"");if(!r||!a||!s||!l||!Number.isFinite(c)||c<0)return[];if(Xr(a).length<24)return[];const f=[];for(const d of tu(n,{characterId:s,chatId:i,sessionId:o,messageIndex:c,role:l})){const p=String(d?.content_hash||"");if(!p||p===r)continue;const m=String(d?.assistant_preview||"");if(!m)continue;const g=Rs(a,m);g<.6||f.push({card:d,score:g})}return f.sort((d,p)=>p.score-d.score||b(p.card?.created_at)-b(d.card?.created_at)),zs(f.map(d=>d.card))}function Ds(e,t={}){if(!e||e.cancelRequested)return!1;const n=String(t.characterId||""),r=String(t.chatId||""),a=String(t.sessionId||""),s=Number(t.messageIndex),i=pn(t.role||"");if(!n||!i||!Number.isFinite(s)||s<0||String(e.characterId||"")!==n||Number(e.messageIndex)!==s||pn(e.messageRole)!==i)return!1;if(r){if(String(e.chatId||"")!==r)return!1}else if(a){if(e.sessionId&&String(e.sessionId)!==a)return!1}else return!1;return!0}function nu(e,t={}){if(!Ds(e,t))return!1;const n=String(t.toHash||"").trim(),r=String(t.text||"");return!n||!r||n===String(e?.saveContentHash||"").trim()?!1:Rs(e?.sourcePreview||"",r)>=Zl}function ru(e){const t=e?.y_percent??e?.anchor_percent??e?.read_percent,n=Number(t);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function mh(e,t){return ru(e)-ru(t)||b(e?.paragraph)-b(t?.paragraph)||b(e?.shot_index)-b(t?.shot_index)||b(t?.created_at)-b(e?.created_at)}function au(e,t){return b(t?.created_at)-b(e?.created_at)||b(t?.message_index)-b(e?.message_index)||b(t?.paragraph)-b(e?.paragraph)||b(t?.shot_index)-b(e?.shot_index)}function zs(e){const t=new Map;for(const n of e||[]){const r=`${n?.paragraph??"?"}|${n?.shot_index??n?.id}`,a=t.get(r);(!a||b(n?.created_at)>=b(a?.created_at))&&t.set(r,n)}return[...t.values()]}function ph(e,t,n=8){const r=new Map;for(const f of e||[]){const d=String(f?.id||"");!d||r.has(d)||r.set(d,f)}const a=[...r.values()],s=Math.max(0,Math.min(64,b(n,8)||8));if(!t)return a.sort(au).slice(0,Math.max(1,s||8));const i=Fs(a,t).sort(mh),o=new Set(i.map(f=>String(f.id))),c=String(t.sessionId||""),l=a.filter(f=>!o.has(String(f.id))).filter(f=>!c||!f?.session_id||f.session_id===c).sort(au).slice(0,s);return[...i,...l]}function Us(e,t){return t?Fs(e,t).length:0}function gh(e,t,n){if(e&&Us(n,e)>0)return e;const r=String(e?.sessionId||e?.session_id||""),a=String(t?.sessionId||t?.session_id||"");return t&&Us(n,t)>0&&(!r||!a||r===a)?t:e||null}function Zr(e){const t=String(e?.role||e?.type||e?.speaker||e?.sender||e?.from||e?.name||"").trim().toLowerCase();return e?.isUser===!0||e?.fromUser===!0||/^(user|human|player|you|me)$/.test(t)||t.includes("user")?"user":e?.isAssistant===!0||e?.isBot===!0||e?.isChar===!0||/^(assistant|bot|char|character|model|ai)$/.test(t)||t.includes("assistant")||t.includes("bot")||t.includes("char")?"char":t==="system"||t==="developer"?"system":""}function su(e){const t=e?.generationInfo??e?.generation_info??e?.messageGenerationInfo;return t==null?!1:typeof t=="string"?t.trim().length>0:typeof t=="object"?Object.keys(t).length>0:!0}function hh(e){return su(e)?"char":"user"}function _h(e){if(e&&typeof e=="object")return Zr(e)==="char";const t=String(e||"").trim().toLowerCase();return t==="char"||t==="assistant"||t==="bot"}var cy=1;function yh(e){const t=e.selIdx,n=e.length,r=e.maxPerSide??1;if(!Number.isFinite(t)||t<0||t>=n||n<=0)return[];const a=[],s=o=>{o>=0&&o<n&&!a.includes(o)&&a.push(o)};if(e.allRoles)return s(t),t+1<n&&s(t+1),t-1>=0&&s(t-1),a;e.isCharAt(t)&&s(t);let i=0;for(let o=t+1;o<n&&i<r;o+=1)e.isCharAt(o)&&(s(o),i+=1);i=0;for(let o=t-1;o>=0&&i<r;o-=1)e.isCharAt(o)&&(s(o),i+=1);return a}function gn(e,t=48){const n=Math.max(1,b(t,48));return String(e||"").replace(/\s+/g,"").slice(0,n)}function bh(e,t,n=48){const r=Array.isArray(e)?e:[],a=Math.floor(b(t,-1)),s=a>=0&&a<r.length?r[a]:null,i=a>0?r[a-1]:null,o=a>=0&&a<r.length-1?r[a+1]:null;return[gn(i?.text,n),gn(s?.text,n),gn(o?.text,n),Zr(s)||String(s?.role||"").trim().toLowerCase()].join("|")}function iu(e,t){const n=String(e||"").replace(/\s+/g,""),r=String(t||"").replace(/\s+/g,"");if(!n||!r)return 0;if(n.includes(r))return r.length;if(r.includes(n))return n.length;let a=0;const s=(o,c,l=8,f=512)=>{let d=l,p=Math.min(o.length,f),m=0;for(;d<=p;){const g=d+p>>1;c.includes(o.slice(0,g))?(m=g,d=g+1):p=g-1}return m};a=Math.max(a,s(r,n),s(n,r));const i=Math.min(r.length,2400);for(let o=0;o+8<=i;o+=32){const c=Math.min(64,i-o);for(let l=c;l>=8;l-=8)if(n.includes(r.slice(o,o+l))){a=Math.max(a,l);break}}return a}function wh(e,t){const n=String(e||""),r=String(t||""),a=gn(n),s=gn(r),i=iu(n,r),o=i>=8,c=a.length>0&&a.length<8&&a===s,l=s.slice(0,48),f=a.slice(0,48);return{domChars:n.length,apiChars:r.length,domCompactChars:a.length,apiCompactChars:s.length,shareScore:i,overlap:o,shortExact:c,apiInDom:!!(l&&l.length>=8&&a.includes(l)),domInApi:!!(f&&f.length>=8&&s.includes(f)),apiKey:l,domKey:f}}function vh(e,t,n){const r=Array.isArray(t)?t:[],a=typeof n=="function"?n:null,s=new Map;if(a)for(let o=0;o<r.length;o+=1){const c=String(r[o]?.text??r[o]?.data??r[o]?.content??""),l=String(a(c)||"");if(!l)continue;const f=Number.isFinite(Number(r[o]?.index))?Number(r[o].index):o,d=s.get(l);d?d.push(f):s.set(l,[f])}let i=0;return{cards:(Array.isArray(e)?e:[]).map(o=>{const c=String(o?.content_hash||""),l=c?s.get(c):void 0;return!c||!l?o:l.length!==1?Number(o?.message_index)!==-1?(i+=1,{...o,message_index:-1}):o:Number(o?.message_index)!==l[0]?(i+=1,{...o,message_index:l[0]}):o}),changed:i}}function xh(e,t,n,r,a){const s=Array.isArray(t)?t:[],i=Math.floor(b(n,-1)),o=(f,d,p,m=-1)=>({chatIndex:Number.isFinite(Number(f?.index))?Number(f?.index):m>=0?m:i,text:String(f?.text||e||""),role:Zr(f)||String(f?.role||"").trim().toLowerCase(),matchMethod:d,score:p});if(!s.length)return{chatIndex:Math.max(0,i),text:String(e||""),role:"",matchMethod:"fallback",score:0};const c=s.length-1-i;if(c>=0&&c<s.length)return o(s[c],"reverse",100,c);const l=Math.max(0,Math.min(s.length-1,c));return o(s[l],"reverse",50,l)}function et(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(100,Math.floor(n))):Math.max(0,Math.min(100,Math.floor(b(t,0))))}function kh(e,t,n=22,r=4){const a=Math.max(1,b(t,1)),s=Math.max(1,b(n,1)),i=Math.max(0,b(r,0)),o=Math.floor(a*et(e,0)/100);return Math.max(i,Math.min(a-s-i,o))}function Sh(e,t,n=22,r=8){const a=Math.max(1,b(t,1)),s=Math.max(1,b(n,1)),i=Math.max(0,b(r,0)),o=a-Math.floor(a*et(e,0)/100)-s;return Math.max(i,Math.min(a-s-i,o))}function ou(e,t){const n=Math.max(1,b(t,1));return et(b(e,0)/n*100,0)}function Ah(e,t,n,r=null){const a=r&&typeof r=="object"?r:{x:38,y:80},s=t==="y"||t==="Y",i=s?b(a.y,80):b(a.x,38),o=s?"overlay_y_pct":"overlay_x_pct",c=s?"overlay_y_offset":"overlay_x_offset",l=String(e?.overlay_pin_origin||""),f=l==="top"||l==="tl"||l==="top-left",d=e?.[o],p=d!=null&&Number.isFinite(Number(d)),m=Number(e?.[c]),g=Number.isFinite(m),h=_=>et(100-Number(_),i);return p?s&&f?h(d):et(d,i):g?s?et((b(n,1)-m)/Math.max(1,b(n,1))*100,i):ou(m,n):et(i,i)}function Mh(e,t,n=null,r=800){const a=Array.isArray(e)?e:[];if(!a.length)return-1;const s=Math.max(1,b(r,800)),i=Number.isFinite(Number(t))?Number(t):s*.5,o=Number.isFinite(Number(n))?Number(n):null;let c=-1,l=1/0,f=-1,d=1/0;for(let p=0;p<a.length;p+=1){const m=a[p];if(!m)continue;const g=b(m.top,0),h=b(m.bottom,g);if(h<=0||g>=s)continue;const _=(g+h)*.5,y=Number.isFinite(Number(m.left))&&Number.isFinite(Number(m.right))?(Number(m.left)+Number(m.right))*.5:null,v=y!=null&&o!=null?Math.hypot(y-o,_-i):Math.abs(_-i);v<d&&(d=v,f=p);const x=i>=g&&i<=h,M=o==null||!Number.isFinite(Number(m.left))||!Number.isFinite(Number(m.right))||o>=Number(m.left)&&o<=Number(m.right);if(x&&M){const L=Math.max(1,h-g);L<l&&(l=L,c=p)}}return c>=0?c:f}function Nh({gesture:e="single",detail:t=1,movement:n=0,textSelecting:r=!1,excludedTarget:a=!1}={}){const s=e==="double"?2:1;return!a&&!r&&b(n,1/0)<=8&&b(t)===s}function Ih({gesture:e="single",detail:t=1,pendingDomIndex:n=null,targetDomIndex:r=null}={}){const a=b(t,1);return e==="double"?a===1?{action:"provisional",pendingDomIndex:r}:a===2?{action:"confirm",clearPending:!0,matchedPending:n!=null&&Number(n)===Number(r)}:{action:"ignore"}:a===1?{action:"confirm",clearPending:!0}:{action:"ignore"}}function Eh({enabled:e=!0,movement:t=0,hasSelection:n=!1,excludedTarget:r=!1}={}){return!!e&&!r&&!!n&&b(t,0)>8}function Ch({delayMs:e=160,onSettle:t}={}){let n=null;const r=Math.max(0,b(e,160)),a=()=>{n=null,typeof t=="function"&&t()};return{bump(){n&&clearTimeout(n),n=setTimeout(a,r)},settleNow(){n&&clearTimeout(n),n=null,a()},cancel(){n&&clearTimeout(n),n=null},get pending(){return n!=null}}}function jh(e=""){let t=String(e||""),n="",r=0;return{observe(a){const s=String(a||"");return!s||s===t?(n="",r=0,!1):s!==n?(n=s,r=1,!1):(r+=1,r<2?!1:(t=n,n="",r=0,!0))},current(){return t},reset(a=""){t=String(a||""),n="",r=0}}}function Th(e,t=300){let n={},r=null,a=null;const s=async()=>a||(a=(async()=>{for(;Object.keys(n).length;){const i=n;n={},await e(i)}})().finally(()=>{a=null}),a);return{enqueue(i){n=Xl(n,i),r&&clearTimeout(r),r=setTimeout(()=>{r=null,s().catch(()=>{})},Math.max(0,b(t,300)))},async flush(){r&&(clearTimeout(r),r=null);do await s();while(Object.keys(n).length||a)},hasPending(){return!!r||!!a||Object.keys(n).length>0}}}function $h(e,t){const n=Array.isArray(e)?e.map(String):[],r=Array.isArray(t)?t.map(String):[];if(n.length!==r.length)return!0;for(let a=0;a<n.length;a+=1)if(n[a]!==r[a])return!0;return!1}function Ph(e,t){const n=String(t||"");if(!n||!Array.isArray(e)||!e.length)return null;const r=e.findIndex(s=>String(s?.card?.id||"")===n);if(r<0)return null;const a=e[r];return a?.thumb?(e.splice(r,1),a):null}function Oh(e,t){return String(e||"")!==String(t||"")}function Lh(e,t,n){if(!e)return!1;const r=String(t||""),a=String(n||"");return!!r&&!!a&&r===a}function Bh(e){if(!e.alwaysOn||e.userCollapsed||e.editorOpen)return 0;const t=b(e.settingsPct,0);return t>0?t:0}function Rh(e,t,n){const r=Math.max(0,b(e,0)),a=Math.max(0,b(t,0)),s=Math.max(0,b(n,0));return{pct:r,w:Math.max(0,Math.round(a*r/100)),h:Math.max(0,Math.round(s*r/100))}}function Fh(e,t,n=0,r=0){const a=Math.max(0,b(e,0)),s=Math.max(0,b(t,0));if(a<=0||s<=0)return{w:0,h:0};const i=Math.max(0,b(n,0)),o=Math.max(0,b(r,0));if(i<=0||o<=0)return{w:a,h:s};const c=Math.min(a/i,s/o);return{w:Math.max(1,Math.round(i*c)),h:Math.max(1,Math.round(o*c))}}function Dh(e,t=""){const n=typeof e=="string"?e:"";return n?`<img src="${n}" style="width:100%;height:100%;object-fit:contain;display:block;background:transparent" />`:'<div style="width:100%;height:100%;background:transparent"></div>'}function zh(e,t,n,r){const a=typeof t=="string"?t:"";return a?String(e||"")!==a||String(n||"")!==String(r||""):!1}function Uh(e,t,n,r=16){const a=Math.max(1,Math.round(b(t?.w,1))),s=Math.max(1,Math.round(b(t?.h,1))),i=Math.max(a,Math.round(b(n?.width,a))),o=Math.max(s,Math.round(b(n?.height,s))),c=Math.max(0,Math.round(b(r,16))),l=String(e||"bottom-right");return{left:l.includes("left")?c:Math.max(c,i-a-c),top:l.includes("top")?c:Math.max(c,o-s-c),w:a,h:s}}function cu(e,t,n=16){const r=Math.max(1,Math.round(b(t?.w,1))),a=Math.max(1,Math.round(b(t?.h,1))),s=Math.max(0,Math.round(b(n,16))),i=String(e||"bottom-right");return{w:r,h:a,top:i.includes("top")?s:null,bottom:i.includes("bottom")?s:null,left:i.includes("left")?s:null,right:i.includes("right")?s:null}}function Hh(e,t=28,n=6){const r=Math.round(b(e?.left,0)),a=Math.round(b(e?.top,0)),s=Math.max(1,Math.round(b(e?.w,1))),i=Math.max(1,Math.round(b(t,28))),o=Math.max(0,Math.round(b(n,6)));return{left:Math.round(r+(s-i)/2),top:a-o}}function Kh(e,t,n=28,r=6,a=16){const s=cu(e,t,a),i=Math.max(1,Math.round(b(n,28))),o=Math.max(0,Math.round(b(r,6))),c=s.left!=null?s.left:s.right,l=Math.round(b(c,0)+(s.w-i)/2);return{size:i,top:s.top!=null?Math.round(s.top-o):null,bottom:s.bottom!=null?Math.round(s.bottom+s.h+o):null,left:s.left!=null?l:null,right:s.right!=null?l:null}}var ae=Object.freeze({width:64,height:88,gap:8,splitWidth:16,splitExtraMargin:4});function Qr(e,t){const n=Math.max(0,Math.floor(b(t,0))),r=Math.max(0,Math.min(Math.floor(b(e,0)),n));return r>0&&r<n?r:0}function Jh(e,t,n){const r=Math.max(0,Math.floor(b(n,0))),a=Math.floor(b(e,-1));if(a<0||r<=0)return-1;const s=Qr(t,r);if(s<=0)return a<r?a:-1;if(a===s)return-1;const i=a>s?a-1:a;return i>=0&&i<r?i:-1}function Gh(e,{count:t=0,selectedCount:n=0,thumbWidth:r=ae.width,gap:a=ae.gap,splitWidth:s=ae.splitWidth,splitExtraMargin:i=ae.splitExtraMargin}={}){const o=Math.max(0,Math.floor(b(t,0)));if(o<=0)return-1;const c=b(e,NaN);if(!Number.isFinite(c)||c<0)return-1;const l=Math.max(1,b(r,ae.width)),f=Math.max(0,b(a,ae.gap)),d=Math.max(0,b(s,ae.splitWidth)),p=Math.max(0,b(i,ae.splitExtraMargin)),m=Qr(n,o),g=[];for(let _=0;_<o;_+=1)m>0&&_===m&&g.push({type:"split"}),g.push({type:"thumb",galIdx:_,marginLeft:m>0&&_===m?p:0});let h=0;for(let _=0;_<g.length;_+=1){_>0&&(h+=f);const y=g[_];if(y.type==="split"){if(c>=h&&c<h+d)return-1;h+=d;continue}if(h+=y.marginLeft,c>=h&&c<h+l)return y.galIdx;h+=l}return-1}function Wh({count:e=0,selectedCount:t=0,thumbWidth:n=ae.width,gap:r=ae.gap,splitWidth:a=ae.splitWidth,splitExtraMargin:s=ae.splitExtraMargin}={}){const i=Math.max(0,Math.floor(b(e,0)));if(i<=0)return 0;const o=Math.max(1,b(n,ae.width)),c=Math.max(0,b(r,ae.gap)),l=Math.max(0,b(a,ae.splitWidth)),f=Math.max(0,b(s,ae.splitExtraMargin)),d=Qr(t,i),p=i+(d>0?1:0);let m=i*o+Math.max(0,p-1)*c;return d>0&&(m+=l+f),m}function qh(e,t,n){const r=Math.max(0,b(t,0)-Math.max(0,b(n,0))),a=b(e,0);return Math.max(0,Math.min(r,a))}function Vh(e,t=0,n=1,r=8,a=0){const s=Array.isArray(e)?e:[];if(!s.length)return[];const i=Math.max(0,Math.min(b(t,0),s.length-1)),o=Math.max(1,Math.min(s.length,b(r,8)||8)),c=Math.min(o,1+2*Math.max(0,b(n,1))),l=Math.max(c,o);let f=Math.max(0,i-Math.floor((l-1)/2));const d=Math.min(s.length-1,f+l-1);f=Math.max(0,d-l+1);const p=[],m=new Set,g=_=>{const y=String(s[_]?.id||"");!y||m.has(y)||(m.add(y),p.push(y))},h=Math.max(0,Math.min(s.length,b(a,0)));for(let _=0;_<h;_+=1)g(_);for(let _=f;_<=d&&(g(_),!(p.length>=o));_+=1);return p}function Yh(e,t,n=2,r=[]){const a=Array.isArray(e)?e:[],s=Math.max(0,Math.min(8,b(n,2))),i=b(t?.messageIndex??t?.message_index,NaN),o=String(t?.sessionId||t?.session_id||""),c=String(t?.chatId||t?.chat_id||""),l=String(t?.hash||""),f=new Set,d=[],p=m=>{const g=String(m||"");!g||f.has(g)||(f.add(g),d.push(g))};for(const m of r||[])p(m);for(const m of a){if(!m?.id||o&&m.session_id&&String(m.session_id)!==o||c&&m.chat_id&&String(m.chat_id)!==c)continue;const g=b(m.message_index,NaN);if(Number.isFinite(i)&&Number.isFinite(g)){Math.abs(g-i)<=s&&p(m.id);continue}l&&String(m.content_hash||"")===l&&p(m.id)}return d}function Xh(e,t,n=2){const r=b(e,NaN),a=b(t,NaN);if(!Number.isFinite(r)||!Number.isFinite(a))return!1;const s=Math.max(0,b(n,2));return Math.abs(r-a)<=s}function Zh(e,t,n=2){const r=Math.max(0,Math.floor(b(t,0))),a=Math.max(0,Math.min(Math.max(0,r-1),Math.floor(b(e,0)))),s=Math.max(0,Math.floor(b(n,2)));return r<=0?{lo:0,hi:-1,center:0}:{lo:Math.max(0,a-s),hi:Math.min(r-1,a+s),center:a}}var lu={chrome:1,content:2,full:3};function Qh(e,t){const n=lu[String(e??"")]||0,r=lu[String(t??"")]||0;return!n&&!r?"full":r>=n?t||e||"full":e||t||"full"}function uu(e){const t=String(e||"").trim();if(!t)return{appearance:"",attire:"",accessories:"",text:"",gender:""};let n=null;const r=t.match(/```(?:json)?\s*([\s\S]*?)```/i),a=(r?r[1]:t).trim().match(/\{[\s\S]*\}/);if(a)try{const i=JSON.parse(a[0]);n=i&&typeof i=="object"?i:null}catch{n=null}if(n&&typeof n=="object"){const i=String(n.appearance??n.look??n.identity??"").trim(),o=String(n.attire??n.clothing??n.outfit??"").trim(),c=String(n.accessories??n.accessory??n.props??"").trim(),l=String(n.gender??n.sex??"").trim().toLowerCase(),f=["girl","female","f","woman"].includes(l)?"girl":["boy","male","m","man"].includes(l)?"boy":l==="other"?"other":"";return{appearance:i,attire:o,accessories:c,text:[i,o,c].filter(Boolean).join(", "),gender:f}}const s=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,"").trim();return{appearance:s,attire:"",accessories:"",text:s,gender:""}}function e_(e={}){const t=!!e.warmBusy,n=Math.max(0,Math.min(100,Math.round(b(e.warmPct,0)))),r=String(e.jobState||""),a=Math.max(0,Math.min(100,Math.round(b(e.jobPct,0))));return t?{pct:Math.max(t?6:0,n),busy:!0,label:"인덱싱"}:r==="tagging"?{pct:Math.max(6,a),busy:!0,label:"인덱싱"}:{pct:0,busy:!1,label:"인덱싱"}}function t_(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=Math.max(t?6:0,Math.min(100,Math.round(b(e.jobPct,0)))),a=Math.max(n?6:0,Math.min(100,Math.round(b(e.indexPct,0)))),s=e.error?"#f87171":"#7c6cff",i="#2dd4bf",o=(c,l)=>`<span style="display:block;height:4px;border-radius:2px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${c}%;background:${l}"></span></span>`;return`<span style="flex:0 0 120px;display:flex;flex-direction:column;gap:3px;justify-content:center">${o(r,s)}${o(a,i)}</span>`}function fu(e={}){const t=!!e.busy,n=Math.max(t?6:0,Math.min(100,Math.round(b(e.pct,0)))),r=String(e.tone||"");return`<span style="flex:0 0 120px;display:block;height:6px;border-radius:3px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${n}%;background:${e.error?"#f87171":r==="index"?"#2dd4bf":"#7c6cff"}"></span></span>`}function n_(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=!!e.busy||t||n;if(!r&&!e.error)return"";const a=typeof e.escapeHtml=="function"?e.escapeHtml:f=>String(f).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),s=String(e.tone||(!t&&n?"index":"job")),i=a(String(e.stage||(s==="index"?"인덱싱":"작업 중")).slice(0,80)),o=a(String(e.meta||"").slice(0,160));let c=e.pct;c==null&&(t?c=e.jobPct:n?c=e.indexPct:c=Math.max(b(e.jobPct,0),b(e.indexPct,0)));const l=fu({pct:c,busy:r||!!e.error,error:e.error,tone:s});return`<div data-inlay-progress-toast="1" style="display:flex;align-items:center;gap:10px;min-width:220px;max-width:min(420px,92vw);padding:10px 14px;border-radius:8px;background:#121820;border:1px solid #2a3344;cursor:pointer;user-select:none"><span style="flex:0 0 auto;font-weight:700;color:${e.error?"#f87171":s==="index"?"#5eead4":"#c4b5fd"};font-size:11px;white-space:nowrap">${i}</span><span style="min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8b97ab;font-size:11px">${o}</span>${l}</div>`}function ea(e){return Math.max(0,Math.min(100,b(e,0)))}function Hs(e,t){const n=Math.max(1,b(t,1));return Math.max(0,Math.min(b(e,0),n-1))/n*100}function r_(e,t=0,n=1,r=null){if(r&&r.forceEven)return Hs(t,n);const a=e?.y_percent??e?.anchor_percent??e?.read_percent,s=Number(a);return Number.isFinite(s)?ea(s):Hs(t,n)}function du(e,t,n=.5){if(!e)return null;const r=Math.max(1,b(e.height,0)),a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return a<b(e.top,0)||a>b(e.bottom,0)?null:ea((a-b(e.top,0))/r*100)}function a_(e,t,n=.5){const r=du(e,t,n);if(r!=null)return r;const a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return b(e?.bottom,0)<a?100:0}function s_(e,t){const n=Array.isArray(e)?e:[];if(!n.length)return-1;const r=ea(t),a=n.map(c=>ea(c)),s=a.reduce((c,l,f)=>l<=20?c.concat(f):c,[]),i=s.length===1&&a[s[0]]>0?a.map((c,l)=>l===s[0]?1:c):a;if(i[0]>0&&r<i[0])return-1;let o=0;for(let c=0;c<i.length;c+=1)r>=i[c]&&(o=c);return o}var mu="data-inlay-inline-shot",pu=/^<\/(?:p|div|li|blockquote|h[1-6]|tr)>$/i,gu=/^<br\s*\/?>$/i;function hu(e){const t=String(e||"");return t?t.replace(/<div[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/div>/gi,"").replace(/<(?:span|p)[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/(?:span|p)>/gi,""):""}function ta(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function _u(e,t){const n=Math.floor(Number(e)),r=Math.max(0,Math.floor(Number(t)||0));return!r||!Number.isFinite(n)||n<1?null:Math.max(1,Math.min(r,n))}function yu(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function i_(e){const t=e.toLowerCase();if(t==="&nbsp;")return" ";if(t==="&amp;")return"&";if(t==="&lt;")return"<";if(t==="&gt;")return">";if(t==="&quot;")return'"';if(t==="&#39;"||t==="&apos;")return"'";const n=/^&#(\d+);$/.exec(e);if(n){const a=Number(n[1]);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}const r=/^&#x([0-9a-f]+);$/i.exec(e);if(r){const a=Number.parseInt(r[1],16);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}return null}function o_(e,t){let n=Math.max(0,Math.min(e.length,Math.floor(t)));for(;n>0;){let r=n;for(;r>0&&/[ \t\r\n]/.test(e[r-1]);)r-=1;if(r<=0||e[r-1]!==">")break;const a=e.lastIndexOf("<",r-1);if(a<0||a>=r-1)break;const s=e.slice(a,r);if(gu.test(s)||pu.test(s)||/^<\//.test(s)||!/^<[a-zA-Z][^>]*>$/.test(s))break;n=a}return n}function bu(e){const t=[];let n=0;const r=String(e||"");for(;n<r.length;){if(r[n]==="<"){const o=r.indexOf(">",n);if(o<0)break;const c=r.slice(n,o+1);(gu.test(c)||pu.test(c))&&t.push({ch:`
`,htmlIndex:n}),n=o+1;continue}if(r[n]==="&"){const o=r.indexOf(";",n);if(o>n&&o-n<16){const c=i_(r.slice(n,o+1));if(c!=null){for(let l=0;l<c.length;l+=1)t.push({ch:c[l],htmlIndex:n});n=o+1;continue}}}t.push({ch:r[n],htmlIndex:n}),n+=1}const a=[];for(let o=0;o<t.length;o+=1){const c=t[o];if(c.ch!==`
`&&/\s/.test(c.ch)){for(a.push({ch:" ",htmlIndex:c.htmlIndex});o+1<t.length&&t[o+1].ch!==`
`&&/\s/.test(t[o+1].ch);)o+=1;continue}a.push(c)}const s=a.filter((o,c)=>o.ch!==" "?!0:a[c-1]?.ch!==`
`&&a[c+1]?.ch!==`
`),i=[];for(const o of s)o.ch===`
`&&i.length&&i[i.length-1].ch===`
`||i.push(o);for(;i.length&&(i[0].ch===`
`||i[0].ch===" ");)i.shift();for(;i.length&&(i[i.length-1].ch===`
`||i[i.length-1].ch===" ");)i.pop();return i}function c_(e){return bu(String(e||"")).map(t=>t.ch).join("")}function wu(e,t){const n=String(e??"").replace(/\r\n/g,`
`),r=Math.floor(Number(t));if(!Number.isFinite(r)||r<1)return null;let a=0,s=0;for(;s<=n.length;){const i=n.indexOf(`
`,s),o=i<0?n.length:i,c=n.slice(s,o);if(c.trim()&&(a+=1,a===r)){const l=/^\s*/.exec(c)?.[0].length||0;return s+l}if(i<0)break;s=i+1}return null}function na(e){return String(e??"").replace(/\s+/g," ").trim()}function vu(e,t){const n=Array.isArray(e)?e:[],r=Math.floor(Number(t))-1;if(!Number.isFinite(r)||r<0||r>=n.length)return null;const a=na(n[r]);if(!a)return null;let s=0;for(let i=0;i<=r;i+=1)na(n[i])===a&&(s+=1);return{text:a,occurrence:s}}function xu(e){const t=[],n=Array.isArray(e)?e:[];for(let r=0;r<n.length;r+=1)for(const a of ta(n[r])){const s=na(a);s&&t.push({text:s,elementIndex:r})}return t}function ku(e,t,n){const r=vu(t,n);if(!r)return-1;const a=xu(e);let s=0;for(const i of a)if(i.text===r.text&&(s+=1,s===r.occurrence))return i.elementIndex;return-1}function Su(e,t,n=["P"]){const r=(Array.isArray(e)?e:[]).map(i=>String(i||"").toUpperCase()),a=Math.floor(Number(t));if(!Number.isFinite(a)||a<0||a>=r.length)return-1;const s=new Set((Array.isArray(n)&&n.length?n:["P"]).map(i=>String(i||"").toUpperCase()));if((r[a]||"")!=="DIV")return a;for(let i=1;i<r.length;i+=1){const o=a-i,c=a+i;if(o>=0&&s.has(r[o]))return o;if(c<r.length&&s.has(r[c]))return c}return-1}function l_(e,t,n,r,a=["P"]){const s=Array.isArray(n)?n:[],i=Math.floor(Number(r));if(!Number.isFinite(i)||i<1||!s.length)return null;const o=s.length;for(let c=Math.max(1,i);c<=o;c+=1){const l=Su(t,ku(e,s,c),a);if(l>=0)return{elementIndex:l,usedLine:c}}return null}function Au(e,t){const n=Number.isFinite(Number(e.shotIndex))?String(Math.floor(Number(e.shotIndex))):"",r=yu(String(e.cardId||(e.pending?`pending-${n||e.line}`:"")||n||e.line||"0")),a="display:block;margin:10px 0;text-align:center;line-height:0;max-width:100%;box-sizing:border-box";return e.pending||!/^data:image\//i.test(String(e.src||""))?`<div ${mu}="${r}" data-inlay-inline-pending="1" x-inlay-inline-shot="${r}" contenteditable="false" style="${a}"><br><br><span style="display:inline-flex;align-items:center;justify-content:center;min-width:48px;min-height:48px;padding:10px;border-radius:12px;background:rgba(124,108,255,.12);border:1px solid rgba(196,181,253,.35)"><svg width="28" height="28" viewBox="0 0 28 28" style="display:inline-block;vertical-align:middle" aria-hidden="true"><circle cx="14" cy="14" r="11" fill="none" stroke="rgba(255,255,255,.18)" stroke-width="3"/><circle cx="14" cy="14" r="11" fill="none" stroke="#c4b5fd" stroke-width="3" stroke-linecap="round" stroke-dasharray="18 52"><animateTransform attributeName="transform" type="rotate" from="0 14 14" to="360 14 14" dur="0.75s" repeatCount="indefinite"/></circle></svg></span><br><br></div>`:`<div ${mu}="${r}" x-inlay-inline-shot="${r}" contenteditable="false" style="${a}"><br><img data-inlay-inline-img="1" src="${yu(e.src)}" alt="" style="width:auto;height:auto;max-width:min(78%,100%);max-height:min(70vh,900px);object-fit:contain;border-radius:8px;display:inline-block;vertical-align:top" loading="eager" decoding="async"><br></div>`}function Mu(e,t,n){const r=hu(e),a=Array.isArray(t)?t:[];if(!r||!a.length)return r;const s=bu(r),i=s.map(g=>g.ch).join(""),o=ta(i).length;if(!o||!s.length)return r;const c=new Map,l=new Set;for(const g of a){const h=_u(g?.line,o),_=String(g?.src||""),y=String(g?.cardId||""),v=g?.pending===!0||!!h&&!/^data:image\//i.test(_);h&&(!v&&!/^data:image\//i.test(_)||y&&l.has(y)||c.has(h)||(y&&l.add(y),c.set(h,{...g,line:h,src:_,pending:v})))}if(!c.size)return r;const f=n?.maxWidthPx,d=new Map;for(const[g,h]of c){const _=wu(i,g);if(_==null||_<0||_>=s.length)continue;const y=o_(r,s[_].htmlIndex);d.has(y)||d.set(y,Au(h,f))}if(!d.size)return r;const p=[...d.entries()].map(([g,h])=>({htmlIndex:g,html:h})).sort((g,h)=>h.htmlIndex-g.htmlIndex);let m=r;for(const g of p)m=m.slice(0,g.htmlIndex)+g.html+m.slice(g.htmlIndex);return m}function u_(e,t,n){const r=ta(e);return r.length?Mu(r.map(a=>String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")).join("<br>"),t,n):""}re(),Lt(),Y(),B(),St(),Ft(),Kr(),De(),Nt(),ze(),fe(),rr(),Ze();var Nu=5e3;async function f_(e,t){const n=u(t||"",128),r=Re.get(e),a=u(r?.saveContentHash||"",128);if(a&&n&&a!==n)return{contentHash:a,assistantPreview:u(r?.saveAssistantPreview||"",An)};const s=r?.publishedIds||[];for(const i of s)try{const o=await gt(i),c=u(o?.content_hash||"",128);if(c&&n&&c!==n)return{contentHash:c,assistantPreview:u(o?.assistant_preview||"",An)}}catch{}return{contentHash:n,assistantPreview:""}}async function d_(e={}){const t={sessionId:u(e.session_id||"",200),characterId:u(e.character_id||"",200),chatId:u(e.chat_id||"",200),messageIndex:O(e.message_index,-1),role:e.role||""};if(!t.characterId||t.messageIndex<0)return{ok:!0,busy:!1};for(const[n,r]of Re.entries()){if(!Ds(r,t))continue;const a=await D("jobs",n),s=String(a?.state||"");if(Os.includes(s))return{ok:!0,busy:!0,job_id:n,state:s,content_hash:u(r.saveContentHash||"",128)}}return{ok:!0,busy:!1}}async function m_(e={}){const t=u(e.to_hash||"",128),n=u(e.assistant_preview||e.assistant_text||"",An),r={toHash:t,text:n,sessionId:u(e.session_id||"",200),characterId:u(e.character_id||"",200),chatId:u(e.chat_id||"",200),messageIndex:O(e.message_index,-1),role:e.role||""};if(!t||!n||!r.characterId||r.messageIndex<0)return{ok:!1,error:{code:"bad_request",message:"to_hash, text, character_id, message_index required"},retargeted:!1};for(const[a,s]of Re.entries()){if(!nu(s,r))continue;const i=await D("jobs",a),o=String(i?.state||"");if(!Os.includes(o))continue;s.saveContentHash=t,s.saveAssistantPreview=n;let c=0;if(s.publishedIds?.length)try{const l=await Hl({session_id:r.sessionId||s.sessionId,card_ids:[...s.publishedIds],to_hash:t,assistant_preview:n});c=Number(l?.rebound||0)}catch{}return w("job.retarget",{job_id:a,to:t.slice(0,8),msg:r.messageIndex,rebound:c,focus:!0}),{ok:!0,retargeted:!0,job_id:a,content_hash:t,rebound:c}}return{ok:!0,retargeted:!1,job_id:"",content_hash:t}}var p_=2500,g_=64;function h_(e,t,n){const r=Yr(t,n),a=(Bn.get(r)?.epoch||0)+1;Bn.set(r,{epoch:a,jobId:e});const s=u(t.assistant_text||"",An),i=u(t.content_hash||"",128);return Re.set(e,{key:r,epoch:a,cancelRequested:!1,publishedIds:[],saveContentHash:i,saveAssistantPreview:s,sourcePreview:s,sessionId:n,characterId:u(t.character_id||"",200),chatId:u(t.chat_id||"",200),messageIndex:O(t.message_index,-1),messageRole:u(t.message_role||t.role||"",40).toLowerCase()}),{key:r,epoch:a}}function __(e){const t=Re.get(e);if(!t||t.cancelRequested)return!1;const n=Bn.get(t.key);return!!(n&&n.jobId===e&&n.epoch===t.epoch)}async function y_(e){const t=Re.get(e),n=t?.publishedIds?[...t.publishedIds]:[];t&&(t.publishedIds=[]);for(const r of n)try{await Ps(r)}catch{}return n.length}async function we(e,t="interrupted"){if(__(e))return!1;const n=await y_(e);return await pe(e,"cancelled",{phase:"cancelled",progress:0,message:`${t}${n?` · discarded ${n}`:""}`,shot_count:0,shot_done:0},null),w("job.cancelled",{job_id:e,message:t,discarded:n,focus:!0}),!0}function ir(e={}){return{shot_count:e.shot_count??0,shot_index:e.shot_index??0,shot_done:e.shot_done??0,progress:e.progress??0,phase:e.phase||"generating",message:e.message||"",cards_so_far:e.cards_so_far,pending_inline:Array.isArray(e.pending_inline)?e.pending_inline:void 0,pending_message_index:Number.isFinite(Number(e.pending_message_index))?Number(e.pending_message_index):void 0,debug_stage:yt()||Cn(),debug_error:pr()?.message||""}}function b_(e){return!e||typeof e!="object"?e:JSON.parse(JSON.stringify(e,(t,n)=>{if(t==="image_url"&&typeof n=="string"&&n.startsWith("data:"))return"";if(!(t==="tagged"||t==="appearance"||t==="debug_tail"))return n}))}async function pe(e,t,n=null,r=null){const a=await D("jobs",e);if(!a)return;const s=a.state,i={...a,state:t},o=b_(n);i.result_json=o!=null?JSON.stringify(o):null,i.error=r,i.updated_at=Date.now()/1e3;const c=t!=="generating"||s!=="generating"||!!r;await z("jobs",i,{persist:c}),(t==="done"||t==="error"||t==="cancelled")&&await jo(),w("job.set",{message:`${t}${r?" ERR":""}${c?"":" (mem)"}`,job_id:e,state:t,persist:c,err:r?String(r).slice(0,160):"",background:t==="generating",focus:t!=="generating"})}async function Iu(e){if(!(E().card||{}).power&&!e.force)throw new Error("Power가 OFF 상태입니다.");const t=u(e.session_id,200)||`sess_${xt().replace(/-/g,"").slice(0,12)}`,n={...e,session_id:t},r=await Ls(n,t);if(r)return w("job.busy",{message:r.error.message||"busy",key:Yr(n,t),focus:!0},"warn"),r;const a=xt(),s=Date.now()/1e3;if(h_(a,n,t),n.force)try{await Ts(t,u(n.content_hash||""),n.message_index)}catch{}return await z("jobs",{id:a,session_id:t,state:"queued",request_json:JSON.stringify(n),result_json:null,error:null,created_at:s,updated_at:s}),x_(a).catch(async i=>{console.error("[Inlay Nexus] job crashed",a,i);try{await pe(a,"error",null,String(i?.message||i).slice(0,1500))}catch{}}),{ok:!0,accepted:!0,job_id:a,session_id:t,job_state:"queued"}}async function w_(e){const t=await D("jobs",e);if(!t)return{ok:!1,error:{code:"not_found",message:"job not found"}};const n=t.result_json?JSON.parse(t.result_json):null,r={};if(n&&typeof n=="object")for(const a of["shot_count","shot_index","shot_done","progress","phase","message","cards_so_far","pending_inline","pending_message_index","debug_stage","debug_error"])a in n&&(r[a]=n[a]);return n&&await ut(n),{ok:!0,job_id:t.id,session_id:t.session_id,state:t.state,error:t.error,result:n,progress:r,debug:{last_stage:Cn(),last_error:pr(),events:ua(e,40)},created_at:t.created_at,updated_at:t.updated_at}}function v_(e){for(const t of["y_percent","anchor_percent","read_percent"]){const n=e[t];if(n!=null)try{return Math.max(0,Math.min(100,Number(n)))}catch{return null}}return null}async function x_(e){const t=await D("jobs",e);if(!t)return;const n=JSON.parse(t.request_json??"{}"),r=String(t.session_id??""),a=oi();En(e);const s=_e("job.run");w("job.start",{job_id:e,session_id:r,message_index:n.message_index,text_len:String(n.assistant_text||"").length});try{if(await we(e,"superseded before start")||(n.force&&await Ts(r,u(n.content_hash||""),n.message_index),await we(e,"superseded before tagging")))return;await pe(e,"tagging",{phase:"tagging",progress:0,message:"장면 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.tagging"});const i=u(n.unified_session_id||"",200),o=u(n.character_id||"",200),c=Array.isArray(n.source_session_ids)?n.source_session_ids.map(A=>u(A,200)).filter(Boolean):[],l=sn(E().card?.asset_nai_tags);let f=!1;if(l==="prepass"||l==="prepass_vision"){const A=await Qg(n,{withPreviews:l==="prepass_vision"});if(A?.block){if(await pe(e,"tagging",{phase:"tagging",progress:.05,message:"에셋 캐릭터 룩 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.char_looks"}),await we(e,"superseded before char looks"))return;try{const W=A.packed.groups.flatMap(le=>le.assets.map(Q=>Q.name)),K=await nh(n,A.block,W,l==="prepass_vision"?A.previews||[]:[]);w("job.char_looks.messages",{mode:l,msgs:K.length,assets:W,groups:A.packed.groups.map(le=>le.trigger),previews:(A.previews||[]).map(le=>le.name)});const q=await Jt(E().llm,K);if(await we(e,"superseded after char looks"))return;const H=_r(q),ge=Array.isArray(H?.new_characters)?H.new_characters:[];ge.length&&await Sc({sessionId:r,tagged:{new_characters:ge,scenes:[]},shotChars:[],unifiedSessionId:i,characterId:o,sourceSessionIds:c});const G=ge.filter(le=>ue(le)).length;f=!0,w("job.char_looks.done",{mode:l,new_characters:ge.length,filled_looks:G,raw_len:String(q||"").length})}catch(W){f=!1,w("job.char_looks.fail",{mode:l,message:String(W?.message||W)},"warn")}}}const d=await ah(n,{skipAssetInject:f}),p=Zg(d);if(w("job.tagger.messages",{msgs:d.length,skip_asset_inject:f}),E().card?.preprocessing){const A=Pn(await ce("preprocess"));if(A){const W=[{role:"system",content:A},d[d.length-1]],K=await Jt(E().llm,W);if(await we(e,"superseded during preprocess"))return;d.splice(d.length-1,0,{role:"system",content:`## Preprocess Summary
${K}`})}}const m=await Jt(E().llm,d);if(await we(e,"superseded after tagging"))return;const g=_r(m);let h=sh(g,n.assistant_text);if(w("job.tagger.done",{shots:h.length,raw_len:String(m||"").length}),!h.length)throw new Error("태거가 shot을 반환하지 않았습니다.");const _=E().card||{},y=Math.max(1,Number(_.image_min??1)),v=Math.max(y,Number(_.image_max??3));h=h.slice(0,v);const x=Jr();if(x==="two_stage"){if(await pe(e,"tagging",{phase:"tagging",progress:.35,message:"큐레이션 2단 씬 태그 보강 중…",shot_count:h.length,shot_done:0,debug_stage:"job.curation_refine"}),await we(e,"superseded during curation refine"))return;await Nl(h,{chatContext:p})}else if(x==="embed_snap"){if(await pe(e,"tagging",{phase:"tagging",progress:.4,message:"씬 태그 임베딩 매칭 중…",shot_count:h.length,shot_done:0,debug_stage:"job.curation_snap"}),await we(e,"superseded during curation snap"))return;const A=await Cl(h);A.ok||(w("job.curation_snap.fallback",{message:A.reason},"warn"),await pe(e,"tagging",{phase:"tagging",progress:.45,message:A.reason||"임베딩 없음 → 큐레이션 없이 생성",shot_count:h.length,shot_done:0,debug_stage:"job.curation_snap_fallback"}))}const M=h.flatMap(A=>A.characters||[]),L=await Sc({sessionId:r,tagged:g,shotChars:M,unifiedSessionId:i,characterId:o,sourceSessionIds:c});w("job.roster",{roster:L.length});const C=ct(_);for(const A of h)A.characters=ka(A.characters||[],L,C);if(await we(e,"superseded before generate"))return;const $=n.message_index!=null?O(n.message_index,-1):-1,F=h.map((A,W)=>{const K=Math.floor(Number(A.line));return!Number.isFinite(K)||K<1?null:{shot_index:W,line:K}}).filter(A=>!!A);await pe(e,"generating",ir({shot_count:h.length,shot_index:0,shot_done:0,progress:0,phase:"generating",message:`이미지 1/${h.length} 생성 준비`,pending_inline:F,pending_message_index:$}));const k=[],I=!!_.llm_anchor_percent;for(let A=0;A<h.length;A+=1){if(await we(e,`superseded before shot ${A+1}`))return;const W=h[A],{main:K,neg:q,captions:H,meta:ge}=await Vr({shot:W,roster:L}),G=xt(),le=Date.now()/1e3,Q=await f_(e,u(n.content_hash||"")),Wt=Q.contentHash,lr=Q.assistantPreview||u(n.assistant_text||"",4e3);let qs=v_(W);qs==null&&I&&(qs=Math.round(A/Math.max(1,h.length)*1e4)/100),w("job.shot.prepare",{shot:A,card_id:G,prompt_len:String(K||"").length,captions:(H||[]).length}),await pe(e,"generating",ir({shot_count:h.length,shot_index:A,shot_done:A,progress:Math.round(A/Math.max(1,h.length)*1e3)/10,phase:"generating",message:`NovelAI 요청 중 ${A+1}/${h.length}… [${yt()}]`,pending_inline:F,pending_message_index:$}));let Ou=0;const ry=setInterval(()=>{Ou+=Nu/1e3;const hn=Ec();Cc()&&is()>=g_&&hn&&Date.now()-hn>=p_&&jm("heartbeat-idle");const Bu=is()||Ic();pe(e,"generating",ir({shot_count:h.length,shot_index:A,shot_done:A,progress:Math.round(A/Math.max(1,h.length)*1e3)/10,phase:"generating",message:`NovelAI 대기 ${A+1}/${h.length} (${Ou}s) · ${yt()}${Bu?` ${Math.round(Bu/1024)}KB`:""}`,pending_inline:F,pending_message_index:$})).catch(()=>{})},Nu);let ur,sa;try{({bytes:ur,seed:sa}=await Fl({main:K,neg:q,captions:H},W.aspect))}finally{clearInterval(ry)}if(w("job.shot.nai_done",{shot:A,bytes:ur?.byteLength||0,seed:sa}),await we(e,`superseded after shot ${A+1} nai`))return;await pe(e,"generating",ir({shot_count:h.length,shot_index:A,shot_done:A,progress:Math.round((A+.5)/Math.max(1,h.length)*1e3)/10,phase:"generating",message:`이미지 저장 중 ${A+1}/${h.length}… [${yt()}]`,pending_inline:F,pending_message_index:$}));const he=jg({imageId:G,sessionId:r,request:n,shotIndex:A,paragraph:W.paragraph,yPercent:qs,line:(()=>{const hn=Math.floor(Number(W.line));return Number.isFinite(hn)&&hn>=1?hn:null})(),contentHash:Wt,assistantPreview:lr});await $a(G,ur,he);const ay={...Is(ge,he,ur?.byteLength||0),aspect:W.aspect||void 0};await z("cards",{id:G,job_id:e,session_id:r,shot_index:A,paragraph:Number(W.paragraph||0),main_prompt:K,negative_prompt:q,characters_json:JSON.stringify(ge.characters||[]),seed:sa,meta_json:JSON.stringify(ay),created_at:le});const Lu=Re.get(e);if(Lu&&Lu.publishedIds.push(G),await we(e,`superseded after shot ${A+1} save`))return;k.push({id:G,shot_index:A,paragraph:he.paragraph,y_percent:he.y_percent,line:he.line,message_index:he.message_index??-1,message_role:he.message_role||"",content_hash:he.content_hash||"",character_id:he.character_id||"",chat_id:he.chat_id||"",character_name:he.character_name||"",chat_name:he.chat_name||"",char_index:he.char_index??-1,chat_index:he.chat_index??-1,assistant_preview:lr,main_prompt:K,negative_prompt:q,characters:ge.characters||[],image_url:Ue(G),seed:sa,storage:"indexeddb",png_bytes:ur?.byteLength||0}),w("job.shot.saved",{shot:A,card_id:G,has_url:!!Ue(G)}),await pe(e,"generating",ir({shot_count:h.length,shot_index:A,shot_done:A+1,progress:Math.round((A+1)/Math.max(1,h.length)*1e3)/10,phase:"generating",message:`이미지 ${A+1}/${h.length} 완료`,cards_so_far:k.length,pending_inline:F,pending_message_index:$}))}if(await we(e,"superseded before done"))return;const P={cards:k,message_index:n.message_index!=null?Number(n.message_index):-1,shot_count:h.length,shot_done:h.length,progress:100,phase:"done",message:`이미지 ${h.length}/${h.length} 완료`};await ut(P),await pe(e,"done",P);const J=Re.get(e);J&&(J.publishedIds=[]),s.end({message:"done",cards:k.length})}catch(i){s.fail(i);const o=i,c=`${o?.message||i}
${o?.stack||""}`.slice(-1500);await pe(e,"error",{phase:"error",message:String(o?.message||i).slice(0,240),debug_stage:Cn(),debug_tail:ua(e,12)},c)}finally{En(a)}}B(),De(),Zt(),ze(),fe();function Gt(e,t){try{return JSON.parse(e)}catch{return t}}async function k_(e,t={}){const n=u(e,80),r=await D("cards",n);if(!r)return{ok:!1,error:{code:"not_found",message:"card not found"}};const a=Gt(r.characters_json||"[]",[]),s=Array.isArray(a)?a:[];let i=r.main_prompt;"main_prompt"in t&&(i=u(t.main_prompt,8e3));let o=r.negative_prompt;"negative_prompt"in t&&(o=u(t.negative_prompt,8e3));let c=s;if("characters"in t){const d=t.characters||[];if(!Array.isArray(d))return{ok:!1,error:{code:"bad_request",message:"characters must be a list"}};c=[];const p=ct(E().card||{});for(let m=0;m<d.slice(0,p).length;m++){const g=d[m];if(typeof g!="object")continue;const h=g,_=m<s.length&&typeof s[m]=="object"?s[m]:{},y=u(h.name!=null?h.name:_.name,200),v=u(h.prompt!=null?h.prompt:_.prompt,4e3);if(!y&&!v)continue;const x={..._,name:y||`char${m+1}`,prompt:v||"girl"};"uc"in h&&(x.uc=u(h.uc,2e3));for(const M of["center_x","center_y"])if(M in h)try{x[M]=Number(h[M])}catch{}c.push(x)}}r.main_prompt=i,r.negative_prompt=o,r.characters_json=JSON.stringify(c);try{let d=Gt(r.meta_json||"{}",{});(!d||typeof d!="object"||Array.isArray(d))&&(d={});const p=d;p.setup=i,p.characters=c,r.meta_json=JSON.stringify(p)}catch{}await z("cards",r);const l=await ht(n,{}),f={id:n,main_prompt:i,negative_prompt:o,characters:c,paragraph:r.paragraph,shot_index:r.shot_index,y_percent:l.y_percent,message_index:l.message_index,content_hash:l.content_hash,image_url:Ue(n)};return await ut(f),{ok:!0,card:f}}async function Eu(e,t="nai",n=null,r={}){const a=await D("cards",e);if(!a)return{ok:!1,error:{code:"not_found",message:"card not found"}};const s=a.session_id,i=Gt(a.meta_json||"{}",{}),o=i.location||{};if(!r.skipBusyCheck)try{const I=await ht(e,i),P=await Ls({session_id:s,content_hash:u(I.content_hash||i.content_hash||"",128),message_index:O(I.message_index,-1)},s);if(P)return P}catch{}const c=u(o.character_id||i.character_id||"",200);let l=u(i.unified_session_id||o.unified_session_id||"",200);!l&&c&&(l=Ju(c));let f=[];try{const I=await D("jobs",a.job_id);if(I?.request_json){const P=JSON.parse(I.request_json);Array.isArray(P.source_session_ids)&&(f=P.source_session_ids.map(J=>u(J,200)).filter(Boolean))}}catch{}const d=await Gn(s,l,c,f);if(t==="full"){const I=await D("jobs",a.job_id);if(!I)return{ok:!1,error:{code:"no_job",message:"original job missing"}};const P=JSON.parse(I.request_json);return P.force=!0,Iu(P)}let p,m,g,h,_={};const y=n;if(y&&("main_prompt"in y||"negative_prompt"in y||"characters"in y))p="main_prompt"in y?u(y.main_prompt||""):u(a.main_prompt),m="negative_prompt"in y?u(y.negative_prompt||""):u(a.negative_prompt),h="characters"in y?y.characters:null,h==null&&(h=Gt(a.characters_json||"[]",[])),g=(h||[]).slice(0,ct(E().card||{})).map(I=>({prompt:Ma(I.prompt||"girl")||"girl",uc:u(I.uc),center_x:Number(I.center_x??.5),center_y:Number(I.center_y??.5)}));else if(u(a.main_prompt||"")){const I=Gt(a.characters_json||"[]",[]),P=Array.isArray(I)?I:[],J=Cu(i),A=P.map(le=>{if(!le||typeof le!="object")return null;const Q=le;if(Q.raw&&typeof Q.raw=="object"){const Wt=Q.raw;return{...Wt,name:u(Wt.name||Q.name,200)}}return{name:u(Q.name,200),action:Q.action,expression:Q.expression,sex:Q.sex,label:Q.label,age:Q.age,original:Q.original||Q.original_tag}}).filter(Boolean),W=E().card||{},K=Ye(E().nai?.model||"nai-diffusion-4-5-full"),q=Object.values(On).filter(Boolean);On[K]&&q.unshift(On[K]);const H=Of({setup:i.setup,main:a.main_prompt,person:i.person,stylePositives:Lf(W),qualitySuffixes:q}),ge={characters:J.length?J:A,paragraph:a.paragraph,camera:H.rebuildMain&&H.lockedSetup?"":u(i.camera||""),situation:H.rebuildMain&&H.lockedSetup?"":u(i.situation||i.scene||""),place:H.rebuildMain&&H.lockedSetup?"":u(i.place||""),action:H.rebuildMain&&H.lockedSetup?"":u(i.action||"")},G=await Vr({shot:ge,roster:d,lockedSetup:H.rebuildMain?H.lockedSetup:void 0});H.rebuildMain?(p=G.main,m=G.neg,g=G.captions,h=G.meta.characters,_={setup:G.meta.setup,person:G.meta.person,characters:h}):(p=u(a.main_prompt),m=u(a.negative_prompt)||G.neg,g=G.captions,h=G.meta.characters,_={setup:p,person:G.meta.person,characters:h})}else{const I=Gt(a.characters_json||"[]",[]),P=Cu(i),J=(I||[]).map(q=>{if(!q||typeof q!="object")return null;const H=q;return H.raw||{name:H.name,action:H.action,expression:H.expression}}).filter(Boolean),A=u(i.setup||""),W={characters:P.length?P:J,paragraph:a.paragraph,camera:A?"":u(i.camera||""),situation:A?"":u(i.situation||i.scene||""),place:A?"":u(i.place||""),action:A?"":u(i.action||"")},K=await Vr({shot:W,roster:d,lockedSetup:A});p=K.main,m=K.neg,g=K.captions,h=K.meta.characters,_={setup:K.meta.setup,person:K.meta.person,characters:h}}if(!g.length&&!(y&&"characters"in y)){const I={characters:(i.characters||[]).map(J=>J.raw||J),camera:i.setup},P=await Vr({shot:I,roster:d});p=P.main,m=P.neg,g=P.captions,h=P.meta.characters,_={setup:P.meta.setup,person:P.meta.person,characters:h}}const{bytes:v,seed:x}=await Fl({main:p,neg:m,captions:g},i.aspect??y?.aspect),M=xt(),L=Date.now()/1e3;let C=await gt(a.id);Object.keys(C).length||(C=await ht(a.id,i));const $={version:1,image_id:M,session_id:s,unified_session_id:l,character_id:u(C.character_id||"",200),character_name:u(C.character_name||i.character_name||"",200),chat_id:u(C.chat_id||"",200),chat_name:u(C.chat_name||i.chat_name||"",200),char_index:O(C.char_index,-1),chat_index:O(C.chat_index,-1),message_index:O(C.message_index,-1),shot_index:O(C.shot_index,O(a.shot_index,0)),paragraph:O(C.paragraph,O(a.paragraph,0)),y_percent:hr(C.y_percent),content_hash:u(C.content_hash||"",128),assistant_preview:u(C.assistant_preview||i.assistant_preview||"",st)};await $a(M,v,$);const F=Is({...i,..._},$,v.byteLength);for(const I of["y_percent","anchor_percent","read_percent"])delete F[I];F.y_percent=$.y_percent,await z("cards",{id:M,job_id:a.job_id,session_id:s,shot_index:a.shot_index,paragraph:a.paragraph,main_prompt:p,negative_prompt:m,characters_json:JSON.stringify(h),seed:x,meta_json:JSON.stringify(F),created_at:L});try{await Ps(e)}catch{}const k={id:M,image_url:Ue(M),main_prompt:p,negative_prompt:m,characters:h,seed:x,paragraph:$.paragraph,y_percent:$.y_percent,message_index:$.message_index,shot_index:$.shot_index,content_hash:$.content_hash,character_id:$.character_id,chat_id:$.chat_id,character_name:$.character_name,chat_name:$.chat_name,assistant_preview:$.assistant_preview,storage:"indexeddb",png_bytes:v.byteLength};return await ut(k),{ok:!0,replaced:e,card:k}}async function S_({session_id:e="",content_hash:t="",message_index:n=-1}={}){const r=u(e,200),a=u(t,128),s=O(n,-1);if(!r&&!a&&s<0)return{ok:!1,error:{code:"bad_request",message:"session_id or content_hash required"}};const i=await Ae("cards"),o=[];for(const h of i){if(r&&h.session_id!==r)continue;const _=Gt(h.meta_json||"{}",{}),y=await ht(h.id,_),v=u(y.content_hash||_.content_hash||"",128),x=O(y.message_index,-1);if(a){if(v!==a)continue}else if(s>=0){if(x!==s)continue}else continue;const M=y.y_percent??_.y_percent??_.anchor_percent??_.read_percent,L=Number(M);o.push({row:h,y:Number.isFinite(L)?L:999,shot:O(h.shot_index,0),paragraph:O(h.paragraph??y.paragraph,0)})}if(o.sort((h,_)=>h.y-_.y||h.shot-_.shot||h.paragraph-_.paragraph),!o.length)return{ok:!1,error:{code:"not_found",message:"no cards for message"}};const c=r||u(o[0]?.row?.session_id||"",200),l={session_id:c,content_hash:a,message_index:s},f=await Ls(l,c);if(f)return f;const d=Yr(l,c);wr.add(d);const p=[],m=[],g=[];try{for(const h of o){const _=h.row;try{const y=await Eu(_.id,"nai",null,{skipBusyCheck:!0});if(y?.busy){g.push({id:_.id,error:y.error?.message||"busy"});break}y?.ok&&y.card?(p.push(y.card),y.replaced&&m.push(y.replaced)):g.push({id:_.id,error:u(y?.error?.message||"reroll failed",400)})}catch(y){g.push({id:_.id,error:u(y?.message||y,400)})}}return{ok:p.length>0,count:p.length,replaced:m,cards:p,failed:g}}finally{wr.delete(d)}}function Cu(e){return Array.isArray(e.characters)?e.characters.map(t=>t&&typeof t=="object"?t.raw||t:null).filter(Boolean):[]}Y(),te(),B(),Kr(),zr(),fe(),Ze();var A_=["Tag ONE character reference image into Danbooru-style English prompts.",'Return ONE JSON object only: {"gender":"girl|boy","appearance":"...","attire":"...","accessories":"..."}.',"gender must be exactly girl or boy from visual evidence. appearance = identity/hair/eyes/body (no clothes). attire = clothing + permanent jewelry (earrings/glasses/watch/earbuds). accessories = weapons/bags/held props/ID only (not jewelry)."].join(`
`);async function M_(e){const t=await So(e),n=t.bytes;if(!n.length)throw new Error("image is empty");const r=t.mime||"image/png",a=t.filename||"image.png",s=`data:${r};base64,${await Ge(n)}`,i=Pn(await ce("autotag"))||A_;w("vision-autotag.start",{message:`llm-vision ${a} ${n.length}B`,bytes:n.length,source:Rr(E().llm.source)});const o=[{role:"system",content:i},{role:"user",content:[{type:"text",text:"Tag this character image. JSON only with gender, appearance, attire, accessories."},{type:"image_url",image_url:{url:s}}]}];let c="";try{c=await Jt(E().llm,o)}catch(f){throw w("vision-autotag.llm.fail",{message:String(f?.message||f)},"error"),new Error(`오토태그 LLM 실패: ${String(f?.message||f).slice(0,240)}`)}const l=uu(c);if(!u(l.appearance)&&!u(l.attire)&&!u(l.accessories))throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");return w("vision-autotag.done",{message:`gender=${l.gender||"-"} app=${l.appearance.length} attire=${l.attire.length} acc=${l.accessories.length}`}),l}re(),Y(),_t(),te(),St(),B(),ls(),Kr(),Br(),zr(),fe(),Ze();function Ks(){const e=xe(),t=e.events;return{last_stage:e.last_stage,events:Array.isArray(t)?t.slice(-20):[]}}async function N_(e){if(e){const t=E(),n={...e};u(n.api_key)&&(t.llm.api_key=u(n.api_key)),delete n.api_key,delete n.api_key_configured,u(n.service_account_json)&&(t.llm.service_account_json=u(n.service_account_json)),delete n.service_account_json,delete n.service_account_configured,Object.keys(n).length&&(t.llm=Be(t.llm,n)),await Xe()}try{const t=E().llm,n=Rr(t.source),r=Kt(t.provider);return n==="custom"&&!gl(t)?{ok:!1,message:r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM Model/API key가 비어 있습니다. NovelAI 키가 아니라 태깅용 LLM 키를 넣으세요."}:(n==="main"||n==="aux")&&!ve("runLLMModel")?{ok:!1,message:"RisuAI runLLMModel API를 사용할 수 없습니다."}:{ok:!0,message:`LLM ok (${n}): ${(await Jt(t,[{role:"user",content:"Reply with exactly: ok"}])).slice(0,120)}`}}catch(t){return{ok:!1,message:String(t?.message||t)}}}async function I_(){const e=E().nai;if(Vn(e)==="comfy")try{if(!os(e))return{ok:!1,message:"ComfyUI 워크플로 JSON이 없습니다.",debug:xe()};const t=Tc({main:"test",neg:"test",captions:[{name:"",prompt:"char1"},{name:"",prompt:"char2"}],nai:e,seed:1}),n=$c(e.comfy_workflow_json,t),r=jc(e),{status:a,data:s}=await cs(`${r}/system_stats`,{method:"GET"});if(a>=400)return{ok:!1,message:`ComfyUI 연결 실패 (HTTP ${a}) · ${r}`,debug:xe()};const i=s?.devices?.[0]?.name||s?.system?.os||"ok";return{ok:!0,message:`ComfyUI ok · ${r} · nodes=${Object.keys(n).length} · ${i}`,debug:Ks()}}catch(t){return w("comfy.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:xe()}}if(!u(e.api_key))return{ok:!1,message:"NAI api_key missing",debug:xe()};try{const t=u(e.api_key);try{const n=_e("nai.test.anlas"),r=await Jm(t);return n.end({message:"anlas ok"}),{ok:!0,message:`NAI token ok · Anlas=${JSON.stringify(r)}`,debug:Ks()}}catch(n){const r=Ye(e.model||"nai-diffusion-4-5-full");return w("nai.test.anlas",{message:String(n?.message||n)},"warn"),{ok:!0,message:`NAI config present · model=${r} · anlas_skip=${n?.message||n}`,debug:Ks()}}}catch(t){return w("nai.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:xe()}}}async function E_(){const e=E().nai,t=u(e.api_key);if(!t)return{ok:!1,message:"NAI api_key missing",debug:xe()};const n=String(xe().job_ctx??"");En("probe-nai");const r=_e("nai.probe");try{w("nai.probe.start",{message:"tiny generate"});const a={prompt:"1girl, solo, simple background, best quality",negative_prompt:"lowres, bad quality",width:512,height:768,steps:10,cfg_scale:5,cfg_rescale:0,sampler:"k_euler_ancestral",scheduler:"karras",model:Ye(e.model||"nai-diffusion-4-5-full"),var_plus:!1,characters:[],seed:Math.floor(Math.random()*4294967295)||1},s=u(e.request_url)||"https://image.novelai.net/ai/generate-image",i=await Oc(t,a,s,{timeoutMs:9e4}),o=i.raw_bytes.byteLength,c=vt(ee(i.raw_bytes));return r.end({bytes:o,is_png:c,seed:i.seed}),{ok:!0,message:`probe ok · png=${c} · ${o}B · seed=${i.seed}`,bytes:o,is_png:c,seed:i.seed,debug:xe()}}catch(a){return r.fail(a),{ok:!1,message:String(a?.message||a),debug:xe()}}finally{En(n)}}async function C_(e,t){if(!e?.byteLength)throw new Error("image is empty");const n=await M_(e),r=u(n.appearance||"",4e3),a=u(n.attire||"",4e3),s=u(n.accessories||"",4e3),i=u(n.gender||"",20),o=u(n.text||[r,a,s].filter(Boolean).join(", "),8e3);if(!r&&!a&&!s)throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");const c=o.split(",").map(f=>f.trim()).filter(Boolean);w("autotag.done",{message:`gender=${i||"-"} app=${r.length} attire=${a.length} acc=${s.length}`,focus:!0});const l={ok:!0,appearance:r,attire:a,accessories:s,tags:c,text:o,count:c.length,threshold:Number(t||.2),engine:"llm-vision"};return i&&(l.gender=i),l}async function j_(e){if(!e?.byteLength)throw new Error("image is empty");const t=await dc(e);if(!t)throw new Error("이미지에서 NovelAI 메타데이터를 읽지 못했습니다. PNG/WebP NAI 원본인지 확인하세요.");const n=rc(t);if(!u(n))throw new Error("메타데이터에 프롬프트가 없습니다.");const r=Gd(t,n);if(!r.positive&&!r.negative)throw new Error("프리셋에 넣을 artist/품질 태그와 네거티브가 비어 있습니다.");return w("preset-from-image.done",{message:`pos=${r.positive.length} neg=${r.negative.length} cfg=${r.cfg_scale}`,focus:!0}),{ok:!0,positive:r.positive,negative:r.negative,cfg_scale:r.cfg_scale,cfg_rescale:r.cfg_rescale,name:"이미지 프리셋"}}B();function T_(e){const t=e.indexOf("?");if(t<0)return{pathname:e,query:{}};const n=e.slice(0,t),r=new URLSearchParams(e.slice(t+1)),a={};for(const[s,i]of r.entries()){const o=a[s];o===void 0?a[s]=i:Array.isArray(o)?o.push(i):a[s]=[o,i]}return{pathname:n,query:a}}function or(e,t,n=""){const r=e[t];return Array.isArray(r)?r[0]??n:r??n}function $_(e,t={}){const n=u(e.auth_token,4e3);if(!n)return!0;const r=String(t.Authorization||t.authorization||"");let a=r.toLowerCase().startsWith("bearer ")?r.slice(7):r;if(a=a||String(t["X-Inlay-Nexus-Token"]||t["x-inlay-nexus-token"]||""),typeof a!="string"||a.length!==n.length)return!1;let s=0;for(let i=0;i<n.length;i+=1)s|=a.charCodeAt(i)^n.charCodeAt(i);return s===0}Y(),te(),B(),re(),Qi(),fe(),Ze(),rr();var j=(...e)=>t=>e.includes(t)?"":null,tt=e=>t=>t.startsWith(e)?t.slice(e.length):null,Js=(e,t)=>n=>n.startsWith(e)&&n.endsWith(t)?n.slice(e.length,n.length-t.length):null,S=e=>({status:200,data:e}),Gs=e=>({status:200,data:e,contentType:"image/png",raw:!0}),cr=e=>{throw bt(404,{ok:!1,...se(e,"not_found")},e)};function ra(e){let t=e.image_b64||e.data||"";return typeof t=="string"&&t.startsWith("data:")&&(t=t.split(",",2)[1]??""),String(t||"")}var P_=[{match:j("/v1/settings/export"),handler:()=>S({ok:!0,json:cg()})},{match:j("/v1/settings"),handler:()=>S({ok:!0,settings:Hr()})},{match:j("/v1/curation/status"),handler:async()=>S({ok:!0,status:await nr()})},{match:j("/v1/curation/catalog"),handler:async()=>S({ok:!0,catalog:await pt()})},{match:j("/v1/prompts"),handler:async()=>S({ok:!0,prompts:await Ur()})},{match:j("/v1/prompts/export"),handler:async()=>S({ok:!0,...await ag()})},{match:tt("/v1/prompts/"),handler:async({param:e})=>S({ok:!0,key:e,text:await ce(e)})},{match:tt("/v1/jobs/"),handler:async({param:e})=>S(await w_(e))},{match:tt("/v1/gallery/explore"),handler:async({query:e})=>S(await zg(Number(or(e,"limit","400"))))},{match:j("/v1/gallery/favorites"),handler:async()=>S(await Kl())},{match:tt("/v1/gallery"),handler:async({query:e})=>S(await Ug(or(e,"session_id"),Number(or(e,"limit","40"))))},{match:j("/v1/nai/reference.png"),handler:async()=>Gs(await $l()??cr("no reference"))},{match:j("/v1/nai/vibe.png"),handler:async()=>Gs(await Sg()??cr("no vibe"))},{match:j("/v1/nai/reference"),handler:async()=>{const e=await wg();return S({ok:!0,configured:e,image_reference:E().nai?.image_reference||"none",preview_url:e?"/v1/nai/reference.png":""})}},{match:j("/v1/nai/vibe"),handler:async()=>{const e=await xg();return S({ok:!0,configured:e,vibe_transfer:E().nai?.vibe_transfer||"none",preview_url:e?"/v1/nai/vibe.png":""})}},{match:tt("/v1/characters"),handler:async({query:e})=>S(await qn(or(e,"session_id"),or(e,"character_id")))},{match:tt("/v1/appearance/"),handler:async({param:e})=>S(await qn(e))},{match:tt("/v1/images/"),handler:async({param:e})=>{let t=e.replace(/^\/+|\/+$/g,"");if(t.endsWith(".json")){const n=await gt(t.slice(0,-5));return Object.keys(n).length||cr("location missing"),S(n)}return t.endsWith(".png")&&(t=t.slice(0,-4)),Gs(await Jl(t)??cr("image missing"))}}],O_=[{match:j("/v1/settings/reset"),handler:async()=>S(await ug())},{match:j("/v1/settings/import"),handler:async({body:e})=>S(await lg(String(e.json||e.text||"")))},{match:j("/v1/settings","/v1/settings/update"),handler:async({body:e})=>S(await dg(e))},{match:j("/v1/curation/catalog"),handler:async({body:e})=>{const t=e.catalog??e;return S(await vl(t))}},{match:j("/v1/curation/catalog/reset"),handler:async()=>S(await xl())},{match:j("/v1/curation/embed"),handler:async()=>S(await kl())},{match:j("/v1/curation/embed/test"),handler:async()=>S(await Sl())},{match:j("/v1/curation/settings"),handler:async({body:e})=>S(await jl(e))},{match:j("/v1/prompts/import"),handler:async({body:e})=>S(await sg(e?.json!=null?e.json:(e?.prompts!=null,e)))},{match:j("/v1/prompts/reset-defaults"),handler:async({body:e})=>S(await ig({keep_author_note:e?.keep_author_note!==!1&&e?.keepAuthorNote!==!1}))},{match:Js("/v1/prompts/","/reset"),handler:async({param:e})=>S(await yl(e,Ln(e)))},{match:tt("/v1/prompts/"),handler:async({param:e,body:t})=>S(await yl(e,String(t.text||"")))},{match:j("/v1/jobs/create","/v1/jobs"),handler:async({body:e})=>({status:202,data:await Iu(e)})},{match:j("/v1/jobs/retarget-hash"),handler:async({body:e})=>S(await m_({session_id:String(e.session_id||e.sessionId||""),character_id:String(e.character_id||e.characterId||""),chat_id:String(e.chat_id||e.chatId||""),message_index:e.message_index??e.messageIndex??e.chatIndex,role:String(e.role||e.message_role||""),to_hash:String(e.to_hash||e.content_hash||e.hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||e.text||"")}))},{match:j("/v1/jobs/busy-message"),handler:async({body:e})=>S(await d_({session_id:String(e.session_id||e.sessionId||""),character_id:String(e.character_id||e.characterId||""),chat_id:String(e.chat_id||e.chatId||""),message_index:e.message_index??e.messageIndex??e.chatIndex,role:String(e.role||e.message_role||"")}))},{match:j("/v1/gallery/unlink","/v1/cards/unlink"),handler:async({body:e})=>S(await Ts(String(e.session_id||""),String(e.content_hash||""),e.message_index))},{match:j("/v1/gallery/rebind-hash","/v1/cards/rebind-hash"),handler:async({body:e})=>S(await Hl({session_id:String(e.session_id||e.sessionId||""),card_ids:e.card_ids||e.ids||[],to_hash:String(e.to_hash||e.content_hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||"")}))},{match:j("/v1/gallery/delete","/v1/cards/delete"),handler:async({body:e})=>{const t=u(e.folder_key||"",400),n=u(e.card_id||e.id||"",80),r=Array.isArray(e.card_ids)?e.card_ids:null;if(t)return S(await Wg(t));if(r?.length)return S(await Hg(r));if(n)return S(await Ps(n));const a="card_id or folder_key required";throw bt(400,{ok:!1,...se(a,"bad_request")},a)}},{match:j("/v1/gallery/export"),handler:async({body:e})=>S(await Jg(e))},{match:j("/v1/gallery/import"),handler:async({body:e})=>S(await Gg(e))},{match:j("/v1/gallery/favorites"),handler:async({body:e})=>Array.isArray(e.ids)?S(await Kg(e.ids)):S(await Kl())},{match:Js("/v1/cards/","/tags"),handler:async({param:e,body:t})=>S(await k_(e,t))},{match:Js("/v1/cards/","/reroll"),handler:async({param:e,body:t})=>S(await Eu(e,String(t.mode||"nai"),t.overrides))},{match:j("/v1/messages/reroll","/v1/gallery/reroll-message"),handler:async({body:e})=>S(await S_({session_id:String(e.session_id||e.sessionId||""),content_hash:String(e.content_hash||e.contentHash||""),message_index:Number(e.message_index??e.messageIndex??-1)}))},{match:j("/v1/characters/global-toggles","/v1/characters/global_toggles"),handler:async({body:e})=>S(await hm(String(e.character_id||""),e.disabled_globals||e.disabled||[]))},{match:j("/v1/characters/unify","/v1/characters/merge"),handler:async({body:e})=>S(await kc(String(e.target_session_id||e.session_id||""),e.source_session_ids||e.session_ids||[],e.include_target!==!1))},{match:j("/v1/characters","/v1/characters/update"),handler:({body:e})=>L_(e)},{match:tt("/v1/appearance/"),handler:async({param:e,body:t})=>t.characters!=null||t.global!=null?(t.characters!=null&&await Wn(e,t.characters||[],{prune:!0}),t.global!=null&&await Wn(rt,t.global||[],{prune:!0}),S(await qn(e))):S(await km(e,t.appearance||{}))},{match:j("/v1/models/test"),handler:async({body:e})=>S(await N_(e.llm&&typeof e.llm=="object"?e.llm:null))},{match:j("/v1/nai/test"),handler:async()=>S(await I_())},{match:j("/v1/nai/probe","/v1/debug/probe-nai"),handler:async()=>S(await E_())},{match:j("/v1/debug/clear"),handler:()=>(ca(),S({ok:!0,cleared:!0}))},{match:j("/v1/debug/asset-tags"),handler:async({body:e})=>S(await pm(e))},{match:j("/v1/nai/reference","/v1/nai/reference/upload"),handler:async({body:e})=>{if(e.clear)return S(await Pl());const t=ra(e);if(!u(t))throw new Error("image_b64 required");return S(await vg(ne(Le(t))))}},{match:j("/v1/nai/reference/clear"),handler:async()=>S(await Pl())},{match:j("/v1/nai/vibe","/v1/nai/vibe/upload"),handler:async({body:e})=>{const t=u(e.preset_id||e.presetId||"",120);if(e.clear)return S(t?await Bl(t):await Ol());if(t&&e.copy_from){const a=u(e.copy_from,120),s=a?await Ig(a,t):!1;return S({ok:!0,preset_id:t,configured:s,preview_url:s?ga(t):""})}const n=ra(e);if(!u(n))throw new Error("image_b64 required");const r={model:e.model,information_extracted:e.information_extracted??e.vibe_transfer_information_extracted,strength:e.strength??e.vibe_transfer_strength};return S(t?await Ng(t,ne(Le(n)),r):await Ag(ne(Le(n)),r))}},{match:j("/v1/nai/vibe/clear"),handler:async({body:e})=>{const t=u(e?.preset_id||e?.presetId||"",120);return S(t?await Bl(t):await Ol())}},{match:j("/v1/autotag","/v1/autotag/evaluate"),handler:async({body:e})=>{const t=ra(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=Le(t);return S(await C_(ne(n),Number(e.threshold??.2)))}},{match:j("/v1/presets/from-image"),handler:async({body:e})=>{const t=ra(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=Le(t);return S(await j_(ne(n)))}}];async function L_(e){const t=u(e.session_id||"",200),n=u(e.character_id||"",200),r=(Array.isArray(e.root_session_ids)?e.root_session_ids:Array.isArray(e.cascade_session_ids)?e.cascade_session_ids:[]).map(s=>u(s,200)).filter(Boolean);if("characters"in e&&t&&await Wn(t,e.characters||[],{prune:!0,rootSessionIds:r}),"global"in e&&await Wn(rt,e.global||[],{prune:!0}),"character"in e){const s=u(e.scope||t||"__global__",200);r.length&&s!=="__global__"?await xc(r,[e.character||{}],""):await ft(s,e.character||{})}const a=Array.isArray(e.root_delete)?e.root_delete:Array.isArray(e.cascade_delete)?e.cascade_delete:[];return a.length&&r.length&&await vm(r,a,""),r.length&&t&&await kc(t,r,!1),S(await qn(t,n))}async function ju(e,t){for(const n of e){const r=n.match(t.pathname);if(r!==null)return n.handler({...t,param:r})}return cr(t.pathname)}async function B_(e,t={}){const{pathname:n,query:r}=T_(e),a=String(t.method||"GET").toUpperCase();let s;if(typeof t.body=="string")try{s=JSON.parse(t.body)}catch{s={}}else s=t.body??{};if(["/v1/health","/healthz","/readyz"].includes(n))return S({ok:!0,health:fg()});if(n==="/v1/debug"||n==="/v1/debug/log")return a==="DELETE"||a==="POST"&&s.clear?(ca(),S({ok:!0,cleared:!0})):S(xe());if(!$_(E(),t.headers||{})){const o="invalid token";throw bt(401,{ok:!1,...se(o,"unauthorized")},o)}const i={method:a,pathname:n,query:r,body:s};if(a==="GET")return ju(P_,i);if(["POST","PUT","PATCH"].includes(a))try{return await ju(O_,i)}catch(o){if(ui(o))throw o;const c=String(o?.message||o);throw bt(500,{ok:!1,...se(c,"internal")},c)}throw bt(405,{ok:!1,...se(a,"method_not_allowed")},a)}re(),Y(),_t(),Mr(),_l(),ze(),fe(),Ze();var aa=null;async function R_(){w("boot.ready.start",{message:nt}),await lt();const e=await Ar().catch(r=>{throw w("boot.storage",{message:String(r?.message||r)},"error"),r});w("boot.storage",{message:e.kind}),yr(await ng()),await rg(),await Sm(),await Am();const t=await D("meta","reference_image");t?.png&&ma(Ot(t.png));const n=await D("meta","vibe_transfer");n?.png&&pa(Ot(n.png)),await Cg(),w("boot.ready.done",{message:nt,has_nativeFetch:ve("nativeFetch"),has_idb:ve("getLocalPluginStorage")})}async function Ws(){return aa||(aa=R_().catch(e=>{throw aa=null,e})),await aa,!0}async function F_(e,t={},n=12e4){await Ws();try{const r=await B_(e,t);if(r.raw)return r.data;if(r.status>=400)throw bt(r.status,r.data);return r.data}catch(r){if(ui(r))throw r;const a=String(r?.message||r);throw bt(500,{ok:!1,...se(a,"internal")},a)}}async function D_(e){return await Ws(),an(e)}function z_(){ii(()=>({cards:zn("cards"),images:zn("images"),jobs:zn("jobs"),blob_urls:td()})),Reflect.set(globalThis,"__INLAY_NATIVE__",{VERSION:nt,ready:Ws,fetch:F_,resolveImageUrl:Ue,refPreviewUrl:eo,vibePreviewUrl:to,ensureImageUrl:D_,warmImages:cd,pinImageUrls:Lo,retainImageUrls:id,dropImageUrl:od,warmProgress:rd,onWarmProgress:ad,debug:xe,clearDebug:ca})}var U_=_n({EXPLORER_CHAR_FOLDER_PREFIX:()=>Tu,EXPLORER_OVERSCAN_ROWS:()=>2,EXPLORER_WINDOW_SIZE:()=>100,applyExplorerClick:()=>J_,clearSelection:()=>W_,createSelectionState:()=>H_,defaultExplorerFolderKey:()=>Z_,explorerCharFolderKey:()=>$u,explorerFolderKeysForCharacter:()=>Q_,explorerWindowRange:()=>ey,groupExplorerFolders:()=>X_,moveFocus:()=>q_,parseExplorerCharFolderKey:()=>Pu,reorderByIds:()=>ty,selectAll:()=>G_,sortExplorerItems:()=>V_,thumbMinWidth:()=>Y_,visibleIds:()=>K_});function H_(e=[]){return{selected:new Set((e||[]).map(String).filter(Boolean)),anchorId:"",focusId:""}}function K_(e=[]){return(e||[]).map(t=>String(t?.id||"")).filter(Boolean)}function J_(e,t,{index:n,ids:r,shift:a=!1,ctrl:s=!1}={}){const i={selected:new Set(e?.selected||[]),anchorId:String(e?.anchorId||""),focusId:String(e?.focusId||"")},o=String(t||"");if(!o)return i;const c=Array.isArray(r)?r.map(String):[],l=typeof n=="number"&&Number.isFinite(n)?n:c.indexOf(o);if(a&&i.anchorId&&c.length){const f=c.indexOf(i.anchorId),d=l>=0?l:c.indexOf(o);if(f>=0&&d>=0){const p=Math.min(f,d),m=Math.max(f,d);return i.selected=new Set(c.slice(p,m+1)),i.focusId=o,i}}return s?(i.selected.has(o)?i.selected.delete(o):i.selected.add(o),i.anchorId=o,i.focusId=o,i):(i.selected=new Set([o]),i.anchorId=o,i.focusId=o,i)}function G_(e,t=[]){return{selected:new Set((t||[]).map(String).filter(Boolean)),anchorId:String(e?.anchorId||t?.[0]||""),focusId:String(e?.focusId||t?.[0]||"")}}function W_(e=null){return{selected:new Set,anchorId:String(e?.anchorId||""),focusId:""}}function q_(e=[],t="",n=1){const r=(e||[]).map(String).filter(Boolean);if(!r.length)return"";const a=r.indexOf(String(t||""));return a<0?r[0]:r[Math.max(0,Math.min(r.length-1,a+n))]}function V_(e=[],t="newest"){const n=[...e||[]],r=(a,s=0)=>{const i=Number(a);return Number.isFinite(i)?i:s};return t==="oldest"?n.sort((a,s)=>r(a.created_at)-r(s.created_at)||String(a.id).localeCompare(String(s.id))):t==="message"?n.sort((a,s)=>r(a.message_index,1e9)-r(s.message_index,1e9)||r(a.shot_index)-r(s.shot_index)||r(s.created_at)-r(a.created_at)):t==="shot"?n.sort((a,s)=>r(a.shot_index)-r(s.shot_index)||r(a.message_index,1e9)-r(s.message_index,1e9)||r(s.created_at)-r(a.created_at)):n.sort((a,s)=>r(s.created_at)-r(a.created_at)||String(s.id).localeCompare(String(a.id)))}function Y_(e="m"){return e==="s"?96:e==="l"?200:148}var ly=100,uy=2;function X_(e=[]){const t=new Map,n=[];for(const r of e||[]){if(!r||typeof r!="object")continue;const a=String(r.character_id||r.character_name||"unknown").trim()||"unknown",s=String(r.character_name||a).trim()||a;let i=t.get(a);i||(i={characterKey:a,characterName:s,chats:[],count:0},t.set(a,i),n.push(a)),i.chats.push(r),i.count+=Number(r.count)||0}return n.map(r=>t.get(r))}var Tu="__char__:";function $u(e){return`${Tu}${String(e||"").trim()}`}function Pu(e){const t=String(e||"");return t.startsWith("__char__:")?t.slice(9).trim():""}function Z_(e=[],t=""){const n=String(t||"");if(n==="__all__")return"__all__";if(n==="__pick__"||!n)return"__pick__";const r=Pu(n);return r?(e||[]).some(a=>a?String(a.character_id||a.character_name||"").trim()===r:!1)?$u(r):"__pick__":(e||[]).some(a=>a&&String(a.key||"")===n)?n:"__pick__"}function Q_(e=[],t){const n=String(t||"").trim();return n?(e||[]).filter(r=>r&&String(r.character_id||r.character_name||"").trim()===n).map(r=>String(r?.key||"")).filter(Boolean):[]}function ey(e={}){const t=Math.max(0,Math.floor(Number(e.itemCount)||0)),n=Math.max(0,Number(e.gap)||12),r=Math.max(48,Number(e.thumbMin)||148),a=Math.max(0,Number(e.cardExtra)||0),s=Math.max(r,Number(e.gridWidth)||600),i=Math.max(1,Number(e.clientHeight)||620),o=Math.max(0,Number(e.scrollTop)||0),c=Math.max(0,Math.floor(Number(e.overscanRows)||2)),l=Math.max(1,Math.floor((s+n)/(r+n))),f=r*(5/4)+a+n,d=t?Math.ceil(t/l):0,p=d*f;if(!t)return{start:0,end:0,topPad:0,bottomPad:0,cols:l,rowH:f};const m=Math.min(Math.max(0,d-1),Math.floor(o/f)),g=Math.max(1,Math.ceil(i/f)+1),h=Math.max(0,m-c),_=Math.min(d,m+g+c);return{start:h*l,end:Math.min(t,_*l),topPad:h*f,bottomPad:Math.max(0,p-_*f),cols:l,rowH:f}}function ty(e=[],t=[]){const n=s=>{const i=s&&typeof s=="object"?s.id:void 0;return String(i??s)},r=new Map((e||[]).map(s=>[n(s),s])),a=[];for(const s of t||[]){const i=String(s);r.has(i)&&(a.push(r.get(i)),r.delete(i))}for(const s of r.values())a.push(s);return a}Br(),cl();function ny(){Reflect.set(globalThis,"__INLAY_VIEWER_CORE__",{...oh}),Reflect.set(globalThis,"__INLAY_LLM__",{...Wp}),Reflect.set(globalThis,"__INLAY_EMBED__",{EMBEDDING_PROVIDERS:xs,normalizeEmbeddingProvider:$e,defaultEndpointForEmbedding:Or,defaultModelForEmbedding:Qn,embeddingModelPlaceholder:Fp,shouldAutoReplaceEmbeddingEndpoint:zp,shouldAutoReplaceEmbeddingModel:Up,embeddingProviderNeedsApiKey:Hp}),Reflect.set(globalThis,"__INLAY_LORE_EXTRA__",{...xd}),Reflect.set(globalThis,"__INLAY_EXPLORER__",{...U_})}re(),Y(),ny(),z_(),w("boot.loaded",{message:nt})})();
...
var Zt = "inlay-nexus-native", ea = "Inlay Nexus", He = "2.1.12", rn = class extends Error {
  segment;
  constructor($) {
  ...
  async function P() {
    ...
    if (t.uiTab === "dashboard") u = `
      ...
      u = `
        ...
        <article class="model-card">
          <div class="model-head">
            <div><div class="prompt-title">${imgBk === "comfy" ? "ComfyUI" : "Novel AI"}</div><div class="muted">${imgBk === "comfy" ? "로컬 ComfyUI API · [[pos]] / [[neg]] / [[char1]]… / [[width]] / [[height]] / [[seed]]" : `char1~char${Number(i.character_max ?? 6) || 6} CharacterCaption + t2i 생성`}</div></div>
