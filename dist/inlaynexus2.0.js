...
//@display-name Inlay Nexus 2.1.11
//@api 3.0
//@version 2.1.11
...
globalThis.__INLAY_NATIVE_PROMPTS__ = {"__v":1,"__enc":""};

(function(){var Di=Object.defineProperty,$=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(r){throw n=[r],r}},dn=(e,t)=>{let n={};for(var r in e)Di(n,r,{get:e[r],enumerable:!0});return t||Di(n,Symbol.toStringTag,{value:"Module"}),n},Ye,zi,mn,Ui,Xe,ta,na,je,pn,gn,hn,or,cr,_n,yn,Ut,Ht,bn,Hi,Ji,Ki,Gi,Su,qi,Wi,Vi,wn,te=$((()=>{Ye="2.1.11",zi="2026-08-06-bg-filter",mn=["author_note","tagger","format","prefill","preprocess","preset_1","lore_inject","char_inject","appearance_inject","asset_tags_inject","autotag","curation_refine","curation_embed_hint"],Ui=["tagger","format","appearance_inject","lore_inject","asset_tags_inject","autotag","curation_refine","curation_embed_hint"],Xe="__global__",ta="inx_native_settings",na=e=>`inx_nxstore_${e}`,je=e=>`inx_nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,pn="inx_nxref_image",gn="inx_nxvibe_image",hn="inx_nxvibe_data",or="inx_nx_curation_catalog",cr="inx_nx_curation_embeddings",_n=e=>`inx_nxvibe_p_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,yn=e=>`inx_nxvibe_pd_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,Ut=e=>`vibe_preset_${String(e)}`,Ht=e=>typeof e=="string"&&e.startsWith("vibe_preset_"),bn=e=>e.slice(12),Hi="native_settings",Ji=e=>`nxstore_${e}`,Ki=e=>`nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,Gi="nxref_image",Su="https://image.novelai.net/ai/generate-image",qi="https://image.novelai.net/ai/encode-vibe",Wi="https://api.novelai.net/user/subscription",Vi=["meta","cards","characters","jobs","images"],wn=4e3}));function Ae(){const e=globalThis;return e.risuai??e.Risuai}function _e(e){return typeof Ae()?.[e]=="function"}var ht=$((()=>{}));function w(e,t={},n="info"){const r={t:Date.now(),iso:new Date().toISOString(),stage:String(e||""),level:n,job_id:vn||t.job_id||"",ms:t.ms!=null?Number(t.ms):void 0,bytes:t.bytes!=null?Number(t.bytes):void 0,status:t.status!=null?t.status:void 0,message:t.message!=null?sa(t.message,240):void 0,detail:{}};for(const[i,s]of Object.entries(t))Yi.has(i)||(r.detail[i]=s==null||typeof s=="number"||typeof s=="boolean"?s:sa(s,220));for(Te.push(r);Te.length>240;)Te.shift();kn=r.stage,(t.focus||!t.background&&es(r.stage))&&(lr=r.stage),n==="error"&&(xn={stage:r.stage,message:String(r.message??""),t:r.t});const a=`[InlayNX:${r.stage}]`+(r.message?` ${String(r.message)}`:"")+(r.ms!=null?` ${r.ms}ms`:"")+(r.bytes!=null?` ${r.bytes}B`:"");return n==="error"?console.error(a,r.detail):n==="warn"?console.warn(a,r.detail):console.log(a,r.detail),r}function fe(e){const t=Date.now();return{end:(n={},r="info")=>w(e,{...n,ms:Date.now()-t},r),fail:(n,r={})=>w(e,{...r,message:String(n?.message??n),ms:Date.now()-t},"error")}}function ye(){const e=Ae()??{};let t=null;try{t=typeof document<"u"?!!document.hidden:null}catch{}const n=Te.slice(-80),r={};for(const a of n)r[a.stage]=(r[a.stage]??0)+1;return{ok:!0,version:Ye,now:Date.now(),last_stage:kn,focus_stage:lr,last_error:xn,job_ctx:vn||null,env:{has_nativeFetch:typeof e.nativeFetch=="function",has_getLocalPluginStorage:typeof e.getLocalPluginStorage=="function",has_pluginStorage:!!e.pluginStorage?.getItem,has_DecompressionStream:typeof DecompressionStream=="function",has_AbortController:typeof AbortController<"u",document_hidden:t},counts:{events:Te.length,...aa?.()??{}},by_stage:r,errors:Te.filter(a=>a.level==="error").slice(-20),events:n}}function ra(){return Te.length=0,xn=null,kn="cleared",!0}var Yi,Te,vn,xn,kn,lr,aa,Xi,Sn,Zi,_t,An,ur,Qi,ia,sa,es,q=$((()=>{te(),ht(),Yi=new Set(["ms","bytes","status","message","job_id","background","focus"]),Te=[],vn="",xn=null,kn="boot",lr="boot",aa=null,Xi=e=>{aa=e},Sn=e=>{vn=e},Zi=()=>vn,_t=()=>lr,An=()=>kn,ur=()=>xn,Qi=()=>Te.length,ia=(e,t)=>Te.filter(n=>n.job_id===e).slice(-t),sa=(e,t=280)=>{if(e==null||typeof e=="number"||typeof e=="boolean")return e;let n;if(typeof e=="string")n=e;else try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:`${n.slice(0,t)}…(+${n.length-t})`},es=e=>e.startsWith("job.")||e.startsWith("nai.")||e.startsWith("llm.")||e.startsWith("image.")}));q();function yt(e,t,n){const r=t?.error?.message,a=new Error(n??r??`HTTP ${e}`);return a.status=e,a.data=t,a}var ts=e=>e instanceof Error&&typeof e.status=="number",re=(e,t="error")=>({error:{code:t,message:e}}),Ze,fr,bt=$((()=>{Ze=e=>new Promise(t=>setTimeout(t,e)),fr=class{tail=Promise.resolve();run(e){const t=this.tail.then(e,e);return this.tail=t.then(()=>{},()=>{}),t}}}));function Y(e){return e?e instanceof Uint8Array?e:new Uint8Array(e):new Uint8Array(0)}function Jt(e){const t=Y(e);let n="";for(let r=0;r<t.length;r+=Kt)n+=String.fromCharCode(...t.subarray(r,r+Kt));return btoa(n)}async function Qe(e){const t=Y(e);if(t.length<ns)return Jt(t);let n="";for(let r=0;r<t.length;r+=Kt)n+=String.fromCharCode(...t.subarray(r,r+Kt)),r>0&&r%(Kt*24)===0&&await Ze(0);return btoa(n)}function Au(e){return e?Jt(e):""}async function Mu(e){return e?Qe(e):""}function $e(e){const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function Nu(e){return e?$e(e).buffer:null}function X(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}function Mn(e,t){const n=new Uint8Array(t);let r=0;for(const a of e)n.set(a,r),r+=a.length;return n}function wt(e){return!!(e&&e.length>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)}function Nn(e){return!!(e&&e.length>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70&&e[8]===87&&e[9]===69&&e[10]===66&&e[11]===80)}function In(e){const t=Y(e);return Nn(t)?"image/webp":wt(t)?"image/png":t.length>=3&&t[0]===255&&t[1]===216&&t[2]===255?"image/jpeg":"image/png"}function Iu(e){const t=/^data:([^;,]+)?(;base64)?,(.*)$/i.exec(String(e||""));if(!t)return null;const n=!!t[2],r=t[3]||"";try{return X(n?$e(r):new TextEncoder().encode(decodeURIComponent(r)))}catch{return null}}var Kt,ns,Z=$((()=>{bt(),Kt=32768,ns=2e5}));function u(e,t=2e5){if(e==null)return"";let n=String(e).replace(/\x00/g," ").replace(/\r\n/g,`
`);return n=n.replace(/[ \t\f\v]+/g," ").replace(/\n{4,}/g,`


`).trim(),n.slice(0,t)}function P(e,t=-1){if(e==null||typeof e=="string"&&!e.trim())return t;const n=parseInt(String(e),10);return Number.isNaN(n)?t:n}function dr(e){if(e==null||typeof e=="string"&&!e.trim())return null;const t=parseFloat(String(e));return Number.isNaN(t)?null:t}function rs(e){const t=u(e);if(!t)return[];const n=[],r=/-?\d+(?:\.\d+)?::(?:(?!::).)*?::|[^,]+/g;let a;for(;(a=r.exec(t))!==null;){const i=a[0].trim();i&&n.push(i)}return n}function I(...e){const t=[],n=new Set;for(const r of e)for(const a of rs(r)){const i=a.trim();if(!i)continue;const s=i.toLowerCase();s==="null"||s==="none"||n.has(s)||(n.add(s),t.push(i))}return t.join(", ")}function V(e){if(e==null)return[];let t;if(Array.isArray(e))t=e.map(a=>u(a,200));else{const a=u(e,2e3);t=a?a.split(/[,|/]|,(?=\s)|、|\//):[],t.length<=1&&a&&(t=a.split(/\n+/))}const n=[],r=new Set;for(const a of t){const i=u(a,200);if(!i)continue;const s=U(i);!s||r.has(s)||(r.add(s),n.push(i))}return n}function Eu(e){let t=0;for(let n=0;n<e.length;n+=1)t=Math.imul(31,t)+e.charCodeAt(n)|0;return t}function Cu(e){const t=u(e,1e6);let n=2166136261,r=2654435769;for(let a=0;a<t.length;a+=1){const i=t.charCodeAt(a);n^=i,n=Math.imul(n,16777619),r^=i+(n<<6|n>>>26),r=Math.imul(r,2246822507)}return`${(n>>>0).toString(16).padStart(8,"0")}${(r>>>0).toString(16).padStart(8,"0")}`}function ju(e){const t=u(e??"",200);return t?`risu_${Cu(`${t}|__unified__`)}`:""}function mr(e){let t=e;for(let n=0;n<20;n+=1){const r=t.replace(/\{\{#when[\s\S]*?\}\}([\s\S]*?)\{\{\/when\}\}/g,"$1").replace(/\{\{#if[\s\S]*?\}\}([\s\S]*?)\{\{\/if\}\}/g,"$1").replace(/\{\{:else\}\}[\s\S]*?(?=\{\{\/)/g,"");if(r===t)break;t=r}return t.replace(/\{\{[^}]+\}\}/g,"").trim()}function Tu(e){const t=e.match(/\[Positive\]\s*([\s\S]*?)\s*\[Negative\]/),n=e.match(/\[Negative\]\s*([\s\S]*?)\s*$/);return t||n?[u(t?.[1]??""),u(n?.[1]??"")]:[u(e),""]}function vt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}var U,xt,et,L=$((()=>{U=e=>u(e,200).toLowerCase().replace(/\s+/g," "),xt=e=>u(e).toLowerCase().replace(/\s+/g,""),et=4e3})),$u,Pu,Ou,as,is,ss,os,cs,ls,us,fs,ds,ms,Lu=$((()=>{$u="",Pu=0,Ou="",as=[],is="indexeddb:getLocalPluginStorage",ss="indexeddb:inx_nximg_*",os="embedded",cs={backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",notes:"PNG/settings live on this device (not save-file). Folder explorer reads card+location metadata."},ls=JSON.parse(`{"power":true,"execute":"auto","mode":"illustration","image_min":3,"image_max":3,"character_max":2,"preset":1,"lorebook":true,"lore_extra":"tags","asset_nai_tags":false,"auto_aspect":false,"char_info":true,"user_info":true,"char_appearance":true,"preprocessing":false,"person_tag_mode":"gender","auto_person_tags":true,"person_tag_solo":false,"person_tag_weight":3,"original_text":"","custom_pos":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","custom_neg":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth","presets":[{"id":"프리셋_닭장_0_14izz","name":"프리셋 1","positive":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","negative":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth"},{"id":"프리셋_농후_1_u4veg","name":"프리셋 2","positive":"2.0::artist:duoyuanjun::, artist:dawalixi, artist:m (1n910), 1.45::artist:murata yuusuke::, 1.4::artist:konya karasue::, 1.5::artist:wanke::, 2.3::artist:lunch(shin new)::, 0.8::artist:baffu::, 1.4::artist:ishigaki takashi::, 0.8::artist:xipa::, 0.8::artist:freng::, 0.5::artist:kim eb::, year 2025, year 2024, 0.5::3d, blender::, high detail, masterpiece, best quality, very aesthetic, highres, best illustration, novel illustration, -3::simple illustration::, -1::censored::, -3::artist collaboration::, detailed background, -1::door::","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration"},{"id":"프리셋_매끈_2_jgrz3","name":"프리셋 3","positive":"2.4::artist:uki_(ukikusaya) ::, 0.6::artist:sohn woohyoung::, 0.6::artist:minamoto (mutton) ::, artist:sakura no tomoru hi e, 0.5::artist:bettkan::, 0.4::artist:nanja::, 0.4::artist:joy boy \\\\(jerrydurd\\\\) ::, artist:freng, 0.2::artist:murata yuusuke::, 0.8::artist:mx2j::, artist:aoi nagisa (metalder), 0.2::artist:oda non::, 0.4::artist:lunch_(shin new) ::, 0.6::artist:duoyuanjun::, year 2025, year 2024, year 2023, solo artist, -5.3::artist collaboration::, -1::faux retro artstyle::, -1::film grain::, -1::clean text::, -1::flat color::, 1.2::3d::, blender(medium), 1.3::realistic::, natural, incredibly absurdres, very aesthetic, highres, masterpiece, best quality, amazing quality, -3::simple illustration::, best illustration, novel illustration, 0.06::best::, -1::ring::, 1.5::uncensored::, -2::censored::, -2::bar censor::, 2::shiny realistic skin::, 1.3::steaming body::,","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, character sheet, reference sheet, lineup, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration,"},{"id":"프리셋_닭_3_8yiw2","name":"프리셋 2-1","positive":"1.5::artist:sohn woohyoung::, 1.6::artist:solipsist::, 1.45::artist:gogalking::, 1.2::artist:oda non::, 1.25::artist:henriiku_(ahemaru) ::, 1.6::artist:Ask (Askzy) ::, 2.7::artist:jagercoke::, 2::artist:seven (sixplusone) ::, artist:wlop, 1.25::artist:wanke::, artist:seoyong, 0.7::artist:healthyman::, artist:freng, 1.2::artist:sos adult::, artist:shinjiro, 2::artist:nianbingzi::, artist:teshima nari, year 2024, year 2025, 2::blender (medium) ::, 2::pastel (medium) ::, -2::flat color::, pastel colors, 1.4::masterpiece, very aesthetic::, best quality, amazing quality, absurdres, 2::realistic::, -6::artist collaboration::, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, no text, -1.1::pubic hair::, uncensored,","negative":"natsuki karin, text, logo, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, sketch"},{"id":"프리셋_말랑_4_ian7o","name":"프리셋 말랑","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_깔_5_3rh46","name":"프리셋 깔","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_쫀_6_815h6","name":"프리셋 쫀","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::, 1.4::bedroom::, 1.2::sunlight::, 2.9::hotel::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"},{"id":"프리셋_리얼_7_xwn4c","name":"프리셋 리얼","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"}],"active_preset_id":"프리셋_닭장_0_14izz","include_min":0,"include_max":0,"userchat":false,"gallery_fab":false,"floating_viewer":true,"overlay_markers":true,"inline_chat_images":false,"progress_toast":false,"llm_anchor_percent":true,"natural_base":"short","composition_curation":false,"inline_previews":true,"inline_thumb_pct":100,"scale_semantics_version":2,"mobile_toggle_pin":false,"hover_preview":true,"hover_preview_anchor":"mouse","hover_preview_corner":"top-right","viewer_minimize_mode":"icon","unified_chat_priority":false,"overlay_hide_offscreen":true,"scroll_message_track":true,"click_message_track":true,"message_select_gesture":"single","text_drag_select":true,"show_risu_settings_button":true,"debug_panel":false,"generate_all_roles":false,"auto_gen_on_reply":false,"scroll_delay_ms":250,"capture_delay_ms":10,"overlay_x_pct":38,"overlay_y_pct":80,"overlay_pin_unit":"pct","overlay_pin_origin":"bl"}`),us={source:"custom",provider:"openrouter",endpoint:"https://openrouter.ai/api/v1/chat/completions",model:"openai/gpt-oss-20b:nitro",api_key:"",service_account_json:"",temperature:.4,max_tokens:8e3,timeout_seconds:180,reasoning_effort:"default",vertex_region:"us-central1",anthropic_version:"2023-06-01"},fs={provider:"Novel AI",backend:"nai",request_url:"https://image.novelai.net/ai/generate-image",api_key:"",model:"nai-diffusion-4-5-full",width:832,height:1216,sampler:"k_euler_ancestral",scheduler:"karras",steps:28,cfg_scale:7,cfg_rescale:.36,seed:0,variety_plus:!1,enable_i2i:!1,image_reference:"none",image_reference_strength:.6,image_reference_fidelity:1,image_reference_type:"character&style",vibe_transfer:"none",vibe_transfer_strength:.6,vibe_transfer_information_extracted:1,uc_preset:"human_focus",apply_quality_tags:!1,comfy_url:"http://localhost:8188",comfy_workflow_json:"",backend_timeout_seconds:300},ds={mode:"off",strict_ids:!1,embedding:{provider:"openai",model:"text-embedding-3-small",endpoint:"https://api.openai.com/v1/embeddings",api_key:""}},ms={bind_host:"",port:0,auth_token:"",allowed_origins:as,database_path:is,images_dir:ss,prompts_dir:os,storage:cs,card:ls,llm:us,nai:fs,curation:ds}})),ps,gs,hs,_s,Bu=$((()=>{ps="nai-diffusion-4-full",gs="nai-diffusion-4-curated-preview",hs="nai-diffusion-3",_s={"naid4.5f":"nai-diffusion-4-5-full","naid4.5c":"nai-diffusion-4-5-curated",naid4f:ps,naid4c:gs,naid3:hs}})),Ru,ys,bs,ws,vs,xs,ks,Ss,Fu,As,Ms,Ns,Is,Du=$((()=>{Ru="",ys="Tag the chat message into Danbooru-style English image prompts. Output ONE JSON object only.",bs='{"scenes":[{"place":"...","shots":[{"paragraph":0,"y_percent":50,"line":7,"aspect":"portrait|square|landscape","camera":"...","situation":"...","characters":[{"name":"...","action":"..."}]}]}],"new_characters":[]}',ws=`Registered: {registered_block}
Incomplete: {incomplete_block}
Detected: {detected_block}`,vs=`NovelAI asset tags for new_characters:
{asset_tags_block}
Priority: asset>lore>invent. Age as Nyo gender. Fill missing hair_length/style/color/eyes.`,xs="Use matched lorebook context:",ks="Character info:",Ss="Summarize visual details from the message.",Fu="",As=`[Positive]
, masterpiece, best quality

[Negative]
lowres, bad quality, watermark`,Ms="Batch-refine ALL shots' scene tags from allowed curation option ids in ONE JSON response.",Ns="Write detailed Danbooru scene tags for camera/situation/place/action.",Is={author_note:"",tagger:ys,format:bs,appearance_inject:ws,asset_tags_inject:vs,lore_inject:xs,char_inject:ks,preprocess:Ss,prefill:"",preset_1:As,curation_refine:Ms,curation_embed_hint:Ns}})),Es,Cs,js,Ts,zu=$((()=>{Es=", no text, best quality, very aesthetic, absurdres",Cs=", rating:general, amazing quality, very aesthetic, absurdres",js=", best quality, amazing quality, very aesthetic, absurdres",Ts={"naid4.5f":", location, very aesthetic, masterpiece, no text","naid4.5c":", location, masterpiece, no text, -0.8::feet::, rating:general",naid4f:Es,naid4c:Cs,naid3:js}})),$s,Ps,Os,Ls,Uu=$((()=>{$s={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, multiple views, logo, too many watermarks",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing",none:""},Ps={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, logo, dated, signature, multiple views, gigantic breasts",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing, logo, dated, signature",none:""},Os={heavy:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]",light:"lowres, jpeg artifacts, worst quality, watermark, blurry, very displeasing",human_focus:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract], bad anatomy, bad hands, @_@, mismatched pupils, heart-shaped pupils, glowing eyes",none:""},Ls={"naid4.5f":{heavy:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page",light:"lowres, artistic error, scan artifacts, worst quality, bad quality, jpeg artifacts, multiple views, very displeasing, too many watermarks, negative space, blank page",human_focus:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page, @_@, mismatched pupils, glowing eyes, bad anatomy",none:""},"naid4.5c":{heavy:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, negative space, blank page",light:"blurry, lowres, upscaled, artistic error, scan artifacts, jpeg artifacts, logo, too many watermarks, negative space, blank page",human_focus:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, bad anatomy, bad hands, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, @_@, mismatched pupils, glowing eyes, negative space, blank page",none:""},naid4f:$s,naid4c:Ps,naid3:Os}})),tt,Bs,En,Rs,Gt=$((()=>{Lu(),Du(),zu(),Uu(),tt=ms,Bs=Is,En=Ts,Rs=Ls}));function Hu(e,t){const n=zs().encode(t),r=new Uint8Array(e.length);for(let a=0;a<e.length;a+=1)r[a]=e[a]^n[a%n.length];return r}function Ju(e){if(typeof Buffer<"u")return new Uint8Array(Buffer.from(e,"base64"));const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function Ku(e){if(!e||typeof e!="object")return{};const t=e;if(typeof t.__enc=="string"){if(Number(t.__v??1)!==Fs)return{};try{const r=Us().decode(Hu(Ju(t.__enc),Ds)),a=JSON.parse(r),i={};for(const[s,o]of Object.entries(a))typeof o=="string"&&(i[s]=o);return i}catch{return{}}}const n={};for(const[r,a]of Object.entries(t))typeof a=="string"&&(n[r]=a);return n}var Fs,Ds,zs,Us,Gu=$((()=>{Fs=1,Ds="inlay-nexus-prompt-pack-v1",zs=()=>new TextEncoder,Us=()=>new TextDecoder}));function qu(){return Ku(globalThis.__INLAY_NATIVE_PROMPTS__)}function Cn(e){const t=u(qu()[e]);return t||Bs[e]||""}var Hs=$((()=>{L(),Gt(),Gu()}));function be(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e))}function nt(e,t){const n=be(e??{});for(const[r,a]of Object.entries(t??{})){const i=n[r];n[r]=ca(a)&&ca(i)?nt(i,a):a}return n}function oa(e){const t=u(e).replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,""),n=t.slice(0,180).replace(/\s+/g," ");try{return JSON.parse(t)}catch{const r=t.match(/\{[\s\S]*\}/);if(!r)throw new Error(`태거 JSON 파싱 실패${n?` · 응답: ${n}`:" · 응답이 비어 있거나 JSON이 아님"}`);try{return JSON.parse(r[0])}catch(a){throw new Error(`태거 JSON 파싱 실패 · ${String(a?.message??a).slice(0,120)} · 응답: ${n}`)}}}var ca,kt=$((()=>{L(),ca=e=>!!e&&typeof e=="object"&&!Array.isArray(e)}));function j(){return da}function pr(e){da=e}function Js(){return ma}function la(e){ma=e}function Ks(){return pa}function ua(e){pa=e}function fa(e){return _r.get(String(e||""))||""}function gr(e,t){const n=String(e||"");n&&(t?_r.set(n,t):_r.delete(n))}var da,Gs,jn,Pe,hr,ma,pa,_r,de=$((()=>{Gt(),bt(),kt(),da=be(tt),Gs=new fr,jn=new Map,Pe=new Map,hr=new Set,ma="",pa="",_r=new Map})),qs,Wu=$((()=>{qs=["shirt","blouse","pants","trousers","jeans","shorts","skirt","dress","jacket","coat","hoodie","sweater","cardigan","vest","waistcoat","uniform","armor","robe","cloak","cape","apron","overalls","leggings","stockings","tights","pantyhose","socks","thighhighs","boots","shoes","heels","sandals","slippers","footwear","barefoot","gloves","mittens","hat","cap","beret","hood","scarf","necktie","bowtie","tie","belt","bra","panties","underwear","lingerie","swimsuit","bikini","kimono","yukata","hakama","cheongsam","hanbok","suit","tuxedo","collar","choker","mask","helmet","nude","naked","topless","bottomless","completely nude","open shirt","unbuttoned","unzipped","torn clothes","clothes","clothing","outfit","attire","sleeves","rolled-up sleeves","long sleeves","short sleeves","sleeveless","off shoulder","bare shoulder","bare shoulders","midriff","navel","cleavage","garter","corset","bodysuit","leotard","fishnets","ribbon","bow","bandana","no shirt","no pants","shirt lift","panties pull","skirt lift"]})),Ws,Vu=$((()=>{Ws=["necklace","earring","earrings","bracelet","ring","pendant","brooch","watch","wristwatch","wristband","glasses","sunglasses","goggles","monocle","crown","tiara","veil","hair ribbon","hairpin","hair pin","scrunchie","hair ornament","airpods","earbuds","earbud","earphones","earphone","headphones","headset","in one ear","wireless earbuds"]})),Vs,Yu=$((()=>{Vs=["bag","backpack","purse","handbag","briefcase","suitcase","pouch","satchel","badge","id card","lanyard","name badge","nameplate","sword","katana","knife","dagger","gun","pistol","rifle","spear","axe","staff","wand","blade","weapon","shield","crossbow","scythe","hammer","umbrella","phone","smartphone","book","clipboard","folder","cigarette","microphone","camera","holding"]}));function qt(e){const t=W(e).toLowerCase();return t?["girl","female","f","woman","여자","여"].includes(t)?"girl":["boy","male","m","man","남자","남"].includes(t)?"boy":["other","unknown","unset","미정","기타"].includes(t)?"other":"":""}function Xu(...e){const t=new Set(["girl","woman","female"]),n=new Set(["boy","man","male"]);let r=0,a=0;for(const i of e)for(const s of String(i??"").split(",")){let o=s.trim().toLowerCase();if(!o)continue;const c=o.match(/^\d+(?:\.\d+)?::(.+)::$/);c&&(o=c[1].trim().toLowerCase()),o=o.replace(/_/g," ").trim(),t.has(o)&&(r+=1),n.has(o)&&(a+=1)}return r>a?"girl":a>r?"boy":""}function rt(e){const t=Array.isArray(e)?e:String(e??"").split(/[,/\n]/),n=[],r=new Set;for(const a of t){const i=W(a),s=St(i);!i||r.has(s)||(r.add(s),n.push(i))}return n}function Zu(e){const t=W(e).split(" ").filter(Boolean);return t.length!==2||!t.every(n=>/^[A-Za-z'-]+$/.test(n))||!t.every(n=>n===n.toUpperCase())?{surname:"",given_name:""}:{surname:t[0],given_name:t[1]}}function Oe(e={}){const t=W(e.name),n=Zu(t);return{...e,id:W(e.id)||t,name:t,aliases:rt(e.aliases),surname:W(e.surname)||n.surname,given_name:W(e.given_name)||n.given_name,surname_variants:rt(e.surname_variants),given_name_variants:rt(e.given_name_variants),priority:Number.isFinite(Number(e.priority))?Number(e.priority):0,attire_locked:e.attire_locked!==!1,accessories_locked:e.accessories_locked!==!1,gender:qt(e.gender??e.sex),schema_version:2}}function yr(e,t,n){const r=Oe(e);return new Set(rt([r[t],...r[n]||[]]).map(St).filter(Boolean))}function Ys(e,t){const n=Oe(e),r=Oe(t),a=yr(n,"surname","surname_variants"),i=yr(r,"surname","surname_variants"),s=yr(n,"given_name","given_name_variants"),o=yr(r,"given_name","given_name_variants");if(!a.size||!i.size||!s.size||!o.size)return!1;const c=[...a].some(f=>i.has(f)),l=[...s].some(f=>o.has(f));return c&&l}function Xs(e,t){if(!e||!t)return!1;const n=Oe(e),r=Oe(t);if(n.id&&r.id&&String(n.id)===String(r.id)||Ys(n,r))return!0;const a=ga(n),i=ga(r);for(const s of a)if(i.has(s))return!0;return!1}function ga(e){const t=Oe(e),n=new Set,r=o=>{const c=St(o);c&&n.add(c)};r(t.name);const a=new Set(rt([t.surname,...t.surname_variants]).map(St));for(const o of t.aliases)a.has(St(o))||r(o);const i=rt([t.surname,...t.surname_variants]),s=rt([t.given_name,...t.given_name_variants]);for(const o of i)for(const c of s)r(`${o} ${c}`),r(`${o}${c}`),r(`${c} ${o}`);return n}function Qu(e,t=[]){const n=St(e);if(!n)return null;const r=t.map(a=>Oe(a)).filter(a=>ga(a).has(n));return r.length!==1?null:r[0]}function ef(e,t){const n=Number(t.priority||0)-Number(e.priority||0);if(n)return n;const r=Number(e.created_at||e.updated_at||0)-Number(t.created_at||t.updated_at||0);return r||String(e.id).localeCompare(String(t.id))}function ha(...e){return rt(e.flat())}function tf(e){const t=[...e].sort(ef),n={...t[0]};n.aliases=ha(...t.map(r=>[r.name,...r.aliases||[]])),n.surname_variants=ha(...t.map(r=>[r.surname,...r.surname_variants||[]])),n.given_name_variants=ha(...t.map(r=>[r.given_name,...r.given_name_variants||[]])),n.surname||(n.surname=t.map(r=>r.surname).find(Boolean)||""),n.given_name||(n.given_name=t.map(r=>r.given_name).find(Boolean)||"");for(const r of t){const a=W(r.appearance||""),i=W(r.attire||""),s=W(r.accessories||""),o=W(r.original||"");a.length>W(n.appearance||"").length&&(n.appearance=a),!_a(n.attire_locked)&&i.length>W(n.attire||"").length&&(n.attire=i),!_a(n.accessories_locked)&&s.length>W(n.accessories||"").length&&(n.accessories=s),o&&!W(n.original||"")&&(n.original=o)}return n.surname=W(n.surname)||t.map(r=>W(r.surname)).find(Boolean)||"",n.given_name=W(n.given_name)||t.map(r=>W(r.given_name)).find(Boolean)||"",n}function nf(e=[]){const t=e.map(a=>Oe(a)),n=[],r=new Set;for(let a=0;a<t.length;a++){if(r.has(a))continue;const i=[t[a]];r.add(a);for(let s=a+1;s<t.length;s++)r.has(s)||i.some(o=>Ys(o,t[s]))&&(r.add(s),i.push(t[s]));n.push(i)}return{records:t,active:n.map(tf),groups:n}}var W,St,_a,ya=$((()=>{W=e=>String(e??"").trim().replace(/\s+/g," "),St=e=>W(e).normalize("NFKC").toLocaleLowerCase().replace(/[\s_.·•･-]+/g,""),_a=e=>e!==!1}));function br(e){const t=Oe(e||{}),n=V([t.name,...t.aliases||[]]),r=V([t.surname,...t.surname_variants||[]]),a=V([t.given_name,...t.given_name_variants||[]]);for(const i of r)for(const s of a)n.push(`${i} ${s}`,`${i}${s}`,`${s} ${i}`);return V(n).filter(i=>!r.some(s=>U(s)===U(i)))}function we(e,t){return Qu(e,t||[])}function ba(e,t,n=6){const r=Math.max(1,Math.min(6,Number(n)||6)),a=[],i=new Set,s=(o,c)=>{if(!o||!c)return o;for(const l of["action","expression","attire","accessories","appearance","label","age","body","sex","original","original_tag","negative"]){const f=u(o[l]||"",2e3),d=u(c[l]||"",2e3);d&&(f?f.toLowerCase().includes(d.toLowerCase())||(o[l]=I(f,d)):o[l]=d)}return o};for(const o of e||[]){if(!o||typeof o!="object")continue;const c=u(o.name,200);if(!c)continue;const l=we(c,t),f=l?`id:${u(l.id||l.name,200)}`:`name:${U(c)}`;if(!f||f==="id:"||f==="name:")continue;const d=a.findIndex(m=>m._dedupeKey===f);if(d>=0){s(a[d],o);continue}a.length>=r||(i.add(f),a.push({...o,name:l?.name||c,_dedupeKey:f}))}return a.map(({_dedupeKey:o,...c})=>c)}function Tn(e){const t=new Set;for(const r of br(e)){const a=U(r);a&&t.add(a)}const n=U(e?.name);return n&&t.add(n),t}function wa(e){return nf(e||[]).active}function rf(e,t){const n=u(e).toLowerCase(),r=xt(e);if(!n)return[];const a=[],i=new Set;for(const s of t||[]){const o=u(s.id||s.name,200);if(!(!o||i.has(o)))for(const c of br(s)){const l=U(c),f=xt(c);if(!(f.length<2)&&(n.includes(l)||r.includes(f))){a.push(s),i.add(o);break}}}return a}function Wt(e,t=""){if(typeof e!="object"||e===null)return null;const n=e,r=u(n.name||t,200);if(!r)return null;let a=V(n.aliases);a=[r,...a.filter(d=>U(d)!==U(r))];const i=u(n.original||n.original_tag||n.copyright||"",400);let s=u(n.appearance||"",4e3),o=u(n.attire||"",4e3),c=u(n.accessories||"",4e3);const l=u(n.tags||"",4e3);l&&!s&&!o&&!c&&(s=l),i&&s&&(s=I(...s.split(",").filter(d=>U(d)!==U(i))));let f=u(n.id,80)||r.replace(/[^a-zA-Z0-9_\uac00-\ud7a3]+/g,"_").replace(/^_|_$/g,"").slice(0,64);return f||(f=`char_${Math.abs(Eu(r))%1e7}`),Oe({...n,id:f,name:r,aliases:a,original:i,appearance:s,attire:o,accessories:c,gender:qt(n.gender??n.sex)})}function af(e,t,n={}){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[],i=typeof n.hasAppearance=="function"?n.hasAppearance:()=>!1,s=typeof n.resolve=="function"?n.resolve:()=>null,o=typeof n.aliasKeys=="function"?n.aliasKeys:()=>new Set,c=typeof n.normalizeName=="function"?n.normalizeName:m=>String(m||"").trim().toLowerCase(),l=typeof n.clean=="function"?n.clean:m=>String(m||"").trim(),f=[],d=new Set;for(const m of r){if(!l(m?.name,200)||i(m))continue;const p=s(m.name,a);if(p&&i(p))continue;for(const h of o(m))d.add(h);const g=c(m.name);g&&d.add(g)}for(const m of a)[...o(m)].some(p=>d.has(p))||f.push(m);for(const m of r){const p=s(m.name,f);if(!(p&&i(m))){if(p&&!i(m)){if(i(p))continue;const g=f.findIndex(h=>s(m.name,[h]));g>=0?f[g]=m:f.push(m);continue}p||f.push(m)}}return f}var Vt=$((()=>{L(),ya()}));function va(e){const t=u(e).toLowerCase();return t?vr(t,ro):!1}function Zs(e){const t=u(e).toLowerCase();return!t||va(t)?!1:vr(t,no)}function sf(e){return va(e)||Zs(e)}function of(e){const t=u(e).toLowerCase();return!t||sf(t)?!1:vr(t,to)}function cf(e){const t=[],n=[],r=[];for(const a of u(e).split(",")){const i=a.trim();i&&(va(i)?r.push(i):Zs(i)||of(i)?n.push(i):t.push(i))}return[I(...t),I(...n),I(...r)]}function lf(e){if(e===!0||e===1)return!0;const t=u(e,20).toLowerCase();return t==="true"||t==="on"||t==="1"}function uf(e){if(e==null||e===!1)return 0;if(e===!0)return 3;if(typeof e=="number"&&Number.isFinite(e)){const n=Math.floor(e);return n<=0?0:n===1?1:n===2?2:3}const t=u(e,40).toLowerCase().replace(/_/g," ").trim();return!t||t==="off"||t==="false"||t==="0"||t==="none"?0:t==="1"||t==="torn"||t==="torn clothes"?1:t==="2"||t==="nude"?2:t==="3"||t==="on"||t==="true"||t==="completely"||t==="completely nude"||t==="complete"?3:0}function ff(e,t,n=null){const r=u(e,4e3);if(t<=0)return r;let a="";return t===1?a="2::torn clothes::":t===2?a="2.5::nude::":n==="m"?a="2.5::completely nude::":a="2::completely nude::",n==="f"?I(r,a,"nipples","pussy"):n==="m"?I(r,a,"penis"):I(r,a)}function df(e){const[t,n]=cf(e);return[t,n]}function mf(...e){const t=[];for(const n of e)if(n!=null)for(const r of u(n).split(",")){let a=r.trim().toLowerCase();if(!a)continue;const i=a.match(/^\d+(?:\.\d+)?::(.+)::$/);i&&(a=i[1].trim().toLowerCase()),a=a.replace(/_/g," ").trim(),a&&t.push(a)}return t}function pf(...e){const t=mf(...e);if(!t.length)return null;let n=0,r=0;for(const a of t)(io.has(a)||/^\d+\+?girls?$/.test(a))&&(n+=1),(so.has(a)||/^\d+\+?boys?$/.test(a))&&(r+=1);return n>r?"f":r>n?"m":null}function $n(e,t){const n=qt(e?.gender??t?.gender??t?.sex);return n==="girl"?"f":n==="boy"?"m":n==="other"?null:pf(t?.appearance,t?.attire,t?.accessories,e?.appearance,e?.attire,e?.accessories,e?.label,e?.age,e?.body,e?.prompt,e?.sex)}function wr(e,t,n,r){return e<=0?"":e===1?t:e<=5?`${e}${n}`:r}function gf(e,t){const n=[],r=wr(e,"1girl","girls","6+girls"),a=wr(t,"1boy","boys","6+boys");return r&&n.push(r),a&&n.push(a),n.join(", ")}function Qs(e){const t=u(e);if(!t)return"";const n=[];for(const r of rs(t)){const a=r.trim();a&&(ka.test(a)||oo.test(a)||co.test(a)||n.push(a))}return I(...n)}function xa(e){const t=[],n=new Set;for(const r of u(e).split(",")){let a=r.trim();if(!a)continue;if(ka.test(a)){const s=a.toLowerCase();if(s.includes("girl"))a="girl";else if(s.includes("boy"))a="boy";else continue}const i=a.toLowerCase();n.has(i)||(n.add(i),t.push(a))}return I(...t)}function hf(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function _f(e,t=3){const n=u(e,200);if(!n)return"";const r=hf(t);return r<=0?n:`${r}::${n}::`}function eo(e,t=null){let n=e;if(n==null&&t!=null&&(n=t),n===!1)return"off";if(n===!0)return"gender";const r=u(n,40).toLowerCase();return["","auto","mixed","true","1","on"].includes(r)?"gender":["off","none","false","0","disable","disabled"].includes(r)?"off":["girl","all_girls","girls_only"].includes(r)?"girls":["person","persons"].includes(r)?"people":lo(r)?r:"gender"}function yf(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function bf(e,t,n="gender",r=null,a=!1){const i=(e||[]).slice(0,6),s=i.length;if(s<=0)return"";if(yf(a)&&s===1)return"solo";const o=eo(n,r);if(o==="off")return"";if(o==="girls")return wr(s,"1girl","girls","6+girls");if(o==="people")return wr(s,"1person","people","6+people");let c=0,l=0,f=0;for(const d of i){const m=u(d.name,200),p=m?we(m,t):null,g=$n(d,p);g==="f"?c++:g==="m"?l++:qt(d.gender??p?.gender)==="other"||f++}return c+=f,gf(c,l)}function Pn(e){return I(e?.original||"",e?.appearance||"",e?.attire||"",e?.accessories||"")}function Me(e){if(typeof e!="object"||e===null)return!1;const t=e;let n=u(t.appearance||"",4e3);if(!n)return!1;const r=u(t.original||"",400);r&&(n=I(...n.split(",").filter(s=>U(s)!==U(r))));const[a]=df(n);if(n=u(a||"",4e3),!n)return!1;const i=new Set(["girl","boy","man","woman","male","female","1girl","1boy","2girls","2boys","solo","other"]);return n.split(",").map(s=>s.trim().toLowerCase()).filter(Boolean).filter(s=>!i.has(s)&&!/^\d+(girl|boy)s?$/.test(s)).length>0}function oe(e){return e!==!1}function wf(e,t){const n=Me(e),r=u(t?.original||t?.original_tag||"",400),a=u(e?.original||"",400),i=u(e?.attire||"",4e3),s=u(e?.accessories||"",4e3),o=u(t?.attire||"",4e3),c=u(t?.accessories||"",4e3),l=oe(e?.attire_locked)?i:o||i,f=oe(e?.accessories_locked)?s:c||s,d=uf(t?.nude),m=lf(t?.weapon),p=ff(l,d,$n(t,e)),g=m?f:"";return xa(n?I(a||r,e?.appearance,p,g,t?.expression,t?.action,t?.sex):I(a?"":r,t?.label,t?.age,t?.appearance,t?.body,p,g,t?.expression,t?.action,t?.sex))}function at(e){const t=typeof e=="object"&&e?e:{},n=P(t.character_max??t.char_max??6,6);return Math.max(1,Math.min(6,n))}var to,no,ro,ao,io,so,ka,oo,Sa,co,lo,vr,it=$((()=>{Wu(),Vu(),Yu(),L(),ya(),Vt(),to=qs,no=Ws,ro=Vs,ao=["off","girls","people","gender"],io=new Set(["girl","woman","female"]),so=new Set(["boy","man","male"]),ka=/^\d+\+?(?:girls?|boys?|people|person)$/i,oo=/^(?:1girl|1boy)$/i,Sa="(?:\\d+\\+?(?:girls?|boys?|people|person)|1girl|1boy|solo)",co=new RegExp(`^-?\\d+(?:\\.\\d+)?::\\s*${Sa}(?:\\s*,\\s*${Sa})*\\s*::$`,"i"),lo=e=>ao.includes(e),vr=(e,t)=>t.some(n=>{if(n.length<=3){const r=n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?:^|[^a-z0-9])${r}(?:[^a-z0-9]|$)`,"i").test(e)}return e.includes(n)})}));Z(),Hs(),de(),it(),L();function vf(e,t,n,r){let a=u(e);if(!a)return"";for(const o of r){const c=u(o);if(c)if(a.endsWith(c))a=a.slice(0,a.length-c.length).replace(/[,\s]+$/g,"");else{const l=a.lastIndexOf(c);l>=0&&(a=`${a.slice(0,l)}${a.slice(l+c.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}}const i=u(t);if(i)if(a.startsWith(i))a=a.slice(i.length).replace(/^[,\s]+/g,"");else{const o=a.indexOf(i);o>=0&&(a=`${a.slice(0,o)}${a.slice(o+i.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}const s=[...n].map(o=>u(o)).filter(Boolean).sort((o,c)=>c.length-o.length);for(const o of s){const c=a.indexOf(o);c<0||(a=`${a.slice(0,c)}${a.slice(c+o.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}return u(a)}function xf(e){const t=u(e.setup),n=u(e.main);if(!n)return{lockedSetup:t,rebuildMain:!0};if(t&&t!==n)return{lockedSetup:t,rebuildMain:!0};const r=u(e.person);if(r||e.stylePositives&&e.stylePositives.length){const a=vf(n,r,e.stylePositives||[],e.qualitySuffixes||[]);if(a&&a!==n)return{lockedSetup:a,rebuildMain:!0}}return{lockedSetup:"",rebuildMain:!1}}function kf(e){if(!e||typeof e!="object")return[];const t=[],n=u(e.custom_pos);n&&t.push(n);const r=Array.isArray(e.presets)?e.presets:[];for(const a of r){if(!a||typeof a!="object")continue;const i=a,s=u(i.positive||i.pos);s&&t.push(s)}return t}async function uo(e,t,n){const r=new Blob([e],{type:t});let a=null;if(typeof createImageBitmap=="function"?a=await createImageBitmap(r):n&&typeof document<"u"&&(a=await new Promise((o,c)=>{const l=new Image,f=URL.createObjectURL(r);l.onload=()=>{URL.revokeObjectURL(f),o(l)},l.onerror=()=>{URL.revokeObjectURL(f),c(new Error("image decode failed"))},l.src=f})),!a)return null;const i=a,s="naturalWidth"in i?{w:i.naturalWidth,h:i.naturalHeight}:{w:0,h:0};return{source:i,width:i.width||s.w||0,height:i.height||s.h||0,close:()=>{try{"close"in i&&i.close()}catch{}}}}function fo(e,t,n,r){if(r&&typeof OffscreenCanvas<"u"){const a=new OffscreenCanvas(t,n),i=a.getContext("2d");return i?(i.drawImage(e.source,0,0,t,n),{kind:"offscreen",canvas:a}):null}if(typeof document<"u"){const a=document.createElement("canvas");a.width=t,a.height=n;const i=a.getContext("2d");return i?(i.drawImage(e.source,0,0,t,n),{kind:"dom",canvas:a}):null}return null}async function Sf(e,t=.8){const n=Y(e);if(!n.length)return null;if(Nn(n))return X(n);const r=In(n);try{const a=await uo(n,r,!0);if(!a)return null;if(!(a.width>0&&a.height>0))return a.close(),null;const i=fo(a,a.width,a.height,!0);if(!i)return a.close(),null;let s;if(i.kind==="offscreen"){const c=await i.canvas.convertToBlob({type:"image/webp",quality:t});if(a.close(),!c||!c.size)return null;s=await c.arrayBuffer()}else s=Iu(i.canvas.toDataURL("image/webp",t)),a.close();if(!s)return null;const o=Y(s);return!Nn(o)||o.length>=n.length*.98?null:s}catch(a){return w("image.webp.encode.fail",{message:String(a?.message||a)},"warn"),null}}async function Af(e){let t=Y(e);if(!t.length)throw new Error("image is empty");const n=1536,r=12e5,a=In(t),i=t.length>r;try{const s=await uo(t,a,!1);if(s&&(i||s.width>n||s.height>n)){const o=Math.min(1,n/Math.max(s.width,s.height,1)),c=fo(s,Math.max(1,Math.round(s.width*o)),Math.max(1,Math.round(s.height*o)),!1);if(c?.kind==="dom"){const l=await new Promise(f=>{c.canvas.toBlob(f,"image/png")});if(l)return t=new Uint8Array(await l.arrayBuffer()),s.close(),{bytes:t,mime:"image/png",filename:"image.png"}}}s?.close()}catch(s){w("autotag.resize",{message:String(s?.message||s)},"warn")}return{bytes:t,mime:a,filename:`image.${a==="image/jpeg"?"jpg":a==="image/webp"?"webp":"png"}`}}async function xr(){return Yt||(Yt=(async()=>{const e=Ae();if(typeof e?.getLocalPluginStorage=="function")try{const n=fe("storage.open"),r=await e.getLocalPluginStorage();if(Aa(r))return n.end({message:"idb/getLocalPluginStorage"}),{kind:"idb",api:r};n.end({message:"getLocalPluginStorage returned unusable api"},"warn")}catch(n){w("storage.open",{message:String(n?.message||n)},"error"),console.warn("[Inlay Nexus] getLocalPluginStorage failed",n?.message||n)}const t=e?.pluginStorage;if(Aa(t))return w("storage.open",{message:"fallback pluginStorage (save-file)"},"warn"),console.warn("[Inlay Nexus] falling back to pluginStorage (save-file scoped)"),{kind:"plugin",api:t};throw w("storage.open",{message:"no storage API"},"error"),new Error("기기 로컬 IndexedDB 저장소(getLocalPluginStorage)를 사용할 수 없습니다.")})().catch(e=>{throw Yt=null,e}),Yt)}function Mf(){return Ae()?.pluginStorage??null}async function Ne(e,t){try{const{kind:n,api:r}=await xr(),a=await r.getItem(e);if(a!=null&&a!=="")return a;if(n==="idb"&&t){const i=Mf();if(i?.getItem)try{const s=await i.getItem(t);if(s!=null&&s!=="")return await r.setItem(e,s),s}catch{}}return null}catch{return null}}function Nf(e){if(typeof e=="string")return e.length;try{return JSON.stringify(e).length}catch{return 0}}async function Ie(e,t){const{kind:n,api:r}=await xr(),a=Nf(t),i=a>5e4?fe("storage.set.large"):null;try{return await r.setItem(e,t),i?i.end({message:e,bytes:a,kind:n,background:!0}):a>8e3&&w("storage.set",{message:e,bytes:a,kind:n,background:!0}),!0}catch(s){throw i?i.fail(s,{message:e,bytes:a,kind:n,background:!0}):w("storage.set",{message:`${e}: ${s?.message||s}`,bytes:a,kind:n,background:!0},"error"),s}}async function me(e){try{const{api:t}=await xr();t?.removeItem&&await t.removeItem(e)}catch{}}var Aa,Yt,kr=$((()=>{q(),ht(),Aa=e=>typeof e?.getItem=="function"&&typeof e?.setItem=="function",Yt=null})),mo,po,At,If=$((()=>{mo=class{budgetChars;urls=new Map;pinned=new Set;bytes=0;constructor(e){this.budgetChars=e}get size(){return this.urls.size}get byteLength(){return this.bytes}get(e){const t=String(e||"");if(!t)return;const n=this.urls.get(t);if(n!==void 0)return this.urls.delete(t),this.urls.set(t,n),n}set(e,t){const n=String(e||"");if(!n||typeof t!="string"||!t)return;const r=this.urls.get(n);r!==void 0&&(this.bytes-=r.length),this.urls.delete(n),this.urls.set(n,t),this.bytes+=t.length,this.evict()}drop(e){const t=String(e||""),n=this.urls.get(t);n!==void 0&&(this.urls.delete(t),this.bytes-=n.length,this.pinned.delete(t))}pin(e){this.pinned.clear();for(const t of e){const n=String(t||"");if(!n)continue;this.pinned.add(n);const r=this.urls.get(n);r!==void 0&&(this.urls.delete(n),this.urls.set(n,r))}this.evict()}retainOnly(e){this.pin(e);for(const t of[...this.urls.keys()]){if(this.pinned.has(t))continue;const n=this.urls.get(t);this.urls.delete(t),n!==void 0&&(this.bytes-=n.length),this.pinned.delete(t)}}pinnedIds(){return[...this.pinned]}clear(){this.urls.clear(),this.pinned.clear(),this.bytes=0}evict(){if(!(this.bytes<=this.budgetChars))for(const[e,t]of this.urls){if(this.bytes<=this.budgetChars)break;this.pinned.has(e)||(this.urls.delete(e),this.bytes-=t.length)}}},po=33554432,At=new mo(po)}));function go(e){const t=String(e.session_id??"");if(!t)return;let n=Xt.get(t);n||(n=new Set,Xt.set(t,n)),n.add(String(e.id))}function ho(e){if(!e)return;const t=String(e.session_id??""),n=t?Xt.get(t):void 0;n&&(n.delete(String(e.id)),n.size===0&&Xt.delete(t))}function _o(e,t){if(e==="characters"){if(Array.isArray(t))return`${t[0]}	${t[1]}`;if(t&&typeof t=="object"){const n=t;return`${n.scope}	${n.id}`}}return String(t)}function Ef(e,t){if(!t||typeof t!="object")return"";const n=t;return e==="meta"?String(n.key||""):e==="characters"?`${n.scope}	${n.id}`:String(n.id||"")}function Cf(e){if(!e||typeof e!="object")return e;const t={...e};if(!t.result_json)return t;try{const n=JSON.parse(t.result_json);if(!n||typeof n!="object")return t;const r={...n};delete r.tagged,delete r.appearance,delete r.debug_tail,Array.isArray(r.cards)&&(r.cards=r.cards.map(a=>{if(!a||typeof a!="object")return a;const i={...a};return typeof i.image_url=="string"&&i.image_url.startsWith("data:")&&(i.image_url=""),i})),t.result_json=JSON.stringify(r)}catch{}return t}function jf(e){const t={};if(e==="images"){for(const[n,r]of B.images)t[n]={id:r.id,location:r.location||null,has_png:r.has_png,png_bytes:r.png_bytes,storage:"indexeddb",storage_key:je(n)};return t}for(const[n,r]of B[e]){const a=r;if(e==="meta"&&a?.key==="reference_image"){t[n]={key:"reference_image",has_png:!!a.png,updated_at:a.updated_at||0};continue}if(e==="meta"&&a?.key==="vibe_transfer"){t[n]={key:"vibe_transfer",has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="meta"&&Ht(a?.key)){t[n]={key:a.key,has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="jobs"){t[n]=Cf(a);continue}t[n]=r}return t}async function Tf(e){await Ie(na(e),jf(e))}function yo(){It=null;const e=[...Bn];Bn.clear(),e.length&&(Sr=Sr.then(async()=>{for(const t of e){if(xo){w("storage.persist.skip",{message:t,background:!0});continue}try{await Tf(t)}catch(n){console.warn("[Inlay Nexus] persist failed",t,n?.message||n)}}}).catch(()=>{}))}function Mt(e){Bn.add(e),!It&&(It=setTimeout(yo,vo))}async function bo(){It&&(clearTimeout(It),yo()),await Sr,await ce}function $f(){const e=globalThis.document;if(!e?.addEventListener)return;const t=()=>{!It&&!Bn.size||bo()};e.addEventListener("visibilitychange",()=>{e.visibilityState==="hidden"&&t()}),globalThis.addEventListener?.("pagehide",t)}function Pf(e,t){B.images.delete(e),B.images.set(e,t)}function wo(e){if(Et+=e,!(Et<=Ia))for(const t of B.images.values()){if(Et<=Ia)break;!t.png||!t.durable||(Et-=t.png.byteLength,t.png=null,t.hydrated=!1)}}async function Of(e,t){if(t.hydrated)return t.png;const n=Ar.get(e);if(n)return n;const r=(async()=>{const a=Rn(await Ne(je(e),Ki(e)));return t.png=a,t.hydrated=!0,t.durable=!0,a?(t.png_bytes=a.byteLength,wo(a.byteLength)):(t.has_png=!1,t.png_bytes=0),a})().finally(()=>Ar.delete(e));return Ar.set(e,r),r}async function st(){return Zt||(Zt=(async()=>{for(const e of Vi){const t=await Ne(na(e),Ji(e));if(t==null||t==="")continue;let n=t;if(typeof t=="string")try{n=JSON.parse(t)}catch{continue}if(!(!n||typeof n!="object"))for(const[r,a]of Object.entries(n)){const i=a??{};if(e==="images"){const s=!!i.has_png;B.images.set(r,{id:String(i.id||r),location:i.location||{},png:null,has_png:s,png_bytes:Number(i.png_bytes)||0,hydrated:!s,durable:!0})}else if(e==="meta"&&(i.key==="reference_image"||r==="reference_image")){const s=Rn(await Ne(pn,Gi));B.meta.set("reference_image",{key:"reference_image",png:s})}else if(e==="meta"&&(i.key==="vibe_transfer"||r==="vibe_transfer")){const s=Rn(await Ne(gn));let o=await Ne(hn);if(typeof o=="string")try{o=JSON.parse(o)}catch{o=null}const c=o??{};B.meta.set("vibe_transfer",{key:"vibe_transfer",png:s,encoded:c.encoded||"",model:c.model||i.model||"",information_extracted:c.information_extracted??i.information_extracted??1})}else if(e==="meta"&&Ht(i.key||r)){const s=String(i.key||r),o=bn(s),c=Rn(await Ne(_n(o)));let l=await Ne(yn(o));if(typeof l=="string")try{l=JSON.parse(l)}catch{l=null}const f=l??{};B.meta.set(s,{key:s,png:c,encoded:f.encoded||"",model:f.model||i.model||"",information_extracted:f.information_extracted??i.information_extracted??1})}else if(e==="cards"){const s=i;B.cards.set(r,s),go(s)}else B[e].set(r,i)}}return!0})().catch(e=>{throw Zt=null,e}),Zt)}async function F(e,t){await st();const n=_o(e,t);if(e==="images"){const a=B.images.get(n);return a?(a.hydrated?a.png&&Pf(n,a):await Of(n,a),a):void 0}const r=B[e].get(n);return r??void 0}async function Lf(e){await st();const t=B.images.get(String(e));if(t)return{has_png:t.has_png,png_bytes:t.png_bytes}}async function D(e,t,n={}){await st();const r=Ef(e,t);if(!r)throw new Error(`invalid ${e} key`);const a=n.persist!==!1;if(e==="images"){const i=t.png||null,s=B.images.get(r);s?.png&&(Et-=s.png.byteLength);const o={id:String(t.id),location:t.location||{},...typeof t.mime=="string"&&t.mime?{mime:t.mime}:{},png:i,has_png:!!i,png_bytes:i?i.byteLength:0,hydrated:!0,durable:!i};return B.images.set(r,o),i?(wo(i.byteLength),ce=ce.then(async()=>{const c=await Qe(new Uint8Array(i));await Ie(je(r),c),B.images.get(r)===o&&(o.durable=!0)}).catch(c=>console.warn("[Inlay Nexus] image persist failed",r,c?.message||c))):ce=ce.then(()=>me(je(r))).catch(()=>{}),a&&Mt("images"),r}if(e==="meta"&&t.key==="reference_image"){const i=t.png||null;return B.meta.set("reference_image",{key:"reference_image",png:i}),i?ce=ce.then(async()=>{await Ie(pn,await Qe(new Uint8Array(i)))}).catch(s=>console.warn("[Inlay Nexus] ref persist failed",s?.message||s)):ce=ce.then(()=>me(pn)).catch(()=>{}),a&&Mt("meta"),"reference_image"}if(e==="meta"&&t.key==="vibe_transfer"){const i={key:"vibe_transfer",png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return B.meta.set("vibe_transfer",i),ce=ce.then(async()=>{i.png?await Ie(gn,await Qe(new Uint8Array(i.png))):await me(gn),i.encoded?await Ie(hn,{encoded:i.encoded,model:i.model,information_extracted:i.information_extracted}):await me(hn)}).catch(s=>console.warn("[Inlay Nexus] vibe persist failed",s?.message||s)),a&&Mt("meta"),"vibe_transfer"}if(e==="meta"&&Ht(t.key)){const i=String(t.key),s=bn(i),o={key:i,png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return B.meta.set(i,o),ce=ce.then(async()=>{o.png?await Ie(_n(s),await Qe(new Uint8Array(o.png))):await me(_n(s)),o.encoded?await Ie(yn(s),{encoded:o.encoded,model:o.model,information_extracted:o.information_extracted}):await me(yn(s))}).catch(c=>console.warn("[Inlay Nexus] preset vibe persist failed",c?.message||c)),a&&Mt("meta"),i}if(e==="cards"){ho(B.cards.get(r));const i=t;return B.cards.set(r,i),go(i),a&&Mt("cards"),r}return B[e].set(r,t),a&&Mt(e),r}async function Nt(e,t){await st();const n=_o(e,t);if(e==="cards"&&ho(B.cards.get(n)),e==="images"){const r=B.images.get(n);r?.png&&(Et-=r.png.byteLength)}if(B[e].delete(n),e==="images"&&await me(je(n)),e==="meta"&&n==="reference_image"&&await me(pn),e==="meta"&&n==="vibe_transfer"&&(await me(gn),await me(hn)),e==="meta"&&Ht(n)){const r=bn(n);await me(_n(r)),await me(yn(r))}return Mt(e),e==="images"&&Na(n),!0}async function ve(e){return await st(),[...B[e].values()]}async function Ma(e){await st();const t=Xt.get(String(e));if(!t)return[];const n=[];for(const r of t){const a=B.cards.get(r);a&&n.push(a)}return n}function On(e){return B[e].size}function Bf(){let e=0;for(const t of B.images.values())e+=t.png_bytes;return e}function Rf(){const e=[];for(const t of B.images.values())e.push(t.location||{});return e}async function Ff(e){await st();const t=B.images.get(String(e))?.location;return t&&typeof t=="object"?t:{}}function Ln(e){return At.get(String(e))}function Df(e,t){At.set(String(e),t)}function Na(e){At.drop(String(e))}function zf(e){At.pin(e)}function Uf(e){At.retainOnly(e)}function Hf(){return At.size}async function Jf(e){return(await F("images",String(e)))?.png??null}var B,Xt,vo,Bn,It,Sr,ce,xo,Ia,Et,Ar,Rn,Zt,Le=$((()=>{te(),q(),Z(),kr(),If(),B={meta:new Map,cards:new Map,characters:new Map,jobs:new Map,images:new Map},Xt=new Map,vo=25,Bn=new Set,It=null,Sr=Promise.resolve(),ce=Promise.resolve(),xo=!1,$f(),Ia=100663296,Et=0,Ar=new Map,Rn=e=>typeof e=="string"&&e?Nu(e):null,Zt=null}));q(),Z(),bt(),Le();async function Qt(e){if(!e)return"";const t=Ln(e);if(t!==void 0)return t;const n=fe("image.data_url"),r=await F("images",e);if(!r?.png)return n.end({message:`missing png ${e}`,id:e,background:!0},"warn"),"";const a=typeof r.mime=="string"&&r.mime||In(r.png),i=`data:${a};base64,${await Mu(r.png)}`;return Df(e,i),n.end({message:e,bytes:r.png.byteLength||0,mime:a,url_len:i.length,focus:!0}),i}function Be(e){const t=typeof e=="string"?e:e?.id;return t&&Ln(String(t))||""}async function Ea(e,t,n=null){const r=fe("image.publish");Na(e);let a=t,i=In(t);try{const o=await Sf(t,.8);o&&(a=o,i="image/webp")}catch(o){w("image.webp",{message:String(o?.message||o),id:e},"warn")}await D("images",{id:e,png:a,mime:i,location:n||{}});let s="";try{const o=Qt(e);s=await Promise.race([o,Ze(5e3).then(()=>Be(e)||"")]),s||(w("image.data_url.defer",{message:e,bytes:a?.byteLength||0,mime:i,focus:!0},"warn"),o.catch(c=>console.warn("[Inlay Nexus] deferred data URL failed",c?.message||c)))}catch(o){w("image.data_url",{message:String(o?.message||o),id:e},"warn"),Promise.resolve().then(()=>Qt(e)).catch(()=>{})}return r.end({message:e,bytes:a?.byteLength||0,src_bytes:t?.byteLength||0,mime:i,has_url:!!s,has_location:!!(n&&Object.keys(n).length),focus:!0}),s}var Ca=2,Ct=new Set,ae=[],ze=0,Re=0,Ue=0,ko=null;function Kf(){const e=ae.length+ze,t=Math.max(Re,Ue+e),n=Math.min(Ue,t),r=t>0?Math.max(0,Math.min(100,Math.round(n/t*100))):0;return{pending:e,active:ze,done:n,total:t,pct:r,busy:e>0}}function Gf(e){ko=typeof e=="function"?e:null}function jt(){try{ko?.()}catch{}}function ja(){for(;ze<Ca&&ae.length;){const e=ae.shift();ze+=1,jt(),Qt(e).catch(()=>{}).finally(()=>{ze-=1,Ct.delete(e),Ue+=1,ae.length===0&&ze===0&&(Re=0,Ue=0),jt(),ja()})}}function qf(e){const t=String(e||"");!t||Ln(t)!==void 0||Ct.has(t)||(Ct.add(t),ae.push(t),Re+=1,jt(),ja())}function So(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];if(zf(t),!t.length)return;const n=new Set(t),r=ae.length,a=[];for(const c of ae)n.has(c)?a.push(c):Ct.delete(c);ae.length=0;const i=[];for(const c of t)Ln(c)===void 0&&(Ct.has(c)||(Ct.add(c),Re+=1),i.includes(c)||i.push(c));const s=a.filter(c=>!i.includes(c));ae.push(...i,...s);const o=r-a.length;o>0&&(Re=Math.max(Ue+ae.length+ze,Re-o)),jt(),ja()}function Wf(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];Uf(t);const n=new Set(t);for(const a of ae)n.has(a)||Ct.delete(a);const r=ae.filter(a=>n.has(a));ae.length=0,ae.push(...r),So(t)}function Vf(e){Na(String(e||""))}async function Yf(e=[],{concurrency:t=Ca}={}){const n=[...new Set((e||[]).map(String).filter(Boolean))],r=Math.max(1,Number(t)||Ca),a=n.filter(i=>Ln(i)===void 0);a.length&&(Re+=a.length,jt());for(let i=0;i<a.length;i+=r){const s=a.slice(i,i+r);await Promise.all(s.map(o=>Qt(o).catch(()=>"").finally(()=>{Ue+=1,ae.length===0&&ze===0&&Ue>=Re&&(Re=0,Ue=0),jt()})))}return ae.length===0&&ze===0&&(Re=0,Ue=0,jt()),n.map(i=>Be(i)).filter(Boolean)}async function ot(e,t={}){if(!e||typeof e!="object")return e;if(Array.isArray(e)){for(let r=0;r<e.length;r+=1)e[r]=await ot(e[r],t);return e}const n=e;if(typeof n.id=="string"&&(typeof n.image_url=="string"||n.image_path!=null||"shot_index"in n||"main_prompt"in n)){const r=String(n.id),a=t.ids!=null?new Set([...t.ids].map(String)):null;if(!t.cachedOnly&&(!a||a.has(r))){const i=await Qt(r);i&&(n.image_url=i)}else n.image_url=Be(r)||"",!n.image_url&&t.warmMissing!==!1&&qf(r);return e}for(const r of Object.keys(n))n[r]&&typeof n[r]=="object"&&(n[r]=await ot(n[r],t));return e}function Tt(e){return e?`data:${In(e)};base64,${Au(e)}`:""}L();var Xf=new Set(["year 2024","year 2025","year 2026","cowboy shot","looking at viewer","best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration"]),Ao=/^(-?\d+(?:\.\d+)?)::([\s\S]*?)::$/;function Ta(e){const t=u(e);if(!t)return[];const n=[];let r="",a=0,i=0,s=0,o=!1;const c=()=>{const l=r.trim();l&&n.push(l),r=""};for(;a<t.length;){const l=t[a];if(!o&&i===0&&s===0){const f=t.slice(a).match(/^(-?\d+(?:\.\d+)?)::/);if(f){c(),o=!0,r=f[0],a+=f[0].length;continue}}if(o){if(r+=l,l===":"&&t[a+1]===":"){for(r+=":",a+=2,o=!1,c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}a+=1;continue}if(l==="{"){i+=1,r+=l,a+=1;continue}if(l==="}"&&i>0){if(i-=1,r+=l,a+=1,i===0&&s===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l==="["){s+=1,r+=l,a+=1;continue}if(l==="]"&&s>0){if(s-=1,r+=l,a+=1,i===0&&s===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l===","&&i===0&&s===0){for(c(),a+=1;a<t.length&&t[a]===" ";)a+=1;continue}r+=l,a+=1}return c(),n}function Zf(e){return/^-\d+(?:\.\d+)?::/.test(e.trim())}function Qf(e){return/artist\s*:/i.test(e)}function Mo(e){return e.replace(/[_-]+/g," ").replace(/\s+/g," ").trim()}function ed(e){const t=Mo(e);return t==="background"||t.endsWith(" background")}function td(e){const t=Mo(e);return t==="straight on"||t.replace(/\s+/g,"")==="straighton"}function nd(e){return!!(!e||Xf.has(e)||ed(e)||td(e))}function No(e){const t=e.trim();if(t.length<2)return null;const n=t[0],r=n==="{"?"}":n==="["?"]":null;if(!r||t[t.length-1]!==r)return null;let a=0;for(let o=0;o<t.length&&t[o]===n;o+=1)a+=1;let i=0;for(let o=t.length-1;o>=0&&t[o]===r;o-=1)i+=1;const s=Math.min(a,i);return s<1?null:{kind:n==="{"?"brace":"bracket",inner:t.slice(s,t.length-s).trim(),depth:s}}function Io(e,t,n){if(t==="weight")return`${n}::${e}::`;const r=t==="brace"?"{":"[",a=t==="brace"?"}":"]",i=Math.max(1,Number(n)||1);return`${r.repeat(i)}${e}${a.repeat(i)}`}function $a(e){const t=e.trim();if(!t)return[];const n=t.match(Ao);if(n){const s=n[1];return n[2].trim().split(",").map(o=>o.trim()).filter(Boolean).map(o=>({plain:o,restore:Io(o,"weight",s)}))}let r=t,a=null,i=0;for(;;){const s=No(r);if(!s)break;a=s.kind,i=s.depth,r=s.inner}return a?r.split(",").map(s=>s.trim()).filter(Boolean).map(s=>({plain:s,restore:Io(s,a,i)})):[{plain:t,restore:t}]}function rd(e){const t=[],n=new Map,r=new Set;for(const a of Ta(e))if(!Zf(a)&&!Qf(a))for(const{plain:i,restore:s}of $a(a)){const o=i.toLowerCase();nd(o)||(n.has(o)||n.set(o,s),!r.has(o)&&(r.add(o),t.push(i)))}return{plains:t,weightMap:n}}function Eo(e){return new Set(e.map(t=>t.toLowerCase()).filter(Boolean))}function Co(e){const t=new Map;for(const i of e)for(const[s,o]of i.weightMap)t.has(s)||t.set(s,o);if(!e.length)return{common:[],assets:[],weightMap:t};let n=Eo(e[0].plains);for(let i=1;i<e.length;i+=1){const s=Eo(e[i].plains);n=new Set([...n].filter(o=>s.has(o)))}const r=[],a=new Set;for(const i of e[0].plains){const s=i.toLowerCase();!n.has(s)||a.has(s)||(a.add(s),r.push(i))}return{common:r,assets:e.map(i=>{const s=[],o=new Set;for(const c of i.plains){const l=c.toLowerCase();n.has(l)||o.has(l)||(o.add(l),s.push(c))}return{name:i.name,unique:s}}),weightMap:t}}function jo(e){const t=[];t.push("## NovelAI character asset tags (ground truth for new_characters looks)"),t.push("Use ONLY tags from this block for appearance / attire / accessories (clothes, jewelry, weapons included)."),t.push("Do not invent looks outside this list. Asset names hint which outfit belongs to which person."),t.push(""),t.push(`공통: ${e.common.length?e.common.join(", "):"(none)"}`);for(const n of e.assets)t.push(""),t.push(`에셋 \`${n.name}\`:`),t.push(`  ${n.unique.length?n.unique.join(", "):"(no unique tags)"}`);return t.join(`
`)}function Pa(e,t){if(!t?.size)return u(e);const n=[],r=new Set;for(const a of Ta(e)){if(Ao.test(a)||No(a)){const i=a.toLowerCase();if(r.has(i))continue;r.add(i),n.push(a);continue}for(const{plain:i}of $a(a)){const s=i.toLowerCase();!s||r.has(s)||(r.add(s),n.push(t.get(s)||i))}}return I(...n)}function ad(...e){const t=new Map;for(const n of e)if(n)for(const[r,a]of n)t.has(r)||t.set(r,a);return t}var id=dn({isCharacterImageExtraLore:()=>$t,matchCharacterImageSectionTitles:()=>Po,normalizeNameKey:()=>en,parseCharacterImageTagLore:()=>Oa,trimCharacterImageTagLore:()=>$o});function $t(e){return String(e?.comment||e?.name||"").trim().toLowerCase()==="lb-xnai.lb.extra"}function Oa(e){const t=String(e||"");if(!t.trim())return{header:"",sections:[]};const n=/^(#{2,3})\s+(.+?)\s*$/gm,r=[];let a;for(;(a=n.exec(t))!==null;)r.push({hashes:a[1],title:String(a[2]||"").trim(),start:a.index,titleEnd:a.index+a[0].length});if(!r.length)return{header:t.trimEnd(),sections:[]};let i=t.slice(0,r[0].start).trimEnd();const s=[];for(let o=0;o<r.length;o+=1){const c=r[o],l=o+1<r.length?r[o+1].start:t.length,f=t.slice(c.titleEnd,l).replace(/^\r?\n/,"").trimEnd();if(c.title.toLowerCase()==="character image tags"){const d=t.slice(c.start,l).trimEnd();i=i?`${i}

${d}`:d;continue}s.push({title:c.title,hashes:c.hashes,body:f})}return{header:i.trimEnd(),sections:s}}function en(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}function To(e){return new Set((Array.isArray(e)?e:[]).map(t=>en(t)).filter(Boolean))}function sd(e,t){if(!t.length)return"";const n=[];e&&n.push(e);for(const r of t){const a=`${r.hashes} ${r.title}`;n.push(r.body?`${a}
${r.body}`:a)}return n.join(`

`).trimEnd()}function $o(e,t=[],n=[]){const r=Oa(e);if(!r.sections.length)return"";const a=To(n);if(!a.size)return"";const i=To(t),s=r.sections.filter(o=>{const c=en(o.title);return a.has(c)&&!i.has(c)});return sd(r.header,s)}function Po(e,t,n=[]){const r=Oa(e),a=en(t),i=new Set((Array.isArray(n)?n:[]).map(o=>en(o)).filter(o=>o.length>=2));if(!a&&!i.size)return[];const s=[];for(const o of r.sections){const c=en(o.title);c.length<2||(a&&a.includes(c)||i.has(c))&&s.push(o.title)}return s}L(),Vt();function Oo(e){const t=e.key||e.keys||e.trigger||"";let n;if(Array.isArray(t))n=t.map(s=>u(s,200));else{const s=u(t,2e3);n=s?s.split(/[,|\n]/):[]}const r=e.secondkey||e.second_key||"";r&&n.push(...V(r));const a=[],i=new Set;for(const s of n){const o=u(s,200),c=U(o),l=o?xt(o):"";!c||i.has(c)||o.startsWith("")||l.length<2||(i.add(c),a.push(o))}return a}function Lo(e,t,n){const r=U(e),a=xt(e);if(a.length<2)return 0;const i=(s,o)=>{if(!s||!o||o.length<2)return 0;let c=0,l=0;for(;l<=s.length-o.length;){const f=s.indexOf(o,l);if(f<0)break;c+=1,l=f+o.length}return c};return Math.max(i(t,r),i(n,a))}function La(e,t){const n=u(t).toLowerCase(),r=xt(t);if(!n)return[];const a=[],i=new Set;for(const s of e||[]){if(typeof s!="object"||$t(s))continue;const o=u(s.mode||"",40).toLowerCase(),c=u(s.key||"",2e3);if(o==="folder"||c.startsWith("folder:"))continue;const l=Oo(s);if(!l.length)continue;let f=0;for(const d of l)f+=Lo(d,n,r);if(!(f<=0))for(const d of l){const m=U(d);!m||i.has(m)||(i.add(m),a.push(d))}}return a}function Bo(e,t=[]){const n=String(e||"");if(!/character\s*image\s*tags/i.test(n))return!1;const r=(n.match(/^#{2,3}\s+.+$/gm)||[]).filter(i=>!/character\s*image\s*tags/i.test(i)),a=Array.isArray(t)?t.filter(Boolean).length:0;return r.length>=3&&(a===0||r.length>a+1)}function od(e){const t=[],n=new Set;for(const r of e||[])if(Me(r))for(const a of br(r)){const i=u(a,200),s=U(i);!i||!s||n.has(s)||(n.add(s),t.push(i))}return t}function Ro(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e==="full"?"full":"tags"}function cd(e,t,n=[],r=5,a=1200,i=null,s="tags"){const o=Array.isArray(e)?e:[],c=Ro(s),l=c==="off"?[]:o.filter(g=>$t(g)),f=o.filter(g=>!$t(g)),d=ld(f,t,r,a),m=Array.isArray(i)&&i.length?i.map(g=>u(g,200)).filter(Boolean):La(f,t),p=[];for(const g of l){const h=u(g.content||g.data||"",5e4);if(h)if(c==="full")p.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:h,key:"full",always:!0,lore_extra_mode:"full"});else{const _=Po(h,t,m),y=_.length?$o(h,n,_):"";y&&!Bo(y,_)&&p.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:y,key:_.join(", "),always:!0,lore_extra_mode:"tags"})}}for(const g of d)Bo(u(g.content||g.data||"",a),[])||p.push(g);return p}function ld(e,t,n=5,r=1200){const a=u(t).toLowerCase(),i=xt(t);if(!a)return[];const s=[];for(const o of e||[]){if(typeof o!="object"||$t(o))continue;const c=u(o.mode||"",40).toLowerCase(),l=u(o.key||"",2e3);if(c==="folder"||l.startsWith("folder:"))continue;const f=u(o.content||o.data||"",r);if(!f)continue;const d=Oo(o);if(!d.length)continue;let m=0;for(const p of d)m+=Lo(p,a,i);m<=0||s.push({comment:u(o.comment||o.name||"",200),content:f,key:l,hits:m})}return s.sort((o,c)=>c.hits-o.hits||String(o.comment).localeCompare(String(c.comment))),s.slice(0,Math.max(1,n)).map(({hits:o,...c})=>c)}L();function Fn(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function Fo(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function Do(e){const t=Fn(e);if(!t)return[];const n=[],r=u(t.base_caption??t.baseCaption??"");r&&n.push(r);const a=t.char_captions??t.charCaptions;if(Array.isArray(a))for(const i of a){const s=Fn(i),o=u(s?.char_caption??s?.charCaption??s?.caption??"");o&&n.push(o)}return n}function zo(e){const t=Fn(Fo(e));if(!t)return u(e);let n=t.Comment??t.comment;n=Fo(n);const r=Fn(n),a=[],i=o=>{if(!o)return;const c=u(o.prompt??o.Prompt??"");c&&a.push(c);const l=Fn(o.v4_prompt??o.v4Prompt);l&&a.push(...Do(l.caption??l)),a.push(...Do(o.caption))};i(r),i(t);const s=u(t.Description??t.description??"");return s&&!a.some(o=>o.includes(s.slice(0,40)))&&a.push(s),I(...a)}Z();var ud=8;function tn(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function Uo(e,t,n){try{return new TextDecoder("utf-8",{fatal:!1}).decode(e.subarray(t,n))}catch{return tn(e,t,n)}}async function Ho(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("deflate"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{try{const t=new DecompressionStream("deflate-raw"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{return null}}}async function fd(e){const t=Y(e),n={};if(!wt(t)||t.length<8)return n;let r=ud;const a=new DataView(t.buffer,t.byteOffset,t.byteLength);for(;r+12<=t.length;){const i=a.getUint32(r),s=tn(t,r+4,r+8),o=r+8,c=o+i;if(c+4>t.length)break;const l=t.subarray(o,c);if(s==="tEXt"){const f=l.indexOf(0);if(f>0){const d=tn(l,0,f),m=tn(l,f+1,l.length);d&&!(d in n)&&(n[d]=m)}}else if(s==="iTXt"){let f=0;const d=l.indexOf(0);if(d>0){const m=Uo(l,0,d);f=d+1;const p=l[f]??0;f+=1,f+=1;const g=l.indexOf(0,f);if(g>=f){f=g+1;const h=l.indexOf(0,f);if(h>=f){f=h+1;let _=l.subarray(f);if(p===1){const k=await Ho(_);k&&(_=k)}const y=Uo(_,0,_.length);m&&!(m in n)&&(n[m]=y)}}}}else if(s==="zTXt"){const f=l.indexOf(0);if(f>0&&f+2<=l.length){const d=tn(l,0,f),m=await Ho(l.subarray(f+2));m&&d&&!(d in n)&&(n[d]=tn(m,0,m.length))}}if(s==="IEND")break;r=c+4}return n}Z();function dd(e,t,n){const r=[];for(let a=0;a<t;a+=1)for(let i=0;i<n;i+=1){const s=i*t+a;r.push(e[s*4+3]&1)}return r}function md(e,t,n){const r=dd(e,t,n),a=Math.floor(r.length/8)*8,i=new Uint8Array(a/8);for(let s=0;s<a;s+=8){let o=0;for(let c=0;c<8;c+=1)o|=r[s+c]<<7-c;i[s/8]=o}return i}async function pd(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("gzip"),n=new Uint8Array(e.byteLength);n.set(e);const r=new Blob([n]).stream().pipeThrough(t);return new Uint8Array(await new Response(r).arrayBuffer())}catch{return null}}async function gd(e,t,n){if(!e.length||t<1||n<1)return null;const r=t*n*4;if(e.length<r)return null;const a=md(e,t,n);if(a.length<20)return null;const i="stealth_pngcomp",s="stealth_pnginfo",o=String.fromCharCode(...a.subarray(0,15));let c=0,l=!1;if(o.startsWith(i))l=!0,c=15;else if(o.startsWith(s))l=!1,c=15;else return null;if(c+4>a.length)return null;const f=(a[c]<<24|a[c+1]<<16|a[c+2]<<8|a[c+3])>>>0;c+=4;const d=Math.floor(f/8);if(d<1||c+d>a.length)return null;let m=a.subarray(c,c+d);if(l){const g=await pd(m);if(!g)return null;m=g}const p=new TextDecoder("utf-8",{fatal:!1}).decode(m);try{const g=JSON.parse(p);if(g&&typeof g=="object"&&!Array.isArray(g)){const h=g;if(typeof h.Comment=="string")try{h.Comment=JSON.parse(h.Comment)}catch{}}return g}catch{return null}}async function hd(e){const t=Y(e);if(!t.length||typeof createImageBitmap!="function")return null;try{const n=new Uint8Array(t.byteLength);n.set(t);const r=new Blob([n]);let a;try{a=await createImageBitmap(r,{colorSpaceConversion:"none",premultiplyAlpha:"none"})}catch{a=await createImageBitmap(r)}const i=a.width,s=a.height,o=typeof OffscreenCanvas=="function"?new OffscreenCanvas(i,s):(()=>{const f=document.createElement("canvas");return f.width=i,f.height=s,f})(),c=o.getContext("2d",{alpha:!0,willReadFrequently:!0})??o.getContext("2d",{alpha:!0,willReadFrequently:!0});if(!c)return a.close?.(),null;c.drawImage(a,0,0);const l=c.getImageData(0,0,i,s);return a.close?.(),{rgba:new Uint8Array(l.data.buffer,l.data.byteOffset,l.data.byteLength),width:i,height:s}}catch{return null}}Z();function Jo(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function Ko(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]<<8|e[a+1]);return String.fromCharCode(...r)}function _d(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]|e[a+1]<<8);return String.fromCharCode(...r)}function yd(e){if(e.length<8)return"";const t=Jo(e,0,8).replace(/\0+$/g,""),n=e.subarray(8);return/^ASCII/i.test(t)?new TextDecoder("utf-8",{fatal:!1}).decode(n).replace(/\0+$/g,""):/^UNICODE/i.test(t)?n.length>=2&&n[0]===255&&n[1]===254?_d(n,2,n.length).replace(/\0+$/g,""):n.length>=2&&n[0]===254&&n[1]===255?Ko(n,2,n.length).replace(/\0+$/g,""):Ko(n,0,n.length).replace(/\0+$/g,""):new TextDecoder("utf-8",{fatal:!1}).decode(e).replace(/\0+$/g,"")}function bd(e){const t={};if(e.length<8)return t;let n=0;e.length>=6&&e[0]===69&&e[1]===120&&e[2]===105&&e[3]===102&&(n=6);const r=e.subarray(n);if(r.length<8)return t;const a=r[0]===73&&r[1]===73,i=r[0]===77&&r[1]===77;if(!a&&!i)return t;const s=new DataView(r.buffer,r.byteOffset,r.byteLength),o=d=>a?s.getUint16(d,!0):s.getUint16(d,!1),c=d=>a?s.getUint32(d,!0):s.getUint32(d,!1),l=c(4);return(d=>{if(d+2>r.length)return;const m=o(d);for(let p=0;p<m;p+=1){const g=d+2+p*12;if(g+12>r.length)break;const h=o(g),_=o(g+2),y=c(g+4);let k=g+8;const x=y*(_===2||_===7?1:_===3?2:_===4?4:1);if(x>4&&(k=c(g+8)),k+x>r.length)continue;const S=r.subarray(k,k+x);h===270&&_===2?t.ImageDescription=new TextDecoder("utf-8",{fatal:!1}).decode(S).replace(/\0+$/g,""):h===37510&&(t.UserComment=yd(S))}})(l),t}function wd(e){const t=Y(e);if(!Nn(t)||t.length<12)return null;let n=12;for(;n+8<=t.length;){const r=Jo(t,n,n+4),a=t[n+4]|t[n+5]<<8|t[n+6]<<16|t[n+7]<<24,i=n+8,s=i+a;if(s>t.length)break;if(r==="EXIF")return t.subarray(i,s);n=s+(a&1)}return null}function vd(e){const t=wd(e);return t?bd(t):{}}var xd={portrait:{width:832,height:1216},square:{width:1024,height:1024},landscape:{width:1216,height:832}};function kd(e){const t=String(e??"").trim().toLowerCase().replace(/\s+/g,"");return t?t==="portrait"||t==="vertical"||t==="tall"||t==="832x1216"||t==="3:4"||t==="2:3"?"portrait":t==="square"||t==="1:1"||t==="1x1"||t==="1024x1024"?"square":t==="landscape"||t==="horizontal"||t==="wide"||t==="1216x832"||t==="4:3"||t==="3:2"?"landscape":null:null}function Sd(e,t,n){if(n){const r=kd(e)||"portrait";return{...xd[r],aspect:r}}return{width:Math.max(64,Math.min(5e3,Math.round(Number(t.width)||832))),height:Math.max(64,Math.min(5e3,Math.round(Number(t.height)||1216))),aspect:"settings"}}L();var Ad=new Set(["best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration","bad anatomy"]);function Md(e){if(/artist\s*:/i.test(e))return!0;for(const{plain:t}of $a(e))if(Ad.has(t.toLowerCase()))return!0;return!1}function Nd(e){const t=[],n=new Set;for(const r of Ta(e)){if(!Md(r))continue;const a=r.toLowerCase();n.has(a)||(n.add(a),t.push(r.trim()))}return I(...t)}function Go(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function qo(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function Wo(e){if(e==null||e==="")return null;const t=Number(e);return Number.isFinite(t)?t:null}function Id(e,t){const n=Go(qo(e)),r=Go(n?qo(n.Comment??n.comment):null)||n,a=u(r?.uc??r?.negative_prompt??r?.negativePrompt??r?.Negative??n?.uc??"",2e4),i=Wo(r?.scale??r?.cfg_scale??r?.cfgScale??n?.scale),s=Wo(r?.cfg_rescale??r?.cfgRescale??n?.cfg_rescale);return{positive:Nd(t),negative:a,cfg_scale:i,cfg_rescale:s}}Z();function Vo(e){const t=e.Comment||e.comment;if(t)try{return{Comment:JSON.parse(t),...e}}catch{return{Comment:t,...e}}return e}async function Yo(e){const t=Y(e);if(!t.length)return null;if(wt(t)){const r=await fd(t);if(r.Comment||r.Description||r.Source)return Vo(r)}else if(Nn(t)){const r=vd(t);if(r.UserComment||r.ImageDescription){const a={};return r.UserComment&&(a.Comment=r.UserComment),r.ImageDescription&&(a.Description=r.ImageDescription),Vo(a)}}const n=await hd(t);return n?gd(n.rgba,n.width,n.height):null}async function Ed(e){const t=await Yo(e);if(!t)return null;const n=zo(t);if(!n.trim())return null;const r=rd(n);return r.plains.length?r:null}L();var Cd=3,jd=/[\uac00-\ud7a3\u1100-\u11ff\u3130-\u318f]/,Xo=new Set(["normal","default","base","neutral","profile","프로필"]),$_=2;function Dn(e,t){return u(e,t).normalize("NFC").toLowerCase()}function Td(e){return jd.test(e)}function $d(e){const t=Dn(e,200);return t?Td(t)?!0:t.length>=Cd:!1}function Zo(e){const t=Dn(e,400).replace(/\.[a-z0-9]{2,5}$/i,"");return t?t.split(/[\s_\-/\\.|]+/).map(n=>n.trim()).filter(Boolean):[]}function Qo(e){const t=[],n=new Set;for(const r of e){if(!$d(r))continue;const a=Dn(r,200);n.has(a)||(n.add(a),t.push(a))}return t}function ec(e){return[...e].sort((t,n)=>n.length-t.length||t.localeCompare(n))}function zn(e,t){const n=Dn(t,200);if(!n)return-1;const r=Zo(e);if(!r.includes(n))return-1;const a=r.filter(c=>c!==n),i=a.filter(c=>Xo.has(c)),s=a.filter(c=>!Xo.has(c));let o=n.length*10;return r.length===1&&(o+=1e5),i.length&&s.length===0?o+=5e4+i.length*1e3:i.length&&(o+=2e4+i.length*500),o+=Math.max(0,5e3-s.length*400),o}function Pd(e,t){const n=u(e,400);if(!n)return null;const r=new Set(Zo(n));if(!r.size)return null;const a=[];for(const i of t){const s=Dn(i,200);r.has(s)&&a.push(s)}return a.length?{name:n,key:n,score:Math.max(...a.map(i=>zn(n,i))),hits:a}:null}function Od(e,t,n=2){const r=ec(t),a=[],i=new Set;for(const s of r){const o=e.filter(l=>l.hits.includes(s)&&!i.has(l.key)).sort((l,f)=>zn(f.name,s)-zn(l.name,s)||l.name.localeCompare(f.name));let c=0;for(const l of o){if(c>=n)break;i.has(l.key)||(i.add(l.key),a.push(l),c+=1)}}return a}L();function Mr(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(Array.isArray(n)){const r=u(n[0],400),a=u(n[1],800);r&&a&&t.push({name:r,key:a});continue}if(n&&typeof n=="object"){const r=n,a=u(r.name??r.assetName??r.fileName,400),i=u(r.key??r.path??r.id??r.asset,800);a&&i&&t.push({name:a,key:i})}}return t}function Ba(e,t){if(Array.isArray(t))for(const n of t){const r=u(n,200);r&&e.push(r)}}function Ld(e){const t=[];Ba(t,e.enabledModules),Ba(t,e.chatModules),Ba(t,e.characterModules);const n=u(e.personaEmbeddedModuleId,200);if(n&&t.push(n),typeof e.moduleIntergration=="string")for(const r of e.moduleIntergration.split(",")){const a=r.trim();a&&t.push(a)}return t}function Bd(e,t){const n=u(e.id,200);if(n&&t.has(n))return!0;const r=u(e.namespace,200);return!!(r&&t.has(r))}function Rd(e,t,n=[]){if(!t.length)return[];const r=new Set(t),a=[],i=new Set,s=o=>{if(!o||typeof o!="object")return;const c=o;if(!Bd(c,r))return;const l=u(c.id,200)||u(c.namespace,200)||"";if(l){if(i.has(l))return;i.add(l)}a.push(...Mr(c.assets))};for(const o of e)s(o);for(const o of n)s(o);return a}function Fd(...e){const t=[],n=new Set;for(const r of e)for(const a of r)!a.name||!a.key||n.has(a.key)||(n.add(a.key),t.push(a));return t}function Dd(e){if(!e||typeof e!="object")return null;const t=e;if(!Array.isArray(t.personas))return null;const n=typeof t.selectedPersona=="number"?t.selectedPersona:0,r=t.personas[n];if(!r||typeof r!="object")return null;const a=r.embeddedModule;return a&&typeof a=="object"?a:null}q(),ht(),L(),Z();var tc=8,zd=24,Ra=new Map,nc=new Map;function Ud(){return Ra}function rc(e){Ra=e}async function ac(e){const t=Ae();if(!t||typeof t.readImage!="function")return null;try{const n=await t.readImage(e);if(!n)return null;if(n instanceof ArrayBuffer)return Y(n);if(n instanceof Uint8Array)return n;if(typeof Blob<"u"&&n instanceof Blob)return Y(await n.arrayBuffer());if(typeof n=="string"){const r=n.match(/^data:[^;]+;base64,(.+)$/i);if(r){const a=atob(r[1]),i=new Uint8Array(a.length);for(let s=0;s<a.length;s+=1)i[s]=a.charCodeAt(s);return i}try{const a=atob(n.replace(/\s+/g,"")),i=new Uint8Array(a.length);for(let s=0;s<a.length;s+=1)i[s]=a.charCodeAt(s);return i}catch{return null}}if(n&&typeof n=="object"){const r=n;if(r.data instanceof ArrayBuffer)return Y(r.data);if(typeof r.data=="string")return ac(r.data)}}catch(n){w("asset-tags.read.fail",{path:e,message:String(n?.message||n)},"warn")}return null}async function Hd(){const e=Ae();if(!e||typeof e.getCurrentCharacterIndex!="function"||typeof e.getCurrentChatIndex!="function"||typeof e.getChatFromIndex!="function")return null;try{const t=await e.getCurrentCharacterIndex(),n=await e.getCurrentChatIndex();return await e.getChatFromIndex(t,n)}catch(t){return w("asset-tags.chat.fail",{message:String(t?.message||t)},"warn"),null}}function Jd(e){const t=e&&typeof e=="object"?e:null;if(!t)return null;const n=Array.isArray(t.chats)?t.chats:null;if(!n?.length)return null;const r=typeof t.chatPage=="number"?t.chatPage:0,a=n[Math.max(0,Math.min(n.length-1,r))];return a&&typeof a=="object"?a:null}async function ic(e){const t=e&&typeof e=="object"?e:null,n=Mr(t?.additionalAssets??t?.additional_assets);let r=[],a=[],i=[];if(_e("getDatabase"))try{const s=await Ae().getDatabase(["modules","enabledModules","moduleIntergration","personas","selectedPersona"]);if(s){const o=await Hd()||Jd(e),c=o&&typeof o=="object"?o:null,l=Dd(s),f=l&&typeof l=="object"?l:null;i=Ld({enabledModules:s.enabledModules,characterModules:t?.modules,chatModules:c?.modules,moduleIntergration:s.moduleIntergration,personaEmbeddedModuleId:f?.id});const d=Array.isArray(s.modules)?s.modules:[];r=Rd(d,i,l?[l]:[]),f&&(a=Mr(f.assets));const m=new Set(i),p=[];for(const g of d){if(!g||typeof g!="object")continue;const h=g,_=u(h.id,200),y=u(h.namespace,200);!(_&&m.has(_))&&!(y&&m.has(y))||p.push({id:_||y,name:u(h.name,200),assets:Mr(h.assets).length})}w("asset-tags.modules",{enabled:i.length,module_assets:r.length,per_module:p.slice(0,12)})}}catch(s){w("asset-tags.modules.fail",{message:String(s?.message||s)},"warn")}return{assets:Fd(n,r,a),characterCount:n.length,moduleCount:r.length,personaCount:a.length,enabledModuleIds:i}}async function sc(e,t){const n=e.map(l=>{const f=Pd(l.name,t);return f?{...l,score:f.score,hits:f.hits}:null}).filter(Boolean),r=[],a=[],i=new Set;let s=0;const o=async l=>{if(i.has(l.key)||r.length>=tc||s>=zd)return!1;s+=1;let f,d,m=!1;const p=nc.get(l.key);if(p)f=p.plains,d=new Map(p.weights),m=!0;else{const g=await ac(l.key);if(!g?.length)return a.push({name:l.name,key:l.key,ok:!1,reason:"read_empty"}),!1;const h=await Ed(g);if(!h?.plains.length)return w("asset-tags.no_meta",{name:l.name}),a.push({name:l.name,key:l.key,ok:!1,reason:"no_nai_meta",bytes:g.length}),!1;f=h.plains,d=h.weightMap,nc.set(l.key,{plains:f,weights:[...d.entries()]})}return i.add(l.key),r.push({name:l.name,plains:f,weightMap:d}),a.push({name:l.name,key:l.key,ok:!0,from_cache:m,plains:f.length,hits:l.hits,score:l.score}),!0},c=new Set(Od(n,t,2).map(l=>l.key));for(const l of ec(t)){if(r.length>=tc)break;const f=n.filter(m=>m.hits.includes(l)).sort((m,p)=>{const g=c.has(m.key)?1:0,h=c.has(p.key)?1:0;return h!==g?h-g:zn(p.name,l)-zn(m.name,l)||m.name.localeCompare(p.name)});let d=0;for(const m of f){if(d>=2)break;await o(m)&&(d+=1)}}return{scored:n,packedRows:r,attempts:s,attemptLog:a}}async function Kd(e){const t=Qo(e);if(!t.length)return w("asset-tags.skip",{reason:"no_long_triggers"}),null;if(!_e("getCharacter")||!_e("readImage"))return w("asset-tags.skip",{reason:"host_api_missing"}),null;let n;try{n=await Ae().getCharacter()}catch(f){return w("asset-tags.getCharacter.fail",{message:String(f?.message||f)},"warn"),null}const r=await ic(n);if(!r.assets.length)return w("asset-tags.skip",{reason:"no_assets"}),null;const{scored:a,packedRows:i,attempts:s}=await sc(r.assets,t);if(!i.length)return w("asset-tags.skip",{reason:"no_meta_hits",matched:a.length,attempts:s}),null;const o=Co(i),c=ad(o.weightMap);Ra=c;const l=jo(o);return w("asset-tags.done",{assets:o.assets.map(f=>f.name),pool:r.assets.length,common:o.common.length,unique:o.assets.reduce((f,d)=>f+d.unique.length,0)}),{block:l,packed:o,weightMap:c}}async function Gd(e={}){const t=u(e.message??e.text??"",2e4),n=Array.isArray(e.lorebook)?e.lorebook:[],r=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys.map(h=>u(h,200)).filter(Boolean):[],a=La(n,t),i=[...r,...a],s=Qo(i),o={setting_asset_nai_tags:j().card.asset_nai_tags===!0,message_preview:t.slice(0,240),message_len:t.length,lorebook_entries:n.length,lore_trigger_keys_ui:r,lore_trigger_keys_backend:a,asset_match_triggers:s,note:"per trigger ≤2 assets; prefer exact/normal/default names; Hangul any length; Latin/Hanja ≥3"};if(!t)return o.skip="no_message",{ok:!0,report:o};if(!s.length)return o.skip="no_long_triggers",{ok:!0,report:o};if(!_e("getCharacter")||!_e("readImage"))return o.skip="host_api_missing",o.host={getCharacter:_e("getCharacter"),readImage:_e("readImage"),getDatabase:_e("getDatabase")},{ok:!0,report:o};let c;try{c=await Ae().getCharacter()}catch(h){return o.skip="getCharacter_fail",o.error=String(h?.message||h),{ok:!1,message:o.error,report:o}}const l=await ic(c);if(o.pool={total:l.assets.length,character:l.characterCount,module:l.moduleCount,persona:l.personaCount,enabled_module_ids:l.enabledModuleIds,sample_names:l.assets.slice(0,40).map(h=>h.name)},!l.assets.length)return o.skip="no_assets",{ok:!0,report:o};const{scored:f,packedRows:d,attempts:m,attemptLog:p}=await sc(l.assets,s);if(o.name_matches=f.slice(0,20).map(h=>({name:h.name,key:h.key,score:h.score,hits:h.hits})),o.read_attempts=m,o.read_log=p,o.picked=d.map(h=>({name:h.name,plains_count:h.plains.length,plains_sample:h.plains.slice(0,12)})),!d.length)return o.skip="no_meta_hits",{ok:!0,report:o};const g=Co(d);return o.packed={common:g.common,assets:g.assets.map(h=>({name:h.name,unique:h.unique}))},o.inject_block_preview=jo(g).slice(0,2e3),o.ok_picked=d.length,{ok:!0,report:o}}te(),L(),ya(),Vt(),it(),Le(),de();var Fe=(e,t)=>!!e&&Object.prototype.hasOwnProperty.call(e,t),Nr=e=>e?[...e]:[],Fa=e=>e;async function ie(e){const t=(await ve("characters")).filter(r=>r.scope===u(e,200)).sort((r,a)=>(r.name||"").localeCompare(a.name||"",void 0,{sensitivity:"base"})),n=[];for(const r of t){let a=r.aliases;if(typeof a=="string")try{a=JSON.parse(a)}catch{a=V(a)}const i=r.appearance||"",s=r.attire||"",o=r.accessories||"";let c=qt(r.gender??r.sex);if(!c){const f=Xu(i,s,o);f&&(c=f,await D("characters",{...r,gender:f,schema_version:Math.max(2,Number(r.schema_version||1)),updated_at:Date.now()/1e3}))}const l={id:r.id,name:r.name,aliases:Array.isArray(a)?a:V(a),surname:r.surname||"",given_name:r.given_name||"",surname_variants:V(r.surname_variants),given_name_variants:V(r.given_name_variants),priority:Number(r.priority||0),attire_locked:oe(r.attire_locked),accessories_locked:oe(r.accessories_locked),schema_version:Number(r.schema_version||1),original:r.original||"",appearance:i,attire:s,accessories:o,gender:c,updated_at:r.updated_at,scope:r.scope};l.tags=Pn(l),n.push(l)}return n}async function qd(e){const t=u(e,200);return t?(await ve("meta")).filter(n=>n.key?.startsWith(`toggle:${t}:`)&&n.enabled===0).map(n=>u(n.global_key||n.key.split(":").slice(2).join(":"),200)).filter(Boolean):[]}async function Wd(e,t){const n=u(e,200);if(!n)return{ok:!1,error:{code:"bad_request",message:"character_id required"}};const r=[],a=new Set;for(const o of t||[]){const c=u(o,200);!c||a.has(c)||(a.add(c),r.push(c))}const i=await ve("meta");for(const o of i)o.key?.startsWith(`toggle:${n}:`)&&await Nt("meta",o.key);const s=Date.now()/1e3;for(const o of r)await D("meta",{key:`toggle:${n}:${o}`,character_id:n,global_key:o,enabled:0,updated_at:s});return{ok:!0,character_id:n,disabled_globals:r}}function oc(e){const t=[];for(const n of[e.id,e.name]){const r=u(n,200);if(!r)continue;t.push(r);const a=r.toLowerCase();a!==r&&t.push(a)}return[...new Set(t)]}function Da(e,t){if(!t?.size)return!1;for(const n of oc(e))if(t.has(n))return!0;return!1}async function za(e){const t=await qd(e);return new Set(t)}async function Vd(e){const t=await za(e),n={};for(const r of await ie(Xe)){const a=!Da(r,t);for(const i of oc(r))n[i]=a;n[u(r.name,200)]=a}return n}async function Yd(e=[]){const t=[],n=new Set;for(const r of e||[]){const a=u(r,200);!a||a==="__global__"||n.has(a)||(n.add(a),t.push(...await ie(a)))}return Fa(wa(t))}async function Ua(e,t="",n="",r=[]){const a=!!j()?.card?.unified_chat_priority,i=(Array.isArray(r)?r:[]).map(f=>u(f,200)).filter(Boolean);let s;a&&i.length?s=await Yd(i):s=await ie(u(e||"",200));const o=u(n||"",200),c=o?await za(o):new Set,l=(await ie(Xe)).filter(f=>!Da(f,c));return Fa(af(s,l,{hasAppearance:Me,resolve:we,aliasKeys:Tn,normalizeName:U,fullTags:Pn,clean:u,globalScope:Xe}))}async function ct(e,t){const n=Fe(t,"appearance"),r=Fe(t,"attire"),a=Fe(t,"accessories"),i=Fe(t,"original"),s=Fe(t,"surname"),o=Fe(t,"given_name"),c=Fe(t,"surname_variants"),l=Fe(t,"given_name_variants");let f=Wt(t);if(!f)return null;const d=u(e,200)||"__global__",m=await ie(d),p=u(f.id,80),g=f,h=m.find(y=>p&&u(y.id,80)===p?!1:!!(we(g.name,[y])||(g.aliases||[]).some(k=>we(k,[y]))));if(h){const y=V([...h.aliases||[],...f.aliases||[],f.name,h.name]),k=u(f.appearance||"",4e3),x=u(f.attire||"",4e3),S=u(f.accessories||"",4e3),E=u(f.original||"",400),M=u(f.surname||"",200),C=u(f.given_name||"",200);if(f=Wt({...h,...f,id:h.id,name:h.name||f.name,aliases:y,original:i?E:E||h.original||"",appearance:n?k:k||h.appearance||"",attire:r?x:x||h.attire||"",accessories:a?S:S||h.accessories||"",surname:s?M:M||h.surname||"",given_name:o?C:C||h.given_name||"",surname_variants:V(c?[...f.surname_variants||[],M]:[...h.surname_variants||[],...f.surname_variants||[],M,h.surname]),given_name_variants:V(l?[...f.given_name_variants||[],C]:[...h.given_name_variants||[],...f.given_name_variants||[],C,h.given_name]),attire_locked:Fe(t,"attire_locked")?oe(f.attire_locked):oe(h.attire_locked),accessories_locked:Fe(t,"accessories_locked")?oe(f.accessories_locked):oe(h.accessories_locked),priority:Math.max(Number(h.priority||0),Number(f.priority||0))}),!f)return null}const _=Date.now()/1e3;if(await D("characters",{scope:d,id:f.id,name:f.name,aliases:f.aliases,surname:f.surname||"",given_name:f.given_name||"",surname_variants:f.surname_variants||[],given_name_variants:f.given_name_variants||[],priority:Number(f.priority||0),attire_locked:oe(f.attire_locked),accessories_locked:oe(f.accessories_locked),schema_version:2,appearance:f.appearance,attire:f.attire,accessories:f.accessories||"",original:f.original||"",gender:qt(f.gender??f.sex),updated_at:_}),d!=="__global__"){const y=`appearance:${d}`,k=(await F("meta",y))?.value||{},x=Pn(f);x?k[f.name]=x:delete k[f.name],await D("meta",{key:y,value:k,updated_at:_})}else(r||a)&&await Xd(f,{clearAttire:r,clearAccessories:a});return f}async function Xd(e,{clearAttire:t=!0,clearAccessories:n=!0}={}){if(!e||!t&&!n)return 0;const r=i=>!i||i.scope==="__global__"||Me(i)?!1:!!Xs(i,e);let a=0;try{const i=await ve("characters");for(const s of i||[]){if(!r(s))continue;const o=t?"":s.attire||"",c=n?"":s.accessories||"";(s.attire||"")===o&&(s.accessories||"")===c||(await D("characters",{...s,attire:o,accessories:c,updated_at:Date.now()/1e3}),a+=1)}}catch{}return a}async function Ir(e,t){const n=u(e,200)||"__global__",r=u(t,80);if(!r)return!1;const a=await F("characters",{scope:n,id:r});if(await Nt("characters",{scope:n,id:r}),n!=="__global__"&&a?.name){const i=`appearance:${n}`,s={...(await F("meta",i))?.value||{}};delete s[a.name],await D("meta",{key:i,value:s,updated_at:Date.now()/1e3})}return!0}var Zd=(e,t)=>!!Xs(e,t);function cc(e){return(Array.isArray(e)?e:[]).filter(t=>{if(!t||typeof t!="object")return!1;const n=t;return!!(n.id||n.name)})}async function Qd(e,t,n=""){const r=cc(t);if(!r.length)return{deleted:0,sessions:0};const a=u(n,200),i=new Set;let s=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||i.has(l))continue;i.add(l);const f=await ie(l);let d=!1;for(const m of f)r.some(p=>Zd(m,p))&&(await Ir(l,m.id),s+=1,d=!0);d&&(o+=1)}return{deleted:s,sessions:o}}async function lc(e,t,n=""){const r=cc(t);if(!r.length)return{updated:0,sessions:0};const a=u(n,200),i=new Set;let s=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||i.has(l))continue;i.add(l);const f=await ie(l);let d=!1;for(const m of r){const p=we(m.name,f)||(Array.isArray(m.aliases)?m.aliases.map(g=>we(g,f)).find(Boolean):null)||(u(m.id,80)?f.find(g=>u(g.id,80)===u(m.id,80)):null);p&&await ct(l,{...m,id:p.id,name:p.name||m.name,appearance:m.appearance!=null?m.appearance:"",attire:m.attire!=null?m.attire:"",accessories:m.accessories!=null?m.accessories:"",original:m.original!=null?m.original:""})&&(s+=1,d=!0)}d&&(o+=1)}return{updated:s,sessions:o}}async function Un(e,t,n={}){const r=u(e,200)||"__global__",a=n.prune===!0,i=Array.isArray(n.rootSessionIds)?n.rootSessionIds:[],s=wa(t||[]);if(i.length){if(a){const c=new Set;for(const l of s){for(const d of Tn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of i){const f=u(l,200);if(!(!f||f==="__global__"))for(const d of await ie(f)){const m=[...Tn(d)],p=U(d.name);p&&m.push(p),!m.some(g=>c.has(g))&&await Ir(f,d.id)}}}return s.length&&await lc(i,s,""),Fa(s.map(c=>Wt(c)).filter(c=>!!c))}const o=[];for(const c of s){const l=await ct(r,c);l&&o.push(l)}if(a){const c=new Set(o.map(l=>u(l.id,80)).filter(Boolean));for(const l of await ie(r)){const f=u(l.id,80);f&&!c.has(f)&&await Ir(r,f)}}return o}async function Hn(e,t=""){const n=u(e,200),r=u(t,200),a=n?await ie(n):[],i=r?await za(r):new Set,s=[];for(const o of await ie(Xe)){const c={...o};c.enabled_for_character=r?!Da(o,i):!0,s.push(c)}return{ok:!0,session_id:n,character_id:r,characters:a,global:s,appearance:Object.fromEntries(a.map(o=>[o.name,Pn(o)])),disabled_globals:[...i].sort(),global_enabled:r?await Vd(r):{}}}async function uc(e,t,n=!0){const r=u(e,200);if(!r)return{ok:!1,error:{code:"bad_request",message:"target_session_id required"}};const a=[],i=new Set;for(const l of t||[]){const f=u(l,200);!f||i.has(f)||(i.add(f),a.push(...await ie(f)))}n&&!i.has(r)&&a.push(...await ie(r));const s=wa(a),o=[];for(const l of s){const f=we(l.name,await ie(r)),d=await ct(r,{...l,id:f?.id||l.id,priority:Math.max(Number(f?.priority||0),Number(l.priority||0))});d&&o.push(d)}const c=new Set;for(const l of o){for(const d of Tn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of await ie(r)){const f=[...Tn(l)],d=U(l.name);d&&f.push(d),!f.some(m=>c.has(m))&&await Ir(r,l.id)}return{...await Hn(r),ok:!0,merged:o.length,sources:[...i]}}async function em(e){return Object.fromEntries((await ie(e)).map(t=>[t.name,Pn(t)]))}async function tm(e,t){return await Un(e,Object.entries(t||{}).map(([n,r])=>({name:n,tags:r}))),{ok:!0,appearance:await em(e)}}async function nm(e){const{sessionId:t,tagged:n,shotChars:r}=e,a=e.unifiedSessionId??"",i=e.sourceSessionIds??[],s=u(e.characterId||"",200),o=u(t||"",200),c=()=>Ua(t,a,s,i);let l=await c();const f=[...n.new_characters||[]],d=new Set(f.map(p=>U(p?.name))),m=(p,g=null)=>({surname:u(p?.surname||g?.surname||"",200),given_name:u(p?.given_name||g?.given_name||"",200),surname_variants:V([...Nr(g?.surname_variants),...Nr(p?.surname_variants),p?.surname,g?.surname]),given_name_variants:V([...Nr(g?.given_name_variants),...Nr(p?.given_name_variants),p?.given_name,g?.given_name])});for(const p of r||[]){const g=u(p.name,200);if(!g||d.has(U(g)))continue;const h=we(g,l);h&&Me(h)||(f.push({name:h?.name||g,aliases:V(p.aliases)||h?.aliases||[g],original:u(p.original||p.original_tag||h?.original||"",400),appearance:I(p.label,p.age,p.appearance,p.body),attire:u(p.attire||""),accessories:u(p.accessories||""),...m(p,h)}),d.add(U(g)))}typeof n=="object"&&(n.new_characters=f);for(const p of f){const g=Wt(p);if(!g)continue;const h=Ud();h.size&&(g.appearance=Pa(g.appearance,h),g.attire=Pa(g.attire,h),g.accessories=Pa(g.accessories,h));const _=we(g.name,l),y=u(g.appearance||""),k=u(g.attire||""),x=u(g.accessories||""),S=m(g,_);if(_&&Me(_)){l=await c();continue}if(_&&!Me(_)){const E=_.scope==="__global__"?Xe:_.scope||o,M=V([..._.aliases||[],...g.aliases||[]]),C=y||_.appearance||"",R=_.original||g.original||"";await ct(E,{id:_.id||g.id,name:_.name||g.name,aliases:M.length?M:_.aliases||g.aliases,original:R,appearance:C,attire:k,accessories:x,attire_locked:oe(_.attire_locked),accessories_locked:oe(_.accessories_locked),...S}),l=await c();continue}_||await ct(o,{...g,attire_locked:oe(g.attire_locked),accessories_locked:oe(g.accessories_locked)}),l=await c()}for(const p of r||[]){const g=u(p.name,200);if(g){if(we(g,l)){l=await c();continue}{const h=I(p.label,p.age,p.appearance||"",p.body||""),_=u(p.attire||""),y=u(p.accessories||"");await ct(o,{name:g,aliases:V(p.aliases)||[g],original:u(p.original||p.original_tag||"",400),appearance:h,attire:_,accessories:y,attire_locked:!0,accessories_locked:!0,...m(p,null)})}l=await c()}}return c()}async function rm(){if((await ve("characters")).length)return;const e=(await ve("meta")).filter(t=>t.key?.startsWith("appearance:"));if(e.length)for(const t of e){const n=t.key.slice(11),r=t.value||{};for(const[a,i]of Object.entries(r)){const s=Wt({name:a,tags:i},a);s&&await ct(n,s)}}}async function am(){const e=await ve("characters");for(const t of e){if(Number(t.schema_version||0)>=2)continue;const n=Wt(t);n&&await D("characters",{...t,...n,scope:t.scope,updated_at:t.updated_at||Date.now()/1e3})}}function im(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function Ha(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"||e==="full"?"two_stage":e===!1||e==="false"||e===0||e==="0"||e==="none"?"off":typeof e=="string"&&dc.has(e)?e:"off"}function Ja(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function Ka(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e===!0||e==="true"||e==="on"?"short":e==="detailed"||e==="detail"?"detailed":e==="supplement"||e==="supp"?"supplement":typeof e=="string"&&fc.has(e)?e:"short"}function Ga(e){if(Array.isArray(e))return e.map(Ga);if(!e||typeof e!="object")return e;const t={};for(const[n,r]of Object.entries(e))pc.has(n.toLowerCase())||(t[n]=Ga(r));return t}function qa(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Settings must be an object");const t=mc(e),n=t.card&&typeof t.card=="object"&&!Array.isArray(t.card)?t.card:{};if(t.card=n,Number(n.scale_semantics_version||0)<2){const c=Number(n.inline_thumb_pct);n.inline_thumb_pct=Number.isFinite(c)?Math.max(1,c/6):100,n.scale_semantics_version=2}if(Number.isFinite(Number(n.overlay_x_pct))||Number.isFinite(Number(n.overlay_y_pct))||n.overlay_pin_unit==="pct"){n.overlay_pin_unit="pct";const c=String(n.overlay_pin_origin||"");(!c||c==="bottom-left")&&(n.overlay_pin_origin="bl")}const r=n.lore_extra;r===!0||r==="true"||r==="sections"?n.lore_extra="tags":r===!1||r==="false"||r==="none"?n.lore_extra="off":r==="full"||r==="tags"||r==="off"?n.lore_extra=r:n.lore_extra="tags",n.asset_nai_tags=n.asset_nai_tags===!0||n.asset_nai_tags==="true"||n.asset_nai_tags===1||n.asset_nai_tags==="1",n.auto_aspect=n.auto_aspect===!0||n.auto_aspect==="true"||n.auto_aspect===1||n.auto_aspect==="1",n.natural_base=Ka(n.natural_base),n.person_tag_solo=n.person_tag_solo===!0||n.person_tag_solo==="true"||n.person_tag_solo===1||n.person_tag_solo==="1"||n.person_tag_solo==="on",n.person_tag_weight=im(n.person_tag_weight);const a=t.curation&&typeof t.curation=="object"&&!Array.isArray(t.curation)?{...t.curation}:{},i=n.composition_curation===!0||n.composition_curation==="true"||n.composition_curation===1||n.composition_curation==="1"||n.composition_curation==="on";a.mode==null&&i&&(a.mode="two_stage"),a.mode=Ha(a.mode),a.strict_ids=Ja(a.strict_ids);const s=a.embedding&&typeof a.embedding=="object"&&!Array.isArray(a.embedding)?{...a.embedding}:{};s.provider||(s.provider="openai"),s.model||(s.model="text-embedding-3-small"),s.endpoint||(s.endpoint="https://api.openai.com/v1/embeddings"),s.api_key==null&&(s.api_key=""),a.embedding=s,t.curation=a,n.composition_curation=!1;const o=n.overlay_markers!==!1;n.overlay_markers=o,n.inline_previews=o,n.inline_chat_images==null?n.inline_chat_images=!1:n.inline_chat_images=n.inline_chat_images===!0||n.inline_chat_images==="true"||n.inline_chat_images===1||n.inline_chat_images==="1",n.progress_toast==null?n.progress_toast=!1:n.progress_toast=n.progress_toast===!0||n.progress_toast==="true"||n.progress_toast===1||n.progress_toast==="1";{const c=String(n.viewer_minimize_mode||"icon");n.viewer_minimize_mode=c==="toolbar"||c==="actions"?c:"icon"}return t.settings_schema_version=2,t}function sm(e){return JSON.stringify(Ga(qa(e)),null,2)}function om(e){if(typeof e!="string")throw new TypeError("Settings JSON must be text");if(e.length>2e6)throw new RangeError("Settings JSON is too large");const t=JSON.parse(e);if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Settings JSON must contain an object");return qa(t)}var fc,dc,mc,pc,Jn=$((()=>{fc=new Set(["off","short","detailed","supplement"]),dc=new Set(["off","two_stage","embed_snap"]),mc=e=>JSON.parse(JSON.stringify(e??{})),pc=new Set(["api_key","auth_token","password","secret"])}));Jn();function gc(e){if(e==null||e==="")return null;const t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:null}function cm(e,t){let n=Number(e.cfg_scale??7),r=Number(e.cfg_rescale??.36);if(Number.isFinite(n)||(n=7),Number.isFinite(r)||(r=.36),t){const a=gc(t.cfg_scale);a!=null&&(n=a);const i=gc(t.cfg_rescale);i!=null&&(r=i)}return{cfg_scale:n,cfg_rescale:r}}function hc(e){if(!e||e.length<22)return!1;const t=Math.max(0,e.length-65536);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=e[n+20]|e[n+21]<<8;if(n+22+r<=e.length)return!0}return!1}function lt(e,t){return e[t]|e[t+1]<<8}function nn(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Wa(e){const t=Math.max(0,e.length-65536-22);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=lt(e,n+20);if(n+22+r<=e.length)return n}return-1}function lm(e){const t=Wa(e);if(t<0)return null;const n=nn(e,t+16);if(n+46>e.length||e[n]!==80||e[n+1]!==75||e[n+2]!==1||e[n+3]!==2)return null;const r=lt(e,n+10),a=nn(e,n+20),i=nn(e,n+24),s=nn(e,n+42);if(s+30>e.length||e[s]!==80||e[s+1]!==75||e[s+2]!==3||e[s+3]!==4)return null;const o=lt(e,s+26),c=lt(e,s+28),l=s+30+o+c;return l+a>e.length?null:{source:"central_dir",compMethod:r,compSize:a,uncompSize:i,dataStart:l,compData:e.subarray(l,l+a)}}function um(e){const t=lt(e,6),n=lt(e,8);let r=nn(e,18);const a=lt(e,26),i=lt(e,28),s=30+a+i;if((t&8)!==0||r===0){let o=-1;for(let c=s+4;c<e.length-3;c+=1){if(e[c]!==80||e[c+1]!==75)continue;const l=e[c+2];if(l===7||l===1||l===5){o=c;break}}if(o<0){const c=Wa(e);c>s&&(o=c)}if(o<0)throw new Error("ZIP 데이터 경계를 찾지 못했습니다 (local header bit3)");r=o-s}if(s+r>e.length)throw new Error(`ZIP 엔트리 길이 초과 (need ${s+r}, have ${e.length})`);return{source:"local_header",compMethod:n,compSize:r,uncompSize:nn(e,22),dataStart:s,compData:e.subarray(s,s+r)}}async function fm(e){if(typeof DecompressionStream!="function")throw new Error("DecompressionStream 미지원 — ZIP deflate를 풀 수 없습니다");const t=Y(e);w("nai.inflate.start",{message:`${t.length}B`,bytes:t.length,focus:!0});const n=new DecompressionStream("deflate-raw"),r=n.writable.getWriter(),a=n.readable.getReader(),i=[];let s=0;const o=Date.now()+2e4,c=(async()=>{for(;;){if(Date.now()>=o)throw new Error(`ZIP inflate 타임아웃 (out=${s}B)`);const{done:d,value:m}=await a.read();if(d)break;m&&(i.push(m),s+=m.length,s>0&&s%524288<m.length&&w("nai.inflate",{message:`out ${Math.round(s/1024)}KB`,bytes:s,focus:!0}))}})(),l=131072;for(let d=0;d<t.length;d+=l){if(Date.now()>=o){try{await r.abort()}catch{}throw new Error(`ZIP inflate write 타임아웃 (in=${d}B)`)}await r.write(t.subarray(d,Math.min(t.length,d+l))),d>0&&d%(l*4)===0&&await Ze(0)}await r.close(),await c;const f=Mn(i,s);return w("nai.inflate.done",{bytes:s,focus:!0}),f}async function dm(e){const t=Y(e);if(w("nai.unzip.start",{message:`${t.length}B`,bytes:t.length,focus:!0}),wt(t))return w("nai.unzip",{message:"raw PNG",bytes:t.length,focus:!0}),X(t);if(t.length<30||t[0]!==80||t[1]!==75){const a=Array.from(t.subarray(0,16)).map(i=>i.toString(16).padStart(2,"0")).join(" ");throw new Error(`ZIP/PNG 응답이 아닙니다 (len=${t.length}, head=${a})`)}const n=lm(t)??um(t);w("nai.unzip.entry",{message:`${n.source} method=${n.compMethod} comp=${n.compSize}B uncomp=${n.uncompSize||"?"}`,comp_method:n.compMethod,bytes:n.compSize,source:n.source,focus:!0});const r=Wa(t);if(r>=0&&n.dataStart+n.compSize>r&&(w("nai.unzip.clamp",{message:`comp ${n.compSize} → ${r-n.dataStart}`,focus:!0},"warn"),n.compSize=r-n.dataStart,n.compData=t.subarray(n.dataStart,r)),n.compSize<=0)throw new Error("ZIP 압축 페이로드가 비어 있습니다");if(n.compMethod===0)return X(n.compData);if(n.compMethod===8){const a=await fm(n.compData);return!wt(a)&&!(a[0]===82&&a[1]===73)&&w("nai.unzip",{message:"inflated but not PNG/RIFF magic",bytes:a.length},"warn"),X(a)}throw new Error(`지원하지 않는 ZIP 압축 방식: ${n.compMethod}`)}var _c=$((()=>{q(),Z(),bt()}));function mm(e="force"){return ke?(ke.forceFinish(e),!0):!1}async function De(e,t={}){const n=Ae()?.nativeFetch,r=n||globalThis.fetch,a=n?"nativeFetch":"fetch";if(typeof r!="function")throw new Error("fetch를 사용할 수 없습니다");const i={...t};i.networkRoute==null&&delete i.networkRoute;const s=fe("net.fetch");w("net.fetch.start",{message:a,url:String(e).slice(0,120),has_signal:!!i.signal});try{const o=await r(e,i),c=Number(o?.status||(o?.ok===!1?0:200));return s.end({message:a,status:c,url:String(e).slice(0,80)}),o}catch(o){throw s.fail(o,{message:a,url:String(e).slice(0,80)}),o}}async function rn(e,t={}){if(!e)throw new Error("빈 응답");const n=Number(t.deadline||Date.now()+Number(t.timeoutMs||9e4)),r=t.signal||null,a=typeof t.onProgress=="function"?t.onProgress:null,i=Number(t.idleMs||2500),s=(d=0)=>{if(r?.aborted)throw new Error(`NAI 본문 읽기 중단 (abort, ${d}B)`);if(Date.now()>=n)throw new Error(`NAI 본문 읽기 타임아웃 (${d}B received)`)};if(e instanceof ArrayBuffer)return e;if(e instanceof Uint8Array)return X(e);if(typeof e=="string"){const d=e.replace(/\s+/g,"");if(d.length>64&&/^[A-Za-z0-9+/=]+$/.test(d))return w("nai.read_bytes",{message:"string base64 body",bytes:d.length,focus:!0}),X($e(d))}const o=e;if(o.buffer instanceof ArrayBuffer&&typeof o.byteLength=="number")return o.buffer.slice(o.byteOffset||0,(o.byteOffset||0)+o.byteLength);const c=e;if(e&&typeof e=="object"&&"data"in e&&!c.arrayBuffer&&!c.body)return rn(c.data,t);let l=null;try{const d=c.headers,m=d?.get?.("content-length")||d?.get?.("Content-Length")||null;m&&(l=Number(m))}catch{}if(l!=null&&l>0&&(Er=l),w("nai.read_bytes.start",{message:"begin body",content_length:l,has_arrayBuffer:typeof c.arrayBuffer=="function",has_body_reader:!!(c.body&&typeof c.body.getReader=="function"),keys:e&&typeof e=="object"?Object.keys(e).slice(0,12).join(","):typeof e,focus:!0}),c.body&&typeof c.body.getReader=="function"){const d=c.body.getReader(),m=[];let p=0,g=Date.now(),h=Date.now(),_=!1,y=null;ke={forceFinish:(x="force")=>{_=!0,w("nai.read_bytes.force",{message:x,bytes:p||l||0,focus:!0});try{d.cancel()}catch{}y&&y({done:!0,value:void 0,__forced:!0})}};try{for(;s(p),!_;){if(p>=64&&Date.now()-g>=i){w("nai.read_bytes.idle_complete",{message:`${i}ms idle`,bytes:p,focus:!0});break}if(l!=null&&l>0&&p>=l){w("nai.read_bytes.length_complete",{bytes:p,content_length:l,focus:!0});break}const x=await new Promise((C,R)=>{let H=!1;const N=(O,J)=>{H||(H=!0,clearInterval(v),y=null,J?R(J):C(O))};y=O=>N(O,null);const v=setInterval(()=>{if(!H){if(_)return N({done:!0,value:void 0,__forced:!0},null);if(p>=64&&Date.now()-g>=i)return N({done:!0,value:void 0,__idle:!0},null);if(l!=null&&l>0&&p>=l)return N({done:!0,value:void 0,__length:!0},null);if(r?.aborted||Date.now()>=n)return d.cancel().catch(()=>{}),N(null,new Error(`NAI 본문 읽기 타임아웃 (${p}B received)`))}},200);d.read().then(O=>N(O,null),O=>N(null,O))});if(x?.__forced||x?.__idle||x?.__length)break;const{done:S,value:E}=x;if(S)break;if(!E)continue;const M=E instanceof Uint8Array?E:new Uint8Array(E);if(m.push(M),p+=M.length,g=Date.now(),Cr=g,xe=p,a&&a(p,l),Date.now()-h>=2e3&&(h=Date.now(),w("nai.read_bytes.progress",{message:`${Math.round(p/1024)}KB`,bytes:p,content_length:l,focus:!0})),hc(Mn(m,p))&&Date.now()-g>=600){w("nai.read_bytes.zip_eocd",{bytes:p,focus:!0});break}if(l!=null&&l>0&&p>=l)break}}catch(x){if(p>=64){const S=Mn(m,p);if(hc(S)||l!=null&&l>0&&p>=l*.98)return w("nai.read_bytes.recover",{message:String(x?.message||x),bytes:p,focus:!0},"warn"),ke=null,X(S)}try{await d.cancel()}catch{}throw ke=null,x}if(ke=null,!p)throw new Error("NAI 본문이 비어 있습니다");const k=Mn(m,p);return w("nai.read_bytes.done",{bytes:p,focus:!0}),X(k)}const f=c.arrayBuffer;if(typeof f=="function"){w("nai.read_bytes",{message:"fallback arrayBuffer() — no body stream",focus:!0});let d=!1,m,p;const g=new Promise((y,k)=>{m=y,p=k});ke={forceFinish:(y="force")=>{w("nai.read_bytes.force",{message:`${y} (arrayBuffer)`,content_length:l,focus:!0},"warn"),d||(d=!0,clearInterval(h),p(new Error(`NAI arrayBuffer 강제중단 (${y}, content-length=${l})`)))}};const h=setInterval(()=>{d||(r?.aborted||Date.now()>=n?(d=!0,clearInterval(h),ke=null,p(new Error(`NAI arrayBuffer 타임아웃 (content-length=${l}). 본문 ~${l?Math.round(l/1024):"?"}KB를 플러그인이 받지 못했습니다.`))):w("nai.read_bytes.wait",{message:`arrayBuffer pending · expect ${l?Math.round(l/1024):"?"}KB`,content_length:l,focus:!0},"warn"))},3e3);f.call(c).then(y=>{d||(d=!0,clearInterval(h),ke=null,m(y))}).catch(y=>{d||(d=!0,clearInterval(h),ke=null,p(y))});const _=await g;if(_&&_.byteLength)return xe=_.byteLength,w("nai.read_bytes.done",{bytes:_.byteLength,focus:!0}),_}if(typeof c.bytes=="function"){const d=await c.bytes();if(d?.length)return X(d)}if(typeof c.text=="function"){const d=await c.text();if(/^[A-Za-z0-9+/=\s]+$/.test(d)&&d.replace(/\s+/g,"").length>64)try{return X($e(d.replace(/\s+/g,"")))}catch{}throw new Error(`바이너리 본문을 읽지 못함 (text head=${String(d).slice(0,120)})`)}throw new Error("바이너리 본문을 읽지 못함")}async function pm(e,t,n,r={}){const a={Authorization:`Bearer ${e}`,"Content-Type":"application/json"},i=Number(r.timeoutMs||75e3),s=r.signal||null,o=JSON.stringify(t);if(w("nai.payload",{message:`body ${Math.round(o.length/1024)}KB`,bytes:o.length,model:t?.model,timeout_ms:i,url:String(n||"https://image.novelai.net/ai/generate-image").slice(0,100),has_nativeFetch:_e("nativeFetch")}),o.length>15e5)throw w("nai.payload",{message:"too large",bytes:o.length},"error"),new Error(`NAI 페이로드가 너무 큼 (${Math.round(o.length/1024)}KB). 참조 이미지/프롬프트를 줄이세요.`);const c=typeof AbortController<"u"?new AbortController:null,l=()=>{w("nai.abort",{message:"external signal"},"warn"),c?.abort()};if(s){if(s.aborted)throw new Error("NAI 요청이 취소되었습니다.");s.addEventListener("abort",l,{once:!0})}const f=Date.now();xe=0,Er=0,Cr=0,Va=!0;const d=setInterval(()=>{const p=Date.now()-f;p>=i?(w("nai.watchdog",{message:`abort after ${p}ms · body=${xe}B`,ms:p,bytes:xe},"warn"),c?.abort()):p>0&&p%1e4<1100&&w("nai.wait",{message:`waiting ${Math.round(p/1e3)}s · body=${xe}B · ${_t()}`,ms:p,bytes:xe,focus:!0},"warn")},1e3);let m=null;try{try{w("nai.fetch.start",{message:"POST generate-image",timeout_ms:i,focus:!0});const p=await De(n||"https://image.novelai.net/ai/generate-image",{method:"POST",headers:a,body:o,signal:c?.signal,requestTimeoutMs:i});if(w("nai.fetch.returned",{message:"nativeFetch resolved",ms:Date.now()-f,status:Number(p?.status||0),focus:!0}),s?.aborted||c?.signal?.aborted)throw w("nai.fetch.aborted",{ms:Date.now()-f},"error"),new Error(`NAI 타임아웃 (${Math.round(i/1e3)}s) — nativeFetch가 응답하지 않습니다. Models에서 NAI Test를 확인하세요.`);const g={signal:c?.signal,deadline:f+i,onProgress:k=>{xe=k}};if(p&&typeof p=="object"&&"ok"in p&&"data"in p&&!p.arrayBuffer){const k=Number(p.status||(p.ok?200:0));if(w("nai.resp.shape",{message:"ok/data shape",status:k,focus:!0}),k===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(k===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(k>=400){const E=typeof p.data=="string"?p.data:p.data instanceof Uint8Array?new TextDecoder().decode(p.data.subarray(0,220)):JSON.stringify(p.data||{}).slice(0,220);throw new Error(`NAI HTTP ${k}: ${E}`)}const x=fe("nai.read_bytes"),S=await rn(p.data,g);if(x.end({bytes:S?.byteLength||0,focus:!0}),!S||S.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${S?.byteLength||0} bytes)`);return S}const h=Number(p?.status||0);if(w("nai.resp.shape",{message:"Response-like",status:h,has_arrayBuffer:typeof p?.arrayBuffer=="function",has_body:!!p?.body,focus:!0}),h===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(h===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(h>=400){let k="";try{k=await p.text()}catch{}throw new Error(`NAI HTTP ${h}: ${k.slice(0,220)}`)}const _=fe("nai.read_bytes"),y=await rn(p,g);if(_.end({bytes:y?.byteLength||0,status:h,focus:!0}),!y||y.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${y?.byteLength||0} bytes)`);return y}catch(p){throw m=String(p?.message||p),w("nai.fetch.error",{message:m,ms:Date.now()-f,bytes:xe},"error"),/abort|timeout|타임아웃|취소|본문 읽기/i.test(m)?new Error(`NAI 타임아웃/본문실패 (${Math.round(i/1e3)}s, body=${xe}B). ${m.slice(0,180)}`):p instanceof Error?p:new Error(m)}}finally{Va=!1,clearInterval(d),s&&s.removeEventListener("abort",l)}}var xe,Er,Cr,ke,Va,Ya,yc,bc,wc,Pt=$((()=>{te(),q(),ht(),Z(),_c(),xe=0,Er=0,Cr=0,ke=null,Va=!1,Ya=()=>xe,yc=()=>Er,bc=()=>Cr,wc=()=>ke!==null}));function Kn(e){return u(e?.backend||"nai").toLowerCase()==="comfy"?"comfy":"nai"}function gm(e){const t=Number(e?.backend_timeout_seconds??300);return Math.max(30,Math.min(1800,Number.isNaN(t)?300:t))*1e3}function jr(e){return String(e||"").trim().replace(/\/+$/,"")}function vc(e){return jr(u(e?.comfy_url))||"http://localhost:8188"}function Xa(e){return!!u(e?.comfy_workflow_json)}async function Za(e,t={}){const n=await De(e,t);if(n&&typeof n=="object"&&"ok"in n&&"data"in n&&typeof n.arrayBuffer!="function"){const i=Number(n.status||(n.ok?200:0));let s=n.data;if(s instanceof Uint8Array&&(s=new TextDecoder().decode(s)),typeof s=="string")try{s=JSON.parse(s)}catch{}return{status:i,data:s}}const r=Number(n?.status||0);let a=null;try{a=await n.json()}catch{try{a=JSON.parse(await n.text())}catch{}}return{status:r,data:a}}async function hm(e,t,n={}){const r=`inlay-nexus-${Math.random().toString(36).slice(2,10)}`,{status:a,data:i}=await Za(`${jr(e)}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:r,prompt:t}),signal:n.signal});if(a>=400||!i?.prompt_id){const s=i?JSON.stringify(i.node_errors||i.error||i).slice(0,300):"";throw new Error(`/prompt 제출 실패 (HTTP ${a}) ${s}`)}return String(i.prompt_id)}async function _m(e,t,n={}){const r=jr(e),a=Number(n.timeoutMs||3e5),i=Date.now()+a;let s=0,o="";for(;Date.now()<i;){if(n.signal?.aborted)throw new Error("이미지 대기 중단 (abort)");await Ze(2500),s+=1;let c=null;try{const{status:d,data:m}=await Za(`${r}/history/${t}`,{method:"GET",signal:n.signal});d<400&&m&&m[t]&&(c=m[t])}catch(d){o=String(d?.message||d);continue}if(s%8===0&&w("comfy.poll",{message:`${s}회 · ${Math.round((Date.now()-(i-a))/1e3)}s`,focus:!0}),!c)continue;const l=c.status||{};if(l.status_str==="error")throw new Error(`생성 실패: ${JSON.stringify(l.messages||[]).slice(0,400)}`);const f=c.outputs||{};for(const d of Object.keys(f)){const m=f[d]?.images;if(Array.isArray(m)&&m.length)return m.find(p=>(p?.type||"output")!=="temp")||m[0]}if(l.completed)throw new Error("생성은 완료됐지만 출력 이미지가 없습니다 (SaveImage 노드 확인)")}throw new Error(`이미지 대기 타임아웃 (${Math.round(a/1e3)}s)${o?` · ${o}`:""}`)}async function ym(e,t,n={}){const r=new URLSearchParams({filename:u(t?.filename,300),subfolder:u(t?.subfolder,300),type:u(t?.type,40)||"output"}),a=await De(`${jr(e)}/view?${r.toString()}`,{method:"GET",signal:n.signal}),i={signal:n.signal,deadline:Date.now()+6e4};if(a&&typeof a=="object"&&"ok"in a&&"data"in a&&!a.arrayBuffer){const o=Number(a.status||(a.ok?200:0));if(o>=400)throw new Error(`/view 실패 (HTTP ${o})`);return rn(a.data,i)}const s=Number(a?.status||0);if(s>=400)throw new Error(`/view 실패 (HTTP ${s})`);return rn(a,i)}function bm(e,t){let n=String(e||"");for(let r=0;r<8;r+=1){const a=n.replace(/\[\[#(\w+)\]\]([\s\S]*?)\[\[\/\1\]\]/g,(i,s,o)=>{const c=t[s];return c!=null&&String(c).trim()!==""?o:""});if(a===n)break;n=a}return n.replace(/[ \t]+\n/g,`
`).replace(/\n{3,}/g,`

`)}function wm(e,t){for(const n of Object.values(e)){const r=n?.inputs;if(!(!r||typeof r!="object"))for(const a of Object.keys(r)){const i=r[a];if(typeof i!="string"||!i.includes("[["))continue;const s=bm(i,t),o=s.match(/^\[\[\s*(\w+)\s*\]\]$/);if(o&&o[1]in t){r[a]=t[o[1]];continue}r[a]=s.replace(/\[\[\s*(\w+)\s*\]\]/g,(c,l)=>l in t?String(t[l]):c)}}}function vm(e,t){const n=Number(t)||1;for(const r of Object.values(e)){const a=r?.inputs;if(!(!a||typeof a!="object"))for(const i of Object.keys(a)){if(!/^(seed|noise_seed)$/i.test(i))continue;const s=a[i];(typeof s=="number"&&Number.isFinite(s)||typeof s=="string"&&/^\d+$/.test(s.trim()))&&(a[i]=n)}}}function xc({main:e,neg:t,captions:n,nai:r,seed:a}){const i={pos:String(e||""),neg:String(t||""),width:Number(r.width??832)||832,height:Number(r.height??1216)||1216,seed:Number(a)||1,steps:Number(r.steps??28)||28,cfg:Number(r.cfg_scale??7)||7};for(let s=0;s<6;s+=1)i[`char${s+1}`]=u(n?.[s]?.prompt,2e3);return i}function xm(e){let t=String(e||"");return t=t.replace(/(:\s*)\[\[\s*(\w+)\s*\]\](\s*[,}\]])/g,'$1"[[$2]]"$3'),t}function kc(e,t){const n=u(e);if(!n)throw new Error("ComfyUI 워크플로 JSON이 비어 있습니다. Models 탭에 API Export JSON을 붙여넣으세요.");let r;const a=xm(n);try{r=JSON.parse(a)}catch(o){const c=/\[\[/.test(n)?' · 팁: [[seed]] 같은 값은 반드시 "[[seed]]"처럼 따옴표로 감싸세요.':"";throw new Error(`ComfyUI 워크플로 JSON 파싱 실패: ${String(o?.message||o).slice(0,120)}${c}`)}if(!r||typeof r!="object"||Array.isArray(r))throw new Error("ComfyUI 워크플로는 API 포맷(JSON 객체, 노드ID→노드)이어야 합니다.");let i=r;if(i.nodes&&i.links)throw new Error("UI 저장 포맷 워크플로입니다. ComfyUI에서 'Export (API)'로 내보낸 JSON을 넣으세요.");const s=JSON.stringify(i);if(!/\[\[\s*pos\s*\]\]/.test(s))throw new Error("워크플로에 [[pos]]가 없습니다. 긍정 프롬프트를 넣는 칸에 [[pos]]를 적어 주세요.");return i=JSON.parse(s),wm(i,t),vm(i,t.seed),i}async function km(e,t,n,r){const a=vc(e),i=gm(e),s=Number(e.seed??0)||Math.floor(Math.random()*4294967295)||1,o=xc({main:t,neg:n,captions:r,nai:e,seed:s}),c=kc(e.comfy_workflow_json,o);return w("comfy.generate.start",{message:a,prompt_len:String(t||"").length,chars:(r||[]).length,nodes:Object.keys(c).length,focus:!0}),Sc.run(async()=>{const l=await hm(a,c);w("comfy.generate.submitted",{message:l.slice(0,8),focus:!0});const f=await _m(a,l,{timeoutMs:i}),d=await ym(a,f);if(w("comfy.generate.done",{bytes:d?.byteLength||0,focus:!0}),!d||d.byteLength<256)throw new Error(`ComfyUI 응답 이미지가 너무 짧음 (${d?.byteLength||0}B)`);return[d,s]})}var Sc,Qa=$((()=>{q(),bt(),L(),Pt(),Sc=new fr}));Qa(),Bu(),Z(),L();var ei=_s;function He(e,t=!1){let n=ei[String(e).toLowerCase()]||e;return t&&(n+="-inpainting"),n}function Sm(e){const t=[],n=[];for(const r of e.characters||[]){const a={x:r.center_x,y:r.center_y};t.push({char_caption:r.prompt,centers:[a]}),n.push({char_caption:r.uc||"",centers:[a]})}return{autoSmea:!0,prefer_brownian:!0,ucPreset:0,use_coords:!1,legacy_uc:!1,add_original_image:!0,v4_prompt:{caption:{base_caption:e.prompt,char_captions:t},use_coords:!1,use_order:!0},v4_negative_prompt:{caption:{base_caption:e.negative_prompt,char_captions:n},legacy_uc:!1}}}function Am(e){const t=He(e.model),n={width:e.width,height:e.height,n_samples:1,seed:e.seed,extra_noise_seed:e.seed,sampler:e.sampler,steps:e.steps,scale:e.cfg_scale,negative_prompt:e.negative_prompt,cfg_rescale:e.cfg_rescale,noise_schedule:e.scheduler,params_version:3,legacy:!1,legacy_v3_extend:!1};if(e.var_plus?n.skip_cfg_above_sigma=t.includes("4-5")?58:19:n.skip_cfg_above_sigma=null,t.includes("nai-diffusion-4")&&Object.assign(n,Sm(e)),e.vibes?.length&&(n.reference_image_multiple=e.vibes.map(r=>r.encoded),n.reference_strength_multiple=e.vibes.map(r=>r.strength),n.reference_information_extracted_multiple=e.vibes.map(r=>r.information_extracted),n.normalize_reference_strength_multiple=!0),e.character_refs?.length){if(!t.includes("4-5"))throw new Error("Character Reference는 NAID4.5 전용입니다");n.director_reference_images=e.character_refs.map(r=>Jt(r.image)),n.director_reference_strength_values=e.character_refs.map(r=>r.strength),n.director_reference_secondary_strength_values=e.character_refs.map(r=>1-r.fidelity),n.director_reference_descriptions=e.character_refs.map(r=>({caption:{base_caption:r.type,char_captions:[]},legacy_uc:!1})),n.director_reference_information_extracted=e.character_refs.map(()=>1),n.controlnet_strength=1,n.inpaintImg2ImgStrength=1,n.normalize_reference_strength_multiple=!0,delete n.skip_cfg_above_sigma}return n}function Je(e){const t=u(e)||"nai-diffusion-4-5-full",n=Object.fromEntries(Object.entries(ei).map(([r,a])=>[a,r]));return ei[t]?t:n[t]?n[t]:"naid4.5f"}te(),q(),bt(),Z(),_c(),Pt();var Mm=new fr;async function Ac(e,t,n,r={}){const a={input:t.prompt,model:He(t.model),action:"generate",parameters:Am(t)};return w("nai.generate.start",{message:a.model,prompt_len:String(t.prompt||"").length,chars:(t.characters||[]).length,has_char_refs:!!t.character_refs?.length,has_vibes:!!t.vibes?.length}),Mm.run(async()=>{const i=await pm(e,a,n,r),s=fe("nai.unzip");try{const o=await dm(new Uint8Array(i)),c=wt(new Uint8Array(o));return s.end({bytes:o?.byteLength||0,is_png:c,zip_bytes:i?.byteLength||0}),c||w("nai.unzip",{message:"unzipped but not PNG magic",bytes:o?.byteLength||0},"warn"),{raw_bytes:o,seed:t.seed||0}}catch(o){throw s.fail(o,{zip_bytes:i?.byteLength||0}),o}})}async function Nm(e){const t=await De(Wi,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),n=Number(t?.status||0);if(n===401)throw new Error("인증 실패 (401). API 토큰을 확인하세요.");if(n>=400)throw new Error(`Anlas 조회 실패: HTTP ${n}`);const r=await t.json(),a=r.trainingStepsLeft||{},i=a.fixedTrainingStepsLeft||0,s=a.purchasedTrainingSteps||0,o=r.perks?.unlimitedMaxPriority||!1;return{fixed:i,purchased:s,total:i+s,opus:o}}function Se(e){return Number.isFinite(e)?Math.max(0,Math.min(100,e)):0}function Im(e){if(!e)return null;for(const t of["y_percent","anchor_percent","read_percent"]){const n=Number(e[t]);if(Number.isFinite(n))return Se(n)}return null}function Em(e){const t=e.length;if(!t)return[];const n=e.map((a,i)=>({index:i,y:Im(a)})).map((a,i)=>a.y!=null?a.y:t===1?50:Se(i/Math.max(1,t-1)*100)).map((a,i)=>({y:a,index:i})).sort((a,i)=>a.y-i.y||a.index-i.index),r=Array.from({length:t},()=>({from_percent:0,to_percent:100}));for(let a=0;a<n.length;a++){const{y:i,index:s}=n[a],o=a>0?n[a-1].y:null,c=a<n.length-1?n[a+1].y:null;let l,f;o==null&&c==null?(l=Se(i-ti),f=Se(i+ti)):o==null?(l=0,f=Se((i+c)/2)):c==null?(l=Se((o+i)/2),f=100):(l=Se((o+i)/2),f=Se((i+c)/2)),f<l&&(f=l),f-l<1&&(l=Se(i-.5),f=Se(i+.5),f<l&&(f=l)),r[s]={from_percent:Math.round(l*100)/100,to_percent:Math.round(f*100)/100}}return r}function Cm(e,t,n){const r=e.length;if(!r)return{start:0,end:0};const a=Se(t),i=Se(n);let s=Math.floor(r*a/100),o=Math.ceil(r*i/100);return o<s&&(o=s),o===s&&s<r&&(o=Math.min(r,s+1)),{start:Math.max(0,s),end:Math.min(r,o)}}function jm(e,t,n,r=Nc){const a=typeof e=="string"?e:"";if(!a)return"";let{start:i,end:s}=Cm(a,t,n);const o=a.lastIndexOf(`
`,i);o>=0&&i-o<=80&&(i=o+1);const c=a.indexOf(`
`,s);c>=0&&c-s<=80&&(s=c);let l=a.slice(i,s).trim();return l.length>r&&(l=`${l.slice(0,r).trimEnd()}…`),l}function Mc(e,t){return Em(e).map(n=>({focus:n,focus_hint:jm(t,n.from_percent,n.to_percent)}))}var ti,Nc,Tm=$((()=>{ti=15,Nc=600})),$m,Ic,Ec,Cc,Pm=$((()=>{$m=1,Ic="Inlay default (SFW)",Ec=[{id:"composition.solo",label:"솔로 구도",options:[{id:"1girl_solo_portrait",description:"여성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"1boy_solo_portrait",description:"남성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"solo_from_side",description:"혼자 옆모습",tags:"from side, cowboy shot"},{id:"solo_upper_body",description:"혼자 상반신 클로즈업",tags:"upper body, looking at viewer"}]},{id:"composition.duo",label:"2인 구도",options:[{id:"facing_each_other",description:"남녀가 서로를 향함",tags:"2::facing another::",slot:"char",by_slot:{female:"2::facing another::",male:"2::facing another::"}},{id:"male_behind_female",description:"남성이 여성 뒤",tags:"2::from side::, 2::side-by-side::, 2::behind another::"},{id:"side_by_side",description:"나란히 서 있음",tags:"2::side-by-side::, 2::from side::"},{id:"2girls_facing",description:"여성 둘이 마주봄",tags:"2::facing another::"},{id:"hug_front",description:"앞에서 안기",tags:"hug, facing another"}]},{id:"camera.framing",label:"카메라/프레이밍",options:[{id:"cowboy_shot",description:"허리 위",tags:"cowboy shot"},{id:"full_body",description:"전신",tags:"full body"},{id:"upper_body",description:"상반신",tags:"upper body"},{id:"close_up",description:"얼굴 클로즈업",tags:"close-up, face"},{id:"from_above",description:"위에서",tags:"from above"},{id:"from_below",description:"아래에서",tags:"from below"},{id:"from_side",description:"옆에서",tags:"from side"},{id:"pov",description:"1인칭 시점",tags:"pov, pov hands"}]},{id:"pose.hands",label:"손/포즈",options:[{id:"hand_on_own_chest",description:"자신의 가슴에 손",tags:"hand on own chest"},{id:"hands_up",description:"손 들기",tags:"hands up"},{id:"reaching_out",description:"손 뻗기",tags:"reaching out"},{id:"holding_hands",description:"손잡기",tags:"holding hands"},{id:"arm_around_waist",description:"허리에 팔",tags:"arm around waist"},{id:"hug_from_behind",description:"뒤에서 안기",tags:"hug from behind"}]},{id:"expression.basic",label:"표정",options:[{id:"smile",description:"미소",tags:"smile"},{id:"blush",description:"홍조",tags:"blush"},{id:"serious",description:"진지",tags:"serious"},{id:"open_mouth",description:"입 벌림",tags:"open mouth"},{id:"closed_eyes",description:"눈 감음",tags:"closed eyes"},{id:"looking_at_another",description:"상대를 봄",tags:"looking at another"}]},{id:"place.indoor",label:"실내 배경",options:[{id:"bedroom",description:"침실",tags:"bedroom, indoors"},{id:"classroom",description:"교실",tags:"classroom, indoors"},{id:"living_room",description:"거실",tags:"living room, indoors"},{id:"bathroom",description:"욕실",tags:"bathroom, indoors"},{id:"cafe",description:"카페",tags:"cafe, indoors"}]},{id:"place.outdoor",label:"야외 배경",options:[{id:"outdoors_day",description:"낮 야외",tags:"outdoors, blue sky"},{id:"street",description:"거리",tags:"street, outdoors"},{id:"park",description:"공원",tags:"park, outdoors, tree"},{id:"beach",description:"해변",tags:"beach, outdoors, ocean"},{id:"night_city",description:"밤 도시",tags:"outdoors, night, cityscape"}]}],Cc={version:1,name:Ic,groups:Ec}}));function Gn(e){return e?e.has_presets===!0?!0:e.presets!=null&&typeof e.presets=="object":!1}function Om(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t={};for(const[n,r]of Object.entries(e)){const a=u(n,80);if(!a||!r||typeof r!="object"||Array.isArray(r))continue;const i=r,s=Array.isArray(i.fallback_order)?i.fallback_order.map(c=>u(c,160)).filter(Boolean):[],o=Math.max(1,Math.min(8,Number(i.max_active_groups)||1));s.length&&(t[a]={max_active_groups:o,fallback_order:s,...u(i.scope,40)?{scope:u(i.scope,40)}:{}})}return Object.keys(t).length?t:void 0}function jc(e,t){const n=u(e,160).toLowerCase(),r=u(t,160).toLowerCase();if(!n||!r)return!1;if(n.endsWith(".*")){const a=n.slice(0,-1);return r.startsWith(a)||r===n.slice(0,-2)}return n.endsWith("*")?r.startsWith(n.slice(0,-1)):r===n}function Tc(e){const t=Array.isArray(e)?e:u(e,800).split(/[,|]/),n=[],r=new Set;for(const a of t){const i=u(a,120);!i||r.has(i)||(r.add(i),n.push(i))}return n}function $c(e,t){const n=Tc(t),r=e.modifier_lanes;if(!r||!Object.keys(r).length)return n;const a=new Map;for(const s of n){const o=sn(e,s);o&&a.set(s,o.group.id)}const i=new Set;for(const s of Object.values(r)){const o=new Set;for(const f of a.values())s.fallback_order.some(d=>jc(d,f))&&o.add(f);if(o.size<=s.max_active_groups)continue;const c=[...o].map(f=>{let d=s.fallback_order.length;for(let m=0;m<s.fallback_order.length;m++)if(jc(s.fallback_order[m],f)){d=m;break}return{gid:f,rank:d}});c.sort((f,d)=>f.rank-d.rank||f.gid.localeCompare(d.gid));const l=new Set(c.slice(0,s.max_active_groups).map(f=>f.gid));for(const{gid:f}of c)l.has(f)||i.add(f)}return i.size?n.filter(s=>{const o=a.get(s);return!o||!i.has(o)}):n}function ni(){return{base:"",char:"",primary:"",secondary:"",female:"",male:""}}function Ot(e,t){const n=u(t,40).toLowerCase();if(["char","character","actor"].includes(n))return"char";if(["primary","main"].includes(n))return"primary";if(["secondary","partner"].includes(n))return"secondary";if(["female","f","girl","woman"].includes(n))return"female";if(["male","m","boy","man"].includes(n))return"male";if(["base","global","scene","camera","place"].includes(n))return"base";const r=u(e,160).toLowerCase();return/^(pose|expression|gesture|emotion|contact|action|interaction|manual|relation|gaze)([./_]|$)/.test(r)||/\.(pose|expression|gesture|interaction|manual|contact)\b/.test(r)||/^composition\.(duo|pair|multi|group|couple)/.test(r)?"char":/^(place|camera|background|location|framing|view|lighting|scene)([./_]|$)/.test(r)||/^composition\./.test(r)?"base":/^state\./.test(r)?"char":"base"}function Pc(e){const t=u(e,200).toLowerCase();if(!t)return null;const n=t.split(".")[0]||"";return n==="global"||n==="scene"||n==="camera"?"base":n==="primary"?"primary":n==="secondary"?"secondary":n==="female"||n==="girl"||n==="woman"?"female":n==="male"||n==="boy"||n==="man"?"male":n==="persona"?"base":null}function Lm(e){return e.trim().toLowerCase()==="global.composition"}function Oc(e){if(!e||typeof e!="object"||Array.isArray(e))return{};const t={};for(const[n,r]of Object.entries(e)){if(Lm(n))continue;const a=Pc(n);if(!a)continue;const i=qn(r);i&&(t[a]=I(t[a],i))}return t}function Lt(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function qn(e){if(typeof e=="string")return u(e,800);if(!Array.isArray(e)||!e.length)return"";const t=[];for(const n of e){if(typeof n=="string"){const i=u(n,200);i&&t.push(i);continue}if(!Array.isArray(n)||n.length<2)continue;const r=Number(n[0]),a=u(n[1],200);a&&(Number.isFinite(r)&&r!==1?t.push(`${r}::${a}::`):t.push(a))}return I(...t)}function Bm(e,t,n){const r=Lt(e);if(!r)return null;const a=u(r.id,120)||`opt_${t}`,i=Oc(r.prompt),s=Lt(r.by_slot)||Lt(r.slots)||Lt(r.actors),o={...i};if(s){for(const d of["base","char","primary","secondary","female","male"]){const m=u(s[d],800);m&&(o[d]=I(o[d],m))}for(const[d,m]of Object.entries(s)){const p=Ot(n,d);typeof m=="string"&&u(m)&&(o[p]=I(o[p],u(m,800)))}}let c=u(r.tags??r.tag,800);if(c||(c=Array.isArray(r.prompt)?qn(r.prompt):""),c||(c=u(typeof r.prompt=="string"?r.prompt:"",800)),!c&&Object.keys(o).length&&(c=I(...Object.values(o))),!c)return null;const l=Ot(n,r.slot??r.target??r.apply_to),f=Object.keys(o).length?o:void 0;return{id:a,description:u(r.description??r.label??r.when,400)||a,tags:c,slot:l,...f?{by_slot:f}:{}}}function Lc(e,t,n){const r=Lt(e);if(!r)return null;const a=u(r.id,160)||`group_${t}`,i=u(r.label??r.name??r.description,200)||a,s=Array.isArray(r.options)?r.options:Array.isArray(r.include_options)?r.include_options:[],o=[];for(let c=0;c<s.length&&o.length<n;c++){const l=Bm(s[c],c,a);l&&o.push(l)}return o.length?{id:a,label:i,options:o,...r.continuity===!0||r.continuity==="true"?{continuity:!0}:{}}:null}function Rm(e,t){const n=Array.isArray(e)?e:e&&typeof e=="object"?Object.values(e):[],r=[];for(let a=0;a<n.length;a++){const i=Lc(n[a],a,t);i&&r.push(i)}return r}function Fm(e,t){return e.modifier_library!=null?{list:Rm(e.modifier_library,80),maxOptions:80,nameHint:"Asset Maid catalog",preNormalized:!0}:Array.isArray(e.groups)?{list:e.groups,maxOptions:80,nameHint:"",preNormalized:!1}:Array.isArray(t)?{list:t,maxOptions:80,nameHint:"",preNormalized:!1}:{list:[],maxOptions:10,nameHint:"",preNormalized:!1}}function ri(e,t="catalog"){const n=Lt(e)||{},{list:r,maxOptions:a,nameHint:i,preNormalized:s}=Fm(n,e),o=[];for(let M=0;M<r.length;M++){if(s){const R=r[M];if(R?.id&&Array.isArray(R.options)&&R.options.length){const H=R.options.slice(0,a).map((N,v)=>({...N,slot:N.slot||Ot(R.id,N.slot),id:N.id||`opt_${v}`,description:N.description||N.id||`opt_${v}`,tags:N.tags}));o.push({id:R.id,label:R.label||R.id,options:H,...R.continuity?{continuity:!0}:{}})}continue}const C=Lc(r[M],M,a);C&&o.push(C)}if(!o.length)throw new Error("큐레이션 카탈로그에 그룹이 없습니다. Inlay `{groups:[…]}` 또는 Asset Maid `modifier_library` JSON인지 확인하세요.");const c=Number(n.version)||1,l=u(n.name,200)||i||t,f=n.presets!=null&&typeof n.presets=="object"?n.presets:void 0,d=Om(n.modifier_lanes),m=Lt(n.global)||{},p=qn(m.fixed_positive)||u(m.fixed_positive??n.fixed_positive,800),g=qn(m.fixed_negative)||u(m.fixed_negative??n.fixed_negative,800),h=n.subjects??m.subjects,_=n.selection??m.selection,y=m.prompt_order??n.prompt_order,k=Array.isArray(y)?y.map(M=>u(M,40)).filter(Boolean):void 0,x=new Set(o.filter(M=>M.continuity).map(M=>M.id)),S=n.continuity??m.continuity;if(Array.isArray(S))for(const M of S){const C=u(M,160);if(!C)continue;x.add(C);const R=o.find(H=>H.id===C);R&&(R.continuity=!0)}const E={version:c,name:l,groups:o,...f?{presets:f,has_presets:!0}:{has_presets:!1},...d?{modifier_lanes:d}:{},...p?{fixed_positive:p}:{},...g?{fixed_negative:g}:{},...h!=null&&typeof h=="object"?{subjects:h}:{},..._!=null&&typeof _=="object"?{selection:_}:{},...k?.length?{prompt_order:k}:{},...x.size?{continuity_group_ids:[...x].sort()}:{}};return E.sha=Wn(E),E}function ai(e,t){const n=u(t,160);return n?e.continuity_group_ids?.includes(n)?!0:Rc(e,n)?.continuity===!0:!1}function Bc(e){return e.groups.filter(t=>!ai(e,t.id))}function ii(){return ri(Cc,"Inlay default (SFW)")}function Wn(e){const t=JSON.stringify({version:e.version,name:e.name,groups:e.groups.map(r=>({id:r.id,continuity:r.continuity??null,options:r.options.map(a=>({id:a.id,tags:a.tags,description:a.description,slot:a.slot,by_slot:a.by_slot}))})),presets:e.presets??null,modifier_lanes:e.modifier_lanes??null,fixed_positive:e.fixed_positive??null,fixed_negative:e.fixed_negative??null,subjects:e.subjects??null,selection:e.selection??null,prompt_order:e.prompt_order??null,continuity_group_ids:e.continuity_group_ids??null});let n=2166136261;for(let r=0;r<t.length;r++)n^=t.charCodeAt(r),n=Math.imul(n,16777619);return(n>>>0).toString(16).padStart(8,"0")}function Dm(...e){const t=ni();for(const n of e)n&&(t.base=I(t.base,n.base),t.char=I(t.char,n.char),t.primary=I(t.primary,n.primary),t.secondary=I(t.secondary,n.secondary),t.female=I(t.female,n.female),t.male=I(t.male,n.male));return t}function an(e){return e?{base:u(e.base,800),char:u(e.char,800),primary:u(e.primary,800),secondary:u(e.secondary,800),female:u(e.female,800),male:u(e.male,800)}:ni()}function Rc(e,t){const n=u(t,160);return n&&e.groups.find(r=>r.id===n)||null}function sn(e,t){const n=u(t,120);if(!n)return null;for(const r of e.groups){const a=r.options.find(i=>i.id===n);if(a)return{group:r,option:a}}return null}function zm(e){const t=[];for(const n of e.groups)for(const r of n.options)t.push({key:`${n.id}::${r.id}`,groupId:n.id,optionId:r.id,text:`${r.description} | ${r.tags}`,tags:r.tags,slot:r.slot||Ot(n.id)});return t}function Um(e,t=!1){const n=Bc(e).map(r=>{const a=r.options.map(i=>`  - ${i.id}: ${i.description}`).join(`
`);return`### ${r.id} (${r.label})
...
`)}function Fc(){return["## Per-actor ids (strict catalog-id mode)",'Add `"characters": [ { "index": 0, "option_ids": ["id", "..."] }, ... ]` to EVERY shot.','Each shot input includes `cast`: `[{ "index": 0, "name": "...", "gender": "girl|boy|""" }, ...]`.',"`index` MUST match `cast[].index` / Pass-1 `characters` array order — use name+gender from `cast`, not chat mention order.","Example: if cast says index 0 = 보민 (boy) and index 1 = Serin (girl), put bound/tears on the boy's index, not the girl's.","Put an option on `characters[].option_ids` when it targets ONE specific actor (pose, contact, expression, gaze).","Put an option on the shot-level `curation_option_ids` instead when it is scene-wide (camera, place, framing) — do not duplicate it into every actor.","Every actor in `cast` needs an entry, even if `option_ids` is `[]`.","This mode has NO freeform camera/situation/action fallback — an unlisted concept is simply omitted, never paraphrased."]}function Hm(e,t,n){const r=n?.strictIds===!0,a=new Set(t.map(o=>u(o,160)).filter(Boolean)),i=Bc(e).filter(o=>a.has(o.id)),s=(i.length?i:[]).map(o=>{const c=o.options.map(l=>`  - ${l.id}: ${l.description}`).join(`
`);return`### ${o.id} (${o.label})
${c}`});return["Curation two-stage ON (pass 2 — scene refine, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ] }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "camera": "...", "situation": "...", "place": "...", "action": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["cowboy_shot", "smile"] }, { "index": 1, "option_ids": ["facing_each_other"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["cowboy_shot", "facing_each_other", "smile", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output — host injects catalog tags from those ids.","For EVERY shot pick ALL listed options that match the chat at that y_percent (pose, contact, expression, place…).","Typical **2–8 ids**; `[]` ONLY if nothing fits. Do not skip obvious matches.",r?"Do NOT invent character appearance/attire. Do NOT invent option ids. Do NOT write freeform camera/situation/action text — ids only.":"Prefer ids over freeform camera/situation/action paraphrase.",...r?[]:["Do NOT invent character appearance/attire. Do NOT invent option ids."],...Dc(),...r?["",...Fc()]:[],"",s.length?"## Allowed options (union of all shots' groups)":`## Allowed options
(none — leave scene fields empty)`,...s].join(`
`)}function Dc(){return["## Chat context (separate user message, READ-ONLY)","A prior user message is the exact chat text from pass 1 (for LLM prompt cache).","Use it for continuity only (who the cast is, ongoing scene).","Do NOT rewrite, quote-edit, summarize into the JSON, or invent missing plot beats.","Do NOT change shot count, shot_index, composition_id, composition_variant, or y_percent.","","## Shot focus bands (PRIMARY evidence)","Each shot includes `y_percent`, `focus: { from_percent, to_percent }`, and `focus_hint` (a short quote from that band of the chat).","Pick options primarily from `focus_hint` / the `focus` percent range for THAT shot.","Do NOT pull actions from far-away bands into this shot. Full chat is background, not a license to copy the same ids onto every shot.","When focuses differ, prefer distinct `curation_option_ids` / per-actor ids across shots — avoid pasting one identical set on every shot_index.","Do NOT invent aftermath tags (`after_sex`, `afterglow`, cum_on_*, etc.) unless `focus_hint` explicitly shows that aftermath.","y_percent / focus are already final — never output new y_percent or focus fields."]}function Jm(){return["Curation embed-snap mode: write DETAILED English Danbooru scene tags.","Fill camera, situation, place, action with concrete tags (framing, pose, contact, location, expression-as-scene).",'Use standard Danbooru spacing (underscores as spaces): e.g. "cowboy shot", "from side", "hand on own chest", "facing another".','Prefer specific pose/contact/framing over vague words like "intimate" or "dramatic".',"Character appearance/attire/accessories stay in character fields — do not move them into camera/situation.","`natural` still follows the Natural base mode system message."].join(`
`)}function Km(e){const t=e.prompt_order;if(!t?.length)return oi;const n=[],r=new Set;for(const a of t){const i=Pc(a)||(u(a,40).toLowerCase()==="char"?"char":null);i&&!r.has(i)&&(r.add(i),n.push(i))}for(const a of oi)r.has(a)||n.push(a);return n}function Gm(e,t){const n=zc(e,t);return I(...Km(e).map(r=>n[r]))}function zc(e,t){const n=Array.isArray(t)?t:u(t,800).split(/[,|]/),r={base:[],char:[],primary:[],secondary:[],female:[],male:[]},a=new Set;for(const i of n){const s=u(i,120);if(!s||a.has(s))continue;const o=sn(e,s);if(!o)continue;a.add(s);const c=o.option.by_slot;if(c&&Object.keys(c).length){for(const l of Object.keys(c)){const f=u(c[l],800);f&&r[l].push(f)}continue}r[Ot(o.group.id)].push(o.option.tags)}return{base:I(...r.base),char:I(...r.char),primary:I(...r.primary),secondary:I(...r.secondary),female:I(...r.female),male:I(...r.male)}}function Bt(e,t){t&&(e.action=I(u(e.action,600),t))}function si(e,t,n){const r={...ni(),...t};e.camera=u(r.base,800),e.situation=u(n?.situation,400)||"",n&&"place"in n&&(e.place=u(n.place,400));const a=(Array.isArray(e.characters)?e.characters:[]).filter(s=>s&&typeof s=="object"),i=!!(r.char||r.primary||r.secondary||r.female||r.male);if(!a.length){e.action=i?I(r.char,r.primary,r.secondary,r.female,r.male):"";return}i&&(e.action=""),qm(a,r)}function Uc(e){const t=Array.isArray(e?.characters)?e.characters:[],n=[];for(let r=0;r<t.length;r++){const a=t[r];if(!a||typeof a!="object"){n.push({index:r,name:"",gender:""});continue}const i=a,s=$n(i);n.push({index:r,name:u(i.name,200),gender:s==="f"?"girl":s==="m"?"boy":""})}return n}function Hc(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(!n||typeof n!="object")continue;const r=n,a=Number(r.index);!Number.isInteger(a)||a<0||t.push({index:a,option_ids:r.option_ids??r.ids??r.curation_option_ids})}return t}function Jc(e,t,n){if(!t.length)return;const r=Array.isArray(e.characters)?e.characters:[];for(const{index:a,option_ids:i}of t){const s=r[a];if(!s||typeof s!="object")continue;const o=Gm(n,i);o&&Bt(s,o)}}function qm(e,t){t.primary&&Bt(e[0],t.primary),t.secondary&&e[1]&&Bt(e[1],t.secondary);for(const n of e){t.char&&Bt(n,t.char);const r=$n(n);t.female&&r==="f"&&Bt(n,t.female),t.male&&r==="m"&&Bt(n,t.male)}if(!e.some(n=>$n(n)!=null)){const n=I(t.female,t.male);if(n)for(const r of e)Bt(r,n)}}function Wm(e){return e.groups.reduce((t,n)=>t+n.options.length,0)}var Vm,Ym,oi,ci=$((()=>{Pm(),L(),it(),Vm=10,Ym=80,oi=["base","char","primary","secondary","female","male"]}));function Xm(e){let t=u(e.composition_id,160)||u(e.preset_id,160)||u(e.leaf_id,160)||u(e.position_id,160)||u(e.curation_leaf,160)||u(e.composition,160);if(t&&/[|/]/.test(t)){const r=t.split(/[/|]/).map(a=>u(a,160)).filter(Boolean);r.length>=2&&((!Array.isArray(e.preset_path)||!e.preset_path.length)&&(e.preset_path=r),t=r[r.length-1])}const n=u(e.composition_variant,120)||u(e.selected_variant_id,120)||u(e.variant_id,120)||u(e.variant,120);return t&&(e.composition_id=t),n&&(e.composition_variant=n),Array.isArray(e.preset_path)&&e.preset_path.length?!0:!!t}function Rt(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function Zm(e){const t=[];for(const n of["children","variants"]){const r=e[n];if(Array.isArray(r))for(const a of r){const i=Rt(a);i&&t.push(i)}}return t}function Kc(e){return Array.isArray(e.variants)?e.variants.map(Rt).filter(Boolean):[]}function Qm(e){const t=e.when_to_use;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):u(e.description,400)}function ep(e){const t=e.avoid_when;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):""}function tp(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,n=u(t.ref??t.id??t.group,160);if(!n)return null;const r=Array.isArray(t.include_options)?t.include_options.map(s=>u(s,120)).filter(Boolean):void 0,a=t.action&&typeof t.action=="object"&&!Array.isArray(t.action)?t.action:null,i=a?{source:u(a.source,40)||void 0,target:u(a.target,40)||void 0,include_options:Array.isArray(a.include_options)?a.include_options.map(s=>u(s,120)).filter(Boolean):void 0}:void 0;return{ref:n,include_options:r?.length?r:void 0,replace:t.replace===!0,order:Number.isFinite(Number(t.order))?Number(t.order):void 0,action:i}}function Gc(e){return Array.isArray(e.modifiers)?e.modifiers.map(tp).filter(Boolean):[]}function np(e){if(!Gn(e))return[];const t=Rt(e.presets);if(!t)return[];const n=[],r=(a,i,s,o)=>{const c=u(a.id,160),l=u(a.type,40),f=c&&c!=="preset"?[...i,c]:i,d=!s&&c&&c!=="preset"?c:s,m=l==="category"&&c?c:o,p=Array.isArray(a.children)?a.children.map(Rt).filter(Boolean):[],g=Kc(a);if(c&&c!=="preset"&&(l==="position"||g.length>0&&p.length===0)){const h=Gc(a),_=[...new Set(h.map(y=>y.ref).filter(Boolean))];n.push({id:c,path:f,composition:d||c,category:m,when:Qm(a),avoid:ep(a),variants:g.map(y=>u(y.id,120)).filter(Boolean),description:u(a.description,300)||c,selectionModifiers:_})}for(const h of p)r(h,f,d,m)};return r(t,[],"",""),n}function qc(e,t,n){const r=Rt(e.presets),a=u(t,160);if(!r||!a)return null;const i={chain:null},s=(d,m)=>{if(i.chain)return;const p=[...m,d];if(u(d.id,160)===a){i.chain=p;return}const g=Array.isArray(d.children)?d.children.map(Rt).filter(Boolean):[];for(const h of g)s(h,p)};s(r,[]);const o=i.chain;if(!o)return null;const c=u(n,120);if(!c)return o;const l=o[o.length-1],f=Kc(l).find(d=>u(d.id,120)===c);return f?[...o,f]:o}function li(e,t){const n=t.preset_path;if(Array.isArray(n)&&n.length){const r=n.map(o=>u(o,160)).filter(Boolean),a=Rt(e.presets);if(!a||!r.length)return null;const i=[a];let s=a;for(const o of r){if(u(s.id,160)===o)continue;const c=Zm(s).find(l=>u(l.id,160)===o);if(!c)return qc(e,r[r.length-1],void 0);i.push(c),s=c}return i}return qc(e,t.composition_id??(typeof n=="string"?n:""),t.composition_variant)}function ui(e){const t=new Map;for(const n of e)for(const r of Gc(n)){const a=t.get(r.ref);if(r.replace||!a){t.set(r.ref,r);continue}const i=[...new Set([...a.include_options||[],...r.include_options||[]])];t.set(r.ref,{...a,...r,include_options:i.length?i:a.include_options,action:r.action||a.action})}return[...t.values()]}function rp(e,t){const n=new Map,r=new Set;for(const i of t){for(const s of ui(i))n.set(s.ref,s);for(const s of Vc(i))r.add(s)}const a=[];for(const[i,s]of n){if(ai(e,i))continue;const o=Rc(e,i);if(!o)continue;const c=s.include_options?.length?new Set(s.include_options):null;let l=c?o.options.filter(f=>c.has(f.id)):o.options;if(r.size){const f=Yc(e,l.map(m=>m.id),r),d=new Set(f);l=l.filter(m=>d.has(m.id))}l.length&&a.push({id:o.id,label:o.label,options:l})}return a}function ap(e,t){return t?.length?ui(t).filter(n=>ai(e,n.ref)):[]}function Wc(e){const t=u(e,40).toLowerCase();return t?["male","m","boy","man"].includes(t)?"male":["female","f","girl","woman"].includes(t)?"female":["primary","main"].includes(t)?"primary":["secondary","partner"].includes(t)?"secondary":["global","base","scene","camera"].includes(t)?"base":["char","both","all"].includes(t)?"char":null:null}function ip(e){return an(Oc(e))}function sp(e,t,n){const r=sn(e,t);if(!r)return an({});const a=n.find(o=>o.ref!==r.group.id?!1:!o.include_options?.length&&!o.action?.include_options?.length?!0:new Set([...o.include_options||[],...o.action?.include_options||[]]).has(t))||n.find(o=>o.ref===r.group.id);if(r.option.by_slot&&Object.keys(r.option.by_slot).length)return an(r.option.by_slot);const i=r.option.tags||qn(r.option.tags);if(!i)return an({});if(a?.action){const o=Wc(a.action.source),c=Wc(a.action.target),l={};if(o&&(l[o]=i),c&&(l[c]=I(l[c],i)),o||c)return an(l)}const s=Ot(r.group.id);return an({[s]:i})}function Vc(e){const t=new Set;for(const n of e){const r=n.modifier_filter;if(!r||typeof r!="object"||Array.isArray(r))continue;const a=r.deny;if(!(!a||typeof a!="object"||Array.isArray(a))){for(const i of Object.values(a))if(Array.isArray(i))for(const s of i){const o=u(s,160).toLowerCase();o&&t.add(o)}}}return t}function Yc(e,t,n){return n.size?t.filter(r=>{const a=r.toLowerCase();if(n.has(a))return!1;const i=sn(e,r);if(!i)return!0;const s=u(i.option.tags,800).toLowerCase(),o=u(i.option.description,400).toLowerCase();for(const c of n){const l=c.replace(/_/g," ");if(s.includes(c)||s.includes(l)||o.includes(l))return!1}return!0}):t}function op(e,t,n){const r=new Map;for(const a of n)Number.isFinite(a.order)&&r.set(a.ref,a.order);return r.size?t.map((a,i)=>({id:a,i})).sort((a,i)=>{const s=sn(e,a.id)?.group.id,o=sn(e,i.id)?.group.id,c=s!=null&&r.has(s)?r.get(s):Number.MAX_SAFE_INTEGER,l=o!=null&&r.has(o)?r.get(o):Number.MAX_SAFE_INTEGER;return c!==l?c-l:a.i-i.i}).map(a=>a.id):t}function cp(e,t,n){if(!Gn(e))return null;const r=li(e,t);if(!r?.length)return null;const a=r.map(m=>ip(m.prompt)),i=ui(r),s=new Set(i.map(m=>m.ref)),o=[...i,...(n?.bindings||[]).filter(m=>!s.has(m.ref))],c=Vc(r),l=[...Tc(t.curation_option_ids),...n?.optionIds||[]];let f=$c(e,l);f=Yc(e,f,c),f=op(e,f,o);const d=f.map(m=>sp(e,m,o));return Dm(...a,...d)}function lp(){return["# Preset selection (Asset Maid analyzer rules)","Use ONLY information in the chat/shot context. Do not invent unseen actors or actions.","","## Actors → composition first","Count actors that are required for the current moment's action/contact.","Pick a composition that matches actor count and genders (e.g. 1girl_solo vs 1girl_1boy).","Do NOT drop a visible partner to force solo. If a male hand/arm is visible contacting the girl from POV, that male is an actor → prefer 1girl_1boy, not 1girl_solo.","","## Walk the tree","Read the leaf list as composition → category → position.","Categories matter: `general` = non-sexual placement; `foreplay` / `sexual` / `insertion` = intimate contact. If the chat has kissing, licking, sexual touch, or sex, do NOT pick a `general` leaf just because posture when-text matches.","For each candidate use when / avoid / selection_modifiers. Prefer the leaf whose when matches AND whose selection_modifiers cover the stated actions.","selection_modifiers are modifier **group ids** this leaf unlocks for pass 2 (e.g. `interaction.partner.mouth_contact`). They are the main reason to prefer one leaf over another when posture is similar.","CRITICAL: do NOT pick a leaf that only matches vague posture words if it lacks the group needed for the chat action. Example: ear licking / kissing / licking neck need a leaf with `interaction.partner.mouth_contact` (usually under foreplay), not `general/facing_each_other` which only has `interaction.general`.","Pick exactly ONE `composition_id` (position leaf) per shot.","If the same leaf id appears under multiple compositions/categories (e.g. `free`), set `composition_id` to the full path string `composition / category / leaf` so the host can disambiguate.","","## Variant","If the leaf lists variants, pick `composition_variant` for the camera that fits (from_side, pov, default…).","If unsure and a default/from_side exists, prefer that over inventing camera tags.","","## What NOT to do in pass 1","Do NOT invent Danbooru camera/pose tags into camera/situation/action.","Do NOT return modifier option ids here (pass 2 does that — e.g. do not emit `licking_ear` in pass 1).","Do NOT set `curation_groups`."]}function up(e,t=!1){const n=np(e),r=new Map;for(const i of n){const s=r.get(i.composition)||[];s.push(i),r.set(i.composition,s)}const a=[];for(const[i,s]of r){a.push(`## composition: ${i}`);for(const o of s){const c=o.variants.length?o.variants.join("|"):"(none)",l=o.selectionModifiers.length?o.selectionModifiers.join(", "):"(none)",f=o.description&&o.description!==o.id&&o.description!==o.when?`description: ${o.description}`:"";a.push([`### ${o.id}`,`path: ${o.path.join(" / ")}`,o.category?`category: ${o.category}`:"",o.when?`when: ${o.when}`:"",o.avoid?`avoid: ${o.avoid}`:"",f,`selection_modifiers: ${l}`,`variants: ${c}`].filter(Boolean).join(`
`))}}return["Curation two-stage ON (pass 1 — Asset Maid presets).","CRITICAL: every shot MUST include `composition_id` (exact leaf id, or full path if id is ambiguous). This overrides the base format schema.","Also set `composition_variant` when the leaf lists variants.",...lp(),"","On every shot set:","- `composition_id`: leaf id (e.g. `face_to_face_upright`) OR path `1girl_1boy / foreplay / face_to_face_upright` when ids collide","- `composition_variant`: one variant id for that leaf, or omit if none","Still fill characters (appearance/attire/accessories) as usual.","`place` may stay as a short location hint.",...t?["STRICT catalog-id mode is ON: leave `camera`, `situation`, `natural`, and every `characters[].action` / `characters[].expression` completely EMPTY.","Pass 2 assembles ALL scene and per-actor tags from catalog ids only, keyed off the `composition_id`/`composition_variant` you pick here."]:["Leave `situation` empty or non-person scene words only — NEVER put 1girl/1boy/solo there (host adds person-count tags).","`camera`/`action` must NOT include 1girl/1boy/solo either.","`natural` still follows the Natural base mode system message."],"","## Preset leaf catalog (do not invent ids)","selection_modifiers = group ids unlocked for pass 2 (not option ids). Use them to choose the leaf; pass 2 picks concrete options like licking_ear.",...a.length?a:["(empty presets tree)"]].join(`
`)}function fp(e){const t=e.modifier_lanes;if(!t||!Object.keys(t).length)return[];const n=["## Modifier lanes (hard caps — host also enforces)","Within each lane, keep at most max_active_groups distinct groups."];for(const[r,a]of Object.entries(t))n.push(`- lane \`${r}\`: max ${a.max_active_groups} group(s) among [${a.fallback_order.join(", ")}] (earlier pattern wins if over cap)`);return n.push("Example: do not pick both manual.arm_pose and manual.partner_contact options together."),n}function dp(e,t,n){const r=n?.strictIds===!0,a=rp(e,t).map(i=>{const s=i.options.map(o=>`  - ${o.id}: ${o.description}`).join(`
`);return`### ${i.id} (${i.label})
${s}`});return["Curation two-stage ON (pass 2 — preset modifiers, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ], "place": "..." }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "place": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["hug", "from_side"] }, { "index": 1, "option_ids": ["blush"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["hug", "from_side", "blush", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output. Host injects those catalog tags into the image — empty array = weak/empty pose.","For EVERY shot, pick ALL options that match the chat band at that shot's y_percent:","- contact / hug / hands / pose / expression / gaze / blush / location / lighting / clothing state when visible","Typical count: **2–8 ids** when the scene has clear action; 1 id only if truly minimal; `[]` ONLY if nothing in the list fits.","Do NOT leave `curation_option_ids` empty just to be safe — if hug/facing/hand contact is in the text and listed below, INCLUDE those ids.","Pick ONLY ids listed below. Never invent ids. Never invent character appearance/attire.","Do NOT put Danbooru tags in freeform fields instead of picking ids — prefer ids.","`place` may repeat a short location hint; optional.","Host assembles path prompts + these options into base vs char slots.",...r?["",...Fc()]:[],...Dc(),...fp(e),"",a.length?"## Allowed modifier options":`## Allowed modifier options
(none — return empty curation_option_ids)`,...a].join(`
`)}var mp=$((()=>{L(),ci()}));function pp(e,t){if(!e.length||e.length!==t.length)return-1;let n=0,r=0,a=0;for(let i=0;i<e.length;i++){const s=e[i],o=t[i];n+=s*o,r+=s*s,a+=o*o}return r<=0||a<=0?-1:n/(Math.sqrt(r)*Math.sqrt(a))}function gp(e,t,n){const r=n?.minScore??.35,a=bp(n?.groupId);let i=null,s=-1,o=null,c=-1;for(const l of t){const f=pp(e,l.vector);f>s&&(s=f,i=l),a&&l.groupId===a&&f>c&&(c=f,o=l)}return o&&c>=r?o:i&&s>=r?i:null}function hp(e){return e.slot||Ot(e.groupId)}function _p(e,t,n,r=.4){const a=[],i=[],s=[],o=[],c=[],l=[],f=[];let d=0,m=0;const p=(g,h)=>{g==="base"?i.push(h):g==="primary"?o.push(h):g==="secondary"?c.push(h):g==="female"?l.push(h):g==="male"?f.push(h):s.push(h)};for(let g=0;g<e.length;g++){const h=e[g].trim();if(!h)continue;const _=t[g];if(!_||!_.length){a.push(h),i.push(h),m+=1;continue}const y=gp(_,n,{minScore:r});y?(a.push(y.tags),p(hp(y),y.tags),d+=1):(a.push(h),i.push(h),m+=1)}return{tags:a,baseTags:i,charTags:s,primaryTags:o,secondaryTags:c,femaleTags:l,maleTags:f,snapped:d,kept:m}}function yp(e){const t=String(e||"").trim();if(!t)return[];const n=[];let r="",a=0;for(let s=0;s<t.length;s++){const o=t[s];if(o===":"&&t[s+1]===":"){a+=r.includes("::")?-1:1,r+="::",s+=1;continue}if(o===","&&a<=0){const c=r.trim();c&&n.push(c),r="";continue}r+=o}const i=r.trim();return i&&n.push(i),n}function bp(e){return typeof e=="string"?e.trim():""}var wp=$((()=>{ci()}));function Ee(e){const t=u(e,40).toLowerCase().replace(/[ -]+/g,"_");return t==="openai_compatible"||t==="compat"?"openai_compat":$r.includes(t)?t:"openai"}function Tr(e){switch(Ee(e)){case"openai":return"https://api.openai.com/v1/embeddings";case"voyage":return"https://api.voyageai.com/v1/embeddings";case"openrouter":return"https://openrouter.ai/api/v1/embeddings";case"lmstudio":return"http://127.0.0.1:1234/v1/embeddings";case"ollama":return"http://127.0.0.1:11434/api/embeddings";default:return"https://api.openai.com/v1/embeddings"}}function Vn(e){switch(Ee(e)){case"voyage":return"voyage-3-lite";case"ollama":return"nomic-embed-text";case"openrouter":return"openai/text-embedding-3-small";case"lmstudio":return"text-embedding-nomic-embed-text-v1.5";default:return"text-embedding-3-small"}}function vp(e){return Vn(e)}function xp(){const e=new Set;for(const t of $r){const n=Tr(t).replace(/\/+$/,"");e.add(n),e.add(n.replace(/\/embeddings$/i,"")),e.add(n.replace(/\/api\/embeddings$/i,"")),e.add(n.replace(/\/v1$/i,""))}return e}function kp(e){const t=u(e,500);if(!t)return!0;const n=t.replace(/\/+$/,"");return xp().has(n)}function Sp(e){const t=u(e,200);return t?new Set($r.map(n=>Vn(n))).has(t):!0}function Ap(e){const t=Ee(e);return t!=="lmstudio"&&t!=="ollama"}function Mp(e){const t=Ee(e.provider),n=u(e.endpoint,500)||Tr(t);return t==="ollama"?n.replace(/\/$/,""):/\/embeddings\/?$/i.test(n)?n.replace(/\/$/,""):/\/v1\/?$/i.test(n)?`${n.replace(/\/$/,"")}/embeddings`:n}function Np(e){const t=e&&typeof e=="object"?e:{},n=Array.isArray(t.data)?t.data:[],r=[];for(const a of n){const i=a&&typeof a=="object"?a.embedding:null;if(Array.isArray(i)&&i.every(s=>typeof s=="number"))r.push(i);else throw new Error("임베딩 응답에 숫자 벡터가 없습니다.")}return r}async function Xc(e){const t=e.ok!==!1&&(e.status===void 0||e.status>=200&&e.status<300);if(typeof e.json=="function")try{const n=await e.json();if(!t){const r=typeof n=="object"&&n?JSON.stringify(n).slice(0,400):String(n);throw new Error(`임베딩 HTTP ${e.status??"?"}: ${r}`)}return n}catch(n){if(n instanceof Error&&n.message.startsWith("임베딩 HTTP"))throw n}if(typeof e.text=="function"){const n=await e.text();if(!t)throw new Error(`임베딩 HTTP ${e.status??"?"}: ${n.slice(0,400)}`);return n?JSON.parse(n):{}}throw new Error("임베딩 응답을 읽을 수 없습니다.")}async function fi(e,t,n){if(!t.length)return{vectors:[],model:u(e.model)};const r=Ee(e.provider),a=u(e.model,200)||Vn(r),i=Mp({...e,provider:r,model:a}),s=u(e.api_key,4e3);if(r==="ollama"){const l=[];for(const f of t){const d=(await Xc(await De(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:a,prompt:f}),signal:n?.signal}))).embedding;if(!Array.isArray(d)||!d.every(m=>typeof m=="number"))throw new Error("Ollama 임베딩 응답이 올바르지 않습니다.");l.push(d)}return{vectors:l,model:a}}const o={"Content-Type":"application/json"};s&&(o.Authorization=`Bearer ${s}`);const c=Np(await Xc(await De(i,{method:"POST",headers:o,body:JSON.stringify(r==="voyage"?{model:a,input:t,input_type:"document"}:{model:a,input:t}),signal:n?.signal})));if(c.length!==t.length)throw new Error(`임베딩 개수 불일치: got ${c.length}, want ${t.length}`);return{vectors:c,model:a}}async function Ip(e){const{vectors:t,model:n}=await fi(e,["curation embedding ping"]),r=t[0]?.length||0;if(!r)throw new Error("임베딩 차원이 0입니다.");return{ok:!0,dims:r,model:n}}var di,$r,Zc=$((()=>{L(),Pt(),di=Object.freeze([{value:"openai",label:"OpenAI"},{value:"voyage",label:"Voyage"},{value:"openrouter",label:"OpenRouter"},{value:"openai_compat",label:"OpenAI-compat"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}]),$r=di.map(e=>e.value)})),Ep=dn({LLM_ENDPOINT_PRESETS:()=>ut,LLM_PROVIDERS:()=>al,REASONING_EFFORTS:()=>mi,applyReasoningToBody:()=>rl,defaultEndpointForProvider:()=>el,endpointPresetKeyFor:()=>Tp,ensureLlmRequestUrl:()=>nl,knownLlmEndpoints:()=>tl,llmModelPlaceholder:()=>jp,normalizeLlmProvider:()=>Ft,normalizeReasoningEffort:()=>Qc,shouldAutoReplaceEndpoint:()=>Cp});function Ft(e){const t=String(e||"").toLowerCase().replace(/[ -]+/g,"_").trim();return["openrouter"].includes(t)?"openrouter":["openai"].includes(t)?"openai":["google","google_ai","google_ai_studio","gemini"].includes(t)?"google_ai":["vertex","vertex_ai","google_vertex"].includes(t)?"vertex":["anthropic","anthropic_compat","anthropic_compatible","claude"].includes(t)?"anthropic_compatible":["lmstudio","lm_studio"].includes(t)?"lmstudio":["ollama"].includes(t)?"ollama":["custom"].includes(t)?"custom":["openai_compatible","openai_compat"].includes(t)?"openrouter":"custom"}function Qc(e){const t=String(e??"default").toLowerCase().trim();return!t||t==="auto"||t==="default"?"default":mi.includes(t)?t:"default"}function el(e,t={}){const n=Ft(e);return n==="vertex"?`https://${String(t.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1"}-aiplatform.googleapis.com`:n==="anthropic_compatible"?ut.anthropic:n==="custom"?ut.openai:ut[n]||ut.openai}function tl(){const e=new Set;for(const t of Object.values(ut)){const n=String(t||"").replace(/\/+$/,"");n&&(e.add(n),e.add(n.replace(/\/chat\/completions$/i,"")),e.add(n.replace(/\/v1\/messages$/i,"")),e.add(n.replace(/\/v1$/i,"")))}return e.add("https://us-central1-aiplatform.googleapis.com"),e.add("https://europe-west1-aiplatform.googleapis.com"),e.add("https://asia-northeast1-aiplatform.googleapis.com"),e}function Cp(e){const t=String(e||"").trim().replace(/\/+$/,"");return t?tl().has(t):!0}function nl(e,t,n={}){const r=Ft(t);let a=String(e||"").trim().replace(/\/+$/,"");if(a||(a=el(r,n).replace(/\/+$/,"")),r==="anthropic_compatible")return/\/v1\/messages$/i.test(a)||/\/messages$/i.test(a)?a:/\/v1$/i.test(a)?`${a}/messages`:`${a}/v1/messages`;if(r==="vertex"){const i=String(n.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1",s=String(n.projectId||"").trim();if(s)return`https://${i}-aiplatform.googleapis.com/v1/projects/${encodeURIComponent(s)}/locations/${encodeURIComponent(i)}/endpoints/openapi/chat/completions`;if(/aiplatform\.googleapis\.com/i.test(a)&&!/\/chat\/completions$/i.test(a))return a}return/\/chat\/completions$/i.test(a)?a:/\/openai$/i.test(a)?`${a}/chat/completions`:/\/v1beta$/i.test(a)?`${a}/openai/chat/completions`:/\/v1$/i.test(a)?`${a}/chat/completions`:a}function rl(e,t){const n={};e&&typeof e=="object"&&Object.assign(n,e);const r=Qc(t);return r==="default"||(n.reasoning={effort:r}),n}function jp(e){const t=Ft(e),n={openrouter:"openai/gpt-4o-mini",openai:"gpt-4o-mini",google_ai:"gemini-2.5-flash",vertex:"gemini-2.0-flash-001",anthropic_compatible:"claude-sonnet-4",lmstudio:"local-model",ollama:"llama3.2",custom:"model-id"};return n[t]||n.custom}function Tp(e){const t=String(e||"").trim().replace(/\/+$/,"");for(const[n,r]of Object.entries(ut)){const a=r.replace(/\/+$/,"");if(t===a||t===a.replace(/\/chat\/completions$/i,"")||t===a.replace(/\/v1\/messages$/i,""))return n}return"custom"}var ut,mi,al,Pr=$((()=>{ut=Object.freeze({openai:"https://api.openai.com/v1/chat/completions",openrouter:"https://openrouter.ai/api/v1/chat/completions",google_ai:"https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",lmstudio:"http://127.0.0.1:1234/v1/chat/completions",ollama:"http://127.0.0.1:11434/v1/chat/completions",anthropic:"https://api.anthropic.com/v1/messages",vertex:"https://us-central1-aiplatform.googleapis.com"}),mi=Object.freeze(["default","none","minimal","low","medium","high","xhigh","max"]),al=Object.freeze([{value:"openrouter",label:"OpenRouter"},{value:"openai",label:"OpenAI"},{value:"google_ai",label:"Google AI Studio"},{value:"vertex",label:"Vertex AI (Google Cloud)"},{value:"anthropic_compatible",label:"Anthropic-compatible"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}])}));function Or(e){const t=String(e||"").trim().toLowerCase();return t==="main"||t==="risu_main"||t==="risu-main"?"main":t==="aux"||t==="otherax"||t==="other_ax"||t==="risu_aux"||t==="risu-aux"||t==="sub"||t==="secondary"?"aux":"custom"}function $p(e){const t=Or(e);return t==="main"||t==="aux"}function il(e){const t=e||{};return $p(t.source)?!0:Ft(t.provider)==="vertex"?!!(u(t.model)&&(u(t.api_key)||u(t.service_account_json))):!!(u(t.model)&&u(t.api_key))}function Pp(e){let t="";const n=[];for(const r of e||[]){const a=String(r?.role||""),i=r?.content;if(a==="system"){const s=typeof i=="string"?i:Array.isArray(i)?i.map(o=>typeof o=="object"?o.text||"":String(o)).join(""):String(i??"");t=t?`${t}
${s}`:s;continue}if(Array.isArray(i)){const s=[];for(const o of i){if(!o||typeof o!="object"){const d=String(o||"").trim();d&&s.push({type:"text",text:d});continue}const c=o.image_url,l=(typeof c=="object"&&c?c.url:"")||(typeof c=="string"?c:"");if(o.type==="image_url"||l){const d=String(l).match(/^data:([^;]+);base64,([\s\S]+)$/i);d&&s.push({type:"image",source:{type:"base64",media_type:d[1]||"image/png",data:d[2].replace(/\s+/g,"")}});continue}const f=String(o.text||"").trim();f&&s.push({type:"text",text:f})}n.push({role:a==="assistant"?"assistant":"user",content:s.length?s:[{type:"text",text:""}]});continue}n.push({role:a==="assistant"?"assistant":"user",content:String(i??"")})}return{system:t,messages:n}}function Op(e){const t=e?.choices||[];if(!t.length)throw new Error("LLM returned no choices.");let n=(t[0].message||{}).content;return Array.isArray(n)&&(n=n.map(Br).join("")),u(n)}function Lp(e){const t=e?.content,n=(Array.isArray(t)?t:[]).map(Br).join(""),r=u(n||e?.completion||"");if(!r)throw new Error("Anthropic 응답이 비어 있습니다.");return r}async function Lr(e){if(!Yn(e))return"";const t=e.getReader(),n=typeof TextDecoder<"u"?new TextDecoder:null;let r="",a="";for(;;){const{done:i,value:s}=await t.read();if(i)break;if(typeof s=="string")r=s,a+=s;else if(s instanceof Uint8Array)a+=n?n.decode(s,{stream:!0}):"";else if(s&&typeof s=="object"){const o=s,c=o[0];typeof c=="string"?r=c:typeof o.content=="string"?r=o.content:typeof o.text=="string"&&(r=o.text)}}return n&&(a+=n.decode()),r||a}async function Bp(e){if(typeof e=="string")return e;if(Yn(e))return Lr(e);if(e==null)return"";if(typeof e=="number"||typeof e=="boolean")return String(e);if(typeof e=="object"){const t=e,n=u(t.type,40).toLowerCase();if(n==="fail"||n==="error"){const a=u(t.result||t.message||t.error||"Risu LLM 실패",800);throw new Error(`Risu LLM 실패: ${a}`)}if(n==="streaming"||n==="stream"){const a=await Lr(t.result??t.data??t.stream);if(a.trim())return a}if(n==="success"||n==="ok"){const a=t.result??t.data??t.content;if(typeof a=="string")return a;if(Yn(a))return Lr(a)}const r=[t.choices?.[0]?.message?.content,t.choices?.[0]?.text,t.choices?.[0]?.delta?.content,t.message?.content,t.content,t.text,t.response,n?null:t.result,t.output];for(const a of r){if(typeof a=="string"&&a.trim())return a;if(Array.isArray(a)){const i=a.map(Br).join("");if(i.trim())return i}if(Yn(a)){const i=await Lr(a);if(i.trim())return i}}try{return JSON.stringify(e)}catch{return String(e)}}return String(e||"")}var Yn,Br,pi=$((()=>{L(),Pr(),Yn=e=>!!e&&typeof e.getReader=="function",Br=e=>typeof e=="object"?e?.text||"":String(e||"")}));async function Rp(){try{const e=await Ne(ta,Hi);if(e==null||e==="")return be(tt);const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return be(tt);const n=qa(t),r=nt(tt,n);return JSON.stringify(t)!==JSON.stringify(n)&&await sl(r),r}catch(e){console.warn("[Inlay Nexus] settings load failed",e?.message||e)}return be(tt)}async function sl(e){if(await Ie(ta,be(e)),await Ne("inx_native_settings")==null)throw new Error("설정 저장 실패: IndexedDB(getLocalPluginStorage)에 기록되지 않았습니다.")}var ol=$((()=>{te(),kt(),Gt(),kr()}));async function Fp(){const e=await F("meta","prompt:__pack__"),t=!e||e.text!=="2026-08-06-bg-filter",n=Date.now()/1e3;for(const r of mn)await F("meta",`prompt:${r}`)&&!(t&&Ui.includes(r))||await D("meta",{key:`prompt:${r}`,text:Cn(r),updated_at:n});await D("meta",{key:"prompt:__pack__",text:zi,updated_at:n})}async function le(e){const t=await F("meta",`prompt:${e}`);return t?.text!=null?t.text:Cn(e)}async function cl(e,t){const n=Date.now()/1e3;return await D("meta",{key:`prompt:${e}`,text:t,updated_at:n}),{ok:!0,key:e,updated_at:n}}async function Rr(){const e=await ve("meta"),t=new Map(e.filter(r=>r.key?.startsWith("prompt:")&&!r.key.startsWith("prompt:__")).map(r=>[r.key.slice(7),{key:r.key.slice(7),text:r.text||"",updated_at:r.updated_at||0}])),n=[];for(const r of mn){const a=t.get(r);a?n.push(a):n.push({key:r,text:Cn(r),updated_at:0}),t.delete(r)}for(const r of t.values())n.push(r);return n}async function Dp(){const e=await Rr(),t={};for(const n of e)t[n.key]=n.text;return{version:Ye,prompts:t}}async function zp(e){const t=Hp(e);let n=0;const r=Date.now()/1e3;for(const a of mn)Object.prototype.hasOwnProperty.call(t,a)&&(await D("meta",{key:`prompt:${a}`,text:String(t[a]??""),updated_at:r}),n+=1);return{ok:!0,updated:n,prompts:await Rr()}}async function Up(e){const t=e?.keep_author_note!==!1,n=Date.now()/1e3;let r=0;for(const a of mn)t&&a==="author_note"||(await D("meta",{key:`prompt:${a}`,text:Cn(a),updated_at:n}),r+=1);return{ok:!0,updated:r,keep_author_note:t,prompts:await Rr()}}function Hp(e){let t=e;if(typeof e=="string"){const i=e.trim();if(!i)return{};t=JSON.parse(i)}if(!t||typeof t!="object"||Array.isArray(t))return{};const n=t,r={},a=n.prompts;if(a&&typeof a=="object"&&!Array.isArray(a)){for(const[i,s]of Object.entries(a))typeof i=="string"&&(r[i]=String(s??""));return r}if(Array.isArray(a)){for(const i of a){if(!i||typeof i!="object")continue;const s=i,o=String(s.key||"");o&&(r[o]=String(s.text??""))}return r}if(typeof n.key=="string"&&"text"in n)return r[n.key]=String(n.text??""),r;for(const[i,s]of Object.entries(n))i==="version"||i==="ok"||typeof s=="string"&&(r[i]=s);return r}async function Ke(){const e=be(j());await Gs.run(()=>sl(e))}function Jp(){return sm(j())}async function Kp(e){const t=om(String(e??"").slice(0,2000001)),n=be(j());await D("meta",{key:"settings_backup",value:n,updated_at:Date.now()/1e3});const r=nt(tt,t);return r.llm={...r.llm,api_key:n.llm?.api_key||""},r.nai={...r.nai,api_key:n.nai?.api_key||""},r.auth_token=n.auth_token||"",pr(r),await Ke(),{ok:!0,settings:Fr()}}async function Gp(){const e=be(j());await D("meta",{key:"settings_backup",value:e,updated_at:Date.now()/1e3});const t=be(tt);t.llm={...t.llm,api_key:e.llm?.api_key||""},t.nai={...t.nai,api_key:e.nai?.api_key||""},t.auth_token=e.auth_token||"";const n=e.card;return t.card={...t.card,presets:Array.isArray(n.presets)?be(n.presets):t.card.presets||[],active_preset_id:String(n.active_preset_id||t.card.active_preset_id||""),custom_pos:String(n.custom_pos??t.card.custom_pos??""),custom_neg:String(n.custom_neg??t.card.custom_neg??"")},pr(t),await Ke(),{ok:!0,settings:Fr()}}function qp(){const e=j(),t=e.nai,n=e.llm;let r=0,a=0,i=0,s=0;try{r=On("cards"),a=On("images"),i=Bf();const o=new Set;for(const c of Rf()){const l=u(c.character_id||"",200)||"unknown",f=u(c.chat_id||"",200)||"unknown";o.add(`${l}|${f}`)}s=o.size}catch{}return{ok:!0,version:Ye,pid:0,source_file:"native",nai_configured:Kn(t)==="comfy"?Xa(t):!!u(t.api_key),image_backend:Kn(t),llm_configured:il(n),port:0,image_mode:"data-url",storage:"indexeddb",storage_api:"getLocalPluginStorage",storage_scope:"device-local",cards:r,images:a,folders:s,png_bytes:i,last_stage:An(),focus_stage:_t(),last_error:ur(),debug_events:Qi()}}function Fr(){const e=be(j());e.nai?.api_key?(e.nai.api_key="",e.nai.api_key_configured=!0):e.nai={...e.nai,api_key_configured:!1},e.llm?.api_key?(e.llm.api_key="",e.llm.api_key_configured=!0):e.llm={...e.llm,api_key_configured:!1},e.llm?.service_account_json?(e.llm.service_account_json="",e.llm.service_account_configured=!0):e.llm={...e.llm,service_account_configured:!1};const t=e.nai;t.backend=Kn(t),t.image_backend=t.backend,t.comfy_configured=Xa(t);const n=Js(),r=Ks(),a=!gi.includes(u(t.image_reference));t.image_reference_configured=!!(a&&n),t.image_reference||(t.image_reference=t.image_reference_configured?"file":"none"),t.image_reference_configured&&n&&(t.reference_preview_url=n);const i=!gi.includes(u(t.vibe_transfer));if(t.vibe_transfer_configured=!!(i&&r),t.vibe_transfer||(t.vibe_transfer=t.vibe_transfer_configured?"file":"none"),t.vibe_transfer_configured&&r&&(t.vibe_preview_url=r),Array.isArray(e.card?.presets))for(const c of e.card.presets){if(!c||typeof c!="object")continue;const l=c,f=u(l.id,120),d=f?fa(f):"";d?(l.vibe_configured=!0,l.vibe_preview_url=d):(delete l.vibe_configured,delete l.vibe_preview_url),delete l.vibe_transfer}e.card.character_max=at(e.card),e.database_path="indexeddb:getLocalPluginStorage",e.images_dir="indexeddb:inx_nximg_*",e.prompts_dir="embedded";const s=e.curation&&typeof e.curation=="object"?e.curation:{},o=s.embedding&&typeof s.embedding=="object"?{...s.embedding}:{};return o.api_key?(o.api_key="",o.api_key_configured=!0):o.api_key_configured=!1,s.embedding=o,e.curation=s,e.storage={...e.storage,backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",image_mode:"data-url"},e}async function Wp(e){const t=e&&typeof e=="object"?e:{},n=j(),r={...t.nai||{}},a={...t.llm||{}},i={...t.card||{}};if("api_key"in r){const s=r.api_key;delete r.api_key,delete r.api_key_configured,u(s)&&(n.nai.api_key=s),(r.clearApiKey||t.clear_nai_key)&&(n.nai.api_key=""),delete r.clearApiKey}if("api_key"in a){const s=a.api_key;delete a.api_key,delete a.api_key_configured,u(s)&&(n.llm.api_key=s),(a.clearApiKey||t.clear_llm_key)&&(n.llm.api_key=""),delete a.clearApiKey}if("service_account_json"in a){const s=a.service_account_json;delete a.service_account_json,delete a.service_account_configured,u(s)&&(n.llm.service_account_json=s),(a.clearServiceAccount||t.clear_llm_service_account)&&(n.llm.service_account_json=""),delete a.clearServiceAccount}if(Object.keys(i).length){const s=nt(n.card,i);Array.isArray(i.presets)&&(s.presets=i.presets),"active_preset_id"in i&&(s.active_preset_id=i.active_preset_id),"custom_pos"in i&&(s.custom_pos=i.custom_pos),"custom_neg"in i&&(s.custom_neg=i.custom_neg),n.card=s,n.card.character_max=at(n.card)}if(Object.keys(r).length&&(n.nai=nt(n.nai,r)),Object.keys(a).length&&(n.llm=nt(n.llm,a)),t.curation&&typeof t.curation=="object"){const{updateCurationSettings:s}=await Promise.resolve().then(()=>(Qn(),Qp));await s(t.curation)}for(const s of["bind_host","port","auth_token"])s in t&&(n[s]=t[s]);return await Ke(),{ok:!0,settings:Fr()}}var gi,ft=$((()=>{Gt(),Jn(),te(),q(),kt(),L(),it(),pi(),ol(),Le(),de(),gi=["","none","off","false","0"]}));function ll(e){const t=typeof e=="string"?e:JSON.stringify(e);return hi(Jt(new TextEncoder().encode(t)))}function Vp(e){const t=ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):Y(e);return hi(Jt(t))}async function Yp(e){let t;try{t=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("Vertex Service Account JSON 파싱 실패")}if(!t?.client_email||!t?.private_key)throw new Error("Service Account JSON에 client_email/private_key가 필요합니다.");if(!globalThis.crypto?.subtle)throw new Error("이 환경에서는 Vertex Service Account(JWT) 서명을 지원하지 않습니다. API key 칸에 OAuth access token을 넣거나 Google AI Studio를 쓰세요.");const n=Math.floor(Date.now()/1e3),r=`${ll({alg:"RS256",typ:"JWT"})}.${ll({iss:t.client_email,scope:"https://www.googleapis.com/auth/cloud-platform",aud:"https://oauth2.googleapis.com/token",iat:n,exp:n+3600})}`,a=String(t.private_key).replace(/\\n/g,`
`).replace(/-----BEGIN [^-]+-----/,"").replace(/-----END [^-]+-----/,"").replace(/\s+/g,""),i=Uint8Array.from(atob(a),f=>f.charCodeAt(0)),s=await crypto.subtle.importKey("pkcs8",i,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),o=`${r}.${Vp(await crypto.subtle.sign("RSASSA-PKCS1-v1_5",s,new TextEncoder().encode(r)))}`,c=await De("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`grant_type=${encodeURIComponent("urn:ietf:params:oauth:grant-type:jwt-bearer")}&assertion=${encodeURIComponent(o)}`});let l={};try{l=await c.json()}catch{l={}}if(!l?.access_token)throw new Error(`Vertex 토큰 발급 실패: ${JSON.stringify(l).slice(0,240)}`);return{accessToken:String(l.access_token),projectId:u(t.project_id||"")}}var hi,Xp=$((()=>{Z(),L(),Pt(),hi=e=>e.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}));async function on(e,t){const n=Or(e.source);if(n==="main"||n==="aux")return Zp(e,t,n);const r=Ft(e.provider),a=u(e.model),i=u(e.vertex_region)||"us-central1";let s=u(e.api_key),o="";if(r==="vertex"&&u(e.service_account_json)){const p=await Yp(e.service_account_json);s=p.accessToken,o=p.projectId}if(!a||!s)throw w("llm.config",{message:"missing model/api_key",provider:r},"error"),new Error(r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM이 설정되지 않았습니다. 모델 설정에서 Provider·Model·API key를 넣으세요. (NovelAI 키와 별개)");const c=nl(u(e.endpoint),r,{region:i,projectId:o});if(r==="vertex"&&!/\/chat\/completions$/i.test(c))throw new Error("Vertex AI: project_id가 있는 Service Account JSON이 필요합니다. (OpenAI-compatible endpoint 구성용)");const l=Number(e.timeout_seconds??180)*1e3,f=typeof AbortController<"u"?new AbortController:null,d=setTimeout(()=>{w("llm.abort",{message:`timeout ${l}ms`,model:a,provider:r},"warn"),f?.abort?.()},l),m=fe("llm.call");w("llm.call.start",{message:a,msgs:t?.length||0,timeout_ms:l,source:n,provider:r,reasoning:u(e.reasoning_effort)||"default"});try{let p;if(r==="anthropic_compatible"){const y=Pp(t),k={model:a,max_tokens:Number(e.max_tokens??8e3),temperature:Math.min(1,Number(e.temperature??.4)),messages:y.messages};y.system&&(k.system=y.system),p=await De(c,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":s,"anthropic-version":u(e.anthropic_version)||"2023-06-01"},body:JSON.stringify(k),signal:f?.signal})}else{const y=rl({model:a,messages:t,temperature:Number(e.temperature??.4),max_tokens:Number(e.max_tokens??8e3)},e.reasoning_effort),k={"Content-Type":"application/json",Authorization:`Bearer ${s}`};r==="openrouter"&&(k["HTTP-Referer"]="https://risuai.xyz",k["X-Title"]="Inlay Nexus"),p=await De(c,{method:"POST",headers:k,body:JSON.stringify(y),signal:f?.signal})}const g=Number(p?.status||0);let h;try{h=await p.json()}catch{h={}}if(g>=400)throw m.fail(new Error(`HTTP ${g}`),{status:g,body:JSON.stringify(h).slice(0,200),provider:r}),new Error(`LLM HTTP ${g}: ${JSON.stringify(h).slice(0,500)}`);const _=r==="anthropic_compatible"?Lp(h):Op(h);return m.end({message:a,status:g,bytes:_.length,provider:r}),_}catch(p){throw m.fail(p,{model:a,provider:r}),p}finally{clearTimeout(d)}}async function Zp(e,t,n,r=""){const a=Ae();if(!a||typeof a.runLLMModel!="function")throw new Error("RisuAI runLLMModel API를 사용할 수 없습니다. Risu를 최신으로 업데이트하세요.");const i=n==="main"?"model":"otherAx",s=Math.max(5e3,Number(e.timeout_seconds??180)*1e3),o=u(r)||"",c=fe("llm.call");w("llm.call.start",{message:`risu:${i}`,msgs:t?.length||0,timeout_ms:s,source:n,static_model:o});let l;const f=new Promise((d,m)=>{l=setTimeout(()=>m(new Error(`Risu LLM timeout ${s}ms (${i})`)),s)});try{const d=await Promise.race([a.runLLMModel({mode:i,...o?{staticModel:o}:{},allowPlugins:!0,messages:t}),f]),m=u(await Bp(d));if(!m)throw new Error(`Risu LLM(${i}) 응답이 비어 있습니다.`);return c.end({message:`risu:${i}`,bytes:m.length}),m}catch(d){throw c.fail(d,{mode:i}),d}finally{l!==void 0&&clearTimeout(l)}}var _i=$((()=>{q(),ht(),L(),Pt(),Xp(),Pr(),pi()})),Qp=dn({catalogSha:()=>Wn,curationStatus:()=>Zn,curationTaggerSystemMessage:()=>hl,embedCurationCatalog:()=>ml,getCurationMode:()=>Dr,getCurationStrictIds:()=>zr,getEmbedProgress:()=>ul,getEmbeddingSettingsFromConfig:()=>Xn,loadCurationCatalog:()=>dt,refineShotsWithCuration:()=>_l,resetCurationCatalog:()=>dl,saveCurationCatalog:()=>fl,snapShotsSceneTags:()=>wl,testCurationEmbedding:()=>pl,updateCurationSettings:()=>vl});function ul(){return{...cn}}function Dr(){const e=j(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=Ha(t.mode);if(n!=="off")return n;const r=e.card;return r?.composition_curation===!0||r?.composition_curation==="true"||r?.composition_curation===1?"two_stage":"off"}function zr(){const e=j(),t=e.curation&&typeof e.curation=="object"?e.curation:{};return Ja(t.strict_ids)}function Xn(){const e=j(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=t.embedding&&typeof t.embedding=="object"?t.embedding:{},r=Ee(n.provider);return{provider:r,model:u(n.model,200)||Vn(r),endpoint:u(n.endpoint,500)||Tr(r),api_key:u(n.api_key,4e3)}}async function dt(){const e=await Ne(or);if(e==null||e==="")return ii();try{const t=typeof e=="string"?JSON.parse(e):e;return ri(t)}catch(t){return w("curation.catalog.load",{message:String(t?.message||t)},"warn"),ii()}}async function fl(e){const t=ri(e);await Ie(or,t);const n=await yi();return n&&(n.catalog_sha,t.sha),{ok:!0,status:await Zn()}}async function dl(){const e=ii();return await Ie(or,e),await me(cr),{ok:!0,status:await Zn()}}async function yi(){const e=await Ne(cr);if(e==null||e==="")return null;try{const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return null;const n=t;return Array.isArray(n.items)?n:null}catch{return null}}async function Zn(){const e=await dt(),t=await yi(),n=Wm(e);let r="missing";if(t?.items?.length){r=t.catalog_sha===e.sha?"ready":"stale";const a=Xn(),i=u(a.model);i&&t.model&&t.model!==i&&(r="stale")}return{mode:Dr(),catalog_name:e.name,catalog_sha:e.sha||Wn(e),option_count:n,group_count:e.groups.length,has_presets:Gn(e),embed_status:r,embed_count:t?.items?.length||0,embed_model:t?.model||"",embed_updated_at:t?.updated_at||0,large_warning:n>xl,embed_progress:ul()}}async function ml(e){const t=await dt(),n=zm(t),r=Xn();if(!n.length)throw new Error("임베딩할 카탈로그 항목이 없습니다.");if(Ee(r.provider)!=="ollama"&&Ee(r.provider)!=="lmstudio"&&!u(r.api_key))throw new Error("임베딩 API key가 없습니다. 큐레이팅 탭에서 키를 저장하세요.");const a=(c,l,f)=>{cn={running:c<l,done:c,total:l,message:f},e?.(c,l,f)},i=Ee(r.provider)==="ollama"?1:16,s=[];let o=r.model;a(0,n.length,"임베딩 시작…");try{for(let l=0;l<n.length;l+=i){const f=n.slice(l,l+i);a(l,n.length,`임베딩 중… ${l}/${n.length}`);const{vectors:d,model:m}=await fi(r,f.map(p=>p.text));o=m||o;for(let p=0;p<f.length;p++){const g=f[p],h=d[p];if(!h?.length)throw new Error(`임베딩 실패: ${g.key}`);s.push({key:g.key,groupId:g.groupId,optionId:g.optionId,tags:g.tags,slot:g.slot,vector:h})}}a(n.length,n.length,"저장 중…");const c={catalog_sha:t.sha||Wn(t),model:o,provider:String(r.provider),updated_at:Date.now()/1e3,items:s};return await Ie(cr,c),a(n.length,n.length,"완료"),cn={running:!1,done:n.length,total:n.length,message:"완료"},{ok:!0,status:await Zn()}}catch(c){throw cn={running:!1,done:cn.done,total:n.length,message:`실패: ${c?.message||c}`},c}}async function pl(){const e=Xn();return Ip(e)}function gl(e){return!!(e.base||e.char||e.primary||e.secondary||e.female||e.male)}async function hl(){const e=Dr();if(e==="off")return null;if(e==="embed_snap")return u(await le("curation_embed_hint"),4e3)||Jm();const t=await dt(),n=zr();return Gn(t)?up(t,n):Um(t,n)}async function _l(e,t){if(!e.length)return;const n=u(t?.chatContext,1e5),r=await dt();if(Gn(r)){for(const a of e)Xm(a);if(e.some(a=>!!li(r,{preset_path:a.preset_path,composition_id:a.composition_id,composition_variant:a.composition_variant}))){await tg(r,e,n);return}w("curation.preset_refine",{message:"no composition_id on shots → falling back to group refine"},"warn")}await eg(r,e,n)}function yl(e,t,n){const r=[{role:"system",content:e}];return t&&r.push({role:"user",content:t}),r.push({role:"user",content:JSON.stringify(n)}),r}async function eg(e,t,n){const r=zr(),a=g=>{const h=g.curation_groups;return Array.isArray(h)?h.map(_=>u(_,160)).filter(Boolean):u(h,400).split(/[,|]/).map(_=>_.trim()).filter(Boolean)},i=t.map(a),s=[...new Set(i.flat())];if(!s.length){w("curation.group_refine",{message:"no curation_groups on shots — skip"},"warn");return}const o=Hm(e,s,{strictIds:r}),c=`${u(await le("curation_refine"),6e3)||o}

${o}`,l=Mc(t,n),f={shots:t.map((g,h)=>({shot_index:h,y_percent:g.y_percent??g.anchor_percent??null,...l[h],curation_groups:i[h],camera:g.camera||"",situation:g.situation||g.scene||"",place:g.place||"",action:g.action||"",natural:g.natural||"",character_count:Array.isArray(g.characters)?g.characters.length:0,cast:Uc(g)}))},d=await on(j().llm,yl(c,n,f)),m=oa(d);if(!m||typeof m!="object")return;bl(t,m,(g,h)=>{if(!h||typeof h!="object")return;const _=h.curation_option_ids??h.option_ids,y=zc(e,_);gl(y)?(si(g,y,{place:h.place!=null?h.place:g.place,situation:""}),g.curation_option_ids=_):(h.place!=null&&(g.place=u(h.place,400)),r||(h.camera!=null&&(g.camera=u(h.camera,600)),h.situation!=null&&(g.situation=u(h.situation,600)),h.action!=null&&(g.action=u(h.action,600)))),r&&Array.isArray(h.characters)&&Jc(g,Hc(h.characters),e)})}async function tg(e,t,n){const r=zr(),a=t.map(d=>li(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant}));if(!a.some(Boolean))return;const i=dp(e,a.filter(Boolean),{strictIds:r}),s=Mc(t,n),o={shots:t.map((d,m)=>({shot_index:m,y_percent:d.y_percent??d.anchor_percent??null,...s[m],composition_id:d.composition_id||"",composition_variant:d.composition_variant||"",place:d.place||"",natural:d.natural||"",character_count:Array.isArray(d.characters)?d.characters.length:0,cast:Uc(d)}))};let c=null;try{const d=await on(j().llm,yl(i,n,o));c=oa(d)}catch(d){w("curation.preset_refine",{message:String(d?.message||d)},"warn")}const l=new Map,f=(d,m,p)=>{const g=m&&typeof m=="object"?m.curation_option_ids??m.option_ids:d.curation_option_ids,h=g!=null?$c(e,g):[];for(const x of ap(e,a[p])){const S=[...x.include_options||[],...x.action?.include_options||[]];S.length&&l.set(x.ref,{ids:S,binding:x})}const _=[...l.values()].flatMap(x=>x.ids),y=[...l.values()].map(x=>x.binding),k=cp(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant,curation_option_ids:h},{optionIds:_,bindings:y});if(k&&gl(k)&&(si(d,k,{place:m&&m.place!=null?m.place:d.place,situation:""}),g!=null&&(d.curation_option_ids=h),e.fixed_positive&&(d.curation_fixed_positive=e.fixed_positive)),r){const x=m&&typeof m=="object"?m.characters:void 0;Array.isArray(x)&&Jc(d,Hc(x),e)}};if(c&&typeof c=="object"){bl(t,c,f);return}t.forEach((d,m)=>f(d,null,m))}function bl(e,t,n){const r=Array.isArray(t.shots)?t.shots:Array.isArray(t)?t:null;if(r){for(let a=0;a<e.length;a++){const i=r.find(s=>s&&typeof s=="object"&&Number(s.shot_index)===a);n(e[a],i||r[a],a)}return}e.length===1&&n(e[0],t,0)}async function wl(e){if(!e.length)return{ok:!0,snapped:0};const t=await dt(),n=await yi(),r=t.sha||Wn(t);if(!n?.items?.length)return{ok:!1,reason:"임베딩 없음 → 큐레이션 없이 생성"};if(n.catalog_sha!==r)return{ok:!1,reason:"임베딩 stale → 큐레이션 없이 생성"};const a=e.map(s=>{const o=I(u(s.camera,600),u(s.situation||s.scene,600),u(s.place,400),u(s.action,600));return yp(o)}),i=a.flat();if(!i.length)return{ok:!0,snapped:0};try{const s=Xn(),{vectors:o}=await fi(s,i);let c=0,l=0;for(let f=0;f<e.length;f++){const d=a[f],m=o.slice(c,c+d.length);if(c+=d.length,!d.length)continue;const{baseTags:p,charTags:g,primaryTags:h,secondaryTags:_,femaleTags:y,maleTags:k,snapped:x}=_p(d,m,n.items);l+=x,si(e[f],{base:I(...p),char:I(...g),primary:I(...h),secondary:I(..._),female:I(...y),male:I(...k)},{place:"",situation:""})}return{ok:!0,snapped:l}}catch(s){const o=`임베딩 API 실패 → 큐레이션 없이 생성 (${s?.message||s})`;return w("curation.snap",{message:o},"warn"),{ok:!1,reason:o}}}async function vl(e){const t=j(),n=t.curation&&typeof t.curation=="object"?{...t.curation}:{},r={...n,...e};if(e.mode!=null&&(r.mode=Ha(e.mode)),e.strict_ids!=null&&(r.strict_ids=Ja(e.strict_ids)),e.embedding&&typeof e.embedding=="object"){const a=n.embedding&&typeof n.embedding=="object"?{...n.embedding}:{},i=e.embedding,s={...a,...i};if("api_key"in i){const o=i.api_key;delete s.api_key,delete s.api_key_configured,u(o)&&(s.api_key=o),(i.clearApiKey||e.clear_embedding_key)&&(s.api_key=""),delete s.clearApiKey}s.provider!=null&&(s.provider=Ee(s.provider)),r.embedding=s}return t.curation=r,e.mode!=null&&t.card&&typeof t.card=="object"&&(t.card.composition_curation=!1),pr(t),await Ke(),{ok:!0}}var xl,cn,Qn=$((()=>{Tm(),ci(),mp(),Jn(),wp(),te(),q(),L(),Zc(),kt(),kr(),de(),ft(),_i(),xl=400,cn={running:!1,done:0,total:0,message:""}}));Qn(),te(),q(),bt(),Z(),Pt();async function Ur(e,t,n,r=1,a=3){const i=He(n),s=Math.max(0,Math.min(1,Number(r)||1)),o={image:await Qe(t),information_extracted:s,model:i};let c="";for(let l=1;l<=a;l++)try{w("nai.encode_vibe.start",{message:i,ie:s,attempt:l,focus:!0});const f=await De(qi,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(o)}),d=Number(f?.status||0);if([502,503,504,520].includes(d)){c=`HTTP ${d}`,await Ze(2*l*1e3);continue}if(d<200||d>=300){let g="";try{g=typeof f?.text=="function"?await f.text():""}catch{}if(c=`HTTP ${d}: ${String(g).slice(0,200)}`,l<a){await Ze(1e3);continue}break}const m=await rn(f,{timeoutMs:6e4}),p=await Qe(m);return w("nai.encode_vibe.done",{message:i,bytes:m?.byteLength||0,focus:!0}),p}catch(f){if(c=String(f?.message||f),l<a){await Ze(1e3);continue}}throw new Error(`encode-vibe 실패 (${a}회): ${c}`)}te(),L(),Le(),de(),ft();var bi=12582912,Ge=32;async function ng(){const e=await F("meta","reference_image");return!!(e?.png&&e.png.byteLength>Ge)}async function kl(){return(await F("meta","reference_image"))?.png||null}async function rg(e){if(!e||e.byteLength<Ge)throw new Error("참조 이미지가 비어 있습니다");if(e.byteLength>bi)throw new Error("참조 이미지가 너무 큽니다 (최대 12MB)");return await D("meta",{key:"reference_image",png:e}),la(Tt(e)),j().nai.image_reference="file",await Ke(),{ok:!0,image_reference:"file",configured:!0,bytes:e.byteLength,preview_url:"/v1/nai/reference.png"}}async function Sl(){return await Nt("meta","reference_image"),la(""),j().nai.image_reference="none",await Ke(),{ok:!0,image_reference:"none",configured:!1}}async function ag(){const e=await F("meta","vibe_transfer");return!!(e?.encoded&&e?.png&&e.png.byteLength>Ge)}async function ig(){return await F("meta","vibe_transfer")||null}async function sg(){return(await F("meta","vibe_transfer"))?.png||null}function Hr(e){let t=Number(e??1);return Number.isNaN(t)&&(t=1),Math.max(0,Math.min(1,t))}async function og(e,t={}){if(!e||e.byteLength<Ge)throw new Error("Vibe 이미지가 비어 있습니다");if(e.byteLength>bi)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const n=j(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const a=Je(t.model||n.nai.model||"nai-diffusion-4-5-full"),i=Hr(t.information_extracted??n.nai.vibe_transfer_information_extracted),s=await Ur(r,e,a,i);return await D("meta",{key:"vibe_transfer",png:e,encoded:s,model:He(a),information_extracted:i}),ua(Tt(e)),n.nai.vibe_transfer="file",t.strength!=null&&!Number.isNaN(Number(t.strength))&&(n.nai.vibe_transfer_strength=Math.max(0,Math.min(1,Number(t.strength)))),n.nai.vibe_transfer_information_extracted=i,await Ke(),{ok:!0,vibe_transfer:"file",configured:!0,bytes:e.byteLength,encoded_bytes:s.length,model:He(a),information_extracted:i,preview_url:"/v1/nai/vibe.png"}}async function Al(){return await Nt("meta","vibe_transfer"),ua(""),j().nai.vibe_transfer="none",await Ke(),{ok:!0,vibe_transfer:"none",configured:!1}}async function cg(){const e=await ig();if(!e?.png||e.png.byteLength<Ge)return null;const t=j(),n=u(t.nai.api_key);if(!n)throw new Error("NAI api_key가 설정되지 않았습니다.");const r=He(Je(t.nai.model||"nai-diffusion-4-5-full")),a=Hr(t.nai.vibe_transfer_information_extracted);if(!(!u(e.encoded)||u(e.model)!==r||Math.abs(Number(e.information_extracted??1)-a)>.001))return e;const i=await Ur(n,e.png,r,a),s={...e,key:"vibe_transfer",encoded:i,model:r,information_extracted:a};return await D("meta",s),s}async function Ml(e){const t=u(e,120);return t&&await F("meta",Ut(t))||null}async function lg(e,t,n={}){const r=u(e,120);if(!r)throw new Error("preset_id required");if(!t||t.byteLength<Ge)throw new Error("Vibe 이미지가 비어 있습니다");if(t.byteLength>bi)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const a=j(),i=u(a.nai.api_key);if(!i)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const s=Je(n.model||a.nai.model||"nai-diffusion-4-5-full"),o=Hr(n.information_extracted??a.nai.vibe_transfer_information_extracted),c=await Ur(i,t,s,o),l=Ut(r);await D("meta",{key:l,png:t,encoded:c,model:He(s),information_extracted:o});const f=Tt(t);return gr(r,f),{ok:!0,preset_id:r,vibe_transfer:"file",configured:!0,bytes:t.byteLength,encoded_bytes:c.length,model:He(s),information_extracted:o,preview_url:f}}async function Nl(e){const t=u(e,120);if(!t)throw new Error("preset_id required");return await Nt("meta",Ut(t)),gr(t,""),{ok:!0,preset_id:t,vibe_transfer:"none",configured:!1}}async function ug(e,t){const n=await Ml(e);if(!n?.png||n.png.byteLength<Ge)return!1;const r=u(t,120);if(!r)return!1;await D("meta",{key:Ut(r),png:n.png,encoded:n.encoded||"",model:n.model||"",information_extracted:n.information_extracted??1});const a=fa(e)||(n.png?Tt(n.png):"");return a&&gr(r,a),!0}async function fg(e){const t=await Ml(e);if(!t?.png||t.png.byteLength<Ge)return null;const n=j(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=He(Je(n.nai.model||"nai-diffusion-4-5-full")),i=Hr(n.nai.vibe_transfer_information_extracted);if(!(!u(t.encoded)||u(t.model)!==a||Math.abs(Number(t.information_extracted??1)-i)>.001))return t;const s=await Ur(r,t.png,a,i),o=Ut(u(e,120)),c={...t,key:o,encoded:s,model:a,information_extracted:i};return await D("meta",c),c}async function dg(){for(const e of await ve("meta")){const t=String(e?.key||"");if(!Ht(t))continue;const n=e.png;!n||n.byteLength<Ge||gr(bn(t),Tt(n))}}Gt(),Jn(),te(),q(),L(),Vt(),it(),Qa(),Le(),de(),ft();function Il(e,t){const n=Number(e);return Math.max(1,Math.min(5e3,Number.isFinite(n)&&n>0?Math.round(n):t))}async function Jr(e){const{shot:t,roster:n}=e,r=j().card,a=j().nai,i=at(r),s=ba(t.characters||[],n,i).slice(0,i),o=Math.max(1,s.length),c=eo(r.person_tag_mode,r.auto_person_tags),l=_f(bf(s,n,c,null,r.person_tag_solo),r.person_tag_weight),[f,d]=Tu(await le("preset_1")),m=Array.isArray(r.presets)?r.presets:[],p=u(r.active_preset_id,120);let g=null;m.length&&(p&&(g=m.find(K=>typeof K=="object"&&u(K.id,120)===p)||null),!g&&typeof m[0]=="object"&&(g=m[0]));let h,_;g?(h=u(g.positive||g.pos||""),_=u(g.negative||g.neg||"")):(h=I(u(r.custom_pos),f),_=I(u(r.custom_neg),d));let y=t.situation||t.scene;const k=u(e.lockedSetup||"");let x;k?x=k:(x=I(t.camera,y,t.place,t.action),r.mode==="asset"&&(x=I(x,"white background","simple background","cowboy shot","looking at viewer","portrait")));const S=Ka(r.natural_base),E=S==="supplement"?600:S==="detailed"?480:400,M=S==="off"?"":u(t.natural||t.natural_base||t.nl||"",E);let C="",R="";if(u(t.composition_id,160)||u(t.curation_fixed_positive,200))try{const K=await dt();C=u(t.curation_fixed_positive,800)||u(K.fixed_positive,800),R=u(K.fixed_negative,800)}catch{C=u(t.curation_fixed_positive,800)}let H=I(h,M,x,C);c!=="off"&&(H=Qs(H),x=Qs(x));let N=l?H?`${l}, ${H}`:l:H;const v=Je(a.model||"nai-diffusion-4-5-full");a.apply_quality_tags!==!1&&(N+=En[v]||"");const O=u(a.uc_preset)||"human_focus",J=I(_,R,(Rs[v]||{})[O]||""),he=[],Q=[];for(let K=0;K<s.length;K++){const z=s[K],zt=u(z.name,200),se=zt?we(zt,n):null,gt=I(wf(se,z)),ee=u(z.negative),Ve=o===1?.5:Math.round((.1+.8*K/Math.max(1,o-1))*10)/10,ir=.5;he.push({prompt:gt||"girl",uc:ee,center_x:Ve,center_y:ir}),Q.push({name:se?.name||zt,prompt:gt,uc:ee,center_x:Ve,center_y:ir,raw:z})}return{main:N,neg:J,captions:he,meta:{setup:x,person:l,characters:Q,paragraph:t.paragraph}}}async function El(e,t){const n=j().nai,r=!!j().card?.auto_aspect,a=e.width&&e.height?{width:Il(e.width,832),height:Il(e.height,1216),aspect:"settings"}:Sd(t,n,r),i=e.captions;if(Kn(n)==="comfy"){const x={...n,width:a.width,height:a.height},[S,E]=await km(x,e.main,e.neg,i);return{bytes:S,seed:E}}const s=u(n.api_key);if(!s)throw new Error("NAI api_key가 설정되지 않았습니다.");const o=[],c=u(n.image_reference||"none").toLowerCase();if(!["","none","off","false","0"].includes(c)){const x=await kl();if(x){let S=u(n.image_reference_type||"character&style")||"character&style";["character","style","character&style"].includes(S)||(S="character&style");let E=Number(n.image_reference_strength??.6),M=Number(n.image_reference_fidelity??1);Number.isNaN(E)&&(E=.6),Number.isNaN(M)&&(M=1),o.push({image:x,type:S,strength:Math.max(0,Math.min(1,E)),fidelity:Math.max(0,Math.min(1,M))})}}const l=j().card,f=Array.isArray(l.presets)?l.presets:[],d=u(l.active_preset_id,120);let m=null;f.length&&(d&&(m=f.find(x=>typeof x=="object"&&u(x.id,120)===d)||null),!m&&typeof f[0]=="object"&&(m=f[0]));const p=u(m?.id||d,120),g=cm(n,m),h=[];let _=p?await fg(p):null;if(!_){const x=u(n.vibe_transfer||"none").toLowerCase();["","none","off","false","0"].includes(x)||(_=await cg())}if(_?.encoded){let x=Number(n.vibe_transfer_strength??.6),S=Number(n.vibe_transfer_information_extracted??_.information_extracted??1);Number.isNaN(x)&&(x=.6),Number.isNaN(S)&&(S=1),h.push({encoded:_.encoded,strength:Math.max(0,Math.min(1,x)),information_extracted:Math.max(0,Math.min(1,S))})}const y={prompt:e.main,negative_prompt:e.neg,width:a.width,height:a.height,seed:Number(n.seed??0)||0,steps:Math.min(Number(n.steps??28)||28,28),cfg_scale:g.cfg_scale,cfg_rescale:g.cfg_rescale,sampler:u(n.sampler)||"k_euler_ancestral",scheduler:u(n.scheduler)||"karras",model:Je(n.model||"nai-diffusion-4-5-full"),var_plus:!!n.variety_plus,characters:i,character_refs:o,vibes:h};w("nai.generate.dims",{message:`${y.width}x${y.height}`,aspect:a.aspect,auto_aspect:r,steps:y.steps,focus:!0}),y.seed||(y.seed=Math.floor(Math.random()*4294967295)||1);const k=u(n.request_url)||"https://image.novelai.net/ai/generate-image";return{bytes:(await Ac(s,y,k,{timeoutMs:9e4})).raw_bytes,seed:y.seed||0}}function mg({imageId:e,sessionId:t,request:n,shotIndex:r,paragraph:a,yPercent:i,line:s=null,contentHash:o="",assistantPreview:c=""}){const l=Math.floor(Number(s));return{version:1,image_id:u(e,80),session_id:u(t,200),unified_session_id:u(n.unified_session_id||"",200),character_id:u(n.character_id||"",200),character_name:u(n.character_name||"",200),chat_id:u(n.chat_id||"",200),chat_name:u(n.chat_name||"",200),char_index:P(n.char_index,-1),chat_index:P(n.chat_index,-1),message_index:P(n.message_index,-1),message_role:u(n.message_role||n.role||"",40).toLowerCase(),shot_index:P(r,0),paragraph:P(a,0),y_percent:i,line:Number.isFinite(l)&&l>=1?l:null,content_hash:u(o||n.content_hash||"",128),assistant_preview:u(c||n.assistant_text||"",et)}}async function mt(e){return Ff(e)}async function Cl(e,t){const n=await F("images",e),r=n?{...n}:{id:e},a=t||{};r.location={...a,version:Number(a.version||1),image_id:u(e,80)},await D("images",r)}async function pt(e,t={}){const n=await mt(e),r=typeof t=="object"&&t?t:{};let a=n.y_percent;a==null&&(a=r.y_percent??r.anchor_percent??r.read_percent);const i=Object.keys(n).length>0,s=je(u(e,80));return{character_id:u(n.character_id||r.character_id||"",200),chat_id:u(n.chat_id||r.chat_id||"",200),character_name:u(n.character_name||r.character_name||"",200),chat_name:u(n.chat_name||r.chat_name||"",200),char_index:P(n.char_index??r.char_index,-1),chat_index:P(n.chat_index??r.chat_index,-1),message_index:P("message_index"in n?n.message_index:r.message_index,-1),message_role:u(n.message_role||r.message_role||"",40).toLowerCase(),shot_index:P(n.shot_index,-1),paragraph:P("paragraph"in n?n.paragraph:r.paragraph,0),y_percent:dr(a),line:(()=>{const o=Math.floor(Number(n.line??r.line));return Number.isFinite(o)&&o>=1?o:null})(),content_hash:u(n.content_hash||r.content_hash||"",128),assistant_preview:u(n.assistant_preview||r.assistant_preview||"",et),unified_session_id:u(n.unified_session_id||r.unified_session_id||"",200),location_file:i?`idb:${s}`:"",storage:"indexeddb",storage_key:s}}function wi(e,t,n=0){const r=typeof e=="object"&&e?{...e}:{},a=t||{};return{...r,character_id:u(a.character_id||r.character_id||"",200),chat_id:u(a.chat_id||r.chat_id||"",200),character_name:u(a.character_name||r.character_name||"",200),chat_name:u(a.chat_name||r.chat_name||"",200),char_index:P(a.char_index??r.char_index,-1),chat_index:P(a.chat_index??r.chat_index,-1),message_index:P(a.message_index??r.message_index,-1),message_role:u(a.message_role||r.message_role||"",40).toLowerCase(),content_hash:u(a.content_hash||r.content_hash||"",128),assistant_preview:u(a.assistant_preview||r.assistant_preview||"",et),unified_session_id:u(a.unified_session_id||r.unified_session_id||"",200),y_percent:dr(a.y_percent??r.y_percent),line:(()=>{const i=Math.floor(Number(a.line??r.line));return Number.isFinite(i)&&i>=1?i:null})(),storage:"indexeddb",storage_key:je(u(a.image_id||"",80)),png_bytes:Number(n)||0}}Z();var pg=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t+=1){let n=t;for(let r=0;r<8;r+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e})();function vi(e){return Array.isArray(e)?new Uint8Array(e):Y(e)}function gg(e){const t=vi(e);let n=4294967295;for(let r=0;r<t.length;r+=1)n=pg[(n^t[r])&255]^n>>>8;return(n^4294967295)>>>0}function G(e){const t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e>>>0,!0),t}function pe(e){const t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function er(e){let t=0;for(const n of e)t+=n.length;return Mn(e,t)}function hg(e){return new TextEncoder().encode(String(e??""))}function _g(e=[]){const t=[],n=[];let r=0;for(const s of e){const o=hg(s.name||"file"),c=vi(s.data),l=gg(c),f=er([pe(67324752),G(20),G(0),G(0),G(0),G(0),pe(l),pe(c.length),pe(c.length),G(o.length),G(0),o,c]),d=er([pe(33639248),G(20),G(20),G(0),G(0),G(0),G(0),pe(l),pe(c.length),pe(c.length),G(o.length),G(0),G(0),G(0),G(0),pe(0),pe(r),o]);t.push(f),n.push(d),r+=f.length}const a=er(n),i=er([pe(101010256),G(0),G(0),G(e.length),G(e.length),pe(a.length),pe(r),G(0)]);return er([...t,a,i])}function xi(e,t){return e[t]|e[t+1]<<8}function jl(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function yg(e){const t=vi(e),n=new Map;let r=0;for(;r+30<=t.length;){const a=jl(t,r);if(a===33639248||a===101010256)break;if(a!==67324752){r+=1;continue}const i=xi(t,r+8),s=jl(t,r+18),o=xi(t,r+26),c=xi(t,r+28),l=r+30,f=new TextDecoder().decode(t.subarray(l,l+o)),d=l+o+c,m=d+s;if(m>t.length)break;i===0&&n.set(f.replace(/\\/g,"/"),t.subarray(d,m)),r=m}return n}function bg(e=[],{exportedAt:t=Date.now()}={}){return{format:"inlay-nexus-gallery",version:1,exported_at:t,items:(e||[]).map(n=>({id:String(n.id||""),file:`images/${String(n.id||"unknown")}.png`,location:{character_id:n.character_id||"",chat_id:n.chat_id||"",character_name:n.character_name||"",chat_name:n.chat_name||"",char_index:n.char_index??-1,chat_index:n.chat_index??-1,message_index:n.message_index??-1,content_hash:n.content_hash||"",paragraph:n.paragraph??0,shot_index:n.shot_index??0,y_percent:n.y_percent??null,assistant_preview:n.assistant_preview||"",session_id:n.session_id||""},meta:{main_prompt:n.main_prompt||"",seed:n.seed??null,created_at:n.created_at??null,characters:n.characters||[]}}))}}function wg(e,t=[]){const n=e?.location||{},r=String(n.content_hash||"").trim(),a=t||[];if(r){const l=a.find(f=>String(f.content_hash||"")===r);if(l)return{status:"exact",matchId:String(l.id),content_hash:r}}const i=String(n.character_id||""),s=String(n.chat_id||""),o=Number(n.message_index),c=a.filter(l=>i&&String(l.character_id||"")!==i||s&&String(l.chat_id||"")!==s||Number.isFinite(o)&&o>=0&&Number(l.message_index)!==o?!1:!!(i||s||Number.isFinite(o)&&o>=0)).slice(0,8);return c.length?{status:"candidate",candidates:c.map(l=>({id:l.id,content_hash:l.content_hash,message_index:l.message_index})),location:n}:{status:"orphan",location:n}}function vg(e=[]){return _g(e)}function xg(e){const t=yg(e);let n=null;const r=t.get("manifest.json");if(r)try{n=JSON.parse(new TextDecoder().decode(r))}catch{n=null}const a=new Map;for(const[i,s]of t.entries())i!=="manifest.json"&&/\.(png|webp|jpe?g)$/i.test(i)&&a.set(i.replace(/\\/g,"/"),s);return{manifest:n,images:a,files:t}}te(),q(),Z(),L(),Le();function tr(e){try{const t=JSON.parse(e.meta_json||"{}");return t&&typeof t=="object"?t:{}}catch{return{}}}async function Tl(e,t){return(await Lf(e))?.png_bytes||Number(t.png_bytes)||0}async function ki(e){const t=(await ve("cards")).sort((i,s)=>(s.created_at||0)-(i.created_at||0)).slice(0,Math.max(1,Math.min(2e3,e))),n={},r=[];for(const i of t){const s=tr(i),o=await pt(i.id,s),c=await mt(i.id),l=u(o.character_name||c.character_name||s.character_name||"",200),f=u(o.chat_name||c.chat_name||s.chat_name||"",200),d=u(o.character_id||"",200)||"unknown",m=u(o.chat_id||"",200)||"unknown",p=`${d}|${m}`;let g=n[p];g||(g={key:p,character_id:d,chat_id:m,character_name:l||d.slice(0,12)||"Unknown",chat_name:f||`chat ${o.chat_index??"?"}`,char_index:o.char_index??-1,chat_index:o.chat_index??-1,count:0,storage:"indexeddb"},n[p]=g),l&&!g.character_name&&(g.character_name=l),f&&(g.chat_name=f),g.count+=1,r.push({id:i.id,job_id:i.job_id,session_id:i.session_id,folder_key:p,shot_index:o.shot_index>=0?o.shot_index:i.shot_index,paragraph:Object.keys(c).length?o.paragraph:i.paragraph,y_percent:o.y_percent,line:o.line,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:d,character_name:g.character_name,chat_id:m,chat_name:g.chat_name,char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:u(o.assistant_preview||c.assistant_preview||s.assistant_preview||"",et),main_prompt:i.main_prompt,characters:JSON.parse(i.characters_json||"[]"),image_url:Be(i.id),seed:i.seed,created_at:i.created_at,storage:"indexeddb",storage_key:o.storage_key||je(i.id),location_file:o.location_file||"",png_bytes:await Tl(i.id,s)})}const a={ok:!0,folders:Object.values(n).sort((i,s)=>`${i.character_name||""}`.localeCompare(`${s.character_name||""}`,void 0,{sensitivity:"base"})||`${i.chat_name||""}`.localeCompare(`${s.chat_name||""}`,void 0,{sensitivity:"base"})),items:r,total:r.length,storage:"indexeddb",storage_api:"getLocalPluginStorage"};return await ot(a,{cachedOnly:!0,warmMissing:!1}),a}async function kg(e=400){return ki(e)}async function Sg(e,t=40){const n=(await Ma(e)).sort((i,s)=>(s.created_at||0)-(i.created_at||0)).slice(0,Number(t)),r=[];for(const i of n){const s=tr(i),o=await pt(i.id,s),c=await mt(i.id);r.push({id:i.id,job_id:i.job_id,shot_index:o.shot_index>=0?o.shot_index:i.shot_index,paragraph:Object.keys(c).length?o.paragraph:i.paragraph,y_percent:o.y_percent,line:o.line,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:o.character_id||"",chat_id:o.chat_id||"",character_name:o.character_name||"",chat_name:o.chat_name||"",char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:o.assistant_preview||s.assistant_preview||"",main_prompt:i.main_prompt,negative_prompt:i.negative_prompt,characters:JSON.parse(i.characters_json||"[]"),image_url:Be(i.id),seed:i.seed,created_at:i.created_at,storage:"indexeddb",storage_key:o.storage_key||je(i.id),png_bytes:await Tl(i.id,s)})}const a={ok:!0,session_id:e,items:r,storage:"indexeddb"};return await ot(a,{cachedOnly:!0}),a}async function $l(e={}){const t=u(e.session_id,200),n=u(e.to_hash,128),r=u(e.assistant_preview||"",et),a=(Array.isArray(e.card_ids)?e.card_ids:[]).map(c=>u(c,80)).filter(Boolean);if(!n||!a.length)return{ok:!1,...re("to_hash and card_ids required","bad_request"),rebound:0,ids:[]};const i=new Set(a),s=new Set;for(const c of a){const l=await F("cards",c),f=u(l?.job_id||"",80);f&&s.add(f)}if(s.size&&t)for(const c of await Ma(t)){const l=u(c?.job_id||"",80);if(!l||!s.has(l))continue;const f=u(c?.id||"",80);f&&i.add(f)}const o=[];for(const c of i){const l=await F("cards",c);if(!l||t&&u(l.session_id||"",200)!==t)continue;const f=tr(l),d=await mt(c);if(u(d.content_hash||f.content_hash||"",128)===n)continue;const m={...d,image_id:c,content_hash:n,assistant_preview:r||d.assistant_preview||""};await Cl(c,m),f.content_hash=n,r&&(f.assistant_preview=r),f.message_role=u(f.message_role||d.message_role||"",40).toLowerCase(),l.meta_json=JSON.stringify(f),await D("cards",l),o.push(c)}return w("gallery.rebind",{n:o.length,to:n.slice(0,8)}),{ok:!0,rebound:o.length,ids:o,content_hash:n}}async function Si(e,t="",n=null){const r=u(e,200),a=u(t);let i=null;try{n!=null&&String(n).trim()!==""&&(i=parseInt(String(n),10))}catch{i=null}if(!r||!a&&i==null)return{ok:!0,unlinked:0,ids:[]};const s=(await Ma(r)).sort((c,l)=>(c.created_at||0)-(l.created_at||0)),o=[];for(const c of s){const l=tr(c),f=await pt(c.id,l),d=u(f.content_hash||""),m=P(f.message_index,-1);let p=!1;if((a&&d&&d===a||i!=null&&i>=0&&m===i)&&(p=!0),!p)continue;const g={...await mt(c.id),version:1,image_id:c.id,session_id:r,content_hash:"",message_index:-1,character_id:"",chat_id:"",char_index:-1,chat_index:-1,unlinked_at:Date.now()/1e3};await Cl(c.id,g),(l.content_hash||l.message_index!=null||l.assistant_preview)&&(l.content_hash="",l.assistant_preview="",l.message_index=-1,l.unlinked_at=Date.now()/1e3,c.meta_json=JSON.stringify(l),await D("cards",c)),o.push(c.id)}return{ok:!0,unlinked:o.length,ids:o}}async function Ai(e){const t=u(e,80);return t?await F("cards",t)?(await Nt("cards",t),await Nt("images",t),{ok:!0,deleted:1,ids:[t]}):{ok:!1,...re("card not found","not_found")}:{ok:!1,...re("card_id required","bad_request")}}async function Mi(e){return Ai(e)}async function Ag(e=[]){const t=[...new Set((e||[]).map(r=>u(r,80)).filter(Boolean))],n=[];for(const r of t)(await Ai(r)).ok&&n.push(r);return{ok:!0,deleted:n.length,ids:n}}async function Pl(){const e=(await F("meta","explorer_favorites"))?.ids;return{ok:!0,ids:Array.isArray(e)?e.map(t=>u(t,80)).filter(Boolean):[]}}async function Mg(e=[]){const t=[...new Set((e||[]).map(n=>u(n,80)).filter(Boolean))].slice(0,5e3);return await D("meta",{key:"explorer_favorites",ids:t,updated_at:Date.now()/1e3}),{ok:!0,ids:t}}async function Ng(e={}){let t=(await ki(2e3)).items;const n=u(e.folder_key||"",400);if(!e.all)if(n)t=t.filter(s=>s.folder_key===n);else if(Array.isArray(e.card_ids)&&e.card_ids.length){const s=new Set(e.card_ids.map(o=>u(o,80)));t=t.filter(o=>s.has(o.id))}else return{ok:!1,...re("card_ids, folder_key, or all required","bad_request")};if(!t.length)return{ok:!1,...re("no images to export","empty")};const r=bg(t),a=[{name:"manifest.json",data:new TextEncoder().encode(JSON.stringify(r,null,2))}];for(const s of t){const o=await Ol(s.id);o?.byteLength&&a.push({name:`images/${s.id}.png`,data:Y(o)})}if(a.length<2)return{ok:!1,...re("image bytes missing","empty")};const i=vg(a);return{ok:!0,count:a.length-1,filename:`inlay-gallery-${Date.now()}.zip`,zip_base64:Jt(i),bytes:i.length}}async function Ig(e={}){const t=e.prefer_new_ids===void 0?!0:e.prefer_new_ids,n=String(e.zip_base64||"").replace(/^data:.*base64,/,"");if(!n)return{ok:!1,...re("zip_base64 required","bad_request")};let r;try{r=$e(n)}catch(l){return{ok:!1,...re(`invalid base64: ${l?.message||l}`,"bad_request")}}const{manifest:a,images:i}=xg(r);if(!a?.items?.length)return{ok:!1,...re("manifest.items missing","bad_request")};const s=(await ki(2e3)).items,o=[],c={exact:0,candidate:0,orphan:0,skipped:0};for(const l of a.items){const f=String(l.file||`images/${l.id}.png`).replace(/\\/g,"/"),d=i.get(f)||i.get(`images/${l.id}.png`);if(!d?.byteLength){c.skipped+=1;continue}const m=wg(l,s);c[m.status]=(c[m.status]||0)+1;const p={...l.location||{}},g=t?vt():u(l.id||"",80)||vt(),h=u(p.session_id||"",200)||`import_${vt().replace(/-/g,"").slice(0,10)}`,_={version:1,image_id:g,session_id:h,character_id:u(p.character_id||"",200),character_name:u(p.character_name||"",200),chat_id:u(p.chat_id||"",200),chat_name:u(p.chat_name||"",200),char_index:P(p.char_index,-1),chat_index:P(p.chat_index,-1),message_index:P(p.message_index,-1),shot_index:P(p.shot_index,0),paragraph:P(p.paragraph,0),y_percent:dr(p.y_percent),content_hash:u(p.content_hash||"",128),assistant_preview:u(p.assistant_preview||"",et),imported_at:Date.now()/1e3,reattach:m.status},y=X(d);await Ea(g,y,_);const k=wi({...l.meta||{},assistant_preview:_.assistant_preview,imported_at:_.imported_at,reattach:m.status},_,y.byteLength||0);await D("cards",{id:g,job_id:`import_${g.slice(0,8)}`,session_id:h,shot_index:_.shot_index,paragraph:_.paragraph,main_prompt:u(l.meta?.main_prompt||"",8e3),negative_prompt:"",characters_json:JSON.stringify(l.meta?.characters||[]),seed:l.meta?.seed??0,meta_json:JSON.stringify(k),created_at:Number(l.meta?.created_at)||Date.now()/1e3}),o.push({id:g,reattach:m.status,content_hash:_.content_hash})}return{ok:!0,imported:o.length,items:o,report:c}}async function Eg(e){const t=u(e,400);if(!t||!t.includes("|"))return{ok:!1,...re("folder_key required","bad_request")};const[n,r]=t.split("|",2),a=u(n,200)||"unknown",i=u(r,200)||"unknown",s=await ve("cards"),o=[];for(const c of s){const l=tr(c),f=await pt(c.id,l),d=u(f.character_id||"",200)||"unknown",m=u(f.chat_id||"",200)||"unknown";d!==a||m!==i||(await Ai(c.id)).ok&&o.push(c.id)}return{ok:!0,deleted:o.length,ids:o,folder_key:`${a}|${i}`}}async function Ol(e){return Jf(e)}L(),Le(),de();var Ni=["queued","tagging","generating"];function Kr(e={},t=""){const n=u(t||e.session_id||"",200)||"_",r=u(e.content_hash||"",128);if(r)return`${n}::h:${r}`;const a=P(e.message_index,-1);return a>=0?`${n}::m:${a}`:`${n}::all`}async function Cg(e){if(hr.has(e))return"message-reroll";const t=jn.get(e);if(!t?.jobId)return"";const n=Pe.get(t.jobId);if(!n||n.cancelRequested)return"";const r=await F("jobs",t.jobId);return r&&Ni.includes(String(r.state||""))?t.jobId:""}async function Ii(e={},t=""){const n=await Cg(Kr(e,t));return n?{ok:!1,busy:!0,accepted:!1,job_id:n==="message-reroll"?"":n,session_id:u(t||e.session_id||"",200),job_state:"busy",error:{code:"busy",message:"같은 메시지 작업이 아직 진행 중입니다. 끝날 때까지 기다려 주세요."}}:null}function Ll(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function Bl(e){const t=Ll(e);return t.length?t.map((n,r)=>`L${r+1}|${n}`).join(`
`):""}function jg(e){if(e.length<2)return!1;for(let t=0;t<e.length;t+=1){const n=Math.floor(Number(e[t]));if(!Number.isFinite(n)||n!==t+1)return!1}return!0}function Tg(e,t){const n=Math.max(1,Math.floor(Number(t)||0)),r=new Set;return e.map(a=>{const i=Number(a);let s=n<=1?1:Math.max(1,Math.min(n,Math.round((Number.isFinite(i)?Math.max(0,Math.min(100,i)):50)/100*(n-1))+1));if(!r.has(s))return r.add(s),s;for(let o=1;o<n;o+=1){const c=s+o;if(c<=n&&!r.has(c))return r.add(c),c;const l=s-o;if(l>=1&&!r.has(l))return r.add(l),l}return r.add(s),s})}function $g(e,t){if(!Array.isArray(e)||e.length<2)return e.slice();const n=Ll(t).length;if(n<2||!jg(e.map(a=>a.line)))return e.slice();const r=Tg(e.map(a=>a.y_percent),n);return e.map((a,i)=>({...a,line:r[i]??a.line}))}q(),kt(),L(),Jn(),Vt(),it(),de(),Qn(),ft();function Pg(e){for(let t=e.length-1;t>=0;t--){const n=e[t];if(!n||n.role!=="user")continue;const r=typeof n.content=="string"?n.content:"";if(r.trim()&&!r.startsWith("# Priority: Author"))return r}return""}async function Og(e){const t=nt(j().card,e.card||{}),n=u(e.session_id,200),r=[{role:"system",content:`${mr(await le("tagger"))}

${mr(await le("format"))}`.trim()}];t.char_info&&u(e.character_description)&&r.push({role:"system",content:`${await le("char_inject")}
## {{char}} Info
${u(e.character_description,12e3)}`}),t.user_info&&u(e.persona_description)&&r.push({role:"system",content:`${await le("char_inject")}
## {{user}} Info
${u(e.persona_description,8e3)}`});const a=u(e.assistant_text,2e4),i=Array.isArray(e.source_session_ids)?e.source_session_ids.map(y=>u(y,200)).filter(Boolean):[],s=t.lorebook||t.char_appearance!==!1||t.asset_nai_tags?await Ua(n,u(e.unified_session_id||"",200),u(e.character_id||"",200),i):[],o=od(s);if(t.lorebook){const y=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:null,k=Ro(t.lore_extra),x=cd(e.lorebook||[],a,o,5,1200,y,k),S=[],E=[];for(const C of x){const R=$t(C)||C.always,H=u(C.content||"",R?5e4:1200);if(!H)continue;const N=u(C.comment||"",200),v=N?`### ${N}
${H}`:H;R?S.push(v):E.push(v)}const M=[];S.length&&M.push(`## lb-xnai.lb.extra — OFFICIAL PACK (START)
...
[END OF lb-xnai.lb.extra] Pack finished — text below is not lb-xnai ground truth.`),E.length&&M.push(`## Reference Lorebook (trigger-matched only)
Naming/context only. Not lb-xnai. Do not copy lore prose into tags.

`+E.join(`

`)),w("job.lore.extra",{trigger_keys:Array.isArray(y)?y.length:0,injected:S.length,reference:E.length,sections:x.filter(C=>$t(C)||C.always).map(C=>C.key||"").filter(Boolean).join(" | ")}),M.length&&r.push({role:"system",content:`${await le("lore_inject")}
${M.join(`

`)}`})}const c=async y=>{if(!t.asset_nai_tags)return;const k=[...Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:[],...La(e.lorebook||[],a)];try{const x=await Kd(k);if(x?.block){let S=await le("asset_tags_inject");S=S.includes("{asset_tags_block}")?S.replace("{asset_tags_block}",x.block):`${S}

${x.block}`,r.push({role:"system",content:S}),w("asset-tags.inject",{reason:y,assets:x.packed.assets.map(E=>E.name),triggers:k.length})}else rc(new Map),w("asset-tags.inject.skip",{reason:y,cause:"collect_empty",triggers:k.length})}catch(x){rc(new Map),w("asset-tags.inject.fail",{reason:y,message:String(x?.message||x)},"warn")}};if(t.char_appearance!==!1){const y=s,k=y.filter(E=>Me(E)),x=y.filter(E=>u(E.name,200)&&!Me(E)),S=rf(a,y);if(k.length||x.length||S.length){const E=v=>{const O=u(v.name,200),J=u(v.appearance||"",200),he=u(v.attire||"",160),Q=u(v.accessories||"",120),K=[J?`appearance=${J}`:"",he?`attire=${he}`:"",Q?`accessories=${Q}`:""].filter(Boolean);return K.length?`${O} ← ${K.join(" | ")}`:O},M=S.filter(v=>Me(v)),C=S.filter(v=>!Me(v)),R=M.length?M.map(E).filter(Boolean).join(`
`):"(none)",H=C.length?C.map(v=>`- ${v.name} (aliases: ${br(v).slice(0,8).join(", ")}) → empty appearance; full looks required in new_characters`).join(`
`):"(none)";let N=await le("appearance_inject");N.includes("{registered_block}")&&(N=N.replace("{registered_block}",R)),N=N.includes("{incomplete_block}")?N.replace("{incomplete_block}",H):`${N}

## Incomplete
${H}`,N=N.includes("{detected_block}")?N.replace("{detected_block}",R):`${N}

${R}`,r.push({role:"system",content:N}),w("job.roster.split",{filled:k.map(v=>v.name),incomplete:x.map(v=>v.name),matched:S.map(v=>v.name),matched_with_looks:M.map(v=>v.name),session_id:n})}}await c("asset_nai_tags_on");const l=Ka(t.natural_base),f=at(t),d=Math.max(1,Number(t.image_min??1)||1),m=Math.max(d,Number(t.image_max??3)||3);r.push({role:"system",content:["Every shot MUST include `y_percent` (0–100): reading position top→bottom. Spread across the full range in order (shot0 < shot1 < …); ~even gaps. E.g. 2→~25/~75; 3→~20/~50/~80; 4→~15/~40/~65/~90. Forbidden: all under 40, duplicates, or gaps under ~15 unless 1 shot.","LINE: message lines are labeled `L1|…`, `L2|…`. Set each shot `line` to that L number (illustration sits immediately before that line). Pick the L# whose text matches the shot moment. `paragraph` = shot order (0,1,2…). `line` is NOT shot order. INVALID: emitting line=1,2,3… just because you have 1st/2nd/3rd shots.",d===m?`SHOT COUNT: produce exactly ${m} shot(s) in scenes[].shots (across all scenes).`:`SHOT COUNT: produce between ${d} and ${m} shots in scenes[].shots (across all scenes). Prefer the count that fits the message; never fewer than ${d} or more than ${m}.`,Bg(l),`CHARACTER CAP: at most ${f} characters per shot (char1..char${f}). If more are visible, keep the ${f} most important; fold extras into situation/place.`,t.auto_aspect?"ASPECT (required on every shot): set `aspect` to exactly one of `portrait` (832×1216 vertical), `square` (1024×1024), or `landscape` (1216×832 horizontal). Pick from the scene framing — tall full-body / standing → portrait; equal crop / face close-up square → square; wide group / side-by-side / scenic → landscape. Like Asset Maid size presets 1/5/2.":""].filter(Boolean).join(`
`)});const p=await hl();p&&r.push({role:"system",content:p});const g=[];if(Number(t.include_max||0)>0)for(const y of e.recent_messages||[]){const k=u(y?.role,40)||"char",x=u(y?.content||y?.data,12e3);x&&(a&&x===a&&["char","assistant","bot"].includes(k.toLowerCase())||g.push(`[${k}]
${x}`))}a&&g.push(Bl(a));const h=g.length?g.join(`

`):Bl(a);if(!h)throw new Error("태깅할 메시지 텍스트가 없습니다.");r.push({role:"user",content:h});const _=u(await le("author_note"),8e3);return _&&r.push({role:"user",content:`# Priority: Author's Note
${_}
> These are instructions explicitly given by the user. If in conflict with previous instructions, this section MUST take precedence.`}),r}function Lg(e,t){const n=at(j().card),r=e,a=[];for(const i of r.scenes||[]){const s=u(i.place);for(const o of i.shots||[]){const c={...o,place:s,characters:ba(o.characters||[],[],n).slice(0,n)};a.push(c)}}return $g(a,t??"")}function Bg(e){return e==="off"?"Natural base mode OFF. Omit the `natural` field (or leave it empty). Do not invent natural-language base phrases.":e==="detailed"?["Natural base mode DETAILED. Every shot MUST include `natural`: a compact English phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include framing/vantage when useful (side view, close-up, viewed through, reflected in…), then for each visible person in left-to-right (or front-to-back) order: hair color + age band + gender, facial expression, clothing, and pose/action as separate details.","Multi-person: NEVER use character names — use position (left girl, right boy) or hair. Add shared action and lighting/atmosphere briefly.","Telegraphic and objective. Example: `side view upper body, left red hair adult woman tense smile in coat pulling right blue hair teen boy startled arms pinned, warm cafe light`. Keep ~12–28 words, English only."].join(" "):e==="supplement"?["Natural base mode SUPPLEMENT. Every shot MUST include `natural`: telegraphic English sentences describing what tags cannot express (composition, framing, actions, atmosphere, lighting) for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Keep tags and natural language clearly separated. Multi-person: NEVER use names — identify by position (left girl, bottom boy) or appearance. For each person include facial expression and clothing as distinct details; also hair and pose unless already obvious.","Unusual framing welcome (viewed through, reflected in shards of a broken mirror, behind…). Concise, minimal, objective — no subjective interpretation.","Example: `Side view, upper body. Left: adult woman with red hair, tense smile, coat, pulling. Right: teen boy with blue hair, startled face, arms pinned. Warm cafe lighting.` Prefer ~2–5 short sentences, English only."].join(" "):["Natural base mode SHORT. Every shot MUST include `natural`: a short English natural-language phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include hair color + age band + gender for each visible person, plus the shared action. Example: `red hair adult woman forced hug blue hair boy`. Keep ~6–20 words, English only."].join(" ")}var Rg=dn({HASH_REBIND_THRESHOLD:()=>Fl,PREFIX_MATCH_MIN_CHARS:()=>24,PREFIX_MATCH_THRESHOLD:()=>Ug,SIMILARITY_COMPARE_MAX:()=>800,VIEWER_THUMB_LAYOUT:()=>ne,activeSegmentIndex:()=>Oh,bigramCounts:()=>Ei,buildInlineChatHtml:()=>Dh,canRetargetJobSaveHash:()=>Hl,claimStickyMarkerByCardId:()=>uh,clampPinPercent:()=>qe,clampReadingPercent:()=>Ph,clampShotLine:()=>au,clampThumbScrollOffset:()=>Sh,composeDualProgressBarsHtml:()=>jh,composeProgressToastHtml:()=>Th,composeSingleProgressBarHtml:()=>Zl,composeStickyThumbHtml:()=>hh,createDebouncedSaveQueue:()=>ch,createScrollSettleTracker:()=>sh,createSessionChangeGuard:()=>oh,describeDomApiCompare:()=>Yg,diceBigramRatio:()=>zl,evenAnchorPercent:()=>Oi,expandElementLineEntries:()=>lu,findCardsForMessageIdentity:()=>Ul,findElementIndexForLine:()=>uu,findElementIndexForLineWithFallback:()=>Fh,findHashRebindCandidates:()=>Hg,findPlainLineStartOffset:()=>ou,fitBoxInside:()=>gh,galleryFocusMessage:()=>Gg,galleryForMessage:()=>Kg,galleryIndexFromChildIndex:()=>vh,gallerySelectedCount:()=>Pi,galleryStripContentWidth:()=>kh,galleryStripSplitAt:()=>Wr,hasGenerationInfo:()=>Gl,htmlToPlainLn:()=>Rh,injectInlineImagesIntoHtml:()=>mu,isCharMessageRole:()=>Wg,isMessageSelectionGesture:()=>rh,isNearbyDomIndex:()=>Nh,jobMatchesMessageIdentity:()=>Ti,lineTextOccurrence:()=>cu,linkCardsForMessage:()=>ji,longestCommonPrefixLength:()=>Dl,markerBlockHtml:()=>du,mergeViewerPaintJob:()=>Eh,messageCompactKey:()=>un,messageContextTriplet:()=>Vg,messagesTextOverlapScore:()=>ql,nearbyDomIndexWindow:()=>Ih,nearbyMessageImageIds:()=>Mh,normalizeInlineMatchText:()=>Xr,normalizeMatchText:()=>Gr,normalizeMessageRole:()=>ln,parseAutotagLookJson:()=>Xl,pickMessageIndexNearPoint:()=>nh,pinPercentToPx:()=>Qg,pinPercentToPxFromBottom:()=>eh,pinPxToPercent:()=>Wl,preferNearbyHostIndex:()=>fu,prefixMatchRatio:()=>Ci,rawMessageRole:()=>qr,readingPercentInMessage:()=>Ql,rebindGalleryMessageIndexes:()=>Xg,resolveCardAnchorPercent:()=>$h,resolveChatMessageMatch:()=>Zg,resolveClickSelectionAction:()=>ah,resolveIndexProgress:()=>Ch,resolveStickyThumbPct:()=>mh,resolveStoredPinPercent:()=>th,roleFromGenerationInfo:()=>qg,scaleInlineThumbnail:()=>zg,shouldKeepStickyThumbHidden:()=>dh,shouldRefreshGallery:()=>lh,shouldRewriteStickyThumb:()=>fh,shouldSelectMessageByTextDrag:()=>ih,splitMessageLines:()=>Yr,stickyCornerEdgeBox:()=>Vl,stickyCornerImageBox:()=>yh,stickyPinEdgeBox:()=>wh,stickyPinOverImage:()=>bh,stickyThumbBoxFromPct:()=>ph,stickyThumbNeedsHtmlPaint:()=>_h,stripInlayInlineHtml:()=>ru,thumbIndexAtStripX:()=>xh,visibleGalleryImageIds:()=>Ah}),Fg=528,Dg=720;function b(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Rl(e,t){const n={...e};for(const[r,a]of Object.entries(t||{})){const i=n[r];n[r]=a&&typeof a=="object"&&!Array.isArray(a)?Rl(i&&typeof i=="object"?i:{},a):a}return n}function zg(e){const t=Math.max(1,b(e,100));return{width:Math.max(1,Math.round(Fg*t/100)),height:Math.max(1,Math.round(Dg*t/100)),percent:t}}function Gr(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}var Ug=.6,Fl=.6,P_=24,O_=800;function ln(e){const t=String(e||"").toLowerCase().trim();return t?t==="char"||t==="assistant"||t==="bot"?"char":t==="user"||t==="human"?"user":t:""}function Dl(e,t){const n=String(e||""),r=String(t||""),a=Math.min(n.length,r.length);let i=0;for(;i<a&&n.charCodeAt(i)===r.charCodeAt(i);)i+=1;return i}function Ei(e){const t=String(e||""),n=new Map;if(t.length<2)return n;for(let r=0;r<t.length-1;r+=1){const a=t.charCodeAt(r)+","+t.charCodeAt(r+1);n.set(a,(n.get(a)||0)+1)}return n}function zl(e,t,n=null){const r=String(e||""),a=String(t||"");if(!r||!a)return 0;if(r===a)return 1;if(r.length<2||a.length<2)return 0;const i=n||Ei(r),s=Ei(a);let o=0;for(const[f,d]of s){const m=i.get(f)||0;m&&(o+=Math.min(m,d))}const c=r.length-1,l=a.length-1;return 2*o/(c+l)}function Ci(e,t){const n=Gr(e),r=Gr(t);if(!n||!r)return 0;const a=Math.max(n.length,r.length);if(a<24)return 0;if(n===r)return 1;const i=Dl(n,r)/a;return i>=.6?i:zl(n.length>800?n.slice(0,800):n,r.length>800?r.slice(0,800):r)}function ji(e,t){if(!t)return[];const n=Array.isArray(e)?e:[],r=String(t.hash||"");return r?$i(n.filter(a=>a?.content_hash&&a.content_hash===r)):[]}function Ul(e,t={}){const n=Array.isArray(e)?e:[],r=String(t.characterId||""),a=String(t.chatId||""),i=String(t.sessionId||""),s=Number(t.messageIndex),o=ln(t.role||t.messageRole||"");if(!r||!o||!Number.isFinite(s)||s<0)return[];const c=[];for(const l of n){if(!String(l?.content_hash||"")||String(l?.character_id||"")!==r)continue;const f=String(l?.chat_id||""),d=String(l?.session_id||"");if(a){if(f!==a)continue}else if(i){if(d&&d!==i)continue}else continue;if(Number(l?.message_index)!==s)continue;const m=ln(l?.message_role||l?.role||"");!m||m!==o||c.push(l)}return $i(c)}function Hg(e,t={}){const n=Array.isArray(e)?e:[],r=String(t.newHash||t.hash||""),a=String(t.text||""),i=String(t.characterId||""),s=String(t.chatId||""),o=String(t.sessionId||""),c=Number(t.messageIndex),l=ln(t.role||t.messageRole||"");if(!r||!a||!i||!l||!Number.isFinite(c)||c<0)return[];if(Gr(a).length<24)return[];const f=[];for(const d of Ul(n,{characterId:i,chatId:s,sessionId:o,messageIndex:c,role:l})){const m=String(d?.content_hash||"");if(!m||m===r)continue;const p=String(d?.assistant_preview||"");if(!p)continue;const g=Ci(a,p);g<.6||f.push({card:d,score:g})}return f.sort((d,m)=>m.score-d.score||b(m.card?.created_at)-b(d.card?.created_at)),$i(f.map(d=>d.card))}function Ti(e,t={}){if(!e||e.cancelRequested)return!1;const n=String(t.characterId||""),r=String(t.chatId||""),a=String(t.sessionId||""),i=Number(t.messageIndex),s=ln(t.role||"");if(!n||!s||!Number.isFinite(i)||i<0||String(e.characterId||"")!==n||Number(e.messageIndex)!==i||ln(e.messageRole)!==s)return!1;if(r){if(String(e.chatId||"")!==r)return!1}else if(a){if(e.sessionId&&String(e.sessionId)!==a)return!1}else return!1;return!0}function Hl(e,t={}){if(!Ti(e,t))return!1;const n=String(t.toHash||"").trim(),r=String(t.text||"");return!n||!r||n===String(e?.saveContentHash||"").trim()?!1:Ci(e?.sourcePreview||"",r)>=Fl}function Jl(e){const t=e?.y_percent??e?.anchor_percent??e?.read_percent,n=Number(t);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function Jg(e,t){return Jl(e)-Jl(t)||b(e?.paragraph)-b(t?.paragraph)||b(e?.shot_index)-b(t?.shot_index)||b(t?.created_at)-b(e?.created_at)}function Kl(e,t){return b(t?.created_at)-b(e?.created_at)||b(t?.message_index)-b(e?.message_index)||b(t?.paragraph)-b(e?.paragraph)||b(t?.shot_index)-b(e?.shot_index)}function $i(e){const t=new Map;for(const n of e||[]){const r=`${n?.paragraph??"?"}|${n?.shot_index??n?.id}`,a=t.get(r);(!a||b(n?.created_at)>=b(a?.created_at))&&t.set(r,n)}return[...t.values()]}function Kg(e,t,n=8){const r=new Map;for(const f of e||[]){const d=String(f?.id||"");!d||r.has(d)||r.set(d,f)}const a=[...r.values()],i=Math.max(0,Math.min(64,b(n,8)||8));if(!t)return a.sort(Kl).slice(0,Math.max(1,i||8));const s=ji(a,t).sort(Jg),o=new Set(s.map(f=>String(f.id))),c=String(t.sessionId||""),l=a.filter(f=>!o.has(String(f.id))).filter(f=>!c||!f?.session_id||f.session_id===c).sort(Kl).slice(0,i);return[...s,...l]}function Pi(e,t){return t?ji(e,t).length:0}function Gg(e,t,n){if(e&&Pi(n,e)>0)return e;const r=String(e?.sessionId||e?.session_id||""),a=String(t?.sessionId||t?.session_id||"");return t&&Pi(n,t)>0&&(!r||!a||r===a)?t:e||null}function qr(e){const t=String(e?.role||e?.type||e?.speaker||e?.sender||e?.from||e?.name||"").trim().toLowerCase();return e?.isUser===!0||e?.fromUser===!0||/^(user|human|player|you|me)$/.test(t)||t.includes("user")?"user":e?.isAssistant===!0||e?.isBot===!0||e?.isChar===!0||/^(assistant|bot|char|character|model|ai)$/.test(t)||t.includes("assistant")||t.includes("bot")||t.includes("char")?"char":t==="system"||t==="developer"?"system":""}function Gl(e){const t=e?.generationInfo??e?.generation_info??e?.messageGenerationInfo;return t==null?!1:typeof t=="string"?t.trim().length>0:typeof t=="object"?Object.keys(t).length>0:!0}function qg(e){return Gl(e)?"char":"user"}function Wg(e){if(e&&typeof e=="object")return qr(e)==="char";const t=String(e||"").trim().toLowerCase();return t==="char"||t==="assistant"||t==="bot"}function un(e,t=48){const n=Math.max(1,b(t,48));return String(e||"").replace(/\s+/g,"").slice(0,n)}function Vg(e,t,n=48){const r=Array.isArray(e)?e:[],a=Math.floor(b(t,-1)),i=a>=0&&a<r.length?r[a]:null,s=a>0?r[a-1]:null,o=a>=0&&a<r.length-1?r[a+1]:null;return[un(s?.text,n),un(i?.text,n),un(o?.text,n),qr(i)||String(i?.role||"").trim().toLowerCase()].join("|")}function ql(e,t){const n=String(e||"").replace(/\s+/g,""),r=String(t||"").replace(/\s+/g,"");if(!n||!r)return 0;if(n.includes(r))return r.length;if(r.includes(n))return n.length;let a=0;const i=(o,c,l=8,f=512)=>{let d=l,m=Math.min(o.length,f),p=0;for(;d<=m;){const g=d+m>>1;c.includes(o.slice(0,g))?(p=g,d=g+1):m=g-1}return p};a=Math.max(a,i(r,n),i(n,r));const s=Math.min(r.length,2400);for(let o=0;o+8<=s;o+=32){const c=Math.min(64,s-o);for(let l=c;l>=8;l-=8)if(n.includes(r.slice(o,o+l))){a=Math.max(a,l);break}}return a}function Yg(e,t){const n=String(e||""),r=String(t||""),a=un(n),i=un(r),s=ql(n,r),o=s>=8,c=a.length>0&&a.length<8&&a===i,l=i.slice(0,48),f=a.slice(0,48);return{domChars:n.length,apiChars:r.length,domCompactChars:a.length,apiCompactChars:i.length,shareScore:s,overlap:o,shortExact:c,apiInDom:!!(l&&l.length>=8&&a.includes(l)),domInApi:!!(f&&f.length>=8&&i.includes(f)),apiKey:l,domKey:f}}function Xg(e,t,n){const r=Array.isArray(t)?t:[],a=typeof n=="function"?n:null,i=new Map;if(a)for(let o=0;o<r.length;o+=1){const c=String(r[o]?.text??r[o]?.data??r[o]?.content??""),l=String(a(c)||"");if(!l)continue;const f=Number.isFinite(Number(r[o]?.index))?Number(r[o].index):o,d=i.get(l);d?d.push(f):i.set(l,[f])}let s=0;return{cards:(Array.isArray(e)?e:[]).map(o=>{const c=String(o?.content_hash||""),l=c?i.get(c):void 0;return!c||!l?o:l.length!==1?Number(o?.message_index)!==-1?(s+=1,{...o,message_index:-1}):o:Number(o?.message_index)!==l[0]?(s+=1,{...o,message_index:l[0]}):o}),changed:s}}function Zg(e,t,n,r,a){const i=Array.isArray(t)?t:[],s=Math.floor(b(n,-1)),o=(f,d,m,p=-1)=>({chatIndex:Number.isFinite(Number(f?.index))?Number(f?.index):p>=0?p:s,text:String(f?.text||e||""),role:qr(f)||String(f?.role||"").trim().toLowerCase(),matchMethod:d,score:m});if(!i.length)return{chatIndex:Math.max(0,s),text:String(e||""),role:"",matchMethod:"fallback",score:0};const c=i.length-1-s;if(c>=0&&c<i.length)return o(i[c],"reverse",100,c);const l=Math.max(0,Math.min(i.length-1,c));return o(i[l],"reverse",50,l)}function qe(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(100,Math.floor(n))):Math.max(0,Math.min(100,Math.floor(b(t,0))))}function Qg(e,t,n=22,r=4){const a=Math.max(1,b(t,1)),i=Math.max(1,b(n,1)),s=Math.max(0,b(r,0)),o=Math.floor(a*qe(e,0)/100);return Math.max(s,Math.min(a-i-s,o))}function eh(e,t,n=22,r=8){const a=Math.max(1,b(t,1)),i=Math.max(1,b(n,1)),s=Math.max(0,b(r,0)),o=a-Math.floor(a*qe(e,0)/100)-i;return Math.max(s,Math.min(a-i-s,o))}function Wl(e,t){const n=Math.max(1,b(t,1));return qe(b(e,0)/n*100,0)}function th(e,t,n,r=null){const a=r&&typeof r=="object"?r:{x:38,y:80},i=t==="y"||t==="Y",s=i?b(a.y,80):b(a.x,38),o=i?"overlay_y_pct":"overlay_x_pct",c=i?"overlay_y_offset":"overlay_x_offset",l=String(e?.overlay_pin_origin||""),f=l==="top"||l==="tl"||l==="top-left",d=e?.[o],m=d!=null&&Number.isFinite(Number(d)),p=Number(e?.[c]),g=Number.isFinite(p),h=_=>qe(100-Number(_),s);return m?i&&f?h(d):qe(d,s):g?i?qe((b(n,1)-p)/Math.max(1,b(n,1))*100,s):Wl(p,n):qe(s,s)}function nh(e,t,n=null,r=800){const a=Array.isArray(e)?e:[];if(!a.length)return-1;const i=Math.max(1,b(r,800)),s=Number.isFinite(Number(t))?Number(t):i*.5,o=Number.isFinite(Number(n))?Number(n):null;let c=-1,l=1/0,f=-1,d=1/0;for(let m=0;m<a.length;m+=1){const p=a[m];if(!p)continue;const g=b(p.top,0),h=b(p.bottom,g);if(h<=0||g>=i)continue;const _=(g+h)*.5,y=Number.isFinite(Number(p.left))&&Number.isFinite(Number(p.right))?(Number(p.left)+Number(p.right))*.5:null,k=y!=null&&o!=null?Math.hypot(y-o,_-s):Math.abs(_-s);k<d&&(d=k,f=m);const x=s>=g&&s<=h,S=o==null||!Number.isFinite(Number(p.left))||!Number.isFinite(Number(p.right))||o>=Number(p.left)&&o<=Number(p.right);if(x&&S){const E=Math.max(1,h-g);E<l&&(l=E,c=m)}}return c>=0?c:f}function rh({gesture:e="single",detail:t=1,movement:n=0,textSelecting:r=!1,excludedTarget:a=!1}={}){const i=e==="double"?2:1;return!a&&!r&&b(n,1/0)<=8&&b(t)===i}function ah({gesture:e="single",detail:t=1,pendingDomIndex:n=null,targetDomIndex:r=null}={}){const a=b(t,1);return e==="double"?a===1?{action:"provisional",pendingDomIndex:r}:a===2?{action:"confirm",clearPending:!0,matchedPending:n!=null&&Number(n)===Number(r)}:{action:"ignore"}:a===1?{action:"confirm",clearPending:!0}:{action:"ignore"}}function ih({enabled:e=!0,movement:t=0,hasSelection:n=!1,excludedTarget:r=!1}={}){return!!e&&!r&&!!n&&b(t,0)>8}function sh({delayMs:e=160,onSettle:t}={}){let n=null;const r=Math.max(0,b(e,160)),a=()=>{n=null,typeof t=="function"&&t()};return{bump(){n&&clearTimeout(n),n=setTimeout(a,r)},settleNow(){n&&clearTimeout(n),n=null,a()},cancel(){n&&clearTimeout(n),n=null},get pending(){return n!=null}}}function oh(e=""){let t=String(e||""),n="",r=0;return{observe(a){const i=String(a||"");return!i||i===t?(n="",r=0,!1):i!==n?(n=i,r=1,!1):(r+=1,r<2?!1:(t=n,n="",r=0,!0))},current(){return t},reset(a=""){t=String(a||""),n="",r=0}}}function ch(e,t=300){let n={},r=null,a=null;const i=async()=>a||(a=(async()=>{for(;Object.keys(n).length;){const s=n;n={},await e(s)}})().finally(()=>{a=null}),a);return{enqueue(s){n=Rl(n,s),r&&clearTimeout(r),r=setTimeout(()=>{r=null,i().catch(()=>{})},Math.max(0,b(t,300)))},async flush(){r&&(clearTimeout(r),r=null);do await i();while(Object.keys(n).length||a)},hasPending(){return!!r||!!a||Object.keys(n).length>0}}}function lh(e,t){const n=Array.isArray(e)?e.map(String):[],r=Array.isArray(t)?t.map(String):[];if(n.length!==r.length)return!0;for(let a=0;a<n.length;a+=1)if(n[a]!==r[a])return!0;return!1}function uh(e,t){const n=String(t||"");if(!n||!Array.isArray(e)||!e.length)return null;const r=e.findIndex(i=>String(i?.card?.id||"")===n);if(r<0)return null;const a=e[r];return a?.thumb?(e.splice(r,1),a):null}function fh(e,t){return String(e||"")!==String(t||"")}function dh(e,t,n){if(!e)return!1;const r=String(t||""),a=String(n||"");return!!r&&!!a&&r===a}function mh(e){if(!e.alwaysOn||e.userCollapsed||e.editorOpen)return 0;const t=b(e.settingsPct,0);return t>0?t:0}function ph(e,t,n){const r=Math.max(0,b(e,0)),a=Math.max(0,b(t,0)),i=Math.max(0,b(n,0));return{pct:r,w:Math.max(0,Math.round(a*r/100)),h:Math.max(0,Math.round(i*r/100))}}function gh(e,t,n=0,r=0){const a=Math.max(0,b(e,0)),i=Math.max(0,b(t,0));if(a<=0||i<=0)return{w:0,h:0};const s=Math.max(0,b(n,0)),o=Math.max(0,b(r,0));if(s<=0||o<=0)return{w:a,h:i};const c=Math.min(a/s,i/o);return{w:Math.max(1,Math.round(s*c)),h:Math.max(1,Math.round(o*c))}}function hh(e,t=""){const n=typeof e=="string"?e:"";return n?`<img src="${n}" style="width:100%;height:100%;object-fit:contain;display:block;background:transparent" />`:'<div style="width:100%;height:100%;background:transparent"></div>'}function _h(e,t,n,r){const a=typeof t=="string"?t:"";return a?String(e||"")!==a||String(n||"")!==String(r||""):!1}function yh(e,t,n,r=16){const a=Math.max(1,Math.round(b(t?.w,1))),i=Math.max(1,Math.round(b(t?.h,1))),s=Math.max(a,Math.round(b(n?.width,a))),o=Math.max(i,Math.round(b(n?.height,i))),c=Math.max(0,Math.round(b(r,16))),l=String(e||"bottom-right");return{left:l.includes("left")?c:Math.max(c,s-a-c),top:l.includes("top")?c:Math.max(c,o-i-c),w:a,h:i}}function Vl(e,t,n=16){const r=Math.max(1,Math.round(b(t?.w,1))),a=Math.max(1,Math.round(b(t?.h,1))),i=Math.max(0,Math.round(b(n,16))),s=String(e||"bottom-right");return{w:r,h:a,top:s.includes("top")?i:null,bottom:s.includes("bottom")?i:null,left:s.includes("left")?i:null,right:s.includes("right")?i:null}}function bh(e,t=28,n=6){const r=Math.round(b(e?.left,0)),a=Math.round(b(e?.top,0)),i=Math.max(1,Math.round(b(e?.w,1))),s=Math.max(1,Math.round(b(t,28))),o=Math.max(0,Math.round(b(n,6)));return{left:Math.round(r+(i-s)/2),top:a-o}}function wh(e,t,n=28,r=6,a=16){const i=Vl(e,t,a),s=Math.max(1,Math.round(b(n,28))),o=Math.max(0,Math.round(b(r,6))),c=i.left!=null?i.left:i.right,l=Math.round(b(c,0)+(i.w-s)/2);return{size:s,top:i.top!=null?Math.round(i.top-o):null,bottom:i.bottom!=null?Math.round(i.bottom+i.h+o):null,left:i.left!=null?l:null,right:i.right!=null?l:null}}var ne=Object.freeze({width:64,height:88,gap:8,splitWidth:16,splitExtraMargin:4});function Wr(e,t){const n=Math.max(0,Math.floor(b(t,0))),r=Math.max(0,Math.min(Math.floor(b(e,0)),n));return r>0&&r<n?r:0}function vh(e,t,n){const r=Math.max(0,Math.floor(b(n,0))),a=Math.floor(b(e,-1));if(a<0||r<=0)return-1;const i=Wr(t,r);if(i<=0)return a<r?a:-1;if(a===i)return-1;const s=a>i?a-1:a;return s>=0&&s<r?s:-1}function xh(e,{count:t=0,selectedCount:n=0,thumbWidth:r=ne.width,gap:a=ne.gap,splitWidth:i=ne.splitWidth,splitExtraMargin:s=ne.splitExtraMargin}={}){const o=Math.max(0,Math.floor(b(t,0)));if(o<=0)return-1;const c=b(e,NaN);if(!Number.isFinite(c)||c<0)return-1;const l=Math.max(1,b(r,ne.width)),f=Math.max(0,b(a,ne.gap)),d=Math.max(0,b(i,ne.splitWidth)),m=Math.max(0,b(s,ne.splitExtraMargin)),p=Wr(n,o),g=[];for(let _=0;_<o;_+=1)p>0&&_===p&&g.push({type:"split"}),g.push({type:"thumb",galIdx:_,marginLeft:p>0&&_===p?m:0});let h=0;for(let _=0;_<g.length;_+=1){_>0&&(h+=f);const y=g[_];if(y.type==="split"){if(c>=h&&c<h+d)return-1;h+=d;continue}if(h+=y.marginLeft,c>=h&&c<h+l)return y.galIdx;h+=l}return-1}function kh({count:e=0,selectedCount:t=0,thumbWidth:n=ne.width,gap:r=ne.gap,splitWidth:a=ne.splitWidth,splitExtraMargin:i=ne.splitExtraMargin}={}){const s=Math.max(0,Math.floor(b(e,0)));if(s<=0)return 0;const o=Math.max(1,b(n,ne.width)),c=Math.max(0,b(r,ne.gap)),l=Math.max(0,b(a,ne.splitWidth)),f=Math.max(0,b(i,ne.splitExtraMargin)),d=Wr(t,s),m=s+(d>0?1:0);let p=s*o+Math.max(0,m-1)*c;return d>0&&(p+=l+f),p}function Sh(e,t,n){const r=Math.max(0,b(t,0)-Math.max(0,b(n,0))),a=b(e,0);return Math.max(0,Math.min(r,a))}function Ah(e,t=0,n=1,r=8,a=0){const i=Array.isArray(e)?e:[];if(!i.length)return[];const s=Math.max(0,Math.min(b(t,0),i.length-1)),o=Math.max(1,Math.min(i.length,b(r,8)||8)),c=Math.min(o,1+2*Math.max(0,b(n,1))),l=Math.max(c,o);let f=Math.max(0,s-Math.floor((l-1)/2));const d=Math.min(i.length-1,f+l-1);f=Math.max(0,d-l+1);const m=[],p=new Set,g=_=>{const y=String(i[_]?.id||"");!y||p.has(y)||(p.add(y),m.push(y))},h=Math.max(0,Math.min(i.length,b(a,0)));for(let _=0;_<h;_+=1)g(_);for(let _=f;_<=d&&(g(_),!(m.length>=o));_+=1);return m}function Mh(e,t,n=2,r=[]){const a=Array.isArray(e)?e:[],i=Math.max(0,Math.min(8,b(n,2))),s=b(t?.messageIndex??t?.message_index,NaN),o=String(t?.sessionId||t?.session_id||""),c=String(t?.chatId||t?.chat_id||""),l=String(t?.hash||""),f=new Set,d=[],m=p=>{const g=String(p||"");!g||f.has(g)||(f.add(g),d.push(g))};for(const p of r||[])m(p);for(const p of a){if(!p?.id||o&&p.session_id&&String(p.session_id)!==o||c&&p.chat_id&&String(p.chat_id)!==c)continue;const g=b(p.message_index,NaN);if(Number.isFinite(s)&&Number.isFinite(g)){Math.abs(g-s)<=i&&m(p.id);continue}l&&String(p.content_hash||"")===l&&m(p.id)}return d}function Nh(e,t,n=2){const r=b(e,NaN),a=b(t,NaN);if(!Number.isFinite(r)||!Number.isFinite(a))return!1;const i=Math.max(0,b(n,2));return Math.abs(r-a)<=i}function Ih(e,t,n=2){const r=Math.max(0,Math.floor(b(t,0))),a=Math.max(0,Math.min(Math.max(0,r-1),Math.floor(b(e,0)))),i=Math.max(0,Math.floor(b(n,2)));return r<=0?{lo:0,hi:-1,center:0}:{lo:Math.max(0,a-i),hi:Math.min(r-1,a+i),center:a}}var Yl={chrome:1,content:2,full:3};function Eh(e,t){const n=Yl[String(e??"")]||0,r=Yl[String(t??"")]||0;return!n&&!r?"full":r>=n?t||e||"full":e||t||"full"}function Xl(e){const t=String(e||"").trim();if(!t)return{appearance:"",attire:"",accessories:"",text:"",gender:""};let n=null;const r=t.match(/```(?:json)?\s*([\s\S]*?)```/i),a=(r?r[1]:t).trim().match(/\{[\s\S]*\}/);if(a)try{const s=JSON.parse(a[0]);n=s&&typeof s=="object"?s:null}catch{n=null}if(n&&typeof n=="object"){const s=String(n.appearance??n.look??n.identity??"").trim(),o=String(n.attire??n.clothing??n.outfit??"").trim(),c=String(n.accessories??n.accessory??n.props??"").trim(),l=String(n.gender??n.sex??"").trim().toLowerCase(),f=["girl","female","f","woman"].includes(l)?"girl":["boy","male","m","man"].includes(l)?"boy":l==="other"?"other":"";return{appearance:s,attire:o,accessories:c,text:[s,o,c].filter(Boolean).join(", "),gender:f}}const i=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,"").trim();return{appearance:i,attire:"",accessories:"",text:i,gender:""}}function Ch(e={}){const t=!!e.warmBusy,n=Math.max(0,Math.min(100,Math.round(b(e.warmPct,0)))),r=String(e.jobState||""),a=Math.max(0,Math.min(100,Math.round(b(e.jobPct,0))));return t?{pct:Math.max(t?6:0,n),busy:!0,label:"인덱싱"}:r==="tagging"?{pct:Math.max(6,a),busy:!0,label:"인덱싱"}:{pct:0,busy:!1,label:"인덱싱"}}function jh(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=Math.max(t?6:0,Math.min(100,Math.round(b(e.jobPct,0)))),a=Math.max(n?6:0,Math.min(100,Math.round(b(e.indexPct,0)))),i=e.error?"#f87171":"#7c6cff",s="#2dd4bf",o=(c,l)=>`<span style="display:block;height:4px;border-radius:2px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${c}%;background:${l}"></span></span>`;return`<span style="flex:0 0 120px;display:flex;flex-direction:column;gap:3px;justify-content:center">${o(r,i)}${o(a,s)}</span>`}function Zl(e={}){const t=!!e.busy,n=Math.max(t?6:0,Math.min(100,Math.round(b(e.pct,0)))),r=String(e.tone||"");return`<span style="flex:0 0 120px;display:block;height:6px;border-radius:3px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${n}%;background:${e.error?"#f87171":r==="index"?"#2dd4bf":"#7c6cff"}"></span></span>`}function Th(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=!!e.busy||t||n;if(!r&&!e.error)return"";const a=typeof e.escapeHtml=="function"?e.escapeHtml:f=>String(f).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),i=String(e.tone||(!t&&n?"index":"job")),s=a(String(e.stage||(i==="index"?"인덱싱":"작업 중")).slice(0,80)),o=a(String(e.meta||"").slice(0,160));let c=e.pct;c==null&&(t?c=e.jobPct:n?c=e.indexPct:c=Math.max(b(e.jobPct,0),b(e.indexPct,0)));const l=Zl({pct:c,busy:r||!!e.error,error:e.error,tone:i});return`<div data-inlay-progress-toast="1" style="display:flex;align-items:center;gap:10px;min-width:220px;max-width:min(420px,92vw);padding:10px 14px;border-radius:8px;background:#121820;border:1px solid #2a3344;cursor:pointer;user-select:none"><span style="flex:0 0 auto;font-weight:700;color:${e.error?"#f87171":i==="index"?"#5eead4":"#c4b5fd"};font-size:11px;white-space:nowrap">${s}</span><span style="min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8b97ab;font-size:11px">${o}</span>${l}</div>`}function Vr(e){return Math.max(0,Math.min(100,b(e,0)))}function Oi(e,t){const n=Math.max(1,b(t,1));return Math.max(0,Math.min(b(e,0),n-1))/n*100}function $h(e,t=0,n=1,r=null){if(r&&r.forceEven)return Oi(t,n);const a=e?.y_percent??e?.anchor_percent??e?.read_percent,i=Number(a);return Number.isFinite(i)?Vr(i):Oi(t,n)}function Ql(e,t,n=.5){if(!e)return null;const r=Math.max(1,b(e.height,0)),a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return a<b(e.top,0)||a>b(e.bottom,0)?null:Vr((a-b(e.top,0))/r*100)}function Ph(e,t,n=.5){const r=Ql(e,t,n);if(r!=null)return r;const a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return b(e?.bottom,0)<a?100:0}function Oh(e,t){const n=Array.isArray(e)?e:[];if(!n.length)return-1;const r=Vr(t),a=n.map(c=>Vr(c)),i=a.reduce((c,l,f)=>l<=20?c.concat(f):c,[]),s=i.length===1&&a[i[0]]>0?a.map((c,l)=>l===i[0]?1:c):a;if(s[0]>0&&r<s[0])return-1;let o=0;for(let c=0;c<s.length;c+=1)r>=s[c]&&(o=c);return o}var eu="data-inlay-inline-shot",tu=/^<\/(?:p|div|li|blockquote|h[1-6]|tr)>$/i,nu=/^<br\s*\/?>$/i;function ru(e){const t=String(e||"");return t?t.replace(/<div[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/div>/gi,"").replace(/<(?:span|p)[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/(?:span|p)>/gi,""):""}function Yr(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function au(e,t){const n=Math.floor(Number(e)),r=Math.max(0,Math.floor(Number(t)||0));return!r||!Number.isFinite(n)||n<1?null:Math.max(1,Math.min(r,n))}function iu(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Lh(e){const t=e.toLowerCase();if(t==="&nbsp;")return" ";if(t==="&amp;")return"&";if(t==="&lt;")return"<";if(t==="&gt;")return">";if(t==="&quot;")return'"';if(t==="&#39;"||t==="&apos;")return"'";const n=/^&#(\d+);$/.exec(e);if(n){const a=Number(n[1]);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}const r=/^&#x([0-9a-f]+);$/i.exec(e);if(r){const a=Number.parseInt(r[1],16);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}return null}function Bh(e,t){let n=Math.max(0,Math.min(e.length,Math.floor(t)));for(;n>0;){let r=n;for(;r>0&&/[ \t\r\n]/.test(e[r-1]);)r-=1;if(r<=0||e[r-1]!==">")break;const a=e.lastIndexOf("<",r-1);if(a<0||a>=r-1)break;const i=e.slice(a,r);if(nu.test(i)||tu.test(i)||/^<\//.test(i)||!/^<[a-zA-Z][^>]*>$/.test(i))break;n=a}return n}function su(e){const t=[];let n=0;const r=String(e||"");for(;n<r.length;){if(r[n]==="<"){const o=r.indexOf(">",n);if(o<0)break;const c=r.slice(n,o+1);(nu.test(c)||tu.test(c))&&t.push({ch:`
`,htmlIndex:n}),n=o+1;continue}if(r[n]==="&"){const o=r.indexOf(";",n);if(o>n&&o-n<16){const c=Lh(r.slice(n,o+1));if(c!=null){for(let l=0;l<c.length;l+=1)t.push({ch:c[l],htmlIndex:n});n=o+1;continue}}}t.push({ch:r[n],htmlIndex:n}),n+=1}const a=[];for(let o=0;o<t.length;o+=1){const c=t[o];if(c.ch!==`
...
`||s[s.length-1].ch===" ");)s.pop();return s}function Rh(e){return su(String(e||"")).map(t=>t.ch).join("")}function ou(e,t){const n=String(e??"").replace(/\r\n/g,`
`),r=Math.floor(Number(t));if(!Number.isFinite(r)||r<1)return null;let a=0,i=0;for(;i<=n.length;){const s=n.indexOf(`
`,i),o=s<0?n.length:s,c=n.slice(i,o);if(c.trim()&&(a+=1,a===r)){const l=/^\s*/.exec(c)?.[0].length||0;return i+l}if(s<0)break;i=s+1}return null}function Xr(e){return String(e??"").replace(/\s+/g," ").trim()}function cu(e,t){const n=Array.isArray(e)?e:[],r=Math.floor(Number(t))-1;if(!Number.isFinite(r)||r<0||r>=n.length)return null;const a=Xr(n[r]);if(!a)return null;let i=0;for(let s=0;s<=r;s+=1)Xr(n[s])===a&&(i+=1);return{text:a,occurrence:i}}function lu(e){const t=[],n=Array.isArray(e)?e:[];for(let r=0;r<n.length;r+=1)for(const a of Yr(n[r])){const i=Xr(a);i&&t.push({text:i,elementIndex:r})}return t}function uu(e,t,n){const r=cu(t,n);if(!r)return-1;const a=lu(e);let i=0;for(const s of a)if(s.text===r.text&&(i+=1,i===r.occurrence))return s.elementIndex;return-1}function fu(e,t,n=["P"]){const r=(Array.isArray(e)?e:[]).map(s=>String(s||"").toUpperCase()),a=Math.floor(Number(t));if(!Number.isFinite(a)||a<0||a>=r.length)return-1;const i=new Set((Array.isArray(n)&&n.length?n:["P"]).map(s=>String(s||"").toUpperCase()));if((r[a]||"")!=="DIV")return a;for(let s=1;s<r.length;s+=1){const o=a-s,c=a+s;if(o>=0&&i.has(r[o]))return o;if(c<r.length&&i.has(r[c]))return c}return-1}function Fh(e,t,n,r,a=["P"]){const i=Array.isArray(n)?n:[],s=Math.floor(Number(r));if(!Number.isFinite(s)||s<1||!i.length)return null;const o=i.length;for(let c=Math.max(1,s);c<=o;c+=1){const l=fu(t,uu(e,i,c),a);if(l>=0)return{elementIndex:l,usedLine:c}}return null}function du(e,t){const n=Number.isFinite(Number(e.shotIndex))?String(Math.floor(Number(e.shotIndex))):"",r=iu(String(e.cardId||(e.pending?`pending-${n||e.line}`:"")||n||e.line||"0")),a="display:block;margin:10px 0;text-align:center;line-height:0;max-width:100%;box-sizing:border-box";return e.pending||!/^data:image\//i.test(String(e.src||""))?`<div ${eu}="${r}" data-inlay-inline-pending="1" x-inlay-inline-shot="${r}" contenteditable="false" style="${a}"><br><br><span style="display:inline-flex;align-items:center;justify-content:center;min-width:48px;min-height:48px;padding:10px;border-radius:12px;background:rgba(124,108,255,.12);border:1px solid rgba(196,181,253,.35)"><svg width="28" height="28" viewBox="0 0 28 28" style="display:inline-block;vertical-align:middle" aria-hidden="true"><circle cx="14" cy="14" r="11" fill="none" stroke="rgba(255,255,255,.18)" stroke-width="3"/><circle cx="14" cy="14" r="11" fill="none" stroke="#c4b5fd" stroke-width="3" stroke-linecap="round" stroke-dasharray="18 52"><animateTransform attributeName="transform" type="rotate" from="0 14 14" to="360 14 14" dur="0.75s" repeatCount="indefinite"/></circle></svg></span><br><br></div>`:`<div ${eu}="${r}" x-inlay-inline-shot="${r}" contenteditable="false" style="${a}"><br><img src="${iu(e.src)}" alt="" style="width:auto;height:auto;max-width:min(60%,100%);max-height:min(70vh,900px);object-fit:contain;border-radius:8px;display:inline-block;vertical-align:top" loading="eager" decoding="async"><br></div>`}function mu(e,t,n){const r=ru(e),a=Array.isArray(t)?t:[];if(!r||!a.length)return r;const i=su(r),s=i.map(g=>g.ch).join(""),o=Yr(s).length;if(!o||!i.length)return r;const c=new Map,l=new Set;for(const g of a){const h=au(g?.line,o),_=String(g?.src||""),y=String(g?.cardId||""),k=g?.pending===!0||!!h&&!/^data:image\//i.test(_);h&&(!k&&!/^data:image\//i.test(_)||y&&l.has(y)||c.has(h)||(y&&l.add(y),c.set(h,{...g,line:h,src:_,pending:k})))}if(!c.size)return r;const f=n?.maxWidthPx,d=new Map;for(const[g,h]of c){const _=ou(s,g);if(_==null||_<0||_>=i.length)continue;const y=Bh(r,i[_].htmlIndex);d.has(y)||d.set(y,du(h,f))}if(!d.size)return r;const m=[...d.entries()].map(([g,h])=>({htmlIndex:g,html:h})).sort((g,h)=>h.htmlIndex-g.htmlIndex);let p=r;for(const g of m)p=p.slice(0,g.htmlIndex)+g.html+p.slice(g.htmlIndex);return p}function Dh(e,t,n){const r=Yr(e);return r.length?mu(r.map(a=>String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")).join("<br>"),t,n):""}te(),q(),L(),kt(),Pt(),_i(),it(),Vt(),Le(),de(),Qn(),ft();var pu=5e3;async function zh(e,t){const n=u(t||"",128),r=Pe.get(e),a=u(r?.saveContentHash||"",128);if(a&&n&&a!==n)return{contentHash:a,assistantPreview:u(r?.saveAssistantPreview||"",wn)};const i=r?.publishedIds||[];for(const s of i)try{const o=await mt(s),c=u(o?.content_hash||"",128);if(c&&n&&c!==n)return{contentHash:c,assistantPreview:u(o?.assistant_preview||"",wn)}}catch{}return{contentHash:n,assistantPreview:""}}async function Uh(e={}){const t={sessionId:u(e.session_id||"",200),characterId:u(e.character_id||"",200),chatId:u(e.chat_id||"",200),messageIndex:P(e.message_index,-1),role:e.role||""};if(!t.characterId||t.messageIndex<0)return{ok:!0,busy:!1};for(const[n,r]of Pe.entries()){if(!Ti(r,t))continue;const a=await F("jobs",n),i=String(a?.state||"");if(Ni.includes(i))return{ok:!0,busy:!0,job_id:n,state:i,content_hash:u(r.saveContentHash||"",128)}}return{ok:!0,busy:!1}}async function Hh(e={}){const t=u(e.to_hash||"",128),n=u(e.assistant_preview||e.assistant_text||"",wn),r={toHash:t,text:n,sessionId:u(e.session_id||"",200),characterId:u(e.character_id||"",200),chatId:u(e.chat_id||"",200),messageIndex:P(e.message_index,-1),role:e.role||""};if(!t||!n||!r.characterId||r.messageIndex<0)return{ok:!1,error:{code:"bad_request",message:"to_hash, text, character_id, message_index required"},retargeted:!1};for(const[a,i]of Pe.entries()){if(!Hl(i,r))continue;const s=await F("jobs",a),o=String(s?.state||"");if(!Ni.includes(o))continue;i.saveContentHash=t,i.saveAssistantPreview=n;let c=0;if(i.publishedIds?.length)try{const l=await $l({session_id:r.sessionId||i.sessionId,card_ids:[...i.publishedIds],to_hash:t,assistant_preview:n});c=Number(l?.rebound||0)}catch{}return w("job.retarget",{job_id:a,to:t.slice(0,8),msg:r.messageIndex,rebound:c,focus:!0}),{ok:!0,retargeted:!0,job_id:a,content_hash:t,rebound:c}}return{ok:!0,retargeted:!1,job_id:"",content_hash:t}}var Jh=2500,Kh=64;function Gh(e,t,n){const r=Kr(t,n),a=(jn.get(r)?.epoch||0)+1;jn.set(r,{epoch:a,jobId:e});const i=u(t.assistant_text||"",wn),s=u(t.content_hash||"",128);return Pe.set(e,{key:r,epoch:a,cancelRequested:!1,publishedIds:[],saveContentHash:s,saveAssistantPreview:i,sourcePreview:i,sessionId:n,characterId:u(t.character_id||"",200),chatId:u(t.chat_id||"",200),messageIndex:P(t.message_index,-1),messageRole:u(t.message_role||t.role||"",40).toLowerCase()}),{key:r,epoch:a}}function qh(e){const t=Pe.get(e);if(!t||t.cancelRequested)return!1;const n=jn.get(t.key);return!!(n&&n.jobId===e&&n.epoch===t.epoch)}async function Wh(e){const t=Pe.get(e),n=t?.publishedIds?[...t.publishedIds]:[];t&&(t.publishedIds=[]);for(const r of n)try{await Mi(r)}catch{}return n.length}async function Ce(e,t="interrupted"){if(qh(e))return!1;const n=await Wh(e);return await ge(e,"cancelled",{phase:"cancelled",progress:0,message:`${t}${n?` · discarded ${n}`:""}`,shot_count:0,shot_done:0},null),w("job.cancelled",{job_id:e,message:t,discarded:n,focus:!0}),!0}function nr(e={}){return{shot_count:e.shot_count??0,shot_index:e.shot_index??0,shot_done:e.shot_done??0,progress:e.progress??0,phase:e.phase||"generating",message:e.message||"",cards_so_far:e.cards_so_far,pending_inline:Array.isArray(e.pending_inline)?e.pending_inline:void 0,pending_message_index:Number.isFinite(Number(e.pending_message_index))?Number(e.pending_message_index):void 0,debug_stage:_t()||An(),debug_error:ur()?.message||""}}function Vh(e){return!e||typeof e!="object"?e:JSON.parse(JSON.stringify(e,(t,n)=>{if(t==="image_url"&&typeof n=="string"&&n.startsWith("data:"))return"";if(!(t==="tagged"||t==="appearance"||t==="debug_tail"))return n}))}async function ge(e,t,n=null,r=null){const a=await F("jobs",e);if(!a)return;const i=a.state,s={...a,state:t},o=Vh(n);s.result_json=o!=null?JSON.stringify(o):null,s.error=r,s.updated_at=Date.now()/1e3;const c=t!=="generating"||i!=="generating"||!!r;await D("jobs",s,{persist:c}),(t==="done"||t==="error"||t==="cancelled")&&await bo(),w("job.set",{message:`${t}${r?" ERR":""}${c?"":" (mem)"}`,job_id:e,state:t,persist:c,err:r?String(r).slice(0,160):"",background:t==="generating",focus:t!=="generating"})}async function gu(e){if(!(j().card||{}).power&&!e.force)throw new Error("Power가 OFF 상태입니다.");const t=u(e.session_id,200)||`sess_${vt().replace(/-/g,"").slice(0,12)}`,n={...e,session_id:t},r=await Ii(n,t);if(r)return w("job.busy",{message:r.error.message||"busy",key:Kr(n,t),focus:!0},"warn"),r;const a=vt(),i=Date.now()/1e3;if(Gh(a,n,t),n.force)try{await Si(t,u(n.content_hash||""),n.message_index)}catch{}return await D("jobs",{id:a,session_id:t,state:"queued",request_json:JSON.stringify(n),result_json:null,error:null,created_at:i,updated_at:i}),Zh(a).catch(async s=>{console.error("[Inlay Nexus] job crashed",a,s);try{await ge(a,"error",null,String(s?.message||s).slice(0,1500))}catch{}}),{ok:!0,accepted:!0,job_id:a,session_id:t,job_state:"queued"}}async function Yh(e){const t=await F("jobs",e);if(!t)return{ok:!1,error:{code:"not_found",message:"job not found"}};const n=t.result_json?JSON.parse(t.result_json):null,r={};if(n&&typeof n=="object")for(const a of["shot_count","shot_index","shot_done","progress","phase","message","cards_so_far","pending_inline","pending_message_index","debug_stage","debug_error"])a in n&&(r[a]=n[a]);return n&&await ot(n),{ok:!0,job_id:t.id,session_id:t.session_id,state:t.state,error:t.error,result:n,progress:r,debug:{last_stage:An(),last_error:ur(),events:ia(e,40)},created_at:t.created_at,updated_at:t.updated_at}}function Xh(e){for(const t of["y_percent","anchor_percent","read_percent"]){const n=e[t];if(n!=null)try{return Math.max(0,Math.min(100,Number(n)))}catch{return null}}return null}async function Zh(e){const t=await F("jobs",e);if(!t)return;const n=JSON.parse(t.request_json??"{}"),r=String(t.session_id??""),a=Zi();Sn(e);const i=fe("job.run");w("job.start",{job_id:e,session_id:r,message_index:n.message_index,text_len:String(n.assistant_text||"").length});try{if(await Ce(e,"superseded before start")||(n.force&&await Si(r,u(n.content_hash||""),n.message_index),await Ce(e,"superseded before tagging")))return;await ge(e,"tagging",{phase:"tagging",progress:0,message:"장면 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.tagging"});const s=await Og(n),o=Pg(s);if(w("job.tagger.messages",{msgs:s.length}),j().card?.preprocessing){const v=mr(await le("preprocess"));if(v){const O=[{role:"system",content:v},s[s.length-1]],J=await on(j().llm,O);if(await Ce(e,"superseded during preprocess"))return;s.splice(s.length-1,0,{role:"system",content:`## Preprocess Summary
${J}`})}}const c=await on(j().llm,s);if(await Ce(e,"superseded after tagging"))return;const l=oa(c);let f=Lg(l,n.assistant_text);if(w("job.tagger.done",{shots:f.length,raw_len:String(c||"").length}),!f.length)throw new Error("태거가 shot을 반환하지 않았습니다.");const d=j().card||{},m=Math.max(1,Number(d.image_min??1)),p=Math.max(m,Number(d.image_max??3));f=f.slice(0,p);const g=Dr();if(g==="two_stage"){if(await ge(e,"tagging",{phase:"tagging",progress:.35,message:"큐레이션 2단 씬 태그 보강 중…",shot_count:f.length,shot_done:0,debug_stage:"job.curation_refine"}),await Ce(e,"superseded during curation refine"))return;await _l(f,{chatContext:o})}else if(g==="embed_snap"){if(await ge(e,"tagging",{phase:"tagging",progress:.4,message:"씬 태그 임베딩 매칭 중…",shot_count:f.length,shot_done:0,debug_stage:"job.curation_snap"}),await Ce(e,"superseded during curation snap"))return;const v=await wl(f);v.ok||(w("job.curation_snap.fallback",{message:v.reason},"warn"),await ge(e,"tagging",{phase:"tagging",progress:.45,message:v.reason||"임베딩 없음 → 큐레이션 없이 생성",shot_count:f.length,shot_done:0,debug_stage:"job.curation_snap_fallback"}))}const h=f.flatMap(v=>v.characters||[]),_=u(n.unified_session_id||"",200),y=u(n.character_id||"",200),k=Array.isArray(n.source_session_ids)?n.source_session_ids.map(v=>u(v,200)).filter(Boolean):[],x=await nm({sessionId:r,tagged:l,shotChars:h,unifiedSessionId:_,characterId:y,sourceSessionIds:k});w("job.roster",{roster:x.length});const S=at(d);for(const v of f)v.characters=ba(v.characters||[],x,S);if(await Ce(e,"superseded before generate"))return;const E=n.message_index!=null?P(n.message_index,-1):-1,M=f.map((v,O)=>{const J=Math.floor(Number(v.line));return!Number.isFinite(J)||J<1?null:{shot_index:O,line:J}}).filter(v=>!!v);await ge(e,"generating",nr({shot_count:f.length,shot_index:0,shot_done:0,progress:0,phase:"generating",message:`이미지 1/${f.length} 생성 준비`,pending_inline:M,pending_message_index:E}));const C=[],R=!!d.llm_anchor_percent;for(let v=0;v<f.length;v+=1){if(await Ce(e,`superseded before shot ${v+1}`))return;const O=f[v],{main:J,neg:he,captions:Q,meta:K}=await Jr({shot:O,roster:x}),z=vt(),zt=Date.now()/1e3,se=await zh(e,u(n.content_hash||"")),gt=se.contentHash,ee=se.assistantPreview||u(n.assistant_text||"",4e3);let Ve=Xh(O);Ve==null&&R&&(Ve=Math.round(v/Math.max(1,f.length)*1e4)/100),w("job.shot.prepare",{shot:v,card_id:z,prompt_len:String(J||"").length,captions:(Q||[]).length}),await ge(e,"generating",nr({shot_count:f.length,shot_index:v,shot_done:v,progress:Math.round(v/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`NovelAI 요청 중 ${v+1}/${f.length}… [${_t()}]`,pending_inline:M,pending_message_index:E}));let ir=0;const j_=setInterval(()=>{ir+=pu/1e3;const fn=bc();wc()&&Ya()>=Kh&&fn&&Date.now()-fn>=Jh&&mm("heartbeat-idle");const ku=Ya()||yc();ge(e,"generating",nr({shot_count:f.length,shot_index:v,shot_done:v,progress:Math.round(v/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`NovelAI 대기 ${v+1}/${f.length} (${ir}s) · ${_t()}${ku?` ${Math.round(ku/1024)}KB`:""}`,pending_inline:M,pending_message_index:E})).catch(()=>{})},pu);let sr,ea;try{({bytes:sr,seed:ea}=await El({main:J,neg:he,captions:Q},O.aspect))}finally{clearInterval(j_)}if(w("job.shot.nai_done",{shot:v,bytes:sr?.byteLength||0,seed:ea}),await Ce(e,`superseded after shot ${v+1} nai`))return;await ge(e,"generating",nr({shot_count:f.length,shot_index:v,shot_done:v,progress:Math.round((v+.5)/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`이미지 저장 중 ${v+1}/${f.length}… [${_t()}]`,pending_inline:M,pending_message_index:E}));const ue=mg({imageId:z,sessionId:r,request:n,shotIndex:v,paragraph:O.paragraph,yPercent:Ve,line:(()=>{const fn=Math.floor(Number(O.line));return Number.isFinite(fn)&&fn>=1?fn:null})(),contentHash:gt,assistantPreview:ee});await Ea(z,sr,ue);const T_={...wi(K,ue,sr?.byteLength||0),aspect:O.aspect||void 0};await D("cards",{id:z,job_id:e,session_id:r,shot_index:v,paragraph:Number(O.paragraph||0),main_prompt:J,negative_prompt:he,characters_json:JSON.stringify(K.characters||[]),seed:ea,meta_json:JSON.stringify(T_),created_at:zt});const xu=Pe.get(e);if(xu&&xu.publishedIds.push(z),await Ce(e,`superseded after shot ${v+1} save`))return;C.push({id:z,shot_index:v,paragraph:ue.paragraph,y_percent:ue.y_percent,line:ue.line,message_index:ue.message_index??-1,message_role:ue.message_role||"",content_hash:ue.content_hash||"",character_id:ue.character_id||"",chat_id:ue.chat_id||"",character_name:ue.character_name||"",chat_name:ue.chat_name||"",char_index:ue.char_index??-1,chat_index:ue.chat_index??-1,assistant_preview:ee,main_prompt:J,negative_prompt:he,characters:K.characters||[],image_url:Be(z),seed:ea,storage:"indexeddb",png_bytes:sr?.byteLength||0}),w("job.shot.saved",{shot:v,card_id:z,has_url:!!Be(z)}),await ge(e,"generating",nr({shot_count:f.length,shot_index:v,shot_done:v+1,progress:Math.round((v+1)/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`이미지 ${v+1}/${f.length} 완료`,cards_so_far:C.length,pending_inline:M,pending_message_index:E}))}if(await Ce(e,"superseded before done"))return;const H={cards:C,message_index:n.message_index!=null?Number(n.message_index):-1,shot_count:f.length,shot_done:f.length,progress:100,phase:"done",message:`이미지 ${f.length}/${f.length} 완료`};await ot(H),await ge(e,"done",H);const N=Pe.get(e);N&&(N.publishedIds=[]),i.end({message:"done",cards:C.length})}catch(s){i.fail(s);const o=s,c=`${o?.message||s}
${o?.stack||""}`.slice(-1500);await ge(e,"error",{phase:"error",message:String(o?.message||s).slice(0,240),debug_stage:An(),debug_tail:ia(e,12)},c)}finally{Sn(a)}}L(),it(),Gt(),Le(),de();function Dt(e,t){try{return JSON.parse(e)}catch{return t}}async function Qh(e,t={}){const n=u(e,80),r=await F("cards",n);if(!r)return{ok:!1,error:{code:"not_found",message:"card not found"}};const a=Dt(r.characters_json||"[]",[]),i=Array.isArray(a)?a:[];let s=r.main_prompt;"main_prompt"in t&&(s=u(t.main_prompt,8e3));let o=r.negative_prompt;"negative_prompt"in t&&(o=u(t.negative_prompt,8e3));let c=i;if("characters"in t){const d=t.characters||[];if(!Array.isArray(d))return{ok:!1,error:{code:"bad_request",message:"characters must be a list"}};c=[];const m=at(j().card||{});for(let p=0;p<d.slice(0,m).length;p++){const g=d[p];if(typeof g!="object")continue;const h=g,_=p<i.length&&typeof i[p]=="object"?i[p]:{},y=u(h.name!=null?h.name:_.name,200),k=u(h.prompt!=null?h.prompt:_.prompt,4e3);if(!y&&!k)continue;const x={..._,name:y||`char${p+1}`,prompt:k||"girl"};"uc"in h&&(x.uc=u(h.uc,2e3));for(const S of["center_x","center_y"])if(S in h)try{x[S]=Number(h[S])}catch{}c.push(x)}}r.main_prompt=s,r.negative_prompt=o,r.characters_json=JSON.stringify(c);try{let d=Dt(r.meta_json||"{}",{});(!d||typeof d!="object"||Array.isArray(d))&&(d={});const m=d;m.setup=s,m.characters=c,r.meta_json=JSON.stringify(m)}catch{}await D("cards",r);const l=await pt(n,{}),f={id:n,main_prompt:s,negative_prompt:o,characters:c,paragraph:r.paragraph,shot_index:r.shot_index,y_percent:l.y_percent,message_index:l.message_index,content_hash:l.content_hash,image_url:Be(n)};return await ot(f),{ok:!0,card:f}}async function hu(e,t="nai",n=null,r={}){const a=await F("cards",e);if(!a)return{ok:!1,error:{code:"not_found",message:"card not found"}};const i=a.session_id,s=Dt(a.meta_json||"{}",{}),o=s.location||{};if(!r.skipBusyCheck)try{const N=await pt(e,s),v=await Ii({session_id:i,content_hash:u(N.content_hash||s.content_hash||"",128),message_index:P(N.message_index,-1)},i);if(v)return v}catch{}const c=u(o.character_id||s.character_id||"",200);let l=u(s.unified_session_id||o.unified_session_id||"",200);!l&&c&&(l=ju(c));let f=[];try{const N=await F("jobs",a.job_id);if(N?.request_json){const v=JSON.parse(N.request_json);Array.isArray(v.source_session_ids)&&(f=v.source_session_ids.map(O=>u(O,200)).filter(Boolean))}}catch{}const d=await Ua(i,l,c,f);if(t==="full"){const N=await F("jobs",a.job_id);if(!N)return{ok:!1,error:{code:"no_job",message:"original job missing"}};const v=JSON.parse(N.request_json);return v.force=!0,gu(v)}let m,p,g,h,_={};const y=n;if(y&&("main_prompt"in y||"negative_prompt"in y||"characters"in y))m="main_prompt"in y?u(y.main_prompt||""):u(a.main_prompt),p="negative_prompt"in y?u(y.negative_prompt||""):u(a.negative_prompt),h="characters"in y?y.characters:null,h==null&&(h=Dt(a.characters_json||"[]",[])),g=(h||[]).slice(0,at(j().card||{})).map(N=>({prompt:xa(N.prompt||"girl")||"girl",uc:u(N.uc),center_x:Number(N.center_x??.5),center_y:Number(N.center_y??.5)}));else if(u(a.main_prompt||"")){const N=Dt(a.characters_json||"[]",[]),v=Array.isArray(N)?N:[],O=_u(s),J=v.map(gt=>{if(!gt||typeof gt!="object")return null;const ee=gt;if(ee.raw&&typeof ee.raw=="object"){const Ve=ee.raw;return{...Ve,name:u(Ve.name||ee.name,200)}}return{name:u(ee.name,200),action:ee.action,expression:ee.expression,sex:ee.sex,label:ee.label,age:ee.age,original:ee.original||ee.original_tag}}).filter(Boolean),he=j().card||{},Q=Je(j().nai?.model||"nai-diffusion-4-5-full"),K=Object.values(En).filter(Boolean);En[Q]&&K.unshift(En[Q]);const z=xf({setup:s.setup,main:a.main_prompt,person:s.person,stylePositives:kf(he),qualitySuffixes:K}),zt={characters:O.length?O:J,paragraph:a.paragraph,camera:z.rebuildMain&&z.lockedSetup?"":u(s.camera||""),situation:z.rebuildMain&&z.lockedSetup?"":u(s.situation||s.scene||""),place:z.rebuildMain&&z.lockedSetup?"":u(s.place||""),action:z.rebuildMain&&z.lockedSetup?"":u(s.action||"")},se=await Jr({shot:zt,roster:d,lockedSetup:z.rebuildMain?z.lockedSetup:void 0});z.rebuildMain?(m=se.main,p=se.neg,g=se.captions,h=se.meta.characters,_={setup:se.meta.setup,person:se.meta.person,characters:h}):(m=u(a.main_prompt),p=u(a.negative_prompt)||se.neg,g=se.captions,h=se.meta.characters,_={setup:m,person:se.meta.person,characters:h})}else{const N=Dt(a.characters_json||"[]",[]),v=_u(s),O=(N||[]).map(K=>{if(!K||typeof K!="object")return null;const z=K;return z.raw||{name:z.name,action:z.action,expression:z.expression}}).filter(Boolean),J=u(s.setup||""),he={characters:v.length?v:O,paragraph:a.paragraph,camera:J?"":u(s.camera||""),situation:J?"":u(s.situation||s.scene||""),place:J?"":u(s.place||""),action:J?"":u(s.action||"")},Q=await Jr({shot:he,roster:d,lockedSetup:J});m=Q.main,p=Q.neg,g=Q.captions,h=Q.meta.characters,_={setup:Q.meta.setup,person:Q.meta.person,characters:h}}if(!g.length&&!(y&&"characters"in y)){const N={characters:(s.characters||[]).map(O=>O.raw||O),camera:s.setup},v=await Jr({shot:N,roster:d});m=v.main,p=v.neg,g=v.captions,h=v.meta.characters,_={setup:v.meta.setup,person:v.meta.person,characters:h}}const{bytes:k,seed:x}=await El({main:m,neg:p,captions:g},s.aspect??y?.aspect),S=vt(),E=Date.now()/1e3;let M=await mt(a.id);Object.keys(M).length||(M=await pt(a.id,s));const C={version:1,image_id:S,session_id:i,unified_session_id:l,character_id:u(M.character_id||"",200),character_name:u(M.character_name||s.character_name||"",200),chat_id:u(M.chat_id||"",200),chat_name:u(M.chat_name||s.chat_name||"",200),char_index:P(M.char_index,-1),chat_index:P(M.chat_index,-1),message_index:P(M.message_index,-1),shot_index:P(M.shot_index,P(a.shot_index,0)),paragraph:P(M.paragraph,P(a.paragraph,0)),y_percent:dr(M.y_percent),content_hash:u(M.content_hash||"",128),assistant_preview:u(M.assistant_preview||s.assistant_preview||"",et)};await Ea(S,k,C);const R=wi({...s,..._},C,k.byteLength);for(const N of["y_percent","anchor_percent","read_percent"])delete R[N];R.y_percent=C.y_percent,await D("cards",{id:S,job_id:a.job_id,session_id:i,shot_index:a.shot_index,paragraph:a.paragraph,main_prompt:m,negative_prompt:p,characters_json:JSON.stringify(h),seed:x,meta_json:JSON.stringify(R),created_at:E});try{await Mi(e)}catch{}const H={id:S,image_url:Be(S),main_prompt:m,negative_prompt:p,characters:h,seed:x,paragraph:C.paragraph,y_percent:C.y_percent,message_index:C.message_index,shot_index:C.shot_index,content_hash:C.content_hash,character_id:C.character_id,chat_id:C.chat_id,character_name:C.character_name,chat_name:C.chat_name,assistant_preview:C.assistant_preview,storage:"indexeddb",png_bytes:k.byteLength};return await ot(H),{ok:!0,replaced:e,card:H}}async function e_({session_id:e="",content_hash:t="",message_index:n=-1}={}){const r=u(e,200),a=u(t,128),i=P(n,-1);if(!r&&!a&&i<0)return{ok:!1,error:{code:"bad_request",message:"session_id or content_hash required"}};const s=await ve("cards"),o=[];for(const h of s){if(r&&h.session_id!==r)continue;const _=Dt(h.meta_json||"{}",{}),y=await pt(h.id,_),k=u(y.content_hash||_.content_hash||"",128),x=P(y.message_index,-1);if(a){if(k!==a)continue}else if(i>=0){if(x!==i)continue}else continue;const S=y.y_percent??_.y_percent??_.anchor_percent??_.read_percent,E=Number(S);o.push({row:h,y:Number.isFinite(E)?E:999,shot:P(h.shot_index,0),paragraph:P(h.paragraph??y.paragraph,0)})}if(o.sort((h,_)=>h.y-_.y||h.shot-_.shot||h.paragraph-_.paragraph),!o.length)return{ok:!1,error:{code:"not_found",message:"no cards for message"}};const c=r||u(o[0]?.row?.session_id||"",200),l={session_id:c,content_hash:a,message_index:i},f=await Ii(l,c);if(f)return f;const d=Kr(l,c);hr.add(d);const m=[],p=[],g=[];try{for(const h of o){const _=h.row;try{const y=await hu(_.id,"nai",null,{skipBusyCheck:!0});if(y?.busy){g.push({id:_.id,error:y.error?.message||"busy"});break}y?.ok&&y.card?(m.push(y.card),y.replaced&&p.push(y.replaced)):g.push({id:_.id,error:u(y?.error?.message||"reroll failed",400)})}catch(y){g.push({id:_.id,error:u(y?.message||y,400)})}}return{ok:m.length>0,count:m.length,replaced:p,cards:m,failed:g}}finally{hr.delete(d)}}function _u(e){return Array.isArray(e.characters)?e.characters.map(t=>t&&typeof t=="object"?t.raw||t:null).filter(Boolean):[]}te(),q(),ht(),Z(),kt(),L(),Qa(),_i(),Pr(),pi(),de(),ft();function Li(){const e=ye(),t=e.events;return{last_stage:e.last_stage,events:Array.isArray(t)?t.slice(-20):[]}}async function t_(e){if(e){const t=j(),n={...e};u(n.api_key)&&(t.llm.api_key=u(n.api_key)),delete n.api_key,delete n.api_key_configured,u(n.service_account_json)&&(t.llm.service_account_json=u(n.service_account_json)),delete n.service_account_json,delete n.service_account_configured,Object.keys(n).length&&(t.llm=nt(t.llm,n)),await Ke()}try{const t=j().llm,n=Or(t.source),r=Ft(t.provider);return n==="custom"&&!il(t)?{ok:!1,message:r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM Model/API key가 비어 있습니다. NovelAI 키가 아니라 태깅용 LLM 키를 넣으세요."}:(n==="main"||n==="aux")&&!_e("runLLMModel")?{ok:!1,message:"RisuAI runLLMModel API를 사용할 수 없습니다."}:{ok:!0,message:`LLM ok (${n}): ${(await on(t,[{role:"user",content:"Reply with exactly: ok"}])).slice(0,120)}`}}catch(t){return{ok:!1,message:String(t?.message||t)}}}async function n_(){const e=j().nai;if(Kn(e)==="comfy")try{if(!Xa(e))return{ok:!1,message:"ComfyUI 워크플로 JSON이 없습니다.",debug:ye()};const t=xc({main:"test",neg:"test",captions:[{name:"",prompt:"char1"},{name:"",prompt:"char2"}],nai:e,seed:1}),n=kc(e.comfy_workflow_json,t),r=vc(e),{status:a,data:i}=await Za(`${r}/system_stats`,{method:"GET"});if(a>=400)return{ok:!1,message:`ComfyUI 연결 실패 (HTTP ${a}) · ${r}`,debug:ye()};const s=i?.devices?.[0]?.name||i?.system?.os||"ok";return{ok:!0,message:`ComfyUI ok · ${r} · nodes=${Object.keys(n).length} · ${s}`,debug:Li()}}catch(t){return w("comfy.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ye()}}if(!u(e.api_key))return{ok:!1,message:"NAI api_key missing",debug:ye()};try{const t=u(e.api_key);try{const n=fe("nai.test.anlas"),r=await Nm(t);return n.end({message:"anlas ok"}),{ok:!0,message:`NAI token ok · Anlas=${JSON.stringify(r)}`,debug:Li()}}catch(n){const r=Je(e.model||"nai-diffusion-4-5-full");return w("nai.test.anlas",{message:String(n?.message||n)},"warn"),{ok:!0,message:`NAI config present · model=${r} · anlas_skip=${n?.message||n}`,debug:Li()}}}catch(t){return w("nai.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ye()}}}async function r_(){const e=j().nai,t=u(e.api_key);if(!t)return{ok:!1,message:"NAI api_key missing",debug:ye()};const n=String(ye().job_ctx??"");Sn("probe-nai");const r=fe("nai.probe");try{w("nai.probe.start",{message:"tiny generate"});const a={prompt:"1girl, solo, simple background, best quality",negative_prompt:"lowres, bad quality",width:512,height:768,steps:10,cfg_scale:5,cfg_rescale:0,sampler:"k_euler_ancestral",scheduler:"karras",model:Je(e.model||"nai-diffusion-4-5-full"),var_plus:!1,characters:[],seed:Math.floor(Math.random()*4294967295)||1},i=u(e.request_url)||"https://image.novelai.net/ai/generate-image",s=await Ac(t,a,i,{timeoutMs:9e4}),o=s.raw_bytes.byteLength,c=wt(Y(s.raw_bytes));return r.end({bytes:o,is_png:c,seed:s.seed}),{ok:!0,message:`probe ok · png=${c} · ${o}B · seed=${s.seed}`,bytes:o,is_png:c,seed:s.seed,debug:ye()}}catch(a){return r.fail(a),{ok:!1,message:String(a?.message||a),debug:ye()}}finally{Sn(n)}}async function a_(e,t){if(!e?.byteLength)throw new Error("image is empty");const n=await Af(e),r=n.bytes,a=n.mime||"image/png",i=n.filename||"image.png",s=`data:${a};base64,${await Qe(r)}`,o=mr(await le("autotag"))||["Tag ONE character reference image into Danbooru-style English prompts.",'Return ONE JSON object only: {"gender":"girl|boy","appearance":"...","attire":"...","accessories":"..."}.',"gender must be exactly girl or boy from visual evidence. appearance = identity/hair/eyes/body (no clothes). attire = clothing + permanent jewelry (earrings/glasses/watch/earbuds). accessories = weapons/bags/held props/ID only (not jewelry)."].join(`
`);w("autotag.start",{message:`llm-vision ${i} ${r.length}B`,bytes:r.length,focus:!0,source:Or(j().llm.source)});const c=[{role:"system",content:o},{role:"user",content:[{type:"text",text:"Tag this character image. JSON only with gender, appearance, attire, accessories."},{type:"image_url",image_url:{url:s}}]}];let l="";try{l=await on(j().llm,c)}catch(k){throw w("autotag.llm.fail",{message:String(k?.message||k)},"error"),new Error(`오토태그 LLM 실패: ${String(k?.message||k).slice(0,240)}`)}const f=Xl(l),d=u(f.appearance||"",4e3),m=u(f.attire||"",4e3),p=u(f.accessories||"",4e3),g=u(f.gender||"",20),h=u(f.text||[d,m,p].filter(Boolean).join(", "),8e3);if(!d&&!m&&!p)throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");const _=h.split(",").map(k=>k.trim()).filter(Boolean);w("autotag.done",{message:`gender=${g||"-"} app=${d.length} attire=${m.length} acc=${p.length}`,focus:!0});const y={ok:!0,appearance:d,attire:m,accessories:p,tags:_,text:h,count:_.length,threshold:Number(t||.2),engine:"llm-vision"};return g&&(y.gender=g),y}async function i_(e){if(!e?.byteLength)throw new Error("image is empty");const t=await Yo(e);if(!t)throw new Error("이미지에서 NovelAI 메타데이터를 읽지 못했습니다. PNG/WebP NAI 원본인지 확인하세요.");const n=zo(t);if(!u(n))throw new Error("메타데이터에 프롬프트가 없습니다.");const r=Id(t,n);if(!r.positive&&!r.negative)throw new Error("프리셋에 넣을 artist/품질 태그와 네거티브가 비어 있습니다.");return w("preset-from-image.done",{message:`pos=${r.positive.length} neg=${r.negative.length} cfg=${r.cfg_scale}`,focus:!0}),{ok:!0,positive:r.positive,negative:r.negative,cfg_scale:r.cfg_scale,cfg_rescale:r.cfg_rescale,name:"이미지 프리셋"}}L();function s_(e){const t=e.indexOf("?");if(t<0)return{pathname:e,query:{}};const n=e.slice(0,t),r=new URLSearchParams(e.slice(t+1)),a={};for(const[i,s]of r.entries()){const o=a[i];o===void 0?a[i]=s:Array.isArray(o)?o.push(s):a[i]=[o,s]}return{pathname:n,query:a}}function rr(e,t,n=""){const r=e[t];return Array.isArray(r)?r[0]??n:r??n}function o_(e,t={}){const n=u(e.auth_token,4e3);if(!n)return!0;const r=String(t.Authorization||t.authorization||"");let a=r.toLowerCase().startsWith("bearer ")?r.slice(7):r;if(a=a||String(t["X-Inlay-Nexus-Token"]||t["x-inlay-nexus-token"]||""),typeof a!="string"||a.length!==n.length)return!1;let i=0;for(let s=0;s<n.length;s+=1)i|=a.charCodeAt(s)^n.charCodeAt(s);return i===0}q(),Z(),L(),te(),Hs(),de(),ft(),Qn();var T=(...e)=>t=>e.includes(t)?"":null,We=e=>t=>t.startsWith(e)?t.slice(e.length):null,Bi=(e,t)=>n=>n.startsWith(e)&&n.endsWith(t)?n.slice(e.length,n.length-t.length):null,A=e=>({status:200,data:e}),Ri=e=>({status:200,data:e,contentType:"image/png",raw:!0}),ar=e=>{throw yt(404,{ok:!1,...re(e,"not_found")},e)};function Zr(e){let t=e.image_b64||e.data||"";return typeof t=="string"&&t.startsWith("data:")&&(t=t.split(",",2)[1]??""),String(t||"")}var c_=[{match:T("/v1/settings/export"),handler:()=>A({ok:!0,json:Jp()})},{match:T("/v1/settings"),handler:()=>A({ok:!0,settings:Fr()})},{match:T("/v1/curation/status"),handler:async()=>A({ok:!0,status:await Zn()})},{match:T("/v1/curation/catalog"),handler:async()=>A({ok:!0,catalog:await dt()})},{match:T("/v1/prompts"),handler:async()=>A({ok:!0,prompts:await Rr()})},{match:T("/v1/prompts/export"),handler:async()=>A({ok:!0,...await Dp()})},{match:We("/v1/prompts/"),handler:async({param:e})=>A({ok:!0,key:e,text:await le(e)})},{match:We("/v1/jobs/"),handler:async({param:e})=>A(await Yh(e))},{match:We("/v1/gallery/explore"),handler:async({query:e})=>A(await kg(Number(rr(e,"limit","400"))))},{match:T("/v1/gallery/favorites"),handler:async()=>A(await Pl())},{match:We("/v1/gallery"),handler:async({query:e})=>A(await Sg(rr(e,"session_id"),Number(rr(e,"limit","40"))))},{match:T("/v1/nai/reference.png"),handler:async()=>Ri(await kl()??ar("no reference"))},{match:T("/v1/nai/vibe.png"),handler:async()=>Ri(await sg()??ar("no vibe"))},{match:T("/v1/nai/reference"),handler:async()=>{const e=await ng();return A({ok:!0,configured:e,image_reference:j().nai?.image_reference||"none",preview_url:e?"/v1/nai/reference.png":""})}},{match:T("/v1/nai/vibe"),handler:async()=>{const e=await ag();return A({ok:!0,configured:e,vibe_transfer:j().nai?.vibe_transfer||"none",preview_url:e?"/v1/nai/vibe.png":""})}},{match:We("/v1/characters"),handler:async({query:e})=>A(await Hn(rr(e,"session_id"),rr(e,"character_id")))},{match:We("/v1/appearance/"),handler:async({param:e})=>A(await Hn(e))},{match:We("/v1/images/"),handler:async({param:e})=>{let t=e.replace(/^\/+|\/+$/g,"");if(t.endsWith(".json")){const n=await mt(t.slice(0,-5));return Object.keys(n).length||ar("location missing"),A(n)}return t.endsWith(".png")&&(t=t.slice(0,-4)),Ri(await Ol(t)??ar("image missing"))}}],l_=[{match:T("/v1/settings/reset"),handler:async()=>A(await Gp())},{match:T("/v1/settings/import"),handler:async({body:e})=>A(await Kp(String(e.json||e.text||"")))},{match:T("/v1/settings","/v1/settings/update"),handler:async({body:e})=>A(await Wp(e))},{match:T("/v1/curation/catalog"),handler:async({body:e})=>{const t=e.catalog??e;return A(await fl(t))}},{match:T("/v1/curation/catalog/reset"),handler:async()=>A(await dl())},{match:T("/v1/curation/embed"),handler:async()=>A(await ml())},{match:T("/v1/curation/embed/test"),handler:async()=>A(await pl())},{match:T("/v1/curation/settings"),handler:async({body:e})=>A(await vl(e))},{match:T("/v1/prompts/import"),handler:async({body:e})=>A(await zp(e?.json!=null?e.json:(e?.prompts!=null,e)))},{match:T("/v1/prompts/reset-defaults"),handler:async({body:e})=>A(await Up({keep_author_note:e?.keep_author_note!==!1&&e?.keepAuthorNote!==!1}))},{match:Bi("/v1/prompts/","/reset"),handler:async({param:e})=>A(await cl(e,Cn(e)))},{match:We("/v1/prompts/"),handler:async({param:e,body:t})=>A(await cl(e,String(t.text||"")))},{match:T("/v1/jobs/create","/v1/jobs"),handler:async({body:e})=>({status:202,data:await gu(e)})},{match:T("/v1/jobs/retarget-hash"),handler:async({body:e})=>A(await Hh({session_id:String(e.session_id||e.sessionId||""),character_id:String(e.character_id||e.characterId||""),chat_id:String(e.chat_id||e.chatId||""),message_index:e.message_index??e.messageIndex??e.chatIndex,role:String(e.role||e.message_role||""),to_hash:String(e.to_hash||e.content_hash||e.hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||e.text||"")}))},{match:T("/v1/jobs/busy-message"),handler:async({body:e})=>A(await Uh({session_id:String(e.session_id||e.sessionId||""),character_id:String(e.character_id||e.characterId||""),chat_id:String(e.chat_id||e.chatId||""),message_index:e.message_index??e.messageIndex??e.chatIndex,role:String(e.role||e.message_role||"")}))},{match:T("/v1/gallery/unlink","/v1/cards/unlink"),handler:async({body:e})=>A(await Si(String(e.session_id||""),String(e.content_hash||""),e.message_index))},{match:T("/v1/gallery/rebind-hash","/v1/cards/rebind-hash"),handler:async({body:e})=>A(await $l({session_id:String(e.session_id||e.sessionId||""),card_ids:e.card_ids||e.ids||[],to_hash:String(e.to_hash||e.content_hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||"")}))},{match:T("/v1/gallery/delete","/v1/cards/delete"),handler:async({body:e})=>{const t=u(e.folder_key||"",400),n=u(e.card_id||e.id||"",80),r=Array.isArray(e.card_ids)?e.card_ids:null;if(t)return A(await Eg(t));if(r?.length)return A(await Ag(r));if(n)return A(await Mi(n));const a="card_id or folder_key required";throw yt(400,{ok:!1,...re(a,"bad_request")},a)}},{match:T("/v1/gallery/export"),handler:async({body:e})=>A(await Ng(e))},{match:T("/v1/gallery/import"),handler:async({body:e})=>A(await Ig(e))},{match:T("/v1/gallery/favorites"),handler:async({body:e})=>Array.isArray(e.ids)?A(await Mg(e.ids)):A(await Pl())},{match:Bi("/v1/cards/","/tags"),handler:async({param:e,body:t})=>A(await Qh(e,t))},{match:Bi("/v1/cards/","/reroll"),handler:async({param:e,body:t})=>A(await hu(e,String(t.mode||"nai"),t.overrides))},{match:T("/v1/messages/reroll","/v1/gallery/reroll-message"),handler:async({body:e})=>A(await e_({session_id:String(e.session_id||e.sessionId||""),content_hash:String(e.content_hash||e.contentHash||""),message_index:Number(e.message_index??e.messageIndex??-1)}))},{match:T("/v1/characters/global-toggles","/v1/characters/global_toggles"),handler:async({body:e})=>A(await Wd(String(e.character_id||""),e.disabled_globals||e.disabled||[]))},{match:T("/v1/characters/unify","/v1/characters/merge"),handler:async({body:e})=>A(await uc(String(e.target_session_id||e.session_id||""),e.source_session_ids||e.session_ids||[],e.include_target!==!1))},{match:T("/v1/characters","/v1/characters/update"),handler:({body:e})=>u_(e)},{match:We("/v1/appearance/"),handler:async({param:e,body:t})=>t.characters!=null||t.global!=null?(t.characters!=null&&await Un(e,t.characters||[],{prune:!0}),t.global!=null&&await Un(Xe,t.global||[],{prune:!0}),A(await Hn(e))):A(await tm(e,t.appearance||{}))},{match:T("/v1/models/test"),handler:async({body:e})=>A(await t_(e.llm&&typeof e.llm=="object"?e.llm:null))},{match:T("/v1/nai/test"),handler:async()=>A(await n_())},{match:T("/v1/nai/probe","/v1/debug/probe-nai"),handler:async()=>A(await r_())},{match:T("/v1/debug/clear"),handler:()=>(ra(),A({ok:!0,cleared:!0}))},{match:T("/v1/debug/asset-tags"),handler:async({body:e})=>A(await Gd(e))},{match:T("/v1/nai/reference","/v1/nai/reference/upload"),handler:async({body:e})=>{if(e.clear)return A(await Sl());const t=Zr(e);if(!u(t))throw new Error("image_b64 required");return A(await rg(X($e(t))))}},{match:T("/v1/nai/reference/clear"),handler:async()=>A(await Sl())},{match:T("/v1/nai/vibe","/v1/nai/vibe/upload"),handler:async({body:e})=>{const t=u(e.preset_id||e.presetId||"",120);if(e.clear)return A(t?await Nl(t):await Al());if(t&&e.copy_from){const a=u(e.copy_from,120),i=a?await ug(a,t):!1;return A({ok:!0,preset_id:t,configured:i,preview_url:i?fa(t):""})}const n=Zr(e);if(!u(n))throw new Error("image_b64 required");const r={model:e.model,information_extracted:e.information_extracted??e.vibe_transfer_information_extracted,strength:e.strength??e.vibe_transfer_strength};return A(t?await lg(t,X($e(n)),r):await og(X($e(n)),r))}},{match:T("/v1/nai/vibe/clear"),handler:async({body:e})=>{const t=u(e?.preset_id||e?.presetId||"",120);return A(t?await Nl(t):await Al())}},{match:T("/v1/autotag","/v1/autotag/evaluate"),handler:async({body:e})=>{const t=Zr(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=$e(t);return A(await a_(X(n),Number(e.threshold??.2)))}},{match:T("/v1/presets/from-image"),handler:async({body:e})=>{const t=Zr(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=$e(t);return A(await i_(X(n)))}}];async function u_(e){const t=u(e.session_id||"",200),n=u(e.character_id||"",200),r=(Array.isArray(e.root_session_ids)?e.root_session_ids:Array.isArray(e.cascade_session_ids)?e.cascade_session_ids:[]).map(i=>u(i,200)).filter(Boolean);if("characters"in e&&t&&await Un(t,e.characters||[],{prune:!0,rootSessionIds:r}),"global"in e&&await Un(Xe,e.global||[],{prune:!0}),"character"in e){const i=u(e.scope||t||"__global__",200);r.length&&i!=="__global__"?await lc(r,[e.character||{}],""):await ct(i,e.character||{})}const a=Array.isArray(e.root_delete)?e.root_delete:Array.isArray(e.cascade_delete)?e.cascade_delete:[];return a.length&&r.length&&await Qd(r,a,""),r.length&&t&&await uc(t,r,!1),A(await Hn(t,n))}async function yu(e,t){for(const n of e){const r=n.match(t.pathname);if(r!==null)return n.handler({...t,param:r})}return ar(t.pathname)}async function f_(e,t={}){const{pathname:n,query:r}=s_(e),a=String(t.method||"GET").toUpperCase();let i;if(typeof t.body=="string")try{i=JSON.parse(t.body)}catch{i={}}else i=t.body??{};if(["/v1/health","/healthz","/readyz"].includes(n))return A({ok:!0,health:qp()});if(n==="/v1/debug"||n==="/v1/debug/log")return a==="DELETE"||a==="POST"&&i.clear?(ra(),A({ok:!0,cleared:!0})):A(ye());if(!o_(j(),t.headers||{})){const o="invalid token";throw yt(401,{ok:!1,...re(o,"unauthorized")},o)}const s={method:a,pathname:n,query:r,body:i};if(a==="GET")return yu(c_,s);if(["POST","PUT","PATCH"].includes(a))try{return await yu(l_,s)}catch(o){if(ts(o))throw o;const c=String(o?.message||o);throw yt(500,{ok:!1,...re(c,"internal")},c)}throw yt(405,{ok:!1,...re(a,"method_not_allowed")},a)}te(),q(),ht(),kr(),ol(),Le(),de(),ft();var Qr=null;async function d_(){w("boot.ready.start",{message:Ye}),await st();const e=await xr().catch(r=>{throw w("boot.storage",{message:String(r?.message||r)},"error"),r});w("boot.storage",{message:e.kind}),pr(await Rp()),await Fp(),await rm(),await am();const t=await F("meta","reference_image");t?.png&&la(Tt(t.png));const n=await F("meta","vibe_transfer");n?.png&&ua(Tt(n.png)),await dg(),w("boot.ready.done",{message:Ye,has_nativeFetch:_e("nativeFetch"),has_idb:_e("getLocalPluginStorage")})}async function Fi(){return Qr||(Qr=d_().catch(e=>{throw Qr=null,e})),await Qr,!0}async function m_(e,t={},n=12e4){await Fi();try{const r=await f_(e,t);if(r.raw)return r.data;if(r.status>=400)throw yt(r.status,r.data);return r.data}catch(r){if(ts(r))throw r;const a=String(r?.message||r);throw yt(500,{ok:!1,...re(a,"internal")},a)}}async function p_(e){return await Fi(),Qt(e)}function g_(){Xi(()=>({cards:On("cards"),images:On("images"),jobs:On("jobs"),blob_urls:Hf()})),Reflect.set(globalThis,"__INLAY_NATIVE__",{VERSION:Ye,ready:Fi,fetch:m_,resolveImageUrl:Be,refPreviewUrl:Js,vibePreviewUrl:Ks,ensureImageUrl:p_,warmImages:Yf,pinImageUrls:So,retainImageUrls:Wf,dropImageUrl:Vf,warmProgress:Kf,onWarmProgress:Gf,debug:ye,clearDebug:ra})}var h_=dn({EXPLORER_CHAR_FOLDER_PREFIX:()=>bu,EXPLORER_OVERSCAN_ROWS:()=>2,EXPLORER_WINDOW_SIZE:()=>100,applyExplorerClick:()=>b_,clearSelection:()=>v_,createSelectionState:()=>__,defaultExplorerFolderKey:()=>M_,explorerCharFolderKey:()=>wu,explorerFolderKeysForCharacter:()=>N_,explorerWindowRange:()=>I_,groupExplorerFolders:()=>A_,moveFocus:()=>x_,parseExplorerCharFolderKey:()=>vu,reorderByIds:()=>E_,selectAll:()=>w_,sortExplorerItems:()=>k_,thumbMinWidth:()=>S_,visibleIds:()=>y_});function __(e=[]){return{selected:new Set((e||[]).map(String).filter(Boolean)),anchorId:"",focusId:""}}function y_(e=[]){return(e||[]).map(t=>String(t?.id||"")).filter(Boolean)}function b_(e,t,{index:n,ids:r,shift:a=!1,ctrl:i=!1}={}){const s={selected:new Set(e?.selected||[]),anchorId:String(e?.anchorId||""),focusId:String(e?.focusId||"")},o=String(t||"");if(!o)return s;const c=Array.isArray(r)?r.map(String):[],l=typeof n=="number"&&Number.isFinite(n)?n:c.indexOf(o);if(a&&s.anchorId&&c.length){const f=c.indexOf(s.anchorId),d=l>=0?l:c.indexOf(o);if(f>=0&&d>=0){const m=Math.min(f,d),p=Math.max(f,d);return s.selected=new Set(c.slice(m,p+1)),s.focusId=o,s}}return i?(s.selected.has(o)?s.selected.delete(o):s.selected.add(o),s.anchorId=o,s.focusId=o,s):(s.selected=new Set([o]),s.anchorId=o,s.focusId=o,s)}function w_(e,t=[]){return{selected:new Set((t||[]).map(String).filter(Boolean)),anchorId:String(e?.anchorId||t?.[0]||""),focusId:String(e?.focusId||t?.[0]||"")}}function v_(e=null){return{selected:new Set,anchorId:String(e?.anchorId||""),focusId:""}}function x_(e=[],t="",n=1){const r=(e||[]).map(String).filter(Boolean);if(!r.length)return"";const a=r.indexOf(String(t||""));return a<0?r[0]:r[Math.max(0,Math.min(r.length-1,a+n))]}function k_(e=[],t="newest"){const n=[...e||[]],r=(a,i=0)=>{const s=Number(a);return Number.isFinite(s)?s:i};return t==="oldest"?n.sort((a,i)=>r(a.created_at)-r(i.created_at)||String(a.id).localeCompare(String(i.id))):t==="message"?n.sort((a,i)=>r(a.message_index,1e9)-r(i.message_index,1e9)||r(a.shot_index)-r(i.shot_index)||r(i.created_at)-r(a.created_at)):t==="shot"?n.sort((a,i)=>r(a.shot_index)-r(i.shot_index)||r(a.message_index,1e9)-r(i.message_index,1e9)||r(i.created_at)-r(a.created_at)):n.sort((a,i)=>r(i.created_at)-r(a.created_at)||String(i.id).localeCompare(String(a.id)))}function S_(e="m"){return e==="s"?96:e==="l"?200:148}var L_=100,B_=2;function A_(e=[]){const t=new Map,n=[];for(const r of e||[]){if(!r||typeof r!="object")continue;const a=String(r.character_id||r.character_name||"unknown").trim()||"unknown",i=String(r.character_name||a).trim()||a;let s=t.get(a);s||(s={characterKey:a,characterName:i,chats:[],count:0},t.set(a,s),n.push(a)),s.chats.push(r),s.count+=Number(r.count)||0}return n.map(r=>t.get(r))}var bu="__char__:";function wu(e){return`${bu}${String(e||"").trim()}`}function vu(e){const t=String(e||"");return t.startsWith("__char__:")?t.slice(9).trim():""}function M_(e=[],t=""){const n=String(t||"");if(n==="__all__")return"__all__";if(n==="__pick__"||!n)return"__pick__";const r=vu(n);return r?(e||[]).some(a=>a?String(a.character_id||a.character_name||"").trim()===r:!1)?wu(r):"__pick__":(e||[]).some(a=>a&&String(a.key||"")===n)?n:"__pick__"}function N_(e=[],t){const n=String(t||"").trim();return n?(e||[]).filter(r=>r&&String(r.character_id||r.character_name||"").trim()===n).map(r=>String(r?.key||"")).filter(Boolean):[]}function I_(e={}){const t=Math.max(0,Math.floor(Number(e.itemCount)||0)),n=Math.max(0,Number(e.gap)||12),r=Math.max(48,Number(e.thumbMin)||148),a=Math.max(0,Number(e.cardExtra)||0),i=Math.max(r,Number(e.gridWidth)||600),s=Math.max(1,Number(e.clientHeight)||620),o=Math.max(0,Number(e.scrollTop)||0),c=Math.max(0,Math.floor(Number(e.overscanRows)||2)),l=Math.max(1,Math.floor((i+n)/(r+n))),f=r*(5/4)+a+n,d=t?Math.ceil(t/l):0,m=d*f;if(!t)return{start:0,end:0,topPad:0,bottomPad:0,cols:l,rowH:f};const p=Math.min(Math.max(0,d-1),Math.floor(o/f)),g=Math.max(1,Math.ceil(s/f)+1),h=Math.max(0,p-c),_=Math.min(d,p+g+c);return{start:h*l,end:Math.min(t,_*l),topPad:h*f,bottomPad:Math.max(0,m-_*f),cols:l,rowH:f}}function E_(e=[],t=[]){const n=i=>{const s=i&&typeof i=="object"?i.id:void 0;return String(s??i)},r=new Map((e||[]).map(i=>[n(i),i])),a=[];for(const i of t||[]){const s=String(i);r.has(s)&&(a.push(r.get(s)),r.delete(s))}for(const i of r.values())a.push(i);return a}Pr(),Zc();function C_(){Reflect.set(globalThis,"__INLAY_VIEWER_CORE__",{...Rg}),Reflect.set(globalThis,"__INLAY_LLM__",{...Ep}),Reflect.set(globalThis,"__INLAY_EMBED__",{EMBEDDING_PROVIDERS:di,normalizeEmbeddingProvider:Ee,defaultEndpointForEmbedding:Tr,defaultModelForEmbedding:Vn,embeddingModelPlaceholder:vp,shouldAutoReplaceEmbeddingEndpoint:kp,shouldAutoReplaceEmbeddingModel:Sp,embeddingProviderNeedsApiKey:Ap}),Reflect.set(globalThis,"__INLAY_LORE_EXTRA__",{...id}),Reflect.set(globalThis,"__INLAY_EXPLORER__",{...h_})}te(),q(),C_(),g_(),w("boot.loaded",{message:Ye})})();
...
var Zt = "inlay-nexus-native", ea = "Inlay Nexus", He = "2.1.11", rn = class extends Error {
  segment;
  constructor($) {
