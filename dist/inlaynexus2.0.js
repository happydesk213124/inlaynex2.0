...
//@display-name Inlay Nexus 2.0.10
//@api 3.0
//@version 2.0.10
...
globalThis.__INLAY_NATIVE_PROMPTS__ = {"__v":1,"__enc":""};

(function(){var Aa=Object.defineProperty,qt=(e,t)=>{let n={};for(var a in e)Aa(n,a,{get:e[a],enumerable:!0});return t||Aa(n,Symbol.toStringTag,{value:"Module"}),n},rt="2.0.10",hs="2026-08-02-lore-extra-boundary",Na=["author_note","tagger","format","prefill","preprocess","preset_1","lore_inject","char_inject","appearance_inject","autotag"],ps=["tagger","format","appearance_inject","lore_inject","autotag"],Ie="__global__",Ia="inx_native_settings",$a=e=>`inx_nxstore_${e}`,ve=e=>`inx_nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,Gt="inx_nxref_image",Wt="inx_nxvibe_image",Vt="inx_nxvibe_data",_s="native_settings",ys=e=>`nxstore_${e}`,bs=e=>`nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,ws="nxref_image",Uu="https://image.novelai.net/ai/generate-image",vs="https://image.novelai.net/ai/encode-vibe",xs="https://api.novelai.net/user/subscription",ks=["meta","cards","characters","jobs","images"],Ss=4e3;function st(){const e=globalThis;return e.risuai??e.Risuai}function Yt(e){return typeof st()?.[e]=="function"}var Ms=new Set(["ms","bytes","status","message","job_id","background","focus"]),xe=[],Zt="",Xt=null,Qt="boot",Nn="boot",Ea=null,As=e=>{Ea=e},en=e=>{Zt=e},Ns=()=>Zt,it=()=>Nn,tn=()=>Qt,In=()=>Xt,Is=()=>xe.length,ja=(e,t)=>xe.filter(n=>n.job_id===e).slice(-t),Ca=(e,t=280)=>{if(e==null||typeof e=="number"||typeof e=="boolean")return e;let n;if(typeof e=="string")n=e;else try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:`${n.slice(0,t)}…(+${n.length-t})`},$s=e=>e.startsWith("job.")||e.startsWith("nai.")||e.startsWith("llm.")||e.startsWith("image.");function v(e,t={},n="info"){const a={t:Date.now(),iso:new Date().toISOString(),stage:String(e||""),level:n,job_id:Zt||t.job_id||"",ms:t.ms!=null?Number(t.ms):void 0,bytes:t.bytes!=null?Number(t.bytes):void 0,status:t.status!=null?t.status:void 0,message:t.message!=null?Ca(t.message,240):void 0,detail:{}};for(const[s,i]of Object.entries(t))Ms.has(s)||(a.detail[s]=i==null||typeof i=="number"||typeof i=="boolean"?i:Ca(i,220));for(xe.push(a);xe.length>240;)xe.shift();Qt=a.stage,(t.focus||!t.background&&$s(a.stage))&&(Nn=a.stage),n==="error"&&(Xt={stage:a.stage,message:String(a.message??""),t:a.t});const r=`[InlayNX:${a.stage}]`+(a.message?` ${String(a.message)}`:"")+(a.ms!=null?` ${a.ms}ms`:"")+(a.bytes!=null?` ${a.bytes}B`:"");return n==="error"?console.error(r,a.detail):n==="warn"?console.warn(r,a.detail):console.log(r,a.detail),a}function Q(e){const t=Date.now();return{end:(n={},a="info")=>v(e,{...n,ms:Date.now()-t},a),fail:(n,a={})=>v(e,{...a,message:String(n?.message??n),ms:Date.now()-t},"error")}}function ae(){const e=st()??{};let t=null;try{t=typeof document<"u"?!!document.hidden:null}catch{}const n=xe.slice(-80),a={};for(const r of n)a[r.stage]=(a[r.stage]??0)+1;return{ok:!0,version:rt,now:Date.now(),last_stage:Qt,focus_stage:Nn,last_error:Xt,job_ctx:Zt||null,env:{has_nativeFetch:typeof e.nativeFetch=="function",has_getLocalPluginStorage:typeof e.getLocalPluginStorage=="function",has_pluginStorage:!!e.pluginStorage?.getItem,has_DecompressionStream:typeof DecompressionStream=="function",has_AbortController:typeof AbortController<"u",document_hidden:t},counts:{events:xe.length,...Ea?.()??{}},by_stage:a,errors:xe.filter(r=>r.level==="error").slice(-20),events:n}}function $n(){return xe.length=0,Xt=null,Qt="cleared",!0}function Je(e,t,n){const a=t?.error?.message,r=new Error(n??a??`HTTP ${e}`);return r.status=e,r.data=t,r}var Ta=e=>e instanceof Error&&typeof e.status=="number",Y=(e,t="error")=>({error:{code:t,message:e}}),Ke=e=>new Promise(t=>setTimeout(t,e)),En=class{tail=Promise.resolve();run(e){const t=this.tail.then(e,e);return this.tail=t.then(()=>{},()=>{}),t}},Mt=32768,Es=2e5;function re(e){return e?e instanceof Uint8Array?e:new Uint8Array(e):new Uint8Array(0)}function ot(e){const t=re(e);let n="";for(let a=0;a<t.length;a+=Mt)n+=String.fromCharCode(...t.subarray(a,a+Mt));return btoa(n)}async function He(e){const t=re(e);if(t.length<Es)return ot(t);let n="";for(let a=0;a<t.length;a+=Mt)n+=String.fromCharCode(...t.subarray(a,a+Mt)),a>0&&a%(Mt*24)===0&&await Ke(0);return btoa(n)}function js(e){return e?ot(e):""}async function Cs(e){return e?He(e):""}function $e(e){const t=atob(e),n=new Uint8Array(t.length);for(let a=0;a<t.length;a+=1)n[a]=t.charCodeAt(a);return n}function Ts(e){return e?$e(e).buffer:null}function Z(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}function At(e,t){const n=new Uint8Array(t);let a=0;for(const r of e)n.set(r,a),a+=r.length;return n}function Nt(e){return!!(e&&e.length>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)}function jn(e){return!!(e&&e.length>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70&&e[8]===87&&e[9]===69&&e[10]===66&&e[11]===80)}function It(e){const t=re(e);return jn(t)?"image/webp":Nt(t)?"image/png":t.length>=3&&t[0]===255&&t[1]===216&&t[2]===255?"image/jpeg":"image/png"}function Ls(e){const t=/^data:([^;,]+)?(;base64)?,(.*)$/i.exec(String(e||""));if(!t)return null;const n=!!t[2],a=t[3]||"";try{return Z(n?$e(a):new TextEncoder().encode(decodeURIComponent(a)))}catch{return null}}function u(e,t=2e5){if(e==null)return"";let n=String(e).replace(/\x00/g," ").replace(/\r\n/g,`
`);return n=n.replace(/[ \t\f\v]+/g," ").replace(/\n{4,}/g,`


`).trim(),n.slice(0,t)}function C(e,t=-1){if(e==null||typeof e=="string"&&!e.trim())return t;const n=parseInt(String(e),10);return Number.isNaN(n)?t:n}function nn(e){if(e==null||typeof e=="string"&&!e.trim())return null;const t=parseFloat(String(e));return Number.isNaN(t)?null:t}function P(...e){const t=[],n=new Set;for(const a of e)for(const r of u(a).split(",")){const s=r.trim();if(!s)continue;const i=s.toLowerCase();i==="null"||i==="none"||n.has(i)||(n.add(i),t.push(s))}return t.join(", ")}var U=e=>u(e,200).toLowerCase().replace(/\s+/g," "),ct=e=>u(e).toLowerCase().replace(/\s+/g,"");function J(e){if(e==null)return[];let t;if(Array.isArray(e))t=e.map(r=>u(r,200));else{const r=u(e,2e3);t=r?r.split(/[,|/]|,(?=\s)|、|\//):[],t.length<=1&&r&&(t=r.split(/\n+/))}const n=[],a=new Set;for(const r of t){const s=u(r,200);if(!s)continue;const i=U(s);!i||a.has(i)||(a.add(i),n.push(s))}return n}function Ps(e){let t=0;for(let n=0;n<e.length;n+=1)t=Math.imul(31,t)+e.charCodeAt(n)|0;return t}function Os(e){const t=u(e,1e6);let n=2166136261,a=2654435769;for(let r=0;r<t.length;r+=1){const s=t.charCodeAt(r);n^=s,n=Math.imul(n,16777619),a^=s+(n<<6|n>>>26),a=Math.imul(a,2246822507)}return`${(n>>>0).toString(16).padStart(8,"0")}${(a>>>0).toString(16).padStart(8,"0")}`}function Bs(e){const t=u(e??"",200);return t?`risu_${Os(`${t}|__unified__`)}`:""}function an(e){let t=e;for(let n=0;n<20;n+=1){const a=t.replace(/\{\{#when[\s\S]*?\}\}([\s\S]*?)\{\{\/when\}\}/g,"$1").replace(/\{\{#if[\s\S]*?\}\}([\s\S]*?)\{\{\/if\}\}/g,"$1").replace(/\{\{:else\}\}[\s\S]*?(?=\{\{\/)/g,"");if(a===t)break;t=a}return t.replace(/\{\{[^}]+\}\}/g,"").trim()}function Rs(e){const t=e.match(/\[Positive\]\s*([\s\S]*?)\s*\[Negative\]/),n=e.match(/\[Negative\]\s*([\s\S]*?)\s*$/);return t||n?[u(t?.[1]??""),u(n?.[1]??"")]:[u(e),""]}function qe(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}var Ge=4e3,Ju="",Ku=0,Hu="",Fs=[],Ds="indexeddb:getLocalPluginStorage",zs="indexeddb:inx_nximg_*",Us="embedded",Js={backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",notes:"PNG/settings live on this device (not save-file). Folder explorer reads card+location metadata."},Ks=JSON.parse(`{"power":true,"execute":"auto","mode":"illustration","image_min":3,"image_max":3,"character_max":2,"preset":1,"lorebook":true,"lore_extra":"tags","char_info":true,"user_info":true,"char_appearance":true,"preprocessing":false,"person_tag_mode":"gender","auto_person_tags":true,"original_text":"","custom_pos":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","custom_neg":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth","presets":[{"id":"프리셋_닭장_0_14izz","name":"프리셋 1","positive":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","negative":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth"},{"id":"프리셋_농후_1_u4veg","name":"프리셋 2","positive":"2.0::artist:duoyuanjun::, artist:dawalixi, artist:m (1n910), 1.45::artist:murata yuusuke::, 1.4::artist:konya karasue::, 1.5::artist:wanke::, 2.3::artist:lunch(shin new)::, 0.8::artist:baffu::, 1.4::artist:ishigaki takashi::, 0.8::artist:xipa::, 0.8::artist:freng::, 0.5::artist:kim eb::, year 2025, year 2024, 0.5::3d, blender::, high detail, masterpiece, best quality, very aesthetic, highres, best illustration, novel illustration, -3::simple illustration::, -1::censored::, -3::artist collaboration::, detailed background, -1::door::","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration"},{"id":"프리셋_매끈_2_jgrz3","name":"프리셋 3","positive":"2.4::artist:uki_(ukikusaya) ::, 0.6::artist:sohn woohyoung::, 0.6::artist:minamoto (mutton) ::, artist:sakura no tomoru hi e, 0.5::artist:bettkan::, 0.4::artist:nanja::, 0.4::artist:joy boy \\\\(jerrydurd\\\\) ::, artist:freng, 0.2::artist:murata yuusuke::, 0.8::artist:mx2j::, artist:aoi nagisa (metalder), 0.2::artist:oda non::, 0.4::artist:lunch_(shin new) ::, 0.6::artist:duoyuanjun::, year 2025, year 2024, year 2023, solo artist, -5.3::artist collaboration::, -1::faux retro artstyle::, -1::film grain::, -1::clean text::, -1::flat color::, 1.2::3d::, blender(medium), 1.3::realistic::, natural, incredibly absurdres, very aesthetic, highres, masterpiece, best quality, amazing quality, -3::simple illustration::, best illustration, novel illustration, 0.06::best::, -1::ring::, 1.5::uncensored::, -2::censored::, -2::bar censor::, 2::shiny realistic skin::, 1.3::steaming body::,","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, character sheet, reference sheet, lineup, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration,"},{"id":"프리셋_닭_3_8yiw2","name":"프리셋 2-1","positive":"1.5::artist:sohn woohyoung::, 1.6::artist:solipsist::, 1.45::artist:gogalking::, 1.2::artist:oda non::, 1.25::artist:henriiku_(ahemaru) ::, 1.6::artist:Ask (Askzy) ::, 2.7::artist:jagercoke::, 2::artist:seven (sixplusone) ::, artist:wlop, 1.25::artist:wanke::, artist:seoyong, 0.7::artist:healthyman::, artist:freng, 1.2::artist:sos adult::, artist:shinjiro, 2::artist:nianbingzi::, artist:teshima nari, year 2024, year 2025, 2::blender (medium) ::, 2::pastel (medium) ::, -2::flat color::, pastel colors, 1.4::masterpiece, very aesthetic::, best quality, amazing quality, absurdres, 2::realistic::, -6::artist collaboration::, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, no text, -1.1::pubic hair::, uncensored,","negative":"natsuki karin, text, logo, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, sketch"},{"id":"프리셋_말랑_4_ian7o","name":"프리셋 말랑","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_깔_5_3rh46","name":"프리셋 깔","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_쫀_6_815h6","name":"프리셋 쫀","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::, 1.4::bedroom::, 1.2::sunlight::, 2.9::hotel::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"},{"id":"프리셋_리얼_7_xwn4c","name":"프리셋 리얼","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"}],"active_preset_id":"프리셋_닭장_0_14izz","include_min":0,"include_max":0,"userchat":false,"gallery_fab":false,"floating_viewer":true,"overlay_markers":true,"llm_anchor_percent":true,"natural_base":true,"inline_previews":true,"inline_thumb_pct":100,"scale_semantics_version":2,"mobile_toggle_pin":false,"hover_preview":true,"hover_preview_anchor":"mouse","hover_preview_corner":"top-right","viewer_minimize_mode":"icon","unified_chat_priority":false,"overlay_hide_offscreen":true,"scroll_message_track":true,"click_message_track":true,"message_select_gesture":"single","text_drag_select":true,"show_risu_settings_button":true,"debug_panel":false,"generate_all_roles":false,"auto_gen_on_reply":false,"scroll_delay_ms":250,"capture_delay_ms":10,"overlay_x_pct":38,"overlay_y_pct":80,"overlay_pin_unit":"pct","overlay_pin_origin":"bl"}`),Hs={source:"custom",provider:"openrouter",endpoint:"https://openrouter.ai/api/v1/chat/completions",model:"openai/gpt-oss-20b:nitro",api_key:"",service_account_json:"",temperature:.4,max_tokens:8e3,timeout_seconds:180,reasoning_effort:"default",vertex_region:"us-central1",anthropic_version:"2023-06-01"},qs={provider:"Novel AI",backend:"nai",request_url:"https://image.novelai.net/ai/generate-image",api_key:"",model:"nai-diffusion-4-5-full",width:832,height:1216,sampler:"k_euler_ancestral",scheduler:"karras",steps:28,cfg_scale:7,cfg_rescale:.36,seed:0,variety_plus:!1,enable_i2i:!1,image_reference:"none",image_reference_strength:.6,image_reference_fidelity:1,image_reference_type:"character&style",vibe_transfer:"none",vibe_transfer_strength:.6,vibe_transfer_information_extracted:1,uc_preset:"human_focus",apply_quality_tags:!1,comfy_url:"http://localhost:8188",comfy_workflow_json:"",backend_timeout_seconds:300},Gs={bind_host:"",port:0,auth_token:"",allowed_origins:Fs,database_path:Ds,images_dir:zs,prompts_dir:Us,storage:Js,card:Ks,llm:Hs,nai:qs},Ws="nai-diffusion-4-full",Vs="nai-diffusion-4-curated-preview",Ys="nai-diffusion-3",Zs={"naid4.5f":"nai-diffusion-4-5-full","naid4.5c":"nai-diffusion-4-5-curated",naid4f:Ws,naid4c:Vs,naid3:Ys},qu="",Xs="Tag the chat message into Danbooru-style English image prompts. Output ONE JSON object only.",Qs='{"scenes":[{"place":"...","shots":[{"paragraph":0,"camera":"...","situation":"...","characters":[{"name":"...","action":"..."}]}]}],"new_characters":[]}',ei=`Registered: {registered_block}
Incomplete: {incomplete_block}
Detected: {detected_block}`,ti="Use matched lorebook context:",ni="Character info:",ai="Summarize visual details from the message.",Gu="",ri=`[Positive]
, masterpiece, best quality

[Negative]
lowres, bad quality, watermark`,si={author_note:"",tagger:Xs,format:Qs,appearance_inject:ei,lore_inject:ti,char_inject:ni,preprocess:ai,prefill:"",preset_1:ri},ii=", no text, best quality, very aesthetic, absurdres",oi=", rating:general, amazing quality, very aesthetic, absurdres",ci=", best quality, amazing quality, very aesthetic, absurdres",li={"naid4.5f":", location, very aesthetic, masterpiece, no text","naid4.5c":", location, masterpiece, no text, -0.8::feet::, rating:general",naid4f:ii,naid4c:oi,naid3:ci},ui={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, multiple views, logo, too many watermarks",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing",none:""},di={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, logo, dated, signature, multiple views, gigantic breasts",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing, logo, dated, signature",none:""},fi={heavy:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]",light:"lowres, jpeg artifacts, worst quality, watermark, blurry, very displeasing",human_focus:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract], bad anatomy, bad hands, @_@, mismatched pupils, heart-shaped pupils, glowing eyes",none:""},gi={"naid4.5f":{heavy:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page",light:"lowres, artistic error, scan artifacts, worst quality, bad quality, jpeg artifacts, multiple views, very displeasing, too many watermarks, negative space, blank page",human_focus:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page, @_@, mismatched pupils, glowing eyes, bad anatomy",none:""},"naid4.5c":{heavy:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, negative space, blank page",light:"blurry, lowres, upscaled, artistic error, scan artifacts, jpeg artifacts, logo, too many watermarks, negative space, blank page",human_focus:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, bad anatomy, bad hands, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, @_@, mismatched pupils, glowing eyes, negative space, blank page",none:""},naid4f:ui,naid4c:di,naid3:fi},We=Gs,mi=si,rn=li,hi=gi,pi=1,_i="inlay-nexus-prompt-pack-v1",yi=()=>new TextEncoder,bi=()=>new TextDecoder;function wi(e,t){const n=yi().encode(t),a=new Uint8Array(e.length);for(let r=0;r<e.length;r+=1)a[r]=e[r]^n[r%n.length];return a}function vi(e){if(typeof Buffer<"u")return new Uint8Array(Buffer.from(e,"base64"));const t=atob(e),n=new Uint8Array(t.length);for(let a=0;a<t.length;a+=1)n[a]=t.charCodeAt(a);return n}function xi(e){if(!e||typeof e!="object")return{};const t=e;if(typeof t.__enc=="string"){if(Number(t.__v??1)!==pi)return{};try{const a=bi().decode(wi(vi(t.__enc),_i)),r=JSON.parse(a),s={};for(const[i,o]of Object.entries(r))typeof o=="string"&&(s[i]=o);return s}catch{return{}}}const n={};for(const[a,r]of Object.entries(t))typeof r=="string"&&(n[a]=r);return n}function ki(){return xi(globalThis.__INLAY_NATIVE_PROMPTS__)}function sn(e){const t=u(ki()[e]);return t||mi[e]||""}var La=e=>!!e&&typeof e=="object"&&!Array.isArray(e);function se(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e))}function Ee(e,t){const n=se(e??{});for(const[a,r]of Object.entries(t??{})){const s=n[a];n[a]=La(r)&&La(s)?Ee(s,r):r}return n}function Si(e){const t=u(e).replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,""),n=t.slice(0,180).replace(/\s+/g," ");try{return JSON.parse(t)}catch{const a=t.match(/\{[\s\S]*\}/);if(!a)throw new Error(`태거 JSON 파싱 실패${n?` · 응답: ${n}`:" · 응답이 비어 있거나 JSON이 아님"}`);try{return JSON.parse(a[0])}catch(r){throw new Error(`태거 JSON 파싱 실패 · ${String(r?.message??r).slice(0,120)} · 응답: ${n}`)}}}var Pa=se(We);function E(){return Pa}function Cn(e){Pa=e}var Mi=new En,on=new Map,lt=new Map,Tn=new Set,Oa="",Ba="";function Ra(){return Oa}function Ln(e){Oa=e}function Fa(){return Ba}function Pn(e){Ba=e}var Ai=["necklace","earring","earrings","bracelet","ring","pendant","brooch","bag","backpack","purse","handbag","briefcase","suitcase","pouch","satchel","watch","wristwatch","wristband","badge","id card","lanyard","name badge","nameplate","glasses","sunglasses","goggles","monocle","crown","tiara","veil","sword","katana","knife","dagger","gun","pistol","rifle","spear","axe","staff","wand","blade","weapon","shield","crossbow","scythe","hammer","umbrella","phone","smartphone","book","clipboard","folder","cigarette","microphone","camera","holding","airpods","earbuds","earbud","earphones","earphone","headphones","headset","in one ear","wireless earbuds"],Ni=["shirt","blouse","pants","trousers","jeans","shorts","skirt","dress","jacket","coat","hoodie","sweater","cardigan","vest","waistcoat","uniform","armor","robe","cloak","cape","apron","overalls","leggings","stockings","tights","pantyhose","socks","thighhighs","boots","shoes","heels","sandals","slippers","footwear","barefoot","gloves","mittens","hat","cap","beret","hood","scarf","necktie","bowtie","tie","belt","bra","panties","underwear","lingerie","swimsuit","bikini","kimono","yukata","hakama","cheongsam","hanbok","suit","tuxedo","collar","choker","mask","helmet","nude","naked","topless","bottomless","completely nude","open shirt","unbuttoned","unzipped","torn clothes","clothes","clothing","outfit","attire","sleeves","rolled-up sleeves","long sleeves","short sleeves","sleeveless","off shoulder","bare shoulders","midriff","navel","cleavage","garter","corset","bodysuit","leotard","fishnets","ribbon","bow","bandana","no shirt","no pants","shirt lift","panties pull","skirt lift"],q=e=>String(e??"").trim().replace(/\s+/g," "),ut=e=>q(e).normalize("NFKC").toLocaleLowerCase().replace(/[\s_.·•･-]+/g,"");function je(e){const t=Array.isArray(e)?e:String(e??"").split(/[,/\n]/),n=[],a=new Set;for(const r of t){const s=q(r),i=ut(s);!s||a.has(i)||(a.add(i),n.push(s))}return n}function Ii(e){const t=q(e).split(" ").filter(Boolean);return t.length!==2||!t.every(n=>/^[A-Za-z'-]+$/.test(n))||!t.every(n=>n===n.toUpperCase())?{surname:"",given_name:""}:{surname:t[0],given_name:t[1]}}function pe(e={}){const t=q(e.name),n=Ii(t);return{...e,id:q(e.id)||t,name:t,aliases:je(e.aliases),surname:q(e.surname)||n.surname,given_name:q(e.given_name)||n.given_name,surname_variants:je(e.surname_variants),given_name_variants:je(e.given_name_variants),priority:Number.isFinite(Number(e.priority))?Number(e.priority):0,attire_locked:e.attire_locked===!0,accessories_locked:e.accessories_locked===!0,schema_version:2}}function cn(e,t,n){const a=pe(e);return new Set(je([a[t],...a[n]||[]]).map(ut).filter(Boolean))}function Da(e,t){const n=pe(e),a=pe(t),r=cn(n,"surname","surname_variants"),s=cn(a,"surname","surname_variants"),i=cn(n,"given_name","given_name_variants"),o=cn(a,"given_name","given_name_variants");if(!r.size||!s.size||!i.size||!o.size)return!1;const c=[...r].some(d=>s.has(d)),l=[...i].some(d=>o.has(d));return c&&l}function za(e,t){if(!e||!t)return!1;const n=pe(e),a=pe(t);if(n.id&&a.id&&String(n.id)===String(a.id)||Da(n,a))return!0;const r=On(n),s=On(a);for(const i of r)if(s.has(i))return!0;return!1}function On(e){const t=pe(e),n=new Set,a=o=>{const c=ut(o);c&&n.add(c)};a(t.name);const r=new Set(je([t.surname,...t.surname_variants]).map(ut));for(const o of t.aliases)r.has(ut(o))||a(o);const s=je([t.surname,...t.surname_variants]),i=je([t.given_name,...t.given_name_variants]);for(const o of s)for(const c of i)a(`${o} ${c}`),a(`${o}${c}`),a(`${c} ${o}`);return n}function $i(e,t=[]){const n=ut(e);if(!n)return null;const a=t.map(r=>pe(r)).filter(r=>On(r).has(n));return a.length!==1?null:a[0]}function Ei(e,t){const n=Number(t.priority||0)-Number(e.priority||0);if(n)return n;const a=Number(e.created_at||e.updated_at||0)-Number(t.created_at||t.updated_at||0);return a||String(e.id).localeCompare(String(t.id))}function Bn(...e){return je(e.flat())}function ji(e){const t=[...e].sort(Ei),n={...t[0]};n.aliases=Bn(...t.map(a=>[a.name,...a.aliases||[]])),n.surname_variants=Bn(...t.map(a=>[a.surname,...a.surname_variants||[]])),n.given_name_variants=Bn(...t.map(a=>[a.given_name,...a.given_name_variants||[]])),n.surname||(n.surname=t.map(a=>a.surname).find(Boolean)||""),n.given_name||(n.given_name=t.map(a=>a.given_name).find(Boolean)||"");for(const a of t){const r=q(a.appearance||""),s=q(a.attire||""),i=q(a.accessories||""),o=q(a.original||"");r.length>q(n.appearance||"").length&&(n.appearance=r),!n.attire_locked&&s.length>q(n.attire||"").length&&(n.attire=s),!n.accessories_locked&&i.length>q(n.accessories||"").length&&(n.accessories=i),o&&!q(n.original||"")&&(n.original=o)}return n.surname=q(n.surname)||t.map(a=>q(a.surname)).find(Boolean)||"",n.given_name=q(n.given_name)||t.map(a=>q(a.given_name)).find(Boolean)||"",n}function Ci(e=[]){const t=e.map(r=>pe(r)),n=[],a=new Set;for(let r=0;r<t.length;r++){if(a.has(r))continue;const s=[t[r]];a.add(r);for(let i=r+1;i<t.length;i++)a.has(i)||s.some(o=>Da(o,t[i]))&&(a.add(i),s.push(t[i]));n.push(s)}return{records:t,active:n.map(ji),groups:n}}function $t(e){const t=pe(e||{}),n=J([t.name,...t.aliases||[]]),a=J([t.surname,...t.surname_variants||[]]),r=J([t.given_name,...t.given_name_variants||[]]);for(const s of a)for(const i of r)n.push(`${s} ${i}`,`${s}${i}`,`${i} ${s}`);return J(n).filter(s=>!a.some(i=>U(i)===U(s)))}function ie(e,t){return $i(e,t||[])}function Rn(e,t,n=6){const a=Math.max(1,Math.min(6,Number(n)||6)),r=[],s=new Set,i=(o,c)=>{if(!o||!c)return o;for(const l of["action","expression","attire","accessories","appearance","label","age","body","sex","original","original_tag","negative"]){const d=u(o[l]||"",2e3),g=u(c[l]||"",2e3);g&&(d?d.toLowerCase().includes(g.toLowerCase())||(o[l]=P(d,g)):o[l]=g)}return o};for(const o of e||[]){if(!o||typeof o!="object")continue;const c=u(o.name,200);if(!c)continue;const l=ie(c,t),d=l?`id:${u(l.id||l.name,200)}`:`name:${U(c)}`;if(!d||d==="id:"||d==="name:")continue;const g=r.findIndex(p=>p._dedupeKey===d);if(g>=0){i(r[g],o);continue}r.length>=a||(s.add(d),r.push({...o,name:l?.name||c,_dedupeKey:d}))}return r.map(({_dedupeKey:o,...c})=>c)}function Fn(e){const t=new Set;for(const a of $t(e)){const r=U(a);r&&t.add(r)}const n=U(e?.name);return n&&t.add(n),t}function Dn(e){return Ci(e||[]).active}function Ti(e,t){const n=u(e).toLowerCase(),a=ct(e);if(!n)return[];const r=[],s=new Set;for(const i of t||[]){const o=u(i.id||i.name,200);if(!(!o||s.has(o)))for(const c of $t(i)){const l=U(c),d=ct(c);if(!(d.length<2)&&(n.includes(l)||a.includes(d))){r.push(i),s.add(o);break}}}return r}function dt(e,t=""){if(typeof e!="object"||e===null)return null;const n=e,a=u(n.name||t,200);if(!a)return null;let r=J(n.aliases);r=[a,...r.filter(g=>U(g)!==U(a))];const s=u(n.original||n.original_tag||n.copyright||"",400);let i=u(n.appearance||"",4e3),o=u(n.attire||"",4e3),c=u(n.accessories||"",4e3);const l=u(n.tags||"",4e3);if(l&&!i&&!o&&!c)[i,o,c]=ee(l);else if(l){const[g,p,f]=ee(P(i,l));i=g,o=P(o,p),c=P(c,f)}if(i){const[g,p,f]=ee(i);i=g,o=P(o,p),c=P(c,f)}s&&i&&(i=P(...i.split(",").filter(g=>U(g)!==U(s))));let d=u(n.id,80)||a.replace(/[^a-zA-Z0-9_\uac00-\ud7a3]+/g,"_").replace(/^_|_$/g,"").slice(0,64);return d||(d=`char_${Math.abs(Ps(a))%1e7}`),pe({...n,id:d,name:a,aliases:r,original:s,appearance:i,attire:o,accessories:c})}function Li(e,t,n={}){const a=Array.isArray(e)?e:[],r=Array.isArray(t)?t:[],s=typeof n.hasAppearance=="function"?n.hasAppearance:()=>!1,i=typeof n.resolve=="function"?n.resolve:()=>null,o=typeof n.aliasKeys=="function"?n.aliasKeys:()=>new Set,c=typeof n.normalizeName=="function"?n.normalizeName:h=>String(h||"").trim().toLowerCase(),l=typeof n.fullTags=="function"?n.fullTags:()=>"",d=typeof n.clean=="function"?n.clean:h=>String(h||"").trim(),g=n.globalScope||"__global__",p=[],f=new Set;for(const h of a){if(!d(h?.name,200)||s(h))continue;const m=i(h.name,r);if(m&&s(m))continue;for(const y of o(h))f.add(y);const _=c(h.name);_&&f.add(_)}for(const h of r){const m=i(h.name,a);if([...o(h)].some(S=>f.has(S)))continue;const _=!h.attire_locked&&d(m?.attire||"")?m?.attire||"":h.attire||"",y=!h.accessories_locked&&d(m?.accessories||"")?m?.accessories||"":h.accessories||"",x=_!==(h.attire||""),k=y!==(h.accessories||"");m&&(x||k)?p.push({...h,attire:_,accessories:y,aliases:h.aliases||m.aliases||[],tags:l({...h,attire:_,accessories:y}),scope:g}):p.push(h)}for(const h of a){const m=i(h.name,p);if(!(m&&s(h))){if(m&&!s(h)){if(s(m))continue;const _=p.findIndex(y=>i(h.name,[y]));_>=0?p[_]=h:p.push(h);continue}m||p.push(h)}}return p}var Pi=Ni,Oi=Ai,Bi=["off","girls","people","gender"],Ri=/\b(?:\d+\+?)?girls?\b|\bwom(?:an|en)\b|\bfemale\b|\blady\b|\bladies\b|\bmilf\b|\bloli\b|\bmaiden\b/i,Fi=/\b(?:\d+\+?)?boys?\b|\bm(?:a|e)n\b|\bmale\b|\bguys?\b|\bgentleman\b|\botoko\b/i,Ua=/^\d+\+?(?:girls?|boys?|people|person)$/i,Di=e=>Bi.includes(e);function Ja(e){const t=u(e).toLowerCase();return t?Oi.some(n=>t.includes(n)):!1}function zi(e){const t=u(e).toLowerCase();return!t||Ja(t)?!1:Pi.some(n=>t.includes(n))}function ee(e){const t=[],n=[],a=[];for(const r of u(e).split(",")){const s=r.trim();s&&(Ja(s)?a.push(s):zi(s)?n.push(s):t.push(s))}return[P(...t),P(...n),P(...a)]}function Ui(e){const[t,n]=ee(e);return[t,n]}function Ce(e,t,n,a){const[r,s,i]=ee(P(e,t,n)),o=u(a);if(!o)return[r,s,i];const[c,l,d]=ee(o);return[P(r,c),l||(d?s:o),d||i]}function Te(e,t,n,a){const[r,s,i]=ee(P(e,t,n)),o=u(a);if(!o)return[r,s,i];const[c,l,d]=ee(o);return[P(r,c),P(s,l),d||o]}function Ji(...e){const t=P(...e.filter(r=>r!=null).map(r=>u(r)));if(!t)return null;const n=(t.match(Ri)||[]).length,a=(t.match(Fi)||[]).length;return n>a?"f":a>n?"m":null}function ln(e,t,n,a){return e<=0?"":e===1?t:e<=5?`${e}${n}`:a}function Ki(e,t){const n=[],a=ln(e,"1girl","girls","6+girls"),r=ln(t,"1boy","boys","6+boys");return a&&n.push(a),r&&n.push(r),n.join(", ")}function Hi(e){const t=[];for(const n of u(e).split(",")){const a=n.trim();a&&(Ua.test(a)||t.push(a))}return P(...t)}function Ka(e){const t=[],n=new Set;for(const a of u(e).split(",")){let r=a.trim();if(!r)continue;if(Ua.test(r)){const i=r.toLowerCase();if(i.includes("girl"))r="girl";else if(i.includes("boy"))r="boy";else continue}const s=r.toLowerCase();n.has(s)||(n.add(s),t.push(r))}return P(...t)}function Ha(e,t=null){let n=e;if(n==null&&t!=null&&(n=t),n===!1)return"off";if(n===!0)return"gender";const a=u(n,40).toLowerCase();return["","auto","mixed","true","1","on"].includes(a)?"gender":["off","none","false","0","disable","disabled"].includes(a)?"off":["girl","all_girls","girls_only"].includes(a)?"girls":["person","persons"].includes(a)?"people":Di(a)?a:"gender"}function qi(e,t,n="gender",a=null){const r=Ha(n,a);if(r==="off")return"";const s=(e||[]).slice(0,6),i=s.length;if(i<=0)return"";if(r==="girls")return ln(i,"1girl","girls","6+girls");if(r==="people")return ln(i,"1person","people","6+people");let o=0,c=0;for(const l of s){const d=u(l.name,200),g=d?ie(d,t):null,p=Ji(g?.appearance,g?.attire,g?.accessories,l.sex,l.label,l.age,l.appearance,l.body,l.attire,l.accessories);p==="f"?o++:p==="m"&&c++}return Ki(o,c)}function ft(e){return P(e?.original||"",e?.appearance||"",e?.attire||"",e?.accessories||"")}function _e(e){if(typeof e!="object"||e===null)return!1;const t=e;let n=u(t.appearance||"",4e3);if(!n)return!1;const a=u(t.original||"",400);a&&(n=P(...n.split(",").filter(i=>U(i)!==U(a))));const[r]=Ui(n);if(n=u(r||"",4e3),!n)return!1;const s=new Set(["girl","boy","man","woman","male","female","1girl","1boy","2girls","2boys","solo","other"]);return n.split(",").map(i=>i.trim().toLowerCase()).filter(Boolean).filter(i=>!s.has(i)&&!/^\d+(girl|boy)s?$/.test(i)).length>0}function Le(e){const t=typeof e=="object"&&e?e:{},n=C(t.character_max??t.char_max??6,6);return Math.max(1,Math.min(6,n))}function Gi(e,t,n,a){let r=u(e);if(!r)return"";for(const o of a){const c=u(o);if(c)if(r.endsWith(c))r=r.slice(0,r.length-c.length).replace(/[,\s]+$/g,"");else{const l=r.lastIndexOf(c);l>=0&&(r=`${r.slice(0,l)}${r.slice(l+c.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}}const s=u(t);if(s)if(r.startsWith(s))r=r.slice(s.length).replace(/^[,\s]+/g,"");else{const o=r.indexOf(s);o>=0&&(r=`${r.slice(0,o)}${r.slice(o+s.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}const i=[...n].map(o=>u(o)).filter(Boolean).sort((o,c)=>c.length-o.length);for(const o of i){const c=r.indexOf(o);c<0||(r=`${r.slice(0,c)}${r.slice(c+o.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}return u(r)}function Wi(e){const t=u(e.setup),n=u(e.main);if(!n)return{lockedSetup:t,rebuildMain:!0};if(t&&t!==n)return{lockedSetup:t,rebuildMain:!0};const a=u(e.person);if(a||e.stylePositives&&e.stylePositives.length){const r=Gi(n,a,e.stylePositives||[],e.qualitySuffixes||[]);if(r&&r!==n)return{lockedSetup:r,rebuildMain:!0}}return{lockedSetup:"",rebuildMain:!1}}function Vi(e){if(!e||typeof e!="object")return[];const t=[],n=u(e.custom_pos);n&&t.push(n);const a=Array.isArray(e.presets)?e.presets:[];for(const r of a){if(!r||typeof r!="object")continue;const s=r,i=u(s.positive||s.pos);i&&t.push(i)}return t}async function qa(e,t,n){const a=new Blob([e],{type:t});let r=null;if(typeof createImageBitmap=="function"?r=await createImageBitmap(a):n&&typeof document<"u"&&(r=await new Promise((o,c)=>{const l=new Image,d=URL.createObjectURL(a);l.onload=()=>{URL.revokeObjectURL(d),o(l)},l.onerror=()=>{URL.revokeObjectURL(d),c(new Error("image decode failed"))},l.src=d})),!r)return null;const s=r,i="naturalWidth"in s?{w:s.naturalWidth,h:s.naturalHeight}:{w:0,h:0};return{source:s,width:s.width||i.w||0,height:s.height||i.h||0,close:()=>{try{"close"in s&&s.close()}catch{}}}}function Ga(e,t,n,a){if(a&&typeof OffscreenCanvas<"u"){const r=new OffscreenCanvas(t,n),s=r.getContext("2d");return s?(s.drawImage(e.source,0,0,t,n),{kind:"offscreen",canvas:r}):null}if(typeof document<"u"){const r=document.createElement("canvas");r.width=t,r.height=n;const s=r.getContext("2d");return s?(s.drawImage(e.source,0,0,t,n),{kind:"dom",canvas:r}):null}return null}async function Yi(e,t=.8){const n=re(e);if(!n.length)return null;if(jn(n))return Z(n);const a=It(n);try{const r=await qa(n,a,!0);if(!r)return null;if(!(r.width>0&&r.height>0))return r.close(),null;const s=Ga(r,r.width,r.height,!0);if(!s)return r.close(),null;let i;if(s.kind==="offscreen"){const c=await s.canvas.convertToBlob({type:"image/webp",quality:t});if(r.close(),!c||!c.size)return null;i=await c.arrayBuffer()}else i=Ls(s.canvas.toDataURL("image/webp",t)),r.close();if(!i)return null;const o=re(i);return!jn(o)||o.length>=n.length*.98?null:i}catch(r){return v("image.webp.encode.fail",{message:String(r?.message||r)},"warn"),null}}async function Zi(e){let t=re(e);if(!t.length)throw new Error("image is empty");const n=1536,a=12e5,r=It(t),s=t.length>a;try{const i=await qa(t,r,!1);if(i&&(s||i.width>n||i.height>n)){const o=Math.min(1,n/Math.max(i.width,i.height,1)),c=Ga(i,Math.max(1,Math.round(i.width*o)),Math.max(1,Math.round(i.height*o)),!1);if(c?.kind==="dom"){const l=await new Promise(d=>{c.canvas.toBlob(d,"image/png")});if(l)return t=new Uint8Array(await l.arrayBuffer()),i.close(),{bytes:t,mime:"image/png",filename:"image.png"}}}i?.close()}catch(i){v("autotag.resize",{message:String(i?.message||i)},"warn")}return{bytes:t,mime:r,filename:`image.${r==="image/jpeg"?"jpg":r==="image/webp"?"webp":"png"}`}}var Wa=e=>typeof e?.getItem=="function"&&typeof e?.setItem=="function",Et=null;async function un(){return Et||(Et=(async()=>{const e=st();if(typeof e?.getLocalPluginStorage=="function")try{const n=Q("storage.open"),a=await e.getLocalPluginStorage();if(Wa(a))return n.end({message:"idb/getLocalPluginStorage"}),{kind:"idb",api:a};n.end({message:"getLocalPluginStorage returned unusable api"},"warn")}catch(n){v("storage.open",{message:String(n?.message||n)},"error"),console.warn("[Inlay Nexus] getLocalPluginStorage failed",n?.message||n)}const t=e?.pluginStorage;if(Wa(t))return v("storage.open",{message:"fallback pluginStorage (save-file)"},"warn"),console.warn("[Inlay Nexus] falling back to pluginStorage (save-file scoped)"),{kind:"plugin",api:t};throw v("storage.open",{message:"no storage API"},"error"),new Error("기기 로컬 IndexedDB 저장소(getLocalPluginStorage)를 사용할 수 없습니다.")})().catch(e=>{throw Et=null,e}),Et)}function Xi(){return st()?.pluginStorage??null}async function Ve(e,t){try{const{kind:n,api:a}=await un(),r=await a.getItem(e);if(r!=null&&r!=="")return r;if(n==="idb"&&t){const s=Xi();if(s?.getItem)try{const i=await s.getItem(t);if(i!=null&&i!=="")return await a.setItem(e,i),i}catch{}}return null}catch{return null}}function Qi(e){if(typeof e=="string")return e.length;try{return JSON.stringify(e).length}catch{return 0}}async function gt(e,t){const{kind:n,api:a}=await un(),r=Qi(t),s=r>5e4?Q("storage.set.large"):null;try{return await a.setItem(e,t),s?s.end({message:e,bytes:r,kind:n,background:!0}):r>8e3&&v("storage.set",{message:e,bytes:r,kind:n,background:!0}),!0}catch(i){throw s?s.fail(i,{message:e,bytes:r,kind:n,background:!0}):v("storage.set",{message:`${e}: ${i?.message||i}`,bytes:r,kind:n,background:!0},"error"),i}}async function Pe(e){try{const{api:t}=await un();t?.removeItem&&await t.removeItem(e)}catch{}}var eo=class{budgetChars;urls=new Map;pinned=new Set;bytes=0;constructor(e){this.budgetChars=e}get size(){return this.urls.size}get byteLength(){return this.bytes}get(e){const t=String(e||"");if(!t)return;const n=this.urls.get(t);if(n!==void 0)return this.urls.delete(t),this.urls.set(t,n),n}set(e,t){const n=String(e||"");if(!n||typeof t!="string"||!t)return;const a=this.urls.get(n);a!==void 0&&(this.bytes-=a.length),this.urls.delete(n),this.urls.set(n,t),this.bytes+=t.length,this.evict()}drop(e){const t=String(e||""),n=this.urls.get(t);n!==void 0&&(this.urls.delete(t),this.bytes-=n.length,this.pinned.delete(t))}pin(e){this.pinned.clear();for(const t of e){const n=String(t||"");if(!n)continue;this.pinned.add(n);const a=this.urls.get(n);a!==void 0&&(this.urls.delete(n),this.urls.set(n,a))}this.evict()}pinnedIds(){return[...this.pinned]}clear(){this.urls.clear(),this.pinned.clear(),this.bytes=0}evict(){if(!(this.bytes<=this.budgetChars))for(const[e,t]of this.urls){if(this.bytes<=this.budgetChars)break;this.pinned.has(e)||(this.urls.delete(e),this.bytes-=t.length)}}},to=33554432,jt=new eo(to),O={meta:new Map,cards:new Map,characters:new Map,jobs:new Map,images:new Map},Ct=new Map;function Va(e){const t=String(e.session_id??"");if(!t)return;let n=Ct.get(t);n||(n=new Set,Ct.set(t,n)),n.add(String(e.id))}function Ya(e){if(!e)return;const t=String(e.session_id??""),n=t?Ct.get(t):void 0;n&&(n.delete(String(e.id)),n.size===0&&Ct.delete(t))}function Za(e,t){if(e==="characters"){if(Array.isArray(t))return`${t[0]}	${t[1]}`;if(t&&typeof t=="object"){const n=t;return`${n.scope}	${n.id}`}}return String(t)}function no(e,t){if(!t||typeof t!="object")return"";const n=t;return e==="meta"?String(n.key||""):e==="characters"?`${n.scope}	${n.id}`:String(n.id||"")}var ao=25,dn=new Set,mt=null,zn=Promise.resolve(),ue=Promise.resolve(),ro=!1;function so(e){if(!e||typeof e!="object")return e;const t={...e};if(!t.result_json)return t;try{const n=JSON.parse(t.result_json);if(!n||typeof n!="object")return t;const a={...n};delete a.tagged,delete a.appearance,delete a.debug_tail,Array.isArray(a.cards)&&(a.cards=a.cards.map(r=>{if(!r||typeof r!="object")return r;const s={...r};return typeof s.image_url=="string"&&s.image_url.startsWith("data:")&&(s.image_url=""),s})),t.result_json=JSON.stringify(a)}catch{}return t}function io(e){const t={};if(e==="images"){for(const[n,a]of O.images)t[n]={id:a.id,location:a.location||null,has_png:a.has_png,png_bytes:a.png_bytes,storage:"indexeddb",storage_key:ve(n)};return t}for(const[n,a]of O[e]){const r=a;if(e==="meta"&&r?.key==="reference_image"){t[n]={key:"reference_image",has_png:!!r.png,updated_at:r.updated_at||0};continue}if(e==="meta"&&r?.key==="vibe_transfer"){t[n]={key:"vibe_transfer",has_png:!!r.png,has_encoded:!!r.encoded,model:r.model||"",information_extracted:r.information_extracted??1,updated_at:r.updated_at||0};continue}if(e==="jobs"){t[n]=so(r);continue}t[n]=a}return t}async function oo(e){await gt($a(e),io(e))}function Xa(){mt=null;const e=[...dn];dn.clear(),e.length&&(zn=zn.then(async()=>{for(const t of e){if(ro){v("storage.persist.skip",{message:t,background:!0});continue}try{await oo(t)}catch(n){console.warn("[Inlay Nexus] persist failed",t,n?.message||n)}}}).catch(()=>{}))}function ht(e){dn.add(e),!mt&&(mt=setTimeout(Xa,ao))}async function Qa(){mt&&(clearTimeout(mt),Xa()),await zn,await ue}function co(){const e=globalThis.document;if(!e?.addEventListener)return;const t=()=>{!mt&&!dn.size||Qa()};e.addEventListener("visibilitychange",()=>{e.visibilityState==="hidden"&&t()}),globalThis.addEventListener?.("pagehide",t)}co();var er=100663296,pt=0;function lo(e,t){O.images.delete(e),O.images.set(e,t)}function tr(e){if(pt+=e,!(pt<=er))for(const t of O.images.values()){if(pt<=er)break;!t.png||!t.durable||(pt-=t.png.byteLength,t.png=null,t.hydrated=!1)}}var Un=new Map,Jn=e=>typeof e=="string"&&e?Ts(e):null;async function uo(e,t){if(t.hydrated)return t.png;const n=Un.get(e);if(n)return n;const a=(async()=>{const r=Jn(await Ve(ve(e),bs(e)));return t.png=r,t.hydrated=!0,t.durable=!0,r?(t.png_bytes=r.byteLength,tr(r.byteLength)):(t.has_png=!1,t.png_bytes=0),r})().finally(()=>Un.delete(e));return Un.set(e,a),a}var Tt=null;async function Oe(){return Tt||(Tt=(async()=>{for(const e of ks){const t=await Ve($a(e),ys(e));if(t==null||t==="")continue;let n=t;if(typeof t=="string")try{n=JSON.parse(t)}catch{continue}if(!(!n||typeof n!="object"))for(const[a,r]of Object.entries(n)){const s=r??{};if(e==="images"){const i=!!s.has_png;O.images.set(a,{id:String(s.id||a),location:s.location||{},png:null,has_png:i,png_bytes:Number(s.png_bytes)||0,hydrated:!i,durable:!0})}else if(e==="meta"&&(s.key==="reference_image"||a==="reference_image")){const i=Jn(await Ve(Gt,ws));O.meta.set("reference_image",{key:"reference_image",png:i})}else if(e==="meta"&&(s.key==="vibe_transfer"||a==="vibe_transfer")){const i=Jn(await Ve(Wt));let o=await Ve(Vt);if(typeof o=="string")try{o=JSON.parse(o)}catch{o=null}const c=o??{};O.meta.set("vibe_transfer",{key:"vibe_transfer",png:i,encoded:c.encoded||"",model:c.model||s.model||"",information_extracted:c.information_extracted??s.information_extracted??1})}else if(e==="cards"){const i=s;O.cards.set(a,i),Va(i)}else O[e].set(a,s)}}return!0})().catch(e=>{throw Tt=null,e}),Tt)}async function R(e,t){await Oe();const n=Za(e,t);if(e==="images"){const r=O.images.get(n);return r?(r.hydrated?r.png&&lo(n,r):await uo(n,r),r):void 0}const a=O[e].get(n);return a??void 0}async function fo(e){await Oe();const t=O.images.get(String(e));if(t)return{has_png:t.has_png,png_bytes:t.png_bytes}}async function F(e,t,n={}){await Oe();const a=no(e,t);if(!a)throw new Error(`invalid ${e} key`);const r=n.persist!==!1;if(e==="images"){const s=t.png||null,i=O.images.get(a);i?.png&&(pt-=i.png.byteLength);const o={id:String(t.id),location:t.location||{},...typeof t.mime=="string"&&t.mime?{mime:t.mime}:{},png:s,has_png:!!s,png_bytes:s?s.byteLength:0,hydrated:!0,durable:!s};return O.images.set(a,o),s?(tr(s.byteLength),ue=ue.then(async()=>{const c=await He(new Uint8Array(s));await gt(ve(a),c),O.images.get(a)===o&&(o.durable=!0)}).catch(c=>console.warn("[Inlay Nexus] image persist failed",a,c?.message||c))):ue=ue.then(()=>Pe(ve(a))).catch(()=>{}),r&&ht("images"),a}if(e==="meta"&&t.key==="reference_image"){const s=t.png||null;return O.meta.set("reference_image",{key:"reference_image",png:s}),s?ue=ue.then(async()=>{await gt(Gt,await He(new Uint8Array(s)))}).catch(i=>console.warn("[Inlay Nexus] ref persist failed",i?.message||i)):ue=ue.then(()=>Pe(Gt)).catch(()=>{}),r&&ht("meta"),"reference_image"}if(e==="meta"&&t.key==="vibe_transfer"){const s={key:"vibe_transfer",png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return O.meta.set("vibe_transfer",s),ue=ue.then(async()=>{s.png?await gt(Wt,await He(new Uint8Array(s.png))):await Pe(Wt),s.encoded?await gt(Vt,{encoded:s.encoded,model:s.model,information_extracted:s.information_extracted}):await Pe(Vt)}).catch(i=>console.warn("[Inlay Nexus] vibe persist failed",i?.message||i)),r&&ht("meta"),"vibe_transfer"}if(e==="cards"){Ya(O.cards.get(a));const s=t;return O.cards.set(a,s),Va(s),r&&ht("cards"),a}return O[e].set(a,t),r&&ht(e),a}async function _t(e,t){await Oe();const n=Za(e,t);if(e==="cards"&&Ya(O.cards.get(n)),e==="images"){const a=O.images.get(n);a?.png&&(pt-=a.png.byteLength)}return O[e].delete(n),e==="images"&&await Pe(ve(n)),e==="meta"&&n==="reference_image"&&await Pe(Gt),e==="meta"&&n==="vibe_transfer"&&(await Pe(Wt),await Pe(Vt)),ht(e),e==="images"&&ar(n),!0}async function de(e){return await Oe(),[...O[e].values()]}async function nr(e){await Oe();const t=Ct.get(String(e));if(!t)return[];const n=[];for(const a of t){const r=O.cards.get(a);r&&n.push(r)}return n}function Lt(e){return O[e].size}function go(){let e=0;for(const t of O.images.values())e+=t.png_bytes;return e}function mo(){const e=[];for(const t of O.images.values())e.push(t.location||{});return e}async function ho(e){await Oe();const t=O.images.get(String(e))?.location;return t&&typeof t=="object"?t:{}}function Pt(e){return jt.get(String(e))}function po(e,t){jt.set(String(e),t)}function ar(e){jt.drop(String(e))}function _o(e){jt.pin(e)}function yo(){return jt.size}async function bo(e){return(await R("images",String(e)))?.png??null}async function yt(e){if(!e)return"";const t=Pt(e);if(t!==void 0)return t;const n=Q("image.data_url"),a=await R("images",e);if(!a?.png)return n.end({message:`missing png ${e}`,id:e,background:!0},"warn"),"";const r=typeof a.mime=="string"&&a.mime||It(a.png),s=`data:${r};base64,${await Cs(a.png)}`;return po(e,s),n.end({message:e,bytes:a.png.byteLength||0,mime:r,url_len:s.length,focus:!0}),s}function ye(e){const t=typeof e=="string"?e:e?.id;return t&&Pt(String(t))||""}async function Kn(e,t,n=null){const a=Q("image.publish");ar(e);let r=t,s=It(t);try{const o=await Yi(t,.8);o&&(r=o,s="image/webp")}catch(o){v("image.webp",{message:String(o?.message||o),id:e},"warn")}await F("images",{id:e,png:r,mime:s,location:n||{}});let i="";try{const o=yt(e);i=await Promise.race([o,Ke(5e3).then(()=>ye(e)||"")]),i||(v("image.data_url.defer",{message:e,bytes:r?.byteLength||0,mime:s,focus:!0},"warn"),o.catch(c=>console.warn("[Inlay Nexus] deferred data URL failed",c?.message||c)))}catch(o){v("image.data_url",{message:String(o?.message||o),id:e},"warn"),Promise.resolve().then(()=>yt(e)).catch(()=>{})}return a.end({message:e,bytes:r?.byteLength||0,src_bytes:t?.byteLength||0,mime:s,has_url:!!i,has_location:!!(n&&Object.keys(n).length),focus:!0}),i}var Hn=2,bt=new Set,oe=[],ke=0,be=0,Se=0,rr=null;function wo(){const e=oe.length+ke,t=Math.max(be,Se+e),n=Math.min(Se,t),a=t>0?Math.max(0,Math.min(100,Math.round(n/t*100))):0;return{pending:e,active:ke,done:n,total:t,pct:a,busy:e>0}}function vo(e){rr=typeof e=="function"?e:null}function Ye(){try{rr?.()}catch{}}function qn(){for(;ke<Hn&&oe.length;){const e=oe.shift();ke+=1,Ye(),yt(e).catch(()=>{}).finally(()=>{ke-=1,bt.delete(e),Se+=1,oe.length===0&&ke===0&&(be=0,Se=0),Ye(),qn()})}}function xo(e){const t=String(e||"");!t||Pt(t)!==void 0||bt.has(t)||(bt.add(t),oe.push(t),be+=1,Ye(),qn())}function ko(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];if(_o(t),!t.length)return;const n=new Set(t),a=oe.length,r=[];for(const c of oe)n.has(c)?r.push(c):bt.delete(c);oe.length=0;const s=[];for(const c of t)Pt(c)===void 0&&(bt.has(c)||(bt.add(c),be+=1),s.includes(c)||s.push(c));const i=r.filter(c=>!s.includes(c));oe.push(...s,...i);const o=a-r.length;o>0&&(be=Math.max(Se+oe.length+ke,be-o)),Ye(),qn()}async function So(e=[],{concurrency:t=Hn}={}){const n=[...new Set((e||[]).map(String).filter(Boolean))],a=Math.max(1,Number(t)||Hn),r=n.filter(s=>Pt(s)===void 0);r.length&&(be+=r.length,Ye());for(let s=0;s<r.length;s+=a){const i=r.slice(s,s+a);await Promise.all(i.map(o=>yt(o).catch(()=>"").finally(()=>{Se+=1,oe.length===0&&ke===0&&Se>=be&&(be=0,Se=0),Ye()})))}return oe.length===0&&ke===0&&(be=0,Se=0,Ye()),n.map(s=>ye(s)).filter(Boolean)}async function Be(e,t={}){if(!e||typeof e!="object")return e;if(Array.isArray(e)){for(let a=0;a<e.length;a+=1)e[a]=await Be(e[a],t);return e}const n=e;if(typeof n.id=="string"&&(typeof n.image_url=="string"||n.image_path!=null||"shot_index"in n||"main_prompt"in n)){const a=String(n.id),r=t.ids!=null?new Set([...t.ids].map(String)):null;if(!t.cachedOnly&&(!r||r.has(a))){const s=await yt(a);s&&(n.image_url=s)}else n.image_url=ye(a)||"",n.image_url||xo(a);return e}for(const a of Object.keys(n))n[a]&&typeof n[a]=="object"&&(n[a]=await Be(n[a],t));return e}function fn(e){return e?`data:${It(e)};base64,${js(e)}`:""}var Re=(e,t)=>!!e&&Object.prototype.hasOwnProperty.call(e,t),gn=e=>e?[...e]:[],Gn=e=>e;async function X(e){return(await de("characters")).filter(t=>t.scope===u(e,200)).sort((t,n)=>(t.name||"").localeCompare(n.name||"",void 0,{sensitivity:"base"})).map(t=>{let n=t.aliases;if(typeof n=="string")try{n=JSON.parse(n)}catch{n=J(n)}const a={id:t.id,name:t.name,aliases:Array.isArray(n)?n:J(n),surname:t.surname||"",given_name:t.given_name||"",surname_variants:J(t.surname_variants),given_name_variants:J(t.given_name_variants),priority:Number(t.priority||0),attire_locked:t.attire_locked===!0,accessories_locked:t.accessories_locked===!0,schema_version:Number(t.schema_version||1),original:t.original||"",appearance:t.appearance||"",attire:t.attire||"",accessories:t.accessories||"",updated_at:t.updated_at,scope:t.scope};return a.tags=ft(a),a})}async function Mo(e){const t=u(e,200);return t?(await de("meta")).filter(n=>n.key?.startsWith(`toggle:${t}:`)&&n.enabled===0).map(n=>u(n.global_key||n.key.split(":").slice(2).join(":"),200)).filter(Boolean):[]}async function Ao(e,t){const n=u(e,200);if(!n)return{ok:!1,error:{code:"bad_request",message:"character_id required"}};const a=[],r=new Set;for(const o of t||[]){const c=u(o,200);!c||r.has(c)||(r.add(c),a.push(c))}const s=await de("meta");for(const o of s)o.key?.startsWith(`toggle:${n}:`)&&await _t("meta",o.key);const i=Date.now()/1e3;for(const o of a)await F("meta",{key:`toggle:${n}:${o}`,character_id:n,global_key:o,enabled:0,updated_at:i});return{ok:!0,character_id:n,disabled_globals:a}}function sr(e){const t=[];for(const n of[e.id,e.name]){const a=u(n,200);if(!a)continue;t.push(a);const r=a.toLowerCase();r!==a&&t.push(r)}return[...new Set(t)]}function Wn(e,t){if(!t?.size)return!1;for(const n of sr(e))if(t.has(n))return!0;return!1}async function Vn(e){const t=await Mo(e);return new Set(t)}async function No(e){const t=await Vn(e),n={};for(const a of await X(Ie)){const r=!Wn(a,t);for(const s of sr(a))n[s]=r;n[u(a.name,200)]=r}return n}async function Io(e=[]){const t=[],n=new Set;for(const a of e||[]){const r=u(a,200);!r||r==="__global__"||n.has(r)||(n.add(r),t.push(...await X(r)))}return Gn(Dn(t))}async function Yn(e,t="",n="",a=[]){const r=!!E()?.card?.unified_chat_priority,s=(Array.isArray(a)?a:[]).map(d=>u(d,200)).filter(Boolean);let i;r&&s.length?i=await Io(s):i=await X(u(e||"",200));const o=u(n||"",200),c=o?await Vn(o):new Set,l=(await X(Ie)).filter(d=>!Wn(d,c));return Gn(Li(i,l,{hasAppearance:_e,resolve:ie,aliasKeys:Fn,normalizeName:U,fullTags:ft,clean:u,globalScope:Ie}))}async function ce(e,t){const n=Re(t,"appearance"),a=Re(t,"attire"),r=Re(t,"accessories"),s=Re(t,"original"),i=Re(t,"surname"),o=Re(t,"given_name"),c=Re(t,"surname_variants"),l=Re(t,"given_name_variants");let d=dt(t);if(!d)return null;const g=u(e,200)||"__global__",p=await X(g),f=u(d.id,80),h=d,m=p.find(y=>f&&u(y.id,80)===f?!1:!!(ie(h.name,[y])||(h.aliases||[]).some(x=>ie(x,[y]))));if(m){const y=J([...m.aliases||[],...d.aliases||[],d.name,m.name]),x=u(d.appearance||"",4e3),k=u(d.attire||"",4e3),S=u(d.accessories||"",4e3),A=u(d.original||"",400),M=u(d.surname||"",200),w=u(d.given_name||"",200);if(d=dt({...m,...d,id:m.id,name:m.name||d.name,aliases:y,original:s?A:A||m.original||"",appearance:n?x:x||m.appearance||"",attire:m.attire_locked?m.attire||"":a?k:k||m.attire||"",accessories:m.accessories_locked?m.accessories||"":r?S:S||m.accessories||"",surname:i?M:M||m.surname||"",given_name:o?w:w||m.given_name||"",surname_variants:J(c?[...d.surname_variants||[],M]:[...m.surname_variants||[],...d.surname_variants||[],M,m.surname]),given_name_variants:J(l?[...d.given_name_variants||[],w]:[...m.given_name_variants||[],...d.given_name_variants||[],w,m.given_name]),attire_locked:m.attire_locked===!0||d.attire_locked===!0,accessories_locked:m.accessories_locked===!0||d.accessories_locked===!0,priority:Math.max(Number(m.priority||0),Number(d.priority||0))}),!d)return null}const _=Date.now()/1e3;if(await F("characters",{scope:g,id:d.id,name:d.name,aliases:d.aliases,surname:d.surname||"",given_name:d.given_name||"",surname_variants:d.surname_variants||[],given_name_variants:d.given_name_variants||[],priority:Number(d.priority||0),attire_locked:d.attire_locked===!0,accessories_locked:d.accessories_locked===!0,schema_version:2,appearance:d.appearance,attire:d.attire,accessories:d.accessories||"",original:d.original||"",updated_at:_}),g!=="__global__"){const y=`appearance:${g}`,x=(await R("meta",y))?.value||{},k=ft(d);k?x[d.name]=k:delete x[d.name],await F("meta",{key:y,value:x,updated_at:_})}else(a||r)&&await $o(d,{clearAttire:a,clearAccessories:r});return d}async function $o(e,{clearAttire:t=!0,clearAccessories:n=!0}={}){if(!e||!t&&!n)return 0;const a=s=>!s||s.scope==="__global__"||_e(s)?!1:!!za(s,e);let r=0;try{const s=await de("characters");for(const i of s||[]){if(!a(i))continue;const o=t?"":i.attire||"",c=n?"":i.accessories||"";(i.attire||"")===o&&(i.accessories||"")===c||(await F("characters",{...i,attire:o,accessories:c,updated_at:Date.now()/1e3}),r+=1)}}catch{}return r}async function Zn(e,t){const n=u(e,200)||"__global__",a=u(t,80);if(!a)return!1;const r=await R("characters",{scope:n,id:a});if(await _t("characters",{scope:n,id:a}),n!=="__global__"&&r?.name){const s=`appearance:${n}`,i={...(await R("meta",s))?.value||{}};delete i[r.name],await F("meta",{key:s,value:i,updated_at:Date.now()/1e3})}return!0}var Eo=(e,t)=>!!za(e,t);function ir(e){return(Array.isArray(e)?e:[]).filter(t=>{if(!t||typeof t!="object")return!1;const n=t;return!!(n.id||n.name)})}async function jo(e,t,n=""){const a=ir(t);if(!a.length)return{deleted:0,sessions:0};const r=u(n,200),s=new Set;let i=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===r||l==="__global__"||s.has(l))continue;s.add(l);const d=await X(l);let g=!1;for(const p of d)a.some(f=>Eo(p,f))&&(await Zn(l,p.id),i+=1,g=!0);g&&(o+=1)}return{deleted:i,sessions:o}}async function or(e,t,n=""){const a=ir(t);if(!a.length)return{updated:0,sessions:0};const r=u(n,200),s=new Set;let i=0,o=0;for(const c of e||[]){const l=u(c,200);if(!l||l===r||l==="__global__"||s.has(l))continue;s.add(l);const d=await X(l);let g=!1;for(const p of a){const f=ie(p.name,d)||(Array.isArray(p.aliases)?p.aliases.map(h=>ie(h,d)).find(Boolean):null)||(u(p.id,80)?d.find(h=>u(h.id,80)===u(p.id,80)):null);f&&await ce(l,{...p,id:f.id,name:f.name||p.name,appearance:p.appearance!=null?p.appearance:"",attire:p.attire!=null?p.attire:"",accessories:p.accessories!=null?p.accessories:"",original:p.original!=null?p.original:""})&&(i+=1,g=!0)}g&&(o+=1)}return{updated:i,sessions:o}}async function Ot(e,t,n={}){const a=u(e,200)||"__global__",r=n.prune===!0,s=Array.isArray(n.rootSessionIds)?n.rootSessionIds:[],i=Dn(t||[]);if(s.length){if(r){const c=new Set;for(const l of i){for(const g of Fn(l))c.add(g);const d=U(l.name);d&&c.add(d)}for(const l of s){const d=u(l,200);if(!(!d||d==="__global__"))for(const g of await X(d)){const p=[...Fn(g)],f=U(g.name);f&&p.push(f),!p.some(h=>c.has(h))&&await Zn(d,g.id)}}}return i.length&&await or(s,i,""),Gn(i.map(c=>dt(c)).filter(c=>!!c))}const o=[];for(const c of i){const l=await ce(a,c);l&&o.push(l)}if(r){const c=new Set(o.map(l=>u(l.id,80)).filter(Boolean));for(const l of await X(a)){const d=u(l.id,80);d&&!c.has(d)&&await Zn(a,d)}}return o}async function Bt(e,t=""){const n=u(e,200),a=u(t,200),r=n?await X(n):[],s=a?await Vn(a):new Set,i=[];for(const o of await X(Ie)){const c={...o};c.enabled_for_character=a?!Wn(o,s):!0,i.push(c)}return{ok:!0,session_id:n,character_id:a,characters:r,global:i,appearance:Object.fromEntries(r.map(o=>[o.name,ft(o)])),disabled_globals:[...s].sort(),global_enabled:a?await No(a):{}}}async function cr(e,t,n=!0){const a=u(e,200);if(!a)return{ok:!1,error:{code:"bad_request",message:"target_session_id required"}};const r=[],s=new Set;for(const c of t||[]){const l=u(c,200);!l||s.has(l)||(s.add(l),r.push(...await X(l)))}n&&!s.has(a)&&r.push(...await X(a));const i=Dn(r),o=[];for(const c of i){const l=ie(c.name,await X(a)),d=await ce(a,{...c,id:l?.id||c.id,priority:Math.max(Number(l?.priority||0),Number(c.priority||0))});d&&o.push(d)}return{...await Bt(a),ok:!0,merged:o.length,sources:[...s]}}async function Co(e){return Object.fromEntries((await X(e)).map(t=>[t.name,ft(t)]))}async function To(e,t){return await Ot(e,Object.entries(t||{}).map(([n,a])=>({name:n,tags:a}))),{ok:!0,appearance:await Co(e)}}async function Lo(e){const{sessionId:t,tagged:n,shotChars:a}=e,r=e.unifiedSessionId??"",s=e.sourceSessionIds??[],i=u(e.characterId||"",200),o=u(t||"",200),c=()=>Yn(t,r,i,s);let l=await c();const d=[...n.new_characters||[]],g=new Set(d.map(f=>U(f?.name))),p=(f,h=null)=>({surname:u(f?.surname||h?.surname||"",200),given_name:u(f?.given_name||h?.given_name||"",200),surname_variants:J([...gn(h?.surname_variants),...gn(f?.surname_variants),f?.surname,h?.surname]),given_name_variants:J([...gn(h?.given_name_variants),...gn(f?.given_name_variants),f?.given_name,h?.given_name])});for(const f of a||[]){const h=u(f.name,200);if(!h||g.has(U(h)))continue;const m=ie(h,l);m&&_e(m)||(d.push({name:m?.name||h,aliases:J(f.aliases)||m?.aliases||[h],original:u(f.original||f.original_tag||m?.original||"",400),appearance:P(f.label,f.age,f.appearance,f.body),attire:u(f.attire||m?.attire||""),accessories:u(f.accessories||m?.accessories||""),...p(f,m)}),g.add(U(h)))}typeof n=="object"&&(n.new_characters=d);for(const f of d){const h=dt(f);if(!h)continue;const m=ie(h.name,l),_=u(h.appearance||""),y=u(h.attire||""),x=u(h.accessories||""),k=p(h,m);if(m?.scope==="__global__"&&_e(m)){const S=y&&!m.attire_locked,A=x&&!m.accessories_locked;if(S||A){let M=m.appearance||"",w=m.attire||"",I=m.accessories||"";S&&([M,w,I]=Ce(M,w,I,y)),A&&([M,w,I]=Te(M,w,I,x)),await ce(o,{id:m.id||h.id,name:m.name||h.name,aliases:m.aliases||h.aliases,original:"",appearance:"",attire:w,accessories:I,...k})}l=await c();continue}if(m&&!_e(m)){const S=m.scope==="__global__"?Ie:m.scope||o,A=J([...m.aliases||[],...h.aliases||[]]);let M=_||m.appearance||"",w=m.attire||"",I=m.accessories||"";const D=m.original||h.original||"";!m.attire_locked&&y?[M,w,I]=Ce(M,w,I,y):!m.attire_locked&&h.attire&&([M,w,I]=Ce(M,w,I,h.attire)),!m.accessories_locked&&x?[M,w,I]=Te(M,w,I,x):!m.accessories_locked&&h.accessories&&([M,w,I]=Te(M,w,I,h.accessories)),await ce(S,{id:m.id||h.id,name:m.name||h.name,aliases:A.length?A:m.aliases||h.aliases,original:D,appearance:M,attire:w,accessories:I,attire_locked:m.attire_locked===!0,accessories_locked:m.accessories_locked===!0,...k}),l=await c();continue}if(m&&m.scope!=="__global__"){const S=J([...m.aliases||[],...h.aliases||[]]);let A=m.appearance||h.appearance||"",M=m.attire||"",w=m.accessories||"",I=m.original||h.original||"";h.appearance&&!m.appearance&&(A=h.appearance),h.original&&!m.original&&(I=h.original),!m.attire_locked&&h.attire&&([A,M,w]=Ce(A,M,w,h.attire)),!m.accessories_locked&&h.accessories&&([A,M,w]=Te(A,M,w,h.accessories)),await ce(o,{id:m.id||h.id,name:m.name||h.name,aliases:S,original:I,appearance:A,attire:M,accessories:w,attire_locked:m.attire_locked===!0,accessories_locked:m.accessories_locked===!0,...k})}else m||await ce(o,h);l=await c()}for(const f of a||[]){const h=u(f.name,200);if(!h)continue;const m=ie(h,l),_=u(f.attire||""),y=u(f.accessories||""),x=u(f.appearance||"");if(m?.scope==="__global__"){const k=!m.attire_locked,S=!m.accessories_locked;if(!k&&!S){l=await c();continue}let A=m.attire||"",M=m.accessories||"",w=m.appearance||"",I=!1;if(k&&_)[w,A,M]=Ce(w,A,M,_),I=!0;else if(k&&x){const[,D]=ee(x);D&&([w,A,M]=Ce(w,A,M,D),I=!0)}if(S&&y)[w,A,M]=Te(w,A,M,y),I=!0;else if(S&&x){const[,,D]=ee(x);D&&([w,A,M]=Te(w,A,M,D),I=!0)}if(!I){l=await c();continue}await ce(o,{id:m.id,name:m.name,aliases:m.aliases,original:"",appearance:"",attire:A,accessories:M})}else if(m){let k=m.appearance||"",S=m.attire||"",A=m.accessories||"";const M=J([...m.aliases||[],...J(f.aliases)]);if(!m.attire_locked&&_)[k,S,A]=Ce(k,S,A,_);else if(!m.attire_locked&&x){const[,w]=ee(x);w&&([k,S,A]=Ce(k,S,A,w))}if(!m.accessories_locked&&y)[k,S,A]=Te(k,S,A,y);else if(!m.accessories_locked&&x){const[,,w]=ee(x);w&&([k,S,A]=Te(k,S,A,w))}await ce(m.scope==="__global__"?Ie:m.scope||o,{id:m.id,name:m.name,aliases:M.length?M:m.aliases,original:m.original||u(f.original||"",400),appearance:k||m.appearance,attire:S,accessories:A,attire_locked:m.attire_locked===!0,accessories_locked:m.accessories_locked===!0})}else{const k=P(f.label,f.age,f.appearance||"",f.body||""),S=u(f.attire||""),A=u(f.accessories||""),[M,w,I]=ee(P(k,S,A));await ce(o,{name:h,aliases:J(f.aliases)||[h],original:u(f.original||f.original_tag||"",400),appearance:M,attire:w,accessories:I})}l=await c()}return c()}async function Po(){if((await de("characters")).length)return;const e=(await de("meta")).filter(t=>t.key?.startsWith("appearance:"));if(e.length)for(const t of e){const n=t.key.slice(11),a=t.value||{};for(const[r,s]of Object.entries(a)){const i=dt({name:r,tags:s},r);i&&await ce(n,i)}}}async function Oo(){const e=await de("characters");for(const t of e){if(Number(t.schema_version||0)>=2)continue;const n=dt(t);n&&await F("characters",{...t,...n,scope:t.scope,updated_at:t.updated_at||Date.now()/1e3})}}function lr(e){if(!e||e.length<22)return!1;const t=Math.max(0,e.length-65536);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const a=e[n+20]|e[n+21]<<8;if(n+22+a<=e.length)return!0}return!1}function Fe(e,t){return e[t]|e[t+1]<<8}function wt(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Xn(e){const t=Math.max(0,e.length-65536-22);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const a=Fe(e,n+20);if(n+22+a<=e.length)return n}return-1}function Bo(e){const t=Xn(e);if(t<0)return null;const n=wt(e,t+16);if(n+46>e.length||e[n]!==80||e[n+1]!==75||e[n+2]!==1||e[n+3]!==2)return null;const a=Fe(e,n+10),r=wt(e,n+20),s=wt(e,n+24),i=wt(e,n+42);if(i+30>e.length||e[i]!==80||e[i+1]!==75||e[i+2]!==3||e[i+3]!==4)return null;const o=Fe(e,i+26),c=Fe(e,i+28),l=i+30+o+c;return l+r>e.length?null:{source:"central_dir",compMethod:a,compSize:r,uncompSize:s,dataStart:l,compData:e.subarray(l,l+r)}}function Ro(e){const t=Fe(e,6),n=Fe(e,8);let a=wt(e,18);const r=Fe(e,26),s=Fe(e,28),i=30+r+s;if((t&8)!==0||a===0){let o=-1;for(let c=i+4;c<e.length-3;c+=1){if(e[c]!==80||e[c+1]!==75)continue;const l=e[c+2];if(l===7||l===1||l===5){o=c;break}}if(o<0){const c=Xn(e);c>i&&(o=c)}if(o<0)throw new Error("ZIP 데이터 경계를 찾지 못했습니다 (local header bit3)");a=o-i}if(i+a>e.length)throw new Error(`ZIP 엔트리 길이 초과 (need ${i+a}, have ${e.length})`);return{source:"local_header",compMethod:n,compSize:a,uncompSize:wt(e,22),dataStart:i,compData:e.subarray(i,i+a)}}async function Fo(e){if(typeof DecompressionStream!="function")throw new Error("DecompressionStream 미지원 — ZIP deflate를 풀 수 없습니다");const t=re(e);v("nai.inflate.start",{message:`${t.length}B`,bytes:t.length,focus:!0});const n=new DecompressionStream("deflate-raw"),a=n.writable.getWriter(),r=n.readable.getReader(),s=[];let i=0;const o=Date.now()+2e4,c=(async()=>{for(;;){if(Date.now()>=o)throw new Error(`ZIP inflate 타임아웃 (out=${i}B)`);const{done:g,value:p}=await r.read();if(g)break;p&&(s.push(p),i+=p.length,i>0&&i%524288<p.length&&v("nai.inflate",{message:`out ${Math.round(i/1024)}KB`,bytes:i,focus:!0}))}})(),l=131072;for(let g=0;g<t.length;g+=l){if(Date.now()>=o){try{await a.abort()}catch{}throw new Error(`ZIP inflate write 타임아웃 (in=${g}B)`)}await a.write(t.subarray(g,Math.min(t.length,g+l))),g>0&&g%(l*4)===0&&await Ke(0)}await a.close(),await c;const d=At(s,i);return v("nai.inflate.done",{bytes:i,focus:!0}),d}async function Do(e){const t=re(e);if(v("nai.unzip.start",{message:`${t.length}B`,bytes:t.length,focus:!0}),Nt(t))return v("nai.unzip",{message:"raw PNG",bytes:t.length,focus:!0}),Z(t);if(t.length<30||t[0]!==80||t[1]!==75){const r=Array.from(t.subarray(0,16)).map(s=>s.toString(16).padStart(2,"0")).join(" ");throw new Error(`ZIP/PNG 응답이 아닙니다 (len=${t.length}, head=${r})`)}const n=Bo(t)??Ro(t);v("nai.unzip.entry",{message:`${n.source} method=${n.compMethod} comp=${n.compSize}B uncomp=${n.uncompSize||"?"}`,comp_method:n.compMethod,bytes:n.compSize,source:n.source,focus:!0});const a=Xn(t);if(a>=0&&n.dataStart+n.compSize>a&&(v("nai.unzip.clamp",{message:`comp ${n.compSize} → ${a-n.dataStart}`,focus:!0},"warn"),n.compSize=a-n.dataStart,n.compData=t.subarray(n.dataStart,a)),n.compSize<=0)throw new Error("ZIP 압축 페이로드가 비어 있습니다");if(n.compMethod===0)return Z(n.compData);if(n.compMethod===8){const r=await Fo(n.compData);return!Nt(r)&&!(r[0]===82&&r[1]===73)&&v("nai.unzip",{message:"inflated but not PNG/RIFF magic",bytes:r.length},"warn"),Z(r)}throw new Error(`지원하지 않는 ZIP 압축 방식: ${n.compMethod}`)}var fe=0,Qn=0,ea=0,ge=null,ur=!1,dr=()=>fe,zo=()=>Qn,Uo=()=>ea,Jo=()=>ge!==null;function Ko(e="force"){return ge?(ge.forceFinish(e),!0):!1}async function De(e,t={}){const n=st()?.nativeFetch,a=n||globalThis.fetch,r=n?"nativeFetch":"fetch";if(typeof a!="function")throw new Error("fetch를 사용할 수 없습니다");const s={...t};s.networkRoute==null&&delete s.networkRoute;const i=Q("net.fetch");v("net.fetch.start",{message:r,url:String(e).slice(0,120),has_signal:!!s.signal});try{const o=await a(e,s),c=Number(o?.status||(o?.ok===!1?0:200));return i.end({message:r,status:c,url:String(e).slice(0,80)}),o}catch(o){throw i.fail(o,{message:r,url:String(e).slice(0,80)}),o}}async function vt(e,t={}){if(!e)throw new Error("빈 응답");const n=Number(t.deadline||Date.now()+Number(t.timeoutMs||9e4)),a=t.signal||null,r=typeof t.onProgress=="function"?t.onProgress:null,s=Number(t.idleMs||2500),i=(g=0)=>{if(a?.aborted)throw new Error(`NAI 본문 읽기 중단 (abort, ${g}B)`);if(Date.now()>=n)throw new Error(`NAI 본문 읽기 타임아웃 (${g}B received)`)};if(e instanceof ArrayBuffer)return e;if(e instanceof Uint8Array)return Z(e);if(typeof e=="string"){const g=e.replace(/\s+/g,"");if(g.length>64&&/^[A-Za-z0-9+/=]+$/.test(g))return v("nai.read_bytes",{message:"string base64 body",bytes:g.length,focus:!0}),Z($e(g))}const o=e;if(o.buffer instanceof ArrayBuffer&&typeof o.byteLength=="number")return o.buffer.slice(o.byteOffset||0,(o.byteOffset||0)+o.byteLength);const c=e;if(e&&typeof e=="object"&&"data"in e&&!c.arrayBuffer&&!c.body)return vt(c.data,t);let l=null;try{const g=c.headers,p=g?.get?.("content-length")||g?.get?.("Content-Length")||null;p&&(l=Number(p))}catch{}if(l!=null&&l>0&&(Qn=l),v("nai.read_bytes.start",{message:"begin body",content_length:l,has_arrayBuffer:typeof c.arrayBuffer=="function",has_body_reader:!!(c.body&&typeof c.body.getReader=="function"),keys:e&&typeof e=="object"?Object.keys(e).slice(0,12).join(","):typeof e,focus:!0}),c.body&&typeof c.body.getReader=="function"){const g=c.body.getReader(),p=[];let f=0,h=Date.now(),m=Date.now(),_=!1,y=null;ge={forceFinish:(k="force")=>{_=!0,v("nai.read_bytes.force",{message:k,bytes:f||l||0,focus:!0});try{g.cancel()}catch{}y&&y({done:!0,value:void 0,__forced:!0})}};try{for(;i(f),!_;){if(f>=64&&Date.now()-h>=s){v("nai.read_bytes.idle_complete",{message:`${s}ms idle`,bytes:f,focus:!0});break}if(l!=null&&l>0&&f>=l){v("nai.read_bytes.length_complete",{bytes:f,content_length:l,focus:!0});break}const k=await new Promise((w,I)=>{let D=!1;const $=(j,z)=>{D||(D=!0,clearInterval(T),y=null,z?I(z):w(j))};y=j=>$(j,null);const T=setInterval(()=>{if(!D){if(_)return $({done:!0,value:void 0,__forced:!0},null);if(f>=64&&Date.now()-h>=s)return $({done:!0,value:void 0,__idle:!0},null);if(l!=null&&l>0&&f>=l)return $({done:!0,value:void 0,__length:!0},null);if(a?.aborted||Date.now()>=n)return g.cancel().catch(()=>{}),$(null,new Error(`NAI 본문 읽기 타임아웃 (${f}B received)`))}},200);g.read().then(j=>$(j,null),j=>$(null,j))});if(k?.__forced||k?.__idle||k?.__length)break;const{done:S,value:A}=k;if(S)break;if(!A)continue;const M=A instanceof Uint8Array?A:new Uint8Array(A);if(p.push(M),f+=M.length,h=Date.now(),ea=h,fe=f,r&&r(f,l),Date.now()-m>=2e3&&(m=Date.now(),v("nai.read_bytes.progress",{message:`${Math.round(f/1024)}KB`,bytes:f,content_length:l,focus:!0})),lr(At(p,f))&&Date.now()-h>=600){v("nai.read_bytes.zip_eocd",{bytes:f,focus:!0});break}if(l!=null&&l>0&&f>=l)break}}catch(k){if(f>=64){const S=At(p,f);if(lr(S)||l!=null&&l>0&&f>=l*.98)return v("nai.read_bytes.recover",{message:String(k?.message||k),bytes:f,focus:!0},"warn"),ge=null,Z(S)}try{await g.cancel()}catch{}throw ge=null,k}if(ge=null,!f)throw new Error("NAI 본문이 비어 있습니다");const x=At(p,f);return v("nai.read_bytes.done",{bytes:f,focus:!0}),Z(x)}const d=c.arrayBuffer;if(typeof d=="function"){v("nai.read_bytes",{message:"fallback arrayBuffer() — no body stream",focus:!0});let g=!1,p,f;const h=new Promise((y,x)=>{p=y,f=x});ge={forceFinish:(y="force")=>{v("nai.read_bytes.force",{message:`${y} (arrayBuffer)`,content_length:l,focus:!0},"warn"),g||(g=!0,clearInterval(m),f(new Error(`NAI arrayBuffer 강제중단 (${y}, content-length=${l})`)))}};const m=setInterval(()=>{g||(a?.aborted||Date.now()>=n?(g=!0,clearInterval(m),ge=null,f(new Error(`NAI arrayBuffer 타임아웃 (content-length=${l}). 본문 ~${l?Math.round(l/1024):"?"}KB를 플러그인이 받지 못했습니다.`))):v("nai.read_bytes.wait",{message:`arrayBuffer pending · expect ${l?Math.round(l/1024):"?"}KB`,content_length:l,focus:!0},"warn"))},3e3);d.call(c).then(y=>{g||(g=!0,clearInterval(m),ge=null,p(y))}).catch(y=>{g||(g=!0,clearInterval(m),ge=null,f(y))});const _=await h;if(_&&_.byteLength)return fe=_.byteLength,v("nai.read_bytes.done",{bytes:_.byteLength,focus:!0}),_}if(typeof c.bytes=="function"){const g=await c.bytes();if(g?.length)return Z(g)}if(typeof c.text=="function"){const g=await c.text();if(/^[A-Za-z0-9+/=\s]+$/.test(g)&&g.replace(/\s+/g,"").length>64)try{return Z($e(g.replace(/\s+/g,"")))}catch{}throw new Error(`바이너리 본문을 읽지 못함 (text head=${String(g).slice(0,120)})`)}throw new Error("바이너리 본문을 읽지 못함")}async function Ho(e,t,n,a={}){const r={Authorization:`Bearer ${e}`,"Content-Type":"application/json"},s=Number(a.timeoutMs||75e3),i=a.signal||null,o=JSON.stringify(t);if(v("nai.payload",{message:`body ${Math.round(o.length/1024)}KB`,bytes:o.length,model:t?.model,timeout_ms:s,url:String(n||"https://image.novelai.net/ai/generate-image").slice(0,100),has_nativeFetch:Yt("nativeFetch")}),o.length>15e5)throw v("nai.payload",{message:"too large",bytes:o.length},"error"),new Error(`NAI 페이로드가 너무 큼 (${Math.round(o.length/1024)}KB). 참조 이미지/프롬프트를 줄이세요.`);const c=typeof AbortController<"u"?new AbortController:null,l=()=>{v("nai.abort",{message:"external signal"},"warn"),c?.abort()};if(i){if(i.aborted)throw new Error("NAI 요청이 취소되었습니다.");i.addEventListener("abort",l,{once:!0})}const d=Date.now();fe=0,Qn=0,ea=0,ur=!0;const g=setInterval(()=>{const f=Date.now()-d;f>=s?(v("nai.watchdog",{message:`abort after ${f}ms · body=${fe}B`,ms:f,bytes:fe},"warn"),c?.abort()):f>0&&f%1e4<1100&&v("nai.wait",{message:`waiting ${Math.round(f/1e3)}s · body=${fe}B · ${it()}`,ms:f,bytes:fe,focus:!0},"warn")},1e3);let p=null;try{try{v("nai.fetch.start",{message:"POST generate-image",timeout_ms:s,focus:!0});const f=await De(n||"https://image.novelai.net/ai/generate-image",{method:"POST",headers:r,body:o,signal:c?.signal,requestTimeoutMs:s});if(v("nai.fetch.returned",{message:"nativeFetch resolved",ms:Date.now()-d,status:Number(f?.status||0),focus:!0}),i?.aborted||c?.signal?.aborted)throw v("nai.fetch.aborted",{ms:Date.now()-d},"error"),new Error(`NAI 타임아웃 (${Math.round(s/1e3)}s) — nativeFetch가 응답하지 않습니다. Models에서 NAI Test를 확인하세요.`);const h={signal:c?.signal,deadline:d+s,onProgress:x=>{fe=x}};if(f&&typeof f=="object"&&"ok"in f&&"data"in f&&!f.arrayBuffer){const x=Number(f.status||(f.ok?200:0));if(v("nai.resp.shape",{message:"ok/data shape",status:x,focus:!0}),x===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(x===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(x>=400){const A=typeof f.data=="string"?f.data:f.data instanceof Uint8Array?new TextDecoder().decode(f.data.subarray(0,220)):JSON.stringify(f.data||{}).slice(0,220);throw new Error(`NAI HTTP ${x}: ${A}`)}const k=Q("nai.read_bytes"),S=await vt(f.data,h);if(k.end({bytes:S?.byteLength||0,focus:!0}),!S||S.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${S?.byteLength||0} bytes)`);return S}const m=Number(f?.status||0);if(v("nai.resp.shape",{message:"Response-like",status:m,has_arrayBuffer:typeof f?.arrayBuffer=="function",has_body:!!f?.body,focus:!0}),m===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(m===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(m>=400){let x="";try{x=await f.text()}catch{}throw new Error(`NAI HTTP ${m}: ${x.slice(0,220)}`)}const _=Q("nai.read_bytes"),y=await vt(f,h);if(_.end({bytes:y?.byteLength||0,status:m,focus:!0}),!y||y.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${y?.byteLength||0} bytes)`);return y}catch(f){throw p=String(f?.message||f),v("nai.fetch.error",{message:p,ms:Date.now()-d,bytes:fe},"error"),/abort|timeout|타임아웃|취소|본문 읽기/i.test(p)?new Error(`NAI 타임아웃/본문실패 (${Math.round(s/1e3)}s, body=${fe}B). ${p.slice(0,180)}`):f instanceof Error?f:new Error(p)}}finally{ur=!1,clearInterval(g),i&&i.removeEventListener("abort",l)}}var qo=new En;function Rt(e){return u(e?.backend||"nai").toLowerCase()==="comfy"?"comfy":"nai"}function Go(e){const t=Number(e?.backend_timeout_seconds??300);return Math.max(30,Math.min(1800,Number.isNaN(t)?300:t))*1e3}function mn(e){return String(e||"").trim().replace(/\/+$/,"")}function fr(e){return mn(u(e?.comfy_url))||"http://localhost:8188"}function ta(e){return!!u(e?.comfy_workflow_json)}async function na(e,t={}){const n=await De(e,t);if(n&&typeof n=="object"&&"ok"in n&&"data"in n&&typeof n.arrayBuffer!="function"){const s=Number(n.status||(n.ok?200:0));let i=n.data;if(i instanceof Uint8Array&&(i=new TextDecoder().decode(i)),typeof i=="string")try{i=JSON.parse(i)}catch{}return{status:s,data:i}}const a=Number(n?.status||0);let r=null;try{r=await n.json()}catch{try{r=JSON.parse(await n.text())}catch{}}return{status:a,data:r}}async function Wo(e,t,n={}){const a=`inlay-nexus-${Math.random().toString(36).slice(2,10)}`,{status:r,data:s}=await na(`${mn(e)}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:a,prompt:t}),signal:n.signal});if(r>=400||!s?.prompt_id){const i=s?JSON.stringify(s.node_errors||s.error||s).slice(0,300):"";throw new Error(`/prompt 제출 실패 (HTTP ${r}) ${i}`)}return String(s.prompt_id)}async function Vo(e,t,n={}){const a=mn(e),r=Number(n.timeoutMs||3e5),s=Date.now()+r;let i=0,o="";for(;Date.now()<s;){if(n.signal?.aborted)throw new Error("이미지 대기 중단 (abort)");await Ke(2500),i+=1;let c=null;try{const{status:g,data:p}=await na(`${a}/history/${t}`,{method:"GET",signal:n.signal});g<400&&p&&p[t]&&(c=p[t])}catch(g){o=String(g?.message||g);continue}if(i%8===0&&v("comfy.poll",{message:`${i}회 · ${Math.round((Date.now()-(s-r))/1e3)}s`,focus:!0}),!c)continue;const l=c.status||{};if(l.status_str==="error")throw new Error(`생성 실패: ${JSON.stringify(l.messages||[]).slice(0,400)}`);const d=c.outputs||{};for(const g of Object.keys(d)){const p=d[g]?.images;if(Array.isArray(p)&&p.length)return p.find(f=>(f?.type||"output")!=="temp")||p[0]}if(l.completed)throw new Error("생성은 완료됐지만 출력 이미지가 없습니다 (SaveImage 노드 확인)")}throw new Error(`이미지 대기 타임아웃 (${Math.round(r/1e3)}s)${o?` · ${o}`:""}`)}async function Yo(e,t,n={}){const a=new URLSearchParams({filename:u(t?.filename,300),subfolder:u(t?.subfolder,300),type:u(t?.type,40)||"output"}),r=await De(`${mn(e)}/view?${a.toString()}`,{method:"GET",signal:n.signal}),s={signal:n.signal,deadline:Date.now()+6e4};if(r&&typeof r=="object"&&"ok"in r&&"data"in r&&!r.arrayBuffer){const o=Number(r.status||(r.ok?200:0));if(o>=400)throw new Error(`/view 실패 (HTTP ${o})`);return vt(r.data,s)}const i=Number(r?.status||0);if(i>=400)throw new Error(`/view 실패 (HTTP ${i})`);return vt(r,s)}function Zo(e,t){let n=String(e||"");for(let a=0;a<8;a+=1){const r=n.replace(/\[\[#(\w+)\]\]([\s\S]*?)\[\[\/\1\]\]/g,(s,i,o)=>{const c=t[i];return c!=null&&String(c).trim()!==""?o:""});if(r===n)break;n=r}return n.replace(/[ \t]+\n/g,`
`).replace(/\n{3,}/g,`

`)}function Xo(e,t){for(const n of Object.values(e)){const a=n?.inputs;if(!(!a||typeof a!="object"))for(const r of Object.keys(a)){const s=a[r];if(typeof s!="string"||!s.includes("[["))continue;const i=Zo(s,t),o=i.match(/^\[\[\s*(\w+)\s*\]\]$/);if(o&&o[1]in t){a[r]=t[o[1]];continue}a[r]=i.replace(/\[\[\s*(\w+)\s*\]\]/g,(c,l)=>l in t?String(t[l]):c)}}}function Qo(e,t){const n=Number(t)||1;for(const a of Object.values(e)){const r=a?.inputs;if(!(!r||typeof r!="object"))for(const s of Object.keys(r)){if(!/^(seed|noise_seed)$/i.test(s))continue;const i=r[s];(typeof i=="number"&&Number.isFinite(i)||typeof i=="string"&&/^\d+$/.test(i.trim()))&&(r[s]=n)}}}function gr({main:e,neg:t,captions:n,nai:a,seed:r}){const s={pos:String(e||""),neg:String(t||""),width:Number(a.width??832)||832,height:Number(a.height??1216)||1216,seed:Number(r)||1,steps:Number(a.steps??28)||28,cfg:Number(a.cfg_scale??7)||7};for(let i=0;i<6;i+=1)s[`char${i+1}`]=u(n?.[i]?.prompt,2e3);return s}function ec(e){let t=String(e||"");return t=t.replace(/(:\s*)\[\[\s*(\w+)\s*\]\](\s*[,}\]])/g,'$1"[[$2]]"$3'),t}function mr(e,t){const n=u(e);if(!n)throw new Error("ComfyUI 워크플로 JSON이 비어 있습니다. Models 탭에 API Export JSON을 붙여넣으세요.");let a;const r=ec(n);try{a=JSON.parse(r)}catch(o){const c=/\[\[/.test(n)?' · 팁: [[seed]] 같은 값은 반드시 "[[seed]]"처럼 따옴표로 감싸세요.':"";throw new Error(`ComfyUI 워크플로 JSON 파싱 실패: ${String(o?.message||o).slice(0,120)}${c}`)}if(!a||typeof a!="object"||Array.isArray(a))throw new Error("ComfyUI 워크플로는 API 포맷(JSON 객체, 노드ID→노드)이어야 합니다.");let s=a;if(s.nodes&&s.links)throw new Error("UI 저장 포맷 워크플로입니다. ComfyUI에서 'Export (API)'로 내보낸 JSON을 넣으세요.");const i=JSON.stringify(s);if(!/\[\[\s*pos\s*\]\]/.test(i))throw new Error("워크플로에 [[pos]]가 없습니다. 긍정 프롬프트를 넣는 칸에 [[pos]]를 적어 주세요.");return s=JSON.parse(i),Xo(s,t),Qo(s,t.seed),s}async function tc(e,t,n,a){const r=fr(e),s=Go(e),i=Number(e.seed??0)||Math.floor(Math.random()*4294967295)||1,o=gr({main:t,neg:n,captions:a,nai:e,seed:i}),c=mr(e.comfy_workflow_json,o);return v("comfy.generate.start",{message:r,prompt_len:String(t||"").length,chars:(a||[]).length,nodes:Object.keys(c).length,focus:!0}),qo.run(async()=>{const l=await Wo(r,c);v("comfy.generate.submitted",{message:l.slice(0,8),focus:!0});const d=await Vo(r,l,{timeoutMs:s}),g=await Yo(r,d);if(v("comfy.generate.done",{bytes:g?.byteLength||0,focus:!0}),!g||g.byteLength<256)throw new Error(`ComfyUI 응답 이미지가 너무 짧음 (${g?.byteLength||0}B)`);return[g,i]})}var aa=Zs;function xt(e,t=!1){let n=aa[String(e).toLowerCase()]||e;return t&&(n+="-inpainting"),n}function nc(e){const t=[],n=[];for(const a of e.characters||[]){const r={x:a.center_x,y:a.center_y};t.push({char_caption:a.prompt,centers:[r]}),n.push({char_caption:a.uc||"",centers:[r]})}return{autoSmea:!0,prefer_brownian:!0,ucPreset:0,use_coords:!1,legacy_uc:!1,add_original_image:!0,v4_prompt:{caption:{base_caption:e.prompt,char_captions:t},use_coords:!1,use_order:!0},v4_negative_prompt:{caption:{base_caption:e.negative_prompt,char_captions:n},legacy_uc:!1}}}function ac(e){const t=xt(e.model),n={width:e.width,height:e.height,n_samples:1,seed:e.seed,extra_noise_seed:e.seed,sampler:e.sampler,steps:e.steps,scale:e.cfg_scale,negative_prompt:e.negative_prompt,cfg_rescale:e.cfg_rescale,noise_schedule:e.scheduler,params_version:3,legacy:!1,legacy_v3_extend:!1};if(e.var_plus?n.skip_cfg_above_sigma=t.includes("4-5")?58:19:n.skip_cfg_above_sigma=null,t.includes("nai-diffusion-4")&&Object.assign(n,nc(e)),e.vibes?.length&&(n.reference_image_multiple=e.vibes.map(a=>a.encoded),n.reference_strength_multiple=e.vibes.map(a=>a.strength),n.reference_information_extracted_multiple=e.vibes.map(a=>a.information_extracted),n.normalize_reference_strength_multiple=!0),e.character_refs?.length){if(!t.includes("4-5"))throw new Error("Character Reference는 NAID4.5 전용입니다");n.director_reference_images=e.character_refs.map(a=>ot(a.image)),n.director_reference_strength_values=e.character_refs.map(a=>a.strength),n.director_reference_secondary_strength_values=e.character_refs.map(a=>1-a.fidelity),n.director_reference_descriptions=e.character_refs.map(a=>({caption:{base_caption:a.type,char_captions:[]},legacy_uc:!1})),n.director_reference_information_extracted=e.character_refs.map(()=>1),n.controlnet_strength=1,n.inpaintImg2ImgStrength=1,n.normalize_reference_strength_multiple=!0,delete n.skip_cfg_above_sigma}return n}function Ze(e){const t=u(e)||"nai-diffusion-4-5-full",n=Object.fromEntries(Object.entries(aa).map(([a,r])=>[r,a]));return aa[t]?t:n[t]?n[t]:"naid4.5f"}var rc=new En;async function hr(e,t,n,a={}){const r={input:t.prompt,model:xt(t.model),action:"generate",parameters:ac(t)};return v("nai.generate.start",{message:r.model,prompt_len:String(t.prompt||"").length,chars:(t.characters||[]).length,has_char_refs:!!t.character_refs?.length,has_vibes:!!t.vibes?.length}),rc.run(async()=>{const s=await Ho(e,r,n,a),i=Q("nai.unzip");try{const o=await Do(new Uint8Array(s)),c=Nt(new Uint8Array(o));return i.end({bytes:o?.byteLength||0,is_png:c,zip_bytes:s?.byteLength||0}),c||v("nai.unzip",{message:"unzipped but not PNG magic",bytes:o?.byteLength||0},"warn"),{raw_bytes:o,seed:t.seed||0}}catch(o){throw i.fail(o,{zip_bytes:s?.byteLength||0}),o}})}async function sc(e){const t=await De(xs,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),n=Number(t?.status||0);if(n===401)throw new Error("인증 실패 (401). API 토큰을 확인하세요.");if(n>=400)throw new Error(`Anlas 조회 실패: HTTP ${n}`);const a=await t.json(),r=a.trainingStepsLeft||{},s=r.fixedTrainingStepsLeft||0,i=r.purchasedTrainingSteps||0,o=a.perks?.unlimitedMaxPriority||!1;return{fixed:s,purchased:i,total:s+i,opus:o}}async function pr(e,t,n,a=1,r=3){const s=xt(n),i=Math.max(0,Math.min(1,Number(a)||1)),o={image:await He(t),information_extracted:i,model:s};let c="";for(let l=1;l<=r;l++)try{v("nai.encode_vibe.start",{message:s,ie:i,attempt:l,focus:!0});const d=await De(vs,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(o)}),g=Number(d?.status||0);if([502,503,504,520].includes(g)){c=`HTTP ${g}`,await Ke(2*l*1e3);continue}if(g<200||g>=300){let h="";try{h=typeof d?.text=="function"?await d.text():""}catch{}if(c=`HTTP ${g}: ${String(h).slice(0,200)}`,l<r){await Ke(1e3);continue}break}const p=await vt(d,{timeoutMs:6e4}),f=await He(p);return v("nai.encode_vibe.done",{message:s,bytes:p?.byteLength||0,focus:!0}),f}catch(d){if(c=String(d?.message||d),l<r){await Ke(1e3);continue}}throw new Error(`encode-vibe 실패 (${r}회): ${c}`)}var ic=e=>JSON.parse(JSON.stringify(e??{})),oc=new Set(["api_key","auth_token","password","secret"]);function ra(e){if(Array.isArray(e))return e.map(ra);if(!e||typeof e!="object")return e;const t={};for(const[n,a]of Object.entries(e))oc.has(n.toLowerCase())||(t[n]=ra(a));return t}function sa(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Settings must be an object");const t=ic(e),n=t.card&&typeof t.card=="object"&&!Array.isArray(t.card)?t.card:{};if(t.card=n,Number(n.scale_semantics_version||0)<2){const s=Number(n.inline_thumb_pct);n.inline_thumb_pct=Number.isFinite(s)?Math.max(1,s/6):100,n.scale_semantics_version=2}if(Number.isFinite(Number(n.overlay_x_pct))||Number.isFinite(Number(n.overlay_y_pct))||n.overlay_pin_unit==="pct"){n.overlay_pin_unit="pct";const s=String(n.overlay_pin_origin||"");(!s||s==="bottom-left")&&(n.overlay_pin_origin="bl")}const a=n.lore_extra;a===!0||a==="true"||a==="sections"?n.lore_extra="tags":a===!1||a==="false"||a==="none"?n.lore_extra="off":a==="full"||a==="tags"||a==="off"?n.lore_extra=a:n.lore_extra="tags";const r=n.overlay_markers!==!1;return n.overlay_markers=r,n.inline_previews=r,t.settings_schema_version=2,t}function cc(e){return JSON.stringify(ra(sa(e)),null,2)}function lc(e){if(typeof e!="string")throw new TypeError("Settings JSON must be text");if(e.length>2e6)throw new RangeError("Settings JSON is too large");const t=JSON.parse(e);if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Settings JSON must contain an object");return sa(t)}var uc=qt({LLM_ENDPOINT_PRESETS:()=>Xe,LLM_PROVIDERS:()=>dc,REASONING_EFFORTS:()=>_r,applyReasoningToBody:()=>xr,defaultEndpointForProvider:()=>br,endpointPresetKeyFor:()=>mc,ensureLlmRequestUrl:()=>vr,knownLlmEndpoints:()=>wr,llmModelPlaceholder:()=>gc,normalizeLlmProvider:()=>Qe,normalizeReasoningEffort:()=>yr,shouldAutoReplaceEndpoint:()=>fc}),Xe=Object.freeze({openai:"https://api.openai.com/v1/chat/completions",openrouter:"https://openrouter.ai/api/v1/chat/completions",google_ai:"https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",lmstudio:"http://127.0.0.1:1234/v1/chat/completions",ollama:"http://127.0.0.1:11434/v1/chat/completions",anthropic:"https://api.anthropic.com/v1/messages",vertex:"https://us-central1-aiplatform.googleapis.com"}),_r=Object.freeze(["default","none","minimal","low","medium","high","xhigh","max"]),dc=Object.freeze([{value:"openrouter",label:"OpenRouter"},{value:"openai",label:"OpenAI"},{value:"google_ai",label:"Google AI Studio"},{value:"vertex",label:"Vertex AI (Google Cloud)"},{value:"anthropic_compatible",label:"Anthropic-compatible"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}]);function Qe(e){const t=String(e||"").toLowerCase().replace(/[ -]+/g,"_").trim();return["openrouter"].includes(t)?"openrouter":["openai"].includes(t)?"openai":["google","google_ai","google_ai_studio","gemini"].includes(t)?"google_ai":["vertex","vertex_ai","google_vertex"].includes(t)?"vertex":["anthropic","anthropic_compat","anthropic_compatible","claude"].includes(t)?"anthropic_compatible":["lmstudio","lm_studio"].includes(t)?"lmstudio":["ollama"].includes(t)?"ollama":["custom"].includes(t)?"custom":["openai_compatible","openai_compat"].includes(t)?"openrouter":"custom"}function yr(e){const t=String(e??"default").toLowerCase().trim();return!t||t==="auto"||t==="default"?"default":_r.includes(t)?t:"default"}function br(e,t={}){const n=Qe(e);return n==="vertex"?`https://${String(t.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1"}-aiplatform.googleapis.com`:n==="anthropic_compatible"?Xe.anthropic:n==="custom"?Xe.openai:Xe[n]||Xe.openai}function wr(){const e=new Set;for(const t of Object.values(Xe)){const n=String(t||"").replace(/\/+$/,"");n&&(e.add(n),e.add(n.replace(/\/chat\/completions$/i,"")),e.add(n.replace(/\/v1\/messages$/i,"")),e.add(n.replace(/\/v1$/i,"")))}return e.add("https://us-central1-aiplatform.googleapis.com"),e.add("https://europe-west1-aiplatform.googleapis.com"),e.add("https://asia-northeast1-aiplatform.googleapis.com"),e}function fc(e){const t=String(e||"").trim().replace(/\/+$/,"");return t?wr().has(t):!0}function vr(e,t,n={}){const a=Qe(t);let r=String(e||"").trim().replace(/\/+$/,"");if(r||(r=br(a,n).replace(/\/+$/,"")),a==="anthropic_compatible")return/\/v1\/messages$/i.test(r)||/\/messages$/i.test(r)?r:/\/v1$/i.test(r)?`${r}/messages`:`${r}/v1/messages`;if(a==="vertex"){const s=String(n.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1",i=String(n.projectId||"").trim();if(i)return`https://${s}-aiplatform.googleapis.com/v1/projects/${encodeURIComponent(i)}/locations/${encodeURIComponent(s)}/endpoints/openapi/chat/completions`;if(/aiplatform\.googleapis\.com/i.test(r)&&!/\/chat\/completions$/i.test(r))return r}return/\/chat\/completions$/i.test(r)?r:/\/openai$/i.test(r)?`${r}/chat/completions`:/\/v1beta$/i.test(r)?`${r}/openai/chat/completions`:/\/v1$/i.test(r)?`${r}/chat/completions`:r}function xr(e,t){const n={};e&&typeof e=="object"&&Object.assign(n,e);const a=yr(t);return a==="default"||(n.reasoning={effort:a}),n}function gc(e){const t=Qe(e),n={openrouter:"openai/gpt-4o-mini",openai:"gpt-4o-mini",google_ai:"gemini-2.5-flash",vertex:"gemini-2.0-flash-001",anthropic_compatible:"claude-sonnet-4",lmstudio:"local-model",ollama:"llama3.2",custom:"model-id"};return n[t]||n.custom}function mc(e){const t=String(e||"").trim().replace(/\/+$/,"");for(const[n,a]of Object.entries(Xe)){const r=a.replace(/\/+$/,"");if(t===r||t===r.replace(/\/chat\/completions$/i,"")||t===r.replace(/\/v1\/messages$/i,""))return n}return"custom"}var hn=e=>!!e&&typeof e.getReader=="function",ia=e=>typeof e=="object"?e?.text||"":String(e||"");function pn(e){const t=String(e||"").trim().toLowerCase();return t==="main"||t==="risu_main"||t==="risu-main"?"main":t==="aux"||t==="otherax"||t==="other_ax"||t==="risu_aux"||t==="risu-aux"||t==="sub"||t==="secondary"?"aux":"custom"}function hc(e){const t=pn(e);return t==="main"||t==="aux"}function kr(e){const t=e||{};return hc(t.source)?!0:Qe(t.provider)==="vertex"?!!(u(t.model)&&(u(t.api_key)||u(t.service_account_json))):!!(u(t.model)&&u(t.api_key))}function pc(e){let t="";const n=[];for(const a of e||[]){const r=String(a?.role||""),s=a?.content;if(r==="system"){const i=typeof s=="string"?s:Array.isArray(s)?s.map(o=>typeof o=="object"?o.text||"":String(o)).join(""):String(s??"");t=t?`${t}
${i}`:i;continue}if(Array.isArray(s)){const i=[];for(const o of s){if(!o||typeof o!="object"){const g=String(o||"").trim();g&&i.push({type:"text",text:g});continue}const c=o.image_url,l=(typeof c=="object"&&c?c.url:"")||(typeof c=="string"?c:"");if(o.type==="image_url"||l){const g=String(l).match(/^data:([^;]+);base64,([\s\S]+)$/i);g&&i.push({type:"image",source:{type:"base64",media_type:g[1]||"image/png",data:g[2].replace(/\s+/g,"")}});continue}const d=String(o.text||"").trim();d&&i.push({type:"text",text:d})}n.push({role:r==="assistant"?"assistant":"user",content:i.length?i:[{type:"text",text:""}]});continue}n.push({role:r==="assistant"?"assistant":"user",content:String(s??"")})}return{system:t,messages:n}}function _c(e){const t=e?.choices||[];if(!t.length)throw new Error("LLM returned no choices.");let n=(t[0].message||{}).content;return Array.isArray(n)&&(n=n.map(ia).join("")),u(n)}function yc(e){const t=e?.content,n=(Array.isArray(t)?t:[]).map(ia).join(""),a=u(n||e?.completion||"");if(!a)throw new Error("Anthropic 응답이 비어 있습니다.");return a}async function _n(e){if(!hn(e))return"";const t=e.getReader(),n=typeof TextDecoder<"u"?new TextDecoder:null;let a="",r="";for(;;){const{done:s,value:i}=await t.read();if(s)break;if(typeof i=="string")a=i,r+=i;else if(i instanceof Uint8Array)r+=n?n.decode(i,{stream:!0}):"";else if(i&&typeof i=="object"){const o=i,c=o[0];typeof c=="string"?a=c:typeof o.content=="string"?a=o.content:typeof o.text=="string"&&(a=o.text)}}return n&&(r+=n.decode()),a||r}async function bc(e){if(typeof e=="string")return e;if(hn(e))return _n(e);if(e==null)return"";if(typeof e=="number"||typeof e=="boolean")return String(e);if(typeof e=="object"){const t=e,n=u(t.type,40).toLowerCase();if(n==="fail"||n==="error"){const r=u(t.result||t.message||t.error||"Risu LLM 실패",800);throw new Error(`Risu LLM 실패: ${r}`)}if(n==="streaming"||n==="stream"){const r=await _n(t.result??t.data??t.stream);if(r.trim())return r}if(n==="success"||n==="ok"){const r=t.result??t.data??t.content;if(typeof r=="string")return r;if(hn(r))return _n(r)}const a=[t.choices?.[0]?.message?.content,t.choices?.[0]?.text,t.choices?.[0]?.delta?.content,t.message?.content,t.content,t.text,t.response,n?null:t.result,t.output];for(const r of a){if(typeof r=="string"&&r.trim())return r;if(Array.isArray(r)){const s=r.map(ia).join("");if(s.trim())return s}if(hn(r)){const s=await _n(r);if(s.trim())return s}}try{return JSON.stringify(e)}catch{return String(e)}}return String(e||"")}async function wc(){try{const e=await Ve(Ia,_s);if(e==null||e==="")return se(We);const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return se(We);const n=sa(t),a=Ee(We,n);return JSON.stringify(t)!==JSON.stringify(n)&&await Sr(a),a}catch(e){console.warn("[Inlay Nexus] settings load failed",e?.message||e)}return se(We)}async function Sr(e){if(await gt(Ia,se(e)),await Ve("inx_native_settings")==null)throw new Error("설정 저장 실패: IndexedDB(getLocalPluginStorage)에 기록되지 않았습니다.")}var Mr=["","none","off","false","0"];async function vc(){const e=await R("meta","prompt:__pack__"),t=!e||e.text!=="2026-08-02-lore-extra-boundary",n=Date.now()/1e3;for(const a of Na)await R("meta",`prompt:${a}`)&&!(t&&ps.includes(a))||await F("meta",{key:`prompt:${a}`,text:sn(a),updated_at:n});await F("meta",{key:"prompt:__pack__",text:hs,updated_at:n})}async function me(e){const t=await R("meta",`prompt:${e}`);return t?.text!=null?t.text:sn(e)}async function Ar(e,t){const n=Date.now()/1e3;return await F("meta",{key:`prompt:${e}`,text:t,updated_at:n}),{ok:!0,key:e,updated_at:n}}async function xc(){const e=await de("meta"),t=new Map(e.filter(a=>a.key?.startsWith("prompt:")&&!a.key.startsWith("prompt:__")).map(a=>[a.key.slice(7),{key:a.key.slice(7),text:a.text||"",updated_at:a.updated_at||0}])),n=[];for(const a of Na){const r=t.get(a);r?n.push(r):n.push({key:a,text:sn(a),updated_at:0}),t.delete(a)}for(const a of t.values())n.push(a);return n}async function ze(){const e=se(E());await Mi.run(()=>Sr(e))}function kc(){return cc(E())}async function Sc(e){const t=lc(String(e??"").slice(0,2000001)),n=se(E());await F("meta",{key:"settings_backup",value:n,updated_at:Date.now()/1e3});const a=Ee(We,t);return a.llm={...a.llm,api_key:n.llm?.api_key||""},a.nai={...a.nai,api_key:n.nai?.api_key||""},a.auth_token=n.auth_token||"",Cn(a),await ze(),{ok:!0,settings:yn()}}async function Mc(){const e=se(E());await F("meta",{key:"settings_backup",value:e,updated_at:Date.now()/1e3});const t=se(We);t.llm={...t.llm,api_key:e.llm?.api_key||""},t.nai={...t.nai,api_key:e.nai?.api_key||""},t.auth_token=e.auth_token||"";const n=e.card;return t.card={...t.card,presets:Array.isArray(n.presets)?se(n.presets):t.card.presets||[],active_preset_id:String(n.active_preset_id||t.card.active_preset_id||""),custom_pos:String(n.custom_pos??t.card.custom_pos??""),custom_neg:String(n.custom_neg??t.card.custom_neg??"")},Cn(t),await ze(),{ok:!0,settings:yn()}}function Ac(){const e=E(),t=e.nai,n=e.llm;let a=0,r=0,s=0,i=0;try{a=Lt("cards"),r=Lt("images"),s=go();const o=new Set;for(const c of mo()){const l=u(c.character_id||"",200)||"unknown",d=u(c.chat_id||"",200)||"unknown";o.add(`${l}|${d}`)}i=o.size}catch{}return{ok:!0,version:rt,pid:0,source_file:"native",nai_configured:Rt(t)==="comfy"?ta(t):!!u(t.api_key),image_backend:Rt(t),llm_configured:kr(n),port:0,image_mode:"data-url",storage:"indexeddb",storage_api:"getLocalPluginStorage",storage_scope:"device-local",cards:a,images:r,folders:i,png_bytes:s,last_stage:tn(),focus_stage:it(),last_error:In(),debug_events:Is()}}function yn(){const e=se(E());e.nai?.api_key?(e.nai.api_key="",e.nai.api_key_configured=!0):e.nai={...e.nai,api_key_configured:!1},e.llm?.api_key?(e.llm.api_key="",e.llm.api_key_configured=!0):e.llm={...e.llm,api_key_configured:!1},e.llm?.service_account_json?(e.llm.service_account_json="",e.llm.service_account_configured=!0):e.llm={...e.llm,service_account_configured:!1};const t=e.nai;t.backend=Rt(t),t.image_backend=t.backend,t.comfy_configured=ta(t);const n=Ra(),a=Fa(),r=!Mr.includes(u(t.image_reference));t.image_reference_configured=!!(r&&n),t.image_reference||(t.image_reference=t.image_reference_configured?"file":"none"),t.image_reference_configured&&n&&(t.reference_preview_url=n);const s=!Mr.includes(u(t.vibe_transfer));return t.vibe_transfer_configured=!!(s&&a),t.vibe_transfer||(t.vibe_transfer=t.vibe_transfer_configured?"file":"none"),t.vibe_transfer_configured&&a&&(t.vibe_preview_url=a),e.card.character_max=Le(e.card),e.database_path="indexeddb:getLocalPluginStorage",e.images_dir="indexeddb:inx_nximg_*",e.prompts_dir="embedded",e.storage={...e.storage,backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",image_mode:"data-url"},e}async function Nc(e){const t=e&&typeof e=="object"?e:{},n=E(),a={...t.nai||{}},r={...t.llm||{}},s={...t.card||{}};if("api_key"in a){const i=a.api_key;delete a.api_key,delete a.api_key_configured,u(i)&&(n.nai.api_key=i),(a.clearApiKey||t.clear_nai_key)&&(n.nai.api_key=""),delete a.clearApiKey}if("api_key"in r){const i=r.api_key;delete r.api_key,delete r.api_key_configured,u(i)&&(n.llm.api_key=i),(r.clearApiKey||t.clear_llm_key)&&(n.llm.api_key=""),delete r.clearApiKey}if("service_account_json"in r){const i=r.service_account_json;delete r.service_account_json,delete r.service_account_configured,u(i)&&(n.llm.service_account_json=i),(r.clearServiceAccount||t.clear_llm_service_account)&&(n.llm.service_account_json=""),delete r.clearServiceAccount}if(Object.keys(s).length){const i=Ee(n.card,s);Array.isArray(s.presets)&&(i.presets=s.presets),"active_preset_id"in s&&(i.active_preset_id=s.active_preset_id),"custom_pos"in s&&(i.custom_pos=s.custom_pos),"custom_neg"in s&&(i.custom_neg=s.custom_neg),n.card=i,n.card.character_max=Le(n.card)}Object.keys(a).length&&(n.nai=Ee(n.nai,a)),Object.keys(r).length&&(n.llm=Ee(n.llm,r));for(const i of["bind_host","port","auth_token"])i in t&&(n[i]=t[i]);return await ze(),{ok:!0,settings:yn()}}var Nr=12582912,Ft=32;async function Ic(){const e=await R("meta","reference_image");return!!(e?.png&&e.png.byteLength>Ft)}async function Ir(){return(await R("meta","reference_image"))?.png||null}async function $c(e){if(!e||e.byteLength<Ft)throw new Error("참조 이미지가 비어 있습니다");if(e.byteLength>Nr)throw new Error("참조 이미지가 너무 큽니다 (최대 12MB)");return await F("meta",{key:"reference_image",png:e}),Ln(fn(e)),E().nai.image_reference="file",await ze(),{ok:!0,image_reference:"file",configured:!0,bytes:e.byteLength,preview_url:"/v1/nai/reference.png"}}async function $r(){return await _t("meta","reference_image"),Ln(""),E().nai.image_reference="none",await ze(),{ok:!0,image_reference:"none",configured:!1}}async function Ec(){const e=await R("meta","vibe_transfer");return!!(e?.encoded&&e?.png&&e.png.byteLength>Ft)}async function jc(){return await R("meta","vibe_transfer")||null}async function Cc(){return(await R("meta","vibe_transfer"))?.png||null}function Er(e){let t=Number(e??1);return Number.isNaN(t)&&(t=1),Math.max(0,Math.min(1,t))}async function Tc(e,t={}){if(!e||e.byteLength<Ft)throw new Error("Vibe 이미지가 비어 있습니다");if(e.byteLength>Nr)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const n=E(),a=u(n.nai.api_key);if(!a)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const r=Ze(t.model||n.nai.model||"nai-diffusion-4-5-full"),s=Er(t.information_extracted??n.nai.vibe_transfer_information_extracted),i=await pr(a,e,r,s);return await F("meta",{key:"vibe_transfer",png:e,encoded:i,model:xt(r),information_extracted:s}),Pn(fn(e)),n.nai.vibe_transfer="file",t.strength!=null&&!Number.isNaN(Number(t.strength))&&(n.nai.vibe_transfer_strength=Math.max(0,Math.min(1,Number(t.strength)))),n.nai.vibe_transfer_information_extracted=s,await ze(),{ok:!0,vibe_transfer:"file",configured:!0,bytes:e.byteLength,encoded_bytes:i.length,model:xt(r),information_extracted:s,preview_url:"/v1/nai/vibe.png"}}async function jr(){return await _t("meta","vibe_transfer"),Pn(""),E().nai.vibe_transfer="none",await ze(),{ok:!0,vibe_transfer:"none",configured:!1}}async function Lc(){const e=await jc();if(!e?.png||e.png.byteLength<Ft)return null;const t=E(),n=u(t.nai.api_key);if(!n)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=xt(Ze(t.nai.model||"nai-diffusion-4-5-full")),r=Er(t.nai.vibe_transfer_information_extracted);if(!(!u(e.encoded)||u(e.model)!==a||Math.abs(Number(e.information_extracted??1)-r)>.001))return e;const s=await pr(n,e.png,a,r),i={...e,key:"vibe_transfer",encoded:s,model:a,information_extracted:r};return await F("meta",i),i}async function bn(e){const{shot:t,roster:n}=e,a=E().card,r=E().nai,s=Le(a),i=Rn(t.characters||[],n,s).slice(0,s),o=Math.max(1,i.length),c=Ha(a.person_tag_mode,a.auto_person_tags),l=qi(i,n,c),[d,g]=Rs(await me("preset_1")),p=Array.isArray(a.presets)?a.presets:[],f=u(a.active_preset_id,120);let h=null;p.length&&(f&&(h=p.find(T=>typeof T=="object"&&u(T.id,120)===f)||null),!h&&typeof p[0]=="object"&&(h=p[0]));let m,_;h?(m=u(h.positive||h.pos||""),_=u(h.negative||h.neg||"")):(m=P(u(a.custom_pos),d),_=P(u(a.custom_neg),g));let y=t.situation||t.scene;c!=="off"&&(y=Hi(y||""));let x;const k=u(e.lockedSetup||"");k?x=k:(x=P(t.camera,y,t.place,t.action),a.mode==="asset"&&(x=P(x,"white background","simple background","cowboy shot","looking at viewer","portrait")));const S=a.natural_base!==!1?u(t.natural||t.natural_base||t.nl||"",400):"";let A=P(l,m,S,x);const M=Ze(r.model||"nai-diffusion-4-5-full");r.apply_quality_tags!==!1&&(A+=rn[M]||"");const w=u(r.uc_preset)||"human_focus",I=P(_,(hi[M]||{})[w]||""),D=[],$=[];for(let T=0;T<i.length;T++){const j=i[T],z=u(j.name,200),ne=z?ie(z,n):null,G=_e(ne),le=ne&&G?ft(ne):"",H=u(j.original||j.original_tag||"",400),Ht=u(ne?.original||"",400),W=Ka(P(Ht?"":H,le,G?"":j.label,G?"":j.age,G?"":j.appearance,G?"":j.body,G?"":j.attire||ne?.attire,G?"":j.accessories||ne?.accessories,j.expression,j.action,j.sex)),he=u(j.negative),B=o===1?.5:Math.round((.1+.8*T/Math.max(1,o-1))*10)/10,at=.5;D.push({prompt:W||"girl",uc:he,center_x:B,center_y:at}),$.push({name:ne?.name||z,prompt:W,uc:he,center_x:B,center_y:at,raw:j})}return{main:A,neg:I,captions:D,meta:{setup:x,person:l,characters:$,paragraph:t.paragraph}}}async function Cr(e){const t=E().nai,n=e.captions;if(Rt(t)==="comfy"){const[d,g]=await tc(t,e.main,e.neg,n);return{bytes:d,seed:g}}const a=u(t.api_key);if(!a)throw new Error("NAI api_key가 설정되지 않았습니다.");const r=[],s=u(t.image_reference||"none").toLowerCase();if(!["","none","off","false","0"].includes(s)){const d=await Ir();if(d){let g=u(t.image_reference_type||"character&style")||"character&style";["character","style","character&style"].includes(g)||(g="character&style");let p=Number(t.image_reference_strength??.6),f=Number(t.image_reference_fidelity??1);Number.isNaN(p)&&(p=.6),Number.isNaN(f)&&(f=1),r.push({image:d,type:g,strength:Math.max(0,Math.min(1,p)),fidelity:Math.max(0,Math.min(1,f))})}}const i=[],o=u(t.vibe_transfer||"none").toLowerCase();if(!["","none","off","false","0"].includes(o)){const d=await Lc();if(d?.encoded){let g=Number(t.vibe_transfer_strength??.6),p=Number(t.vibe_transfer_information_extracted??d.information_extracted??1);Number.isNaN(g)&&(g=.6),Number.isNaN(p)&&(p=1),i.push({encoded:d.encoded,strength:Math.max(0,Math.min(1,g)),information_extracted:Math.max(0,Math.min(1,p))})}}const c={prompt:e.main,negative_prompt:e.neg,width:Math.min(Number(t.width??640)||640,832),height:Math.min(Number(t.height??960)||960,1216),seed:Number(t.seed??0)||0,steps:Math.min(Number(t.steps??28)||28,28),cfg_scale:Number(t.cfg_scale??7),cfg_rescale:Number(t.cfg_rescale??.36),sampler:u(t.sampler)||"k_euler_ancestral",scheduler:u(t.scheduler)||"karras",model:Ze(t.model||"nai-diffusion-4-5-full"),var_plus:!!t.variety_plus,characters:n,character_refs:r,vibes:i};c.width*c.height>1011712&&(c.width=640,c.height=960),v("nai.generate.dims",{message:`${c.width}x${c.height}`,steps:c.steps,focus:!0}),c.seed||(c.seed=Math.floor(Math.random()*4294967295)||1);const l=u(t.request_url)||"https://image.novelai.net/ai/generate-image";return{bytes:(await hr(a,c,l,{timeoutMs:9e4})).raw_bytes,seed:c.seed||0}}function Pc({imageId:e,sessionId:t,request:n,shotIndex:a,paragraph:r,yPercent:s,contentHash:i=""}){return{version:1,image_id:u(e,80),session_id:u(t,200),unified_session_id:u(n.unified_session_id||"",200),character_id:u(n.character_id||"",200),character_name:u(n.character_name||"",200),chat_id:u(n.chat_id||"",200),chat_name:u(n.chat_name||"",200),char_index:C(n.char_index,-1),chat_index:C(n.chat_index,-1),message_index:C(n.message_index,-1),message_role:u(n.message_role||n.role||"",40).toLowerCase(),shot_index:C(a,0),paragraph:C(r,0),y_percent:s,content_hash:u(i||n.content_hash||"",128),assistant_preview:u(n.assistant_text||"",Ge)}}async function et(e){return ho(e)}async function Tr(e,t){const n=await R("images",e),a=n?{...n}:{id:e},r=t||{};a.location={...r,version:Number(r.version||1),image_id:u(e,80)},await F("images",a)}async function Ue(e,t={}){const n=await et(e),a=typeof t=="object"&&t?t:{};let r=n.y_percent;r==null&&(r=a.y_percent??a.anchor_percent??a.read_percent);const s=Object.keys(n).length>0,i=ve(u(e,80));return{character_id:u(n.character_id||a.character_id||"",200),chat_id:u(n.chat_id||a.chat_id||"",200),character_name:u(n.character_name||a.character_name||"",200),chat_name:u(n.chat_name||a.chat_name||"",200),char_index:C(n.char_index??a.char_index,-1),chat_index:C(n.chat_index??a.chat_index,-1),message_index:C("message_index"in n?n.message_index:a.message_index,-1),message_role:u(n.message_role||a.message_role||"",40).toLowerCase(),shot_index:C(n.shot_index,-1),paragraph:C("paragraph"in n?n.paragraph:a.paragraph,0),y_percent:nn(r),content_hash:u(n.content_hash||a.content_hash||"",128),assistant_preview:u(n.assistant_preview||a.assistant_preview||"",Ge),unified_session_id:u(n.unified_session_id||a.unified_session_id||"",200),location_file:s?`idb:${i}`:"",storage:"indexeddb",storage_key:i}}function oa(e,t,n=0){const a=typeof e=="object"&&e?{...e}:{},r=t||{};return{...a,character_id:u(r.character_id||a.character_id||"",200),chat_id:u(r.chat_id||a.chat_id||"",200),character_name:u(r.character_name||a.character_name||"",200),chat_name:u(r.chat_name||a.chat_name||"",200),char_index:C(r.char_index??a.char_index,-1),chat_index:C(r.chat_index??a.chat_index,-1),message_index:C(r.message_index??a.message_index,-1),message_role:u(r.message_role||a.message_role||"",40).toLowerCase(),content_hash:u(r.content_hash||a.content_hash||"",128),assistant_preview:u(r.assistant_preview||a.assistant_preview||"",Ge),unified_session_id:u(r.unified_session_id||a.unified_session_id||"",200),y_percent:nn(r.y_percent??a.y_percent),storage:"indexeddb",storage_key:ve(u(r.image_id||"",80)),png_bytes:Number(n)||0}}var Oc=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t+=1){let n=t;for(let a=0;a<8;a+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e})();function ca(e){return Array.isArray(e)?new Uint8Array(e):re(e)}function Bc(e){const t=ca(e);let n=4294967295;for(let a=0;a<t.length;a+=1)n=Oc[(n^t[a])&255]^n>>>8;return(n^4294967295)>>>0}function K(e){const t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e>>>0,!0),t}function te(e){const t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function Dt(e){let t=0;for(const n of e)t+=n.length;return At(e,t)}function Rc(e){return new TextEncoder().encode(String(e??""))}function Fc(e=[]){const t=[],n=[];let a=0;for(const i of e){const o=Rc(i.name||"file"),c=ca(i.data),l=Bc(c),d=Dt([te(67324752),K(20),K(0),K(0),K(0),K(0),te(l),te(c.length),te(c.length),K(o.length),K(0),o,c]),g=Dt([te(33639248),K(20),K(20),K(0),K(0),K(0),K(0),te(l),te(c.length),te(c.length),K(o.length),K(0),K(0),K(0),K(0),te(0),te(a),o]);t.push(d),n.push(g),a+=d.length}const r=Dt(n),s=Dt([te(101010256),K(0),K(0),K(e.length),K(e.length),te(r.length),te(a),K(0)]);return Dt([...t,r,s])}function la(e,t){return e[t]|e[t+1]<<8}function Lr(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Dc(e){const t=ca(e),n=new Map;let a=0;for(;a+30<=t.length;){const r=Lr(t,a);if(r===33639248||r===101010256)break;if(r!==67324752){a+=1;continue}const s=la(t,a+8),i=Lr(t,a+18),o=la(t,a+26),c=la(t,a+28),l=a+30,d=new TextDecoder().decode(t.subarray(l,l+o)),g=l+o+c,p=g+i;if(p>t.length)break;s===0&&n.set(d.replace(/\\/g,"/"),t.subarray(g,p)),a=p}return n}function zc(e=[],{exportedAt:t=Date.now()}={}){return{format:"inlay-nexus-gallery",version:1,exported_at:t,items:(e||[]).map(n=>({id:String(n.id||""),file:`images/${String(n.id||"unknown")}.png`,location:{character_id:n.character_id||"",chat_id:n.chat_id||"",character_name:n.character_name||"",chat_name:n.chat_name||"",char_index:n.char_index??-1,chat_index:n.chat_index??-1,message_index:n.message_index??-1,content_hash:n.content_hash||"",paragraph:n.paragraph??0,shot_index:n.shot_index??0,y_percent:n.y_percent??null,assistant_preview:n.assistant_preview||"",session_id:n.session_id||""},meta:{main_prompt:n.main_prompt||"",seed:n.seed??null,created_at:n.created_at??null,characters:n.characters||[]}}))}}function Uc(e,t=[]){const n=e?.location||{},a=String(n.content_hash||"").trim(),r=t||[];if(a){const l=r.find(d=>String(d.content_hash||"")===a);if(l)return{status:"exact",matchId:String(l.id),content_hash:a}}const s=String(n.character_id||""),i=String(n.chat_id||""),o=Number(n.message_index),c=r.filter(l=>s&&String(l.character_id||"")!==s||i&&String(l.chat_id||"")!==i||Number.isFinite(o)&&o>=0&&Number(l.message_index)!==o?!1:!!(s||i||Number.isFinite(o)&&o>=0)).slice(0,8);return c.length?{status:"candidate",candidates:c.map(l=>({id:l.id,content_hash:l.content_hash,message_index:l.message_index})),location:n}:{status:"orphan",location:n}}function Jc(e=[]){return Fc(e)}function Kc(e){const t=Dc(e);let n=null;const a=t.get("manifest.json");if(a)try{n=JSON.parse(new TextDecoder().decode(a))}catch{n=null}const r=new Map;for(const[s,i]of t.entries())s!=="manifest.json"&&/\.(png|webp|jpe?g)$/i.test(s)&&r.set(s.replace(/\\/g,"/"),i);return{manifest:n,images:r,files:t}}function zt(e){try{const t=JSON.parse(e.meta_json||"{}");return t&&typeof t=="object"?t:{}}catch{return{}}}async function Pr(e,t){return(await fo(e))?.png_bytes||Number(t.png_bytes)||0}async function ua(e){const t=(await de("cards")).sort((s,i)=>(i.created_at||0)-(s.created_at||0)).slice(0,Math.max(1,Math.min(2e3,e))),n={},a=[];for(const s of t){const i=zt(s),o=await Ue(s.id,i),c=await et(s.id),l=u(o.character_name||c.character_name||i.character_name||"",200),d=u(o.chat_name||c.chat_name||i.chat_name||"",200),g=u(o.character_id||"",200)||"unknown",p=u(o.chat_id||"",200)||"unknown",f=`${g}|${p}`;let h=n[f];h||(h={key:f,character_id:g,chat_id:p,character_name:l||g.slice(0,12)||"Unknown",chat_name:d||`chat ${o.chat_index??"?"}`,char_index:o.char_index??-1,chat_index:o.chat_index??-1,count:0,storage:"indexeddb"},n[f]=h),l&&!h.character_name&&(h.character_name=l),d&&(h.chat_name=d),h.count+=1,a.push({id:s.id,job_id:s.job_id,session_id:s.session_id,folder_key:f,shot_index:o.shot_index>=0?o.shot_index:s.shot_index,paragraph:Object.keys(c).length?o.paragraph:s.paragraph,y_percent:o.y_percent,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:g,character_name:h.character_name,chat_id:p,chat_name:h.chat_name,char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:u(o.assistant_preview||c.assistant_preview||i.assistant_preview||"",Ge),main_prompt:s.main_prompt,characters:JSON.parse(s.characters_json||"[]"),image_url:ye(s.id),seed:s.seed,created_at:s.created_at,storage:"indexeddb",storage_key:o.storage_key||ve(s.id),location_file:o.location_file||"",png_bytes:await Pr(s.id,i)})}const r={ok:!0,folders:Object.values(n).sort((s,i)=>`${s.character_name||""}`.localeCompare(`${i.character_name||""}`,void 0,{sensitivity:"base"})||`${s.chat_name||""}`.localeCompare(`${i.chat_name||""}`,void 0,{sensitivity:"base"})),items:a,total:a.length,storage:"indexeddb",storage_api:"getLocalPluginStorage"};return await Be(r,{cachedOnly:!0}),r}async function Hc(e=400){return ua(e)}async function qc(e,t=40){const n=(await nr(e)).sort((s,i)=>(i.created_at||0)-(s.created_at||0)).slice(0,Number(t)),a=[];for(const s of n){const i=zt(s),o=await Ue(s.id,i),c=await et(s.id);a.push({id:s.id,job_id:s.job_id,shot_index:o.shot_index>=0?o.shot_index:s.shot_index,paragraph:Object.keys(c).length?o.paragraph:s.paragraph,y_percent:o.y_percent,message_index:o.message_index??-1,message_role:o.message_role||"",content_hash:o.content_hash||"",character_id:o.character_id||"",chat_id:o.chat_id||"",character_name:o.character_name||"",chat_name:o.chat_name||"",char_index:o.char_index??-1,chat_index:o.chat_index??-1,assistant_preview:o.assistant_preview||i.assistant_preview||"",main_prompt:s.main_prompt,negative_prompt:s.negative_prompt,characters:JSON.parse(s.characters_json||"[]"),image_url:ye(s.id),seed:s.seed,created_at:s.created_at,storage:"indexeddb",storage_key:o.storage_key||ve(s.id),png_bytes:await Pr(s.id,i)})}const r={ok:!0,session_id:e,items:a,storage:"indexeddb"};return await Be(r,{cachedOnly:!0}),r}async function Gc(e={}){const t=u(e.session_id,200),n=u(e.to_hash,128),a=u(e.assistant_preview||"",Ge),r=(Array.isArray(e.card_ids)?e.card_ids:[]).map(i=>u(i,80)).filter(Boolean);if(!n||!r.length)return{ok:!1,...Y("to_hash and card_ids required","bad_request"),rebound:0,ids:[]};const s=[];for(const i of r){const o=await R("cards",i);if(!o||t&&u(o.session_id||"",200)!==t)continue;const c=zt(o),l=await et(i),d={...l,image_id:i,content_hash:n,assistant_preview:a||l.assistant_preview||""};await Tr(i,d),c.content_hash=n,a&&(c.assistant_preview=a),c.message_role=u(c.message_role||l.message_role||"",40).toLowerCase(),o.meta_json=JSON.stringify(c),await F("cards",o),s.push(i)}return v("gallery.rebind",{n:s.length,to:n.slice(0,8)}),{ok:!0,rebound:s.length,ids:s,content_hash:n}}async function da(e,t="",n=null){const a=u(e,200),r=u(t);let s=null;try{n!=null&&String(n).trim()!==""&&(s=parseInt(String(n),10))}catch{s=null}if(!a||!r&&s==null)return{ok:!0,unlinked:0,ids:[]};const i=(await nr(a)).sort((c,l)=>(c.created_at||0)-(l.created_at||0)),o=[];for(const c of i){const l=zt(c),d=await Ue(c.id,l),g=u(d.content_hash||""),p=C(d.message_index,-1);let f=!1;if((r&&g&&g===r||s!=null&&s>=0&&p===s)&&(f=!0),!f)continue;const h={...await et(c.id),version:1,image_id:c.id,session_id:a,content_hash:"",message_index:-1,character_id:"",chat_id:"",char_index:-1,chat_index:-1,unlinked_at:Date.now()/1e3};await Tr(c.id,h),(l.content_hash||l.message_index!=null||l.assistant_preview)&&(l.content_hash="",l.assistant_preview="",l.message_index=-1,l.unlinked_at=Date.now()/1e3,c.meta_json=JSON.stringify(l),await F("cards",c)),o.push(c.id)}return{ok:!0,unlinked:o.length,ids:o}}async function fa(e){const t=u(e,80);return t?await R("cards",t)?(await _t("cards",t),await _t("images",t),{ok:!0,deleted:1,ids:[t]}):{ok:!1,...Y("card not found","not_found")}:{ok:!1,...Y("card_id required","bad_request")}}async function ga(e){return fa(e)}async function Wc(e=[]){const t=[...new Set((e||[]).map(a=>u(a,80)).filter(Boolean))],n=[];for(const a of t)(await fa(a)).ok&&n.push(a);return{ok:!0,deleted:n.length,ids:n}}async function Or(){const e=(await R("meta","explorer_favorites"))?.ids;return{ok:!0,ids:Array.isArray(e)?e.map(t=>u(t,80)).filter(Boolean):[]}}async function Vc(e=[]){const t=[...new Set((e||[]).map(n=>u(n,80)).filter(Boolean))].slice(0,5e3);return await F("meta",{key:"explorer_favorites",ids:t,updated_at:Date.now()/1e3}),{ok:!0,ids:t}}async function Yc(e={}){let t=(await ua(2e3)).items;const n=u(e.folder_key||"",400);if(!e.all)if(n)t=t.filter(i=>i.folder_key===n);else if(Array.isArray(e.card_ids)&&e.card_ids.length){const i=new Set(e.card_ids.map(o=>u(o,80)));t=t.filter(o=>i.has(o.id))}else return{ok:!1,...Y("card_ids, folder_key, or all required","bad_request")};if(!t.length)return{ok:!1,...Y("no images to export","empty")};const a=zc(t),r=[{name:"manifest.json",data:new TextEncoder().encode(JSON.stringify(a,null,2))}];for(const i of t){const o=await Br(i.id);o?.byteLength&&r.push({name:`images/${i.id}.png`,data:re(o)})}if(r.length<2)return{ok:!1,...Y("image bytes missing","empty")};const s=Jc(r);return{ok:!0,count:r.length-1,filename:`inlay-gallery-${Date.now()}.zip`,zip_base64:ot(s),bytes:s.length}}async function Zc(e={}){const t=e.prefer_new_ids===void 0?!0:e.prefer_new_ids,n=String(e.zip_base64||"").replace(/^data:.*base64,/,"");if(!n)return{ok:!1,...Y("zip_base64 required","bad_request")};let a;try{a=$e(n)}catch(l){return{ok:!1,...Y(`invalid base64: ${l?.message||l}`,"bad_request")}}const{manifest:r,images:s}=Kc(a);if(!r?.items?.length)return{ok:!1,...Y("manifest.items missing","bad_request")};const i=(await ua(2e3)).items,o=[],c={exact:0,candidate:0,orphan:0,skipped:0};for(const l of r.items){const d=String(l.file||`images/${l.id}.png`).replace(/\\/g,"/"),g=s.get(d)||s.get(`images/${l.id}.png`);if(!g?.byteLength){c.skipped+=1;continue}const p=Uc(l,i);c[p.status]=(c[p.status]||0)+1;const f={...l.location||{}},h=t?qe():u(l.id||"",80)||qe(),m=u(f.session_id||"",200)||`import_${qe().replace(/-/g,"").slice(0,10)}`,_={version:1,image_id:h,session_id:m,character_id:u(f.character_id||"",200),character_name:u(f.character_name||"",200),chat_id:u(f.chat_id||"",200),chat_name:u(f.chat_name||"",200),char_index:C(f.char_index,-1),chat_index:C(f.chat_index,-1),message_index:C(f.message_index,-1),shot_index:C(f.shot_index,0),paragraph:C(f.paragraph,0),y_percent:nn(f.y_percent),content_hash:u(f.content_hash||"",128),assistant_preview:u(f.assistant_preview||"",Ge),imported_at:Date.now()/1e3,reattach:p.status},y=Z(g);await Kn(h,y,_);const x=oa({...l.meta||{},assistant_preview:_.assistant_preview,imported_at:_.imported_at,reattach:p.status},_,y.byteLength||0);await F("cards",{id:h,job_id:`import_${h.slice(0,8)}`,session_id:m,shot_index:_.shot_index,paragraph:_.paragraph,main_prompt:u(l.meta?.main_prompt||"",8e3),negative_prompt:"",characters_json:JSON.stringify(l.meta?.characters||[]),seed:l.meta?.seed??0,meta_json:JSON.stringify(x),created_at:Number(l.meta?.created_at)||Date.now()/1e3}),o.push({id:h,reattach:p.status,content_hash:_.content_hash})}return{ok:!0,imported:o.length,items:o,report:c}}async function Xc(e){const t=u(e,400);if(!t||!t.includes("|"))return{ok:!1,...Y("folder_key required","bad_request")};const[n,a]=t.split("|",2),r=u(n,200)||"unknown",s=u(a,200)||"unknown",i=await de("cards"),o=[];for(const c of i){const l=zt(c),d=await Ue(c.id,l),g=u(d.character_id||"",200)||"unknown",p=u(d.chat_id||"",200)||"unknown";g!==r||p!==s||(await fa(c.id)).ok&&o.push(c.id)}return{ok:!0,deleted:o.length,ids:o,folder_key:`${r}|${s}`}}async function Br(e){return bo(e)}var Qc=["queued","tagging","generating"];function wn(e={},t=""){const n=u(t||e.session_id||"",200)||"_",a=u(e.content_hash||"",128);if(a)return`${n}::h:${a}`;const r=C(e.message_index,-1);return r>=0?`${n}::m:${r}`:`${n}::all`}async function el(e){if(Tn.has(e))return"message-reroll";const t=on.get(e);if(!t?.jobId)return"";const n=lt.get(t.jobId);if(!n||n.cancelRequested)return"";const a=await R("jobs",t.jobId);return a&&Qc.includes(String(a.state||""))?t.jobId:""}async function ma(e={},t=""){const n=await el(wn(e,t));return n?{ok:!1,busy:!0,accepted:!1,job_id:n==="message-reroll"?"":n,session_id:u(t||e.session_id||"",200),job_state:"busy",error:{code:"busy",message:"같은 메시지 작업이 아직 진행 중입니다. 끝날 때까지 기다려 주세요."}}:null}var Rr=e=>e.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"");function Fr(e){const t=typeof e=="string"?e:JSON.stringify(e);return Rr(ot(new TextEncoder().encode(t)))}function tl(e){const t=ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):re(e);return Rr(ot(t))}async function nl(e){let t;try{t=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("Vertex Service Account JSON 파싱 실패")}if(!t?.client_email||!t?.private_key)throw new Error("Service Account JSON에 client_email/private_key가 필요합니다.");if(!globalThis.crypto?.subtle)throw new Error("이 환경에서는 Vertex Service Account(JWT) 서명을 지원하지 않습니다. API key 칸에 OAuth access token을 넣거나 Google AI Studio를 쓰세요.");const n=Math.floor(Date.now()/1e3),a=`${Fr({alg:"RS256",typ:"JWT"})}.${Fr({iss:t.client_email,scope:"https://www.googleapis.com/auth/cloud-platform",aud:"https://oauth2.googleapis.com/token",iat:n,exp:n+3600})}`,r=String(t.private_key).replace(/\\n/g,`
`).replace(/-----BEGIN [^-]+-----/,"").replace(/-----END [^-]+-----/,"").replace(/\s+/g,""),s=Uint8Array.from(atob(r),d=>d.charCodeAt(0)),i=await crypto.subtle.importKey("pkcs8",s,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),o=`${a}.${tl(await crypto.subtle.sign("RSASSA-PKCS1-v1_5",i,new TextEncoder().encode(a)))}`,c=await De("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`grant_type=${encodeURIComponent("urn:ietf:params:oauth:grant-type:jwt-bearer")}&assertion=${encodeURIComponent(o)}`});let l={};try{l=await c.json()}catch{l={}}if(!l?.access_token)throw new Error(`Vertex 토큰 발급 실패: ${JSON.stringify(l).slice(0,240)}`);return{accessToken:String(l.access_token),projectId:u(t.project_id||"")}}async function vn(e,t){const n=pn(e.source);if(n==="main"||n==="aux")return al(e,t,n);const a=Qe(e.provider),r=u(e.model),s=u(e.vertex_region)||"us-central1";let i=u(e.api_key),o="";if(a==="vertex"&&u(e.service_account_json)){const f=await nl(e.service_account_json);i=f.accessToken,o=f.projectId}if(!r||!i)throw v("llm.config",{message:"missing model/api_key",provider:a},"error"),new Error(a==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM이 설정되지 않았습니다. 모델 설정에서 Provider·Model·API key를 넣으세요. (NovelAI 키와 별개)");const c=vr(u(e.endpoint),a,{region:s,projectId:o});if(a==="vertex"&&!/\/chat\/completions$/i.test(c))throw new Error("Vertex AI: project_id가 있는 Service Account JSON이 필요합니다. (OpenAI-compatible endpoint 구성용)");const l=Number(e.timeout_seconds??180)*1e3,d=typeof AbortController<"u"?new AbortController:null,g=setTimeout(()=>{v("llm.abort",{message:`timeout ${l}ms`,model:r,provider:a},"warn"),d?.abort?.()},l),p=Q("llm.call");v("llm.call.start",{message:r,msgs:t?.length||0,timeout_ms:l,source:n,provider:a,reasoning:u(e.reasoning_effort)||"default"});try{let f;if(a==="anthropic_compatible"){const y=pc(t),x={model:r,max_tokens:Number(e.max_tokens??8e3),temperature:Math.min(1,Number(e.temperature??.4)),messages:y.messages};y.system&&(x.system=y.system),f=await De(c,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":i,"anthropic-version":u(e.anthropic_version)||"2023-06-01"},body:JSON.stringify(x),signal:d?.signal})}else{const y=xr({model:r,messages:t,temperature:Number(e.temperature??.4),max_tokens:Number(e.max_tokens??8e3)},e.reasoning_effort),x={"Content-Type":"application/json",Authorization:`Bearer ${i}`};a==="openrouter"&&(x["HTTP-Referer"]="https://risuai.xyz",x["X-Title"]="Inlay Nexus"),f=await De(c,{method:"POST",headers:x,body:JSON.stringify(y),signal:d?.signal})}const h=Number(f?.status||0);let m;try{m=await f.json()}catch{m={}}if(h>=400)throw p.fail(new Error(`HTTP ${h}`),{status:h,body:JSON.stringify(m).slice(0,200),provider:a}),new Error(`LLM HTTP ${h}: ${JSON.stringify(m).slice(0,500)}`);const _=a==="anthropic_compatible"?yc(m):_c(m);return p.end({message:r,status:h,bytes:_.length,provider:a}),_}catch(f){throw p.fail(f,{model:r,provider:a}),f}finally{clearTimeout(g)}}async function al(e,t,n,a=""){const r=st();if(!r||typeof r.runLLMModel!="function")throw new Error("RisuAI runLLMModel API를 사용할 수 없습니다. Risu를 최신으로 업데이트하세요.");const s=n==="main"?"model":"otherAx",i=Math.max(5e3,Number(e.timeout_seconds??180)*1e3),o=u(a)||"",c=Q("llm.call");v("llm.call.start",{message:`risu:${s}`,msgs:t?.length||0,timeout_ms:i,source:n,static_model:o});let l;const d=new Promise((g,p)=>{l=setTimeout(()=>p(new Error(`Risu LLM timeout ${i}ms (${s})`)),i)});try{const g=await Promise.race([r.runLLMModel({mode:s,...o?{staticModel:o}:{},allowPlugins:!0,messages:t}),d]),p=u(await bc(g));if(!p)throw new Error(`Risu LLM(${s}) 응답이 비어 있습니다.`);return c.end({message:`risu:${s}`,bytes:p.length}),p}catch(g){throw c.fail(g,{mode:s}),g}finally{l!==void 0&&clearTimeout(l)}}var rl=qt({isCharacterImageExtraLore:()=>tt,matchCharacterImageSectionTitles:()=>Ur,normalizeNameKey:()=>kt,parseCharacterImageTagLore:()=>ha,trimCharacterImageTagLore:()=>zr});function tt(e){return String(e?.comment||e?.name||"").trim().toLowerCase()==="lb-xnai.lb.extra"}function ha(e){const t=String(e||"");if(!t.trim())return{header:"",sections:[]};const n=/^(#{2,3})\s+(.+?)\s*$/gm,a=[];let r;for(;(r=n.exec(t))!==null;)a.push({hashes:r[1],title:String(r[2]||"").trim(),start:r.index,titleEnd:r.index+r[0].length});if(!a.length)return{header:t.trimEnd(),sections:[]};let s=t.slice(0,a[0].start).trimEnd();const i=[];for(let o=0;o<a.length;o+=1){const c=a[o],l=o+1<a.length?a[o+1].start:t.length,d=t.slice(c.titleEnd,l).replace(/^\r?\n/,"").trimEnd();if(c.title.toLowerCase()==="character image tags"){const g=t.slice(c.start,l).trimEnd();s=s?`${s}

${g}`:g;continue}i.push({title:c.title,hashes:c.hashes,body:d})}return{header:s.trimEnd(),sections:i}}function kt(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}function Dr(e){return new Set((Array.isArray(e)?e:[]).map(t=>kt(t)).filter(Boolean))}function sl(e,t){if(!t.length)return"";const n=[];e&&n.push(e);for(const a of t){const r=`${a.hashes} ${a.title}`;n.push(a.body?`${r}
${a.body}`:r)}return n.join(`

`).trimEnd()}function zr(e,t=[],n=[]){const a=ha(e);if(!a.sections.length)return"";const r=Dr(n);if(!r.size)return"";const s=Dr(t),i=a.sections.filter(o=>{const c=kt(o.title);return r.has(c)&&!s.has(c)});return sl(a.header,i)}function Ur(e,t,n=[]){const a=ha(e),r=kt(t),s=new Set((Array.isArray(n)?n:[]).map(o=>kt(o)).filter(o=>o.length>=2));if(!r&&!s.size)return[];const i=[];for(const o of a.sections){const c=kt(o.title);c.length<2||(r&&r.includes(c)||s.has(c))&&i.push(o.title)}return i}function Jr(e){const t=e.key||e.keys||e.trigger||"";let n;if(Array.isArray(t))n=t.map(i=>u(i,200));else{const i=u(t,2e3);n=i?i.split(/[,|\n]/):[]}const a=e.secondkey||e.second_key||"";a&&n.push(...J(a));const r=[],s=new Set;for(const i of n){const o=u(i,200),c=U(o),l=o?ct(o):"";!c||s.has(c)||o.startsWith("")||l.length<2||(s.add(c),r.push(o))}return r}function Kr(e,t,n){const a=U(e),r=ct(e);if(r.length<2)return 0;const s=(i,o)=>{if(!i||!o||o.length<2)return 0;let c=0,l=0;for(;l<=i.length-o.length;){const d=i.indexOf(o,l);if(d<0)break;c+=1,l=d+o.length}return c};return Math.max(s(t,a),s(n,r))}function il(e,t){const n=u(t).toLowerCase(),a=ct(t);if(!n)return[];const r=[],s=new Set;for(const i of e||[]){if(typeof i!="object"||tt(i))continue;const o=u(i.mode||"",40).toLowerCase(),c=u(i.key||"",2e3);if(o==="folder"||c.startsWith("folder:"))continue;const l=Jr(i);if(!l.length)continue;let d=0;for(const g of l)d+=Kr(g,n,a);if(!(d<=0))for(const g of l){const p=U(g);!p||s.has(p)||(s.add(p),r.push(g))}}return r}function Hr(e,t=[]){const n=String(e||"");if(!/character\s*image\s*tags/i.test(n))return!1;const a=(n.match(/^#{2,3}\s+.+$/gm)||[]).filter(s=>!/character\s*image\s*tags/i.test(s)),r=Array.isArray(t)?t.filter(Boolean).length:0;return a.length>=3&&(r===0||a.length>r+1)}function ol(e){const t=[],n=new Set;for(const a of e||[])if(_e(a))for(const r of $t(a)){const s=u(r,200),i=U(s);!s||!i||n.has(i)||(n.add(i),t.push(s))}return t}function qr(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e==="full"?"full":"tags"}function cl(e,t,n=[],a=5,r=1200,s=null,i="tags"){const o=Array.isArray(e)?e:[],c=qr(i),l=c==="off"?[]:o.filter(h=>tt(h)),d=o.filter(h=>!tt(h)),g=ll(d,t,a,r),p=Array.isArray(s)&&s.length?s.map(h=>u(h,200)).filter(Boolean):il(d,t),f=[];for(const h of l){const m=u(h.content||h.data||"",5e4);if(m)if(c==="full")f.push({comment:u(h.comment||h.name||"lb-xnai.lb.extra",200),content:m,key:"full",always:!0,lore_extra_mode:"full"});else{const _=Ur(m,t,p),y=_.length?zr(m,n,_):"";y&&!Hr(y,_)&&f.push({comment:u(h.comment||h.name||"lb-xnai.lb.extra",200),content:y,key:_.join(", "),always:!0,lore_extra_mode:"tags"})}}for(const h of g)Hr(u(h.content||h.data||"",r),[])||f.push(h);return f}function ll(e,t,n=5,a=1200){const r=u(t).toLowerCase(),s=ct(t);if(!r)return[];const i=[];for(const o of e||[]){if(typeof o!="object"||tt(o))continue;const c=u(o.mode||"",40).toLowerCase(),l=u(o.key||"",2e3);if(c==="folder"||l.startsWith("folder:"))continue;const d=u(o.content||o.data||"",a);if(!d)continue;const g=Jr(o);if(!g.length)continue;let p=0;for(const f of g)p+=Kr(f,r,s);p<=0||i.push({comment:u(o.comment||o.name||"",200),content:d,key:l,hits:p})}return i.sort((o,c)=>c.hits-o.hits||String(o.comment).localeCompare(String(c.comment))),i.slice(0,Math.max(1,n)).map(({hits:o,...c})=>c)}async function ul(e){const t=Ee(E().card,e.card||{}),n=u(e.session_id,200),a=[{role:"system",content:`${an(await me("tagger"))}

${an(await me("format"))}`.trim()}];t.char_info&&u(e.character_description)&&a.push({role:"system",content:`${await me("char_inject")}
## {{char}} Info
${u(e.character_description,12e3)}`}),t.user_info&&u(e.persona_description)&&a.push({role:"system",content:`${await me("char_inject")}
## {{user}} Info
${u(e.persona_description,8e3)}`});const r=u(e.assistant_text,2e4),s=Array.isArray(e.source_session_ids)?e.source_session_ids.map(p=>u(p,200)).filter(Boolean):[],i=t.lorebook||t.char_appearance!==!1?await Yn(n,u(e.unified_session_id||"",200),u(e.character_id||"",200),s):[],o=ol(i);if(t.lorebook){const p=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:null,f=qr(t.lore_extra),h=cl(e.lorebook||[],r,o,5,1200,p,f),m=[],_=[];for(const x of h){const k=tt(x)||x.always,S=u(x.content||"",k?5e4:1200);if(!S)continue;const A=u(x.comment||"",200),M=A?`### ${A}
${S}`:S;k?m.push(M):_.push(M)}const y=[];m.length&&y.push(`## lb-xnai.lb.extra — OFFICIAL PACK (START)
...
[END OF lb-xnai.lb.extra] The official pack above is finished. Do NOT treat any heading or text below as lb-xnai image-tag ground truth.`),_.length&&y.push(`## Reference Lorebook (trigger-matched only)
...
`)),v("job.lore.extra",{trigger_keys:Array.isArray(p)?p.length:0,injected:m.length,reference:_.length,sections:h.filter(x=>tt(x)||x.always).map(x=>x.key||"").filter(Boolean).join(" | ")}),y.length&&a.push({role:"system",content:`${await me("lore_inject")}
${y.join(`

`)}`})}if(t.char_appearance!==!1){const p=i,f=p.filter(_=>_e(_)),h=p.filter(_=>u(_.name,200)&&!_e(_)),m=Ti(r,p);if(f.length||h.length||m.length){const _=f.length?f.map(S=>{const A=u(S.name,200),M=u(S.appearance||"",120);return M?`${A} ← ${M}`:A}).filter(Boolean).join(`
`):"(없음)",y=h.length?h.map(S=>`- ${S.name} (별칭: ${$t(S).slice(0,8).join(", ")}) → appearance 비어 있음, new_characters에 상세 외형 필수`).join(`
`):"(없음)",x=m.length?m.map(S=>`- ${S.name} [${_e(S)?"외형OK":"외형미완성"}] (별칭: ${$t(S).slice(0,8).join(", ")})`).join(`
`):"(이번 메시지에서 등록 캐릭터 트리거 미검출 — 전부 신규일 수 있음)";let k=await me("appearance_inject");k=k.includes("{registered_block}")?k.replace("{registered_block}",_):`${k}

${_}`,k=k.includes("{incomplete_block}")?k.replace("{incomplete_block}",y):`${k}

## 외형 미완성
${y}`,k=k.includes("{detected_block}")?k.replace("{detected_block}",x):`${k}

${x}`,a.push({role:"system",content:k}),v("job.roster.split",{filled:f.map(S=>S.name),incomplete:h.map(S=>S.name),matched:m.map(S=>S.name),session_id:n})}}a.push({role:"system",content:"Every shot MUST include `y_percent` (number 0–100): reading position top→bottom in the message. CRITICAL spread rule: NEVER cluster all shots in the early band. Space them across the whole 0–100 range in reading order (shot0 < shot1 < shot2 …). Aim ~even gaps. Examples — 2 shots: ~25 and ~75; 3 shots: ~20, ~50, ~80; 4 shots: ~15, ~40, ~65, ~90. Forbidden: all values under 40, duplicates, or gaps under ~15 between neighbors unless only 1 shot."}),t.natural_base!==!1?a.push({role:"system",content:"Natural base mode ON. Every shot MUST include `natural`: a short English natural-language phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action). Include hair color + age band + gender for each visible person, plus the shared action. Example: `red hair adult woman forced hug blue hair boy`. Keep ~6–20 words, English only."}):a.push({role:"system",content:"Natural base mode OFF. Omit the `natural` field (or leave it empty). Do not invent natural-language base phrases."});const c=Le(t);a.push({role:"system",content:`CHARACTER CAP: each shot may include at most ${c} characters (char1..char${c} only). Never list more than ${c} entries in \`characters[]\`. If more people are visible, keep the ${c} most important and fold extras into situation/place tags.`});const l=[];if(Number(t.include_max||0)>0)for(const p of e.recent_messages||[]){const f=u(p?.role,40)||"char",h=u(p?.content||p?.data,12e3);h&&(r&&h===r&&["char","assistant","bot"].includes(f.toLowerCase())||l.push(`[${f}]
${h}`))}r&&l.push(r);const d=l.length?l.join(`

`):r;if(!d)throw new Error("태깅할 메시지 텍스트가 없습니다.");a.push({role:"user",content:d});const g=u(await me("author_note"),8e3);return g&&a.push({role:"user",content:`# Priority: Author's Note
${g}
> These are instructions explicitly given by the user. If in conflict with previous instructions, this section MUST take precedence.`}),a}function dl(e){const t=Le(E().card),n=e,a=[];for(const r of n.scenes||[]){const s=u(r.place);for(const i of r.shots||[]){const o={...i,place:s,characters:Rn(i.characters||[],[],t).slice(0,t)};a.push(o)}}return a}var Gr=5e3,fl=2500,gl=64;function ml(e,t,n){const a=wn(t,n),r=(on.get(a)?.epoch||0)+1;return on.set(a,{epoch:r,jobId:e}),lt.set(e,{key:a,epoch:r,cancelRequested:!1,publishedIds:[]}),{key:a,epoch:r}}function hl(e){const t=lt.get(e);if(!t||t.cancelRequested)return!1;const n=on.get(t.key);return!!(n&&n.jobId===e&&n.epoch===t.epoch)}async function pl(e){const t=lt.get(e),n=t?.publishedIds?[...t.publishedIds]:[];t&&(t.publishedIds=[]);for(const a of n)try{await ga(a)}catch{}return n.length}async function Me(e,t="interrupted"){if(hl(e))return!1;const n=await pl(e);return await we(e,"cancelled",{phase:"cancelled",progress:0,message:`${t}${n?` · discarded ${n}`:""}`,shot_count:0,shot_done:0},null),v("job.cancelled",{job_id:e,message:t,discarded:n,focus:!0}),!0}function Ut(e={}){return{shot_count:e.shot_count??0,shot_index:e.shot_index??0,shot_done:e.shot_done??0,progress:e.progress??0,phase:e.phase||"generating",message:e.message||"",cards_so_far:e.cards_so_far,debug_stage:it()||tn(),debug_error:In()?.message||""}}function _l(e){return!e||typeof e!="object"?e:JSON.parse(JSON.stringify(e,(t,n)=>{if(t==="image_url"&&typeof n=="string"&&n.startsWith("data:"))return"";if(!(t==="tagged"||t==="appearance"||t==="debug_tail"))return n}))}async function we(e,t,n=null,a=null){const r=await R("jobs",e);if(!r)return;const s=r.state,i={...r,state:t},o=_l(n);i.result_json=o!=null?JSON.stringify(o):null,i.error=a,i.updated_at=Date.now()/1e3;const c=t!=="generating"||s!=="generating"||!!a;await F("jobs",i,{persist:c}),(t==="done"||t==="error"||t==="cancelled")&&await Qa(),v("job.set",{message:`${t}${a?" ERR":""}${c?"":" (mem)"}`,job_id:e,state:t,persist:c,err:a?String(a).slice(0,160):"",background:t==="generating",focus:t!=="generating"})}async function Wr(e){if(!(E().card||{}).power&&!e.force)throw new Error("Power가 OFF 상태입니다.");const t=u(e.session_id,200)||`sess_${qe().replace(/-/g,"").slice(0,12)}`,n={...e,session_id:t},a=await ma(n,t);if(a)return v("job.busy",{message:a.error.message||"busy",key:wn(n,t),focus:!0},"warn"),a;const r=qe(),s=Date.now()/1e3;if(ml(r,n,t),n.force)try{await da(t,u(n.content_hash||""),n.message_index)}catch{}return await F("jobs",{id:r,session_id:t,state:"queued",request_json:JSON.stringify(n),result_json:null,error:null,created_at:s,updated_at:s}),wl(r).catch(async i=>{console.error("[Inlay Nexus] job crashed",r,i);try{await we(r,"error",null,String(i?.message||i).slice(0,1500))}catch{}}),{ok:!0,accepted:!0,job_id:r,session_id:t,job_state:"queued"}}async function yl(e){const t=await R("jobs",e);if(!t)return{ok:!1,error:{code:"not_found",message:"job not found"}};const n=t.result_json?JSON.parse(t.result_json):null,a={};if(n&&typeof n=="object")for(const r of["shot_count","shot_index","shot_done","progress","phase","message","cards_so_far","debug_stage","debug_error"])r in n&&(a[r]=n[r]);return n&&await Be(n),{ok:!0,job_id:t.id,session_id:t.session_id,state:t.state,error:t.error,result:n,progress:a,debug:{last_stage:tn(),last_error:In(),events:ja(e,40)},created_at:t.created_at,updated_at:t.updated_at}}function bl(e){for(const t of["y_percent","anchor_percent","read_percent"]){const n=e[t];if(n!=null)try{return Math.max(0,Math.min(100,Number(n)))}catch{return null}}return null}async function wl(e){const t=await R("jobs",e);if(!t)return;const n=JSON.parse(t.request_json??"{}"),a=String(t.session_id??""),r=Ns();en(e);const s=Q("job.run");v("job.start",{job_id:e,session_id:a,message_index:n.message_index,text_len:String(n.assistant_text||"").length});try{if(await Me(e,"superseded before start")||(n.force&&await da(a,u(n.content_hash||""),n.message_index),await Me(e,"superseded before tagging")))return;await we(e,"tagging",{phase:"tagging",progress:0,message:"장면 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.tagging"});const i=await ul(n);if(v("job.tagger.messages",{msgs:i.length}),E().card?.preprocessing){const w=an(await me("preprocess"));if(w){const I=[{role:"system",content:w},i[i.length-1]],D=await vn(E().llm,I);if(await Me(e,"superseded during preprocess"))return;i.splice(i.length-1,0,{role:"system",content:`## Preprocess Summary
${D}`})}}const o=await vn(E().llm,i);if(await Me(e,"superseded after tagging"))return;const c=Si(o);let l=dl(c);if(v("job.tagger.done",{shots:l.length,raw_len:String(o||"").length}),!l.length)throw new Error("태거가 shot을 반환하지 않았습니다.");const d=E().card||{},g=Math.max(1,Number(d.image_min??1)),p=Math.max(g,Number(d.image_max??3));l=l.slice(0,p);const f=l.flatMap(w=>w.characters||[]),h=u(n.unified_session_id||"",200),m=u(n.character_id||"",200),_=Array.isArray(n.source_session_ids)?n.source_session_ids.map(w=>u(w,200)).filter(Boolean):[],y=await Lo({sessionId:a,tagged:c,shotChars:f,unifiedSessionId:h,characterId:m,sourceSessionIds:_});v("job.roster",{roster:y.length});const x=Le(d);for(const w of l)w.characters=Rn(w.characters||[],y,x);if(await Me(e,"superseded before generate"))return;await we(e,"generating",Ut({shot_count:l.length,shot_index:0,shot_done:0,progress:0,phase:"generating",message:`이미지 1/${l.length} 생성 준비`}));const k=[],S=!!d.llm_anchor_percent;for(let w=0;w<l.length;w+=1){if(await Me(e,`superseded before shot ${w+1}`))return;const I=l[w],{main:D,neg:$,captions:T,meta:j}=await bn({shot:I,roster:y}),z=qe(),ne=Date.now()/1e3,G=u(n.content_hash||"");let le=bl(I);le==null&&S&&(le=Math.round(w/Math.max(1,l.length)*1e4)/100),v("job.shot.prepare",{shot:w,card_id:z,prompt_len:String(D||"").length,captions:(T||[]).length}),await we(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w,progress:Math.round(w/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`NovelAI 요청 중 ${w+1}/${l.length}… [${it()}]`}));let H=0;const Ht=setInterval(()=>{H+=Gr/1e3;const gs=Uo();Jo()&&dr()>=gl&&gs&&Date.now()-gs>=fl&&Ko("heartbeat-idle");const ms=dr()||zo();we(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w,progress:Math.round(w/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`NovelAI 대기 ${w+1}/${l.length} (${H}s) · ${it()}${ms?` ${Math.round(ms/1024)}KB`:""}`})).catch(()=>{})},Gr);let W,he;try{({bytes:W,seed:he}=await Cr({main:D,neg:$,captions:T}))}finally{clearInterval(Ht)}if(v("job.shot.nai_done",{shot:w,bytes:W?.byteLength||0,seed:he}),await Me(e,`superseded after shot ${w+1} nai`))return;await we(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w,progress:Math.round((w+.5)/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`이미지 저장 중 ${w+1}/${l.length}… [${it()}]`}));const B=Pc({imageId:z,sessionId:a,request:n,shotIndex:w,paragraph:I.paragraph,yPercent:le,contentHash:G});await Kn(z,W,B);const at=oa(j,B,W?.byteLength||0);await F("cards",{id:z,job_id:e,session_id:a,shot_index:w,paragraph:Number(I.paragraph||0),main_prompt:D,negative_prompt:$,characters_json:JSON.stringify(j.characters||[]),seed:he,meta_json:JSON.stringify(at),created_at:ne});const fs=lt.get(e);if(fs&&fs.publishedIds.push(z),await Me(e,`superseded after shot ${w+1} save`))return;k.push({id:z,shot_index:w,paragraph:B.paragraph,y_percent:B.y_percent,message_index:B.message_index??-1,message_role:B.message_role||"",content_hash:B.content_hash||"",character_id:B.character_id||"",chat_id:B.chat_id||"",character_name:B.character_name||"",chat_name:B.chat_name||"",char_index:B.char_index??-1,chat_index:B.chat_index??-1,assistant_preview:u(n.assistant_text||"",Ss),main_prompt:D,negative_prompt:$,characters:j.characters||[],image_url:ye(z),seed:he,storage:"indexeddb",png_bytes:W?.byteLength||0}),v("job.shot.saved",{shot:w,card_id:z,has_url:!!ye(z)}),await we(e,"generating",Ut({shot_count:l.length,shot_index:w,shot_done:w+1,progress:Math.round((w+1)/Math.max(1,l.length)*1e3)/10,phase:"generating",message:`이미지 ${w+1}/${l.length} 완료`,cards_so_far:k.length}))}if(await Me(e,"superseded before done"))return;const A={cards:k,message_index:n.message_index!=null?Number(n.message_index):-1,shot_count:l.length,shot_done:l.length,progress:100,phase:"done",message:`이미지 ${l.length}/${l.length} 완료`};await Be(A),await we(e,"done",A);const M=lt.get(e);M&&(M.publishedIds=[]),s.end({message:"done",cards:k.length})}catch(i){s.fail(i);const o=i,c=`${o?.message||i}
${o?.stack||""}`.slice(-1500);await we(e,"error",{phase:"error",message:String(o?.message||i).slice(0,240),debug_stage:tn(),debug_tail:ja(e,12)},c)}finally{en(r)}}function nt(e,t){try{return JSON.parse(e)}catch{return t}}async function vl(e,t={}){const n=u(e,80),a=await R("cards",n);if(!a)return{ok:!1,error:{code:"not_found",message:"card not found"}};const r=nt(a.characters_json||"[]",[]),s=Array.isArray(r)?r:[];let i=a.main_prompt;"main_prompt"in t&&(i=u(t.main_prompt,8e3));let o=a.negative_prompt;"negative_prompt"in t&&(o=u(t.negative_prompt,8e3));let c=s;if("characters"in t){const g=t.characters||[];if(!Array.isArray(g))return{ok:!1,error:{code:"bad_request",message:"characters must be a list"}};c=[];const p=Le(E().card||{});for(let f=0;f<g.slice(0,p).length;f++){const h=g[f];if(typeof h!="object")continue;const m=h,_=f<s.length&&typeof s[f]=="object"?s[f]:{},y=u(m.name!=null?m.name:_.name,200),x=u(m.prompt!=null?m.prompt:_.prompt,4e3);if(!y&&!x)continue;const k={..._,name:y||`char${f+1}`,prompt:x||"girl"};"uc"in m&&(k.uc=u(m.uc,2e3));for(const S of["center_x","center_y"])if(S in m)try{k[S]=Number(m[S])}catch{}c.push(k)}}a.main_prompt=i,a.negative_prompt=o,a.characters_json=JSON.stringify(c);try{let g=nt(a.meta_json||"{}",{});(!g||typeof g!="object"||Array.isArray(g))&&(g={});const p=g;p.setup=i,p.characters=c,a.meta_json=JSON.stringify(p)}catch{}await F("cards",a);const l=await Ue(n,{}),d={id:n,main_prompt:i,negative_prompt:o,characters:c,paragraph:a.paragraph,shot_index:a.shot_index,y_percent:l.y_percent,message_index:l.message_index,content_hash:l.content_hash,image_url:ye(n)};return await Be(d),{ok:!0,card:d}}async function Vr(e,t="nai",n=null,a={}){const r=await R("cards",e);if(!r)return{ok:!1,error:{code:"not_found",message:"card not found"}};const s=r.session_id,i=nt(r.meta_json||"{}",{}),o=i.location||{};if(!a.skipBusyCheck)try{const $=await Ue(e,i),T=await ma({session_id:s,content_hash:u($.content_hash||i.content_hash||"",128),message_index:C($.message_index,-1)},s);if(T)return T}catch{}const c=u(o.character_id||i.character_id||"",200);let l=u(i.unified_session_id||o.unified_session_id||"",200);!l&&c&&(l=Bs(c));let d=[];try{const $=await R("jobs",r.job_id);if($?.request_json){const T=JSON.parse($.request_json);Array.isArray(T.source_session_ids)&&(d=T.source_session_ids.map(j=>u(j,200)).filter(Boolean))}}catch{}const g=await Yn(s,l,c,d);if(t==="full"){const $=await R("jobs",r.job_id);if(!$)return{ok:!1,error:{code:"no_job",message:"original job missing"}};const T=JSON.parse($.request_json);return T.force=!0,Wr(T)}let p,f,h,m,_={};const y=n;if(y&&("main_prompt"in y||"negative_prompt"in y||"characters"in y))p="main_prompt"in y?u(y.main_prompt||""):u(r.main_prompt),f="negative_prompt"in y?u(y.negative_prompt||""):u(r.negative_prompt),m="characters"in y?y.characters:null,m==null&&(m=nt(r.characters_json||"[]",[])),h=(m||[]).slice(0,Le(E().card||{})).map($=>({prompt:Ka($.prompt||"girl")||"girl",uc:u($.uc),center_x:Number($.center_x??.5),center_y:Number($.center_y??.5)}));else if(u(r.main_prompt||"")){const $=nt(r.characters_json||"[]",[]),T=Array.isArray($)?$:[],j=Yr(i),z=T.map(he=>{if(!he||typeof he!="object")return null;const B=he;if(B.raw&&typeof B.raw=="object"){const at=B.raw;return{...at,name:u(at.name||B.name,200)}}return{name:u(B.name,200),action:B.action,expression:B.expression,sex:B.sex,label:B.label,age:B.age,original:B.original||B.original_tag}}).filter(Boolean),ne=E().card||{},G=Ze(E().nai?.model||"nai-diffusion-4-5-full"),le=Object.values(rn).filter(Boolean);rn[G]&&le.unshift(rn[G]);const H=Wi({setup:i.setup,main:r.main_prompt,person:i.person,stylePositives:Vi(ne),qualitySuffixes:le}),Ht={characters:j.length?j:z,paragraph:r.paragraph,camera:H.rebuildMain&&H.lockedSetup?"":u(i.camera||""),situation:H.rebuildMain&&H.lockedSetup?"":u(i.situation||i.scene||""),place:H.rebuildMain&&H.lockedSetup?"":u(i.place||""),action:H.rebuildMain&&H.lockedSetup?"":u(i.action||"")},W=await bn({shot:Ht,roster:g,lockedSetup:H.rebuildMain?H.lockedSetup:void 0});H.rebuildMain?(p=W.main,f=W.neg,h=W.captions,m=W.meta.characters,_={setup:W.meta.setup,person:W.meta.person,characters:m}):(p=u(r.main_prompt),f=u(r.negative_prompt)||W.neg,h=W.captions,m=W.meta.characters,_={setup:p,person:W.meta.person,characters:m})}else{const $=nt(r.characters_json||"[]",[]),T=Yr(i),j=($||[]).map(le=>{if(!le||typeof le!="object")return null;const H=le;return H.raw||{name:H.name,action:H.action,expression:H.expression}}).filter(Boolean),z=u(i.setup||""),ne={characters:T.length?T:j,paragraph:r.paragraph,camera:z?"":u(i.camera||""),situation:z?"":u(i.situation||i.scene||""),place:z?"":u(i.place||""),action:z?"":u(i.action||"")},G=await bn({shot:ne,roster:g,lockedSetup:z});p=G.main,f=G.neg,h=G.captions,m=G.meta.characters,_={setup:G.meta.setup,person:G.meta.person,characters:m}}if(!h.length&&!(y&&"characters"in y)){const $={characters:(i.characters||[]).map(j=>j.raw||j),camera:i.setup},T=await bn({shot:$,roster:g});p=T.main,f=T.neg,h=T.captions,m=T.meta.characters,_={setup:T.meta.setup,person:T.meta.person,characters:m}}const{bytes:x,seed:k}=await Cr({main:p,neg:f,captions:h}),S=qe(),A=Date.now()/1e3;let M=await et(r.id);Object.keys(M).length||(M=await Ue(r.id,i));const w={version:1,image_id:S,session_id:s,unified_session_id:l,character_id:u(M.character_id||"",200),character_name:u(M.character_name||i.character_name||"",200),chat_id:u(M.chat_id||"",200),chat_name:u(M.chat_name||i.chat_name||"",200),char_index:C(M.char_index,-1),chat_index:C(M.chat_index,-1),message_index:C(M.message_index,-1),shot_index:C(M.shot_index,C(r.shot_index,0)),paragraph:C(M.paragraph,C(r.paragraph,0)),y_percent:nn(M.y_percent),content_hash:u(M.content_hash||"",128),assistant_preview:u(M.assistant_preview||i.assistant_preview||"",Ge)};await Kn(S,x,w);const I=oa({...i,..._},w,x.byteLength);for(const $ of["y_percent","anchor_percent","read_percent"])delete I[$];I.y_percent=w.y_percent,await F("cards",{id:S,job_id:r.job_id,session_id:s,shot_index:r.shot_index,paragraph:r.paragraph,main_prompt:p,negative_prompt:f,characters_json:JSON.stringify(m),seed:k,meta_json:JSON.stringify(I),created_at:A});try{await ga(e)}catch{}const D={id:S,image_url:ye(S),main_prompt:p,negative_prompt:f,characters:m,seed:k,paragraph:w.paragraph,y_percent:w.y_percent,message_index:w.message_index,shot_index:w.shot_index,content_hash:w.content_hash,character_id:w.character_id,chat_id:w.chat_id,character_name:w.character_name,chat_name:w.chat_name,assistant_preview:w.assistant_preview,storage:"indexeddb",png_bytes:x.byteLength};return await Be(D),{ok:!0,replaced:e,card:D}}async function xl({session_id:e="",content_hash:t="",message_index:n=-1}={}){const a=u(e,200),r=u(t,128),s=C(n,-1);if(!a&&!r&&s<0)return{ok:!1,error:{code:"bad_request",message:"session_id or content_hash required"}};const i=await de("cards"),o=[];for(const m of i){if(a&&m.session_id!==a)continue;const _=nt(m.meta_json||"{}",{}),y=await Ue(m.id,_),x=u(y.content_hash||_.content_hash||"",128),k=C(y.message_index,-1);if(r){if(x!==r)continue}else if(s>=0){if(k!==s)continue}else continue;const S=y.y_percent??_.y_percent??_.anchor_percent??_.read_percent,A=Number(S);o.push({row:m,y:Number.isFinite(A)?A:999,shot:C(m.shot_index,0),paragraph:C(m.paragraph??y.paragraph,0)})}if(o.sort((m,_)=>m.y-_.y||m.shot-_.shot||m.paragraph-_.paragraph),!o.length)return{ok:!1,error:{code:"not_found",message:"no cards for message"}};const c=a||u(o[0]?.row?.session_id||"",200),l={session_id:c,content_hash:r,message_index:s},d=await ma(l,c);if(d)return d;const g=wn(l,c);Tn.add(g);const p=[],f=[],h=[];try{for(const m of o){const _=m.row;try{const y=await Vr(_.id,"nai",null,{skipBusyCheck:!0});if(y?.busy){h.push({id:_.id,error:y.error?.message||"busy"});break}y?.ok&&y.card?(p.push(y.card),y.replaced&&f.push(y.replaced)):h.push({id:_.id,error:u(y?.error?.message||"reroll failed",400)})}catch(y){h.push({id:_.id,error:u(y?.message||y,400)})}}return{ok:p.length>0,count:p.length,replaced:f,cards:p,failed:h}}finally{Tn.delete(g)}}function Yr(e){return Array.isArray(e.characters)?e.characters.map(t=>t&&typeof t=="object"?t.raw||t:null).filter(Boolean):[]}var kl=qt({HASH_REBIND_THRESHOLD:()=>Il,PREFIX_MATCH_MIN_CHARS:()=>24,PREFIX_MATCH_THRESHOLD:()=>Nl,SIMILARITY_COMPARE_MAX:()=>800,VIEWER_THUMB_LAYOUT:()=>V,activeSegmentIndex:()=>pu,bigramCounts:()=>_a,clampPinPercent:()=>Ae,clampReadingPercent:()=>hu,clampThumbScrollOffset:()=>iu,composeDualProgressBarsHtml:()=>gu,composeStickyThumbHtml:()=>Xl,createDebouncedSaveQueue:()=>Wl,createScrollSettleTracker:()=>ql,createSessionChangeGuard:()=>Gl,describeDomApiCompare:()=>Ol,diceBigramRatio:()=>Qr,evenAnchorPercent:()=>wa,findHashRebindCandidates:()=>$l,galleryFocusMessage:()=>Cl,galleryForMessage:()=>jl,galleryIndexFromChildIndex:()=>au,gallerySelectedCount:()=>ba,galleryStripContentWidth:()=>su,galleryStripSplitAt:()=>Sn,hasGenerationInfo:()=>rs,isCharMessageRole:()=>Ll,isMessageSelectionGesture:()=>Jl,isNearbyDomIndex:()=>lu,linkCardsForMessage:()=>ya,longestCommonPrefixLength:()=>Xr,mergeViewerPaintJob:()=>du,messageCompactKey:()=>St,messageContextTriplet:()=>Pl,messagesTextOverlapScore:()=>ss,nearbyDomIndexWindow:()=>uu,nearbyMessageImageIds:()=>cu,normalizeMatchText:()=>xn,normalizeMessageRole:()=>pa,parseAutotagLookJson:()=>ls,pickMessageIndexNearPoint:()=>Ul,pinPercentToPx:()=>Fl,pinPercentToPxFromBottom:()=>Dl,pinPxToPercent:()=>is,prefixMatchRatio:()=>es,rawMessageRole:()=>kn,readingPercentInMessage:()=>us,rebindGalleryMessageIndexes:()=>Bl,resolveCardAnchorPercent:()=>mu,resolveChatMessageMatch:()=>Rl,resolveClickSelectionAction:()=>Kl,resolveIndexProgress:()=>fu,resolveStoredPinPercent:()=>zl,roleFromGenerationInfo:()=>Tl,scaleInlineThumbnail:()=>Al,shouldKeepStickyThumbHidden:()=>Zl,shouldRefreshGallery:()=>Vl,shouldRewriteStickyThumb:()=>Yl,shouldSelectMessageByTextDrag:()=>Hl,stickyCornerEdgeBox:()=>os,stickyCornerImageBox:()=>eu,stickyPinEdgeBox:()=>nu,stickyPinOverImage:()=>tu,stickyThumbNeedsHtmlPaint:()=>Ql,thumbIndexAtStripX:()=>ru,visibleGalleryImageIds:()=>ou}),Sl=528,Ml=720;function b(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Zr(e,t){const n={...e};for(const[a,r]of Object.entries(t||{})){const s=n[a];n[a]=r&&typeof r=="object"&&!Array.isArray(r)?Zr(s&&typeof s=="object"?s:{},r):r}return n}function Al(e){const t=Math.max(1,b(e,100));return{width:Math.max(1,Math.round(Sl*t/100)),height:Math.max(1,Math.round(Ml*t/100)),percent:t}}function xn(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}var Nl=.6,Il=.6,Wu=24,Vu=800;function pa(e){const t=String(e||"").toLowerCase().trim();return t?t==="char"||t==="assistant"||t==="bot"?"char":t==="user"||t==="human"?"user":t:""}function Xr(e,t){const n=String(e||""),a=String(t||""),r=Math.min(n.length,a.length);let s=0;for(;s<r&&n.charCodeAt(s)===a.charCodeAt(s);)s+=1;return s}function _a(e){const t=String(e||""),n=new Map;if(t.length<2)return n;for(let a=0;a<t.length-1;a+=1){const r=t.charCodeAt(a)+","+t.charCodeAt(a+1);n.set(r,(n.get(r)||0)+1)}return n}function Qr(e,t,n=null){const a=String(e||""),r=String(t||"");if(!a||!r)return 0;if(a===r)return 1;if(a.length<2||r.length<2)return 0;const s=n||_a(a),i=_a(r);let o=0;for(const[d,g]of i){const p=s.get(d)||0;p&&(o+=Math.min(p,g))}const c=a.length-1,l=r.length-1;return 2*o/(c+l)}function es(e,t){const n=xn(e),a=xn(t);if(!n||!a)return 0;const r=Math.max(n.length,a.length);if(r<24)return 0;if(n===a)return 1;const s=Xr(n,a)/r;return s>=.6?s:Qr(n.length>800?n.slice(0,800):n,a.length>800?a.slice(0,800):a)}function ya(e,t){if(!t)return[];const n=Array.isArray(e)?e:[],a=String(t.hash||"");return a?as(n.filter(r=>r?.content_hash&&r.content_hash===a)):[]}function $l(e,t={}){const n=Array.isArray(e)?e:[],a=String(t.newHash||t.hash||""),r=String(t.text||""),s=String(t.characterId||""),i=String(t.chatId||""),o=String(t.sessionId||""),c=Number(t.messageIndex),l=pa(t.role||t.messageRole||"");if(!a||!r||!s||!l||!Number.isFinite(c)||c<0)return[];if(n.some(g=>g?.content_hash&&g.content_hash===a))return[];if(xn(r).length<24)return[];const d=[];for(const g of n){const p=String(g?.content_hash||"");if(!p||p===a||String(g?.character_id||"")!==s)continue;const f=String(g?.chat_id||""),h=String(g?.session_id||"");if(i){if(f!==i)continue}else if(o){if(h&&h!==o)continue}else continue;if(Number(g?.message_index)!==c)continue;const m=pa(g?.message_role||g?.role||"");if(!m||m!==l)continue;const _=String(g?.assistant_preview||"");if(!_)continue;const y=es(r,_);y<.6||d.push({card:g,score:y})}return d.sort((g,p)=>p.score-g.score||b(p.card?.created_at)-b(g.card?.created_at)),as(d.map(g=>g.card))}function ts(e){const t=e?.y_percent??e?.anchor_percent??e?.read_percent,n=Number(t);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function El(e,t){return ts(e)-ts(t)||b(e?.paragraph)-b(t?.paragraph)||b(e?.shot_index)-b(t?.shot_index)||b(t?.created_at)-b(e?.created_at)}function ns(e,t){return b(t?.created_at)-b(e?.created_at)||b(t?.message_index)-b(e?.message_index)||b(t?.paragraph)-b(e?.paragraph)||b(t?.shot_index)-b(e?.shot_index)}function as(e){const t=new Map;for(const n of e||[]){const a=`${n?.paragraph??"?"}|${n?.shot_index??n?.id}`,r=t.get(a);(!r||b(n?.created_at)>=b(r?.created_at))&&t.set(a,n)}return[...t.values()]}function jl(e,t,n=8){const a=new Map;for(const d of e||[]){const g=String(d?.id||"");!g||a.has(g)||a.set(g,d)}const r=[...a.values()],s=Math.max(0,Math.min(64,b(n,8)||8));if(!t)return r.sort(ns).slice(0,Math.max(1,s||8));const i=ya(r,t).sort(El),o=new Set(i.map(d=>String(d.id))),c=String(t.sessionId||""),l=r.filter(d=>!o.has(String(d.id))).filter(d=>!c||!d?.session_id||d.session_id===c).sort(ns).slice(0,s);return[...i,...l]}function ba(e,t){return t?ya(e,t).length:0}function Cl(e,t,n){return e&&ba(n,e)>0?e:t&&ba(n,t)>0?t:e||t||null}function kn(e){const t=String(e?.role||e?.type||e?.speaker||e?.sender||e?.from||e?.name||"").trim().toLowerCase();return e?.isUser===!0||e?.fromUser===!0||/^(user|human|player|you|me)$/.test(t)||t.includes("user")?"user":e?.isAssistant===!0||e?.isBot===!0||e?.isChar===!0||/^(assistant|bot|char|character|model|ai)$/.test(t)||t.includes("assistant")||t.includes("bot")||t.includes("char")?"char":t==="system"||t==="developer"?"system":""}function rs(e){const t=e?.generationInfo??e?.generation_info??e?.messageGenerationInfo;return t==null?!1:typeof t=="string"?t.trim().length>0:typeof t=="object"?Object.keys(t).length>0:!0}function Tl(e){return rs(e)?"char":"user"}function Ll(e){if(e&&typeof e=="object")return kn(e)==="char";const t=String(e||"").trim().toLowerCase();return t==="char"||t==="assistant"||t==="bot"}function St(e,t=48){const n=Math.max(1,b(t,48));return String(e||"").replace(/\s+/g,"").slice(0,n)}function Pl(e,t,n=48){const a=Array.isArray(e)?e:[],r=Math.floor(b(t,-1)),s=r>=0&&r<a.length?a[r]:null,i=r>0?a[r-1]:null,o=r>=0&&r<a.length-1?a[r+1]:null;return[St(i?.text,n),St(s?.text,n),St(o?.text,n),kn(s)||String(s?.role||"").trim().toLowerCase()].join("|")}function ss(e,t){const n=String(e||"").replace(/\s+/g,""),a=String(t||"").replace(/\s+/g,"");if(!n||!a)return 0;if(n.includes(a))return a.length;if(a.includes(n))return n.length;let r=0;const s=(o,c,l=8,d=512)=>{let g=l,p=Math.min(o.length,d),f=0;for(;g<=p;){const h=g+p>>1;c.includes(o.slice(0,h))?(f=h,g=h+1):p=h-1}return f};r=Math.max(r,s(a,n),s(n,a));const i=Math.min(a.length,2400);for(let o=0;o+8<=i;o+=32){const c=Math.min(64,i-o);for(let l=c;l>=8;l-=8)if(n.includes(a.slice(o,o+l))){r=Math.max(r,l);break}}return r}function Ol(e,t){const n=String(e||""),a=String(t||""),r=St(n),s=St(a),i=ss(n,a),o=i>=8,c=r.length>0&&r.length<8&&r===s,l=s.slice(0,48),d=r.slice(0,48);return{domChars:n.length,apiChars:a.length,domCompactChars:r.length,apiCompactChars:s.length,shareScore:i,overlap:o,shortExact:c,apiInDom:!!(l&&l.length>=8&&r.includes(l)),domInApi:!!(d&&d.length>=8&&s.includes(d)),apiKey:l,domKey:d}}function Bl(e,t,n){const a=Array.isArray(t)?t:[],r=typeof n=="function"?n:null,s=new Map;if(r)for(let o=0;o<a.length;o+=1){const c=String(a[o]?.text??a[o]?.data??a[o]?.content??""),l=String(r(c)||"");if(!l)continue;const d=Number.isFinite(Number(a[o]?.index))?Number(a[o].index):o,g=s.get(l);g?g.push(d):s.set(l,[d])}let i=0;return{cards:(Array.isArray(e)?e:[]).map(o=>{const c=String(o?.content_hash||""),l=c?s.get(c):void 0;return!c||!l?o:l.length!==1?Number(o?.message_index)!==-1?(i+=1,{...o,message_index:-1}):o:Number(o?.message_index)!==l[0]?(i+=1,{...o,message_index:l[0]}):o}),changed:i}}function Rl(e,t,n,a,r){const s=Array.isArray(t)?t:[],i=Math.floor(b(n,-1)),o=(d,g,p,f=-1)=>({chatIndex:Number.isFinite(Number(d?.index))?Number(d?.index):f>=0?f:i,text:String(d?.text||e||""),role:kn(d)||String(d?.role||"").trim().toLowerCase(),matchMethod:g,score:p});if(!s.length)return{chatIndex:Math.max(0,i),text:String(e||""),role:"",matchMethod:"fallback",score:0};const c=s.length-1-i;if(c>=0&&c<s.length)return o(s[c],"reverse",100,c);const l=Math.max(0,Math.min(s.length-1,c));return o(s[l],"reverse",50,l)}function Ae(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(100,Math.floor(n))):Math.max(0,Math.min(100,Math.floor(b(t,0))))}function Fl(e,t,n=22,a=4){const r=Math.max(1,b(t,1)),s=Math.max(1,b(n,1)),i=Math.max(0,b(a,0)),o=Math.floor(r*Ae(e,0)/100);return Math.max(i,Math.min(r-s-i,o))}function Dl(e,t,n=22,a=8){const r=Math.max(1,b(t,1)),s=Math.max(1,b(n,1)),i=Math.max(0,b(a,0)),o=r-Math.floor(r*Ae(e,0)/100)-s;return Math.max(i,Math.min(r-s-i,o))}function is(e,t){const n=Math.max(1,b(t,1));return Ae(b(e,0)/n*100,0)}function zl(e,t,n,a=null){const r=a&&typeof a=="object"?a:{x:38,y:80},s=t==="y"||t==="Y",i=s?b(r.y,80):b(r.x,38),o=s?"overlay_y_pct":"overlay_x_pct",c=s?"overlay_y_offset":"overlay_x_offset",l=String(e?.overlay_pin_origin||""),d=l==="top"||l==="tl"||l==="top-left",g=e?.[o],p=g!=null&&Number.isFinite(Number(g)),f=Number(e?.[c]),h=Number.isFinite(f),m=_=>Ae(100-Number(_),i);return p?s&&d?m(g):Ae(g,i):h?s?Ae((b(n,1)-f)/Math.max(1,b(n,1))*100,i):is(f,n):Ae(i,i)}function Ul(e,t,n=null,a=800){const r=Array.isArray(e)?e:[];if(!r.length)return-1;const s=Math.max(1,b(a,800)),i=Number.isFinite(Number(t))?Number(t):s*.5,o=Number.isFinite(Number(n))?Number(n):null;let c=-1,l=1/0,d=-1,g=1/0;for(let p=0;p<r.length;p+=1){const f=r[p];if(!f)continue;const h=b(f.top,0),m=b(f.bottom,h);if(m<=0||h>=s)continue;const _=(h+m)*.5,y=Number.isFinite(Number(f.left))&&Number.isFinite(Number(f.right))?(Number(f.left)+Number(f.right))*.5:null,x=y!=null&&o!=null?Math.hypot(y-o,_-i):Math.abs(_-i);x<g&&(g=x,d=p);const k=i>=h&&i<=m,S=o==null||!Number.isFinite(Number(f.left))||!Number.isFinite(Number(f.right))||o>=Number(f.left)&&o<=Number(f.right);if(k&&S){const A=Math.max(1,m-h);A<l&&(l=A,c=p)}}return c>=0?c:d}function Jl({gesture:e="single",detail:t=1,movement:n=0,textSelecting:a=!1,excludedTarget:r=!1}={}){const s=e==="double"?2:1;return!r&&!a&&b(n,1/0)<=8&&b(t)===s}function Kl({gesture:e="single",detail:t=1,pendingDomIndex:n=null,targetDomIndex:a=null}={}){const r=b(t,1);return e==="double"?r===1?{action:"provisional",pendingDomIndex:a}:r===2?{action:"confirm",clearPending:!0,matchedPending:n!=null&&Number(n)===Number(a)}:{action:"ignore"}:r===1?{action:"confirm",clearPending:!0}:{action:"ignore"}}function Hl({enabled:e=!0,movement:t=0,hasSelection:n=!1,excludedTarget:a=!1}={}){return!!e&&!a&&!!n&&b(t,0)>8}function ql({delayMs:e=160,onSettle:t}={}){let n=null;const a=Math.max(0,b(e,160)),r=()=>{n=null,typeof t=="function"&&t()};return{bump(){n&&clearTimeout(n),n=setTimeout(r,a)},settleNow(){n&&clearTimeout(n),n=null,r()},cancel(){n&&clearTimeout(n),n=null},get pending(){return n!=null}}}function Gl(e=""){let t=String(e||""),n="",a=0;return{observe(r){const s=String(r||"");return!s||s===t?(n="",a=0,!1):s!==n?(n=s,a=1,!1):(a+=1,a<2?!1:(t=n,n="",a=0,!0))},current(){return t},reset(r=""){t=String(r||""),n="",a=0}}}function Wl(e,t=300){let n={},a=null,r=null;const s=async()=>r||(r=(async()=>{for(;Object.keys(n).length;){const i=n;n={},await e(i)}})().finally(()=>{r=null}),r);return{enqueue(i){n=Zr(n,i),a&&clearTimeout(a),a=setTimeout(()=>{a=null,s().catch(()=>{})},Math.max(0,b(t,300)))},async flush(){a&&(clearTimeout(a),a=null);do await s();while(Object.keys(n).length||r)},hasPending(){return!!a||!!r||Object.keys(n).length>0}}}function Vl(e,t){const n=Array.isArray(e)?e.map(String):[],a=Array.isArray(t)?t.map(String):[];if(n.length!==a.length)return!0;for(let r=0;r<n.length;r+=1)if(n[r]!==a[r])return!0;return!1}function Yl(e,t){return String(e||"")!==String(t||"")}function Zl(e,t,n){if(!e)return!1;const a=String(t||""),r=String(n||"");return!!a&&!!r&&a===r}function Xl(e,t=""){const n=typeof e=="string"?e:"";return n?`<img src="${n}" style="width:100%;height:100%;object-fit:cover;display:block" />`:'<div style="width:100%;height:100%;background:#0b0f18"></div>'}function Ql(e,t,n,a){const r=typeof t=="string"?t:"";return r?String(e||"")!==r||String(n||"")!==String(a||""):!1}function eu(e,t,n,a=16){const r=Math.max(1,Math.round(b(t?.w,1))),s=Math.max(1,Math.round(b(t?.h,1))),i=Math.max(r,Math.round(b(n?.width,r))),o=Math.max(s,Math.round(b(n?.height,s))),c=Math.max(0,Math.round(b(a,16))),l=String(e||"bottom-right");return{left:l.includes("left")?c:Math.max(c,i-r-c),top:l.includes("top")?c:Math.max(c,o-s-c),w:r,h:s}}function os(e,t,n=16){const a=Math.max(1,Math.round(b(t?.w,1))),r=Math.max(1,Math.round(b(t?.h,1))),s=Math.max(0,Math.round(b(n,16))),i=String(e||"bottom-right");return{w:a,h:r,top:i.includes("top")?s:null,bottom:i.includes("bottom")?s:null,left:i.includes("left")?s:null,right:i.includes("right")?s:null}}function tu(e,t=28,n=6){const a=Math.round(b(e?.left,0)),r=Math.round(b(e?.top,0)),s=Math.max(1,Math.round(b(e?.w,1))),i=Math.max(1,Math.round(b(t,28))),o=Math.max(0,Math.round(b(n,6)));return{left:Math.round(a+(s-i)/2),top:r-o}}function nu(e,t,n=28,a=6,r=16){const s=os(e,t,r),i=Math.max(1,Math.round(b(n,28))),o=Math.max(0,Math.round(b(a,6))),c=s.left!=null?s.left:s.right,l=Math.round(b(c,0)+(s.w-i)/2);return{size:i,top:s.top!=null?Math.round(s.top-o):null,bottom:s.bottom!=null?Math.round(s.bottom+s.h+o):null,left:s.left!=null?l:null,right:s.right!=null?l:null}}var V=Object.freeze({width:64,height:88,gap:8,splitWidth:16,splitExtraMargin:4});function Sn(e,t){const n=Math.max(0,Math.floor(b(t,0))),a=Math.max(0,Math.min(Math.floor(b(e,0)),n));return a>0&&a<n?a:0}function au(e,t,n){const a=Math.max(0,Math.floor(b(n,0))),r=Math.floor(b(e,-1));if(r<0||a<=0)return-1;const s=Sn(t,a);if(s<=0)return r<a?r:-1;if(r===s)return-1;const i=r>s?r-1:r;return i>=0&&i<a?i:-1}function ru(e,{count:t=0,selectedCount:n=0,thumbWidth:a=V.width,gap:r=V.gap,splitWidth:s=V.splitWidth,splitExtraMargin:i=V.splitExtraMargin}={}){const o=Math.max(0,Math.floor(b(t,0)));if(o<=0)return-1;const c=b(e,NaN);if(!Number.isFinite(c)||c<0)return-1;const l=Math.max(1,b(a,V.width)),d=Math.max(0,b(r,V.gap)),g=Math.max(0,b(s,V.splitWidth)),p=Math.max(0,b(i,V.splitExtraMargin)),f=Sn(n,o),h=[];for(let _=0;_<o;_+=1)f>0&&_===f&&h.push({type:"split"}),h.push({type:"thumb",galIdx:_,marginLeft:f>0&&_===f?p:0});let m=0;for(let _=0;_<h.length;_+=1){_>0&&(m+=d);const y=h[_];if(y.type==="split"){if(c>=m&&c<m+g)return-1;m+=g;continue}if(m+=y.marginLeft,c>=m&&c<m+l)return y.galIdx;m+=l}return-1}function su({count:e=0,selectedCount:t=0,thumbWidth:n=V.width,gap:a=V.gap,splitWidth:r=V.splitWidth,splitExtraMargin:s=V.splitExtraMargin}={}){const i=Math.max(0,Math.floor(b(e,0)));if(i<=0)return 0;const o=Math.max(1,b(n,V.width)),c=Math.max(0,b(a,V.gap)),l=Math.max(0,b(r,V.splitWidth)),d=Math.max(0,b(s,V.splitExtraMargin)),g=Sn(t,i),p=i+(g>0?1:0);let f=i*o+Math.max(0,p-1)*c;return g>0&&(f+=l+d),f}function iu(e,t,n){const a=Math.max(0,b(t,0)-Math.max(0,b(n,0))),r=b(e,0);return Math.max(0,Math.min(a,r))}function ou(e,t=0,n=1,a=8,r=0){const s=Array.isArray(e)?e:[];if(!s.length)return[];const i=Math.max(0,Math.min(b(t,0),s.length-1)),o=Math.max(1,Math.min(s.length,b(a,8)||8)),c=Math.min(o,1+2*Math.max(0,b(n,1))),l=Math.max(c,o);let d=Math.max(0,i-Math.floor((l-1)/2));const g=Math.min(s.length-1,d+l-1);d=Math.max(0,g-l+1);const p=[],f=new Set,h=_=>{const y=String(s[_]?.id||"");!y||f.has(y)||(f.add(y),p.push(y))},m=Math.max(0,Math.min(s.length,b(r,0)));for(let _=0;_<m;_+=1)h(_);for(let _=d;_<=g&&(h(_),!(p.length>=o));_+=1);return p}function cu(e,t,n=2,a=[]){const r=Array.isArray(e)?e:[],s=Math.max(0,Math.min(8,b(n,2))),i=b(t?.messageIndex??t?.message_index,NaN),o=String(t?.sessionId||t?.session_id||""),c=String(t?.chatId||t?.chat_id||""),l=String(t?.hash||""),d=new Set,g=[],p=f=>{const h=String(f||"");!h||d.has(h)||(d.add(h),g.push(h))};for(const f of a||[])p(f);for(const f of r){if(!f?.id||o&&f.session_id&&String(f.session_id)!==o||c&&f.chat_id&&String(f.chat_id)!==c)continue;const h=b(f.message_index,NaN);if(Number.isFinite(i)&&Number.isFinite(h)){Math.abs(h-i)<=s&&p(f.id);continue}l&&String(f.content_hash||"")===l&&p(f.id)}return g}function lu(e,t,n=2){const a=b(e,NaN),r=b(t,NaN);if(!Number.isFinite(a)||!Number.isFinite(r))return!1;const s=Math.max(0,b(n,2));return Math.abs(a-r)<=s}function uu(e,t,n=2){const a=Math.max(0,Math.floor(b(t,0))),r=Math.max(0,Math.min(Math.max(0,a-1),Math.floor(b(e,0)))),s=Math.max(0,Math.floor(b(n,2)));return a<=0?{lo:0,hi:-1,center:0}:{lo:Math.max(0,r-s),hi:Math.min(a-1,r+s),center:r}}var cs={chrome:1,content:2,full:3};function du(e,t){const n=cs[String(e??"")]||0,a=cs[String(t??"")]||0;return!n&&!a?"full":a>=n?t||e||"full":e||t||"full"}function ls(e){const t=String(e||"").trim();if(!t)return{appearance:"",attire:"",accessories:"",text:""};let n=null;const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i),r=(a?a[1]:t).trim().match(/\{[\s\S]*\}/);if(r)try{const i=JSON.parse(r[0]);n=i&&typeof i=="object"?i:null}catch{n=null}if(n&&typeof n=="object"){const i=String(n.appearance??n.look??n.identity??"").trim(),o=String(n.attire??n.clothing??n.outfit??"").trim(),c=String(n.accessories??n.accessory??n.props??"").trim();return{appearance:i,attire:o,accessories:c,text:[i,o,c].filter(Boolean).join(", ")}}const s=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,"").trim();return{appearance:s,attire:"",accessories:"",text:s}}function fu(e={}){const t=!!e.warmBusy,n=Math.max(0,Math.min(100,Math.round(b(e.warmPct,0)))),a=String(e.jobState||""),r=Math.max(0,Math.min(100,Math.round(b(e.jobPct,0))));return t?{pct:Math.max(t?6:0,n),busy:!0,label:"인덱싱"}:a==="tagging"?{pct:Math.max(6,r),busy:!0,label:"인덱싱"}:{pct:0,busy:!1,label:"인덱싱"}}function gu(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,a=Math.max(t?6:0,Math.min(100,Math.round(b(e.jobPct,0)))),r=Math.max(n?6:0,Math.min(100,Math.round(b(e.indexPct,0)))),s=e.error?"#f87171":"#7c6cff",i="#2dd4bf",o=(c,l)=>`<span style="display:block;height:5px;border-radius:999px;background:rgba(255,255,255,.08);overflow:hidden"><span style="display:block;height:100%;width:${c}%;background:${l};border-radius:inherit"></span></span>`;return`<span style="flex:0 0 132px;display:flex;flex-direction:column;gap:3px;justify-content:center">${o(a,s)}${o(r,i)}</span>`}function Mn(e){return Math.max(0,Math.min(100,b(e,0)))}function wa(e,t){const n=Math.max(1,b(t,1));return Math.max(0,Math.min(b(e,0),n-1))/n*100}function mu(e,t=0,n=1,a=null){if(a&&a.forceEven)return wa(t,n);const r=e?.y_percent??e?.anchor_percent??e?.read_percent,s=Number(r);return Number.isFinite(s)?Mn(s):wa(t,n)}function us(e,t,n=.5){if(!e)return null;const a=Math.max(1,b(e.height,0)),r=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return r<b(e.top,0)||r>b(e.bottom,0)?null:Mn((r-b(e.top,0))/a*100)}function hu(e,t,n=.5){const a=us(e,t,n);if(a!=null)return a;const r=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return b(e?.bottom,0)<r?100:0}function pu(e,t){const n=Array.isArray(e)?e:[];if(!n.length)return-1;const a=Mn(t),r=n.map(c=>Mn(c)),s=r.reduce((c,l,d)=>l<=20?c.concat(d):c,[]),i=s.length===1&&r[s[0]]>0?r.map((c,l)=>l===s[0]?1:c):r;if(i[0]>0&&a<i[0])return-1;let o=0;for(let c=0;c<i.length;c+=1)a>=i[c]&&(o=c);return o}function va(){const e=ae(),t=e.events;return{last_stage:e.last_stage,events:Array.isArray(t)?t.slice(-20):[]}}async function _u(e){if(e){const t=E(),n={...e};u(n.api_key)&&(t.llm.api_key=u(n.api_key)),delete n.api_key,delete n.api_key_configured,u(n.service_account_json)&&(t.llm.service_account_json=u(n.service_account_json)),delete n.service_account_json,delete n.service_account_configured,Object.keys(n).length&&(t.llm=Ee(t.llm,n)),await ze()}try{const t=E().llm,n=pn(t.source),a=Qe(t.provider);return n==="custom"&&!kr(t)?{ok:!1,message:a==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM Model/API key가 비어 있습니다. NovelAI 키가 아니라 태깅용 LLM 키를 넣으세요."}:(n==="main"||n==="aux")&&!Yt("runLLMModel")?{ok:!1,message:"RisuAI runLLMModel API를 사용할 수 없습니다."}:{ok:!0,message:`LLM ok (${n}): ${(await vn(t,[{role:"user",content:"Reply with exactly: ok"}])).slice(0,120)}`}}catch(t){return{ok:!1,message:String(t?.message||t)}}}async function yu(){const e=E().nai;if(Rt(e)==="comfy")try{if(!ta(e))return{ok:!1,message:"ComfyUI 워크플로 JSON이 없습니다.",debug:ae()};const t=gr({main:"test",neg:"test",captions:[{name:"",prompt:"char1"},{name:"",prompt:"char2"}],nai:e,seed:1}),n=mr(e.comfy_workflow_json,t),a=fr(e),{status:r,data:s}=await na(`${a}/system_stats`,{method:"GET"});if(r>=400)return{ok:!1,message:`ComfyUI 연결 실패 (HTTP ${r}) · ${a}`,debug:ae()};const i=s?.devices?.[0]?.name||s?.system?.os||"ok";return{ok:!0,message:`ComfyUI ok · ${a} · nodes=${Object.keys(n).length} · ${i}`,debug:va()}}catch(t){return v("comfy.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ae()}}if(!u(e.api_key))return{ok:!1,message:"NAI api_key missing",debug:ae()};try{const t=u(e.api_key);try{const n=Q("nai.test.anlas"),a=await sc(t);return n.end({message:"anlas ok"}),{ok:!0,message:`NAI token ok · Anlas=${JSON.stringify(a)}`,debug:va()}}catch(n){const a=Ze(e.model||"nai-diffusion-4-5-full");return v("nai.test.anlas",{message:String(n?.message||n)},"warn"),{ok:!0,message:`NAI config present · model=${a} · anlas_skip=${n?.message||n}`,debug:va()}}}catch(t){return v("nai.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:ae()}}}async function bu(){const e=E().nai,t=u(e.api_key);if(!t)return{ok:!1,message:"NAI api_key missing",debug:ae()};const n=String(ae().job_ctx??"");en("probe-nai");const a=Q("nai.probe");try{v("nai.probe.start",{message:"tiny generate"});const r={prompt:"1girl, solo, simple background, best quality",negative_prompt:"lowres, bad quality",width:512,height:768,steps:10,cfg_scale:5,cfg_rescale:0,sampler:"k_euler_ancestral",scheduler:"karras",model:Ze(e.model||"nai-diffusion-4-5-full"),var_plus:!1,characters:[],seed:Math.floor(Math.random()*4294967295)||1},s=u(e.request_url)||"https://image.novelai.net/ai/generate-image",i=await hr(t,r,s,{timeoutMs:9e4}),o=i.raw_bytes.byteLength,c=Nt(re(i.raw_bytes));return a.end({bytes:o,is_png:c,seed:i.seed}),{ok:!0,message:`probe ok · png=${c} · ${o}B · seed=${i.seed}`,bytes:o,is_png:c,seed:i.seed,debug:ae()}}catch(r){return a.fail(r),{ok:!1,message:String(r?.message||r),debug:ae()}}finally{en(n)}}async function wu(e,t){if(!e?.byteLength)throw new Error("image is empty");const n=await Zi(e),a=n.bytes,r=n.mime||"image/png",s=n.filename||"image.png",i=`data:${r};base64,${await He(a)}`,o=an(await me("autotag"))||["Tag ONE character reference image into Danbooru-style English prompts.",'Return ONE JSON object only: {"appearance":"...","attire":"...","accessories":"..."}.',"appearance = identity/hair/eyes/body (no clothes). attire = clothing only. accessories = jewelry/props/earbuds/etc."].join(`
`);v("autotag.start",{message:`llm-vision ${s} ${a.length}B`,bytes:a.length,focus:!0,source:pn(E().llm.source)});const c=[{role:"system",content:o},{role:"user",content:[{type:"text",text:"Tag this character image. JSON only with appearance, attire, accessories."},{type:"image_url",image_url:{url:i}}]}];let l="";try{l=await vn(E().llm,c)}catch(_){throw v("autotag.llm.fail",{message:String(_?.message||_)},"error"),new Error(`오토태그 LLM 실패: ${String(_?.message||_).slice(0,240)}`)}const d=ls(l),g=u(d.appearance||"",4e3),p=u(d.attire||"",4e3),f=u(d.accessories||"",4e3),h=u(d.text||[g,p,f].filter(Boolean).join(", "),8e3);if(!g&&!p&&!f)throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");const m=h.split(",").map(_=>_.trim()).filter(Boolean);return v("autotag.done",{message:`app=${g.length} attire=${p.length} acc=${f.length}`,focus:!0}),{ok:!0,appearance:g,attire:p,accessories:f,tags:m,text:h,count:m.length,threshold:Number(t||.2),engine:"llm-vision"}}function vu(e){const t=e.indexOf("?");if(t<0)return{pathname:e,query:{}};const n=e.slice(0,t),a=new URLSearchParams(e.slice(t+1)),r={};for(const[s,i]of a.entries()){const o=r[s];o===void 0?r[s]=i:Array.isArray(o)?o.push(i):r[s]=[o,i]}return{pathname:n,query:r}}function Jt(e,t,n=""){const a=e[t];return Array.isArray(a)?a[0]??n:a??n}function xu(e,t={}){const n=u(e.auth_token,4e3);if(!n)return!0;const a=String(t.Authorization||t.authorization||"");let r=a.toLowerCase().startsWith("bearer ")?a.slice(7):a;if(r=r||String(t["X-Inlay-Nexus-Token"]||t["x-inlay-nexus-token"]||""),typeof r!="string"||r.length!==n.length)return!1;let s=0;for(let i=0;i<n.length;i+=1)s|=r.charCodeAt(i)^n.charCodeAt(i);return s===0}var L=(...e)=>t=>e.includes(t)?"":null,Ne=e=>t=>t.startsWith(e)?t.slice(e.length):null,xa=(e,t)=>n=>n.startsWith(e)&&n.endsWith(t)?n.slice(e.length,n.length-t.length):null,N=e=>({status:200,data:e}),ka=e=>({status:200,data:e,contentType:"image/png",raw:!0}),Kt=e=>{throw Je(404,{ok:!1,...Y(e,"not_found")},e)};function Sa(e){let t=e.image_b64||e.data||"";return typeof t=="string"&&t.startsWith("data:")&&(t=t.split(",",2)[1]??""),String(t||"")}var ku=[{match:L("/v1/settings/export"),handler:()=>N({ok:!0,json:kc()})},{match:L("/v1/settings"),handler:()=>N({ok:!0,settings:yn()})},{match:L("/v1/prompts"),handler:async()=>N({ok:!0,prompts:await xc()})},{match:Ne("/v1/prompts/"),handler:async({param:e})=>N({ok:!0,key:e,text:await me(e)})},{match:Ne("/v1/jobs/"),handler:async({param:e})=>N(await yl(e))},{match:Ne("/v1/gallery/explore"),handler:async({query:e})=>N(await Hc(Number(Jt(e,"limit","400"))))},{match:L("/v1/gallery/favorites"),handler:async()=>N(await Or())},{match:Ne("/v1/gallery"),handler:async({query:e})=>N(await qc(Jt(e,"session_id"),Number(Jt(e,"limit","40"))))},{match:L("/v1/nai/reference.png"),handler:async()=>ka(await Ir()??Kt("no reference"))},{match:L("/v1/nai/vibe.png"),handler:async()=>ka(await Cc()??Kt("no vibe"))},{match:L("/v1/nai/reference"),handler:async()=>{const e=await Ic();return N({ok:!0,configured:e,image_reference:E().nai?.image_reference||"none",preview_url:e?"/v1/nai/reference.png":""})}},{match:L("/v1/nai/vibe"),handler:async()=>{const e=await Ec();return N({ok:!0,configured:e,vibe_transfer:E().nai?.vibe_transfer||"none",preview_url:e?"/v1/nai/vibe.png":""})}},{match:Ne("/v1/characters"),handler:async({query:e})=>N(await Bt(Jt(e,"session_id"),Jt(e,"character_id")))},{match:Ne("/v1/appearance/"),handler:async({param:e})=>N(await Bt(e))},{match:Ne("/v1/images/"),handler:async({param:e})=>{let t=e.replace(/^\/+|\/+$/g,"");if(t.endsWith(".json")){const n=await et(t.slice(0,-5));return Object.keys(n).length||Kt("location missing"),N(n)}return t.endsWith(".png")&&(t=t.slice(0,-4)),ka(await Br(t)??Kt("image missing"))}}],Su=[{match:L("/v1/settings/reset"),handler:async()=>N(await Mc())},{match:L("/v1/settings/import"),handler:async({body:e})=>N(await Sc(String(e.json||e.text||"")))},{match:L("/v1/settings","/v1/settings/update"),handler:async({body:e})=>N(await Nc(e))},{match:xa("/v1/prompts/","/reset"),handler:async({param:e})=>N(await Ar(e,sn(e)))},{match:Ne("/v1/prompts/"),handler:async({param:e,body:t})=>N(await Ar(e,String(t.text||"")))},{match:L("/v1/jobs/create","/v1/jobs"),handler:async({body:e})=>({status:202,data:await Wr(e)})},{match:L("/v1/gallery/unlink","/v1/cards/unlink"),handler:async({body:e})=>N(await da(String(e.session_id||""),String(e.content_hash||""),e.message_index))},{match:L("/v1/gallery/rebind-hash","/v1/cards/rebind-hash"),handler:async({body:e})=>N(await Gc({session_id:String(e.session_id||e.sessionId||""),card_ids:e.card_ids||e.ids||[],to_hash:String(e.to_hash||e.content_hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||"")}))},{match:L("/v1/gallery/delete","/v1/cards/delete"),handler:async({body:e})=>{const t=u(e.folder_key||"",400),n=u(e.card_id||e.id||"",80),a=Array.isArray(e.card_ids)?e.card_ids:null;if(t)return N(await Xc(t));if(a?.length)return N(await Wc(a));if(n)return N(await ga(n));const r="card_id or folder_key required";throw Je(400,{ok:!1,...Y(r,"bad_request")},r)}},{match:L("/v1/gallery/export"),handler:async({body:e})=>N(await Yc(e))},{match:L("/v1/gallery/import"),handler:async({body:e})=>N(await Zc(e))},{match:L("/v1/gallery/favorites"),handler:async({body:e})=>Array.isArray(e.ids)?N(await Vc(e.ids)):N(await Or())},{match:xa("/v1/cards/","/tags"),handler:async({param:e,body:t})=>N(await vl(e,t))},{match:xa("/v1/cards/","/reroll"),handler:async({param:e,body:t})=>N(await Vr(e,String(t.mode||"nai"),t.overrides))},{match:L("/v1/messages/reroll","/v1/gallery/reroll-message"),handler:async({body:e})=>N(await xl({session_id:String(e.session_id||e.sessionId||""),content_hash:String(e.content_hash||e.contentHash||""),message_index:Number(e.message_index??e.messageIndex??-1)}))},{match:L("/v1/characters/global-toggles","/v1/characters/global_toggles"),handler:async({body:e})=>N(await Ao(String(e.character_id||""),e.disabled_globals||e.disabled||[]))},{match:L("/v1/characters/unify","/v1/characters/merge"),handler:async({body:e})=>N(await cr(String(e.target_session_id||e.session_id||""),e.source_session_ids||e.session_ids||[],e.include_target!==!1))},{match:L("/v1/characters","/v1/characters/update"),handler:({body:e})=>Mu(e)},{match:Ne("/v1/appearance/"),handler:async({param:e,body:t})=>t.characters!=null||t.global!=null?(t.characters!=null&&await Ot(e,t.characters||[],{prune:!0}),t.global!=null&&await Ot(Ie,t.global||[],{prune:!0}),N(await Bt(e))):N(await To(e,t.appearance||{}))},{match:L("/v1/models/test"),handler:async({body:e})=>N(await _u(e.llm&&typeof e.llm=="object"?e.llm:null))},{match:L("/v1/nai/test"),handler:async()=>N(await yu())},{match:L("/v1/nai/probe","/v1/debug/probe-nai"),handler:async()=>N(await bu())},{match:L("/v1/debug/clear"),handler:()=>($n(),N({ok:!0,cleared:!0}))},{match:L("/v1/nai/reference","/v1/nai/reference/upload"),handler:async({body:e})=>{if(e.clear)return N(await $r());const t=Sa(e);if(!u(t))throw new Error("image_b64 required");return N(await $c(Z($e(t))))}},{match:L("/v1/nai/reference/clear"),handler:async()=>N(await $r())},{match:L("/v1/nai/vibe","/v1/nai/vibe/upload"),handler:async({body:e})=>{if(e.clear)return N(await jr());const t=Sa(e);if(!u(t))throw new Error("image_b64 required");return N(await Tc(Z($e(t)),{model:e.model,information_extracted:e.information_extracted??e.vibe_transfer_information_extracted,strength:e.strength??e.vibe_transfer_strength}))}},{match:L("/v1/nai/vibe/clear"),handler:async()=>N(await jr())},{match:L("/v1/autotag","/v1/autotag/evaluate"),handler:async({body:e})=>{const t=Sa(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=$e(t);return N(await wu(Z(n),Number(e.threshold??.2)))}}];async function Mu(e){const t=u(e.session_id||"",200),n=u(e.character_id||"",200),a=(Array.isArray(e.root_session_ids)?e.root_session_ids:Array.isArray(e.cascade_session_ids)?e.cascade_session_ids:[]).map(s=>u(s,200)).filter(Boolean);if("characters"in e&&t&&await Ot(t,e.characters||[],{prune:!0,rootSessionIds:a}),"global"in e&&await Ot(Ie,e.global||[],{prune:!0}),"character"in e){const s=u(e.scope||t||"__global__",200);a.length&&s!=="__global__"?await or(a,[e.character||{}],""):await ce(s,e.character||{})}const r=Array.isArray(e.root_delete)?e.root_delete:Array.isArray(e.cascade_delete)?e.cascade_delete:[];return r.length&&a.length&&await jo(a,r,""),a.length&&t&&await cr(t,a,!1),N(await Bt(t,n))}async function ds(e,t){for(const n of e){const a=n.match(t.pathname);if(a!==null)return n.handler({...t,param:a})}return Kt(t.pathname)}async function Au(e,t={}){const{pathname:n,query:a}=vu(e),r=String(t.method||"GET").toUpperCase();let s;if(typeof t.body=="string")try{s=JSON.parse(t.body)}catch{s={}}else s=t.body??{};if(["/v1/health","/healthz","/readyz"].includes(n))return N({ok:!0,health:Ac()});if(n==="/v1/debug"||n==="/v1/debug/log")return r==="DELETE"||r==="POST"&&s.clear?($n(),N({ok:!0,cleared:!0})):N(ae());if(!xu(E(),t.headers||{})){const o="invalid token";throw Je(401,{ok:!1,...Y(o,"unauthorized")},o)}const i={method:r,pathname:n,query:a,body:s};if(r==="GET")return ds(ku,i);if(["POST","PUT","PATCH"].includes(r))try{return await ds(Su,i)}catch(o){if(Ta(o))throw o;const c=String(o?.message||o);throw Je(500,{ok:!1,...Y(c,"internal")},c)}throw Je(405,{ok:!1,...Y(r,"method_not_allowed")},r)}var An=null;async function Nu(){v("boot.ready.start",{message:rt}),await Oe();const e=await un().catch(a=>{throw v("boot.storage",{message:String(a?.message||a)},"error"),a});v("boot.storage",{message:e.kind}),Cn(await wc()),await vc(),await Po(),await Oo();const t=await R("meta","reference_image");t?.png&&Ln(fn(t.png));const n=await R("meta","vibe_transfer");n?.png&&Pn(fn(n.png)),v("boot.ready.done",{message:rt,has_nativeFetch:Yt("nativeFetch"),has_idb:Yt("getLocalPluginStorage")})}async function Ma(){return An||(An=Nu().catch(e=>{throw An=null,e})),await An,!0}async function Iu(e,t={},n=12e4){await Ma();try{const a=await Au(e,t);if(a.raw)return a.data;if(a.status>=400)throw Je(a.status,a.data);return a.data}catch(a){if(Ta(a))throw a;const r=String(a?.message||a);throw Je(500,{ok:!1,...Y(r,"internal")},r)}}async function $u(e){return await Ma(),yt(e)}function Eu(){As(()=>({cards:Lt("cards"),images:Lt("images"),jobs:Lt("jobs"),blob_urls:yo()})),Reflect.set(globalThis,"__INLAY_NATIVE__",{VERSION:rt,ready:Ma,fetch:Iu,resolveImageUrl:ye,refPreviewUrl:Ra,vibePreviewUrl:Fa,ensureImageUrl:$u,warmImages:So,pinImageUrls:ko,warmProgress:wo,onWarmProgress:vo,debug:ae,clearDebug:$n})}var ju=qt({applyExplorerClick:()=>Lu,clearSelection:()=>Ou,createSelectionState:()=>Cu,moveFocus:()=>Bu,reorderByIds:()=>Du,selectAll:()=>Pu,sortExplorerItems:()=>Ru,thumbMinWidth:()=>Fu,visibleIds:()=>Tu});function Cu(e=[]){return{selected:new Set((e||[]).map(String).filter(Boolean)),anchorId:"",focusId:""}}function Tu(e=[]){return(e||[]).map(t=>String(t?.id||"")).filter(Boolean)}function Lu(e,t,{index:n,ids:a,shift:r=!1,ctrl:s=!1}={}){const i={selected:new Set(e?.selected||[]),anchorId:String(e?.anchorId||""),focusId:String(e?.focusId||"")},o=String(t||"");if(!o)return i;const c=Array.isArray(a)?a.map(String):[],l=typeof n=="number"&&Number.isFinite(n)?n:c.indexOf(o);if(r&&i.anchorId&&c.length){const d=c.indexOf(i.anchorId),g=l>=0?l:c.indexOf(o);if(d>=0&&g>=0){const p=Math.min(d,g),f=Math.max(d,g);return i.selected=new Set(c.slice(p,f+1)),i.focusId=o,i}}return s?(i.selected.has(o)?i.selected.delete(o):i.selected.add(o),i.anchorId=o,i.focusId=o,i):(i.selected=new Set([o]),i.anchorId=o,i.focusId=o,i)}function Pu(e,t=[]){return{selected:new Set((t||[]).map(String).filter(Boolean)),anchorId:String(e?.anchorId||t?.[0]||""),focusId:String(e?.focusId||t?.[0]||"")}}function Ou(e=null){return{selected:new Set,anchorId:String(e?.anchorId||""),focusId:""}}function Bu(e=[],t="",n=1){const a=(e||[]).map(String).filter(Boolean);if(!a.length)return"";const r=a.indexOf(String(t||""));return r<0?a[0]:a[Math.max(0,Math.min(a.length-1,r+n))]}function Ru(e=[],t="newest"){const n=[...e||[]],a=(r,s=0)=>{const i=Number(r);return Number.isFinite(i)?i:s};return t==="oldest"?n.sort((r,s)=>a(r.created_at)-a(s.created_at)||String(r.id).localeCompare(String(s.id))):t==="message"?n.sort((r,s)=>a(r.message_index,1e9)-a(s.message_index,1e9)||a(r.shot_index)-a(s.shot_index)||a(s.created_at)-a(r.created_at)):t==="shot"?n.sort((r,s)=>a(r.shot_index)-a(s.shot_index)||a(r.message_index,1e9)-a(s.message_index,1e9)||a(s.created_at)-a(r.created_at)):n.sort((r,s)=>a(s.created_at)-a(r.created_at)||String(s.id).localeCompare(String(r.id)))}function Fu(e="m"){return e==="s"?96:e==="l"?200:148}function Du(e=[],t=[]){const n=s=>{const i=s&&typeof s=="object"?s.id:void 0;return String(i??s)},a=new Map((e||[]).map(s=>[n(s),s])),r=[];for(const s of t||[]){const i=String(s);a.has(i)&&(r.push(a.get(i)),a.delete(i))}for(const s of a.values())r.push(s);return r}function zu(){Reflect.set(globalThis,"__INLAY_VIEWER_CORE__",{...kl}),Reflect.set(globalThis,"__INLAY_LLM__",{...uc}),Reflect.set(globalThis,"__INLAY_LORE_EXTRA__",{...rl}),Reflect.set(globalThis,"__INLAY_EXPLORER__",{...ju})}zu(),Eu(),v("boot.loaded",{message:rt})})();
...
var Zt = "inlay-nexus-native", ea = "Inlay Nexus", He = "2.0.10", rn = class extends Error {
  segment;
  constructor($) {
