...
//@display-name Inlay Nexus 2.1.7
//@api 3.0
//@version 2.1.7
...
(function(){var Ti=Object.defineProperty,$=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(r){throw n=[r],r}},dn=(e,t)=>{let n={};for(var r in e)Ti(n,r,{get:e[r],enumerable:!0});return t||Ti(n,Symbol.toStringTag,{value:"Module"}),n},Ye,ji,mn,$i,Xe,Xr,Zr,je,pn,gn,hn,ar,ir,_n,yn,zt,Ut,bn,Pi,Oi,Li,Bi,du,Ri,Fi,Di,zi,ee=$((()=>{Ye="2.1.7",ji="2026-08-06-bg-filter",mn=["author_note","tagger","format","prefill","preprocess","preset_1","lore_inject","char_inject","appearance_inject","asset_tags_inject","autotag","curation_refine","curation_embed_hint"],$i=["tagger","format","appearance_inject","lore_inject","asset_tags_inject","autotag","curation_refine","curation_embed_hint"],Xe="__global__",Xr="inx_native_settings",Zr=e=>`inx_nxstore_${e}`,je=e=>`inx_nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,pn="inx_nxref_image",gn="inx_nxvibe_image",hn="inx_nxvibe_data",ar="inx_nx_curation_catalog",ir="inx_nx_curation_embeddings",_n=e=>`inx_nxvibe_p_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,yn=e=>`inx_nxvibe_pd_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,80)}`,zt=e=>`vibe_preset_${String(e)}`,Ut=e=>typeof e=="string"&&e.startsWith("vibe_preset_"),bn=e=>e.slice(12),Pi="native_settings",Oi=e=>`nxstore_${e}`,Li=e=>`nximg_${String(e).replace(/[^a-zA-Z0-9_-]/g,"_")}`,Bi="nxref_image",du="https://image.novelai.net/ai/generate-image",Ri="https://image.novelai.net/ai/encode-vibe",Fi="https://api.novelai.net/user/subscription",Di=["meta","cards","characters","jobs","images"],zi=4e3}));function Ae(){const e=globalThis;return e.risuai??e.Risuai}function ge(e){return typeof Ae()?.[e]=="function"}var pt=$((()=>{}));function w(e,t={},n="info"){const r={t:Date.now(),iso:new Date().toISOString(),stage:String(e||""),level:n,job_id:wn||t.job_id||"",ms:t.ms!=null?Number(t.ms):void 0,bytes:t.bytes!=null?Number(t.bytes):void 0,status:t.status!=null?t.status:void 0,message:t.message!=null?na(t.message,240):void 0,detail:{}};for(const[i,o]of Object.entries(t))Ui.has(i)||(r.detail[i]=o==null||typeof o=="number"||typeof o=="boolean"?o:na(o,220));for($e.push(r);$e.length>240;)$e.shift();xn=r.stage,(t.focus||!t.background&&qi(r.stage))&&(or=r.stage),n==="error"&&(vn={stage:r.stage,message:String(r.message??""),t:r.t});const a=`[InlayNX:${r.stage}]`+(r.message?` ${String(r.message)}`:"")+(r.ms!=null?` ${r.ms}ms`:"")+(r.bytes!=null?` ${r.bytes}B`:"");return n==="error"?console.error(a,r.detail):n==="warn"?console.warn(a,r.detail):console.log(a,r.detail),r}function ue(e){const t=Date.now();return{end:(n={},r="info")=>w(e,{...n,ms:Date.now()-t},r),fail:(n,r={})=>w(e,{...r,message:String(n?.message??n),ms:Date.now()-t},"error")}}function he(){const e=Ae()??{};let t=null;try{t=typeof document<"u"?!!document.hidden:null}catch{}const n=$e.slice(-80),r={};for(const a of n)r[a.stage]=(r[a.stage]??0)+1;return{ok:!0,version:Ye,now:Date.now(),last_stage:xn,focus_stage:or,last_error:vn,job_ctx:wn||null,env:{has_nativeFetch:typeof e.nativeFetch=="function",has_getLocalPluginStorage:typeof e.getLocalPluginStorage=="function",has_pluginStorage:!!e.pluginStorage?.getItem,has_DecompressionStream:typeof DecompressionStream=="function",has_AbortController:typeof AbortController<"u",document_hidden:t},counts:{events:$e.length,...ea?.()??{}},by_stage:r,errors:$e.filter(a=>a.level==="error").slice(-20),events:n}}function Qr(){return $e.length=0,vn=null,xn="cleared",!0}var Ui,$e,wn,vn,xn,or,ea,Ji,kn,Hi,gt,Sn,sr,Ki,ta,na,qi,q=$((()=>{ee(),pt(),Ui=new Set(["ms","bytes","status","message","job_id","background","focus"]),$e=[],wn="",vn=null,xn="boot",or="boot",ea=null,Ji=e=>{ea=e},kn=e=>{wn=e},Hi=()=>wn,gt=()=>or,Sn=()=>xn,sr=()=>vn,Ki=()=>$e.length,ta=(e,t)=>$e.filter(n=>n.job_id===e).slice(-t),na=(e,t=280)=>{if(e==null||typeof e=="number"||typeof e=="boolean")return e;let n;if(typeof e=="string")n=e;else try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:`${n.slice(0,t)}…(+${n.length-t})`},qi=e=>e.startsWith("job.")||e.startsWith("nai.")||e.startsWith("llm.")||e.startsWith("image.")}));q();function ht(e,t,n){const r=t?.error?.message,a=new Error(n??r??`HTTP ${e}`);return a.status=e,a.data=t,a}var Gi=e=>e instanceof Error&&typeof e.status=="number",ae=(e,t="error")=>({error:{code:t,message:e}}),Ze,cr,_t=$((()=>{Ze=e=>new Promise(t=>setTimeout(t,e)),cr=class{tail=Promise.resolve();run(e){const t=this.tail.then(e,e);return this.tail=t.then(()=>{},()=>{}),t}}}));function V(e){return e?e instanceof Uint8Array?e:new Uint8Array(e):new Uint8Array(0)}function Jt(e){const t=V(e);let n="";for(let r=0;r<t.length;r+=Ht)n+=String.fromCharCode(...t.subarray(r,r+Ht));return btoa(n)}async function Qe(e){const t=V(e);if(t.length<Wi)return Jt(t);let n="";for(let r=0;r<t.length;r+=Ht)n+=String.fromCharCode(...t.subarray(r,r+Ht)),r>0&&r%(Ht*24)===0&&await Ze(0);return btoa(n)}function mu(e){return e?Jt(e):""}async function pu(e){return e?Qe(e):""}function Pe(e){const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function gu(e){return e?Pe(e).buffer:null}function Z(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}function An(e,t){const n=new Uint8Array(t);let r=0;for(const a of e)n.set(a,r),r+=a.length;return n}function yt(e){return!!(e&&e.length>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)}function Mn(e){return!!(e&&e.length>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70&&e[8]===87&&e[9]===69&&e[10]===66&&e[11]===80)}function Nn(e){const t=V(e);return Mn(t)?"image/webp":yt(t)?"image/png":t.length>=3&&t[0]===255&&t[1]===216&&t[2]===255?"image/jpeg":"image/png"}function hu(e){const t=/^data:([^;,]+)?(;base64)?,(.*)$/i.exec(String(e||""));if(!t)return null;const n=!!t[2],r=t[3]||"";try{return Z(n?Pe(r):new TextEncoder().encode(decodeURIComponent(r)))}catch{return null}}var Ht,Wi,Q=$((()=>{_t(),Ht=32768,Wi=2e5}));function u(e,t=2e5){if(e==null)return"";let n=String(e).replace(/\x00/g," ").replace(/\r\n/g,`
`);return n=n.replace(/[ \t\f\v]+/g," ").replace(/\n{4,}/g,`


`).trim(),n.slice(0,t)}function P(e,t=-1){if(e==null||typeof e=="string"&&!e.trim())return t;const n=parseInt(String(e),10);return Number.isNaN(n)?t:n}function lr(e){if(e==null||typeof e=="string"&&!e.trim())return null;const t=parseFloat(String(e));return Number.isNaN(t)?null:t}function Vi(e){const t=u(e);if(!t)return[];const n=[],r=/-?\d+(?:\.\d+)?::(?:(?!::).)*?::|[^,]+/g;let a;for(;(a=r.exec(t))!==null;){const i=a[0].trim();i&&n.push(i)}return n}function I(...e){const t=[],n=new Set;for(const r of e)for(const a of Vi(r)){const i=a.trim();if(!i)continue;const o=i.toLowerCase();o==="null"||o==="none"||n.has(o)||(n.add(o),t.push(i))}return t.join(", ")}function W(e){if(e==null)return[];let t;if(Array.isArray(e))t=e.map(a=>u(a,200));else{const a=u(e,2e3);t=a?a.split(/[,|/]|,(?=\s)|、|\//):[],t.length<=1&&a&&(t=a.split(/\n+/))}const n=[],r=new Set;for(const a of t){const i=u(a,200);if(!i)continue;const o=U(i);!o||r.has(o)||(r.add(o),n.push(i))}return n}function _u(e){let t=0;for(let n=0;n<e.length;n+=1)t=Math.imul(31,t)+e.charCodeAt(n)|0;return t}function yu(e){const t=u(e,1e6);let n=2166136261,r=2654435769;for(let a=0;a<t.length;a+=1){const i=t.charCodeAt(a);n^=i,n=Math.imul(n,16777619),r^=i+(n<<6|n>>>26),r=Math.imul(r,2246822507)}return`${(n>>>0).toString(16).padStart(8,"0")}${(r>>>0).toString(16).padStart(8,"0")}`}function bu(e){const t=u(e??"",200);return t?`risu_${yu(`${t}|__unified__`)}`:""}function ur(e){let t=e;for(let n=0;n<20;n+=1){const r=t.replace(/\{\{#when[\s\S]*?\}\}([\s\S]*?)\{\{\/when\}\}/g,"$1").replace(/\{\{#if[\s\S]*?\}\}([\s\S]*?)\{\{\/if\}\}/g,"$1").replace(/\{\{:else\}\}[\s\S]*?(?=\{\{\/)/g,"");if(r===t)break;t=r}return t.replace(/\{\{[^}]+\}\}/g,"").trim()}function wu(e){const t=e.match(/\[Positive\]\s*([\s\S]*?)\s*\[Negative\]/),n=e.match(/\[Negative\]\s*([\s\S]*?)\s*$/);return t||n?[u(t?.[1]??""),u(n?.[1]??"")]:[u(e),""]}function bt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}var U,wt,et,O=$((()=>{U=e=>u(e,200).toLowerCase().replace(/\s+/g," "),wt=e=>u(e).toLowerCase().replace(/\s+/g,""),et=4e3})),vu,xu,ku,Yi,Xi,Zi,Qi,eo,to,no,ro,ao,io,Su=$((()=>{vu="",xu=0,ku="",Yi=[],Xi="indexeddb:getLocalPluginStorage",Zi="indexeddb:inx_nximg_*",Qi="embedded",eo={backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",notes:"PNG/settings live on this device (not save-file). Folder explorer reads card+location metadata."},to=JSON.parse(`{"power":true,"execute":"auto","mode":"illustration","image_min":3,"image_max":3,"character_max":2,"preset":1,"lorebook":true,"lore_extra":"tags","asset_nai_tags":false,"auto_aspect":false,"char_info":true,"user_info":true,"char_appearance":true,"preprocessing":false,"person_tag_mode":"gender","auto_person_tags":true,"person_tag_solo":false,"person_tag_weight":3,"original_text":"","custom_pos":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","custom_neg":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth","presets":[{"id":"프리셋_닭장_0_14izz","name":"프리셋 1","positive":"1.5::artist:sasamori tomoe, artist:sohn woohyoung::, 0.9::artist:hero_neisan, artist:takano suzu::, 0.4::artist:kidmo::, 1.3::seoyong::, 1.2::healthyman::, freng, 1.1::murata yuusuke::, 1.2::hiramedousa::, 1.2::artist:sos adult::, 1.7::shinjiro, artist:umezawa_itte::, -3::artist collaboration::, year 2025, year 2024, realstic 3d, -3::spoken bubble, text, cross-section::, rating:explicit, -3::multiple views::, -3::small lines::, 1.5::balanced contrast::, -2::simple illustration::, -1::censored::, best quality, amazing quality, very aesthetic, highres, incredibly absurdres,","negative":"blank page, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, artist:xinzoruo, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, six fingers extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration, 2::dark pussy, pink pussy, red pussy::, 2::pale skin, red skin, yellow skin, blush::, shark teeth"},{"id":"프리셋_농후_1_u4veg","name":"프리셋 2","positive":"2.0::artist:duoyuanjun::, artist:dawalixi, artist:m (1n910), 1.45::artist:murata yuusuke::, 1.4::artist:konya karasue::, 1.5::artist:wanke::, 2.3::artist:lunch(shin new)::, 0.8::artist:baffu::, 1.4::artist:ishigaki takashi::, 0.8::artist:xipa::, 0.8::artist:freng::, 0.5::artist:kim eb::, year 2025, year 2024, 0.5::3d, blender::, high detail, masterpiece, best quality, very aesthetic, highres, best illustration, novel illustration, -3::simple illustration::, -1::censored::, -3::artist collaboration::, detailed background, -1::door::","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration"},{"id":"프리셋_매끈_2_jgrz3","name":"프리셋 3","positive":"2.4::artist:uki_(ukikusaya) ::, 0.6::artist:sohn woohyoung::, 0.6::artist:minamoto (mutton) ::, artist:sakura no tomoru hi e, 0.5::artist:bettkan::, 0.4::artist:nanja::, 0.4::artist:joy boy \\\\(jerrydurd\\\\) ::, artist:freng, 0.2::artist:murata yuusuke::, 0.8::artist:mx2j::, artist:aoi nagisa (metalder), 0.2::artist:oda non::, 0.4::artist:lunch_(shin new) ::, 0.6::artist:duoyuanjun::, year 2025, year 2024, year 2023, solo artist, -5.3::artist collaboration::, -1::faux retro artstyle::, -1::film grain::, -1::clean text::, -1::flat color::, 1.2::3d::, blender(medium), 1.3::realistic::, natural, incredibly absurdres, very aesthetic, highres, masterpiece, best quality, amazing quality, -3::simple illustration::, best illustration, novel illustration, 0.06::best::, -1::ring::, 1.5::uncensored::, -2::censored::, -2::bar censor::, 2::shiny realistic skin::, 1.3::steaming body::,","negative":"blank page, text, logo, watermark, too many watermarks, reference, signature, artist name, dated, artistic error, scan artifacts, jpeg artifacts, upscaled, aliasing, film grain, heavy film grain, dithering, chromatic aberration, digital dissolve, halftone, screentones, artist:xinzoruo, artist:milkpanda, artist:kurukurumagical, artist collaboration, one-hour drawing challenge, toon (style), 1990s (style), 4koma, 2koma, character sheet, reference sheet, lineup, mutation, deformed, distorted, disfigured, bad anatomy, unnatural hair, bad face, mob face, bad eyes, empty eyes, bad proportions, bad limbs, amputee, bad arm, bad hands, bad hand structure, extra digits, fewer digits, bad leg, extra leg, distorted composition, bad perspective, multiple views, disorganized colors, unfinished, incomplete, displeasing, very displeasing, unsatisfactory, inadequate, deficient, subpar, poor, blurry, lowres, worst quality, bad quality, fewer details, bad portrait, bad illustration,"},{"id":"프리셋_닭_3_8yiw2","name":"프리셋 2-1","positive":"1.5::artist:sohn woohyoung::, 1.6::artist:solipsist::, 1.45::artist:gogalking::, 1.2::artist:oda non::, 1.25::artist:henriiku_(ahemaru) ::, 1.6::artist:Ask (Askzy) ::, 2.7::artist:jagercoke::, 2::artist:seven (sixplusone) ::, artist:wlop, 1.25::artist:wanke::, artist:seoyong, 0.7::artist:healthyman::, artist:freng, 1.2::artist:sos adult::, artist:shinjiro, 2::artist:nianbingzi::, artist:teshima nari, year 2024, year 2025, 2::blender (medium) ::, 2::pastel (medium) ::, -2::flat color::, pastel colors, 1.4::masterpiece, very aesthetic::, best quality, amazing quality, absurdres, 2::realistic::, -6::artist collaboration::, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, no text, -1.1::pubic hair::, uncensored,","negative":"natsuki karin, text, logo, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, sketch"},{"id":"프리셋_말랑_4_ian7o","name":"프리셋 말랑","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_깔_5_3rh46","name":"프리셋 깔","positive":"artist:freng, 1.2::artist:taesi::, artist:sohn woohyoung, 0.7::artist:oda non::, 1.5::artist:aoi nagisa (metalder) ::, 0.5::artist:chamchami::, 0.5::artist:blue gk::, artist:modare, artist:dishwasher1910, year 2025, year:2024, best quality, amazing quality, very aesthetic, highres, incredibly absurdres, high detail, masterpiece, -3::simple illustration::, novel illustration, best illustration, -1::multiple views::, no text, -3::multiple view, people, crowd, 2koma, x-ray, internal cumshot::, 2::nsfw::,","negative":"text, logo, cartoon, flat color, spot color, watermark, too many watermarks, blank page, text-only page, reference, username, signature, artist:xinzoruo, artist:milkpanda, artist collaboration, variant set, large variant set, 4koma, 2koma, toon (style), oekaki, chibi, turnaround, film grain, monochrome, dithering, halftone, screentones, dated, old, 1990s (style), mutation, deformed, distorted, disfigured, artistic error, distorted anatomy, anatomical structure error, asymmetrical face, unnatural hair, bad eyes, cloudy eyes, blank eyes, bad proportions, bad limb, bad hands, extra hands, bad hand structure, extra digits, fewer digits, bad legs, extra legs, amputee, distorted composition, bad perspective, multiple views, negative space, animation error, chromatic aberration, disorganized colors, scan artifacts, jpeg artifacts, vertical lines, vertical banding, worst quality, bad quality, lowres, blurry, upscaled, fewer details, unfinished, incomplete, amateur, cheesy, unsatisfactory, inadequate, deficient, subpar, poor, displeasing, very displeasing, bad illustration, bad portrait, limited palette, six finger, four finger, three finger, bad anatomy,"},{"id":"프리셋_쫀_6_815h6","name":"프리셋 쫀","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::, 1.4::bedroom::, 1.2::sunlight::, 2.9::hotel::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"},{"id":"프리셋_리얼_7_xwn4c","name":"프리셋 리얼","positive":"nsfw, 2::blender (medium), 3D::, 8::realistic::, 8::realistic skin::, 20::high detail texture::, 4::hizuki akira, dishwasher1910,::, 0.5::kim hyung tae::, 0.15::kidmo::, 0.75::icecake::, 0.3::von.franken::, 0.9::kase daiki::, nixeu, 0.5::yd_(orange_maru) ::, artist:2n5, healthyman, 0.75::nonohachi::, 0.2::freng::, 0.2::tsunako::, 0.3::bara_(03_bara_) ::, 0.5::ishigaki takashi::, 0.6::wanke::, 2::wlop::, 12.2::zero_q_0q::, 12.2::bm94199,::, re0n, 0.2::yunsang::, 0.2::ie (raarami), sos adult::, 0.6::qiandaiyiyu::, year 2025, year 2024, 4::masterpiece, very aesthetic, best quality, incredibly absurdres, absurdres, ultra high resolution::, 0.7::ai-generated::, -2::multiple views::, -2::simple illustration::, -3::artist collaboration::, -10::blackbord::, 4::heavy breath::,","negative":"8::watermark, too many watermarks,::, 2::text, logo, signature, Pictures, photos, brands, brand logos, dolls, other's, another's, painting, printing, print, letters, artist name, External characters, third party, outsiders, Except for designated characters::, 2::artist:nameo (judgemasterkou), artist:matsunaga kouyou::, artist collaboration, chibi, 1990s (style), bad anatomy, distorted anatomy, disfigured, 10::bad hands, missing finger, extra digits, mutation, extra arms, extra legs, long neck, bad feet, very displeasing, undetailed eyes, bad sole, bad toe, Deformed toe, deformed sole, mutant toe, mutant sole, deformed finger, deformed hand, deformed foot, deformed feet, mutant finger, mutant arm, mutant foot, mutant feet, extra hand, extra feet, extra foot, extra finger, extra toe, not five toes, not five fingers, Extra toes, extra fingers, six toes, four toes, Ugly feet, ugly toes, ugly hands, ugly fingers::, multiple views, negative space, blank page, variant set, large variant set, 4koma, 2koma, oekaki, halftone, screentone, artistic error, film grain, scan artifacts, jpeg artifacts, chromatic aberration, dithering, disorganized colors, lowres, worst quality, bad quality, cheesy, sloppiness, unfinished, Incomplete, **cartoon, anime, manga, 2d, flat color, cel shading, line art, sketch, blurry, out of focus, low contrast** 4, ::western face, caucasian, square jaw, angular jaw, square jawbone, angular jawbone, wide chin, chin dimple::, -6::five fingers, five toes, five finger, five toe, 5 fingers, 5 toes, 5 finger, 5 toe::,"}],"active_preset_id":"프리셋_닭장_0_14izz","include_min":0,"include_max":0,"userchat":false,"gallery_fab":false,"floating_viewer":true,"overlay_markers":true,"inline_chat_images":false,"progress_toast":false,"llm_anchor_percent":true,"natural_base":"short","composition_curation":false,"inline_previews":true,"inline_thumb_pct":100,"scale_semantics_version":2,"mobile_toggle_pin":false,"hover_preview":true,"hover_preview_anchor":"mouse","hover_preview_corner":"top-right","viewer_minimize_mode":"icon","unified_chat_priority":false,"overlay_hide_offscreen":true,"scroll_message_track":true,"click_message_track":true,"message_select_gesture":"single","text_drag_select":true,"show_risu_settings_button":true,"debug_panel":false,"generate_all_roles":false,"auto_gen_on_reply":false,"scroll_delay_ms":250,"capture_delay_ms":10,"overlay_x_pct":38,"overlay_y_pct":80,"overlay_pin_unit":"pct","overlay_pin_origin":"bl"}`),no={source:"custom",provider:"openrouter",endpoint:"https://openrouter.ai/api/v1/chat/completions",model:"openai/gpt-oss-20b:nitro",api_key:"",service_account_json:"",temperature:.4,max_tokens:8e3,timeout_seconds:180,reasoning_effort:"default",vertex_region:"us-central1",anthropic_version:"2023-06-01"},ro={provider:"Novel AI",backend:"nai",request_url:"https://image.novelai.net/ai/generate-image",api_key:"",model:"nai-diffusion-4-5-full",width:832,height:1216,sampler:"k_euler_ancestral",scheduler:"karras",steps:28,cfg_scale:7,cfg_rescale:.36,seed:0,variety_plus:!1,enable_i2i:!1,image_reference:"none",image_reference_strength:.6,image_reference_fidelity:1,image_reference_type:"character&style",vibe_transfer:"none",vibe_transfer_strength:.6,vibe_transfer_information_extracted:1,uc_preset:"human_focus",apply_quality_tags:!1,comfy_url:"http://localhost:8188",comfy_workflow_json:"",backend_timeout_seconds:300},ao={mode:"off",strict_ids:!1,embedding:{provider:"openai",model:"text-embedding-3-small",endpoint:"https://api.openai.com/v1/embeddings",api_key:""}},io={bind_host:"",port:0,auth_token:"",allowed_origins:Yi,database_path:Xi,images_dir:Zi,prompts_dir:Qi,storage:eo,card:to,llm:no,nai:ro,curation:ao}})),oo,so,co,lo,Au=$((()=>{oo="nai-diffusion-4-full",so="nai-diffusion-4-curated-preview",co="nai-diffusion-3",lo={"naid4.5f":"nai-diffusion-4-5-full","naid4.5c":"nai-diffusion-4-5-curated",naid4f:oo,naid4c:so,naid3:co}})),Mu,uo,fo,mo,po,go,ho,_o,Nu,yo,bo,wo,vo,Iu=$((()=>{Mu="",uo="Tag the chat message into Danbooru-style English image prompts. Output ONE JSON object only.",fo='{"scenes":[{"place":"...","shots":[{"paragraph":0,"y_percent":50,"line":7,"aspect":"portrait|square|landscape","camera":"...","situation":"...","characters":[{"name":"...","action":"..."}]}]}],"new_characters":[]}',mo=`Registered: {registered_block}
Incomplete: {incomplete_block}
Detected: {detected_block}`,po=`NovelAI asset tags for new_characters:
{asset_tags_block}
Priority: asset>lore>invent. Age as Nyo gender. Fill missing hair_length/style/color/eyes.`,go="Use matched lorebook context:",ho="Character info:",_o="Summarize visual details from the message.",Nu="",yo=`[Positive]
, masterpiece, best quality

[Negative]
lowres, bad quality, watermark`,bo="Batch-refine ALL shots' scene tags from allowed curation option ids in ONE JSON response.",wo="Write detailed Danbooru scene tags for camera/situation/place/action.",vo={author_note:"",tagger:uo,format:fo,appearance_inject:mo,asset_tags_inject:po,lore_inject:go,char_inject:ho,preprocess:_o,prefill:"",preset_1:yo,curation_refine:bo,curation_embed_hint:wo}})),xo,ko,So,Ao,Cu=$((()=>{xo=", no text, best quality, very aesthetic, absurdres",ko=", rating:general, amazing quality, very aesthetic, absurdres",So=", best quality, amazing quality, very aesthetic, absurdres",Ao={"naid4.5f":", location, very aesthetic, masterpiece, no text","naid4.5c":", location, masterpiece, no text, -0.8::feet::, rating:general",naid4f:xo,naid4c:ko,naid3:So}})),Mo,No,Io,Co,Eu=$((()=>{Mo={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, multiple views, logo, too many watermarks",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing",none:""},No={heavy:"blurry, lowres, error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, logo, dated, signature, multiple views, gigantic breasts",light:"blurry, lowres, error, worst quality, bad quality, jpeg artifacts, very displeasing, logo, dated, signature",none:""},Io={heavy:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]",light:"lowres, jpeg artifacts, worst quality, watermark, blurry, very displeasing",human_focus:"lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract], bad anatomy, bad hands, @_@, mismatched pupils, heart-shaped pupils, glowing eyes",none:""},Co={"naid4.5f":{heavy:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page",light:"lowres, artistic error, scan artifacts, worst quality, bad quality, jpeg artifacts, multiple views, very displeasing, too many watermarks, negative space, blank page",human_focus:"lowres, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, dithering, halftone, screentone, multiple views, logo, too many watermarks, negative space, blank page, @_@, mismatched pupils, glowing eyes, bad anatomy",none:""},"naid4.5c":{heavy:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, negative space, blank page",light:"blurry, lowres, upscaled, artistic error, scan artifacts, jpeg artifacts, logo, too many watermarks, negative space, blank page",human_focus:"blurry, lowres, upscaled, artistic error, film grain, scan artifacts, bad anatomy, bad hands, worst quality, bad quality, jpeg artifacts, very displeasing, chromatic aberration, halftone, multiple views, logo, too many watermarks, @_@, mismatched pupils, glowing eyes, negative space, blank page",none:""},naid4f:Mo,naid4c:No,naid3:Io}})),tt,Eo,In,To,Kt=$((()=>{Su(),Iu(),Cu(),Eu(),tt=io,Eo=vo,In=Ao,To=Co}));function Tu(e,t){const n=Po().encode(t),r=new Uint8Array(e.length);for(let a=0;a<e.length;a+=1)r[a]=e[a]^n[a%n.length];return r}function ju(e){if(typeof Buffer<"u")return new Uint8Array(Buffer.from(e,"base64"));const t=atob(e),n=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=t.charCodeAt(r);return n}function $u(e){if(!e||typeof e!="object")return{};const t=e;if(typeof t.__enc=="string"){if(Number(t.__v??1)!==jo)return{};try{const r=Oo().decode(Tu(ju(t.__enc),$o)),a=JSON.parse(r),i={};for(const[o,s]of Object.entries(a))typeof s=="string"&&(i[o]=s);return i}catch{return{}}}const n={};for(const[r,a]of Object.entries(t))typeof a=="string"&&(n[r]=a);return n}var jo,$o,Po,Oo,Pu=$((()=>{jo=1,$o="inlay-nexus-prompt-pack-v1",Po=()=>new TextEncoder,Oo=()=>new TextDecoder}));function Ou(){return $u(globalThis.__INLAY_NATIVE_PROMPTS__)}function Cn(e){const t=u(Ou()[e]);return t||Eo[e]||""}var Lo=$((()=>{O(),Kt(),Pu()}));function _e(e){if(typeof structuredClone=="function")try{return structuredClone(e)}catch{}return JSON.parse(JSON.stringify(e))}function nt(e,t){const n=_e(e??{});for(const[r,a]of Object.entries(t??{})){const i=n[r];n[r]=aa(a)&&aa(i)?nt(i,a):a}return n}function ra(e){const t=u(e).replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,""),n=t.slice(0,180).replace(/\s+/g," ");try{return JSON.parse(t)}catch{const r=t.match(/\{[\s\S]*\}/);if(!r)throw new Error(`태거 JSON 파싱 실패${n?` · 응답: ${n}`:" · 응답이 비어 있거나 JSON이 아님"}`);try{return JSON.parse(r[0])}catch(a){throw new Error(`태거 JSON 파싱 실패 · ${String(a?.message??a).slice(0,120)} · 응답: ${n}`)}}}var aa,vt=$((()=>{O(),aa=e=>!!e&&typeof e=="object"&&!Array.isArray(e)}));function T(){return ca}function fr(e){ca=e}function Bo(){return la}function ia(e){la=e}function Ro(){return ua}function oa(e){ua=e}function sa(e){return pr.get(String(e||""))||""}function dr(e,t){const n=String(e||"");n&&(t?pr.set(n,t):pr.delete(n))}var ca,Fo,En,xt,mr,la,ua,pr,fe=$((()=>{Kt(),_t(),vt(),ca=_e(tt),Fo=new cr,En=new Map,xt=new Map,mr=new Set,la="",ua="",pr=new Map})),Do,Lu=$((()=>{Do=["shirt","blouse","pants","trousers","jeans","shorts","skirt","dress","jacket","coat","hoodie","sweater","cardigan","vest","waistcoat","uniform","armor","robe","cloak","cape","apron","overalls","leggings","stockings","tights","pantyhose","socks","thighhighs","boots","shoes","heels","sandals","slippers","footwear","barefoot","gloves","mittens","hat","cap","beret","hood","scarf","necktie","bowtie","tie","belt","bra","panties","underwear","lingerie","swimsuit","bikini","kimono","yukata","hakama","cheongsam","hanbok","suit","tuxedo","collar","choker","mask","helmet","nude","naked","topless","bottomless","completely nude","open shirt","unbuttoned","unzipped","torn clothes","clothes","clothing","outfit","attire","sleeves","rolled-up sleeves","long sleeves","short sleeves","sleeveless","off shoulder","bare shoulder","bare shoulders","midriff","navel","cleavage","garter","corset","bodysuit","leotard","fishnets","ribbon","bow","bandana","no shirt","no pants","shirt lift","panties pull","skirt lift"]})),zo,Bu=$((()=>{zo=["necklace","earring","earrings","bracelet","ring","pendant","brooch","watch","wristwatch","wristband","glasses","sunglasses","goggles","monocle","crown","tiara","veil","hair ribbon","hairpin","hair pin","scrunchie","hair ornament","airpods","earbuds","earbud","earphones","earphone","headphones","headset","in one ear","wireless earbuds"]})),Uo,Ru=$((()=>{Uo=["bag","backpack","purse","handbag","briefcase","suitcase","pouch","satchel","badge","id card","lanyard","name badge","nameplate","sword","katana","knife","dagger","gun","pistol","rifle","spear","axe","staff","wand","blade","weapon","shield","crossbow","scythe","hammer","umbrella","phone","smartphone","book","clipboard","folder","cigarette","microphone","camera","holding"]}));function qt(e){const t=G(e).toLowerCase();return t?["girl","female","f","woman","여자","여"].includes(t)?"girl":["boy","male","m","man","남자","남"].includes(t)?"boy":["other","unknown","unset","미정","기타"].includes(t)?"other":"":""}function Fu(...e){const t=new Set(["girl","woman","female"]),n=new Set(["boy","man","male"]);let r=0,a=0;for(const i of e)for(const o of String(i??"").split(",")){let s=o.trim().toLowerCase();if(!s)continue;const c=s.match(/^\d+(?:\.\d+)?::(.+)::$/);c&&(s=c[1].trim().toLowerCase()),s=s.replace(/_/g," ").trim(),t.has(s)&&(r+=1),n.has(s)&&(a+=1)}return r>a?"girl":a>r?"boy":""}function rt(e){const t=Array.isArray(e)?e:String(e??"").split(/[,/\n]/),n=[],r=new Set;for(const a of t){const i=G(a),o=kt(i);!i||r.has(o)||(r.add(o),n.push(i))}return n}function Du(e){const t=G(e).split(" ").filter(Boolean);return t.length!==2||!t.every(n=>/^[A-Za-z'-]+$/.test(n))||!t.every(n=>n===n.toUpperCase())?{surname:"",given_name:""}:{surname:t[0],given_name:t[1]}}function Oe(e={}){const t=G(e.name),n=Du(t);return{...e,id:G(e.id)||t,name:t,aliases:rt(e.aliases),surname:G(e.surname)||n.surname,given_name:G(e.given_name)||n.given_name,surname_variants:rt(e.surname_variants),given_name_variants:rt(e.given_name_variants),priority:Number.isFinite(Number(e.priority))?Number(e.priority):0,attire_locked:e.attire_locked!==!1,accessories_locked:e.accessories_locked!==!1,gender:qt(e.gender??e.sex),schema_version:2}}function gr(e,t,n){const r=Oe(e);return new Set(rt([r[t],...r[n]||[]]).map(kt).filter(Boolean))}function Jo(e,t){const n=Oe(e),r=Oe(t),a=gr(n,"surname","surname_variants"),i=gr(r,"surname","surname_variants"),o=gr(n,"given_name","given_name_variants"),s=gr(r,"given_name","given_name_variants");if(!a.size||!i.size||!o.size||!s.size)return!1;const c=[...a].some(f=>i.has(f)),l=[...o].some(f=>s.has(f));return c&&l}function Ho(e,t){if(!e||!t)return!1;const n=Oe(e),r=Oe(t);if(n.id&&r.id&&String(n.id)===String(r.id)||Jo(n,r))return!0;const a=fa(n),i=fa(r);for(const o of a)if(i.has(o))return!0;return!1}function fa(e){const t=Oe(e),n=new Set,r=s=>{const c=kt(s);c&&n.add(c)};r(t.name);const a=new Set(rt([t.surname,...t.surname_variants]).map(kt));for(const s of t.aliases)a.has(kt(s))||r(s);const i=rt([t.surname,...t.surname_variants]),o=rt([t.given_name,...t.given_name_variants]);for(const s of i)for(const c of o)r(`${s} ${c}`),r(`${s}${c}`),r(`${c} ${s}`);return n}function zu(e,t=[]){const n=kt(e);if(!n)return null;const r=t.map(a=>Oe(a)).filter(a=>fa(a).has(n));return r.length!==1?null:r[0]}function Uu(e,t){const n=Number(t.priority||0)-Number(e.priority||0);if(n)return n;const r=Number(e.created_at||e.updated_at||0)-Number(t.created_at||t.updated_at||0);return r||String(e.id).localeCompare(String(t.id))}function da(...e){return rt(e.flat())}function Ju(e){const t=[...e].sort(Uu),n={...t[0]};n.aliases=da(...t.map(r=>[r.name,...r.aliases||[]])),n.surname_variants=da(...t.map(r=>[r.surname,...r.surname_variants||[]])),n.given_name_variants=da(...t.map(r=>[r.given_name,...r.given_name_variants||[]])),n.surname||(n.surname=t.map(r=>r.surname).find(Boolean)||""),n.given_name||(n.given_name=t.map(r=>r.given_name).find(Boolean)||"");for(const r of t){const a=G(r.appearance||""),i=G(r.attire||""),o=G(r.accessories||""),s=G(r.original||"");a.length>G(n.appearance||"").length&&(n.appearance=a),!ma(n.attire_locked)&&i.length>G(n.attire||"").length&&(n.attire=i),!ma(n.accessories_locked)&&o.length>G(n.accessories||"").length&&(n.accessories=o),s&&!G(n.original||"")&&(n.original=s)}return n.surname=G(n.surname)||t.map(r=>G(r.surname)).find(Boolean)||"",n.given_name=G(n.given_name)||t.map(r=>G(r.given_name)).find(Boolean)||"",n}function Hu(e=[]){const t=e.map(a=>Oe(a)),n=[],r=new Set;for(let a=0;a<t.length;a++){if(r.has(a))continue;const i=[t[a]];r.add(a);for(let o=a+1;o<t.length;o++)r.has(o)||i.some(s=>Jo(s,t[o]))&&(r.add(o),i.push(t[o]));n.push(i)}return{records:t,active:n.map(Ju),groups:n}}var G,kt,ma,pa=$((()=>{G=e=>String(e??"").trim().replace(/\s+/g," "),kt=e=>G(e).normalize("NFKC").toLocaleLowerCase().replace(/[\s_.·•･-]+/g,""),ma=e=>e!==!1}));function hr(e){const t=Oe(e||{}),n=W([t.name,...t.aliases||[]]),r=W([t.surname,...t.surname_variants||[]]),a=W([t.given_name,...t.given_name_variants||[]]);for(const i of r)for(const o of a)n.push(`${i} ${o}`,`${i}${o}`,`${o} ${i}`);return W(n).filter(i=>!r.some(o=>U(o)===U(i)))}function ye(e,t){return zu(e,t||[])}function ga(e,t,n=6){const r=Math.max(1,Math.min(6,Number(n)||6)),a=[],i=new Set,o=(s,c)=>{if(!s||!c)return s;for(const l of["action","expression","attire","accessories","appearance","label","age","body","sex","original","original_tag","negative"]){const f=u(s[l]||"",2e3),d=u(c[l]||"",2e3);d&&(f?f.toLowerCase().includes(d.toLowerCase())||(s[l]=I(f,d)):s[l]=d)}return s};for(const s of e||[]){if(!s||typeof s!="object")continue;const c=u(s.name,200);if(!c)continue;const l=ye(c,t),f=l?`id:${u(l.id||l.name,200)}`:`name:${U(c)}`;if(!f||f==="id:"||f==="name:")continue;const d=a.findIndex(m=>m._dedupeKey===f);if(d>=0){o(a[d],s);continue}a.length>=r||(i.add(f),a.push({...s,name:l?.name||c,_dedupeKey:f}))}return a.map(({_dedupeKey:s,...c})=>c)}function Tn(e){const t=new Set;for(const r of hr(e)){const a=U(r);a&&t.add(a)}const n=U(e?.name);return n&&t.add(n),t}function ha(e){return Hu(e||[]).active}function Ku(e,t){const n=u(e).toLowerCase(),r=wt(e);if(!n)return[];const a=[],i=new Set;for(const o of t||[]){const s=u(o.id||o.name,200);if(!(!s||i.has(s)))for(const c of hr(o)){const l=U(c),f=wt(c);if(!(f.length<2)&&(n.includes(l)||r.includes(f))){a.push(o),i.add(s);break}}}return a}function Gt(e,t=""){if(typeof e!="object"||e===null)return null;const n=e,r=u(n.name||t,200);if(!r)return null;let a=W(n.aliases);a=[r,...a.filter(d=>U(d)!==U(r))];const i=u(n.original||n.original_tag||n.copyright||"",400);let o=u(n.appearance||"",4e3),s=u(n.attire||"",4e3),c=u(n.accessories||"",4e3);const l=u(n.tags||"",4e3);l&&!o&&!s&&!c&&(o=l),i&&o&&(o=I(...o.split(",").filter(d=>U(d)!==U(i))));let f=u(n.id,80)||r.replace(/[^a-zA-Z0-9_\uac00-\ud7a3]+/g,"_").replace(/^_|_$/g,"").slice(0,64);return f||(f=`char_${Math.abs(_u(r))%1e7}`),Oe({...n,id:f,name:r,aliases:a,original:i,appearance:o,attire:s,accessories:c,gender:qt(n.gender??n.sex)})}function qu(e,t,n={}){const r=Array.isArray(e)?e:[],a=Array.isArray(t)?t:[],i=typeof n.hasAppearance=="function"?n.hasAppearance:()=>!1,o=typeof n.resolve=="function"?n.resolve:()=>null,s=typeof n.aliasKeys=="function"?n.aliasKeys:()=>new Set,c=typeof n.normalizeName=="function"?n.normalizeName:m=>String(m||"").trim().toLowerCase(),l=typeof n.clean=="function"?n.clean:m=>String(m||"").trim(),f=[],d=new Set;for(const m of r){if(!l(m?.name,200)||i(m))continue;const p=o(m.name,a);if(p&&i(p))continue;for(const h of s(m))d.add(h);const g=c(m.name);g&&d.add(g)}for(const m of a)[...s(m)].some(p=>d.has(p))||f.push(m);for(const m of r){const p=o(m.name,f);if(!(p&&i(m))){if(p&&!i(m)){if(i(p))continue;const g=f.findIndex(h=>o(m.name,[h]));g>=0?f[g]=m:f.push(m);continue}p||f.push(m)}}return f}var Wt=$((()=>{O(),pa()}));function _a(e){const t=u(e).toLowerCase();return t?yr(t,Yo):!1}function Ko(e){const t=u(e).toLowerCase();return!t||_a(t)?!1:yr(t,Vo)}function Gu(e){return _a(e)||Ko(e)}function Wu(e){const t=u(e).toLowerCase();return!t||Gu(t)?!1:yr(t,Wo)}function Vu(e){const t=[],n=[],r=[];for(const a of u(e).split(",")){const i=a.trim();i&&(_a(i)?r.push(i):Ko(i)||Wu(i)?n.push(i):t.push(i))}return[I(...t),I(...n),I(...r)]}function Yu(e){if(e===!0||e===1)return!0;const t=u(e,20).toLowerCase();return t==="true"||t==="on"||t==="1"}function Xu(e){if(e==null||e===!1)return 0;if(e===!0)return 3;if(typeof e=="number"&&Number.isFinite(e)){const n=Math.floor(e);return n<=0?0:n===1?1:n===2?2:3}const t=u(e,40).toLowerCase().replace(/_/g," ").trim();return!t||t==="off"||t==="false"||t==="0"||t==="none"?0:t==="1"||t==="torn"||t==="torn clothes"?1:t==="2"||t==="nude"?2:t==="3"||t==="on"||t==="true"||t==="completely"||t==="completely nude"||t==="complete"?3:0}function Zu(e,t,n=null){const r=u(e,4e3);if(t<=0)return r;let a="";return t===1?a="2::torn clothes::":t===2?a="2.5::nude::":n==="m"?a="2.5::completely nude::":a="2::completely nude::",n==="f"?I(r,a,"nipples","pussy"):n==="m"?I(r,a,"penis"):I(r,a)}function Qu(e){const[t,n]=Vu(e);return[t,n]}function ef(...e){const t=[];for(const n of e)if(n!=null)for(const r of u(n).split(",")){let a=r.trim().toLowerCase();if(!a)continue;const i=a.match(/^\d+(?:\.\d+)?::(.+)::$/);i&&(a=i[1].trim().toLowerCase()),a=a.replace(/_/g," ").trim(),a&&t.push(a)}return t}function tf(...e){const t=ef(...e);if(!t.length)return null;let n=0,r=0;for(const a of t)(Zo.has(a)||/^\d+\+?girls?$/.test(a))&&(n+=1),(Qo.has(a)||/^\d+\+?boys?$/.test(a))&&(r+=1);return n>r?"f":r>n?"m":null}function jn(e,t){const n=qt(e?.gender??t?.gender??t?.sex);return n==="girl"?"f":n==="boy"?"m":n==="other"?null:tf(t?.appearance,t?.attire,t?.accessories,e?.appearance,e?.attire,e?.accessories,e?.label,e?.age,e?.body,e?.prompt,e?.sex)}function _r(e,t,n,r){return e<=0?"":e===1?t:e<=5?`${e}${n}`:r}function nf(e,t){const n=[],r=_r(e,"1girl","girls","6+girls"),a=_r(t,"1boy","boys","6+boys");return r&&n.push(r),a&&n.push(a),n.join(", ")}function qo(e){const t=u(e);if(!t)return"";const n=[];for(const r of Vi(t)){const a=r.trim();a&&(ba.test(a)||es.test(a)||ts.test(a)||n.push(a))}return I(...n)}function ya(e){const t=[],n=new Set;for(const r of u(e).split(",")){let a=r.trim();if(!a)continue;if(ba.test(a)){const o=a.toLowerCase();if(o.includes("girl"))a="girl";else if(o.includes("boy"))a="boy";else continue}const i=a.toLowerCase();n.has(i)||(n.add(i),t.push(a))}return I(...t)}function rf(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function af(e,t=3){const n=u(e,200);if(!n)return"";const r=rf(t);return r<=0?n:`${r}::${n}::`}function Go(e,t=null){let n=e;if(n==null&&t!=null&&(n=t),n===!1)return"off";if(n===!0)return"gender";const r=u(n,40).toLowerCase();return["","auto","mixed","true","1","on"].includes(r)?"gender":["off","none","false","0","disable","disabled"].includes(r)?"off":["girl","all_girls","girls_only"].includes(r)?"girls":["person","persons"].includes(r)?"people":ns(r)?r:"gender"}function of(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function sf(e,t,n="gender",r=null,a=!1){const i=(e||[]).slice(0,6),o=i.length;if(o<=0)return"";if(of(a)&&o===1)return"solo";const s=Go(n,r);if(s==="off")return"";if(s==="girls")return _r(o,"1girl","girls","6+girls");if(s==="people")return _r(o,"1person","people","6+people");let c=0,l=0,f=0;for(const d of i){const m=u(d.name,200),p=m?ye(m,t):null,g=jn(d,p);g==="f"?c++:g==="m"?l++:qt(d.gender??p?.gender)==="other"||f++}return c+=f,nf(c,l)}function $n(e){return I(e?.original||"",e?.appearance||"",e?.attire||"",e?.accessories||"")}function Me(e){if(typeof e!="object"||e===null)return!1;const t=e;let n=u(t.appearance||"",4e3);if(!n)return!1;const r=u(t.original||"",400);r&&(n=I(...n.split(",").filter(o=>U(o)!==U(r))));const[a]=Qu(n);if(n=u(a||"",4e3),!n)return!1;const i=new Set(["girl","boy","man","woman","male","female","1girl","1boy","2girls","2boys","solo","other"]);return n.split(",").map(o=>o.trim().toLowerCase()).filter(Boolean).filter(o=>!i.has(o)&&!/^\d+(girl|boy)s?$/.test(o)).length>0}function oe(e){return e!==!1}function cf(e,t){const n=Me(e),r=u(t?.original||t?.original_tag||"",400),a=u(e?.original||"",400),i=u(e?.attire||"",4e3),o=u(e?.accessories||"",4e3),s=u(t?.attire||"",4e3),c=u(t?.accessories||"",4e3),l=oe(e?.attire_locked)?i:s||i,f=oe(e?.accessories_locked)?o:c||o,d=Xu(t?.nude),m=Yu(t?.weapon),p=Zu(l,d,jn(t,e)),g=m?f:"";return ya(n?I(a||r,e?.appearance,p,g,t?.expression,t?.action,t?.sex):I(a?"":r,t?.label,t?.age,t?.appearance,t?.body,p,g,t?.expression,t?.action,t?.sex))}function at(e){const t=typeof e=="object"&&e?e:{},n=P(t.character_max??t.char_max??6,6);return Math.max(1,Math.min(6,n))}var Wo,Vo,Yo,Xo,Zo,Qo,ba,es,wa,ts,ns,yr,it=$((()=>{Lu(),Bu(),Ru(),O(),pa(),Wt(),Wo=Do,Vo=zo,Yo=Uo,Xo=["off","girls","people","gender"],Zo=new Set(["girl","woman","female"]),Qo=new Set(["boy","man","male"]),ba=/^\d+\+?(?:girls?|boys?|people|person)$/i,es=/^(?:1girl|1boy)$/i,wa="(?:\\d+\\+?(?:girls?|boys?|people|person)|1girl|1boy|solo)",ts=new RegExp(`^-?\\d+(?:\\.\\d+)?::\\s*${wa}(?:\\s*,\\s*${wa})*\\s*::$`,"i"),ns=e=>Xo.includes(e),yr=(e,t)=>t.some(n=>{if(n.length<=3){const r=n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?:^|[^a-z0-9])${r}(?:[^a-z0-9]|$)`,"i").test(e)}return e.includes(n)})}));Q(),Lo(),fe(),it(),O();function lf(e,t,n,r){let a=u(e);if(!a)return"";for(const s of r){const c=u(s);if(c)if(a.endsWith(c))a=a.slice(0,a.length-c.length).replace(/[,\s]+$/g,"");else{const l=a.lastIndexOf(c);l>=0&&(a=`${a.slice(0,l)}${a.slice(l+c.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}}const i=u(t);if(i)if(a.startsWith(i))a=a.slice(i.length).replace(/^[,\s]+/g,"");else{const s=a.indexOf(i);s>=0&&(a=`${a.slice(0,s)}${a.slice(s+i.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}const o=[...n].map(s=>u(s)).filter(Boolean).sort((s,c)=>c.length-s.length);for(const s of o){const c=a.indexOf(s);c<0||(a=`${a.slice(0,c)}${a.slice(c+s.length)}`.replace(/,\s*,/g,",").replace(/^[,\s]+|[,\s]+$/g,""))}return u(a)}function uf(e){const t=u(e.setup),n=u(e.main);if(!n)return{lockedSetup:t,rebuildMain:!0};if(t&&t!==n)return{lockedSetup:t,rebuildMain:!0};const r=u(e.person);if(r||e.stylePositives&&e.stylePositives.length){const a=lf(n,r,e.stylePositives||[],e.qualitySuffixes||[]);if(a&&a!==n)return{lockedSetup:a,rebuildMain:!0}}return{lockedSetup:"",rebuildMain:!1}}function ff(e){if(!e||typeof e!="object")return[];const t=[],n=u(e.custom_pos);n&&t.push(n);const r=Array.isArray(e.presets)?e.presets:[];for(const a of r){if(!a||typeof a!="object")continue;const i=a,o=u(i.positive||i.pos);o&&t.push(o)}return t}async function rs(e,t,n){const r=new Blob([e],{type:t});let a=null;if(typeof createImageBitmap=="function"?a=await createImageBitmap(r):n&&typeof document<"u"&&(a=await new Promise((s,c)=>{const l=new Image,f=URL.createObjectURL(r);l.onload=()=>{URL.revokeObjectURL(f),s(l)},l.onerror=()=>{URL.revokeObjectURL(f),c(new Error("image decode failed"))},l.src=f})),!a)return null;const i=a,o="naturalWidth"in i?{w:i.naturalWidth,h:i.naturalHeight}:{w:0,h:0};return{source:i,width:i.width||o.w||0,height:i.height||o.h||0,close:()=>{try{"close"in i&&i.close()}catch{}}}}function as(e,t,n,r){if(r&&typeof OffscreenCanvas<"u"){const a=new OffscreenCanvas(t,n),i=a.getContext("2d");return i?(i.drawImage(e.source,0,0,t,n),{kind:"offscreen",canvas:a}):null}if(typeof document<"u"){const a=document.createElement("canvas");a.width=t,a.height=n;const i=a.getContext("2d");return i?(i.drawImage(e.source,0,0,t,n),{kind:"dom",canvas:a}):null}return null}async function df(e,t=.8){const n=V(e);if(!n.length)return null;if(Mn(n))return Z(n);const r=Nn(n);try{const a=await rs(n,r,!0);if(!a)return null;if(!(a.width>0&&a.height>0))return a.close(),null;const i=as(a,a.width,a.height,!0);if(!i)return a.close(),null;let o;if(i.kind==="offscreen"){const c=await i.canvas.convertToBlob({type:"image/webp",quality:t});if(a.close(),!c||!c.size)return null;o=await c.arrayBuffer()}else o=hu(i.canvas.toDataURL("image/webp",t)),a.close();if(!o)return null;const s=V(o);return!Mn(s)||s.length>=n.length*.98?null:o}catch(a){return w("image.webp.encode.fail",{message:String(a?.message||a)},"warn"),null}}async function mf(e){let t=V(e);if(!t.length)throw new Error("image is empty");const n=1536,r=12e5,a=Nn(t),i=t.length>r;try{const o=await rs(t,a,!1);if(o&&(i||o.width>n||o.height>n)){const s=Math.min(1,n/Math.max(o.width,o.height,1)),c=as(o,Math.max(1,Math.round(o.width*s)),Math.max(1,Math.round(o.height*s)),!1);if(c?.kind==="dom"){const l=await new Promise(f=>{c.canvas.toBlob(f,"image/png")});if(l)return t=new Uint8Array(await l.arrayBuffer()),o.close(),{bytes:t,mime:"image/png",filename:"image.png"}}}o?.close()}catch(o){w("autotag.resize",{message:String(o?.message||o)},"warn")}return{bytes:t,mime:a,filename:`image.${a==="image/jpeg"?"jpg":a==="image/webp"?"webp":"png"}`}}async function br(){return Vt||(Vt=(async()=>{const e=Ae();if(typeof e?.getLocalPluginStorage=="function")try{const n=ue("storage.open"),r=await e.getLocalPluginStorage();if(va(r))return n.end({message:"idb/getLocalPluginStorage"}),{kind:"idb",api:r};n.end({message:"getLocalPluginStorage returned unusable api"},"warn")}catch(n){w("storage.open",{message:String(n?.message||n)},"error"),console.warn("[Inlay Nexus] getLocalPluginStorage failed",n?.message||n)}const t=e?.pluginStorage;if(va(t))return w("storage.open",{message:"fallback pluginStorage (save-file)"},"warn"),console.warn("[Inlay Nexus] falling back to pluginStorage (save-file scoped)"),{kind:"plugin",api:t};throw w("storage.open",{message:"no storage API"},"error"),new Error("기기 로컬 IndexedDB 저장소(getLocalPluginStorage)를 사용할 수 없습니다.")})().catch(e=>{throw Vt=null,e}),Vt)}function pf(){return Ae()?.pluginStorage??null}async function Ne(e,t){try{const{kind:n,api:r}=await br(),a=await r.getItem(e);if(a!=null&&a!=="")return a;if(n==="idb"&&t){const i=pf();if(i?.getItem)try{const o=await i.getItem(t);if(o!=null&&o!=="")return await r.setItem(e,o),o}catch{}}return null}catch{return null}}function gf(e){if(typeof e=="string")return e.length;try{return JSON.stringify(e).length}catch{return 0}}async function Ie(e,t){const{kind:n,api:r}=await br(),a=gf(t),i=a>5e4?ue("storage.set.large"):null;try{return await r.setItem(e,t),i?i.end({message:e,bytes:a,kind:n,background:!0}):a>8e3&&w("storage.set",{message:e,bytes:a,kind:n,background:!0}),!0}catch(o){throw i?i.fail(o,{message:e,bytes:a,kind:n,background:!0}):w("storage.set",{message:`${e}: ${o?.message||o}`,bytes:a,kind:n,background:!0},"error"),o}}async function de(e){try{const{api:t}=await br();t?.removeItem&&await t.removeItem(e)}catch{}}var va,Vt,wr=$((()=>{q(),pt(),va=e=>typeof e?.getItem=="function"&&typeof e?.setItem=="function",Vt=null})),is,os,Yt,hf=$((()=>{is=class{budgetChars;urls=new Map;pinned=new Set;bytes=0;constructor(e){this.budgetChars=e}get size(){return this.urls.size}get byteLength(){return this.bytes}get(e){const t=String(e||"");if(!t)return;const n=this.urls.get(t);if(n!==void 0)return this.urls.delete(t),this.urls.set(t,n),n}set(e,t){const n=String(e||"");if(!n||typeof t!="string"||!t)return;const r=this.urls.get(n);r!==void 0&&(this.bytes-=r.length),this.urls.delete(n),this.urls.set(n,t),this.bytes+=t.length,this.evict()}drop(e){const t=String(e||""),n=this.urls.get(t);n!==void 0&&(this.urls.delete(t),this.bytes-=n.length,this.pinned.delete(t))}pin(e){this.pinned.clear();for(const t of e){const n=String(t||"");if(!n)continue;this.pinned.add(n);const r=this.urls.get(n);r!==void 0&&(this.urls.delete(n),this.urls.set(n,r))}this.evict()}pinnedIds(){return[...this.pinned]}clear(){this.urls.clear(),this.pinned.clear(),this.bytes=0}evict(){if(!(this.bytes<=this.budgetChars))for(const[e,t]of this.urls){if(this.bytes<=this.budgetChars)break;this.pinned.has(e)||(this.urls.delete(e),this.bytes-=t.length)}}},os=33554432,Yt=new is(os)}));function ss(e){const t=String(e.session_id??"");if(!t)return;let n=Xt.get(t);n||(n=new Set,Xt.set(t,n)),n.add(String(e.id))}function cs(e){if(!e)return;const t=String(e.session_id??""),n=t?Xt.get(t):void 0;n&&(n.delete(String(e.id)),n.size===0&&Xt.delete(t))}function ls(e,t){if(e==="characters"){if(Array.isArray(t))return`${t[0]}	${t[1]}`;if(t&&typeof t=="object"){const n=t;return`${n.scope}	${n.id}`}}return String(t)}function _f(e,t){if(!t||typeof t!="object")return"";const n=t;return e==="meta"?String(n.key||""):e==="characters"?`${n.scope}	${n.id}`:String(n.id||"")}function yf(e){if(!e||typeof e!="object")return e;const t={...e};if(!t.result_json)return t;try{const n=JSON.parse(t.result_json);if(!n||typeof n!="object")return t;const r={...n};delete r.tagged,delete r.appearance,delete r.debug_tail,Array.isArray(r.cards)&&(r.cards=r.cards.map(a=>{if(!a||typeof a!="object")return a;const i={...a};return typeof i.image_url=="string"&&i.image_url.startsWith("data:")&&(i.image_url=""),i})),t.result_json=JSON.stringify(r)}catch{}return t}function bf(e){const t={};if(e==="images"){for(const[n,r]of L.images)t[n]={id:r.id,location:r.location||null,has_png:r.has_png,png_bytes:r.png_bytes,storage:"indexeddb",storage_key:je(n)};return t}for(const[n,r]of L[e]){const a=r;if(e==="meta"&&a?.key==="reference_image"){t[n]={key:"reference_image",has_png:!!a.png,updated_at:a.updated_at||0};continue}if(e==="meta"&&a?.key==="vibe_transfer"){t[n]={key:"vibe_transfer",has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="meta"&&Ut(a?.key)){t[n]={key:a.key,has_png:!!a.png,has_encoded:!!a.encoded,model:a.model||"",information_extracted:a.information_extracted??1,updated_at:a.updated_at||0};continue}if(e==="jobs"){t[n]=yf(a);continue}t[n]=r}return t}async function wf(e){await Ie(Zr(e),bf(e))}function us(){Mt=null;const e=[...Ln];Ln.clear(),e.length&&(vr=vr.then(async()=>{for(const t of e){if(hs){w("storage.persist.skip",{message:t,background:!0});continue}try{await wf(t)}catch(n){console.warn("[Inlay Nexus] persist failed",t,n?.message||n)}}}).catch(()=>{}))}function St(e){Ln.add(e),!Mt&&(Mt=setTimeout(us,gs))}async function fs(){Mt&&(clearTimeout(Mt),us()),await vr,await se}function vf(){const e=globalThis.document;if(!e?.addEventListener)return;const t=()=>{!Mt&&!Ln.size||fs()};e.addEventListener("visibilitychange",()=>{e.visibilityState==="hidden"&&t()}),globalThis.addEventListener?.("pagehide",t)}function xf(e,t){L.images.delete(e),L.images.set(e,t)}function ds(e){if(Nt+=e,!(Nt<=xa))for(const t of L.images.values()){if(Nt<=xa)break;!t.png||!t.durable||(Nt-=t.png.byteLength,t.png=null,t.hydrated=!1)}}async function kf(e,t){if(t.hydrated)return t.png;const n=xr.get(e);if(n)return n;const r=(async()=>{const a=Bn(await Ne(je(e),Li(e)));return t.png=a,t.hydrated=!0,t.durable=!0,a?(t.png_bytes=a.byteLength,ds(a.byteLength)):(t.has_png=!1,t.png_bytes=0),a})().finally(()=>xr.delete(e));return xr.set(e,r),r}async function ot(){return Zt||(Zt=(async()=>{for(const e of Di){const t=await Ne(Zr(e),Oi(e));if(t==null||t==="")continue;let n=t;if(typeof t=="string")try{n=JSON.parse(t)}catch{continue}if(!(!n||typeof n!="object"))for(const[r,a]of Object.entries(n)){const i=a??{};if(e==="images"){const o=!!i.has_png;L.images.set(r,{id:String(i.id||r),location:i.location||{},png:null,has_png:o,png_bytes:Number(i.png_bytes)||0,hydrated:!o,durable:!0})}else if(e==="meta"&&(i.key==="reference_image"||r==="reference_image")){const o=Bn(await Ne(pn,Bi));L.meta.set("reference_image",{key:"reference_image",png:o})}else if(e==="meta"&&(i.key==="vibe_transfer"||r==="vibe_transfer")){const o=Bn(await Ne(gn));let s=await Ne(hn);if(typeof s=="string")try{s=JSON.parse(s)}catch{s=null}const c=s??{};L.meta.set("vibe_transfer",{key:"vibe_transfer",png:o,encoded:c.encoded||"",model:c.model||i.model||"",information_extracted:c.information_extracted??i.information_extracted??1})}else if(e==="meta"&&Ut(i.key||r)){const o=String(i.key||r),s=bn(o),c=Bn(await Ne(_n(s)));let l=await Ne(yn(s));if(typeof l=="string")try{l=JSON.parse(l)}catch{l=null}const f=l??{};L.meta.set(o,{key:o,png:c,encoded:f.encoded||"",model:f.model||i.model||"",information_extracted:f.information_extracted??i.information_extracted??1})}else if(e==="cards"){const o=i;L.cards.set(r,o),ss(o)}else L[e].set(r,i)}}return!0})().catch(e=>{throw Zt=null,e}),Zt)}async function z(e,t){await ot();const n=ls(e,t);if(e==="images"){const a=L.images.get(n);return a?(a.hydrated?a.png&&xf(n,a):await kf(n,a),a):void 0}const r=L[e].get(n);return r??void 0}async function Sf(e){await ot();const t=L.images.get(String(e));if(t)return{has_png:t.has_png,png_bytes:t.png_bytes}}async function F(e,t,n={}){await ot();const r=_f(e,t);if(!r)throw new Error(`invalid ${e} key`);const a=n.persist!==!1;if(e==="images"){const i=t.png||null,o=L.images.get(r);o?.png&&(Nt-=o.png.byteLength);const s={id:String(t.id),location:t.location||{},...typeof t.mime=="string"&&t.mime?{mime:t.mime}:{},png:i,has_png:!!i,png_bytes:i?i.byteLength:0,hydrated:!0,durable:!i};return L.images.set(r,s),i?(ds(i.byteLength),se=se.then(async()=>{const c=await Qe(new Uint8Array(i));await Ie(je(r),c),L.images.get(r)===s&&(s.durable=!0)}).catch(c=>console.warn("[Inlay Nexus] image persist failed",r,c?.message||c))):se=se.then(()=>de(je(r))).catch(()=>{}),a&&St("images"),r}if(e==="meta"&&t.key==="reference_image"){const i=t.png||null;return L.meta.set("reference_image",{key:"reference_image",png:i}),i?se=se.then(async()=>{await Ie(pn,await Qe(new Uint8Array(i)))}).catch(o=>console.warn("[Inlay Nexus] ref persist failed",o?.message||o)):se=se.then(()=>de(pn)).catch(()=>{}),a&&St("meta"),"reference_image"}if(e==="meta"&&t.key==="vibe_transfer"){const i={key:"vibe_transfer",png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return L.meta.set("vibe_transfer",i),se=se.then(async()=>{i.png?await Ie(gn,await Qe(new Uint8Array(i.png))):await de(gn),i.encoded?await Ie(hn,{encoded:i.encoded,model:i.model,information_extracted:i.information_extracted}):await de(hn)}).catch(o=>console.warn("[Inlay Nexus] vibe persist failed",o?.message||o)),a&&St("meta"),"vibe_transfer"}if(e==="meta"&&Ut(t.key)){const i=String(t.key),o=bn(i),s={key:i,png:t.png||null,encoded:t.encoded||"",model:t.model||"",information_extracted:t.information_extracted??1};return L.meta.set(i,s),se=se.then(async()=>{s.png?await Ie(_n(o),await Qe(new Uint8Array(s.png))):await de(_n(o)),s.encoded?await Ie(yn(o),{encoded:s.encoded,model:s.model,information_extracted:s.information_extracted}):await de(yn(o))}).catch(c=>console.warn("[Inlay Nexus] preset vibe persist failed",c?.message||c)),a&&St("meta"),i}if(e==="cards"){cs(L.cards.get(r));const i=t;return L.cards.set(r,i),ss(i),a&&St("cards"),r}return L[e].set(r,t),a&&St(e),r}async function At(e,t){await ot();const n=ls(e,t);if(e==="cards"&&cs(L.cards.get(n)),e==="images"){const r=L.images.get(n);r?.png&&(Nt-=r.png.byteLength)}if(L[e].delete(n),e==="images"&&await de(je(n)),e==="meta"&&n==="reference_image"&&await de(pn),e==="meta"&&n==="vibe_transfer"&&(await de(gn),await de(hn)),e==="meta"&&Ut(n)){const r=bn(n);await de(_n(r)),await de(yn(r))}return St(e),e==="images"&&ps(n),!0}async function be(e){return await ot(),[...L[e].values()]}async function ms(e){await ot();const t=Xt.get(String(e));if(!t)return[];const n=[];for(const r of t){const a=L.cards.get(r);a&&n.push(a)}return n}function Pn(e){return L[e].size}function Af(){let e=0;for(const t of L.images.values())e+=t.png_bytes;return e}function Mf(){const e=[];for(const t of L.images.values())e.push(t.location||{});return e}async function Nf(e){await ot();const t=L.images.get(String(e))?.location;return t&&typeof t=="object"?t:{}}function On(e){return Yt.get(String(e))}function If(e,t){Yt.set(String(e),t)}function ps(e){Yt.drop(String(e))}function Cf(e){Yt.pin(e)}function Ef(){return Yt.size}async function Tf(e){return(await z("images",String(e)))?.png??null}var L,Xt,gs,Ln,Mt,vr,se,hs,xa,Nt,xr,Bn,Zt,Le=$((()=>{ee(),q(),Q(),wr(),hf(),L={meta:new Map,cards:new Map,characters:new Map,jobs:new Map,images:new Map},Xt=new Map,gs=25,Ln=new Set,Mt=null,vr=Promise.resolve(),se=Promise.resolve(),hs=!1,vf(),xa=100663296,Nt=0,xr=new Map,Bn=e=>typeof e=="string"&&e?gu(e):null,Zt=null}));q(),Q(),_t(),Le();async function Qt(e){if(!e)return"";const t=On(e);if(t!==void 0)return t;const n=ue("image.data_url"),r=await z("images",e);if(!r?.png)return n.end({message:`missing png ${e}`,id:e,background:!0},"warn"),"";const a=typeof r.mime=="string"&&r.mime||Nn(r.png),i=`data:${a};base64,${await pu(r.png)}`;return If(e,i),n.end({message:e,bytes:r.png.byteLength||0,mime:a,url_len:i.length,focus:!0}),i}function Be(e){const t=typeof e=="string"?e:e?.id;return t&&On(String(t))||""}async function ka(e,t,n=null){const r=ue("image.publish");ps(e);let a=t,i=Nn(t);try{const s=await df(t,.8);s&&(a=s,i="image/webp")}catch(s){w("image.webp",{message:String(s?.message||s),id:e},"warn")}await F("images",{id:e,png:a,mime:i,location:n||{}});let o="";try{const s=Qt(e);o=await Promise.race([s,Ze(5e3).then(()=>Be(e)||"")]),o||(w("image.data_url.defer",{message:e,bytes:a?.byteLength||0,mime:i,focus:!0},"warn"),s.catch(c=>console.warn("[Inlay Nexus] deferred data URL failed",c?.message||c)))}catch(s){w("image.data_url",{message:String(s?.message||s),id:e},"warn"),Promise.resolve().then(()=>Qt(e)).catch(()=>{})}return r.end({message:e,bytes:a?.byteLength||0,src_bytes:t?.byteLength||0,mime:i,has_url:!!o,has_location:!!(n&&Object.keys(n).length),focus:!0}),o}var Sa=2,en=new Set,we=[],ze=0,Re=0,Ue=0,_s=null;function jf(){const e=we.length+ze,t=Math.max(Re,Ue+e),n=Math.min(Ue,t),r=t>0?Math.max(0,Math.min(100,Math.round(n/t*100))):0;return{pending:e,active:ze,done:n,total:t,pct:r,busy:e>0}}function $f(e){_s=typeof e=="function"?e:null}function It(){try{_s?.()}catch{}}function Aa(){for(;ze<Sa&&we.length;){const e=we.shift();ze+=1,It(),Qt(e).catch(()=>{}).finally(()=>{ze-=1,en.delete(e),Ue+=1,we.length===0&&ze===0&&(Re=0,Ue=0),It(),Aa()})}}function Pf(e){const t=String(e||"");!t||On(t)!==void 0||en.has(t)||(en.add(t),we.push(t),Re+=1,It(),Aa())}function Of(e=[]){const t=[...new Set((e||[]).map(String).filter(Boolean))];if(Cf(t),!t.length)return;const n=new Set(t),r=we.length,a=[];for(const c of we)n.has(c)?a.push(c):en.delete(c);we.length=0;const i=[];for(const c of t)On(c)===void 0&&(en.has(c)||(en.add(c),Re+=1),i.includes(c)||i.push(c));const o=a.filter(c=>!i.includes(c));we.push(...i,...o);const s=r-a.length;s>0&&(Re=Math.max(Ue+we.length+ze,Re-s)),It(),Aa()}async function Lf(e=[],{concurrency:t=Sa}={}){const n=[...new Set((e||[]).map(String).filter(Boolean))],r=Math.max(1,Number(t)||Sa),a=n.filter(i=>On(i)===void 0);a.length&&(Re+=a.length,It());for(let i=0;i<a.length;i+=r){const o=a.slice(i,i+r);await Promise.all(o.map(s=>Qt(s).catch(()=>"").finally(()=>{Ue+=1,we.length===0&&ze===0&&Ue>=Re&&(Re=0,Ue=0),It()})))}return we.length===0&&ze===0&&(Re=0,Ue=0,It()),n.map(i=>Be(i)).filter(Boolean)}async function st(e,t={}){if(!e||typeof e!="object")return e;if(Array.isArray(e)){for(let r=0;r<e.length;r+=1)e[r]=await st(e[r],t);return e}const n=e;if(typeof n.id=="string"&&(typeof n.image_url=="string"||n.image_path!=null||"shot_index"in n||"main_prompt"in n)){const r=String(n.id),a=t.ids!=null?new Set([...t.ids].map(String)):null;if(!t.cachedOnly&&(!a||a.has(r))){const i=await Qt(r);i&&(n.image_url=i)}else n.image_url=Be(r)||"",n.image_url||Pf(r);return e}for(const r of Object.keys(n))n[r]&&typeof n[r]=="object"&&(n[r]=await st(n[r],t));return e}function Ct(e){return e?`data:${Nn(e)};base64,${mu(e)}`:""}O();var Bf=new Set(["year 2024","year 2025","year 2026","cowboy shot","looking at viewer","best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration"]),ys=/^(-?\d+(?:\.\d+)?)::([\s\S]*?)::$/;function Ma(e){const t=u(e);if(!t)return[];const n=[];let r="",a=0,i=0,o=0,s=!1;const c=()=>{const l=r.trim();l&&n.push(l),r=""};for(;a<t.length;){const l=t[a];if(!s&&i===0&&o===0){const f=t.slice(a).match(/^(-?\d+(?:\.\d+)?)::/);if(f){c(),s=!0,r=f[0],a+=f[0].length;continue}}if(s){if(r+=l,l===":"&&t[a+1]===":"){for(r+=":",a+=2,s=!1,c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}a+=1;continue}if(l==="{"){i+=1,r+=l,a+=1;continue}if(l==="}"&&i>0){if(i-=1,r+=l,a+=1,i===0&&o===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l==="["){o+=1,r+=l,a+=1;continue}if(l==="]"&&o>0){if(o-=1,r+=l,a+=1,i===0&&o===0)for(c();a<t.length&&(t[a]===","||t[a]===" ");)a+=1;continue}if(l===","&&i===0&&o===0){for(c(),a+=1;a<t.length&&t[a]===" ";)a+=1;continue}r+=l,a+=1}return c(),n}function Rf(e){return/^-\d+(?:\.\d+)?::/.test(e.trim())}function Ff(e){return/artist\s*:/i.test(e)}function bs(e){return e.replace(/[_-]+/g," ").replace(/\s+/g," ").trim()}function Df(e){const t=bs(e);return t==="background"||t.endsWith(" background")}function zf(e){const t=bs(e);return t==="straight on"||t.replace(/\s+/g,"")==="straighton"}function Uf(e){return!!(!e||Bf.has(e)||Df(e)||zf(e))}function ws(e){const t=e.trim();if(t.length<2)return null;const n=t[0],r=n==="{"?"}":n==="["?"]":null;if(!r||t[t.length-1]!==r)return null;let a=0;for(let s=0;s<t.length&&t[s]===n;s+=1)a+=1;let i=0;for(let s=t.length-1;s>=0&&t[s]===r;s-=1)i+=1;const o=Math.min(a,i);return o<1?null:{kind:n==="{"?"brace":"bracket",inner:t.slice(o,t.length-o).trim(),depth:o}}function vs(e,t,n){if(t==="weight")return`${n}::${e}::`;const r=t==="brace"?"{":"[",a=t==="brace"?"}":"]",i=Math.max(1,Number(n)||1);return`${r.repeat(i)}${e}${a.repeat(i)}`}function Na(e){const t=e.trim();if(!t)return[];const n=t.match(ys);if(n){const o=n[1];return n[2].trim().split(",").map(s=>s.trim()).filter(Boolean).map(s=>({plain:s,restore:vs(s,"weight",o)}))}let r=t,a=null,i=0;for(;;){const o=ws(r);if(!o)break;a=o.kind,i=o.depth,r=o.inner}return a?r.split(",").map(o=>o.trim()).filter(Boolean).map(o=>({plain:o,restore:vs(o,a,i)})):[{plain:t,restore:t}]}function Jf(e){const t=[],n=new Map,r=new Set;for(const a of Ma(e))if(!Rf(a)&&!Ff(a))for(const{plain:i,restore:o}of Na(a)){const s=i.toLowerCase();Uf(s)||(n.has(s)||n.set(s,o),!r.has(s)&&(r.add(s),t.push(i)))}return{plains:t,weightMap:n}}function xs(e){return new Set(e.map(t=>t.toLowerCase()).filter(Boolean))}function ks(e){const t=new Map;for(const i of e)for(const[o,s]of i.weightMap)t.has(o)||t.set(o,s);if(!e.length)return{common:[],assets:[],weightMap:t};let n=xs(e[0].plains);for(let i=1;i<e.length;i+=1){const o=xs(e[i].plains);n=new Set([...n].filter(s=>o.has(s)))}const r=[],a=new Set;for(const i of e[0].plains){const o=i.toLowerCase();!n.has(o)||a.has(o)||(a.add(o),r.push(i))}return{common:r,assets:e.map(i=>{const o=[],s=new Set;for(const c of i.plains){const l=c.toLowerCase();n.has(l)||s.has(l)||(s.add(l),o.push(c))}return{name:i.name,unique:o}}),weightMap:t}}function Ss(e){const t=[];t.push("## NovelAI character asset tags (ground truth for new_characters looks)"),t.push("Use ONLY tags from this block for appearance / attire / accessories (clothes, jewelry, weapons included)."),t.push("Do not invent looks outside this list. Asset names hint which outfit belongs to which person."),t.push(""),t.push(`공통: ${e.common.length?e.common.join(", "):"(none)"}`);for(const n of e.assets)t.push(""),t.push(`에셋 \`${n.name}\`:`),t.push(`  ${n.unique.length?n.unique.join(", "):"(no unique tags)"}`);return t.join(`
`)}function Ia(e,t){if(!t?.size)return u(e);const n=[],r=new Set;for(const a of Ma(e)){if(ys.test(a)||ws(a)){const i=a.toLowerCase();if(r.has(i))continue;r.add(i),n.push(a);continue}for(const{plain:i}of Na(a)){const o=i.toLowerCase();!o||r.has(o)||(r.add(o),n.push(t.get(o)||i))}}return I(...n)}function Hf(...e){const t=new Map;for(const n of e)if(n)for(const[r,a]of n)t.has(r)||t.set(r,a);return t}var Kf=dn({isCharacterImageExtraLore:()=>Et,matchCharacterImageSectionTitles:()=>Ns,normalizeNameKey:()=>tn,parseCharacterImageTagLore:()=>Ca,trimCharacterImageTagLore:()=>Ms});function Et(e){return String(e?.comment||e?.name||"").trim().toLowerCase()==="lb-xnai.lb.extra"}function Ca(e){const t=String(e||"");if(!t.trim())return{header:"",sections:[]};const n=/^(#{2,3})\s+(.+?)\s*$/gm,r=[];let a;for(;(a=n.exec(t))!==null;)r.push({hashes:a[1],title:String(a[2]||"").trim(),start:a.index,titleEnd:a.index+a[0].length});if(!r.length)return{header:t.trimEnd(),sections:[]};let i=t.slice(0,r[0].start).trimEnd();const o=[];for(let s=0;s<r.length;s+=1){const c=r[s],l=s+1<r.length?r[s+1].start:t.length,f=t.slice(c.titleEnd,l).replace(/^\r?\n/,"").trimEnd();if(c.title.toLowerCase()==="character image tags"){const d=t.slice(c.start,l).trimEnd();i=i?`${i}

${d}`:d;continue}o.push({title:c.title,hashes:c.hashes,body:f})}return{header:i.trimEnd(),sections:o}}function tn(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}function As(e){return new Set((Array.isArray(e)?e:[]).map(t=>tn(t)).filter(Boolean))}function qf(e,t){if(!t.length)return"";const n=[];e&&n.push(e);for(const r of t){const a=`${r.hashes} ${r.title}`;n.push(r.body?`${a}
${r.body}`:a)}return n.join(`

`).trimEnd()}function Ms(e,t=[],n=[]){const r=Ca(e);if(!r.sections.length)return"";const a=As(n);if(!a.size)return"";const i=As(t),o=r.sections.filter(s=>{const c=tn(s.title);return a.has(c)&&!i.has(c)});return qf(r.header,o)}function Ns(e,t,n=[]){const r=Ca(e),a=tn(t),i=new Set((Array.isArray(n)?n:[]).map(s=>tn(s)).filter(s=>s.length>=2));if(!a&&!i.size)return[];const o=[];for(const s of r.sections){const c=tn(s.title);c.length<2||(a&&a.includes(c)||i.has(c))&&o.push(s.title)}return o}O(),Wt();function Is(e){const t=e.key||e.keys||e.trigger||"";let n;if(Array.isArray(t))n=t.map(o=>u(o,200));else{const o=u(t,2e3);n=o?o.split(/[,|\n]/):[]}const r=e.secondkey||e.second_key||"";r&&n.push(...W(r));const a=[],i=new Set;for(const o of n){const s=u(o,200),c=U(s),l=s?wt(s):"";!c||i.has(c)||s.startsWith("")||l.length<2||(i.add(c),a.push(s))}return a}function Cs(e,t,n){const r=U(e),a=wt(e);if(a.length<2)return 0;const i=(o,s)=>{if(!o||!s||s.length<2)return 0;let c=0,l=0;for(;l<=o.length-s.length;){const f=o.indexOf(s,l);if(f<0)break;c+=1,l=f+s.length}return c};return Math.max(i(t,r),i(n,a))}function Ea(e,t){const n=u(t).toLowerCase(),r=wt(t);if(!n)return[];const a=[],i=new Set;for(const o of e||[]){if(typeof o!="object"||Et(o))continue;const s=u(o.mode||"",40).toLowerCase(),c=u(o.key||"",2e3);if(s==="folder"||c.startsWith("folder:"))continue;const l=Is(o);if(!l.length)continue;let f=0;for(const d of l)f+=Cs(d,n,r);if(!(f<=0))for(const d of l){const m=U(d);!m||i.has(m)||(i.add(m),a.push(d))}}return a}function Es(e,t=[]){const n=String(e||"");if(!/character\s*image\s*tags/i.test(n))return!1;const r=(n.match(/^#{2,3}\s+.+$/gm)||[]).filter(i=>!/character\s*image\s*tags/i.test(i)),a=Array.isArray(t)?t.filter(Boolean).length:0;return r.length>=3&&(a===0||r.length>a+1)}function Gf(e){const t=[],n=new Set;for(const r of e||[])if(Me(r))for(const a of hr(r)){const i=u(a,200),o=U(i);!i||!o||n.has(o)||(n.add(o),t.push(i))}return t}function Ts(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e==="full"?"full":"tags"}function Wf(e,t,n=[],r=5,a=1200,i=null,o="tags"){const s=Array.isArray(e)?e:[],c=Ts(o),l=c==="off"?[]:s.filter(g=>Et(g)),f=s.filter(g=>!Et(g)),d=Vf(f,t,r,a),m=Array.isArray(i)&&i.length?i.map(g=>u(g,200)).filter(Boolean):Ea(f,t),p=[];for(const g of l){const h=u(g.content||g.data||"",5e4);if(h)if(c==="full")p.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:h,key:"full",always:!0,lore_extra_mode:"full"});else{const _=Ns(h,t,m),y=_.length?Ms(h,n,_):"";y&&!Es(y,_)&&p.push({comment:u(g.comment||g.name||"lb-xnai.lb.extra",200),content:y,key:_.join(", "),always:!0,lore_extra_mode:"tags"})}}for(const g of d)Es(u(g.content||g.data||"",a),[])||p.push(g);return p}function Vf(e,t,n=5,r=1200){const a=u(t).toLowerCase(),i=wt(t);if(!a)return[];const o=[];for(const s of e||[]){if(typeof s!="object"||Et(s))continue;const c=u(s.mode||"",40).toLowerCase(),l=u(s.key||"",2e3);if(c==="folder"||l.startsWith("folder:"))continue;const f=u(s.content||s.data||"",r);if(!f)continue;const d=Is(s);if(!d.length)continue;let m=0;for(const p of d)m+=Cs(p,a,i);m<=0||o.push({comment:u(s.comment||s.name||"",200),content:f,key:l,hits:m})}return o.sort((s,c)=>c.hits-s.hits||String(s.comment).localeCompare(String(c.comment))),o.slice(0,Math.max(1,n)).map(({hits:s,...c})=>c)}O();function Rn(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function js(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function $s(e){const t=Rn(e);if(!t)return[];const n=[],r=u(t.base_caption??t.baseCaption??"");r&&n.push(r);const a=t.char_captions??t.charCaptions;if(Array.isArray(a))for(const i of a){const o=Rn(i),s=u(o?.char_caption??o?.charCaption??o?.caption??"");s&&n.push(s)}return n}function Ps(e){const t=Rn(js(e));if(!t)return u(e);let n=t.Comment??t.comment;n=js(n);const r=Rn(n),a=[],i=s=>{if(!s)return;const c=u(s.prompt??s.Prompt??"");c&&a.push(c);const l=Rn(s.v4_prompt??s.v4Prompt);l&&a.push(...$s(l.caption??l)),a.push(...$s(s.caption))};i(r),i(t);const o=u(t.Description??t.description??"");return o&&!a.some(s=>s.includes(o.slice(0,40)))&&a.push(o),I(...a)}Q();var Yf=8;function nn(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function Os(e,t,n){try{return new TextDecoder("utf-8",{fatal:!1}).decode(e.subarray(t,n))}catch{return nn(e,t,n)}}async function Ls(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("deflate"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{try{const t=new DecompressionStream("deflate-raw"),n=e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength),r=new Blob([n]).stream().pipeThrough(t),a=await new Response(r).arrayBuffer();return new Uint8Array(a)}catch{return null}}}async function Xf(e){const t=V(e),n={};if(!yt(t)||t.length<8)return n;let r=Yf;const a=new DataView(t.buffer,t.byteOffset,t.byteLength);for(;r+12<=t.length;){const i=a.getUint32(r),o=nn(t,r+4,r+8),s=r+8,c=s+i;if(c+4>t.length)break;const l=t.subarray(s,c);if(o==="tEXt"){const f=l.indexOf(0);if(f>0){const d=nn(l,0,f),m=nn(l,f+1,l.length);d&&!(d in n)&&(n[d]=m)}}else if(o==="iTXt"){let f=0;const d=l.indexOf(0);if(d>0){const m=Os(l,0,d);f=d+1;const p=l[f]??0;f+=1,f+=1;const g=l.indexOf(0,f);if(g>=f){f=g+1;const h=l.indexOf(0,f);if(h>=f){f=h+1;let _=l.subarray(f);if(p===1){const k=await Ls(_);k&&(_=k)}const y=Os(_,0,_.length);m&&!(m in n)&&(n[m]=y)}}}}else if(o==="zTXt"){const f=l.indexOf(0);if(f>0&&f+2<=l.length){const d=nn(l,0,f),m=await Ls(l.subarray(f+2));m&&d&&!(d in n)&&(n[d]=nn(m,0,m.length))}}if(o==="IEND")break;r=c+4}return n}Q();function Zf(e,t,n){const r=[];for(let a=0;a<t;a+=1)for(let i=0;i<n;i+=1){const o=i*t+a;r.push(e[o*4+3]&1)}return r}function Qf(e,t,n){const r=Zf(e,t,n),a=Math.floor(r.length/8)*8,i=new Uint8Array(a/8);for(let o=0;o<a;o+=8){let s=0;for(let c=0;c<8;c+=1)s|=r[o+c]<<7-c;i[o/8]=s}return i}async function ed(e){if(typeof DecompressionStream!="function")return null;try{const t=new DecompressionStream("gzip"),n=new Uint8Array(e.byteLength);n.set(e);const r=new Blob([n]).stream().pipeThrough(t);return new Uint8Array(await new Response(r).arrayBuffer())}catch{return null}}async function td(e,t,n){if(!e.length||t<1||n<1)return null;const r=t*n*4;if(e.length<r)return null;const a=Qf(e,t,n);if(a.length<20)return null;const i="stealth_pngcomp",o="stealth_pnginfo",s=String.fromCharCode(...a.subarray(0,15));let c=0,l=!1;if(s.startsWith(i))l=!0,c=15;else if(s.startsWith(o))l=!1,c=15;else return null;if(c+4>a.length)return null;const f=(a[c]<<24|a[c+1]<<16|a[c+2]<<8|a[c+3])>>>0;c+=4;const d=Math.floor(f/8);if(d<1||c+d>a.length)return null;let m=a.subarray(c,c+d);if(l){const g=await ed(m);if(!g)return null;m=g}const p=new TextDecoder("utf-8",{fatal:!1}).decode(m);try{const g=JSON.parse(p);if(g&&typeof g=="object"&&!Array.isArray(g)){const h=g;if(typeof h.Comment=="string")try{h.Comment=JSON.parse(h.Comment)}catch{}}return g}catch{return null}}async function nd(e){const t=V(e);if(!t.length||typeof createImageBitmap!="function")return null;try{const n=new Uint8Array(t.byteLength);n.set(t);const r=new Blob([n]);let a;try{a=await createImageBitmap(r,{colorSpaceConversion:"none",premultiplyAlpha:"none"})}catch{a=await createImageBitmap(r)}const i=a.width,o=a.height,s=typeof OffscreenCanvas=="function"?new OffscreenCanvas(i,o):(()=>{const f=document.createElement("canvas");return f.width=i,f.height=o,f})(),c=s.getContext("2d",{alpha:!0,willReadFrequently:!0})??s.getContext("2d",{alpha:!0,willReadFrequently:!0});if(!c)return a.close?.(),null;c.drawImage(a,0,0);const l=c.getImageData(0,0,i,o);return a.close?.(),{rgba:new Uint8Array(l.data.buffer,l.data.byteOffset,l.data.byteLength),width:i,height:o}}catch{return null}}Q();function Bs(e,t,n){let r="";for(let a=t;a<n;a+=1)r+=String.fromCharCode(e[a]);return r}function Rs(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]<<8|e[a+1]);return String.fromCharCode(...r)}function rd(e,t,n){const r=[];for(let a=t;a+1<n;a+=2)r.push(e[a]|e[a+1]<<8);return String.fromCharCode(...r)}function ad(e){if(e.length<8)return"";const t=Bs(e,0,8).replace(/\0+$/g,""),n=e.subarray(8);return/^ASCII/i.test(t)?new TextDecoder("utf-8",{fatal:!1}).decode(n).replace(/\0+$/g,""):/^UNICODE/i.test(t)?n.length>=2&&n[0]===255&&n[1]===254?rd(n,2,n.length).replace(/\0+$/g,""):n.length>=2&&n[0]===254&&n[1]===255?Rs(n,2,n.length).replace(/\0+$/g,""):Rs(n,0,n.length).replace(/\0+$/g,""):new TextDecoder("utf-8",{fatal:!1}).decode(e).replace(/\0+$/g,"")}function id(e){const t={};if(e.length<8)return t;let n=0;e.length>=6&&e[0]===69&&e[1]===120&&e[2]===105&&e[3]===102&&(n=6);const r=e.subarray(n);if(r.length<8)return t;const a=r[0]===73&&r[1]===73,i=r[0]===77&&r[1]===77;if(!a&&!i)return t;const o=new DataView(r.buffer,r.byteOffset,r.byteLength),s=d=>a?o.getUint16(d,!0):o.getUint16(d,!1),c=d=>a?o.getUint32(d,!0):o.getUint32(d,!1),l=c(4);return(d=>{if(d+2>r.length)return;const m=s(d);for(let p=0;p<m;p+=1){const g=d+2+p*12;if(g+12>r.length)break;const h=s(g),_=s(g+2),y=c(g+4);let k=g+8;const x=y*(_===2||_===7?1:_===3?2:_===4?4:1);if(x>4&&(k=c(g+8)),k+x>r.length)continue;const S=r.subarray(k,k+x);h===270&&_===2?t.ImageDescription=new TextDecoder("utf-8",{fatal:!1}).decode(S).replace(/\0+$/g,""):h===37510&&(t.UserComment=ad(S))}})(l),t}function od(e){const t=V(e);if(!Mn(t)||t.length<12)return null;let n=12;for(;n+8<=t.length;){const r=Bs(t,n,n+4),a=t[n+4]|t[n+5]<<8|t[n+6]<<16|t[n+7]<<24,i=n+8,o=i+a;if(o>t.length)break;if(r==="EXIF")return t.subarray(i,o);n=o+(a&1)}return null}function sd(e){const t=od(e);return t?id(t):{}}var cd={portrait:{width:832,height:1216},square:{width:1024,height:1024},landscape:{width:1216,height:832}};function ld(e){const t=String(e??"").trim().toLowerCase().replace(/\s+/g,"");return t?t==="portrait"||t==="vertical"||t==="tall"||t==="832x1216"||t==="3:4"||t==="2:3"?"portrait":t==="square"||t==="1:1"||t==="1x1"||t==="1024x1024"?"square":t==="landscape"||t==="horizontal"||t==="wide"||t==="1216x832"||t==="4:3"||t==="3:2"?"landscape":null:null}function ud(e,t,n){if(n){const r=ld(e)||"portrait";return{...cd[r],aspect:r}}return{width:Math.max(64,Math.min(5e3,Math.round(Number(t.width)||832))),height:Math.max(64,Math.min(5e3,Math.round(Number(t.height)||1216))),aspect:"settings"}}O();var fd=new Set(["best quality","amazing quality","very aesthetic","highres","incredibly absurdres","best illustration","artist collaboration","bad anatomy"]);function dd(e){if(/artist\s*:/i.test(e))return!0;for(const{plain:t}of Na(e))if(fd.has(t.toLowerCase()))return!0;return!1}function md(e){const t=[],n=new Set;for(const r of Ma(e)){if(!dd(r))continue;const a=r.toLowerCase();n.has(a)||(n.add(a),t.push(r.trim()))}return I(...t)}function Fs(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function Ds(e){if(typeof e!="string")return e;const t=e.trim();if(!t||t[0]!=="{"&&t[0]!=="[")return e;try{return JSON.parse(t)}catch{return e}}function zs(e){if(e==null||e==="")return null;const t=Number(e);return Number.isFinite(t)?t:null}function pd(e,t){const n=Fs(Ds(e)),r=Fs(n?Ds(n.Comment??n.comment):null)||n,a=u(r?.uc??r?.negative_prompt??r?.negativePrompt??r?.Negative??n?.uc??"",2e4),i=zs(r?.scale??r?.cfg_scale??r?.cfgScale??n?.scale),o=zs(r?.cfg_rescale??r?.cfgRescale??n?.cfg_rescale);return{positive:md(t),negative:a,cfg_scale:i,cfg_rescale:o}}Q();function Us(e){const t=e.Comment||e.comment;if(t)try{return{Comment:JSON.parse(t),...e}}catch{return{Comment:t,...e}}return e}async function Js(e){const t=V(e);if(!t.length)return null;if(yt(t)){const r=await Xf(t);if(r.Comment||r.Description||r.Source)return Us(r)}else if(Mn(t)){const r=sd(t);if(r.UserComment||r.ImageDescription){const a={};return r.UserComment&&(a.Comment=r.UserComment),r.ImageDescription&&(a.Description=r.ImageDescription),Us(a)}}const n=await nd(t);return n?td(n.rgba,n.width,n.height):null}async function gd(e){const t=await Js(e);if(!t)return null;const n=Ps(t);if(!n.trim())return null;const r=Jf(n);return r.plains.length?r:null}O();var hd=3,_d=/[\uac00-\ud7a3\u1100-\u11ff\u3130-\u318f]/,Hs=new Set(["normal","default","base","neutral","profile","프로필"]),p_=2;function Fn(e,t){return u(e,t).normalize("NFC").toLowerCase()}function yd(e){return _d.test(e)}function bd(e){const t=Fn(e,200);return t?yd(t)?!0:t.length>=hd:!1}function Ks(e){const t=Fn(e,400).replace(/\.[a-z0-9]{2,5}$/i,"");return t?t.split(/[\s_\-/\\.|]+/).map(n=>n.trim()).filter(Boolean):[]}function qs(e){const t=[],n=new Set;for(const r of e){if(!bd(r))continue;const a=Fn(r,200);n.has(a)||(n.add(a),t.push(a))}return t}function Gs(e){return[...e].sort((t,n)=>n.length-t.length||t.localeCompare(n))}function Dn(e,t){const n=Fn(t,200);if(!n)return-1;const r=Ks(e);if(!r.includes(n))return-1;const a=r.filter(c=>c!==n),i=a.filter(c=>Hs.has(c)),o=a.filter(c=>!Hs.has(c));let s=n.length*10;return r.length===1&&(s+=1e5),i.length&&o.length===0?s+=5e4+i.length*1e3:i.length&&(s+=2e4+i.length*500),s+=Math.max(0,5e3-o.length*400),s}function wd(e,t){const n=u(e,400);if(!n)return null;const r=new Set(Ks(n));if(!r.size)return null;const a=[];for(const i of t){const o=Fn(i,200);r.has(o)&&a.push(o)}return a.length?{name:n,key:n,score:Math.max(...a.map(i=>Dn(n,i))),hits:a}:null}function vd(e,t,n=2){const r=Gs(t),a=[],i=new Set;for(const o of r){const s=e.filter(l=>l.hits.includes(o)&&!i.has(l.key)).sort((l,f)=>Dn(f.name,o)-Dn(l.name,o)||l.name.localeCompare(f.name));let c=0;for(const l of s){if(c>=n)break;i.has(l.key)||(i.add(l.key),a.push(l),c+=1)}}return a}O();function kr(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(Array.isArray(n)){const r=u(n[0],400),a=u(n[1],800);r&&a&&t.push({name:r,key:a});continue}if(n&&typeof n=="object"){const r=n,a=u(r.name??r.assetName??r.fileName,400),i=u(r.key??r.path??r.id??r.asset,800);a&&i&&t.push({name:a,key:i})}}return t}function Ta(e,t){if(Array.isArray(t))for(const n of t){const r=u(n,200);r&&e.push(r)}}function xd(e){const t=[];Ta(t,e.enabledModules),Ta(t,e.chatModules),Ta(t,e.characterModules);const n=u(e.personaEmbeddedModuleId,200);if(n&&t.push(n),typeof e.moduleIntergration=="string")for(const r of e.moduleIntergration.split(",")){const a=r.trim();a&&t.push(a)}return t}function kd(e,t){const n=u(e.id,200);if(n&&t.has(n))return!0;const r=u(e.namespace,200);return!!(r&&t.has(r))}function Sd(e,t,n=[]){if(!t.length)return[];const r=new Set(t),a=[],i=new Set,o=s=>{if(!s||typeof s!="object")return;const c=s;if(!kd(c,r))return;const l=u(c.id,200)||u(c.namespace,200)||"";if(l){if(i.has(l))return;i.add(l)}a.push(...kr(c.assets))};for(const s of e)o(s);for(const s of n)o(s);return a}function Ad(...e){const t=[],n=new Set;for(const r of e)for(const a of r)!a.name||!a.key||n.has(a.key)||(n.add(a.key),t.push(a));return t}function Md(e){if(!e||typeof e!="object")return null;const t=e;if(!Array.isArray(t.personas))return null;const n=typeof t.selectedPersona=="number"?t.selectedPersona:0,r=t.personas[n];if(!r||typeof r!="object")return null;const a=r.embeddedModule;return a&&typeof a=="object"?a:null}q(),pt(),O(),Q();var Ws=8,Nd=24,ja=new Map,Vs=new Map;function Id(){return ja}function Ys(e){ja=e}async function Xs(e){const t=Ae();if(!t||typeof t.readImage!="function")return null;try{const n=await t.readImage(e);if(!n)return null;if(n instanceof ArrayBuffer)return V(n);if(n instanceof Uint8Array)return n;if(typeof Blob<"u"&&n instanceof Blob)return V(await n.arrayBuffer());if(typeof n=="string"){const r=n.match(/^data:[^;]+;base64,(.+)$/i);if(r){const a=atob(r[1]),i=new Uint8Array(a.length);for(let o=0;o<a.length;o+=1)i[o]=a.charCodeAt(o);return i}try{const a=atob(n.replace(/\s+/g,"")),i=new Uint8Array(a.length);for(let o=0;o<a.length;o+=1)i[o]=a.charCodeAt(o);return i}catch{return null}}if(n&&typeof n=="object"){const r=n;if(r.data instanceof ArrayBuffer)return V(r.data);if(typeof r.data=="string")return Xs(r.data)}}catch(n){w("asset-tags.read.fail",{path:e,message:String(n?.message||n)},"warn")}return null}async function Cd(){const e=Ae();if(!e||typeof e.getCurrentCharacterIndex!="function"||typeof e.getCurrentChatIndex!="function"||typeof e.getChatFromIndex!="function")return null;try{const t=await e.getCurrentCharacterIndex(),n=await e.getCurrentChatIndex();return await e.getChatFromIndex(t,n)}catch(t){return w("asset-tags.chat.fail",{message:String(t?.message||t)},"warn"),null}}function Ed(e){const t=e&&typeof e=="object"?e:null;if(!t)return null;const n=Array.isArray(t.chats)?t.chats:null;if(!n?.length)return null;const r=typeof t.chatPage=="number"?t.chatPage:0,a=n[Math.max(0,Math.min(n.length-1,r))];return a&&typeof a=="object"?a:null}async function Zs(e){const t=e&&typeof e=="object"?e:null,n=kr(t?.additionalAssets??t?.additional_assets);let r=[],a=[],i=[];if(ge("getDatabase"))try{const o=await Ae().getDatabase(["modules","enabledModules","moduleIntergration","personas","selectedPersona"]);if(o){const s=await Cd()||Ed(e),c=s&&typeof s=="object"?s:null,l=Md(o),f=l&&typeof l=="object"?l:null;i=xd({enabledModules:o.enabledModules,characterModules:t?.modules,chatModules:c?.modules,moduleIntergration:o.moduleIntergration,personaEmbeddedModuleId:f?.id});const d=Array.isArray(o.modules)?o.modules:[];r=Sd(d,i,l?[l]:[]),f&&(a=kr(f.assets));const m=new Set(i),p=[];for(const g of d){if(!g||typeof g!="object")continue;const h=g,_=u(h.id,200),y=u(h.namespace,200);!(_&&m.has(_))&&!(y&&m.has(y))||p.push({id:_||y,name:u(h.name,200),assets:kr(h.assets).length})}w("asset-tags.modules",{enabled:i.length,module_assets:r.length,per_module:p.slice(0,12)})}}catch(o){w("asset-tags.modules.fail",{message:String(o?.message||o)},"warn")}return{assets:Ad(n,r,a),characterCount:n.length,moduleCount:r.length,personaCount:a.length,enabledModuleIds:i}}async function Qs(e,t){const n=e.map(l=>{const f=wd(l.name,t);return f?{...l,score:f.score,hits:f.hits}:null}).filter(Boolean),r=[],a=[],i=new Set;let o=0;const s=async l=>{if(i.has(l.key)||r.length>=Ws||o>=Nd)return!1;o+=1;let f,d,m=!1;const p=Vs.get(l.key);if(p)f=p.plains,d=new Map(p.weights),m=!0;else{const g=await Xs(l.key);if(!g?.length)return a.push({name:l.name,key:l.key,ok:!1,reason:"read_empty"}),!1;const h=await gd(g);if(!h?.plains.length)return w("asset-tags.no_meta",{name:l.name}),a.push({name:l.name,key:l.key,ok:!1,reason:"no_nai_meta",bytes:g.length}),!1;f=h.plains,d=h.weightMap,Vs.set(l.key,{plains:f,weights:[...d.entries()]})}return i.add(l.key),r.push({name:l.name,plains:f,weightMap:d}),a.push({name:l.name,key:l.key,ok:!0,from_cache:m,plains:f.length,hits:l.hits,score:l.score}),!0},c=new Set(vd(n,t,2).map(l=>l.key));for(const l of Gs(t)){if(r.length>=Ws)break;const f=n.filter(m=>m.hits.includes(l)).sort((m,p)=>{const g=c.has(m.key)?1:0,h=c.has(p.key)?1:0;return h!==g?h-g:Dn(p.name,l)-Dn(m.name,l)||m.name.localeCompare(p.name)});let d=0;for(const m of f){if(d>=2)break;await s(m)&&(d+=1)}}return{scored:n,packedRows:r,attempts:o,attemptLog:a}}async function Td(e){const t=qs(e);if(!t.length)return w("asset-tags.skip",{reason:"no_long_triggers"}),null;if(!ge("getCharacter")||!ge("readImage"))return w("asset-tags.skip",{reason:"host_api_missing"}),null;let n;try{n=await Ae().getCharacter()}catch(f){return w("asset-tags.getCharacter.fail",{message:String(f?.message||f)},"warn"),null}const r=await Zs(n);if(!r.assets.length)return w("asset-tags.skip",{reason:"no_assets"}),null;const{scored:a,packedRows:i,attempts:o}=await Qs(r.assets,t);if(!i.length)return w("asset-tags.skip",{reason:"no_meta_hits",matched:a.length,attempts:o}),null;const s=ks(i),c=Hf(s.weightMap);ja=c;const l=Ss(s);return w("asset-tags.done",{assets:s.assets.map(f=>f.name),pool:r.assets.length,common:s.common.length,unique:s.assets.reduce((f,d)=>f+d.unique.length,0)}),{block:l,packed:s,weightMap:c}}async function jd(e={}){const t=u(e.message??e.text??"",2e4),n=Array.isArray(e.lorebook)?e.lorebook:[],r=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys.map(h=>u(h,200)).filter(Boolean):[],a=Ea(n,t),i=[...r,...a],o=qs(i),s={setting_asset_nai_tags:T().card.asset_nai_tags===!0,message_preview:t.slice(0,240),message_len:t.length,lorebook_entries:n.length,lore_trigger_keys_ui:r,lore_trigger_keys_backend:a,asset_match_triggers:o,note:"per trigger ≤2 assets; prefer exact/normal/default names; Hangul any length; Latin/Hanja ≥3"};if(!t)return s.skip="no_message",{ok:!0,report:s};if(!o.length)return s.skip="no_long_triggers",{ok:!0,report:s};if(!ge("getCharacter")||!ge("readImage"))return s.skip="host_api_missing",s.host={getCharacter:ge("getCharacter"),readImage:ge("readImage"),getDatabase:ge("getDatabase")},{ok:!0,report:s};let c;try{c=await Ae().getCharacter()}catch(h){return s.skip="getCharacter_fail",s.error=String(h?.message||h),{ok:!1,message:s.error,report:s}}const l=await Zs(c);if(s.pool={total:l.assets.length,character:l.characterCount,module:l.moduleCount,persona:l.personaCount,enabled_module_ids:l.enabledModuleIds,sample_names:l.assets.slice(0,40).map(h=>h.name)},!l.assets.length)return s.skip="no_assets",{ok:!0,report:s};const{scored:f,packedRows:d,attempts:m,attemptLog:p}=await Qs(l.assets,o);if(s.name_matches=f.slice(0,20).map(h=>({name:h.name,key:h.key,score:h.score,hits:h.hits})),s.read_attempts=m,s.read_log=p,s.picked=d.map(h=>({name:h.name,plains_count:h.plains.length,plains_sample:h.plains.slice(0,12)})),!d.length)return s.skip="no_meta_hits",{ok:!0,report:s};const g=ks(d);return s.packed={common:g.common,assets:g.assets.map(h=>({name:h.name,unique:h.unique}))},s.inject_block_preview=Ss(g).slice(0,2e3),s.ok_picked=d.length,{ok:!0,report:s}}ee(),O(),pa(),Wt(),it(),Le(),fe();var Fe=(e,t)=>!!e&&Object.prototype.hasOwnProperty.call(e,t),Sr=e=>e?[...e]:[],$a=e=>e;async function ie(e){const t=(await be("characters")).filter(r=>r.scope===u(e,200)).sort((r,a)=>(r.name||"").localeCompare(a.name||"",void 0,{sensitivity:"base"})),n=[];for(const r of t){let a=r.aliases;if(typeof a=="string")try{a=JSON.parse(a)}catch{a=W(a)}const i=r.appearance||"",o=r.attire||"",s=r.accessories||"";let c=qt(r.gender??r.sex);if(!c){const f=Fu(i,o,s);f&&(c=f,await F("characters",{...r,gender:f,schema_version:Math.max(2,Number(r.schema_version||1)),updated_at:Date.now()/1e3}))}const l={id:r.id,name:r.name,aliases:Array.isArray(a)?a:W(a),surname:r.surname||"",given_name:r.given_name||"",surname_variants:W(r.surname_variants),given_name_variants:W(r.given_name_variants),priority:Number(r.priority||0),attire_locked:oe(r.attire_locked),accessories_locked:oe(r.accessories_locked),schema_version:Number(r.schema_version||1),original:r.original||"",appearance:i,attire:o,accessories:s,gender:c,updated_at:r.updated_at,scope:r.scope};l.tags=$n(l),n.push(l)}return n}async function $d(e){const t=u(e,200);return t?(await be("meta")).filter(n=>n.key?.startsWith(`toggle:${t}:`)&&n.enabled===0).map(n=>u(n.global_key||n.key.split(":").slice(2).join(":"),200)).filter(Boolean):[]}async function Pd(e,t){const n=u(e,200);if(!n)return{ok:!1,error:{code:"bad_request",message:"character_id required"}};const r=[],a=new Set;for(const s of t||[]){const c=u(s,200);!c||a.has(c)||(a.add(c),r.push(c))}const i=await be("meta");for(const s of i)s.key?.startsWith(`toggle:${n}:`)&&await At("meta",s.key);const o=Date.now()/1e3;for(const s of r)await F("meta",{key:`toggle:${n}:${s}`,character_id:n,global_key:s,enabled:0,updated_at:o});return{ok:!0,character_id:n,disabled_globals:r}}function ec(e){const t=[];for(const n of[e.id,e.name]){const r=u(n,200);if(!r)continue;t.push(r);const a=r.toLowerCase();a!==r&&t.push(a)}return[...new Set(t)]}function Pa(e,t){if(!t?.size)return!1;for(const n of ec(e))if(t.has(n))return!0;return!1}async function Oa(e){const t=await $d(e);return new Set(t)}async function Od(e){const t=await Oa(e),n={};for(const r of await ie(Xe)){const a=!Pa(r,t);for(const i of ec(r))n[i]=a;n[u(r.name,200)]=a}return n}async function Ld(e=[]){const t=[],n=new Set;for(const r of e||[]){const a=u(r,200);!a||a==="__global__"||n.has(a)||(n.add(a),t.push(...await ie(a)))}return $a(ha(t))}async function La(e,t="",n="",r=[]){const a=!!T()?.card?.unified_chat_priority,i=(Array.isArray(r)?r:[]).map(f=>u(f,200)).filter(Boolean);let o;a&&i.length?o=await Ld(i):o=await ie(u(e||"",200));const s=u(n||"",200),c=s?await Oa(s):new Set,l=(await ie(Xe)).filter(f=>!Pa(f,c));return $a(qu(o,l,{hasAppearance:Me,resolve:ye,aliasKeys:Tn,normalizeName:U,fullTags:$n,clean:u,globalScope:Xe}))}async function ct(e,t){const n=Fe(t,"appearance"),r=Fe(t,"attire"),a=Fe(t,"accessories"),i=Fe(t,"original"),o=Fe(t,"surname"),s=Fe(t,"given_name"),c=Fe(t,"surname_variants"),l=Fe(t,"given_name_variants");let f=Gt(t);if(!f)return null;const d=u(e,200)||"__global__",m=await ie(d),p=u(f.id,80),g=f,h=m.find(y=>p&&u(y.id,80)===p?!1:!!(ye(g.name,[y])||(g.aliases||[]).some(k=>ye(k,[y]))));if(h){const y=W([...h.aliases||[],...f.aliases||[],f.name,h.name]),k=u(f.appearance||"",4e3),x=u(f.attire||"",4e3),S=u(f.accessories||"",4e3),C=u(f.original||"",400),N=u(f.surname||"",200),E=u(f.given_name||"",200);if(f=Gt({...h,...f,id:h.id,name:h.name||f.name,aliases:y,original:i?C:C||h.original||"",appearance:n?k:k||h.appearance||"",attire:r?x:x||h.attire||"",accessories:a?S:S||h.accessories||"",surname:o?N:N||h.surname||"",given_name:s?E:E||h.given_name||"",surname_variants:W(c?[...f.surname_variants||[],N]:[...h.surname_variants||[],...f.surname_variants||[],N,h.surname]),given_name_variants:W(l?[...f.given_name_variants||[],E]:[...h.given_name_variants||[],...f.given_name_variants||[],E,h.given_name]),attire_locked:Fe(t,"attire_locked")?oe(f.attire_locked):oe(h.attire_locked),accessories_locked:Fe(t,"accessories_locked")?oe(f.accessories_locked):oe(h.accessories_locked),priority:Math.max(Number(h.priority||0),Number(f.priority||0))}),!f)return null}const _=Date.now()/1e3;if(await F("characters",{scope:d,id:f.id,name:f.name,aliases:f.aliases,surname:f.surname||"",given_name:f.given_name||"",surname_variants:f.surname_variants||[],given_name_variants:f.given_name_variants||[],priority:Number(f.priority||0),attire_locked:oe(f.attire_locked),accessories_locked:oe(f.accessories_locked),schema_version:2,appearance:f.appearance,attire:f.attire,accessories:f.accessories||"",original:f.original||"",gender:qt(f.gender??f.sex),updated_at:_}),d!=="__global__"){const y=`appearance:${d}`,k=(await z("meta",y))?.value||{},x=$n(f);x?k[f.name]=x:delete k[f.name],await F("meta",{key:y,value:k,updated_at:_})}else(r||a)&&await Bd(f,{clearAttire:r,clearAccessories:a});return f}async function Bd(e,{clearAttire:t=!0,clearAccessories:n=!0}={}){if(!e||!t&&!n)return 0;const r=i=>!i||i.scope==="__global__"||Me(i)?!1:!!Ho(i,e);let a=0;try{const i=await be("characters");for(const o of i||[]){if(!r(o))continue;const s=t?"":o.attire||"",c=n?"":o.accessories||"";(o.attire||"")===s&&(o.accessories||"")===c||(await F("characters",{...o,attire:s,accessories:c,updated_at:Date.now()/1e3}),a+=1)}}catch{}return a}async function Ar(e,t){const n=u(e,200)||"__global__",r=u(t,80);if(!r)return!1;const a=await z("characters",{scope:n,id:r});if(await At("characters",{scope:n,id:r}),n!=="__global__"&&a?.name){const i=`appearance:${n}`,o={...(await z("meta",i))?.value||{}};delete o[a.name],await F("meta",{key:i,value:o,updated_at:Date.now()/1e3})}return!0}var Rd=(e,t)=>!!Ho(e,t);function tc(e){return(Array.isArray(e)?e:[]).filter(t=>{if(!t||typeof t!="object")return!1;const n=t;return!!(n.id||n.name)})}async function Fd(e,t,n=""){const r=tc(t);if(!r.length)return{deleted:0,sessions:0};const a=u(n,200),i=new Set;let o=0,s=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||i.has(l))continue;i.add(l);const f=await ie(l);let d=!1;for(const m of f)r.some(p=>Rd(m,p))&&(await Ar(l,m.id),o+=1,d=!0);d&&(s+=1)}return{deleted:o,sessions:s}}async function nc(e,t,n=""){const r=tc(t);if(!r.length)return{updated:0,sessions:0};const a=u(n,200),i=new Set;let o=0,s=0;for(const c of e||[]){const l=u(c,200);if(!l||l===a||l==="__global__"||i.has(l))continue;i.add(l);const f=await ie(l);let d=!1;for(const m of r){const p=ye(m.name,f)||(Array.isArray(m.aliases)?m.aliases.map(g=>ye(g,f)).find(Boolean):null)||(u(m.id,80)?f.find(g=>u(g.id,80)===u(m.id,80)):null);p&&await ct(l,{...m,id:p.id,name:p.name||m.name,appearance:m.appearance!=null?m.appearance:"",attire:m.attire!=null?m.attire:"",accessories:m.accessories!=null?m.accessories:"",original:m.original!=null?m.original:""})&&(o+=1,d=!0)}d&&(s+=1)}return{updated:o,sessions:s}}async function zn(e,t,n={}){const r=u(e,200)||"__global__",a=n.prune===!0,i=Array.isArray(n.rootSessionIds)?n.rootSessionIds:[],o=ha(t||[]);if(i.length){if(a){const c=new Set;for(const l of o){for(const d of Tn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of i){const f=u(l,200);if(!(!f||f==="__global__"))for(const d of await ie(f)){const m=[...Tn(d)],p=U(d.name);p&&m.push(p),!m.some(g=>c.has(g))&&await Ar(f,d.id)}}}return o.length&&await nc(i,o,""),$a(o.map(c=>Gt(c)).filter(c=>!!c))}const s=[];for(const c of o){const l=await ct(r,c);l&&s.push(l)}if(a){const c=new Set(s.map(l=>u(l.id,80)).filter(Boolean));for(const l of await ie(r)){const f=u(l.id,80);f&&!c.has(f)&&await Ar(r,f)}}return s}async function Un(e,t=""){const n=u(e,200),r=u(t,200),a=n?await ie(n):[],i=r?await Oa(r):new Set,o=[];for(const s of await ie(Xe)){const c={...s};c.enabled_for_character=r?!Pa(s,i):!0,o.push(c)}return{ok:!0,session_id:n,character_id:r,characters:a,global:o,appearance:Object.fromEntries(a.map(s=>[s.name,$n(s)])),disabled_globals:[...i].sort(),global_enabled:r?await Od(r):{}}}async function rc(e,t,n=!0){const r=u(e,200);if(!r)return{ok:!1,error:{code:"bad_request",message:"target_session_id required"}};const a=[],i=new Set;for(const l of t||[]){const f=u(l,200);!f||i.has(f)||(i.add(f),a.push(...await ie(f)))}n&&!i.has(r)&&a.push(...await ie(r));const o=ha(a),s=[];for(const l of o){const f=ye(l.name,await ie(r)),d=await ct(r,{...l,id:f?.id||l.id,priority:Math.max(Number(f?.priority||0),Number(l.priority||0))});d&&s.push(d)}const c=new Set;for(const l of s){for(const d of Tn(l))c.add(d);const f=U(l.name);f&&c.add(f)}for(const l of await ie(r)){const f=[...Tn(l)],d=U(l.name);d&&f.push(d),!f.some(m=>c.has(m))&&await Ar(r,l.id)}return{...await Un(r),ok:!0,merged:s.length,sources:[...i]}}async function Dd(e){return Object.fromEntries((await ie(e)).map(t=>[t.name,$n(t)]))}async function zd(e,t){return await zn(e,Object.entries(t||{}).map(([n,r])=>({name:n,tags:r}))),{ok:!0,appearance:await Dd(e)}}async function Ud(e){const{sessionId:t,tagged:n,shotChars:r}=e,a=e.unifiedSessionId??"",i=e.sourceSessionIds??[],o=u(e.characterId||"",200),s=u(t||"",200),c=()=>La(t,a,o,i);let l=await c();const f=[...n.new_characters||[]],d=new Set(f.map(p=>U(p?.name))),m=(p,g=null)=>({surname:u(p?.surname||g?.surname||"",200),given_name:u(p?.given_name||g?.given_name||"",200),surname_variants:W([...Sr(g?.surname_variants),...Sr(p?.surname_variants),p?.surname,g?.surname]),given_name_variants:W([...Sr(g?.given_name_variants),...Sr(p?.given_name_variants),p?.given_name,g?.given_name])});for(const p of r||[]){const g=u(p.name,200);if(!g||d.has(U(g)))continue;const h=ye(g,l);h&&Me(h)||(f.push({name:h?.name||g,aliases:W(p.aliases)||h?.aliases||[g],original:u(p.original||p.original_tag||h?.original||"",400),appearance:I(p.label,p.age,p.appearance,p.body),attire:u(p.attire||""),accessories:u(p.accessories||""),...m(p,h)}),d.add(U(g)))}typeof n=="object"&&(n.new_characters=f);for(const p of f){const g=Gt(p);if(!g)continue;const h=Id();h.size&&(g.appearance=Ia(g.appearance,h),g.attire=Ia(g.attire,h),g.accessories=Ia(g.accessories,h));const _=ye(g.name,l),y=u(g.appearance||""),k=u(g.attire||""),x=u(g.accessories||""),S=m(g,_);if(_&&Me(_)){l=await c();continue}if(_&&!Me(_)){const C=_.scope==="__global__"?Xe:_.scope||s,N=W([..._.aliases||[],...g.aliases||[]]),E=y||_.appearance||"",B=_.original||g.original||"";await ct(C,{id:_.id||g.id,name:_.name||g.name,aliases:N.length?N:_.aliases||g.aliases,original:B,appearance:E,attire:k,accessories:x,attire_locked:oe(_.attire_locked),accessories_locked:oe(_.accessories_locked),...S}),l=await c();continue}_||await ct(s,{...g,attire_locked:oe(g.attire_locked),accessories_locked:oe(g.accessories_locked)}),l=await c()}for(const p of r||[]){const g=u(p.name,200);if(g){if(ye(g,l)){l=await c();continue}{const h=I(p.label,p.age,p.appearance||"",p.body||""),_=u(p.attire||""),y=u(p.accessories||"");await ct(s,{name:g,aliases:W(p.aliases)||[g],original:u(p.original||p.original_tag||"",400),appearance:h,attire:_,accessories:y,attire_locked:!0,accessories_locked:!0,...m(p,null)})}l=await c()}}return c()}async function Jd(){if((await be("characters")).length)return;const e=(await be("meta")).filter(t=>t.key?.startsWith("appearance:"));if(e.length)for(const t of e){const n=t.key.slice(11),r=t.value||{};for(const[a,i]of Object.entries(r)){const o=Gt({name:a,tags:i},a);o&&await ct(n,o)}}}async function Hd(){const e=await be("characters");for(const t of e){if(Number(t.schema_version||0)>=2)continue;const n=Gt(t);n&&await F("characters",{...t,...n,scope:t.scope,updated_at:t.updated_at||Date.now()/1e3})}}function Kd(e){const t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(5,Math.round(t))):3}function Ba(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"||e==="full"?"two_stage":e===!1||e==="false"||e===0||e==="0"||e==="none"?"off":typeof e=="string"&&ic.has(e)?e:"off"}function Ra(e){return e===!0||e==="true"||e===1||e==="1"||e==="on"}function Fa(e){return e===!1||e==="false"||e==="off"||e==="none"?"off":e===!0||e==="true"||e==="on"?"short":e==="detailed"||e==="detail"?"detailed":e==="supplement"||e==="supp"?"supplement":typeof e=="string"&&ac.has(e)?e:"short"}function Da(e){if(Array.isArray(e))return e.map(Da);if(!e||typeof e!="object")return e;const t={};for(const[n,r]of Object.entries(e))sc.has(n.toLowerCase())||(t[n]=Da(r));return t}function za(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new TypeError("Settings must be an object");const t=oc(e),n=t.card&&typeof t.card=="object"&&!Array.isArray(t.card)?t.card:{};if(t.card=n,Number(n.scale_semantics_version||0)<2){const c=Number(n.inline_thumb_pct);n.inline_thumb_pct=Number.isFinite(c)?Math.max(1,c/6):100,n.scale_semantics_version=2}if(Number.isFinite(Number(n.overlay_x_pct))||Number.isFinite(Number(n.overlay_y_pct))||n.overlay_pin_unit==="pct"){n.overlay_pin_unit="pct";const c=String(n.overlay_pin_origin||"");(!c||c==="bottom-left")&&(n.overlay_pin_origin="bl")}const r=n.lore_extra;r===!0||r==="true"||r==="sections"?n.lore_extra="tags":r===!1||r==="false"||r==="none"?n.lore_extra="off":r==="full"||r==="tags"||r==="off"?n.lore_extra=r:n.lore_extra="tags",n.asset_nai_tags=n.asset_nai_tags===!0||n.asset_nai_tags==="true"||n.asset_nai_tags===1||n.asset_nai_tags==="1",n.auto_aspect=n.auto_aspect===!0||n.auto_aspect==="true"||n.auto_aspect===1||n.auto_aspect==="1",n.natural_base=Fa(n.natural_base),n.person_tag_solo=n.person_tag_solo===!0||n.person_tag_solo==="true"||n.person_tag_solo===1||n.person_tag_solo==="1"||n.person_tag_solo==="on",n.person_tag_weight=Kd(n.person_tag_weight);const a=t.curation&&typeof t.curation=="object"&&!Array.isArray(t.curation)?{...t.curation}:{},i=n.composition_curation===!0||n.composition_curation==="true"||n.composition_curation===1||n.composition_curation==="1"||n.composition_curation==="on";a.mode==null&&i&&(a.mode="two_stage"),a.mode=Ba(a.mode),a.strict_ids=Ra(a.strict_ids);const o=a.embedding&&typeof a.embedding=="object"&&!Array.isArray(a.embedding)?{...a.embedding}:{};o.provider||(o.provider="openai"),o.model||(o.model="text-embedding-3-small"),o.endpoint||(o.endpoint="https://api.openai.com/v1/embeddings"),o.api_key==null&&(o.api_key=""),a.embedding=o,t.curation=a,n.composition_curation=!1;const s=n.overlay_markers!==!1;n.overlay_markers=s,n.inline_previews=s,n.inline_chat_images==null?n.inline_chat_images=!1:n.inline_chat_images=n.inline_chat_images===!0||n.inline_chat_images==="true"||n.inline_chat_images===1||n.inline_chat_images==="1",n.progress_toast==null?n.progress_toast=!1:n.progress_toast=n.progress_toast===!0||n.progress_toast==="true"||n.progress_toast===1||n.progress_toast==="1";{const c=String(n.viewer_minimize_mode||"icon");n.viewer_minimize_mode=c==="toolbar"||c==="actions"?c:"icon"}return t.settings_schema_version=2,t}function qd(e){return JSON.stringify(Da(za(e)),null,2)}function Gd(e){if(typeof e!="string")throw new TypeError("Settings JSON must be text");if(e.length>2e6)throw new RangeError("Settings JSON is too large");const t=JSON.parse(e);if(!t||typeof t!="object"||Array.isArray(t))throw new TypeError("Settings JSON must contain an object");return za(t)}var ac,ic,oc,sc,Jn=$((()=>{ac=new Set(["off","short","detailed","supplement"]),ic=new Set(["off","two_stage","embed_snap"]),oc=e=>JSON.parse(JSON.stringify(e??{})),sc=new Set(["api_key","auth_token","password","secret"])}));Jn();function cc(e){if(e==null||e==="")return null;const t=typeof e=="number"?e:Number(e);return Number.isFinite(t)?t:null}function Wd(e,t){let n=Number(e.cfg_scale??7),r=Number(e.cfg_rescale??.36);if(Number.isFinite(n)||(n=7),Number.isFinite(r)||(r=.36),t){const a=cc(t.cfg_scale);a!=null&&(n=a);const i=cc(t.cfg_rescale);i!=null&&(r=i)}return{cfg_scale:n,cfg_rescale:r}}function lc(e){if(!e||e.length<22)return!1;const t=Math.max(0,e.length-65536);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=e[n+20]|e[n+21]<<8;if(n+22+r<=e.length)return!0}return!1}function lt(e,t){return e[t]|e[t+1]<<8}function rn(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function Ua(e){const t=Math.max(0,e.length-65536-22);for(let n=e.length-22;n>=t;n-=1)if(e[n]===80&&e[n+1]===75&&e[n+2]===5&&e[n+3]===6){const r=lt(e,n+20);if(n+22+r<=e.length)return n}return-1}function Vd(e){const t=Ua(e);if(t<0)return null;const n=rn(e,t+16);if(n+46>e.length||e[n]!==80||e[n+1]!==75||e[n+2]!==1||e[n+3]!==2)return null;const r=lt(e,n+10),a=rn(e,n+20),i=rn(e,n+24),o=rn(e,n+42);if(o+30>e.length||e[o]!==80||e[o+1]!==75||e[o+2]!==3||e[o+3]!==4)return null;const s=lt(e,o+26),c=lt(e,o+28),l=o+30+s+c;return l+a>e.length?null:{source:"central_dir",compMethod:r,compSize:a,uncompSize:i,dataStart:l,compData:e.subarray(l,l+a)}}function Yd(e){const t=lt(e,6),n=lt(e,8);let r=rn(e,18);const a=lt(e,26),i=lt(e,28),o=30+a+i;if((t&8)!==0||r===0){let s=-1;for(let c=o+4;c<e.length-3;c+=1){if(e[c]!==80||e[c+1]!==75)continue;const l=e[c+2];if(l===7||l===1||l===5){s=c;break}}if(s<0){const c=Ua(e);c>o&&(s=c)}if(s<0)throw new Error("ZIP 데이터 경계를 찾지 못했습니다 (local header bit3)");r=s-o}if(o+r>e.length)throw new Error(`ZIP 엔트리 길이 초과 (need ${o+r}, have ${e.length})`);return{source:"local_header",compMethod:n,compSize:r,uncompSize:rn(e,22),dataStart:o,compData:e.subarray(o,o+r)}}async function Xd(e){if(typeof DecompressionStream!="function")throw new Error("DecompressionStream 미지원 — ZIP deflate를 풀 수 없습니다");const t=V(e);w("nai.inflate.start",{message:`${t.length}B`,bytes:t.length,focus:!0});const n=new DecompressionStream("deflate-raw"),r=n.writable.getWriter(),a=n.readable.getReader(),i=[];let o=0;const s=Date.now()+2e4,c=(async()=>{for(;;){if(Date.now()>=s)throw new Error(`ZIP inflate 타임아웃 (out=${o}B)`);const{done:d,value:m}=await a.read();if(d)break;m&&(i.push(m),o+=m.length,o>0&&o%524288<m.length&&w("nai.inflate",{message:`out ${Math.round(o/1024)}KB`,bytes:o,focus:!0}))}})(),l=131072;for(let d=0;d<t.length;d+=l){if(Date.now()>=s){try{await r.abort()}catch{}throw new Error(`ZIP inflate write 타임아웃 (in=${d}B)`)}await r.write(t.subarray(d,Math.min(t.length,d+l))),d>0&&d%(l*4)===0&&await Ze(0)}await r.close(),await c;const f=An(i,o);return w("nai.inflate.done",{bytes:o,focus:!0}),f}async function Zd(e){const t=V(e);if(w("nai.unzip.start",{message:`${t.length}B`,bytes:t.length,focus:!0}),yt(t))return w("nai.unzip",{message:"raw PNG",bytes:t.length,focus:!0}),Z(t);if(t.length<30||t[0]!==80||t[1]!==75){const a=Array.from(t.subarray(0,16)).map(i=>i.toString(16).padStart(2,"0")).join(" ");throw new Error(`ZIP/PNG 응답이 아닙니다 (len=${t.length}, head=${a})`)}const n=Vd(t)??Yd(t);w("nai.unzip.entry",{message:`${n.source} method=${n.compMethod} comp=${n.compSize}B uncomp=${n.uncompSize||"?"}`,comp_method:n.compMethod,bytes:n.compSize,source:n.source,focus:!0});const r=Ua(t);if(r>=0&&n.dataStart+n.compSize>r&&(w("nai.unzip.clamp",{message:`comp ${n.compSize} → ${r-n.dataStart}`,focus:!0},"warn"),n.compSize=r-n.dataStart,n.compData=t.subarray(n.dataStart,r)),n.compSize<=0)throw new Error("ZIP 압축 페이로드가 비어 있습니다");if(n.compMethod===0)return Z(n.compData);if(n.compMethod===8){const a=await Xd(n.compData);return!yt(a)&&!(a[0]===82&&a[1]===73)&&w("nai.unzip",{message:"inflated but not PNG/RIFF magic",bytes:a.length},"warn"),Z(a)}throw new Error(`지원하지 않는 ZIP 압축 방식: ${n.compMethod}`)}var uc=$((()=>{q(),Q(),_t()}));function Qd(e="force"){return xe?(xe.forceFinish(e),!0):!1}async function De(e,t={}){const n=Ae()?.nativeFetch,r=n||globalThis.fetch,a=n?"nativeFetch":"fetch";if(typeof r!="function")throw new Error("fetch를 사용할 수 없습니다");const i={...t};i.networkRoute==null&&delete i.networkRoute;const o=ue("net.fetch");w("net.fetch.start",{message:a,url:String(e).slice(0,120),has_signal:!!i.signal});try{const s=await r(e,i),c=Number(s?.status||(s?.ok===!1?0:200));return o.end({message:a,status:c,url:String(e).slice(0,80)}),s}catch(s){throw o.fail(s,{message:a,url:String(e).slice(0,80)}),s}}async function an(e,t={}){if(!e)throw new Error("빈 응답");const n=Number(t.deadline||Date.now()+Number(t.timeoutMs||9e4)),r=t.signal||null,a=typeof t.onProgress=="function"?t.onProgress:null,i=Number(t.idleMs||2500),o=(d=0)=>{if(r?.aborted)throw new Error(`NAI 본문 읽기 중단 (abort, ${d}B)`);if(Date.now()>=n)throw new Error(`NAI 본문 읽기 타임아웃 (${d}B received)`)};if(e instanceof ArrayBuffer)return e;if(e instanceof Uint8Array)return Z(e);if(typeof e=="string"){const d=e.replace(/\s+/g,"");if(d.length>64&&/^[A-Za-z0-9+/=]+$/.test(d))return w("nai.read_bytes",{message:"string base64 body",bytes:d.length,focus:!0}),Z(Pe(d))}const s=e;if(s.buffer instanceof ArrayBuffer&&typeof s.byteLength=="number")return s.buffer.slice(s.byteOffset||0,(s.byteOffset||0)+s.byteLength);const c=e;if(e&&typeof e=="object"&&"data"in e&&!c.arrayBuffer&&!c.body)return an(c.data,t);let l=null;try{const d=c.headers,m=d?.get?.("content-length")||d?.get?.("Content-Length")||null;m&&(l=Number(m))}catch{}if(l!=null&&l>0&&(Mr=l),w("nai.read_bytes.start",{message:"begin body",content_length:l,has_arrayBuffer:typeof c.arrayBuffer=="function",has_body_reader:!!(c.body&&typeof c.body.getReader=="function"),keys:e&&typeof e=="object"?Object.keys(e).slice(0,12).join(","):typeof e,focus:!0}),c.body&&typeof c.body.getReader=="function"){const d=c.body.getReader(),m=[];let p=0,g=Date.now(),h=Date.now(),_=!1,y=null;xe={forceFinish:(x="force")=>{_=!0,w("nai.read_bytes.force",{message:x,bytes:p||l||0,focus:!0});try{d.cancel()}catch{}y&&y({done:!0,value:void 0,__forced:!0})}};try{for(;o(p),!_;){if(p>=64&&Date.now()-g>=i){w("nai.read_bytes.idle_complete",{message:`${i}ms idle`,bytes:p,focus:!0});break}if(l!=null&&l>0&&p>=l){w("nai.read_bytes.length_complete",{bytes:p,content_length:l,focus:!0});break}const x=await new Promise((E,B)=>{let J=!1;const v=(R,Y)=>{J||(J=!0,clearInterval(M),y=null,Y?B(Y):E(R))};y=R=>v(R,null);const M=setInterval(()=>{if(!J){if(_)return v({done:!0,value:void 0,__forced:!0},null);if(p>=64&&Date.now()-g>=i)return v({done:!0,value:void 0,__idle:!0},null);if(l!=null&&l>0&&p>=l)return v({done:!0,value:void 0,__length:!0},null);if(r?.aborted||Date.now()>=n)return d.cancel().catch(()=>{}),v(null,new Error(`NAI 본문 읽기 타임아웃 (${p}B received)`))}},200);d.read().then(R=>v(R,null),R=>v(null,R))});if(x?.__forced||x?.__idle||x?.__length)break;const{done:S,value:C}=x;if(S)break;if(!C)continue;const N=C instanceof Uint8Array?C:new Uint8Array(C);if(m.push(N),p+=N.length,g=Date.now(),Nr=g,ve=p,a&&a(p,l),Date.now()-h>=2e3&&(h=Date.now(),w("nai.read_bytes.progress",{message:`${Math.round(p/1024)}KB`,bytes:p,content_length:l,focus:!0})),lc(An(m,p))&&Date.now()-g>=600){w("nai.read_bytes.zip_eocd",{bytes:p,focus:!0});break}if(l!=null&&l>0&&p>=l)break}}catch(x){if(p>=64){const S=An(m,p);if(lc(S)||l!=null&&l>0&&p>=l*.98)return w("nai.read_bytes.recover",{message:String(x?.message||x),bytes:p,focus:!0},"warn"),xe=null,Z(S)}try{await d.cancel()}catch{}throw xe=null,x}if(xe=null,!p)throw new Error("NAI 본문이 비어 있습니다");const k=An(m,p);return w("nai.read_bytes.done",{bytes:p,focus:!0}),Z(k)}const f=c.arrayBuffer;if(typeof f=="function"){w("nai.read_bytes",{message:"fallback arrayBuffer() — no body stream",focus:!0});let d=!1,m,p;const g=new Promise((y,k)=>{m=y,p=k});xe={forceFinish:(y="force")=>{w("nai.read_bytes.force",{message:`${y} (arrayBuffer)`,content_length:l,focus:!0},"warn"),d||(d=!0,clearInterval(h),p(new Error(`NAI arrayBuffer 강제중단 (${y}, content-length=${l})`)))}};const h=setInterval(()=>{d||(r?.aborted||Date.now()>=n?(d=!0,clearInterval(h),xe=null,p(new Error(`NAI arrayBuffer 타임아웃 (content-length=${l}). 본문 ~${l?Math.round(l/1024):"?"}KB를 플러그인이 받지 못했습니다.`))):w("nai.read_bytes.wait",{message:`arrayBuffer pending · expect ${l?Math.round(l/1024):"?"}KB`,content_length:l,focus:!0},"warn"))},3e3);f.call(c).then(y=>{d||(d=!0,clearInterval(h),xe=null,m(y))}).catch(y=>{d||(d=!0,clearInterval(h),xe=null,p(y))});const _=await g;if(_&&_.byteLength)return ve=_.byteLength,w("nai.read_bytes.done",{bytes:_.byteLength,focus:!0}),_}if(typeof c.bytes=="function"){const d=await c.bytes();if(d?.length)return Z(d)}if(typeof c.text=="function"){const d=await c.text();if(/^[A-Za-z0-9+/=\s]+$/.test(d)&&d.replace(/\s+/g,"").length>64)try{return Z(Pe(d.replace(/\s+/g,"")))}catch{}throw new Error(`바이너리 본문을 읽지 못함 (text head=${String(d).slice(0,120)})`)}throw new Error("바이너리 본문을 읽지 못함")}async function em(e,t,n,r={}){const a={Authorization:`Bearer ${e}`,"Content-Type":"application/json"},i=Number(r.timeoutMs||75e3),o=r.signal||null,s=JSON.stringify(t);if(w("nai.payload",{message:`body ${Math.round(s.length/1024)}KB`,bytes:s.length,model:t?.model,timeout_ms:i,url:String(n||"https://image.novelai.net/ai/generate-image").slice(0,100),has_nativeFetch:ge("nativeFetch")}),s.length>15e5)throw w("nai.payload",{message:"too large",bytes:s.length},"error"),new Error(`NAI 페이로드가 너무 큼 (${Math.round(s.length/1024)}KB). 참조 이미지/프롬프트를 줄이세요.`);const c=typeof AbortController<"u"?new AbortController:null,l=()=>{w("nai.abort",{message:"external signal"},"warn"),c?.abort()};if(o){if(o.aborted)throw new Error("NAI 요청이 취소되었습니다.");o.addEventListener("abort",l,{once:!0})}const f=Date.now();ve=0,Mr=0,Nr=0,Ja=!0;const d=setInterval(()=>{const p=Date.now()-f;p>=i?(w("nai.watchdog",{message:`abort after ${p}ms · body=${ve}B`,ms:p,bytes:ve},"warn"),c?.abort()):p>0&&p%1e4<1100&&w("nai.wait",{message:`waiting ${Math.round(p/1e3)}s · body=${ve}B · ${gt()}`,ms:p,bytes:ve,focus:!0},"warn")},1e3);let m=null;try{try{w("nai.fetch.start",{message:"POST generate-image",timeout_ms:i,focus:!0});const p=await De(n||"https://image.novelai.net/ai/generate-image",{method:"POST",headers:a,body:s,signal:c?.signal,requestTimeoutMs:i});if(w("nai.fetch.returned",{message:"nativeFetch resolved",ms:Date.now()-f,status:Number(p?.status||0),focus:!0}),o?.aborted||c?.signal?.aborted)throw w("nai.fetch.aborted",{ms:Date.now()-f},"error"),new Error(`NAI 타임아웃 (${Math.round(i/1e3)}s) — nativeFetch가 응답하지 않습니다. Models에서 NAI Test를 확인하세요.`);const g={signal:c?.signal,deadline:f+i,onProgress:k=>{ve=k}};if(p&&typeof p=="object"&&"ok"in p&&"data"in p&&!p.arrayBuffer){const k=Number(p.status||(p.ok?200:0));if(w("nai.resp.shape",{message:"ok/data shape",status:k,focus:!0}),k===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(k===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(k>=400){const C=typeof p.data=="string"?p.data:p.data instanceof Uint8Array?new TextDecoder().decode(p.data.subarray(0,220)):JSON.stringify(p.data||{}).slice(0,220);throw new Error(`NAI HTTP ${k}: ${C}`)}const x=ue("nai.read_bytes"),S=await an(p.data,g);if(x.end({bytes:S?.byteLength||0,focus:!0}),!S||S.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${S?.byteLength||0} bytes)`);return S}const h=Number(p?.status||0);if(w("nai.resp.shape",{message:"Response-like",status:h,has_arrayBuffer:typeof p?.arrayBuffer=="function",has_body:!!p?.body,focus:!0}),h===401)throw new Error("인증 실패 (401). NovelAI API 토큰(pst-...)을 확인하세요.");if(h===429)throw new Error("Rate limited (429). 잠시 후 다시 시도하세요.");if(h>=400){let k="";try{k=await p.text()}catch{}throw new Error(`NAI HTTP ${h}: ${k.slice(0,220)}`)}const _=ue("nai.read_bytes"),y=await an(p,g);if(_.end({bytes:y?.byteLength||0,status:h,focus:!0}),!y||y.byteLength<32)throw new Error(`NAI 응답이 너무 짧음 (${y?.byteLength||0} bytes)`);return y}catch(p){throw m=String(p?.message||p),w("nai.fetch.error",{message:m,ms:Date.now()-f,bytes:ve},"error"),/abort|timeout|타임아웃|취소|본문 읽기/i.test(m)?new Error(`NAI 타임아웃/본문실패 (${Math.round(i/1e3)}s, body=${ve}B). ${m.slice(0,180)}`):p instanceof Error?p:new Error(m)}}finally{Ja=!1,clearInterval(d),o&&o.removeEventListener("abort",l)}}var ve,Mr,Nr,xe,Ja,Ha,fc,dc,mc,Tt=$((()=>{ee(),q(),pt(),Q(),uc(),ve=0,Mr=0,Nr=0,xe=null,Ja=!1,Ha=()=>ve,fc=()=>Mr,dc=()=>Nr,mc=()=>xe!==null}));function Hn(e){return u(e?.backend||"nai").toLowerCase()==="comfy"?"comfy":"nai"}function tm(e){const t=Number(e?.backend_timeout_seconds??300);return Math.max(30,Math.min(1800,Number.isNaN(t)?300:t))*1e3}function Ir(e){return String(e||"").trim().replace(/\/+$/,"")}function pc(e){return Ir(u(e?.comfy_url))||"http://localhost:8188"}function Ka(e){return!!u(e?.comfy_workflow_json)}async function qa(e,t={}){const n=await De(e,t);if(n&&typeof n=="object"&&"ok"in n&&"data"in n&&typeof n.arrayBuffer!="function"){const i=Number(n.status||(n.ok?200:0));let o=n.data;if(o instanceof Uint8Array&&(o=new TextDecoder().decode(o)),typeof o=="string")try{o=JSON.parse(o)}catch{}return{status:i,data:o}}const r=Number(n?.status||0);let a=null;try{a=await n.json()}catch{try{a=JSON.parse(await n.text())}catch{}}return{status:r,data:a}}async function nm(e,t,n={}){const r=`inlay-nexus-${Math.random().toString(36).slice(2,10)}`,{status:a,data:i}=await qa(`${Ir(e)}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:r,prompt:t}),signal:n.signal});if(a>=400||!i?.prompt_id){const o=i?JSON.stringify(i.node_errors||i.error||i).slice(0,300):"";throw new Error(`/prompt 제출 실패 (HTTP ${a}) ${o}`)}return String(i.prompt_id)}async function rm(e,t,n={}){const r=Ir(e),a=Number(n.timeoutMs||3e5),i=Date.now()+a;let o=0,s="";for(;Date.now()<i;){if(n.signal?.aborted)throw new Error("이미지 대기 중단 (abort)");await Ze(2500),o+=1;let c=null;try{const{status:d,data:m}=await qa(`${r}/history/${t}`,{method:"GET",signal:n.signal});d<400&&m&&m[t]&&(c=m[t])}catch(d){s=String(d?.message||d);continue}if(o%8===0&&w("comfy.poll",{message:`${o}회 · ${Math.round((Date.now()-(i-a))/1e3)}s`,focus:!0}),!c)continue;const l=c.status||{};if(l.status_str==="error")throw new Error(`생성 실패: ${JSON.stringify(l.messages||[]).slice(0,400)}`);const f=c.outputs||{};for(const d of Object.keys(f)){const m=f[d]?.images;if(Array.isArray(m)&&m.length)return m.find(p=>(p?.type||"output")!=="temp")||m[0]}if(l.completed)throw new Error("생성은 완료됐지만 출력 이미지가 없습니다 (SaveImage 노드 확인)")}throw new Error(`이미지 대기 타임아웃 (${Math.round(a/1e3)}s)${s?` · ${s}`:""}`)}async function am(e,t,n={}){const r=new URLSearchParams({filename:u(t?.filename,300),subfolder:u(t?.subfolder,300),type:u(t?.type,40)||"output"}),a=await De(`${Ir(e)}/view?${r.toString()}`,{method:"GET",signal:n.signal}),i={signal:n.signal,deadline:Date.now()+6e4};if(a&&typeof a=="object"&&"ok"in a&&"data"in a&&!a.arrayBuffer){const s=Number(a.status||(a.ok?200:0));if(s>=400)throw new Error(`/view 실패 (HTTP ${s})`);return an(a.data,i)}const o=Number(a?.status||0);if(o>=400)throw new Error(`/view 실패 (HTTP ${o})`);return an(a,i)}function im(e,t){let n=String(e||"");for(let r=0;r<8;r+=1){const a=n.replace(/\[\[#(\w+)\]\]([\s\S]*?)\[\[\/\1\]\]/g,(i,o,s)=>{const c=t[o];return c!=null&&String(c).trim()!==""?s:""});if(a===n)break;n=a}return n.replace(/[ \t]+\n/g,`
`).replace(/\n{3,}/g,`

`)}function om(e,t){for(const n of Object.values(e)){const r=n?.inputs;if(!(!r||typeof r!="object"))for(const a of Object.keys(r)){const i=r[a];if(typeof i!="string"||!i.includes("[["))continue;const o=im(i,t),s=o.match(/^\[\[\s*(\w+)\s*\]\]$/);if(s&&s[1]in t){r[a]=t[s[1]];continue}r[a]=o.replace(/\[\[\s*(\w+)\s*\]\]/g,(c,l)=>l in t?String(t[l]):c)}}}function sm(e,t){const n=Number(t)||1;for(const r of Object.values(e)){const a=r?.inputs;if(!(!a||typeof a!="object"))for(const i of Object.keys(a)){if(!/^(seed|noise_seed)$/i.test(i))continue;const o=a[i];(typeof o=="number"&&Number.isFinite(o)||typeof o=="string"&&/^\d+$/.test(o.trim()))&&(a[i]=n)}}}function gc({main:e,neg:t,captions:n,nai:r,seed:a}){const i={pos:String(e||""),neg:String(t||""),width:Number(r.width??832)||832,height:Number(r.height??1216)||1216,seed:Number(a)||1,steps:Number(r.steps??28)||28,cfg:Number(r.cfg_scale??7)||7};for(let o=0;o<6;o+=1)i[`char${o+1}`]=u(n?.[o]?.prompt,2e3);return i}function cm(e){let t=String(e||"");return t=t.replace(/(:\s*)\[\[\s*(\w+)\s*\]\](\s*[,}\]])/g,'$1"[[$2]]"$3'),t}function hc(e,t){const n=u(e);if(!n)throw new Error("ComfyUI 워크플로 JSON이 비어 있습니다. Models 탭에 API Export JSON을 붙여넣으세요.");let r;const a=cm(n);try{r=JSON.parse(a)}catch(s){const c=/\[\[/.test(n)?' · 팁: [[seed]] 같은 값은 반드시 "[[seed]]"처럼 따옴표로 감싸세요.':"";throw new Error(`ComfyUI 워크플로 JSON 파싱 실패: ${String(s?.message||s).slice(0,120)}${c}`)}if(!r||typeof r!="object"||Array.isArray(r))throw new Error("ComfyUI 워크플로는 API 포맷(JSON 객체, 노드ID→노드)이어야 합니다.");let i=r;if(i.nodes&&i.links)throw new Error("UI 저장 포맷 워크플로입니다. ComfyUI에서 'Export (API)'로 내보낸 JSON을 넣으세요.");const o=JSON.stringify(i);if(!/\[\[\s*pos\s*\]\]/.test(o))throw new Error("워크플로에 [[pos]]가 없습니다. 긍정 프롬프트를 넣는 칸에 [[pos]]를 적어 주세요.");return i=JSON.parse(o),om(i,t),sm(i,t.seed),i}async function lm(e,t,n,r){const a=pc(e),i=tm(e),o=Number(e.seed??0)||Math.floor(Math.random()*4294967295)||1,s=gc({main:t,neg:n,captions:r,nai:e,seed:o}),c=hc(e.comfy_workflow_json,s);return w("comfy.generate.start",{message:a,prompt_len:String(t||"").length,chars:(r||[]).length,nodes:Object.keys(c).length,focus:!0}),_c.run(async()=>{const l=await nm(a,c);w("comfy.generate.submitted",{message:l.slice(0,8),focus:!0});const f=await rm(a,l,{timeoutMs:i}),d=await am(a,f);if(w("comfy.generate.done",{bytes:d?.byteLength||0,focus:!0}),!d||d.byteLength<256)throw new Error(`ComfyUI 응답 이미지가 너무 짧음 (${d?.byteLength||0}B)`);return[d,o]})}var _c,Ga=$((()=>{q(),_t(),O(),Tt(),_c=new cr}));Ga(),Au(),Q(),O();var Wa=lo;function Je(e,t=!1){let n=Wa[String(e).toLowerCase()]||e;return t&&(n+="-inpainting"),n}function um(e){const t=[],n=[];for(const r of e.characters||[]){const a={x:r.center_x,y:r.center_y};t.push({char_caption:r.prompt,centers:[a]}),n.push({char_caption:r.uc||"",centers:[a]})}return{autoSmea:!0,prefer_brownian:!0,ucPreset:0,use_coords:!1,legacy_uc:!1,add_original_image:!0,v4_prompt:{caption:{base_caption:e.prompt,char_captions:t},use_coords:!1,use_order:!0},v4_negative_prompt:{caption:{base_caption:e.negative_prompt,char_captions:n},legacy_uc:!1}}}function fm(e){const t=Je(e.model),n={width:e.width,height:e.height,n_samples:1,seed:e.seed,extra_noise_seed:e.seed,sampler:e.sampler,steps:e.steps,scale:e.cfg_scale,negative_prompt:e.negative_prompt,cfg_rescale:e.cfg_rescale,noise_schedule:e.scheduler,params_version:3,legacy:!1,legacy_v3_extend:!1};if(e.var_plus?n.skip_cfg_above_sigma=t.includes("4-5")?58:19:n.skip_cfg_above_sigma=null,t.includes("nai-diffusion-4")&&Object.assign(n,um(e)),e.vibes?.length&&(n.reference_image_multiple=e.vibes.map(r=>r.encoded),n.reference_strength_multiple=e.vibes.map(r=>r.strength),n.reference_information_extracted_multiple=e.vibes.map(r=>r.information_extracted),n.normalize_reference_strength_multiple=!0),e.character_refs?.length){if(!t.includes("4-5"))throw new Error("Character Reference는 NAID4.5 전용입니다");n.director_reference_images=e.character_refs.map(r=>Jt(r.image)),n.director_reference_strength_values=e.character_refs.map(r=>r.strength),n.director_reference_secondary_strength_values=e.character_refs.map(r=>1-r.fidelity),n.director_reference_descriptions=e.character_refs.map(r=>({caption:{base_caption:r.type,char_captions:[]},legacy_uc:!1})),n.director_reference_information_extracted=e.character_refs.map(()=>1),n.controlnet_strength=1,n.inpaintImg2ImgStrength=1,n.normalize_reference_strength_multiple=!0,delete n.skip_cfg_above_sigma}return n}function He(e){const t=u(e)||"nai-diffusion-4-5-full",n=Object.fromEntries(Object.entries(Wa).map(([r,a])=>[a,r]));return Wa[t]?t:n[t]?n[t]:"naid4.5f"}ee(),q(),_t(),Q(),uc(),Tt();var dm=new cr;async function yc(e,t,n,r={}){const a={input:t.prompt,model:Je(t.model),action:"generate",parameters:fm(t)};return w("nai.generate.start",{message:a.model,prompt_len:String(t.prompt||"").length,chars:(t.characters||[]).length,has_char_refs:!!t.character_refs?.length,has_vibes:!!t.vibes?.length}),dm.run(async()=>{const i=await em(e,a,n,r),o=ue("nai.unzip");try{const s=await Zd(new Uint8Array(i)),c=yt(new Uint8Array(s));return o.end({bytes:s?.byteLength||0,is_png:c,zip_bytes:i?.byteLength||0}),c||w("nai.unzip",{message:"unzipped but not PNG magic",bytes:s?.byteLength||0},"warn"),{raw_bytes:s,seed:t.seed||0}}catch(s){throw o.fail(s,{zip_bytes:i?.byteLength||0}),s}})}async function mm(e){const t=await De(Fi,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),n=Number(t?.status||0);if(n===401)throw new Error("인증 실패 (401). API 토큰을 확인하세요.");if(n>=400)throw new Error(`Anlas 조회 실패: HTTP ${n}`);const r=await t.json(),a=r.trainingStepsLeft||{},i=a.fixedTrainingStepsLeft||0,o=a.purchasedTrainingSteps||0,s=r.perks?.unlimitedMaxPriority||!1;return{fixed:i,purchased:o,total:i+o,opus:s}}function ke(e){return Number.isFinite(e)?Math.max(0,Math.min(100,e)):0}function pm(e){if(!e)return null;for(const t of["y_percent","anchor_percent","read_percent"]){const n=Number(e[t]);if(Number.isFinite(n))return ke(n)}return null}function gm(e){const t=e.length;if(!t)return[];const n=e.map((a,i)=>({index:i,y:pm(a)})).map((a,i)=>a.y!=null?a.y:t===1?50:ke(i/Math.max(1,t-1)*100)).map((a,i)=>({y:a,index:i})).sort((a,i)=>a.y-i.y||a.index-i.index),r=Array.from({length:t},()=>({from_percent:0,to_percent:100}));for(let a=0;a<n.length;a++){const{y:i,index:o}=n[a],s=a>0?n[a-1].y:null,c=a<n.length-1?n[a+1].y:null;let l,f;s==null&&c==null?(l=ke(i-Va),f=ke(i+Va)):s==null?(l=0,f=ke((i+c)/2)):c==null?(l=ke((s+i)/2),f=100):(l=ke((s+i)/2),f=ke((i+c)/2)),f<l&&(f=l),f-l<1&&(l=ke(i-.5),f=ke(i+.5),f<l&&(f=l)),r[o]={from_percent:Math.round(l*100)/100,to_percent:Math.round(f*100)/100}}return r}function hm(e,t,n){const r=e.length;if(!r)return{start:0,end:0};const a=ke(t),i=ke(n);let o=Math.floor(r*a/100),s=Math.ceil(r*i/100);return s<o&&(s=o),s===o&&o<r&&(s=Math.min(r,o+1)),{start:Math.max(0,o),end:Math.min(r,s)}}function _m(e,t,n,r=wc){const a=typeof e=="string"?e:"";if(!a)return"";let{start:i,end:o}=hm(a,t,n);const s=a.lastIndexOf(`
`,i);s>=0&&i-s<=80&&(i=s+1);const c=a.indexOf(`
`,o);c>=0&&c-o<=80&&(o=c);let l=a.slice(i,o).trim();return l.length>r&&(l=`${l.slice(0,r).trimEnd()}…`),l}function bc(e,t){return gm(e).map(n=>({focus:n,focus_hint:_m(t,n.from_percent,n.to_percent)}))}var Va,wc,ym=$((()=>{Va=15,wc=600})),bm,vc,xc,kc,wm=$((()=>{bm=1,vc="Inlay default (SFW)",xc=[{id:"composition.solo",label:"솔로 구도",options:[{id:"1girl_solo_portrait",description:"여성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"1boy_solo_portrait",description:"남성 1명 초상·상반신·시청자 응시",tags:"cowboy shot, looking at viewer"},{id:"solo_from_side",description:"혼자 옆모습",tags:"from side, cowboy shot"},{id:"solo_upper_body",description:"혼자 상반신 클로즈업",tags:"upper body, looking at viewer"}]},{id:"composition.duo",label:"2인 구도",options:[{id:"facing_each_other",description:"남녀가 서로를 향함",tags:"2::facing another::",slot:"char",by_slot:{female:"2::facing another::",male:"2::facing another::"}},{id:"male_behind_female",description:"남성이 여성 뒤",tags:"2::from side::, 2::side-by-side::, 2::behind another::"},{id:"side_by_side",description:"나란히 서 있음",tags:"2::side-by-side::, 2::from side::"},{id:"2girls_facing",description:"여성 둘이 마주봄",tags:"2::facing another::"},{id:"hug_front",description:"앞에서 안기",tags:"hug, facing another"}]},{id:"camera.framing",label:"카메라/프레이밍",options:[{id:"cowboy_shot",description:"허리 위",tags:"cowboy shot"},{id:"full_body",description:"전신",tags:"full body"},{id:"upper_body",description:"상반신",tags:"upper body"},{id:"close_up",description:"얼굴 클로즈업",tags:"close-up, face"},{id:"from_above",description:"위에서",tags:"from above"},{id:"from_below",description:"아래에서",tags:"from below"},{id:"from_side",description:"옆에서",tags:"from side"},{id:"pov",description:"1인칭 시점",tags:"pov, pov hands"}]},{id:"pose.hands",label:"손/포즈",options:[{id:"hand_on_own_chest",description:"자신의 가슴에 손",tags:"hand on own chest"},{id:"hands_up",description:"손 들기",tags:"hands up"},{id:"reaching_out",description:"손 뻗기",tags:"reaching out"},{id:"holding_hands",description:"손잡기",tags:"holding hands"},{id:"arm_around_waist",description:"허리에 팔",tags:"arm around waist"},{id:"hug_from_behind",description:"뒤에서 안기",tags:"hug from behind"}]},{id:"expression.basic",label:"표정",options:[{id:"smile",description:"미소",tags:"smile"},{id:"blush",description:"홍조",tags:"blush"},{id:"serious",description:"진지",tags:"serious"},{id:"open_mouth",description:"입 벌림",tags:"open mouth"},{id:"closed_eyes",description:"눈 감음",tags:"closed eyes"},{id:"looking_at_another",description:"상대를 봄",tags:"looking at another"}]},{id:"place.indoor",label:"실내 배경",options:[{id:"bedroom",description:"침실",tags:"bedroom, indoors"},{id:"classroom",description:"교실",tags:"classroom, indoors"},{id:"living_room",description:"거실",tags:"living room, indoors"},{id:"bathroom",description:"욕실",tags:"bathroom, indoors"},{id:"cafe",description:"카페",tags:"cafe, indoors"}]},{id:"place.outdoor",label:"야외 배경",options:[{id:"outdoors_day",description:"낮 야외",tags:"outdoors, blue sky"},{id:"street",description:"거리",tags:"street, outdoors"},{id:"park",description:"공원",tags:"park, outdoors, tree"},{id:"beach",description:"해변",tags:"beach, outdoors, ocean"},{id:"night_city",description:"밤 도시",tags:"outdoors, night, cityscape"}]}],kc={version:1,name:vc,groups:xc}}));function Kn(e){return e?e.has_presets===!0?!0:e.presets!=null&&typeof e.presets=="object":!1}function vm(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t={};for(const[n,r]of Object.entries(e)){const a=u(n,80);if(!a||!r||typeof r!="object"||Array.isArray(r))continue;const i=r,o=Array.isArray(i.fallback_order)?i.fallback_order.map(c=>u(c,160)).filter(Boolean):[],s=Math.max(1,Math.min(8,Number(i.max_active_groups)||1));o.length&&(t[a]={max_active_groups:s,fallback_order:o,...u(i.scope,40)?{scope:u(i.scope,40)}:{}})}return Object.keys(t).length?t:void 0}function Sc(e,t){const n=u(e,160).toLowerCase(),r=u(t,160).toLowerCase();if(!n||!r)return!1;if(n.endsWith(".*")){const a=n.slice(0,-1);return r.startsWith(a)||r===n.slice(0,-2)}return n.endsWith("*")?r.startsWith(n.slice(0,-1)):r===n}function Ac(e){const t=Array.isArray(e)?e:u(e,800).split(/[,|]/),n=[],r=new Set;for(const a of t){const i=u(a,120);!i||r.has(i)||(r.add(i),n.push(i))}return n}function Mc(e,t){const n=Ac(t),r=e.modifier_lanes;if(!r||!Object.keys(r).length)return n;const a=new Map;for(const o of n){const s=sn(e,o);s&&a.set(o,s.group.id)}const i=new Set;for(const o of Object.values(r)){const s=new Set;for(const f of a.values())o.fallback_order.some(d=>Sc(d,f))&&s.add(f);if(s.size<=o.max_active_groups)continue;const c=[...s].map(f=>{let d=o.fallback_order.length;for(let m=0;m<o.fallback_order.length;m++)if(Sc(o.fallback_order[m],f)){d=m;break}return{gid:f,rank:d}});c.sort((f,d)=>f.rank-d.rank||f.gid.localeCompare(d.gid));const l=new Set(c.slice(0,o.max_active_groups).map(f=>f.gid));for(const{gid:f}of c)l.has(f)||i.add(f)}return i.size?n.filter(o=>{const s=a.get(o);return!s||!i.has(s)}):n}function Ya(){return{base:"",char:"",primary:"",secondary:"",female:"",male:""}}function jt(e,t){const n=u(t,40).toLowerCase();if(["char","character","actor"].includes(n))return"char";if(["primary","main"].includes(n))return"primary";if(["secondary","partner"].includes(n))return"secondary";if(["female","f","girl","woman"].includes(n))return"female";if(["male","m","boy","man"].includes(n))return"male";if(["base","global","scene","camera","place"].includes(n))return"base";const r=u(e,160).toLowerCase();return/^(pose|expression|gesture|emotion|contact|action|interaction|manual|relation|gaze)([./_]|$)/.test(r)||/\.(pose|expression|gesture|interaction|manual|contact)\b/.test(r)||/^composition\.(duo|pair|multi|group|couple)/.test(r)?"char":/^(place|camera|background|location|framing|view|lighting|scene)([./_]|$)/.test(r)||/^composition\./.test(r)?"base":/^state\./.test(r)?"char":"base"}function Nc(e){const t=u(e,200).toLowerCase();if(!t)return null;const n=t.split(".")[0]||"";return n==="global"||n==="scene"||n==="camera"?"base":n==="primary"?"primary":n==="secondary"?"secondary":n==="female"||n==="girl"||n==="woman"?"female":n==="male"||n==="boy"||n==="man"?"male":n==="persona"?"base":null}function xm(e){return e.trim().toLowerCase()==="global.composition"}function Ic(e){if(!e||typeof e!="object"||Array.isArray(e))return{};const t={};for(const[n,r]of Object.entries(e)){if(xm(n))continue;const a=Nc(n);if(!a)continue;const i=qn(r);i&&(t[a]=I(t[a],i))}return t}function $t(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function qn(e){if(typeof e=="string")return u(e,800);if(!Array.isArray(e)||!e.length)return"";const t=[];for(const n of e){if(typeof n=="string"){const i=u(n,200);i&&t.push(i);continue}if(!Array.isArray(n)||n.length<2)continue;const r=Number(n[0]),a=u(n[1],200);a&&(Number.isFinite(r)&&r!==1?t.push(`${r}::${a}::`):t.push(a))}return I(...t)}function km(e,t,n){const r=$t(e);if(!r)return null;const a=u(r.id,120)||`opt_${t}`,i=Ic(r.prompt),o=$t(r.by_slot)||$t(r.slots)||$t(r.actors),s={...i};if(o){for(const d of["base","char","primary","secondary","female","male"]){const m=u(o[d],800);m&&(s[d]=I(s[d],m))}for(const[d,m]of Object.entries(o)){const p=jt(n,d);typeof m=="string"&&u(m)&&(s[p]=I(s[p],u(m,800)))}}let c=u(r.tags??r.tag,800);if(c||(c=Array.isArray(r.prompt)?qn(r.prompt):""),c||(c=u(typeof r.prompt=="string"?r.prompt:"",800)),!c&&Object.keys(s).length&&(c=I(...Object.values(s))),!c)return null;const l=jt(n,r.slot??r.target??r.apply_to),f=Object.keys(s).length?s:void 0;return{id:a,description:u(r.description??r.label??r.when,400)||a,tags:c,slot:l,...f?{by_slot:f}:{}}}function Cc(e,t,n){const r=$t(e);if(!r)return null;const a=u(r.id,160)||`group_${t}`,i=u(r.label??r.name??r.description,200)||a,o=Array.isArray(r.options)?r.options:Array.isArray(r.include_options)?r.include_options:[],s=[];for(let c=0;c<o.length&&s.length<n;c++){const l=km(o[c],c,a);l&&s.push(l)}return s.length?{id:a,label:i,options:s,...r.continuity===!0||r.continuity==="true"?{continuity:!0}:{}}:null}function Sm(e,t){const n=Array.isArray(e)?e:e&&typeof e=="object"?Object.values(e):[],r=[];for(let a=0;a<n.length;a++){const i=Cc(n[a],a,t);i&&r.push(i)}return r}function Am(e,t){return e.modifier_library!=null?{list:Sm(e.modifier_library,80),maxOptions:80,nameHint:"Asset Maid catalog",preNormalized:!0}:Array.isArray(e.groups)?{list:e.groups,maxOptions:80,nameHint:"",preNormalized:!1}:Array.isArray(t)?{list:t,maxOptions:80,nameHint:"",preNormalized:!1}:{list:[],maxOptions:10,nameHint:"",preNormalized:!1}}function Xa(e,t="catalog"){const n=$t(e)||{},{list:r,maxOptions:a,nameHint:i,preNormalized:o}=Am(n,e),s=[];for(let N=0;N<r.length;N++){if(o){const B=r[N];if(B?.id&&Array.isArray(B.options)&&B.options.length){const J=B.options.slice(0,a).map((v,M)=>({...v,slot:v.slot||jt(B.id,v.slot),id:v.id||`opt_${M}`,description:v.description||v.id||`opt_${M}`,tags:v.tags}));s.push({id:B.id,label:B.label||B.id,options:J,...B.continuity?{continuity:!0}:{}})}continue}const E=Cc(r[N],N,a);E&&s.push(E)}if(!s.length)throw new Error("큐레이션 카탈로그에 그룹이 없습니다. Inlay `{groups:[…]}` 또는 Asset Maid `modifier_library` JSON인지 확인하세요.");const c=Number(n.version)||1,l=u(n.name,200)||i||t,f=n.presets!=null&&typeof n.presets=="object"?n.presets:void 0,d=vm(n.modifier_lanes),m=$t(n.global)||{},p=qn(m.fixed_positive)||u(m.fixed_positive??n.fixed_positive,800),g=qn(m.fixed_negative)||u(m.fixed_negative??n.fixed_negative,800),h=n.subjects??m.subjects,_=n.selection??m.selection,y=m.prompt_order??n.prompt_order,k=Array.isArray(y)?y.map(N=>u(N,40)).filter(Boolean):void 0,x=new Set(s.filter(N=>N.continuity).map(N=>N.id)),S=n.continuity??m.continuity;if(Array.isArray(S))for(const N of S){const E=u(N,160);if(!E)continue;x.add(E);const B=s.find(J=>J.id===E);B&&(B.continuity=!0)}const C={version:c,name:l,groups:s,...f?{presets:f,has_presets:!0}:{has_presets:!1},...d?{modifier_lanes:d}:{},...p?{fixed_positive:p}:{},...g?{fixed_negative:g}:{},...h!=null&&typeof h=="object"?{subjects:h}:{},..._!=null&&typeof _=="object"?{selection:_}:{},...k?.length?{prompt_order:k}:{},...x.size?{continuity_group_ids:[...x].sort()}:{}};return C.sha=Gn(C),C}function Za(e,t){const n=u(t,160);return n?e.continuity_group_ids?.includes(n)?!0:Tc(e,n)?.continuity===!0:!1}function Ec(e){return e.groups.filter(t=>!Za(e,t.id))}function Qa(){return Xa(kc,"Inlay default (SFW)")}function Gn(e){const t=JSON.stringify({version:e.version,name:e.name,groups:e.groups.map(r=>({id:r.id,continuity:r.continuity??null,options:r.options.map(a=>({id:a.id,tags:a.tags,description:a.description,slot:a.slot,by_slot:a.by_slot}))})),presets:e.presets??null,modifier_lanes:e.modifier_lanes??null,fixed_positive:e.fixed_positive??null,fixed_negative:e.fixed_negative??null,subjects:e.subjects??null,selection:e.selection??null,prompt_order:e.prompt_order??null,continuity_group_ids:e.continuity_group_ids??null});let n=2166136261;for(let r=0;r<t.length;r++)n^=t.charCodeAt(r),n=Math.imul(n,16777619);return(n>>>0).toString(16).padStart(8,"0")}function Mm(...e){const t=Ya();for(const n of e)n&&(t.base=I(t.base,n.base),t.char=I(t.char,n.char),t.primary=I(t.primary,n.primary),t.secondary=I(t.secondary,n.secondary),t.female=I(t.female,n.female),t.male=I(t.male,n.male));return t}function on(e){return e?{base:u(e.base,800),char:u(e.char,800),primary:u(e.primary,800),secondary:u(e.secondary,800),female:u(e.female,800),male:u(e.male,800)}:Ya()}function Tc(e,t){const n=u(t,160);return n&&e.groups.find(r=>r.id===n)||null}function sn(e,t){const n=u(t,120);if(!n)return null;for(const r of e.groups){const a=r.options.find(i=>i.id===n);if(a)return{group:r,option:a}}return null}function Nm(e){const t=[];for(const n of e.groups)for(const r of n.options)t.push({key:`${n.id}::${r.id}`,groupId:n.id,optionId:r.id,text:`${r.description} | ${r.tags}`,tags:r.tags,slot:r.slot||jt(n.id)});return t}function Im(e,t=!1){const n=Ec(e).map(r=>{const a=r.options.map(i=>`  - ${i.id}: ${i.description}`).join(`
`);return`### ${r.id} (${r.label})
...
`)}function jc(){return["## Per-actor ids (strict catalog-id mode)",'Add `"characters": [ { "index": 0, "option_ids": ["id", "..."] }, ... ]` to EVERY shot.','Each shot input includes `cast`: `[{ "index": 0, "name": "...", "gender": "girl|boy|""" }, ...]`.',"`index` MUST match `cast[].index` / Pass-1 `characters` array order — use name+gender from `cast`, not chat mention order.","Example: if cast says index 0 = 보민 (boy) and index 1 = Serin (girl), put bound/tears on the boy's index, not the girl's.","Put an option on `characters[].option_ids` when it targets ONE specific actor (pose, contact, expression, gaze).","Put an option on the shot-level `curation_option_ids` instead when it is scene-wide (camera, place, framing) — do not duplicate it into every actor.","Every actor in `cast` needs an entry, even if `option_ids` is `[]`.","This mode has NO freeform camera/situation/action fallback — an unlisted concept is simply omitted, never paraphrased."]}function Cm(e,t,n){const r=n?.strictIds===!0,a=new Set(t.map(s=>u(s,160)).filter(Boolean)),i=Ec(e).filter(s=>a.has(s.id)),o=(i.length?i:[]).map(s=>{const c=s.options.map(l=>`  - ${l.id}: ${l.description}`).join(`
`);return`### ${s.id} (${s.label})
${c}`});return["Curation two-stage ON (pass 2 — scene refine, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ] }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "camera": "...", "situation": "...", "place": "...", "action": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["cowboy_shot", "smile"] }, { "index": 1, "option_ids": ["facing_each_other"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["cowboy_shot", "facing_each_other", "smile", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output — host injects catalog tags from those ids.","For EVERY shot pick ALL listed options that match the chat at that y_percent (pose, contact, expression, place…).","Typical **2–8 ids**; `[]` ONLY if nothing fits. Do not skip obvious matches.",r?"Do NOT invent character appearance/attire. Do NOT invent option ids. Do NOT write freeform camera/situation/action text — ids only.":"Prefer ids over freeform camera/situation/action paraphrase.",...r?[]:["Do NOT invent character appearance/attire. Do NOT invent option ids."],...$c(),...r?["",...jc()]:[],"",o.length?"## Allowed options (union of all shots' groups)":`## Allowed options
(none — leave scene fields empty)`,...o].join(`
`)}function $c(){return["## Chat context (separate user message, READ-ONLY)","A prior user message is the exact chat text from pass 1 (for LLM prompt cache).","Use it for continuity only (who the cast is, ongoing scene).","Do NOT rewrite, quote-edit, summarize into the JSON, or invent missing plot beats.","Do NOT change shot count, shot_index, composition_id, composition_variant, or y_percent.","","## Shot focus bands (PRIMARY evidence)","Each shot includes `y_percent`, `focus: { from_percent, to_percent }`, and `focus_hint` (a short quote from that band of the chat).","Pick options primarily from `focus_hint` / the `focus` percent range for THAT shot.","Do NOT pull actions from far-away bands into this shot. Full chat is background, not a license to copy the same ids onto every shot.","When focuses differ, prefer distinct `curation_option_ids` / per-actor ids across shots — avoid pasting one identical set on every shot_index.","Do NOT invent aftermath tags (`after_sex`, `afterglow`, cum_on_*, etc.) unless `focus_hint` explicitly shows that aftermath.","y_percent / focus are already final — never output new y_percent or focus fields."]}function Em(){return["Curation embed-snap mode: write DETAILED English Danbooru scene tags.","Fill camera, situation, place, action with concrete tags (framing, pose, contact, location, expression-as-scene).",'Use standard Danbooru spacing (underscores as spaces): e.g. "cowboy shot", "from side", "hand on own chest", "facing another".','Prefer specific pose/contact/framing over vague words like "intimate" or "dramatic".',"Character appearance/attire/accessories stay in character fields — do not move them into camera/situation.","`natural` still follows the Natural base mode system message."].join(`
`)}function Tm(e){const t=e.prompt_order;if(!t?.length)return ti;const n=[],r=new Set;for(const a of t){const i=Nc(a)||(u(a,40).toLowerCase()==="char"?"char":null);i&&!r.has(i)&&(r.add(i),n.push(i))}for(const a of ti)r.has(a)||n.push(a);return n}function jm(e,t){const n=Pc(e,t);return I(...Tm(e).map(r=>n[r]))}function Pc(e,t){const n=Array.isArray(t)?t:u(t,800).split(/[,|]/),r={base:[],char:[],primary:[],secondary:[],female:[],male:[]},a=new Set;for(const i of n){const o=u(i,120);if(!o||a.has(o))continue;const s=sn(e,o);if(!s)continue;a.add(o);const c=s.option.by_slot;if(c&&Object.keys(c).length){for(const l of Object.keys(c)){const f=u(c[l],800);f&&r[l].push(f)}continue}r[jt(s.group.id)].push(s.option.tags)}return{base:I(...r.base),char:I(...r.char),primary:I(...r.primary),secondary:I(...r.secondary),female:I(...r.female),male:I(...r.male)}}function Pt(e,t){t&&(e.action=I(u(e.action,600),t))}function ei(e,t,n){const r={...Ya(),...t};e.camera=u(r.base,800),e.situation=u(n?.situation,400)||"",n&&"place"in n&&(e.place=u(n.place,400));const a=(Array.isArray(e.characters)?e.characters:[]).filter(o=>o&&typeof o=="object"),i=!!(r.char||r.primary||r.secondary||r.female||r.male);if(!a.length){e.action=i?I(r.char,r.primary,r.secondary,r.female,r.male):"";return}i&&(e.action=""),$m(a,r)}function Oc(e){const t=Array.isArray(e?.characters)?e.characters:[],n=[];for(let r=0;r<t.length;r++){const a=t[r];if(!a||typeof a!="object"){n.push({index:r,name:"",gender:""});continue}const i=a,o=jn(i);n.push({index:r,name:u(i.name,200),gender:o==="f"?"girl":o==="m"?"boy":""})}return n}function Lc(e){if(!Array.isArray(e))return[];const t=[];for(const n of e){if(!n||typeof n!="object")continue;const r=n,a=Number(r.index);!Number.isInteger(a)||a<0||t.push({index:a,option_ids:r.option_ids??r.ids??r.curation_option_ids})}return t}function Bc(e,t,n){if(!t.length)return;const r=Array.isArray(e.characters)?e.characters:[];for(const{index:a,option_ids:i}of t){const o=r[a];if(!o||typeof o!="object")continue;const s=jm(n,i);s&&Pt(o,s)}}function $m(e,t){t.primary&&Pt(e[0],t.primary),t.secondary&&e[1]&&Pt(e[1],t.secondary);for(const n of e){t.char&&Pt(n,t.char);const r=jn(n);t.female&&r==="f"&&Pt(n,t.female),t.male&&r==="m"&&Pt(n,t.male)}if(!e.some(n=>jn(n)!=null)){const n=I(t.female,t.male);if(n)for(const r of e)Pt(r,n)}}function Pm(e){return e.groups.reduce((t,n)=>t+n.options.length,0)}var Om,Lm,ti,ni=$((()=>{wm(),O(),it(),Om=10,Lm=80,ti=["base","char","primary","secondary","female","male"]}));function Bm(e){let t=u(e.composition_id,160)||u(e.preset_id,160)||u(e.leaf_id,160)||u(e.position_id,160)||u(e.curation_leaf,160)||u(e.composition,160);if(t&&/[|/]/.test(t)){const r=t.split(/[/|]/).map(a=>u(a,160)).filter(Boolean);r.length>=2&&((!Array.isArray(e.preset_path)||!e.preset_path.length)&&(e.preset_path=r),t=r[r.length-1])}const n=u(e.composition_variant,120)||u(e.selected_variant_id,120)||u(e.variant_id,120)||u(e.variant,120);return t&&(e.composition_id=t),n&&(e.composition_variant=n),Array.isArray(e.preset_path)&&e.preset_path.length?!0:!!t}function Ot(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function Rm(e){const t=[];for(const n of["children","variants"]){const r=e[n];if(Array.isArray(r))for(const a of r){const i=Ot(a);i&&t.push(i)}}return t}function Rc(e){return Array.isArray(e.variants)?e.variants.map(Ot).filter(Boolean):[]}function Fm(e){const t=e.when_to_use;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):u(e.description,400)}function Dm(e){const t=e.avoid_when;return typeof t=="string"?u(t,400):Array.isArray(t)?u(t.map(n=>u(n,200)).filter(Boolean).join(" "),400):""}function zm(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,n=u(t.ref??t.id??t.group,160);if(!n)return null;const r=Array.isArray(t.include_options)?t.include_options.map(o=>u(o,120)).filter(Boolean):void 0,a=t.action&&typeof t.action=="object"&&!Array.isArray(t.action)?t.action:null,i=a?{source:u(a.source,40)||void 0,target:u(a.target,40)||void 0,include_options:Array.isArray(a.include_options)?a.include_options.map(o=>u(o,120)).filter(Boolean):void 0}:void 0;return{ref:n,include_options:r?.length?r:void 0,replace:t.replace===!0,order:Number.isFinite(Number(t.order))?Number(t.order):void 0,action:i}}function Fc(e){return Array.isArray(e.modifiers)?e.modifiers.map(zm).filter(Boolean):[]}function Um(e){if(!Kn(e))return[];const t=Ot(e.presets);if(!t)return[];const n=[],r=(a,i,o,s)=>{const c=u(a.id,160),l=u(a.type,40),f=c&&c!=="preset"?[...i,c]:i,d=!o&&c&&c!=="preset"?c:o,m=l==="category"&&c?c:s,p=Array.isArray(a.children)?a.children.map(Ot).filter(Boolean):[],g=Rc(a);if(c&&c!=="preset"&&(l==="position"||g.length>0&&p.length===0)){const h=Fc(a),_=[...new Set(h.map(y=>y.ref).filter(Boolean))];n.push({id:c,path:f,composition:d||c,category:m,when:Fm(a),avoid:Dm(a),variants:g.map(y=>u(y.id,120)).filter(Boolean),description:u(a.description,300)||c,selectionModifiers:_})}for(const h of p)r(h,f,d,m)};return r(t,[],"",""),n}function Dc(e,t,n){const r=Ot(e.presets),a=u(t,160);if(!r||!a)return null;const i={chain:null},o=(d,m)=>{if(i.chain)return;const p=[...m,d];if(u(d.id,160)===a){i.chain=p;return}const g=Array.isArray(d.children)?d.children.map(Ot).filter(Boolean):[];for(const h of g)o(h,p)};o(r,[]);const s=i.chain;if(!s)return null;const c=u(n,120);if(!c)return s;const l=s[s.length-1],f=Rc(l).find(d=>u(d.id,120)===c);return f?[...s,f]:s}function ri(e,t){const n=t.preset_path;if(Array.isArray(n)&&n.length){const r=n.map(s=>u(s,160)).filter(Boolean),a=Ot(e.presets);if(!a||!r.length)return null;const i=[a];let o=a;for(const s of r){if(u(o.id,160)===s)continue;const c=Rm(o).find(l=>u(l.id,160)===s);if(!c)return Dc(e,r[r.length-1],void 0);i.push(c),o=c}return i}return Dc(e,t.composition_id??(typeof n=="string"?n:""),t.composition_variant)}function ai(e){const t=new Map;for(const n of e)for(const r of Fc(n)){const a=t.get(r.ref);if(r.replace||!a){t.set(r.ref,r);continue}const i=[...new Set([...a.include_options||[],...r.include_options||[]])];t.set(r.ref,{...a,...r,include_options:i.length?i:a.include_options,action:r.action||a.action})}return[...t.values()]}function Jm(e,t){const n=new Map,r=new Set;for(const i of t){for(const o of ai(i))n.set(o.ref,o);for(const o of Uc(i))r.add(o)}const a=[];for(const[i,o]of n){if(Za(e,i))continue;const s=Tc(e,i);if(!s)continue;const c=o.include_options?.length?new Set(o.include_options):null;let l=c?s.options.filter(f=>c.has(f.id)):s.options;if(r.size){const f=Jc(e,l.map(m=>m.id),r),d=new Set(f);l=l.filter(m=>d.has(m.id))}l.length&&a.push({id:s.id,label:s.label,options:l})}return a}function Hm(e,t){return t?.length?ai(t).filter(n=>Za(e,n.ref)):[]}function zc(e){const t=u(e,40).toLowerCase();return t?["male","m","boy","man"].includes(t)?"male":["female","f","girl","woman"].includes(t)?"female":["primary","main"].includes(t)?"primary":["secondary","partner"].includes(t)?"secondary":["global","base","scene","camera"].includes(t)?"base":["char","both","all"].includes(t)?"char":null:null}function Km(e){return on(Ic(e))}function qm(e,t,n){const r=sn(e,t);if(!r)return on({});const a=n.find(s=>s.ref!==r.group.id?!1:!s.include_options?.length&&!s.action?.include_options?.length?!0:new Set([...s.include_options||[],...s.action?.include_options||[]]).has(t))||n.find(s=>s.ref===r.group.id);if(r.option.by_slot&&Object.keys(r.option.by_slot).length)return on(r.option.by_slot);const i=r.option.tags||qn(r.option.tags);if(!i)return on({});if(a?.action){const s=zc(a.action.source),c=zc(a.action.target),l={};if(s&&(l[s]=i),c&&(l[c]=I(l[c],i)),s||c)return on(l)}const o=jt(r.group.id);return on({[o]:i})}function Uc(e){const t=new Set;for(const n of e){const r=n.modifier_filter;if(!r||typeof r!="object"||Array.isArray(r))continue;const a=r.deny;if(!(!a||typeof a!="object"||Array.isArray(a))){for(const i of Object.values(a))if(Array.isArray(i))for(const o of i){const s=u(o,160).toLowerCase();s&&t.add(s)}}}return t}function Jc(e,t,n){return n.size?t.filter(r=>{const a=r.toLowerCase();if(n.has(a))return!1;const i=sn(e,r);if(!i)return!0;const o=u(i.option.tags,800).toLowerCase(),s=u(i.option.description,400).toLowerCase();for(const c of n){const l=c.replace(/_/g," ");if(o.includes(c)||o.includes(l)||s.includes(l))return!1}return!0}):t}function Gm(e,t,n){const r=new Map;for(const a of n)Number.isFinite(a.order)&&r.set(a.ref,a.order);return r.size?t.map((a,i)=>({id:a,i})).sort((a,i)=>{const o=sn(e,a.id)?.group.id,s=sn(e,i.id)?.group.id,c=o!=null&&r.has(o)?r.get(o):Number.MAX_SAFE_INTEGER,l=s!=null&&r.has(s)?r.get(s):Number.MAX_SAFE_INTEGER;return c!==l?c-l:a.i-i.i}).map(a=>a.id):t}function Wm(e,t,n){if(!Kn(e))return null;const r=ri(e,t);if(!r?.length)return null;const a=r.map(m=>Km(m.prompt)),i=ai(r),o=new Set(i.map(m=>m.ref)),s=[...i,...(n?.bindings||[]).filter(m=>!o.has(m.ref))],c=Uc(r),l=[...Ac(t.curation_option_ids),...n?.optionIds||[]];let f=Mc(e,l);f=Jc(e,f,c),f=Gm(e,f,s);const d=f.map(m=>qm(e,m,s));return Mm(...a,...d)}function Vm(){return["# Preset selection (Asset Maid analyzer rules)","Use ONLY information in the chat/shot context. Do not invent unseen actors or actions.","","## Actors → composition first","Count actors that are required for the current moment's action/contact.","Pick a composition that matches actor count and genders (e.g. 1girl_solo vs 1girl_1boy).","Do NOT drop a visible partner to force solo. If a male hand/arm is visible contacting the girl from POV, that male is an actor → prefer 1girl_1boy, not 1girl_solo.","","## Walk the tree","Read the leaf list as composition → category → position.","Categories matter: `general` = non-sexual placement; `foreplay` / `sexual` / `insertion` = intimate contact. If the chat has kissing, licking, sexual touch, or sex, do NOT pick a `general` leaf just because posture when-text matches.","For each candidate use when / avoid / selection_modifiers. Prefer the leaf whose when matches AND whose selection_modifiers cover the stated actions.","selection_modifiers are modifier **group ids** this leaf unlocks for pass 2 (e.g. `interaction.partner.mouth_contact`). They are the main reason to prefer one leaf over another when posture is similar.","CRITICAL: do NOT pick a leaf that only matches vague posture words if it lacks the group needed for the chat action. Example: ear licking / kissing / licking neck need a leaf with `interaction.partner.mouth_contact` (usually under foreplay), not `general/facing_each_other` which only has `interaction.general`.","Pick exactly ONE `composition_id` (position leaf) per shot.","If the same leaf id appears under multiple compositions/categories (e.g. `free`), set `composition_id` to the full path string `composition / category / leaf` so the host can disambiguate.","","## Variant","If the leaf lists variants, pick `composition_variant` for the camera that fits (from_side, pov, default…).","If unsure and a default/from_side exists, prefer that over inventing camera tags.","","## What NOT to do in pass 1","Do NOT invent Danbooru camera/pose tags into camera/situation/action.","Do NOT return modifier option ids here (pass 2 does that — e.g. do not emit `licking_ear` in pass 1).","Do NOT set `curation_groups`."]}function Ym(e,t=!1){const n=Um(e),r=new Map;for(const i of n){const o=r.get(i.composition)||[];o.push(i),r.set(i.composition,o)}const a=[];for(const[i,o]of r){a.push(`## composition: ${i}`);for(const s of o){const c=s.variants.length?s.variants.join("|"):"(none)",l=s.selectionModifiers.length?s.selectionModifiers.join(", "):"(none)",f=s.description&&s.description!==s.id&&s.description!==s.when?`description: ${s.description}`:"";a.push([`### ${s.id}`,`path: ${s.path.join(" / ")}`,s.category?`category: ${s.category}`:"",s.when?`when: ${s.when}`:"",s.avoid?`avoid: ${s.avoid}`:"",f,`selection_modifiers: ${l}`,`variants: ${c}`].filter(Boolean).join(`
`))}}return["Curation two-stage ON (pass 1 — Asset Maid presets).","CRITICAL: every shot MUST include `composition_id` (exact leaf id, or full path if id is ambiguous). This overrides the base format schema.","Also set `composition_variant` when the leaf lists variants.",...Vm(),"","On every shot set:","- `composition_id`: leaf id (e.g. `face_to_face_upright`) OR path `1girl_1boy / foreplay / face_to_face_upright` when ids collide","- `composition_variant`: one variant id for that leaf, or omit if none","Still fill characters (appearance/attire/accessories) as usual.","`place` may stay as a short location hint.",...t?["STRICT catalog-id mode is ON: leave `camera`, `situation`, `natural`, and every `characters[].action` / `characters[].expression` completely EMPTY.","Pass 2 assembles ALL scene and per-actor tags from catalog ids only, keyed off the `composition_id`/`composition_variant` you pick here."]:["Leave `situation` empty or non-person scene words only — NEVER put 1girl/1boy/solo there (host adds person-count tags).","`camera`/`action` must NOT include 1girl/1boy/solo either.","`natural` still follows the Natural base mode system message."],"","## Preset leaf catalog (do not invent ids)","selection_modifiers = group ids unlocked for pass 2 (not option ids). Use them to choose the leaf; pass 2 picks concrete options like licking_ear.",...a.length?a:["(empty presets tree)"]].join(`
`)}function Xm(e){const t=e.modifier_lanes;if(!t||!Object.keys(t).length)return[];const n=["## Modifier lanes (hard caps — host also enforces)","Within each lane, keep at most max_active_groups distinct groups."];for(const[r,a]of Object.entries(t))n.push(`- lane \`${r}\`: max ${a.max_active_groups} group(s) among [${a.fallback_order.join(", ")}] (earlier pattern wins if over cap)`);return n.push("Example: do not pick both manual.arm_pose and manual.partner_contact options together."),n}function Zm(e,t,n){const r=n?.strictIds===!0,a=Jm(e,t).map(i=>{const o=i.options.map(s=>`  - ${s.id}: ${s.description}`).join(`
`);return`### ${i.id} (${i.label})
${o}`});return["Curation two-stage ON (pass 2 — preset modifiers, BATCH).","You receive ALL shots in one request. Return ONE JSON object covering every shot.",r?'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "characters": [ { "index": 0, "option_ids": ["id", "..."] } ], "place": "..." }, ... ] }':'Schema: { "shots": [ { "shot_index": 0, "curation_option_ids": ["id", "..."], "place": "..." }, ... ] }',r?'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["bedroom"], "characters": [ { "index": 0, "option_ids": ["hug", "from_side"] }, { "index": 1, "option_ids": ["blush"] } ] } ] }':'Example: { "shots": [ { "shot_index": 0, "curation_option_ids": ["hug", "from_side", "blush", "bedroom"], "place": "bedroom" } ] }',"shot_index must match the input shots array (0-based). Return exactly one entry per input shot, same order.","","## CRITICAL: fill curation_option_ids","`curation_option_ids` is the MAIN output. Host injects those catalog tags into the image — empty array = weak/empty pose.","For EVERY shot, pick ALL options that match the chat band at that shot's y_percent:","- contact / hug / hands / pose / expression / gaze / blush / location / lighting / clothing state when visible","Typical count: **2–8 ids** when the scene has clear action; 1 id only if truly minimal; `[]` ONLY if nothing in the list fits.","Do NOT leave `curation_option_ids` empty just to be safe — if hug/facing/hand contact is in the text and listed below, INCLUDE those ids.","Pick ONLY ids listed below. Never invent ids. Never invent character appearance/attire.","Do NOT put Danbooru tags in freeform fields instead of picking ids — prefer ids.","`place` may repeat a short location hint; optional.","Host assembles path prompts + these options into base vs char slots.",...r?["",...jc()]:[],...$c(),...Xm(e),"",a.length?"## Allowed modifier options":`## Allowed modifier options
(none — return empty curation_option_ids)`,...a].join(`
`)}var Qm=$((()=>{O(),ni()}));function ep(e,t){if(!e.length||e.length!==t.length)return-1;let n=0,r=0,a=0;for(let i=0;i<e.length;i++){const o=e[i],s=t[i];n+=o*s,r+=o*o,a+=s*s}return r<=0||a<=0?-1:n/(Math.sqrt(r)*Math.sqrt(a))}function tp(e,t,n){const r=n?.minScore??.35,a=ip(n?.groupId);let i=null,o=-1,s=null,c=-1;for(const l of t){const f=ep(e,l.vector);f>o&&(o=f,i=l),a&&l.groupId===a&&f>c&&(c=f,s=l)}return s&&c>=r?s:i&&o>=r?i:null}function np(e){return e.slot||jt(e.groupId)}function rp(e,t,n,r=.4){const a=[],i=[],o=[],s=[],c=[],l=[],f=[];let d=0,m=0;const p=(g,h)=>{g==="base"?i.push(h):g==="primary"?s.push(h):g==="secondary"?c.push(h):g==="female"?l.push(h):g==="male"?f.push(h):o.push(h)};for(let g=0;g<e.length;g++){const h=e[g].trim();if(!h)continue;const _=t[g];if(!_||!_.length){a.push(h),i.push(h),m+=1;continue}const y=tp(_,n,{minScore:r});y?(a.push(y.tags),p(np(y),y.tags),d+=1):(a.push(h),i.push(h),m+=1)}return{tags:a,baseTags:i,charTags:o,primaryTags:s,secondaryTags:c,femaleTags:l,maleTags:f,snapped:d,kept:m}}function ap(e){const t=String(e||"").trim();if(!t)return[];const n=[];let r="",a=0;for(let o=0;o<t.length;o++){const s=t[o];if(s===":"&&t[o+1]===":"){a+=r.includes("::")?-1:1,r+="::",o+=1;continue}if(s===","&&a<=0){const c=r.trim();c&&n.push(c),r="";continue}r+=s}const i=r.trim();return i&&n.push(i),n}function ip(e){return typeof e=="string"?e.trim():""}var op=$((()=>{ni()}));function Ce(e){const t=u(e,40).toLowerCase().replace(/[ -]+/g,"_");return t==="openai_compatible"||t==="compat"?"openai_compat":Er.includes(t)?t:"openai"}function Cr(e){switch(Ce(e)){case"openai":return"https://api.openai.com/v1/embeddings";case"voyage":return"https://api.voyageai.com/v1/embeddings";case"openrouter":return"https://openrouter.ai/api/v1/embeddings";case"lmstudio":return"http://127.0.0.1:1234/v1/embeddings";case"ollama":return"http://127.0.0.1:11434/api/embeddings";default:return"https://api.openai.com/v1/embeddings"}}function Wn(e){switch(Ce(e)){case"voyage":return"voyage-3-lite";case"ollama":return"nomic-embed-text";case"openrouter":return"openai/text-embedding-3-small";case"lmstudio":return"text-embedding-nomic-embed-text-v1.5";default:return"text-embedding-3-small"}}function sp(e){return Wn(e)}function cp(){const e=new Set;for(const t of Er){const n=Cr(t).replace(/\/+$/,"");e.add(n),e.add(n.replace(/\/embeddings$/i,"")),e.add(n.replace(/\/api\/embeddings$/i,"")),e.add(n.replace(/\/v1$/i,""))}return e}function lp(e){const t=u(e,500);if(!t)return!0;const n=t.replace(/\/+$/,"");return cp().has(n)}function up(e){const t=u(e,200);return t?new Set(Er.map(n=>Wn(n))).has(t):!0}function fp(e){const t=Ce(e);return t!=="lmstudio"&&t!=="ollama"}function dp(e){const t=Ce(e.provider),n=u(e.endpoint,500)||Cr(t);return t==="ollama"?n.replace(/\/$/,""):/\/embeddings\/?$/i.test(n)?n.replace(/\/$/,""):/\/v1\/?$/i.test(n)?`${n.replace(/\/$/,"")}/embeddings`:n}function mp(e){const t=e&&typeof e=="object"?e:{},n=Array.isArray(t.data)?t.data:[],r=[];for(const a of n){const i=a&&typeof a=="object"?a.embedding:null;if(Array.isArray(i)&&i.every(o=>typeof o=="number"))r.push(i);else throw new Error("임베딩 응답에 숫자 벡터가 없습니다.")}return r}async function Hc(e){const t=e.ok!==!1&&(e.status===void 0||e.status>=200&&e.status<300);if(typeof e.json=="function")try{const n=await e.json();if(!t){const r=typeof n=="object"&&n?JSON.stringify(n).slice(0,400):String(n);throw new Error(`임베딩 HTTP ${e.status??"?"}: ${r}`)}return n}catch(n){if(n instanceof Error&&n.message.startsWith("임베딩 HTTP"))throw n}if(typeof e.text=="function"){const n=await e.text();if(!t)throw new Error(`임베딩 HTTP ${e.status??"?"}: ${n.slice(0,400)}`);return n?JSON.parse(n):{}}throw new Error("임베딩 응답을 읽을 수 없습니다.")}async function ii(e,t,n){if(!t.length)return{vectors:[],model:u(e.model)};const r=Ce(e.provider),a=u(e.model,200)||Wn(r),i=dp({...e,provider:r,model:a}),o=u(e.api_key,4e3);if(r==="ollama"){const l=[];for(const f of t){const d=(await Hc(await De(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:a,prompt:f}),signal:n?.signal}))).embedding;if(!Array.isArray(d)||!d.every(m=>typeof m=="number"))throw new Error("Ollama 임베딩 응답이 올바르지 않습니다.");l.push(d)}return{vectors:l,model:a}}const s={"Content-Type":"application/json"};o&&(s.Authorization=`Bearer ${o}`);const c=mp(await Hc(await De(i,{method:"POST",headers:s,body:JSON.stringify(r==="voyage"?{model:a,input:t,input_type:"document"}:{model:a,input:t}),signal:n?.signal})));if(c.length!==t.length)throw new Error(`임베딩 개수 불일치: got ${c.length}, want ${t.length}`);return{vectors:c,model:a}}async function pp(e){const{vectors:t,model:n}=await ii(e,["curation embedding ping"]),r=t[0]?.length||0;if(!r)throw new Error("임베딩 차원이 0입니다.");return{ok:!0,dims:r,model:n}}var oi,Er,Kc=$((()=>{O(),Tt(),oi=Object.freeze([{value:"openai",label:"OpenAI"},{value:"voyage",label:"Voyage"},{value:"openrouter",label:"OpenRouter"},{value:"openai_compat",label:"OpenAI-compat"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}]),Er=oi.map(e=>e.value)})),gp=dn({LLM_ENDPOINT_PRESETS:()=>ut,LLM_PROVIDERS:()=>Xc,REASONING_EFFORTS:()=>si,applyReasoningToBody:()=>Yc,defaultEndpointForProvider:()=>Gc,endpointPresetKeyFor:()=>yp,ensureLlmRequestUrl:()=>Vc,knownLlmEndpoints:()=>Wc,llmModelPlaceholder:()=>_p,normalizeLlmProvider:()=>Lt,normalizeReasoningEffort:()=>qc,shouldAutoReplaceEndpoint:()=>hp});function Lt(e){const t=String(e||"").toLowerCase().replace(/[ -]+/g,"_").trim();return["openrouter"].includes(t)?"openrouter":["openai"].includes(t)?"openai":["google","google_ai","google_ai_studio","gemini"].includes(t)?"google_ai":["vertex","vertex_ai","google_vertex"].includes(t)?"vertex":["anthropic","anthropic_compat","anthropic_compatible","claude"].includes(t)?"anthropic_compatible":["lmstudio","lm_studio"].includes(t)?"lmstudio":["ollama"].includes(t)?"ollama":["custom"].includes(t)?"custom":["openai_compatible","openai_compat"].includes(t)?"openrouter":"custom"}function qc(e){const t=String(e??"default").toLowerCase().trim();return!t||t==="auto"||t==="default"?"default":si.includes(t)?t:"default"}function Gc(e,t={}){const n=Lt(e);return n==="vertex"?`https://${String(t.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1"}-aiplatform.googleapis.com`:n==="anthropic_compatible"?ut.anthropic:n==="custom"?ut.openai:ut[n]||ut.openai}function Wc(){const e=new Set;for(const t of Object.values(ut)){const n=String(t||"").replace(/\/+$/,"");n&&(e.add(n),e.add(n.replace(/\/chat\/completions$/i,"")),e.add(n.replace(/\/v1\/messages$/i,"")),e.add(n.replace(/\/v1$/i,"")))}return e.add("https://us-central1-aiplatform.googleapis.com"),e.add("https://europe-west1-aiplatform.googleapis.com"),e.add("https://asia-northeast1-aiplatform.googleapis.com"),e}function hp(e){const t=String(e||"").trim().replace(/\/+$/,"");return t?Wc().has(t):!0}function Vc(e,t,n={}){const r=Lt(t);let a=String(e||"").trim().replace(/\/+$/,"");if(a||(a=Gc(r,n).replace(/\/+$/,"")),r==="anthropic_compatible")return/\/v1\/messages$/i.test(a)||/\/messages$/i.test(a)?a:/\/v1$/i.test(a)?`${a}/messages`:`${a}/v1/messages`;if(r==="vertex"){const i=String(n.region||"us-central1").trim().replace(/[^a-z0-9-]/gi,"")||"us-central1",o=String(n.projectId||"").trim();if(o)return`https://${i}-aiplatform.googleapis.com/v1/projects/${encodeURIComponent(o)}/locations/${encodeURIComponent(i)}/endpoints/openapi/chat/completions`;if(/aiplatform\.googleapis\.com/i.test(a)&&!/\/chat\/completions$/i.test(a))return a}return/\/chat\/completions$/i.test(a)?a:/\/openai$/i.test(a)?`${a}/chat/completions`:/\/v1beta$/i.test(a)?`${a}/openai/chat/completions`:/\/v1$/i.test(a)?`${a}/chat/completions`:a}function Yc(e,t){const n={};e&&typeof e=="object"&&Object.assign(n,e);const r=qc(t);return r==="default"||(n.reasoning={effort:r}),n}function _p(e){const t=Lt(e),n={openrouter:"openai/gpt-4o-mini",openai:"gpt-4o-mini",google_ai:"gemini-2.5-flash",vertex:"gemini-2.0-flash-001",anthropic_compatible:"claude-sonnet-4",lmstudio:"local-model",ollama:"llama3.2",custom:"model-id"};return n[t]||n.custom}function yp(e){const t=String(e||"").trim().replace(/\/+$/,"");for(const[n,r]of Object.entries(ut)){const a=r.replace(/\/+$/,"");if(t===a||t===a.replace(/\/chat\/completions$/i,"")||t===a.replace(/\/v1\/messages$/i,""))return n}return"custom"}var ut,si,Xc,Tr=$((()=>{ut=Object.freeze({openai:"https://api.openai.com/v1/chat/completions",openrouter:"https://openrouter.ai/api/v1/chat/completions",google_ai:"https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",lmstudio:"http://127.0.0.1:1234/v1/chat/completions",ollama:"http://127.0.0.1:11434/v1/chat/completions",anthropic:"https://api.anthropic.com/v1/messages",vertex:"https://us-central1-aiplatform.googleapis.com"}),si=Object.freeze(["default","none","minimal","low","medium","high","xhigh","max"]),Xc=Object.freeze([{value:"openrouter",label:"OpenRouter"},{value:"openai",label:"OpenAI"},{value:"google_ai",label:"Google AI Studio"},{value:"vertex",label:"Vertex AI (Google Cloud)"},{value:"anthropic_compatible",label:"Anthropic-compatible"},{value:"lmstudio",label:"LM Studio (로컬)"},{value:"ollama",label:"Ollama (로컬)"},{value:"custom",label:"Custom endpoint"}])}));function jr(e){const t=String(e||"").trim().toLowerCase();return t==="main"||t==="risu_main"||t==="risu-main"?"main":t==="aux"||t==="otherax"||t==="other_ax"||t==="risu_aux"||t==="risu-aux"||t==="sub"||t==="secondary"?"aux":"custom"}function bp(e){const t=jr(e);return t==="main"||t==="aux"}function Zc(e){const t=e||{};return bp(t.source)?!0:Lt(t.provider)==="vertex"?!!(u(t.model)&&(u(t.api_key)||u(t.service_account_json))):!!(u(t.model)&&u(t.api_key))}function wp(e){let t="";const n=[];for(const r of e||[]){const a=String(r?.role||""),i=r?.content;if(a==="system"){const o=typeof i=="string"?i:Array.isArray(i)?i.map(s=>typeof s=="object"?s.text||"":String(s)).join(""):String(i??"");t=t?`${t}
${o}`:o;continue}if(Array.isArray(i)){const o=[];for(const s of i){if(!s||typeof s!="object"){const d=String(s||"").trim();d&&o.push({type:"text",text:d});continue}const c=s.image_url,l=(typeof c=="object"&&c?c.url:"")||(typeof c=="string"?c:"");if(s.type==="image_url"||l){const d=String(l).match(/^data:([^;]+);base64,([\s\S]+)$/i);d&&o.push({type:"image",source:{type:"base64",media_type:d[1]||"image/png",data:d[2].replace(/\s+/g,"")}});continue}const f=String(s.text||"").trim();f&&o.push({type:"text",text:f})}n.push({role:a==="assistant"?"assistant":"user",content:o.length?o:[{type:"text",text:""}]});continue}n.push({role:a==="assistant"?"assistant":"user",content:String(i??"")})}return{system:t,messages:n}}function vp(e){const t=e?.choices||[];if(!t.length)throw new Error("LLM returned no choices.");let n=(t[0].message||{}).content;return Array.isArray(n)&&(n=n.map(Pr).join("")),u(n)}function xp(e){const t=e?.content,n=(Array.isArray(t)?t:[]).map(Pr).join(""),r=u(n||e?.completion||"");if(!r)throw new Error("Anthropic 응답이 비어 있습니다.");return r}async function $r(e){if(!Vn(e))return"";const t=e.getReader(),n=typeof TextDecoder<"u"?new TextDecoder:null;let r="",a="";for(;;){const{done:i,value:o}=await t.read();if(i)break;if(typeof o=="string")r=o,a+=o;else if(o instanceof Uint8Array)a+=n?n.decode(o,{stream:!0}):"";else if(o&&typeof o=="object"){const s=o,c=s[0];typeof c=="string"?r=c:typeof s.content=="string"?r=s.content:typeof s.text=="string"&&(r=s.text)}}return n&&(a+=n.decode()),r||a}async function kp(e){if(typeof e=="string")return e;if(Vn(e))return $r(e);if(e==null)return"";if(typeof e=="number"||typeof e=="boolean")return String(e);if(typeof e=="object"){const t=e,n=u(t.type,40).toLowerCase();if(n==="fail"||n==="error"){const a=u(t.result||t.message||t.error||"Risu LLM 실패",800);throw new Error(`Risu LLM 실패: ${a}`)}if(n==="streaming"||n==="stream"){const a=await $r(t.result??t.data??t.stream);if(a.trim())return a}if(n==="success"||n==="ok"){const a=t.result??t.data??t.content;if(typeof a=="string")return a;if(Vn(a))return $r(a)}const r=[t.choices?.[0]?.message?.content,t.choices?.[0]?.text,t.choices?.[0]?.delta?.content,t.message?.content,t.content,t.text,t.response,n?null:t.result,t.output];for(const a of r){if(typeof a=="string"&&a.trim())return a;if(Array.isArray(a)){const i=a.map(Pr).join("");if(i.trim())return i}if(Vn(a)){const i=await $r(a);if(i.trim())return i}}try{return JSON.stringify(e)}catch{return String(e)}}return String(e||"")}var Vn,Pr,ci=$((()=>{O(),Tr(),Vn=e=>!!e&&typeof e.getReader=="function",Pr=e=>typeof e=="object"?e?.text||"":String(e||"")}));async function Sp(){try{const e=await Ne(Xr,Pi);if(e==null||e==="")return _e(tt);const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return _e(tt);const n=za(t),r=nt(tt,n);return JSON.stringify(t)!==JSON.stringify(n)&&await Qc(r),r}catch(e){console.warn("[Inlay Nexus] settings load failed",e?.message||e)}return _e(tt)}async function Qc(e){if(await Ie(Xr,_e(e)),await Ne("inx_native_settings")==null)throw new Error("설정 저장 실패: IndexedDB(getLocalPluginStorage)에 기록되지 않았습니다.")}var el=$((()=>{ee(),vt(),Kt(),wr()}));async function Ap(){const e=await z("meta","prompt:__pack__"),t=!e||e.text!=="2026-08-06-bg-filter",n=Date.now()/1e3;for(const r of mn)await z("meta",`prompt:${r}`)&&!(t&&$i.includes(r))||await F("meta",{key:`prompt:${r}`,text:Cn(r),updated_at:n});await F("meta",{key:"prompt:__pack__",text:ji,updated_at:n})}async function ce(e){const t=await z("meta",`prompt:${e}`);return t?.text!=null?t.text:Cn(e)}async function tl(e,t){const n=Date.now()/1e3;return await F("meta",{key:`prompt:${e}`,text:t,updated_at:n}),{ok:!0,key:e,updated_at:n}}async function Or(){const e=await be("meta"),t=new Map(e.filter(r=>r.key?.startsWith("prompt:")&&!r.key.startsWith("prompt:__")).map(r=>[r.key.slice(7),{key:r.key.slice(7),text:r.text||"",updated_at:r.updated_at||0}])),n=[];for(const r of mn){const a=t.get(r);a?n.push(a):n.push({key:r,text:Cn(r),updated_at:0}),t.delete(r)}for(const r of t.values())n.push(r);return n}async function Mp(){const e=await Or(),t={};for(const n of e)t[n.key]=n.text;return{version:Ye,prompts:t}}async function Np(e){const t=Cp(e);let n=0;const r=Date.now()/1e3;for(const a of mn)Object.prototype.hasOwnProperty.call(t,a)&&(await F("meta",{key:`prompt:${a}`,text:String(t[a]??""),updated_at:r}),n+=1);return{ok:!0,updated:n,prompts:await Or()}}async function Ip(e){const t=e?.keep_author_note!==!1,n=Date.now()/1e3;let r=0;for(const a of mn)t&&a==="author_note"||(await F("meta",{key:`prompt:${a}`,text:Cn(a),updated_at:n}),r+=1);return{ok:!0,updated:r,keep_author_note:t,prompts:await Or()}}function Cp(e){let t=e;if(typeof e=="string"){const i=e.trim();if(!i)return{};t=JSON.parse(i)}if(!t||typeof t!="object"||Array.isArray(t))return{};const n=t,r={},a=n.prompts;if(a&&typeof a=="object"&&!Array.isArray(a)){for(const[i,o]of Object.entries(a))typeof i=="string"&&(r[i]=String(o??""));return r}if(Array.isArray(a)){for(const i of a){if(!i||typeof i!="object")continue;const o=i,s=String(o.key||"");s&&(r[s]=String(o.text??""))}return r}if(typeof n.key=="string"&&"text"in n)return r[n.key]=String(n.text??""),r;for(const[i,o]of Object.entries(n))i==="version"||i==="ok"||typeof o=="string"&&(r[i]=o);return r}async function Ke(){const e=_e(T());await Fo.run(()=>Qc(e))}function Ep(){return qd(T())}async function Tp(e){const t=Gd(String(e??"").slice(0,2000001)),n=_e(T());await F("meta",{key:"settings_backup",value:n,updated_at:Date.now()/1e3});const r=nt(tt,t);return r.llm={...r.llm,api_key:n.llm?.api_key||""},r.nai={...r.nai,api_key:n.nai?.api_key||""},r.auth_token=n.auth_token||"",fr(r),await Ke(),{ok:!0,settings:Lr()}}async function jp(){const e=_e(T());await F("meta",{key:"settings_backup",value:e,updated_at:Date.now()/1e3});const t=_e(tt);t.llm={...t.llm,api_key:e.llm?.api_key||""},t.nai={...t.nai,api_key:e.nai?.api_key||""},t.auth_token=e.auth_token||"";const n=e.card;return t.card={...t.card,presets:Array.isArray(n.presets)?_e(n.presets):t.card.presets||[],active_preset_id:String(n.active_preset_id||t.card.active_preset_id||""),custom_pos:String(n.custom_pos??t.card.custom_pos??""),custom_neg:String(n.custom_neg??t.card.custom_neg??"")},fr(t),await Ke(),{ok:!0,settings:Lr()}}function $p(){const e=T(),t=e.nai,n=e.llm;let r=0,a=0,i=0,o=0;try{r=Pn("cards"),a=Pn("images"),i=Af();const s=new Set;for(const c of Mf()){const l=u(c.character_id||"",200)||"unknown",f=u(c.chat_id||"",200)||"unknown";s.add(`${l}|${f}`)}o=s.size}catch{}return{ok:!0,version:Ye,pid:0,source_file:"native",nai_configured:Hn(t)==="comfy"?Ka(t):!!u(t.api_key),image_backend:Hn(t),llm_configured:Zc(n),port:0,image_mode:"data-url",storage:"indexeddb",storage_api:"getLocalPluginStorage",storage_scope:"device-local",cards:r,images:a,folders:o,png_bytes:i,last_stage:Sn(),focus_stage:gt(),last_error:sr(),debug_events:Ki()}}function Lr(){const e=_e(T());e.nai?.api_key?(e.nai.api_key="",e.nai.api_key_configured=!0):e.nai={...e.nai,api_key_configured:!1},e.llm?.api_key?(e.llm.api_key="",e.llm.api_key_configured=!0):e.llm={...e.llm,api_key_configured:!1},e.llm?.service_account_json?(e.llm.service_account_json="",e.llm.service_account_configured=!0):e.llm={...e.llm,service_account_configured:!1};const t=e.nai;t.backend=Hn(t),t.image_backend=t.backend,t.comfy_configured=Ka(t);const n=Bo(),r=Ro(),a=!li.includes(u(t.image_reference));t.image_reference_configured=!!(a&&n),t.image_reference||(t.image_reference=t.image_reference_configured?"file":"none"),t.image_reference_configured&&n&&(t.reference_preview_url=n);const i=!li.includes(u(t.vibe_transfer));if(t.vibe_transfer_configured=!!(i&&r),t.vibe_transfer||(t.vibe_transfer=t.vibe_transfer_configured?"file":"none"),t.vibe_transfer_configured&&r&&(t.vibe_preview_url=r),Array.isArray(e.card?.presets))for(const c of e.card.presets){if(!c||typeof c!="object")continue;const l=c,f=u(l.id,120),d=f?sa(f):"";d?(l.vibe_configured=!0,l.vibe_preview_url=d):(delete l.vibe_configured,delete l.vibe_preview_url),delete l.vibe_transfer}e.card.character_max=at(e.card),e.database_path="indexeddb:getLocalPluginStorage",e.images_dir="indexeddb:inx_nximg_*",e.prompts_dir="embedded";const o=e.curation&&typeof e.curation=="object"?e.curation:{},s=o.embedding&&typeof o.embedding=="object"?{...o.embedding}:{};return s.api_key?(s.api_key="",s.api_key_configured=!0):s.api_key_configured=!1,o.embedding=s,e.curation=o,e.storage={...e.storage,backend:"indexeddb",api:"getLocalPluginStorage",image_encoding:"base64",scope:"device-local",image_mode:"data-url"},e}async function Pp(e){const t=e&&typeof e=="object"?e:{},n=T(),r={...t.nai||{}},a={...t.llm||{}},i={...t.card||{}};if("api_key"in r){const o=r.api_key;delete r.api_key,delete r.api_key_configured,u(o)&&(n.nai.api_key=o),(r.clearApiKey||t.clear_nai_key)&&(n.nai.api_key=""),delete r.clearApiKey}if("api_key"in a){const o=a.api_key;delete a.api_key,delete a.api_key_configured,u(o)&&(n.llm.api_key=o),(a.clearApiKey||t.clear_llm_key)&&(n.llm.api_key=""),delete a.clearApiKey}if("service_account_json"in a){const o=a.service_account_json;delete a.service_account_json,delete a.service_account_configured,u(o)&&(n.llm.service_account_json=o),(a.clearServiceAccount||t.clear_llm_service_account)&&(n.llm.service_account_json=""),delete a.clearServiceAccount}if(Object.keys(i).length){const o=nt(n.card,i);Array.isArray(i.presets)&&(o.presets=i.presets),"active_preset_id"in i&&(o.active_preset_id=i.active_preset_id),"custom_pos"in i&&(o.custom_pos=i.custom_pos),"custom_neg"in i&&(o.custom_neg=i.custom_neg),n.card=o,n.card.character_max=at(n.card)}if(Object.keys(r).length&&(n.nai=nt(n.nai,r)),Object.keys(a).length&&(n.llm=nt(n.llm,a)),t.curation&&typeof t.curation=="object"){const{updateCurationSettings:o}=await Promise.resolve().then(()=>(Zn(),Fp));await o(t.curation)}for(const o of["bind_host","port","auth_token"])o in t&&(n[o]=t[o]);return await Ke(),{ok:!0,settings:Lr()}}var li,ft=$((()=>{Kt(),Jn(),ee(),q(),vt(),O(),it(),ci(),el(),Le(),fe(),li=["","none","off","false","0"]}));function nl(e){const t=typeof e=="string"?e:JSON.stringify(e);return ui(Jt(new TextEncoder().encode(t)))}function Op(e){const t=ArrayBuffer.isView(e)?new Uint8Array(e.buffer,e.byteOffset,e.byteLength):V(e);return ui(Jt(t))}async function Lp(e){let t;try{t=typeof e=="string"?JSON.parse(e):e}catch{throw new Error("Vertex Service Account JSON 파싱 실패")}if(!t?.client_email||!t?.private_key)throw new Error("Service Account JSON에 client_email/private_key가 필요합니다.");if(!globalThis.crypto?.subtle)throw new Error("이 환경에서는 Vertex Service Account(JWT) 서명을 지원하지 않습니다. API key 칸에 OAuth access token을 넣거나 Google AI Studio를 쓰세요.");const n=Math.floor(Date.now()/1e3),r=`${nl({alg:"RS256",typ:"JWT"})}.${nl({iss:t.client_email,scope:"https://www.googleapis.com/auth/cloud-platform",aud:"https://oauth2.googleapis.com/token",iat:n,exp:n+3600})}`,a=String(t.private_key).replace(/\\n/g,`
`).replace(/-----BEGIN [^-]+-----/,"").replace(/-----END [^-]+-----/,"").replace(/\s+/g,""),i=Uint8Array.from(atob(a),f=>f.charCodeAt(0)),o=await crypto.subtle.importKey("pkcs8",i,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),s=`${r}.${Op(await crypto.subtle.sign("RSASSA-PKCS1-v1_5",o,new TextEncoder().encode(r)))}`,c=await De("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`grant_type=${encodeURIComponent("urn:ietf:params:oauth:grant-type:jwt-bearer")}&assertion=${encodeURIComponent(s)}`});let l={};try{l=await c.json()}catch{l={}}if(!l?.access_token)throw new Error(`Vertex 토큰 발급 실패: ${JSON.stringify(l).slice(0,240)}`);return{accessToken:String(l.access_token),projectId:u(t.project_id||"")}}var ui,Bp=$((()=>{Q(),O(),Tt(),ui=e=>e.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}));async function cn(e,t){const n=jr(e.source);if(n==="main"||n==="aux")return Rp(e,t,n);const r=Lt(e.provider),a=u(e.model),i=u(e.vertex_region)||"us-central1";let o=u(e.api_key),s="";if(r==="vertex"&&u(e.service_account_json)){const p=await Lp(e.service_account_json);o=p.accessToken,s=p.projectId}if(!a||!o)throw w("llm.config",{message:"missing model/api_key",provider:r},"error"),new Error(r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM이 설정되지 않았습니다. 모델 설정에서 Provider·Model·API key를 넣으세요. (NovelAI 키와 별개)");const c=Vc(u(e.endpoint),r,{region:i,projectId:s});if(r==="vertex"&&!/\/chat\/completions$/i.test(c))throw new Error("Vertex AI: project_id가 있는 Service Account JSON이 필요합니다. (OpenAI-compatible endpoint 구성용)");const l=Number(e.timeout_seconds??180)*1e3,f=typeof AbortController<"u"?new AbortController:null,d=setTimeout(()=>{w("llm.abort",{message:`timeout ${l}ms`,model:a,provider:r},"warn"),f?.abort?.()},l),m=ue("llm.call");w("llm.call.start",{message:a,msgs:t?.length||0,timeout_ms:l,source:n,provider:r,reasoning:u(e.reasoning_effort)||"default"});try{let p;if(r==="anthropic_compatible"){const y=wp(t),k={model:a,max_tokens:Number(e.max_tokens??8e3),temperature:Math.min(1,Number(e.temperature??.4)),messages:y.messages};y.system&&(k.system=y.system),p=await De(c,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":o,"anthropic-version":u(e.anthropic_version)||"2023-06-01"},body:JSON.stringify(k),signal:f?.signal})}else{const y=Yc({model:a,messages:t,temperature:Number(e.temperature??.4),max_tokens:Number(e.max_tokens??8e3)},e.reasoning_effort),k={"Content-Type":"application/json",Authorization:`Bearer ${o}`};r==="openrouter"&&(k["HTTP-Referer"]="https://risuai.xyz",k["X-Title"]="Inlay Nexus"),p=await De(c,{method:"POST",headers:k,body:JSON.stringify(y),signal:f?.signal})}const g=Number(p?.status||0);let h;try{h=await p.json()}catch{h={}}if(g>=400)throw m.fail(new Error(`HTTP ${g}`),{status:g,body:JSON.stringify(h).slice(0,200),provider:r}),new Error(`LLM HTTP ${g}: ${JSON.stringify(h).slice(0,500)}`);const _=r==="anthropic_compatible"?xp(h):vp(h);return m.end({message:a,status:g,bytes:_.length,provider:r}),_}catch(p){throw m.fail(p,{model:a,provider:r}),p}finally{clearTimeout(d)}}async function Rp(e,t,n,r=""){const a=Ae();if(!a||typeof a.runLLMModel!="function")throw new Error("RisuAI runLLMModel API를 사용할 수 없습니다. Risu를 최신으로 업데이트하세요.");const i=n==="main"?"model":"otherAx",o=Math.max(5e3,Number(e.timeout_seconds??180)*1e3),s=u(r)||"",c=ue("llm.call");w("llm.call.start",{message:`risu:${i}`,msgs:t?.length||0,timeout_ms:o,source:n,static_model:s});let l;const f=new Promise((d,m)=>{l=setTimeout(()=>m(new Error(`Risu LLM timeout ${o}ms (${i})`)),o)});try{const d=await Promise.race([a.runLLMModel({mode:i,...s?{staticModel:s}:{},allowPlugins:!0,messages:t}),f]),m=u(await kp(d));if(!m)throw new Error(`Risu LLM(${i}) 응답이 비어 있습니다.`);return c.end({message:`risu:${i}`,bytes:m.length}),m}catch(d){throw c.fail(d,{mode:i}),d}finally{l!==void 0&&clearTimeout(l)}}var fi=$((()=>{q(),pt(),O(),Tt(),Bp(),Tr(),ci()})),Fp=dn({catalogSha:()=>Gn,curationStatus:()=>Xn,curationTaggerSystemMessage:()=>ll,embedCurationCatalog:()=>ol,getCurationMode:()=>Br,getCurationStrictIds:()=>Rr,getEmbedProgress:()=>rl,getEmbeddingSettingsFromConfig:()=>Yn,loadCurationCatalog:()=>dt,refineShotsWithCuration:()=>ul,resetCurationCatalog:()=>il,saveCurationCatalog:()=>al,snapShotsSceneTags:()=>ml,testCurationEmbedding:()=>sl,updateCurationSettings:()=>pl});function rl(){return{...ln}}function Br(){const e=T(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=Ba(t.mode);if(n!=="off")return n;const r=e.card;return r?.composition_curation===!0||r?.composition_curation==="true"||r?.composition_curation===1?"two_stage":"off"}function Rr(){const e=T(),t=e.curation&&typeof e.curation=="object"?e.curation:{};return Ra(t.strict_ids)}function Yn(){const e=T(),t=e.curation&&typeof e.curation=="object"?e.curation:{},n=t.embedding&&typeof t.embedding=="object"?t.embedding:{},r=Ce(n.provider);return{provider:r,model:u(n.model,200)||Wn(r),endpoint:u(n.endpoint,500)||Cr(r),api_key:u(n.api_key,4e3)}}async function dt(){const e=await Ne(ar);if(e==null||e==="")return Qa();try{const t=typeof e=="string"?JSON.parse(e):e;return Xa(t)}catch(t){return w("curation.catalog.load",{message:String(t?.message||t)},"warn"),Qa()}}async function al(e){const t=Xa(e);await Ie(ar,t);const n=await di();return n&&(n.catalog_sha,t.sha),{ok:!0,status:await Xn()}}async function il(){const e=Qa();return await Ie(ar,e),await de(ir),{ok:!0,status:await Xn()}}async function di(){const e=await Ne(ir);if(e==null||e==="")return null;try{const t=typeof e=="string"?JSON.parse(e):e;if(!t||typeof t!="object")return null;const n=t;return Array.isArray(n.items)?n:null}catch{return null}}async function Xn(){const e=await dt(),t=await di(),n=Pm(e);let r="missing";if(t?.items?.length){r=t.catalog_sha===e.sha?"ready":"stale";const a=Yn(),i=u(a.model);i&&t.model&&t.model!==i&&(r="stale")}return{mode:Br(),catalog_name:e.name,catalog_sha:e.sha||Gn(e),option_count:n,group_count:e.groups.length,has_presets:Kn(e),embed_status:r,embed_count:t?.items?.length||0,embed_model:t?.model||"",embed_updated_at:t?.updated_at||0,large_warning:n>gl,embed_progress:rl()}}async function ol(e){const t=await dt(),n=Nm(t),r=Yn();if(!n.length)throw new Error("임베딩할 카탈로그 항목이 없습니다.");if(Ce(r.provider)!=="ollama"&&Ce(r.provider)!=="lmstudio"&&!u(r.api_key))throw new Error("임베딩 API key가 없습니다. 큐레이팅 탭에서 키를 저장하세요.");const a=(c,l,f)=>{ln={running:c<l,done:c,total:l,message:f},e?.(c,l,f)},i=Ce(r.provider)==="ollama"?1:16,o=[];let s=r.model;a(0,n.length,"임베딩 시작…");try{for(let l=0;l<n.length;l+=i){const f=n.slice(l,l+i);a(l,n.length,`임베딩 중… ${l}/${n.length}`);const{vectors:d,model:m}=await ii(r,f.map(p=>p.text));s=m||s;for(let p=0;p<f.length;p++){const g=f[p],h=d[p];if(!h?.length)throw new Error(`임베딩 실패: ${g.key}`);o.push({key:g.key,groupId:g.groupId,optionId:g.optionId,tags:g.tags,slot:g.slot,vector:h})}}a(n.length,n.length,"저장 중…");const c={catalog_sha:t.sha||Gn(t),model:s,provider:String(r.provider),updated_at:Date.now()/1e3,items:o};return await Ie(ir,c),a(n.length,n.length,"완료"),ln={running:!1,done:n.length,total:n.length,message:"완료"},{ok:!0,status:await Xn()}}catch(c){throw ln={running:!1,done:ln.done,total:n.length,message:`실패: ${c?.message||c}`},c}}async function sl(){const e=Yn();return pp(e)}function cl(e){return!!(e.base||e.char||e.primary||e.secondary||e.female||e.male)}async function ll(){const e=Br();if(e==="off")return null;if(e==="embed_snap")return u(await ce("curation_embed_hint"),4e3)||Em();const t=await dt(),n=Rr();return Kn(t)?Ym(t,n):Im(t,n)}async function ul(e,t){if(!e.length)return;const n=u(t?.chatContext,1e5),r=await dt();if(Kn(r)){for(const a of e)Bm(a);if(e.some(a=>!!ri(r,{preset_path:a.preset_path,composition_id:a.composition_id,composition_variant:a.composition_variant}))){await zp(r,e,n);return}w("curation.preset_refine",{message:"no composition_id on shots → falling back to group refine"},"warn")}await Dp(r,e,n)}function fl(e,t,n){const r=[{role:"system",content:e}];return t&&r.push({role:"user",content:t}),r.push({role:"user",content:JSON.stringify(n)}),r}async function Dp(e,t,n){const r=Rr(),a=g=>{const h=g.curation_groups;return Array.isArray(h)?h.map(_=>u(_,160)).filter(Boolean):u(h,400).split(/[,|]/).map(_=>_.trim()).filter(Boolean)},i=t.map(a),o=[...new Set(i.flat())];if(!o.length){w("curation.group_refine",{message:"no curation_groups on shots — skip"},"warn");return}const s=Cm(e,o,{strictIds:r}),c=`${u(await ce("curation_refine"),6e3)||s}

${s}`,l=bc(t,n),f={shots:t.map((g,h)=>({shot_index:h,y_percent:g.y_percent??g.anchor_percent??null,...l[h],curation_groups:i[h],camera:g.camera||"",situation:g.situation||g.scene||"",place:g.place||"",action:g.action||"",natural:g.natural||"",character_count:Array.isArray(g.characters)?g.characters.length:0,cast:Oc(g)}))},d=await cn(T().llm,fl(c,n,f)),m=ra(d);if(!m||typeof m!="object")return;dl(t,m,(g,h)=>{if(!h||typeof h!="object")return;const _=h.curation_option_ids??h.option_ids,y=Pc(e,_);cl(y)?(ei(g,y,{place:h.place!=null?h.place:g.place,situation:""}),g.curation_option_ids=_):(h.place!=null&&(g.place=u(h.place,400)),r||(h.camera!=null&&(g.camera=u(h.camera,600)),h.situation!=null&&(g.situation=u(h.situation,600)),h.action!=null&&(g.action=u(h.action,600)))),r&&Array.isArray(h.characters)&&Bc(g,Lc(h.characters),e)})}async function zp(e,t,n){const r=Rr(),a=t.map(d=>ri(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant}));if(!a.some(Boolean))return;const i=Zm(e,a.filter(Boolean),{strictIds:r}),o=bc(t,n),s={shots:t.map((d,m)=>({shot_index:m,y_percent:d.y_percent??d.anchor_percent??null,...o[m],composition_id:d.composition_id||"",composition_variant:d.composition_variant||"",place:d.place||"",natural:d.natural||"",character_count:Array.isArray(d.characters)?d.characters.length:0,cast:Oc(d)}))};let c=null;try{const d=await cn(T().llm,fl(i,n,s));c=ra(d)}catch(d){w("curation.preset_refine",{message:String(d?.message||d)},"warn")}const l=new Map,f=(d,m,p)=>{const g=m&&typeof m=="object"?m.curation_option_ids??m.option_ids:d.curation_option_ids,h=g!=null?Mc(e,g):[];for(const x of Hm(e,a[p])){const S=[...x.include_options||[],...x.action?.include_options||[]];S.length&&l.set(x.ref,{ids:S,binding:x})}const _=[...l.values()].flatMap(x=>x.ids),y=[...l.values()].map(x=>x.binding),k=Wm(e,{preset_path:d.preset_path,composition_id:d.composition_id,composition_variant:d.composition_variant,curation_option_ids:h},{optionIds:_,bindings:y});if(k&&cl(k)&&(ei(d,k,{place:m&&m.place!=null?m.place:d.place,situation:""}),g!=null&&(d.curation_option_ids=h),e.fixed_positive&&(d.curation_fixed_positive=e.fixed_positive)),r){const x=m&&typeof m=="object"?m.characters:void 0;Array.isArray(x)&&Bc(d,Lc(x),e)}};if(c&&typeof c=="object"){dl(t,c,f);return}t.forEach((d,m)=>f(d,null,m))}function dl(e,t,n){const r=Array.isArray(t.shots)?t.shots:Array.isArray(t)?t:null;if(r){for(let a=0;a<e.length;a++){const i=r.find(o=>o&&typeof o=="object"&&Number(o.shot_index)===a);n(e[a],i||r[a],a)}return}e.length===1&&n(e[0],t,0)}async function ml(e){if(!e.length)return{ok:!0,snapped:0};const t=await dt(),n=await di(),r=t.sha||Gn(t);if(!n?.items?.length)return{ok:!1,reason:"임베딩 없음 → 큐레이션 없이 생성"};if(n.catalog_sha!==r)return{ok:!1,reason:"임베딩 stale → 큐레이션 없이 생성"};const a=e.map(o=>{const s=I(u(o.camera,600),u(o.situation||o.scene,600),u(o.place,400),u(o.action,600));return ap(s)}),i=a.flat();if(!i.length)return{ok:!0,snapped:0};try{const o=Yn(),{vectors:s}=await ii(o,i);let c=0,l=0;for(let f=0;f<e.length;f++){const d=a[f],m=s.slice(c,c+d.length);if(c+=d.length,!d.length)continue;const{baseTags:p,charTags:g,primaryTags:h,secondaryTags:_,femaleTags:y,maleTags:k,snapped:x}=rp(d,m,n.items);l+=x,ei(e[f],{base:I(...p),char:I(...g),primary:I(...h),secondary:I(..._),female:I(...y),male:I(...k)},{place:"",situation:""})}return{ok:!0,snapped:l}}catch(o){const s=`임베딩 API 실패 → 큐레이션 없이 생성 (${o?.message||o})`;return w("curation.snap",{message:s},"warn"),{ok:!1,reason:s}}}async function pl(e){const t=T(),n=t.curation&&typeof t.curation=="object"?{...t.curation}:{},r={...n,...e};if(e.mode!=null&&(r.mode=Ba(e.mode)),e.strict_ids!=null&&(r.strict_ids=Ra(e.strict_ids)),e.embedding&&typeof e.embedding=="object"){const a=n.embedding&&typeof n.embedding=="object"?{...n.embedding}:{},i=e.embedding,o={...a,...i};if("api_key"in i){const s=i.api_key;delete o.api_key,delete o.api_key_configured,u(s)&&(o.api_key=s),(i.clearApiKey||e.clear_embedding_key)&&(o.api_key=""),delete o.clearApiKey}o.provider!=null&&(o.provider=Ce(o.provider)),r.embedding=o}return t.curation=r,e.mode!=null&&t.card&&typeof t.card=="object"&&(t.card.composition_curation=!1),fr(t),await Ke(),{ok:!0}}var gl,ln,Zn=$((()=>{ym(),ni(),Qm(),Jn(),op(),ee(),q(),O(),Kc(),vt(),wr(),fe(),ft(),fi(),gl=400,ln={running:!1,done:0,total:0,message:""}}));Zn(),ee(),q(),_t(),Q(),Tt();async function Fr(e,t,n,r=1,a=3){const i=Je(n),o=Math.max(0,Math.min(1,Number(r)||1)),s={image:await Qe(t),information_extracted:o,model:i};let c="";for(let l=1;l<=a;l++)try{w("nai.encode_vibe.start",{message:i,ie:o,attempt:l,focus:!0});const f=await De(Ri,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(s)}),d=Number(f?.status||0);if([502,503,504,520].includes(d)){c=`HTTP ${d}`,await Ze(2*l*1e3);continue}if(d<200||d>=300){let g="";try{g=typeof f?.text=="function"?await f.text():""}catch{}if(c=`HTTP ${d}: ${String(g).slice(0,200)}`,l<a){await Ze(1e3);continue}break}const m=await an(f,{timeoutMs:6e4}),p=await Qe(m);return w("nai.encode_vibe.done",{message:i,bytes:m?.byteLength||0,focus:!0}),p}catch(f){if(c=String(f?.message||f),l<a){await Ze(1e3);continue}}throw new Error(`encode-vibe 실패 (${a}회): ${c}`)}ee(),O(),Le(),fe(),ft();var mi=12582912,qe=32;async function Up(){const e=await z("meta","reference_image");return!!(e?.png&&e.png.byteLength>qe)}async function hl(){return(await z("meta","reference_image"))?.png||null}async function Jp(e){if(!e||e.byteLength<qe)throw new Error("참조 이미지가 비어 있습니다");if(e.byteLength>mi)throw new Error("참조 이미지가 너무 큽니다 (최대 12MB)");return await F("meta",{key:"reference_image",png:e}),ia(Ct(e)),T().nai.image_reference="file",await Ke(),{ok:!0,image_reference:"file",configured:!0,bytes:e.byteLength,preview_url:"/v1/nai/reference.png"}}async function _l(){return await At("meta","reference_image"),ia(""),T().nai.image_reference="none",await Ke(),{ok:!0,image_reference:"none",configured:!1}}async function Hp(){const e=await z("meta","vibe_transfer");return!!(e?.encoded&&e?.png&&e.png.byteLength>qe)}async function Kp(){return await z("meta","vibe_transfer")||null}async function qp(){return(await z("meta","vibe_transfer"))?.png||null}function Dr(e){let t=Number(e??1);return Number.isNaN(t)&&(t=1),Math.max(0,Math.min(1,t))}async function Gp(e,t={}){if(!e||e.byteLength<qe)throw new Error("Vibe 이미지가 비어 있습니다");if(e.byteLength>mi)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const n=T(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const a=He(t.model||n.nai.model||"nai-diffusion-4-5-full"),i=Dr(t.information_extracted??n.nai.vibe_transfer_information_extracted),o=await Fr(r,e,a,i);return await F("meta",{key:"vibe_transfer",png:e,encoded:o,model:Je(a),information_extracted:i}),oa(Ct(e)),n.nai.vibe_transfer="file",t.strength!=null&&!Number.isNaN(Number(t.strength))&&(n.nai.vibe_transfer_strength=Math.max(0,Math.min(1,Number(t.strength)))),n.nai.vibe_transfer_information_extracted=i,await Ke(),{ok:!0,vibe_transfer:"file",configured:!0,bytes:e.byteLength,encoded_bytes:o.length,model:Je(a),information_extracted:i,preview_url:"/v1/nai/vibe.png"}}async function yl(){return await At("meta","vibe_transfer"),oa(""),T().nai.vibe_transfer="none",await Ke(),{ok:!0,vibe_transfer:"none",configured:!1}}async function Wp(){const e=await Kp();if(!e?.png||e.png.byteLength<qe)return null;const t=T(),n=u(t.nai.api_key);if(!n)throw new Error("NAI api_key가 설정되지 않았습니다.");const r=Je(He(t.nai.model||"nai-diffusion-4-5-full")),a=Dr(t.nai.vibe_transfer_information_extracted);if(!(!u(e.encoded)||u(e.model)!==r||Math.abs(Number(e.information_extracted??1)-a)>.001))return e;const i=await Fr(n,e.png,r,a),o={...e,key:"vibe_transfer",encoded:i,model:r,information_extracted:a};return await F("meta",o),o}async function bl(e){const t=u(e,120);return t&&await z("meta",zt(t))||null}async function Vp(e,t,n={}){const r=u(e,120);if(!r)throw new Error("preset_id required");if(!t||t.byteLength<qe)throw new Error("Vibe 이미지가 비어 있습니다");if(t.byteLength>mi)throw new Error("Vibe 이미지가 너무 큽니다 (최대 12MB)");const a=T(),i=u(a.nai.api_key);if(!i)throw new Error("NAI api_key가 설정되지 않았습니다. encode-vibe에 키가 필요합니다.");const o=He(n.model||a.nai.model||"nai-diffusion-4-5-full"),s=Dr(n.information_extracted??a.nai.vibe_transfer_information_extracted),c=await Fr(i,t,o,s),l=zt(r);await F("meta",{key:l,png:t,encoded:c,model:Je(o),information_extracted:s});const f=Ct(t);return dr(r,f),{ok:!0,preset_id:r,vibe_transfer:"file",configured:!0,bytes:t.byteLength,encoded_bytes:c.length,model:Je(o),information_extracted:s,preview_url:f}}async function wl(e){const t=u(e,120);if(!t)throw new Error("preset_id required");return await At("meta",zt(t)),dr(t,""),{ok:!0,preset_id:t,vibe_transfer:"none",configured:!1}}async function Yp(e,t){const n=await bl(e);if(!n?.png||n.png.byteLength<qe)return!1;const r=u(t,120);if(!r)return!1;await F("meta",{key:zt(r),png:n.png,encoded:n.encoded||"",model:n.model||"",information_extracted:n.information_extracted??1});const a=sa(e)||(n.png?Ct(n.png):"");return a&&dr(r,a),!0}async function Xp(e){const t=await bl(e);if(!t?.png||t.png.byteLength<qe)return null;const n=T(),r=u(n.nai.api_key);if(!r)throw new Error("NAI api_key가 설정되지 않았습니다.");const a=Je(He(n.nai.model||"nai-diffusion-4-5-full")),i=Dr(n.nai.vibe_transfer_information_extracted);if(!(!u(t.encoded)||u(t.model)!==a||Math.abs(Number(t.information_extracted??1)-i)>.001))return t;const o=await Fr(r,t.png,a,i),s=zt(u(e,120)),c={...t,key:s,encoded:o,model:a,information_extracted:i};return await F("meta",c),c}async function Zp(){for(const e of await be("meta")){const t=String(e?.key||"");if(!Ut(t))continue;const n=e.png;!n||n.byteLength<qe||dr(bn(t),Ct(n))}}Kt(),Jn(),ee(),q(),O(),Wt(),it(),Ga(),Le(),fe(),ft();function vl(e,t){const n=Number(e);return Math.max(1,Math.min(5e3,Number.isFinite(n)&&n>0?Math.round(n):t))}async function zr(e){const{shot:t,roster:n}=e,r=T().card,a=T().nai,i=at(r),o=ga(t.characters||[],n,i).slice(0,i),s=Math.max(1,o.length),c=Go(r.person_tag_mode,r.auto_person_tags),l=af(sf(o,n,c,null,r.person_tag_solo),r.person_tag_weight),[f,d]=wu(await ce("preset_1")),m=Array.isArray(r.presets)?r.presets:[],p=u(r.active_preset_id,120);let g=null;m.length&&(p&&(g=m.find(D=>typeof D=="object"&&u(D.id,120)===p)||null),!g&&typeof m[0]=="object"&&(g=m[0]));let h,_;g?(h=u(g.positive||g.pos||""),_=u(g.negative||g.neg||"")):(h=I(u(r.custom_pos),f),_=I(u(r.custom_neg),d));let y=t.situation||t.scene;const k=u(e.lockedSetup||"");let x;k?x=k:(x=I(t.camera,y,t.place,t.action),r.mode==="asset"&&(x=I(x,"white background","simple background","cowboy shot","looking at viewer","portrait")));const S=Fa(r.natural_base),C=S==="supplement"?600:S==="detailed"?480:400,N=S==="off"?"":u(t.natural||t.natural_base||t.nl||"",C);let E="",B="";if(u(t.composition_id,160)||u(t.curation_fixed_positive,200))try{const D=await dt();E=u(t.curation_fixed_positive,800)||u(D.fixed_positive,800),B=u(D.fixed_negative,800)}catch{E=u(t.curation_fixed_positive,800)}let J=I(h,N,x,E);c!=="off"&&(J=qo(J),x=qo(x));let v=l?J?`${l}, ${J}`:l:J;const M=He(a.model||"nai-diffusion-4-5-full");a.apply_quality_tags!==!1&&(v+=In[M]||"");const R=u(a.uc_preset)||"human_focus",Y=I(_,B,(To[M]||{})[R]||""),Se=[],X=[];for(let D=0;D<o.length;D++){const K=o[D],Ft=u(K.name,200),ne=Ft?ye(Ft,n):null,Ve=I(cf(ne,K)),re=u(K.negative),Te=s===1?.5:Math.round((.1+.8*D/Math.max(1,s-1))*10)/10,Dt=.5;Se.push({prompt:Ve||"girl",uc:re,center_x:Te,center_y:Dt}),X.push({name:ne?.name||Ft,prompt:Ve,uc:re,center_x:Te,center_y:Dt,raw:K})}return{main:v,neg:Y,captions:Se,meta:{setup:x,person:l,characters:X,paragraph:t.paragraph}}}async function xl(e,t){const n=T().nai,r=!!T().card?.auto_aspect,a=e.width&&e.height?{width:vl(e.width,832),height:vl(e.height,1216),aspect:"settings"}:ud(t,n,r),i=e.captions;if(Hn(n)==="comfy"){const x={...n,width:a.width,height:a.height},[S,C]=await lm(x,e.main,e.neg,i);return{bytes:S,seed:C}}const o=u(n.api_key);if(!o)throw new Error("NAI api_key가 설정되지 않았습니다.");const s=[],c=u(n.image_reference||"none").toLowerCase();if(!["","none","off","false","0"].includes(c)){const x=await hl();if(x){let S=u(n.image_reference_type||"character&style")||"character&style";["character","style","character&style"].includes(S)||(S="character&style");let C=Number(n.image_reference_strength??.6),N=Number(n.image_reference_fidelity??1);Number.isNaN(C)&&(C=.6),Number.isNaN(N)&&(N=1),s.push({image:x,type:S,strength:Math.max(0,Math.min(1,C)),fidelity:Math.max(0,Math.min(1,N))})}}const l=T().card,f=Array.isArray(l.presets)?l.presets:[],d=u(l.active_preset_id,120);let m=null;f.length&&(d&&(m=f.find(x=>typeof x=="object"&&u(x.id,120)===d)||null),!m&&typeof f[0]=="object"&&(m=f[0]));const p=u(m?.id||d,120),g=Wd(n,m),h=[];let _=p?await Xp(p):null;if(!_){const x=u(n.vibe_transfer||"none").toLowerCase();["","none","off","false","0"].includes(x)||(_=await Wp())}if(_?.encoded){let x=Number(n.vibe_transfer_strength??.6),S=Number(n.vibe_transfer_information_extracted??_.information_extracted??1);Number.isNaN(x)&&(x=.6),Number.isNaN(S)&&(S=1),h.push({encoded:_.encoded,strength:Math.max(0,Math.min(1,x)),information_extracted:Math.max(0,Math.min(1,S))})}const y={prompt:e.main,negative_prompt:e.neg,width:a.width,height:a.height,seed:Number(n.seed??0)||0,steps:Math.min(Number(n.steps??28)||28,28),cfg_scale:g.cfg_scale,cfg_rescale:g.cfg_rescale,sampler:u(n.sampler)||"k_euler_ancestral",scheduler:u(n.scheduler)||"karras",model:He(n.model||"nai-diffusion-4-5-full"),var_plus:!!n.variety_plus,characters:i,character_refs:s,vibes:h};w("nai.generate.dims",{message:`${y.width}x${y.height}`,aspect:a.aspect,auto_aspect:r,steps:y.steps,focus:!0}),y.seed||(y.seed=Math.floor(Math.random()*4294967295)||1);const k=u(n.request_url)||"https://image.novelai.net/ai/generate-image";return{bytes:(await yc(o,y,k,{timeoutMs:9e4})).raw_bytes,seed:y.seed||0}}function Qp({imageId:e,sessionId:t,request:n,shotIndex:r,paragraph:a,yPercent:i,line:o=null,contentHash:s=""}){const c=Math.floor(Number(o));return{version:1,image_id:u(e,80),session_id:u(t,200),unified_session_id:u(n.unified_session_id||"",200),character_id:u(n.character_id||"",200),character_name:u(n.character_name||"",200),chat_id:u(n.chat_id||"",200),chat_name:u(n.chat_name||"",200),char_index:P(n.char_index,-1),chat_index:P(n.chat_index,-1),message_index:P(n.message_index,-1),message_role:u(n.message_role||n.role||"",40).toLowerCase(),shot_index:P(r,0),paragraph:P(a,0),y_percent:i,line:Number.isFinite(c)&&c>=1?c:null,content_hash:u(s||n.content_hash||"",128),assistant_preview:u(n.assistant_text||"",et)}}async function Bt(e){return Nf(e)}async function kl(e,t){const n=await z("images",e),r=n?{...n}:{id:e},a=t||{};r.location={...a,version:Number(a.version||1),image_id:u(e,80)},await F("images",r)}async function mt(e,t={}){const n=await Bt(e),r=typeof t=="object"&&t?t:{};let a=n.y_percent;a==null&&(a=r.y_percent??r.anchor_percent??r.read_percent);const i=Object.keys(n).length>0,o=je(u(e,80));return{character_id:u(n.character_id||r.character_id||"",200),chat_id:u(n.chat_id||r.chat_id||"",200),character_name:u(n.character_name||r.character_name||"",200),chat_name:u(n.chat_name||r.chat_name||"",200),char_index:P(n.char_index??r.char_index,-1),chat_index:P(n.chat_index??r.chat_index,-1),message_index:P("message_index"in n?n.message_index:r.message_index,-1),message_role:u(n.message_role||r.message_role||"",40).toLowerCase(),shot_index:P(n.shot_index,-1),paragraph:P("paragraph"in n?n.paragraph:r.paragraph,0),y_percent:lr(a),line:(()=>{const s=Math.floor(Number(n.line??r.line));return Number.isFinite(s)&&s>=1?s:null})(),content_hash:u(n.content_hash||r.content_hash||"",128),assistant_preview:u(n.assistant_preview||r.assistant_preview||"",et),unified_session_id:u(n.unified_session_id||r.unified_session_id||"",200),location_file:i?`idb:${o}`:"",storage:"indexeddb",storage_key:o}}function pi(e,t,n=0){const r=typeof e=="object"&&e?{...e}:{},a=t||{};return{...r,character_id:u(a.character_id||r.character_id||"",200),chat_id:u(a.chat_id||r.chat_id||"",200),character_name:u(a.character_name||r.character_name||"",200),chat_name:u(a.chat_name||r.chat_name||"",200),char_index:P(a.char_index??r.char_index,-1),chat_index:P(a.chat_index??r.chat_index,-1),message_index:P(a.message_index??r.message_index,-1),message_role:u(a.message_role||r.message_role||"",40).toLowerCase(),content_hash:u(a.content_hash||r.content_hash||"",128),assistant_preview:u(a.assistant_preview||r.assistant_preview||"",et),unified_session_id:u(a.unified_session_id||r.unified_session_id||"",200),y_percent:lr(a.y_percent??r.y_percent),line:(()=>{const i=Math.floor(Number(a.line??r.line));return Number.isFinite(i)&&i>=1?i:null})(),storage:"indexeddb",storage_key:je(u(a.image_id||"",80)),png_bytes:Number(n)||0}}Q();var eg=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t+=1){let n=t;for(let r=0;r<8;r+=1)n=n&1?3988292384^n>>>1:n>>>1;e[t]=n>>>0}return e})();function gi(e){return Array.isArray(e)?new Uint8Array(e):V(e)}function tg(e){const t=gi(e);let n=4294967295;for(let r=0;r<t.length;r+=1)n=eg[(n^t[r])&255]^n>>>8;return(n^4294967295)>>>0}function H(e){const t=new Uint8Array(2);return new DataView(t.buffer).setUint16(0,e>>>0,!0),t}function me(e){const t=new Uint8Array(4);return new DataView(t.buffer).setUint32(0,e>>>0,!0),t}function Qn(e){let t=0;for(const n of e)t+=n.length;return An(e,t)}function ng(e){return new TextEncoder().encode(String(e??""))}function rg(e=[]){const t=[],n=[];let r=0;for(const o of e){const s=ng(o.name||"file"),c=gi(o.data),l=tg(c),f=Qn([me(67324752),H(20),H(0),H(0),H(0),H(0),me(l),me(c.length),me(c.length),H(s.length),H(0),s,c]),d=Qn([me(33639248),H(20),H(20),H(0),H(0),H(0),H(0),me(l),me(c.length),me(c.length),H(s.length),H(0),H(0),H(0),H(0),me(0),me(r),s]);t.push(f),n.push(d),r+=f.length}const a=Qn(n),i=Qn([me(101010256),H(0),H(0),H(e.length),H(e.length),me(a.length),me(r),H(0)]);return Qn([...t,a,i])}function hi(e,t){return e[t]|e[t+1]<<8}function Sl(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function ag(e){const t=gi(e),n=new Map;let r=0;for(;r+30<=t.length;){const a=Sl(t,r);if(a===33639248||a===101010256)break;if(a!==67324752){r+=1;continue}const i=hi(t,r+8),o=Sl(t,r+18),s=hi(t,r+26),c=hi(t,r+28),l=r+30,f=new TextDecoder().decode(t.subarray(l,l+s)),d=l+s+c,m=d+o;if(m>t.length)break;i===0&&n.set(f.replace(/\\/g,"/"),t.subarray(d,m)),r=m}return n}function ig(e=[],{exportedAt:t=Date.now()}={}){return{format:"inlay-nexus-gallery",version:1,exported_at:t,items:(e||[]).map(n=>({id:String(n.id||""),file:`images/${String(n.id||"unknown")}.png`,location:{character_id:n.character_id||"",chat_id:n.chat_id||"",character_name:n.character_name||"",chat_name:n.chat_name||"",char_index:n.char_index??-1,chat_index:n.chat_index??-1,message_index:n.message_index??-1,content_hash:n.content_hash||"",paragraph:n.paragraph??0,shot_index:n.shot_index??0,y_percent:n.y_percent??null,assistant_preview:n.assistant_preview||"",session_id:n.session_id||""},meta:{main_prompt:n.main_prompt||"",seed:n.seed??null,created_at:n.created_at??null,characters:n.characters||[]}}))}}function og(e,t=[]){const n=e?.location||{},r=String(n.content_hash||"").trim(),a=t||[];if(r){const l=a.find(f=>String(f.content_hash||"")===r);if(l)return{status:"exact",matchId:String(l.id),content_hash:r}}const i=String(n.character_id||""),o=String(n.chat_id||""),s=Number(n.message_index),c=a.filter(l=>i&&String(l.character_id||"")!==i||o&&String(l.chat_id||"")!==o||Number.isFinite(s)&&s>=0&&Number(l.message_index)!==s?!1:!!(i||o||Number.isFinite(s)&&s>=0)).slice(0,8);return c.length?{status:"candidate",candidates:c.map(l=>({id:l.id,content_hash:l.content_hash,message_index:l.message_index})),location:n}:{status:"orphan",location:n}}function sg(e=[]){return rg(e)}function cg(e){const t=ag(e);let n=null;const r=t.get("manifest.json");if(r)try{n=JSON.parse(new TextDecoder().decode(r))}catch{n=null}const a=new Map;for(const[i,o]of t.entries())i!=="manifest.json"&&/\.(png|webp|jpe?g)$/i.test(i)&&a.set(i.replace(/\\/g,"/"),o);return{manifest:n,images:a,files:t}}ee(),q(),Q(),O(),Le();function er(e){try{const t=JSON.parse(e.meta_json||"{}");return t&&typeof t=="object"?t:{}}catch{return{}}}async function Al(e,t){return(await Sf(e))?.png_bytes||Number(t.png_bytes)||0}async function _i(e){const t=(await be("cards")).sort((i,o)=>(o.created_at||0)-(i.created_at||0)).slice(0,Math.max(1,Math.min(2e3,e))),n={},r=[];for(const i of t){const o=er(i),s=await mt(i.id,o),c=await Bt(i.id),l=u(s.character_name||c.character_name||o.character_name||"",200),f=u(s.chat_name||c.chat_name||o.chat_name||"",200),d=u(s.character_id||"",200)||"unknown",m=u(s.chat_id||"",200)||"unknown",p=`${d}|${m}`;let g=n[p];g||(g={key:p,character_id:d,chat_id:m,character_name:l||d.slice(0,12)||"Unknown",chat_name:f||`chat ${s.chat_index??"?"}`,char_index:s.char_index??-1,chat_index:s.chat_index??-1,count:0,storage:"indexeddb"},n[p]=g),l&&!g.character_name&&(g.character_name=l),f&&(g.chat_name=f),g.count+=1,r.push({id:i.id,job_id:i.job_id,session_id:i.session_id,folder_key:p,shot_index:s.shot_index>=0?s.shot_index:i.shot_index,paragraph:Object.keys(c).length?s.paragraph:i.paragraph,y_percent:s.y_percent,line:s.line,message_index:s.message_index??-1,message_role:s.message_role||"",content_hash:s.content_hash||"",character_id:d,character_name:g.character_name,chat_id:m,chat_name:g.chat_name,char_index:s.char_index??-1,chat_index:s.chat_index??-1,assistant_preview:u(s.assistant_preview||c.assistant_preview||o.assistant_preview||"",et),main_prompt:i.main_prompt,characters:JSON.parse(i.characters_json||"[]"),image_url:Be(i.id),seed:i.seed,created_at:i.created_at,storage:"indexeddb",storage_key:s.storage_key||je(i.id),location_file:s.location_file||"",png_bytes:await Al(i.id,o)})}const a={ok:!0,folders:Object.values(n).sort((i,o)=>`${i.character_name||""}`.localeCompare(`${o.character_name||""}`,void 0,{sensitivity:"base"})||`${i.chat_name||""}`.localeCompare(`${o.chat_name||""}`,void 0,{sensitivity:"base"})),items:r,total:r.length,storage:"indexeddb",storage_api:"getLocalPluginStorage"};return await st(a,{cachedOnly:!0}),a}async function lg(e=400){return _i(e)}async function ug(e,t=40){const n=(await ms(e)).sort((i,o)=>(o.created_at||0)-(i.created_at||0)).slice(0,Number(t)),r=[];for(const i of n){const o=er(i),s=await mt(i.id,o),c=await Bt(i.id);r.push({id:i.id,job_id:i.job_id,shot_index:s.shot_index>=0?s.shot_index:i.shot_index,paragraph:Object.keys(c).length?s.paragraph:i.paragraph,y_percent:s.y_percent,line:s.line,message_index:s.message_index??-1,message_role:s.message_role||"",content_hash:s.content_hash||"",character_id:s.character_id||"",chat_id:s.chat_id||"",character_name:s.character_name||"",chat_name:s.chat_name||"",char_index:s.char_index??-1,chat_index:s.chat_index??-1,assistant_preview:s.assistant_preview||o.assistant_preview||"",main_prompt:i.main_prompt,negative_prompt:i.negative_prompt,characters:JSON.parse(i.characters_json||"[]"),image_url:Be(i.id),seed:i.seed,created_at:i.created_at,storage:"indexeddb",storage_key:s.storage_key||je(i.id),png_bytes:await Al(i.id,o)})}const a={ok:!0,session_id:e,items:r,storage:"indexeddb"};return await st(a,{cachedOnly:!0}),a}async function fg(e={}){const t=u(e.session_id,200),n=u(e.to_hash,128),r=u(e.assistant_preview||"",et),a=(Array.isArray(e.card_ids)?e.card_ids:[]).map(o=>u(o,80)).filter(Boolean);if(!n||!a.length)return{ok:!1,...ae("to_hash and card_ids required","bad_request"),rebound:0,ids:[]};const i=[];for(const o of a){const s=await z("cards",o);if(!s||t&&u(s.session_id||"",200)!==t)continue;const c=er(s),l=await Bt(o),f={...l,image_id:o,content_hash:n,assistant_preview:r||l.assistant_preview||""};await kl(o,f),c.content_hash=n,r&&(c.assistant_preview=r),c.message_role=u(c.message_role||l.message_role||"",40).toLowerCase(),s.meta_json=JSON.stringify(c),await F("cards",s),i.push(o)}return w("gallery.rebind",{n:i.length,to:n.slice(0,8)}),{ok:!0,rebound:i.length,ids:i,content_hash:n}}async function yi(e,t="",n=null){const r=u(e,200),a=u(t);let i=null;try{n!=null&&String(n).trim()!==""&&(i=parseInt(String(n),10))}catch{i=null}if(!r||!a&&i==null)return{ok:!0,unlinked:0,ids:[]};const o=(await ms(r)).sort((c,l)=>(c.created_at||0)-(l.created_at||0)),s=[];for(const c of o){const l=er(c),f=await mt(c.id,l),d=u(f.content_hash||""),m=P(f.message_index,-1);let p=!1;if((a&&d&&d===a||i!=null&&i>=0&&m===i)&&(p=!0),!p)continue;const g={...await Bt(c.id),version:1,image_id:c.id,session_id:r,content_hash:"",message_index:-1,character_id:"",chat_id:"",char_index:-1,chat_index:-1,unlinked_at:Date.now()/1e3};await kl(c.id,g),(l.content_hash||l.message_index!=null||l.assistant_preview)&&(l.content_hash="",l.assistant_preview="",l.message_index=-1,l.unlinked_at=Date.now()/1e3,c.meta_json=JSON.stringify(l),await F("cards",c)),s.push(c.id)}return{ok:!0,unlinked:s.length,ids:s}}async function bi(e){const t=u(e,80);return t?await z("cards",t)?(await At("cards",t),await At("images",t),{ok:!0,deleted:1,ids:[t]}):{ok:!1,...ae("card not found","not_found")}:{ok:!1,...ae("card_id required","bad_request")}}async function wi(e){return bi(e)}async function dg(e=[]){const t=[...new Set((e||[]).map(r=>u(r,80)).filter(Boolean))],n=[];for(const r of t)(await bi(r)).ok&&n.push(r);return{ok:!0,deleted:n.length,ids:n}}async function Ml(){const e=(await z("meta","explorer_favorites"))?.ids;return{ok:!0,ids:Array.isArray(e)?e.map(t=>u(t,80)).filter(Boolean):[]}}async function mg(e=[]){const t=[...new Set((e||[]).map(n=>u(n,80)).filter(Boolean))].slice(0,5e3);return await F("meta",{key:"explorer_favorites",ids:t,updated_at:Date.now()/1e3}),{ok:!0,ids:t}}async function pg(e={}){let t=(await _i(2e3)).items;const n=u(e.folder_key||"",400);if(!e.all)if(n)t=t.filter(o=>o.folder_key===n);else if(Array.isArray(e.card_ids)&&e.card_ids.length){const o=new Set(e.card_ids.map(s=>u(s,80)));t=t.filter(s=>o.has(s.id))}else return{ok:!1,...ae("card_ids, folder_key, or all required","bad_request")};if(!t.length)return{ok:!1,...ae("no images to export","empty")};const r=ig(t),a=[{name:"manifest.json",data:new TextEncoder().encode(JSON.stringify(r,null,2))}];for(const o of t){const s=await Nl(o.id);s?.byteLength&&a.push({name:`images/${o.id}.png`,data:V(s)})}if(a.length<2)return{ok:!1,...ae("image bytes missing","empty")};const i=sg(a);return{ok:!0,count:a.length-1,filename:`inlay-gallery-${Date.now()}.zip`,zip_base64:Jt(i),bytes:i.length}}async function gg(e={}){const t=e.prefer_new_ids===void 0?!0:e.prefer_new_ids,n=String(e.zip_base64||"").replace(/^data:.*base64,/,"");if(!n)return{ok:!1,...ae("zip_base64 required","bad_request")};let r;try{r=Pe(n)}catch(l){return{ok:!1,...ae(`invalid base64: ${l?.message||l}`,"bad_request")}}const{manifest:a,images:i}=cg(r);if(!a?.items?.length)return{ok:!1,...ae("manifest.items missing","bad_request")};const o=(await _i(2e3)).items,s=[],c={exact:0,candidate:0,orphan:0,skipped:0};for(const l of a.items){const f=String(l.file||`images/${l.id}.png`).replace(/\\/g,"/"),d=i.get(f)||i.get(`images/${l.id}.png`);if(!d?.byteLength){c.skipped+=1;continue}const m=og(l,o);c[m.status]=(c[m.status]||0)+1;const p={...l.location||{}},g=t?bt():u(l.id||"",80)||bt(),h=u(p.session_id||"",200)||`import_${bt().replace(/-/g,"").slice(0,10)}`,_={version:1,image_id:g,session_id:h,character_id:u(p.character_id||"",200),character_name:u(p.character_name||"",200),chat_id:u(p.chat_id||"",200),chat_name:u(p.chat_name||"",200),char_index:P(p.char_index,-1),chat_index:P(p.chat_index,-1),message_index:P(p.message_index,-1),shot_index:P(p.shot_index,0),paragraph:P(p.paragraph,0),y_percent:lr(p.y_percent),content_hash:u(p.content_hash||"",128),assistant_preview:u(p.assistant_preview||"",et),imported_at:Date.now()/1e3,reattach:m.status},y=Z(d);await ka(g,y,_);const k=pi({...l.meta||{},assistant_preview:_.assistant_preview,imported_at:_.imported_at,reattach:m.status},_,y.byteLength||0);await F("cards",{id:g,job_id:`import_${g.slice(0,8)}`,session_id:h,shot_index:_.shot_index,paragraph:_.paragraph,main_prompt:u(l.meta?.main_prompt||"",8e3),negative_prompt:"",characters_json:JSON.stringify(l.meta?.characters||[]),seed:l.meta?.seed??0,meta_json:JSON.stringify(k),created_at:Number(l.meta?.created_at)||Date.now()/1e3}),s.push({id:g,reattach:m.status,content_hash:_.content_hash})}return{ok:!0,imported:s.length,items:s,report:c}}async function hg(e){const t=u(e,400);if(!t||!t.includes("|"))return{ok:!1,...ae("folder_key required","bad_request")};const[n,r]=t.split("|",2),a=u(n,200)||"unknown",i=u(r,200)||"unknown",o=await be("cards"),s=[];for(const c of o){const l=er(c),f=await mt(c.id,l),d=u(f.character_id||"",200)||"unknown",m=u(f.chat_id||"",200)||"unknown";d!==a||m!==i||(await bi(c.id)).ok&&s.push(c.id)}return{ok:!0,deleted:s.length,ids:s,folder_key:`${a}|${i}`}}async function Nl(e){return Tf(e)}O(),Le(),fe();var _g=["queued","tagging","generating"];function Ur(e={},t=""){const n=u(t||e.session_id||"",200)||"_",r=u(e.content_hash||"",128);if(r)return`${n}::h:${r}`;const a=P(e.message_index,-1);return a>=0?`${n}::m:${a}`:`${n}::all`}async function yg(e){if(mr.has(e))return"message-reroll";const t=En.get(e);if(!t?.jobId)return"";const n=xt.get(t.jobId);if(!n||n.cancelRequested)return"";const r=await z("jobs",t.jobId);return r&&_g.includes(String(r.state||""))?t.jobId:""}async function vi(e={},t=""){const n=await yg(Ur(e,t));return n?{ok:!1,busy:!0,accepted:!1,job_id:n==="message-reroll"?"":n,session_id:u(t||e.session_id||"",200),job_state:"busy",error:{code:"busy",message:"같은 메시지 작업이 아직 진행 중입니다. 끝날 때까지 기다려 주세요."}}:null}function Il(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function Cl(e){const t=Il(e);return t.length?t.map((n,r)=>`L${r+1}|${n}`).join(`
`):""}function bg(e){if(e.length<2)return!1;for(let t=0;t<e.length;t+=1){const n=Math.floor(Number(e[t]));if(!Number.isFinite(n)||n!==t+1)return!1}return!0}function wg(e,t){const n=Math.max(1,Math.floor(Number(t)||0)),r=new Set;return e.map(a=>{const i=Number(a);let o=n<=1?1:Math.max(1,Math.min(n,Math.round((Number.isFinite(i)?Math.max(0,Math.min(100,i)):50)/100*(n-1))+1));if(!r.has(o))return r.add(o),o;for(let s=1;s<n;s+=1){const c=o+s;if(c<=n&&!r.has(c))return r.add(c),c;const l=o-s;if(l>=1&&!r.has(l))return r.add(l),l}return r.add(o),o})}function vg(e,t){if(!Array.isArray(e)||e.length<2)return e.slice();const n=Il(t).length;if(n<2||!bg(e.map(a=>a.line)))return e.slice();const r=wg(e.map(a=>a.y_percent),n);return e.map((a,i)=>({...a,line:r[i]??a.line}))}q(),vt(),O(),Jn(),Wt(),it(),fe(),Zn(),ft();function xg(e){for(let t=e.length-1;t>=0;t--){const n=e[t];if(!n||n.role!=="user")continue;const r=typeof n.content=="string"?n.content:"";if(r.trim()&&!r.startsWith("# Priority: Author"))return r}return""}async function kg(e){const t=nt(T().card,e.card||{}),n=u(e.session_id,200),r=[{role:"system",content:`${ur(await ce("tagger"))}

${ur(await ce("format"))}`.trim()}];t.char_info&&u(e.character_description)&&r.push({role:"system",content:`${await ce("char_inject")}
## {{char}} Info
${u(e.character_description,12e3)}`}),t.user_info&&u(e.persona_description)&&r.push({role:"system",content:`${await ce("char_inject")}
## {{user}} Info
${u(e.persona_description,8e3)}`});const a=u(e.assistant_text,2e4),i=Array.isArray(e.source_session_ids)?e.source_session_ids.map(y=>u(y,200)).filter(Boolean):[],o=t.lorebook||t.char_appearance!==!1||t.asset_nai_tags?await La(n,u(e.unified_session_id||"",200),u(e.character_id||"",200),i):[],s=Gf(o);if(t.lorebook){const y=Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:null,k=Ts(t.lore_extra),x=Wf(e.lorebook||[],a,s,5,1200,y,k),S=[],C=[];for(const E of x){const B=Et(E)||E.always,J=u(E.content||"",B?5e4:1200);if(!J)continue;const v=u(E.comment||"",200),M=v?`### ${v}
${J}`:J;B?S.push(M):C.push(M)}const N=[];S.length&&N.push(`## lb-xnai.lb.extra — OFFICIAL PACK (START)
...
[END OF lb-xnai.lb.extra] Pack finished — text below is not lb-xnai ground truth.`),C.length&&N.push(`## Reference Lorebook (trigger-matched only)
Naming/context only. Not lb-xnai. Do not copy lore prose into tags.

`+C.join(`

`)),w("job.lore.extra",{trigger_keys:Array.isArray(y)?y.length:0,injected:S.length,reference:C.length,sections:x.filter(E=>Et(E)||E.always).map(E=>E.key||"").filter(Boolean).join(" | ")}),N.length&&r.push({role:"system",content:`${await ce("lore_inject")}
${N.join(`

`)}`})}const c=async y=>{if(!t.asset_nai_tags)return;const k=[...Array.isArray(e.lore_trigger_keys)?e.lore_trigger_keys:[],...Ea(e.lorebook||[],a)];try{const x=await Td(k);if(x?.block){let S=await ce("asset_tags_inject");S=S.includes("{asset_tags_block}")?S.replace("{asset_tags_block}",x.block):`${S}

${x.block}`,r.push({role:"system",content:S}),w("asset-tags.inject",{reason:y,assets:x.packed.assets.map(C=>C.name),triggers:k.length})}else Ys(new Map),w("asset-tags.inject.skip",{reason:y,cause:"collect_empty",triggers:k.length})}catch(x){Ys(new Map),w("asset-tags.inject.fail",{reason:y,message:String(x?.message||x)},"warn")}};if(t.char_appearance!==!1){const y=o,k=y.filter(C=>Me(C)),x=y.filter(C=>u(C.name,200)&&!Me(C)),S=Ku(a,y);if(k.length||x.length||S.length){const C=M=>{const R=u(M.name,200),Y=u(M.appearance||"",200),Se=u(M.attire||"",160),X=u(M.accessories||"",120),D=[Y?`appearance=${Y}`:"",Se?`attire=${Se}`:"",X?`accessories=${X}`:""].filter(Boolean);return D.length?`${R} ← ${D.join(" | ")}`:R},N=S.filter(M=>Me(M)),E=S.filter(M=>!Me(M)),B=N.length?N.map(C).filter(Boolean).join(`
`):"(none)",J=E.length?E.map(M=>`- ${M.name} (aliases: ${hr(M).slice(0,8).join(", ")}) → empty appearance; full looks required in new_characters`).join(`
`):"(none)";let v=await ce("appearance_inject");v.includes("{registered_block}")&&(v=v.replace("{registered_block}",B)),v=v.includes("{incomplete_block}")?v.replace("{incomplete_block}",J):`${v}

## Incomplete
${J}`,v=v.includes("{detected_block}")?v.replace("{detected_block}",B):`${v}

${B}`,r.push({role:"system",content:v}),w("job.roster.split",{filled:k.map(M=>M.name),incomplete:x.map(M=>M.name),matched:S.map(M=>M.name),matched_with_looks:N.map(M=>M.name),session_id:n})}}await c("asset_nai_tags_on");const l=Fa(t.natural_base),f=at(t),d=Math.max(1,Number(t.image_min??1)||1),m=Math.max(d,Number(t.image_max??3)||3);r.push({role:"system",content:["Every shot MUST include `y_percent` (0–100): reading position top→bottom. Spread across the full range in order (shot0 < shot1 < …); ~even gaps. E.g. 2→~25/~75; 3→~20/~50/~80; 4→~15/~40/~65/~90. Forbidden: all under 40, duplicates, or gaps under ~15 unless 1 shot.","LINE: message lines are labeled `L1|…`, `L2|…`. Set each shot `line` to that L number (illustration sits immediately before that line). Pick the L# whose text matches the shot moment. `paragraph` = shot order (0,1,2…). `line` is NOT shot order. INVALID: emitting line=1,2,3… just because you have 1st/2nd/3rd shots.",d===m?`SHOT COUNT: produce exactly ${m} shot(s) in scenes[].shots (across all scenes).`:`SHOT COUNT: produce between ${d} and ${m} shots in scenes[].shots (across all scenes). Prefer the count that fits the message; never fewer than ${d} or more than ${m}.`,Ag(l),`CHARACTER CAP: at most ${f} characters per shot (char1..char${f}). If more are visible, keep the ${f} most important; fold extras into situation/place.`,t.auto_aspect?"ASPECT (required on every shot): set `aspect` to exactly one of `portrait` (832×1216 vertical), `square` (1024×1024), or `landscape` (1216×832 horizontal). Pick from the scene framing — tall full-body / standing → portrait; equal crop / face close-up square → square; wide group / side-by-side / scenic → landscape. Like Asset Maid size presets 1/5/2.":""].filter(Boolean).join(`
`)});const p=await ll();p&&r.push({role:"system",content:p});const g=[];if(Number(t.include_max||0)>0)for(const y of e.recent_messages||[]){const k=u(y?.role,40)||"char",x=u(y?.content||y?.data,12e3);x&&(a&&x===a&&["char","assistant","bot"].includes(k.toLowerCase())||g.push(`[${k}]
${x}`))}a&&g.push(Cl(a));const h=g.length?g.join(`

`):Cl(a);if(!h)throw new Error("태깅할 메시지 텍스트가 없습니다.");r.push({role:"user",content:h});const _=u(await ce("author_note"),8e3);return _&&r.push({role:"user",content:`# Priority: Author's Note
${_}
> These are instructions explicitly given by the user. If in conflict with previous instructions, this section MUST take precedence.`}),r}function Sg(e,t){const n=at(T().card),r=e,a=[];for(const i of r.scenes||[]){const o=u(i.place);for(const s of i.shots||[]){const c={...s,place:o,characters:ga(s.characters||[],[],n).slice(0,n)};a.push(c)}}return vg(a,t??"")}function Ag(e){return e==="off"?"Natural base mode OFF. Omit the `natural` field (or leave it empty). Do not invent natural-language base phrases.":e==="detailed"?["Natural base mode DETAILED. Every shot MUST include `natural`: a compact English phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include framing/vantage when useful (side view, close-up, viewed through, reflected in…), then for each visible person in left-to-right (or front-to-back) order: hair color + age band + gender, facial expression, clothing, and pose/action as separate details.","Multi-person: NEVER use character names — use position (left girl, right boy) or hair. Add shared action and lighting/atmosphere briefly.","Telegraphic and objective. Example: `side view upper body, left red hair adult woman tense smile in coat pulling right blue hair teen boy startled arms pinned, warm cafe light`. Keep ~12–28 words, English only."].join(" "):e==="supplement"?["Natural base mode SUPPLEMENT. Every shot MUST include `natural`: telegraphic English sentences describing what tags cannot express (composition, framing, actions, atmosphere, lighting) for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Keep tags and natural language clearly separated. Multi-person: NEVER use names — identify by position (left girl, bottom boy) or appearance. For each person include facial expression and clothing as distinct details; also hair and pose unless already obvious.","Unusual framing welcome (viewed through, reflected in shards of a broken mirror, behind…). Concise, minimal, objective — no subjective interpretation.","Example: `Side view, upper body. Left: adult woman with red hair, tense smile, coat, pulling. Right: teen boy with blue hair, startled face, arms pinned. Warm cafe lighting.` Prefer ~2–5 short sentences, English only."].join(" "):["Natural base mode SHORT. Every shot MUST include `natural`: a short English natural-language phrase for NovelAI base caption only (NOT Danbooru comma tags, NOT characters[].action).","Include hair color + age band + gender for each visible person, plus the shared action. Example: `red hair adult woman forced hug blue hair boy`. Keep ~6–20 words, English only."].join(" ")}ee(),q(),O(),vt(),Tt(),fi(),it(),Wt(),Le(),fe(),Zn(),ft();var El=5e3,Mg=2500,Ng=64;function Ig(e,t,n){const r=Ur(t,n),a=(En.get(r)?.epoch||0)+1;return En.set(r,{epoch:a,jobId:e}),xt.set(e,{key:r,epoch:a,cancelRequested:!1,publishedIds:[]}),{key:r,epoch:a}}function Cg(e){const t=xt.get(e);if(!t||t.cancelRequested)return!1;const n=En.get(t.key);return!!(n&&n.jobId===e&&n.epoch===t.epoch)}async function Eg(e){const t=xt.get(e),n=t?.publishedIds?[...t.publishedIds]:[];t&&(t.publishedIds=[]);for(const r of n)try{await wi(r)}catch{}return n.length}async function Ee(e,t="interrupted"){if(Cg(e))return!1;const n=await Eg(e);return await pe(e,"cancelled",{phase:"cancelled",progress:0,message:`${t}${n?` · discarded ${n}`:""}`,shot_count:0,shot_done:0},null),w("job.cancelled",{job_id:e,message:t,discarded:n,focus:!0}),!0}function tr(e={}){return{shot_count:e.shot_count??0,shot_index:e.shot_index??0,shot_done:e.shot_done??0,progress:e.progress??0,phase:e.phase||"generating",message:e.message||"",cards_so_far:e.cards_so_far,pending_inline:Array.isArray(e.pending_inline)?e.pending_inline:void 0,debug_stage:gt()||Sn(),debug_error:sr()?.message||""}}function Tg(e){return!e||typeof e!="object"?e:JSON.parse(JSON.stringify(e,(t,n)=>{if(t==="image_url"&&typeof n=="string"&&n.startsWith("data:"))return"";if(!(t==="tagged"||t==="appearance"||t==="debug_tail"))return n}))}async function pe(e,t,n=null,r=null){const a=await z("jobs",e);if(!a)return;const i=a.state,o={...a,state:t},s=Tg(n);o.result_json=s!=null?JSON.stringify(s):null,o.error=r,o.updated_at=Date.now()/1e3;const c=t!=="generating"||i!=="generating"||!!r;await F("jobs",o,{persist:c}),(t==="done"||t==="error"||t==="cancelled")&&await fs(),w("job.set",{message:`${t}${r?" ERR":""}${c?"":" (mem)"}`,job_id:e,state:t,persist:c,err:r?String(r).slice(0,160):"",background:t==="generating",focus:t!=="generating"})}async function Tl(e){if(!(T().card||{}).power&&!e.force)throw new Error("Power가 OFF 상태입니다.");const t=u(e.session_id,200)||`sess_${bt().replace(/-/g,"").slice(0,12)}`,n={...e,session_id:t},r=await vi(n,t);if(r)return w("job.busy",{message:r.error.message||"busy",key:Ur(n,t),focus:!0},"warn"),r;const a=bt(),i=Date.now()/1e3;if(Ig(a,n,t),n.force)try{await yi(t,u(n.content_hash||""),n.message_index)}catch{}return await F("jobs",{id:a,session_id:t,state:"queued",request_json:JSON.stringify(n),result_json:null,error:null,created_at:i,updated_at:i}),Pg(a).catch(async o=>{console.error("[Inlay Nexus] job crashed",a,o);try{await pe(a,"error",null,String(o?.message||o).slice(0,1500))}catch{}}),{ok:!0,accepted:!0,job_id:a,session_id:t,job_state:"queued"}}async function jg(e){const t=await z("jobs",e);if(!t)return{ok:!1,error:{code:"not_found",message:"job not found"}};const n=t.result_json?JSON.parse(t.result_json):null,r={};if(n&&typeof n=="object")for(const a of["shot_count","shot_index","shot_done","progress","phase","message","cards_so_far","pending_inline","debug_stage","debug_error"])a in n&&(r[a]=n[a]);return n&&await st(n),{ok:!0,job_id:t.id,session_id:t.session_id,state:t.state,error:t.error,result:n,progress:r,debug:{last_stage:Sn(),last_error:sr(),events:ta(e,40)},created_at:t.created_at,updated_at:t.updated_at}}function $g(e){for(const t of["y_percent","anchor_percent","read_percent"]){const n=e[t];if(n!=null)try{return Math.max(0,Math.min(100,Number(n)))}catch{return null}}return null}async function Pg(e){const t=await z("jobs",e);if(!t)return;const n=JSON.parse(t.request_json??"{}"),r=String(t.session_id??""),a=Hi();kn(e);const i=ue("job.run");w("job.start",{job_id:e,session_id:r,message_index:n.message_index,text_len:String(n.assistant_text||"").length});try{if(await Ee(e,"superseded before start")||(n.force&&await yi(r,u(n.content_hash||""),n.message_index),await Ee(e,"superseded before tagging")))return;await pe(e,"tagging",{phase:"tagging",progress:0,message:"장면 태깅 중…",shot_count:0,shot_done:0,debug_stage:"job.tagging"});const o=await kg(n),s=xg(o);if(w("job.tagger.messages",{msgs:o.length}),T().card?.preprocessing){const v=ur(await ce("preprocess"));if(v){const M=[{role:"system",content:v},o[o.length-1]],R=await cn(T().llm,M);if(await Ee(e,"superseded during preprocess"))return;o.splice(o.length-1,0,{role:"system",content:`## Preprocess Summary
${R}`})}}const c=await cn(T().llm,o);if(await Ee(e,"superseded after tagging"))return;const l=ra(c);let f=Sg(l,n.assistant_text);if(w("job.tagger.done",{shots:f.length,raw_len:String(c||"").length}),!f.length)throw new Error("태거가 shot을 반환하지 않았습니다.");const d=T().card||{},m=Math.max(1,Number(d.image_min??1)),p=Math.max(m,Number(d.image_max??3));f=f.slice(0,p);const g=Br();if(g==="two_stage"){if(await pe(e,"tagging",{phase:"tagging",progress:.35,message:"큐레이션 2단 씬 태그 보강 중…",shot_count:f.length,shot_done:0,debug_stage:"job.curation_refine"}),await Ee(e,"superseded during curation refine"))return;await ul(f,{chatContext:s})}else if(g==="embed_snap"){if(await pe(e,"tagging",{phase:"tagging",progress:.4,message:"씬 태그 임베딩 매칭 중…",shot_count:f.length,shot_done:0,debug_stage:"job.curation_snap"}),await Ee(e,"superseded during curation snap"))return;const v=await ml(f);v.ok||(w("job.curation_snap.fallback",{message:v.reason},"warn"),await pe(e,"tagging",{phase:"tagging",progress:.45,message:v.reason||"임베딩 없음 → 큐레이션 없이 생성",shot_count:f.length,shot_done:0,debug_stage:"job.curation_snap_fallback"}))}const h=f.flatMap(v=>v.characters||[]),_=u(n.unified_session_id||"",200),y=u(n.character_id||"",200),k=Array.isArray(n.source_session_ids)?n.source_session_ids.map(v=>u(v,200)).filter(Boolean):[],x=await Ud({sessionId:r,tagged:l,shotChars:h,unifiedSessionId:_,characterId:y,sourceSessionIds:k});w("job.roster",{roster:x.length});const S=at(d);for(const v of f)v.characters=ga(v.characters||[],x,S);if(await Ee(e,"superseded before generate"))return;const C=f.map((v,M)=>{const R=Math.floor(Number(v.line));return!Number.isFinite(R)||R<1?null:{shot_index:M,line:R}}).filter(v=>!!v);await pe(e,"generating",tr({shot_count:f.length,shot_index:0,shot_done:0,progress:0,phase:"generating",message:`이미지 1/${f.length} 생성 준비`,pending_inline:C}));const N=[],E=!!d.llm_anchor_percent;for(let v=0;v<f.length;v+=1){if(await Ee(e,`superseded before shot ${v+1}`))return;const M=f[v],{main:R,neg:Y,captions:Se,meta:X}=await zr({shot:M,roster:x}),D=bt(),K=Date.now()/1e3,Ft=u(n.content_hash||"");let ne=$g(M);ne==null&&E&&(ne=Math.round(v/Math.max(1,f.length)*1e4)/100),w("job.shot.prepare",{shot:v,card_id:D,prompt_len:String(R||"").length,captions:(Se||[]).length}),await pe(e,"generating",tr({shot_count:f.length,shot_index:v,shot_done:v,progress:Math.round(v/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`NovelAI 요청 중 ${v+1}/${f.length}… [${gt()}]`,pending_inline:C}));let Ve=0;const re=setInterval(()=>{Ve+=El/1e3;const fn=dc();mc()&&Ha()>=Ng&&fn&&Date.now()-fn>=Mg&&Qd("heartbeat-idle");const fu=Ha()||fc();pe(e,"generating",tr({shot_count:f.length,shot_index:v,shot_done:v,progress:Math.round(v/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`NovelAI 대기 ${v+1}/${f.length} (${Ve}s) · ${gt()}${fu?` ${Math.round(fu/1024)}KB`:""}`,pending_inline:C})).catch(()=>{})},El);let Te,Dt;try{({bytes:Te,seed:Dt}=await xl({main:R,neg:Y,captions:Se},M.aspect))}finally{clearInterval(re)}if(w("job.shot.nai_done",{shot:v,bytes:Te?.byteLength||0,seed:Dt}),await Ee(e,`superseded after shot ${v+1} nai`))return;await pe(e,"generating",tr({shot_count:f.length,shot_index:v,shot_done:v,progress:Math.round((v+.5)/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`이미지 저장 중 ${v+1}/${f.length}… [${gt()}]`,pending_inline:C}));const le=Qp({imageId:D,sessionId:r,request:n,shotIndex:v,paragraph:M.paragraph,yPercent:ne,line:(()=>{const fn=Math.floor(Number(M.line));return Number.isFinite(fn)&&fn>=1?fn:null})(),contentHash:Ft});await ka(D,Te,le);const m_={...pi(X,le,Te?.byteLength||0),aspect:M.aspect||void 0};await F("cards",{id:D,job_id:e,session_id:r,shot_index:v,paragraph:Number(M.paragraph||0),main_prompt:R,negative_prompt:Y,characters_json:JSON.stringify(X.characters||[]),seed:Dt,meta_json:JSON.stringify(m_),created_at:K});const uu=xt.get(e);if(uu&&uu.publishedIds.push(D),await Ee(e,`superseded after shot ${v+1} save`))return;N.push({id:D,shot_index:v,paragraph:le.paragraph,y_percent:le.y_percent,line:le.line,message_index:le.message_index??-1,message_role:le.message_role||"",content_hash:le.content_hash||"",character_id:le.character_id||"",chat_id:le.chat_id||"",character_name:le.character_name||"",chat_name:le.chat_name||"",char_index:le.char_index??-1,chat_index:le.chat_index??-1,assistant_preview:u(n.assistant_text||"",zi),main_prompt:R,negative_prompt:Y,characters:X.characters||[],image_url:Be(D),seed:Dt,storage:"indexeddb",png_bytes:Te?.byteLength||0}),w("job.shot.saved",{shot:v,card_id:D,has_url:!!Be(D)}),await pe(e,"generating",tr({shot_count:f.length,shot_index:v,shot_done:v+1,progress:Math.round((v+1)/Math.max(1,f.length)*1e3)/10,phase:"generating",message:`이미지 ${v+1}/${f.length} 완료`,cards_so_far:N.length,pending_inline:C}))}if(await Ee(e,"superseded before done"))return;const B={cards:N,message_index:n.message_index!=null?Number(n.message_index):-1,shot_count:f.length,shot_done:f.length,progress:100,phase:"done",message:`이미지 ${f.length}/${f.length} 완료`,pending_inline:C};await st(B),await pe(e,"done",B);const J=xt.get(e);J&&(J.publishedIds=[]),i.end({message:"done",cards:N.length})}catch(o){i.fail(o);const s=o,c=`${s?.message||o}
${s?.stack||""}`.slice(-1500);await pe(e,"error",{phase:"error",message:String(s?.message||o).slice(0,240),debug_stage:Sn(),debug_tail:ta(e,12)},c)}finally{kn(a)}}O(),it(),Kt(),Le(),fe();function Rt(e,t){try{return JSON.parse(e)}catch{return t}}async function Og(e,t={}){const n=u(e,80),r=await z("cards",n);if(!r)return{ok:!1,error:{code:"not_found",message:"card not found"}};const a=Rt(r.characters_json||"[]",[]),i=Array.isArray(a)?a:[];let o=r.main_prompt;"main_prompt"in t&&(o=u(t.main_prompt,8e3));let s=r.negative_prompt;"negative_prompt"in t&&(s=u(t.negative_prompt,8e3));let c=i;if("characters"in t){const d=t.characters||[];if(!Array.isArray(d))return{ok:!1,error:{code:"bad_request",message:"characters must be a list"}};c=[];const m=at(T().card||{});for(let p=0;p<d.slice(0,m).length;p++){const g=d[p];if(typeof g!="object")continue;const h=g,_=p<i.length&&typeof i[p]=="object"?i[p]:{},y=u(h.name!=null?h.name:_.name,200),k=u(h.prompt!=null?h.prompt:_.prompt,4e3);if(!y&&!k)continue;const x={..._,name:y||`char${p+1}`,prompt:k||"girl"};"uc"in h&&(x.uc=u(h.uc,2e3));for(const S of["center_x","center_y"])if(S in h)try{x[S]=Number(h[S])}catch{}c.push(x)}}r.main_prompt=o,r.negative_prompt=s,r.characters_json=JSON.stringify(c);try{let d=Rt(r.meta_json||"{}",{});(!d||typeof d!="object"||Array.isArray(d))&&(d={});const m=d;m.setup=o,m.characters=c,r.meta_json=JSON.stringify(m)}catch{}await F("cards",r);const l=await mt(n,{}),f={id:n,main_prompt:o,negative_prompt:s,characters:c,paragraph:r.paragraph,shot_index:r.shot_index,y_percent:l.y_percent,message_index:l.message_index,content_hash:l.content_hash,image_url:Be(n)};return await st(f),{ok:!0,card:f}}async function jl(e,t="nai",n=null,r={}){const a=await z("cards",e);if(!a)return{ok:!1,error:{code:"not_found",message:"card not found"}};const i=a.session_id,o=Rt(a.meta_json||"{}",{}),s=o.location||{};if(!r.skipBusyCheck)try{const v=await mt(e,o),M=await vi({session_id:i,content_hash:u(v.content_hash||o.content_hash||"",128),message_index:P(v.message_index,-1)},i);if(M)return M}catch{}const c=u(s.character_id||o.character_id||"",200);let l=u(o.unified_session_id||s.unified_session_id||"",200);!l&&c&&(l=bu(c));let f=[];try{const v=await z("jobs",a.job_id);if(v?.request_json){const M=JSON.parse(v.request_json);Array.isArray(M.source_session_ids)&&(f=M.source_session_ids.map(R=>u(R,200)).filter(Boolean))}}catch{}const d=await La(i,l,c,f);if(t==="full"){const v=await z("jobs",a.job_id);if(!v)return{ok:!1,error:{code:"no_job",message:"original job missing"}};const M=JSON.parse(v.request_json);return M.force=!0,Tl(M)}let m,p,g,h,_={};const y=n;if(y&&("main_prompt"in y||"negative_prompt"in y||"characters"in y))m="main_prompt"in y?u(y.main_prompt||""):u(a.main_prompt),p="negative_prompt"in y?u(y.negative_prompt||""):u(a.negative_prompt),h="characters"in y?y.characters:null,h==null&&(h=Rt(a.characters_json||"[]",[])),g=(h||[]).slice(0,at(T().card||{})).map(v=>({prompt:ya(v.prompt||"girl")||"girl",uc:u(v.uc),center_x:Number(v.center_x??.5),center_y:Number(v.center_y??.5)}));else if(u(a.main_prompt||"")){const v=Rt(a.characters_json||"[]",[]),M=Array.isArray(v)?v:[],R=$l(o),Y=M.map(Ve=>{if(!Ve||typeof Ve!="object")return null;const re=Ve;if(re.raw&&typeof re.raw=="object"){const Te=re.raw;return{...Te,name:u(Te.name||re.name,200)}}return{name:u(re.name,200),action:re.action,expression:re.expression,sex:re.sex,label:re.label,age:re.age,original:re.original||re.original_tag}}).filter(Boolean),Se=T().card||{},X=He(T().nai?.model||"nai-diffusion-4-5-full"),D=Object.values(In).filter(Boolean);In[X]&&D.unshift(In[X]);const K=uf({setup:o.setup,main:a.main_prompt,person:o.person,stylePositives:ff(Se),qualitySuffixes:D}),Ft={characters:R.length?R:Y,paragraph:a.paragraph,camera:K.rebuildMain&&K.lockedSetup?"":u(o.camera||""),situation:K.rebuildMain&&K.lockedSetup?"":u(o.situation||o.scene||""),place:K.rebuildMain&&K.lockedSetup?"":u(o.place||""),action:K.rebuildMain&&K.lockedSetup?"":u(o.action||"")},ne=await zr({shot:Ft,roster:d,lockedSetup:K.rebuildMain?K.lockedSetup:void 0});K.rebuildMain?(m=ne.main,p=ne.neg,g=ne.captions,h=ne.meta.characters,_={setup:ne.meta.setup,person:ne.meta.person,characters:h}):(m=u(a.main_prompt),p=u(a.negative_prompt)||ne.neg,g=ne.captions,h=ne.meta.characters,_={setup:m,person:ne.meta.person,characters:h})}else{const v=Rt(a.characters_json||"[]",[]),M=$l(o),R=(v||[]).map(D=>{if(!D||typeof D!="object")return null;const K=D;return K.raw||{name:K.name,action:K.action,expression:K.expression}}).filter(Boolean),Y=u(o.setup||""),Se={characters:M.length?M:R,paragraph:a.paragraph,camera:Y?"":u(o.camera||""),situation:Y?"":u(o.situation||o.scene||""),place:Y?"":u(o.place||""),action:Y?"":u(o.action||"")},X=await zr({shot:Se,roster:d,lockedSetup:Y});m=X.main,p=X.neg,g=X.captions,h=X.meta.characters,_={setup:X.meta.setup,person:X.meta.person,characters:h}}if(!g.length&&!(y&&"characters"in y)){const v={characters:(o.characters||[]).map(R=>R.raw||R),camera:o.setup},M=await zr({shot:v,roster:d});m=M.main,p=M.neg,g=M.captions,h=M.meta.characters,_={setup:M.meta.setup,person:M.meta.person,characters:h}}const{bytes:k,seed:x}=await xl({main:m,neg:p,captions:g},o.aspect??y?.aspect),S=bt(),C=Date.now()/1e3;let N=await Bt(a.id);Object.keys(N).length||(N=await mt(a.id,o));const E={version:1,image_id:S,session_id:i,unified_session_id:l,character_id:u(N.character_id||"",200),character_name:u(N.character_name||o.character_name||"",200),chat_id:u(N.chat_id||"",200),chat_name:u(N.chat_name||o.chat_name||"",200),char_index:P(N.char_index,-1),chat_index:P(N.chat_index,-1),message_index:P(N.message_index,-1),shot_index:P(N.shot_index,P(a.shot_index,0)),paragraph:P(N.paragraph,P(a.paragraph,0)),y_percent:lr(N.y_percent),content_hash:u(N.content_hash||"",128),assistant_preview:u(N.assistant_preview||o.assistant_preview||"",et)};await ka(S,k,E);const B=pi({...o,..._},E,k.byteLength);for(const v of["y_percent","anchor_percent","read_percent"])delete B[v];B.y_percent=E.y_percent,await F("cards",{id:S,job_id:a.job_id,session_id:i,shot_index:a.shot_index,paragraph:a.paragraph,main_prompt:m,negative_prompt:p,characters_json:JSON.stringify(h),seed:x,meta_json:JSON.stringify(B),created_at:C});try{await wi(e)}catch{}const J={id:S,image_url:Be(S),main_prompt:m,negative_prompt:p,characters:h,seed:x,paragraph:E.paragraph,y_percent:E.y_percent,message_index:E.message_index,shot_index:E.shot_index,content_hash:E.content_hash,character_id:E.character_id,chat_id:E.chat_id,character_name:E.character_name,chat_name:E.chat_name,assistant_preview:E.assistant_preview,storage:"indexeddb",png_bytes:k.byteLength};return await st(J),{ok:!0,replaced:e,card:J}}async function Lg({session_id:e="",content_hash:t="",message_index:n=-1}={}){const r=u(e,200),a=u(t,128),i=P(n,-1);if(!r&&!a&&i<0)return{ok:!1,error:{code:"bad_request",message:"session_id or content_hash required"}};const o=await be("cards"),s=[];for(const h of o){if(r&&h.session_id!==r)continue;const _=Rt(h.meta_json||"{}",{}),y=await mt(h.id,_),k=u(y.content_hash||_.content_hash||"",128),x=P(y.message_index,-1);if(a){if(k!==a)continue}else if(i>=0){if(x!==i)continue}else continue;const S=y.y_percent??_.y_percent??_.anchor_percent??_.read_percent,C=Number(S);s.push({row:h,y:Number.isFinite(C)?C:999,shot:P(h.shot_index,0),paragraph:P(h.paragraph??y.paragraph,0)})}if(s.sort((h,_)=>h.y-_.y||h.shot-_.shot||h.paragraph-_.paragraph),!s.length)return{ok:!1,error:{code:"not_found",message:"no cards for message"}};const c=r||u(s[0]?.row?.session_id||"",200),l={session_id:c,content_hash:a,message_index:i},f=await vi(l,c);if(f)return f;const d=Ur(l,c);mr.add(d);const m=[],p=[],g=[];try{for(const h of s){const _=h.row;try{const y=await jl(_.id,"nai",null,{skipBusyCheck:!0});if(y?.busy){g.push({id:_.id,error:y.error?.message||"busy"});break}y?.ok&&y.card?(m.push(y.card),y.replaced&&p.push(y.replaced)):g.push({id:_.id,error:u(y?.error?.message||"reroll failed",400)})}catch(y){g.push({id:_.id,error:u(y?.message||y,400)})}}return{ok:m.length>0,count:m.length,replaced:p,cards:m,failed:g}}finally{mr.delete(d)}}function $l(e){return Array.isArray(e.characters)?e.characters.map(t=>t&&typeof t=="object"?t.raw||t:null).filter(Boolean):[]}var Bg=dn({HASH_REBIND_THRESHOLD:()=>Ug,PREFIX_MATCH_MIN_CHARS:()=>24,PREFIX_MATCH_THRESHOLD:()=>zg,SIMILARITY_COMPARE_MAX:()=>800,VIEWER_THUMB_LAYOUT:()=>te,activeSegmentIndex:()=>Oh,bigramCounts:()=>ki,buildInlineChatHtml:()=>Dh,claimStickyMarkerByCardId:()=>uh,clampPinPercent:()=>Ge,clampReadingPercent:()=>Ph,clampShotLine:()=>Ql,clampThumbScrollOffset:()=>Sh,composeDualProgressBarsHtml:()=>Th,composeProgressToastHtml:()=>jh,composeSingleProgressBarHtml:()=>Gl,composeStickyThumbHtml:()=>hh,createDebouncedSaveQueue:()=>ch,createScrollSettleTracker:()=>oh,createSessionChangeGuard:()=>sh,describeDomApiCompare:()=>Yg,diceBigramRatio:()=>Ll,evenAnchorPercent:()=>Mi,expandElementLineEntries:()=>au,findElementIndexForLine:()=>iu,findElementIndexForLineWithFallback:()=>Fh,findHashRebindCandidates:()=>Jg,findPlainLineStartOffset:()=>nu,fitBoxInside:()=>gh,galleryFocusMessage:()=>qg,galleryForMessage:()=>Kg,galleryIndexFromChildIndex:()=>vh,gallerySelectedCount:()=>Ai,galleryStripContentWidth:()=>kh,galleryStripSplitAt:()=>Kr,hasGenerationInfo:()=>zl,htmlToPlainLn:()=>Rh,injectInlineImagesIntoHtml:()=>cu,isCharMessageRole:()=>Wg,isMessageSelectionGesture:()=>rh,isNearbyDomIndex:()=>Nh,lineTextOccurrence:()=>ru,linkCardsForMessage:()=>Si,longestCommonPrefixLength:()=>Ol,markerBlockHtml:()=>su,mergeViewerPaintJob:()=>Ch,messageCompactKey:()=>un,messageContextTriplet:()=>Vg,messagesTextOverlapScore:()=>Ul,nearbyDomIndexWindow:()=>Ih,nearbyMessageImageIds:()=>Mh,normalizeInlineMatchText:()=>Wr,normalizeMatchText:()=>Jr,normalizeMessageRole:()=>xi,parseAutotagLookJson:()=>ql,pickMessageIndexNearPoint:()=>nh,pinPercentToPx:()=>Qg,pinPercentToPxFromBottom:()=>eh,pinPxToPercent:()=>Jl,preferNearbyHostIndex:()=>ou,prefixMatchRatio:()=>Bl,rawMessageRole:()=>Hr,readingPercentInMessage:()=>Wl,rebindGalleryMessageIndexes:()=>Xg,resolveCardAnchorPercent:()=>$h,resolveChatMessageMatch:()=>Zg,resolveClickSelectionAction:()=>ah,resolveIndexProgress:()=>Eh,resolveStickyThumbPct:()=>mh,resolveStoredPinPercent:()=>th,roleFromGenerationInfo:()=>Gg,scaleInlineThumbnail:()=>Dg,shouldKeepStickyThumbHidden:()=>dh,shouldRefreshGallery:()=>lh,shouldRewriteStickyThumb:()=>fh,shouldSelectMessageByTextDrag:()=>ih,splitMessageLines:()=>Gr,stickyCornerEdgeBox:()=>Hl,stickyCornerImageBox:()=>yh,stickyPinEdgeBox:()=>wh,stickyPinOverImage:()=>bh,stickyThumbBoxFromPct:()=>ph,stickyThumbNeedsHtmlPaint:()=>_h,stripInlayInlineHtml:()=>Zl,thumbIndexAtStripX:()=>xh,visibleGalleryImageIds:()=>Ah}),Rg=528,Fg=720;function b(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Pl(e,t){const n={...e};for(const[r,a]of Object.entries(t||{})){const i=n[r];n[r]=a&&typeof a=="object"&&!Array.isArray(a)?Pl(i&&typeof i=="object"?i:{},a):a}return n}function Dg(e){const t=Math.max(1,b(e,100));return{width:Math.max(1,Math.round(Rg*t/100)),height:Math.max(1,Math.round(Fg*t/100)),percent:t}}function Jr(e){return String(e||"").replace(/[^a-zA-Z0-9\uac00-\ud7a3\u3040-\u30ff\u3400-\u9fff\uff00-\uffef]/g,"").toLowerCase()}var zg=.6,Ug=.6,g_=24,h_=800;function xi(e){const t=String(e||"").toLowerCase().trim();return t?t==="char"||t==="assistant"||t==="bot"?"char":t==="user"||t==="human"?"user":t:""}function Ol(e,t){const n=String(e||""),r=String(t||""),a=Math.min(n.length,r.length);let i=0;for(;i<a&&n.charCodeAt(i)===r.charCodeAt(i);)i+=1;return i}function ki(e){const t=String(e||""),n=new Map;if(t.length<2)return n;for(let r=0;r<t.length-1;r+=1){const a=t.charCodeAt(r)+","+t.charCodeAt(r+1);n.set(a,(n.get(a)||0)+1)}return n}function Ll(e,t,n=null){const r=String(e||""),a=String(t||"");if(!r||!a)return 0;if(r===a)return 1;if(r.length<2||a.length<2)return 0;const i=n||ki(r),o=ki(a);let s=0;for(const[f,d]of o){const m=i.get(f)||0;m&&(s+=Math.min(m,d))}const c=r.length-1,l=a.length-1;return 2*s/(c+l)}function Bl(e,t){const n=Jr(e),r=Jr(t);if(!n||!r)return 0;const a=Math.max(n.length,r.length);if(a<24)return 0;if(n===r)return 1;const i=Ol(n,r)/a;return i>=.6?i:Ll(n.length>800?n.slice(0,800):n,r.length>800?r.slice(0,800):r)}function Si(e,t){if(!t)return[];const n=Array.isArray(e)?e:[],r=String(t.hash||"");return r?Dl(n.filter(a=>a?.content_hash&&a.content_hash===r)):[]}function Jg(e,t={}){const n=Array.isArray(e)?e:[],r=String(t.newHash||t.hash||""),a=String(t.text||""),i=String(t.characterId||""),o=String(t.chatId||""),s=String(t.sessionId||""),c=Number(t.messageIndex),l=xi(t.role||t.messageRole||"");if(!r||!a||!i||!l||!Number.isFinite(c)||c<0)return[];if(n.some(d=>d?.content_hash&&d.content_hash===r))return[];if(Jr(a).length<24)return[];const f=[];for(const d of n){const m=String(d?.content_hash||"");if(!m||m===r||String(d?.character_id||"")!==i)continue;const p=String(d?.chat_id||""),g=String(d?.session_id||"");if(o){if(p!==o)continue}else if(s){if(g&&g!==s)continue}else continue;if(Number(d?.message_index)!==c)continue;const h=xi(d?.message_role||d?.role||"");if(!h||h!==l)continue;const _=String(d?.assistant_preview||"");if(!_)continue;const y=Bl(a,_);y<.6||f.push({card:d,score:y})}return f.sort((d,m)=>m.score-d.score||b(m.card?.created_at)-b(d.card?.created_at)),Dl(f.map(d=>d.card))}function Rl(e){const t=e?.y_percent??e?.anchor_percent??e?.read_percent,n=Number(t);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function Hg(e,t){return Rl(e)-Rl(t)||b(e?.paragraph)-b(t?.paragraph)||b(e?.shot_index)-b(t?.shot_index)||b(t?.created_at)-b(e?.created_at)}function Fl(e,t){return b(t?.created_at)-b(e?.created_at)||b(t?.message_index)-b(e?.message_index)||b(t?.paragraph)-b(e?.paragraph)||b(t?.shot_index)-b(e?.shot_index)}function Dl(e){const t=new Map;for(const n of e||[]){const r=`${n?.paragraph??"?"}|${n?.shot_index??n?.id}`,a=t.get(r);(!a||b(n?.created_at)>=b(a?.created_at))&&t.set(r,n)}return[...t.values()]}function Kg(e,t,n=8){const r=new Map;for(const f of e||[]){const d=String(f?.id||"");!d||r.has(d)||r.set(d,f)}const a=[...r.values()],i=Math.max(0,Math.min(64,b(n,8)||8));if(!t)return a.sort(Fl).slice(0,Math.max(1,i||8));const o=Si(a,t).sort(Hg),s=new Set(o.map(f=>String(f.id))),c=String(t.sessionId||""),l=a.filter(f=>!s.has(String(f.id))).filter(f=>!c||!f?.session_id||f.session_id===c).sort(Fl).slice(0,i);return[...o,...l]}function Ai(e,t){return t?Si(e,t).length:0}function qg(e,t,n){if(e&&Ai(n,e)>0)return e;const r=String(e?.sessionId||e?.session_id||""),a=String(t?.sessionId||t?.session_id||"");return t&&Ai(n,t)>0&&(!r||!a||r===a)?t:e||null}function Hr(e){const t=String(e?.role||e?.type||e?.speaker||e?.sender||e?.from||e?.name||"").trim().toLowerCase();return e?.isUser===!0||e?.fromUser===!0||/^(user|human|player|you|me)$/.test(t)||t.includes("user")?"user":e?.isAssistant===!0||e?.isBot===!0||e?.isChar===!0||/^(assistant|bot|char|character|model|ai)$/.test(t)||t.includes("assistant")||t.includes("bot")||t.includes("char")?"char":t==="system"||t==="developer"?"system":""}function zl(e){const t=e?.generationInfo??e?.generation_info??e?.messageGenerationInfo;return t==null?!1:typeof t=="string"?t.trim().length>0:typeof t=="object"?Object.keys(t).length>0:!0}function Gg(e){return zl(e)?"char":"user"}function Wg(e){if(e&&typeof e=="object")return Hr(e)==="char";const t=String(e||"").trim().toLowerCase();return t==="char"||t==="assistant"||t==="bot"}function un(e,t=48){const n=Math.max(1,b(t,48));return String(e||"").replace(/\s+/g,"").slice(0,n)}function Vg(e,t,n=48){const r=Array.isArray(e)?e:[],a=Math.floor(b(t,-1)),i=a>=0&&a<r.length?r[a]:null,o=a>0?r[a-1]:null,s=a>=0&&a<r.length-1?r[a+1]:null;return[un(o?.text,n),un(i?.text,n),un(s?.text,n),Hr(i)||String(i?.role||"").trim().toLowerCase()].join("|")}function Ul(e,t){const n=String(e||"").replace(/\s+/g,""),r=String(t||"").replace(/\s+/g,"");if(!n||!r)return 0;if(n.includes(r))return r.length;if(r.includes(n))return n.length;let a=0;const i=(s,c,l=8,f=512)=>{let d=l,m=Math.min(s.length,f),p=0;for(;d<=m;){const g=d+m>>1;c.includes(s.slice(0,g))?(p=g,d=g+1):m=g-1}return p};a=Math.max(a,i(r,n),i(n,r));const o=Math.min(r.length,2400);for(let s=0;s+8<=o;s+=32){const c=Math.min(64,o-s);for(let l=c;l>=8;l-=8)if(n.includes(r.slice(s,s+l))){a=Math.max(a,l);break}}return a}function Yg(e,t){const n=String(e||""),r=String(t||""),a=un(n),i=un(r),o=Ul(n,r),s=o>=8,c=a.length>0&&a.length<8&&a===i,l=i.slice(0,48),f=a.slice(0,48);return{domChars:n.length,apiChars:r.length,domCompactChars:a.length,apiCompactChars:i.length,shareScore:o,overlap:s,shortExact:c,apiInDom:!!(l&&l.length>=8&&a.includes(l)),domInApi:!!(f&&f.length>=8&&i.includes(f)),apiKey:l,domKey:f}}function Xg(e,t,n){const r=Array.isArray(t)?t:[],a=typeof n=="function"?n:null,i=new Map;if(a)for(let s=0;s<r.length;s+=1){const c=String(r[s]?.text??r[s]?.data??r[s]?.content??""),l=String(a(c)||"");if(!l)continue;const f=Number.isFinite(Number(r[s]?.index))?Number(r[s].index):s,d=i.get(l);d?d.push(f):i.set(l,[f])}let o=0;return{cards:(Array.isArray(e)?e:[]).map(s=>{const c=String(s?.content_hash||""),l=c?i.get(c):void 0;return!c||!l?s:l.length!==1?Number(s?.message_index)!==-1?(o+=1,{...s,message_index:-1}):s:Number(s?.message_index)!==l[0]?(o+=1,{...s,message_index:l[0]}):s}),changed:o}}function Zg(e,t,n,r,a){const i=Array.isArray(t)?t:[],o=Math.floor(b(n,-1)),s=(f,d,m,p=-1)=>({chatIndex:Number.isFinite(Number(f?.index))?Number(f?.index):p>=0?p:o,text:String(f?.text||e||""),role:Hr(f)||String(f?.role||"").trim().toLowerCase(),matchMethod:d,score:m});if(!i.length)return{chatIndex:Math.max(0,o),text:String(e||""),role:"",matchMethod:"fallback",score:0};const c=i.length-1-o;if(c>=0&&c<i.length)return s(i[c],"reverse",100,c);const l=Math.max(0,Math.min(i.length-1,c));return s(i[l],"reverse",50,l)}function Ge(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.min(100,Math.floor(n))):Math.max(0,Math.min(100,Math.floor(b(t,0))))}function Qg(e,t,n=22,r=4){const a=Math.max(1,b(t,1)),i=Math.max(1,b(n,1)),o=Math.max(0,b(r,0)),s=Math.floor(a*Ge(e,0)/100);return Math.max(o,Math.min(a-i-o,s))}function eh(e,t,n=22,r=8){const a=Math.max(1,b(t,1)),i=Math.max(1,b(n,1)),o=Math.max(0,b(r,0)),s=a-Math.floor(a*Ge(e,0)/100)-i;return Math.max(o,Math.min(a-i-o,s))}function Jl(e,t){const n=Math.max(1,b(t,1));return Ge(b(e,0)/n*100,0)}function th(e,t,n,r=null){const a=r&&typeof r=="object"?r:{x:38,y:80},i=t==="y"||t==="Y",o=i?b(a.y,80):b(a.x,38),s=i?"overlay_y_pct":"overlay_x_pct",c=i?"overlay_y_offset":"overlay_x_offset",l=String(e?.overlay_pin_origin||""),f=l==="top"||l==="tl"||l==="top-left",d=e?.[s],m=d!=null&&Number.isFinite(Number(d)),p=Number(e?.[c]),g=Number.isFinite(p),h=_=>Ge(100-Number(_),o);return m?i&&f?h(d):Ge(d,o):g?i?Ge((b(n,1)-p)/Math.max(1,b(n,1))*100,o):Jl(p,n):Ge(o,o)}function nh(e,t,n=null,r=800){const a=Array.isArray(e)?e:[];if(!a.length)return-1;const i=Math.max(1,b(r,800)),o=Number.isFinite(Number(t))?Number(t):i*.5,s=Number.isFinite(Number(n))?Number(n):null;let c=-1,l=1/0,f=-1,d=1/0;for(let m=0;m<a.length;m+=1){const p=a[m];if(!p)continue;const g=b(p.top,0),h=b(p.bottom,g);if(h<=0||g>=i)continue;const _=(g+h)*.5,y=Number.isFinite(Number(p.left))&&Number.isFinite(Number(p.right))?(Number(p.left)+Number(p.right))*.5:null,k=y!=null&&s!=null?Math.hypot(y-s,_-o):Math.abs(_-o);k<d&&(d=k,f=m);const x=o>=g&&o<=h,S=s==null||!Number.isFinite(Number(p.left))||!Number.isFinite(Number(p.right))||s>=Number(p.left)&&s<=Number(p.right);if(x&&S){const C=Math.max(1,h-g);C<l&&(l=C,c=m)}}return c>=0?c:f}function rh({gesture:e="single",detail:t=1,movement:n=0,textSelecting:r=!1,excludedTarget:a=!1}={}){const i=e==="double"?2:1;return!a&&!r&&b(n,1/0)<=8&&b(t)===i}function ah({gesture:e="single",detail:t=1,pendingDomIndex:n=null,targetDomIndex:r=null}={}){const a=b(t,1);return e==="double"?a===1?{action:"provisional",pendingDomIndex:r}:a===2?{action:"confirm",clearPending:!0,matchedPending:n!=null&&Number(n)===Number(r)}:{action:"ignore"}:a===1?{action:"confirm",clearPending:!0}:{action:"ignore"}}function ih({enabled:e=!0,movement:t=0,hasSelection:n=!1,excludedTarget:r=!1}={}){return!!e&&!r&&!!n&&b(t,0)>8}function oh({delayMs:e=160,onSettle:t}={}){let n=null;const r=Math.max(0,b(e,160)),a=()=>{n=null,typeof t=="function"&&t()};return{bump(){n&&clearTimeout(n),n=setTimeout(a,r)},settleNow(){n&&clearTimeout(n),n=null,a()},cancel(){n&&clearTimeout(n),n=null},get pending(){return n!=null}}}function sh(e=""){let t=String(e||""),n="",r=0;return{observe(a){const i=String(a||"");return!i||i===t?(n="",r=0,!1):i!==n?(n=i,r=1,!1):(r+=1,r<2?!1:(t=n,n="",r=0,!0))},current(){return t},reset(a=""){t=String(a||""),n="",r=0}}}function ch(e,t=300){let n={},r=null,a=null;const i=async()=>a||(a=(async()=>{for(;Object.keys(n).length;){const o=n;n={},await e(o)}})().finally(()=>{a=null}),a);return{enqueue(o){n=Pl(n,o),r&&clearTimeout(r),r=setTimeout(()=>{r=null,i().catch(()=>{})},Math.max(0,b(t,300)))},async flush(){r&&(clearTimeout(r),r=null);do await i();while(Object.keys(n).length||a)},hasPending(){return!!r||!!a||Object.keys(n).length>0}}}function lh(e,t){const n=Array.isArray(e)?e.map(String):[],r=Array.isArray(t)?t.map(String):[];if(n.length!==r.length)return!0;for(let a=0;a<n.length;a+=1)if(n[a]!==r[a])return!0;return!1}function uh(e,t){const n=String(t||"");if(!n||!Array.isArray(e)||!e.length)return null;const r=e.findIndex(i=>String(i?.card?.id||"")===n);if(r<0)return null;const a=e[r];return a?.thumb?(e.splice(r,1),a):null}function fh(e,t){return String(e||"")!==String(t||"")}function dh(e,t,n){if(!e)return!1;const r=String(t||""),a=String(n||"");return!!r&&!!a&&r===a}function mh(e){if(!e.alwaysOn||e.userCollapsed||e.editorOpen)return 0;const t=b(e.settingsPct,0);return t>0?t:0}function ph(e,t,n){const r=Math.max(0,b(e,0)),a=Math.max(0,b(t,0)),i=Math.max(0,b(n,0));return{pct:r,w:Math.max(0,Math.round(a*r/100)),h:Math.max(0,Math.round(i*r/100))}}function gh(e,t,n=0,r=0){const a=Math.max(0,b(e,0)),i=Math.max(0,b(t,0));if(a<=0||i<=0)return{w:0,h:0};const o=Math.max(0,b(n,0)),s=Math.max(0,b(r,0));if(o<=0||s<=0)return{w:a,h:i};const c=Math.min(a/o,i/s);return{w:Math.max(1,Math.round(o*c)),h:Math.max(1,Math.round(s*c))}}function hh(e,t=""){const n=typeof e=="string"?e:"";return n?`<img src="${n}" style="width:100%;height:100%;object-fit:contain;display:block;background:transparent" />`:'<div style="width:100%;height:100%;background:transparent"></div>'}function _h(e,t,n,r){const a=typeof t=="string"?t:"";return a?String(e||"")!==a||String(n||"")!==String(r||""):!1}function yh(e,t,n,r=16){const a=Math.max(1,Math.round(b(t?.w,1))),i=Math.max(1,Math.round(b(t?.h,1))),o=Math.max(a,Math.round(b(n?.width,a))),s=Math.max(i,Math.round(b(n?.height,i))),c=Math.max(0,Math.round(b(r,16))),l=String(e||"bottom-right");return{left:l.includes("left")?c:Math.max(c,o-a-c),top:l.includes("top")?c:Math.max(c,s-i-c),w:a,h:i}}function Hl(e,t,n=16){const r=Math.max(1,Math.round(b(t?.w,1))),a=Math.max(1,Math.round(b(t?.h,1))),i=Math.max(0,Math.round(b(n,16))),o=String(e||"bottom-right");return{w:r,h:a,top:o.includes("top")?i:null,bottom:o.includes("bottom")?i:null,left:o.includes("left")?i:null,right:o.includes("right")?i:null}}function bh(e,t=28,n=6){const r=Math.round(b(e?.left,0)),a=Math.round(b(e?.top,0)),i=Math.max(1,Math.round(b(e?.w,1))),o=Math.max(1,Math.round(b(t,28))),s=Math.max(0,Math.round(b(n,6)));return{left:Math.round(r+(i-o)/2),top:a-s}}function wh(e,t,n=28,r=6,a=16){const i=Hl(e,t,a),o=Math.max(1,Math.round(b(n,28))),s=Math.max(0,Math.round(b(r,6))),c=i.left!=null?i.left:i.right,l=Math.round(b(c,0)+(i.w-o)/2);return{size:o,top:i.top!=null?Math.round(i.top-s):null,bottom:i.bottom!=null?Math.round(i.bottom+i.h+s):null,left:i.left!=null?l:null,right:i.right!=null?l:null}}var te=Object.freeze({width:64,height:88,gap:8,splitWidth:16,splitExtraMargin:4});function Kr(e,t){const n=Math.max(0,Math.floor(b(t,0))),r=Math.max(0,Math.min(Math.floor(b(e,0)),n));return r>0&&r<n?r:0}function vh(e,t,n){const r=Math.max(0,Math.floor(b(n,0))),a=Math.floor(b(e,-1));if(a<0||r<=0)return-1;const i=Kr(t,r);if(i<=0)return a<r?a:-1;if(a===i)return-1;const o=a>i?a-1:a;return o>=0&&o<r?o:-1}function xh(e,{count:t=0,selectedCount:n=0,thumbWidth:r=te.width,gap:a=te.gap,splitWidth:i=te.splitWidth,splitExtraMargin:o=te.splitExtraMargin}={}){const s=Math.max(0,Math.floor(b(t,0)));if(s<=0)return-1;const c=b(e,NaN);if(!Number.isFinite(c)||c<0)return-1;const l=Math.max(1,b(r,te.width)),f=Math.max(0,b(a,te.gap)),d=Math.max(0,b(i,te.splitWidth)),m=Math.max(0,b(o,te.splitExtraMargin)),p=Kr(n,s),g=[];for(let _=0;_<s;_+=1)p>0&&_===p&&g.push({type:"split"}),g.push({type:"thumb",galIdx:_,marginLeft:p>0&&_===p?m:0});let h=0;for(let _=0;_<g.length;_+=1){_>0&&(h+=f);const y=g[_];if(y.type==="split"){if(c>=h&&c<h+d)return-1;h+=d;continue}if(h+=y.marginLeft,c>=h&&c<h+l)return y.galIdx;h+=l}return-1}function kh({count:e=0,selectedCount:t=0,thumbWidth:n=te.width,gap:r=te.gap,splitWidth:a=te.splitWidth,splitExtraMargin:i=te.splitExtraMargin}={}){const o=Math.max(0,Math.floor(b(e,0)));if(o<=0)return 0;const s=Math.max(1,b(n,te.width)),c=Math.max(0,b(r,te.gap)),l=Math.max(0,b(a,te.splitWidth)),f=Math.max(0,b(i,te.splitExtraMargin)),d=Kr(t,o),m=o+(d>0?1:0);let p=o*s+Math.max(0,m-1)*c;return d>0&&(p+=l+f),p}function Sh(e,t,n){const r=Math.max(0,b(t,0)-Math.max(0,b(n,0))),a=b(e,0);return Math.max(0,Math.min(r,a))}function Ah(e,t=0,n=1,r=8,a=0){const i=Array.isArray(e)?e:[];if(!i.length)return[];const o=Math.max(0,Math.min(b(t,0),i.length-1)),s=Math.max(1,Math.min(i.length,b(r,8)||8)),c=Math.min(s,1+2*Math.max(0,b(n,1))),l=Math.max(c,s);let f=Math.max(0,o-Math.floor((l-1)/2));const d=Math.min(i.length-1,f+l-1);f=Math.max(0,d-l+1);const m=[],p=new Set,g=_=>{const y=String(i[_]?.id||"");!y||p.has(y)||(p.add(y),m.push(y))},h=Math.max(0,Math.min(i.length,b(a,0)));for(let _=0;_<h;_+=1)g(_);for(let _=f;_<=d&&(g(_),!(m.length>=s));_+=1);return m}function Mh(e,t,n=2,r=[]){const a=Array.isArray(e)?e:[],i=Math.max(0,Math.min(8,b(n,2))),o=b(t?.messageIndex??t?.message_index,NaN),s=String(t?.sessionId||t?.session_id||""),c=String(t?.chatId||t?.chat_id||""),l=String(t?.hash||""),f=new Set,d=[],m=p=>{const g=String(p||"");!g||f.has(g)||(f.add(g),d.push(g))};for(const p of r||[])m(p);for(const p of a){if(!p?.id||s&&p.session_id&&String(p.session_id)!==s||c&&p.chat_id&&String(p.chat_id)!==c)continue;const g=b(p.message_index,NaN);if(Number.isFinite(o)&&Number.isFinite(g)){Math.abs(g-o)<=i&&m(p.id);continue}l&&String(p.content_hash||"")===l&&m(p.id)}return d}function Nh(e,t,n=2){const r=b(e,NaN),a=b(t,NaN);if(!Number.isFinite(r)||!Number.isFinite(a))return!1;const i=Math.max(0,b(n,2));return Math.abs(r-a)<=i}function Ih(e,t,n=2){const r=Math.max(0,Math.floor(b(t,0))),a=Math.max(0,Math.min(Math.max(0,r-1),Math.floor(b(e,0)))),i=Math.max(0,Math.floor(b(n,2)));return r<=0?{lo:0,hi:-1,center:0}:{lo:Math.max(0,a-i),hi:Math.min(r-1,a+i),center:a}}var Kl={chrome:1,content:2,full:3};function Ch(e,t){const n=Kl[String(e??"")]||0,r=Kl[String(t??"")]||0;return!n&&!r?"full":r>=n?t||e||"full":e||t||"full"}function ql(e){const t=String(e||"").trim();if(!t)return{appearance:"",attire:"",accessories:"",text:"",gender:""};let n=null;const r=t.match(/```(?:json)?\s*([\s\S]*?)```/i),a=(r?r[1]:t).trim().match(/\{[\s\S]*\}/);if(a)try{const o=JSON.parse(a[0]);n=o&&typeof o=="object"?o:null}catch{n=null}if(n&&typeof n=="object"){const o=String(n.appearance??n.look??n.identity??"").trim(),s=String(n.attire??n.clothing??n.outfit??"").trim(),c=String(n.accessories??n.accessory??n.props??"").trim(),l=String(n.gender??n.sex??"").trim().toLowerCase(),f=["girl","female","f","woman"].includes(l)?"girl":["boy","male","m","man"].includes(l)?"boy":l==="other"?"other":"";return{appearance:o,attire:s,accessories:c,text:[o,s,c].filter(Boolean).join(", "),gender:f}}const i=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/i,"").trim();return{appearance:i,attire:"",accessories:"",text:i,gender:""}}function Eh(e={}){const t=!!e.warmBusy,n=Math.max(0,Math.min(100,Math.round(b(e.warmPct,0)))),r=String(e.jobState||""),a=Math.max(0,Math.min(100,Math.round(b(e.jobPct,0))));return t?{pct:Math.max(t?6:0,n),busy:!0,label:"인덱싱"}:r==="tagging"?{pct:Math.max(6,a),busy:!0,label:"인덱싱"}:{pct:0,busy:!1,label:"인덱싱"}}function Th(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=Math.max(t?6:0,Math.min(100,Math.round(b(e.jobPct,0)))),a=Math.max(n?6:0,Math.min(100,Math.round(b(e.indexPct,0)))),i=e.error?"#f87171":"#7c6cff",o="#2dd4bf",s=(c,l)=>`<span style="display:block;height:4px;border-radius:2px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${c}%;background:${l}"></span></span>`;return`<span style="flex:0 0 120px;display:flex;flex-direction:column;gap:3px;justify-content:center">${s(r,i)}${s(a,o)}</span>`}function Gl(e={}){const t=!!e.busy,n=Math.max(t?6:0,Math.min(100,Math.round(b(e.pct,0)))),r=String(e.tone||"");return`<span style="flex:0 0 120px;display:block;height:6px;border-radius:3px;background:#1e2633;overflow:hidden"><span style="display:block;height:100%;width:${n}%;background:${e.error?"#f87171":r==="index"?"#2dd4bf":"#7c6cff"}"></span></span>`}function jh(e={}){const t=!!e.jobBusy,n=!!e.indexBusy,r=!!e.busy||t||n;if(!r&&!e.error)return"";const a=typeof e.escapeHtml=="function"?e.escapeHtml:f=>String(f).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),i=String(e.tone||(!t&&n?"index":"job")),o=a(String(e.stage||(i==="index"?"인덱싱":"작업 중")).slice(0,80)),s=a(String(e.meta||"").slice(0,160));let c=e.pct;c==null&&(t?c=e.jobPct:n?c=e.indexPct:c=Math.max(b(e.jobPct,0),b(e.indexPct,0)));const l=Gl({pct:c,busy:r||!!e.error,error:e.error,tone:i});return`<div data-inlay-progress-toast="1" style="display:flex;align-items:center;gap:10px;min-width:220px;max-width:min(420px,92vw);padding:10px 14px;border-radius:8px;background:#121820;border:1px solid #2a3344;cursor:pointer;user-select:none"><span style="flex:0 0 auto;font-weight:700;color:${e.error?"#f87171":i==="index"?"#5eead4":"#c4b5fd"};font-size:11px;white-space:nowrap">${o}</span><span style="min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8b97ab;font-size:11px">${s}</span>${l}</div>`}function qr(e){return Math.max(0,Math.min(100,b(e,0)))}function Mi(e,t){const n=Math.max(1,b(t,1));return Math.max(0,Math.min(b(e,0),n-1))/n*100}function $h(e,t=0,n=1,r=null){if(r&&r.forceEven)return Mi(t,n);const a=e?.y_percent??e?.anchor_percent??e?.read_percent,i=Number(a);return Number.isFinite(i)?qr(i):Mi(t,n)}function Wl(e,t,n=.5){if(!e)return null;const r=Math.max(1,b(e.height,0)),a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return a<b(e.top,0)||a>b(e.bottom,0)?null:qr((a-b(e.top,0))/r*100)}function Ph(e,t,n=.5){const r=Wl(e,t,n);if(r!=null)return r;const a=Math.max(0,b(t,0))*(Number.isFinite(n)?n:.5);return b(e?.bottom,0)<a?100:0}function Oh(e,t){const n=Array.isArray(e)?e:[];if(!n.length)return-1;const r=qr(t),a=n.map(c=>qr(c)),i=a.reduce((c,l,f)=>l<=20?c.concat(f):c,[]),o=i.length===1&&a[i[0]]>0?a.map((c,l)=>l===i[0]?1:c):a;if(o[0]>0&&r<o[0])return-1;let s=0;for(let c=0;c<o.length;c+=1)r>=o[c]&&(s=c);return s}var Vl="data-inlay-inline-shot",Yl=/^<\/(?:p|div|li|blockquote|h[1-6]|tr)>$/i,Xl=/^<br\s*\/?>$/i;function Zl(e){const t=String(e||"");return t?t.replace(/<div[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/div>/gi,"").replace(/<(?:span|p)[^>]*\bdata-inlay-inline-shot\b[^>]*>[\s\S]*?<\/(?:span|p)>/gi,""):""}function Gr(e){return String(e??"").replace(/\r\n/g,`
`).split(`
`).map(t=>t.trim()).filter(Boolean)}function Ql(e,t){const n=Math.floor(Number(e)),r=Math.max(0,Math.floor(Number(t)||0));return!r||!Number.isFinite(n)||n<1?null:Math.max(1,Math.min(r,n))}function eu(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Lh(e){const t=e.toLowerCase();if(t==="&nbsp;")return" ";if(t==="&amp;")return"&";if(t==="&lt;")return"<";if(t==="&gt;")return">";if(t==="&quot;")return'"';if(t==="&#39;"||t==="&apos;")return"'";const n=/^&#(\d+);$/.exec(e);if(n){const a=Number(n[1]);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}const r=/^&#x([0-9a-f]+);$/i.exec(e);if(r){const a=Number.parseInt(r[1],16);if(Number.isFinite(a)&&a>0&&a<1114112)return String.fromCodePoint(a)}return null}function Bh(e,t){let n=Math.max(0,Math.min(e.length,Math.floor(t)));for(;n>0;){let r=n;for(;r>0&&/[ \t\r\n]/.test(e[r-1]);)r-=1;if(r<=0||e[r-1]!==">")break;const a=e.lastIndexOf("<",r-1);if(a<0||a>=r-1)break;const i=e.slice(a,r);if(Xl.test(i)||Yl.test(i)||/^<\//.test(i)||!/^<[a-zA-Z][^>]*>$/.test(i))break;n=a}return n}function tu(e){const t=[];let n=0;const r=String(e||"");for(;n<r.length;){if(r[n]==="<"){const s=r.indexOf(">",n);if(s<0)break;const c=r.slice(n,s+1);(Xl.test(c)||Yl.test(c))&&t.push({ch:`
`,htmlIndex:n}),n=s+1;continue}if(r[n]==="&"){const s=r.indexOf(";",n);if(s>n&&s-n<16){const c=Lh(r.slice(n,s+1));if(c!=null){for(let l=0;l<c.length;l+=1)t.push({ch:c[l],htmlIndex:n});n=s+1;continue}}}t.push({ch:r[n],htmlIndex:n}),n+=1}const a=[];for(let s=0;s<t.length;s+=1){const c=t[s];if(c.ch!==`
...
`||o[o.length-1].ch===" ");)o.pop();return o}function Rh(e){return tu(String(e||"")).map(t=>t.ch).join("")}function nu(e,t){const n=String(e??"").replace(/\r\n/g,`
`),r=Math.floor(Number(t));if(!Number.isFinite(r)||r<1)return null;let a=0,i=0;for(;i<=n.length;){const o=n.indexOf(`
`,i),s=o<0?n.length:o,c=n.slice(i,s);if(c.trim()&&(a+=1,a===r)){const l=/^\s*/.exec(c)?.[0].length||0;return i+l}if(o<0)break;i=o+1}return null}function Wr(e){return String(e??"").replace(/\s+/g," ").trim()}function ru(e,t){const n=Array.isArray(e)?e:[],r=Math.floor(Number(t))-1;if(!Number.isFinite(r)||r<0||r>=n.length)return null;const a=Wr(n[r]);if(!a)return null;let i=0;for(let o=0;o<=r;o+=1)Wr(n[o])===a&&(i+=1);return{text:a,occurrence:i}}function au(e){const t=[],n=Array.isArray(e)?e:[];for(let r=0;r<n.length;r+=1)for(const a of Gr(n[r])){const i=Wr(a);i&&t.push({text:i,elementIndex:r})}return t}function iu(e,t,n){const r=ru(t,n);if(!r)return-1;const a=au(e);let i=0;for(const o of a)if(o.text===r.text&&(i+=1,i===r.occurrence))return o.elementIndex;return-1}function ou(e,t,n=["P"]){const r=(Array.isArray(e)?e:[]).map(o=>String(o||"").toUpperCase()),a=Math.floor(Number(t));if(!Number.isFinite(a)||a<0||a>=r.length)return-1;const i=new Set((Array.isArray(n)&&n.length?n:["P"]).map(o=>String(o||"").toUpperCase()));if((r[a]||"")!=="DIV")return a;for(let o=1;o<r.length;o+=1){const s=a-o,c=a+o;if(s>=0&&i.has(r[s]))return s;if(c<r.length&&i.has(r[c]))return c}return-1}function Fh(e,t,n,r,a=["P"]){const i=Array.isArray(n)?n:[],o=Math.floor(Number(r));if(!Number.isFinite(o)||o<1||!i.length)return null;const s=i.length;for(let c=Math.max(1,o);c<=s;c+=1){const l=ou(t,iu(e,i,c),a);if(l>=0)return{elementIndex:l,usedLine:c}}return null}function su(e,t){const n=Number.isFinite(Number(e.shotIndex))?String(Math.floor(Number(e.shotIndex))):"",r=eu(String(e.cardId||(e.pending?`pending-${n||e.line}`:"")||n||e.line||"0")),a="display:block;margin:10px 0;text-align:center;line-height:0;max-width:100%;box-sizing:border-box";return e.pending||!/^data:image\//i.test(String(e.src||""))?`<div ${Vl}="${r}" data-inlay-inline-pending="1" x-inlay-inline-shot="${r}" contenteditable="false" style="${a}"><br><br><span style="display:inline-flex;align-items:center;justify-content:center;min-width:48px;min-height:48px;padding:10px;border-radius:12px;background:rgba(124,108,255,.12);border:1px solid rgba(196,181,253,.35)"><svg width="28" height="28" viewBox="0 0 28 28" style="display:inline-block;vertical-align:middle" aria-hidden="true"><circle cx="14" cy="14" r="11" fill="none" stroke="rgba(255,255,255,.18)" stroke-width="3"/><circle cx="14" cy="14" r="11" fill="none" stroke="#c4b5fd" stroke-width="3" stroke-linecap="round" stroke-dasharray="18 52"><animateTransform attributeName="transform" type="rotate" from="0 14 14" to="360 14 14" dur="0.75s" repeatCount="indefinite"/></circle></svg></span><br><br></div>`:`<div ${Vl}="${r}" x-inlay-inline-shot="${r}" contenteditable="false" style="${a}"><br><img src="${eu(e.src)}" alt="" style="width:auto;height:auto;max-width:min(60%,100%);max-height:min(70vh,900px);object-fit:contain;border-radius:8px;display:inline-block;vertical-align:top" loading="eager" decoding="async"><br></div>`}function cu(e,t,n){const r=Zl(e),a=Array.isArray(t)?t:[];if(!r||!a.length)return r;const i=tu(r),o=i.map(g=>g.ch).join(""),s=Gr(o).length;if(!s||!i.length)return r;const c=new Map,l=new Set;for(const g of a){const h=Ql(g?.line,s),_=String(g?.src||""),y=String(g?.cardId||""),k=g?.pending===!0||!!h&&!/^data:image\//i.test(_);h&&(!k&&!/^data:image\//i.test(_)||y&&l.has(y)||c.has(h)||(y&&l.add(y),c.set(h,{...g,line:h,src:_,pending:k})))}if(!c.size)return r;const f=n?.maxWidthPx,d=new Map;for(const[g,h]of c){const _=nu(o,g);if(_==null||_<0||_>=i.length)continue;const y=Bh(r,i[_].htmlIndex);d.has(y)||d.set(y,su(h,f))}if(!d.size)return r;const m=[...d.entries()].map(([g,h])=>({htmlIndex:g,html:h})).sort((g,h)=>h.htmlIndex-g.htmlIndex);let p=r;for(const g of m)p=p.slice(0,g.htmlIndex)+g.html+p.slice(g.htmlIndex);return p}function Dh(e,t,n){const r=Gr(e);return r.length?cu(r.map(a=>String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")).join("<br>"),t,n):""}ee(),q(),pt(),Q(),vt(),O(),Ga(),fi(),Tr(),ci(),fe(),ft();function Ni(){const e=he(),t=e.events;return{last_stage:e.last_stage,events:Array.isArray(t)?t.slice(-20):[]}}async function zh(e){if(e){const t=T(),n={...e};u(n.api_key)&&(t.llm.api_key=u(n.api_key)),delete n.api_key,delete n.api_key_configured,u(n.service_account_json)&&(t.llm.service_account_json=u(n.service_account_json)),delete n.service_account_json,delete n.service_account_configured,Object.keys(n).length&&(t.llm=nt(t.llm,n)),await Ke()}try{const t=T().llm,n=jr(t.source),r=Lt(t.provider);return n==="custom"&&!Zc(t)?{ok:!1,message:r==="vertex"?"Vertex AI: Model + Service Account JSON(또는 access token)이 필요합니다.":"태깅 LLM Model/API key가 비어 있습니다. NovelAI 키가 아니라 태깅용 LLM 키를 넣으세요."}:(n==="main"||n==="aux")&&!ge("runLLMModel")?{ok:!1,message:"RisuAI runLLMModel API를 사용할 수 없습니다."}:{ok:!0,message:`LLM ok (${n}): ${(await cn(t,[{role:"user",content:"Reply with exactly: ok"}])).slice(0,120)}`}}catch(t){return{ok:!1,message:String(t?.message||t)}}}async function Uh(){const e=T().nai;if(Hn(e)==="comfy")try{if(!Ka(e))return{ok:!1,message:"ComfyUI 워크플로 JSON이 없습니다.",debug:he()};const t=gc({main:"test",neg:"test",captions:[{name:"",prompt:"char1"},{name:"",prompt:"char2"}],nai:e,seed:1}),n=hc(e.comfy_workflow_json,t),r=pc(e),{status:a,data:i}=await qa(`${r}/system_stats`,{method:"GET"});if(a>=400)return{ok:!1,message:`ComfyUI 연결 실패 (HTTP ${a}) · ${r}`,debug:he()};const o=i?.devices?.[0]?.name||i?.system?.os||"ok";return{ok:!0,message:`ComfyUI ok · ${r} · nodes=${Object.keys(n).length} · ${o}`,debug:Ni()}}catch(t){return w("comfy.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:he()}}if(!u(e.api_key))return{ok:!1,message:"NAI api_key missing",debug:he()};try{const t=u(e.api_key);try{const n=ue("nai.test.anlas"),r=await mm(t);return n.end({message:"anlas ok"}),{ok:!0,message:`NAI token ok · Anlas=${JSON.stringify(r)}`,debug:Ni()}}catch(n){const r=He(e.model||"nai-diffusion-4-5-full");return w("nai.test.anlas",{message:String(n?.message||n)},"warn"),{ok:!0,message:`NAI config present · model=${r} · anlas_skip=${n?.message||n}`,debug:Ni()}}}catch(t){return w("nai.test",{message:String(t?.message||t)},"error"),{ok:!1,message:String(t?.message||t),debug:he()}}}async function Jh(){const e=T().nai,t=u(e.api_key);if(!t)return{ok:!1,message:"NAI api_key missing",debug:he()};const n=String(he().job_ctx??"");kn("probe-nai");const r=ue("nai.probe");try{w("nai.probe.start",{message:"tiny generate"});const a={prompt:"1girl, solo, simple background, best quality",negative_prompt:"lowres, bad quality",width:512,height:768,steps:10,cfg_scale:5,cfg_rescale:0,sampler:"k_euler_ancestral",scheduler:"karras",model:He(e.model||"nai-diffusion-4-5-full"),var_plus:!1,characters:[],seed:Math.floor(Math.random()*4294967295)||1},i=u(e.request_url)||"https://image.novelai.net/ai/generate-image",o=await yc(t,a,i,{timeoutMs:9e4}),s=o.raw_bytes.byteLength,c=yt(V(o.raw_bytes));return r.end({bytes:s,is_png:c,seed:o.seed}),{ok:!0,message:`probe ok · png=${c} · ${s}B · seed=${o.seed}`,bytes:s,is_png:c,seed:o.seed,debug:he()}}catch(a){return r.fail(a),{ok:!1,message:String(a?.message||a),debug:he()}}finally{kn(n)}}async function Hh(e,t){if(!e?.byteLength)throw new Error("image is empty");const n=await mf(e),r=n.bytes,a=n.mime||"image/png",i=n.filename||"image.png",o=`data:${a};base64,${await Qe(r)}`,s=ur(await ce("autotag"))||["Tag ONE character reference image into Danbooru-style English prompts.",'Return ONE JSON object only: {"gender":"girl|boy","appearance":"...","attire":"...","accessories":"..."}.',"gender must be exactly girl or boy from visual evidence. appearance = identity/hair/eyes/body (no clothes). attire = clothing + permanent jewelry (earrings/glasses/watch/earbuds). accessories = weapons/bags/held props/ID only (not jewelry)."].join(`
`);w("autotag.start",{message:`llm-vision ${i} ${r.length}B`,bytes:r.length,focus:!0,source:jr(T().llm.source)});const c=[{role:"system",content:s},{role:"user",content:[{type:"text",text:"Tag this character image. JSON only with gender, appearance, attire, accessories."},{type:"image_url",image_url:{url:o}}]}];let l="";try{l=await cn(T().llm,c)}catch(k){throw w("autotag.llm.fail",{message:String(k?.message||k)},"error"),new Error(`오토태그 LLM 실패: ${String(k?.message||k).slice(0,240)}`)}const f=ql(l),d=u(f.appearance||"",4e3),m=u(f.attire||"",4e3),p=u(f.accessories||"",4e3),g=u(f.gender||"",20),h=u(f.text||[d,m,p].filter(Boolean).join(", "),8e3);if(!d&&!m&&!p)throw new Error("LLM이 외형/의상/악세사리 태그를 반환하지 않았습니다. 비전(이미지) 지원 모델인지 확인하세요.");const _=h.split(",").map(k=>k.trim()).filter(Boolean);w("autotag.done",{message:`gender=${g||"-"} app=${d.length} attire=${m.length} acc=${p.length}`,focus:!0});const y={ok:!0,appearance:d,attire:m,accessories:p,tags:_,text:h,count:_.length,threshold:Number(t||.2),engine:"llm-vision"};return g&&(y.gender=g),y}async function Kh(e){if(!e?.byteLength)throw new Error("image is empty");const t=await Js(e);if(!t)throw new Error("이미지에서 NovelAI 메타데이터를 읽지 못했습니다. PNG/WebP NAI 원본인지 확인하세요.");const n=Ps(t);if(!u(n))throw new Error("메타데이터에 프롬프트가 없습니다.");const r=pd(t,n);if(!r.positive&&!r.negative)throw new Error("프리셋에 넣을 artist/품질 태그와 네거티브가 비어 있습니다.");return w("preset-from-image.done",{message:`pos=${r.positive.length} neg=${r.negative.length} cfg=${r.cfg_scale}`,focus:!0}),{ok:!0,positive:r.positive,negative:r.negative,cfg_scale:r.cfg_scale,cfg_rescale:r.cfg_rescale,name:"이미지 프리셋"}}O();function qh(e){const t=e.indexOf("?");if(t<0)return{pathname:e,query:{}};const n=e.slice(0,t),r=new URLSearchParams(e.slice(t+1)),a={};for(const[i,o]of r.entries()){const s=a[i];s===void 0?a[i]=o:Array.isArray(s)?s.push(o):a[i]=[s,o]}return{pathname:n,query:a}}function nr(e,t,n=""){const r=e[t];return Array.isArray(r)?r[0]??n:r??n}function Gh(e,t={}){const n=u(e.auth_token,4e3);if(!n)return!0;const r=String(t.Authorization||t.authorization||"");let a=r.toLowerCase().startsWith("bearer ")?r.slice(7):r;if(a=a||String(t["X-Inlay-Nexus-Token"]||t["x-inlay-nexus-token"]||""),typeof a!="string"||a.length!==n.length)return!1;let i=0;for(let o=0;o<n.length;o+=1)i|=a.charCodeAt(o)^n.charCodeAt(o);return i===0}q(),Q(),O(),ee(),Lo(),fe(),ft(),Zn();var j=(...e)=>t=>e.includes(t)?"":null,We=e=>t=>t.startsWith(e)?t.slice(e.length):null,Ii=(e,t)=>n=>n.startsWith(e)&&n.endsWith(t)?n.slice(e.length,n.length-t.length):null,A=e=>({status:200,data:e}),Ci=e=>({status:200,data:e,contentType:"image/png",raw:!0}),rr=e=>{throw ht(404,{ok:!1,...ae(e,"not_found")},e)};function Vr(e){let t=e.image_b64||e.data||"";return typeof t=="string"&&t.startsWith("data:")&&(t=t.split(",",2)[1]??""),String(t||"")}var Wh=[{match:j("/v1/settings/export"),handler:()=>A({ok:!0,json:Ep()})},{match:j("/v1/settings"),handler:()=>A({ok:!0,settings:Lr()})},{match:j("/v1/curation/status"),handler:async()=>A({ok:!0,status:await Xn()})},{match:j("/v1/curation/catalog"),handler:async()=>A({ok:!0,catalog:await dt()})},{match:j("/v1/prompts"),handler:async()=>A({ok:!0,prompts:await Or()})},{match:j("/v1/prompts/export"),handler:async()=>A({ok:!0,...await Mp()})},{match:We("/v1/prompts/"),handler:async({param:e})=>A({ok:!0,key:e,text:await ce(e)})},{match:We("/v1/jobs/"),handler:async({param:e})=>A(await jg(e))},{match:We("/v1/gallery/explore"),handler:async({query:e})=>A(await lg(Number(nr(e,"limit","400"))))},{match:j("/v1/gallery/favorites"),handler:async()=>A(await Ml())},{match:We("/v1/gallery"),handler:async({query:e})=>A(await ug(nr(e,"session_id"),Number(nr(e,"limit","40"))))},{match:j("/v1/nai/reference.png"),handler:async()=>Ci(await hl()??rr("no reference"))},{match:j("/v1/nai/vibe.png"),handler:async()=>Ci(await qp()??rr("no vibe"))},{match:j("/v1/nai/reference"),handler:async()=>{const e=await Up();return A({ok:!0,configured:e,image_reference:T().nai?.image_reference||"none",preview_url:e?"/v1/nai/reference.png":""})}},{match:j("/v1/nai/vibe"),handler:async()=>{const e=await Hp();return A({ok:!0,configured:e,vibe_transfer:T().nai?.vibe_transfer||"none",preview_url:e?"/v1/nai/vibe.png":""})}},{match:We("/v1/characters"),handler:async({query:e})=>A(await Un(nr(e,"session_id"),nr(e,"character_id")))},{match:We("/v1/appearance/"),handler:async({param:e})=>A(await Un(e))},{match:We("/v1/images/"),handler:async({param:e})=>{let t=e.replace(/^\/+|\/+$/g,"");if(t.endsWith(".json")){const n=await Bt(t.slice(0,-5));return Object.keys(n).length||rr("location missing"),A(n)}return t.endsWith(".png")&&(t=t.slice(0,-4)),Ci(await Nl(t)??rr("image missing"))}}],Vh=[{match:j("/v1/settings/reset"),handler:async()=>A(await jp())},{match:j("/v1/settings/import"),handler:async({body:e})=>A(await Tp(String(e.json||e.text||"")))},{match:j("/v1/settings","/v1/settings/update"),handler:async({body:e})=>A(await Pp(e))},{match:j("/v1/curation/catalog"),handler:async({body:e})=>{const t=e.catalog??e;return A(await al(t))}},{match:j("/v1/curation/catalog/reset"),handler:async()=>A(await il())},{match:j("/v1/curation/embed"),handler:async()=>A(await ol())},{match:j("/v1/curation/embed/test"),handler:async()=>A(await sl())},{match:j("/v1/curation/settings"),handler:async({body:e})=>A(await pl(e))},{match:j("/v1/prompts/import"),handler:async({body:e})=>A(await Np(e?.json!=null?e.json:(e?.prompts!=null,e)))},{match:j("/v1/prompts/reset-defaults"),handler:async({body:e})=>A(await Ip({keep_author_note:e?.keep_author_note!==!1&&e?.keepAuthorNote!==!1}))},{match:Ii("/v1/prompts/","/reset"),handler:async({param:e})=>A(await tl(e,Cn(e)))},{match:We("/v1/prompts/"),handler:async({param:e,body:t})=>A(await tl(e,String(t.text||"")))},{match:j("/v1/jobs/create","/v1/jobs"),handler:async({body:e})=>({status:202,data:await Tl(e)})},{match:j("/v1/gallery/unlink","/v1/cards/unlink"),handler:async({body:e})=>A(await yi(String(e.session_id||""),String(e.content_hash||""),e.message_index))},{match:j("/v1/gallery/rebind-hash","/v1/cards/rebind-hash"),handler:async({body:e})=>A(await fg({session_id:String(e.session_id||e.sessionId||""),card_ids:e.card_ids||e.ids||[],to_hash:String(e.to_hash||e.content_hash||""),assistant_preview:String(e.assistant_preview||e.assistant_text||"")}))},{match:j("/v1/gallery/delete","/v1/cards/delete"),handler:async({body:e})=>{const t=u(e.folder_key||"",400),n=u(e.card_id||e.id||"",80),r=Array.isArray(e.card_ids)?e.card_ids:null;if(t)return A(await hg(t));if(r?.length)return A(await dg(r));if(n)return A(await wi(n));const a="card_id or folder_key required";throw ht(400,{ok:!1,...ae(a,"bad_request")},a)}},{match:j("/v1/gallery/export"),handler:async({body:e})=>A(await pg(e))},{match:j("/v1/gallery/import"),handler:async({body:e})=>A(await gg(e))},{match:j("/v1/gallery/favorites"),handler:async({body:e})=>Array.isArray(e.ids)?A(await mg(e.ids)):A(await Ml())},{match:Ii("/v1/cards/","/tags"),handler:async({param:e,body:t})=>A(await Og(e,t))},{match:Ii("/v1/cards/","/reroll"),handler:async({param:e,body:t})=>A(await jl(e,String(t.mode||"nai"),t.overrides))},{match:j("/v1/messages/reroll","/v1/gallery/reroll-message"),handler:async({body:e})=>A(await Lg({session_id:String(e.session_id||e.sessionId||""),content_hash:String(e.content_hash||e.contentHash||""),message_index:Number(e.message_index??e.messageIndex??-1)}))},{match:j("/v1/characters/global-toggles","/v1/characters/global_toggles"),handler:async({body:e})=>A(await Pd(String(e.character_id||""),e.disabled_globals||e.disabled||[]))},{match:j("/v1/characters/unify","/v1/characters/merge"),handler:async({body:e})=>A(await rc(String(e.target_session_id||e.session_id||""),e.source_session_ids||e.session_ids||[],e.include_target!==!1))},{match:j("/v1/characters","/v1/characters/update"),handler:({body:e})=>Yh(e)},{match:We("/v1/appearance/"),handler:async({param:e,body:t})=>t.characters!=null||t.global!=null?(t.characters!=null&&await zn(e,t.characters||[],{prune:!0}),t.global!=null&&await zn(Xe,t.global||[],{prune:!0}),A(await Un(e))):A(await zd(e,t.appearance||{}))},{match:j("/v1/models/test"),handler:async({body:e})=>A(await zh(e.llm&&typeof e.llm=="object"?e.llm:null))},{match:j("/v1/nai/test"),handler:async()=>A(await Uh())},{match:j("/v1/nai/probe","/v1/debug/probe-nai"),handler:async()=>A(await Jh())},{match:j("/v1/debug/clear"),handler:()=>(Qr(),A({ok:!0,cleared:!0}))},{match:j("/v1/debug/asset-tags"),handler:async({body:e})=>A(await jd(e))},{match:j("/v1/nai/reference","/v1/nai/reference/upload"),handler:async({body:e})=>{if(e.clear)return A(await _l());const t=Vr(e);if(!u(t))throw new Error("image_b64 required");return A(await Jp(Z(Pe(t))))}},{match:j("/v1/nai/reference/clear"),handler:async()=>A(await _l())},{match:j("/v1/nai/vibe","/v1/nai/vibe/upload"),handler:async({body:e})=>{const t=u(e.preset_id||e.presetId||"",120);if(e.clear)return A(t?await wl(t):await yl());if(t&&e.copy_from){const a=u(e.copy_from,120),i=a?await Yp(a,t):!1;return A({ok:!0,preset_id:t,configured:i,preview_url:i?sa(t):""})}const n=Vr(e);if(!u(n))throw new Error("image_b64 required");const r={model:e.model,information_extracted:e.information_extracted??e.vibe_transfer_information_extracted,strength:e.strength??e.vibe_transfer_strength};return A(t?await Vp(t,Z(Pe(n)),r):await Gp(Z(Pe(n)),r))}},{match:j("/v1/nai/vibe/clear"),handler:async({body:e})=>{const t=u(e?.preset_id||e?.presetId||"",120);return A(t?await wl(t):await yl())}},{match:j("/v1/autotag","/v1/autotag/evaluate"),handler:async({body:e})=>{const t=Vr(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=Pe(t);return A(await Hh(Z(n),Number(e.threshold??.2)))}},{match:j("/v1/presets/from-image"),handler:async({body:e})=>{const t=Vr(e).replace(/\s+/g,"");if(!t)throw new Error("image_b64 required");const n=Pe(t);return A(await Kh(Z(n)))}}];async function Yh(e){const t=u(e.session_id||"",200),n=u(e.character_id||"",200),r=(Array.isArray(e.root_session_ids)?e.root_session_ids:Array.isArray(e.cascade_session_ids)?e.cascade_session_ids:[]).map(i=>u(i,200)).filter(Boolean);if("characters"in e&&t&&await zn(t,e.characters||[],{prune:!0,rootSessionIds:r}),"global"in e&&await zn(Xe,e.global||[],{prune:!0}),"character"in e){const i=u(e.scope||t||"__global__",200);r.length&&i!=="__global__"?await nc(r,[e.character||{}],""):await ct(i,e.character||{})}const a=Array.isArray(e.root_delete)?e.root_delete:Array.isArray(e.cascade_delete)?e.cascade_delete:[];return a.length&&r.length&&await Fd(r,a,""),r.length&&t&&await rc(t,r,!1),A(await Un(t,n))}async function lu(e,t){for(const n of e){const r=n.match(t.pathname);if(r!==null)return n.handler({...t,param:r})}return rr(t.pathname)}async function Xh(e,t={}){const{pathname:n,query:r}=qh(e),a=String(t.method||"GET").toUpperCase();let i;if(typeof t.body=="string")try{i=JSON.parse(t.body)}catch{i={}}else i=t.body??{};if(["/v1/health","/healthz","/readyz"].includes(n))return A({ok:!0,health:$p()});if(n==="/v1/debug"||n==="/v1/debug/log")return a==="DELETE"||a==="POST"&&i.clear?(Qr(),A({ok:!0,cleared:!0})):A(he());if(!Gh(T(),t.headers||{})){const s="invalid token";throw ht(401,{ok:!1,...ae(s,"unauthorized")},s)}const o={method:a,pathname:n,query:r,body:i};if(a==="GET")return lu(Wh,o);if(["POST","PUT","PATCH"].includes(a))try{return await lu(Vh,o)}catch(s){if(Gi(s))throw s;const c=String(s?.message||s);throw ht(500,{ok:!1,...ae(c,"internal")},c)}throw ht(405,{ok:!1,...ae(a,"method_not_allowed")},a)}ee(),q(),pt(),wr(),el(),Le(),fe(),ft();var Yr=null;async function Zh(){w("boot.ready.start",{message:Ye}),await ot();const e=await br().catch(r=>{throw w("boot.storage",{message:String(r?.message||r)},"error"),r});w("boot.storage",{message:e.kind}),fr(await Sp()),await Ap(),await Jd(),await Hd();const t=await z("meta","reference_image");t?.png&&ia(Ct(t.png));const n=await z("meta","vibe_transfer");n?.png&&oa(Ct(n.png)),await Zp(),w("boot.ready.done",{message:Ye,has_nativeFetch:ge("nativeFetch"),has_idb:ge("getLocalPluginStorage")})}async function Ei(){return Yr||(Yr=Zh().catch(e=>{throw Yr=null,e})),await Yr,!0}async function Qh(e,t={},n=12e4){await Ei();try{const r=await Xh(e,t);if(r.raw)return r.data;if(r.status>=400)throw ht(r.status,r.data);return r.data}catch(r){if(Gi(r))throw r;const a=String(r?.message||r);throw ht(500,{ok:!1,...ae(a,"internal")},a)}}async function e_(e){return await Ei(),Qt(e)}function t_(){Ji(()=>({cards:Pn("cards"),images:Pn("images"),jobs:Pn("jobs"),blob_urls:Ef()})),Reflect.set(globalThis,"__INLAY_NATIVE__",{VERSION:Ye,ready:Ei,fetch:Qh,resolveImageUrl:Be,refPreviewUrl:Bo,vibePreviewUrl:Ro,ensureImageUrl:e_,warmImages:Lf,pinImageUrls:Of,warmProgress:jf,onWarmProgress:$f,debug:he,clearDebug:Qr})}var n_=dn({applyExplorerClick:()=>i_,clearSelection:()=>s_,createSelectionState:()=>r_,moveFocus:()=>c_,reorderByIds:()=>f_,selectAll:()=>o_,sortExplorerItems:()=>l_,thumbMinWidth:()=>u_,visibleIds:()=>a_});function r_(e=[]){return{selected:new Set((e||[]).map(String).filter(Boolean)),anchorId:"",focusId:""}}function a_(e=[]){return(e||[]).map(t=>String(t?.id||"")).filter(Boolean)}function i_(e,t,{index:n,ids:r,shift:a=!1,ctrl:i=!1}={}){const o={selected:new Set(e?.selected||[]),anchorId:String(e?.anchorId||""),focusId:String(e?.focusId||"")},s=String(t||"");if(!s)return o;const c=Array.isArray(r)?r.map(String):[],l=typeof n=="number"&&Number.isFinite(n)?n:c.indexOf(s);if(a&&o.anchorId&&c.length){const f=c.indexOf(o.anchorId),d=l>=0?l:c.indexOf(s);if(f>=0&&d>=0){const m=Math.min(f,d),p=Math.max(f,d);return o.selected=new Set(c.slice(m,p+1)),o.focusId=s,o}}return i?(o.selected.has(s)?o.selected.delete(s):o.selected.add(s),o.anchorId=s,o.focusId=s,o):(o.selected=new Set([s]),o.anchorId=s,o.focusId=s,o)}function o_(e,t=[]){return{selected:new Set((t||[]).map(String).filter(Boolean)),anchorId:String(e?.anchorId||t?.[0]||""),focusId:String(e?.focusId||t?.[0]||"")}}function s_(e=null){return{selected:new Set,anchorId:String(e?.anchorId||""),focusId:""}}function c_(e=[],t="",n=1){const r=(e||[]).map(String).filter(Boolean);if(!r.length)return"";const a=r.indexOf(String(t||""));return a<0?r[0]:r[Math.max(0,Math.min(r.length-1,a+n))]}function l_(e=[],t="newest"){const n=[...e||[]],r=(a,i=0)=>{const o=Number(a);return Number.isFinite(o)?o:i};return t==="oldest"?n.sort((a,i)=>r(a.created_at)-r(i.created_at)||String(a.id).localeCompare(String(i.id))):t==="message"?n.sort((a,i)=>r(a.message_index,1e9)-r(i.message_index,1e9)||r(a.shot_index)-r(i.shot_index)||r(i.created_at)-r(a.created_at)):t==="shot"?n.sort((a,i)=>r(a.shot_index)-r(i.shot_index)||r(a.message_index,1e9)-r(i.message_index,1e9)||r(i.created_at)-r(a.created_at)):n.sort((a,i)=>r(i.created_at)-r(a.created_at)||String(i.id).localeCompare(String(a.id)))}function u_(e="m"){return e==="s"?96:e==="l"?200:148}function f_(e=[],t=[]){const n=i=>{const o=i&&typeof i=="object"?i.id:void 0;return String(o??i)},r=new Map((e||[]).map(i=>[n(i),i])),a=[];for(const i of t||[]){const o=String(i);r.has(o)&&(a.push(r.get(o)),r.delete(o))}for(const i of r.values())a.push(i);return a}Tr(),Kc();function d_(){Reflect.set(globalThis,"__INLAY_VIEWER_CORE__",{...Bg}),Reflect.set(globalThis,"__INLAY_LLM__",{...gp}),Reflect.set(globalThis,"__INLAY_EMBED__",{EMBEDDING_PROVIDERS:oi,normalizeEmbeddingProvider:Ce,defaultEndpointForEmbedding:Cr,defaultModelForEmbedding:Wn,embeddingModelPlaceholder:sp,shouldAutoReplaceEmbeddingEndpoint:lp,shouldAutoReplaceEmbeddingModel:up,embeddingProviderNeedsApiKey:fp}),Reflect.set(globalThis,"__INLAY_LORE_EXTRA__",{...Kf}),Reflect.set(globalThis,"__INLAY_EXPLORER__",{...n_})}ee(),q(),d_(),t_(),w("boot.loaded",{message:Ye})})();
...
var Zt = "inlay-nexus-native", ea = "Inlay Nexus", He = "2.1.7", rn = class extends Error {
  segment;
  constructor($) {
