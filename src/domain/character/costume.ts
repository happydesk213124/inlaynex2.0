 ...
 *
 * Index 0 is always the generation default when a shot has no readable
 * `costume` pick. `attire` / `accessories` on the roster row remain the
 * active editing mirror for the UI; they are not the generation fallback.
 */
...
/** Wear for a shot: resolved costume, else index 0, else roster attire mirror. */
