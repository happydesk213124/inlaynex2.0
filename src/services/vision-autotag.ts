...
export async function runVisionAutotagLook(imageBytes: BytesLike): Promise<AutotagLook> {
  ...
  if (!cleanText(parsed.appearance) && !cleanText(parsed.attire) && !cleanText(parsed.accessories)) {
