      ...
      \`;
        ...
        <div class="card" style="margin-top:14px">
          ...
          <ul style="margin:10px 0 0;padding-left:18px;line-height:1.55;color:#c9d4e6;font-size:13px">
            <li>플러그인 로드 불가 수정: 캐릭터 탭 lorefilter 패치 SyntaxError · smoke에 node --check 추가</li>
          </ul>
        </div>
        <div class="card" style="margin-top:14px">
        ...
        <div class="card" style="margin-top:14px">
          ...
          <ul style="margin:10px 0 0;padding-left:18px;line-height:1.55;color:#c9d4e6;font-size:13px">
            <li>생성 완료(unzip) 직후 바로 스피너→이미지 반영 · 다음 NovelAI 요청은 그와 동시에 진행(앞 장 저장 때문에 뒤 장 표시가 밀리지 않음)</li>
          </ul>
        </div>
        <div class="card" style="margin-top:14px">
          <strong>2.2.43</strong>
          <ul style="margin:10px 0 0;padding-left:18px;line-height:1.55;color:#c9d4e6;font-size:13px">
            <li>NovelAI 연속 생성: 한 장 HTTP가 끝나는 즉시 다음 장을 요청하고, ZIP 해제·DB 저장·해시 연결은 뒤에서 처리(장수 많을수록 대기 단축)</li>
          </ul>
        </div>
        <div class="card" style="margin-top:14px">
